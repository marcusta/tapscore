...
//
// One participant at a time. Gross total = sum of recorded strokes (with pickups
// resolved to WHS net-double: par + 2 + strokes given). Net total = gross −
// strokes given, distributed by stroke index on a playing-handicap basis.
//
