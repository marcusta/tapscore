(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const vs="modulepreload",ws=function(i){return"/tapscore/"+i},dt={},xs=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let u=function(h){return Promise.all(h.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");n=u(t.map(h=>{if(h=ws(h),h in dt)return;dt[h]=!0;const f=h.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${m}`))return;const c=document.createElement("link");if(c.rel=f?"stylesheet":vs,f||(c.as="script"),c.crossOrigin="",c.href=h,d&&c.setAttribute("nonce",d),document.head.appendChild(c),f)return new Promise((_,g)=>{c.addEventListener("load",_),c.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return n.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Mt="/tapscore/".replace(/\/+$/,""),qe=Mt+"/api",Ee={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},$s=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Ht(i,e){const t={};for(const[s,n]of $s)if(s in i)for(const r of n)r in i||(t[r]=`var(--${s})`);return{...e,...t,...i}}const Ft=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],ks={thin:"1px",medium:"3px",thick:"5px"};function Bt(i){const e=i.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":ks[e.toLowerCase()]??e}function Ss(){return Ft.map(i=>{const e=Bt(Ee[i]);return`@property --${i}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Gt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},qt={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Cs={...qt,"done-opacity":"0.35"},Is={...Gt,...qt,...Ee,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ts={...Gt,...Cs,...Ee,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Es{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Kt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const Y=new Es;function Kt(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,Y.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){Y.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,Y.notify(t.subs))})},deps:new Set};s.run()}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}}function N(i){const e={run(){Y.runTracked(e,i)},deps:new Set};return e.run(),()=>{e.disposed=!0,Kt(e)}}function he(i){Y.batch(i)}function G(i){return Y.untrack(i)}class Ns{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const H=new Ns,oe=Mt;function Ke(i){return oe?i===oe?"/":i.startsWith(oe+"/")?i.slice(oe.length):i:i}function Ps(i){return oe+i}class D{constructor(){this.route=new p(Ke(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>he(()=>{this.route.set(Ke(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",o=n>=0?e.slice(0,n):e,d=o.indexOf("?"),u=d>=0?o.slice(0,d):o,h=d>=0?o.slice(d+1):"",f=s.query!==void 0?zs(s.query):h?"?"+h:"",m=Ps(u)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),he(()=>{this.route.set(u),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const s=this.route.get().split("/"),n={};for(const[r,o]of t.entries())o.startsWith(":")&&(n[o.slice(1)]=s[r]??"");return n})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function zs(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function Os(i){return e=>i[e]}const js="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ct="data-basics-global";function Rs(){if(document.head.querySelector(`style[${ct}]`))return;const i=document.createElement("style");i.setAttribute(ct,""),i.textContent=Ss()+js,document.head.appendChild(i)}function Ds(i,e){Rs();const t=new Set(Ft),s=(r,o,d)=>{const u=Object.entries(r).map(([h,f])=>`--${h}:${t.has(h)?Bt(f):f}`).join(";");return`${o}{color-scheme:${d};${u}}`},n=document.createElement("style");return n.textContent=s(i,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(n),r=>`var(--${r})`}const ut="basics-js-theme";class Ls{constructor(){this.dark=new p(!1);const e=localStorage.getItem(ut),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),N(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ut,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function y(i){const e=document.createElement("template");return e.innerHTML=i,e}function As(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const ht=new Set;class P{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!ht.has(t)){ht.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return H.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=G(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){G(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const n=s??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")n(N(()=>{const u=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(u):o.textContent=String(u)}));else for(const[u,h]of Object.entries(d)){const f=u.includes("-");u.startsWith("on")&&typeof h=="function"?o.addEventListener(u.slice(2),h):typeof h=="function"?n(N(()=>{const m=h();f?o.setAttribute(u,String(m)):o[u]=m})):f?o.setAttribute(u,String(h)):o[u]=h}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof P?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const u of d.values())u.forEach(h=>h());d.clear()}),this.track(N(()=>{const u=r(),h=new Map;for(const[m,c]of u.entries()){const _=n(c,m);if(o.has(_))h.set(_,o.get(_));else{const g=[];h.set(_,G(()=>s(c,m,C=>g.push(C)))),d.set(_,g)}}for(const[m,c]of o)h.has(m)||(c.remove(),G(()=>d.get(m)?.forEach(_=>_())),d.delete(m));let f=e.firstChild;for(const m of h.values())m===f?f=f.nextSibling:e.insertBefore(m,f);o.clear();for(const[m,c]of h)o.set(m,c)}))}$condition(e,t,s,n){let r=null;this.track(N(()=>{r&&(r.remove(),r=null);const o=t.get();r=G(()=>o?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track(N(()=>{if(r){const u=r;r=null,G(()=>u.destroy())}e.textContent="";const o=t.get(),d=s[o]??As(o,s)??n;d&&(r=G(()=>{const u=new d;return u.mount(e),u}))})),this.track(()=>r?.destroy())}}const Ie=new Set;function Ms(i){return Ie.add(i),()=>Ie.delete(i)}function Hs(){for(const i of Array.from(Ie)){Ie.delete(i);try{i()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Fs(i,e,t){const s=document.querySelector(e);s.textContent="";const n=H.get(D);let r=null,o=!1,d=null,u=!!t?.hot?.data.hmr;const h=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await xs(()=>import("./obs-shell.component-DOKWV7xC.js"),[])).ObsShellComponent),r=G(()=>new d)):(!u&&t?.onInit&&(await t.onInit(),u=!0),r=G(()=>new i)),G(()=>r.mount(s)),o=f};await h(Ke(location.pathname).startsWith("/_obs")),N(()=>{const f=n.route.get().startsWith("/_obs");f!==o&&h(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Hs(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class q extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Bs=10,ke=[];let Se=[],de=null;function Gs(i){ke.push(i),ke.length>Bs&&ke.shift()}function Vt(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...ke],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Se.push(s),qs()}function qs(){de||(de=setTimeout(Ut,5e3))}function Ut(){if(de&&(clearTimeout(de),de=null),Se.length===0)return;const i=Se;Se=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${qe}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${qe}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ut()});const Ks=3e4,Vs=2,be=new Map,Wt=new WeakMap;function Us(i){if(i instanceof q)return i.traceId;if(i!=null&&typeof i=="object")return Wt.get(i)}async function b(i){if(i.method==="GET"){const e=be.get(i.url);if(e)return e;const t=pt(i,Vs);return be.set(i.url,t),t.then(()=>be.delete(i.url),()=>be.delete(i.url)),t}return pt(i,0)}async function pt(i,e){const t=i.timeout??Ks;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Ys(Ws(i,r),t)}catch(o){if(s=o,!(o instanceof q)&&o!=null&&typeof o=="object"&&Wt.set(o,r),o instanceof q||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function Ws(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(Gs({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const o=await n.json().catch(()=>({error:n.statusText}));throw new q(n.status,o.error??n.statusText,o.details,r)}return n.json()}function Ys(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}const Ve=new Set;let je=!1;function Qs(i){return Ve.add(i),()=>{Ve.delete(i)}}function Xs(){if(!je){je=!0;try{for(const i of[...Ve])try{i()}catch(e){try{Vt("session-listener",Js(e))}catch{}}}finally{je=!1}}}function Js(i){try{if(i instanceof Error){const e=i.message;if(typeof e=="string")return e}return String(i)}catch{return"listener threw a value that could not be described"}}async function j(i,e,t,s={}){he(()=>{i.set(!0),e.set(null)});try{const n=await t();return i.set(!1),n}catch(n){const r=Zs(n);he(()=>{i.set(!1),e.set(r)}),Vt(r.code,r.message,Us(n)),r.code==="auth"&&s.sessionExpiry!==!1&&Xs();return}}function Zs(i){return i instanceof q?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:i.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const mt={sessionExpiry:!1};function en(i){return{me:()=>b({method:"GET",url:`${i}/auth/me`}),login:e=>b({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>b({method:"POST",url:`${i}/auth/logout`,body:{}})}}class M{constructor(){this.api=en(qe),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Qs(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Ms(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await j(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await j(this.loading,this.error,()=>this.api.login({username:e,password:t}),mt);return s?(this.currentUser.set(s),!0):!1}async logout(){await j(this.loading,this.error,()=>this.api.logout(),mt);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Yt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},tn={...Yt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},sn={...Yt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},nn=Ht(tn,Is),rn=Ht(sn,Ts),a=Ds(nn,rn),T=i=>`var(--${i})`,x=(i,e)=>`var(--${i}, ${e})`,$=i=>{const e=Ee[i];if(e===void 0)throw new Error(`unknown control token: --${i}`);return e},l=Os({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ye=i=>`
    ...
    cursor: not-allowed;`,on={primary:ye("primary"),secondary:ye("secondary"),ghost:ye("ghost"),danger:ye("danger"),disabled:Qt},S=(i=x("btn-radius",$("btn-radius")),e="secondary")=>`
    /*
    ...
    ${on[e]}
    &:disabled {${Qt}}
`,an=`max(${x("field-border-width",$("field-border-width"))}, ${x("field-rule-width",$("field-rule-width"))})`,_e=(i,e)=>`
    border-top-color: ${i};
...
`;function dn(i){return{async me(){return b({method:"GET",url:`${i}/players/me`})},async register(e){return b({method:"POST",url:`${i}/players/register`,body:e})},async updateHandicap(e){return b({method:"POST",url:`${i}/players/me/handicap`,body:e})},async myHandicapHistory(){return b({method:"GET",url:`${i}/players/me/handicap-history`})},async updateProfile(e){return b({method:"POST",url:`${i}/players/me/profile`,body:e})},async search(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/players/search${s?"?"+s:""}`})}}}function cn(i){return{async list(){return b({method:"GET",url:`${i}/friends`})},async add(e){return b({method:"POST",url:`${i}/friends`,body:e})},async remove(e){return b({method:"DELETE",url:`${i}/friends/${e.friendId}`})}}}function un(i){return{async list(){return b({method:"GET",url:`${i}/clubs`})},async get(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/clubs/get${s?"?"+s:""}`})},async create(e){return b({method:"POST",url:`${i}/clubs`,body:e})},async update(e){return b({method:"POST",url:`${i}/clubs/update`,body:e})},async remove(e){return b({method:"DELETE",url:`${i}/clubs/${e.id}`})}}}function hn(i){return{async list(){return b({method:"GET",url:`${i}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/courses/by-club${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/courses/get${s?"?"+s:""}`})},async create(e){return b({method:"POST",url:`${i}/courses`,body:e})},async update(e){return b({method:"POST",url:`${i}/courses/update`,body:e})},async updateHole(e){return b({method:"POST",url:`${i}/courses/holes/update`,body:e})},async validate(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/courses/validate${s?"?"+s:""}`})},async remove(e){return b({method:"DELETE",url:`${i}/courses/${e.id}`})}}}function pn(i){return{async listByCourse(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/tees/by-course${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/tees/get${s?"?"+s:""}`})},async create(e){return b({method:"POST",url:`${i}/tees`,body:e})},async update(e){return b({method:"POST",url:`${i}/tees/update`,body:e})},async remove(e){return b({method:"DELETE",url:`${i}/tees/${e.id}`})}}}function mn(i){return{async create(e){return b({method:"POST",url:`${i}/guest-players`,body:e})}}}function fn(i){return{async latest(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/handicap/latest${s?"?"+s:""}`})},async history(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/handicap/history${s?"?"+s:""}`})},async record(e){return b({method:"POST",url:`${i}/handicap/record`,body:e})}}}function gn(i){return{async list(){return b({method:"GET",url:`${i}/rounds`})},async balls(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/rounds/balls${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/rounds/get${s?"?"+s:""}`})},async create(e){return b({method:"POST",url:`${i}/rounds`,body:e})},async createFromDraft(e){return b({method:"POST",url:`${i}/rounds/from-draft`,body:e})},async update(e){return b({method:"POST",url:`${i}/rounds/update`,body:e})},async remove(e){return b({method:"DELETE",url:`${i}/rounds/${e.id}`})}}}function bn(i){return{async listByRound(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/score-events/by-round${s?"?"+s:""}`})},async append(e){return b({method:"POST",url:`${i}/score-events`,body:e})}}}function yn(i){return{async forBall(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/scorecards/for-ball${s?"?"+s:""}`})},async forRound(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/scorecards/for-round${s?"?"+s:""}`})}}}function _n(i){return{async forRound(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/leaderboards/for-round${s?"?"+s:""}`})}}}function vn(i){return{async create(e){return b({method:"POST",url:`${i}/friendly-rounds`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/friendly-rounds/by-token${s?"?"+s:""}`})},async balls(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/friendly-rounds/balls${s?"?"+s:""}`})},async scorecard(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/friendly-rounds/scorecard${s?"?"+s:""}`})},async result(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/friendly-rounds/result${s?"?"+s:""}`})},async score(e){return b({method:"POST",url:`${i}/friendly-rounds/score`,body:e})},async setup(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/friendly-rounds/setup${s?"?"+s:""}`})},async editSetup(e){return b({method:"POST",url:`${i}/friendly-rounds/setup`,body:e})},async remove(e){return b({method:"DELETE",url:`${i}/friendly-rounds/${e.token}`})},async finish(e){return b({method:"POST",url:`${i}/friendly-rounds/finish`,body:e})},async reopen(e){return b({method:"POST",url:`${i}/friendly-rounds/reopen`,body:e})},async join(e){return b({method:"POST",url:`${i}/friendly-rounds/join`,body:e})},async leave(e){return b({method:"POST",url:`${i}/friendly-rounds/leave`,body:e})},async claimGuest(e){return b({method:"POST",url:`${i}/friendly-rounds/claim-guest`,body:e})},async claimSeat(e){return b({method:"POST",url:`${i}/friendly-rounds/claim-seat`,body:e})},async releaseSeat(e){return b({method:"POST",url:`${i}/friendly-rounds/release-seat`,body:e})}}}function wn(i){return{async myRounds(){return b({method:"GET",url:`${i}/dashboard/my-rounds`})}}}function xn(i){return{async clubs(){return b({method:"GET",url:`${i}/setup/clubs`})},async courses(){return b({method:"GET",url:`${i}/setup/courses`})},async teesByCourse(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/setup/tees/by-course${s?"?"+s:""}`})},async formats(){return b({method:"GET",url:`${i}/setup/formats`})},async aggregations(){return b({method:"GET",url:`${i}/setup/aggregations`})}}}function $n(i){return{async get(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/competitions/get${s?"?"+s:""}`})},async participants(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/competitions/participants${s?"?"+s:""}`})},async leaderboard(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&s.set(r,String(o));const n=s.toString();return b({method:"GET",url:`${i}/competitions/${e.id}/leaderboard${n?"?"+n:""}`})},async results(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&s.set(r,String(o));const n=s.toString();return b({method:"GET",url:`${i}/competitions/${e.id}/results${n?"?"+n:""}`})},async list(){return b({method:"GET",url:`${i}/competitions`})},async create(e){return b({method:"POST",url:`${i}/competitions`,body:e})},async update(e){return b({method:"POST",url:`${i}/competitions/update`,body:e})},async transition(e){return b({method:"POST",url:`${i}/competitions/transition`,body:e})},async createRound(e){const t=new Set(["id"]),s={};for(const[n,r]of Object.entries(e))t.has(n)||(s[n]=r);return b({method:"POST",url:`${i}/competitions/${e.id}/rounds`,body:s})},async applyCut(e){const t=new Set(["id"]),s={};for(const[n,r]of Object.entries(e))t.has(n)||(s[n]=r);return b({method:"POST",url:`${i}/competitions/${e.id}/cut`,body:s})},async finalize(e){const t=new Set(["id"]),s={};for(const[n,r]of Object.entries(e))t.has(n)||(s[n]=r);return b({method:"POST",url:`${i}/competitions/${e.id}/finalize`,body:s})},async addParticipant(e){return b({method:"POST",url:`${i}/competitions/participants/add`,body:e})},async removeParticipant(e){return b({method:"POST",url:`${i}/competitions/participants/remove`,body:e})},async withdrawParticipant(e){return b({method:"POST",url:`${i}/competitions/participants/withdraw`,body:e})}}}function kn(i){return{async myRoles(){return b({method:"GET",url:`${i}/me/roles`})},async adminStats(){return b({method:"GET",url:`${i}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[n,r]of Object.entries(e))r!==void 0&&t.set(n,String(r));const s=t.toString();return b({method:"GET",url:`${i}/admin/rounds${s?"?"+s:""}`})},async adminPlayers(){return b({method:"GET",url:`${i}/admin/players`})},async adminGrantRole(e){return b({method:"POST",url:`${i}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return b({method:"POST",url:`${i}/admin/roles/revoke`,body:e})}}}const A="/tapscore/".replace(/\/+$/,"")+"/api",v={players:dn(A),friends:cn(A),clubs:un(A),courses:hn(A),tees:pn(A),guestPlayers:mn(A),handicap:fn(A),rounds:gn(A),scoreEvents:bn(A),scorecards:yn(A),leaderboards:_n(A),friendlyRounds:vn(A),dashboard:wn(A),setup:xn(A),competitions:$n(A),admin:kn(A)};function Sn(i){return[...i.played?["Played"]:[],...i.created?["Created"]:[]].join(" · ")}function Cn(i,e){const t=new Map;for(const s of e)t.set(s.round.id,{round:s.round,token:s.friendlyRound.shareToken,played:!1,created:!0});for(const s of i){const n=t.get(s.round.id);n?n.played=!0:t.set(s.round.id,{round:s.round,token:s.shareToken,played:!0,created:!1})}return[...t.values()].sort((s,n)=>n.round.date.localeCompare(s.round.date)||s.round.id.localeCompare(n.round.id))}function In(i,e){return i.filter(t=>t.played&&!t.created&&!e.has(t.round.id)).slice().sort((t,s)=>s.round.date.localeCompare(t.round.date)||t.round.id.localeCompare(s.round.id))}function ft(i,e){return i.some(t=>t.round.id===e)?i.filter(t=>t.round.id!==e):i}function B(){try{return globalThis.localStorage??null}catch{return null}}function Ne(i,e,t){return{read(s=B()){if(!s)return e.empty;let n;try{n=s.getItem(i)}catch{return e.empty}if(!n)return e.empty;try{return e.decode(n)}catch{return e.empty}},write(s,n=B()){if(!n)return e.empty;const r=t!==void 0&&Array.isArray(s)?s.slice(0,t):s;try{n.setItem(i,e.encode(r))}catch{}return r}}}function Xe(i){return{decode(e){const t=JSON.parse(e);return Array.isArray(t)?t.filter(i):[]},encode:e=>JSON.stringify(e),get empty(){return[]}}}const Tn=500,Je=Ne("tapscore.seen-rounds.v1",Xe(i=>typeof i=="string"),Tn);function Ze(i=B()){return Je.read(i)}function Re(i=B()){return new Set(Ze(i))}function En(i,e=B()){if(!e)return[];const t=Ze(e).filter(s=>s!==i);return Je.write([i,...t],e)}function Xt(i,e=B()){if(!e)return[];const t=Ze(e),s=t.filter(n=>n!==i);return s.length!==t.length&&Je.write(s,e),s}const Nn=50,et=Ne("tapscore.device-rounds.v1",Xe(Pn),Nn);function tt(i=B()){return et.read(i)}function Pn(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.courseName=="string"&&(e.status==="not_started"||e.status==="active"||e.status==="complete")&&typeof e.lastSeenAt=="string"}function ae(i,e=B()){if(!e)return[];const t=tt(e).filter(s=>s.token!==i.token);return et.write([i,...t],e)}function Jt(i,e=B()){if(!e)return[];const t=tt(e),s=t.filter(n=>n.token!==i);return s.length!==t.length&&et.write(s,e),s}class Pe{mine=new p(null);mineLoading=new p(!1);mineError=new p(null);myRounds=new k(()=>{const e=this.mine.get();return e?Cn(e.produced,e.created):[]});deviceRounds=new p([]);seenIds=new p(Re());newRounds=new k(()=>In(this.myRounds.get(),this.seenIds.get()));async loadMine(){this.seenIds.set(Re());const e=await j(this.mineLoading,this.mineError,()=>v.dashboard.myRounds());e&&this.mine.set(e)}loadDevice(){this.deviceRounds.set(tt())}clear(){this.mine.set(null),this.mineError.set(null),this.mineLoading.set(!1),this.seenIds.set(Re()),this.loadDevice()}async remove(e,t){try{await v.friendlyRounds.remove({token:e})}catch{return!1}const s=this.mine.get();return s&&this.mine.set({produced:ft(s.produced,t),created:ft(s.created,t)}),this.deviceRounds.set(Jt(e)),Xt(t),!0}}const zn={DEV:!1};function On(i,e){return i===void 0||i===""?e:i!=="0"&&i.toLowerCase()!=="false"}const gt=zn??{},Zt={competitions:On(gt.VITE_FEATURE_COMPETITIONS,!!gt.DEV)},jn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5 12 4l8 7.5"/><path d="M6 10v10h12V10"/><path d="M10 20v-5.5h4V20"/></svg>',Rn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M3.5 20c.5-3.5 2.7-5.5 5.5-5.5s5 2 5.5 5.5"/><circle cx="16.5" cy="9.5" r="2.8"/><path d="M16.8 14.6c2.2.4 3.5 2 3.9 4.9"/></svg>',Dn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4h8v3a4 4 0 0 1-8 0V4Z"/><path d="M8 5H5v2a3 3 0 0 0 3 3"/><path d="M16 5h3v2a3 3 0 0 1-3 3"/><path d="M10 12.5V15h4v-2.5"/><path d="M9 20h6"/><path d="M12 15v5"/></svg>';function Ln(i){const e=[{key:"home",label:"Home",href:"/",icon:jn},{key:"friends",label:"Friends",href:"/friends",icon:Rn}];return i.competitions&&e.push({key:"comps",label:"Comps",href:"/competitions",icon:Dn}),e}const An=["/login","/round"];function es(i){return!An.includes(i)}function Mn(i,e){return e&&es(i)}const Hn=y(`
...
`);class Bn extends P{static styles=`
        .tabbar {
            display: flex;
    ...
    `;router=this.inject(D);auth=this.inject(M);landing=this.inject(Pe);newCount=new k(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Hn,{root:{className:()=>Mn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"}}),t=Ln(Zt);return this.$each(this.ref(e,"root"),()=>t,(s,n,r)=>this.wireEl(Fn,{link:{...this.router.link(s.href),href:s.href},icon:{innerHTML:()=>s.icon},label:()=>s.label,badge:{textContent:()=>{if(s.key!=="home")return"";const o=this.newCount.get();return o===0?"":String(o)},className:()=>(s.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},r),s=>s.key),e}}class ze{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await j(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list()]));if(!t)return;const[s,n,r]=t;this.player.set(s),this.history.set(n),this.clubs.set(r)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null)}async saveIndex(e){return await j(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveGender(e){const t=await j(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await j(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function De(i,e){return i.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function st(i,e="frecency"){return e==="alpha"?[...i].sort(De):[...i].sort((t,s)=>{const n=t.frecency,r=s.frecency,o=n>0,d=r>0;if(o!==d)return o?-1:1;if(!o)return De(t,s);if(r!==n)return r-n;const u=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,h=s.lastPlayedAt?Date.parse(s.lastPlayedAt):NaN,f=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u,m=Number.isNaN(h)?Number.NEGATIVE_INFINITY:h;return m!==f?m-f:De(t,s)})}const Gn=1440*60*1e3;function qn(i,e){if(!i)return null;const t=Date.parse(i),s=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(s))return null;const n=Math.floor((s-t)/Gn);if(n<=0)return"today";if(n===1)return"yesterday";if(n<7)return`${n} days ago`;if(n<14)return"last week";if(n<30)return`${Math.floor(n/7)} weeks ago`;if(n<60)return"last month";if(n<365)return`${Math.floor(n/30)} months ago`;const r=Math.floor(n/365);return r===1?"last year":`${r} years ago`}function Kn(i,e){if(i.sharedRoundCount<=0)return"never played";const t=qn(i.lastPlayedAt,e),s=`played ${i.sharedRoundCount}×`;return t?`${s}, ${t}`:s}const ts=2;function bt(i){return i.trim().length>=ts}function ss(i){return st(i,"frecency")}function Vn(i,e){return ss([...i.filter(t=>t.id!==e.id),e])}function Un(i,e){return i.filter(t=>t.id!==e)}function yt(i,e,t){return i.map(s=>s.id===e?{...s,isFriend:t}:s)}function Wn(i,e,t=()=>{},s=300){let n=0,r;return o=>{const d=o.trim(),u=++n;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<ts){e(d,[]);return}r=setTimeout(()=>{i(d).then(h=>{u===n&&e(d,h)},h=>{u===n&&t(d,h)})},s)}}const ns=Ne("tapscore.friends.sort.v1",{decode:i=>i==="alpha"?"alpha":"frecency",encode:i=>i,empty:"frecency"});function Yn(i=B()){return ns.read(i)}function Qn(i,e=B()){ns.write(i,e)}class Oe{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(Yn());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Wn(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await j(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(ss(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await j(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(Vn(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,sharedRoundCount:0,lastPlayedAt:null,frecency:0})),this.results.set(yt(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),Qn(e)}async remove(e){await j(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(Un(this.friends.get(),e)),this.results.set(yt(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class is{roles=new p([]);rolesLoaded=!1;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}async loadRoles(e=!1){if(!(!e&&this.rolesLoaded)){this.rolesLoaded=!0;try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}}}clear(){this.roles.set([]),this.rolesLoaded=!1,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await j(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[s,n,r]=t;this.stats.set(s),this.rounds.set(n),this.players.set(r)}}async function Xn(i){await i.auth.logout(),i.profile.clear(),i.friends.clear(),i.admins.clear(),i.landing.clear(),i.navigate("/")}function Jn(i){if(!i.signedIn)return[];const e=[{kind:"identity",displayName:(i.displayName??"").trim()||(i.username??"").trim()||"Signed in",username:(i.username??"").trim()},{kind:"profile",label:"Profile"}];return i.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e}function Zn(i){return Jn(i).map(e=>e.kind)}function _t(i){return i.signedIn?"avatar":"signin"}function ei(i,e){const t=(i??"").trim().split(/\s+/).filter(n=>n.length>0);if(t.length>=2)return(ve(t[0])+ve(t[t.length-1])).toUpperCase();if(t.length===1)return ve(t[0]).toUpperCase();const s=(e??"").trim();return s.length>0?ve(s).toUpperCase():"•"}function ve(i){return[...i][0]??""}const ti=y(`
...
`);class si extends P{static styles=`
        .acct {
            position: relative;
            display: flex;
    ...
    `;auth=this.inject(M);profile=this.inject(ze);friends=this.inject(Oe);admins=this.inject(is);landing=this.inject(Pe);router=this.inject(D);open=new p(!1);state=new k(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));has(e){return Zn(this.state.get()).includes(e)}rowClass(e,t=""){const s=`acct__row${t}`;return this.has(e)?s:`${s} hidden`}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(ti,{signin:{className:()=>_t(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},avatar:{className:()=>_t(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden",textContent:()=>{const h=this.state.get();return ei(h.displayName,h.username)},"aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const h=this.state.get();return(h.displayName??"").trim()||(h.username??"").trim()||"Signed in"},idUser:()=>{const h=(this.state.get().username??"").trim();return h===""?"":`@${h}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:async()=>{this.open.set(!1),await Xn({auth:this.auth,profile:this.profile,friends:this.friends,admins:this.admins,landing:this.landing,navigate:h=>this.router.navigate(h)})}}}),t=this.ref(e,"root"),s=e.querySelector('[bind="avatar"]'),n=h=>{h.key==="Escape"&&this.open.get()&&(this.open.set(!1),s?.focus())},r=h=>{if(!this.open.get())return;const f=h.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let o=!1;const d=()=>{o||(o=!0,window.addEventListener("keydown",n),document.addEventListener("pointerdown",r,!0))},u=()=>{o&&(o=!1,window.removeEventListener("keydown",n),document.removeEventListener("pointerdown",r,!0))};return this.track(N(()=>{this.open.get()?d():u()})),this.track(u),e}}const at=class at extends P{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(N(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};at.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let Ue=at;const I=i=>`var(--${i})`,lt=class lt extends P{render(){const e=document.createElement("div"),t=(u,h)=>{typeof h=="function"?this.track(N(()=>{u.textContent=h()})):u.textContent=h};this.spawn(Ue,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200";const s=document.createElement("h2");s.className="ui-confirm__title",t(s,this.props.title??"Confirm"),this.dialogEl.appendChild(s);const n=document.createElement("p");n.className="ui-confirm__message",t(n,this.props.message),this.dialogEl.appendChild(n);const r=document.createElement("div");r.className="ui-confirm__actions";const o=document.createElement("button");o.className="ui-confirm__btn ui-confirm__btn--cancel",t(o,this.props.cancelLabel??"Cancel"),o.addEventListener("click",u=>{u.stopPropagation(),this.handleCancel()}),r.appendChild(o);const d=document.createElement("button");return d.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(d,this.props.confirmLabel??"Confirm"),d.addEventListener("click",u=>{u.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),r.appendChild(d),this.dialogEl.appendChild(r),this.dialogEl.addEventListener("click",u=>u.stopPropagation()),e.appendChild(this.dialogEl),this.track(N(()=>{this.dialogEl.classList.toggle("open",this.props.open.get())})),e}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}};lt.styles=`
        .ui-confirm {
            position: fixed;
            top: 50%;
            left: 50%;
    ...
    `;let U=lt;function ni(i){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function ne(){return ni()}const Ce=10;class pe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await j(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=ne()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=ne()){return e.labels?.[t]??e.labels?.en??""}presets(e=ne()){return this.descriptors.get().filter(s=>s.preset).sort((s,n)=>{const r=s.preset?.rank??Number.POSITIVE_INFINITY,o=n.preset?.rank??Number.POSITIVE_INFINITY;return r!==o?r-o:(this.labelOf(s,e)??s.id).localeCompare(this.labelOf(n,e)??n.id)})}taglineOf(e,t=ne()){const n=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return n?.[t]??n?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{},n=s.teamCount??{};return{count:{min:n.min??2,...n.max!==void 0?{max:n.max}:{}},size:{min:s.teamSize?.min??2,max:s.teamSize?.max??2}}}if(t.slotBallCount){const s=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:s?Ce:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function rs(i){const e=H.get(pe);return e.load(),e.labelOf(i.formatId)??`${i.scoringMode} · ${i.teamShape}`}function ii(i){return i.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:Sn(e)||null,date:e.round.date,formats:e.round.formatSlots.map(rs).join(" · ")}))}function ri(i){return i.map(e=>({key:e.token,token:e.token,roundId:null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:null,formats:null}))}const ce={fromMyRounds:ii,fromDeviceRounds:ri},oi=14,ai=1440*60*1e3;function re(i,e){return e(i)}function li(i,e,t,s=oi){const n=e-s*ai,r=[],o=[];for(const d of i){const u=re(d,t);if(u.status==="complete"){const h=u.completedAt?Date.parse(u.completedAt):NaN;(Number.isNaN(h)||h>=n)&&o.push(d)}else r.push(d)}return r.sort((d,u)=>vt(re(d,t).lastActivityAt,re(u,t).lastActivityAt)),o.sort((d,u)=>vt(re(d,t).completedAt,re(u,t).completedAt)),{ongoing:r,finished:o}}function vt(i,e){const t=i?Date.parse(i):NaN,s=e?Date.parse(e):NaN,n=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return n===r?0:r-n}const di=y(`
    <div class="landing">
...
`),ci='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',ui=y(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${ci}</button>
    </div>
`),os={not_started:"Not started",active:"Live",complete:"Finished"};class wt extends P{static styles=`
        .landing {
...
`),mi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',fi=y(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
...
`);class gi extends P{static styles=`
        .history {
    ...
    `;svc=this.inject(Pe);auth=this.inject(M);router=this.inject(D);loggedIn=new k(()=>this.auth.currentUser.get()!==null);rows=new k(()=>hi(this.loggedIn.get()?ce.fromMyRounds(this.svc.myRounds.get()):ce.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(pi,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(s,n,r)=>this.roundRow(s,r),s=>s.key),this.spawn(U,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const s=this.deleteTarget.get();return`Delete ${s?`“${s.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const s=this.deleteTarget.get();s&&this.svc.remove(s.token,s.roundId)}});const t=s=>{s.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(fi,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},course:()=>e.courseName||"Round",role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>os[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>e.date??"",formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",e.courseName||"this round")}}},t)}}function as(i){return i.handicapIndex*(i.slope/113)+(i.courseRating-i.par)}function bi(i){return Math.round(as(i))}function yi(i,e,t){const s=t;if(s<=0)return 0;if(i>=0){const u=Math.floor(i/s),h=i-u*s;return u+(e>=1&&e<=h?1:0)}const n=-i,r=Math.floor(n/s),o=n-r*s,d=r+(e>s-o?1:0);return d===0?0:-d}const _i=180,$t=4,vi=12;function ie(i,e){return e<=0?0:Math.max(0,Math.min(e-1,i))}function wi(i){const{dragDistance:e,velocity:t,itemWidth:s}=i;if(Math.abs(e)<vi)return 0;const n=e+t*_i,r=Math.round(-n/s);return Math.max(-$t,Math.min($t,r))}const kt="tapscore:pending-scores:v1",xi=336*60*60*1e3,St=200;function $i(){try{return globalThis.localStorage??null}catch{return null}}function ki(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Si{entries=[];storage;constructor(e=$i(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=xi);return t.length>St?t.slice(t.length-St):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(kt);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(ki):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(kt,JSON.stringify(this.entries))}catch{}}}const Ci=50;function Ii(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.cursor=="string"}const nt=Ne("tapscore.result-cursors.v1",Xe(Ii),Ci);function it(i=B()){return nt.read(i)}function Ti(i,e=B()){return it(e).find(t=>t.token===i)?.cursor??null}function Ei(i,e,t=B()){if(!t)return[];const s=it(t).filter(n=>n.token!==i);return nt.write([{token:i,cursor:e},...s],t)}function Ni(i,e=B()){if(!e)return[];const t=it(e),s=t.filter(n=>n.token!==i);return s.length!==t.length&&nt.write(s,e),s}const Pi=["1st","2nd","3rd","4th","5th","6th","7th","8th"],X=(i,e)=>`${i}|${e}`;function ls(i){return i.players.map(e=>e.displayName).join(" & ")||i.label||"Ball"}function zi(i,e,t){return i?!(i.minPar!==void 0&&e<i.minPar||i.maxPar!==void 0&&e>i.maxPar||i.pars&&!i.pars.includes(e)||i.holes&&!i.holes.includes(t)):!0}class te{constructor(e=new Si){this.queue=e}queue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);scorecards=new p([]);cells=new p(new Map);result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const n=++this.loadSeq;s&&this.resetForNewToken(t),H.get(pe).load();const r=await j(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||n!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),ae({token:e,courseName:r.round.courseNameSnapshot??"",status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),H.get(M).currentUser.get()&&En(r.round.id),this.pendingSlotIndex!==null){const h=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,h!==null&&this.selectedSlot.set(h)}const[o,d]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[])]);n!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(o),await this.flushPending())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),Jt(e);const t=this.round.get()?.id;return t&&Xt(t),Ni(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:t.completedAt}),ae({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:null}),ae({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await j(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}persistedCursor(e=this.token){return e?Ti(e):null}setResultCursor(e,t){const s=t!==null&&t!==this.resultCursor;this.resultCursor=t,s&&Ei(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}onLiveResultEvent(e){const t=this.token,s=this.round.get();if(t&&s&&e.status!==s.status){const n=e.status==="complete"?new Date().toISOString():null;this.round.set({...s,status:e.status,completedAt:n}),ae({token:t,courseName:s.courseNameSnapshot??"",status:e.status,completedAt:n,lastSeenAt:new Date().toISOString()})}this.pollResult()}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,ls(t));for(const t of this.result.get()?.slots??[])for(const s of t.subjectLabels??[])e.set(s.ballId,s.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new k(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,n)=>{for(const r of s.ballIds)e.set(r,`Group ${n+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return ie(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(o=>o.id===e);if(!t||!s)return"";const n=t.playHoles.filter(o=>o.courseHoleNumber===s.courseHoleNumber).sort((o,d)=>o.ordinal-d.ordinal);if(n.length===1)return`${s.courseHoleNumber}`;const r=n.findIndex(o=>o.id===e);return`${s.courseHoleNumber} (${Pi[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(ie(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(ie(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(X(e,t));return s?s.strokes:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(X(e,t))?.status??null}strokesHintFor(e,t){const s=this.round.get();if(!s)return null;const n=this.balls.get().find(m=>m.id===e);if(!n||n.pending)return null;const r=this.selectedSlotDefId(),d=(n.slots.find(m=>m.slotDefId===r)??n.slots[0])?.playingHandicap;if(d==null)return null;const u=this.playHoleById(t);if(!u)return null;const h=n.players[0]?.teeName??null,f=u.tees.find(m=>m.teeName===h)?.strokeIndex??u.baseStrokeIndex;return yi(d,f,s.routeSi.allocationCycleSize)}metadataFor(e,t,s){const n=this.cells.get().get(X(e,t));return n&&n.metadata!==void 0?n.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=H.get(pe),t=this.round.get()?.formatSlots??[],s=[],n=new Set;for(const r of t){const o=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of o)n.has(d.key)||(n.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>zi(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,n){const r=X(e,t),o=crypto.randomUUID();this.patchCell(r,{strokes:s,metadata:n,status:"saving",clientEventId:o});const d=this.token;d&&(this.enqueue(d,e,t,s,n,o),await this.post(d,e,t,s,n,o))}async retry(e,t){const s=X(e,t),n=this.cells.get().get(s);if(!n)return;this.patchCell(s,{...n,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,n.strokes,n.metadata,n.clientEventId),await this.post(r,e,t,n.strokes,n.metadata,n.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(X(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,n,r,o){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:o,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,s,n,r,o){const d=X(t,s);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:o,...r!=null?{metadata:r}:{}}),this.queue.remove(o);const u=this.cells.get().get(d);u&&u.clientEventId===o&&this.patchCell(d,{...u,status:"saved"});const h=this.round.get();e===this.token&&h&&h.status==="not_started"&&this.round.set({...h,status:"active"})}catch{const u=this.cells.get().get(d);u&&u.clientEventId===o&&this.patchCell(d,{...u,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1);const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const Oi=700;function ji(i){if(!i.currentHole)return!1;const e=i.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function Ri(i){return i.currentHole?i.balls.some((e,t)=>t!==i.currentBallIndex&&!e.scored):!1}function Le(i){const e=i.currentHole;if(!e)return{kind:"noop"};const t=i.balls,s=i.currentBallIndex;for(let n=s+1;n<t.length;n++)if(!t[n].scored)return{kind:"moveToBall",ballIndex:n};for(let n=0;n<s;n++)if(!t[n].scored)return{kind:"moveToBall",ballIndex:n};return i.holeIndex>=i.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:i.holeIndex+1,delayMs:Oi}}function Di(i,e){const t=i.currentHole;if(e.kind==="statsDone")return i.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Le(i)};const s=i.balls[i.currentBallIndex];if(!t||!s)return{write:null,move:{kind:"noop"}};if(s.pending)return i.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Le(i)};const n={ballIndex:i.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&i.collectsStats?{write:n,move:{kind:"openStats"}}:i.holeCompleteOnEntry?{write:n,move:{kind:"stay"}}:{write:n,move:Le(i)}}const J=60,Ct=8,We=4,Li=Array.from({length:We*2+1},(i,e)=>e-We),Ai="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Mi=y(`
...
`);class Gi extends P{static styles=`
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Ct}px; flex-shrink: 0; }
    ...
    `;svc=this.inject(te);holeIdx=this.svc.holeIdx;modalOpen=this.svc.keypadOpen;currentBallIdx=new p(0);holeCompleteOnEntry=!1;extendedOpen=new p(!1);extendedScore=new p(10);statsOpen=new p(!1);pendingMeta=new p({});lastMetaKey=null;toastMsg=new p(null);dragOffset=new p(0);transitioning=new p(!1);ptr=null;pendingSteps=null;settleTimer=null;advanceTimer=null;flashTimer=null;hasScoring=new k(()=>this.svc.balls.get().length>0);group=()=>this.svc.group();playedOrder=()=>this.svc.playedOrder();holeIndex=()=>this.svc.holeIndex();currentHole=()=>this.svc.currentPlayedHole();occAtOffset=e=>{const t=this.playedOrder();return t[ie(this.holeIndex()+e,t.length)]??null};ballsInGroup=()=>{const e=this.group();if(!e)return[];const t=new Map(this.svc.balls.get().map(s=>[s.id,s]));return e.ballIds.map(s=>t.get(s)).filter(s=>!!s)};parFor=e=>this.svc.parFor(e);occLabel=e=>this.svc.occLabel(e);ballName=e=>ls(e);metaInputs=()=>this.svc.metadataInputsForHole(this.svc.currentPlayHole()).filter(e=>e.kind==="boolean");displayScore=e=>e===null?"–":String(e);hintText=(e,t)=>{const s=this.svc.strokesHintFor(e,t);return s===null?null:s===0?"0":s>0?`-${s}`:`+${-s}`};toParValue=e=>{let t=0,s=0,n=!1;for(const r of this.playedOrder()){const o=this.svc.strokesFor(e.id,r.playHoleId);o!==null&&o>0&&(t+=o,s+=this.parFor(r.playHoleId),n=!0)}return n?t-s:null};toParText=e=>{const t=this.toParValue(e);return t===null?"–":t===0?"E":t>0?`+${t}`:`${t}`};toParClass=e=>{const t=this.toParValue(e);return`se-row__topar ${t===null||t===0?"even":t<0?"under":"over"}`};scoreLabel=(e,t)=>{if(e===1)return"HIO";const s=e-t;return s<=-4||s>=5?"OTHER":{"-3":"ALBA","-2":"EAGLE","-1":"BIRDIE",0:"PAR",1:"BOGEY",2:"DOUBLE",3:"TRIPLE",4:"QUAD"}[String(s)]??""};render(){this.track(()=>{this.advanceTimer&&clearTimeout(this.advanceTimer),this.flashTimer&&clearTimeout(this.flashTimer),this.settleTimer&&clearTimeout(this.settleTimer),this.modalOpen.set(!1)}),this.track(N(()=>{const r=this.ballsInGroup().length;r>0&&this.currentBallIdx.get()>=r&&this.currentBallIdx.set(0)}));const e=this.wire(Mi,{root:{className:()=>this.hasScoring.get()?"se":"se hidden"},close:{onclick:()=>{this.statsOpen.set(!1),this.modalOpen.set(!1)}},modal:{className:()=>this.modalOpen.get()?"se-modal":"se-modal hidden"},modalTitle:()=>{const r=this.currentHole();return r?`Hole ${this.occLabel(r.playHoleId)} · Par ${this.parFor(r.playHoleId)}`:""},modalPrev:{onclick:()=>this.stepHole(-1),disabled:()=>!this.svc.canPrevHole()},modalNext:{onclick:()=>this.stepHole(1),disabled:()=>!this.svc.canNextHole()},extended:{className:()=>this.extendedOpen.get()?"se-pad__ext":"se-pad__ext hidden"},extVal:()=>String(this.extendedScore.get()),extMinus:{onclick:()=>this.extendedScore.set(Math.max(10,this.extendedScore.get()-1))},extPlus:{onclick:()=>this.extendedScore.set(this.extendedScore.get()+1)},extCancel:{onclick:()=>this.extendedOpen.set(!1)},extOk:{onclick:()=>{this.extendedOpen.set(!1),this.commit(this.extendedScore.get())}},toast:{className:()=>this.toastMsg.get()?"se-toast":"se-toast hidden",textContent:()=>this.toastMsg.get()??""},stats:{className:()=>this.statsOpen.get()?"se-stats":"se-stats hidden"},statsBack:{onclick:()=>this.statsOpen.set(!1)},statsHole:()=>{const r=this.currentHole();return r?`Hole ${this.occLabel(r.playHoleId)} · Par ${this.parFor(r.playHoleId)}`:""},statsTitle:()=>{const r=this.ballsInGroup()[this.currentBallIdx.get()];return r?this.ballName(r):""},statsScore:()=>{const r=this.ballsInGroup()[this.currentBallIdx.get()],o=this.currentHole();return!r||!o?"":this.displayScore(this.svc.strokesFor(r.id,o.playHoleId))},statsNext:{textContent:()=>this.hasMoreUnscored()?"Next ›":"Done ›",onclick:()=>{this.statsOpen.set(!1),this.apply({kind:"statsDone"})}}}),t=this.ref(e,"viewport"),s=this.ref(e,"track");this.bindCarouselPointer(t,s),this.track(N(()=>{s.style.transition=this.transitioning.get()?Ai:"none",s.style.transform=`translateX(${this.dragOffset.get()}px)`})),this.$each(s,new k(()=>Li),(r,o,d)=>this.holeItem(r,d),r=>r),this.$each(this.ref(e,"rows"),new k(()=>{const r=this.playedOrder(),o=this.holeIndex(),d=r[o];if(!d)return[];const u=o>0?r[o-1].playHoleId:null;return this.ballsInGroup().map(h=>({ball:h,ph:d.playHoleId,prevPh:u}))}),(r,o,d)=>this.playerRow(r.ball,r.ph,r.prevPh,d),r=>`${r.ball.id}|${r.ph}`),this.$each(this.ref(e,"modalList"),new k(()=>this.ballsInGroup()),(r,o,d)=>this.modalRow(r,o,d),r=>r.id);const n=this.ref(e,"keys");for(const r of[1,2,3,4,5,6,7,8,9])n.appendChild(this.numberKey(r));return n.appendChild(this.specialKey("10+","","se-key",()=>this.openExtended())),n.appendChild(this.specialKey("✕","clear","se-key clear",()=>this.commit(null))),n.appendChild(this.specialKey("0","pick up","se-key muted",()=>this.commit(0))),this.$each(this.ref(e,"statsBody"),new k(()=>this.metaInputs()),(r,o,d)=>this.metaChip(r,d),r=>r.key),this.track(N(()=>{if(!this.modalOpen.get()){this.lastMetaKey=null;return}const r=this.ballsInGroup()[this.currentBallIdx.get()],o=this.currentHole();if(!r||!o)return;const d=`${r.id}|${o.playHoleId}`;if(d===this.lastMetaKey)return;this.lastMetaKey=d;const u={};for(const h of this.metaInputs())u[h.key]=this.svc.metadataFor(r.id,o.playHoleId,h.key)===!0;this.pendingMeta.set(u)})),e}holeItem(e,t){return this.wireEl(Hi,{item:{className:()=>{const s=e===-1&&this.holeIndex()<=0;return`se-hole${e===0?" active":""}${s?" gone":""}`}},hnum:{textContent:()=>{const s=this.occAtOffset(e);return s?this.occLabel(s.playHoleId):""}},hpar:{textContent:()=>{const s=this.occAtOffset(e);return s?`Par ${this.parFor(s.playHoleId)}`:""}}},t)}playerRow(e,t,s,n){return e.pending?this.wireEl(It,{name:{textContent:this.ballName(e),className:"se-row__name se-row__name--pending"},topar:{textContent:"open seat",className:"se-row__topar"},prev:{textContent:""},cval:{textContent:"–"},circle:{className:"se-row__circle empty se-row__circle--pending"}},n):this.wireEl(It,{name:{textContent:this.ballName(e)},topar:{textContent:()=>this.toParText(e),className:()=>this.toParClass(e)},prev:{textContent:()=>s?this.displayScore(this.svc.strokesFor(e.id,s)):""},cval:{textContent:()=>{const r=this.svc.strokesFor(e.id,t);return r!==null?this.displayScore(r):this.hintText(e.id,t)??"–"}},circle:{className:()=>this.svc.strokesFor(e.id,t)!==null?"se-row__circle":this.hintText(e.id,t)!==null?"se-row__circle empty hint":"se-row__circle empty",onclick:()=>this.openModalForBall(e.id)}},n)}modalRow(e,t,s){const n=e.pending?"Open seat — claim to score":e.players.length>1?`Team · CH ${e.courseHandicap}`:`CH ${e.players[0]?.courseHandicap??e.courseHandicap}`;return this.wireEl(Fi,{mrow:{className:()=>this.currentBallIdx.get()===t?"se-mrow sel":"se-mrow",onclick:()=>this.currentBallIdx.set(t)},mname:{textContent:this.ballName(e)},mhcp:{textContent:n},mval:{textContent:()=>{const r=this.currentHole();if(!r)return"–";const o=this.svc.strokesFor(e.id,r.playHoleId);return o!==null?this.displayScore(o):this.hintText(e.id,r.playHoleId)??"–"},className:()=>{const r=this.currentHole();return!!r&&this.svc.strokesFor(e.id,r.playHoleId)===null&&!!r&&this.hintText(e.id,r.playHoleId)!==null?"se-mrow__val se-mrow__val--hint":"se-mrow__val"}}},s)}numberKey(e){return this.wireEl(Tt,{key:{className:()=>{const t=this.currentHole();return(t?e===this.parFor(t.playHoleId):!1)?"se-key par":"se-key"},onclick:()=>this.commit(e)},num:{textContent:String(e)},lbl:{textContent:()=>{const t=this.currentHole();return t?this.scoreLabel(e,this.parFor(t.playHoleId)):""}}})}specialKey(e,t,s,n){return this.wireEl(Tt,{key:{className:s,onclick:n},num:{textContent:e},lbl:{textContent:t}})}openModalForBall(e){const t=this.ballsInGroup().findIndex(s=>s.id===e);this.currentBallIdx.set(t<0?0:t),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.noteHoleEntered(),this.modalOpen.set(!0)}advanceState(){const e=this.currentHole();return{balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId,label:this.occLabel(e.playHoleId)}:null,holeIndex:this.holeIndex(),holeCount:this.playedOrder().length,holeCompleteOnEntry:this.holeCompleteOnEntry,collectsStats:this.metaInputs().length>0}}noteHoleEntered(){this.holeCompleteOnEntry=ji(this.advanceState())}stepHole(e){this.advanceTimer&&(clearTimeout(this.advanceTimer),this.advanceTimer=null),this.extendedOpen.set(!1),this.statsOpen.set(!1),e<0?this.svc.prevHole():this.svc.nextHole(),this.currentBallIdx.set(0),this.noteHoleEntered()}openExtended(){this.extendedScore.set(10),this.extendedOpen.set(!0)}commit(e){this.apply({kind:"score",value:e})}apply(e){this.execute(Di(this.advanceState(),e))}execute(e){const t=e.write;if(t){const n=this.ballsInGroup()[t.ballIndex];n&&this.svc.setScore(n.id,t.holeId,t.value,t.withMetadata?this.metaSnapshot():void 0)}const s=e.move;switch(s.kind){case"noop":case"stay":return;case"moveToBall":this.currentBallIdx.set(s.ballIndex);return;case"openStats":this.statsOpen.set(!0);return;case"roundComplete":this.flash(s.toast),this.modalOpen.set(!1);return;case"holeComplete":{this.flash(s.toast),this.advanceTimer&&clearTimeout(this.advanceTimer),this.advanceTimer=setTimeout(()=>{this.advanceTimer=null,this.currentHole()?.playHoleId===s.fromHoleId&&(this.holeIdx.set(ie(s.toHoleIndex,this.playedOrder().length)),this.currentBallIdx.set(0),this.noteHoleEntered())},s.delayMs);return}}}hasMoreUnscored=()=>{const e=this.currentHole();return Ri({balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId}:null})};metaSnapshot(){const e=this.metaInputs();if(e.length===0)return;const t=this.pendingMeta.get(),s={};for(const n of e)s[n.key]=t[n.key]===!0;return s}setMeta(e,t){const s=this.pendingMeta.get();this.pendingMeta.set({...s,[e]:t});const n=this.ballsInGroup()[this.currentBallIdx.get()],r=this.currentHole();if(!n||!r)return;const o=this.svc.strokesFor(n.id,r.playHoleId);o!==null&&this.svc.setScore(n.id,r.playHoleId,o,this.metaSnapshot())}metaChip(e,t){return this.wireEl(Bi,{glabel:{textContent:e.label},miss:{className:()=>this.pendingMeta.get()[e.key]?"se-seg":"se-seg on-miss",onclick:()=>this.setMeta(e.key,!1)},hit:{className:()=>this.pendingMeta.get()[e.key]?"se-seg on-hit":"se-seg",onclick:()=>this.setMeta(e.key,!0)}},t)}flash(e){this.toastMsg.set(e),this.flashTimer&&clearTimeout(this.flashTimer),this.flashTimer=setTimeout(()=>{this.flashTimer=null,this.toastMsg.get()===e&&this.toastMsg.set(null)},1100)}snap(e){this.pendingSteps=e,this.transitioning.set(!0),this.dragOffset.set(-e*J),this.settleTimer&&clearTimeout(this.settleTimer),this.settleTimer=setTimeout(()=>this.finishSettle(),420)}finishSettle(){if(this.pendingSteps===null)return;const e=this.pendingSteps;this.pendingSteps=null,this.settleTimer&&(clearTimeout(this.settleTimer),this.settleTimer=null),this.transitioning.set(!1),e!==0&&this.holeIdx.set(ie(this.holeIndex()+e,this.playedOrder().length)),this.dragOffset.set(0)}bindCarouselPointer(e,t){t.addEventListener("transitionend",n=>{n.propertyName==="transform"&&this.finishSettle()}),e.addEventListener("pointerdown",n=>{this.ptr||this.transitioning.get()||this.playedOrder().length<=1||(this.ptr={id:n.pointerId,startX:n.clientX,startY:n.clientY,lastX:n.clientX,lastTime:Date.now(),velocity:0,horiz:!1},this.dragOffset.set(0),e.setPointerCapture?.(n.pointerId))}),e.addEventListener("pointermove",n=>{const r=this.ptr;if(!r||r.id!==n.pointerId)return;const o=n.clientX-r.startX,d=n.clientY-r.startY;if(!r.horiz){if(Math.abs(d)>Math.abs(o)&&Math.abs(d)>8||Math.abs(o)<=8)return;r.horiz=!0}const u=Date.now(),h=Math.max(1,u-r.lastTime);r.velocity=(n.clientX-r.lastX)/h,r.lastX=n.clientX,r.lastTime=u,this.dragOffset.set(o)});const s=n=>{const r=this.ptr;if(!r||r.id!==n.pointerId)return;const o=n.clientX-r.startX,d=r.horiz;if(this.ptr=null,e.releasePointerCapture?.(n.pointerId),!d){this.dragOffset.set(0);return}this.snap(wi({dragDistance:o,velocity:r.velocity,itemWidth:J}))};e.addEventListener("pointerup",s),e.addEventListener("pointercancel",n=>{!this.ptr||this.ptr.id!==n.pointerId||(this.ptr=null,e.releasePointerCapture?.(n.pointerId),this.snap(0))})}}function qi(i,e){const t=[...i].sort((r,o)=>r.canonicalOrdinal-o.canonicalOrdinal);if(e.length===0)return[{label:"TOT",holes:t,playHoleIds:new Set(t.map(r=>r.playHoleId))}];const s=[...e].sort((r,o)=>r.fromCanonicalOrdinal-o.fromCanonicalOrdinal),n=[];for(const r of s){const o=t.filter(d=>d.canonicalOrdinal>=r.fromCanonicalOrdinal&&d.canonicalOrdinal<=r.toCanonicalOrdinal);o.length!==0&&n.push({label:r.label,holes:o,playHoleIds:new Set(o.map(d=>d.playHoleId))})}return n}function ds(i,e){const t=i.cells.filter(s=>e.has(s.playHoleId));if(i.aggregate==="sum"){const s=t.map(n=>n.value).filter(n=>n!==null);return s.length===0?"—":String(s.reduce((n,r)=>n+r,0))}if(i.aggregate==="last"){for(let s=t.length-1;s>=0;s--){const n=t[s].value;if(n!==null)return Number.isInteger(n)?String(n):n.toFixed(1)}return"—"}return"—"}function Ki(i,e){if(i.aggregate==="sum"){const t=i.cells.map(s=>s.value).filter(s=>s!==null);return t.length===0?"—":String(t.reduce((s,n)=>s+n,0))}if(i.aggregate==="last"){const t=e[e.length-1];return t?ds(i,t.playHoleIds):"—"}return"—"}function Vi(i){const e=i?.marker;if(e){const t=e.tone;return{kind:"marker",template:e.template,tone:t==="success"||t==="warning"||t==="danger"?t:null,label:e.label?e.label:null,teamFill:i?.team??null}}return i?.team?{kind:"pill",team:i.team}:{kind:"plain"}}function Ui(i){return i.filter(e=>!(e.startsWith("slot #")||/^CH -?\d/.test(e)||/^PH -?\d/.test(e)))}const Te=" & ";function cs(i){return i.componentId??"default-score-grid"}function rt(i,e,t,s={}){const n=qi(i.holes,e),r=s.mode??"product",o=i.rows.map(d=>{const u=new Map(d.cells.map(h=>[h.playHoleId,h]));return{kind:d.kind,emphasis:d.emphasis===!0,team:d.team??null,subjectName:d.subjectBallId?t(d.subjectBallId):null,labelText:d.label,groups:n.map(h=>({cells:h.holes.map(f=>{const m=u.get(f.playHoleId);return{text:m?.display??"",title:m?.title?m.title:null,decoration:Vi(m)}}),subtotal:ds(d,h.playHoleIds)})),total:Ki(d,n)}});return{componentId:cs(i),subjectBallIds:[...i.subjectBallIds],title:{groups:i.title.groups.map(d=>d.map(u=>t(u))),joiner:i.title.joiner,nameJoiner:Te},subtitleFacts:r==="verification"?[...i.subtitleFacts]:Ui(i.subtitleFacts),footnotes:[...i.footnotes],caption:i.caption??null,totals:i.totals.map(d=>({label:d.label,value:String(d.value??"—")})),columnGroups:n.map(d=>({label:d.label,columns:d.holes.map(u=>({label:u.occurrenceLabel}))})),hasTotalColumn:n.length>1,rows:o}}function Ae(i){return[...new Set(i)].sort().join("\0")}function Wi(i,e){const t=new Map;e.forEach((n,r)=>{if(n.ballIds.length===0)return;const o=Ae(n.ballIds);t.set(o,t.has(o)?null:r)});const s=new Map;for(const n of i){if(n.subjectBallIds.length===0)continue;const r=Ae(n.subjectBallIds);s.set(r,(s.get(r)??0)+1)}return i.map(n=>{if(n.subjectBallIds.length===0)return{kind:"standalone"};const r=Ae(n.subjectBallIds);if((s.get(r)??0)!==1)return{kind:"standalone"};const o=t.get(r);return o==null?{kind:"standalone"}:{kind:"attached",entryIndex:o}})}function Yi(i,e){const t=new Set(i.map(e));return t.size!==1?null:[...t][0]??null}function Qi(i,e){if(i===void 0)return null;const t=e==="high"?-i:i;return{text:t===0?"E":t>0?`+${t}`:`−${Math.abs(t)}`,tone:t===0?"even":t>0?"over":"under"}}const Xi=()=>null;function Ji(i,e,t=Xi){return{kind:"ranked",metricLabel:i.metricLabel,hasPace:i.entries.some(s=>s.paceDelta!==void 0),entries:i.entries.map(s=>({position:s.position,lead:s.position===1,name:s.ballIds.map(e).join(Te),group:Yi(s.ballIds,t),total:String(s.total??"—"),holesPlayed:s.holesPlayed,pace:Qi(s.paceDelta,i.direction)}))}}function Zi(i,e){return{kind:"match_summary",title:i.title,matches:i.matches.map(t=>({sideAName:t.sideA.ballIds.map(e).join(Te),sideBName:t.sideB.ballIds.map(e).join(Te),leader:t.leader,standing:t.magnitude===0?"AS":`${t.magnitude} UP`,status:t.finished?"Final":`thru ${t.thru}`}))}}function Ye(i,e){return[i,...[...new Set(e)].sort()].join("|")}const er=new Map;function tr(i){const e=i.cards??[],t=(i.leaderboard??[]).find(o=>o.kind==="ranked")??null;if(!t)return{rankedSection:null,slotDefId:i.slotDefId,attached:er,standalone:[...e]};const s=Wi(e,t.entries),n=new Map,r=[];return e.forEach((o,d)=>{const u=s[d],h=u?.kind==="attached"?t.entries[u.entryIndex]:void 0;if(!h){r.push(o);return}n.set(Ye(i.slotDefId,h.ballIds),o)}),{rankedSection:t,slotDefId:i.slotDefId,attached:n,standalone:r}}class sr{open=new Set;isOpen(e){return this.open.has(e)}toggle(e){return this.set(e,!this.open.has(e))}set(e,t){return t?this.open.add(e):this.open.delete(e),t}keys(){return[...this.open].sort()}retain(e){const t=new Set(e);for(const s of[...this.open])t.has(s)||this.open.delete(s)}}const us={ring:{meaning:"a single-unit decided result",fill:"#d63b2f",visual:"red filled circle — the Gamebook birdie mark (score to par −1)"},double_ring:{meaning:"a two-unit decided result; more emphatic than a ring",fill:"#e0862c",teamFillBorder:"border-width: 3px; border-style: double;",visual:"orange filled circle (score to par −2); doubled white border when team-filled"},diamond:{meaning:"a rare / high-magnitude decided result — the strongest form",fill:"#e0b41f",visual:"yellow filled circle — hole-in-one / albatross territory"},dot:{meaning:"a lightweight per-hole flag where a full ring would be too heavy",visual:"the bare base shape (no fill, no border) — inherits cell colour"},badge:{meaning:"a labelled status needing short text or a number, not just a shape",rule:["width: auto; min-width: 1.8em;","padding-left: 0.45em; padding-right: 0.45em;","border: 2px solid currentColor;"],tones:{success:"#267348",warning:"#946200",danger:"#9b332a"},visual:"outline pill in the tone colour, text inside"},square:{meaning:"a one-step negative score relation",fill:"#5b9bd5",boxy:!0,visual:"light-blue filled square (score to par +1)"},double_square:{meaning:"a stronger negative score relation",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square (score to par +2)"},box_badge:{meaning:"an angular labelled state that must not read as a round marker",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square carrying its value (+3 or worse)"}};function me(i){return`lb-mark--${i}`}const le=()=>Object.entries(us);function hs(i){return i.join(`
            `)}function Me(i,e){return i.map((t,s)=>`& .${me(t)}${s===i.length-1?` { ${e} }`:","}`)}function nr(){const i=[];i.push("/* Outline forms keep currentColor + tone tints. */");for(const[r,o]of le())if(!(!o.rule&&!o.tones)){if(o.rule){i.push(`& .${me(r)} {`);for(const d of o.rule)i.push(`    ${d}`);i.push("}")}for(const[d,u]of Object.entries(o.tones??{}))i.push(`& .${me(r)}.lb-mark-tone--${d} { color: ${u}; }`)}i.push("/* Filled forms — declared after the tone rules so white text wins. */");const e=le().filter(([,r])=>r.boxy).map(([r])=>r),t=[],s=new Set;for(const[r,o]of le()){if(o.fill===void 0||s.has(r))continue;const d=le().filter(([,u])=>u.fill===o.fill).map(([u])=>u);for(const u of d)s.add(u);t.push({fill:o.fill,ids:d})}let n=-1;if(e.length>0){const r=t.findIndex(o=>o.ids.some(d=>us[d].boxy));n=r===-1?t.length:r}return t.forEach((r,o)=>{o===n&&i.push(...Me(e,"border-radius: 3px;")),i.push(...Me(r.ids,`background: ${r.fill}; color: #fff;`))}),n===t.length&&i.push(...Me(e,"border-radius: 3px;")),hs(i)}function ir(){const i=[];for(const[e,t]of le()){if(!t.teamFillBorder)continue;const s=me(e);i.push(`& .${s}.lb-mark-fill--a,`,`& .${s}.lb-mark-fill--b { ${t.teamFillBorder} }`)}return hs(i)}const ps=()=>null;function E(i){return String(i).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function rr(i){return i.kind==="si"?"lb-c-si":i.kind==="given"?"lb-c-given":i.kind==="status"?"lb-c-status":i.kind==="category"?"lb-c-cat":""}function or(i){const e=[i.kind==="category"?"lb-r-cat":`lb-r-${i.kind}`];return(i.kind==="si"||i.kind==="given")&&e.push("lb-r-dim"),i.team&&e.push(`lb-team-${i.team}`),e.join(" ")}function ar(i,e,t){const s=i.title!==null?` title="${E(i.title)}"`:"",n=t(E(i.text)),r=i.decoration;let o;if(r.kind==="marker"){const d=r.tone?` lb-mark-tone--${r.tone}`:"",u=r.teamFill?` lb-mark-fill--${r.teamFill}`:"",h=r.label!==null?` title="${E(r.label)}" aria-label="${E(r.label)}"`:"";o=`<span class="lb-mark ${me(r.template)}${d}${u}"${h}>${n}</span>`}else r.kind==="pill"?o=`<span class="lb-pill lb-pill--${r.team}">${n}</span>`:o=n;return`<td class="${rr(e)}"${s}>${o}</td>`}function ot(i,e){const t=m=>{const c=i.columnGroups[m],_=`<tr><th class="lb-rowlabel">Hole</th>${c.columns.map(C=>`<th>${E(C.label)}</th>`).join("")}<th class="lb-sum">${E(c.label)}</th></tr>`,g=i.rows.map(C=>{const z=ge=>C.emphasis?`<strong>${ge}</strong>`:ge,L=C.groups[m],R=L.cells.map(ge=>ar(ge,C,z)).join(""),F=`<td class="lb-sum">${z(L.subtotal)}</td>`,K=C.subjectName!==null?E(C.subjectName)+(C.labelText?" "+E(C.labelText):""):E(C.labelText);return`<tr class="${or(C)}"><th class="lb-rowlabel">${K}</th>${R}${F}</tr>`}).join("");return`<div class="lb-card__scroll"><table class="lb-grid"><thead>${_}</thead><tbody>${g}</tbody></table></div>`},s=i.columnGroups.map((m,c)=>t(c)).join(""),n=i.title.groups.map(m=>m.map(c=>E(c)).join(i.title.nameJoiner)).filter(Boolean).join(i.title.joiner),r=i.subtitleFacts.length?`<div class="lb-card__sub">${i.subtitleFacts.map(E).join(" · ")}</div>`:"",o=e.mode==="verification"&&i.footnotes.length?`<div class="lb-card__notes"><span class="lb-card__notes-label">Points breakdown</span>${i.footnotes.map(m=>`<span class="lb-card__note">${E(m)}</span>`).join("")}</div>`:"",d=e.mode==="verification"&&i.caption?`<p class="lb-card__caption">${E(i.caption)}</p>`:"",u=i.totals.length?`<ul class="lb-card__totals">${i.totals.map(m=>`<li>${E(m.label)} = <strong>${m.value}</strong></li>`).join("")}</ul>`:"",h=n?`<header class="lb-card__head"><h4>${n}</h4>${r}</header>`:r;return`<article class="${e.cardModifier?`lb-card ${e.cardModifier}`:"lb-card"}">
  ${h}
  ${s}
  ${o}${d}${u}
</article>`}function lr(i,e,t,s){return ot(rt(i,e,t,s),s)}function dr(i,e,t,s){return ot(rt(i,e,t,s),{...s,cardModifier:"lb-card--compact-match"})}function cr(i,e,t,s){return ot(rt(i,e,t,s),{...s,cardModifier:"lb-card--category-matrix"})}function ur(i){return i.pace===null?'<td class="lb-rank__pace"></td>':`<td class="lb-rank__pace lb-rank__pace--${i.pace.tone}">${E(i.pace.text)}</td>`}function hr(i){return`lb-panel-${i.replace(/[^a-zA-Z0-9_-]+/g,"-")}`}function pr(i,e,t=ps,s=null){const n=Ji(i,e,t),r=n.hasPace,o=r?5:4,d=n.entries.map((f,m)=>{const c=f.group?` <span class="lb-rank__group">${E(f.group)}</span>`:"",_=`
  <td class="lb-rank__total">${f.total}</td>${r?`
  ${ur(f)}`:""}
  <td class="lb-rank__thru">${f.holesPlayed}</td>
</tr>`,g=i.entries[m],C=s&&g?s.plan.attached.get(Ye(s.plan.slotDefId,g.ballIds)):void 0;if(!s||!g||!C)return`<tr class="${f.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${f.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${E(f.name)}</span>${c}</span></td>${_}`;const z=Ye(s.plan.slotDefId,g.ballIds),L=s.isOpen(z),R=hr(z),F=ms(C,s.routeSections,e,{mode:s.mode??"product"}),K=["lb-rank__row--expandable"];return f.lead&&K.push("lb-rank__lead"),L&&K.push("lb-rank__row--open"),`<tr class="${K.join(" ")}" data-expand-key="${E(z)}">
  <td class="lb-rank__pos">${f.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${L}" aria-controls="${E(R)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${E(f.name)}</span>${c}</span><span class="lb-rank__chev" aria-hidden="true"></span></button></td>${_}
<tr class="lb-rank__panel${L?" lb-rank__panel--open":""}" data-panel-key="${E(z)}">
  <td class="lb-rank__panelcell" colspan="${o}"><div class="lb-rank__panelwrap" id="${E(R)}"><div class="lb-rank__panelbox">${F}</div></div></td>
</tr>`}).join(""),u=r?`
      <col class="lb-rank__col-pace">`:"",h=r?'<th class="lb-rank__pace">Pace</th>':"";return`<div class="lb-section">
  <h4 class="lb-section__title">${E(n.metricLabel)}</h4>
  <table class="lb-rank">
    <colgroup>
    ...
    <thead><tr><th class="lb-rank__pos">#</th><th class="lb-rank__who">Player</th><th class="lb-rank__total">Total</th>${h}<th class="lb-rank__thru">Thru</th></tr></thead>
    <tbody>${d}</tbody>
  </table>
</div>`}function mr(i,e){const t=Zi(i,e),s=t.matches.map(n=>{const r=n.leader==="a"?" lb-mp__team--lead":"",o=n.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    <div class="lb-mp__team lb-mp__team--a${r}">${E(n.sideAName)}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${E(n.standing)}</span><span class="lb-mp__status">${E(n.status)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${o}">${E(n.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${E(t.title)}</h4>${s}
</div>`}const fr={ranked:pr,match_summary:(i,e)=>mr(i,e)},gr={"default-score-grid":lr,"compact-match-grid":dr,"category-matrix-grid":cr};function br(i){return`<div class="lb-diag">Unrenderable result section <code>${E(i)}</code> — no generic view yet. Results are not hidden.</div>`}function yr(i){return`<div class="lb-diag">Unsupported score-grid component <code>${E(i)}</code> — no generic view yet. Results are not hidden.</div>`}function _r(i,e,t,s=null){const n=fr[i.kind];return n?n(i,e,t,s):br(i.kind)}function ms(i,e,t,s){const n=cs(i),r=gr[n];return r?r(i,e,t,s):yr(n)}function vr(i,e,t=ps,s=null){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${E(i.formatLabel)}.</div>`:i.leaderboard.map(r=>_r(r,e,t,s&&r===s.plan.rankedSection?s:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${E(i.formatLabel)}.</div>`}function wr(i,e,t,s={}){if(i.length===0)return"";const n=s.mode??"product";return i.map(r=>ms(r,e,t,{mode:n})).join(`
`)}const xr=y(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class $r extends P{static styles=`
        .lb {
    ...
    `;svc=this.inject(te);expansion=new sr;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(xr,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const s=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(s))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const s=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(s)&&(this.applyOpen(t,this.expansion.set(s,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const s=e.nextElementSibling;s?.classList.contains("lb-rank__panel")&&s.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=h=>{const f=this.svc.nameOf(h);return this.svc.isPending(h)?`${f} (open seat)`:f},n=h=>this.svc.groupLabelOf(h),r=tr(t);this.expansion.retain(r.attached.keys());const o=vr(t,s,n,{plan:r,routeSections:e.routeSections,isOpen:h=>this.expansion.isOpen(h)}),d=wr(r.standalone,e.routeSections,s),u=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return o+u}}function kr(i,e){if(!e)return[];const t=[],s=new Set;for(const n of i)for(const r of n.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Sr=y(`
...
`);class Ir extends P{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${O()}
    ...
    `;svc=this.inject(te);auth=this.inject(M);router=this.inject(D);tokenQ=this.router.query("token");claiming=new p(!1);error=new p("");claimable(){return kr(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async claim(e){const t=this.tokenQ.get();if(!(!t||this.claiming.get())){this.error.set(""),this.claiming.set(!0);try{await v.friendlyRounds.claimGuest({token:t,guestPlayerId:e}),await this.svc.loadByToken(t)}catch(s){this.error.set(s instanceof q&&s.status===409?"Already claimed — or you already play in this round under your account.":s instanceof q&&s.status===404?"That guest is no longer claimable on this round.":"Could not claim right now. Try again.")}finally{this.claiming.set(!1)}}}render(){const e=this.wire(Sr,{root:{className:()=>this.claimable().length>0?"claim-card":"claim-card hidden"},err:{textContent:()=>this.error.get()}});return this.$each(this.ref(e,"rows"),()=>this.claimable(),(t,s,n)=>this.wireEl(Cr,{name:()=>t.displayName,claim:{disabled:()=>this.claiming.get(),onclick:()=>{this.claim(t.guestPlayerId)}}},n),t=>t.guestPlayerId),e}}function He(i){return typeof i=="object"&&i!==null&&typeof i.get=="function"}const w=i=>`var(--${i})`,Et="http://www.w3.org/2000/svg";function Tr(){const i=document.createElementNS(Et,"svg");i.setAttribute("width","12"),i.setAttribute("height","8"),i.setAttribute("viewBox","0 0 12 8"),i.setAttribute("fill","none"),i.setAttribute("aria-hidden","true"),i.setAttribute("focusable","false");const e=document.createElementNS(Et,"path");return e.setAttribute("d","M1 1.5 6 6.5 11 1.5"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.5"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.setAttribute("fill","none"),i.appendChild(e),i}const ue=class ue extends P{constructor(){super(...arguments),this.uid=`ui-select-${ue.seq++}`,this.open=new p(!1),this.highlightIndex=new p(-1),this.optionEls=[],this.onOutsidePointer=e=>{this.wrapperEl.contains(e.target)||this.open.set(!1)}}get isMulti(){return this.props.multiple===!0}get multi(){return this.props}get single(){return this.props}currentOptions(){return He(this.props.options)?this.props.options.get():this.props.options}selectedValues(){if(this.isMulti)return this.multi.values.get();const e=this.single.value.get();return e?[e]:[]}placeholderText(){const e=this.props.placeholder;return(typeof e=="function"?e():e)??""}formatCount(e){return this.multi.countLabel?this.multi.countLabel(e):String(e)}render(){const e=document.createElement("div");e.className="ui-select",this.wrapperEl=e;const t=this.props.zIndex??50,s=this.isMulti;this.triggerEl=document.createElement("button"),this.triggerEl.className="ui-select__trigger",this.triggerEl.setAttribute("type","button"),this.triggerEl.setAttribute("role","combobox"),this.triggerEl.setAttribute("aria-haspopup","listbox");const n=document.createElement("span");n.className="ui-select__trigger-label",this.triggerEl.appendChild(n);const r=document.createElement("span");r.className="ui-select__chevron",r.appendChild(Tr()),r.setAttribute("aria-hidden","true"),this.triggerEl.appendChild(r),this.triggerEl.addEventListener("click",d=>{d.stopPropagation(),this.toggle()}),this.triggerEl.addEventListener("keydown",d=>{this.handleTriggerKeydown(d)}),e.appendChild(this.triggerEl),this.dropdownEl=document.createElement("div"),this.dropdownEl.className="ui-select__dropdown",this.dropdownEl.style.zIndex=String(t),this.dropdownEl.addEventListener("keydown",d=>{this.handleDropdownKeydown(d)}),this.listEl=document.createElement("div"),this.listEl.className="ui-select__list",this.listEl.setAttribute("role","listbox"),s&&this.listEl.setAttribute("aria-multiselectable","true"),this.dropdownEl.appendChild(this.listEl),s&&(this.countEl=document.createElement("div"),this.countEl.className="ui-select__count",this.countEl.setAttribute("role","status"),this.countEl.setAttribute("aria-live","polite"),this.dropdownEl.appendChild(this.countEl)),e.appendChild(this.dropdownEl);const o=d=>{this.optionEls=[],this.listEl.textContent="";for(let u=0;u<d.length;u++){const h=d[u],f=document.createElement("button");if(f.className=s?"ui-select__option ui-select__option--multi":"ui-select__option",f.setAttribute("type","button"),f.id=`${this.uid}-opt-${u}`,h.disabled){f.classList.add("ui-select__option--header"),f.disabled=!0,f.setAttribute("role","presentation"),f.setAttribute("aria-disabled","true");const c=document.createElement("span");c.className="ui-select__option-label",c.textContent=h.label,f.appendChild(c),this.listEl.appendChild(f),this.optionEls.push(f);continue}if(f.setAttribute("role","option"),s){const c=document.createElement("span");c.className="ui-select__checkbox",c.setAttribute("aria-hidden","true"),f.appendChild(c)}if(h.icon){const c=document.createElement("span");c.className="ui-select__option-icon",c.textContent=h.icon,f.appendChild(c)}const m=document.createElement("span");if(m.className="ui-select__option-label",m.textContent=h.label,f.appendChild(m),!s){const c=document.createElement("span");c.className="ui-select__check",c.setAttribute("aria-hidden","true"),f.appendChild(c)}f.addEventListener("click",c=>{c.stopPropagation(),this.chooseOption(h.value)}),f.addEventListener("mouseenter",()=>{this.highlightIndex.set(u)}),this.listEl.appendChild(f),this.optionEls.push(f)}};return He(this.props.options)?this.track(N(()=>{o(this.currentOptions())})):o(this.props.options),this.track(N(()=>{const d=this.currentOptions(),u=this.selectedValues();if(s){const h=u.length;if(h>0)n.textContent=this.formatCount(h),this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const f=this.placeholderText();n.textContent=f,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!f)}this.countEl&&(this.countEl.textContent=this.formatCount(h))}else{const h=this.single.value.get(),f=d.find(m=>m.value===h);if(f)n.textContent=f.icon?`${f.icon} ${f.label}`:f.label,this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const m=this.placeholderText();n.textContent=m,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!m)}}for(let h=0;h<d.length;h++){const f=this.optionEls[h];if(!f||d[h].disabled)continue;const m=u.includes(d[h].value);f.setAttribute("aria-selected",String(m)),f.classList.toggle("ui-select__option--selected",m);const c=f.querySelector(".ui-select__check");c&&(c.textContent=m?"✓":"");const _=f.querySelector(".ui-select__checkbox");_&&(_.textContent=m?"✓":"")}})),this.track(N(()=>{const d=this.open.get();this.dropdownEl.classList.toggle("open",d),r.classList.toggle("ui-select__chevron--open",d),this.triggerEl.setAttribute("aria-expanded",String(d)),d?document.addEventListener("pointerdown",this.onOutsidePointer,!0):document.removeEventListener("pointerdown",this.onOutsidePointer,!0),d&&G(()=>{const u=this.currentOptions(),h=this.selectedValues(),f=u.findIndex(c=>!c.disabled&&h.includes(c.value)),m=u.findIndex(c=>!c.disabled);this.highlightIndex.set(f>=0?f:m)})})),this.track(N(()=>{const d=this.highlightIndex.get();for(let u=0;u<this.optionEls.length;u++)this.optionEls[u].classList.toggle("ui-select__option--highlighted",u===d);d>=0&&this.optionEls[d]&&(this.triggerEl.setAttribute("aria-activedescendant",`${this.uid}-opt-${d}`),this.optionEls[d].scrollIntoView({block:"nearest"}))})),this.props.disabled!=null&&(He(this.props.disabled)?this.track(N(()=>{const d=this.props.disabled.get();this.triggerEl.classList.toggle("ui-select__trigger--disabled",d),this.triggerEl.disabled=d})):this.props.disabled&&(this.triggerEl.classList.add("ui-select__trigger--disabled"),this.triggerEl.disabled=!0)),e}toggle(){this.open.update(e=>!e)}chooseOption(e){if(this.isMulti){const t=this.multi.values.get();this.multi.values.set(t.includes(e)?t.filter(s=>s!==e):[...t,e]);return}he(()=>{this.single.value.set(e),this.open.set(!1)}),this.triggerEl.focus()}commitHighlighted(){const e=this.highlightIndex.get(),t=this.currentOptions();e>=0&&e<t.length&&!t[e].disabled&&this.chooseOption(t[e].value)}handleTriggerKeydown(e){switch(e.key){case"Enter":case" ":e.preventDefault(),this.open.get()?this.commitHighlighted():this.open.set(!0);break;case"ArrowDown":e.preventDefault(),this.open.get()?this.moveHighlight(1):this.open.set(!0);break;case"ArrowUp":e.preventDefault(),this.open.get()?this.moveHighlight(-1):this.open.set(!0);break;case"Escape":this.open.get()&&(e.preventDefault(),this.open.set(!1));break}}handleDropdownKeydown(e){switch(e.key){case"ArrowDown":e.preventDefault(),this.moveHighlight(1);break;case"ArrowUp":e.preventDefault(),this.moveHighlight(-1);break;case"Enter":case" ":e.preventDefault(),this.commitHighlighted();break;case"Escape":e.preventDefault(),this.open.set(!1),this.triggerEl.focus();break;case"Tab":this.open.set(!1);break}}moveHighlight(e){const t=this.currentOptions();if(t.length===0||!t.some(n=>!n.disabled))return;let s=this.highlightIndex.get();do s+=e,s<0&&(s=t.length-1),s>=t.length&&(s=0);while(t[s].disabled);this.highlightIndex.set(s)}onDestroy(){document.removeEventListener("pointerdown",this.onOutsidePointer,!0)}};ue.styles=`
        .ui-select {
            position: relative;
            display: inline-block;
        }
    ...
    `,ue.seq=0;let W=ue;function Er(i){if(!i)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=i.seats.length>0,t=i.claimedSeats.some(r=>r.viewerMayRelease),s=i.viewer.claimSeat.allowed,n=i.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&n,blockedMessage:e&&!s&&!n?i.viewer.claimSeat.message??i.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Nr(i,e){const t=[];if(i.groupId!==null&&e.length>0){const s=e.findIndex(n=>n.id===i.groupId);if(s>=0){t.push(`Group ${s+1}`);const n=e[s].startTime;n.includes(":")&&t.push(n)}}return i.category!==null&&t.push(i.category),t.join(" · ")}function Pr(i){return(i?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const zr=y(`
...
`);class Rr extends P{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${O()}
...
`);class Hr extends P{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${O()}
    ...
    `;svc=this.inject(te);auth=this.inject(M);router=this.inject(D);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Lr(this.svc.startList.get())}eligible(){return this.policyState().visible&&Dr(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),n=await v.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});n.ok?await this.svc.loadByToken(e):this.diagnostics.set(n.diagnostics)}catch(s){this.error.set(s instanceof q&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(N(()=>this.ensureTeesLoaded()));const e=new k(()=>Ar(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(N(()=>{const r=e.get(),o=this.groupChoice.get();(!o||!r.options.some(d=>d.value===o&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Mr,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new W({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const n=new W({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return n.mount(this.ref(t,"groupHost")),this.track(()=>n.destroy()),t}}const Fr=y(`
...
`);class Br extends P{static styles=`
        .edit-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${O()}
    ...
    `;router=this.inject(D);tokenQ=this.router.query("token");editable=new p(!1);render(){const e=this.tokenQ.get();return e&&v.friendlyRounds.setup({token:e}).then(t=>this.editable.set(t.editable===!0)).catch(()=>this.editable.set(!1)),this.wire(Fr,{root:{className:()=>this.editable.get()?"edit-card":"edit-card hidden"},edit:{onclick:()=>{const t=this.tokenQ.get();t&&this.router.navigate("/create",{query:{token:t}})}}})}}function Gr(i,e){if(!e)return!1;for(const t of i)for(const s of t.players)if(s.playerId===e)return!0;return!1}const qr=y(`
...
`);class Kr extends P{static styles=`
    ...
    `;svc=this.inject(te);auth=this.inject(M);router=this.inject(D);tokenQ=this.router.query("token");open=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);eligible(){return Gr(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.error.set(""),this.diagnostics.set([]),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){const e=this.wire(qr,{root:{className:()=>this.eligible()?"leave-card":"leave-card hidden"},leaveBtn:{onclick:()=>this.open.set(!0),disabled:()=>this.leaving.get()},diag:{textContent:()=>this.diagnostics.get().map(t=>t.message).join(" · ")},err:{textContent:()=>this.error.get()}});return this.spawn(U,this.ref(e,"confirmHost"),{open:this.open,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}}),e}}function Vr(i){return!(i.tab!=="leaderboard"||!i.pageVisible||i.status==="complete")}const Ur=2,Wr=3;function Yr(i,e=null){const t=new URLSearchParams({token:i});return e!==null&&t.set("since",e),`${A}/friendly-rounds/events?${t.toString()}`}function Qr(i){if(typeof i!="object"||i===null)return!1;const e=i;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Xr(i){const t=(i.eventSourceFactory??(o=>new EventSource(o)))(Yr(i.token,i.since??null));let s=!1,n=0;const r=()=>{s=!0,t.onopen=null,t.onmessage=null,t.onerror=null,t.close()};return t.onopen=()=>{n=0},t.onmessage=o=>{if(s)return;let d;try{d=JSON.parse(o.data)}catch{return}Qr(d)&&i.onEvent({latestEventId:d.latestEventId,status:d.status})},t.onerror=()=>{s||(t.readyState===Ur||++n>=Wr)&&(r(),i.onDegrade())},{stop:()=>{s||r()}}}const Jr=2e4;function Zr(i){if(!(i===null||i===""))return/^\d+$/.test(i)?Number(i):i}const eo=y(`
...
`),to=y('<button bind="pill" class="round-view__fmt" type="button"></button>'),so=y('<button bind="pill" class="round-view__grp" type="button"></button>');class no extends P{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Io extends P{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .setup__friends {
                margin-top: ${l("sm")}; padding: ${l("sm")}; ${O()}
                &.hidden { display: none; }
...
`);class zo extends P{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function Dt(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Do extends P{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject(Oe);auth=this.inject(M);router=this.inject(D);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Oo,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:n=>this.svc.setQuery(n.target.value)},searchHint:{textContent:()=>{const n=this.svc.query.get().trim();return n.length>0&&!bt(n)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const n=this.svc.query.get().trim();return bt(n)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===n&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(n,r,o)=>this.wireEl(jo,{initials:()=>Dt(n.displayName),name:()=>n.displayName,username:()=>n.homeClubName?`@${n.username} · ${n.homeClubName}`:`@${n.username}`,hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(n.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const d=this.svc.results.get().find(u=>u.id===n.id);d&&!d.isFriend&&this.svc.add(d)}},added:{className:()=>this.isFriendNow(n.id)?"friend-row__added":"friend-row__added hidden"}},o),n=>n.id);const s=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>st(this.svc.friends.get(),this.svc.sortMode.get()),(n,r,o)=>this.wireEl(Ro,{initials:()=>Dt(n.displayName),name:()=>n.displayName,subtitle:()=>{const d=this.svc.friends.get().find(u=>u.id===n.id)??n;return Kn(d,s)},hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(n.id)}}},o),n=>n.id),t}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Lo=y(`
    <div class="profile">
...
`);class Mo extends P{static styles=`
    ...
    `;svc=this.inject(ze);auth=this.inject(M);router=this.inject(D);indexDraft=new p("");localErr=new p("");render(){this.auth.currentUser.get()&&this.svc.load();const e=()=>this.auth.currentUser.get()!==null,t=this.wire(Lo,{anon:{className:()=>e()?"profile__anon hidden":"profile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/profile"}})},body:{className:()=>e()?"profile__body":"profile__body hidden"},name:()=>this.svc.player.get()?.displayName??"…",username:()=>{const o=this.svc.player.get();return o?`@${o.username}`:""},hcp:()=>{const o=this.svc.player.get()?.handicapIndex;return o==null?"–":o<0?`+${(-o).toFixed(1)}`:o.toFixed(1)},index:{value:()=>this.indexDraft.get(),oninput:o=>this.indexDraft.set(o.target.value)},save:{disabled:()=>this.svc.saving.get()||this.indexDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},form:{onsubmit:async o=>{o.preventDefault(),this.localErr.set("");const d=Q(this.indexDraft.get());if(d===null||d<-10||d>54){this.localErr.set("Enter an index between +10 and 54 (use “+” for a plus handicap).");return}await this.svc.saveIndex(d)&&this.indexDraft.set("")}},saveErr:{textContent:()=>this.localErr.get()||this.svc.saveError.get()?.message||""},genderErr:{textContent:()=>this.svc.saveError.get()?.message||""},clubErr:{textContent:()=>this.svc.saveError.get()?.message||""},historyEmpty:{className:()=>this.svc.history.get().length===0?"profile__empty":"profile__empty hidden"}});this.$each(this.ref(t,"history"),this.svc.history,(o,d,u)=>this.wireEl(Ao,{index:()=>o.handicapIndex.toFixed(1),source:()=>o.source,date:()=>o.effectiveDate},u),o=>o.id);const s=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(t,"gender"),()=>s,(o,d,u)=>this.wireEl(y('<button bind="b" type="button"></button>'),{b:{textContent:()=>o.label,className:()=>this.svc.player.get()?.gender===o.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.saveGender(o.value)}}},u),o=>o.label);const n=new p(this.svc.player.get()?.homeClubId??"");this.track(N(()=>n.set(this.svc.player.get()?.homeClubId??""))),this.track(N(()=>{const o=n.get();queueMicrotask(()=>{o!==(this.svc.player.get()?.homeClubId??"")&&this.svc.saveHomeClub(o===""?null:o)})}));const r=new W({value:n,options:{get:()=>[{value:"",label:"No home club"},...this.svc.clubs.get().map(o=>({value:o.id,label:o.name}))]},placeholder:"No home club",disabled:{get:()=>this.svc.saving.get()}});return r.mount(this.ref(t,"club")),this.track(()=>r.destroy()),t}}const Ho=y(`
    <div class="admin">
...
`),qo={not_started:"Not started",active:"Playing",complete:"Done"};function Ko(i){const e=[`${i.participants.length} players`,`${i.scoreEventCount} scores`];return i.lastEventAt?e.push(`last ${i.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Vo(i){const e=[`@${i.username}`,`${i.roundCount} rounds`];return i.lastRoundDate&&e.push(`last ${i.lastRoundDate}`),i.handicapIndex!==null&&e.push(`hcp ${i.handicapIndex}`),i.deletedAt&&e.push("DELETED"),e.join(" · ")}class Uo extends P{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Jo extends P{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),pa=y('<option bind="option"></option>');class ma extends P{competitions=this.inject(se);state=this.inject(fe);router=this.inject(D);render(){const e=new k(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(ua,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Yo(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,r)=>this.wireEl(pa,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,r)=>this.wireEl(ha,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>ca[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function fa(i,e,t){return JSON.stringify({entry:i,points:e,columns:t})}function ga(i){return i.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const ba=y(`
    <div>
...
`),ya=y('<button bind="button" type="button"></button>'),_a=y('<th bind="cell"></th>'),va=y('<tr bind="row"></tr>'),wa=y('<td bind="cell"><span bind="value"></span></td>'),xa=y(`
...
`),$a=y('<span bind="part"><span bind="separator"></span><span bind="value"></span></span>');class ka extends P{competitions=this.inject(se);state=this.inject(fe);render(){const e=new k(()=>{if(this.state.lifecycle.get()!=="finalized")return(this.competitions.board.get()?.view.entries??[]).map(m=>({entry:m,points:null}));const h=this.competitions.results.get()?.resultSets??[],f=Math.min(this.state.resultSetIndex.get(),h.length-1);return(h[f]?.entries??[]).map(m=>({entry:m.entry,points:m.points}))}),t=new k(()=>{const h=this.competitions.board.get()?.view.rounds??[];if(h.length>0)return h;const f=new Set;for(const m of e.get())for(const c of m.entry.rounds)f.add(c.roundNumber);return[...f].sort((m,c)=>m-c).map(m=>({roundNumber:m,postCut:!1}))}),s=()=>this.state.lifecycle.get()==="finalized",n=()=>s()?(this.competitions.results.get()?.resultSets.length??0)>0:this.competitions.board.get()!==null,r=()=>this.state.cutOutcome.get(),o=h=>h.length===0?"—":h.map(f=>f.displayName).join(", "),d=this.wire(ba,{admin:{className:()=>this.state.admin.get()&&this.state.lifecycle.get()==="active"?"cd__section cd__admin":"cd__section cd__admin hidden"},cutOutcome:{className:()=>r()?"cd__cutoutcome":"cd__cutoutcome hidden"},advancedLabel:()=>`Advanced (${r()?.advanced.length??0}):`,advanced:()=>o(r()?.advanced??[]),cutLabel:()=>`Cut (${r()?.cut.length??0}):`,cut:()=>o(r()?.cut??[]),applyCut:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.cutConfirmOpen.set(!0)},finalize:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.finalizeConfirmOpen.set(!0)},title:()=>s()?"Official results":"Leaderboard",board:{className:()=>s()?"cd__board cb cb--official":"cd__board"},official:{textContent:()=>{const h=this.competitions.results.get()?.finalizedAt.slice(0,10)??"";return s()&&h?`Official results · finalized ${h}`:""},className:()=>s()?"cd__official-banner":"cd__official-banner hidden"},boardHead:{className:()=>s()?"cb-head hidden":"cb-head"},metric:()=>this.competitions.board.get()?.view.metricLabel??"",operator:()=>{const h=this.competitions.board.get();return h?h.view.operator.kind==="best_n"?`Best ${h.view.operator.n} of ${h.view.rounds.length}`:"Total across rounds":""},defaulted:{className:()=>this.competitions.board.get()?.defaulted?"cb-head__hint":"cb-head__hint hidden"},empty:{className:()=>n()&&e.get().length===0?"cb-empty":"cb-empty hidden"},table:{className:()=>n()&&e.get().length>0?"cb":"cb hidden"},refusal:{textContent:()=>s()?this.competitions.resultsRefusal.get()??"":this.competitions.board.get()===null?this.competitions.boardRefusal.get()??"":""}}),u=new k(()=>[{text:"#",className:"cb-pos"},{text:"Player",className:"cb-who"},...t.get().map((h,f,m)=>({text:`R${h.roundNumber}`,className:`cb-c${h.postCut&&!m.slice(0,f).some(c=>c.postCut)?" cb-c--divider":""}`})),{text:"Total",className:"cb-total"},...s()?[{text:"Pts",className:"cb-points"}]:[]]);return this.$each(this.ref(d,"headers"),u,(h,f,m)=>this.wireEl(_a,{cell:{textContent:()=>h.text,className:()=>h.className}},m),h=>`${h.text}:${h.className}`),this.$each(this.ref(d,"rows"),e,(h,f,m)=>this.boardRow(h,t.get(),m),h=>fa(h.entry,h.points,t.get())),this.$each(this.ref(d,"switcher"),new k(()=>s()?this.competitions.results.get()?.resultSets??[]:[]),(h,f,m)=>this.wireEl(ya,{button:{textContent:()=>h.scoringType.toUpperCase(),className:()=>this.state.resultSetIndex.get()===f?"on":"",onclick:()=>this.state.resultSetIndex.set(f)}},m),h=>h.scoringType),this.spawn(U,this.ref(d,"cutConfirm"),{open:this.state.cutConfirmOpen,title:"Apply cut?",message:"This evaluates the configured cut against the current aggregate and marks who advances. Cut players are left out of later rounds.",confirmLabel:"Apply cut",cancelLabel:"Cancel",onconfirm:async()=>{const h=await this.competitions.applyCut(this.state.id.get()??"");h.ok&&this.state.cutOutcome.set(h.outcome)}}),this.spawn(U,this.ref(d,"finalizeConfirm"),{open:this.state.finalizeConfirmOpen,title:"Finalize competition?",message:"Finalizing freezes the official results and locks the competition. This cannot be undone.",confirmLabel:"Finalize",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.competitions.finalize(this.state.id.get()??"")}}),d}boardRow(e,t,s){const n=e.entry,r=n.withdrawn||n.cutAfterRound!==null,o=["cb-row"];n.withdrawn?o.push("cb-row--withdrawn"):n.cutAfterRound!==null?o.push("cb-row--cut"):n.position===1&&o.push("cb-row--lead"),n.incomplete&&o.push("cb-row--incomplete");const d=t.findIndex(m=>m.postCut),u=new Map(n.rounds.map(m=>[m.roundNumber,m])),h=[{kind:"position",text:r?"—":String(n.position)},{kind:"who",entry:n},...t.map((m,c)=>({kind:"round",cell:u.get(m.roundNumber)??null,divider:c===d})),{kind:"total",text:n.total===null?"—":String(n.total)},...e.points===null?[]:[{kind:"points",text:String(e.points)}]],f=this.wireEl(va,{row:{className:()=>o.join(" ")}},s);return this.$each(f,new k(()=>h),(m,c,_)=>this.boardCell(m,_),(m,c)=>c),f}boardCell(e,t){if(e.kind==="who")return this.whoCell(e.entry,t);const s=e.kind==="position"?"cb-pos":e.kind==="total"?"cb-total":e.kind==="points"?"cb-points":`cb-c cb-c--${e.cell?.status??"missing"}${e.divider?" cb-c--divider":""}`,n=e.kind==="round"?e.cell?.value===null||!e.cell?"—":String(e.cell.value):e.text;return this.wireEl(wa,{cell:{className:()=>s},value:{textContent:()=>n,className:()=>e.kind==="round"&&e.cell?.status==="dropped"?"cb-struck":""}},t)}whoCell(e,t){const s=e.withdrawn?"WD":e.cutAfterRound!==null?`Cut R${e.cutAfterRound}`:"",n=ga(e),r=this.wireEl(xa,{cell:{},name:()=>e.displayName,category:{textContent:()=>e.category??"",className:()=>e.category?"cb-tag cb-cat":"cb-tag cb-cat hidden"},status:{textContent:()=>s,className:()=>s?"cb-tag cb-tag--out":"cb-tag cb-tag--out hidden"},equals:{className:()=>n.length===0?"hidden":""},total:()=>e.total===null?"—":String(e.total)},t);return this.$each(r.querySelector('[bind="parts"]'),new k(()=>n),(o,d,u)=>this.wireEl($a,{separator:()=>d===0?"":" + ",value:{textContent:()=>o.text,className:()=>o.dropped?"cb-struck":""}},u),(o,d)=>d),r}}const Sa=y(`
    <div class="cd">
...
`);class Ca extends P{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .cd__official-banner {
                ${O()} padding: ${l("sm")} ${l("lg")}; margin-bottom: ${l("sm")};
                background: ${a("accent-soft")}; color: ${a("accent")};
    ...
    `;competitions=this.inject(se);state=this.inject(fe);router=this.inject(D);render(){const e=()=>this.competitions.detail.get();this.track(N(()=>{const s=this.state.id.get();s&&G(()=>{this.state.enter(),this.competitions.loadDetail(s)})})),this.state.initialize();const t=this.wire(Sa,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>ys(this.state.lifecycle.get()),className:()=>_s(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&Ge(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>Ge(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const s=Ge(this.state.lifecycle.get()),n=this.state.id.get();s&&n&&this.competitions.transition(n,s.to)}}});return this.spawn(ra,this.ref(t,"setup")),this.spawn(da,this.ref(t,"roster")),this.spawn(ma,this.ref(t,"rounds")),this.spawn(ka,this.ref(t,"results")),t}}const Ia=y(`
    <div class="app-shell">
...
`);class Ta extends P{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(D);render(){const e=this.wire(Ia,{header:{className:()=>es(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(si,this.ref(e,"account")),this.spawn(Bn,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":wt,"/history":gi,"/round":no,"/create":Io,"/login":zo,"/friends":Do,"/profile":Mo,"/admin":Uo,...Zt.competitions?{"/competitions":Jo,"/competition":Ca}:{}},wt),e}}class Ea extends M{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await bs(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await To()),this.error.set(null)}catch(e){e instanceof q&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Eo(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof q&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}H.get(Ls);const Lt=H.get(D);H.set(M,new Ea);const At=H.get(M);await Fs(Ta,"#app",{hot:void 0,onInit:async()=>{await At.load(),At.currentUser.get()&&Lt.route.get()==="/login"&&Lt.navigate("/",!0)}});export{qe as A,P as C,D as R,p as S,Ls as T,b as a,he as b,k as c,Ts as d,N as e,Is as n,j as r,y as t};
