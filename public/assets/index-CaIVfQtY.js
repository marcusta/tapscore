(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const ma="modulepreload",ga=function(s){return"/tapscore/"+s},xn={},ba=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");i=c(t.map(u=>{if(u=ga(u),u in xn)return;xn[u]=!0;const p=u.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=p?"stylesheet":ma,p||(h.as="script"),h.crossOrigin="",h.href=u,d&&h.setAttribute("nonce",d),document.head.appendChild(h),p)return new Promise((g,v)=>{h.addEventListener("load",g),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return i.then(l=>{for(const d of l||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},zi="/tapscore/".replace(/\/+$/,""),As=zi+"/api",Xt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},_a=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Bi(s,e){const t={};for(const[n,i]of _a)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Li=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],ya={thin:"1px",medium:"3px",thick:"5px"};function Fi(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":ya[e.toLowerCase()]??e}function va(){return Li.map(s=>{const e=Fi(Xt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Gi={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},ji={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},wa={...ji,"done-opacity":"0.35"},xa={...Gi,...ji,...Xt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},$a={...Gi,...wa,...Xt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class ka{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Di(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ke=new ka;function Di(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class f{constructor(e){this.subs=new Set,this.val=e}get(){return ke.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ke.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ke.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ke.notify(t.subs))})},deps:new Set};n.run()}get(){return ke.subscribe(this.subs),this.val}peek(){return this.val}}function I(s){const e={run(){ke.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Di(e)}}function lt(s){ke.batch(s)}function se(s){return ke.untrack(s)}class Sa{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const W=new Sa,Je=zi;function zs(s){return Je?s===Je?"/":s.startsWith(Je+"/")?s.slice(Je.length):s:s}function Ta(s){return Je+s}class G{constructor(){this.route=new f(zs(location.pathname??"/")),this.search=new f(location.search??""),window.addEventListener("popstate",()=>lt(()=>{this.route.set(zs(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",l=i>=0?e.slice(0,i):e,d=l.indexOf("?"),c=d>=0?l.slice(0,d):l,u=d>=0?l.slice(d+1):"",p=n.query!==void 0?Pa(n.query):u?"?"+u:"",m=Ta(c)+p+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),lt(()=>{this.route.set(c),this.search.set(p)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const n=this.route.get().split("/"),i={};for(const[r,l]of t.entries())l.startsWith(":")&&(i[l.slice(1)]=n[r]??"");return i})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Pa(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function Ia(s){return e=>s[e]}const Ca="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",$n="data-basics-global";function Ea(){if(document.head.querySelector(`style[${$n}]`))return;const s=document.createElement("style");s.setAttribute($n,""),s.textContent=va()+Ca,document.head.appendChild(s)}function Ra(s,e){Ea();const t=new Set(Li),n=(r,l,d)=>{const c=Object.entries(r).map(([u,p])=>`--${u}:${t.has(u)?Fi(p):p}`).join(";");return`${l}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const kn="basics-js-theme";class Na{constructor(){this.dark=new f(!1);const e=localStorage.getItem(kn),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),I(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(kn,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function Oa(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Sn=new Set;class M{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Sn.has(t)){Sn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return W.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=se(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){se(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(l=>this.track(l)),r=e.content.cloneNode(!0);for(const l of r.querySelectorAll("[bind]")){const d=t[l.getAttribute("bind")];if(d)if(typeof d=="function")i(I(()=>{const c=d();l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement?l.value=String(c):l.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const p=c.includes("-");c.startsWith("on")&&typeof u=="function"?l.addEventListener(c.slice(2),u):typeof u=="function"?i(I(()=>{const m=u();p?l.setAttribute(c,String(m)):l[c]=m})):p?l.setAttribute(c,String(u)):l[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof M?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,l,...d)=>this.spawn(r,l,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,l)=>l){const r=typeof t=="function"?t:()=>t.get(),l=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(I(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(l.has(g))u.set(g,l.get(g));else{const v=[];u.set(g,se(()=>n(h,m,w=>v.push(w)))),d.set(g,v)}}for(const[m,h]of l)u.has(m)||(h.remove(),se(()=>d.get(m)?.forEach(g=>g())),d.delete(m));let p=e.firstChild;for(const m of u.values())m===p?p=p.nextSibling:e.insertBefore(m,p);l.clear();for(const[m,h]of u)l.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(I(()=>{r&&(r.remove(),r=null);const l=t.get();r=se(()=>l?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(I(()=>{if(r){const c=r;r=null,se(()=>c.destroy())}e.textContent="";const l=t.get(),d=n[l]??Oa(l,n)??i;d&&(r=se(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ht=new Set;function Ha(s){return Ht.add(s),()=>Ht.delete(s)}function Ma(){for(const s of Array.from(Ht)){Ht.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Aa(s,e,t){const n=document.querySelector(e);n.textContent="";const i=W.get(G);let r=null,l=!1,d=null,c=!!t?.hot?.data.hmr;const u=async p=>{r&&(r.destroy(),r=null,n.textContent=""),p?(d||(d=(await ba(()=>import("./obs-shell.component-CcPrGwOo.js"),[])).ObsShellComponent),r=se(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=se(()=>new s)),se(()=>r.mount(n)),l=p};await u(zs(location.pathname).startsWith("/_obs")),I(()=>{const p=i.route.get().startsWith("/_obs");p!==l&&u(p)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(p){console.error("[startApp] the root component threw while disposing",p)}if(r=null,Ma(),t.onDispose)try{t.onDispose()}catch(p){console.error("[startApp] onDispose threw",p)}}),t.hot.accept())}class X extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const za=10,Et=[];let Rt=[],it=null;function Ba(s){Et.push(s),Et.length>za&&Et.shift()}function qi(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Et],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Rt.push(n),La()}function La(){it||(it=setTimeout(Vi,5e3))}function Vi(){if(it&&(clearTimeout(it),it=null),Rt.length===0)return;const s=Rt;Rt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${As}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${As}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Vi()});const Fa=3e4,Ga=2,yt=new Map,Ui=new WeakMap;function ja(s){if(s instanceof X)return s.traceId;if(s!=null&&typeof s=="object")return Ui.get(s)}async function _(s){if(s.method==="GET"){const e=yt.get(s.url);if(e)return e;const t=Tn(s,Ga);return yt.set(s.url,t),t.then(()=>yt.delete(s.url),()=>yt.delete(s.url)),t}return Tn(s,0)}async function Tn(s,e){const t=s.timeout??Fa;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await qa(Da(s,r),t)}catch(l){if(n=l,!(l instanceof X)&&l!=null&&typeof l=="object"&&Ui.set(l,r),l instanceof X||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw n}async function Da(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Ba({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const l=await i.json().catch(()=>({error:i.statusText}));throw new X(i.status,l.error??i.statusText,l.details,r)}return i.json()}function qa(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Bs=new Set;let ps=!1;function Va(s){return Bs.add(s),()=>{Bs.delete(s)}}function Ki(){if(!ps){ps=!0;try{for(const s of[...Bs])try{s()}catch(e){try{qi("session-listener",Ua(e))}catch{}}}finally{ps=!1}}}function Ua(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function L(s,e,t,n={}){lt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=Ka(i);lt(()=>{s.set(!1),e.set(r)}),qi(r.code,r.message,ja(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Ki();return}}function Ka(s){return s instanceof X?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const fs={sessionExpiry:!1};function Wa(s){return{me:()=>_({method:"GET",url:`${s}/auth/me`}),login:e=>_({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>_({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>_({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class q{constructor(){this.api=Wa(As),this.currentUser=new f(null),this.loading=new f(!1),this.error=new f(null),this.offSessionExpired=Va(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Ha(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await L(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await L(this.loading,this.error,()=>this.api.login({username:e,password:t}),fs);return n?(this.currentUser.set(n),!0):!1}async logout(){await L(this.loading,this.error,()=>this.api.logout(),fs);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await L(this.loading,this.error,()=>this.api.logoutAll(),fs),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Wi={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Ya={...Wi,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Xa={...Wi,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Qa=Bi(Ya,xa),Ja=Bi(Xa,$a),o=Ra(Qa,Ja),B=s=>`var(--${s})`,C=(s,e)=>`var(--${s}, ${e})`,E=s=>{const e=Xt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=Ia({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),vt=s=>`
    ...
    cursor: not-allowed;`,Za={primary:vt("primary"),secondary:vt("secondary"),ghost:vt("ghost"),danger:vt("danger"),disabled:Yi},x=(s=C("btn-radius",E("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Za[e]}
    &:disabled {${Yi}}
`,eo=`max(${C("field-border-width",E("field-border-width"))}, ${C("field-rule-width",E("field-rule-width"))})`,wt=(s,e)=>`
    border-top-color: ${s};
...
`);class Fo extends M{static styles=`
        .dock {
    ...
    `;router=this.inject(G);auth=this.inject(q);landing=this.inject(Zt);newCount=new S(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Bo,{bar:{className:()=>In(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return zo(r)?In(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Mo(Ji),n=Math.ceil(t.length/2),i=(r,l)=>this.wireEl(Lo,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const d=this.newCount.get();return d===0?"":String(d)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},l);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,l,d)=>i(r,d),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,l,d)=>i(r,d),r=>r.key),e}}const Zi=["tee","approach","putting","shortGame","penalties","recovery"],Nt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function er(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Go(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const jo="Track statistics",Do="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function tr(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Mt(s,e){return s[e]}function qo(s,e){if(!s.enabled)return!0;const t=tr(e);return t===null?!1:!Mt(s,t)}function Vo(s,e){if(!s.enabled)return null;const t=tr(e);return t===null||Mt(s,t)?null:`Needs ${er(t)}`}function Uo(s,e,t){return Wo({...s,[e]:t})}function Ko(s,e){return{...s,enabled:e}}function Wo(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function gs(s){const e={...Nt,enabled:s.enabled};for(const t of Zi)e[t]=s[t];return e}function Yo(s){return s.avatarVersion?`${U}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function Xo(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return($t(t[0])+$t(t[t.length-1])).toUpperCase();if(t.length===1)return $t(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?$t(n).toUpperCase():"•"}function $t(s){return[...s][0]??""}const kt=512,Qo=2*1024*1024;function Jo(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Zo=.85;class et extends Error{}async function el(s){let e;try{e=await createImageBitmap(s)}catch{throw new et("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Jo(e.width,e.height),r=document.createElement("canvas");r.width=kt,r.height=kt;const l=r.getContext("2d");if(!l)throw new et("This browser cannot process images.");l.drawImage(e,t,n,i,i,0,0,kt,kt);const d=await new Promise(c=>r.toBlob(c,"image/jpeg",Zo));if(!d)throw new et("That image could not be processed.");if(d.size>Qo)throw new et("That image is too large.");return d}finally{e.close()}}async function tl(s){const e=await fetch(`${U}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await sr(e);return await e.json()}async function sl(){const s=await fetch(`${U}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await sr(s)}async function sr(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new X(t,nl(e.error,s.status))}function nl(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Ce{loading=new f(!1);error=new f(null);player=new f(null);history=new f([]);clubs=new f([]);teeRoles=new f([]);saving=new f(!1);saveError=new f(null);statsConfig=new f(Nt);statsSaving=new f(!1);statsError=new f(null);hasRecordedStats=new f(!1);avatarSaving=new f(!1);avatarError=new f(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await L(this.loading,this.error,()=>Promise.all([y.players.me(),y.players.myHandicapHistory(),y.clubs.list(),y.courses.teeRoleCatalog().catch(()=>[]),y.playerStats.myConfig().catch(()=>null),y.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,l,d,c]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.teeRoles.set(l),this.statsConfig.set(d?gs(d):Nt),this.hasRecordedStats.set((c?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.teeRoles.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Nt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await L(this.saving,this.saveError,()=>y.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveDisplayName(e){const t=await L(this.saving,this.saveError,()=>y.players.updateProfile({displayName:e}));return t?(this.player.set(t),!0):!1}async confirmHandicap(){const e=await L(this.saving,this.saveError,()=>y.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await L(this.saving,this.saveError,()=>y.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await L(this.saving,this.saveError,()=>y.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async savePreferredTeeRole(e){const t=await L(this.saving,this.saveError,()=>y.players.updateProfile({preferredTeeRoleKey:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await L(this.statsSaving,this.statsError,()=>y.playerStats.putMyConfig(gs(e)));return t?(this.statsConfig.set(gs(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await el(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof et?i.message:"That image could not be prepared."}),!1}const n=await L(this.avatarSaving,this.avatarError,()=>tl(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await L(this.avatarSaving,this.avatarError,()=>sl().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function St(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function bs(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function At(s,e="frecency"){return e==="alpha"?[...s].sort(bs):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,l=i>0,d=r>0;if(l!==d)return l?-1:1;if(!l)return bs(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,p=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==p?m-p:bs(t,n)})}const il=1440*60*1e3;function rl(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/il);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function al(s,e){if(s.sharedRoundCount<=0)return"never played";const t=rl(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function ol(s){return`@${s.username}`}function ll(s){return s.homeClubName?.trim()??""}const nr=2;function Cn(s){return s.trim().length>=nr}function ir(s){return At(s,"frecency")}function dl(s,e){return ir([...s.filter(t=>t.id!==e.id),e])}function cl(s,e){return s.filter(t=>t.id!==e)}function En(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function ul(s,e,t=()=>{},n=300){let i=0,r;return l=>{const d=l.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<nr){e(d,[]);return}r=setTimeout(()=>{s(d).then(u=>{c===i&&e(d,u)},u=>{c===i&&t(d,u)})},n)}}const rr=Ye("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function hl(s=Q()){return rr.read(s)}function pl(s,e=Q()){rr.write(s,e)}class es{loading=new f(!1);error=new f(null);friends=new f([]);loaded=new f(!1);sortMode=new f(hl());query=new f("");searching=new f(!1);searchError=new f(null);results=new f([]);resultsFor=new f("");mutating=new f(!1);mutateError=new f(null);runSearch=ul(e=>y.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await L(this.loading,this.error,()=>y.friends.list());t&&(this.friends.set(ir(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await L(this.mutating,this.mutateError,()=>y.friends.add({friendId:e.id}))&&(this.friends.set(dl(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(En(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),pl(e)}async remove(e){await L(this.mutating,this.mutateError,()=>y.friends.remove({friendId:e}))&&(this.friends.set(cl(this.friends.get(),e)),this.results.set(En(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class en{feed=new f(null);loading=new f(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await y.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function tt(s,e){return s instanceof X&&s.status===401?(Ki(),"Your session expired — sign in again."):e}function zt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function fl(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${zt(s.scoreToPar)}`}function ar(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function or(s){return(s.courseName??"").trim()||null}function ml(s){const e=[];for(const t of s){const n=t.friends[0],i=ar(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:or(t),progress:fl(n)})}return e}function gl(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function bl(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function _l(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function yl(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${zt(s.scoreToPar)}`}function vl(s){const e=[];for(const t of s){const n=t.friends[0],i=ar(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:or(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function lr(s){if(s instanceof X){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Ue={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function wl(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function xl(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function $l(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${zt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${zt(s.scoreToPar)}`}}}function kl(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function Sl(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function Tl(s){return s===1?"1 course played":`${s} courses played`}const _s={rounds:[],nextCursor:null,hasMore:!1};function Rn(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function dr(s){return s.hasMore&&s.nextCursor!==null}class ts{playerId=new f(null);unavailable=new f(null);profile=new f(null);profileLoading=new f(!1);profileError=new f(null);profileLoaded=!1;rounds=new f(_s);roundsLoaded=new f(!1);roundsLoading=new f(!1);loadingMore=new f(!1);roundsError=new f(null);roundsGeneration=0;courses=new f([]);coursesHasMore=new f(!1);coursesLoaded=new f(!1);coursesLoading=new f(!1);coursesError=new f(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await y.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(tt(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await y.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(Rn(_s,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(tt(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!dr(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await y.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(Rn(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(tt(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await y.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(tt(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=lr(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(_s),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function cr(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function Pl(s){return Math.round(cr(s))}function Il(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),l=i-r*n,d=r+(e>n-l?1:0);return d===0?0:-d}function Cl(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function be(){return Cl()}const Ae=10;class Ke{loading=new f(!1);error=new f(null);descriptors=new f([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await L(this.loading,this.error,()=>y.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=be()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=be()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=be()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=be()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=be()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,l=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==l?r-l:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=be()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Ae:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const Nn=["scramble","foursomes","greensomes"];class El{loading=new f(!1);error=new f(null);descriptors=new f([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof y.setup?.formations=="function")return this.inFlight=(async()=>{const e=await L(this.loading,this.error,()=>y.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=Nn.indexOf(n);return i===-1?Nn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=be()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const Rl=180,On=4,Nl=12;function qe(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function Ol(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<Nl)return 0;const i=e+t*Rl,r=Math.round(-i/n);return Math.max(-On,Math.min(On,r))}const Hn="tapscore:pending-scores:v1",Hl=336*60*60*1e3,Mn=200;function Ml(){try{return globalThis.localStorage??null}catch{return null}}function Al(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class zl{entries=[];storage;constructor(e=Ml(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Hl);return t.length>Mn?t.slice(t.length-Mn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Hn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Al):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Hn,JSON.stringify(this.entries))}catch{}}}const $e=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","putts","penalties","penalty_source"],Bl={minPar:4},Ll={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Missed where",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},Fl={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Around the green"}]}};function Ls(s){return Ll[s]}function An(s){return Fl[s]}function Gl(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function ur(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function jl(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function Dl(s,e,t){return e-t<=s-2?"1":"0"}function Fs(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class ql{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=zn(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=zn(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!jl(this.par,this.strokes,e)?null:Dl(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Fs(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of $e)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Fs(this).state};`,e}get prompts(){const e=[];for(const t of $e)this.isVisible(t)&&e.push({key:t,label:Ls(t),control:An(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&ur(Bl,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune())}step(e,t){const n=An(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<$e.length;e++){let t=!1;for(const n of $e){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),Vl(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of $e){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function Vl(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function zn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of $e){const n=s[t];n!==void 0&&e.set(t,n)}return e}const Bn="tapscore:pending-stat-events:v1",Ul=336*60*60*1e3,Ln=500;function Kl(){try{return globalThis.localStorage??null}catch{return null}}function Wl(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Yl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&$e.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Xl{entries=[];storage;makeId;constructor(e=Kl(),t=Date.now(),n=Wl){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const l=[];for(const d of i){const c={token:e,playHoleId:t,playerId:n,key:d.key,value:d.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(p=>p.token===e&&p.playHoleId===t&&p.playerId===n&&p.key===d.key);u>=0?this.entries[u]=c:this.entries.push(c),l.push(c)}return this.entries=this.applyHygiene(r),this.persist(),l}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Ul);return t.length>Ln?t.slice(t.length-Ln):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Bn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Yl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Bn,JSON.stringify(this.entries))}catch{}}}const Ql=50;function Jl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const tn=Ye("tapscore.result-cursors.v1",Xs(Jl),Ql);function sn(s=Q()){return tn.read(s)}function Zl(s,e=Q()){return sn(e).find(t=>t.token===s)?.cursor??null}function ed(s,e,t=Q()){if(!t)return[];const n=sn(t).filter(i=>i.token!==s);return tn.write([{token:s,cursor:e},...n],t)}function td(s,e=Q()){if(!e)return[];const t=sn(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&tn.write(n,e),n}const sd=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Re=(s,e)=>`${s}|${e}`;function nn(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function nd(s,e,t){return ur(s,e,t)}function ys(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function id(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function rd(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class ge{constructor(e=new zl,t=new Xl){this.queue=e,this.statQueue=t}queue;statQueue;loading=new f(!1);error=new f(null);friendlyRound=new f(null);round=new f(null);startList=new f(null);balls=new f([]);firstOpen=new f(!1);firstOpenRoundId=null;scorecards=new f([]);cells=new f(new Map);statModules=new f(new Map);statRows=new f([]);statRev=new f(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new f(null);resultLoading=new f(!1);resultError=new f(null);resultCursor=null;holeIdx=new f(0);groupIdx=new f(0);keypadOpen=new f(!1);finishFlowOpen=new f(!1);selectedSlot=new f(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),W.get(Ke).load();const r=await L(this.loading,this.error,()=>y.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Ze({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!To(r.round.id))),W.get(q).currentUser.get()&&Po(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[l,d,c,u]=await Promise.all([y.friendlyRounds.balls({token:e}).catch(()=>[]),y.friendlyRounds.scorecard({token:e}).catch(()=>[]),y.playerStats.configsByToken({token:e}).catch(()=>null),y.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(p=>[p.playerId,p.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(d),this.balls.set(l),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new f(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await y.friendlyRounds.remove({token:e}),Qi(e);const t=this.round.get()?.id;return t&&Xi(t),td(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new f(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await y.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Ze({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await y.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Ze({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await L(this.resultLoading,this.resultError,()=>y.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await y.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await y.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const l=await y.friendlyRounds.balls({token:e}).catch(()=>null);if(l===null||i())return;this.balls.set(l)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?Zl(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&ed(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await y.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Ze({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new S(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,nn(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new S(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(l=>n.subjectLabels?.some(d=>d.ballId===l&&d.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const l=r.entries.find(d=>i(d.ballIds));if(!l)continue;return l.total===null?null:l.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-l.paceDelta:l.paceDelta}:{kind:"total",total:l.total}}if(r.kind==="match_summary"){const l=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!l)continue;if(l.thru===0&&!l.finished)return null;const d=i(l.sideA.ballIds)?"a":"b";if(l.leader===null||l.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=l.leader===d;return{kind:"match",text:`${l.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return qe(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(l=>l.id===e);if(!t||!n)return"";const i=t.playHoles.filter(l=>l.courseHoleNumber===n.courseHoleNumber).sort((l,d)=>l.ordinal-d.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(l=>l.id===e);return`${n.courseHoleNumber} (${sd[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(qe(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(qe(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(l=>{const d=n.get(l.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return d?.strokes===null||d===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Re(e,t));return n?n.strokes:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Re(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const l=this.playHoleById(t);if(!l)return null;const d=i.players[0]?.teeName??null,c=l.tees.find(u=>u.teeName===d)?.strokeIndex??l.baseStrokeIndex;return Il(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Fs(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new ql(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?id(t):new Map;for(const i of $e){const r=ys(e,i);if(!this.statLocal.has(r))continue;const l=this.statLocal.get(r)??null;l===null?n.delete(i):n.set(i,l)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=ys(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=ys({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await y.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return rd(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Re(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=W.get(Ke),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const l=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of l)i.has(d.key)||(i.add(d.key),n.push(d))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>nd(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Re(e,t),l=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:l});const d=this.token;d&&(this.enqueue(d,e,t,n,i,l),await this.post(d,e,t,n,i,l))}async retry(e,t){const n=Re(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Re(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,l){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:l,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,l){const d=Re(t,n);try{await y.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:l,...r!=null?{metadata:r}:{}}),this.queue.remove(l);const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class hr{roundId=new f(null);view=new f(null);balls=new f([]);loading=new f(!1);error=new f(null);unavailable=new f(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await y.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=lr(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(tt(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await y.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new S(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,nn(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new S(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class pr{roles=new f([]);rolesPromise=null;loading=new f(!1);error=new f(null);stats=new f(null);rounds=new f([]);players=new f([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await y.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await L(this.loading,this.error,()=>Promise.all([y.admin.adminStats(),y.admin.adminRounds({limit:100}),y.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const ad=["last5","last10","last20","thisYear","all","custom"];function Bt(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function od(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function rn(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const rt={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function ld(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function dd(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function vs(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function cd(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function ss(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function fr(s){return`${s.getFullYear()}-`}function mr(s,e,t,n){const i=ss(t);switch(s){case"last5":case"last10":case"last20":{const r=rn(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=fr(n);return i.filter(l=>l.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>dd(e,r))}}function gr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const l=rn(e);return l===null?!1:n.length<l}case"thisYear":{const l=`${fr(r)}01-01`;return!n.some(d=>d.date<l)}case"all":return!0;case"custom":{if(ld(t))return!1;if(t.from===null)return!0;const l=t.from;return!n.some(d=>d.date<l)}}}const ud="Unnamed course";function hd(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??ud,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Lt="last10";function pd(s){return ad.includes(s)}const br=Ye("tapscore.stats.window.v1",{decode:s=>pd(s)?s:Lt,encode:s=>s,empty:Lt});function Gs(s=Q()){return br.read(s)}function Fn(s,e=Q()){br.write(s,e)}function $(s,e){return{value:e===0?null:s/e,n:s,d:e}}const fd=5;function md(s,e=fd){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const Ft=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0});function gd(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker}}function bd(s){let e=Ft;for(const t of s)e=gd(e,t);return e}const Be=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function ns(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function _d(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function yd(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function vd(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function _r(s){return $(s.fairwayHits,s.teeRecorded)}function wd(s){return $(s.troubleCount,s.teeRecorded)}function xd(s){return $(s.holesScoredPenalty,s.holesScored)}function $d(s){return{penalty:$(s.strokesVsParPenalty,s.holesScoredPenalty),clean:$(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function kd(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return $(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Sd(s){return $(s.recoverySuccesses,s.recoveryAttempts)}function Td(s,e){return $(s.penaltiesTotal,e)}function Pd(s){return{fairway:$(s.strokesVsParFairway,s.holesScoredFairway),inPlay:$(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:$(s.strokesVsParTrouble,s.holesScoredTrouble)}}function Id(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return $(e,s.holesScoredTrouble*s.holesScoredFairway)}function yr(s){return $(s.girHits,s.girRecorded)}function Cd(s){return{fairway:$(s.girHitsFairway,s.girRecordedFairway),inPlay:$(s.girHitsInPlay,s.girRecordedInPlay),trouble:$(s.girHitsTrouble,s.girRecordedTrouble)}}function Ed(s){return{par3:$(s.girHitsPar3,s.girRecordedPar3),par4:$(s.girHitsPar4,s.girRecordedPar4),par5:$(s.girHitsPar5,s.girRecordedPar5)}}function Rd(s){const e=$(s.strokesVsParGirHit,s.girHolesScored),t=$(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:$(n,s.holesScoredGirMiss*s.girHolesScored)}}function Nd(s,e){return $(vd(s,e),s.girFirstPuttRecorded)}function Od(s){let e=0;for(const t of Be)e+=ns(s,t);return e}function Hd(s,e){return $(ns(s,e),Od(s))}function Md(s){return $(s.birdiesOnGir,s.girHolesScored)}function Ad(s){return $(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function zd(s){const e=s.greenMissRecorded;return{long:$(s.greenMissLong,e),short:$(s.greenMissShort,e),left:$(s.greenMissLeft,e),right:$(s.greenMissRight,e)}}function Bd(s){return{left:$(s.teeMissLeft,s.teeMissRecorded),right:$(s.teeMissRight,s.teeMissRecorded),troubleLeft:$(s.teeTroubleLeft,s.teeMissLeft),troubleRight:$(s.teeTroubleRight,s.teeMissRight)}}function Ld(s){const e=s.penaltySourceRecorded;return{tee:$(s.penaltiesTee,e),approach:$(s.penaltiesApproach,e),short:$(s.penaltiesShort,e)}}function Fd(s,e){return $(yd(s,e),ns(s,e))}function Gd(s){return $(s.threePutts,s.puttsRecorded)}function jd(s){const e=s.puttsRecorded;return{zero:$(s.holesZeroPutt,e),one:$(s.holesOnePutt,e),two:$(s.holesTwoPutt,e),threePlus:$(s.threePutts,e)}}function Dd(s){return{par3:$(s.puttsTotalPar3,s.puttsRecordedPar3),par4:$(s.puttsTotalPar4,s.puttsRecordedPar4),par5:$(s.puttsTotalPar5,s.puttsRecordedPar5)}}function qd(s){return $(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function Vd(s){return $(s.puttsTotalGir,s.puttsRecordedGir)}function Ud(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return $(e,t)}function vr(s){return{standard:$(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:$(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:$(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:$(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function Kd(s){return $(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function Wd(s){return $(s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Yd(s){return $(s.holesMultiChipBunker,s.scrambleAttemptsBunker)}function Xd(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Qd(s){return{standard:$(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:$(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:$(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:$(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function Jd(s){return{par3:$(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:$(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:$(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Zd(s,e){return $(s.doubleBogeyPlus,e)}function ec(s){return $(s.bounceBackSuccesses,s.bounceBackOpportunities)}const tc=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],sc=18;function nc(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let p=r.get(c.holeCount);if(p||(p={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,p)),p.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;p.completeRounds+=1;const h=u.strokesTotal-u.parTotal;(p.best===null||h<p.best.vsPar)&&(p.best={vsPar:h,strokes:u.strokesTotal})}const l=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let d=0;for(const c of l)d+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:d,lengths:l,avgVsParPer18:$(n*sc,t),scoreTypeCounts:i}}const wr=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),xr=Object.freeze({inside2m:1.25,outside2m:2.12}),$r=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),kr=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),ic=["scratch","hcp5","hcp12","hcp20"];function an(s){return s===null?"hcp12":s<2.5?"scratch":s<8.5?"hcp5":s<16?"hcp12":"hcp20"}function rc(s){return Math.round(4*s.eHole[3]+10*s.eHole[4]+4*s.eHole[5])}const ac=Object.freeze({version:"v1-provisional-scratch",calibratedAt:null,eHole:Object.freeze({3:3.25,4:4.15,5:4.85}),eAfterTee:Object.freeze({4:Object.freeze({fairway:2.95,in_play:3.25,trouble:3.7}),5:Object.freeze({fairway:3.65,in_play:3.95,trouble:4.4})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),oc=Object.freeze({version:"v1-provisional-hcp5",calibratedAt:null,eHole:Object.freeze({3:3.4,4:4.45,5:5.1}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.2,in_play:3.6,trouble:4.05}),5:Object.freeze({fairway:3.9,in_play:4.25,trouble:4.55})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),lc=Object.freeze({version:"v1-provisional-hcp20",calibratedAt:null,eHole:Object.freeze({3:3.9,4:5.1,5:5.9}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.85,in_play:4.2,trouble:4.85}),5:Object.freeze({fairway:4.65,in_play:5,trouble:5.65})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),dc=Object.freeze({inside_1m:1.02,"1_to_2m":1.35,"2_to_4m":1.72,"4_to_8m":1.95,over_8m:2.2}),cc=Object.freeze({inside_1m:1.03,"1_to_2m":1.4,"2_to_4m":1.78,"4_to_8m":2.02,over_8m:2.3}),uc=Object.freeze({inside_1m:1.08,"1_to_2m":1.5,"2_to_4m":1.92,"4_to_8m":2.2,over_8m:2.55}),hc=Object.freeze({inside2m:1.19,outside2m:1.96}),pc=Object.freeze({inside2m:1.22,outside2m:2.03}),fc=Object.freeze({inside2m:1.29,outside2m:2.22}),mc=Object.freeze({standard:1.55,hard:1.9,bunker:1.75}),gc=Object.freeze({standard:1.62,hard:2,bunker:1.85}),bc=Object.freeze({standard:1.8,hard:2.25,bunker:2.08}),ft=Object.freeze({scratch:Object.freeze({tables:ac,expected:dc,chipOutcome:hc,chipBaseline:mc}),hcp5:Object.freeze({tables:oc,expected:cc,chipOutcome:pc,chipBaseline:gc}),hcp12:Object.freeze({tables:kr,expected:wr,chipOutcome:xr,chipBaseline:$r}),hcp20:Object.freeze({tables:lc,expected:uc,chipOutcome:fc,chipBaseline:bc})}),mt=ft.hcp12,ue=["tee","approach","shortGame","putting","penalties"];function Sr(s,e=kr,t=wr,n=xr,i=$r){const r=s.attHolesPar3Gir+s.attHolesPar3Miss,l=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,d=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,c=r+l+d,u={attributed:c,holesScored:s.holesScored};if(c===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const p=l+d,m=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,h=s.attMissStandard+s.attMissHard+s.attMissBunker,g=r*e.eHole[3]+l*e.eHole[4]+d*e.eHole[5],w=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+r*e.eHole[3],T=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m,N=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,z=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,K=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),O=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),J=s.attStrokes-s.attPutts-s.attPenalties-p-m+T+K-w,de=m-h+N-z,ce=s.attPutts-(T+N),pa=s.attPenalties,fa=s.attStrokes-g;return{tee:O,approach:J,shortGame:de,putting:ce,penalties:pa,total:fa,coverage:u}}function Gt(s,e=mt){return Sr(s,e.tables,e.expected,e.chipOutcome,e.chipBaseline)}const Tr=9;function Te(s,e){return Pr(s,We(s,e))}function Gn(s){return Pr(s,s.total)}function Pr(s,e){return e===null||s.coverage.attributed<Tr?null:e*18/s.coverage.attributed}function We(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function Ir(s,e){const t=n=>jn(Te(s,n),e.map(i=>Te(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:jn(Gn(s),e.map(Gn))}}function on(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function ln(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function jn(s,e){if(s===null)return null;const t=ln(e);return t===null?null:s-t}function _c(s){return s.penalties}const Dn=1,yc=2,vc=.75,wc=4,xc=3,$c=12,kc=5,Sc=2,Tc=10,qn=.35;function Pc(s,e,t,n){const i=Ir(e,t),r=[];let l=0;const d=(T,N)=>{r.push({line:T,magnitude:N,order:l++})};let c=null,u=null;for(const T of ue){const N=on(i,T);N!==null&&((c===null||N<c.delta)&&(c={component:T,delta:N}),(u===null||N>u.delta)&&(u={component:T,delta:N}))}c!==null&&c.delta<=-Dn&&d({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=Dn&&d({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const p=ln(t.map(_c)),m=e.penalties;p!==null&&m!==null&&m>=p+yc&&d({id:"penalties_spike",params:{penalties:m,baseline:p}},0),s.teeMissRecorded>=Tc&&s.teeMissLeft>=qn*s.teeMissRecorded&&s.teeMissRight>=qn*s.teeMissRecorded&&d({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=xc&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&d({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const h=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,g=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;h>=wc&&g>=vc*h&&d({id:"scramble_streak",params:{successes:g,attempts:h}},0),s.threePutts===0&&s.puttsTotal>=$c&&d({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const v=Te(e,"putting"),w=t.map(T=>Te(T,"putting")).filter(T=>T!==null);return v!==null&&w.length>=kc&&w.every(T=>v<T)&&d({id:"best_putting_round",params:{putting:v,rounds:w.length}},0),s.bounceBackOpportunities>=Sc&&s.bounceBackSuccesses===s.bounceBackOpportunities&&d({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((T,N)=>N.magnitude-T.magnitude||T.order-N.order),r.slice(0,Math.max(0,n)).map(T=>T.line)}const Cr=["auto",...ic],js="auto";function dt(s){switch(s){case"scratch":return"Scratch";case"hcp5":return"5 handicap";case"hcp12":return"12 handicap";case"hcp20":return"20+ handicap"}}function Vn(s){return s==="auto"?"Match my handicap":dt(s)}function Ic(s,e){return s!=="auto"?`About ${rc(ft[s].tables)} shots on a par 72.`:e===null?`No handicap on your profile yet, so this uses the ${dt("hcp12")} reference.`:`Your ${dn(e)} handicap puts you on the ${dt(an(e))} reference.`}function dn(s){return s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}function cn(s,e){return s==="auto"?an(e):s}const Cc=Object.freeze({cohort:an(null),choice:js,handicapIndex:null});function Ec(s,e){return{cohort:cn(s,e),choice:s,handicapIndex:e}}function Rc(s){return Cr.includes(s)}const Er=Ye("tapscore.stats.sgBaseline.v1",{decode:s=>Rc(s)?s:js,encode:s=>s,empty:js});function Ds(s=Q()){return Er.read(s)}function Nc(s,e=Q()){Er.write(s,e)}const Un=Object.freeze(Object.keys(Ft));function Oc(s){if(typeof s!="object"||s===null)return[...Un];const e=s;return Un.filter(t=>typeof e[t]!="number")}function jt(s){if(s.length===0)return null;const e=Oc(s[0].measures);if(e.length===0)return null;const t=e.slice(0,3).join(", "),n=e.length>3?` and ${e.length-3} more`:"";return`The server sent stats this app does not understand (missing ${t}${n}).`}const Hc=["tee","approach","putting","shortGame","scoring"];function ws(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const Mc=3,Rr={rounds:[],totals:Ft,waterfall:Sr(Ft),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function un(s,e=mt){const t=ss(s);if(t.length===0)return Rr;const n=bd(t.map(l=>l.measures)),i=t.map(l=>Gt(l.measures,e)),r=t.length;return{rounds:t.map((l,d)=>{const c=i[d];return{id:l.roundId,date:l.date,courseName:l.courseName,name:l.name,holeCount:l.holeCount,strokes:l.measures.holesScored===0?null:l.measures.strokesTotal,vsPar:l.measures.holesScored===0?null:l.measures.strokesTotal-l.measures.parTotal,waterfall:c}}),totals:n,waterfall:Gt(n,e),priorities:Ac(i),trends:zc(t,e),tee:Bc(n,r),approach:Lc(n),putting:Fc(n,e),shortGame:Gc(n),scoring:jc(n,r),results:nc(t)}}function Ac(s){const e=ue.map(n=>{const i=s.map(r=>Te(r,n));return{component:n,per18:ln(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>ue.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function xs(s){return md(s)==="percentage"?s.value:null}function zc(s,e=mt){const t=[...s].reverse(),n=(i,r,l,d)=>{const c=[];for(const u of t){const p=d(u.measures);p!==null&&c.push(p)}return c.length>=Mc?{id:i,title:r,kind:l,points:c}:null};return[n("fairway","Fairways","percentage",i=>xs(_r(i))),n("gir","Greens","percentage",i=>xs(yr(i))),n("putting","Putting","strokesLost",i=>Te(Gt(i,e),"putting")),n("scramble","Scrambling","percentage",i=>xs(vr(i).overall))].filter(i=>i!==null)}function Bc(s,e){return s.teeRecorded<=0?null:{fairway:_r(s),inPlayOnly:$(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:wd(s),troubleTax:Id(s),vsParByTee:Pd(s),recovery:Sd(s),teeMiss:Bd(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:Td(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:xd(s),penaltyTax:kd(s),vsParByPenalty:$d(s),penaltySource:Ld(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function Lc(s){if(s.girRecorded<=0)return null;const e={};for(const t of Be)e[t]=Nd(s,t);return{gir:yr(s),girByTee:Cd(s),girFirstPuttMix:e,birdieConversion:Md(s),hardChipShare:Ad(s),girByPar:Ed(s),greenMiss:zd(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:Rd(s)}}function Fc(s,e){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const t={};for(const n of Be)t[n]=Hd(s,n);return{ladder:Be.map(n=>{const i=ns(s,n),r=e.expected[n];return{bucket:n,made:Fd(s,n),baseline:Math.max(0,2-r),cost:i>0?_d(s,n)-i*r:null}}),firstPuttSpread:t,threePutt:Gd(s),threePuttsFromOver8m:qd(s),puttsPerGirHole:Vd(s),puttsAfterMissedGreen:Ud(s),puttDistribution:jd(s),puttsPerHoleByPar:Dd(s)}}function Gc(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:vr(s),chipInside2m:Qd(s),conversionInside2m:$(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:Kd(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,multiChip:Wd(s),multiChipBunker:Yd(s),extraShortGameStrokes:Xd(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded}}function jc(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Jd(s),doubleBogeyPlusPerRound:Zd(s,e),bounceBack:ec(s)}}function Nr(s){let e=0;for(const t of s)for(const n of ue){const i=We(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Dc(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function hn(s){const e=W.get(Ke);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function qc(s){const e=W.get(Ke);return e.load(),e.labelOf(s)??s}function Vc(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:xo(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(hn).join(" · ")}))}function Uc(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function ct(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Dt(s){return s.courseName?ct(s)===s.courseName?null:s.courseName:null}function Fe(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const at={fromMyRounds:Vc,fromDeviceRounds:Uc},Or="—";function he(s){return s.d<=0||s.value===null?null:`${Math.round(s.value*100)}%`}function Kc(s){return s.d<=0?null:`${ae(s.n)} of ${ae(s.d)}`}function $s(s){const e=he(s);if(e===null)return null;const t=Kc(s);return t===null?e:`${e} (${t})`}function ie(s,e=2,t=!1){return s.d<=0||s.value===null?null:t?we(s.value,e):Pe(s.value,e)}function Ge(s){return{one:s,many:`${s}s`}}const ye=Ge("round"),te=Ge("hole"),Ot=Ge("green");function Wc(s,e){return s.d<=0?null:`over ${ne(s.d,e)}`}function Kn(s,e){const t=ie(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=Wc(s,e.unit);return i===null?n:`${n} (${i})`}const Hr={one:"hole from trouble",many:"holes from trouble"},Yc={one:"from the fairway",many:"from the fairway"};function Xc(s){const e=s.trouble.d,t=s.fairway.d;return e<=0||t<=0?null:`over ${ne(e,Hr)} vs ${ne(t,Yc)}`}function Mr(s,e,t,n){return s.d<=0||t.d<=0?null:`over ${ne(s.d,e)} vs ${ne(t.d,n)}`}const Ar={one:"hole with the green missed",many:"holes with the green missed"},zr={one:"green hit",many:"greens hit"},Qc={one:"hole with a penalty",many:"holes with a penalty"},Jc={one:"without",many:"without"},Zc=Ge("penalty hole");function eu(s){return Mr(s.miss,Ar,s.hit,zr)}function tu(s){return Mr(s.penalty,Qc,s.clean,Jc)}function is(s){const e=s.filter(n=>n.d>0).map(n=>ne(n.d,n.unit)),t=e.pop();return t===void 0?null:e.length===0?`over ${t}`:`over ${e.join(", ")} and ${t}`}const su={one:"hole from the fairway",many:"holes from the fairway"},nu={one:"hole in play",many:"holes in play"},iu=Ge("par 3"),ru=Ge("par 4"),au=Ge("par 5");function ou(s){return is([{d:s.fairway.d,unit:su},{d:s.inPlay.d,unit:nu},{d:s.trouble.d,unit:Hr}])}function Wn(s){return is([{d:s.par3.d,unit:iu},{d:s.par4.d,unit:ru},{d:s.par5.d,unit:au}])}function lu(s){return is([{d:s.hit.d,unit:zr},{d:s.miss.d,unit:Ar}])}function ae(s){return s===Math.round(s)?String(Math.round(s)):Pe(s,1)}function ne(s,e){return`${ae(s)} ${s===1?e.one:e.many}`}function Pe(s,e=1){return s.toFixed(e)}function we(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return Pe(0,e);const i=Pe(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function du(s){return s===null?Or:we(s,1)}function cu(s){return`${we(s)} per 18`}function rs(s){return s===0?"E":we(s,s===Math.round(s)?0:1)}function as(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function ks(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function uu(s){return s==="indoor"?"Indoor":"Outdoor"}function hu(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Br(s){return Fe(s)}const Lr="Statistics",pu="All statistics →";function fu(s){return s==="custom"?Lt:s}function mu(s,e,t){return rn(s)!==null||!t?Bt(s):`${Bt(s)} — newest ${e}`}function gu(s){return $(s.strokesTotal-s.parTotal,s.holesScored)}function bu(s){const e=[],t=gu(s.totals),n=ie(t,2,!0);n!==null&&e.push({id:"vsPar",value:n,label:"Vs par per hole"});const i=s.tee,r=i===null?null:he(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit"});const l=s.approach,d=l===null?null:he(l.gir);return d!==null&&e.push({id:"gir",value:d,label:"Greens in regulation"}),e}function _u(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${as(e.component)}`}function yu(s){const e=fu(s.preset),t=mr(e,rt,s.rows,s.now);if(t.length===0)return null;const n=un(t,s.bundle??mt),i=bu(n);if(i.length===0)return null;const r=gr({preset:e,filter:rt,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:mu(e,t.length,r),tiles:i,priorityLine:_u(n)}}function vu(s){const e=s.tiles.map(n=>`${n.label} ${n.value}`),t=[`${Lr}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class os{static PAGE_SIZE=20;rows=new f(null);hasMore=new f(!1);preset=new f(Gs());sgChoice=new f(Ds());profile=W.get(Ce);loaded=!1;loading=!1;card=new S(()=>{const e=this.rows.get();if(e===null)return null;const t=cn(this.sgChoice.get(),this.profile.player.get()?.handicapIndex??null);return yu({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date,bundle:ft[t]})});refreshPreset(){this.preset.set(Gs()),this.sgChoice.set(Ds())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await y.playerStats.myStats({limit:os.PAGE_SIZE});if(jt(t.rounds)!==null)return;this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof X&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const vn=class vn extends M{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(I(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};vn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let le=wn;async function wu(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const xu="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Ee(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Se(s){const e=()=>Yo(s());return{avatarPhoto:{src:()=>e()??xu,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return Xo(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Le(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function $u(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function ku(s){return $u(s).map(e=>e.kind)}function Yn(s){return s.signedIn?"avatar":"signin"}const Su=b(`
...
`);class Tu extends M{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),Hu='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',pn=`
...
`,Mu=b(`
    <div class="round-row">
        ...
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Hu}</button>
...
`);class Qn extends M{static styles=`
        .landing {
...
`),Gu='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',ju=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${pn}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Gu}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
    </div>
`);class Du extends M{static styles=`
        .history {
...
`,Ne=60,Zn=8,Vs=4,Xu=Array.from({length:Vs*2+1},(s,e)=>e-Vs),Qu="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Ju=b(`
...
`),ih=b('<button bind="btn" class="se-seg" type="button"></button>'),rh=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),ah=b('<div bind="rule" class="se-stats__rule"></div>');class oh extends M{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
...
</tr>`;const K=Us(n.plan.slotDefId,N.ballIds),O=n.isOpen(K),J=Eh(K),de=Kr(z,n.routeSections,e,{mode:n.mode??"product"}),ce=["lb-rank__row--expandable"];return g.lead&&ce.push("lb-rank__lead"),O&&ce.push("lb-rank__row--open"),`<tr class="${ce.join(" ")}" data-expand-key="${F(K)}">
  <td class="lb-rank__pos">${g.position}</td>
...
<tr class="lb-rank__panel${O?" lb-rank__panel--open":""}" data-panel-key="${F(K)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${F(J)}"><div class="lb-rank__panelbox">${de}</div></div></td>
      ...
      <col class="lb-rank__col-pace">`:"",p=r?'<th class="lb-rank__pace">Pace</th>':"",m=l?`
...
</div>`}function Nh(s,e){const t=bh(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",l=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Oh={ranked:Rh,match_summary:(s,e)=>Nh(s,e)},Hh={"default-score-grid":Th,"compact-match-grid":Ph,"category-matrix-grid":Ih};function Mh(s){return`<div class="lb-diag">Unrenderable result section <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Ah(s){return`<div class="lb-diag">Unsupported score-grid component <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function zh(s,e,t,n=null){const i=Oh[s.kind];return i?i(s,e,t,n):Mh(s.kind)}function Kr(s,e,t,n){const i=qr(s),r=Hh[i];return r?r(s,e,t,n):Ah(i)}function Wr(s,e,t=Ur,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${F(s.formatLabel)}.</div>`:s.leaderboard.map(r=>zh(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${F(s.formatLabel)}.</div>`}function Yr(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Kr(r,e,t,{mode:i})).join(`
`)}const Bh=b(`
...
`);class bn extends M{static styles=`
    ...
    `;svc=this.inject(ge);expansion=new vh;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Bh,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const p=this.svc.nameOf(u);return this.svc.isPending(u)?`${p} (open seat)`:p},i=u=>this.svc.groupLabelOf(u),r=yh(t);this.expansion.retain(r.attached.keys());const l=Wr(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),d=Yr(r.standalone,e.routeSections,n),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return l+c}}function Lh(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Fh=b(`
...
`);class jh extends M{static styles=`
    ...
    `,ot.seq=0;let pe=ot;function qh(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Vh(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Uh(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Kh=b(`
...
`);class tp extends M{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${R()}
    ...
    `;svc=this.inject(ge);auth=this.inject(q);router=this.inject(G);tokenQ=this.router.query("token");joining=new f(!1);error=new f("");diagnostics=new f([]);teeId=new f("");tees=new f([]);loadedForCourseId=null;groupChoice=new f("");policyState(){return Jh(this.svc.startList.get())}eligible(){return this.policyState().visible&&Qh(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,y.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await y.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof X&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(I(()=>this.ensureTeesLoaded()));const e=new S(()=>Zh(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(I(()=>{const r=e.get(),l=this.groupChoice.get();(!l||!r.options.some(d=>d.value===l&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(ep,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new pe({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new pe({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const ii=1440*60*1e3;function sp(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>ii?!0:e-t>=ii}function np(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function ip(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!np(s.balls,s.playerId)||!sp(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ve(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Vt(s){return s<0?`+${String(-s)}`:String(s)}const rp=b(`
...
`);class ap extends M{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${R()}
    ...
    `;svc=this.inject(ge);auth=this.inject(q);profile=this.inject(Ce);settled=new f(!1);editing=new f(!1);text=new f("");busy=new f(!1);error=new f("");state(){const e=this.profile.player.get();return ip({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Vt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ve(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(I(()=>this.ensureProfileLoaded())),this.wire(rp,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Vt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function op(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const lp=b(`
...
`);class dp extends M{static styles=`
...
`);class vp extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(q);router=this.inject(G);stage=new f("prompt");error=new f("");render(){this.track(I(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(yp,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>up(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(bn,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=Jr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return cp({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return Xr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:Qr({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class ze{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new f(!1);error=new f(null);loaded=new f(!1);loadedRounds=new f([]);roundsWithStats=new f(null);hasMore=new f(!1);preset=new f(Gs());filter=new f(rt);sgChoice=new f(Ds());profile=W.get(Ce);handicapIndex=new S(()=>this.profile.player.get()?.handicapIndex??null);sgCohort=new S(()=>cn(this.sgChoice.get(),this.handicapIndex.get()));sgBundle=new S(()=>ft[this.sgCohort.get()]);sgInfo=new S(()=>Ec(this.sgChoice.get(),this.handicapIndex.get()));extending=new f(!1);extendError=new f(null);pagesFetched=0;cursor=null;windowRounds=new S(()=>mr(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new S(()=>un(this.windowRounds.get(),this.sgBundle.get()));courses=new S(()=>hd(this.loadedRounds.get()));overFiltered=new S(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await L(this.loading,this.error,()=>y.playerStats.myStats({limit:ze.PAGE_SIZE}));if(!t)return;const n=jt(t.rounds);if(n!==null){this.error.set({code:"server",message:n});return}this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded()}select(e){this.preset.set(e),Fn(e),this.extendIfNeeded()}selectSgBaseline(e){this.sgChoice.set(e),Nc(e)}async loadHandicap(){await this.profile.load()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),Fn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(rt),this.select(Lt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<ze.MAX_PAGES&&gr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await y.playerStats.myStats({limit:ze.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}const n=jt(t.rounds);if(n!==null){this.extendError.set({code:"server",message:n});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=ze.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(rt),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class ht{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new f("idle");failure=new f(null);roundId=new f(null);holes=new f([]);round=new f(null);history=new f([]);dashboard=W.get(ze);inFlight=null;sgInfo=this.dashboard.sgInfo;model=new S(()=>{const e=this.round.get();return e===null?null:gp({round:e,holes:this.holes.get(),history:this.history.get(),bundle:this.dashboard.sgBundle.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.dashboard.loadHandicap(),this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await y.playerStats.myRoundStats({roundId:e})}catch(l){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(oi(l)),this.failure.set(li(l));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(l){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(oi(l)),this.failure.set(li(l));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(l=>l.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(l=>l.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=l=>{for(const d of l)n.has(d.roundId)||(n.add(d.roundId),t.push(d))};if(i(this.dashboard.loadedRounds.get()),ri(t,e,Ks))return t;let r=null;for(let l=0;l<ht.MAX_PAGES;l++){const d=await y.playerStats.myStats({limit:ht.PAGE_SIZE,cursor:r??void 0}),c=jt(d.rounds);if(c!==null)throw new Error(c);if(i(d.rounds),ri(t,e,Ks)||d.nextCursor===null)return t;r=d.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function oi(s){if(s instanceof X){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function li(s){return s instanceof X&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const oe=100,Zr=88,Ws=56,di=56;function cs(s){return s>0?"loss":s<0?"gain":"zero"}function Xe(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function H(s){return String(Math.round(s*1e3)/1e3)}function us(s){return s<0?0:s>1?1:s}function Ie(s,e){return`<svg class="chart" viewBox="0 0 ${oe} ${H(s)}" preserveAspectRatio="none" style="height:${H(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function _n(s,e,t,n=1){return`<path d="M${H(s)} 0 L${H(s)} ${H(e)}" stroke="${t}" stroke-width="${H(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function me(s,e,t,n,i){return`<rect x="${H(s)}" y="${H(e)}" width="${H(t)}" height="${H(n)}" fill="${i}"/>`}const wp=1;function xp(s,e){const t=oe/2,n=cs(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:wp,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function ea(s,e,t,n=10){const i=xp(s,e),r=i.bar&&i.bar.width>0?me(i.bar.x,0,i.bar.width,n,Xe(i.tone,t)):"";return Ie(n,[me(0,0,oe,n,t.track),r,_n(i.zeroX,n,t.rule)].join(""))}function $p(s){const e=[];let t=0;for(const n of s){const i=oe*us(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function kp(s,e,t=12){const n=$p(s).filter(i=>i.width>0).map(i=>me(i.x,0,i.width,t,i.color)).join("");return Ie(t,me(0,0,oe,t,e.track)+n)}const ci=2,Sp=1e-4;function Tp(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=ci,l=Math.max(0,e-ci*2);return s.map((d,c)=>({x:s.length===1?oe/2:c/(s.length-1)*oe,y:i===0?e/2:r+l-(d-t)/i*l}))}function Pp(s){return s.map((e,t)=>`${t===0?"M":"L"}${H(e.x)} ${H(e.y)}`).join(" ")}function Ip(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Sp?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Cp(s,e,t,n=34){const i=Tp(s,n);if(i.length===0)return Ie(n,"");const r=Xe(Ip(s,e),t),l=`<path d="${Pp(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,d=i[i.length-1],c=`<path d="M${H(d.x)} ${H(d.y)} L${H(d.x)} ${H(d.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Ie(n,l+c)}const Ep=.5;function Rp(s,e,t=12){const n=oe/2,i=ue.length-1,r=Math.max(1,(t-i)/ue.length),l=[];return ue.forEach((d,c)=>{const u=We(s,d);if(u===null||!(e>0))return;const p=Math.max(u===0?0:Ep,n*Math.min(1,Math.abs(u)/e));l.push({component:d,x:u>=0?n:n-p,y:c*(r+1),width:p,height:r,tone:cs(u)})}),l}function Np(s,e,t,n=12){const i=Rp(s,e,n).filter(r=>r.width>0).map(r=>me(r.x,r.y,r.width,r.height,Xe(r.tone,t))).join("");return Ie(n,_n(oe/2,n,t.rule)+i)}const ta=1,ui=.02;function Op(s,e){const t=e>0?oe*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=us(s),i=e<=0?"neutral":s>e+ui?"gain":s<e-ui?"loss":"neutral";return{bar:{width:Math.max(ta,oe*n),tone:i},tickX:t}}function Hp(s,e,t,n=10){const i=Op(s,e),r=i.bar?me(0,0,i.bar.width,n,Xe(i.bar.tone,t)):"",l=i.tickX===null?"":_n(i.tickX,n,t.rule,2);return Ie(n,me(0,0,oe,n,t.track)+r+l)}function Mp(s){return s===null?null:Math.max(ta,oe*us(s))}function sa(s,e,t=e.neutral,n=8){const i=Mp(s),r=i===null?"":me(0,0,i,n,t);return Ie(n,me(0,0,oe,n,e.track)+r)}const hi=100,Ut=50,Ap=16,Tt=22,pi=44,zp=3,Bp=33,Lp={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function nt(s,e){const t=(s-90)*Math.PI/180;return{x:Ut+e*Math.cos(t),y:Ut+e*Math.sin(t)}}function fi(s,e,t,n){const i=e-s>180?1:0,r=nt(s,n),l=nt(e,n),d=nt(e,t),c=nt(s,t);return`M${H(r.x)} ${H(r.y)} A${H(n)} ${H(n)} 0 ${i} 1 ${H(l.x)} ${H(l.y)} L${H(d.x)} ${H(d.y)} A${H(t)} ${H(t)} 0 ${i} 0 ${H(c.x)} ${H(c.y)} Z`}function Fp(s){const e=Math.max(s.long,s.short,s.left,s.right),t=zp/2,n=[];for(const i of["long","right","short","left"]){const r=Lp[i],l=r.from+t,d=r.to-t,c=e>0?us(s[i]/e):0,u=Tt+(pi-Tt)*c,p=nt((r.from+r.to)/2,Bp);n.push({id:i,trackPath:fi(l,d,Tt,pi),valuePath:fi(l,d,Tt,u),labelX:p.x,labelY:p.y})}return n}function Gp(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${H(Ut)}" cy="${H(Ut)}" r="${H(Ap)}" fill="${t.track}"/>`+s.map(r=>`<text x="${H(r.labelX)}" y="${H(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${hi} ${hi}" preserveAspectRatio="xMidYMid meet" style="width:${H(n)}px;height:${H(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const jp=60,Kt=58,Dp=2,qp={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function Vp(s,e){const t=Kt-Dp,n=l=>e>0?l/e*t:0,i=[],r=(l,d)=>{const c=qp[l];let u=Kt;for(const p of d){const m=n(p.count);u-=m,i.push({id:p.id,column:l,tone:p.tone,x:c.x,y:u,width:c.width,height:m})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function Up(s,e,t){const n=s.filter(i=>i.height>0).map(i=>me(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${H(Kt)} L${H(oe)} ${H(Kt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return Ie(jp,n)}const hs={gain:o("accent-strong"),loss:o("danger"),zero:o("border-strong"),neutral:o("accent"),track:o("surface-sunken"),rule:o("border")},k={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",filterBaseline:"Compared to",filterBaselineHint:"Which player the strokes-gained rows measure you against. It does not change which rounds are in the window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",penaltyTax:"Extra strokes per hole on the holes where you took a penalty, against your own penalty-free holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",noValue:Or,proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate your reference expects from that distance. For the two longest bands it sits at zero: the reference expects two putts from there, so any make is ahead of it.",ladderCost:"Cost is how many strokes this distance has cost you across the window, against the reference you picked. Plus means it cost you shots; minus means you gained them.",costOfMissedGreen:"What a hole costs you against par on average with the green hit, and with it missed.",missedGreenTax:"The difference between what a hole costs you with the green hit and with it missed.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",puttsByPar:"Putts per hole on each kind of hole — every hole you recorded putts on, green hit or not.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",scrambling:"Missed greens where you still got up and down for par or better.",sandSave:"Missed greens from a bunker where you still got up and down.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",multiChipBunker:"Bunker holes that took more than one shot to get out.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",avgVsParByPar:"Your average score against par on each kind of hole.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function j(s,e,t){return{kind:"bar",id:s,title:e,share:t.value,value:he(t)}}function Y(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}const Kp=["Holed","Cost"];function Wp(s){const e=s.value===null?k.notRecorded:`${s.value} holed`;if(s.cost===k.noValue)return`${s.title}, ${e}, ${k.notRecorded}`;const t=s.cost.replace(/^[+\u2212]/,"");return s.cost.startsWith("+")?`${s.title}, ${e}, ${t} strokes lost`:s.cost.startsWith("−")?`${s.title}, ${e}, ${t} strokes gained`:`${s.title}, ${e}, level`}function Yp(s,e){switch(s){case"tee":{const t=e.tee&&$s(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&$s(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?Kn(e.putting.puttsPerGirHole,{unit:Ot,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&$s(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?Kn(e.scoring.doubleBogeyPlusPerRound,{unit:ye,label:"doubles or worse per round"}):null}}function Xp(s){return Y("troubleTax","Trouble tax",ie(s.troubleTax,2,!0),null)}function Es(s){return ie(s,2,!0)}function Qp(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>he(i)??"",n=(i,r)=>`${i} ${he(r)??k.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:Fp(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function Jp(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:Vp(e,s.teeRecorded),text:[`Left ${ae(e.leftInPlay+e.leftTrouble)}`,`Fairway ${ae(e.fairway)}`,`Right ${ae(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function Zp(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function mi(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:t.fairway.value,value:he(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:t.inPlayOnly.value,value:he(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:t.trouble.value,value:he(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:k.teeFanHead},Jp(t)]:[],...Zp(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},Y("vsParFairway","From the fairway",Es(t.vsParByTee.fairway)),Y("vsParInPlay","From in play",Es(t.vsParByTee.inPlay)),Y("vsParTrouble","From trouble",Es(t.vsParByTee.trouble))]:[],Xp(t),j("recovery","Recovery",t.recovery),...t.penaltiesRecordedHoles>0?[Y("penalties","Penalties",ie(t.penaltiesPerRound,2)),j("penaltyHoleShare","Holes with a penalty",t.penaltyHoleShare),Y("penaltyTax","Penalty tax",ie(t.penaltyTax,2,!0))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:k.greenMissHead},Qp(t)]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},j("girFairway","From the fairway",t.girByTee.fairway),j("girInPlay","From in play",t.girByTee.inPlay),j("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},j("girPar3","Par 3",t.girByPar.par3),j("girPar4","Par 4",t.girByPar.par4),j("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"Proximity with GIR"},...Be.map(n=>j(`mix-${n}`,ks(n),t.girFirstPuttMix[n])),j("birdieConversion","Birdie conversion",t.birdieConversion),...t.hardChipShare.d>0?[j("hardChipShare","Hard misses",t.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},Y("vsParGreenHit","Green hit",ie(t.costOfMissedGreen.hit,2,!0)),Y("vsParGreenMissed","Green missed",ie(t.costOfMissedGreen.miss,2,!0)),Y("missedGreenTax","Missed-green tax",ie(t.costOfMissedGreen.delta,2,!0))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[Be[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},...Be.map(n=>j(`spread-${n}`,ks(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"columns",id:"ladderCols",cells:[...Kp]},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:ks(n.bucket),made:n.made.value,baseline:n.baseline,value:he(n.made),cost:du(n.cost)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},j("putts-zero","No putts",t.puttDistribution.zero),j("putts-one","One putt",t.puttDistribution.one),j("putts-two","Two putts",t.puttDistribution.two),j("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],j("longThreePutt","Three-putts from over 8 m",t.threePuttsFromOver8m),Y("puttsPerGir","Putts per green hit",ie(t.puttsPerGirHole,2)),...t.puttsAfterMissedGreen.d>0?[Y("puttsAfterMissedGreen","Putts after a missed green",ie(t.puttsAfterMissedGreen,2))]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},Y("puttsPar3","Par 3",ie(t.puttsPerHoleByPar.par3,2)),Y("puttsPar4","Par 4",ie(t.puttsPerHoleByPar.par4,2)),Y("puttsPar5","Par 5",ie(t.puttsPerHoleByPar.par5,2))]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},j("scrambleStandard","Standard",t.scramble.standard),j("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[j("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[j("sandSave","Sand save",t.sandSave)]:[],...t.shortGameStrokesRecorded>0?[j("multiChipBunker","More than one from sand",t.multiChipBunker),Y("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes)),j("multiChip","More than one chip",t.multiChip)]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},j("chipStandard","Standard",t.chipInside2m.standard),j("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[j("chipBunker","Bunker",t.chipInside2m.bunker)]:[],j("conversionInside2m","Holed from inside 2 m",t.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},Y("chipInsStandard","Standard",ae(t.chipIns.standard)),Y("chipInsHard","Hard",ae(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[Y("chipInsBunker","Bunker",ae(t.chipIns.bunker))]:[]]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>ie(i,2,!0);return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},Y("par3","Par 3",n(t.avgVsParByParGroup.par3)),Y("par4","Par 4",n(t.avgVsParByParGroup.par4)),Y("par5","Par 5",n(t.avgVsParByParGroup.par5)),Y("doubles","Doubles or worse",ie(t.doubleBogeyPlusPerRound,2)),j("bounceBack","Bounce-back",t.bounceBack)]}}}function ef(s){if(!s||s.rounds===0)return"";const e=ne(s.rounds,ye),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${ne(t.holeCount,te)}`;const n=s.lengths.map(i=>`${ae(i.rounds)} × ${ne(i.holeCount,te)}`).join(", ");return`${e} — ${n}`}function tf(s){return s===18?"Best 18":s===9?"Best 9":`Best ${ae(s)} holes`}const sf=18;function nf(s){const e=s.lengths.some(i=>i.holeCount!==sf),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${ne(s.holesScored,te)}`;return e?`${n}, scaled to 18`:n}function Rs(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:we(s.avgVsParPer18.value,1),qualifier:nf(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:tf(t.holeCount),value:rs(n.vsPar),qualifier:`${ae(n.strokes)} strokes`,hero:!1})}return e}function rf(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function Pt(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return tc.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:rf(t),share:$(n,e).value,value:he($(n,e))??k.noValue}})}function af(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function gi(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const _e={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s,e){const t=s?.baseline??Cc,n=e===void 0?ft[t.cohort].tables.calibratedAt:e,i=`under “${k.filterBaseline}” in Filters`,r=dt(t.cohort),l=t.choice!=="auto"?`Measured against the ${r} reference — you picked this ${i}.`:t.handicapIndex===null?`Measured against the ${r} reference — no handicap on your profile yet. Change it ${i}.`:`Measured against the ${r} reference — matched to your ${dn(t.handicapIndex)} handicap. Change it ${i}.`,d="Each tier is one set of expected scores per hole and per lie.";return n===null?`${l} ${d} The tiers are still provisional, so treat the order of the rows as the reading and the sizes as rough.`:`${l} ${d} This tier was frozen on ${n}. Everyone on this reference is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${Tr} attributed holes is left out of the comparison entirely.`},total(s){const e=of(s.rowsPer18);if(e===null)return null;const t=we(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${ne(e.recorded,Zc)} you labelled, ${ae(e.tee)} came off the tee, ${ae(e.approach)} on the approach and ${ae(e.short)} around the green.`}};function of(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function Wt(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Yt(s){const e=[{id:"holes",title:"Holes counted",body:_e.holesCounted(s)},{id:"rows",title:"The five rows",body:_e.fiveRows()},{id:"baseline",title:"The baseline",body:_e.baseline(s)},{id:"per18",title:"Per 18 holes",body:_e.per18()}],t=_e.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=_e.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:k.penaltySourceInfoTitle,body:n}),e}const ee={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},bi={title:"Your round",seeWholeRound:"See the whole round"};function lf(s){const e=[Br(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function na(s,e){return s===null?null:e===null?String(s):`${s} (${rs(e)})`}function df(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function cf(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function uf(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${rs(s.vsPar)})`}function hf(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function pf(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function ff(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function mf(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function yn(s){const e=[],t=uf(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:hf(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:pf(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:ff(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function gf(s){return s===null?[]:yn(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function _i(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(mf(s.marker).toLowerCase())):e.push("no score");for(const t of yn(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function ia(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=Pe(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function yi(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function Ns(s,e=1){return typeof s=="number"?Pe(Math.abs(s),e):""}function Oe(s){return typeof s=="number"?String(Math.round(s)):""}function vi(s){return typeof s=="string"?s:"tee"}function bf(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${yi(vi(e.component))} was ${Ns(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${yi(vi(e.component))} cost you ${Ns(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${Ns(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Oe(e.left)} left and ${Oe(e.right)} right of ${Oe(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Oe(e.successes)} of the ${Oe(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Oe(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Oe(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const _f=b(`
...
${ds}
    `;round=this.inject(ge);stats=this.inject(ht);auth=this.inject(q);router=this.inject(G);colors=hs;infoOpen=new f(!1);render(){this.track(I(()=>{const i=this.eligibleRoundId();se(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(_f,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>bi.title,score:()=>{const i=e();return i===null?"":na(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>bi.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:We(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...ue],(i,r,l)=>this.wireEl(vf,{label:()=>as(i),amount:{textContent:()=>{const d=n(i);return d===null?k.notRecorded:we(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Xe(cs(d),this.colors)}`}}},l),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Yt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:ue.map(r=>Te(i.waterfall,r)),penaltySource:Wt(i.panels.totals),baseline:this.stats.sgInfo.get()})},(i,r,l)=>this.wireEl(bt,{ctitle:()=>i.title,ctext:()=>i.body},l),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,l)=>this.wireEl(yf,{text:()=>bf(i)},l),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:Xr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:Qr({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return ee.waterfallHint;let t=null;for(const n of ue){const i=on(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?ee.waterfallHint:ia(t,e.windowCount)}}function wi(s){return!(!s.pageVisible||s.status==="complete")}function xf(s,e){return e&&!s}const $f=2,xi=3,kf=75e3;function Sf(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${U}/friendly-rounds/events?${t.toString()}`}function Tf(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Pf(s){const e=s.eventSourceFactory??(z=>new EventSource(z)),t=s.setTimer??((z,K)=>setTimeout(z,K)),n=s.clearTimer??(z=>clearTimeout(z)),i=s.livenessTimeoutMs??kf,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let l=!1,d=0,c=null,u=null,p=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(T,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},v=()=>{l=!0,m(),g()},w=()=>{if(g(),++d>=xi){v(),s.onDegrade();return}N()};function T(){if(!l){if(!r()){h();return}w()}}function N(){if(l)return;let z;try{z=e(Sf(s.token,p))}catch{v(),s.onDegrade();return}c=z,z.onopen=()=>{d=0},z.onmessage=K=>{if(l||c!==z)return;h();let O;try{O=JSON.parse(K.data)}catch{return}Tf(O)&&(O.latestEventId!==null&&(p=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},z.onerror=()=>{l||c!==z||(z.readyState===$f||++d>=xi)&&(v(),s.onDegrade())},h()}return N(),{stop:()=>{l||v()}}}const If=2e4;function Cf(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Ef=b(`
...
`),Rf=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Nf=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Of extends M{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class pm extends M{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`),mm='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',gm=b(`
...
`),Ri=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${mm}</button>
    </div>
`);class bm extends M{static styles=`
        .friends {
...
`);function la(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>wl(s),subtitle:()=>xl(s,Fe),progress:()=>$l(s)}}function da(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class ym extends M{static styles=`
    ...
    `;svc=this.inject(ts);activity=this.inject(en);auth=this.inject(q);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();se(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",l=new S(()=>{const h=e.get();return h?_l(this.activity.feed.get(),h):null}),d=()=>this.svc.unavailable.get(),c=()=>n()&&d()===null&&i()!==null,u=()=>n()&&d()===null&&i()===null,p=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(_m,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&d()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=d();return h?Ue[h].title:""}},refusalMsg:{textContent:()=>{const h=d();return h?Ue[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...Se(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?kl(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>l.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=l.get();return h?yl(h):""},onclick:()=>{const h=l.get();h&&p(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>Tl(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,v)=>this.wireEl(oa,la(h,p),v),h=>h.roundId),m}}const vm=b(`
    <div class="frounds">
...
`);class wm extends M{static styles=`
    ...
    `;svc=this.inject(ts);auth=this.inject(q);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const p=e.get();se(()=>{!p||!n()||(this.svc.setPlayer(p),this.svc.loadRounds())})}));const i=()=>this.svc.rounds.get(),r=()=>this.svc.unavailable.get(),l=()=>(t.get()??"").trim(),d=p=>this.router.navigate("/spectate",{query:{id:p,name:l()}}),c=()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:l()}}),u=this.wire(vm,{back:{onclick:c},subtitle:{textContent:()=>{const p=l();return p?`Rounds ${p} has shared with friends.`:"Rounds shared with friends."}},refusal:{className:()=>r()!==null?"frounds__refusal":"frounds__refusal hidden"},refusalTitle:{textContent:()=>{const p=r();return p?Ue[p].title:""}},refusalMsg:{textContent:()=>{const p=r();return p?Ue[p].message:""}},anon:{className:()=>n()?"frounds__anon hidden":"frounds__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-rounds?id=${e.get()??""}&name=${encodeURIComponent(t.get()??"")}`}})},state:{textContent:()=>r()!==null||!n()?"":this.svc.roundsLoading.get()?"Loading…":i().rounds.length===0?this.svc.roundsError.get()??"":""},retry:{className:()=>r()===null&&this.svc.roundsError.get()!==null&&i().rounds.length===0&&!this.svc.roundsLoading.get()?"frounds__retry":"frounds__retry hidden",onclick:()=>{this.svc.loadRounds(!0)}},empty:{className:()=>r()===null&&this.svc.roundsLoaded.get()&&i().rounds.length===0&&this.svc.roundsError.get()===null?"frounds__state":"frounds__state hidden"},listCard:{className:()=>r()===null&&i().rounds.length>0?"frounds__listcard":"frounds__listcard hidden"},more:{className:()=>r()===null&&dr(i())&&i().rounds.length>0?"frounds__more":"frounds__more hidden",disabled:()=>this.svc.loadingMore.get(),textContent:()=>this.svc.loadingMore.get()?"Loading…":"Show more rounds",onclick:()=>{this.svc.loadMoreRounds()}},moreError:{textContent:()=>i().rounds.length>0?this.svc.roundsError.get()??"":""}});return this.$each(this.ref(u,"list"),()=>r()===null?i().rounds:[],(p,m,h)=>this.wireEl(oa,la(p,d),h),p=>p.roundId),u}}const xm=b(`
    <div class="fcourses">
...
`);class km extends M{static styles=`
    ...
    `;svc=this.inject(ts);auth=this.inject(q);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],l=()=>(t.get()??"").trim(),d=this.wire(xm,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:l()}})},subtitle:{textContent:()=>{const c=l();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ue[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ue[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(l())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,u,p)=>this.wireEl($m,{name:()=>c.courseName??"Course",facts:()=>Sl(c,Fe)},p),c=>c.courseId),d}}function Sm(s,e,t){const n=pt(e);if(n){const d=Oi(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=Oi(s)??"this",r=pt(t),l=r?` at ${r}`:"";return`Watching · ${i} round${l}`}function Tm(s,e,t,n){const i=pt(s)===null?null:pt(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Pm="You're watching this round. Only its players can enter scores.",Ni={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Oi(s){const e=pt(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function pt(s){return(s??"").trim()||null}const Im=b(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${Pm}</p>
        </div>
    </div>
`);class Cm extends M{static styles=`
        .spectate {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${bn.styles}
    `;svc=this.inject(hr);auth=this.inject(q);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),l=()=>(t.get()??"").trim()||null;return this.wire(Im,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(l()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Ni[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Ni[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Sm(l(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?Tm(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Fe(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const l=i.length>1?`<h2 class="spectate__slot-head">${Em(r.formatLabel)}</h2>`:"",d=Wr(r,t,n),c=Yr(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return l+d+u}).join("")}}function Em(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const Rm=b(`
    <div class="profile">
...
`);class Hm extends M{static styles=`
        .profile {
            ...
            & .profile__card {
                ...
                & .profile__label-row { display: flex; align-items: baseline; gap: ${a("xs")}; }
                & .profile__info {
                    ${x()}
                    padding: 0; min-width: 0; border: 0; background: transparent;
                    color: ${o("text-muted")}; font: inherit; font-weight: 700;
                    &:hover { color: ${o("text")}; }
                }
                & .profile__hcp-row {
                    display: flex; align-items: center; gap: ${a("md")};
    ...
    `;svc=this.inject(Ce);auth=this.inject(q);router=this.inject(G);indexDraft=new f("");localErr=new f("");nameDraft=new f("");nameEditing=new f(!1);nameErr=new f("");teeRoleInfoOpen=new f(!1);render(){this.auth.currentUser.get()&&this.svc.load();const e=()=>this.auth.currentUser.get()!==null;let t=null,n=null;const i=this.wire(Rm,{anon:{className:()=>e()?"profile__anon hidden":"profile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/profile"}})},body:{className:()=>e()?"profile__body":"profile__body hidden"},...Se(()=>{const c=this.svc.player.get();return{id:c?.id??"",avatarVersion:c?.avatarVersion??null,displayName:c?.displayName,username:c?.username}}),photoFile:{onchange:c=>{const u=c.target,p=u.files?.[0];u.value="",p&&this.svc.saveAvatar(p)}},photoPick:{textContent:()=>this.svc.avatarSaving.get()?"Saving…":this.svc.player.get()?.avatarVersion?"Change photo":"Add photo",disabled:()=>this.svc.avatarSaving.get(),onclick:()=>t?.click()},photoRemove:{textContent:()=>"Remove",className:()=>this.svc.player.get()?.avatarVersion?"profile__photo-remove":"profile__photo-remove hidden",disabled:()=>this.svc.avatarSaving.get(),onclick:()=>{this.svc.removeAvatar()}},photoErr:{textContent:()=>this.svc.avatarError.get()?.message??""},nameDisplay:{className:()=>this.nameEditing.get()?"profile__name-display hidden":"profile__name-display"},name:()=>this.svc.player.get()?.displayName??"…",editName:{disabled:()=>this.svc.saving.get(),onclick:()=>{this.nameDraft.set(this.svc.player.get()?.displayName??""),this.nameErr.set(""),this.nameEditing.set(!0),queueMicrotask(()=>n?.focus())}},nameForm:{className:()=>this.nameEditing.get()?"profile__name-form":"profile__name-form hidden",onsubmit:async c=>{c.preventDefault();const u=this.nameDraft.get().trim();if(!u){this.nameErr.set("Enter a display name.");return}this.nameErr.set(""),await this.svc.saveDisplayName(u)&&this.nameEditing.set(!1)}},nameInput:{value:()=>this.nameDraft.get(),disabled:()=>this.svc.saving.get(),oninput:c=>this.nameDraft.set(c.target.value)},cancelName:{disabled:()=>this.svc.saving.get(),onclick:()=>{this.nameEditing.set(!1),this.nameErr.set("")}},saveName:{disabled:()=>this.svc.saving.get()||this.nameDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},nameErr:{textContent:()=>this.nameErr.get()||this.svc.saveError.get()?.message||""},username:()=>{const c=this.svc.player.get();return c?`@${c.username}`:""},hcp:()=>{const c=this.svc.player.get()?.handicapIndex;return c==null?"–":c<0?`+${(-c).toFixed(1)}`:c.toFixed(1)},index:{value:()=>this.indexDraft.get(),oninput:c=>this.indexDraft.set(c.target.value)},save:{disabled:()=>this.svc.saving.get()||this.indexDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},form:{onsubmit:async c=>{c.preventDefault(),this.localErr.set("");const u=ve(this.indexDraft.get());if(u===null||u<-10||u>54){this.localErr.set("Enter an index between +10 and 54 (use “+” for a plus handicap).");return}await this.svc.saveIndex(u)&&this.indexDraft.set("")}},saveErr:{textContent:()=>this.localErr.get()||this.svc.saveError.get()?.message||""},genderErr:{textContent:()=>this.svc.saveError.get()?.message||""},teeRoleInfo:{"aria-expanded":()=>String(this.teeRoleInfoOpen.get()),onclick:()=>this.teeRoleInfoOpen.set(!this.teeRoleInfoOpen.get())},teeRoleExplain:{textContent:()=>"Choose Club, Tournament or Beginner for the tee type you normally play. It pre-fills your own gender’s round tee only when the selected course has a matching tee. Otherwise the course default applies. The organiser can change the round defaults, and any player’s tee can still be overridden.",className:()=>this.teeRoleInfoOpen.get()?"profile__hint profile__tee-explain":"profile__hint profile__tee-explain hidden"},teeRoleErr:{textContent:()=>this.svc.saveError.get()?.message||""},clubErr:{textContent:()=>this.svc.saveError.get()?.message||""},toStats:{className:()=>this.svc.hasRecordedStats.get()?"statlink":"statlink hidden",onclick:()=>this.router.navigate("/stats")},statlinkRule:{className:()=>this.svc.hasRecordedStats.get()?"statrow__rule":"statrow__rule hidden"},masterTitle:()=>jo,masterHint:()=>Do,master:{checked:()=>this.svc.statsConfig.get().enabled,disabled:()=>this.statsBusy(),onchange:c=>{this.saveStats(c,(u,p)=>Ko(u,p),u=>u.enabled)}},statsErr:{textContent:()=>this.svc.statsError.get()?.message||""},historyEmpty:{className:()=>this.svc.history.get().length===0?"profile__empty":"profile__empty hidden"}});this.$each(this.ref(i,"history"),this.svc.history,(c,u,p)=>this.wireEl(Nm,{index:()=>c.handicapIndex.toFixed(1),source:()=>c.source,date:()=>c.effectiveDate},p),c=>c.id),this.$each(this.ref(i,"statModules"),()=>[...Zi],(c,u,p)=>{const m=()=>this.svc.statsConfig.get(),h=()=>qo(m(),c);return this.wireEl(Om,{row:{className:()=>h()?"statrow statrow--locked":"statrow"},title:()=>er(c),ann:()=>Vo(m(),c)??"",hint:()=>Go(c),chk:{checked:()=>Mt(m(),c),disabled:()=>h()||this.statsBusy(),onchange:g=>{this.saveStats(g,(v,w)=>Uo(v,c,w),v=>Mt(v,c))}}},p)},c=>c);const r=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(i,"gender"),()=>r,(c,u,p)=>this.wireEl(b('<button bind="b" type="button"></button>'),{b:{textContent:()=>c.label,className:()=>this.svc.player.get()?.gender===c.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.saveGender(c.value)}}},p),c=>c.label),this.$each(this.ref(i,"teeRole"),()=>[{value:null,label:"No preference"},...this.svc.teeRoles.get().map(c=>({value:c.roleKey,label:c.displayName}))],(c,u,p)=>this.wireEl(b('<button bind="b" type="button"></button>'),{b:{textContent:()=>c.label,className:()=>this.svc.player.get()?.preferredTeeRoleKey===c.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.savePreferredTeeRole(c.value)}}},p),c=>c.value??"none");const l=new f(this.svc.player.get()?.homeClubId??"");this.track(I(()=>l.set(this.svc.player.get()?.homeClubId??""))),this.track(I(()=>{const c=l.get();queueMicrotask(()=>{c!==(this.svc.player.get()?.homeClubId??"")&&this.svc.saveHomeClub(c===""?null:c)})}));const d=new pe({value:l,options:{get:()=>[{value:"",label:"No home club"},...this.svc.clubs.get().map(c=>({value:c.id,label:c.name}))]},placeholder:"No home club",disabled:{get:()=>this.svc.saving.get()}});return d.mount(this.ref(i,"club")),this.track(()=>d.destroy()),t=this.ref(i,"photoFile"),n=this.ref(i,"nameInput"),i}statsBusy(){return this.svc.statsSaving.get()||this.svc.saving.get()}async saveStats(e,t,n){const i=e.target;await this.svc.saveStatsConfig(t(this.svc.statsConfig.get(),i.checked)),i.checked=n(this.svc.statsConfig.get())}}function Z(s,e){return s>0?`Measured over ${ne(s,e)}.`:null}function xe(s){return s===null?null:`Measured ${s}.`}function V(...s){return s.filter(e=>e!==null&&e!=="").join(" ")}function D(s,e,t){return{id:s,title:e,body:t}}function Mm(s){return s.penaltiesRecordedHoles<=0?null:is([{d:s.penaltiesPerRound.d,unit:ye},{d:s.penaltiesRecordedHoles,unit:te}])}function Am(s,e,t){switch(s){case"tee":{const n=e.tee;return n?[D("teeFan","Where your tee shots finish",V(k.teeFan,Z(n.teeRecorded,te))),D("vsParByTee","Average vs par, by where the tee shot finished",V(k.vsParByTee,xe(ou(n.vsParByTee)))),D("troubleTax","Trouble tax",V(k.troubleTax,xe(Xc(n.vsParByTee)))),D("recovery","Recovery",V(k.recovery,Z(n.recovery.d,te))),D("penalties","Penalties",V(k.penalties,xe(Mm(n)))),D("penaltyTax","Penalty tax",V(k.penaltyTax,xe(tu(n.vsParByPenalty))))]:[]}case"approach":{const n=e.approach;return n?[D("greenMiss","Where you miss the green",V(k.greenMiss,Z(n.greenMissRecorded,te))),D("proximity","Proximity with GIR",V(k.proximityProxy,Z(n.girFirstPuttMix.inside_1m.d,Ot))),D("birdieConversion","Birdie conversion",V(k.birdieConversion,Z(n.birdieConversion.d,Ot))),D("hardChipShare","Hard misses",V(k.hardChipShare,Z(n.hardChipShare.d,te))),D("costOfMissedGreen","Cost of a missed green",V(k.costOfMissedGreen,xe(lu(n.costOfMissedGreen)))),D("missedGreenTax","Missed-green tax",V(k.missedGreenTax,xe(eu(n.costOfMissedGreen))))]:[]}case"putting":{const n=e.putting;return n?[D("firstPuttSpread","First putt, all holes",V(k.firstPuttSpread,Z(n.firstPuttSpread.inside_1m.d,te))),D("ladder","Holed on the first putt",V(k.ladderBaseline,k.ladderCost,`Measured against the ${dt(t.cohort)} reference — change it under “${k.filterBaseline}” in Filters.`)),D("threePutt","Three or more putts",V(k.threePutt,k.longThreePutt,Z(n.threePutt.d,te))),D("puttsPerGir","Putts per green hit",V(k.puttsPerGir,Z(n.puttsPerGirHole.d,Ot))),D("puttsAfterMissedGreen","Putts after a missed green",V(k.puttsAfterMissedGreen,Z(n.puttsAfterMissedGreen.d,te))),D("puttsByPar","Putts per hole, by par",V(k.puttsByPar,xe(Wn(n.puttsPerHoleByPar))))]:[]}case"shortGame":{const n=e.shortGame;if(!n)return[];const i=n.scramble.standard.d+n.scramble.hard.d+n.scramble.bunker.d;return[D("scrambling","Scrambling",V(k.scrambling,Z(i,te))),D("sandSave","Sand save",V(k.sandSave,Z(n.sandSave.d,te))),D("multiChipBunker","More than one from sand",V(k.multiChipBunker,Z(n.multiChipBunker.d,te))),D("extraShortGameStrokes","Extra short-game shots",V(k.extraShortGameStrokes,Z(n.shortGameStrokesRecorded,te))),D("multiChip","More than one chip",V(k.multiChip,Z(n.multiChip.d,te))),D("chipInside2m","Chipped to inside 2 m",V(k.conversionInside2m,Z(n.conversionInside2m.d,te))),D("chipIns","Chip-ins",k.chipIns)]}case"scoring":{const n=e.scoring;return n?[D("vsPar","Average vs par",V(k.avgVsParByPar,xe(Wn(n.avgVsParByParGroup)))),D("doubles","Doubles or worse",V(k.doubleBogeyPlus,Z(n.doubleBogeyPlusPerRound.d,ye))),D("bounceBack","Bounce-back",V(k.bounceBack,Z(n.bounceBack.d,te)))]:[]}case null:return[]}}const zm=b(`
...
`),Bm=b('<h3 bind="text" class="block__subhead"></h3>'),Lm=b(`
...
`);class ca extends M{static styles=`
${ds}
        .statspanels {
            ...
            & .block__cost {
                width: ${di}px; flex: none; text-align: right;
            ...
            & .block--columns {
                ...
                & .block__colhead:nth-child(4) { width: ${di}px; }
            }
    ...
    `;expanded=new f([]);openInfo=new f(null);colors=hs;render(){const e=()=>this.props.model(),t=this.wire(Um,{infoSheet:{className:()=>this.openInfo.get()!==null?"stats-info":"stats-info hidden",onclick:n=>{n.target===n.currentTarget&&this.openInfo.set(null)}},infoTitle:()=>{const n=this.openInfo.get();return n===null?"":ws(n)},infoDone:{onclick:()=>this.openInfo.set(null)}});return this.$each(this.ref(t,"panels"),()=>[...Hc],(n,i,r)=>{const l=()=>this.expanded.get().includes(n),d=this.wireEl(zm,{panel:{className:()=>e()[n]?"panel":"panel hidden"},head:{"aria-expanded":()=>String(l()),onclick:()=>this.togglePanel(n)},title:()=>ws(n),headline:()=>Yp(n,e())??"",body:{className:()=>l()?"panel__body":"panel__body hidden"},infoRow:{className:()=>l()&&this.infoCards(n).length>0?"panel__inforow":"panel__inforow hidden"},infoTrigger:{textContent:()=>k.prioritiesInfo,"aria-label":()=>`${k.prioritiesInfo}: ${ws(n)}`,onclick:()=>this.openInfo.set(n)}},r);return this.$each(this.ref(d,"blocks"),()=>mi(n,e()),(c,u,p)=>this.renderBlock(n,c,p),c=>c.id),d},n=>n),this.$each(this.ref(t,"infoCards"),()=>this.infoCards(this.openInfo.get()),(n,i,r)=>this.wireEl(bt,{ctitle:()=>(this.infoCardNow(n.id)??n).title,ctext:()=>(this.infoCardNow(n.id)??n).body},r),n=>n.id),t}infoCards(e){return Am(e,this.props.model(),this.props.baseline())}infoCardNow(e){return this.infoCards(this.openInfo.get()).find(t=>t.id===e)}renderBlock(e,t,n){switch(t.kind){case"subhead":return this.wireEl(Bm,{text:()=>t.text},n);case"columns":return this.wireEl(Lm,{c0:()=>t.cells[0]??"",c1:()=>t.cells[1]??""},n);case"split":{const i=()=>this.blockNow(e,t.id)??t;return this.wireEl(Fm,{bar:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":kp(r.segments.map(l=>({id:l.id,share:l.share??0,color:this.segmentColor(l.tone)})),this.colors)}},legend:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":r.segments.map(l=>`<span class="legend__key"><span class="legend__swatch" style="background:${this.segmentColor(l.tone)}"></span><span>${l.title}</span><span class="legend__value">${l.value??k.noValue}</span></span>`).join("")}}},n)}case"bar":return this.wireEl(Gm,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="bar"||i.share===null?"":sa(i.share,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value,k.noValue)},n);case"rung":{const i=()=>{const r=this.blockNow(e,t.id);return r&&r.kind==="rung"?r:t};return this.wireEl(jm,{row:{"aria-label":()=>{const r=i();return Wp({title:r.title,value:r.value,cost:r.cost})}},title:()=>t.title,bar:{innerHTML:()=>{const r=i();return Hp(r.made,r.baseline,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value,k.noValue),cost:()=>i().cost},n)}case"figure":return this.wireEl(Dm,{title:()=>t.title,hint:()=>{const i=this.blockNow(e,t.id)??t;return(i.kind==="figure"?i.hint:t.hint)??""},value:this.valueBinding(e,t.id,()=>t.value)},n);case"compass":return this.wireEl(qm,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="compass"?"":Gp(i.sectors,i.labels,this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="compass"?i.text:t.text}},n);case"fan":return this.wireEl(Vm,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="fan"?"":Up(i.columns,this.toneColors(),this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="fan"?i.text:t.text}},n)}}toneColors(){return{fairway:this.segmentColor("fairway"),inplay:this.segmentColor("inplay"),trouble:this.segmentColor("trouble")}}valueBinding(e,t,n,i=k.notRecorded){const r=()=>{const l=this.blockNow(e,t);return l&&"value"in l?l.value:n()};return{textContent:()=>r()??i,className:()=>r()===null?"block__value block__value--absent":"block__value"}}segmentColor(e){switch(e){case"fairway":return this.colors.gain;case"inplay":return this.colors.neutral;case"trouble":return this.colors.loss}}togglePanel(e){const t=this.expanded.get();this.expanded.set(t.includes(e)?t.filter(n=>n!==e):[...t,e])}blockNow(e,t){return mi(e,this.props.model()).find(n=>n.id===t)}}const Km=b(`
    <div class="stats">
...
${ds}
    `;svc=this.inject(ze);auth=this.inject(q);router=this.inject(G);filterOpen=new f(!1);prioritiesInfoOpen=new f(!1);colors=hs;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&(this.svc.load(),this.svc.loadHandicap());const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Km,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>k.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>k.filterClear,onclick:()=>this.svc.clearFilter()},sgLabel:()=>k.filterBaseline,sgWhat:()=>k.filterBaselineHint,sgHint:()=>Ic(this.svc.sgChoice.get(),this.svc.handicapIndex.get()),empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>ef(t().results),resultsCard:{className:()=>Rs(t().results).length===0&&Pt(t().results).length===0?"results hidden":"results"},histHead:()=>Pt(t().results).length===0?"":k.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>k.prioritiesHint,infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>k.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>k.roundsHint,pickHint:()=>n()?k.filterRoundsHint:""});return this.setHeading(i,"resultsSec",k.resultsHeading),this.setHeading(i,"prioritiesSec",k.priorities),this.setHeading(i,"trendsSec",k.trends),this.setHeading(i,"roundsSec",k.roundsHeading),this.mountPicker(i),this.mountBaselinePicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>Rs(t().results),(r,l,d)=>this.wireEl(Ym,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},d),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>Pt(t().results),(r,l,d)=>this.wireEl(Xm,{title:()=>r.title,bar:{innerHTML:()=>sa((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},d),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,l,d)=>this.wireEl(Qm,{title:()=>as(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":ea(c.per18,Dc(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?cu(c.per18):k.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.per18===null?af(c.roundsInWindow):`over ${ne(c.roundsCovered,ye)}`:""}}},d),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Yt({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:Wt(t().totals),baseline:this.svc.sgInfo.get()}),(r,l,d)=>this.wireEl(bt,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},d),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,l,d)=>this.wireEl(Jm,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Cp(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return tg(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ne(c.points.length,ye)}}},d),r=>r.id),this.spawn(ca,this.ref(i,"panels"),{model:t,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,l,d)=>this.wireEl(Zm,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${gi(r)} — hole by hole`},label:()=>gi(r),subtitle:()=>sg(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(cd(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Np(c.waterfall,Nr(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":rs(c.vsPar)}}},d),r=>r.id),i}mountPicker(e){const t=new f(this.svc.preset.get());this.track(I(()=>t.set(this.svc.preset.get()))),this.track(I(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Bt(r)} — ${od(r)}`}),i=new pe({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Bt("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountBaselinePicker(e){const t=new f(this.svc.sgChoice.get());this.track(I(()=>t.set(this.svc.sgChoice.get()))),this.track(I(()=>{const i=t.get();queueMicrotask(()=>{i!==this.svc.sgChoice.get()&&this.svc.selectSgBaseline(i)})}));const n=new pe({value:t,options:Cr.map(i=>({value:i,label:Vn(i)})),placeholder:Vn("auto")});n.mount(this.ref(e,"sgPicker")),this.track(()=>n.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,l)=>this.wireEl(Hi,{chip:{textContent:()=>uu(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(vs(this.svc.filter.get(),"venueTypes",i))}},l),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,l)=>this.wireEl(Hi,{chip:{textContent:()=>hu(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(vs(this.svc.filter.get(),"roundTypes",i))}},l),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,l)=>this.wireEl(Wm,{name:()=>i.name,count:()=>ne(i.roundCount,ye),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(vs(this.svc.filter.get(),"courseIds",i.id))}},l),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return Rs(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return Pt(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Yt({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:Wt(t.totals),baseline:this.svc.sgInfo.get()}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ne(e,ye):`${Pe(e,0)} of ${ne(t,ye)}`}statusLine(){const e=this.svc.extendError.get();return e?`${k.extendProblemPrefix}${e.message}`:this.svc.extending.get()?k.extending:this.svc.budgetSpent()?k.budgetSpent:this.svc.loading.get()?k.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?k.windowEmpty:this.svc.loadedCount()===0?k.noStats:""}}function tg(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:we(e)}function sg(s){const e=[Br(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${Pe(s.holeCount,0)} holes`),e.join(" · ")}const ng=b(`
...
`),og=b('<li bind="text" class="roundstats__legenditem"></li>');function lg(){const s=[];for(const[e,t]of Object.entries(mn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class dg extends M{static styles=`
        .roundstats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${ds}
    `;svc=this.inject(ht);auth=this.inject(q);router=this.inject(G);colors=hs;openHole=new f(null);infoOpen=new f(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(I(()=>{const d=e.get();se(()=>{this.openHole.set(null),d&&this.svc.load(d)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",l=this.wire(ng,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":ai(t()),subtitle:()=>this.subtitle(),score:()=>{const d=t();return d===null?"":na(d.strokes,d.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>ee.waterfallHeading,wfHint:()=>ee.waterfallHint,infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:d=>{d.target===d.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>ee.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const d=this.selected();return d===null?"":df(d)},detailEmpty:()=>{const d=this.selected();return d===null?"":yn(d).length===0?ee.nothingRecordedOnHole:""}});return this.setHeading(l,"stripSec",ee.holeStripHeading),this.$each(this.ref(l,"strip"),()=>t()?.cells??[],(d,c,u)=>this.wireEl(ig,{cell:{className:()=>{const p=this.cellNow(d.id)??d;return p.marker===null?"cell":`cell cell--${p.marker}`},"aria-pressed":()=>String(this.openHole.get()===d.id),"aria-label":()=>_i(this.cellNow(d.id)??d),title:()=>_i(this.cellNow(d.id)??d),onclick:()=>this.openHole.set(this.openHole.get()===d.id?null:d.id)},hole:()=>String((this.cellNow(d.id)??d).holeNumber),score:()=>cf(this.cellNow(d.id)??d),tee:{className:()=>(this.cellNow(d.id)??d).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const p=this.cellNow(d.id)??d;return p.tee===null?"":`background:${this.teeColor(p.tee)}`}},gir:{className:()=>{const p=this.cellNow(d.id)??d;return p.gir===null?"cell__gir cell__gir--absent":p.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const p=this.cellNow(d.id)??d;return p.putts===null?"":String(p.putts)},pen:{className:()=>fp(this.cellNow(d.id)??d)?"cell__pen":"cell__pen cell__pen--absent"}},u),d=>d.id),this.$each(this.ref(l,"detailLines"),()=>gf(this.selected()),(d,c,u)=>this.wireEl(rg,{label:()=>d.label,value:()=>d.value},u),d=>d.key),this.$each(this.ref(l,"deltas"),()=>{const d=t();return d===null?[]:ue.filter(c=>We(d.waterfall,c)!==null)},(d,c,u)=>this.wireEl(ag,{title:()=>as(d),sentence:()=>{const p=t();if(p===null||p.deltas===null)return"";const m=on(p.deltas,d);return m===null?"":ia(m,p.windowCount)},value:{textContent:()=>{const p=this.componentValue(d);return p===null?"":we(p)},style:()=>{const p=this.componentValue(d);return p===null?"":`color:${Xe(cs(p),this.colors)}`}},bar:{innerHTML:()=>{const p=t(),m=this.componentValue(d);return p===null||m===null?"":ea(m,Nr([p.waterfall]),this.colors)}}},u),d=>d),this.$each(this.ref(l,"infoCards"),()=>{const d=t();return d===null?[]:Yt({attributed:d.waterfall.coverage.attributed,holesScored:d.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:ue.map(c=>Te(d.waterfall,c)),penaltySource:Wt(d.panels.totals),baseline:this.svc.sgInfo.get()})},(d,c,u)=>this.wireEl(bt,{ctitle:()=>d.title,ctext:()=>d.body},u),d=>d.id),this.spawn(ca,this.ref(l,"panels"),{model:()=>t()?.panels??Rr,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(l,"legend"),()=>[ee.legendTee,ee.legendGir,ee.legendPutts,ee.legendPenalty,ee.legendAbsence],(d,c,u)=>this.wireEl(og,{text:()=>d},u),d=>d),l}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:We(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":lf({...e,title:ai(e)})}stateLine(){if(this.auth.currentUser.get()===null)return ee.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return ee.loading;case"notFound":return ee.noStatsInRound;case"notAuthorized":return ee.notSignedIn;case"failed":return`${ee.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?ee.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const cg=b(`
    <div class="admin">
...
`),fg={not_started:"Not started",active:"Playing",complete:"Done"},mg={private:"Private",friends:"Friends",link:"Link"};function gg(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function bg(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class _g extends M{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),Dg=b('<button bind="button" type="button"></button>'),qg=b('<th bind="cell"></th>'),Vg=b('<tr bind="row"></tr>'),Ug=b('<td bind="cell"><span bind="value"></span></td>'),Kg=b(`
...
`);class Qg extends M{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class Zg extends M{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(G);render(){const e=this.wire(Jg,{header:{className:()=>Zs(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Tu,this.ref(e,"account")),this.spawn(Fo,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Qn,"/history":Du,"/round":Of,"/create":om,"/login":pm,"/friends":bm,"/friend":ym,"/friend-rounds":wm,"/friend-courses":km,"/spectate":Cm,"/profile":Hm,"/stats":eg,"/round-stats":dg,"/admin":_g,...Ji.competitions?{"/competitions":$g,"/competition":Qg}:{}},Qn),e}}class eb extends q{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await aa(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await lm()),this.error.set(null)}catch(e){e instanceof X&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await dm(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof X&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await cm();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof X&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}W.get(Na);const Mi=W.get(G);W.set(q,new eb);const Ai=W.get(q);await Aa(Zg,"#app",{hot:void 0,onInit:async()=>{await Ai.load(),Ai.currentUser.get()&&Mi.route.get()==="/login"&&Mi.navigate("/",!0)}});export{As as A,M as C,G as R,f as S,Na as T,_ as a,lt as b,S as c,$a as d,I as e,xa as n,L as r,b as t};
