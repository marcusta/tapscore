...
</tr>`;const B=ds(n.plan.slotDefId,D.ballIds),V=n.isOpen(B),fe=yc(B),rr=Gi(P,n.routeSections,e,{mode:n.mode??"product"}),zt=["lb-rank__row--expandable"];return b.lead&&zt.push("lb-rank__lead"),V&&zt.push("lb-rank__row--open"),`<tr class="${zt.join(" ")}" data-expand-key="${L(B)}">
  <td class="lb-rank__pos">${b.position}</td>
...
<tr class="lb-rank__panel${V?" lb-rank__panel--open":""}" data-panel-key="${L(B)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${L(fe)}"><div class="lb-rank__panelbox">${rr}</div></div></td>
</tr>`}).join(""),u=r?`
...
</div>`}function wc(s,e){const t=ac(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",l=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
`);class ju extends E{static styles=`
    ...
    `;round=this.inject(ae);stats=this.inject(Ze);auth=this.inject(j);router=this.inject(M);colors=Ot;render(){this.track(I(()=>{const i=this.eligibleRoundId();K(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Hu,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>kn.title,score:()=>{const i=e();return i===null?"":Yi(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),open:{textContent:()=>kn.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ne(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...ee],(i,r,l)=>this.wireEl(Fu,{label:()=>Et(i),amount:{textContent:()=>{const d=n(i);return d===null?z.notRecorded:Le(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Ae(Rt(d),this.colors)}`}}},l),i=>i),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,l)=>this.wireEl(Mu,{text:()=>Au(i)},l),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:ru({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ou({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return U.waterfallHint;let t=null;for(const n of ee){const i=xs(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?U.waterfallHint:Qi(t,e.windowCount)}}function Du(s,e=typeof navigator>"u"?"en":navigator.language){const t=(s?.name??"").trim();if(t)return t;const n=s?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n||"Round"}function Pn(s){return!(!s.pageVisible||s.status==="complete")}function Bu(s,e){return e&&!s}const Gu=2,Cn=3,qu=75e3;function Vu(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${F}/friendly-rounds/events?${t.toString()}`}function Uu(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Ku(s){const e=s.eventSourceFactory??(P=>new EventSource(P)),t=s.setTimer??((P,B)=>setTimeout(P,B)),n=s.clearTimer??(P=>clearTimeout(P)),i=s.livenessTimeoutMs??qu,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let l=!1,d=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(O,i)},b=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{l=!0,m(),b()},x=()=>{if(b(),++d>=Cn){g(),s.onDegrade();return}D()};function O(){if(!l){if(!r()){h();return}x()}}function D(){if(l)return;let P;try{P=e(Vu(s.token,f))}catch{g(),s.onDegrade();return}c=P,P.onopen=()=>{d=0},P.onmessage=B=>{if(l||c!==P)return;h();let V;try{V=JSON.parse(B.data)}catch{return}Uu(V)&&(V.latestEventId!==null&&(f=V.latestEventId),s.onEvent({latestEventId:V.latestEventId,status:V.status}))},P.onerror=()=>{l||c!==P||(P.readyState===Gu||++d>=Cn)&&(g(),s.onDegrade())},h()}return D(),{stop:()=>{l||g()}}}const Wu=2e4;function Yu(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Qu=_(`
...
`);class Hh extends E{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(It);activity=this.inject(bs);auth=this.inject(j);router=this.inject(M);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();K(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",l=new $(()=>{const h=e.get();return h?ao(this.activity.feed.get(),h):null}),d=()=>this.svc.unavailable.get(),c=()=>n()&&d()===null&&i()!==null,u=()=>n()&&d()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(Ah,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&d()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=d();return h?Ee[h].title:""}},refusalMsg:{textContent:()=>{const h=d();return h?Ee[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...ve(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?po(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>l.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=l.get();return h?oo(h):""},onclick:()=>{const h=l.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>mo(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,b,g)=>this.wireEl(Zi,er(h,f),g),h=>h.roundId),m}}const Mh=_(`
    <div class="frounds">
...
`);class Bh extends E{static styles=`
        .fcourses {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(It);auth=this.inject(j);router=this.inject(M);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();K(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],l=()=>(t.get()??"").trim(),d=this.wire(jh,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:l()}})},subtitle:{textContent:()=>{const c=l();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ee[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ee[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(l())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,u,f)=>this.wireEl(Dh,{name:()=>c.courseName??"Course",facts:()=>fo(c,he)},f),c=>c.courseId),d}}function Gh(s,e,t){const n=et(e);if(n){const d=An(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=An(s)??"this",r=et(t),l=r?` at ${r}`:"";return`Watching · ${i} round${l}`}function qh(s,e,t,n){const i=et(s)===null?null:et(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Vh="You're watching this round. Only its players can enter scores.",Ln={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function An(s){const e=et(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function et(s){return(s??"").trim()||null}const Uh=_(`
    <div class="spectate">
