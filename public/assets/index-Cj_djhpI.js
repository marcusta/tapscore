(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const Be="modulepreload",Fe=function(o){return"/tapscore/"+o},me={},Ae=function(e,t,s){let r=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),d=i?.nonce||i?.getAttribute("nonce");r=c(t.map(u=>{if(u=Fe(u),u in me)return;me[u]=!0;const m=u.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${p}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":Be,m||(g.as="script"),g.crossOrigin="",g.href=u,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((_,N)=>{g.addEventListener("load",_),g.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${u}`)))})}))}function n(i){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=i,window.dispatchEvent(d),!d.defaultPrevented)throw i}return r.then(i=>{for(const d of i||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})};class De{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){Te(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const R=new De;function Te(o){for(const e of o.deps)e.delete(o);o.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return R.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,R.notify(this.subs))}update(e){this.set(e(this.val))}}class T{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){R.runTracked(s,()=>{const r=e();Object.is(t.val,r)||(t.val=r,R.notify(t.subs))})},deps:new Set};s.run()}get(){return R.subscribe(this.subs),this.val}peek(){return this.val}}function v(o){const e={run(){R.runTracked(e,o)},deps:new Set};return e.run(),()=>Te(e)}function W(o){R.batch(o)}function A(o){return R.untrack(o)}class Ge{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const z=new Ge,K="/tapscore/".replace(/\/+$/,"");function ne(o){return K?o===K?"/":o.startsWith(K+"/")?o.slice(K.length):o:o}function qe(o){return K+o}class j{constructor(){this.route=new h(ne(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>W(()=>{this.route.set(ne(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},r=e.indexOf("#"),n=r>=0?e.slice(r):"",i=r>=0?e.slice(0,r):e,d=i.indexOf("?"),c=d>=0?i.slice(0,d):i,u=d>=0?i.slice(d+1):"",m=s.query!==void 0?Ke(s.query):u?"?"+u:"",p=qe(c)+m+n;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),W(()=>{this.route.set(c),this.search.set(m)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:r=>{r.preventDefault(),this.navigate(e)},className:()=>{const r=this.route.get();return r===s||r.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new T(()=>{const s=this.route.get().split("/"),r={};for(const[n,i]of t.entries())i.startsWith(":")&&(r[i.slice(1)]=s[n]??"");return r})}query(e){return new T(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new T(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Ke(o){const e=new URLSearchParams;for(const[s,r]of Object.entries(o))r==null||r===""||e.set(s,String(r));const t=e.toString();return t?"?"+t:""}function Ue(o){return e=>o[e]}function We(o,e){const t=(r,n,i)=>{const d=Object.entries(r).map(([c,u])=>`--${c}:${u}`).join(";");return`${n}{color-scheme:${i};${d}}`},s=document.createElement("style");return s.textContent=t(o,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),r=>`var(--${r})`}const fe="basics-js-theme";class Xe{constructor(){this.dark=new h(!1);const e=localStorage.getItem(fe),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),v(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(fe,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function y(o){const e=document.createElement("template");return e.innerHTML=o,e}function Ve(o,e){let t;for(const s of Object.keys(e))o.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const ge=new Set;class I{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!ge.has(t)){ge.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return z.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const r=A(()=>{const n=new e(s[0]);return n.mount(t),n});return this.children.push(r),r}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const r=s??(i=>this.track(i)),n=e.content.cloneNode(!0);for(const i of n.querySelectorAll("[bind]")){const d=t[i.getAttribute("bind")];if(d)if(typeof d=="function")r(v(()=>{const c=d();i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value=String(c):i.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const m=c.includes("-");c.startsWith("on")&&typeof u=="function"?i.addEventListener(c.slice(2),u):typeof u=="function"?r(v(()=>{const p=u();m?i.setAttribute(c,String(p)):i[c]=p})):m?i.setAttribute(c,String(u)):i[c]=u}}return n}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const r=this.ref(t,e);return r?(typeof s=="string"?r.textContent=s:typeof s=="function"&&s.prototype instanceof I?this.spawn(s,r):typeof s=="function"&&s(r,{spawn:(n,i,...d)=>this.spawn(n,i,...d),track:n=>this.track(n)}),!0):!1}$each(e,t,s,r=(n,i)=>i){const n=typeof t=="function"?t:()=>t.get(),i=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(v(()=>{const c=n(),u=new Map;for(const[p,g]of c.entries()){const _=r(g,p);if(i.has(_))u.set(_,i.get(_));else{const N=[];u.set(_,A(()=>s(g,p,x=>N.push(x)))),d.set(_,N)}}for(const[p,g]of i)u.has(p)||(g.remove(),d.get(p)?.forEach(_=>_()),d.delete(p));let m=e.firstChild;for(const p of u.values())p===m?m=m.nextSibling:e.insertBefore(p,m);i.clear();for(const[p,g]of u)i.set(p,g)}))}$condition(e,t,s,r){let n=null;this.track(v(()=>{n&&(n.remove(),n=null);const i=t.get();n=A(()=>i?s():r?.()??null),n&&e.appendChild(n)}))}$swap(e,t,s,r){let n=null;this.track(v(()=>{n&&(n.destroy(),n=null),e.textContent="";const i=t.get(),d=s[i]??Ve(i,s)??r;d&&(n=A(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>n?.destroy())}}async function Qe(o,e,t){const s=document.querySelector(e);s.textContent="";const r=z.get(j);let n=null,i=!1,d=null,c=!!t?.hot?.data.hmr;const u=async m=>{n&&(n.destroy(),n=null,s.textContent=""),m?(d||(d=(await Ae(()=>import("./obs-shell.component-C1uc1T1A.js"),[])).ObsShellComponent),n=A(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),n=A(()=>new o)),A(()=>n.mount(s)),i=m};await u(ne(location.pathname).startsWith("/_obs")),v(()=>{const m=r.route.get().startsWith("/_obs");m!==i&&u(m)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>n?.destroy()),t.hot.accept())}class q extends Error{constructor(e,t,s,r){super(t),this.status=e,this.details=s,this.traceId=r,this.name="ApiError"}}const Ye=10,Q=[];let Y=[],U=null;function Ze(o){Q.push(o),Q.length>Ye&&Q.shift()}function Je(o,e,t){const s={code:o,message:e,url:typeof location<"u"?location.href:"",context:[...Q],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Y.push(s),et()}function et(){U||(U=setTimeout(Ie,5e3))}function Ie(){if(U&&(clearTimeout(U),U=null),Y.length===0)return;const o=Y;Y=[];for(const e of o){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ie()});const tt=3e4,st=2,X=new Map,Ee=new WeakMap;function nt(o){if(o instanceof q)return o.traceId;if(o!=null&&typeof o=="object")return Ee.get(o)}async function f(o){if(o.method==="GET"){const e=X.get(o.url);if(e)return e;const t=be(o,st);return X.set(o.url,t),t.then(()=>X.delete(o.url),()=>X.delete(o.url)),t}return be(o,0)}async function be(o,e){const t=o.timeout??tt;let s;for(let r=0;r<=e;r++){const n=crypto.randomUUID();try{return await ot(rt(o,n),t)}catch(i){if(s=i,!(i instanceof q)&&i!=null&&typeof i=="object"&&Ee.set(i,n),i instanceof q||r===e)break;await new Promise(d=>setTimeout(d,1e3*2**r))}}throw s}async function rt(o,e){const t={"X-Trace-Id":e},s={method:o.method,headers:t};o.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(o.body));const r=await fetch(o.url,s),n=r.headers.get("x-trace-id")??e;if(Ze({type:"api",detail:`${o.method} ${o.url}`,timestamp:new Date().toISOString()}),!r.ok){const i=await r.json().catch(()=>({error:r.statusText}));throw new q(r.status,i.error??r.statusText,i.details,n)}return r.json()}function ot(o,e){let t;const s=new Promise((r,n)=>{t=setTimeout(()=>n(new Error("Request timeout")),e)});return Promise.race([o,s]).finally(()=>clearTimeout(t))}async function C(o,e,t){W(()=>{o.set(!0),e.set(null)});try{const s=await t();return o.set(!1),s}catch(s){const r=it(s);W(()=>{o.set(!1),e.set(r)}),Je(r.code,r.message,nt(s));return}}function it(o){return o instanceof q?o.status===401?{code:"auth",message:"Unauthorized"}:o.status===409?{code:"conflict",message:"Data has changed — please try again"}:o.status===400?{code:"validation",message:o.message}:{code:"server",message:"Server error"}:o instanceof Error?o.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function at(o){return{me:()=>f({method:"GET",url:`${o}/auth/me`}),login:e=>f({method:"POST",url:`${o}/auth/login`,body:e}),logout:()=>f({method:"POST",url:`${o}/auth/logout`,body:{}})}}class ie{constructor(){this.api=at("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await C(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await C(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await C(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const ye={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},a=We({...ye,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...ye,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),$=o=>`var(--${o})`,l=Ue({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),S=(o=$("radius"))=>`
...
`);class dt extends I{static styles=`
        .tabbar {
            display: flex;
...
`),St={not_started:"Not started",active:"Live",complete:"Done"};class _e extends I{static styles=`
        .landing {
    ...
    `;svc=this.inject(wt);router=this.inject(j);render(){this.svc.load();const e=this.wire($t,{createBtn:{onclick:()=>this.router.navigate("/create")},signin:{onclick:()=>this.router.navigate("/login")},count:()=>{const t=this.svc.rounds.get().length;return t===0?"":`${t} on the card`},empty:{className:()=>this.svc.rounds.get().length===0?"landing__empty":"landing__empty hidden"}});return this.$each(this.ref(e,"list"),this.svc.rounds,(t,s,r)=>this.wireEl(kt,{row:{onclick:()=>this.router.navigate("/round",{query:{token:t.friendlyRound.shareToken}})},course:()=>t.round.courseNameSnapshot??"Round",status:{textContent:()=>St[t.round.status]??t.round.status,className:()=>`round-row__status s-${t.round.status}`},date:()=>t.round.date,formats:()=>t.round.formatSlots.map(ae).join(" · ")},r),t=>t.friendlyRound.id),e}}const Tt=180,ve=4,It=12;function G(o,e){return e<=0?0:Math.max(0,Math.min(e-1,o))}function Et(o){const{dragDistance:e,velocity:t,itemWidth:s}=o;if(Math.abs(e)<It)return 0;const r=e+t*Tt,n=Math.round(-r/s);return Math.max(-ve,Math.min(ve,n))}const Pt=["1st","2nd","3rd","4th","5th","6th","7th","8th"],D=(o,e)=>`${o}|${e}`;function Pe(o){return o.players.map(e=>e.displayName).join(" & ")||o.label||"Ball"}function Ct(o,e,t){return o?!(o.minPar!==void 0&&e<o.minPar||o.maxPar!==void 0&&e>o.maxPar||o.pars&&!o.pars.includes(e)||o.holes&&!o.holes.includes(t)):!0}class le{loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);holeIdx=new h(0);groupIdx=new h(0);selectedSlot=new h(0);token=null;loadSeq=0;resultSeq=0;async loadByToken(e,t){const s=e!==this.token;this.token=e;const r=++this.loadSeq;s&&this.resetForNewToken(t),z.get(Z).load();const n=await C(this.loading,this.error,()=>k.friendlyRounds.byToken({token:e}));if(!n||r!==this.loadSeq||e!==this.token)return;this.friendlyRound.set(n.friendlyRound),this.round.set(n.round);const[i,d]=await Promise.all([k.friendlyRounds.balls({token:e}).catch(()=>[]),k.friendlyRounds.scorecard({token:e}).catch(()=>[])]);r!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(i))}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await C(this.resultLoading,this.resultError,()=>k.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&this.result.set(s)}ballNameById=new T(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Pe(t));return e});nameOf(e){return this.ballNameById.get().get(e)??e}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return G(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(i=>i.id===e);if(!t||!s)return"";const r=t.playHoles.filter(i=>i.courseHoleNumber===s.courseHoleNumber).sort((i,d)=>i.ordinal-d.ordinal);if(r.length===1)return`${s.courseHoleNumber}`;const n=r.findIndex(i=>i.id===e);return`${s.courseHoleNumber} (${Pt[n]??`${n+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(G(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(G(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(D(e,t));return s?s.strokes:this.scorecards.get().find(i=>i.ballId===e)?.holes.find(i=>i.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(D(e,t))?.status??null}metadataFor(e,t,s){const r=this.cells.get().get(D(e,t));return r&&r.metadata!==void 0?r.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=z.get(Z),t=this.round.get()?.formatSlots??[],s=[],r=new Set;for(const n of t){const i=e.byId(n.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of i)r.has(d.key)||(r.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Ct(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,r){const n=D(e,t),i=crypto.randomUUID();this.patchCell(n,{strokes:s,metadata:r,status:"saving",clientEventId:i}),await this.post(e,t,s,r,i)}async retry(e,t){const s=D(e,t),r=this.cells.get().get(s);r&&(this.patchCell(s,{...r,status:"saving"}),await this.post(e,t,r.strokes,r.metadata,r.clientEventId))}async post(e,t,s,r,n){if(!this.token)return;const i=D(e,t);try{await k.friendlyRounds.score({token:this.token,ballId:e,playHoleId:t,strokes:s,eventType:s===null?"score_cleared":"score_entered",clientEventId:n,...r!=null?{metadata:r}:{}});const d=this.cells.get().get(i);d&&d.clientEventId===n&&this.patchCell(i,{...d,status:"saved"});const c=this.round.get();c&&c.status==="not_started"&&this.round.set({...c,status:"active"})}catch{const d=this.cells.get().get(i);d&&d.clientEventId===n&&this.patchCell(i,{...d,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.friendlyRound.set(null),this.round.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.selectedSlot.set(e?.selectedSlot??0)}}const B=60,xe=8,re=4,zt=Array.from({length:re*2+1},(o,e)=>e-re),Ot="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",jt=y(`
...
`);class Lt extends I{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
...
</div>`}function Qt(o,e){const t=o.matches.map(s=>{const r=b(s.sideA.ballIds.map(e).join(" & ")),n=b(s.sideB.ballIds.map(e).join(" & ")),i=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,c=s.leader==="a"?" lb-mp__team--lead":"",u=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Yt={ranked:Vt,match_summary:Qt},Zt={"default-score-grid":Ut,"compact-match-grid":Wt,"category-matrix-grid":Xt};function Jt(o){return o.componentId??"default-score-grid"}function es(o){return`<div class="lb-diag">Unrenderable result section <code>${b(o)}</code> — no generic view yet. Results are not hidden.</div>`}function ts(o){return`<div class="lb-diag">Unsupported score-grid component <code>${b(o)}</code> — no generic view yet. Results are not hidden.</div>`}function ss(o,e){const t=Yt[o.kind];return t?t(o,e):es(o.kind)}function ns(o,e,t,s){const r=Jt(o),n=Zt[r];return n?n(o,e,t,s):ts(r)}function rs(o,e){return o.leaderboard.length===0&&o.cards.length===0?`<div class="lb-empty">No scores entered yet for ${b(o.formatLabel)}.</div>`:o.leaderboard.map(s=>ss(s,e)).join("")||`<div class="lb-empty">No leaderboard metric for ${b(o.formatLabel)}.</div>`}function os(o,e,t,s={}){if(o.cards.length===0)return"";const r=s.mode??"product";return o.cards.map(n=>ns(n,e,t,{mode:r})).join(`
`)}const is=y(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class as extends I{static styles=`
        .lb {
...
`),ds=y('<button bind="pill" class="round-view__fmt" type="button"></button>');class cs extends I{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class ks extends I{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 18vh ${l("xl")} 0;
    ...
    `;auth=this.inject(ie);router=this.inject(j);username="";password="";render(){return this.wire($s,{root:{inert:()=>this.auth.loading.get()},error:{className:()=>this.auth.error.get()?"error show":"error",textContent:()=>this.auth.error.get()?.message??""},form:{onsubmit:async e=>{e.preventDefault(),await this.auth.login(this.username,this.password)&&this.router.navigate("/rounds",!0)}},username:{oninput:e=>{this.username=e.target.value}},password:{oninput:e=>{this.password=e.target.value}},submit:{textContent:()=>this.auth.loading.get()?"Signing in…":"Sign in"}})}}class Ss{loading=new h(!1);error=new h(null);guests=new h([]);async load(){const e=await C(this.loading,this.error,()=>k.guestPlayers.list());e&&this.guests.set(e)}async create(e){const t=await C(this.loading,this.error,()=>k.guestPlayers.create(e));return t&&this.guests.update(s=>[...s,t]),t??null}}const Ts=y(`
    <div class="players">
...
`);function Es(o){return o.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Ps extends I{static styles=`
        .players {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class js extends I{static styles=`
    ...
    `;svc=this.inject(Cs);router=this.inject(j);render(){this.svc.load();const e=this.wire(zs,{subtitle:()=>{const s=this.svc.rounds.get().length;return s===0?"No rounds yet — tee one up.":`${s} round${s===1?"":"s"} on the card.`},newBtn:{onclick:()=>this.router.navigate("/create")}}),t={not_started:"Not started",active:"Live",complete:"Done"};return this.$each(this.ref(e,"list"),this.svc.rounds,(s,r,n)=>this.wireEl(Os,{row:{disabled:!0},course:()=>s.courseNameSnapshot??"Round",status:{textContent:()=>t[s.status]??s.status,className:()=>`round-row__status s-${s.status}`},date:()=>s.date,formats:()=>s.formatSlots.map(ae).join(" · ")},n),s=>s.id),e}}const Ns=y(`
    <div class="app-shell">
...
`);class Hs extends I{static styles=`
    ...
    `;router=this.inject(j);render(){const e=this.wire(Ns,{});return this.spawn(dt,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":_e,"/round":cs,"/create":ws,"/login":ks,"/rounds":js,"/players":Ps},_e),e}}z.get(Xe);const ke=z.get(j),Se=z.get(ie);await Qe(Hs,"#app",{hot:void 0,onInit:async()=>{await Se.load(),Se.currentUser.get()&&ke.route.get()==="/login"&&ke.navigate("/",!0)}});export{I as C,j as R,h as S,Xe as T,f as a,W as b,T as c,v as e,C as r,y as t};
