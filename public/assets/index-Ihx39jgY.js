(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const xr="modulepreload",$r=function(s){return"/tapscore/"+s},Qs={},kr=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),l=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=$r(u),u in Qs)return;Qs[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":xr,f||(h.as="script"),h.crossOrigin="",h.href=u,l&&h.setAttribute("nonce",l),document.head.appendChild(h),f)return new Promise((g,y)=>{h.addEventListener("load",g),h.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=d,window.dispatchEvent(l),!l.defaultPrevented)throw d}return i.then(d=>{for(const l of d||[])l.status==="rejected"&&r(l.reason);return e().catch(r)})},si="/tapscore/".replace(/\/+$/,""),fs=si+"/api",Ht={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Sr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function ni(s,e){const t={};for(const[n,i]of Sr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const ii=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Tr={thin:"1px",medium:"3px",thick:"5px"};function ri(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Tr[e.toLowerCase()]??e}function Pr(){return ii.map(s=>{const e=ri(Ht[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const oi={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},ai={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Ir={...ai,"done-opacity":"0.35"},Cr={...oi,...ai,...Ht,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Er={...oi,...Ir,...Ht,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Nr{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;li(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ye=new Nr;function li(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return ye.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ye.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ye.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ye.notify(t.subs))})},deps:new Set};n.run()}get(){return ye.subscribe(this.subs),this.val}peek(){return this.val}}function I(s){const e={run(){ye.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,li(e)}}function tt(s){ye.batch(s)}function Y(s){return ye.untrack(s)}class Rr{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const V=new Rr,Ue=si;function ms(s){return Ue?s===Ue?"/":s.startsWith(Ue+"/")?s.slice(Ue.length):s:s}function Or(s){return Ue+s}class B{constructor(){this.route=new p(ms(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>tt(()=>{this.route.set(ms(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,l=d.indexOf("?"),c=l>=0?d.slice(0,l):d,u=l>=0?d.slice(l+1):"",f=n.query!==void 0?Hr(n.query):u?"?"+u:"",m=Or(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),tt(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Hr(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function Mr(s){return e=>s[e]}const zr="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Xs="data-basics-global";function Lr(){if(document.head.querySelector(`style[${Xs}]`))return;const s=document.createElement("style");s.setAttribute(Xs,""),s.textContent=Pr()+zr,document.head.appendChild(s)}function Ar(s,e){Lr();const t=new Set(ii),n=(r,d,l)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?ri(f):f}`).join(";");return`${d}{color-scheme:${l};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const Js="basics-js-theme";class Fr{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Js),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),I(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(Js,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function Br(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Zs=new Set;class O{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Zs.has(t)){Zs.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return V.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=Y(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){Y(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const l=t[d.getAttribute("bind")];if(l)if(typeof l=="function")i(I(()=>{const c=l();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(l)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(I(()=>{const m=u();f?d.setAttribute(c,String(m)):d[c]=m})):f?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof O?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...l)=>this.spawn(r,d,...l),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,l=new Map;this.track(()=>{for(const c of l.values())c.forEach(u=>u());l.clear()}),this.track(I(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(d.has(g))u.set(g,d.get(g));else{const y=[];u.set(g,Y(()=>n(h,m,w=>y.push(w)))),l.set(g,y)}}for(const[m,h]of d)u.has(m)||(h.remove(),Y(()=>l.get(m)?.forEach(g=>g())),l.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(I(()=>{r&&(r.remove(),r=null);const d=t.get();r=Y(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(I(()=>{if(r){const c=r;r=null,Y(()=>c.destroy())}e.textContent="";const d=t.get(),l=n[d]??Br(d,n)??i;l&&(r=Y(()=>{const c=new l;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const St=new Set;function jr(s){return St.add(s),()=>St.delete(s)}function Dr(){for(const s of Array.from(St)){St.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Gr(s,e,t){const n=document.querySelector(e);n.textContent="";const i=V.get(B);let r=null,d=!1,l=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(l||(l=(await kr(()=>import("./obs-shell.component-CACocu_s.js"),[])).ObsShellComponent),r=Y(()=>new l)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=Y(()=>new s)),Y(()=>r.mount(n)),d=f};await u(ms(location.pathname).startsWith("/_obs")),I(()=>{const f=i.route.get().startsWith("/_obs");f!==d&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Dr(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class U extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const qr=10,xt=[];let $t=[],Xe=null;function Vr(s){xt.push(s),xt.length>qr&&xt.shift()}function di(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...xt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),$t.push(n),Ur()}function Ur(){Xe||(Xe=setTimeout(ci,5e3))}function ci(){if(Xe&&(clearTimeout(Xe),Xe=null),$t.length===0)return;const s=$t;$t=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${fs}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${fs}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ci()});const Kr=3e4,Wr=2,ut=new Map,ui=new WeakMap;function Yr(s){if(s instanceof U)return s.traceId;if(s!=null&&typeof s=="object")return ui.get(s)}async function _(s){if(s.method==="GET"){const e=ut.get(s.url);if(e)return e;const t=en(s,Wr);return ut.set(s.url,t),t.then(()=>ut.delete(s.url),()=>ut.delete(s.url)),t}return en(s,0)}async function en(s,e){const t=s.timeout??Kr;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await Xr(Qr(s,r),t)}catch(d){if(n=d,!(d instanceof U)&&d!=null&&typeof d=="object"&&ui.set(d,r),d instanceof U||i===e)break;await new Promise(l=>setTimeout(l,1e3*2**i))}}throw n}async function Qr(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Vr({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new U(i.status,d.error??i.statusText,d.details,r)}return i.json()}function Xr(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const gs=new Set;let Kt=!1;function Jr(s){return gs.add(s),()=>{gs.delete(s)}}function hi(){if(!Kt){Kt=!0;try{for(const s of[...gs])try{s()}catch(e){try{di("session-listener",Zr(e))}catch{}}}finally{Kt=!1}}}function Zr(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function F(s,e,t,n={}){tt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=eo(i);tt(()=>{s.set(!1),e.set(r)}),di(r.code,r.message,Yr(i)),r.code==="auth"&&n.sessionExpiry!==!1&&hi();return}}function eo(s){return s instanceof U?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const Wt={sessionExpiry:!1};function to(s){return{me:()=>_({method:"GET",url:`${s}/auth/me`}),login:e=>_({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>_({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>_({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class D{constructor(){this.api=to(fs),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Jr(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=jr(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await F(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await F(this.loading,this.error,()=>this.api.login({username:e,password:t}),Wt);return n?(this.currentUser.set(n),!0):!1}async logout(){await F(this.loading,this.error,()=>this.api.logout(),Wt);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await F(this.loading,this.error,()=>this.api.logoutAll(),Wt),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const pi={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},so={...pi,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},no={...pi,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},io=ni(so,Cr),ro=ni(no,Er),a=Ar(io,ro),M=s=>`var(--${s})`,T=(s,e)=>`var(--${s}, ${e})`,P=s=>{const e=Ht[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},o=Mr({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ht=s=>`
    background: ${T(`btn-${s}-bg`,P(`btn-${s}-bg`))};
    color: ${T(`btn-${s}-fg`,P(`btn-${s}-fg`))};
    border-color: ${T(`btn-${s}-border`,P(`btn-${s}-border`))};
    box-shadow: ${T(`btn-${s}-shadow`,P(`btn-${s}-shadow`))};
    &:hover {
        background: ${T(`btn-${s}-bg-hover`,P(`btn-${s}-bg-hover`))};
        color: ${T(`btn-${s}-fg-hover`,P(`btn-${s}-fg-hover`))};
        border-color: ${T(`btn-${s}-border-hover`,P(`btn-${s}-border-hover`))};
    }`,fi=`
    background: ${T("btn-disabled-bg",P("btn-disabled-bg"))};
    color: ${T("btn-disabled-fg",P("btn-disabled-fg"))};
    border-color: ${T("btn-disabled-border",P("btn-disabled-border"))};
    box-shadow: none;
    opacity: ${T("btn-disabled-opacity",P("btn-disabled-opacity"))};
    cursor: not-allowed;`,oo={primary:ht("primary"),secondary:ht("secondary"),ghost:ht("ghost"),danger:ht("danger"),disabled:fi},x=(s=T("btn-radius",P("btn-radius")),e="secondary")=>`
    /*
     ...
     */
    border: ${T("btn-border-width",P("btn-border-width"))} solid transparent;
    border-radius: ${s};
    padding: ${T("btn-padding-y",P("btn-padding-y"))} ${T("btn-padding-x",P("btn-padding-x"))};
    font-family: ${M("font-ui")};
    font-size: ${T("btn-font-size",P("btn-font-size"))};
    line-height: ${T("btn-line-height",P("btn-line-height"))};
    font-weight: ${T("btn-font-weight",P("btn-font-weight"))};
    cursor: pointer;
    transition:
        background ${M("dur-fast")} ${M("ease-standard")},
        border-color ${M("dur-fast")} ${M("ease-standard")},
        color ${M("dur-fast")} ${M("ease-standard")},
        box-shadow ${M("dur-fast")} ${M("ease-standard")};
    &:focus-visible {
        outline: none;
        box-shadow: 0 0 0 ${T("btn-focus-ring-width",P("btn-focus-ring-width"))} ${T("btn-focus-ring",P("btn-focus-ring"))};
    }
    ${oo[e]}
    &:disabled {${fi}}
`,ao=`max(${T("field-border-width",P("field-border-width"))}, ${T("field-rule-width",P("field-rule-width"))})`,pt=(s,e)=>`
    border-top-color: ${s};
    border-right-color: ${s};
    border-left-color: ${s};
    border-bottom-color: ${e};`,ee=()=>`
    border-style: solid;
    border-top-width: ${T("field-border-width",P("field-border-width"))};
    border-right-width: ${T("field-border-width",P("field-border-width"))};
    border-left-width: ${T("field-border-width",P("field-border-width"))};
    border-bottom-width: ${ao};
    ${pt(T("field-border",P("field-border")),T("field-rule",P("field-rule")))}
    border-radius: ${T("field-radius",P("field-radius"))};
    padding: ${T("field-padding-y",P("field-padding-y"))} ${T("field-padding-x",P("field-padding-x"))};
    background: ${T("field-bg",P("field-bg"))};
    color: ${M("text")};
    font-family: ${M("font-ui")};
    font-size: ${T("field-font-size",P("field-font-size"))};
    line-height: ${T("field-line-height",P("field-line-height"))};
    font-weight: 400;
    transition:
        border-color ${M("dur-fast")} ${M("ease-standard")},
        box-shadow ${M("dur-fast")} ${M("ease-standard")},
        background ${M("dur-fast")} ${M("ease-standard")};
    &::placeholder { color: ${M("text-muted")}; }
    &:focus-visible {
        outline: none;
        ${pt(T("field-focus-border",P("field-focus-border")),T("field-focus-border",P("field-focus-border")))}
        background: ${T("field-bg-focus",P("field-bg-focus"))};
        box-shadow: 0 0 0 ${T("field-focus-ring-width",P("field-focus-ring-width"))} ${T("field-focus-ring",P("field-focus-ring"))};
    }
    &[aria-invalid='true'] {
        ${pt(T("field-invalid-border",P("field-invalid-border")),T("field-invalid-rule",P("field-invalid-rule")))}
    }
    &[aria-invalid='true']:focus-visible {
        ${pt(T("field-invalid-border",P("field-invalid-border")),T("field-invalid-rule",P("field-invalid-rule")))}
        background: ${T("field-bg-focus",P("field-bg-focus"))};
        box-shadow: 0 0 0 ${T("field-focus-ring-width",P("field-focus-ring-width"))} ${T("field-invalid-ring",P("field-invalid-ring"))};
    }
`,lo=()=>`
    display: block;
    font-family: ${M("font-ui")};
...
`,C=s=>`
    ...
    box-shadow: ${M("shadow-1")};
    ${s?.hover?`
    transition:
        box-shadow ${M("dur-base")} ${M("ease-standard")},
        border-color ${M("dur-base")} ${M("ease-standard")};
    &:hover { box-shadow: ${M("shadow-2")}; }`:""}
    & .ui-card__eyebrow {
        ${lo()}
        margin: 0 0 ${o("sm")} 0;
    }
...
`);class Ko extends O{static styles=`
        .dock {
            ...
            & .dock__play {
                ...
                &:hover { background: ${a("primary")}; color: ${a("primary-text")}; }
                ...
                &.dock__play--floating {
                    position: fixed;
                    bottom: calc(env(safe-area-inset-bottom) + ${o("lg")});
                }
            }
        }
    ...
    `;router=this.inject(B);auth=this.inject(D);landing=this.inject(Lt);newCount=new $(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Vo,{bar:{className:()=>sn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return qo(r)?sn(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Do(bi),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(Uo,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const l=this.newCount.get();return l===0?"":String(l)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,l)=>i(r,l),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,l)=>i(r,l),r=>r.key),e}}const _i=["tee","approach","putting","shortGame","penalties","recovery"],kt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function yi(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Wo(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Yo="Track statistics",Qo="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function vi(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Tt(s,e){return s[e]}function Xo(s,e){if(!s.enabled)return!0;const t=vi(e);return t===null?!1:!Tt(s,t)}function Jo(s,e){if(!s.enabled)return null;const t=vi(e);return t===null||Tt(s,t)?null:`Needs ${yi(t)}`}function Zo(s,e,t){return ta({...s,[e]:t})}function ea(s,e){return{...s,enabled:e}}function ta(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function Qt(s){const e={...kt,enabled:s.enabled};for(const t of _i)e[t]=s[t];return e}function sa(s){return s.avatarVersion?`${G}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function na(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(mt(t[0])+mt(t[t.length-1])).toUpperCase();if(t.length===1)return mt(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?mt(n).toUpperCase():"•"}function mt(s){return[...s][0]??""}const gt=512,ia=2*1024*1024;function ra(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const oa=.85;class We extends Error{}async function aa(s){let e;try{e=await createImageBitmap(s)}catch{throw new We("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=ra(e.width,e.height),r=document.createElement("canvas");r.width=gt,r.height=gt;const d=r.getContext("2d");if(!d)throw new We("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,gt,gt);const l=await new Promise(c=>r.toBlob(c,"image/jpeg",oa));if(!l)throw new We("That image could not be processed.");if(l.size>ia)throw new We("That image is too large.");return l}finally{e.close()}}async function la(s){const e=await fetch(`${G}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await wi(e);return await e.json()}async function da(){const s=await fetch(`${G}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await wi(s)}async function wi(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new U(t,ca(e.error,s.status))}function ca(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class De{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(kt);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await F(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null),v.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,l]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?Qt(d):kt),this.hasRecordedStats.set((l?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(kt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await F(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await F(this.saving,this.saveError,()=>v.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await F(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await F(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await F(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(Qt(e)));return t?(this.statsConfig.set(Qt(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await aa(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof We?i.message:"That image could not be prepared."}),!1}const n=await F(this.avatarSaving,this.avatarError,()=>la(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await F(this.avatarSaving,this.avatarError,()=>da().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function bt(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function Xt(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Pt(s,e="frecency"){return e==="alpha"?[...s].sort(Xt):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,l=r>0;if(d!==l)return d?-1:1;if(!d)return Xt(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:Xt(t,n)})}const ua=1440*60*1e3;function ha(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/ua);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function pa(s,e){if(s.sharedRoundCount<=0)return"never played";const t=ha(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function fa(s){return s.isMutual?null:"hasn't added you back"}const xi=2;function nn(s){return s.trim().length>=xi}function $i(s){return Pt(s,"frecency")}function ma(s,e){return $i([...s.filter(t=>t.id!==e.id),e])}function ga(s,e){return s.filter(t=>t.id!==e)}function rn(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function ba(s,e,t=()=>{},n=300){let i=0,r;return d=>{const l=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,l.length<xi){e(l,[]);return}r=setTimeout(()=>{s(l).then(u=>{c===i&&e(l,u)},u=>{c===i&&t(l,u)})},n)}}const ki=dt("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function _a(s=Q()){return ki.read(s)}function ya(s,e=Q()){ki.write(s,e)}class At{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(_a());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=ba(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await F(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set($i(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await F(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(ma(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(rn(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),ya(e)}async remove(e){await F(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(ga(this.friends.get(),e)),this.results.set(rn(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class Cs{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await v.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Ye(s,e){return s instanceof U&&s.status===401?(hi(),"Your session expired — sign in again."):e}function It(s){return s===0?"E":s>0?`+${s}`:`${s}`}function va(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${It(s.scoreToPar)}`}function Si(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function Ti(s){return(s.courseName??"").trim()||null}function wa(s){const e=[];for(const t of s){const n=t.friends[0],i=Si(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:Ti(t),progress:va(n)})}return e}function xa(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function $a(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function ka(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function Sa(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${It(s.scoreToPar)}`}function Ta(s){const e=[];for(const t of s){const n=t.friends[0],i=Si(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:Ti(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function Pi(s){if(s instanceof U){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Fe={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function Pa(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function Ia(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function Ca(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${It(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${It(s.scoreToPar)}`}}}function Ea(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function Na(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function Ra(s){return s===1?"1 course played":`${s} courses played`}const Jt={rounds:[],nextCursor:null,hasMore:!1};function on(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function Ii(s){return s.hasMore&&s.nextCursor!==null}class Ft{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(Jt);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await v.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Ye(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(on(Jt,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ye(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!Ii(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(on(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ye(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await v.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Ye(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=Pi(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(Jt),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function Ci(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function Oa(s){return Math.round(Ci(s))}function Ha(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,l=r+(e>n-d?1:0);return l===0?0:-l}function Ma(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function pe(){return Ma()}const Ie=10;class Be{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await F(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=pe()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=pe()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=pe()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=pe()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=pe()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=pe()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Ie:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const an=["scramble","foursomes","greensomes"];class za{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof v.setup?.formations=="function")return this.inFlight=(async()=>{const e=await F(this.loading,this.error,()=>v.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=an.indexOf(n);return i===-1?an.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=pe()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const La=180,ln=4,Aa=12;function Le(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function Fa(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<Aa)return 0;const i=e+t*La,r=Math.round(-i/n);return Math.max(-ln,Math.min(ln,r))}const dn="tapscore:pending-scores:v1",Ba=336*60*60*1e3,cn=200;function ja(){try{return globalThis.localStorage??null}catch{return null}}function Da(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Ga{entries=[];storage;constructor(e=ja(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Ba);return t.length>cn?t.slice(t.length-cn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(dn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Da):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(dn,JSON.stringify(this.entries))}catch{}}}const _e=["tee_result","recovery_ok","gir","short_game_difficulty","first_putt","putts","penalties"],qa={minPar:4},Va={tee_result:"Tee shot",recovery_ok:"Recovery",gir:"Green in regulation",short_game_difficulty:"Short game",first_putt:"First putt",putts:"Putts",penalties:"Penalties"},Ua={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"}]},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null}};function Ka(s){return Va[s]}function un(s){return Ua[s]}function Wa(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function Ei(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}class Ya{modules;par;holeNumber;persistedMap;draft=new Map;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=hn(i),this.draft=new Map(r),this.prune()}refresh(e,t){const n=this.signature();return this.modules=e,this.persistedMap=hn(t),this.prune(),this.signature()!==n}signature(){let e="";for(const t of _e)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e}get prompts(){const e=[];for(const t of _e)this.isVisible(t)&&e.push({key:t,label:Ka(t),control:un(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Ei(qa,this.par,this.holeNumber)?"visible":"unreadable";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(this.record(e,t),this.prune())}step(e,t){const n=un(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<_e.length;e++){let t=!1;for(const n of _e){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),Qa(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of _e){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function Qa(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function hn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of _e){const n=s[t];n!==void 0&&e.set(t,n)}return e}const pn="tapscore:pending-stat-events:v1",Xa=336*60*60*1e3,fn=500;function Ja(){try{return globalThis.localStorage??null}catch{return null}}function Za(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function el(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&_e.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class tl{entries=[];storage;makeId;constructor(e=Ja(),t=Date.now(),n=Za){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const l of i){const c={token:e,playHoleId:t,playerId:n,key:l.key,value:l.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===l.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Xa);return t.length>fn?t.slice(t.length-fn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(pn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(el):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(pn,JSON.stringify(this.entries))}catch{}}}const sl=50;function nl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const Es=dt("tapscore.result-cursors.v1",Ss(nl),sl);function Ns(s=Q()){return Es.read(s)}function il(s,e=Q()){return Ns(e).find(t=>t.token===s)?.cursor??null}function rl(s,e,t=Q()){if(!t)return[];const n=Ns(t).filter(i=>i.token!==s);return Es.write([{token:s,cursor:e},...n],t)}function ol(s,e=Q()){if(!e)return[];const t=Ns(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&Es.write(n,e),n}const al=["1st","2nd","3rd","4th","5th","6th","7th","8th"],ke=(s,e)=>`${s}|${e}`;function Rs(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function ll(s,e,t){return Ei(s,e,t)}function Zt(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function dl(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),e}function cl(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class he{constructor(e=new Ga,t=new tl){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),V.get(Be).load();const r=await F(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Ke({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!Oo(r.round.id))),V.get(D).currentUser.get()&&Ho(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,l,c,u]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[]),v.playerStats.configsByToken({token:e}).catch(()=>null),v.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(l),this.balls.set(d),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),gi(e);const t=this.round.get()?.id;return t&&mi(t),ol(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Ke({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Ke({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await F(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?il(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&rl(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Ke({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Rs(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new $(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(d=>n.subjectLabels?.some(l=>l.ballId===d&&l.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const d=r.entries.find(l=>i(l.ballIds));if(!d)continue;return d.total===null?null:d.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-d.paceDelta:d.paceDelta}:{kind:"total",total:d.total}}if(r.kind==="match_summary"){const d=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!d)continue;if(d.thru===0&&!d.finished)return null;const l=i(d.sideA.ballIds)?"a":"b";if(d.leader===null||d.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=d.leader===l;return{kind:"match",text:`${d.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Le(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,l)=>d.ordinal-l.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${al[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Le(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Le(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(d=>{const l=n.get(d.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return l?.strokes===null||l===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(ke(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(ke(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const l=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===l)?.strokeIndex??d.baseStrokeIndex;return Ha(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.flushStats(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e))&&this.bumpStatRev()}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);return!t||!n?null:new Ya(t,n.par,n.courseHoleNumber,this.persistedStats(e))}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?dl(t):new Map;for(const i of _e){const r=Zt(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=Zt(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=Zt({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await v.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return cl(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(ke(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=V.get(Be),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const l of d)i.has(l.key)||(i.add(l.key),n.push(l))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>ll(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=ke(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const l=this.token;l&&(this.enqueue(l,e,t,n,i,d),await this.post(l,e,t,n,i,d))}async retry(e,t){const n=ke(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(ke(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const l=ke(t,n);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class Ni{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await v.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=Pi(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Ye(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await v.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Rs(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new $(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class Ri{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await F(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const ul=["last5","last10","last20","thisYear","all","custom"];function Ct(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function hl(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function Os(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const Je={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function pl(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function fl(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function es(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function ml(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Bt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function Oi(s){return`${s.getFullYear()}-`}function Hi(s,e,t,n){const i=Bt(t);switch(s){case"last5":case"last10":case"last20":{const r=Os(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=Oi(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>fl(e,r))}}function Mi(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=Os(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${Oi(r)}01-01`;return!n.some(l=>l.date<d)}case"all":return!0;case"custom":{if(pl(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(l=>l.date<d)}}}const gl="Unnamed course";function bl(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??gl,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Et="last10";function _l(s){return ul.includes(s)}const zi=dt("tapscore.stats.window.v1",{decode:s=>_l(s)?s:Et,encode:s=>s,empty:Et});function bs(s=Q()){return zi.read(s)}function mn(s,e=Q()){zi.write(s,e)}function k(s,e){return{value:e===0?null:s/e,n:s,d:e}}const st=5;function Oe(s,e=st){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const _s=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,girRecorded:0,girHits:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0});function yl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5}}function vl(s){let e=_s;for(const t of s)e=yl(e,t);return e}const ve=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function jt(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function wl(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function xl(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function $l(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function Li(s){return k(s.fairwayHits,s.teeRecorded)}function kl(s){return k(s.troubleCount,s.teeRecorded)}function Sl(s){return k(s.holesWithPenalty,s.penaltiesRecorded)}function Tl(s){return{penalty:k(s.strokesVsParPenalty,s.holesScoredPenalty),clean:k(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function Pl(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return k(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Il(s){return k(s.recoverySuccesses,s.recoveryAttempts)}function Cl(s,e){return k(s.penaltiesTotal,e)}function El(s){return{fairway:k(s.strokesVsParFairway,s.holesScoredFairway),inPlay:k(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:k(s.strokesVsParTrouble,s.holesScoredTrouble)}}function Nl(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return k(e,s.holesScoredTrouble*s.holesScoredFairway)}function Ai(s){return k(s.girHits,s.girRecorded)}function Rl(s){return{fairway:k(s.girHitsFairway,s.girRecordedFairway),inPlay:k(s.girHitsInPlay,s.girRecordedInPlay),trouble:k(s.girHitsTrouble,s.girRecordedTrouble)}}function Ol(s){return{par3:k(s.girHitsPar3,s.girRecordedPar3),par4:k(s.girHitsPar4,s.girRecordedPar4),par5:k(s.girHitsPar5,s.girRecordedPar5)}}function Hl(s){const e=k(s.strokesVsParGirHit,s.girHolesScored),t=k(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:k(n,s.holesScoredGirMiss*s.girHolesScored)}}function Ml(s,e){return k($l(s,e),s.girFirstPuttRecorded)}function zl(s){let e=0;for(const t of ve)e+=jt(s,t);return e}function Ll(s,e){return k(jt(s,e),zl(s))}function Al(s){return k(s.birdiesOnGir,s.girHolesScored)}function Fl(s){return k(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}function Bl(s,e){return k(xl(s,e),jt(s,e))}function jl(s){return k(s.threePutts,s.puttsRecorded)}function Dl(s){const e=s.puttsRecorded;return{zero:k(s.holesZeroPutt,e),one:k(s.holesOnePutt,e),two:k(s.holesTwoPutt,e),threePlus:k(s.threePutts,e)}}function Gl(s){return{par3:k(s.puttsTotalPar3,s.puttsRecordedPar3),par4:k(s.puttsTotalPar4,s.puttsRecordedPar4),par5:k(s.puttsTotalPar5,s.puttsRecordedPar5)}}function ql(s){return k(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function Vl(s){return k(s.puttsTotalGir,s.puttsRecordedGir)}function Ul(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return k(e,t)}function Fi(s){return{standard:k(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:k(s.scrambleSuccessesHard,s.scrambleAttemptsHard),overall:k(s.scrambleSuccessesStandard+s.scrambleSuccessesHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}}function Kl(s){return{standard:k(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:k(s.scrambleInside2mHard,s.scrambleFirstPuttHard),overall:k(s.scrambleInside2mStandard+s.scrambleInside2mHard,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard)}}function Wl(s){return{par3:k(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:k(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:k(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Yl(s,e){return k(s.doubleBogeyPlus,e)}function Ql(s){return k(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Xl=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],Jl=18;function Zl(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let f=r.get(c.holeCount);if(f||(f={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,f)),f.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;f.completeRounds+=1;const h=u.strokesTotal-u.parTotal;(f.best===null||h<f.best.vsPar)&&(f.best={vsPar:h,strokes:u.strokesTotal})}const d=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let l=0;for(const c of d)l+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:l,lengths:d,avgVsParPer18:k(n*Jl,t),scoreTypeCounts:i}}const Bi=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),ed=Object.freeze({inside2m:1.25,outside2m:2.12}),td=Object.freeze({standard:1.7,hard:2.1}),ce=["putting","shortGame","penalties","longGame"],sd=.8;function nt(s,e=Bi,t=ed,n=td){let i=0,r=0,d=0;for(const A of ve){const R=jt(s,A);i+=R,r+=wl(s,A),d+=R*e[A]}const l=i===0?null:r-d,c=(A,R,q,E)=>{const K=Math.max(0,R-A);return A*(t.inside2m-E)+K*(t.outside2m-E)+q*(1-(1+E))},u=s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard,f=s.scrambleHoledStandard+s.scrambleHoledHard,m=u===0&&f===0?null:c(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard,s.scrambleHoledStandard,n.standard)+c(s.scrambleInside2mHard,s.scrambleFirstPuttHard,s.scrambleHoledHard,n.hard),h=s.penaltiesTotal,g=s.holesScored===0?null:s.strokesTotal-s.parTotal,y={holesScored:s.holesScored,puttsRecorded:s.puttsRecorded},w=s.puttsRecorded>=sd*s.holesScored,z=g===null||l===null||m===null||!w?null:g-l-m-h;return{putting:l,shortGame:m,penalties:h,longGame:z,total:g,coverage:y}}function je(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function ji(s,e){return{putting:qe(s.putting,e.map(Di)),shortGame:qe(s.shortGame,e.map(nd)),penalties:qe(s.penalties,e.map(Gi)),longGame:qe(s.longGame,e.map(id)),total:qe(s.total,e.map(rd))}}function Hs(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Ms(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function qe(s,e){if(s===null)return null;const t=Ms(e);return t===null?null:s-t}function Di(s){return s.putting}function nd(s){return s.shortGame}function Gi(s){return s.penalties}function id(s){return s.longGame}function rd(s){return s.total}const gn=1,od=2,ad=.75,ld=4,dd=3,cd=12,ud=5,hd=2;function pd(s,e,t,n){const i=ji(e,t),r=[];let d=0;const l=(y,w)=>{r.push({line:y,magnitude:w,order:d++})};let c=null,u=null;for(const y of ce){const w=Hs(i,y);w!==null&&((c===null||w<c.delta)&&(c={component:y,delta:w}),(u===null||w>u.delta)&&(u={component:y,delta:w}))}c!==null&&c.delta<=-gn&&l({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=gn&&l({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=Ms(t.map(Gi));f!==null&&s.penaltiesTotal>=f+od&&l({id:"penalties_spike",params:{penalties:s.penaltiesTotal,baseline:f}},0),s.scrambleAttemptsHard>=dd&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&l({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard,h=s.scrambleSuccessesStandard+s.scrambleSuccessesHard;m>=ld&&h>=ad*m&&l({id:"scramble_streak",params:{successes:h,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=cd&&l({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const g=t.map(Di).filter(y=>y!==null);return e.putting!==null&&g.length>=ud&&g.every(y=>e.putting<y)&&l({id:"best_putting_round",params:{putting:e.putting,rounds:g.length}},0),s.bounceBackOpportunities>=hd&&s.bounceBackSuccesses===s.bounceBackOpportunities&&l({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((y,w)=>w.magnitude-y.magnitude||y.order-w.order),r.slice(0,Math.max(0,n)).map(y=>y.line)}const fd=["tee","approach","putting","shortGame","scoring"];function md(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const gd=3,qi={rounds:[],totals:_s,waterfall:nt(_s),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function zs(s){const e=Bt(s);if(e.length===0)return qi;const t=vl(e.map(r=>r.measures)),n=e.map(r=>nt(r.measures)),i=e.length;return{rounds:e.map((r,d)=>{const l=n[d];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:l.total,waterfall:l}}),totals:t,waterfall:nt(t),priorities:bd(n),trends:_d(e),tee:yd(t,i),approach:vd(t),putting:wd(t),shortGame:xd(t),scoring:$d(t,i),results:Zl(e)}}function bd(s){const e=ce.map(n=>{const i=s.map(r=>je(r,n));return{component:n,perRound:Ms(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>ce.indexOf(n);return e.sort((n,i)=>n.perRound!==null&&i.perRound!==null?n.perRound===i.perRound?t(n.component)-t(i.component):i.perRound-n.perRound:n.perRound!==null?-1:i.perRound!==null?1:t(n.component)-t(i.component))}function ts(s){return Oe(s)==="percentage"?s.value:null}function _d(s){const e=[...s].reverse(),t=(n,i,r,d)=>{const l=[];for(const c of e){const u=d(c.measures);u!==null&&l.push(u)}return l.length>=gd?{id:n,title:i,kind:r,points:l}:null};return[t("fairway","Fairways","percentage",n=>ts(Li(n))),t("gir","Greens","percentage",n=>ts(Ai(n))),t("putting","Putting","strokesLost",n=>nt(n).putting),t("scramble","Scrambling","percentage",n=>ts(Fi(n).overall))].filter(n=>n!==null)}function yd(s,e){return s.teeRecorded<=0?null:{fairway:Li(s),inPlayOnly:k(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:kl(s),troubleTax:Nl(s),vsParByTee:El(s),recovery:Il(s),penaltiesPerRound:Cl(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:Sl(s),penaltyTax:Pl(s),vsParByPenalty:Tl(s)}}function vd(s){if(s.girRecorded<=0)return null;const e={};for(const t of ve)e[t]=Ml(s,t);return{gir:Ai(s),girByTee:Rl(s),girFirstPuttMix:e,birdieConversion:Al(s),hardChipShare:Fl(s),girByPar:Ol(s),costOfMissedGreen:Hl(s)}}function wd(s){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const e={};for(const t of ve)e[t]=Ll(s,t);return{ladder:ve.map(t=>({bucket:t,made:Bl(s,t),baseline:Math.max(0,2-Bi[t])})),firstPuttSpread:e,threePutt:jl(s),threePuttsFromOver8m:ql(s),puttsPerGirHole:Vl(s),puttsAfterMissedGreen:Ul(s),puttDistribution:Dl(s),puttsPerHoleByPar:Gl(s)}}function xd(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:Fi(s),chipInside2m:Kl(s),conversionInside2m:k(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,overall:s.scrambleHoledStandard+s.scrambleHoledHard}}}function $d(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Wl(s),doubleBogeyPlusPerRound:Yl(s,e),bounceBack:Ql(s)}}function Vi(s){let e=0;for(const t of s)for(const n of ce){const i=je(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function kd(s){let e=0;for(const t of s)t.perRound!==null&&(e=Math.max(e,Math.abs(t.perRound)));return e}function Ls(s){const e=V.get(Be);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function Sd(s){const e=V.get(Be);return e.load(),e.labelOf(s)??s}function Td(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:Co(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(Ls).join(" · ")}))}function Pd(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function it(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Nt(s){return s.courseName?it(s)===s.courseName?null:s.courseName:null}function Ne(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const Ze={fromMyRounds:Td,fromDeviceRounds:Pd};function me(s){switch(Oe(s)){case"absent":return null;case"fraction":return`${oe(s.n)} of ${oe(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function Id(s){return Oe(s)!=="percentage"?null:`${oe(s.n)} of ${oe(s.d)}`}function re(s){const e=me(s);if(e===null)return null;const t=Id(s);return t===null?e:`${e} (${t})`}function rt(s,e=2,t=!1){return Oe(s)==="absent"||s.value===null?null:t?He(s.value,e):xe(s.value,e)}function As(s){return{one:s,many:`${s}s`}}const fe=As("round"),ie=As("hole"),ys=As("green"),Fs="thin sample";function Ui(s,e){switch(Oe(s)){case"absent":return null;case"fraction":return`over ${J(s.d,e)} — ${Fs}`;case"percentage":return`over ${J(s.d,e)}`}}function ne(s,e){const t=rt(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=Ui(s,e.unit);return i===null?n:`${n} (${i})`}const Cd={one:"hole from trouble",many:"holes from trouble"},Ed={one:"from the fairway",many:"from the fairway"};function Nd(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${J(e,Cd)} vs ${J(t,Ed)}`;return e<st||t<st?`${n} — ${Fs}`:n}function Ki(s,e,t,n){if(s.d<=0||t.d<=0)return null;const i=`over ${J(s.d,e)} vs ${J(t.d,n)}`;return s.d<st||t.d<st?`${i} — ${Fs}`:i}const Rd={one:"hole with the green missed",many:"holes with the green missed"},Od={one:"green hit",many:"greens hit"},Hd={one:"hole with a penalty",many:"holes with a penalty"},Md={one:"without",many:"without"};function zd(s){return Ki(s.miss,Rd,s.hit,Od)}function Ld(s){return Ki(s.penalty,Hd,s.clean,Md)}function Ad(s){return Oe(s)==="fraction"}function oe(s){return s===Math.round(s)?String(Math.round(s)):xe(s,1)}function J(s,e){return`${oe(s)} ${s===1?e.one:e.many}`}function xe(s,e=1){return s.toFixed(e)}function He(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return xe(0,e);const i=xe(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function Fd(s){return`${He(s)}/round`}function Dt(s){return s===0?"E":He(s,s===Math.round(s)?0:1)}function Gt(s){switch(s){case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"longGame":return"Long game"}}function ss(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function Bd(s){return s==="indoor"?"Indoor":"Outdoor"}function jd(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Wi(s){return Ne(s)}const Yi="Statistics",Dd="All statistics →";function Gd(s){return s==="custom"?Et:s}function qd(s,e,t){return Os(s)!==null||!t?Ct(s):`${Ct(s)} — newest ${e}`}function Vd(s){return k(s.strokesTotal-s.parTotal,s.holesScored)}function Ud(s){const e=[],t=Vd(s.totals),n=rt(t,2,!0);if(n!==null){const c=Oe(t)==="fraction"?Ui(t,ie):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:me(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,l=d===null?null:me(d.gir);return l!==null&&e.push({id:"gir",value:l,label:"Greens in regulation",note:null}),e}function Kd(s){const e=s.priorities.find(t=>t.perRound!==null);return!e||e.perRound===null||e.perRound<=0?null:`Costing you most: ${Gt(e.component)}`}function Wd(s){const e=Gd(s.preset),t=Hi(e,Je,s.rows,s.now);if(t.length===0)return null;const n=zs(t),i=Ud(n);if(i.length===0)return null;const r=Mi({preset:e,filter:Je,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:qd(e,t.length,r),tiles:i,priorityLine:Kd(n)}}function Yd(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${Yi}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class qt{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(bs());loaded=!1;loading=!1;card=new $(()=>{const e=this.rows.get();return e===null?null:Wd({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(bs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await v.playerStats.myStats({limit:qt.PAGE_SIZE});this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof U&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const Ws=class Ws extends O{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(I(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};Ws.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let te=Ys;async function Qd(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Xd="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function $e(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function we(s){const e=()=>sa(s());return{avatarPhoto:{src:()=>e()??Xd,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return na(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Ee(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function Jd(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Zd(s){return Jd(s).map(e=>e.kind)}function bn(s){return s.signedIn?"avatar":"signin"}const ec=b(`
...
`);class tc extends O{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
    ...
    `;auth=this.inject(D);profile=this.inject(De);friends=this.inject(At);activity=this.inject(Cs);friendProfile=this.inject(Ft);spectate=this.inject(Ni);admins=this.inject(Ri);homeStats=this.inject(qt);landing=this.inject(Lt);router=this.inject(B);open=new p(!1);state=new $(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));signOutAllOpen=new p(!1);has(e){return Zd(this.state.get()).includes(e)}rowClass(e,t=""){const n=`acct__row${t}`;return this.has(e)?n:`${n} hidden`}async signOut(e={}){await Qd({auth:this.auth,profile:this.profile,friends:this.friends,activity:this.activity,friendProfile:this.friendProfile,spectate:this.spectate,admins:this.admins,homeStats:this.homeStats,landing:this.landing,navigate:t=>this.router.navigate(t)},e)}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(ec,{signin:{className:()=>bn(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},...we(()=>{const u=this.profile.player.get();return{id:u?.id??"",avatarVersion:u?.avatarVersion??null,displayName:this.state.get().displayName,username:this.state.get().username}}),avatar:{className:()=>bn(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden","aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const u=this.state.get();return(u.displayName??"").trim()||(u.username??"").trim()||"Signed in"},idUser:()=>{const u=(this.state.get().username??"").trim();return u===""?"":`@${u}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOut()}},signoutAll:{className:()=>this.rowClass("signout-all"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOutAllOpen.set(!0)}}});this.spawn(te,this.ref(e,"confirmHost"),{open:this.signOutAllOpen,title:"Sign out everywhere?",message:"Every device signed in to this account is signed out, including this one. Rounds and scores are untouched — you can sign back in with your password.",confirmLabel:"Sign out everywhere",cancelLabel:"Cancel",onconfirm:()=>{this.signOut({everywhere:!0})}});const t=this.ref(e,"root"),n=e.querySelector('[bind="avatar"]'),i=u=>{u.key==="Escape"&&this.open.get()&&(this.open.set(!1),n?.focus())},r=u=>{if(!this.open.get())return;const f=u.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let d=!1;const l=()=>{d||(d=!0,window.addEventListener("keydown",i),document.addEventListener("pointerdown",r,!0))},c=()=>{d&&(d=!1,window.removeEventListener("keydown",i),document.removeEventListener("pointerdown",r,!0))};return this.track(I(()=>{this.open.get()?l():c()})),this.track(c),e}}function Ae(s){return s.token===null?null:s.created?"delete":s.played?"leave":null}function Qi(s){return s==="delete"?"Delete round":"Remove me from this round"}const sc=14,nc=1440*60*1e3;function Ve(s,e){return e(s)}function ic(s,e,t,n=sc){const i=e-n*nc,r=[],d=[];for(const l of s){const c=Ve(l,t);if(c.status==="complete"){const u=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(u)||u>=i)&&d.push(l)}else r.push(l)}return r.sort((l,c)=>_n(Ve(l,t).lastActivityAt,Ve(c,t).lastActivityAt)),d.sort((l,c)=>_n(Ve(l,t).completedAt,Ve(c,t).completedAt)),{ongoing:r,finished:d}}function _n(s,e){const t=s?Date.parse(s):NaN,n=e?Date.parse(e):NaN,i=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(n)?Number.NEGATIVE_INFINITY:n;return i===r?0:r-i}const rc=3,Xi=4;function ns(s){return s==null||!Number.isFinite(s)?null:`HCP ${s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}`}function Ji(s){return s>Xi}function oc(s){return s.rows===0||s.finished>0?!1:!Ji(s.ongoing)}function ac(s){return s.rows===0}const lc=b(`
...
`),dc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Bs=`
...
`,cc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${Bs}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${dc}</button>
...
`),pc=b(`
    <button bind="row" type="button" class="round-summary recent-row">
        ...
        <span class="recent-row__content">${Bs}</span>
    </button>
`);class yn extends O{static styles=`
        .landing {
            ...
            padding: ${o("lg")} ${o("lg")} calc(${o("2xl")} + 76px);
            ...
            & .landing__identity {
                ...
                &.hidden { display: none; }
                &:focus-visible { outline: 2px solid ${a("accent")}; outline-offset: 4px; }
            ...
            & .round-summary {
                ...
                &:hover:not(:disabled) { background: ${a("hover-bg")}; }
                ...
                & .round-summary__progress::before { content: '·'; margin-right: ${o("sm")}; }
            ...
            & .round-row__menu-button {
                ...
                &:hover { background: ${a("hover-bg")}; color: ${a("text")}; }
                &:focus-visible { outline: 2px solid ${a("accent")}; outline-offset: -2px; }
            }
            & .round-row__menu {
                position: absolute;
                ...
                z-index: 3;
                width: max-content;
                max-width: min(220px, calc(100vw - ${o("lg")}));
                padding: ${o("xs")};
            ...
            & .round-row__menu-action {
                ...
                &:hover { background: ${a("hover-bg")}; }
                &:focus-visible { outline: 2px solid ${a("danger")}; outline-offset: -2px; }
            }
    ...
    `;svc=this.inject(Lt);profile=this.inject(De);activity=this.inject(Cs);homeStats=this.inject(qt);auth=this.inject(D);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>this.loggedIn.get()?Ze.fromMyRounds(this.svc.myRounds.get()):Ze.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new $(()=>ic(this.rows.get(),Date.now(),e=>e));ongoing=new $(()=>this.parts.get().ongoing);finished=new $(()=>this.parts.get().finished);ongoingShown=new $(()=>this.ongoing.get().slice(0,Xi));finishedShown=new $(()=>this.finished.get().slice(0,rc));counts=new $(()=>({rows:this.rows.get().length,ongoing:this.ongoing.get().length,finished:this.finished.get().length}));newRows=new $(()=>this.loggedIn.get()?Ze.fromMyRounds(this.svc.newRounds.get()):[]);chips=new $(()=>this.loggedIn.get()?wa(this.activity.feed.get()?.live??[]):[]);recents=new $(()=>this.loggedIn.get()?Ta(this.activity.feed.get()?.recent??[]):[]);statsCard=new $(()=>this.loggedIn.get()?this.homeStats.card.get():null);statsTiles=new $(()=>this.statsCard.get()?.tiles??[]);deleteOpen=new p(!1);leaveOpen=new p(!1);actionTarget=new p(null);actionError=new p("");openRoundMenu=new p(null);askAction(e,t,n,i){this.openRoundMenu.set(null),this.actionError.set(""),this.actionTarget.set({token:t,roundId:n,name:i,action:e}),e==="delete"?this.deleteOpen.set(!0):this.leaveOpen.set(!0)}render(){this.loggedIn.get()?(this.svc.loadMine(),this.profile.load(),this.activity.load(),this.homeStats.refreshPreset(),this.homeStats.load(!0)):this.svc.loadDevice();const e=this.wire(lc,{head:{className:()=>this.loggedIn.get()?"landing__head hidden":"landing__head"},identity:{className:()=>this.loggedIn.get()?"landing__identity":"landing__identity hidden","aria-label":()=>{const r=this.identityName(),d=ns(this.profile.player.get()?.handicapIndex);return d?`${r}, ${d}`:r},onclick:()=>this.router.navigate("/profile")},...we(()=>{const r=this.profile.player.get();return{id:r?.id??"",avatarVersion:r?.avatarVersion??null,displayName:r?.displayName??null,username:r?.username??this.auth.currentUser.get()?.username??null}}),identityName:()=>this.identityName(),identityHcp:{textContent:()=>ns(this.profile.player.get()?.handicapIndex)??"",className:()=>ns(this.profile.player.get()?.handicapIndex)===null?"landing__identity-hcp hidden":"landing__identity-hcp"},history:{className:()=>oc(this.counts.get())?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},outNowSection:{className:()=>this.chips.get().length>0?"landing__section-block landing__outnow":"landing__section-block landing__outnow hidden"},outNowContext:()=>$a(this.activity.feed.get()?.live??[])??"",recentlySection:{className:()=>this.recents.get().length>0?"landing__section-block landing__recently":"landing__section-block landing__recently hidden"},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const r=this.newRows.get().length;return r===0?"":String(r)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block landing__ongoing":"landing__section-block landing__ongoing hidden"},ongoingCount:()=>{const r=this.ongoing.get().length;return r===0?"":String(r)},ongoingMore:{className:()=>Ji(this.counts.get().ongoing)?"landing__ongoing-foot":"landing__ongoing-foot hidden","aria-label":()=>"Show all ongoing rounds",onclick:()=>this.router.navigate("/history")},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block landing__finished":"landing__section-block landing__finished hidden"},finishedCount:()=>{const r=this.finished.get().length;return r===0?"":String(r)},finishedAll:{"aria-label":()=>"All rounds",onclick:()=>this.router.navigate("/history")},stats:{className:()=>this.statsCard.get()===null?"landing__stats hidden":"landing__stats","aria-label":()=>{const r=this.statsCard.get();return r===null?"":Yd(r)},onclick:()=>this.router.navigate("/stats")},statsWindow:()=>this.statsCard.get()?.windowLabel??"",statsPriority:{textContent:()=>this.statsCard.get()?.priorityLine??"",className:()=>this.statsCard.get()?.priorityLine?"landing__stats-priority":"landing__stats-priority hidden"},statsTitle:()=>Yi,statsFoot:()=>Dd,empty:{className:()=>ac(this.counts.get())?"landing__empty":"landing__empty hidden"},actionError:{textContent:()=>this.actionError.get()}});this.$each(this.ref(e,"outNowList"),this.chips,(r,d,l)=>this.wireEl(uc,{chip:{"aria-label":()=>xa(r),onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},...we(()=>{const c=this.chips.get().find(u=>u.roundId===r.roundId)??r;return{id:c.playerId,avatarVersion:c.avatarVersion,displayName:c.displayName}}),who:()=>r.title,line:()=>r.progress},l),r=>r.roundId),this.$each(this.ref(e,"recentlyList"),this.recents,(r,d,l)=>this.wireEl(pc,{row:{onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},...we(()=>({id:r.playerId,avatarVersion:r.avatarVersion,displayName:r.displayName})),title:()=>r.friendLabel,course:{textContent:()=>r.title,className:()=>r.title?"round-summary__course":"round-summary__course hidden"},date:()=>Ne(r.date),progress:{textContent:"",className:"round-summary__progress hidden"},formats:{textContent:()=>(r.formatIds??[]).map(Sd).join(" · "),className:()=>(r.formatIds??[]).length>0?"round-summary__formats":"round-summary__formats hidden"}},l),r=>r.roundId),this.$each(this.ref(e,"newList"),this.newRows,(r,d,l)=>this.roundRow(r,l),r=>r.key),this.$each(this.ref(e,"ongoingList"),this.ongoingShown,(r,d,l)=>this.roundRow(r,l,!0),r=>r.key),this.$each(this.ref(e,"finishedList"),this.finishedShown,(r,d,l)=>this.roundRow(r,l),r=>r.key),this.$each(this.ref(e,"statsTiles"),this.statsTiles,(r,d,l)=>this.wireEl(hc,{value:()=>r.value,label:()=>r.label,note:{textContent:()=>r.note??"",className:()=>r.note===null?"stat-tile__note hidden":"stat-tile__note"}},l),r=>`${r.id}:${r.value}:${r.note??""}`),this.spawn(te,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const r=this.actionTarget.get();return`Delete ${r?`“${r.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.remove(r.token,r.roundId).then(d=>{d||this.actionError.set("Could not delete the round. Try again.")})}}),this.spawn(te,this.ref(e,"confirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.leave(r.token,r.roundId).then(d=>{d.ok||this.actionError.set(d.message)})}});const t=r=>{r.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1),r.key==="Escape"&&this.leaveOpen.get()&&this.leaveOpen.set(!1),r.key==="Escape"&&this.openRoundMenu.get()!==null&&this.openRoundMenu.set(null)};window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t));const n=this.ref(e,"root"),i=r=>{if(this.openRoundMenu.get()===null)return;const d=r.target;d instanceof Node&&n.contains(d)||this.openRoundMenu.set(null)};return document.addEventListener("pointerdown",i,!0),this.track(()=>document.removeEventListener("pointerdown",i,!0)),e}identityName(){const e=this.profile.player.get(),t=(e?.displayName??"").trim();if(t!=="")return t;const n=(e?.username??this.auth.currentUser.get()?.username??"").trim();return n===""?"Signed in":n}roundRow(e,t,n=!1){return this.wireEl(cc,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>it(e),course:{textContent:()=>Nt(e)??"",className:()=>Nt(e)?"round-summary__course":"round-summary__course hidden"},date:()=>Ne(e.date),progress:{textContent:()=>n&&e.holesPlayed&&e.holesPlayed>0?`Thru ${e.holesPlayed}`:"",className:()=>n&&e.holesPlayed&&e.holesPlayed>0?"round-summary__progress":"round-summary__progress hidden"},formats:{textContent:()=>e.formats??"",className:()=>e.formats?"round-summary__formats":"round-summary__formats hidden"},actions:{className:()=>Ae(e)===null?"round-row__actions hidden":"round-row__actions"},menuButton:{"aria-expanded":()=>this.openRoundMenu.get()===e.key?"true":"false",onclick:()=>this.openRoundMenu.set(this.openRoundMenu.get()===e.key?null:e.key)},menu:{className:()=>this.openRoundMenu.get()===e.key?"round-row__menu":"round-row__menu hidden"},action:{textContent:()=>{const i=Ae(e);return i?Qi(i):""},onclick:()=>{const i=Ae(e);!i||e.token===null||this.askAction(i,e.token,e.roundId??"",it(e))}}},t)}}function fc(s){return[...s].sort((e,t)=>{const n=vn(e),i=vn(t);return i!==n?i-n:e.key.localeCompare(t.key)})}function vn(s){const e=s.completedAt??s.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const mc=b(`
    <div class="history">
...
`),gc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',bc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${Bs}</button>
        <div bind="actions" class="round-row__actions">
...
`);class _c extends O{static styles=`
        .history {
            ...
            & .round-row {
                ...
                & .round-row__menu-button {
                    ...
                    & svg { width: 18px; height: 18px; }
                    &:hover, &[aria-expanded='true'] { background: ${a("hover-bg")}; color: ${a("text")}; }
                    &:focus-visible { outline: 2px solid ${a("accent")}; outline-offset: -2px; }
                }
                & .round-row__menu {
                    position: absolute;
    ...
    `;svc=this.inject(Lt);auth=this.inject(D);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>fc(this.loggedIn.get()?Ze.fromMyRounds(this.svc.myRounds.get()):Ze.fromDeviceRounds(this.svc.deviceRounds.get())));ongoingRows=new $(()=>this.rows.get().filter(e=>e.status!=="complete"));finishedRows=new $(()=>this.rows.get().filter(e=>e.status==="complete"));deleteOpen=new p(!1);leaveOpen=new p(!1);actionTarget=new p(null);actionError=new p("");openRoundMenu=new p(null);askAction(e,t,n,i){this.openRoundMenu.set(null),this.actionError.set(""),this.actionTarget.set({token:t,roundId:n,name:i,action:e}),e==="delete"?this.deleteOpen.set(!0):this.leaveOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(mc,{back:{onclick:()=>this.router.navigate("/")},actionError:{textContent:()=>this.actionError.get()},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"},sections:{className:()=>this.rows.get().length===0?"history__sections hidden":"history__sections"},ongoingSection:{className:()=>this.ongoingRows.get().length===0?"history__section history__ongoing hidden":"history__section history__ongoing"},ongoingCount:()=>String(this.ongoingRows.get().length),finishedSection:{className:()=>this.finishedRows.get().length===0?"history__section history__finished hidden":"history__section history__finished"},finishedCount:()=>String(this.finishedRows.get().length)});this.$each(this.ref(e,"ongoingList"),this.ongoingRows,(r,d,l)=>this.roundRow(r,l,!0),r=>r.key),this.$each(this.ref(e,"finishedList"),this.finishedRows,(r,d,l)=>this.roundRow(r,l),r=>r.key),this.spawn(te,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const r=this.actionTarget.get();return`Delete ${r?`“${r.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.remove(r.token,r.roundId).then(d=>{d||this.actionError.set("Could not delete the round. Try again.")})}}),this.spawn(te,this.ref(e,"confirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.leave(r.token,r.roundId).then(d=>{d.ok||this.actionError.set(d.message)})}});const t=r=>{r.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1),r.key==="Escape"&&this.leaveOpen.get()&&this.leaveOpen.set(!1),r.key==="Escape"&&this.openRoundMenu.get()!==null&&this.openRoundMenu.set(null)};window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t));const n=this.ref(e,"root"),i=r=>{if(this.openRoundMenu.get()===null)return;const d=r.target;d instanceof Node&&n.contains(d)||this.openRoundMenu.set(null)};return document.addEventListener("pointerdown",i,!0),this.track(()=>document.removeEventListener("pointerdown",i,!0)),e}roundRow(e,t,n=!1){return this.wireEl(bc,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>it(e),course:{textContent:()=>Nt(e)??"",className:()=>Nt(e)?"round-summary__course":"round-summary__course hidden"},date:()=>Ne(e.date),progress:{textContent:()=>n&&e.holesPlayed&&e.holesPlayed>0?`Thru ${e.holesPlayed}`:"",className:()=>n&&e.holesPlayed&&e.holesPlayed>0?"round-summary__progress":"round-summary__progress hidden"},formats:{textContent:()=>e.formats??"",className:()=>e.formats?"round-summary__formats":"round-summary__formats hidden"},actions:{className:()=>Ae(e)===null?"round-row__actions hidden":"round-row__actions"},menuButton:{"aria-expanded":()=>this.openRoundMenu.get()===e.key?"true":"false",onclick:()=>this.openRoundMenu.set(this.openRoundMenu.get()===e.key?null:e.key)},menu:{className:()=>this.openRoundMenu.get()===e.key?"round-row__menu":"round-row__menu hidden"},action:{textContent:()=>{const i=Ae(e);return i?Qi(i):""},onclick:()=>{const i=Ae(e);!i||e.token===null||this.askAction(i,e.token,e.roundId??"",it(e))}}},t)}}const yc=700;function vc(s){if(!s.currentHole)return!1;const e=s.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function wc(s){return s.currentHole?s.balls.some((e,t)=>t!==s.currentBallIndex&&!e.scored):!1}function is(s){const e=s.currentHole;if(!e)return{kind:"noop"};const t=s.balls,n=s.currentBallIndex;for(let i=n+1;i<t.length;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};for(let i=0;i<n;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};return s.holeIndex>=s.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:s.holeIndex+1,delayMs:yc}}function xc(s,e){const t=s.currentHole;if(e.kind==="statsDone")return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:is(s)};const n=s.balls[s.currentBallIndex];if(!t||!n)return{write:null,move:{kind:"noop"}};if(n.pending)return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:is(s)};const i={ballIndex:s.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&s.collectsStats?{write:i,move:{kind:"openStats"}}:s.holeCompleteOnEntry?{write:i,move:{kind:"stay"}}:{write:i,move:is(s)}}const Se=60,wn=8,ws=4,$c=Array.from({length:ws*2+1},(s,e)=>e-ws),kc="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Sc=b(`
...
`),Nc=b('<button bind="btn" class="se-seg" type="button"></button>'),Rc=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),Oc=b('<div bind="rule" class="se-stats__rule"></div>');class Hc extends O{static styles=`
        .se {
            margin-top: ${o("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__hcpinfo {
                ...
                border: 1px solid ${a("border")}; border-radius: 999px;
                color: ${a("text-muted")};
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${wn}px; flex-shrink: 0; }
        ...
        .se-hcp__head {
            display: flex; align-items: center; justify-content: space-between;
            & .se-hcp__title {
                font-family: ${a("font-display")}; font-weight: 700; font-size: 1.15rem;
                color: ${a("text")};
            }
            & .se-hcp__close {
                background: none; border: none; color: ${a("text-muted")};
        ...
        .se-hcp__steps { display: flex; flex-direction: column; gap: ${o("sm")}; }
        .se-hcp__card {
            display: flex; align-items: flex-start; gap: ${o("md")};
            border: 1px solid ${a("border")}; border-radius: ${a("radius")};
            padding: ${o("md")};
            & .se-hcp__card-body {
            ...
            & .se-hcp__card-text { font-size: 0.9rem; color: ${a("text")}; }
            & .se-hcp__card-math {
                font-size: 0.75rem; color: ${a("text-muted")};
                &[hidden] { display: none; }
            }
            & .se-hcp__card-result {
                font-family: ${a("font-display")}; font-weight: 700; font-size: 1.1rem;
                font-variant-numeric: tabular-nums; color: ${a("text")};
            }
        }
        .se-hcp__foot {
            display: flex; align-items: center; gap: ${o("sm")};
            padding-top: ${o("xs")};
            & .se-hcp__foot-label { font-size: 0.9rem; font-weight: 600; color: ${a("text")}; }
            & .se-hcp__eff {
                font-family: ${a("font-display")}; font-weight: 700; font-size: 1.35rem;
                font-variant-numeric: tabular-nums; color: ${a("accent")};
            }
        }
    ...
    `;svc=this.inject(he);holeIdx=this.svc.holeIdx;modalOpen=this.svc.keypadOpen;currentBallIdx=new p(0);holeCompleteOnEntry=!1;extendedOpen=new p(!1);extendedScore=new p(10);statsOpen=new p(!1);pendingMeta=new p({});lastMetaKey=null;toastMsg=new p(null);hcpInfoBallId=new p(null);dragOffset=new p(0);transitioning=new p(!1);ptr=null;pendingSteps=null;settleTimer=null;advanceTimer=null;flashTimer=null;hasScoring=new $(()=>this.svc.balls.get().length>0);group=()=>this.svc.group();playedOrder=()=>this.svc.playedOrder();holeIndex=()=>this.svc.holeIndex();currentHole=()=>this.svc.currentPlayedHole();occAtOffset=e=>{const t=this.playedOrder();return t[Le(this.holeIndex()+e,t.length)]??null};ballsInGroup=()=>{const e=this.group();if(!e)return[];const t=new Map(this.svc.balls.get().map(n=>[n.id,n]));return e.ballIds.map(n=>t.get(n)).filter(n=>!!n)};parFor=e=>this.svc.parFor(e);occLabel=e=>this.svc.occLabel(e);ballName=e=>Rs(e);metaInputs=()=>this.svc.metadataInputsForHole(this.svc.currentPlayHole()).filter(e=>e.kind==="boolean");displayScore=e=>e===null?"–":String(e);hintText=(e,t)=>{const n=this.svc.strokesHintFor(e,t);return n===null?null:n===0?"0":n>0?`-${n}`:`+${-n}`};toParValue=e=>{let t=0,n=0,i=!1;for(const r of this.playedOrder()){const d=this.svc.strokesFor(e.id,r.playHoleId);d!==null&&d>0&&(t+=d,n+=this.parFor(r.playHoleId),i=!0)}return i?t-n:null};hcpLine=e=>{const t=this.ballsInGroup().find(d=>d.id===e);if(!t||t.pending)return null;const n=t.players.length>1?t.courseHandicap:t.players[0]?.courseHandicap??t.courseHandicap;if(n===null)return null;const i=t.players.length>1?`Team · HCP ${n}`:`HCP ${n}`,r=this.svc.effectivePlayingHandicap(t);return r!==null&&r!==n?`${i} → ${r}`:i};rowDerivation=e=>{const t=this.ballsInGroup().find(n=>n.id===e);return!t||t.pending?null:this.svc.presentedSlot(t)?.handicapDerivation??null};selectedFormatLabel=()=>{const e=this.svc.round.get()?.formatSlots.find(t=>t.slotDefId===this.svc.selectedSlotDefId());return e?Ls(e):null};hcpCards=e=>{const t=this.selectedFormatLabel(),n=[];for(const i of e.steps)switch(i.kind){case"course_handicap":{const r=i.handicapIndex!==null&&i.slope!==null&&i.courseRating!==null&&i.par!==null,d=i.teeName?`the ${i.teeName} tees`:"these tees";n.push({title:`Course handicap · ${i.producerLabel}`,text:r?`Exact handicap ${i.handicapIndex}, adjusted for the difficulty of ${d}.`:`The handicap ${i.producerLabel} plays this course off.`,math:r?`${i.handicapIndex} × ${i.slope} ÷ 113 + (${i.courseRating} − ${i.par}), rounded — the World Handicap System formula.`:null,result:i.result});break}case"team_combination":n.push({title:"Team handicap",text:"The team plays off a share of each member's handicap.",math:`${i.parts.map(r=>`${r.pct}% of ${r.producerLabel}'s ${r.ch}`).join(" + ")}, rounded.`,result:i.result});break;case"allowance":i.pct!==100&&n.push({title:"Allowance",text:`${t??"This format"} is played at ${i.pct}% handicap.`,math:null,result:i.result});break;case"match_delta":n.push(i.ownPh===i.lowestPh?{title:"Match difference",text:"Lowest handicap in the match — plays off scratch, and the others get the difference.",math:null,result:i.result}:{title:"Match difference",text:"In match formats only the difference matters: the lowest ball plays off 0, this ball gets the rest.",math:`${i.ownPh} − ${i.lowestPh} = ${i.result}.`,result:i.result});break}return n};figureText=e=>{const t=this.svc.slotStandingFor(e);if(t===null){const n=this.toParValue(e);return n===null?"–":n===0?"E":n>0?`+${n}`:`${n}`}switch(t.kind){case"pace":{const n=t.delta;return n===0?"E":n>0?`+${n}`:`${n}`}case"total":return String(t.total);case"match":return t.text}};figureClass=e=>{const t=this.svc.slotStandingFor(e);let n,i=!1;if(t===null){const r=this.toParValue(e);n=r===null||r===0?"even":r<0?"under":"over"}else t.kind==="pace"?n=t.delta===0?"even":t.delta<0?"under":"over":t.kind==="total"?n="even":(n=t.tone,i=!0);return`se-row__topar ${n}${i?" se-row__topar--match":""}`};scoreLabel=(e,t)=>{if(e===1)return"HIO";const n=e-t;return n<=-4||n>=5?"OTHER":{"-3":"ALBA","-2":"EAGLE","-1":"BIRDIE",0:"PAR",1:"BOGEY",2:"DOUBLE",3:"TRIPLE",4:"QUAD"}[String(n)]??""};render(){this.track(()=>{this.advanceTimer&&clearTimeout(this.advanceTimer),this.flashTimer&&clearTimeout(this.flashTimer),this.settleTimer&&clearTimeout(this.settleTimer),this.modalOpen.set(!1)}),this.track(I(()=>{const l=this.ballsInGroup().length;l>0&&this.currentBallIdx.get()>=l&&this.selectBall(0)}));const e=this.wire(Sc,{root:{className:()=>this.hasScoring.get()?"se":"se hidden"},close:{onclick:()=>{this.statsOpen.set(!1),this.modalOpen.set(!1),this.svc.flushStats()}},modal:{className:()=>this.modalOpen.get()?"se-modal":"se-modal hidden"},modalTitle:()=>{const l=this.currentHole();return l?`Hole ${this.occLabel(l.playHoleId)} · Par ${this.parFor(l.playHoleId)}`:""},modalPrev:{onclick:()=>this.stepHole(-1),disabled:()=>!this.svc.canPrevHole()},modalNext:{onclick:()=>this.stepHole(1),disabled:()=>!this.svc.canNextHole()},extended:{className:()=>this.extendedOpen.get()?"se-pad__ext":"se-pad__ext hidden"},extVal:()=>String(this.extendedScore.get()),extMinus:{onclick:()=>this.extendedScore.set(Math.max(10,this.extendedScore.get()-1))},extPlus:{onclick:()=>this.extendedScore.set(this.extendedScore.get()+1)},extCancel:{onclick:()=>this.extendedOpen.set(!1)},extOk:{onclick:()=>{this.extendedOpen.set(!1),this.commit(this.extendedScore.get())}},toast:{className:()=>this.toastMsg.get()?"se-toast":"se-toast hidden",textContent:()=>this.toastMsg.get()??""},hcpModal:{className:()=>this.hcpInfoBallId.get()!==null?"se-hcp":"se-hcp hidden",onclick:l=>{l.target===l.currentTarget&&this.hcpInfoBallId.set(null)}},hcpClose:{onclick:()=>this.hcpInfoBallId.set(null)},hcpTitle:()=>{const l=this.hcpInfoBallId.get(),c=l?this.ballsInGroup().find(u=>u.id===l):null;return c?this.ballName(c):""},hcpFormat:()=>this.selectedFormatLabel()??"",hcpEff:()=>{const l=this.hcpInfoBallId.get(),c=l?this.rowDerivation(l):null;return c?String(c.effectivePh):""},stats:{className:()=>this.statsOpen.get()?"se-stats":"se-stats hidden"},statsBack:{onclick:()=>{this.statsOpen.set(!1),this.svc.flushStats()}},statsHole:()=>{const l=this.currentHole();return l?`Hole ${this.occLabel(l.playHoleId)} · Par ${this.parFor(l.playHoleId)}`:""},statsTitle:()=>{const l=this.ballsInGroup()[this.currentBallIdx.get()];return l?this.ballName(l):""},statsScore:()=>{const l=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();return!l||!c?"":this.displayScore(this.svc.strokesFor(l.id,c.playHoleId))},statsNext:{textContent:()=>this.hasMoreUnscored()?"Next ›":"Done ›",onclick:()=>{this.statsOpen.set(!1),this.svc.flushStats(),this.apply({kind:"statsDone"})}}}),t=this.ref(e,"viewport"),n=this.ref(e,"track");this.bindCarouselPointer(t,n),this.track(I(()=>{n.style.transition=this.transitioning.get()?kc:"none",n.style.transform=`translateX(${this.dragOffset.get()}px)`})),this.$each(n,new $(()=>$c),(l,c,u)=>this.holeItem(l,u),l=>l),this.$each(this.ref(e,"rows"),new $(()=>{const l=this.playedOrder(),c=this.holeIndex(),u=l[c];if(!u)return[];const f=c>0?l[c-1].playHoleId:null;return this.ballsInGroup().map(m=>({ball:m,ph:u.playHoleId,prevPh:f}))}),(l,c,u)=>this.playerRow(l.ball,l.ph,l.prevPh,u),l=>`${l.ball.id}|${l.ph}|${l.ball.pending}`),this.$each(this.ref(e,"hcpSteps"),new $(()=>{const l=this.hcpInfoBallId.get(),c=l?this.rowDerivation(l):null;return c?this.hcpCards(c):[]}),(l,c,u)=>this.wireEl(Ic,{ctitle:{textContent:l.title},ctext:{textContent:l.text},cmath:{textContent:l.math??"",hidden:l.math===null},cresult:{textContent:String(l.result)}},u),(l,c)=>`${c}|${l.title}|${l.result}`),this.$each(this.ref(e,"modalList"),new $(()=>this.ballsInGroup()),(l,c,u)=>this.modalRow(l,c,u),l=>l.id);const i=this.ref(e,"keys");for(const l of[1,2,3,4,5,6,7,8,9])i.appendChild(this.numberKey(l));i.appendChild(this.specialKey("10+","","se-key",()=>this.openExtended())),i.appendChild(this.specialKey("✕","clear","se-key clear",()=>this.commit(null))),i.appendChild(this.specialKey("0","pick up","se-key muted",()=>this.commit(0))),this.$each(this.ref(e,"statsBody"),new $(()=>this.statBodyRows()),(l,c,u)=>this.statBodyRow(l,u),l=>l.key),this.track(I(()=>{if(!this.modalOpen.get()){this.lastMetaKey=null,this.svc.seedStatStep(null);return}const l=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();if(!l||!c)return;this.seedStatStepForCursor();const u=`${l.id}|${c.playHoleId}`;if(u===this.lastMetaKey)return;this.lastMetaKey=u;const f={};for(const m of this.metaInputs())f[m.key]=this.svc.metadataFor(l.id,c.playHoleId,m.key)===!0;this.pendingMeta.set(f)}));const r=()=>{document.visibilityState==="hidden"&&this.svc.flushStats()},d=()=>this.svc.flushStats();return document.addEventListener("visibilitychange",r),window.addEventListener("pagehide",d),this.track(()=>{document.removeEventListener("visibilitychange",r),window.removeEventListener("pagehide",d),this.svc.flushStats()}),e}holeItem(e,t){return this.wireEl(Tc,{item:{className:()=>{const n=e===-1&&this.holeIndex()<=0;return`se-hole${e===0?" active":""}${n?" gone":""}`}},hnum:{textContent:()=>{const n=this.occAtOffset(e);return n?this.occLabel(n.playHoleId):""}},hpar:{textContent:()=>{const n=this.occAtOffset(e);return n?`Par ${this.parFor(n.playHoleId)}`:""}}},t)}playerRow(e,t,n,i){return e.pending?this.wireEl(xn,{name:{textContent:this.ballName(e),className:"se-row__name se-row__name--pending"},hcp:{textContent:"open seat"},topar:{textContent:"",className:"se-row__topar"},prev:{textContent:""},cval:{textContent:"–"},circle:{className:"se-row__circle empty se-row__circle--pending"}},i):this.wireEl(xn,{name:{textContent:this.ballName(e)},hcp:{textContent:()=>this.hcpLine(e.id)??"",hidden:()=>this.hcpLine(e.id)===null},hcpInfo:{className:()=>this.rowDerivation(e.id)!==null?"se-row__hcpinfo":"se-row__hcpinfo hidden",onclick:()=>this.hcpInfoBallId.set(e.id)},topar:{textContent:()=>this.figureText(e),className:()=>this.figureClass(e)},prev:{textContent:()=>n?this.displayScore(this.svc.strokesFor(e.id,n)):""},cval:{textContent:()=>{const r=this.svc.strokesFor(e.id,t);return r!==null?this.displayScore(r):this.hintText(e.id,t)??"–"}},circle:{className:()=>this.svc.strokesFor(e.id,t)!==null?"se-row__circle":this.hintText(e.id,t)!==null?"se-row__circle empty hint":"se-row__circle empty",onclick:()=>this.openModalForBall(e.id)}},i)}modalRow(e,t,n){const i=()=>{if(e.pending)return"Open seat — claim to score";const r=e.players.length>1?e.courseHandicap:e.players[0]?.courseHandicap??e.courseHandicap,d=r===null?"–":String(r),l=e.players.length>1?`Team · HCP ${d}`:`HCP ${d}`,c=this.svc.effectivePlayingHandicap(e);return r!==null&&c!==null&&c!==r?`${l} → ${c}`:l};return this.wireEl(Pc,{mrow:{className:()=>this.currentBallIdx.get()===t?"se-mrow sel":"se-mrow",onclick:()=>this.selectBall(t)},mname:{textContent:this.ballName(e)},mhcp:{textContent:i},mval:{textContent:()=>{const r=this.currentHole();if(!r)return"–";const d=this.svc.strokesFor(e.id,r.playHoleId);return d!==null?this.displayScore(d):this.hintText(e.id,r.playHoleId)??"–"},className:()=>{const r=this.currentHole();return!!r&&this.svc.strokesFor(e.id,r.playHoleId)===null&&!!r&&this.hintText(e.id,r.playHoleId)!==null?"se-mrow__val se-mrow__val--hint":"se-mrow__val"}}},n)}numberKey(e){return this.wireEl($n,{key:{className:()=>{const t=this.currentHole();return(t?e===this.parFor(t.playHoleId):!1)?"se-key par":"se-key"},onclick:()=>this.commit(e)},num:{textContent:String(e)},lbl:{textContent:()=>{const t=this.currentHole();return t?this.scoreLabel(e,this.parFor(t.playHoleId)):""}}})}specialKey(e,t,n,i){return this.wireEl($n,{key:{className:n,onclick:i},num:{textContent:e},lbl:{textContent:t}})}openModalForBall(e){const t=this.ballsInGroup().findIndex(n=>n.id===e);this.selectBall(t<0?0:t),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.noteHoleEntered(),this.modalOpen.set(!0)}selectBall(e){this.currentBallIdx.set(e),this.seedStatStepForCursor()}seedStatStepForCursor(){const e=this.ballsInGroup()[this.currentBallIdx.get()],t=this.currentHole(),n=e?this.svc.statSubject(e):null;this.svc.seedStatStep(n&&t?{playerId:n,playHoleId:t.playHoleId}:null)}advanceState(){const e=this.currentHole();return{balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId,label:this.occLabel(e.playHoleId)}:null,holeIndex:this.holeIndex(),holeCount:this.playedOrder().length,holeCompleteOnEntry:this.holeCompleteOnEntry,collectsStats:this.metaInputs().length>0||this.svc.statPrompts().length>0}}noteHoleEntered(){this.holeCompleteOnEntry=vc(this.advanceState())}stepHole(e){this.advanceTimer&&(clearTimeout(this.advanceTimer),this.advanceTimer=null),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.svc.flushStats(),e<0?this.svc.prevHole():this.svc.nextHole(),this.selectBall(0),this.noteHoleEntered()}openExtended(){this.extendedScore.set(10),this.extendedOpen.set(!0)}commit(e){this.apply({kind:"score",value:e})}apply(e){this.execute(xc(this.advanceState(),e))}execute(e){const t=e.write;if(t){const i=this.ballsInGroup()[t.ballIndex];i&&this.svc.setScore(i.id,t.holeId,t.value,t.withMetadata?this.metaSnapshot():void 0)}const n=e.move;switch(n.kind){case"noop":case"stay":return;case"moveToBall":this.selectBall(n.ballIndex);return;case"openStats":this.statsOpen.set(!0);return;case"roundComplete":this.modalOpen.set(!1),this.svc.finishFlowOpen.set(!0);return;case"holeComplete":{this.flash(n.toast),this.advanceTimer&&clearTimeout(this.advanceTimer),this.advanceTimer=setTimeout(()=>{this.advanceTimer=null,this.currentHole()?.playHoleId===n.fromHoleId&&(this.holeIdx.set(Le(n.toHoleIndex,this.playedOrder().length)),this.selectBall(0),this.noteHoleEntered())},n.delayMs);return}}}hasMoreUnscored=()=>{const e=this.currentHole();return wc({balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId}:null})};metaSnapshot(){const e=this.metaInputs();if(e.length===0)return;const t=this.pendingMeta.get(),n={};for(const i of e)n[i.key]=t[i.key]===!0;return n}setMeta(e,t){const n=this.pendingMeta.get();this.pendingMeta.set({...n,[e]:t});const i=this.ballsInGroup()[this.currentBallIdx.get()],r=this.currentHole();if(!i||!r)return;const d=this.svc.strokesFor(i.id,r.playHoleId);d!==null&&this.svc.setScore(i.id,r.playHoleId,d,this.metaSnapshot())}metaChip(e,t){return this.wireEl(Cc,{glabel:{textContent:e.label},miss:{className:()=>this.pendingMeta.get()[e.key]?"se-seg":"se-seg on-miss",onclick:()=>this.setMeta(e.key,!1)},hit:{className:()=>this.pendingMeta.get()[e.key]?"se-seg on-hit":"se-seg",onclick:()=>this.setMeta(e.key,!0)}},t)}metaInputsForStep=()=>{const e=new Set(this.svc.statPrompts().map(t=>t.key));return this.metaInputs().filter(t=>!e.has(t.key))};statBodyRows=()=>{const e=this.metaInputsForStep(),t=this.svc.statPrompts(),n=e.map(i=>({kind:"meta",key:`meta:${i.key}`,input:i}));e.length>0&&t.length>0&&n.push({kind:"rule",key:"rule"});for(const i of t)n.push({kind:"stat",key:`stat:${i.key}`,prompt:i});return n};statBodyRow(e,t){return e.kind==="meta"?this.metaChip(e.input,t):e.kind==="rule"?this.wireEl(Oc,{},t):e.prompt.control.kind==="segments"?this.statSegments(e.prompt,t):this.statStepper(e.prompt,t)}statSegments(e,t){const n=e.control,i=n.kind==="segments"?n.options:[],r=i.length>=4?" tight":"",d=this.wireEl(Ec,{glabel:{textContent:e.label}},t),l=this.ref(d,"seg");for(const c of i){const u=this.wireEl(Nc,{btn:{textContent:c.label,className:()=>`se-seg${r}${this.svc.statValue(e.key)===c.value?" on-neutral":""}`,onclick:()=>this.answerStat(e.key,this.svc.statValue(e.key)===c.value?null:c.value)}},t);l?.appendChild(u)}return d}statStepper(e,t){const n=e.control,i=n.kind==="stepper"?n.min:0,r=n.kind==="stepper"?n.max:null;return this.wireEl(Rc,{glabel:{textContent:e.label},minus:{onclick:()=>this.stepStat(e.key,-1),"aria-label":`Fewer ${e.label}`},plus:{onclick:()=>this.stepStat(e.key,1),"aria-label":`More ${e.label}`},val:{textContent:()=>Wa(this.svc.statStepperValue(e.key,i),r),className:()=>this.svc.statIsAnswered(e.key)?"se-stats__step-val":"se-stats__step-val unanswered","aria-label":()=>this.svc.statIsAnswered(e.key)?`${e.label} ${this.svc.statStepperValue(e.key,i)}`:`${e.label} not answered`}},t)}answerStat(e,t){this.svc.answerStat(e,t),this.mirrorStatToMeta(e)}stepStat(e,t){this.svc.stepStat(e,t),this.mirrorStatToMeta(e)}mirrorStatToMeta(e){if(!this.metaInputs().some(n=>n.key===e))return;const t=this.svc.statValue(e);t!==null&&this.setMeta(e,t==="1")}flash(e){this.toastMsg.set(e),this.flashTimer&&clearTimeout(this.flashTimer),this.flashTimer=setTimeout(()=>{this.flashTimer=null,this.toastMsg.get()===e&&this.toastMsg.set(null)},1100)}snap(e){this.pendingSteps=e,this.transitioning.set(!0),this.dragOffset.set(-e*Se),this.settleTimer&&clearTimeout(this.settleTimer),this.settleTimer=setTimeout(()=>this.finishSettle(),420)}finishSettle(){if(this.pendingSteps===null)return;const e=this.pendingSteps;this.pendingSteps=null,this.settleTimer&&(clearTimeout(this.settleTimer),this.settleTimer=null),this.transitioning.set(!1),e!==0&&this.holeIdx.set(Le(this.holeIndex()+e,this.playedOrder().length)),this.dragOffset.set(0)}bindCarouselPointer(e,t){t.addEventListener("transitionend",i=>{i.propertyName==="transform"&&this.finishSettle()}),e.addEventListener("pointerdown",i=>{this.ptr||this.transitioning.get()||this.playedOrder().length<=1||(this.ptr={id:i.pointerId,startX:i.clientX,startY:i.clientY,lastX:i.clientX,lastTime:Date.now(),velocity:0,horiz:!1},this.dragOffset.set(0),e.setPointerCapture?.(i.pointerId))}),e.addEventListener("pointermove",i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const d=i.clientX-r.startX,l=i.clientY-r.startY;if(!r.horiz){if(Math.abs(l)>Math.abs(d)&&Math.abs(l)>8||Math.abs(d)<=8)return;r.horiz=!0}const c=Date.now(),u=Math.max(1,c-r.lastTime);r.velocity=(i.clientX-r.lastX)/u,r.lastX=i.clientX,r.lastTime=c,this.dragOffset.set(d)});const n=i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const d=i.clientX-r.startX,l=r.horiz;if(this.ptr=null,e.releasePointerCapture?.(i.pointerId),!l){this.dragOffset.set(0);return}this.snap(Fa({dragDistance:d,velocity:r.velocity,itemWidth:Se}))};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",i=>{!this.ptr||this.ptr.id!==i.pointerId||(this.ptr=null,e.releasePointerCapture?.(i.pointerId),this.snap(0))})}}function Mc(s,e){const t=[...s].sort((r,d)=>r.canonicalOrdinal-d.canonicalOrdinal);if(e.length===0)return[{label:"TOT",holes:t,playHoleIds:new Set(t.map(r=>r.playHoleId))}];const n=[...e].sort((r,d)=>r.fromCanonicalOrdinal-d.fromCanonicalOrdinal),i=[];for(const r of n){const d=t.filter(l=>l.canonicalOrdinal>=r.fromCanonicalOrdinal&&l.canonicalOrdinal<=r.toCanonicalOrdinal);d.length!==0&&i.push({label:r.label,holes:d,playHoleIds:new Set(d.map(l=>l.playHoleId))})}return i}function Zi(s,e){const t=s.cells.filter(n=>e.has(n.playHoleId));if(s.aggregate==="sum"){const n=t.map(i=>i.value).filter(i=>i!==null);return n.length===0?"—":String(n.reduce((i,r)=>i+r,0))}if(s.aggregate==="last"){for(let n=t.length-1;n>=0;n--){const i=t[n].value;if(i!==null)return Number.isInteger(i)?String(i):i.toFixed(1)}return"—"}return"—"}function zc(s,e){if(s.aggregate==="sum"){const t=s.cells.map(n=>n.value).filter(n=>n!==null);return t.length===0?"—":String(t.reduce((n,i)=>n+i,0))}if(s.aggregate==="last"){const t=e[e.length-1];return t?Zi(s,t.playHoleIds):"—"}return"—"}function Lc(s){const e=s?.marker;if(e){const t=e.tone;return{kind:"marker",template:e.template,tone:t==="success"||t==="warning"||t==="danger"?t:null,label:e.label?e.label:null,teamFill:s?.team??null}}return s?.team?{kind:"pill",team:s.team}:{kind:"plain"}}function Ac(s){return s.filter(e=>!(e.startsWith("slot #")||/^HCP -?\d/.test(e)||/^PH -?\d/.test(e)))}const Rt=" & ";function er(s){return s.componentId??"default-score-grid"}function js(s,e,t,n={}){const i=Mc(s.holes,e),r=n.mode??"product",d=s.rows.map(l=>{const c=new Map(l.cells.map(u=>[u.playHoleId,u]));return{kind:l.kind,emphasis:l.emphasis===!0,team:l.team??null,subjectName:l.subjectBallId?t(l.subjectBallId):null,labelText:l.label,groups:i.map(u=>({cells:u.holes.map(f=>{const m=c.get(f.playHoleId);return{text:m?.display??"",title:m?.title?m.title:null,decoration:Lc(m)}}),subtotal:Zi(l,u.playHoleIds)})),total:zc(l,i)}});return{componentId:er(s),subjectBallIds:[...s.subjectBallIds],title:{groups:s.title.groups.map(l=>l.map(c=>t(c))),joiner:s.title.joiner,nameJoiner:Rt},subtitleFacts:r==="verification"?[...s.subtitleFacts]:Ac(s.subtitleFacts),footnotes:[...s.footnotes],caption:s.caption??null,totals:s.totals.map(l=>({label:l.label,value:String(l.value??"—")})),columnGroups:i.map(l=>({label:l.label,columns:l.holes.map(c=>({label:c.occurrenceLabel}))})),hasTotalColumn:i.length>1,rows:d}}function rs(s){return[...new Set(s)].sort().join("\0")}function Fc(s,e){const t=new Map;e.forEach((i,r)=>{if(i.ballIds.length===0)return;const d=rs(i.ballIds);t.set(d,t.has(d)?null:r)});const n=new Map;for(const i of s){if(i.subjectBallIds.length===0)continue;const r=rs(i.subjectBallIds);n.set(r,(n.get(r)??0)+1)}return s.map(i=>{if(i.subjectBallIds.length===0)return{kind:"standalone"};const r=rs(i.subjectBallIds);if((n.get(r)??0)!==1)return{kind:"standalone"};const d=t.get(r);return d==null?{kind:"standalone"}:{kind:"attached",entryIndex:d}})}function Bc(s,e){const t=new Set(s.map(e));return t.size!==1?null:[...t][0]??null}function jc(s,e){if(s===void 0)return null;const t=e==="high"?-s:s;return{text:t===0?"E":t>0?`+${t}`:`−${Math.abs(t)}`,tone:t===0?"even":t>0?"over":"under"}}const Dc=()=>null;function Gc(s,e,t=Dc){return{kind:"ranked",metricLabel:s.metricLabel,hasPace:s.entries.some(n=>n.paceDelta!==void 0),entries:s.entries.map(n=>({position:n.position,lead:n.position===1,name:n.ballIds.map(e).join(Rt),group:Bc(n.ballIds,t),total:String(n.total??"—"),holesPlayed:n.holesPlayed,pace:jc(n.paceDelta,s.direction)}))}}function qc(s,e){return{kind:"match_summary",title:s.title,matches:s.matches.map(t=>({sideAName:t.sideA.ballIds.map(e).join(Rt),sideBName:t.sideB.ballIds.map(e).join(Rt),leader:t.leader,standing:t.magnitude===0?"AS":`${t.magnitude} UP`,status:t.finished?"Final":`thru ${t.thru}`}))}}function xs(s,e){return[s,...[...new Set(e)].sort()].join("|")}const Vc=new Map;function Uc(s){const e=s.cards??[],t=(s.leaderboard??[]).find(d=>d.kind==="ranked")??null;if(!t)return{rankedSection:null,slotDefId:s.slotDefId,attached:Vc,standalone:[...e]};const n=Fc(e,t.entries),i=new Map,r=[];return e.forEach((d,l)=>{const c=n[l],u=c?.kind==="attached"?t.entries[c.entryIndex]:void 0;if(!u){r.push(d);return}i.set(xs(s.slotDefId,u.ballIds),d)}),{rankedSection:t,slotDefId:s.slotDefId,attached:i,standalone:r}}class Kc{open=new Set;isOpen(e){return this.open.has(e)}toggle(e){return this.set(e,!this.open.has(e))}set(e,t){return t?this.open.add(e):this.open.delete(e),t}keys(){return[...this.open].sort()}retain(e){const t=new Set(e);for(const n of[...this.open])t.has(n)||this.open.delete(n)}}const Ds={ring:{meaning:"a single-unit decided result",fill:"#d63b2f",visual:"red filled circle — the Gamebook birdie mark (score to par −1)"},double_ring:{meaning:"a two-unit decided result; more emphatic than a ring",fill:"#e0862c",teamFillBorder:"border-width: 3px; border-style: double;",visual:"orange filled circle (score to par −2); doubled white border when team-filled"},diamond:{meaning:"a rare / high-magnitude decided result — the strongest form",fill:"#e0b41f",visual:"yellow filled circle — hole-in-one / albatross territory"},dot:{meaning:"a lightweight per-hole flag where a full ring would be too heavy",visual:"the bare base shape (no fill, no border) — inherits cell colour"},badge:{meaning:"a labelled status needing short text or a number, not just a shape",rule:["width: auto; min-width: 1.8em;","padding-left: 0.45em; padding-right: 0.45em;","border: 2px solid currentColor;"],tones:{success:"#267348",warning:"#946200",danger:"#9b332a"},visual:"outline pill in the tone colour, text inside"},square:{meaning:"a one-step negative score relation",fill:"#5b9bd5",boxy:!0,visual:"light-blue filled square (score to par +1)"},double_square:{meaning:"a stronger negative score relation",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square (score to par +2)"},box_badge:{meaning:"an angular labelled state that must not read as a round marker",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square carrying its value (+3 or worse)"}};function ot(s){return`lb-mark--${s}`}const Qe=()=>Object.entries(Ds);function tr(s){return s.join(`
            `)}function os(s,e){return s.map((t,n)=>`& .${ot(t)}${n===s.length-1?` { ${e} }`:","}`)}function Wc(){const s=[];s.push("/* Outline forms keep currentColor + tone tints. */");for(const[r,d]of Qe())if(!(!d.rule&&!d.tones)){if(d.rule){s.push(`& .${ot(r)} {`);for(const l of d.rule)s.push(`    ${l}`);s.push("}")}for(const[l,c]of Object.entries(d.tones??{}))s.push(`& .${ot(r)}.lb-mark-tone--${l} { color: ${c}; }`)}s.push("/* Filled forms — declared after the tone rules so white text wins. */");const e=Qe().filter(([,r])=>r.boxy).map(([r])=>r),t=[],n=new Set;for(const[r,d]of Qe()){if(d.fill===void 0||n.has(r))continue;const l=Qe().filter(([,c])=>c.fill===d.fill).map(([c])=>c);for(const c of l)n.add(c);t.push({fill:d.fill,ids:l})}let i=-1;if(e.length>0){const r=t.findIndex(d=>d.ids.some(l=>Ds[l].boxy));i=r===-1?t.length:r}return t.forEach((r,d)=>{d===i&&s.push(...os(e,"border-radius: 3px;")),s.push(...os(r.ids,`background: ${r.fill}; color: #fff;`))}),i===t.length&&s.push(...os(e,"border-radius: 3px;")),tr(s)}function Yc(){const s=[];for(const[e,t]of Qe()){if(!t.teamFillBorder)continue;const n=ot(e);s.push(`& .${n}.lb-mark-fill--a,`,`& .${n}.lb-mark-fill--b { ${t.teamFillBorder} }`)}return tr(s)}const sr=()=>null;function L(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Qc(s){return s.kind==="si"?"lb-c-si":s.kind==="given"?"lb-c-given":s.kind==="status"?"lb-c-status":s.kind==="category"?"lb-c-cat":""}function Xc(s){const e=[s.kind==="category"?"lb-r-cat":`lb-r-${s.kind}`];return(s.kind==="si"||s.kind==="given")&&e.push("lb-r-dim"),s.team&&e.push(`lb-team-${s.team}`),e.join(" ")}function Jc(s,e,t){const n=s.title!==null?` title="${L(s.title)}"`:"",i=t(L(s.text)),r=s.decoration;let d;if(r.kind==="marker"){const l=r.tone?` lb-mark-tone--${r.tone}`:"",c=r.teamFill?` lb-mark-fill--${r.teamFill}`:"",u=r.label!==null?` title="${L(r.label)}" aria-label="${L(r.label)}"`:"";d=`<span class="lb-mark ${ot(r.template)}${l}${c}"${u}>${i}</span>`}else r.kind==="pill"?d=`<span class="lb-pill lb-pill--${r.team}">${i}</span>`:d=i;return`<td class="${Qc(e)}"${n}>${d}</td>`}function Gs(s,e){const t=m=>{const h=s.columnGroups[m],g=`<tr><th class="lb-rowlabel">Hole</th>${h.columns.map(w=>`<th>${L(w.label)}</th>`).join("")}<th class="lb-sum">${L(h.label)}</th></tr>`,y=s.rows.map(w=>{const z=K=>w.emphasis?`<strong>${K}</strong>`:K,A=w.groups[m],R=A.cells.map(K=>Jc(K,w,z)).join(""),q=`<td class="lb-sum">${z(A.subtotal)}</td>`,E=w.subjectName!==null?L(w.subjectName)+(w.labelText?" "+L(w.labelText):""):L(w.labelText);return`<tr class="${Xc(w)}"><th class="lb-rowlabel">${E}</th>${R}${q}</tr>`}).join("");return`<div class="lb-card__scroll"><table class="lb-grid"><thead>${g}</thead><tbody>${y}</tbody></table></div>`},n=s.columnGroups.map((m,h)=>t(h)).join(""),i=s.title.groups.map(m=>m.map(h=>L(h)).join(s.title.nameJoiner)).filter(Boolean).join(s.title.joiner),r=s.subtitleFacts.length?`<div class="lb-card__sub">${s.subtitleFacts.map(L).join(" · ")}</div>`:"",d=e.mode==="verification"&&s.footnotes.length?`<div class="lb-card__notes"><span class="lb-card__notes-label">Points breakdown</span>${s.footnotes.map(m=>`<span class="lb-card__note">${L(m)}</span>`).join("")}</div>`:"",l=e.mode==="verification"&&s.caption?`<p class="lb-card__caption">${L(s.caption)}</p>`:"",c=s.totals.length?`<ul class="lb-card__totals">${s.totals.map(m=>`<li>${L(m.label)} = <strong>${m.value}</strong></li>`).join("")}</ul>`:"",u=i?`<header class="lb-card__head"><h4>${i}</h4>${r}</header>`:r;return`<article class="${e.cardModifier?`lb-card ${e.cardModifier}`:"lb-card"}">
  ${u}
  ${n}
  ${d}${l}${c}
</article>`}function Zc(s,e,t,n){return Gs(js(s,e,t,n),n)}function eu(s,e,t,n){return Gs(js(s,e,t,n),{...n,cardModifier:"lb-card--compact-match"})}function tu(s,e,t,n){return Gs(js(s,e,t,n),{...n,cardModifier:"lb-card--category-matrix"})}function su(s){return s.pace===null?'<td class="lb-rank__pace"></td>':`<td class="lb-rank__pace lb-rank__pace--${s.pace.tone}">${L(s.pace.text)}</td>`}function nu(s){return`lb-panel-${s.replace(/[^a-zA-Z0-9_-]+/g,"-")}`}function iu(s,e,t=sr,n=null){const i=Gc(s,e,t),r=i.hasPace,d=n!==null,l=(r?5:4)+(d?1:0),c=i.entries.map((g,y)=>{const w=g.group?` <span class="lb-rank__group">${L(g.group)}</span>`:"",z=`
  <td class="lb-rank__total">${g.total}</td>${r?`
  ${su(g)}`:""}
  <td class="lb-rank__thru">${g.holesPlayed}</td>`,A=s.entries[y],R=n&&A?n.plan.attached.get(xs(n.plan.slotDefId,A.ballIds)):void 0;if(!n)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${L(g.name)}</span>${w}</span></td>${z}
</tr>`;if(!A||!R)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${L(g.name)}</span>${w}</span></td>${z}
  <td class="lb-rank__disclosure"></td>
</tr>`;const q=xs(n.plan.slotDefId,A.ballIds),E=n.isOpen(q),K=nu(q),ae=nr(R,n.routeSections,e,{mode:n.mode??"product"}),le=["lb-rank__row--expandable"];return g.lead&&le.push("lb-rank__lead"),E&&le.push("lb-rank__row--open"),`<tr class="${le.join(" ")}" data-expand-key="${L(q)}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${E}" aria-controls="${L(K)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${L(g.name)}</span>${w}</span></button></td>${z}
  <td class="lb-rank__disclosure"><span class="lb-rank__chev" aria-hidden="true"></span></td>
</tr>
<tr class="lb-rank__panel${E?" lb-rank__panel--open":""}" data-panel-key="${L(q)}">
  <td class="lb-rank__panelcell" colspan="${l}"><div class="lb-rank__panelwrap" id="${L(K)}"><div class="lb-rank__panelbox">${ae}</div></div></td>
</tr>`}).join(""),u=r?`
...
</div>`}function ru(s,e){const t=qc(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",d=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const ou={ranked:iu,match_summary:(s,e)=>ru(s,e)},au={"default-score-grid":Zc,"compact-match-grid":eu,"category-matrix-grid":tu};function lu(s){return`<div class="lb-diag">Unrenderable result section <code>${L(s)}</code> — no generic view yet. Results are not hidden.</div>`}function du(s){return`<div class="lb-diag">Unsupported score-grid component <code>${L(s)}</code> — no generic view yet. Results are not hidden.</div>`}function cu(s,e,t,n=null){const i=ou[s.kind];return i?i(s,e,t,n):lu(s.kind)}function nr(s,e,t,n){const i=er(s),r=au[i];return r?r(s,e,t,n):du(i)}function ir(s,e,t=sr,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${L(s.formatLabel)}.</div>`:s.leaderboard.map(r=>cu(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${L(s.formatLabel)}.</div>`}function rr(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>nr(r,e,t,{mode:i})).join(`
`)}const uu=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class qs extends O{static styles=`
        .lb {
    ...
    `;svc=this.inject(he);expansion=new Kc;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(uu,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=Uc(t);this.expansion.retain(r.attached.keys());const d=ir(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),l=rr(r.standalone,e.routeSections,n),c=l?`<h3 class="lb-cards__head">Scorecard</h3>${l}`:"";return d+c}}function hu(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const pu=b(`
...
`);class mu extends O{static styles=`
        .claim-card {
            margin-top: ${o("lg")};
            padding: ${o("lg")};
            ${C()}
    ...
    `;svc=this.inject(he);auth=this.inject(D);router=this.inject(B);tokenQ=this.router.query("token");claiming=new p(!1);error=new p("");claimable(){return hu(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async claim(e){const t=this.tokenQ.get();if(!(!t||this.claiming.get())){this.error.set(""),this.claiming.set(!0);try{await v.friendlyRounds.claimGuest({token:t,guestPlayerId:e}),await this.svc.loadByToken(t)}catch(n){this.error.set(n instanceof U&&n.status===409?"Already claimed — or you already play in this round under your account.":n instanceof U&&n.status===404?"That guest is no longer claimable on this round.":"Could not claim right now. Try again.")}finally{this.claiming.set(!1)}}}render(){const e=this.wire(pu,{root:{className:()=>this.claimable().length>0?"claim-card":"claim-card hidden"},err:{textContent:()=>this.error.get()}});return this.$each(this.ref(e,"rows"),()=>this.claimable(),(t,n,i)=>this.wireEl(fu,{name:()=>t.displayName,claim:{disabled:()=>this.claiming.get(),onclick:()=>{this.claim(t.guestPlayerId)}}},i),t=>t.guestPlayerId),e}}function as(s){return typeof s=="object"&&s!==null&&typeof s.get=="function"}const S=s=>`var(--${s})`,kn="http://www.w3.org/2000/svg";function gu(){const s=document.createElementNS(kn,"svg");s.setAttribute("width","12"),s.setAttribute("height","8"),s.setAttribute("viewBox","0 0 12 8"),s.setAttribute("fill","none"),s.setAttribute("aria-hidden","true"),s.setAttribute("focusable","false");const e=document.createElementNS(kn,"path");return e.setAttribute("d","M1 1.5 6 6.5 11 1.5"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.5"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.setAttribute("fill","none"),s.appendChild(e),s}const et=class et extends O{constructor(){super(...arguments),this.uid=`ui-select-${et.seq++}`,this.open=new p(!1),this.highlightIndex=new p(-1),this.optionEls=[],this.onOutsidePointer=e=>{this.wrapperEl.contains(e.target)||this.open.set(!1)}}get isMulti(){return this.props.multiple===!0}get multi(){return this.props}get single(){return this.props}currentOptions(){return as(this.props.options)?this.props.options.get():this.props.options}selectedValues(){if(this.isMulti)return this.multi.values.get();const e=this.single.value.get();return e?[e]:[]}placeholderText(){const e=this.props.placeholder;return(typeof e=="function"?e():e)??""}formatCount(e){return this.multi.countLabel?this.multi.countLabel(e):String(e)}render(){const e=document.createElement("div");e.className="ui-select",this.wrapperEl=e;const t=this.props.zIndex??50,n=this.isMulti;this.triggerEl=document.createElement("button"),this.triggerEl.className="ui-select__trigger",this.triggerEl.setAttribute("type","button"),this.triggerEl.setAttribute("role","combobox"),this.triggerEl.setAttribute("aria-haspopup","listbox");const i=document.createElement("span");i.className="ui-select__trigger-label",this.triggerEl.appendChild(i);const r=document.createElement("span");r.className="ui-select__chevron",r.appendChild(gu()),r.setAttribute("aria-hidden","true"),this.triggerEl.appendChild(r),this.triggerEl.addEventListener("click",l=>{l.stopPropagation(),this.toggle()}),this.triggerEl.addEventListener("keydown",l=>{this.handleTriggerKeydown(l)}),e.appendChild(this.triggerEl),this.dropdownEl=document.createElement("div"),this.dropdownEl.className="ui-select__dropdown",this.dropdownEl.style.zIndex=String(t),this.dropdownEl.addEventListener("keydown",l=>{this.handleDropdownKeydown(l)}),this.listEl=document.createElement("div"),this.listEl.className="ui-select__list",this.listEl.setAttribute("role","listbox"),n&&this.listEl.setAttribute("aria-multiselectable","true"),this.dropdownEl.appendChild(this.listEl),n&&(this.countEl=document.createElement("div"),this.countEl.className="ui-select__count",this.countEl.setAttribute("role","status"),this.countEl.setAttribute("aria-live","polite"),this.dropdownEl.appendChild(this.countEl)),e.appendChild(this.dropdownEl);const d=l=>{this.optionEls=[],this.listEl.textContent="";for(let c=0;c<l.length;c++){const u=l[c],f=document.createElement("button");if(f.className=n?"ui-select__option ui-select__option--multi":"ui-select__option",f.setAttribute("type","button"),f.id=`${this.uid}-opt-${c}`,u.disabled){f.classList.add("ui-select__option--header"),f.disabled=!0,f.setAttribute("role","presentation"),f.setAttribute("aria-disabled","true");const h=document.createElement("span");h.className="ui-select__option-label",h.textContent=u.label,f.appendChild(h),this.listEl.appendChild(f),this.optionEls.push(f);continue}if(f.setAttribute("role","option"),n){const h=document.createElement("span");h.className="ui-select__checkbox",h.setAttribute("aria-hidden","true"),f.appendChild(h)}if(u.icon){const h=document.createElement("span");h.className="ui-select__option-icon",h.textContent=u.icon,f.appendChild(h)}const m=document.createElement("span");if(m.className="ui-select__option-label",m.textContent=u.label,f.appendChild(m),!n){const h=document.createElement("span");h.className="ui-select__check",h.setAttribute("aria-hidden","true"),f.appendChild(h)}f.addEventListener("click",h=>{h.stopPropagation(),this.chooseOption(u.value)}),f.addEventListener("mouseenter",()=>{this.highlightIndex.set(c)}),this.listEl.appendChild(f),this.optionEls.push(f)}};return as(this.props.options)?this.track(I(()=>{d(this.currentOptions())})):d(this.props.options),this.track(I(()=>{const l=this.currentOptions(),c=this.selectedValues();if(n){const u=c.length;if(u>0)i.textContent=this.formatCount(u),this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const f=this.placeholderText();i.textContent=f,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!f)}this.countEl&&(this.countEl.textContent=this.formatCount(u))}else{const u=this.single.value.get(),f=l.find(m=>m.value===u);if(f)i.textContent=f.icon?`${f.icon} ${f.label}`:f.label,this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const m=this.placeholderText();i.textContent=m,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!m)}}for(let u=0;u<l.length;u++){const f=this.optionEls[u];if(!f||l[u].disabled)continue;const m=c.includes(l[u].value);f.setAttribute("aria-selected",String(m)),f.classList.toggle("ui-select__option--selected",m);const h=f.querySelector(".ui-select__check");h&&(h.textContent=m?"✓":"");const g=f.querySelector(".ui-select__checkbox");g&&(g.textContent=m?"✓":"")}})),this.track(I(()=>{const l=this.open.get();this.dropdownEl.classList.toggle("open",l),r.classList.toggle("ui-select__chevron--open",l),this.triggerEl.setAttribute("aria-expanded",String(l)),l?document.addEventListener("pointerdown",this.onOutsidePointer,!0):document.removeEventListener("pointerdown",this.onOutsidePointer,!0),l&&Y(()=>{const c=this.currentOptions(),u=this.selectedValues(),f=c.findIndex(h=>!h.disabled&&u.includes(h.value)),m=c.findIndex(h=>!h.disabled);this.highlightIndex.set(f>=0?f:m)})})),this.track(I(()=>{const l=this.highlightIndex.get();for(let c=0;c<this.optionEls.length;c++)this.optionEls[c].classList.toggle("ui-select__option--highlighted",c===l);l>=0&&this.optionEls[l]&&(this.triggerEl.setAttribute("aria-activedescendant",`${this.uid}-opt-${l}`),this.optionEls[l].scrollIntoView({block:"nearest"}))})),this.props.disabled!=null&&(as(this.props.disabled)?this.track(I(()=>{const l=this.props.disabled.get();this.triggerEl.classList.toggle("ui-select__trigger--disabled",l),this.triggerEl.disabled=l})):this.props.disabled&&(this.triggerEl.classList.add("ui-select__trigger--disabled"),this.triggerEl.disabled=!0)),e}toggle(){this.open.update(e=>!e)}chooseOption(e){if(this.isMulti){const t=this.multi.values.get();this.multi.values.set(t.includes(e)?t.filter(n=>n!==e):[...t,e]);return}tt(()=>{this.single.value.set(e),this.open.set(!1)}),this.triggerEl.focus()}commitHighlighted(){const e=this.highlightIndex.get(),t=this.currentOptions();e>=0&&e<t.length&&!t[e].disabled&&this.chooseOption(t[e].value)}handleTriggerKeydown(e){switch(e.key){case"Enter":case" ":e.preventDefault(),this.open.get()?this.commitHighlighted():this.open.set(!0);break;case"ArrowDown":e.preventDefault(),this.open.get()?this.moveHighlight(1):this.open.set(!0);break;case"ArrowUp":e.preventDefault(),this.open.get()?this.moveHighlight(-1):this.open.set(!0);break;case"Escape":this.open.get()&&(e.preventDefault(),this.open.set(!1));break}}handleDropdownKeydown(e){switch(e.key){case"ArrowDown":e.preventDefault(),this.moveHighlight(1);break;case"ArrowUp":e.preventDefault(),this.moveHighlight(-1);break;case"Enter":case" ":e.preventDefault(),this.commitHighlighted();break;case"Escape":e.preventDefault(),this.open.set(!1),this.triggerEl.focus();break;case"Tab":this.open.set(!1);break}}moveHighlight(e){const t=this.currentOptions();if(t.length===0||!t.some(i=>!i.disabled))return;let n=this.highlightIndex.get();do n+=e,n<0&&(n=t.length-1),n>=t.length&&(n=0);while(t[n].disabled);this.highlightIndex.set(n)}onDestroy(){document.removeEventListener("pointerdown",this.onOutsidePointer,!0)}};et.styles=`
        ...
        .ui-select__trigger {
            ...
            border-bottom: 2px solid ${S("border-strong")};
            border-radius: ${S("radius-sm")};
            background: ${S("bg")};
            color: ${S("text")};
            font-family: ${S("font-ui")};
            font-size: inherit;
            cursor: pointer;
            text-align: left;
            line-height: 1.5;
            transition:
                border-color ${S("dur-fast")} ${S("ease-standard")},
                box-shadow ${S("dur-fast")} ${S("ease-standard")},
                background ${S("dur-fast")} ${S("ease-standard")};
        }
        .ui-select__trigger:focus-visible {
            outline: none;
            border-color: ${S("accent")};
            background: ${S("surface")};
            box-shadow: 0 0 0 3px ${S("accent-soft")};
        }
        .ui-select__trigger--placeholder {
            color: ${S("text-muted")};
        }
        ...
        .ui-select__chevron {
            ...
            pointer-events: none;
            color: ${S("text-muted")};
            transition: transform ${S("dur-fast")} ${S("ease-standard")};
        }
        ...
        .ui-select__dropdown {
            ...
            transition: opacity ${S("dur-base")} ${S("ease-standard")},
                        transform ${S("dur-base")} ${S("ease-standard")};
        }
        ...
        .ui-select__option--highlighted {
            background: ${S("surface-2")};
        }
        .ui-select__option--selected {
            color: ${S("accent-strong")};
            font-weight: 600;
        }
    ...
    `,et.seq=0;let ue=et;function bu(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function _u(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function yu(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const vu=b(`
...
`);class $u extends O{static styles=`
        .seat-card {
            margin-top: ${o("lg")};
            padding: ${o("lg")};
            ${C()}
...
`);class Iu extends O{static styles=`
        .join-card {
            margin-top: ${o("lg")};
            padding: ${o("lg")};
            ${C()}
    ...
    `;svc=this.inject(he);auth=this.inject(D);router=this.inject(B);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Su(this.svc.startList.get())}eligible(){return this.policyState().visible&&ku(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await v.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof U&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(I(()=>this.ensureTeesLoaded()));const e=new $(()=>Tu(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(I(()=>{const r=e.get(),d=this.groupChoice.get();(!d||!r.options.some(l=>l.value===d&&!l.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Pu,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new ue({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new ue({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const Tn=1440*60*1e3;function Cu(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>Tn?!0:e-t>=Tn}function Eu(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function Nu(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!Eu(s.balls,s.playerId)||!Cu(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ge(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Ot(s){return s<0?`+${String(-s)}`:String(s)}const Ru=b(`
...
`);class Ou extends O{static styles=`
        .hcp-checkin {
            margin-bottom: ${o("lg")};
            padding: ${o("md")} ${o("lg")};
            ${C()}
    ...
    `;svc=this.inject(he);auth=this.inject(D);profile=this.inject(De);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return Nu({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Ot(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ge(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(I(()=>this.ensureProfileLoaded())),this.wire(Ru,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Ot(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function Hu(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const Mu=b(`
...
`);class zu extends O{static styles=`
    ...
    `;svc=this.inject(he);auth=this.inject(D);router=this.inject(B);tokenQ=this.router.query("token");editable=new p(!1);deleteOpen=new p(!1);finishOpen=new p(!1);finishAsReopen=new p(!1);leaveOpen=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);isComplete(){return this.svc.round.get()?.status==="complete"}canLeave(){return Hu(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}canDelete(){const e=this.auth.currentUser.get()?.id??null;return e!==null&&this.svc.friendlyRound.get()?.creatorPlayerId===e}clear(){this.error.set(""),this.diagnostics.set([])}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.clear(),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){this.track(I(()=>{const r=this.tokenQ.get();this.editable.set(!1),r&&v.friendlyRounds.setup({token:r}).then(d=>{this.tokenQ.get()===r&&this.editable.set(d.editable===!0)}).catch(()=>{})})),this.track(I(()=>{this.props.open.get()&&this.clear()}));const e=this.wire(Mu,{root:{className:()=>this.props.open.get()?"rmanage":"rmanage hidden"},backdrop:{onclick:()=>this.props.open.set(!1)},close:{onclick:()=>this.props.open.set(!1)},editRow:{className:()=>this.editable.get()?"rmanage__row":"rmanage__row hidden",onclick:()=>{const r=this.tokenQ.get();r&&(this.props.open.set(!1),this.router.navigate("/create",{query:{token:r}}))}},leaveRow:{className:()=>this.canLeave()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.leaveOpen.set(!0),disabled:()=>this.leaving.get()},finishRow:{onclick:()=>{this.finishAsReopen.set(this.isComplete()),this.finishOpen.set(!0)},disabled:()=>this.svc.finishing.get()},finishTitle:()=>this.isComplete()?"Reopen round":"Finish round",finishSub:()=>this.isComplete()?"Move it back to your ongoing rounds.":"Move it to your finished rounds. Nothing is locked.",deleteRow:{className:()=>this.canDelete()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.deleteOpen.set(!0),disabled:()=>this.svc.deleting.get()},diag:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},err:{textContent:()=>this.error.get()}});this.spawn(te,this.ref(e,"deleteConfirmHost"),{open:this.deleteOpen,title:"Delete round?",message:"This permanently removes the round and all its scores for everyone. This can't be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.clear(),this.svc.deleteRound().then(r=>{r?this.router.navigate("/"):this.error.set("Could not delete the round. Try again.")})}}),this.spawn(te,this.ref(e,"finishConfirmHost"),{open:this.finishOpen,title:()=>this.finishAsReopen.get()?"Reopen this round?":"Finish this round?",message:()=>this.finishAsReopen.get()?"It'll move back to your ongoing rounds.":"It'll move to your finished rounds. You can still edit or reopen it any time.",confirmLabel:()=>this.finishAsReopen.get()?"Reopen round":"Finish round",cancelLabel:"Cancel",onconfirm:()=>{this.clear(),(this.finishAsReopen.get()?this.svc.reopenRound():this.svc.finishRound()).then(d=>{d||this.error.set("Could not update the round. Try again.")})}}),this.spawn(te,this.ref(e,"leaveConfirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}});let t=null;const n=this.ref(e,"close");this.track(I(()=>{this.props.open.get()?(t=document.activeElement instanceof HTMLElement?document.activeElement:null,queueMicrotask(()=>n.focus())):t&&(t.focus(),t=null)}));const i=r=>{if(r.key==="Escape"){if(this.deleteOpen.get())return void this.deleteOpen.set(!1);if(this.finishOpen.get())return void this.finishOpen.set(!1);if(this.leaveOpen.get())return void this.leaveOpen.set(!1);this.props.open.get()&&this.props.open.set(!1)}};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),e}}function Lu(s){const{balls:e,groups:t,strokesFor:n}=s,i=new Set(e.filter(d=>!d.pending).map(d=>d.id));let r=0;for(const d of t)for(const l of d.ballIds)if(i.has(l))for(const c of d.playedOrder)n(l,c.playHoleId)===null&&r++;return r}function Au(s){return s<=0?null:s===1?"1 score is still missing.":`${s} scores are still missing.`}function Fu(s,e,t=!0){if(s===null||e===null||s<=0)return null;const n=s-e;return n===0?null:s===1&&t||n<=-3?"diamond":n===-2?"double_ring":n===-1?"ring":n===1?"square":n===2?"double_square":"box_badge"}function Bu(s){const e=s.par,t=s.score,n=t===0,i=n?null:t,r=s.stats;return{id:s.playHoleId,ordinal:s.ordinal,holeNumber:s.courseHoleNumber,par:e,lengthM:s.lengthM,strokes:i,isPickedUp:n,vsPar:i===null?null:i-e,marker:Fu(i,e),tee:r.teeResult,gir:r.gir,putts:r.putts,firstPutt:r.firstPutt,shortGame:r.shortGameDifficulty,penalties:r.penalties,recoveryOk:r.recoveryOk}}function ju(s){return(s.penalties??0)>0}const $s=10,Du=3;function Gu(s){const{round:e,holes:t,history:n,windowSize:i=$s,insightLimit:r=Du}=s,d=zs([e]),l=d.waterfall,u=qu(e,n,i).map(m=>nt(m.measures)),f=d.rounds[0];return{roundId:e.roundId,date:e.date,courseName:e.courseName,name:e.name,holeCount:e.holeCount,strokes:f?.strokes??null,vsPar:f?.vsPar??null,cells:[...t].sort((m,h)=>m.ordinal-h.ordinal).map(Bu),panels:d,waterfall:l,deltas:u.length===0?null:ji(l,u),windowCount:u.length,insights:pd(e.measures,l,u,r)}}function qu(s,e,t){const n=e.filter(d=>d.roundId!==s.roundId);n.push(s);const i=Bt(n),r=i.findIndex(d=>d.roundId===s.roundId);return r===-1?[]:i.slice(r+1,r+1+Math.max(0,t))}function Pn(s,e,t){const n=Bt(s),i=n.findIndex(r=>r.roundId===e);return i===-1?!1:n.length-(i+1)>=t}function In(s){const e=(s.name??"").trim();if(e!=="")return e;const t=(s.courseName??"").trim();return t===""?"Round":t}function or(s){const{signedInPlayerId:e,statConfigPlayerIds:t,statRows:n,holesUnscored:i}=s;return e===null||e===""?{reason:"notSignedIn",playerId:null}:t.has(e)?n.some(d=>d.playerId===e&&Vu(d))?i!==0?{reason:"roundUnfinished",playerId:null}:{reason:"eligible",playerId:e}:{reason:"noStatsRecorded",playerId:null}:{reason:"noStatsConfigured",playerId:null}}function Vu(s){return s.teeResult!==null||s.gir!==null||s.firstPutt!==null||s.putts!==null||s.shortGameDifficulty!==null||s.penalties!==null||s.recoveryOk!==null}function ar(s){const{playerId:e,balls:t,groups:n,strokesFor:i}=s,r=t.find(l=>l.players.some(c=>c.playerId===e));if(!r)return null;const d=n.find(l=>l.ballIds.includes(r.id));return d?d.playedOrder.filter(l=>i(r.id,l.playHoleId)===null).length:null}function lr(s,e=typeof navigator>"u"?"en":navigator.language){const t=(s?.name??"").trim();if(t)return t;const n=s?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n||"Round"}const Uu=b(`
...
`);class Ku extends O{static styles=`
        ...
        .ffl {
            ...
            & .ffl__round {
                margin: ${o("sm")} 0 0;
                color: ${a("text-muted")}; font-size: 0.95rem;
                &:empty { display: none; }
            }
            & .ffl__missing {
                margin: ${o("lg")} 0 0;
                color: ${a("danger")}; font-size: 0.9rem; font-weight: 600;
                &:empty { display: none; }
            }
            & .ffl__err {
                margin: ${o("md")} 0 0;
                color: ${a("danger")}; font-size: 0.85rem;
                &:empty { display: none; }
            }
            ...
            & .ffl__prompt {
                ...
                &.hidden { display: none; }
                justify-content: center;
                padding: ${o("2xl")} ${o("xl")} calc(${o("xl")} + env(safe-area-inset-bottom));
                text-align: center;
            ...
            & .ffl__board {
                ...
                & .ffl__board-scroll {
                    flex: 1; overflow-y: auto;
                    -webkit-overflow-scrolling: touch;
                    padding: ${o("xl")} ${o("lg")} ${o("lg")};
                }
                & .ffl__board-head { margin-bottom: ${o("sm")}; }
                & .ffl__bottom {
                    flex: 0 0 auto;
                    padding: ${o("md")} ${o("lg")} calc(${o("md")} + env(safe-area-inset-bottom));
                    background: ${a("surface")};
                    box-shadow: ${a("shadow-elevated")};
                }
            }
        }
    `;svc=this.inject(he);auth=this.inject(D);router=this.inject(B);stage=new p("prompt");error=new p("");render(){this.track(I(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(Uu,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>Au(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(qs,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=lr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return Lu({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return or({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:ar({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Ce{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(bs());filter=new p(Je);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new $(()=>Hi(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new $(()=>zs(this.windowRounds.get()));courses=new $(()=>bl(this.loadedRounds.get()));overFiltered=new $(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await F(this.loading,this.error,()=>v.playerStats.myStats({limit:Ce.PAGE_SIZE}));t&&(this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded())}select(e){this.preset.set(e),mn(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),mn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(Je),this.select(Et)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Ce.MAX_PAGES&&Mi({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await v.playerStats.myStats({limit:Ce.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Ce.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(Je),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class at{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=V.get(Ce);inFlight=null;model=new $(()=>{const e=this.round.get();return e===null?null:Gu({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await v.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Cn(d)),this.failure.set(En(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Cn(d)),this.failure.set(En(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const l of d)n.has(l.roundId)||(n.add(l.roundId),t.push(l))};if(i(this.dashboard.loadedRounds.get()),Pn(t,e,$s))return t;let r=null;for(let d=0;d<at.MAX_PAGES;d++){const l=await v.playerStats.myStats({limit:at.PAGE_SIZE,cursor:r??void 0});if(i(l.rounds),Pn(t,e,$s)||l.nextCursor===null)return t;r=l.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function Cn(s){if(s instanceof U){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function En(s){return s instanceof U&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const se=100;function Vt(s){return s>0?"loss":s<0?"gain":"zero"}function Ge(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function Z(s){return String(Math.round(s*1e3)/1e3)}function Vs(s){return s<0?0:s>1?1:s}function Re(s,e){return`<svg class="chart" viewBox="0 0 ${se} ${Z(s)}" preserveAspectRatio="none" style="height:${Z(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function Us(s,e,t,n=1){return`<path d="M${Z(s)} 0 L${Z(s)} ${Z(e)}" stroke="${t}" stroke-width="${Z(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function be(s,e,t,n,i){return`<rect x="${Z(s)}" y="${Z(e)}" width="${Z(t)}" height="${Z(n)}" fill="${i}"/>`}const Wu=1;function Yu(s,e){const t=se/2,n=Vt(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:Wu,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function dr(s,e,t,n=10){const i=Yu(s,e),r=i.bar&&i.bar.width>0?be(i.bar.x,0,i.bar.width,n,Ge(i.tone,t)):"";return Re(n,[be(0,0,se,n,t.track),r,Us(i.zeroX,n,t.rule)].join(""))}function Qu(s){const e=[];let t=0;for(const n of s){const i=se*Vs(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function Xu(s,e,t=12){const n=Qu(s).filter(i=>i.width>0).map(i=>be(i.x,0,i.width,t,i.color)).join("");return Re(t,be(0,0,se,t,e.track)+n)}const Nn=2,Ju=1e-4;function Zu(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=Nn,d=Math.max(0,e-Nn*2);return s.map((l,c)=>({x:s.length===1?se/2:c/(s.length-1)*se,y:i===0?e/2:r+d-(l-t)/i*d}))}function eh(s){return s.map((e,t)=>`${t===0?"M":"L"}${Z(e.x)} ${Z(e.y)}`).join(" ")}function th(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Ju?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function sh(s,e,t,n=34){const i=Zu(s,n);if(i.length===0)return Re(n,"");const r=Ge(th(s,e),t),d=`<path d="${eh(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,l=i[i.length-1],c=`<path d="M${Z(l.x)} ${Z(l.y)} L${Z(l.x)} ${Z(l.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Re(n,d+c)}const nh=.5;function ih(s,e,t=8){const n=se/2,i=ce.length-1,r=Math.max(1,(t-i)/ce.length),d=[];return ce.forEach((l,c)=>{const u=je(s,l);if(u===null||!(e>0))return;const f=Math.max(u===0?0:nh,n*Math.min(1,Math.abs(u)/e));d.push({component:l,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:Vt(u)})}),d}function rh(s,e,t,n=8){const i=ih(s,e,n).filter(r=>r.width>0).map(r=>be(r.x,r.y,r.width,r.height,Ge(r.tone,t))).join("");return Re(n,Us(se/2,n,t.rule)+i)}const cr=1,Rn=.02;function oh(s,e){const t=e>0?se*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=Vs(s),i=e<=0?"neutral":s>e+Rn?"gain":s<e-Rn?"loss":"neutral";return{bar:{width:Math.max(cr,se*n),tone:i},tickX:t}}function ah(s,e,t,n=10){const i=oh(s,e),r=i.bar?be(0,0,i.bar.width,n,Ge(i.bar.tone,t)):"",d=i.tickX===null?"":Us(i.tickX,n,t.rule,2);return Re(n,be(0,0,se,n,t.track)+r+d)}function lh(s){return s===null?null:Math.max(cr,se*Vs(s))}function ur(s,e,t=e.neutral,n=8){const i=lh(s),r=i===null?"":be(0,0,i,n,t);return Re(n,be(0,0,se,n,e.track)+r)}const Ut={gain:a("accent-strong"),loss:a("danger"),zero:a("border-strong"),neutral:a("accent"),track:a("surface-sunken"),rule:a("border")},N={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Strokes lost per round against a fixed baseline, worst first. Positive costs you shots.",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s four waterfall terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",resultsHeading:"Results",scoreTypesHead:"Holes by score",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function ze(s){return Ad(s)?null:s.value}function X(s,e,t){return{kind:"bar",id:s,title:e,share:ze(t),value:me(t)}}function j(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function dh(s,e){switch(s){case"tee":{const t=e.tee&&re(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&re(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?ne(e.putting.puttsPerGirHole,{unit:ys,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&re(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?ne(e.scoring.doubleBogeyPlusPerRound,{unit:fe,label:"doubles or worse per round"}):null}}function ch(s){const e=Nd(s.vsParByTee),t=e?`${N.troubleTax} Measured ${e}.`:N.troubleTax;return j("troubleTax","Trouble tax",rt(s.troubleTax,2,!0),t)}function On(s){return s===null?null:`Measured ${s}.`}function ls(s){return ne(s,{unit:ie,signed:!0})}function uh(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function Hn(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:ze(t.fairway),value:me(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:ze(t.inPlayOnly),value:me(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:ze(t.trouble),value:me(t.trouble)}]},...uh(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},{kind:"note",id:"vsParByTeeNote",text:N.vsParByTee},j("vsParFairway","From the fairway",ls(t.vsParByTee.fairway)),j("vsParInPlay","From in play",ls(t.vsParByTee.inPlay)),j("vsParTrouble","From trouble",ls(t.vsParByTee.trouble))]:[],ch(t),j("recovery","Recovery",re(t.recovery),N.recovery),...t.penaltiesRecordedHoles>0?[j("penalties","Penalties",ne(t.penaltiesPerRound,{unit:fe}),`${N.penalties} Recorded on ${J(t.penaltiesRecordedHoles,ie)}.`),j("penaltyHoleShare","Holes with a penalty",re(t.penaltyHoleShare)),j("penaltyTax","Penalty tax",rt(t.penaltyTax,2,!0),On(Ld(t.vsParByPenalty)))]:[]]:[]}case"approach":{const t=e.approach;return t?[{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},X("girFairway","From the fairway",t.girByTee.fairway),X("girInPlay","From in play",t.girByTee.inPlay),X("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},X("girPar3","Par 3",t.girByPar.par3),X("girPar4","Par 4",t.girByPar.par4),X("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:N.proximityProxy},...ve.map(n=>X(`mix-${n}`,ss(n),t.girFirstPuttMix[n])),j("birdieConversion","Birdie conversion",re(t.birdieConversion),N.birdieConversion),...t.hardChipShare.d>0?[j("hardChipShare","Hard misses",re(t.hardChipShare),N.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},j("vsParGreenHit","Green hit",ne(t.costOfMissedGreen.hit,{unit:ys,signed:!0})),j("vsParGreenMissed","Green missed",ne(t.costOfMissedGreen.miss,{unit:ie,signed:!0})),j("missedGreenTax","Missed-green tax",rt(t.costOfMissedGreen.delta,2,!0),On(zd(t.costOfMissedGreen)))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[ve[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},{kind:"note",id:"firstPuttNote",text:N.firstPuttSpread},...ve.map(n=>X(`spread-${n}`,ss(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:N.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:ss(n.bucket),made:ze(n.made),baseline:n.baseline,value:me(n.made)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},X("putts-zero","No putts",t.puttDistribution.zero),X("putts-one","One putt",t.puttDistribution.one),X("putts-two","Two putts",t.puttDistribution.two),X("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],j("threePutt","Three-putts",re(t.threePutt),N.threePutt),j("longThreePutt","Three-putts from over 8 m",re(t.threePuttsFromOver8m),N.longThreePutt),j("puttsPerGir","Putts per green hit",ne(t.puttsPerGirHole,{unit:ys}),N.puttsPerGir),...t.puttsAfterMissedGreen.d>0?[j("puttsAfterMissedGreen","Putts after a missed green",ne(t.puttsAfterMissedGreen,{unit:ie}),N.puttsAfterMissedGreen)]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},j("puttsPar3","Par 3",ne(t.puttsPerHoleByPar.par3,{unit:ie})),j("puttsPar4","Par 4",ne(t.puttsPerHoleByPar.par4,{unit:ie})),j("puttsPar5","Par 5",ne(t.puttsPerHoleByPar.par5,{unit:ie}))]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},X("scrambleStandard","Standard",t.scramble.standard),X("scrambleHard","Hard",t.scramble.hard),{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},X("chipStandard","Standard",t.chipInside2m.standard),X("chipHard","Hard",t.chipInside2m.hard),j("conversionInside2m","Holed from inside 2 m",re(t.conversionInside2m),N.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},{kind:"note",id:"chipInsNote",text:N.chipIns},j("chipInsStandard","Standard",oe(t.chipIns.standard)),j("chipInsHard","Hard",oe(t.chipIns.hard))]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>ne(i,{unit:ie,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},j("par3","Par 3",n(t.avgVsParByParGroup.par3)),j("par4","Par 4",n(t.avgVsParByParGroup.par4)),j("par5","Par 5",n(t.avgVsParByParGroup.par5)),j("doubles","Doubles or worse",ne(t.doubleBogeyPlusPerRound,{unit:fe}),N.doubleBogeyPlus),j("bounceBack","Bounce-back",re(t.bounceBack),N.bounceBack)]}}}function hh(s){if(!s||s.rounds===0)return"";const e=J(s.rounds,fe),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${J(t.holeCount,ie)}`;const n=s.lengths.map(i=>`${oe(i.rounds)} × ${J(i.holeCount,ie)}`).join(", ");return`${e} — ${n}`}function ph(s){return s===18?"Best 18":s===9?"Best 9":`Best ${oe(s)} holes`}const fh=18;function mh(s){const e=s.lengths.some(i=>i.holeCount!==fh),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${J(s.holesScored,ie)}`;return e?`${n}, scaled to 18`:n}function ds(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:He(s.avgVsParPer18.value,1),qualifier:mh(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:ph(t.holeCount),value:Dt(n.vsPar),qualifier:`${oe(n.strokes)} strokes`,hero:!1})}return e}function gh(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function _t(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return Xl.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:gh(t),share:ze(k(n,e)),value:me(k(n,e))??oe(n)}})}function bh(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function Mn(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const W={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},zn={title:"Your round",seeWholeRound:"See the whole round"};function _h(s){const e=[Wi(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function hr(s,e){return s===null?null:e===null?String(s):`${s} (${Dt(e)})`}function yh(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function vh(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function wh(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Dt(s.vsPar)})`}function xh(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function $h(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function kh(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function Sh(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function Ks(s){const e=[],t=wh(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:xh(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:$h(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:kh(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Th(s){return s===null?[]:Ks(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function Ln(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(Sh(s.marker).toLowerCase())):e.push("no score");for(const t of Ks(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function pr(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=xe(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function An(s){switch(s){case"putting":return"Putting";case"shortGame":return"Your short game";case"penalties":return"Penalties";case"longGame":return"Tee to green"}}function cs(s,e=1){return typeof s=="number"?xe(Math.abs(s),e):""}function yt(s){return typeof s=="number"?String(Math.round(s)):""}function Fn(s){return typeof s=="string"?s:"longGame"}function Ph(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${An(Fn(e.component))} was ${cs(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${An(Fn(e.component))} cost you ${cs(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${cs(e.baseline)} in a normal round.`}case"scramble_streak":return`You saved par ${yt(e.successes)} of the ${yt(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${yt(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${yt(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Ih=b(`
...
`);class Nh extends O{static styles=`
    ...
    `;round=this.inject(he);stats=this.inject(at);auth=this.inject(D);router=this.inject(B);colors=Ut;render(){this.track(I(()=>{const i=this.eligibleRoundId();Y(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Ih,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>zn.title,score:()=>{const i=e();return i===null?"":hr(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),open:{textContent:()=>zn.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:je(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...ce],(i,r,d)=>this.wireEl(Eh,{label:()=>Gt(i),amount:{textContent:()=>{const l=n(i);return l===null?N.notRecorded:He(l)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const l=n(i);return l===null?"":`color:${Ge(Vt(l),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl(Ch,{text:()=>Ph(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:or({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ar({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return W.waterfallHint;let t=null;for(const n of ce){const i=Hs(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?W.waterfallHint:pr(t,e.windowCount)}}function Bn(s){return!(!s.pageVisible||s.status==="complete")}function Rh(s,e){return e&&!s}const Oh=2,jn=3,Hh=75e3;function Mh(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${G}/friendly-rounds/events?${t.toString()}`}function zh(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Lh(s){const e=s.eventSourceFactory??(R=>new EventSource(R)),t=s.setTimer??((R,q)=>setTimeout(R,q)),n=s.clearTimer??(R=>clearTimeout(R)),i=s.livenessTimeoutMs??Hh,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,l=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(z,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},y=()=>{d=!0,m(),g()},w=()=>{if(g(),++l>=jn){y(),s.onDegrade();return}A()};function z(){if(!d){if(!r()){h();return}w()}}function A(){if(d)return;let R;try{R=e(Mh(s.token,f))}catch{y(),s.onDegrade();return}c=R,R.onopen=()=>{l=0},R.onmessage=q=>{if(d||c!==R)return;h();let E;try{E=JSON.parse(q.data)}catch{return}zh(E)&&(E.latestEventId!==null&&(f=E.latestEventId),s.onEvent({latestEventId:E.latestEventId,status:E.status}))},R.onerror=()=>{d||c!==R||(R.readyState===Oh||++l>=jn)&&(y(),s.onDegrade())},h()}return A(),{stop:()=>{d||y()}}}const Ah=2e4;function Fh(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Bh=b(`
...
`),jh=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Dh=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Gh extends O{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class bp extends O{static styles=`
        .setup {
            padding: ${o("lg")} ${o("lg")} ${o("2xl")};
            ...
            & .player {
                ...
                & .player__name { ${ee()} flex: 1; padding: ${o("md")}; font-size: 1rem; }
                & .player__remove {
                    ${x()}
                ...
                & .player__index { ${ee()} flex: 1; min-width: 0; padding: ${o("md")}; font-size: 1rem; }
            ...
            & .bteams__pitch > h2, & .bteams > h2 { margin: 0 0 ${o("sm")}; }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { ${ee()} width: 56px; padding: ${o("xs")} ${o("sm")}; font-size: 0.95rem; }
                    }
                }
                ...
                & .fslot__seg {
                    ...
                    padding: 3px; border: 1px solid ${a("border")};
                    border-radius: ${a("radius-pill")}; background: ${a("surface-sunken")};
                    & button {
                        appearance: none; border: 1px solid transparent; background: none;
                        padding: ${o("xs")} ${o("md")}; border-radius: ${a("radius-pill")};
                        font-family: inherit; font-weight: 500; font-size: 0.85rem;
                        color: ${a("text-muted")}; cursor: pointer; white-space: nowrap;
                        &:hover { color: ${a("text")}; }
                        &.on {
                            background: ${a("surface")}; border-color: ${a("border")};
                            color: ${a("text")}; font-weight: 700;
                        }
                    }
                }
                ...
                & .fslot__hint {
                    margin: 0; font-size: 0.78rem; line-height: 1.4; color: ${a("text-muted")};
                    &:empty { display: none; }
                }
                & .fslot__err {
                    font-size: 0.82rem; color: ${a("error")};
                ...
                & .grow {
                    ...
                    & .fslot__seg { flex: 0 0 auto; & button { min-width: 40px; padding: ${o("xs")} ${o("sm")}; } }
                }
                & .gaddball {
                    ${x()}
                ...
                & .grp__start {
                    ...
                    & .grp__time { ${ee()} flex: 1; min-width: 0; padding: ${o("sm")} ${o("md")}; font-size: 1rem; font-family: inherit; }
        ...
        .hcp {
            ...
            & .hcp__cancel { ${x()} flex: 1; padding: ${o("md")}; font-family: inherit; font-weight: 700; font-size: 0.95rem; }
            & .hcp__ok {
                ${x()}
...
`);class $p extends O{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${o("xl")} 0;
...
`),Sp='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',Tp=b(`
...
`),Qn=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Sp}</button>
    </div>
`);class Pp extends O{static styles=`
        .friends {
            ...
            & .friend-row {
                ...
                & .friend-row__remove {
                    ...
                    box-shadow: none;
                    color: ${a("text-muted")};
                    transition: background ${a("dur-fast")} ${a("ease-standard")}, color ${a("dur-fast")} ${a("ease-standard")};
    ...
    `;svc=this.inject(At);auth=this.inject(D);router=this.inject(B);removeOpen=new p(!1);removeTarget=new p(null);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(kp,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:r=>this.svc.setQuery(r.target.value)},searchHint:{textContent:()=>{const r=this.svc.query.get().trim();return r.length>0&&!nn(r)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const r=this.svc.query.get().trim();return nn(r)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===r&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&bt(this.svc.friends.get()).mutual.length===0?"friends__empty":"friends__empty hidden"},connectionsSection:{className:()=>bt(this.svc.friends.get()).addedByMe.length>0?"friends__section":"friends__section hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(r,d,l)=>this.wireEl(Tp,{...we(()=>this.svc.results.get().find(c=>c.id===r.id)??r),name:()=>r.displayName,username:()=>r.homeClubName?`@${r.username} · ${r.homeClubName}`:`@${r.username}`,hcp:()=>r.handicapIndex===null?"–":r.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(r.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const c=this.svc.results.get().find(u=>u.id===r.id);c&&!c.isFriend&&this.svc.add(c)}},added:{className:()=>this.isFriendNow(r.id)?"friend-row__added":"friend-row__added hidden"}},l),r=>r.id);const n=new Date().toISOString();this.$each(this.ref(t,"friends"),()=>Pt(bt(this.svc.friends.get()).mutual,this.svc.sortMode.get()),(r,d,l)=>this.wireEl(Qn,this.friendRowBindings(r,n),l),r=>r.id),this.$each(this.ref(t,"connections"),()=>Pt(bt(this.svc.friends.get()).addedByMe,this.svc.sortMode.get()),(r,d,l)=>this.wireEl(Qn,this.friendRowBindings(r,n),l),r=>r.id),this.spawn(te,this.ref(t,"removeConfirmHost"),{open:this.removeOpen,title:()=>{const r=this.removeTarget.get();return r?`Remove ${r.displayName} from friends?`:"Remove friend?"},message:()=>{const r=this.removeTarget.get();return r?`${r.displayName} will disappear from your friends list. You can add them again later.`:"They will disappear from your friends list. You can add them again later."},confirmLabel:"Remove friend",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.removeTarget.get();r&&this.svc.remove(r.id)}});const i=r=>{r.key==="Escape"&&this.removeOpen.get()&&this.removeOpen.set(!1)};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),t}liveFriend(e){return this.svc.friends.get().find(t=>t.id===e.id)??e}askRemove(e){const t=this.liveFriend(e);this.removeTarget.set({id:t.id,displayName:t.displayName}),this.removeOpen.set(!0)}friendRowBindings(e,t){return{...we(()=>this.svc.friends.get().find(n=>n.id===e.id)??e),open:{disabled:()=>!this.liveFriend(e).isMutual,onclick:()=>{const n=this.liveFriend(e);n.isMutual&&this.router.navigate("/friend",{query:{id:e.id,name:n.displayName}})}},name:()=>e.displayName,subtitle:()=>pa(this.liveFriend(e),t),connection:()=>fa(this.liveFriend(e))??"",hcp:()=>e.handicapIndex===null?"–":e.handicapIndex.toFixed(1),remove:{"aria-label":()=>`Remove ${this.liveFriend(e).displayName} from friends`,title:()=>`Remove ${this.liveFriend(e).displayName} from friends`,disabled:()=>this.svc.mutating.get()||this.removeOpen.get(),onclick:()=>this.askRemove(e)}}}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const gr=b(`
...
`);function br(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Pa(s),subtitle:()=>Ia(s,Ne),progress:()=>Ca(s)}}function _r(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${o("md")};
            width: 100%;
            padding: ${o("md")} ${o("lg")};
...
`);class Cp extends O{static styles=`
        .fprofile {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
    ...
    `;svc=this.inject(Ft);activity=this.inject(Cs);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();Y(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new $(()=>{const h=e.get();return h?ka(this.activity.feed.get(),h):null}),l=()=>this.svc.unavailable.get(),c=()=>n()&&l()===null&&i()!==null,u=()=>n()&&l()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(Ip,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&l()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=l();return h?Fe[h].title:""}},refusalMsg:{textContent:()=>{const h=l();return h?Fe[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...we(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?Ea(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?Sa(h):""},onclick:()=>{const h=d.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>Ra(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,y)=>this.wireEl(gr,br(h,f),y),h=>h.roundId),m}}const Ep=b(`
    <div class="frounds">
...
`);class Np extends O{static styles=`
        .frounds {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
    ...
    `;svc=this.inject(Ft);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const f=e.get();Y(()=>{!f||!n()||(this.svc.setPlayer(f),this.svc.loadRounds())})}));const i=()=>this.svc.rounds.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim(),l=f=>this.router.navigate("/spectate",{query:{id:f,name:d()}}),c=()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}}),u=this.wire(Ep,{back:{onclick:c},subtitle:{textContent:()=>{const f=d();return f?`Rounds ${f} has shared with friends.`:"Rounds shared with friends."}},refusal:{className:()=>r()!==null?"frounds__refusal":"frounds__refusal hidden"},refusalTitle:{textContent:()=>{const f=r();return f?Fe[f].title:""}},refusalMsg:{textContent:()=>{const f=r();return f?Fe[f].message:""}},anon:{className:()=>n()?"frounds__anon hidden":"frounds__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-rounds?id=${e.get()??""}&name=${encodeURIComponent(t.get()??"")}`}})},state:{textContent:()=>r()!==null||!n()?"":this.svc.roundsLoading.get()?"Loading…":i().rounds.length===0?this.svc.roundsError.get()??"":""},retry:{className:()=>r()===null&&this.svc.roundsError.get()!==null&&i().rounds.length===0&&!this.svc.roundsLoading.get()?"frounds__retry":"frounds__retry hidden",onclick:()=>{this.svc.loadRounds(!0)}},empty:{className:()=>r()===null&&this.svc.roundsLoaded.get()&&i().rounds.length===0&&this.svc.roundsError.get()===null?"frounds__state":"frounds__state hidden"},listCard:{className:()=>r()===null&&i().rounds.length>0?"frounds__listcard":"frounds__listcard hidden"},more:{className:()=>r()===null&&Ii(i())&&i().rounds.length>0?"frounds__more":"frounds__more hidden",disabled:()=>this.svc.loadingMore.get(),textContent:()=>this.svc.loadingMore.get()?"Loading…":"Show more rounds",onclick:()=>{this.svc.loadMoreRounds()}},moreError:{textContent:()=>i().rounds.length>0?this.svc.roundsError.get()??"":""}});return this.$each(this.ref(u,"list"),()=>r()===null?i().rounds:[],(f,m,h)=>this.wireEl(gr,br(f,l),h),f=>f.roundId),u}}const Rp=b(`
    <div class="fcourses">
...
`);class Hp extends O{static styles=`
        .fcourses {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
    ...
    `;svc=this.inject(Ft);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();Y(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],d=()=>(t.get()??"").trim(),l=this.wire(Rp,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}})},subtitle:{textContent:()=>{const c=d();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Fe[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Fe[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(d())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(l,"list"),r,(c,u,f)=>this.wireEl(Op,{name:()=>c.courseName??"Course",facts:()=>Na(c,Ne)},f),c=>c.courseId),l}}function Mp(s,e,t){const n=lt(e);if(n){const l=Jn(s);return l?`Watching · ${l} ${n}`:`Watching · ${n}`}const i=Jn(s)??"this",r=lt(t),d=r?` at ${r}`:"";return`Watching · ${i} round${d}`}function zp(s,e,t,n){const i=lt(s)===null?null:lt(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Lp="You're watching this round. Only its players can enter scores.",Xn={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Jn(s){const e=lt(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function lt(s){return(s??"").trim()||null}const Ap=b(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${Lp}</p>
        </div>
    </div>
`);class Fp extends O{static styles=`
        .spectate {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
        ...
        ${qs.styles}
    `;svc=this.inject(Ni);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();Y(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim()||null;return this.wire(Ap,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(d()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Xn[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Xn[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Mp(d(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?zp(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Ne(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const d=i.length>1?`<h2 class="spectate__slot-head">${Bp(r.formatLabel)}</h2>`:"",l=ir(r,t,n),c=rr(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return d+l+u}).join("")}}function Bp(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const jp=b(`
    <div class="profile">
...
`);class qp extends O{static styles=`
        .profile {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { ${ee()} width: 90px; padding: ${o("md")}; font-size: 1rem; text-align: center; }
                    & button {
                        ${x()}
...
`),Up=b('<h3 bind="text" class="block__subhead"></h3>'),Kp=b('<p bind="text" class="block__note"></p>'),Wp=b(`
...
`),Jp=b('<div bind="panels" class="statspanels"></div>');class yr extends O{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${o("sm")};
    ...
    `;expanded=new p([]);colors=Ut;render(){const e=this.wire(Jp,{}),t=()=>this.props.model();return this.$each(this.ref(e,"panels"),()=>[...fd],(n,i,r)=>{const d=()=>this.expanded.get().includes(n),l=this.wireEl(Vp,{panel:{className:()=>t()[n]?"panel":"panel hidden"},head:{"aria-expanded":()=>String(d()),onclick:()=>this.togglePanel(n)},title:()=>md(n),headline:()=>dh(n,t())??"",body:{className:()=>d()?"panel__body":"panel__body hidden"}},r);return this.$each(this.ref(l,"body"),()=>Hn(n,t()),(c,u,f)=>this.renderBlock(n,c,f),c=>c.id),l},n=>n),e}renderBlock(e,t,n){switch(t.kind){case"subhead":return this.wireEl(Up,{text:()=>t.text},n);case"note":return this.wireEl(Kp,{text:()=>t.text},n);case"split":{const i=()=>this.blockNow(e,t.id)??t;return this.wireEl(Wp,{bar:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":Xu(r.segments.map(d=>({id:d.id,share:d.share??0,color:this.segmentColor(d.tone)})),this.colors)}},legend:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":r.segments.map(d=>`<span class="legend__key"><span class="legend__swatch" style="background:${this.segmentColor(d.tone)}"></span><span>${d.title}</span><span class="legend__value">${d.value??N.notRecorded}</span></span>`).join("")}}},n)}case"bar":return this.wireEl(Yp,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="bar"||i.share===null?"":ur(i.share,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value)},n);case"rung":return this.wireEl(Qp,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="rung"?"":ah(i.made,i.baseline,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value)},n);case"figure":return this.wireEl(Xp,{title:()=>t.title,hint:()=>{const i=this.blockNow(e,t.id)??t;return(i.kind==="figure"?i.hint:t.hint)??""},value:this.valueBinding(e,t.id,()=>t.value)},n)}}valueBinding(e,t,n){const i=()=>{const r=this.blockNow(e,t);return r&&"value"in r?r.value:n()};return{textContent:()=>i()??N.notRecorded,className:()=>i()===null?"block__value block__value--absent":"block__value"}}segmentColor(e){switch(e){case"fairway":return this.colors.gain;case"inplay":return this.colors.neutral;case"trouble":return this.colors.loss}}togglePanel(e){const t=this.expanded.get();this.expanded.set(t.includes(e)?t.filter(n=>n!==e):[...t,e])}blockNow(e,t){return Hn(e,this.props.model()).find(n=>n.id===t)}}const Zp=b(`
    <div class="stats">
...
`);class af extends O{static styles=`
        .stats {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
            ...
            & .results__tiles {
                display: grid; grid-template-columns: repeat(2, 1fr); gap: ${o("md")};
            }
            & .rtile {
                ...
                & .rtile__label {
                    font-size: 0.82rem; color: ${a("text-muted")}; white-space: nowrap;
                }
                & .rtile__qualifier {
                    font-size: 0.72rem; color: ${a("text-muted")}; white-space: nowrap;
                    &:empty { display: none; }
                }
            }
            ...
            & .results__hist { display: flex; flex-direction: column; gap: ${o("xs")}; }
            & .stype {
                display: flex; align-items: center; gap: ${o("md")};
    ...
    `;svc=this.inject(Ce);auth=this.inject(D);router=this.inject(B);filterOpen=new p(!1);colors=Ut;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Zp,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>N.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>N.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>hh(t().results),resultsCard:{className:()=>ds(t().results).length===0&&_t(t().results).length===0?"results hidden":"results"},histHead:()=>_t(t().results).length===0?"":N.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>N.prioritiesHint,trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>N.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>N.roundsHint,pickHint:()=>n()?N.filterRoundsHint:""});return this.setHeading(i,"resultsSec",N.resultsHeading),this.setHeading(i,"prioritiesSec",N.priorities),this.setHeading(i,"trendsSec",N.trends),this.setHeading(i,"roundsSec",N.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>ds(t().results),(r,d,l)=>this.wireEl(tf,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},l),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>_t(t().results),(r,d,l)=>this.wireEl(sf,{title:()=>r.title,bar:{innerHTML:()=>ur((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},l),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,l)=>this.wireEl(nf,{title:()=>Gt(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.perRound===null||c===void 0?"":dr(c.perRound,kd(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.perRound!==null?Fd(c.perRound):N.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.perRound===null?bh(c.roundsInWindow):`over ${J(c.roundsCovered,fe)}`:""}}},l),r=>r.component),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,l)=>this.wireEl(rf,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return sh(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return lf(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return J(c.points.length,fe)}}},l),r=>r.id),this.spawn(yr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,l)=>this.wireEl(of,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${Mn(r)} — hole by hole`},label:()=>Mn(r),subtitle:()=>df(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(ml(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return rh(c.waterfall,Vi(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Dt(c.vsPar)}}},l),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(I(()=>t.set(this.svc.preset.get()))),this.track(I(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Ct(r)} — ${hl(r)}`}),i=new ue({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Ct("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(Zn,{chip:{textContent:()=>Bd(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(es(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(Zn,{chip:{textContent:()=>jd(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(es(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(ef,{name:()=>i.name,count:()=>J(i.roundCount,fe),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(es(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return ds(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return _t(this.svc.model.get().results).find(t=>t.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?J(e,fe):`${xe(e,0)} of ${J(t,fe)}`}statusLine(){const e=this.svc.extendError.get();return e?`${N.extendProblemPrefix}${e.message}`:this.svc.extending.get()?N.extending:this.svc.budgetSpent()?N.budgetSpent:this.svc.loading.get()?N.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?N.windowEmpty:this.svc.loadedCount()===0?N.noStats:""}}function lf(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:He(e)}function df(s){const e=[Wi(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${xe(s.holeCount,0)} holes`),e.join(" · ")}const cf=b(`
...
`),ff=b('<li bind="text" class="roundstats__legenditem"></li>');function mf(){const s=[];for(const[e,t]of Object.entries(Ds))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class gf extends O{static styles=`
        .roundstats {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
    ...
    `;svc=this.inject(at);auth=this.inject(D);router=this.inject(B);colors=Ut;openHole=new p(null);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(I(()=>{const l=e.get();Y(()=>{this.openHole.set(null),l&&this.svc.load(l)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",d=this.wire(cf,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":In(t()),subtitle:()=>this.subtitle(),score:()=>{const l=t();return l===null?"":hr(l.strokes,l.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>W.waterfallHeading,wfHint:()=>W.waterfallHint,legendHeading:()=>W.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const l=this.selected();return l===null?"":yh(l)},detailEmpty:()=>{const l=this.selected();return l===null?"":Ks(l).length===0?W.nothingRecordedOnHole:""}});return this.setHeading(d,"stripSec",W.holeStripHeading),this.$each(this.ref(d,"strip"),()=>t()?.cells??[],(l,c,u)=>this.wireEl(uf,{cell:{className:()=>{const f=this.cellNow(l.id)??l;return f.marker===null?"cell":`cell cell--${f.marker}`},"aria-pressed":()=>String(this.openHole.get()===l.id),"aria-label":()=>Ln(this.cellNow(l.id)??l),title:()=>Ln(this.cellNow(l.id)??l),onclick:()=>this.openHole.set(this.openHole.get()===l.id?null:l.id)},hole:()=>String((this.cellNow(l.id)??l).holeNumber),score:()=>vh(this.cellNow(l.id)??l),tee:{className:()=>(this.cellNow(l.id)??l).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const f=this.cellNow(l.id)??l;return f.tee===null?"":`background:${this.teeColor(f.tee)}`}},gir:{className:()=>{const f=this.cellNow(l.id)??l;return f.gir===null?"cell__gir cell__gir--absent":f.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const f=this.cellNow(l.id)??l;return f.putts===null?"":String(f.putts)},pen:{className:()=>ju(this.cellNow(l.id)??l)?"cell__pen":"cell__pen cell__pen--absent"}},u),l=>l.id),this.$each(this.ref(d,"detailLines"),()=>Th(this.selected()),(l,c,u)=>this.wireEl(hf,{label:()=>l.label,value:()=>l.value},u),l=>l.key),this.$each(this.ref(d,"deltas"),()=>{const l=t();return l===null?[]:ce.filter(c=>je(l.waterfall,c)!==null)},(l,c,u)=>this.wireEl(pf,{title:()=>Gt(l),sentence:()=>{const f=t();if(f===null||f.deltas===null)return"";const m=Hs(f.deltas,l);return m===null?"":pr(m,f.windowCount)},value:{textContent:()=>{const f=this.componentValue(l);return f===null?"":He(f)},style:()=>{const f=this.componentValue(l);return f===null?"":`color:${Ge(Vt(f),this.colors)}`}},bar:{innerHTML:()=>{const f=t(),m=this.componentValue(l);return f===null||m===null?"":dr(m,Vi([f.waterfall]),this.colors)}}},u),l=>l),this.spawn(yr,this.ref(d,"panels"),{model:()=>t()?.panels??qi}),this.$each(this.ref(d,"legend"),()=>[W.legendTee,W.legendGir,W.legendPutts,W.legendPenalty,W.legendAbsence],(l,c,u)=>this.wireEl(ff,{text:()=>l},u),l=>l),d}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:je(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":_h({...e,title:In(e)})}stateLine(){if(this.auth.currentUser.get()===null)return W.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return W.loading;case"notFound":return W.noStatsInRound;case"notAuthorized":return W.notSignedIn;case"failed":return`${W.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?W.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const bf=b(`
    <div class="admin">
...
`),wf={not_started:"Not started",active:"Playing",complete:"Done"},xf={private:"Private",friends:"Friends",link:"Link"};function $f(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function kf(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Sf extends O{static styles=`
        .admin {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
...
`);class Ef extends O{static styles=`
        .comps {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
            ...
            & .comps__create {
                ...
                gap: ${o("sm")};
                margin-bottom: ${o("md")};
                & input { ${ee()} flex: 1; padding: ${o("md")}; font-size: 1rem; }
                & button {
                    ${x()}
                    padding: ${o("md")} ${o("lg")};
                    font-family: inherit; font-size: 0.95rem; font-weight: 700;
...
`),Vf=b('<option bind="option"></option>');class Uf extends O{competitions=this.inject(Me);state=this.inject(ct);router=this.inject(B);render(){const e=new $(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Gf,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Pf(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(Vf,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(qf,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>Df[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Kf(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function Wf(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const Yf=b(`
    <div>
...
`),Qf=b('<button bind="button" type="button"></button>'),Xf=b('<th bind="cell"></th>'),Jf=b('<tr bind="row"></tr>'),Zf=b('<td bind="cell"><span bind="value"></span></td>'),em=b(`
...
`);class im extends O{static styles=`
        .cd {
            padding: ${o("lg")} ${o("lg")} ${o("2xl")};
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${o("xs")};
                    ...
                    & input, & select { ${ee()} padding: ${o("sm")} ${o("md")}; font-size: 0.95rem; }
                }
    ...
    `;competitions=this.inject(Me);state=this.inject(ct);router=this.inject(B);render(){const e=()=>this.competitions.detail.get();this.track(I(()=>{const n=this.state.id.get();n&&Y(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(nm,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>vr(this.state.lifecycle.get()),className:()=>wr(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&ps(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>ps(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=ps(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(Lf,this.ref(t,"setup")),this.spawn(jf,this.ref(t,"roster")),this.spawn(Uf,this.ref(t,"rounds")),this.spawn(sm,this.ref(t,"results")),t}}const rm=b(`
    <div class="app-shell">
...
`);class om extends O{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(B);render(){const e=this.wire(rm,{header:{className:()=>Is(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(tc,this.ref(e,"account")),this.spawn(Ko,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":yn,"/history":_c,"/round":Gh,"/create":bp,"/login":$p,"/friends":Pp,"/friend":Cp,"/friend-rounds":Np,"/friend-courses":Hp,"/spectate":Fp,"/profile":qp,"/stats":af,"/round-stats":gf,"/admin":Sf,...bi.competitions?{"/competitions":Ef,"/competition":im}:{}},yn),e}}class am extends D{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await mr(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await _p()),this.error.set(null)}catch(e){e instanceof U&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await yp(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof U&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await vp();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof U&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}V.get(Fr);const ei=V.get(B);V.set(D,new am);const ti=V.get(D);await Gr(om,"#app",{hot:void 0,onInit:async()=>{await ti.load(),ti.currentUser.get()&&ei.route.get()==="/login"&&ei.navigate("/",!0)}});export{fs as A,O as C,B as R,p as S,Fr as T,_ as a,tt as b,$ as c,Er as d,I as e,Cr as n,F as r,b as t};
