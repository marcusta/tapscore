(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Kr="modulepreload",Wr=function(s){return"/tapscore/"+s},hn={},Yr=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=Wr(u),u in hn)return;hn[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Kr,f||(h.as="script"),h.crossOrigin="",h.href=u,o&&h.setAttribute("nonce",o),document.head.appendChild(h),f)return new Promise((g,v)=>{h.addEventListener("load",g),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=d,window.dispatchEvent(o),!o.defaultPrevented)throw d}return i.then(d=>{for(const o of d||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})},ki="/tapscore/".replace(/\/+$/,""),Ps=ki+"/api",qt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Qr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Si(s,e){const t={};for(const[n,i]of Qr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Ti=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Xr={thin:"1px",medium:"3px",thick:"5px"};function Pi(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Xr[e.toLowerCase()]??e}function Jr(){return Ti.map(s=>{const e=Pi(qt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Ii={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Ci={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Zr={...Ci,"done-opacity":"0.35"},ea={...Ii,...Ci,...qt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},ta={...Ii,...Zr,...qt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class sa{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Ei(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ve=new sa;function Ei(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ve.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ve.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ve.notify(t.subs))})},deps:new Set};n.run()}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}}function E(s){const e={run(){ve.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Ei(e)}}function rt(s){ve.batch(s)}function X(s){return ve.untrack(s)}class na{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const U=new na,Ye=ki;function Is(s){return Ye?s===Ye?"/":s.startsWith(Ye+"/")?s.slice(Ye.length):s:s}function ia(s){return Ye+s}class j{constructor(){this.route=new p(Is(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>rt(()=>{this.route.set(Is(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,o=d.indexOf("?"),c=o>=0?d.slice(0,o):d,u=o>=0?d.slice(o+1):"",f=n.query!==void 0?ra(n.query):u?"?"+u:"",m=ia(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),rt(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function ra(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function aa(s){return e=>s[e]}const oa="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",pn="data-basics-global";function la(){if(document.head.querySelector(`style[${pn}]`))return;const s=document.createElement("style");s.setAttribute(pn,""),s.textContent=Jr()+oa,document.head.appendChild(s)}function da(s,e){la();const t=new Set(Ti),n=(r,d,o)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?Pi(f):f}`).join(";");return`${d}{color-scheme:${o};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const fn="basics-js-theme";class ca{constructor(){this.dark=new p(!1);const e=localStorage.getItem(fn),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),E(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(fn,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function ua(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const mn=new Set;class H{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!mn.has(t)){mn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return U.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=X(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){X(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const o=t[d.getAttribute("bind")];if(o)if(typeof o=="function")i(E(()=>{const c=o();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(o)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(E(()=>{const m=u();f?d.setAttribute(c,String(m)):d[c]=m})):f?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof H?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...o)=>this.spawn(r,d,...o),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,o=new Map;this.track(()=>{for(const c of o.values())c.forEach(u=>u());o.clear()}),this.track(E(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(d.has(g))u.set(g,d.get(g));else{const v=[];u.set(g,X(()=>n(h,m,w=>v.push(w)))),o.set(g,v)}}for(const[m,h]of d)u.has(m)||(h.remove(),X(()=>o.get(m)?.forEach(g=>g())),o.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(E(()=>{r&&(r.remove(),r=null);const d=t.get();r=X(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(E(()=>{if(r){const c=r;r=null,X(()=>c.destroy())}e.textContent="";const d=t.get(),o=n[d]??ua(d,n)??i;o&&(r=X(()=>{const c=new o;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ct=new Set;function ha(s){return Ct.add(s),()=>Ct.delete(s)}function pa(){for(const s of Array.from(Ct)){Ct.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function fa(s,e,t){const n=document.querySelector(e);n.textContent="";const i=U.get(j);let r=null,d=!1,o=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(o||(o=(await Yr(()=>import("./obs-shell.component-BW3fQjG-.js"),[])).ObsShellComponent),r=X(()=>new o)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=X(()=>new s)),X(()=>r.mount(n)),d=f};await u(Is(location.pathname).startsWith("/_obs")),E(()=>{const f=i.route.get().startsWith("/_obs");f!==d&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,pa(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class K extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const ma=10,Tt=[];let Pt=[],tt=null;function ga(s){Tt.push(s),Tt.length>ma&&Tt.shift()}function Ni(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Tt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Pt.push(n),ba()}function ba(){tt||(tt=setTimeout(Ri,5e3))}function Ri(){if(tt&&(clearTimeout(tt),tt=null),Pt.length===0)return;const s=Pt;Pt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ps}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ps}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ri()});const ya=3e4,_a=2,mt=new Map,Oi=new WeakMap;function va(s){if(s instanceof K)return s.traceId;if(s!=null&&typeof s=="object")return Oi.get(s)}async function y(s){if(s.method==="GET"){const e=mt.get(s.url);if(e)return e;const t=gn(s,_a);return mt.set(s.url,t),t.then(()=>mt.delete(s.url),()=>mt.delete(s.url)),t}return gn(s,0)}async function gn(s,e){const t=s.timeout??ya;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await xa(wa(s,r),t)}catch(d){if(n=d,!(d instanceof K)&&d!=null&&typeof d=="object"&&Oi.set(d,r),d instanceof K||i===e)break;await new Promise(o=>setTimeout(o,1e3*2**i))}}throw n}async function wa(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(ga({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new K(i.status,d.error??i.statusText,d.details,r)}return i.json()}function xa(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Cs=new Set;let as=!1;function $a(s){return Cs.add(s),()=>{Cs.delete(s)}}function Mi(){if(!as){as=!0;try{for(const s of[...Cs])try{s()}catch(e){try{Ni("session-listener",ka(e))}catch{}}}finally{as=!1}}}function ka(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function G(s,e,t,n={}){rt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=Sa(i);rt(()=>{s.set(!1),e.set(r)}),Ni(r.code,r.message,va(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Mi();return}}function Sa(s){return s instanceof K?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const os={sessionExpiry:!1};function Ta(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class D{constructor(){this.api=Ta(Ps),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=$a(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=ha(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await G(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await G(this.loading,this.error,()=>this.api.login({username:e,password:t}),os);return n?(this.currentUser.set(n),!0):!1}async logout(){await G(this.loading,this.error,()=>this.api.logout(),os);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await G(this.loading,this.error,()=>this.api.logoutAll(),os),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Hi={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Pa={...Hi,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Ia={...Hi,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Ca=Si(Pa,ea),Ea=Si(Ia,ta),l=da(Ca,Ea),z=s=>`var(--${s})`,I=(s,e)=>`var(--${s}, ${e})`,C=s=>{const e=qt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=aa({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),gt=s=>`
    ...
    cursor: not-allowed;`,Na={primary:gt("primary"),secondary:gt("secondary"),ghost:gt("ghost"),danger:gt("danger"),disabled:Ai},$=(s=I("btn-radius",C("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Na[e]}
    &:disabled {${Ai}}
`,Ra=`max(${I("field-border-width",C("field-border-width"))}, ${I("field-rule-width",C("field-rule-width"))})`,bt=(s,e)=>`
    border-top-color: ${s};
...
`);class yo extends H{static styles=`
        .dock {
    ...
    `;router=this.inject(j);auth=this.inject(D);landing=this.inject(Kt);newCount=new k(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(go,{bar:{className:()=>yn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return mo(r)?yn(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=po(Bi),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(bo,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const o=this.newCount.get();return o===0?"":String(o)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,o)=>i(r,o),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,o)=>i(r,o),r=>r.key),e}}const Fi=["tee","approach","putting","shortGame","penalties","recovery"],It={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function Gi(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function _o(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const vo="Track statistics",wo="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function ji(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Et(s,e){return s[e]}function xo(s,e){if(!s.enabled)return!0;const t=ji(e);return t===null?!1:!Et(s,t)}function $o(s,e){if(!s.enabled)return null;const t=ji(e);return t===null||Et(s,t)?null:`Needs ${Gi(t)}`}function ko(s,e,t){return To({...s,[e]:t})}function So(s,e){return{...s,enabled:e}}function To(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function ds(s){const e={...It,enabled:s.enabled};for(const t of Fi)e[t]=s[t];return e}function Po(s){return s.avatarVersion?`${q}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function Io(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(_t(t[0])+_t(t[t.length-1])).toUpperCase();if(t.length===1)return _t(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?_t(n).toUpperCase():"•"}function _t(s){return[...s][0]??""}const vt=512,Co=2*1024*1024;function Eo(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const No=.85;class Xe extends Error{}async function Ro(s){let e;try{e=await createImageBitmap(s)}catch{throw new Xe("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Eo(e.width,e.height),r=document.createElement("canvas");r.width=vt,r.height=vt;const d=r.getContext("2d");if(!d)throw new Xe("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,vt,vt);const o=await new Promise(c=>r.toBlob(c,"image/jpeg",No));if(!o)throw new Xe("That image could not be processed.");if(o.size>Co)throw new Xe("That image is too large.");return o}finally{e.close()}}async function Oo(s){const e=await fetch(`${q}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await Di(e);return await e.json()}async function Mo(){const s=await fetch(`${q}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await Di(s)}async function Di(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new K(t,Ho(e.error,s.status))}function Ho(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Ue{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(It);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await G(this.loading,this.error,()=>Promise.all([_.players.me(),_.players.myHandicapHistory(),_.clubs.list(),_.playerStats.myConfig().catch(()=>null),_.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,o]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?ds(d):It),this.hasRecordedStats.set((o?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(It),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await G(this.saving,this.saveError,()=>_.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await G(this.saving,this.saveError,()=>_.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await G(this.saving,this.saveError,()=>_.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await G(this.saving,this.saveError,()=>_.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await G(this.statsSaving,this.statsError,()=>_.playerStats.putMyConfig(ds(e)));return t?(this.statsConfig.set(ds(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await Ro(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof Xe?i.message:"That image could not be prepared."}),!1}const n=await G(this.avatarSaving,this.avatarError,()=>Oo(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await G(this.avatarSaving,this.avatarError,()=>Mo().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function wt(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function cs(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Nt(s,e="frecency"){return e==="alpha"?[...s].sort(cs):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,o=r>0;if(d!==o)return d?-1:1;if(!d)return cs(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:cs(t,n)})}const Ao=1440*60*1e3;function Lo(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/Ao);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function zo(s,e){if(s.sharedRoundCount<=0)return"never played";const t=Lo(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function Bo(s){return s.isMutual?null:"hasn't added you back"}const qi=2;function _n(s){return s.trim().length>=qi}function Vi(s){return Nt(s,"frecency")}function Fo(s,e){return Vi([...s.filter(t=>t.id!==e.id),e])}function Go(s,e){return s.filter(t=>t.id!==e)}function vn(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function jo(s,e,t=()=>{},n=300){let i=0,r;return d=>{const o=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,o.length<qi){e(o,[]);return}r=setTimeout(()=>{s(o).then(u=>{c===i&&e(o,u)},u=>{c===i&&t(o,u)})},n)}}const Ui=pt("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function Do(s=Z()){return Ui.read(s)}function qo(s,e=Z()){Ui.write(s,e)}class Wt{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(Do());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=jo(e=>_.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await G(this.loading,this.error,()=>_.friends.list());t&&(this.friends.set(Vi(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await G(this.mutating,this.mutateError,()=>_.friends.add({friendId:e.id}))&&(this.friends.set(Fo(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(vn(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),qo(e)}async remove(e){await G(this.mutating,this.mutateError,()=>_.friends.remove({friendId:e}))&&(this.friends.set(Go(this.friends.get(),e)),this.results.set(vn(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class Ds{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await _.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Je(s,e){return s instanceof K&&s.status===401?(Mi(),"Your session expired — sign in again."):e}function Rt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function Vo(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${Rt(s.scoreToPar)}`}function Ki(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function Wi(s){return(s.courseName??"").trim()||null}function Uo(s){const e=[];for(const t of s){const n=t.friends[0],i=Ki(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:Wi(t),progress:Vo(n)})}return e}function Ko(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function Wo(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function Yo(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function Qo(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${Rt(s.scoreToPar)}`}function Xo(s){const e=[];for(const t of s){const n=t.friends[0],i=Ki(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:Wi(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function Yi(s){if(s instanceof K){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const De={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function Jo(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function Zo(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function el(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${Rt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${Rt(s.scoreToPar)}`}}}function tl(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function sl(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function nl(s){return s===1?"1 course played":`${s} courses played`}const us={rounds:[],nextCursor:null,hasMore:!1};function wn(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function Qi(s){return s.hasMore&&s.nextCursor!==null}class Yt{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(us);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await _.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Je(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await _.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(wn(us,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Je(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!Qi(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await _.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(wn(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Je(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await _.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Je(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=Yi(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(us),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function Xi(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function il(s){return Math.round(Xi(s))}function rl(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,o=r+(e>n-d?1:0);return o===0?0:-o}function al(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function me(){return al()}const Re=10;class qe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await G(this.loading,this.error,()=>_.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=me()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=me()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=me()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=me()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=me()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=me()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Re:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const xn=["scramble","foursomes","greensomes"];class ol{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof _.setup?.formations=="function")return this.inFlight=(async()=>{const e=await G(this.loading,this.error,()=>_.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=xn.indexOf(n);return i===-1?xn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=me()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const ll=180,$n=4,dl=12;function Ge(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function cl(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<dl)return 0;const i=e+t*ll,r=Math.round(-i/n);return Math.max(-$n,Math.min($n,r))}const kn="tapscore:pending-scores:v1",ul=336*60*60*1e3,Sn=200;function hl(){try{return globalThis.localStorage??null}catch{return null}}function pl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class fl{entries=[];storage;constructor(e=hl(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=ul);return t.length>Sn?t.slice(t.length-Sn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(kn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(pl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(kn,JSON.stringify(this.entries))}catch{}}}const _e=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","putts","penalties","penalty_source"],ml={minPar:4},gl={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Missed where",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},bl={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Around the green"}]}};function Es(s){return gl[s]}function Tn(s){return bl[s]}function yl(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function Ji(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function _l(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function vl(s,e,t){return e-t<=s-2?"1":"0"}function Ns(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class wl{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=Pn(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=Pn(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!_l(this.par,this.strokes,e)?null:vl(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Ns(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of _e)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Ns(this).state};`,e}get prompts(){const e=[];for(const t of _e)this.isVisible(t)&&e.push({key:t,label:Es(t),control:Tn(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Ji(ml,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune())}step(e,t){const n=Tn(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<_e.length;e++){let t=!1;for(const n of _e){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),xl(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of _e){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function xl(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function Pn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of _e){const n=s[t];n!==void 0&&e.set(t,n)}return e}const In="tapscore:pending-stat-events:v1",$l=336*60*60*1e3,Cn=500;function kl(){try{return globalThis.localStorage??null}catch{return null}}function Sl(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Tl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&_e.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Pl{entries=[];storage;makeId;constructor(e=kl(),t=Date.now(),n=Sl){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const o of i){const c={token:e,playHoleId:t,playerId:n,key:o.key,value:o.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===o.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=$l);return t.length>Cn?t.slice(t.length-Cn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(In);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Tl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(In,JSON.stringify(this.entries))}catch{}}}const Il=50;function Cl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const qs=pt("tapscore.result-cursors.v1",Bs(Cl),Il);function Vs(s=Z()){return qs.read(s)}function El(s,e=Z()){return Vs(e).find(t=>t.token===s)?.cursor??null}function Nl(s,e,t=Z()){if(!t)return[];const n=Vs(t).filter(i=>i.token!==s);return qs.write([{token:s,cursor:e},...n],t)}function Rl(s,e=Z()){if(!e)return[];const t=Vs(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&qs.write(n,e),n}const Ol=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Pe=(s,e)=>`${s}|${e}`;function Us(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function Ml(s,e,t){return Ji(s,e,t)}function hs(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Hl(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function Al(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class fe{constructor(e=new fl,t=new Pl){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),U.get(qe).load();const r=await G(this.loading,this.error,()=>_.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Qe({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!no(r.round.id))),U.get(D).currentUser.get()&&io(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,o,c,u]=await Promise.all([_.friendlyRounds.balls({token:e}).catch(()=>[]),_.friendlyRounds.scorecard({token:e}).catch(()=>[]),_.playerStats.configsByToken({token:e}).catch(()=>null),_.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(o),this.balls.set(d),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await _.friendlyRounds.remove({token:e}),zi(e);const t=this.round.get()?.id;return t&&Li(t),Rl(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await G(this.resultLoading,this.resultError,()=>_.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await _.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await _.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await _.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?El(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Nl(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await _.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Qe({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Us(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new k(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(d=>n.subjectLabels?.some(o=>o.ballId===d&&o.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const d=r.entries.find(o=>i(o.ballIds));if(!d)continue;return d.total===null?null:d.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-d.paceDelta:d.paceDelta}:{kind:"total",total:d.total}}if(r.kind==="match_summary"){const d=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!d)continue;if(d.thru===0&&!d.finished)return null;const o=i(d.sideA.ballIds)?"a":"b";if(d.leader===null||d.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=d.leader===o;return{kind:"match",text:`${d.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Ge(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,o)=>d.ordinal-o.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${Ol[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Ge(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Ge(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(d=>{const o=n.get(d.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return o?.strokes===null||o===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Pe(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Pe(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const o=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===o)?.strokeIndex??d.baseStrokeIndex;return rl(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Ns(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new wl(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Hl(t):new Map;for(const i of _e){const r=hs(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=hs(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=hs({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await _.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return Al(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Pe(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=U.get(qe),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const o of d)i.has(o.key)||(i.add(o.key),n.push(o))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Ml(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Pe(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const o=this.token;o&&(this.enqueue(o,e,t,n,i,d),await this.post(o,e,t,n,i,d))}async retry(e,t){const n=Pe(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Pe(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const o=Pe(t,n);try{await _.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class Zi{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await _.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=Yi(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Je(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await _.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Us(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new k(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class er{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await _.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await G(this.loading,this.error,()=>Promise.all([_.admin.adminStats(),_.admin.adminRounds({limit:100}),_.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const Ll=["last5","last10","last20","thisYear","all","custom"];function Ot(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function zl(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function Ks(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const st={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function Bl(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function Fl(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function ps(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function Gl(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Qt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function tr(s){return`${s.getFullYear()}-`}function sr(s,e,t,n){const i=Qt(t);switch(s){case"last5":case"last10":case"last20":{const r=Ks(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=tr(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>Fl(e,r))}}function nr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=Ks(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${tr(r)}01-01`;return!n.some(o=>o.date<d)}case"all":return!0;case"custom":{if(Bl(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(o=>o.date<d)}}}const jl="Unnamed course";function Dl(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??jl,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Mt="last10";function ql(s){return Ll.includes(s)}const ir=pt("tapscore.stats.window.v1",{decode:s=>ql(s)?s:Mt,encode:s=>s,empty:Mt});function Rs(s=Z()){return ir.read(s)}function En(s,e=Z()){ir.write(s,e)}function x(s,e){return{value:e===0?null:s/e,n:s,d:e}}const at=5;function Le(s,e=at){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const Ht=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0});function Vl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker}}function Ul(s){let e=Ht;for(const t of s)e=Vl(e,t);return e}const Me=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function Ws(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function Kl(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function Wl(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function rr(s){return x(s.fairwayHits,s.teeRecorded)}function Yl(s){return x(s.troubleCount,s.teeRecorded)}function Ql(s){return x(s.holesWithPenalty,s.penaltiesRecorded)}function Xl(s){return{penalty:x(s.strokesVsParPenalty,s.holesScoredPenalty),clean:x(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function Jl(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return x(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Zl(s){return x(s.recoverySuccesses,s.recoveryAttempts)}function ed(s,e){return x(s.penaltiesTotal,e)}function td(s){return{fairway:x(s.strokesVsParFairway,s.holesScoredFairway),inPlay:x(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:x(s.strokesVsParTrouble,s.holesScoredTrouble)}}function sd(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return x(e,s.holesScoredTrouble*s.holesScoredFairway)}function ar(s){return x(s.girHits,s.girRecorded)}function nd(s){return{fairway:x(s.girHitsFairway,s.girRecordedFairway),inPlay:x(s.girHitsInPlay,s.girRecordedInPlay),trouble:x(s.girHitsTrouble,s.girRecordedTrouble)}}function id(s){return{par3:x(s.girHitsPar3,s.girRecordedPar3),par4:x(s.girHitsPar4,s.girRecordedPar4),par5:x(s.girHitsPar5,s.girRecordedPar5)}}function rd(s){const e=x(s.strokesVsParGirHit,s.girHolesScored),t=x(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:x(n,s.holesScoredGirMiss*s.girHolesScored)}}function ad(s,e){return x(Wl(s,e),s.girFirstPuttRecorded)}function od(s){let e=0;for(const t of Me)e+=Ws(s,t);return e}function ld(s,e){return x(Ws(s,e),od(s))}function dd(s){return x(s.birdiesOnGir,s.girHolesScored)}function cd(s){return x(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function ud(s){const e=s.greenMissRecorded;return{long:x(s.greenMissLong,e),short:x(s.greenMissShort,e),left:x(s.greenMissLeft,e),right:x(s.greenMissRight,e)}}function hd(s){return{left:x(s.teeMissLeft,s.teeMissRecorded),right:x(s.teeMissRight,s.teeMissRecorded),troubleLeft:x(s.teeTroubleLeft,s.teeMissLeft),troubleRight:x(s.teeTroubleRight,s.teeMissRight)}}function pd(s){const e=s.penaltySourceRecorded;return{tee:x(s.penaltiesTee,e),approach:x(s.penaltiesApproach,e),short:x(s.penaltiesShort,e)}}function fd(s,e){return x(Kl(s,e),Ws(s,e))}function md(s){return x(s.threePutts,s.puttsRecorded)}function gd(s){const e=s.puttsRecorded;return{zero:x(s.holesZeroPutt,e),one:x(s.holesOnePutt,e),two:x(s.holesTwoPutt,e),threePlus:x(s.threePutts,e)}}function bd(s){return{par3:x(s.puttsTotalPar3,s.puttsRecordedPar3),par4:x(s.puttsTotalPar4,s.puttsRecordedPar4),par5:x(s.puttsTotalPar5,s.puttsRecordedPar5)}}function yd(s){return x(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function _d(s){return x(s.puttsTotalGir,s.puttsRecordedGir)}function vd(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return x(e,t)}function or(s){return{standard:x(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:x(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:x(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function wd(s){return x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function xd(s){return x(s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function $d(s){return x(s.holesMultiChipBunker,s.scrambleAttemptsBunker)}function kd(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Sd(s){return{standard:x(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:x(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:x(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:x(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function Td(s){return{par3:x(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:x(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:x(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Pd(s,e){return x(s.doubleBogeyPlus,e)}function Id(s){return x(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Cd=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],Ed=18;function Nd(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let f=r.get(c.holeCount);if(f||(f={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,f)),f.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;f.completeRounds+=1;const h=u.strokesTotal-u.parTotal;(f.best===null||h<f.best.vsPar)&&(f.best={vsPar:h,strokes:u.strokesTotal})}const d=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let o=0;for(const c of d)o+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:o,lengths:d,avgVsParPer18:x(n*Ed,t),scoreTypeCounts:i}}const lr=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),Rd=Object.freeze({inside2m:1.25,outside2m:2.12}),Od=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),dr=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),de=["tee","approach","shortGame","putting","penalties"];function ot(s,e=dr,t=lr,n=Rd,i=Od){const r=s.attHolesPar3Gir+s.attHolesPar3Miss,d=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,o=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,c=r+d+o,u={attributed:c,holesScored:s.holesScored};if(c===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const f=d+o,m=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,h=s.attMissStandard+s.attMissHard+s.attMissBunker,g=r*e.eHole[3]+d*e.eHole[4]+o*e.eHole[5],w=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+r*e.eHole[3],T=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m,R=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,L=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,V=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),O=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),W=s.attStrokes-s.attPutts-s.attPenalties-f-m+T+V-w,ae=m-h+R-L,oe=s.attPutts-(T+R),Vr=s.attPenalties,Ur=s.attStrokes-g;return{tee:O,approach:W,shortGame:ae,putting:oe,penalties:Vr,total:Ur,coverage:u}}const cr=9;function xe(s,e){return ur(s,Ve(s,e))}function Nn(s){return ur(s,s.total)}function ur(s,e){return e===null||s.coverage.attributed<cr?null:e*18/s.coverage.attributed}function Ve(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function hr(s,e){const t=n=>Rn(xe(s,n),e.map(i=>xe(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:Rn(Nn(s),e.map(Nn))}}function Ys(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function Qs(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function Rn(s,e){if(s===null)return null;const t=Qs(e);return t===null?null:s-t}function Md(s){return s.penalties}const On=1,Hd=2,Ad=.75,Ld=4,zd=3,Bd=12,Fd=5,Gd=2,jd=10,Mn=.35;function Dd(s,e,t,n){const i=hr(e,t),r=[];let d=0;const o=(T,R)=>{r.push({line:T,magnitude:R,order:d++})};let c=null,u=null;for(const T of de){const R=Ys(i,T);R!==null&&((c===null||R<c.delta)&&(c={component:T,delta:R}),(u===null||R>u.delta)&&(u={component:T,delta:R}))}c!==null&&c.delta<=-On&&o({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=On&&o({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=Qs(t.map(Md)),m=e.penalties;f!==null&&m!==null&&m>=f+Hd&&o({id:"penalties_spike",params:{penalties:m,baseline:f}},0),s.teeMissRecorded>=jd&&s.teeMissLeft>=Mn*s.teeMissRecorded&&s.teeMissRight>=Mn*s.teeMissRecorded&&o({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=zd&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&o({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const h=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,g=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;h>=Ld&&g>=Ad*h&&o({id:"scramble_streak",params:{successes:g,attempts:h}},0),s.threePutts===0&&s.puttsTotal>=Bd&&o({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const v=xe(e,"putting"),w=t.map(T=>xe(T,"putting")).filter(T=>T!==null);return v!==null&&w.length>=Fd&&w.every(T=>v<T)&&o({id:"best_putting_round",params:{putting:v,rounds:w.length}},0),s.bounceBackOpportunities>=Gd&&s.bounceBackSuccesses===s.bounceBackOpportunities&&o({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((T,R)=>R.magnitude-T.magnitude||T.order-R.order),r.slice(0,Math.max(0,n)).map(T=>T.line)}const Hn=Object.freeze(Object.keys(Ht));function qd(s){if(typeof s!="object"||s===null)return[...Hn];const e=s;return Hn.filter(t=>typeof e[t]!="number")}function At(s){if(s.length===0)return null;const e=qd(s[0].measures);if(e.length===0)return null;const t=e.slice(0,3).join(", "),n=e.length>3?` and ${e.length-3} more`:"";return`The server sent stats this app does not understand (missing ${t}${n}).`}const Vd=["tee","approach","putting","shortGame","scoring"];function Ud(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const Kd=3,pr={rounds:[],totals:Ht,waterfall:ot(Ht),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function Xs(s){const e=Qt(s);if(e.length===0)return pr;const t=Ul(e.map(r=>r.measures)),n=e.map(r=>ot(r.measures)),i=e.length;return{rounds:e.map((r,d)=>{const o=n[d];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:r.measures.holesScored===0?null:r.measures.strokesTotal-r.measures.parTotal,waterfall:o}}),totals:t,waterfall:ot(t),priorities:Wd(n),trends:Yd(e),tee:Qd(t,i),approach:Xd(t),putting:Jd(t),shortGame:Zd(t),scoring:ec(t,i),results:Nd(e)}}function Wd(s){const e=de.map(n=>{const i=s.map(r=>xe(r,n));return{component:n,per18:Qs(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>de.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function fs(s){return Le(s)==="percentage"?s.value:null}function Yd(s){const e=[...s].reverse(),t=(n,i,r,d)=>{const o=[];for(const c of e){const u=d(c.measures);u!==null&&o.push(u)}return o.length>=Kd?{id:n,title:i,kind:r,points:o}:null};return[t("fairway","Fairways","percentage",n=>fs(rr(n))),t("gir","Greens","percentage",n=>fs(ar(n))),t("putting","Putting","strokesLost",n=>xe(ot(n),"putting")),t("scramble","Scrambling","percentage",n=>fs(or(n).overall))].filter(n=>n!==null)}function Qd(s,e){return s.teeRecorded<=0?null:{fairway:rr(s),inPlayOnly:x(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:Yl(s),troubleTax:sd(s),vsParByTee:td(s),recovery:Zl(s),teeMiss:hd(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:ed(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:Ql(s),penaltyTax:Jl(s),vsParByPenalty:Xl(s),penaltySource:pd(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function Xd(s){if(s.girRecorded<=0)return null;const e={};for(const t of Me)e[t]=ad(s,t);return{gir:ar(s),girByTee:nd(s),girFirstPuttMix:e,birdieConversion:dd(s),hardChipShare:cd(s),girByPar:id(s),greenMiss:ud(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:rd(s)}}function Jd(s){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const e={};for(const t of Me)e[t]=ld(s,t);return{ladder:Me.map(t=>({bucket:t,made:fd(s,t),baseline:Math.max(0,2-lr[t])})),firstPuttSpread:e,threePutt:md(s),threePuttsFromOver8m:yd(s),puttsPerGirHole:_d(s),puttsAfterMissedGreen:vd(s),puttDistribution:gd(s),puttsPerHoleByPar:bd(s)}}function Zd(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:or(s),chipInside2m:Sd(s),conversionInside2m:x(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:wd(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,multiChip:xd(s),multiChipBunker:$d(s),extraShortGameStrokes:kd(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded}}function ec(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Td(s),doubleBogeyPlusPerRound:Pd(s,e),bounceBack:Id(s)}}function fr(s){let e=0;for(const t of s)for(const n of de){const i=Ve(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function tc(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function Js(s){const e=U.get(qe);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function sc(s){const e=U.get(qe);return e.load(),e.labelOf(s)??s}function nc(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:Za(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(Js).join(" · ")}))}function ic(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function lt(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Lt(s){return s.courseName?lt(s)===s.courseName?null:s.courseName:null}function Ae(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const nt={fromMyRounds:nc,fromDeviceRounds:ic};function ce(s){switch(Le(s)){case"absent":return null;case"fraction":return`${J(s.n)} of ${J(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function rc(s){return Le(s)!=="percentage"?null:`${J(s.n)} of ${J(s.d)}`}function se(s){const e=ce(s);if(e===null)return null;const t=rc(s);return t===null?e:`${e} (${t})`}function dt(s,e=2,t=!1){return Le(s)==="absent"||s.value===null?null:t?Se(s.value,e):$e(s.value,e)}function Xt(s){return{one:s,many:`${s}s`}}const be=Xt("round"),le=Xt("hole"),Os=Xt("green"),Zs="thin sample";function mr(s,e){switch(Le(s)){case"absent":return null;case"fraction":return`over ${ee(s.d,e)} — ${Zs}`;case"percentage":return`over ${ee(s.d,e)}`}}function re(s,e){const t=dt(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=mr(s,e.unit);return i===null?n:`${n} (${i})`}const ac={one:"hole from trouble",many:"holes from trouble"},oc={one:"from the fairway",many:"from the fairway"};function lc(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${ee(e,ac)} vs ${ee(t,oc)}`;return e<at||t<at?`${n} — ${Zs}`:n}function gr(s,e,t,n){if(s.d<=0||t.d<=0)return null;const i=`over ${ee(s.d,e)} vs ${ee(t.d,n)}`;return s.d<at||t.d<at?`${i} — ${Zs}`:i}const dc={one:"hole with the green missed",many:"holes with the green missed"},cc={one:"green hit",many:"greens hit"},uc={one:"hole with a penalty",many:"holes with a penalty"},hc={one:"without",many:"without"},pc=Xt("penalty hole");function fc(s){return gr(s.miss,dc,s.hit,cc)}function mc(s){return gr(s.penalty,uc,s.clean,hc)}function gc(s){return Le(s)==="fraction"}function J(s){return s===Math.round(s)?String(Math.round(s)):$e(s,1)}function ee(s,e){return`${J(s)} ${s===1?e.one:e.many}`}function $e(s,e=1){return s.toFixed(e)}function Se(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return $e(0,e);const i=$e(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function bc(s){return`${Se(s)} per 18`}function Jt(s){return s===0?"E":Se(s,s===Math.round(s)?0:1)}function Zt(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function ms(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function yc(s){return s==="indoor"?"Indoor":"Outdoor"}function _c(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function br(s){return Ae(s)}const yr="Statistics",vc="All statistics →";function wc(s){return s==="custom"?Mt:s}function xc(s,e,t){return Ks(s)!==null||!t?Ot(s):`${Ot(s)} — newest ${e}`}function $c(s){return x(s.strokesTotal-s.parTotal,s.holesScored)}function kc(s){const e=[],t=$c(s.totals),n=dt(t,2,!0);if(n!==null){const c=Le(t)==="fraction"?mr(t,le):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:ce(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,o=d===null?null:ce(d.gir);return o!==null&&e.push({id:"gir",value:o,label:"Greens in regulation",note:null}),e}function Sc(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${Zt(e.component)}`}function Tc(s){const e=wc(s.preset),t=sr(e,st,s.rows,s.now);if(t.length===0)return null;const n=Xs(t),i=kc(n);if(i.length===0)return null;const r=nr({preset:e,filter:st,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:xc(e,t.length,r),tiles:i,priorityLine:Sc(n)}}function Pc(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${yr}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class es{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(Rs());loaded=!1;loading=!1;card=new k(()=>{const e=this.rows.get();return e===null?null:Tc({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(Rs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await _.playerStats.myStats({limit:es.PAGE_SIZE});if(At(t.rounds)!==null)return;this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof K&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const cn=class cn extends H{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(E(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};cn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let ie=un;async function Ic(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Cc="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Te(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function we(s){const e=()=>Po(s());return{avatarPhoto:{src:()=>e()??Cc,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return Io(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function He(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function Ec(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Nc(s){return Ec(s).map(e=>e.kind)}function An(s){return s.signedIn?"avatar":"signin"}const Rc=b(`
...
`);class Oc extends H{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),Gc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',en=`
...
`,jc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${en}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Gc}</button>
...
`),Vc=b(`
    <button bind="row" type="button" class="round-summary recent-row">
        ...
        <span class="recent-row__content">${en}</span>
    </button>
...
`),Wc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Yc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${en}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Wc}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
    </div>
`);class Qc extends H{static styles=`
        .history {
...
`),tn='<button bind="infoTrigger" class="stats__info" type="button"></button>',sn=`
...
`,Ie=60,Fn=8,Hs=4,nu=Array.from({length:Hs*2+1},(s,e)=>e-Hs),iu="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",ru=b(`
...
`),uu=b('<button bind="btn" class="se-seg" type="button"></button>'),hu=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),pu=b('<div bind="rule" class="se-stats__rule"></div>');class fu extends H{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Fn}px; flex-shrink: 0; }
...
</tr>`;const V=As(n.plan.slotDefId,R.ballIds),O=n.isOpen(V),W=Lu(V),ae=Tr(L,n.routeSections,e,{mode:n.mode??"product"}),oe=["lb-rank__row--expandable"];return g.lead&&oe.push("lb-rank__lead"),O&&oe.push("lb-rank__row--open"),`<tr class="${oe.join(" ")}" data-expand-key="${F(V)}">
  <td class="lb-rank__pos">${g.position}</td>
...
</div>`}function Bu(s,e){const t=ku(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",d=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Fu={ranked:zu,match_summary:(s,e)=>Bu(s,e)},Gu={"default-score-grid":Ou,"compact-match-grid":Mu,"category-matrix-grid":Hu};function ju(s){return`<div class="lb-diag">Unrenderable result section <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Du(s){return`<div class="lb-diag">Unsupported score-grid component <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function qu(s,e,t,n=null){const i=Fu[s.kind];return i?i(s,e,t,n):ju(s.kind)}function Tr(s,e,t,n){const i=$r(s),r=Gu[i];return r?r(s,e,t,n):Du(i)}function Pr(s,e,t=Sr,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${F(s.formatLabel)}.</div>`:s.leaderboard.map(r=>qu(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${F(s.formatLabel)}.</div>`}function Ir(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Tr(r,e,t,{mode:i})).join(`
`)}const Vu=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class on extends H{static styles=`
        .lb {
    ...
    `;svc=this.inject(fe);expansion=new Pu;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Vu,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=Tu(t);this.expansion.retain(r.attached.keys());const d=Pr(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),o=Ir(r.standalone,e.routeSections,n),c=o?`<h3 class="lb-cards__head">Scorecard</h3>${o}`:"";return d+c}}function Uu(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Ku=b(`
...
`);class Yu extends H{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `,it.seq=0;let he=it;function Xu(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Ju(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Zu(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const eh=b(`
...
`);class nh extends H{static styles=`
        .seat-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
...
`);class lh extends H{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(j);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return rh(this.svc.startList.get())}eligible(){return this.policyState().visible&&ih(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,_.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await _.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof K&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(E(()=>this.ensureTeesLoaded()));const e=new k(()=>ah(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(E(()=>{const r=e.get(),d=this.groupChoice.get();(!d||!r.options.some(o=>o.value===d&&!o.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(oh,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new he({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new he({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const Vn=1440*60*1e3;function dh(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>Vn?!0:e-t>=Vn}function ch(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function uh(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!ch(s.balls,s.playerId)||!dh(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ye(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Bt(s){return s<0?`+${String(-s)}`:String(s)}const hh=b(`
...
`);class ph extends H{static styles=`
    ...
    `;svc=this.inject(fe);auth=this.inject(D);profile=this.inject(Ue);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return uh({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Bt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ye(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(E(()=>this.ensureProfileLoaded())),this.wire(hh,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Bt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function fh(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const mh=b(`
...
`);class gh extends H{static styles=`
...
`);class Ph extends H{static styles=`
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(j);stage=new p("prompt");error=new p("");render(){this.track(E(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(Th,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>yh(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(on,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=Nr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return bh({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return Cr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:Er({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Oe{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(Rs());filter=new p(st);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new k(()=>sr(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new k(()=>Xs(this.windowRounds.get()));courses=new k(()=>Dl(this.loadedRounds.get()));overFiltered=new k(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await G(this.loading,this.error,()=>_.playerStats.myStats({limit:Oe.PAGE_SIZE}));if(!t)return;const n=At(t.rounds);if(n!==null){this.error.set({code:"server",message:n});return}this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded()}select(e){this.preset.set(e),En(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),En("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(st),this.select(Mt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Oe.MAX_PAGES&&nr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await _.playerStats.myStats({limit:Oe.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}const n=At(t.rounds);if(n!==null){this.extendError.set({code:"server",message:n});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Oe.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(st),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class ut{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=U.get(Oe);inFlight=null;model=new k(()=>{const e=this.round.get();return e===null?null:$h({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await _.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Wn(d)),this.failure.set(Yn(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Wn(d)),this.failure.set(Yn(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const o of d)n.has(o.roundId)||(n.add(o.roundId),t.push(o))};if(i(this.dashboard.loadedRounds.get()),Un(t,e,Ls))return t;let r=null;for(let d=0;d<ut.MAX_PAGES;d++){const o=await _.playerStats.myStats({limit:ut.PAGE_SIZE,cursor:r??void 0}),c=At(o.rounds);if(c!==null)throw new Error(c);if(i(o.rounds),Un(t,e,Ls)||o.nextCursor===null)return t;r=o.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function Wn(s){if(s instanceof K){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function Yn(s){return s instanceof K&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const te=100;function ns(s){return s>0?"loss":s<0?"gain":"zero"}function Ke(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function M(s){return String(Math.round(s*1e3)/1e3)}function is(s){return s<0?0:s>1?1:s}function ke(s,e){return`<svg class="chart" viewBox="0 0 ${te} ${M(s)}" preserveAspectRatio="none" style="height:${M(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function ln(s,e,t,n=1){return`<path d="M${M(s)} 0 L${M(s)} ${M(e)}" stroke="${t}" stroke-width="${M(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function pe(s,e,t,n,i){return`<rect x="${M(s)}" y="${M(e)}" width="${M(t)}" height="${M(n)}" fill="${i}"/>`}const Ih=1;function Ch(s,e){const t=te/2,n=ns(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:Ih,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function Rr(s,e,t,n=10){const i=Ch(s,e),r=i.bar&&i.bar.width>0?pe(i.bar.x,0,i.bar.width,n,Ke(i.tone,t)):"";return ke(n,[pe(0,0,te,n,t.track),r,ln(i.zeroX,n,t.rule)].join(""))}function Eh(s){const e=[];let t=0;for(const n of s){const i=te*is(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function Nh(s,e,t=12){const n=Eh(s).filter(i=>i.width>0).map(i=>pe(i.x,0,i.width,t,i.color)).join("");return ke(t,pe(0,0,te,t,e.track)+n)}const Qn=2,Rh=1e-4;function Oh(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=Qn,d=Math.max(0,e-Qn*2);return s.map((o,c)=>({x:s.length===1?te/2:c/(s.length-1)*te,y:i===0?e/2:r+d-(o-t)/i*d}))}function Mh(s){return s.map((e,t)=>`${t===0?"M":"L"}${M(e.x)} ${M(e.y)}`).join(" ")}function Hh(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Rh?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Ah(s,e,t,n=34){const i=Oh(s,n);if(i.length===0)return ke(n,"");const r=Ke(Hh(s,e),t),d=`<path d="${Mh(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,o=i[i.length-1],c=`<path d="M${M(o.x)} ${M(o.y)} L${M(o.x)} ${M(o.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(n,d+c)}const Lh=.5;function zh(s,e,t=12){const n=te/2,i=de.length-1,r=Math.max(1,(t-i)/de.length),d=[];return de.forEach((o,c)=>{const u=Ve(s,o);if(u===null||!(e>0))return;const f=Math.max(u===0?0:Lh,n*Math.min(1,Math.abs(u)/e));d.push({component:o,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:ns(u)})}),d}function Bh(s,e,t,n=12){const i=zh(s,e,n).filter(r=>r.width>0).map(r=>pe(r.x,r.y,r.width,r.height,Ke(r.tone,t))).join("");return ke(n,ln(te/2,n,t.rule)+i)}const Or=1,Xn=.02;function Fh(s,e){const t=e>0?te*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=is(s),i=e<=0?"neutral":s>e+Xn?"gain":s<e-Xn?"loss":"neutral";return{bar:{width:Math.max(Or,te*n),tone:i},tickX:t}}function Gh(s,e,t,n=10){const i=Fh(s,e),r=i.bar?pe(0,0,i.bar.width,n,Ke(i.bar.tone,t)):"",d=i.tickX===null?"":ln(i.tickX,n,t.rule,2);return ke(n,pe(0,0,te,n,t.track)+r+d)}function jh(s){return s===null?null:Math.max(Or,te*is(s))}function Mr(s,e,t=e.neutral,n=8){const i=jh(s),r=i===null?"":pe(0,0,i,n,t);return ke(n,pe(0,0,te,n,e.track)+r)}const Jn=100,Ft=50,Dh=16,xt=22,Zn=44,qh=3,Vh=33,Uh={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function et(s,e){const t=(s-90)*Math.PI/180;return{x:Ft+e*Math.cos(t),y:Ft+e*Math.sin(t)}}function ei(s,e,t,n){const i=e-s>180?1:0,r=et(s,n),d=et(e,n),o=et(e,t),c=et(s,t);return`M${M(r.x)} ${M(r.y)} A${M(n)} ${M(n)} 0 ${i} 1 ${M(d.x)} ${M(d.y)} L${M(o.x)} ${M(o.y)} A${M(t)} ${M(t)} 0 ${i} 0 ${M(c.x)} ${M(c.y)} Z`}function Kh(s){const e=Math.max(s.long,s.short,s.left,s.right),t=qh/2,n=[];for(const i of["long","right","short","left"]){const r=Uh[i],d=r.from+t,o=r.to-t,c=e>0?is(s[i]/e):0,u=xt+(Zn-xt)*c,f=et((r.from+r.to)/2,Vh);n.push({id:i,trackPath:ei(d,o,xt,Zn),valuePath:ei(d,o,xt,u),labelX:f.x,labelY:f.y})}return n}function Wh(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${M(Ft)}" cy="${M(Ft)}" r="${M(Dh)}" fill="${t.track}"/>`+s.map(r=>`<text x="${M(r.labelX)}" y="${M(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${Jn} ${Jn}" preserveAspectRatio="xMidYMid meet" style="width:${M(n)}px;height:${M(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const Yh=60,Gt=58,Qh=2,Xh={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function Jh(s,e){const t=Gt-Qh,n=d=>e>0?d/e*t:0,i=[],r=(d,o)=>{const c=Xh[d];let u=Gt;for(const f of o){const m=n(f.count);u-=m,i.push({id:f.id,column:d,tone:f.tone,x:c.x,y:u,width:c.width,height:m})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function Zh(s,e,t){const n=s.filter(i=>i.height>0).map(i=>pe(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${M(Gt)} L${M(te)} ${M(Gt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(Yh,n)}const rs={gain:l("accent-strong"),loss:l("danger"),zero:l("border-strong"),neutral:l("accent"),track:l("surface-sunken"),rule:l("border")},S={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",sandSave:"Missed greens from a bunker where you still got up and down.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",multiChipBunker:"Bunker holes that took more than one shot to get out.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function Fe(s){return gc(s)?null:s.value}function Y(s,e,t){return{kind:"bar",id:s,title:e,share:Fe(t),value:ce(t)}}function B(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function ep(s,e){switch(s){case"tee":{const t=e.tee&&se(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&se(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?re(e.putting.puttsPerGirHole,{unit:Os,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&se(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?re(e.scoring.doubleBogeyPlusPerRound,{unit:be,label:"doubles or worse per round"}):null}}function tp(s){const e=lc(s.vsParByTee),t=e?`${S.troubleTax} Measured ${e}.`:S.troubleTax;return B("troubleTax","Trouble tax",dt(s.troubleTax,2,!0),t)}function ti(s){return s===null?null:`Measured ${s}.`}function ws(s){return re(s,{unit:le,signed:!0})}function sp(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>ce(i)??"",n=(i,r)=>`${i} ${ce(r)??S.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:Kh(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function np(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:Jh(e,s.teeRecorded),text:[`Left ${J(e.leftInPlay+e.leftTrouble)}`,`Fairway ${J(e.fairway)}`,`Right ${J(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function ip(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function si(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:Fe(t.fairway),value:ce(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:Fe(t.inPlayOnly),value:ce(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:Fe(t.trouble),value:ce(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:S.teeFanHead},np(t),{kind:"note",id:"teeFanNote",text:S.teeFan}]:[],...ip(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},{kind:"note",id:"vsParByTeeNote",text:S.vsParByTee},B("vsParFairway","From the fairway",ws(t.vsParByTee.fairway)),B("vsParInPlay","From in play",ws(t.vsParByTee.inPlay)),B("vsParTrouble","From trouble",ws(t.vsParByTee.trouble))]:[],tp(t),B("recovery","Recovery",se(t.recovery),S.recovery),...t.penaltiesRecordedHoles>0?[B("penalties","Penalties",re(t.penaltiesPerRound,{unit:be}),`${S.penalties} Recorded on ${ee(t.penaltiesRecordedHoles,le)}.`),B("penaltyHoleShare","Holes with a penalty",se(t.penaltyHoleShare)),B("penaltyTax","Penalty tax",dt(t.penaltyTax,2,!0),ti(mc(t.vsParByPenalty)))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:S.greenMissHead},sp(t),{kind:"note",id:"greenMissNote",text:S.greenMiss}]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},Y("girFairway","From the fairway",t.girByTee.fairway),Y("girInPlay","From in play",t.girByTee.inPlay),Y("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},Y("girPar3","Par 3",t.girByPar.par3),Y("girPar4","Par 4",t.girByPar.par4),Y("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:S.proximityProxy},...Me.map(n=>Y(`mix-${n}`,ms(n),t.girFirstPuttMix[n])),B("birdieConversion","Birdie conversion",se(t.birdieConversion),S.birdieConversion),...t.hardChipShare.d>0?[B("hardChipShare","Hard misses",se(t.hardChipShare),S.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},B("vsParGreenHit","Green hit",re(t.costOfMissedGreen.hit,{unit:Os,signed:!0})),B("vsParGreenMissed","Green missed",re(t.costOfMissedGreen.miss,{unit:le,signed:!0})),B("missedGreenTax","Missed-green tax",dt(t.costOfMissedGreen.delta,2,!0),ti(fc(t.costOfMissedGreen)))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[Me[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},{kind:"note",id:"firstPuttNote",text:S.firstPuttSpread},...Me.map(n=>Y(`spread-${n}`,ms(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:S.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:ms(n.bucket),made:Fe(n.made),baseline:n.baseline,value:ce(n.made)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},Y("putts-zero","No putts",t.puttDistribution.zero),Y("putts-one","One putt",t.puttDistribution.one),Y("putts-two","Two putts",t.puttDistribution.two),Y("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],B("threePutt","Three-putts",se(t.threePutt),S.threePutt),B("longThreePutt","Three-putts from over 8 m",se(t.threePuttsFromOver8m),S.longThreePutt),B("puttsPerGir","Putts per green hit",re(t.puttsPerGirHole,{unit:Os}),S.puttsPerGir),...t.puttsAfterMissedGreen.d>0?[B("puttsAfterMissedGreen","Putts after a missed green",re(t.puttsAfterMissedGreen,{unit:le}),S.puttsAfterMissedGreen)]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},B("puttsPar3","Par 3",re(t.puttsPerHoleByPar.par3,{unit:le})),B("puttsPar4","Par 4",re(t.puttsPerHoleByPar.par4,{unit:le})),B("puttsPar5","Par 5",re(t.puttsPerHoleByPar.par5,{unit:le}))]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},Y("scrambleStandard","Standard",t.scramble.standard),Y("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[Y("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[B("sandSave","Sand save",se(t.sandSave),S.sandSave)]:[],...t.shortGameStrokesRecorded>0?[B("multiChipBunker","More than one from sand",se(t.multiChipBunker),S.multiChipBunker),B("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes),S.extraShortGameStrokes),B("multiChip","More than one chip",se(t.multiChip),S.multiChip)]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},Y("chipStandard","Standard",t.chipInside2m.standard),Y("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[Y("chipBunker","Bunker",t.chipInside2m.bunker)]:[],B("conversionInside2m","Holed from inside 2 m",se(t.conversionInside2m),S.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},{kind:"note",id:"chipInsNote",text:S.chipIns},B("chipInsStandard","Standard",J(t.chipIns.standard)),B("chipInsHard","Hard",J(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[B("chipInsBunker","Bunker",J(t.chipIns.bunker))]:[]]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>re(i,{unit:le,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},B("par3","Par 3",n(t.avgVsParByParGroup.par3)),B("par4","Par 4",n(t.avgVsParByParGroup.par4)),B("par5","Par 5",n(t.avgVsParByParGroup.par5)),B("doubles","Doubles or worse",re(t.doubleBogeyPlusPerRound,{unit:be}),S.doubleBogeyPlus),B("bounceBack","Bounce-back",se(t.bounceBack),S.bounceBack)]}}}function rp(s){if(!s||s.rounds===0)return"";const e=ee(s.rounds,be),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${ee(t.holeCount,le)}`;const n=s.lengths.map(i=>`${J(i.rounds)} × ${ee(i.holeCount,le)}`).join(", ");return`${e} — ${n}`}function ap(s){return s===18?"Best 18":s===9?"Best 9":`Best ${J(s)} holes`}const op=18;function lp(s){const e=s.lengths.some(i=>i.holeCount!==op),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${ee(s.holesScored,le)}`;return e?`${n}, scaled to 18`:n}function xs(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:Se(s.avgVsParPer18.value,1),qualifier:lp(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:ap(t.holeCount),value:Jt(n.vsPar),qualifier:`${J(n.strokes)} strokes`,hero:!1})}return e}function dp(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function $t(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return Cd.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:dp(t),share:Fe(x(n,e)),value:ce(x(n,e))??J(n)}})}function cp(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function ni(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const ge={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s=dr.calibratedAt){return s===null?"Tapscore reference baseline v1 is one set of expected scores per hole and per lie. It is still provisional, so treat the order of the rows as the reading and the sizes as rough.":`Tapscore reference baseline v1 is one set of expected scores per hole and per lie, frozen on ${s}. Everyone is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${cr} attributed holes is left out of the comparison entirely.`},total(s){const e=up(s.rowsPer18);if(e===null)return null;const t=Se(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${ee(e.recorded,pc)} you labelled, ${J(e.tee)} came off the tee, ${J(e.approach)} on the approach and ${J(e.short)} around the green.`}};function up(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function jt(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Dt(s){const e=[{id:"holes",title:"Holes counted",body:ge.holesCounted(s)},{id:"rows",title:"The five rows",body:ge.fiveRows()},{id:"baseline",title:"The baseline",body:ge.baseline()},{id:"per18",title:"Per 18 holes",body:ge.per18()}],t=ge.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=ge.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:S.penaltySourceInfoTitle,body:n}),e}const Q={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},ii={title:"Your round",seeWholeRound:"See the whole round"};function hp(s){const e=[br(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function Hr(s,e){return s===null?null:e===null?String(s):`${s} (${Jt(e)})`}function pp(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function fp(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function mp(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Jt(s.vsPar)})`}function gp(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function bp(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function yp(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function _p(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function dn(s){const e=[],t=mp(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:gp(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:bp(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:yp(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function vp(s){return s===null?[]:dn(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function ri(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(_p(s.marker).toLowerCase())):e.push("no score");for(const t of dn(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function Ar(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=$e(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function ai(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function $s(s,e=1){return typeof s=="number"?$e(Math.abs(s),e):""}function Ce(s){return typeof s=="number"?String(Math.round(s)):""}function oi(s){return typeof s=="string"?s:"tee"}function wp(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${ai(oi(e.component))} was ${$s(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${ai(oi(e.component))} cost you ${$s(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${$s(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Ce(e.left)} left and ${Ce(e.right)} right of ${Ce(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Ce(e.successes)} of the ${Ce(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Ce(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Ce(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const xp=b(`
...
${sn}
    `;round=this.inject(fe);stats=this.inject(ut);auth=this.inject(D);router=this.inject(j);colors=rs;infoOpen=new p(!1);render(){this.track(E(()=>{const i=this.eligibleRoundId();X(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(xp,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>ii.title,score:()=>{const i=e();return i===null?"":Hr(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>ii.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ve(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...de],(i,r,d)=>this.wireEl(kp,{label:()=>Zt(i),amount:{textContent:()=>{const o=n(i);return o===null?S.notRecorded:Se(o)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const o=n(i);return o===null?"":`color:${Ke(ns(o),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Dt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(r=>xe(i.waterfall,r)),penaltySource:jt(i.panels.totals)})},(i,r,d)=>this.wireEl(ss,{ctitle:()=>i.title,ctext:()=>i.body},d),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl($p,{text:()=>wp(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:Cr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:Er({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return Q.waterfallHint;let t=null;for(const n of de){const i=Ys(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?Q.waterfallHint:Ar(t,e.windowCount)}}function li(s){return!(!s.pageVisible||s.status==="complete")}function Tp(s,e){return e&&!s}const Pp=2,di=3,Ip=75e3;function Cp(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${q}/friendly-rounds/events?${t.toString()}`}function Ep(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Np(s){const e=s.eventSourceFactory??(L=>new EventSource(L)),t=s.setTimer??((L,V)=>setTimeout(L,V)),n=s.clearTimer??(L=>clearTimeout(L)),i=s.livenessTimeoutMs??Ip,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,o=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(T,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},v=()=>{d=!0,m(),g()},w=()=>{if(g(),++o>=di){v(),s.onDegrade();return}R()};function T(){if(!d){if(!r()){h();return}w()}}function R(){if(d)return;let L;try{L=e(Cp(s.token,f))}catch{v(),s.onDegrade();return}c=L,L.onopen=()=>{o=0},L.onmessage=V=>{if(d||c!==L)return;h();let O;try{O=JSON.parse(V.data)}catch{return}Ep(O)&&(O.latestEventId!==null&&(f=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},L.onerror=()=>{d||c!==L||(L.readyState===Pp||++o>=di)&&(v(),s.onDegrade())},h()}return R(),{stop:()=>{d||v()}}}const Rp=2e4;function Op(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Mp=b(`
...
`),Hp=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Ap=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Lp extends H{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class hf extends H{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class yf extends H{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`),vf='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',wf=b(`
...
`),yi=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${vf}</button>
    </div>
`);class xf extends H{static styles=`
        .friends {
...
`);function Fr(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Jo(s),subtitle:()=>Zo(s,Ae),progress:()=>el(s)}}function Gr(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class kf extends H{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Yt);activity=this.inject(Ds);auth=this.inject(D);router=this.inject(j);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(E(()=>{const h=e.get();X(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new k(()=>{const h=e.get();return h?Yo(this.activity.feed.get(),h):null}),o=()=>this.svc.unavailable.get(),c=()=>n()&&o()===null&&i()!==null,u=()=>n()&&o()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire($f,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&o()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=o();return h?De[h].title:""}},refusalMsg:{textContent:()=>{const h=o();return h?De[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...we(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?tl(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?Qo(h):""},onclick:()=>{const h=d.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>nl(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,v)=>this.wireEl(Br,Fr(h,f),v),h=>h.roundId),m}}const Sf=b(`
    <div class="frounds">
...
`);class Cf extends H{static styles=`
        .fcourses {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class Mf extends H{static styles=`
        ...
        ${on.styles}
    `;svc=this.inject(Zi);auth=this.inject(D);router=this.inject(j);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(E(()=>{const c=e.get();X(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim()||null;return this.wire(Of,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(d()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?_i[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?_i[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Ef(d(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?Nf(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Ae(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const d=i.length>1?`<h2 class="spectate__slot-head">${Hf(r.formatLabel)}</h2>`:"",o=Pr(r,t,n),c=Ir(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return d+o+u}).join("")}}function Hf(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const Af=b(`
    <div class="profile">
...
`);class Bf extends H{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),Gf=b('<h3 bind="text" class="block__subhead"></h3>'),jf=b('<p bind="text" class="block__note"></p>'),Df=b(`
...
`),Yf=b('<div bind="panels" class="statspanels"></div>');class jr extends H{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
...
`);class nm extends H{static styles=`
        .stats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${sn}
    `;svc=this.inject(Oe);auth=this.inject(D);router=this.inject(j);filterOpen=new p(!1);prioritiesInfoOpen=new p(!1);colors=rs;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Qf,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>S.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>S.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>rp(t().results),resultsCard:{className:()=>xs(t().results).length===0&&$t(t().results).length===0?"results hidden":"results"},histHead:()=>$t(t().results).length===0?"":S.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>S.prioritiesHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>S.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>S.roundsHint,pickHint:()=>n()?S.filterRoundsHint:""});return this.setHeading(i,"resultsSec",S.resultsHeading),this.setHeading(i,"prioritiesSec",S.priorities),this.setHeading(i,"trendsSec",S.trends),this.setHeading(i,"roundsSec",S.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>xs(t().results),(r,d,o)=>this.wireEl(Jf,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},o),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>$t(t().results),(r,d,o)=>this.wireEl(Zf,{title:()=>r.title,bar:{innerHTML:()=>Mr((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},o),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,o)=>this.wireEl(em,{title:()=>Zt(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":Rr(c.per18,tc(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?bc(c.per18):S.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.per18===null?cp(c.roundsInWindow):`over ${ee(c.roundsCovered,be)}`:""}}},o),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Dt({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:jt(t().totals)}),(r,d,o)=>this.wireEl(ss,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},o),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,o)=>this.wireEl(tm,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Ah(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return im(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ee(c.points.length,be)}}},o),r=>r.id),this.spawn(jr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,o)=>this.wireEl(sm,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${ni(r)} — hole by hole`},label:()=>ni(r),subtitle:()=>rm(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(Gl(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Bh(c.waterfall,fr(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Jt(c.vsPar)}}},o),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(E(()=>t.set(this.svc.preset.get()))),this.track(E(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Ot(r)} — ${zl(r)}`}),i=new he({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Ot("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(wi,{chip:{textContent:()=>yc(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(ps(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(wi,{chip:{textContent:()=>_c(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(ps(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(Xf,{name:()=>i.name,count:()=>ee(i.roundCount,be),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(ps(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return xs(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return $t(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Dt({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:jt(t.totals)}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ee(e,be):`${$e(e,0)} of ${ee(t,be)}`}statusLine(){const e=this.svc.extendError.get();return e?`${S.extendProblemPrefix}${e.message}`:this.svc.extending.get()?S.extending:this.svc.budgetSpent()?S.budgetSpent:this.svc.loading.get()?S.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?S.windowEmpty:this.svc.loadedCount()===0?S.noStats:""}}function im(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:Se(e)}function rm(s){const e=[br(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${$e(s.holeCount,0)} holes`),e.join(" · ")}const am=b(`
...
`),cm=b('<li bind="text" class="roundstats__legenditem"></li>');function um(){const s=[];for(const[e,t]of Object.entries(rn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class hm extends H{static styles=`
        .roundstats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${sn}
    `;svc=this.inject(ut);auth=this.inject(D);router=this.inject(j);colors=rs;openHole=new p(null);infoOpen=new p(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(E(()=>{const o=e.get();X(()=>{this.openHole.set(null),o&&this.svc.load(o)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",d=this.wire(am,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":Kn(t()),subtitle:()=>this.subtitle(),score:()=>{const o=t();return o===null?"":Hr(o.strokes,o.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>Q.waterfallHeading,wfHint:()=>Q.waterfallHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:o=>{o.target===o.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>Q.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const o=this.selected();return o===null?"":pp(o)},detailEmpty:()=>{const o=this.selected();return o===null?"":dn(o).length===0?Q.nothingRecordedOnHole:""}});return this.setHeading(d,"stripSec",Q.holeStripHeading),this.$each(this.ref(d,"strip"),()=>t()?.cells??[],(o,c,u)=>this.wireEl(om,{cell:{className:()=>{const f=this.cellNow(o.id)??o;return f.marker===null?"cell":`cell cell--${f.marker}`},"aria-pressed":()=>String(this.openHole.get()===o.id),"aria-label":()=>ri(this.cellNow(o.id)??o),title:()=>ri(this.cellNow(o.id)??o),onclick:()=>this.openHole.set(this.openHole.get()===o.id?null:o.id)},hole:()=>String((this.cellNow(o.id)??o).holeNumber),score:()=>fp(this.cellNow(o.id)??o),tee:{className:()=>(this.cellNow(o.id)??o).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const f=this.cellNow(o.id)??o;return f.tee===null?"":`background:${this.teeColor(f.tee)}`}},gir:{className:()=>{const f=this.cellNow(o.id)??o;return f.gir===null?"cell__gir cell__gir--absent":f.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const f=this.cellNow(o.id)??o;return f.putts===null?"":String(f.putts)},pen:{className:()=>wh(this.cellNow(o.id)??o)?"cell__pen":"cell__pen cell__pen--absent"}},u),o=>o.id),this.$each(this.ref(d,"detailLines"),()=>vp(this.selected()),(o,c,u)=>this.wireEl(lm,{label:()=>o.label,value:()=>o.value},u),o=>o.key),this.$each(this.ref(d,"deltas"),()=>{const o=t();return o===null?[]:de.filter(c=>Ve(o.waterfall,c)!==null)},(o,c,u)=>this.wireEl(dm,{title:()=>Zt(o),sentence:()=>{const f=t();if(f===null||f.deltas===null)return"";const m=Ys(f.deltas,o);return m===null?"":Ar(m,f.windowCount)},value:{textContent:()=>{const f=this.componentValue(o);return f===null?"":Se(f)},style:()=>{const f=this.componentValue(o);return f===null?"":`color:${Ke(ns(f),this.colors)}`}},bar:{innerHTML:()=>{const f=t(),m=this.componentValue(o);return f===null||m===null?"":Rr(m,fr([f.waterfall]),this.colors)}}},u),o=>o),this.$each(this.ref(d,"infoCards"),()=>{const o=t();return o===null?[]:Dt({attributed:o.waterfall.coverage.attributed,holesScored:o.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(c=>xe(o.waterfall,c)),penaltySource:jt(o.panels.totals)})},(o,c,u)=>this.wireEl(ss,{ctitle:()=>o.title,ctext:()=>o.body},u),o=>o.id),this.spawn(jr,this.ref(d,"panels"),{model:()=>t()?.panels??pr}),this.$each(this.ref(d,"legend"),()=>[Q.legendTee,Q.legendGir,Q.legendPutts,Q.legendPenalty,Q.legendAbsence],(o,c,u)=>this.wireEl(cm,{text:()=>o},u),o=>o),d}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Ve(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":hp({...e,title:Kn(e)})}stateLine(){if(this.auth.currentUser.get()===null)return Q.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return Q.loading;case"notFound":return Q.noStatsInRound;case"notAuthorized":return Q.notSignedIn;case"failed":return`${Q.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?Q.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const pm=b(`
    <div class="admin">
...
`),bm={not_started:"Not started",active:"Playing",complete:"Done"},ym={private:"Private",friends:"Friends",link:"Link"};function _m(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function vm(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class wm extends H{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),Am=b('<button bind="chip" class="cd__friendchip" type="button"></button>');class Lm extends H{competitions=this.inject(ze);state=this.inject(ft);render(){const e=()=>this.state.id.get()??"",t=this.wire(Mm,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&zs(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(Hm,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&zs(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(Am,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(d=>d.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const zm={not_started:"Not started",active:"Live",complete:"Finished"},Bm=b(`
    <section class="cd__section">
...
`),Gm=b('<option bind="option"></option>');class jm extends H{competitions=this.inject(ze);state=this.inject(ft);router=this.inject(j);render(){const e=new k(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Bm,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&$m(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(Gm,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(Fm,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>zm[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Dm(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function qm(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const Vm=b(`
    <div>
...
`),Um=b('<button bind="button" type="button"></button>'),Km=b('<th bind="cell"></th>'),Wm=b('<tr bind="row"></tr>'),Ym=b('<td bind="cell"><span bind="value"></span></td>'),Qm=b(`
...
`);class eg extends H{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
    ...
    `;competitions=this.inject(ze);state=this.inject(ft);router=this.inject(j);render(){const e=()=>this.competitions.detail.get();this.track(E(()=>{const n=this.state.id.get();n&&X(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(Zm,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>Dr(this.state.lifecycle.get()),className:()=>qr(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&Ts(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>Ts(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=Ts(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(Om,this.ref(t,"setup")),this.spawn(Lm,this.ref(t,"roster")),this.spawn(jm,this.ref(t,"rounds")),this.spawn(Jm,this.ref(t,"results")),t}}const tg=b(`
    <div class="app-shell">
...
`);class sg extends H{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(j);render(){const e=this.wire(tg,{header:{className:()=>js(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Oc,this.ref(e,"account")),this.spawn(yo,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":zn,"/history":Qc,"/round":Lp,"/create":hf,"/login":yf,"/friends":xf,"/friend":kf,"/friend-rounds":Tf,"/friend-courses":Cf,"/spectate":Mf,"/profile":Bf,"/stats":nm,"/round-stats":hm,"/admin":wm,...Bi.competitions?{"/competitions":Tm,"/competition":eg}:{}},zn),e}}class ng extends D{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await zr(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await pf()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await ff(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await mf();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}U.get(ca);const xi=U.get(j);U.set(D,new ng);const $i=U.get(D);await fa(sg,"#app",{hot:void 0,onInit:async()=>{await $i.load(),$i.currentUser.get()&&xi.route.get()==="/login"&&xi.navigate("/",!0)}});export{Ps as A,H as C,j as R,p as S,ca as T,y as a,rt as b,k as c,ta as d,E as e,ea as n,G as r,b as t};
