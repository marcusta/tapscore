(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const ks="modulepreload",Ss=function(i){return"/tapscore/"+i},ct={},Cs=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let c=function(h){return Promise.all(h.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");n=c(t.map(h=>{if(h=Ss(h),h in ct)return;ct[h]=!0;const f=h.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${m}`))return;const u=document.createElement("link");if(u.rel=f?"stylesheet":ks,f||(u.as="script"),u.crossOrigin="",u.href=h,d&&u.setAttribute("nonce",d),document.head.appendChild(u),f)return new Promise((b,g)=>{u.addEventListener("load",b),u.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return n.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Bt="/tapscore/".replace(/\/+$/,""),Ke=Bt+"/api",Ee={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Is=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Gt(i,e){const t={};for(const[s,n]of Is)if(s in i)for(const r of n)r in i||(t[r]=`var(--${s})`);return{...e,...t,...i}}const qt=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Ts={thin:"1px",medium:"3px",thick:"5px"};function Kt(i){const e=i.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Ts[e.toLowerCase()]??e}function Es(){return qt.map(i=>{const e=Kt(Ee[i]);return`@property --${i}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Vt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Ut={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Ns={...Ut,"done-opacity":"0.35"},Ps={...Vt,...Ut,...Ee,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},zs={...Vt,...Ns,...Ee,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Os{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Wt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const Y=new Os;function Wt(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,Y.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){Y.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,Y.notify(t.subs))})},deps:new Set};s.run()}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}}function N(i){const e={run(){Y.runTracked(e,i)},deps:new Set};return e.run(),()=>{e.disposed=!0,Wt(e)}}function pe(i){Y.batch(i)}function q(i){return Y.untrack(i)}class Rs{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const B=new Rs,ae=Bt;function Ve(i){return ae?i===ae?"/":i.startsWith(ae+"/")?i.slice(ae.length):i:i}function js(i){return ae+i}class A{constructor(){this.route=new p(Ve(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>pe(()=>{this.route.set(Ve(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",o=n>=0?e.slice(0,n):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,h=d>=0?o.slice(d+1):"",f=s.query!==void 0?Ls(s.query):h?"?"+h:"",m=js(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),pe(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const s=this.route.get().split("/"),n={};for(const[r,o]of t.entries())o.startsWith(":")&&(n[o.slice(1)]=s[r]??"");return n})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Ls(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function Ds(i){return e=>i[e]}const As="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ut="data-basics-global";function Ms(){if(document.head.querySelector(`style[${ut}]`))return;const i=document.createElement("style");i.setAttribute(ut,""),i.textContent=Es()+As,document.head.appendChild(i)}function Hs(i,e){Ms();const t=new Set(qt),s=(r,o,d)=>{const c=Object.entries(r).map(([h,f])=>`--${h}:${t.has(h)?Kt(f):f}`).join(";");return`${o}{color-scheme:${d};${c}}`},n=document.createElement("style");return n.textContent=s(i,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(n),r=>`var(--${r})`}const ht="basics-js-theme";class Fs{constructor(){this.dark=new p(!1);const e=localStorage.getItem(ht),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),N(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ht,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(i){const e=document.createElement("template");return e.innerHTML=i,e}function Bs(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const pt=new Set;class z{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!pt.has(t)){pt.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return B.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=q(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){q(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const n=s??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")n(N(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,h]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof h=="function"?o.addEventListener(c.slice(2),h):typeof h=="function"?n(N(()=>{const m=h();f?o.setAttribute(c,String(m)):o[c]=m})):f?o.setAttribute(c,String(h)):o[c]=h}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof z?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(h=>h());d.clear()}),this.track(N(()=>{const c=r(),h=new Map;for(const[m,u]of c.entries()){const b=n(u,m);if(o.has(b))h.set(b,o.get(b));else{const g=[];h.set(b,q(()=>s(u,m,x=>g.push(x)))),d.set(b,g)}}for(const[m,u]of o)h.has(m)||(u.remove(),q(()=>d.get(m)?.forEach(b=>b())),d.delete(m));let f=e.firstChild;for(const m of h.values())m===f?f=f.nextSibling:e.insertBefore(m,f);o.clear();for(const[m,u]of h)o.set(m,u)}))}$condition(e,t,s,n){let r=null;this.track(N(()=>{r&&(r.remove(),r=null);const o=t.get();r=q(()=>o?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track(N(()=>{if(r){const c=r;r=null,q(()=>c.destroy())}e.textContent="";const o=t.get(),d=s[o]??Bs(o,s)??n;d&&(r=q(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ie=new Set;function Gs(i){return Ie.add(i),()=>Ie.delete(i)}function qs(){for(const i of Array.from(Ie)){Ie.delete(i);try{i()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ks(i,e,t){const s=document.querySelector(e);s.textContent="";const n=B.get(A);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const h=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await Cs(()=>import("./obs-shell.component-LmM9ozN5.js"),[])).ObsShellComponent),r=q(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=q(()=>new i)),q(()=>r.mount(s)),o=f};await h(Ve(location.pathname).startsWith("/_obs")),N(()=>{const f=n.route.get().startsWith("/_obs");f!==o&&h(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,qs(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class K extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Vs=10,ke=[];let Se=[],ce=null;function Us(i){ke.push(i),ke.length>Vs&&ke.shift()}function Yt(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...ke],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Se.push(s),Ws()}function Ws(){ce||(ce=setTimeout(Qt,5e3))}function Qt(){if(ce&&(clearTimeout(ce),ce=null),Se.length===0)return;const i=Se;Se=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ke}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ke}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Qt()});const Ys=3e4,Qs=2,be=new Map,Xt=new WeakMap;function Xs(i){if(i instanceof K)return i.traceId;if(i!=null&&typeof i=="object")return Xt.get(i)}async function y(i){if(i.method==="GET"){const e=be.get(i.url);if(e)return e;const t=mt(i,Qs);return be.set(i.url,t),t.then(()=>be.delete(i.url),()=>be.delete(i.url)),t}return mt(i,0)}async function mt(i,e){const t=i.timeout??Ys;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Zs(Js(i,r),t)}catch(o){if(s=o,!(o instanceof K)&&o!=null&&typeof o=="object"&&Xt.set(o,r),o instanceof K||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function Js(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(Us({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const o=await n.json().catch(()=>({error:n.statusText}));throw new K(n.status,o.error??n.statusText,o.details,r)}return n.json()}function Zs(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}const Ue=new Set;let je=!1;function en(i){return Ue.add(i),()=>{Ue.delete(i)}}function tn(){if(!je){je=!0;try{for(const i of[...Ue])try{i()}catch(e){try{Yt("session-listener",sn(e))}catch{}}}finally{je=!1}}}function sn(i){try{if(i instanceof Error){const e=i.message;if(typeof e=="string")return e}return String(i)}catch{return"listener threw a value that could not be described"}}async function j(i,e,t,s={}){pe(()=>{i.set(!0),e.set(null)});try{const n=await t();return i.set(!1),n}catch(n){const r=nn(n);pe(()=>{i.set(!1),e.set(r)}),Yt(r.code,r.message,Xs(n)),r.code==="auth"&&s.sessionExpiry!==!1&&tn();return}}function nn(i){return i instanceof K?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:i.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const ft={sessionExpiry:!1};function rn(i){return{me:()=>y({method:"GET",url:`${i}/auth/me`}),login:e=>y({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${i}/auth/logout`,body:{}})}}class H{constructor(){this.api=rn(Ke),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=en(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Gs(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await j(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await j(this.loading,this.error,()=>this.api.login({username:e,password:t}),ft);return s?(this.currentUser.set(s),!0):!1}async logout(){await j(this.loading,this.error,()=>this.api.logout(),ft);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Jt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},on={...Jt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},an={...Jt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},ln=Gt(on,Ps),dn=Gt(an,zs),a=Hs(ln,dn),E=i=>`var(--${i})`,$=(i,e)=>`var(--${i}, ${e})`,k=i=>{const e=Ee[i];if(e===void 0)throw new Error(`unknown control token: --${i}`);return e},l=Ds({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ye=i=>`
    ...
    cursor: not-allowed;`,cn={primary:ye("primary"),secondary:ye("secondary"),ghost:ye("ghost"),danger:ye("danger"),disabled:Zt},I=(i=$("btn-radius",k("btn-radius")),e="secondary")=>`
    /*
    ...
    ${cn[e]}
    &:disabled {${Zt}}
`,un=`max(${$("field-border-width",k("field-border-width"))}, ${$("field-rule-width",k("field-rule-width"))})`,_e=(i,e)=>`
    border-top-color: ${i};
    ...
    border-bottom-width: ${un};
    ${_e($("field-border",k("field-border")),$("field-rule",k("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${_e($("field-focus-border",k("field-focus-border")),$("field-focus-border",k("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${_e($("field-invalid-border",k("field-invalid-border")),$("field-invalid-rule",k("field-invalid-rule")))}
    }
...
`);class Vn extends z{static styles=`
        .tabbar {
            display: flex;
    ...
    `;router=this.inject(A);auth=this.inject(H);landing=this.inject(Pe);newCount=new S(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(qn,{root:{className:()=>Gn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"}}),t=Fn(ss);return this.$each(this.ref(e,"root"),()=>t,(s,n,r)=>this.wireEl(Kn,{link:{...this.router.link(s.href),href:s.href},icon:{innerHTML:()=>s.icon},label:()=>s.label,badge:{textContent:()=>{if(s.key!=="home")return"";const o=this.newCount.get();return o===0?"":String(o)},className:()=>(s.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},r),s=>s.key),e}}class ze{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await j(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list()]));if(!t)return;const[s,n,r]=t;this.player.set(s),this.history.set(n),this.clubs.set(r)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null)}async saveIndex(e){return await j(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveGender(e){const t=await j(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await j(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function De(i,e){return i.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function nt(i,e="frecency"){return e==="alpha"?[...i].sort(De):[...i].sort((t,s)=>{const n=t.frecency,r=s.frecency,o=n>0,d=r>0;if(o!==d)return o?-1:1;if(!o)return De(t,s);if(r!==n)return r-n;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,h=s.lastPlayedAt?Date.parse(s.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(h)?Number.NEGATIVE_INFINITY:h;return m!==f?m-f:De(t,s)})}const Un=1440*60*1e3;function Wn(i,e){if(!i)return null;const t=Date.parse(i),s=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(s))return null;const n=Math.floor((s-t)/Un);if(n<=0)return"today";if(n===1)return"yesterday";if(n<7)return`${n} days ago`;if(n<14)return"last week";if(n<30)return`${Math.floor(n/7)} weeks ago`;if(n<60)return"last month";if(n<365)return`${Math.floor(n/30)} months ago`;const r=Math.floor(n/365);return r===1?"last year":`${r} years ago`}function Yn(i,e){if(i.sharedRoundCount<=0)return"never played";const t=Wn(i.lastPlayedAt,e),s=`played ${i.sharedRoundCount}×`;return t?`${s}, ${t}`:s}const is=2;function yt(i){return i.trim().length>=is}function rs(i){return nt(i,"frecency")}function Qn(i,e){return rs([...i.filter(t=>t.id!==e.id),e])}function Xn(i,e){return i.filter(t=>t.id!==e)}function _t(i,e,t){return i.map(s=>s.id===e?{...s,isFriend:t}:s)}function Jn(i,e,t=()=>{},s=300){let n=0,r;return o=>{const d=o.trim(),c=++n;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<is){e(d,[]);return}r=setTimeout(()=>{i(d).then(h=>{c===n&&e(d,h)},h=>{c===n&&t(d,h)})},s)}}const os=Ne("tapscore.friends.sort.v1",{decode:i=>i==="alpha"?"alpha":"frecency",encode:i=>i,empty:"frecency"});function Zn(i=G()){return os.read(i)}function ei(i,e=G()){os.write(i,e)}class Oe{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(Zn());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Jn(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await j(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(rs(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await j(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(Qn(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,sharedRoundCount:0,lastPlayedAt:null,frecency:0})),this.results.set(_t(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),ei(e)}async remove(e){await j(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(Xn(this.friends.get(),e)),this.results.set(_t(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class as{roles=new p([]);rolesLoaded=!1;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}async loadRoles(e=!1){if(!(!e&&this.rolesLoaded)){this.rolesLoaded=!0;try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}}}clear(){this.roles.set([]),this.rolesLoaded=!1,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await j(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[s,n,r]=t;this.stats.set(s),this.rounds.set(n),this.players.set(r)}}async function ti(i){await i.auth.logout(),i.profile.clear(),i.friends.clear(),i.admins.clear(),i.landing.clear(),i.navigate("/")}function si(i){if(!i.signedIn)return[];const e=[{kind:"identity",displayName:(i.displayName??"").trim()||(i.username??"").trim()||"Signed in",username:(i.username??"").trim()},{kind:"profile",label:"Profile"}];return i.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e}function ni(i){return si(i).map(e=>e.kind)}function vt(i){return i.signedIn?"avatar":"signin"}function ii(i,e){const t=(i??"").trim().split(/\s+/).filter(n=>n.length>0);if(t.length>=2)return(ve(t[0])+ve(t[t.length-1])).toUpperCase();if(t.length===1)return ve(t[0]).toUpperCase();const s=(e??"").trim();return s.length>0?ve(s).toUpperCase():"•"}function ve(i){return[...i][0]??""}const ri=_(`
...
`);class oi extends z{static styles=`
        .acct {
            position: relative;
            display: flex;
    ...
    `;auth=this.inject(H);profile=this.inject(ze);friends=this.inject(Oe);admins=this.inject(as);landing=this.inject(Pe);router=this.inject(A);open=new p(!1);state=new S(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));has(e){return ni(this.state.get()).includes(e)}rowClass(e,t=""){const s=`acct__row${t}`;return this.has(e)?s:`${s} hidden`}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(ri,{signin:{className:()=>vt(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},avatar:{className:()=>vt(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden",textContent:()=>{const h=this.state.get();return ii(h.displayName,h.username)},"aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const h=this.state.get();return(h.displayName??"").trim()||(h.username??"").trim()||"Signed in"},idUser:()=>{const h=(this.state.get().username??"").trim();return h===""?"":`@${h}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:async()=>{this.open.set(!1),await ti({auth:this.auth,profile:this.profile,friends:this.friends,admins:this.admins,landing:this.landing,navigate:h=>this.router.navigate(h)})}}}),t=this.ref(e,"root"),s=e.querySelector('[bind="avatar"]'),n=h=>{h.key==="Escape"&&this.open.get()&&(this.open.set(!1),s?.focus())},r=h=>{if(!this.open.get())return;const f=h.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let o=!1;const d=()=>{o||(o=!0,window.addEventListener("keydown",n),document.addEventListener("pointerdown",r,!0))},c=()=>{o&&(o=!1,window.removeEventListener("keydown",n),document.removeEventListener("pointerdown",r,!0))};return this.track(N(()=>{this.open.get()?d():c()})),this.track(c),e}}const lt=class lt extends z{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(N(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};lt.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let U=dt;function ai(i){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function ie(){return ai()}const Ce=10;class me{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await j(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=ie()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=ie()){return e.labels?.[t]??e.labels?.en??""}presets(e=ie()){return this.descriptors.get().filter(s=>s.preset).sort((s,n)=>{const r=s.preset?.rank??Number.POSITIVE_INFINITY,o=n.preset?.rank??Number.POSITIVE_INFINITY;return r!==o?r-o:(this.labelOf(s,e)??s.id).localeCompare(this.labelOf(n,e)??n.id)})}taglineOf(e,t=ie()){const n=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return n?.[t]??n?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{},n=s.teamCount??{};return{count:{min:n.min??2,...n.max!==void 0?{max:n.max}:{}},size:{min:s.teamSize?.min??2,max:s.teamSize?.max??2}}}if(t.slotBallCount){const s=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:s?Ce:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function ls(i){const e=B.get(me);return e.load(),e.labelOf(i.formatId)??`${i.scoringMode} · ${i.teamShape}`}function li(i){return i.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:En(e)||null,date:e.round.date,formats:e.round.formatSlots.map(ls).join(" · ")}))}function di(i){return i.map(e=>({key:e.token,token:e.token,roundId:null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:null,formats:null}))}const ue={fromMyRounds:li,fromDeviceRounds:di},ci=14,ui=1440*60*1e3;function oe(i,e){return e(i)}function hi(i,e,t,s=ci){const n=e-s*ui,r=[],o=[];for(const d of i){const c=oe(d,t);if(c.status==="complete"){const h=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(h)||h>=n)&&o.push(d)}else r.push(d)}return r.sort((d,c)=>wt(oe(d,t).lastActivityAt,oe(c,t).lastActivityAt)),o.sort((d,c)=>wt(oe(d,t).completedAt,oe(c,t).completedAt)),{ongoing:r,finished:o}}function wt(i,e){const t=i?Date.parse(i):NaN,s=e?Date.parse(e):NaN,n=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return n===r?0:r-n}const pi=_(`
    <div class="landing">
...
`),mi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',fi=_(`
    <div class="round-row">
...
`),ds={not_started:"Not started",active:"Live",complete:"Finished"};class xt extends z{static styles=`
        .landing {
...
`),yi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',_i=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${yi}</button>
    </div>
`);class vi extends z{static styles=`
        .history {
    ...
    `;svc=this.inject(Pe);auth=this.inject(H);router=this.inject(A);loggedIn=new S(()=>this.auth.currentUser.get()!==null);rows=new S(()=>gi(this.loggedIn.get()?ue.fromMyRounds(this.svc.myRounds.get()):ue.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(bi,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(s,n,r)=>this.roundRow(s,r),s=>s.key),this.spawn(U,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const s=this.deleteTarget.get();return`Delete ${s?`“${s.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const s=this.deleteTarget.get();s&&this.svc.remove(s.token,s.roundId)}});const t=s=>{s.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(_i,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},course:()=>e.courseName||"Round",role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>ds[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>e.date??"",formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",e.courseName||"this round")}}},t)}}function cs(i){return i.handicapIndex*(i.slope/113)+(i.courseRating-i.par)}function wi(i){return Math.round(cs(i))}function xi(i,e,t){const s=t;if(s<=0)return 0;if(i>=0){const c=Math.floor(i/s),h=i-c*s;return c+(e>=1&&e<=h?1:0)}const n=-i,r=Math.floor(n/s),o=n-r*s,d=r+(e>s-o?1:0);return d===0?0:-d}const $i=180,kt=4,ki=12;function re(i,e){return e<=0?0:Math.max(0,Math.min(e-1,i))}function Si(i){const{dragDistance:e,velocity:t,itemWidth:s}=i;if(Math.abs(e)<ki)return 0;const n=e+t*$i,r=Math.round(-n/s);return Math.max(-kt,Math.min(kt,r))}const St="tapscore:pending-scores:v1",Ci=336*60*60*1e3,Ct=200;function Ii(){try{return globalThis.localStorage??null}catch{return null}}function Ti(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Ei{entries=[];storage;constructor(e=Ii(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=Ci);return t.length>Ct?t.slice(t.length-Ct):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(St);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ti):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(St,JSON.stringify(this.entries))}catch{}}}const Ni=50;function Pi(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.cursor=="string"}const it=Ne("tapscore.result-cursors.v1",Je(Pi),Ni);function rt(i=G()){return it.read(i)}function zi(i,e=G()){return rt(e).find(t=>t.token===i)?.cursor??null}function Oi(i,e,t=G()){if(!t)return[];const s=rt(t).filter(n=>n.token!==i);return it.write([{token:i,cursor:e},...s],t)}function Ri(i,e=G()){if(!e)return[];const t=rt(e),s=t.filter(n=>n.token!==i);return s.length!==t.length&&it.write(s,e),s}const ji=["1st","2nd","3rd","4th","5th","6th","7th","8th"],J=(i,e)=>`${i}|${e}`;function us(i){return i.players.map(e=>e.displayName).join(" & ")||i.label||"Ball"}function Li(i,e,t){return i?!(i.minPar!==void 0&&e<i.minPar||i.maxPar!==void 0&&e>i.maxPar||i.pars&&!i.pars.includes(e)||i.holes&&!i.holes.includes(t)):!0}class se{constructor(e=new Ei){this.queue=e}queue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);scorecards=new p([]);cells=new p(new Map);result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const n=++this.loadSeq;s&&this.resetForNewToken(t),B.get(me).load();const r=await j(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||n!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),le({token:e,courseName:r.round.courseNameSnapshot??"",status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),B.get(H).currentUser.get()&&On(r.round.id),this.pendingSlotIndex!==null){const h=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,h!==null&&this.selectedSlot.set(h)}const[o,d]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[])]);n!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(o),await this.flushPending())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),ts(e);const t=this.round.get()?.id;return t&&es(t),Ri(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:t.completedAt}),le({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:null}),le({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await j(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,s=this.loadSeq;let n;try{n=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||s!==this.loadSeq||e!==this.token||this.scorecards.set(n)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,s=this.loadSeq,n=()=>t!==this.quietSeq||s!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(n())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const o=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(o===null||n())return;this.balls.set(o)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?zi(e):null}setResultCursor(e,t){const s=t!==null&&t!==this.resultCursor;this.resultCursor=t,s&&Oi(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}onLiveResultEvent(e){const t=this.token,s=this.round.get();if(t&&s&&e.status!==s.status){const n=e.status==="complete"?new Date().toISOString():null;this.round.set({...s,status:e.status,completedAt:n}),le({token:t,courseName:s.courseNameSnapshot??"",status:e.status,completedAt:n,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new S(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,us(t));for(const t of this.result.get()?.slots??[])for(const s of t.subjectLabels??[])e.set(s.ballId,s.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new S(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,n)=>{for(const r of s.ballIds)e.set(r,`Group ${n+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return re(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(o=>o.id===e);if(!t||!s)return"";const n=t.playHoles.filter(o=>o.courseHoleNumber===s.courseHoleNumber).sort((o,d)=>o.ordinal-d.ordinal);if(n.length===1)return`${s.courseHoleNumber}`;const r=n.findIndex(o=>o.id===e);return`${s.courseHoleNumber} (${ji[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(re(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(re(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(J(e,t));return s?s.strokes:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(J(e,t))?.status??null}strokesHintFor(e,t){const s=this.round.get();if(!s)return null;const n=this.balls.get().find(m=>m.id===e);if(!n||n.pending)return null;const r=this.selectedSlotDefId(),d=(n.slots.find(m=>m.slotDefId===r)??n.slots[0])?.playingHandicap;if(d==null)return null;const c=this.playHoleById(t);if(!c)return null;const h=n.players[0]?.teeName??null,f=c.tees.find(m=>m.teeName===h)?.strokeIndex??c.baseStrokeIndex;return xi(d,f,s.routeSi.allocationCycleSize)}metadataFor(e,t,s){const n=this.cells.get().get(J(e,t));return n&&n.metadata!==void 0?n.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=B.get(me),t=this.round.get()?.formatSlots??[],s=[],n=new Set;for(const r of t){const o=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of o)n.has(d.key)||(n.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Li(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,n){const r=J(e,t),o=crypto.randomUUID();this.patchCell(r,{strokes:s,metadata:n,status:"saving",clientEventId:o});const d=this.token;d&&(this.enqueue(d,e,t,s,n,o),await this.post(d,e,t,s,n,o))}async retry(e,t){const s=J(e,t),n=this.cells.get().get(s);if(!n)return;this.patchCell(s,{...n,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,n.strokes,n.metadata,n.clientEventId),await this.post(r,e,t,n.strokes,n.metadata,n.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(J(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,n,r,o){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:o,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,s,n,r,o){const d=J(t,s);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:o,...r!=null?{metadata:r}:{}}),this.queue.remove(o);const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"saved"});const h=this.round.get();e===this.token&&h&&h.status==="not_started"&&this.round.set({...h,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1);const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const Di=700;function Ai(i){if(!i.currentHole)return!1;const e=i.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function Mi(i){return i.currentHole?i.balls.some((e,t)=>t!==i.currentBallIndex&&!e.scored):!1}function Ae(i){const e=i.currentHole;if(!e)return{kind:"noop"};const t=i.balls,s=i.currentBallIndex;for(let n=s+1;n<t.length;n++)if(!t[n].scored)return{kind:"moveToBall",ballIndex:n};for(let n=0;n<s;n++)if(!t[n].scored)return{kind:"moveToBall",ballIndex:n};return i.holeIndex>=i.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:i.holeIndex+1,delayMs:Di}}function Hi(i,e){const t=i.currentHole;if(e.kind==="statsDone")return i.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Ae(i)};const s=i.balls[i.currentBallIndex];if(!t||!s)return{write:null,move:{kind:"noop"}};if(s.pending)return i.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Ae(i)};const n={ballIndex:i.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&i.collectsStats?{write:n,move:{kind:"openStats"}}:i.holeCompleteOnEntry?{write:n,move:{kind:"stay"}}:{write:n,move:Ae(i)}}const Z=60,It=8,Ye=4,Fi=Array.from({length:Ye*2+1},(i,e)=>e-Ye),Bi="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Gi=_(`
...
`);class Ui extends z{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
...
</tr>`;if(!R||!C)return`<tr class="${b.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${P(b.name)}</span>${x}</span></td>${O}
  <td class="lb-rank__disclosure"></td>
</tr>`;const D=Qe(s.plan.slotDefId,R.ballIds),F=s.isOpen(D),X=gr(D),$s=bs(C,s.routeSections,e,{mode:s.mode??"product"}),Re=["lb-rank__row--expandable"];return b.lead&&Re.push("lb-rank__lead"),F&&Re.push("lb-rank__row--open"),`<tr class="${Re.join(" ")}" data-expand-key="${P(D)}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${F}" aria-controls="${P(X)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${P(b.name)}</span>${x}</span></button></td>${O}
...
<tr class="lb-rank__panel${F?" lb-rank__panel--open":""}" data-panel-key="${P(D)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${P(X)}"><div class="lb-rank__panelbox">${$s}</div></div></td>
</tr>`}).join(""),h=r?`
      <col class="lb-rank__col-pace">`:"",f=r?'<th class="lb-rank__pace">Pace</th>':"",m=o?`
      <col class="lb-rank__col-disclosure">`:"",u=o?'<th class="lb-rank__disclosure" aria-label="Scorecard"></th>':"";return`<div class="lb-section">
  ...
  <table class="lb-rank">
    ...
    <thead><tr><th class="lb-rank__pos">#</th><th class="lb-rank__who">Player</th><th class="lb-rank__total">Total</th>${f}<th class="lb-rank__thru">Thru</th>${u}</tr></thead>
    <tbody>${c}</tbody>
  </table>
</div>`}function yr(i,e){const t=nr(i,e),s=t.matches.map(n=>{const r=n.leader==="a"?" lb-mp__team--lead":"",o=n.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const _r={ranked:br,match_summary:(i,e)=>yr(i,e)},vr={"default-score-grid":hr,"compact-match-grid":pr,"category-matrix-grid":mr};function wr(i){return`<div class="lb-diag">Unrenderable result section <code>${P(i)}</code> — no generic view yet. Results are not hidden.</div>`}function xr(i){return`<div class="lb-diag">Unsupported score-grid component <code>${P(i)}</code> — no generic view yet. Results are not hidden.</div>`}function $r(i,e,t,s=null){const n=_r[i.kind];return n?n(i,e,t,s):wr(i.kind)}function bs(i,e,t,s){const n=ps(i),r=vr[n];return r?r(i,e,t,s):xr(n)}function kr(i,e,t=gs,s=null){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${P(i.formatLabel)}.</div>`:i.leaderboard.map(r=>$r(r,e,t,s&&r===s.plan.rankedSection?s:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${P(i.formatLabel)}.</div>`}function Sr(i,e,t,s={}){if(i.length===0)return"";const n=s.mode??"product";return i.map(r=>bs(r,e,t,{mode:n})).join(`
`)}const Cr=_(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class Ir extends z{static styles=`
        .lb {
    ...
    `;svc=this.inject(se);expansion=new or;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Cr,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const s=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(s))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const s=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(s)&&(this.applyOpen(t,this.expansion.set(s,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const s=e.nextElementSibling;s?.classList.contains("lb-rank__panel")&&s.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=h=>{const f=this.svc.nameOf(h);return this.svc.isPending(h)?`${f} (open seat)`:f},n=h=>this.svc.groupLabelOf(h),r=rr(t);this.expansion.retain(r.attached.keys());const o=kr(t,s,n,{plan:r,routeSections:e.routeSections,isOpen:h=>this.expansion.isOpen(h)}),d=Sr(r.standalone,e.routeSections,s),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return o+c}}function Tr(i,e){if(!e)return[];const t=[],s=new Set;for(const n of i)for(const r of n.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Er=_(`
...
`);class Pr extends z{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
    ...
    `,he.seq=0;let W=he;function Or(i){if(!i)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=i.seats.length>0,t=i.claimedSeats.some(r=>r.viewerMayRelease),s=i.viewer.claimSeat.allowed,n=i.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&n,blockedMessage:e&&!s&&!n?i.viewer.claimSeat.message??i.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Rr(i,e){const t=[];if(i.groupId!==null&&e.length>0){const s=e.findIndex(n=>n.id===i.groupId);if(s>=0){t.push(`Group ${s+1}`);const n=e[s].startTime;n.includes(":")&&t.push(n)}}return i.category!==null&&t.push(i.category),t.join(" · ")}function jr(i){return(i?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Lr=_(`
...
`);class Mr extends z{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
...
`);class qr extends z{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
...
`);class Ur extends z{static styles=`
...
`),no=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),io=_('<button bind="pill" class="round-view__grp" type="button"></button>');class ro extends z{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Eo extends z{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class Ro extends z{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function Mt(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Ao extends z{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject(Oe);auth=this.inject(H);router=this.inject(A);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(jo,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:n=>this.svc.setQuery(n.target.value)},searchHint:{textContent:()=>{const n=this.svc.query.get().trim();return n.length>0&&!yt(n)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const n=this.svc.query.get().trim();return yt(n)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===n&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(n,r,o)=>this.wireEl(Lo,{initials:()=>Mt(n.displayName),name:()=>n.displayName,username:()=>n.homeClubName?`@${n.username} · ${n.homeClubName}`:`@${n.username}`,hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(n.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const d=this.svc.results.get().find(c=>c.id===n.id);d&&!d.isFriend&&this.svc.add(d)}},added:{className:()=>this.isFriendNow(n.id)?"friend-row__added":"friend-row__added hidden"}},o),n=>n.id);const s=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>nt(this.svc.friends.get(),this.svc.sortMode.get()),(n,r,o)=>this.wireEl(Do,{initials:()=>Mt(n.displayName),name:()=>n.displayName,subtitle:()=>{const d=this.svc.friends.get().find(c=>c.id===n.id)??n;return Yn(d,s)},hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(n.id)}}},o),n=>n.id),t}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Mo=_(`
    <div class="profile">
...
`);class Fo extends z{static styles=`
        .profile {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),Vo={not_started:"Not started",active:"Playing",complete:"Done"};function Uo(i){const e=[`${i.participants.length} players`,`${i.scoreEventCount} scores`];return i.lastEventAt?e.push(`last ${i.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Wo(i){const e=[`@${i.username}`,`${i.roundCount} rounds`];return i.lastRoundDate&&e.push(`last ${i.lastRoundDate}`),i.handicapIndex!==null&&e.push(`hcp ${i.handicapIndex}`),i.deletedAt&&e.push("DELETED"),e.join(" · ")}class Yo extends z{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class ea extends z{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),ca=_('<button bind="chip" class="cd__friendchip" type="button"></button>');class ua extends z{competitions=this.inject(ne);state=this.inject(ge);render(){const e=()=>this.state.id.get()??"",t=this.wire(la,{count:()=>{const s=this.competitions.participants.get().length;return s===0?"":String(s)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&Xe(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:s=>{s.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:s=>this.state.guestNameDraft.set(s.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:s=>this.state.guestGenderDraft.set(s.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:s=>this.state.guestHcpDraft.set(s.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(s,n,r)=>this.wireEl(da,{name:()=>s.displayNameSnapshot,category:{textContent:()=>s.category??"",className:()=>s.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>s.withdrawnAt?"Withdrawn":s.cutAfterRound!==null?`Cut R${s.cutAfterRound}`:"",className:()=>s.withdrawnAt||s.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!s.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),s.id)}},remove:{className:()=>this.state.admin.get()&&Xe(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),s.id)}}},r),s=>JSON.stringify({id:s.id,name:s.displayNameSnapshot,category:s.category,withdrawnAt:s.withdrawnAt,cutAfterRound:s.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(s,n,r)=>this.wireEl(ca,{chip:{textContent:()=>s.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(o=>o.playerId===s.id),onclick:()=>{this.competitions.addPlayer(e(),s.id,null)}}},r),s=>s.id),t}}const ha={not_started:"Not started",active:"Live",complete:"Finished"},pa=_(`
    <section class="cd__section">
...
`),fa=_('<option bind="option"></option>');class ga extends z{competitions=this.inject(ne);state=this.inject(ge);router=this.inject(A);render(){const e=new S(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(pa,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Xo(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,r)=>this.wireEl(fa,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,r)=>this.wireEl(ma,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>ha[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function ba(i,e,t){return JSON.stringify({entry:i,points:e,columns:t})}function ya(i){return i.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const _a=_(`
    <div>
...
`),va=_('<button bind="button" type="button"></button>'),wa=_('<th bind="cell"></th>'),xa=_('<tr bind="row"></tr>'),$a=_('<td bind="cell"><span bind="value"></span></td>'),ka=_(`
...
`),Sa=_('<span bind="part"><span bind="separator"></span><span bind="value"></span></span>');class Ca extends z{competitions=this.inject(ne);state=this.inject(ge);render(){const e=new S(()=>{if(this.state.lifecycle.get()!=="finalized")return(this.competitions.board.get()?.view.entries??[]).map(m=>({entry:m,points:null}));const h=this.competitions.results.get()?.resultSets??[],f=Math.min(this.state.resultSetIndex.get(),h.length-1);return(h[f]?.entries??[]).map(m=>({entry:m.entry,points:m.points}))}),t=new S(()=>{const h=this.competitions.board.get()?.view.rounds??[];if(h.length>0)return h;const f=new Set;for(const m of e.get())for(const u of m.entry.rounds)f.add(u.roundNumber);return[...f].sort((m,u)=>m-u).map(m=>({roundNumber:m,postCut:!1}))}),s=()=>this.state.lifecycle.get()==="finalized",n=()=>s()?(this.competitions.results.get()?.resultSets.length??0)>0:this.competitions.board.get()!==null,r=()=>this.state.cutOutcome.get(),o=h=>h.length===0?"—":h.map(f=>f.displayName).join(", "),d=this.wire(_a,{admin:{className:()=>this.state.admin.get()&&this.state.lifecycle.get()==="active"?"cd__section cd__admin":"cd__section cd__admin hidden"},cutOutcome:{className:()=>r()?"cd__cutoutcome":"cd__cutoutcome hidden"},advancedLabel:()=>`Advanced (${r()?.advanced.length??0}):`,advanced:()=>o(r()?.advanced??[]),cutLabel:()=>`Cut (${r()?.cut.length??0}):`,cut:()=>o(r()?.cut??[]),applyCut:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.cutConfirmOpen.set(!0)},finalize:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.finalizeConfirmOpen.set(!0)},title:()=>s()?"Official results":"Leaderboard",board:{className:()=>s()?"cd__board cb cb--official":"cd__board"},official:{textContent:()=>{const h=this.competitions.results.get()?.finalizedAt.slice(0,10)??"";return s()&&h?`Official results · finalized ${h}`:""},className:()=>s()?"cd__official-banner":"cd__official-banner hidden"},boardHead:{className:()=>s()?"cb-head hidden":"cb-head"},metric:()=>this.competitions.board.get()?.view.metricLabel??"",operator:()=>{const h=this.competitions.board.get();return h?h.view.operator.kind==="best_n"?`Best ${h.view.operator.n} of ${h.view.rounds.length}`:"Total across rounds":""},defaulted:{className:()=>this.competitions.board.get()?.defaulted?"cb-head__hint":"cb-head__hint hidden"},empty:{className:()=>n()&&e.get().length===0?"cb-empty":"cb-empty hidden"},table:{className:()=>n()&&e.get().length>0?"cb":"cb hidden"},refusal:{textContent:()=>s()?this.competitions.resultsRefusal.get()??"":this.competitions.board.get()===null?this.competitions.boardRefusal.get()??"":""}}),c=new S(()=>[{text:"#",className:"cb-pos"},{text:"Player",className:"cb-who"},...t.get().map((h,f,m)=>({text:`R${h.roundNumber}`,className:`cb-c${h.postCut&&!m.slice(0,f).some(u=>u.postCut)?" cb-c--divider":""}`})),{text:"Total",className:"cb-total"},...s()?[{text:"Pts",className:"cb-points"}]:[]]);return this.$each(this.ref(d,"headers"),c,(h,f,m)=>this.wireEl(wa,{cell:{textContent:()=>h.text,className:()=>h.className}},m),h=>`${h.text}:${h.className}`),this.$each(this.ref(d,"rows"),e,(h,f,m)=>this.boardRow(h,t.get(),m),h=>ba(h.entry,h.points,t.get())),this.$each(this.ref(d,"switcher"),new S(()=>s()?this.competitions.results.get()?.resultSets??[]:[]),(h,f,m)=>this.wireEl(va,{button:{textContent:()=>h.scoringType.toUpperCase(),className:()=>this.state.resultSetIndex.get()===f?"on":"",onclick:()=>this.state.resultSetIndex.set(f)}},m),h=>h.scoringType),this.spawn(U,this.ref(d,"cutConfirm"),{open:this.state.cutConfirmOpen,title:"Apply cut?",message:"This evaluates the configured cut against the current aggregate and marks who advances. Cut players are left out of later rounds.",confirmLabel:"Apply cut",cancelLabel:"Cancel",onconfirm:async()=>{const h=await this.competitions.applyCut(this.state.id.get()??"");h.ok&&this.state.cutOutcome.set(h.outcome)}}),this.spawn(U,this.ref(d,"finalizeConfirm"),{open:this.state.finalizeConfirmOpen,title:"Finalize competition?",message:"Finalizing freezes the official results and locks the competition. This cannot be undone.",confirmLabel:"Finalize",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.competitions.finalize(this.state.id.get()??"")}}),d}boardRow(e,t,s){const n=e.entry,r=n.withdrawn||n.cutAfterRound!==null,o=["cb-row"];n.withdrawn?o.push("cb-row--withdrawn"):n.cutAfterRound!==null?o.push("cb-row--cut"):n.position===1&&o.push("cb-row--lead"),n.incomplete&&o.push("cb-row--incomplete");const d=t.findIndex(m=>m.postCut),c=new Map(n.rounds.map(m=>[m.roundNumber,m])),h=[{kind:"position",text:r?"—":String(n.position)},{kind:"who",entry:n},...t.map((m,u)=>({kind:"round",cell:c.get(m.roundNumber)??null,divider:u===d})),{kind:"total",text:n.total===null?"—":String(n.total)},...e.points===null?[]:[{kind:"points",text:String(e.points)}]],f=this.wireEl(xa,{row:{className:()=>o.join(" ")}},s);return this.$each(f,new S(()=>h),(m,u,b)=>this.boardCell(m,b),(m,u)=>u),f}boardCell(e,t){if(e.kind==="who")return this.whoCell(e.entry,t);const s=e.kind==="position"?"cb-pos":e.kind==="total"?"cb-total":e.kind==="points"?"cb-points":`cb-c cb-c--${e.cell?.status??"missing"}${e.divider?" cb-c--divider":""}`,n=e.kind==="round"?e.cell?.value===null||!e.cell?"—":String(e.cell.value):e.text;return this.wireEl($a,{cell:{className:()=>s},value:{textContent:()=>n,className:()=>e.kind==="round"&&e.cell?.status==="dropped"?"cb-struck":""}},t)}whoCell(e,t){const s=e.withdrawn?"WD":e.cutAfterRound!==null?`Cut R${e.cutAfterRound}`:"",n=ya(e),r=this.wireEl(ka,{cell:{},name:()=>e.displayName,category:{textContent:()=>e.category??"",className:()=>e.category?"cb-tag cb-cat":"cb-tag cb-cat hidden"},status:{textContent:()=>s,className:()=>s?"cb-tag cb-tag--out":"cb-tag cb-tag--out hidden"},equals:{className:()=>n.length===0?"hidden":""},total:()=>e.total===null?"—":String(e.total)},t);return this.$each(r.querySelector('[bind="parts"]'),new S(()=>n),(o,d,c)=>this.wireEl(Sa,{separator:()=>d===0?"":" + ",value:{textContent:()=>o.text,className:()=>o.dropped?"cb-struck":""}},c),(o,d)=>d),r}}const Ia=_(`
    <div class="cd">
...
`);class Ta extends z{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class Na extends z{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(A);render(){const e=this.wire(Ea,{header:{className:()=>ns(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(oi,this.ref(e,"account")),this.spawn(Vn,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":xt,"/history":vi,"/round":ro,"/create":Eo,"/login":Ro,"/friends":Ao,"/profile":Fo,"/admin":Yo,...ss.competitions?{"/competitions":ea,"/competition":Ta}:{}},xt),e}}class Pa extends H{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await vs(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await No()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Po(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}B.get(Fs);const Ht=B.get(A);B.set(H,new Pa);const Ft=B.get(H);await Ks(Na,"#app",{hot:void 0,onInit:async()=>{await Ft.load(),Ft.currentUser.get()&&Ht.route.get()==="/login"&&Ht.navigate("/",!0)}});export{Ke as A,z as C,A as R,p as S,Fs as T,y as a,pe as b,S as c,zs as d,N as e,Ps as n,j as r,_ as t};
