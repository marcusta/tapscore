(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const a of i.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Yt="modulepreload",Qt=function(r){return"/tapscore/"+r},qe={},Xt=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=a?.nonce||a?.getAttribute("nonce");n=c(t.map(u=>{if(u=Qt(u),u in qe)return;qe[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Yt,f||(h.as="script"),h.crossOrigin="",h.href=u,d&&h.setAttribute("nonce",d),document.head.appendChild(h),f)return new Promise((y,b)=>{h.addEventListener("load",y),h.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${u}`)))})}))}function i(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return n.then(a=>{for(const d of a||[])d.status==="rejected"&&i(d.reason);return e().catch(i)})};class Jt{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){_t(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const W=new Jt;function _t(r){for(const e of r.deps)e.delete(r);r.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,W.notify(this.subs))}update(e){this.set(e(this.val))}}class w{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){W.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,W.notify(t.subs))})},deps:new Set};s.run()}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}}function k(r){const e={run(){W.runTracked(e,r)},deps:new Set};return e.run(),()=>_t(e)}function de(r){W.batch(r)}function V(r){return W.untrack(r)}class Zt{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const z=new Zt,oe="/tapscore/".replace(/\/+$/,"");function Ee(r){return oe?r===oe?"/":r.startsWith(oe+"/")?r.slice(oe.length):r:r}function es(r){return oe+r}class N{constructor(){this.route=new p(Ee(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>de(()=>{this.route.set(Ee(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),i=n>=0?e.slice(n):"",a=n>=0?e.slice(0,n):e,d=a.indexOf("?"),c=d>=0?a.slice(0,d):a,u=d>=0?a.slice(d+1):"",f=s.query!==void 0?ts(s.query):u?"?"+u:"",m=es(c)+f+i;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),de(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new w(()=>{const s=this.route.get().split("/"),n={};for(const[i,a]of t.entries())a.startsWith(":")&&(n[a.slice(1)]=s[i]??"");return n})}query(e){return new w(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new w(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function ts(r){const e=new URLSearchParams;for(const[s,n]of Object.entries(r))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function ss(r){return e=>r[e]}function ns(r,e){const t=(n,i,a)=>{const d=Object.entries(n).map(([c,u])=>`--${c}:${u}`).join(";");return`${i}{color-scheme:${a};${d}}`},s=document.createElement("style");return s.textContent=t(r,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const Ke="basics-js-theme";class is{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Ke),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),k(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(Ke,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(r){const e=document.createElement("template");return e.innerHTML=r,e}function rs(r,e){let t;for(const s of Object.keys(e))r.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const Ve=new Set;class C{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Ve.has(t)){Ve.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return z.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=V(()=>{const i=new e(s[0]);return i.mount(t),i});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(a=>this.track(a)),i=e.content.cloneNode(!0);for(const a of i.querySelectorAll("[bind]")){const d=t[a.getAttribute("bind")];if(d)if(typeof d=="function")n(k(()=>{const c=d();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(c):a.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?a.addEventListener(c.slice(2),u):typeof u=="function"?n(k(()=>{const m=u();f?a.setAttribute(c,String(m)):a[c]=m})):f?a.setAttribute(c,String(u)):a[c]=u}}return i}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof C?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(i,a,...d)=>this.spawn(i,a,...d),track:i=>this.track(i)}),!0):!1}$each(e,t,s,n=(i,a)=>a){const i=typeof t=="function"?t:()=>t.get(),a=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(k(()=>{const c=i(),u=new Map;for(const[m,h]of c.entries()){const y=n(h,m);if(a.has(y))u.set(y,a.get(y));else{const b=[];u.set(y,V(()=>s(h,m,$=>b.push($)))),d.set(y,b)}}for(const[m,h]of a)u.has(m)||(h.remove(),d.get(m)?.forEach(y=>y()),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);a.clear();for(const[m,h]of u)a.set(m,h)}))}$condition(e,t,s,n){let i=null;this.track(k(()=>{i&&(i.remove(),i=null);const a=t.get();i=V(()=>a?s():n?.()??null),i&&e.appendChild(i)}))}$swap(e,t,s,n){let i=null;this.track(k(()=>{i&&(i.destroy(),i=null),e.textContent="";const a=t.get(),d=s[a]??rs(a,s)??n;d&&(i=V(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>i?.destroy())}}async function os(r,e,t){const s=document.querySelector(e);s.textContent="";const n=z.get(N);let i=null,a=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{i&&(i.destroy(),i=null,s.textContent=""),f?(d||(d=(await Xt(()=>import("./obs-shell.component-Dd2SVm5K.js"),[])).ObsShellComponent),i=V(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),i=V(()=>new r)),V(()=>i.mount(s)),a=f};await u(Ee(location.pathname).startsWith("/_obs")),k(()=>{const f=n.route.get().startsWith("/_obs");f!==a&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>i?.destroy()),t.hot.accept())}class F extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const as=10,be=[];let _e=[],ae=null;function ls(r){be.push(r),be.length>as&&be.shift()}function ds(r,e,t){const s={code:r,message:e,url:typeof location<"u"?location.href:"",context:[...be],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),_e.push(s),cs()}function cs(){ae||(ae=setTimeout(yt,5e3))}function yt(){if(ae&&(clearTimeout(ae),ae=null),_e.length===0)return;const r=_e;_e=[];for(const e of r){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&yt()});const us=3e4,hs=2,pe=new Map,vt=new WeakMap;function ps(r){if(r instanceof F)return r.traceId;if(r!=null&&typeof r=="object")return vt.get(r)}async function g(r){if(r.method==="GET"){const e=pe.get(r.url);if(e)return e;const t=We(r,hs);return pe.set(r.url,t),t.then(()=>pe.delete(r.url),()=>pe.delete(r.url)),t}return We(r,0)}async function We(r,e){const t=r.timeout??us;let s;for(let n=0;n<=e;n++){const i=crypto.randomUUID();try{return await fs(ms(r,i),t)}catch(a){if(s=a,!(a instanceof F)&&a!=null&&typeof a=="object"&&vt.set(a,i),a instanceof F||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function ms(r,e){const t={"X-Trace-Id":e},s={method:r.method,headers:t};r.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(r.body));const n=await fetch(r.url,s),i=n.headers.get("x-trace-id")??e;if(ls({type:"api",detail:`${r.method} ${r.url}`,timestamp:new Date().toISOString()}),!n.ok){const a=await n.json().catch(()=>({error:n.statusText}));throw new F(n.status,a.error??n.statusText,a.details,i)}return n.json()}function fs(r,e){let t;const s=new Promise((n,i)=>{t=setTimeout(()=>i(new Error("Request timeout")),e)});return Promise.race([r,s]).finally(()=>clearTimeout(t))}async function I(r,e,t){de(()=>{r.set(!0),e.set(null)});try{const s=await t();return r.set(!1),s}catch(s){const n=gs(s);de(()=>{r.set(!1),e.set(n)}),ds(n.code,n.message,ps(s));return}}function gs(r){return r instanceof F?r.status===401?{code:"auth",message:"Unauthorized"}:r.status===409?{code:"conflict",message:"Data has changed — please try again"}:r.status===400?{code:"validation",message:r.message}:{code:"server",message:"Server error"}:r instanceof Error?r.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function bs(r){return{me:()=>g({method:"GET",url:`${r}/auth/me`}),login:e=>g({method:"POST",url:`${r}/auth/login`,body:e}),logout:()=>g({method:"POST",url:`${r}/auth/logout`,body:{}})}}class O{constructor(){this.api=bs("/api"),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null)}async load(){const e=await I(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await I(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await I(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Ue={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},o=ns({...Ue,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...Ue,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),D=r=>`var(--${r})`,l=ss({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),x=(r=D("radius"))=>`
...
`);class Gs extends C{static styles=`
        .tabbar {
            display: flex;
...
`),Xs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Js=_(`
    <div class="round-row">
...
`),Et={not_started:"Not started",active:"Live",complete:"Finished"};class Ze extends C{static styles=`
        .landing {
...
`),tn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',sn=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
...
`);class xn extends C{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
  ...
  <td class="lb-rank__thru">${d.holesPlayed}</td>
      ...
      <col class="lb-rank__col-pace">`:"",a=s?'<th class="lb-rank__pace">Pace</th>':"";return`<div class="lb-section">
  ...
  <table class="lb-rank">
    ...
    <thead><tr><th class="lb-rank__pos">#</th><th class="lb-rank__who">Player</th><th class="lb-rank__total">Total</th>${a}<th class="lb-rank__thru">Thru</th></tr></thead>
    <tbody>${n}</tbody>
  </table>
</div>`}function Hn(r,e){const t=r.matches.map(s=>{const n=S(s.sideA.ballIds.map(e).join(" & ")),i=S(s.sideB.ballIds.map(e).join(" & ")),a=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,c=s.leader==="a"?" lb-mp__team--lead":"",u=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    <div class="lb-mp__team lb-mp__team--a${c}">${n}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${S(a)}</span><span class="lb-mp__status">${S(d)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${u}">${i}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${S(r.title)}</h4>${t}
</div>`}const Fn={ranked:Ln,match_summary:(r,e)=>Hn(r,e)},Mn={"default-score-grid":Nn,"compact-match-grid":Pn,"category-matrix-grid":zn};function An(r){return r.componentId??"default-score-grid"}function Bn(r){return`<div class="lb-diag">Unrenderable result section <code>${S(r)}</code> — no generic view yet. Results are not hidden.</div>`}function Gn(r){return`<div class="lb-diag">Unsupported score-grid component <code>${S(r)}</code> — no generic view yet. Results are not hidden.</div>`}function qn(r,e,t){const s=Fn[r.kind];return s?s(r,e,t):Bn(r.kind)}function Kn(r,e,t,s){const n=An(r),i=Mn[n];return i?i(r,e,t,s):Gn(n)}function Vn(r,e,t=zt){return r.leaderboard.length===0&&r.cards.length===0?`<div class="lb-empty">No scores entered yet for ${S(r.formatLabel)}.</div>`:r.leaderboard.map(n=>qn(n,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${S(r.formatLabel)}.</div>`}function Wn(r,e,t,s={}){if(r.cards.length===0)return"";const n=s.mode??"product";return r.cards.map(i=>Kn(i,e,t,{mode:n})).join(`
`)}const Un=_(`
...
`);class Yn extends C{static styles=`
    ...
    `;svc=this.inject(te);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Un,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=c=>{const u=this.svc.nameOf(c);return this.svc.isPending(c)?`${u} (open seat)`:u},i=Vn(t,s,c=>this.svc.groupLabelOf(c)),a=Wn(t,e.routeSections,s),d=a?`<h3 class="lb-cards__head">Scorecard</h3>${a}`:"";return i+d}}function Qn(r,e){if(!e)return[];const t=[],s=new Set;for(const n of r)for(const i of n.players){if(i.playerId===e)return[];i.guestPlayerId===null||s.has(i.guestPlayerId)||(s.add(i.guestPlayerId),t.push({guestPlayerId:i.guestPlayerId,displayName:i.displayName}))}return t}const Xn=_(`
...
`);class Zn extends C{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${T()}
...
`);class oi extends C{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${T()}
...
`);class ui extends C{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${T()}
...
`);class pi extends C{static styles=`
        .edit-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${T()}
...
`);class gi extends C{static styles=`
        .leave-card {
...
`),wi=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),xi=_('<button bind="pill" class="round-view__grp" type="button"></button>');class $i extends C{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class sr extends C{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .setup__friends {
                margin-top: ${l("sm")}; padding: ${l("sm")}; ${T()}
                &.hidden { display: none; }
            ...
            & .fslot {
                ...
                & .grp__start {
                    ...
                    & .grp__time { flex: 1; min-width: 0; padding: ${l("sm")} ${l("md")}; font-size: 1rem; font-family: inherit; ${M()} }
...
`);class ar extends C{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function ft(r){return r.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class ur extends C{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
        ...
        .profile {
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { width: 90px; padding: ${l("md")}; font-size: 1rem; text-align: center; ${M()} }
                    & button {
...
`);class yr extends C{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
            ...
            & .comps__create {
                ...
                gap: ${l("sm")};
                margin-bottom: ${l("md")};
                & input { flex: 1; padding: ${l("md")}; font-size: 1rem; ${M()} }
                & button {
                    padding: ${l("md")} ${l("lg")};
...
`),Fr=_('<button bind="button" type="button"></button>'),Mr=_('<th bind="cell"></th>'),Ar=_('<tr bind="row"></tr>'),Br=_('<td bind="cell"><span bind="value"></span></td>'),Gr=_(`
...
`);class Wr extends C{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${l("xs")};
                    ...
                    & input, & select { padding: ${l("sm")} ${l("md")}; font-size: 0.95rem; ${M()} }
                }
            ...
            & .cd__guestrow input, & .cd__addroundrow input, & .cd__addroundrow select {
                padding: ${l("sm")} ${l("md")}; font-size: 0.9rem; ${M()} min-width: 0; }
            ...
            & .cd__official-banner {
                ${T()} padding: ${l("sm")} ${l("lg")}; margin-bottom: ${l("sm")};
                background: ${o("accent-soft")}; color: ${o("accent")};
...
`);class Yr extends C{static styles=`
    ...
    `;router=this.inject(N);render(){const e=this.wire(Ur,{});return this.spawn(Gs,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Ze,"/history":nn,"/round":$i,"/create":sr,"/login":ar,"/friends":ur,"/profile":mr,...It.competitions?{"/competitions":yr,"/competition":Wr}:{}},Ze),e}}class Qr extends O{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Ft(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await nr()),this.error.set(null)}catch(e){e instanceof F&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await ir(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof F&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}z.get(is);const gt=z.get(N);z.set(O,new Qr);const bt=z.get(O);await os(Yr,"#app",{hot:void 0,onInit:async()=>{await bt.load(),bt.currentUser.get()&&gt.route.get()==="/login"&&gt.navigate("/",!0)}});export{C,N as R,p as S,is as T,g as a,de as b,w as c,k as e,I as r,_ as t};
