(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const ms="modulepreload",fs=function(i){return"/tapscore/"+i},ot={},gs=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let c=function(h){return Promise.all(h.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");n=c(t.map(h=>{if(h=fs(h),h in ot)return;ot[h]=!0;const f=h.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${m}`))return;const u=document.createElement("link");if(u.rel=f?"stylesheet":ms,f||(u.as="script"),u.crossOrigin="",u.href=h,d&&u.setAttribute("nonce",d),document.head.appendChild(u),f)return new Promise((_,b)=>{u.addEventListener("load",_),u.addEventListener("error",()=>b(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return n.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Lt="/tapscore/".replace(/\/+$/,""),He=Lt+"/api",Ie={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},bs=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Dt(i,e){const t={};for(const[s,n]of bs)if(s in i)for(const r of n)r in i||(t[r]=`var(--${s})`);return{...e,...t,...i}}const At=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],ys={thin:"1px",medium:"3px",thick:"5px"};function Ht(i){const e=i.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":ys[e.toLowerCase()]??e}function _s(){return At.map(i=>{const e=Ht(Ie[i]);return`@property --${i}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Mt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Ft={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},vs={...Ft,"done-opacity":"0.35"},ws={...Mt,...Ft,...Ie,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},xs={...Mt,...vs,...Ie,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class $s{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Bt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const W=new $s;function Bt(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,W.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){W.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,W.notify(t.subs))})},deps:new Set};s.run()}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}}function E(i){const e={run(){W.runTracked(e,i)},deps:new Set};return e.run(),()=>{e.disposed=!0,Bt(e)}}function he(i){W.batch(i)}function G(i){return W.untrack(i)}class ks{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const A=new ks,oe=Lt;function Me(i){return oe?i===oe?"/":i.startsWith(oe+"/")?i.slice(oe.length):i:i}function Ss(i){return oe+i}class R{constructor(){this.route=new p(Me(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>he(()=>{this.route.set(Me(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",o=n>=0?e.slice(0,n):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,h=d>=0?o.slice(d+1):"",f=s.query!==void 0?Cs(s.query):h?"?"+h:"",m=Ss(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),he(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const s=this.route.get().split("/"),n={};for(const[r,o]of t.entries())o.startsWith(":")&&(n[o.slice(1)]=s[r]??"");return n})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Cs(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function Ts(i){return e=>i[e]}const Is="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",at="data-basics-global";function Es(){if(document.head.querySelector(`style[${at}]`))return;const i=document.createElement("style");i.setAttribute(at,""),i.textContent=_s()+Is,document.head.appendChild(i)}function Ns(i,e){Es();const t=new Set(At),s=(r,o,d)=>{const c=Object.entries(r).map(([h,f])=>`--${h}:${t.has(h)?Ht(f):f}`).join(";");return`${o}{color-scheme:${d};${c}}`},n=document.createElement("style");return n.textContent=s(i,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(n),r=>`var(--${r})`}const lt="basics-js-theme";class Ps{constructor(){this.dark=new p(!1);const e=localStorage.getItem(lt),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),E(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(lt,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function y(i){const e=document.createElement("template");return e.innerHTML=i,e}function zs(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const dt=new Set;class N{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!dt.has(t)){dt.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return A.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=G(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){G(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const n=s??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")n(E(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,h]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof h=="function"?o.addEventListener(c.slice(2),h):typeof h=="function"?n(E(()=>{const m=h();f?o.setAttribute(c,String(m)):o[c]=m})):f?o.setAttribute(c,String(h)):o[c]=h}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof N?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(h=>h());d.clear()}),this.track(E(()=>{const c=r(),h=new Map;for(const[m,u]of c.entries()){const _=n(u,m);if(o.has(_))h.set(_,o.get(_));else{const b=[];h.set(_,G(()=>s(u,m,T=>b.push(T)))),d.set(_,b)}}for(const[m,u]of o)h.has(m)||(u.remove(),G(()=>d.get(m)?.forEach(_=>_())),d.delete(m));let f=e.firstChild;for(const m of h.values())m===f?f=f.nextSibling:e.insertBefore(m,f);o.clear();for(const[m,u]of h)o.set(m,u)}))}$condition(e,t,s,n){let r=null;this.track(E(()=>{r&&(r.remove(),r=null);const o=t.get();r=G(()=>o?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track(E(()=>{if(r){const c=r;r=null,G(()=>c.destroy())}e.textContent="";const o=t.get(),d=s[o]??zs(o,s)??n;d&&(r=G(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ce=new Set;function Os(i){return Ce.add(i),()=>Ce.delete(i)}function js(){for(const i of Array.from(Ce)){Ce.delete(i);try{i()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Rs(i,e,t){const s=document.querySelector(e);s.textContent="";const n=A.get(R);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const h=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await gs(()=>import("./obs-shell.component-C1VJqPwu.js"),[])).ObsShellComponent),r=G(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=G(()=>new i)),G(()=>r.mount(s)),o=f};await h(Me(location.pathname).startsWith("/_obs")),E(()=>{const f=n.route.get().startsWith("/_obs");f!==o&&h(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,js(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class q extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Ls=10,$e=[];let ke=[],de=null;function Ds(i){$e.push(i),$e.length>Ls&&$e.shift()}function Gt(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...$e],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),ke.push(s),As()}function As(){de||(de=setTimeout(qt,5e3))}function qt(){if(de&&(clearTimeout(de),de=null),ke.length===0)return;const i=ke;ke=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${He}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${He}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&qt()});const Hs=3e4,Ms=2,be=new Map,Kt=new WeakMap;function Fs(i){if(i instanceof q)return i.traceId;if(i!=null&&typeof i=="object")return Kt.get(i)}async function g(i){if(i.method==="GET"){const e=be.get(i.url);if(e)return e;const t=ct(i,Ms);return be.set(i.url,t),t.then(()=>be.delete(i.url),()=>be.delete(i.url)),t}return ct(i,0)}async function ct(i,e){const t=i.timeout??Hs;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Gs(Bs(i,r),t)}catch(o){if(s=o,!(o instanceof q)&&o!=null&&typeof o=="object"&&Kt.set(o,r),o instanceof q||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function Bs(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(Ds({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const o=await n.json().catch(()=>({error:n.statusText}));throw new q(n.status,o.error??n.statusText,o.details,r)}return n.json()}function Gs(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}const Fe=new Set;let Pe=!1;function qs(i){return Fe.add(i),()=>{Fe.delete(i)}}function Ks(){if(!Pe){Pe=!0;try{for(const i of[...Fe])try{i()}catch(e){try{Gt("session-listener",Vs(e))}catch{}}}finally{Pe=!1}}}function Vs(i){try{if(i instanceof Error){const e=i.message;if(typeof e=="string")return e}return String(i)}catch{return"listener threw a value that could not be described"}}async function O(i,e,t,s={}){he(()=>{i.set(!0),e.set(null)});try{const n=await t();return i.set(!1),n}catch(n){const r=Us(n);he(()=>{i.set(!1),e.set(r)}),Gt(r.code,r.message,Fs(n)),r.code==="auth"&&s.sessionExpiry!==!1&&Ks();return}}function Us(i){return i instanceof q?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:i.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const ut={sessionExpiry:!1};function Ws(i){return{me:()=>g({method:"GET",url:`${i}/auth/me`}),login:e=>g({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>g({method:"POST",url:`${i}/auth/logout`,body:{}})}}class H{constructor(){this.api=Ws(He),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=qs(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Os(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await O(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await O(this.loading,this.error,()=>this.api.login({username:e,password:t}),ut);return s?(this.currentUser.set(s),!0):!1}async logout(){await O(this.loading,this.error,()=>this.api.logout(),ut);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Vt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Ys={...Vt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Qs={...Vt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Xs=Dt(Ys,ws),Js=Dt(Qs,xs),a=Ns(Xs,Js),I=i=>`var(--${i})`,x=(i,e)=>`var(--${i}, ${e})`,$=i=>{const e=Ie[i];if(e===void 0)throw new Error(`unknown control token: --${i}`);return e},l=Ts({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ye=i=>`
    ...
    cursor: not-allowed;`,Zs={primary:ye("primary"),secondary:ye("secondary"),ghost:ye("ghost"),danger:ye("danger"),disabled:Ut},S=(i=x("btn-radius",$("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Zs[e]}
    &:disabled {${Ut}}
`,en=`max(${x("field-border-width",$("field-border-width"))}, ${x("field-rule-width",$("field-rule-width"))})`,_e=(i,e)=>`
    border-top-color: ${i};
...
`);class En extends N{static styles=`
        .tabbar {
            display: flex;
...
`),Jt={not_started:"Not started",active:"Live",complete:"Finished"};class gt extends N{static styles=`
        .landing {
...
`),Fn='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Bn=y(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Fn}</button>
    </div>
`);class Gn extends N{static styles=`
        .history {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class gi extends N{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${wt}px; flex-shrink: 0; }
...
</div>`}function Li(i,e){const t=Si(i,e),s=t.matches.map(n=>{const r=n.leader==="a"?" lb-mp__team--lead":"",o=n.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Di={ranked:Ri,match_summary:(i,e)=>Li(i,e)},Ai={"default-score-grid":Pi,"compact-match-grid":zi,"category-matrix-grid":Oi};function Hi(i){return`<div class="lb-diag">Unrenderable result section <code>${P(i)}</code> — no generic view yet. Results are not hidden.</div>`}function Mi(i){return`<div class="lb-diag">Unsupported score-grid component <code>${P(i)}</code> — no generic view yet. Results are not hidden.</div>`}function Fi(i,e,t){const s=Di[i.kind];return s?s(i,e,t):Hi(i.kind)}function Bi(i,e,t,s){const n=ss(i),r=Ai[n];return r?r(i,e,t,s):Mi(n)}function Gi(i,e,t=rs){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${P(i.formatLabel)}.</div>`:i.leaderboard.map(n=>Fi(n,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${P(i.formatLabel)}.</div>`}function qi(i,e,t,s={}){if(i.cards.length===0)return"";const n=s.mode??"product";return i.cards.map(r=>Bi(r,e,t,{mode:n})).join(`
`)}const Ki=y(`
...
`);class Vi extends N{static styles=`
    ...
    `;svc=this.inject(te);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Ki,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=c=>{const h=this.svc.nameOf(c);return this.svc.isPending(c)?`${h} (open seat)`:h},r=Gi(t,s,c=>this.svc.groupLabelOf(c)),o=qi(t,e.routeSections,s),d=o?`<h3 class="lb-cards__head">Scorecard</h3>${o}`:"";return r+d}}function Ui(i,e){if(!e)return[];const t=[],s=new Set;for(const n of i)for(const r of n.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Wi=y(`
...
`);class Qi extends N{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${z()}
    ...
    `,ue.seq=0;let U=ue;function Ji(i){if(!i)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=i.seats.length>0,t=i.claimedSeats.some(r=>r.viewerMayRelease),s=i.viewer.claimSeat.allowed,n=i.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&n,blockedMessage:e&&!s&&!n?i.viewer.claimSeat.message??i.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Zi(i,e){const t=[];if(i.groupId!==null&&e.length>0){const s=e.findIndex(n=>n.id===i.groupId);if(s>=0){t.push(`Group ${s+1}`);const n=e[s].startTime;n.includes(":")&&t.push(n)}}return i.category!==null&&t.push(i.category),t.join(" · ")}function er(i){return(i?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const tr=y(`
...
`);class ir extends N{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${z()}
...
`);class dr extends N{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${z()}
    ...
    `;svc=this.inject(te);auth=this.inject(H);router=this.inject(R);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return or(this.svc.startList.get())}eligible(){return this.policyState().visible&&rr(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),n=await v.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});n.ok?await this.svc.loadByToken(e):this.diagnostics.set(n.diagnostics)}catch(s){this.error.set(s instanceof q&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(E(()=>this.ensureTeesLoaded()));const e=new k(()=>ar(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(E(()=>{const r=e.get(),o=this.groupChoice.get();(!o||!r.options.some(d=>d.value===o&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(lr,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new U({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const n=new U({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return n.mount(this.ref(t,"groupHost")),this.track(()=>n.destroy()),t}}const cr=y(`
...
`);class ur extends N{static styles=`
        .edit-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${z()}
    ...
    `;router=this.inject(R);tokenQ=this.router.query("token");editable=new p(!1);render(){const e=this.tokenQ.get();return e&&v.friendlyRounds.setup({token:e}).then(t=>this.editable.set(t.editable===!0)).catch(()=>this.editable.set(!1)),this.wire(cr,{root:{className:()=>this.editable.get()?"edit-card":"edit-card hidden"},edit:{onclick:()=>{const t=this.tokenQ.get();t&&this.router.navigate("/create",{query:{token:t}})}}})}}function hr(i,e){if(!e)return!1;for(const t of i)for(const s of t.players)if(s.playerId===e)return!0;return!1}const pr=y(`
...
`);class mr extends N{static styles=`
        .leave-card {
    ...
    `;svc=this.inject(te);auth=this.inject(H);router=this.inject(R);tokenQ=this.router.query("token");open=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);eligible(){return hr(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.error.set(""),this.diagnostics.set([]),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){const e=this.wire(pr,{root:{className:()=>this.eligible()?"leave-card":"leave-card hidden"},leaveBtn:{onclick:()=>this.open.set(!0),disabled:()=>this.leaving.get()},diag:{textContent:()=>this.diagnostics.get().map(t=>t.message).join(" · ")},err:{textContent:()=>this.error.get()}});return this.spawn(V,this.ref(e,"confirmHost"),{open:this.open,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}}),e}}function fr(i){return!(i.tab!=="leaderboard"||!i.pageVisible||i.status==="complete")}const gr=2,br=3;function yr(i,e=null){const t=new URLSearchParams({token:i});return e!==null&&t.set("since",e),`${D}/friendly-rounds/events?${t.toString()}`}function _r(i){if(typeof i!="object"||i===null)return!1;const e=i;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function vr(i){const t=(i.eventSourceFactory??(o=>new EventSource(o)))(yr(i.token,i.since??null));let s=!1,n=0;const r=()=>{s=!0,t.onopen=null,t.onmessage=null,t.onerror=null,t.close()};return t.onopen=()=>{n=0},t.onmessage=o=>{if(s)return;let d;try{d=JSON.parse(o.data)}catch{return}_r(d)&&i.onEvent({latestEventId:d.latestEventId,status:d.status})},t.onerror=()=>{s||(t.readyState===gr||++n>=br)&&(r(),i.onDegrade())},{stop:()=>{s||r()}}}const wr=2e4;function xr(i){if(!(i===null||i===""))return/^\d+$/.test(i)?Number(i):i}const $r=y(`
...
`),kr=y('<button bind="pill" class="round-view__fmt" type="button"></button>'),Sr=y('<button bind="pill" class="round-view__grp" type="button"></button>');class Cr extends N{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class no extends N{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class lo extends N{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function Ot(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class po extends N{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class go extends N{static styles=`
        .profile {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),wo={not_started:"Not started",active:"Playing",complete:"Done"};function xo(i){const e=[`${i.participants.length} players`,`${i.scoreEventCount} scores`];return i.lastEventAt?e.push(`last ${i.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function $o(i){const e=[`@${i.username}`,`${i.roundCount} rounds`];return i.lastRoundDate&&e.push(`last ${i.lastRoundDate}`),i.handicapIndex!==null&&e.push(`hcp ${i.handicapIndex}`),i.deletedAt&&e.push("DELETED"),e.join(" · ")}class ko extends N{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Eo extends N{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),qo=y('<option bind="option"></option>');class Ko extends N{competitions=this.inject(se);state=this.inject(fe);router=this.inject(R);render(){const e=new k(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Bo,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Co(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,r)=>this.wireEl(qo,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,r)=>this.wireEl(Go,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>Fo[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Vo(i,e,t){return JSON.stringify({entry:i,points:e,columns:t})}function Uo(i){return i.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const Wo=y(`
    <div>
...
`),Yo=y('<button bind="button" type="button"></button>'),Qo=y('<th bind="cell"></th>'),Xo=y('<tr bind="row"></tr>'),Jo=y('<td bind="cell"><span bind="value"></span></td>'),Zo=y(`
...
`);class na extends N{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class ra extends N{static styles=`
    ...
    `;router=this.inject(R);render(){const e=this.wire(ia,{});return this.spawn(En,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":gt,"/history":Gn,"/round":Cr,"/create":no,"/login":lo,"/friends":po,"/profile":go,"/admin":ko,...Qt.competitions?{"/competitions":Eo,"/competition":na}:{}},gt),e}}class oa extends H{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await us(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await io()),this.error.set(null)}catch(e){e instanceof q&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await ro(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof q&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}A.get(Ps);const jt=A.get(R);A.set(H,new oa);const Rt=A.get(H);await Rs(ra,"#app",{hot:void 0,onInit:async()=>{await Rt.load(),Rt.currentUser.get()&&jt.route.get()==="/login"&&jt.navigate("/",!0)}});export{He as A,N as C,R,p as S,Ps as T,g as a,he as b,k as c,xs as d,E as e,ws as n,O as r,y as t};
