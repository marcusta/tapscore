(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const ar="modulepreload",or=function(s){return"/tapscore/"+s},As={},lr=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),l=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=or(u),u in As)return;As[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":ar,f||(h.as="script"),h.crossOrigin="",h.href=u,l&&h.setAttribute("nonce",l),document.head.appendChild(h),f)return new Promise((b,g)=>{h.addEventListener("load",b),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=d,window.dispatchEvent(l),!l.defaultPrevented)throw d}return i.then(d=>{for(const l of d||[])l.status==="rejected"&&r(l.reason);return e().catch(r)})},jn="/tapscore/".replace(/\/+$/,""),es=jn+"/api",xt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},dr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Dn(s,e){const t={};for(const[n,i]of dr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Gn=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],cr={thin:"1px",medium:"3px",thick:"5px"};function Bn(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":cr[e.toLowerCase()]??e}function ur(){return Gn.map(s=>{const e=Bn(xt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const qn={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Vn={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},hr={...Vn,"done-opacity":"0.35"},pr={...qn,...Vn,...xt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},fr={...qn,...hr,...xt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class mr{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Un(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ue=new mr;function Un(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return ue.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ue.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ue.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ue.notify(t.subs))})},deps:new Set};n.run()}get(){return ue.subscribe(this.subs),this.val}peek(){return this.val}}function I(s){const e={run(){ue.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Un(e)}}function Ye(s){ue.batch(s)}function K(s){return ue.untrack(s)}class gr{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const B=new gr,Fe=jn;function ts(s){return Fe?s===Fe?"/":s.startsWith(Fe+"/")?s.slice(Fe.length):s:s}function br(s){return Fe+s}class M{constructor(){this.route=new p(ts(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>Ye(()=>{this.route.set(ts(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,l=d.indexOf("?"),c=l>=0?d.slice(0,l):d,u=l>=0?d.slice(l+1):"",f=n.query!==void 0?_r(n.query):u?"?"+u:"",m=br(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),Ye(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function _r(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function yr(s){return e=>s[e]}const vr="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Ms="data-basics-global";function wr(){if(document.head.querySelector(`style[${Ms}]`))return;const s=document.createElement("style");s.setAttribute(Ms,""),s.textContent=ur()+vr,document.head.appendChild(s)}function xr(s,e){wr();const t=new Set(Gn),n=(r,d,l)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?Bn(f):f}`).join(";");return`${d}{color-scheme:${l};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const Fs="basics-js-theme";class $r{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Fs),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),I(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(Fs,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(s){const e=document.createElement("template");return e.innerHTML=s,e}function kr(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const js=new Set;class E{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!js.has(t)){js.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return B.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=K(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){K(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const l=t[d.getAttribute("bind")];if(l)if(typeof l=="function")i(I(()=>{const c=l();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(l)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(I(()=>{const m=u();f?d.setAttribute(c,String(m)):d[c]=m})):f?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof E?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...l)=>this.spawn(r,d,...l),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,l=new Map;this.track(()=>{for(const c of l.values())c.forEach(u=>u());l.clear()}),this.track(I(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const b=i(h,m);if(d.has(b))u.set(b,d.get(b));else{const g=[];u.set(b,K(()=>n(h,m,x=>g.push(x)))),l.set(b,g)}}for(const[m,h]of d)u.has(m)||(h.remove(),K(()=>l.get(m)?.forEach(b=>b())),l.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(I(()=>{r&&(r.remove(),r=null);const d=t.get();r=K(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(I(()=>{if(r){const c=r;r=null,K(()=>c.destroy())}e.textContent="";const d=t.get(),l=n[d]??kr(d,n)??i;l&&(r=K(()=>{const c=new l;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const mt=new Set;function Sr(s){return mt.add(s),()=>mt.delete(s)}function Tr(){for(const s of Array.from(mt)){mt.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ir(s,e,t){const n=document.querySelector(e);n.textContent="";const i=B.get(M);let r=null,d=!1,l=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(l||(l=(await lr(()=>import("./obs-shell.component-DcEjwH8o.js"),[])).ObsShellComponent),r=K(()=>new l)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=K(()=>new s)),K(()=>r.mount(n)),d=f};await u(ts(location.pathname).startsWith("/_obs")),I(()=>{const f=i.route.get().startsWith("/_obs");f!==d&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Tr(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class q extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const Pr=10,ut=[];let ht=[],Ve=null;function Cr(s){ut.push(s),ut.length>Pr&&ut.shift()}function Kn(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...ut],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),ht.push(n),Er()}function Er(){Ve||(Ve=setTimeout(Wn,5e3))}function Wn(){if(Ve&&(clearTimeout(Ve),Ve=null),ht.length===0)return;const s=ht;ht=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${es}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${es}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Wn()});const Nr=3e4,Rr=2,nt=new Map,Yn=new WeakMap;function Or(s){if(s instanceof q)return s.traceId;if(s!=null&&typeof s=="object")return Yn.get(s)}async function y(s){if(s.method==="GET"){const e=nt.get(s.url);if(e)return e;const t=Ds(s,Rr);return nt.set(s.url,t),t.then(()=>nt.delete(s.url),()=>nt.delete(s.url)),t}return Ds(s,0)}async function Ds(s,e){const t=s.timeout??Nr;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await Lr(zr(s,r),t)}catch(d){if(n=d,!(d instanceof q)&&d!=null&&typeof d=="object"&&Yn.set(d,r),d instanceof q||i===e)break;await new Promise(l=>setTimeout(l,1e3*2**i))}}throw n}async function zr(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Cr({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new q(i.status,d.error??i.statusText,d.details,r)}return i.json()}function Lr(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const ss=new Set;let Lt=!1;function Hr(s){return ss.add(s),()=>{ss.delete(s)}}function Qn(){if(!Lt){Lt=!0;try{for(const s of[...ss])try{s()}catch(e){try{Kn("session-listener",Ar(e))}catch{}}}finally{Lt=!1}}}function Ar(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function A(s,e,t,n={}){Ye(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=Mr(i);Ye(()=>{s.set(!1),e.set(r)}),Kn(r.code,r.message,Or(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Qn();return}}function Mr(s){return s instanceof q?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const Ht={sessionExpiry:!1};function Fr(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class j{constructor(){this.api=Fr(es),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Hr(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Sr(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await A(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await A(this.loading,this.error,()=>this.api.login({username:e,password:t}),Ht);return n?(this.currentUser.set(n),!0):!1}async logout(){await A(this.loading,this.error,()=>this.api.logout(),Ht);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await A(this.loading,this.error,()=>this.api.logoutAll(),Ht),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Xn={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},jr={...Xn,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Dr={...Xn,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Gr=Dn(jr,pr),Br=Dn(Dr,fr),o=xr(Gr,Br),R=s=>`var(--${s})`,S=(s,e)=>`var(--${s}, ${e})`,T=s=>{const e=xt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=yr({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),it=s=>`
    ...
    cursor: not-allowed;`,qr={primary:it("primary"),secondary:it("secondary"),ghost:it("ghost"),danger:it("danger"),disabled:Jn},w=(s=S("btn-radius",T("btn-radius")),e="secondary")=>`
    /*
    ...
    ${qr[e]}
    &:disabled {${Jn}}
`,Vr=`max(${S("field-border-width",T("field-border-width"))}, ${S("field-rule-width",T("field-rule-width"))})`,rt=(s,e)=>`
    border-top-color: ${s};
    ...
    border-bottom-width: ${Vr};
    ${rt(S("field-border",T("field-border")),S("field-rule",T("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${rt(S("field-focus-border",T("field-focus-border")),S("field-focus-border",T("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${rt(S("field-invalid-border",T("field-invalid-border")),S("field-invalid-rule",T("field-invalid-rule")))}
    }
...
`);class Ea extends E{static styles=`
        .dock {
    ...
    `;router=this.inject(M);auth=this.inject(j);landing=this.inject(St);newCount=new $(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Pa,{bar:{className:()=>qs(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return Ia(r)?qs(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Sa(ti),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(Ca,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const l=this.newCount.get();return l===0?"":String(l)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,l)=>i(r,l),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,l)=>i(r,l),r=>r.key),e}}const si=["tee","approach","putting","shortGame","penalties","recovery"],pt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function ni(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Na(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Ra="Track statistics",Oa="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function ii(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function gt(s,e){return s[e]}function za(s,e){if(!s.enabled)return!0;const t=ii(e);return t===null?!1:!gt(s,t)}function La(s,e){if(!s.enabled)return null;const t=ii(e);return t===null||gt(s,t)?null:`Needs ${ni(t)}`}function Ha(s,e,t){return Ma({...s,[e]:t})}function Aa(s,e){return{...s,enabled:e}}function Ma(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function Mt(s){const e={...pt,enabled:s.enabled};for(const t of si)e[t]=s[t];return e}function Fa(s){return s.avatarVersion?`${F}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function ja(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(at(t[0])+at(t[t.length-1])).toUpperCase();if(t.length===1)return at(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?at(n).toUpperCase():"•"}function at(s){return[...s][0]??""}const ot=512,Da=2*1024*1024;function Ga(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Ba=.85;class De extends Error{}async function qa(s){let e;try{e=await createImageBitmap(s)}catch{throw new De("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Ga(e.width,e.height),r=document.createElement("canvas");r.width=ot,r.height=ot;const d=r.getContext("2d");if(!d)throw new De("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,ot,ot);const l=await new Promise(c=>r.toBlob(c,"image/jpeg",Ba));if(!l)throw new De("That image could not be processed.");if(l.size>Da)throw new De("That image is too large.");return l}finally{e.close()}}async function Va(s){const e=await fetch(`${F}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await ri(e);return await e.json()}async function Ua(){const s=await fetch(`${F}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await ri(s)}async function ri(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new q(t,Ka(e.error,s.status))}function Ka(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class ze{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(pt);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await A(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null),v.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,l]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?Mt(d):pt),this.hasRecordedStats.set((l?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(pt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await A(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await A(this.saving,this.saveError,()=>v.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await A(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await A(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await A(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(Mt(e)));return t?(this.statsConfig.set(Mt(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await qa(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof De?i.message:"That image could not be prepared."}),!1}const n=await A(this.avatarSaving,this.avatarError,()=>Va(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await A(this.avatarSaving,this.avatarError,()=>Ua().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function Ft(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function gs(s,e="frecency"){return e==="alpha"?[...s].sort(Ft):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,l=r>0;if(d!==l)return d?-1:1;if(!d)return Ft(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:Ft(t,n)})}const Wa=1440*60*1e3;function Ya(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/Wa);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function Qa(s,e){if(s.sharedRoundCount<=0)return"never played";const t=Ya(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}const ai=2;function Vs(s){return s.trim().length>=ai}function oi(s){return gs(s,"frecency")}function Xa(s,e){return oi([...s.filter(t=>t.id!==e.id),e])}function Ja(s,e){return s.filter(t=>t.id!==e)}function Us(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function Za(s,e,t=()=>{},n=300){let i=0,r;return d=>{const l=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,l.length<ai){e(l,[]);return}r=setTimeout(()=>{s(l).then(u=>{c===i&&e(l,u)},u=>{c===i&&t(l,u)})},n)}}const li=tt("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function eo(s=W()){return li.read(s)}function to(s,e=W()){li.write(s,e)}class Tt{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(eo());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Za(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await A(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(oi(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await A(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(Xa(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Us(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),to(e)}async remove(e){await A(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(Ja(this.friends.get(),e)),this.results.set(Us(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class bs{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await v.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Ge(s,e){return s instanceof q&&s.status===401?(Qn(),"Your session expired — sign in again."):e}function bt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function so(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${bt(s.scoreToPar)}`}function di(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function ci(s){return(s.courseName??"").trim()||null}function no(s){const e=[];for(const t of s){const n=t.friends[0],i=di(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:ci(t),progress:so(n)})}return e}function io(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function ro(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function ao(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function oo(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${bt(s.scoreToPar)}`}function lo(s){const e=[];for(const t of s){const n=t.friends[0],i=di(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,displayName:n.displayName,title:ci(t)??"A round",date:t.date})}return e}function ui(s){if(s instanceof q){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Ee={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function co(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function uo(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function ho(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${bt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${bt(s.scoreToPar)}`}}}function po(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function fo(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function mo(s){return s===1?"1 course played":`${s} courses played`}const jt={rounds:[],nextCursor:null,hasMore:!1};function Ks(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function hi(s){return s.hasMore&&s.nextCursor!==null}class It{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(jt);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await v.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Ge(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(Ks(jt,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ge(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!hi(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(Ks(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ge(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await v.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Ge(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=ui(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(jt),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function pi(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function go(s){return Math.round(pi(s))}function bo(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,l=r+(e>n-d?1:0);return l===0?0:-l}function _o(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function Se(){return _o()}const ft=10;class Qe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await A(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=Se()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=Se()){return e.labels?.[t]??e.labels?.en??""}presets(e=Se()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=Se()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?ft:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const yo=180,Ws=4,vo=12;function Pe(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function wo(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<vo)return 0;const i=e+t*yo,r=Math.round(-i/n);return Math.max(-Ws,Math.min(Ws,r))}const Ys="tapscore:pending-scores:v1",xo=336*60*60*1e3,Qs=200;function $o(){try{return globalThis.localStorage??null}catch{return null}}function ko(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class So{entries=[];storage;constructor(e=$o(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=xo);return t.length>Qs?t.slice(t.length-Qs):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Ys);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(ko):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Ys,JSON.stringify(this.entries))}catch{}}}const le=["tee_result","recovery_ok","gir","short_game_difficulty","first_putt","putts","penalties"],To={minPar:4},Io={tee_result:"Tee shot",recovery_ok:"Recovery",gir:"Green in regulation",short_game_difficulty:"Short game",first_putt:"First putt",putts:"Putts",penalties:"Penalties"},Po={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"}]},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null}};function Co(s){return Io[s]}function Xs(s){return Po[s]}function Eo(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function fi(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}class No{modules;par;holeNumber;persistedMap;draft=new Map;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=Js(i),this.draft=new Map(r),this.prune()}refresh(e,t){const n=this.signature();return this.modules=e,this.persistedMap=Js(t),this.prune(),this.signature()!==n}signature(){let e="";for(const t of le)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e}get prompts(){const e=[];for(const t of le)this.isVisible(t)&&e.push({key:t,label:Co(t),control:Xs(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&fi(To,this.par,this.holeNumber)?"visible":"unreadable";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(this.record(e,t),this.prune())}step(e,t){const n=Xs(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<le.length;e++){let t=!1;for(const n of le){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),Ro(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of le){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function Ro(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function Js(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of le){const n=s[t];n!==void 0&&e.set(t,n)}return e}const Zs="tapscore:pending-stat-events:v1",Oo=336*60*60*1e3,en=500;function zo(){try{return globalThis.localStorage??null}catch{return null}}function Lo(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Ho(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&le.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Ao{entries=[];storage;makeId;constructor(e=zo(),t=Date.now(),n=Lo){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const l of i){const c={token:e,playHoleId:t,playerId:n,key:l.key,value:l.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===l.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Oo);return t.length>en?t.slice(t.length-en):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Zs);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ho):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Zs,JSON.stringify(this.entries))}catch{}}}const Mo=50;function Fo(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const _s=tt("tapscore.result-cursors.v1",hs(Fo),Mo);function ys(s=W()){return _s.read(s)}function jo(s,e=W()){return ys(e).find(t=>t.token===s)?.cursor??null}function Do(s,e,t=W()){if(!t)return[];const n=ys(t).filter(i=>i.token!==s);return _s.write([{token:s,cursor:e},...n],t)}function Go(s,e=W()){if(!e)return[];const t=ys(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&_s.write(n,e),n}const Bo=["1st","2nd","3rd","4th","5th","6th","7th","8th"],me=(s,e)=>`${s}|${e}`;function vs(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function qo(s,e,t){return fi(s,e,t)}function Dt(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Vo(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),e}function Uo(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class ae{constructor(e=new So,t=new Ao){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),B.get(Qe).load();const r=await A(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),je({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!ga(r.round.id))),B.get(j).currentUser.get()&&ba(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,l,c,u]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[]),v.playerStats.configsByToken({token:e}).catch(()=>null),v.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(l),this.balls.set(d),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),ei(e);const t=this.round.get()?.id;return t&&Zn(t),Go(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),je({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),je({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await A(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?jo(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Do(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),je({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,vs(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new $(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Pe(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,l)=>d.ordinal-l.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${Bo[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Pe(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Pe(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const n=this.cells.get().get(me(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(me(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const l=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===l)?.strokeIndex??d.baseStrokeIndex;return bo(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.flushStats(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e))&&this.bumpStatRev()}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);return!t||!n?null:new No(t,n.par,n.courseHoleNumber,this.persistedStats(e))}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Vo(t):new Map;for(const i of le){const r=Dt(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=Dt(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=Dt({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await v.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return Uo(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(me(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=B.get(Qe),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const l of d)i.has(l.key)||(i.add(l.key),n.push(l))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>qo(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=me(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const l=this.token;l&&(this.enqueue(l,e,t,n,i,d),await this.post(l,e,t,n,i,d))}async retry(e,t){const n=me(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(me(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const l=me(t,n);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class mi{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await v.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=ui(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Ge(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await v.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,vs(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new $(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class gi{roles=new p([]);rolesLoaded=!1;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}async loadRoles(e=!1){if(!(!e&&this.rolesLoaded)){this.rolesLoaded=!0;try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}}}clear(){this.roles.set([]),this.rolesLoaded=!1,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await A(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const Ko=["last5","last10","last20","thisYear","all","custom"];function _t(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function Wo(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function ws(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const Ue={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function Yo(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function Qo(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function Gt(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function Xo(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Pt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function bi(s){return`${s.getFullYear()}-`}function _i(s,e,t,n){const i=Pt(t);switch(s){case"last5":case"last10":case"last20":{const r=ws(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=bi(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>Qo(e,r))}}function yi(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=ws(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${bi(r)}01-01`;return!n.some(l=>l.date<d)}case"all":return!0;case"custom":{if(Yo(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(l=>l.date<d)}}}const Jo="Unnamed course";function Zo(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??Jo,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const yt="last10";function el(s){return Ko.includes(s)}const vi=tt("tapscore.stats.window.v1",{decode:s=>el(s)?s:yt,encode:s=>s,empty:yt});function ns(s=W()){return vi.read(s)}function tn(s,e=W()){vi.write(s,e)}function H(s,e){return{value:e===0?null:s/e,n:s,d:e}}const is=5;function xe(s,e=is){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const rs=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,girRecorded:0,girHits:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0});function tl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved}}function sl(s){let e=rs;for(const t of s)e=tl(e,t);return e}const Ct=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function wi(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function nl(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function il(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function rl(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function xi(s){return H(s.fairwayHits,s.teeRecorded)}function al(s){return H(s.troubleCount,s.teeRecorded)}function ol(s){return H(s.recoverySuccesses,s.recoveryAttempts)}function ll(s,e){return H(s.penaltiesTotal,e)}function dl(s){return{fairway:H(s.strokesVsParFairway,s.holesScoredFairway),inPlay:H(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:H(s.strokesVsParTrouble,s.holesScoredTrouble)}}function cl(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return H(e,s.holesScoredTrouble*s.holesScoredFairway)}function $i(s){return H(s.girHits,s.girRecorded)}function ul(s){return{fairway:H(s.girHitsFairway,s.girRecordedFairway),inPlay:H(s.girHitsInPlay,s.girRecordedInPlay),trouble:H(s.girHitsTrouble,s.girRecordedTrouble)}}function hl(s,e){return H(rl(s,e),s.girFirstPuttRecorded)}function pl(s){return H(s.birdiesOnGir,s.girHolesScored)}function fl(s,e){return H(il(s,e),wi(s,e))}function ml(s){return H(s.threePutts,s.puttsRecorded)}function gl(s){return H(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function bl(s){return H(s.puttsTotalGir,s.puttsRecordedGir)}function ki(s){return{standard:H(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:H(s.scrambleSuccessesHard,s.scrambleAttemptsHard),overall:H(s.scrambleSuccessesStandard+s.scrambleSuccessesHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}}function _l(s){return{standard:H(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:H(s.scrambleInside2mHard,s.scrambleFirstPuttHard),overall:H(s.scrambleInside2mStandard+s.scrambleInside2mHard,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard)}}function yl(s){return{par3:H(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:H(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:H(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function vl(s,e){return H(s.doubleBogeyPlus,e)}function wl(s){return H(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Si=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),xl=1.85,$l=Object.freeze({inside2m:1.25,outside2m:2.12}),ee=["putting","shortGame","penalties","longGame"],kl=.8;function Xe(s,e=Si,t=$l,n=xl){let i=0,r=0,d=0;for(const P of Ct){const G=wi(s,P);i+=G,r+=nl(s,P),d+=G*e[P]}const l=i===0?null:r-d,c=s.scrambleInside2mStandard+s.scrambleInside2mHard,u=s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard,f=Math.max(0,u-c),m=s.scrambleHoledStandard+s.scrambleHoledHard,h=u===0&&m===0?null:c*(t.inside2m-n)+f*(t.outside2m-n)+m*(1-(1+n)),b=s.penaltiesTotal,g=s.holesScored===0?null:s.strokesTotal-s.parTotal,x={holesScored:s.holesScored,puttsRecorded:s.puttsRecorded},O=s.puttsRecorded>=kl*s.holesScored,D=g===null||l===null||h===null||!O?null:g-l-h-b;return{putting:l,shortGame:h,penalties:b,longGame:D,total:g,coverage:x}}function Ne(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Ti(s,e){return{putting:Ae(s.putting,e.map(Ii)),shortGame:Ae(s.shortGame,e.map(Sl)),penalties:Ae(s.penalties,e.map(Pi)),longGame:Ae(s.longGame,e.map(Tl)),total:Ae(s.total,e.map(Il))}}function xs(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function $s(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function Ae(s,e){if(s===null)return null;const t=$s(e);return t===null?null:s-t}function Ii(s){return s.putting}function Sl(s){return s.shortGame}function Pi(s){return s.penalties}function Tl(s){return s.longGame}function Il(s){return s.total}const sn=1,Pl=2,Cl=.75,El=4,Nl=12,Rl=5,Ol=2;function zl(s,e,t,n){const i=Ti(e,t),r=[];let d=0;const l=(g,x)=>{r.push({line:g,magnitude:x,order:d++})};let c=null,u=null;for(const g of ee){const x=xs(i,g);x!==null&&((c===null||x<c.delta)&&(c={component:g,delta:x}),(u===null||x>u.delta)&&(u={component:g,delta:x}))}c!==null&&c.delta<=-sn&&l({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=sn&&l({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=$s(t.map(Pi));f!==null&&s.penaltiesTotal>=f+Pl&&l({id:"penalties_spike",params:{penalties:s.penaltiesTotal,baseline:f}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard,h=s.scrambleSuccessesStandard+s.scrambleSuccessesHard;m>=El&&h>=Cl*m&&l({id:"scramble_streak",params:{successes:h,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=Nl&&l({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const b=t.map(Ii).filter(g=>g!==null);return e.putting!==null&&b.length>=Rl&&b.every(g=>e.putting<g)&&l({id:"best_putting_round",params:{putting:e.putting,rounds:b.length}},0),s.bounceBackOpportunities>=Ol&&s.bounceBackSuccesses===s.bounceBackOpportunities&&l({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((g,x)=>x.magnitude-g.magnitude||g.order-x.order),r.slice(0,Math.max(0,n)).map(g=>g.line)}const Ll=["tee","approach","putting","shortGame","scoring"];function Hl(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const Al=3,Ci={rounds:[],totals:rs,waterfall:Xe(rs),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null};function ks(s){const e=Pt(s);if(e.length===0)return Ci;const t=sl(e.map(r=>r.measures)),n=e.map(r=>Xe(r.measures)),i=e.length;return{rounds:e.map((r,d)=>{const l=n[d];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:l.total,waterfall:l}}),totals:t,waterfall:Xe(t),priorities:Ml(n),trends:Fl(e),tee:jl(t,i),approach:Dl(t),putting:Gl(t),shortGame:Bl(t),scoring:ql(t,i)}}function Ml(s){const e=ee.map(n=>{const i=s.map(r=>Ne(r,n));return{component:n,perRound:$s(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>ee.indexOf(n);return e.sort((n,i)=>n.perRound!==null&&i.perRound!==null?n.perRound===i.perRound?t(n.component)-t(i.component):i.perRound-n.perRound:n.perRound!==null?-1:i.perRound!==null?1:t(n.component)-t(i.component))}function Bt(s){return xe(s)==="percentage"?s.value:null}function Fl(s){const e=[...s].reverse(),t=(n,i,r,d)=>{const l=[];for(const c of e){const u=d(c.measures);u!==null&&l.push(u)}return l.length>=Al?{id:n,title:i,kind:r,points:l}:null};return[t("fairway","Fairways","percentage",n=>Bt(xi(n))),t("gir","Greens","percentage",n=>Bt($i(n))),t("putting","Putting","strokesLost",n=>Xe(n).putting),t("scramble","Scrambling","percentage",n=>Bt(ki(n).overall))].filter(n=>n!==null)}function jl(s,e){return s.teeRecorded<=0?null:{fairway:xi(s),inPlayOnly:H(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:al(s),troubleTax:cl(s),vsParByTee:dl(s),recovery:ol(s),penaltiesPerRound:ll(s,e)}}function Dl(s){if(s.girRecorded<=0)return null;const e={};for(const t of Ct)e[t]=hl(s,t);return{gir:$i(s),girByTee:ul(s),girFirstPuttMix:e,birdieConversion:pl(s)}}function Gl(s){return s.puttsRecorded<=0&&s.firstPuttRecorded<=0?null:{ladder:Ct.map(e=>({bucket:e,made:fl(s,e),baseline:Math.max(0,2-Si[e])})),threePutt:ml(s),threePuttsFromOver8m:gl(s),puttsPerGirHole:bl(s)}}function Bl(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:ki(s),chipInside2m:_l(s),conversionInside2m:H(t,n),chipIns:s.scrambleHoledStandard+s.scrambleHoledHard}}function ql(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:yl(s),doubleBogeyPlusPerRound:vl(s,e),bounceBack:wl(s)}}function Ei(s){let e=0;for(const t of s)for(const n of ee){const i=Ne(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Vl(s){let e=0;for(const t of s)t.perRound!==null&&(e=Math.max(e,Math.abs(t.perRound)));return e}function Ss(s){const e=B.get(Qe);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function Ul(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:ha(e)||null,date:e.round.date,formats:e.round.formatSlots.map(Ss).join(" · ")}))}function Kl(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:e.date??null,formats:null}))}function Ce(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Te(s){return s.courseName?Ce(s)===s.courseName?null:s.courseName:null}function he(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const Ke={fromMyRounds:Ul,fromDeviceRounds:Kl};function ce(s){switch(xe(s)){case"absent":return null;case"fraction":return`${Re(s.n)} of ${Re(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function Wl(s){return xe(s)!=="percentage"?null:`${Re(s.n)} of ${Re(s.d)}`}function se(s){const e=ce(s);if(e===null)return null;const t=Wl(s);return t===null?e:`${e} (${t})`}function Ts(s,e=2,t=!1){return xe(s)==="absent"||s.value===null?null:t?Le(s.value,e):pe(s.value,e)}function Is(s){return{one:s,many:`${s}s`}}const de=Is("round"),Ni=Is("hole"),Ri=Is("green"),Oi="thin sample";function zi(s,e){switch(xe(s)){case"absent":return null;case"fraction":return`over ${ne(s.d,e)} — ${Oi}`;case"percentage":return`over ${ne(s.d,e)}`}}function Ie(s,e){const t=Ts(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=zi(s,e.unit);return i===null?n:`${n} (${i})`}const Yl={one:"hole from trouble",many:"holes from trouble"},Ql={one:"from the fairway",many:"from the fairway"};function Xl(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${ne(e,Yl)} vs ${ne(t,Ql)}`;return e<is||t<is?`${n} — ${Oi}`:n}function Jl(s){return xe(s)==="fraction"}function Re(s){return s===Math.round(s)?String(Math.round(s)):pe(s,1)}function ne(s,e){return`${Re(s)} ${s===1?e.one:e.many}`}function pe(s,e=1){return s.toFixed(e)}function Le(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return pe(0,e);const i=pe(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function Zl(s){return`${Le(s)}/round`}function Ps(s){return s===0?"E":Le(s,s===Math.round(s)?0:1)}function Et(s){switch(s){case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"longGame":return"Long game"}}function ed(s){switch(s){case"putting":return"Putts taken vs expected from where you started";case"shortGame":return"Chips and pitches vs an average short-game shot";case"penalties":return"Strokes added by penalties";case"longGame":return"Tee shots and approaches — what the rest did not explain"}}function nn(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function td(s){return s==="indoor"?"Indoor":"Outdoor"}function sd(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Li(s){return he(s)}const Hi="Statistics",nd="All statistics →";function id(s){return s==="custom"?yt:s}function rd(s,e,t){return ws(s)!==null||!t?_t(s):`${_t(s)} — newest ${e}`}function ad(s){return H(s.strokesTotal-s.parTotal,s.holesScored)}function od(s){const e=[],t=ad(s.totals),n=Ts(t,2,!0);if(n!==null){const c=xe(t)==="fraction"?zi(t,Ni):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:ce(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,l=d===null?null:ce(d.gir);return l!==null&&e.push({id:"gir",value:l,label:"Greens in regulation",note:null}),e}function ld(s){const e=s.priorities.find(t=>t.perRound!==null);return!e||e.perRound===null||e.perRound<=0?null:`Costing you most: ${Et(e.component)}`}function dd(s){const e=id(s.preset),t=_i(e,Ue,s.rows,s.now);if(t.length===0)return null;const n=ks(t),i=od(n);if(i.length===0)return null;const r=yi({preset:e,filter:Ue,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:rd(e,t.length,r),tiles:i,priorityLine:ld(n)}}function cd(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${Hi}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class Nt{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(ns());loaded=!1;loading=!1;card=new $(()=>{const e=this.rows.get();return e===null?null:dd({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(ns())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await v.playerStats.myStats({limit:Nt.PAGE_SIZE});this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof q&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const Ls=class Ls extends E{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(I(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};Ls.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let Z=Hs;async function ud(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const hd="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function $e(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function ve(s){const e=()=>Fa(s());return{avatarPhoto:{src:()=>e()??hd,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return ja(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Oe(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function pd(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function fd(s){return pd(s).map(e=>e.kind)}function rn(s){return s.signedIn?"avatar":"signin"}const md=_(`
...
`);class gd extends E{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),kd='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Sd=_(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${kd}</button>
    </div>
`),Td=_(`
...
`,os={not_started:"Not started",active:"Live",complete:"Finished"};class ln extends E{static styles=`
        .landing {
    ...
    `;svc=this.inject(St);profile=this.inject(ze);activity=this.inject(bs);homeStats=this.inject(Nt);auth=this.inject(j);router=this.inject(M);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>this.loggedIn.get()?Ke.fromMyRounds(this.svc.myRounds.get()):Ke.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new $(()=>yd(this.rows.get(),Date.now(),e=>e));ongoing=new $(()=>this.parts.get().ongoing);finished=new $(()=>this.parts.get().finished);ongoingShown=new $(()=>this.ongoing.get().slice(0,Ai));finishedShown=new $(()=>this.finished.get().slice(0,vd));counts=new $(()=>({rows:this.rows.get().length,ongoing:this.ongoing.get().length,finished:this.finished.get().length}));newRows=new $(()=>this.loggedIn.get()?Ke.fromMyRounds(this.svc.newRounds.get()):[]);chips=new $(()=>this.loggedIn.get()?no(this.activity.feed.get()?.live??[]):[]);recents=new $(()=>this.loggedIn.get()?lo(this.activity.feed.get()?.recent??[]):[]);statsCard=new $(()=>this.loggedIn.get()?this.homeStats.card.get():null);statsTiles=new $(()=>this.statsCard.get()?.tiles??[]);deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,n){this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?(this.svc.loadMine(),this.profile.load(),this.activity.load(),this.homeStats.refreshPreset(),this.homeStats.load(!0)):this.svc.loadDevice();const e=this.wire($d,{head:{className:()=>this.loggedIn.get()?"landing__head hidden":"landing__head"},identity:{className:()=>this.loggedIn.get()?"landing__identity":"landing__identity hidden","aria-label":()=>{const n=this.identityName(),i=qt(this.profile.player.get()?.handicapIndex);return i?`${n}, ${i}`:n},onclick:()=>this.router.navigate("/profile")},...ve(()=>{const n=this.profile.player.get();return{id:n?.id??"",avatarVersion:n?.avatarVersion??null,displayName:n?.displayName??null,username:n?.username??this.auth.currentUser.get()?.username??null}}),identityName:()=>this.identityName(),identityHcp:{textContent:()=>qt(this.profile.player.get()?.handicapIndex)??"",className:()=>qt(this.profile.player.get()?.handicapIndex)===null?"landing__identity-hcp hidden":"landing__identity-hcp"},history:{className:()=>wd(this.counts.get())?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},outNowSection:{className:()=>this.chips.get().length>0?"landing__section-block landing__outnow":"landing__section-block landing__outnow hidden"},outNowContext:()=>ro(this.activity.feed.get()?.live??[])??"",recentlySection:{className:()=>this.recents.get().length>0?"landing__section-block landing__recently":"landing__section-block landing__recently hidden"},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const n=this.newRows.get().length;return n===0?"":String(n)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block":"landing__section-block hidden"},ongoingCount:()=>{const n=this.ongoing.get().length;return n===0?"":String(n)},ongoingMore:{className:()=>Mi(this.counts.get().ongoing)?"landing__more":"landing__more hidden","aria-label":()=>"Show all ongoing rounds",onclick:()=>this.router.navigate("/history")},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block landing__finished":"landing__section-block landing__finished hidden"},finishedCount:()=>{const n=this.finished.get().length;return n===0?"":String(n)},finishedAll:{"aria-label":()=>"All rounds",onclick:()=>this.router.navigate("/history")},stats:{className:()=>this.statsCard.get()===null?"landing__stats hidden":"landing__stats","aria-label":()=>{const n=this.statsCard.get();return n===null?"":cd(n)},onclick:()=>this.router.navigate("/stats")},statsWindow:()=>this.statsCard.get()?.windowLabel??"",statsPriority:{textContent:()=>this.statsCard.get()?.priorityLine??"",className:()=>this.statsCard.get()?.priorityLine?"landing__stats-priority":"landing__stats-priority hidden"},statsTitle:()=>Hi,statsFoot:()=>nd,empty:{className:()=>xd(this.counts.get())?"landing__empty":"landing__empty hidden"}});this.$each(this.ref(e,"outNowList"),this.chips,(n,i,r)=>this.wireEl(Id,{chip:{"aria-label":()=>io(n),onclick:()=>this.router.navigate("/spectate",{query:{id:n.roundId,name:n.displayName}})},...ve(()=>{const d=this.chips.get().find(l=>l.roundId===n.roundId)??n;return{id:d.playerId,avatarVersion:d.avatarVersion,displayName:d.displayName}}),who:()=>n.title,line:()=>n.progress},r),n=>n.roundId),this.$each(this.ref(e,"recentlyList"),this.recents,(n,i,r)=>this.wireEl(Cd,{row:{onclick:()=>this.router.navigate("/spectate",{query:{id:n.roundId,name:n.displayName}})},who:()=>n.friendLabel,what:()=>n.title,when:()=>he(n.date)},r),n=>n.roundId),this.$each(this.ref(e,"newList"),this.newRows,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.$each(this.ref(e,"ongoingList"),this.ongoingShown,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.$each(this.ref(e,"finishedList"),this.finishedShown,(n,i,r)=>this.finishedRow(n,r),n=>n.key),this.$each(this.ref(e,"statsTiles"),this.statsTiles,(n,i,r)=>this.wireEl(Pd,{value:()=>n.value,label:()=>n.label,note:{textContent:()=>n.note??"",className:()=>n.note===null?"stat-tile__note hidden":"stat-tile__note"}},r),n=>`${n.id}:${n.value}:${n.note??""}`),this.spawn(Z,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const n=this.deleteTarget.get();return`Delete ${n?`“${n.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const n=this.deleteTarget.get();n&&this.svc.remove(n.token,n.roundId)}});const t=n=>{n.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}identityName(){const e=this.profile.player.get(),t=(e?.displayName??"").trim();if(t!=="")return t;const n=(e?.username??this.auth.currentUser.get()?.username??"").trim();return n===""?"Signed in":n}finishedRow(e,t){return this.wireEl(Td,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Ce(e),course:{textContent:()=>Te(e)??"",className:()=>Te(e)?"finished-row__course":"finished-row__course hidden"},date:()=>he(e.date),status:{textContent:()=>os[e.status]??e.status,className:()=>`finished-row__status s-${e.status}`}},t)}roundRow(e,t){return this.wireEl(Sd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Ce(e),course:{textContent:()=>Te(e)??"",className:()=>Te(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>os[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>he(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",Ce(e))}}},t)}}function Ed(s){return[...s].sort((e,t)=>{const n=dn(e),i=dn(t);return i!==n?i-n:e.key.localeCompare(t.key)})}function dn(s){const e=s.completedAt??s.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const Nd=_(`
    <div class="history">
...
`),Rd='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Od=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="title" class="round-row__title"></span>
...
`);class zd extends E{static styles=`
        .history {
    ...
    `;svc=this.inject(St);auth=this.inject(j);router=this.inject(M);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>Ed(this.loggedIn.get()?Ke.fromMyRounds(this.svc.myRounds.get()):Ke.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,n){this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(Nd,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.spawn(Z,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const n=this.deleteTarget.get();return`Delete ${n?`“${n.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const n=this.deleteTarget.get();n&&this.svc.remove(n.token,n.roundId)}});const t=n=>{n.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(Od,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Ce(e),course:{textContent:()=>Te(e)??"",className:()=>Te(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>os[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>he(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",Ce(e))}}},t)}}const Ld=700;function Hd(s){if(!s.currentHole)return!1;const e=s.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function Ad(s){return s.currentHole?s.balls.some((e,t)=>t!==s.currentBallIndex&&!e.scored):!1}function Vt(s){const e=s.currentHole;if(!e)return{kind:"noop"};const t=s.balls,n=s.currentBallIndex;for(let i=n+1;i<t.length;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};for(let i=0;i<n;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};return s.holeIndex>=s.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:s.holeIndex+1,delayMs:Ld}}function Md(s,e){const t=s.currentHole;if(e.kind==="statsDone")return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Vt(s)};const n=s.balls[s.currentBallIndex];if(!t||!n)return{write:null,move:{kind:"noop"}};if(n.pending)return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Vt(s)};const i={ballIndex:s.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&s.collectsStats?{write:i,move:{kind:"openStats"}}:s.holeCompleteOnEntry?{write:i,move:{kind:"stay"}}:{write:i,move:Vt(s)}}const ge=60,cn=8,ls=4,Fd=Array.from({length:ls*2+1},(s,e)=>e-ls),jd="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Dd=_(`
...
`),Kd=_('<button bind="btn" class="se-seg" type="button"></button>'),Wd=_(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),Yd=_('<div bind="rule" class="se-stats__rule"></div>');class Qd extends E{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__slot { width: ${ge}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
...
</tr>`;const G=ds(n.plan.slotDefId,D.ballIds),V=n.isOpen(G),fe=yc(G),rr=Bi(P,n.routeSections,e,{mode:n.mode??"product"}),zt=["lb-rank__row--expandable"];return b.lead&&zt.push("lb-rank__lead"),V&&zt.push("lb-rank__row--open"),`<tr class="${zt.join(" ")}" data-expand-key="${L(G)}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${V}" aria-controls="${L(fe)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${L(b.name)}</span>${x}</span></button></td>${O}
  <td class="lb-rank__disclosure"><span class="lb-rank__chev" aria-hidden="true"></span></td>
</tr>
<tr class="lb-rank__panel${V?" lb-rank__panel--open":""}" data-panel-key="${L(G)}">
  <td class="lb-rank__panelcell" colspan="${l}"><div class="lb-rank__panelwrap" id="${L(fe)}"><div class="lb-rank__panelbox">${rr}</div></div></td>
</tr>`}).join(""),u=r?`
...
</div>`}function wc(s,e){const t=ac(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",d=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const xc={ranked:vc,match_summary:(s,e)=>wc(s,e)},$c={"default-score-grid":mc,"compact-match-grid":gc,"category-matrix-grid":bc};function kc(s){return`<div class="lb-diag">Unrenderable result section <code>${L(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Sc(s){return`<div class="lb-diag">Unsupported score-grid component <code>${L(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Tc(s,e,t,n=null){const i=xc[s.kind];return i?i(s,e,t,n):kc(s.kind)}function Bi(s,e,t,n){const i=ji(s),r=$c[i];return r?r(s,e,t,n):Sc(i)}function qi(s,e,t=Gi,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${L(s.formatLabel)}.</div>`:s.leaderboard.map(r=>Tc(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${L(s.formatLabel)}.</div>`}function Vi(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Bi(r,e,t,{mode:i})).join(`
`)}const Ic=_(`
...
`);class Ui extends E{static styles=`
    ...
    `;svc=this.inject(ae);expansion=new dc;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Ic,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=lc(t);this.expansion.retain(r.attached.keys());const d=qi(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),l=Vi(r.standalone,e.routeSections,n),c=l?`<h3 class="lb-cards__head">Scorecard</h3>${l}`:"";return d+c}}function Pc(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Cc=_(`
...
`);class Nc extends E{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${C()}
    ...
    `,We.seq=0;let te=We;function Oc(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function zc(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Lc(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Hc=_(`
...
`);class Fc extends E{static styles=`
        .seat-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${C()}
...
`);class qc extends E{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${C()}
    ...
    `;svc=this.inject(ae);auth=this.inject(j);router=this.inject(M);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Dc(this.svc.startList.get())}eligible(){return this.policyState().visible&&jc(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await v.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof q&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(I(()=>this.ensureTeesLoaded()));const e=new $(()=>Gc(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(I(()=>{const r=e.get(),d=this.groupChoice.get();(!d||!r.options.some(l=>l.value===d&&!l.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Bc,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new te({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new te({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const mn=1440*60*1e3;function Vc(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>mn?!0:e-t>=mn}function Uc(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function Kc(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!Uc(s.balls,s.playerId)||!Vc(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ie(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function wt(s){return s<0?`+${String(-s)}`:String(s)}const Wc=_(`
...
`);class Yc extends E{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${C()}
    ...
    `;svc=this.inject(ae);auth=this.inject(j);profile=this.inject(ze);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return Kc({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":wt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ie(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(I(()=>this.ensureProfileLoaded())),this.wire(Wc,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${wt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function Qc(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const Xc=_(`
...
`);class Jc extends E{static styles=`
    ...
    `;svc=this.inject(ae);auth=this.inject(j);router=this.inject(M);tokenQ=this.router.query("token");editable=new p(!1);deleteOpen=new p(!1);finishOpen=new p(!1);finishAsReopen=new p(!1);leaveOpen=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);isComplete(){return this.svc.round.get()?.status==="complete"}canLeave(){return Qc(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}clear(){this.error.set(""),this.diagnostics.set([])}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.clear(),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){this.track(I(()=>{const r=this.tokenQ.get();this.editable.set(!1),r&&v.friendlyRounds.setup({token:r}).then(d=>{this.tokenQ.get()===r&&this.editable.set(d.editable===!0)}).catch(()=>{})})),this.track(I(()=>{this.props.open.get()&&this.clear()}));const e=this.wire(Xc,{root:{className:()=>this.props.open.get()?"rmanage":"rmanage hidden"},backdrop:{onclick:()=>this.props.open.set(!1)},close:{onclick:()=>this.props.open.set(!1)},editRow:{className:()=>this.editable.get()?"rmanage__row":"rmanage__row hidden",onclick:()=>{const r=this.tokenQ.get();r&&(this.props.open.set(!1),this.router.navigate("/create",{query:{token:r}}))}},leaveRow:{className:()=>this.canLeave()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.leaveOpen.set(!0),disabled:()=>this.leaving.get()},finishRow:{onclick:()=>{this.finishAsReopen.set(this.isComplete()),this.finishOpen.set(!0)},disabled:()=>this.svc.finishing.get()},finishTitle:()=>this.isComplete()?"Reopen round":"Finish round",finishSub:()=>this.isComplete()?"Move it back to your ongoing rounds.":"Move it to your finished rounds. Nothing is locked.",deleteRow:{onclick:()=>this.deleteOpen.set(!0),disabled:()=>this.svc.deleting.get()},diag:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},err:{textContent:()=>this.error.get()}});this.spawn(Z,this.ref(e,"deleteConfirmHost"),{open:this.deleteOpen,title:"Delete round?",message:"This permanently removes the round and all its scores for everyone. This can't be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.clear(),this.svc.deleteRound().then(r=>{r?this.router.navigate("/"):this.error.set("Could not delete the round. Try again.")})}}),this.spawn(Z,this.ref(e,"finishConfirmHost"),{open:this.finishOpen,title:()=>this.finishAsReopen.get()?"Reopen this round?":"Finish this round?",message:()=>this.finishAsReopen.get()?"It'll move back to your ongoing rounds.":"It'll move to your finished rounds. You can still edit or reopen it any time.",confirmLabel:()=>this.finishAsReopen.get()?"Reopen round":"Finish round",cancelLabel:"Cancel",onconfirm:()=>{this.clear(),(this.finishAsReopen.get()?this.svc.reopenRound():this.svc.finishRound()).then(d=>{d||this.error.set("Could not update the round. Try again.")})}}),this.spawn(Z,this.ref(e,"leaveConfirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}});let t=null;const n=this.ref(e,"close");this.track(I(()=>{this.props.open.get()?(t=document.activeElement instanceof HTMLElement?document.activeElement:null,queueMicrotask(()=>n.focus())):t&&(t.focus(),t=null)}));const i=r=>{if(r.key==="Escape"){if(this.deleteOpen.get())return void this.deleteOpen.set(!1);if(this.finishOpen.get())return void this.finishOpen.set(!1);if(this.leaveOpen.get())return void this.leaveOpen.set(!1);this.props.open.get()&&this.props.open.set(!1)}};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),e}}class ye{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(ns());filter=new p(Ue);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new $(()=>_i(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new $(()=>ks(this.windowRounds.get()));courses=new $(()=>Zo(this.loadedRounds.get()));overFiltered=new $(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await A(this.loading,this.error,()=>v.playerStats.myStats({limit:ye.PAGE_SIZE}));t&&(this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded())}select(e){this.preset.set(e),tn(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),tn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(Ue),this.select(yt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<ye.MAX_PAGES&&yi({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await v.playerStats.myStats({limit:ye.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=ye.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(Ue),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}function Zc(s,e,t=!0){if(s===null||e===null||s<=0)return null;const n=s-e;return n===0?null:s===1&&t||n<=-3?"diamond":n===-2?"double_ring":n===-1?"ring":n===1?"square":n===2?"double_square":"box_badge"}function eu(s){const e=s.par,t=s.score,n=t===0,i=n?null:t,r=s.stats;return{id:s.playHoleId,ordinal:s.ordinal,holeNumber:s.courseHoleNumber,par:e,lengthM:s.lengthM,strokes:i,isPickedUp:n,vsPar:i===null?null:i-e,marker:Zc(i,e),tee:r.teeResult,gir:r.gir,putts:r.putts,firstPutt:r.firstPutt,shortGame:r.shortGameDifficulty,penalties:r.penalties,recoveryOk:r.recoveryOk}}function tu(s){return(s.penalties??0)>0}const cs=10,su=3;function nu(s){const{round:e,holes:t,history:n,windowSize:i=cs,insightLimit:r=su}=s,d=ks([e]),l=d.waterfall,u=iu(e,n,i).map(m=>Xe(m.measures)),f=d.rounds[0];return{roundId:e.roundId,date:e.date,courseName:e.courseName,name:e.name,holeCount:e.holeCount,strokes:f?.strokes??null,vsPar:f?.vsPar??null,cells:[...t].sort((m,h)=>m.ordinal-h.ordinal).map(eu),panels:d,waterfall:l,deltas:u.length===0?null:Ti(l,u),windowCount:u.length,insights:zl(e.measures,l,u,r)}}function iu(s,e,t){const n=e.filter(d=>d.roundId!==s.roundId);n.push(s);const i=Pt(n),r=i.findIndex(d=>d.roundId===s.roundId);return r===-1?[]:i.slice(r+1,r+1+Math.max(0,t))}function gn(s,e,t){const n=Pt(s),i=n.findIndex(r=>r.roundId===e);return i===-1?!1:n.length-(i+1)>=t}function bn(s){const e=(s.name??"").trim();if(e!=="")return e;const t=(s.courseName??"").trim();return t===""?"Round":t}function ru(s){const{signedInPlayerId:e,statConfigPlayerIds:t,statRows:n,holesUnscored:i}=s;return e===null||e===""?{reason:"notSignedIn",playerId:null}:t.has(e)?n.some(d=>d.playerId===e&&au(d))?i!==0?{reason:"roundUnfinished",playerId:null}:{reason:"eligible",playerId:e}:{reason:"noStatsRecorded",playerId:null}:{reason:"noStatsConfigured",playerId:null}}function au(s){return s.teeResult!==null||s.gir!==null||s.firstPutt!==null||s.putts!==null||s.shortGameDifficulty!==null||s.penalties!==null||s.recoveryOk!==null}function ou(s){const{playerId:e,balls:t,groups:n,strokesFor:i}=s,r=t.find(l=>l.players.some(c=>c.playerId===e));if(!r)return null;const d=n.find(l=>l.ballIds.includes(r.id));return d?d.playedOrder.filter(l=>i(r.id,l.playHoleId)===null).length:null}class Ze{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=B.get(ye);inFlight=null;model=new $(()=>{const e=this.round.get();return e===null?null:nu({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await v.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(_n(d)),this.failure.set(yn(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(_n(d)),this.failure.set(yn(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const l of d)n.has(l.roundId)||(n.add(l.roundId),t.push(l))};if(i(this.dashboard.loadedRounds.get()),gn(t,e,cs))return t;let r=null;for(let d=0;d<Ze.MAX_PAGES;d++){const l=await v.playerStats.myStats({limit:Ze.PAGE_SIZE,cursor:r??void 0});if(i(l.rounds),gn(t,e,cs)||l.nextCursor===null)return t;r=l.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function _n(s){if(s instanceof q){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function yn(s){return s instanceof q&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const J=100;function Rt(s){return s>0?"loss":s<0?"gain":"zero"}function He(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function Y(s){return String(Math.round(s*1e3)/1e3)}function Rs(s){return s<0?0:s>1?1:s}function we(s,e){return`<svg class="chart" viewBox="0 0 ${J} ${Y(s)}" preserveAspectRatio="none" style="height:${Y(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function Os(s,e,t,n=1){return`<path d="M${Y(s)} 0 L${Y(s)} ${Y(e)}" stroke="${t}" stroke-width="${Y(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function re(s,e,t,n,i){return`<rect x="${Y(s)}" y="${Y(e)}" width="${Y(t)}" height="${Y(n)}" fill="${i}"/>`}const lu=1;function du(s,e){const t=J/2,n=Rt(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:lu,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function Ki(s,e,t,n=10){const i=du(s,e),r=i.bar&&i.bar.width>0?re(i.bar.x,0,i.bar.width,n,He(i.tone,t)):"";return we(n,[re(0,0,J,n,t.track),r,Os(i.zeroX,n,t.rule)].join(""))}function cu(s){const e=[];let t=0;for(const n of s){const i=J*Rs(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function uu(s,e,t=12){const n=cu(s).filter(i=>i.width>0).map(i=>re(i.x,0,i.width,t,i.color)).join("");return we(t,re(0,0,J,t,e.track)+n)}const vn=2,hu=1e-4;function pu(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=vn,d=Math.max(0,e-vn*2);return s.map((l,c)=>({x:s.length===1?J/2:c/(s.length-1)*J,y:i===0?e/2:r+d-(l-t)/i*d}))}function fu(s){return s.map((e,t)=>`${t===0?"M":"L"}${Y(e.x)} ${Y(e.y)}`).join(" ")}function mu(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=hu?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function gu(s,e,t,n=34){const i=pu(s,n);if(i.length===0)return we(n,"");const r=He(mu(s,e),t),d=`<path d="${fu(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,l=i[i.length-1],c=`<path d="M${Y(l.x)} ${Y(l.y)} L${Y(l.x)} ${Y(l.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return we(n,d+c)}const bu=.5;function _u(s,e,t=8){const n=J/2,i=ee.length-1,r=Math.max(1,(t-i)/ee.length),d=[];return ee.forEach((l,c)=>{const u=Ne(s,l);if(u===null||!(e>0))return;const f=Math.max(u===0?0:bu,n*Math.min(1,Math.abs(u)/e));d.push({component:l,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:Rt(u)})}),d}function yu(s,e,t,n=8){const i=_u(s,e,n).filter(r=>r.width>0).map(r=>re(r.x,r.y,r.width,r.height,He(r.tone,t))).join("");return we(n,Os(J/2,n,t.rule)+i)}const Wi=1,wn=.02;function vu(s,e){const t=e>0?J*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=Rs(s),i=e<=0?"neutral":s>e+wn?"gain":s<e-wn?"loss":"neutral";return{bar:{width:Math.max(Wi,J*n),tone:i},tickX:t}}function wu(s,e,t,n=10){const i=vu(s,e),r=i.bar?re(0,0,i.bar.width,n,He(i.bar.tone,t)):"",d=i.tickX===null?"":Os(i.tickX,n,t.rule,2);return we(n,re(0,0,J,n,t.track)+r+d)}function xu(s){return s===null?null:Math.max(Wi,J*Rs(s))}function $u(s,e,t=e.neutral,n=8){const i=xu(s),r=i===null?"":re(0,0,i,n,t);return we(n,re(0,0,J,n,e.track)+r)}const Ot={gain:o("accent-strong"),loss:o("danger"),zero:o("border-strong"),neutral:o("accent"),track:o("surface-sunken"),rule:o("border")},z={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Strokes lost per round against a fixed baseline, worst first. Positive costs you shots.",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s four waterfall terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function qe(s){return Jl(s)?null:s.value}function oe(s,e,t){return{kind:"bar",id:s,title:e,share:qe(t),value:ce(t)}}function Q(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function ku(s,e){switch(s){case"tee":{const t=e.tee&&se(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&se(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?Ie(e.putting.puttsPerGirHole,{unit:Ri,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&se(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?Ie(e.scoring.doubleBogeyPlusPerRound,{unit:de,label:"doubles or worse per round"}):null}}function Su(s){const e=Xl(s.vsParByTee),t=e?`${z.troubleTax} Measured ${e}.`:z.troubleTax;return Q("troubleTax","Trouble tax",Ts(s.troubleTax,2,!0),t)}function xn(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:qe(t.fairway),value:ce(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:qe(t.inPlayOnly),value:ce(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:qe(t.trouble),value:ce(t.trouble)}]},Su(t),Q("recovery","Recovery",se(t.recovery),z.recovery),Q("penalties","Penalties",Ie(t.penaltiesPerRound,{unit:de}),z.penalties)]:[]}case"approach":{const t=e.approach;return t?[{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},oe("girFairway","From the fairway",t.girByTee.fairway),oe("girInPlay","From in play",t.girByTee.inPlay),oe("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:z.proximityProxy},...Ct.map(n=>oe(`mix-${n}`,nn(n),t.girFirstPuttMix[n])),Q("birdieConversion","Birdie conversion",se(t.birdieConversion),z.birdieConversion)]:[]}case"putting":{const t=e.putting;return t?[{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:z.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:nn(n.bucket),made:qe(n.made),baseline:n.baseline,value:ce(n.made)})),Q("threePutt","Three-putts",se(t.threePutt),z.threePutt),Q("longThreePutt","Three-putts from over 8 m",se(t.threePuttsFromOver8m),z.longThreePutt),Q("puttsPerGir","Putts per green hit",Ie(t.puttsPerGirHole,{unit:Ri}),z.puttsPerGir)]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},oe("scrambleStandard","Standard",t.scramble.standard),oe("scrambleHard","Hard",t.scramble.hard),{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},oe("chipStandard","Standard",t.chipInside2m.standard),oe("chipHard","Hard",t.chipInside2m.hard),Q("conversionInside2m","Holed from inside 2 m",se(t.conversionInside2m),z.conversionInside2m),Q("chipIns","Chip-ins",Re(t.chipIns),z.chipIns)]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>Ie(i,{unit:Ni,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},Q("par3","Par 3",n(t.avgVsParByParGroup.par3)),Q("par4","Par 4",n(t.avgVsParByParGroup.par4)),Q("par5","Par 5",n(t.avgVsParByParGroup.par5)),Q("doubles","Doubles or worse",Ie(t.doubleBogeyPlusPerRound,{unit:de}),z.doubleBogeyPlus),Q("bounceBack","Bounce-back",se(t.bounceBack),z.bounceBack)]}}}function Tu(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function $n(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const U={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},kn={title:"Your round",seeWholeRound:"See the whole round"};function Iu(s){const e=[Li(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function Yi(s,e){return s===null?null:e===null?String(s):`${s} (${Ps(e)})`}function Pu(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function Cu(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function Eu(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Ps(s.vsPar)})`}function Nu(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function Ru(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function Ou(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function zu(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function zs(s){const e=[],t=Eu(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:Nu(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:Ru(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:Ou(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Lu(s){return s===null?[]:zs(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function Sn(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(zu(s.marker).toLowerCase())):e.push("no score");for(const t of zs(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function Qi(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=pe(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function Tn(s){switch(s){case"putting":return"Putting";case"shortGame":return"Your short game";case"penalties":return"Penalties";case"longGame":return"Tee to green"}}function Yt(s,e=1){return typeof s=="number"?pe(Math.abs(s),e):""}function Qt(s){return typeof s=="number"?String(Math.round(s)):""}function In(s){return typeof s=="string"?s:"longGame"}function Hu(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${Tn(In(e.component))} was ${Yt(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${Tn(In(e.component))} cost you ${Yt(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${Yt(e.baseline)} in a normal round.`}case"scramble_streak":return`You saved par ${Qt(e.successes)} of the ${Qt(e.attempts)} times you missed the green.`;case"three_putt_free":return`No three-putts — ${Qt(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Au=_(`
...
`);class ju extends E{static styles=`
    ...
    `;round=this.inject(ae);stats=this.inject(Ze);auth=this.inject(j);router=this.inject(M);colors=Ot;render(){this.track(I(()=>{const i=this.eligibleRoundId();K(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Au,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>kn.title,score:()=>{const i=e();return i===null?"":Yi(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),open:{textContent:()=>kn.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ne(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...ee],(i,r,d)=>this.wireEl(Fu,{label:()=>Et(i),amount:{textContent:()=>{const l=n(i);return l===null?z.notRecorded:Le(l)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const l=n(i);return l===null?"":`color:${He(Rt(l),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl(Mu,{text:()=>Hu(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:ru({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ou({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return U.waterfallHint;let t=null;for(const n of ee){const i=xs(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?U.waterfallHint:Qi(t,e.windowCount)}}function Du(s,e=typeof navigator>"u"?"en":navigator.language){const t=(s?.name??"").trim();if(t)return t;const n=s?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n||"Round"}function Pn(s){return!(!s.pageVisible||s.status==="complete")}function Gu(s,e){return e&&!s}const Bu=2,Cn=3,qu=75e3;function Vu(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${F}/friendly-rounds/events?${t.toString()}`}function Uu(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Ku(s){const e=s.eventSourceFactory??(P=>new EventSource(P)),t=s.setTimer??((P,G)=>setTimeout(P,G)),n=s.clearTimer??(P=>clearTimeout(P)),i=s.livenessTimeoutMs??qu,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,l=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(O,i)},b=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{d=!0,m(),b()},x=()=>{if(b(),++l>=Cn){g(),s.onDegrade();return}D()};function O(){if(!d){if(!r()){h();return}x()}}function D(){if(d)return;let P;try{P=e(Vu(s.token,f))}catch{g(),s.onDegrade();return}c=P,P.onopen=()=>{l=0},P.onmessage=G=>{if(d||c!==P)return;h();let V;try{V=JSON.parse(G.data)}catch{return}Uu(V)&&(V.latestEventId!==null&&(f=V.latestEventId),s.onEvent({latestEventId:V.latestEventId,status:V.status}))},P.onerror=()=>{d||c!==P||(P.readyState===Bu||++l>=Cn)&&(g(),s.onDegrade())},h()}return D(),{stop:()=>{d||g()}}}const Wu=2e4;function Yu(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Qu=_(`
...
`),Xu=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),Ju=_('<button bind="pill" class="round-view__grp" type="button"></button>');class Zu extends E{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Sh extends E{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
            ...
            & .player {
                ...
                & .player__name { ${X()} flex: 1; padding: ${a("md")}; font-size: 1rem; }
                & .player__remove {
                    ${w()}
                ...
                & .player__index { ${X()} flex: 1; min-width: 0; padding: ${a("md")}; font-size: 1rem; }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { ${X()} width: 56px; padding: ${a("xs")} ${a("sm")}; font-size: 0.95rem; }
                    }
                }
                ...
                & .grp__start {
                    ...
                    & .grp__time { ${X()} flex: 1; min-width: 0; padding: ${a("sm")} ${a("md")}; font-size: 1rem; font-family: inherit; }
        ...
        .hcp {
            ...
            & .hcp__cancel { ${w()} flex: 1; padding: ${a("md")}; font-family: inherit; font-weight: 700; font-size: 0.95rem; }
            & .hcp__ok {
                ${w()}
...
`);class Lh extends E{static styles=`
        .friends {
    ...
    `;svc=this.inject(Tt);auth=this.inject(j);router=this.inject(M);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Rh,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:i=>this.svc.setQuery(i.target.value)},searchHint:{textContent:()=>{const i=this.svc.query.get().trim();return i.length>0&&!Vs(i)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const i=this.svc.query.get().trim();return Vs(i)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===i&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(i,r,d)=>this.wireEl(Oh,{...ve(()=>this.svc.results.get().find(l=>l.id===i.id)??i),name:()=>i.displayName,username:()=>i.homeClubName?`@${i.username} · ${i.homeClubName}`:`@${i.username}`,hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(i.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const l=this.svc.results.get().find(c=>c.id===i.id);l&&!l.isFriend&&this.svc.add(l)}},added:{className:()=>this.isFriendNow(i.id)?"friend-row__added":"friend-row__added hidden"}},d),i=>i.id);const n=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>gs(this.svc.friends.get(),this.svc.sortMode.get()),(i,r,d)=>this.wireEl(zh,{...ve(()=>this.svc.friends.get().find(l=>l.id===i.id)??i),open:{disabled:()=>!this.liveFriend(i).isMutual,onclick:()=>{const l=this.liveFriend(i);l.isMutual&&this.router.navigate("/friend",{query:{id:i.id,name:l.displayName}})}},name:()=>i.displayName,subtitle:()=>{const l=this.svc.friends.get().find(c=>c.id===i.id)??i;return Qa(l,n)},hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(i.id)}}},d),i=>i.id),t}liveFriend(e){return this.svc.friends.get().find(t=>t.id===e.id)??e}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Zi=_(`
...
`);function er(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>co(s),subtitle:()=>uo(s,he),progress:()=>ho(s)}}function tr(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class Ah extends E{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(It);activity=this.inject(bs);auth=this.inject(j);router=this.inject(M);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();K(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new $(()=>{const h=e.get();return h?ao(this.activity.feed.get(),h):null}),l=()=>this.svc.unavailable.get(),c=()=>n()&&l()===null&&i()!==null,u=()=>n()&&l()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(Hh,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&l()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=l();return h?Ee[h].title:""}},refusalMsg:{textContent:()=>{const h=l();return h?Ee[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...ve(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?po(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?oo(h):""},onclick:()=>{const h=d.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>mo(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,b,g)=>this.wireEl(Zi,er(h,f),g),h=>h.roundId),m}}const Mh=_(`
    <div class="frounds">
...
`);class Gh extends E{static styles=`
    ...
    `;svc=this.inject(It);auth=this.inject(j);router=this.inject(M);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();K(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],d=()=>(t.get()??"").trim(),l=this.wire(jh,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}})},subtitle:{textContent:()=>{const c=d();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ee[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ee[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(d())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(l,"list"),r,(c,u,f)=>this.wireEl(Dh,{name:()=>c.courseName??"Course",facts:()=>fo(c,he)},f),c=>c.courseId),l}}function Bh(s,e,t){const n=et(e);if(n){const l=Hn(s);return l?`Watching · ${l} ${n}`:`Watching · ${n}`}const i=Hn(s)??"this",r=et(t),d=r?` at ${r}`:"";return`Watching · ${i} round${d}`}function qh(s,e,t,n){const i=et(s)===null?null:et(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Vh="You're watching this round. Only its players can enter scores.",Ln={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Hn(s){const e=et(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function et(s){return(s??"").trim()||null}const Uh=_(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${Vh}</p>
        </div>
    </div>
`);class Kh extends E{static styles=`
        .spectate {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${Ui.styles}
    `;svc=this.inject(mi);auth=this.inject(j);router=this.inject(M);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();K(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim()||null;return this.wire(Uh,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(d()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Ln[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Ln[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Bh(d(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?qh(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>he(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const d=i.length>1?`<h2 class="spectate__slot-head">${Wh(r.formatLabel)}</h2>`:"",l=qi(r,t,n),c=Vi(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return d+l+u}).join("")}}function Wh(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const Yh=_(`
    <div class="profile">
...
`);class Jh extends E{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { ${X()} width: 90px; padding: ${a("md")}; font-size: 1rem; text-align: center; }
                    & button {
                        ${w()}
...
`),ep=_('<h3 bind="text" class="block__subhead"></h3>'),tp=_('<p bind="text" class="block__note"></p>'),sp=_(`
...
`),ap=_('<div bind="panels" class="statspanels"></div>');class sr extends E{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
...
`);class hp extends E{static styles=`
        .stats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(ye);auth=this.inject(j);router=this.inject(M);filterOpen=new p(!1);colors=Ot;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(op,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>z.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>z.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>z.prioritiesHint,trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>z.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>z.roundsHint,pickHint:()=>n()?z.filterRoundsHint:""});return this.setHeading(i,"prioritiesSec",z.priorities),this.setHeading(i,"trendsSec",z.trends),this.setHeading(i,"roundsSec",z.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,l)=>this.wireEl(dp,{title:()=>Et(r.component),subtitle:()=>ed(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.perRound===null||c===void 0?"":Ki(c.perRound,Vl(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.perRound!==null?Zl(c.perRound):z.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.perRound===null?Tu(c.roundsInWindow):`over ${ne(c.roundsCovered,de)}`:""}}},l),r=>r.component),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,l)=>this.wireEl(cp,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return gu(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return pp(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ne(c.points.length,de)}}},l),r=>r.id),this.spawn(sr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,l)=>this.wireEl(up,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${$n(r)} — hole by hole`},label:()=>$n(r),subtitle:()=>fp(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(Xo(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return yu(c.waterfall,Ei(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Ps(c.vsPar)}}},l),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(I(()=>t.set(this.svc.preset.get()))),this.track(I(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${_t(r)} — ${Wo(r)}`}),i=new te({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:_t("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(An,{chip:{textContent:()=>td(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(Gt(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(An,{chip:{textContent:()=>sd(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(Gt(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(lp,{name:()=>i.name,count:()=>ne(i.roundCount,de),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(Gt(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ne(e,de):`${pe(e,0)} of ${ne(t,de)}`}statusLine(){const e=this.svc.extendError.get();return e?`${z.extendProblemPrefix}${e.message}`:this.svc.extending.get()?z.extending:this.svc.budgetSpent()?z.budgetSpent:this.svc.loading.get()?z.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?z.windowEmpty:this.svc.loadedCount()===0?z.noStats:""}}function pp(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:Le(e)}function fp(s){const e=[Li(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${pe(s.holeCount,0)} holes`),e.join(" · ")}const mp=_(`
...
`),yp=_('<li bind="text" class="roundstats__legenditem"></li>');function vp(){const s=[];for(const[e,t]of Object.entries(Es))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class wp extends E{static styles=`
        .roundstats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Ze);auth=this.inject(j);router=this.inject(M);colors=Ot;openHole=new p(null);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(I(()=>{const r=e.get();K(()=>{this.openHole.set(null),r&&this.svc.load(r)})}));const i=this.wire(mp,{back:{onclick:()=>this.router.navigate("/stats")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":bn(t()),subtitle:()=>this.subtitle(),score:()=>{const r=t();return r===null?"":Yi(r.strokes,r.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>U.waterfallHeading,wfHint:()=>U.waterfallHint,legendHeading:()=>U.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const r=this.selected();return r===null?"":Pu(r)},detailEmpty:()=>{const r=this.selected();return r===null?"":zs(r).length===0?U.nothingRecordedOnHole:""}});return this.setHeading(i,"stripSec",U.holeStripHeading),this.$each(this.ref(i,"strip"),()=>t()?.cells??[],(r,d,l)=>this.wireEl(gp,{cell:{className:()=>{const c=this.cellNow(r.id)??r;return c.marker===null?"cell":`cell cell--${c.marker}`},"aria-pressed":()=>String(this.openHole.get()===r.id),"aria-label":()=>Sn(this.cellNow(r.id)??r),title:()=>Sn(this.cellNow(r.id)??r),onclick:()=>this.openHole.set(this.openHole.get()===r.id?null:r.id)},hole:()=>String((this.cellNow(r.id)??r).holeNumber),score:()=>Cu(this.cellNow(r.id)??r),tee:{className:()=>(this.cellNow(r.id)??r).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const c=this.cellNow(r.id)??r;return c.tee===null?"":`background:${this.teeColor(c.tee)}`}},gir:{className:()=>{const c=this.cellNow(r.id)??r;return c.gir===null?"cell__gir cell__gir--absent":c.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const c=this.cellNow(r.id)??r;return c.putts===null?"":String(c.putts)},pen:{className:()=>tu(this.cellNow(r.id)??r)?"cell__pen":"cell__pen cell__pen--absent"}},l),r=>r.id),this.$each(this.ref(i,"detailLines"),()=>Lu(this.selected()),(r,d,l)=>this.wireEl(bp,{label:()=>r.label,value:()=>r.value},l),r=>r.key),this.$each(this.ref(i,"deltas"),()=>{const r=t();return r===null?[]:ee.filter(d=>Ne(r.waterfall,d)!==null)},(r,d,l)=>this.wireEl(_p,{title:()=>Et(r),sentence:()=>{const c=t();if(c===null||c.deltas===null)return"";const u=xs(c.deltas,r);return u===null?"":Qi(u,c.windowCount)},value:{textContent:()=>{const c=this.componentValue(r);return c===null?"":Le(c)},style:()=>{const c=this.componentValue(r);return c===null?"":`color:${He(Rt(c),this.colors)}`}},bar:{innerHTML:()=>{const c=t(),u=this.componentValue(r);return c===null||u===null?"":Ki(u,Ei([c.waterfall]),this.colors)}}},l),r=>r),this.spawn(sr,this.ref(i,"panels"),{model:()=>t()?.panels??Ci}),this.$each(this.ref(i,"legend"),()=>[U.legendTee,U.legendGir,U.legendPutts,U.legendPenalty,U.legendAbsence],(r,d,l)=>this.wireEl(yp,{text:()=>r},l),r=>r),i}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Ne(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":Iu({...e,title:bn(e)})}stateLine(){if(this.auth.currentUser.get()===null)return U.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return U.loading;case"notFound":return U.noStatsInRound;case"notAuthorized":return U.notSignedIn;case"failed":return`${U.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?U.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const xp=_(`
    <div class="admin">
...
`),Tp={not_started:"Not started",active:"Playing",complete:"Done"};function Ip(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Pp(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Cp extends E{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class zp extends E{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
            ...
            & .comps__create {
                ...
                gap: ${a("sm")};
                margin-bottom: ${a("md")};
                & input { ${X()} flex: 1; padding: ${a("md")}; font-size: 1rem; }
                & button {
                    ${w()}
                    padding: ${a("md")} ${a("lg")};
...
`),qp=_('<button bind="chip" class="cd__friendchip" type="button"></button>');class Vp extends E{competitions=this.inject(ke);state=this.inject(st);render(){const e=()=>this.state.id.get()??"",t=this.wire(Gp,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&us(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(Bp,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&us(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(qp,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(d=>d.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const Up={not_started:"Not started",active:"Live",complete:"Finished"},Kp=_(`
    <section class="cd__section">
...
`),Yp=_('<option bind="option"></option>');class Qp extends E{competitions=this.inject(ke);state=this.inject(st);router=this.inject(M);render(){const e=new $(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Kp,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Np(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(Yp,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(Wp,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>Up[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Xp(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function Jp(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const Zp=_(`
    <div>
...
`),ef=_('<button bind="button" type="button"></button>'),tf=_('<th bind="cell"></th>'),sf=_('<tr bind="row"></tr>'),nf=_('<td bind="cell"><span bind="value"></span></td>'),rf=_(`
...
`);class df extends E{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${a("xs")};
                    ...
                    & input, & select { ${X()} padding: ${a("sm")} ${a("md")}; font-size: 0.95rem; }
                }
    ...
    `;competitions=this.inject(ke);state=this.inject(st);router=this.inject(M);render(){const e=()=>this.competitions.detail.get();this.track(I(()=>{const n=this.state.id.get();n&&K(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(lf,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>nr(this.state.lifecycle.get()),className:()=>ir(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&Zt(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>Zt(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=Zt(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(Dp,this.ref(t,"setup")),this.spawn(Vp,this.ref(t,"roster")),this.spawn(Qp,this.ref(t,"rounds")),this.spawn(of,this.ref(t,"results")),t}}const cf=_(`
    <div class="app-shell">
...
`);class uf extends E{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(M);render(){const e=this.wire(cf,{header:{className:()=>ms(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(gd,this.ref(e,"account")),this.spawn(Ea,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":ln,"/history":zd,"/round":Zu,"/create":Sh,"/login":Nh,"/friends":Lh,"/friend":Ah,"/friend-rounds":Fh,"/friend-courses":Gh,"/spectate":Kh,"/profile":Jh,"/stats":hp,"/round-stats":wp,"/admin":Cp,...ti.competitions?{"/competitions":zp,"/competition":df}:{}},ln),e}}class hf extends j{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Ji(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await Th()),this.error.set(null)}catch(e){e instanceof q&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Ih(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof q&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await Ph();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof q&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}B.get($r);const Mn=B.get(M);B.set(j,new hf);const Fn=B.get(j);await Ir(uf,"#app",{hot:void 0,onInit:async()=>{await Fn.load(),Fn.currentUser.get()&&Mn.route.get()==="/login"&&Mn.navigate("/",!0)}});export{es as A,E as C,M as R,p as S,$r as T,y as a,Ye as b,$ as c,fr as d,I as e,pr as n,A as r,_ as t};
