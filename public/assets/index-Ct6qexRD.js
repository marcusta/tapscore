(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const i of n)if(i.type==="childList")for(const l of i.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const i={};return n.integrity&&(i.integrity=n.integrity),n.referrerPolicy&&(i.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?i.credentials="include":n.crossOrigin==="anonymous"?i.credentials="omit":i.credentials="same-origin",i}function s(n){if(n.ep)return;n.ep=!0;const i=t(n);fetch(n.href,i)}})();const Dt="modulepreload",Mt=function(r){return"/tapscore/"+r},Fe={},Ht=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let u=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");n=u(t.map(c=>{if(c=Mt(c),c in Fe)return;Fe[c]=!0;const m=c.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":Dt,m||(g.as="script"),g.crossOrigin="",g.href=c,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((x,v)=>{g.addEventListener("load",x),g.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function i(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return n.then(l=>{for(const d of l||[])d.status==="rejected"&&i(d.reason);return e().catch(i)})};class Ft{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){dt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const V=new Ft;function dt(r){for(const e of r.deps)e.delete(r);r.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return V.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,V.notify(this.subs))}update(e){this.set(e(this.val))}}class y{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){V.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,V.notify(t.subs))})},deps:new Set};s.run()}get(){return V.subscribe(this.subs),this.val}peek(){return this.val}}function S(r){const e={run(){V.runTracked(e,r)},deps:new Set};return e.run(),()=>dt(e)}function oe(r){V.batch(r)}function K(r){return V.untrack(r)}class At{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const P=new At,ne="/tapscore/".replace(/\/+$/,"");function ke(r){return ne?r===ne?"/":r.startsWith(ne+"/")?r.slice(ne.length):r:r}function Bt(r){return ne+r}class N{constructor(){this.route=new h(ke(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>oe(()=>{this.route.set(ke(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),i=n>=0?e.slice(n):"",l=n>=0?e.slice(0,n):e,d=l.indexOf("?"),u=d>=0?l.slice(0,d):l,c=d>=0?l.slice(d+1):"",m=s.query!==void 0?Gt(s.query):c?"?"+c:"",p=Bt(u)+m+i;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),oe(()=>{this.route.set(u),this.search.set(m)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new y(()=>{const s=this.route.get().split("/"),n={};for(const[i,l]of t.entries())l.startsWith(":")&&(n[l.slice(1)]=s[i]??"");return n})}query(e){return new y(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new y(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Gt(r){const e=new URLSearchParams;for(const[s,n]of Object.entries(r))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function qt(r){return e=>r[e]}function Kt(r,e){const t=(n,i,l)=>{const d=Object.entries(n).map(([u,c])=>`--${u}:${c}`).join(";");return`${i}{color-scheme:${l};${d}}`},s=document.createElement("style");return s.textContent=t(r,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const Ae="basics-js-theme";class Vt{constructor(){this.dark=new h(!1);const e=localStorage.getItem(Ae),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),S(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(Ae,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(r){const e=document.createElement("template");return e.innerHTML=r,e}function Wt(r,e){let t;for(const s of Object.keys(e))r.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const Be=new Set;class I{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Be.has(t)){Be.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return P.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=K(()=>{const i=new e(s[0]);return i.mount(t),i});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(l=>this.track(l)),i=e.content.cloneNode(!0);for(const l of i.querySelectorAll("[bind]")){const d=t[l.getAttribute("bind")];if(d)if(typeof d=="function")n(S(()=>{const u=d();l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement?l.value=String(u):l.textContent=String(u)}));else for(const[u,c]of Object.entries(d)){const m=u.includes("-");u.startsWith("on")&&typeof c=="function"?l.addEventListener(u.slice(2),c):typeof c=="function"?n(S(()=>{const p=c();m?l.setAttribute(u,String(p)):l[u]=p})):m?l.setAttribute(u,String(c)):l[u]=c}}return i}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof I?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(i,l,...d)=>this.spawn(i,l,...d),track:i=>this.track(i)}),!0):!1}$each(e,t,s,n=(i,l)=>l){const i=typeof t=="function"?t:()=>t.get(),l=new Map,d=new Map;this.track(()=>{for(const u of d.values())u.forEach(c=>c());d.clear()}),this.track(S(()=>{const u=i(),c=new Map;for(const[p,g]of u.entries()){const x=n(g,p);if(l.has(x))c.set(x,l.get(x));else{const v=[];c.set(x,K(()=>s(g,p,$=>v.push($)))),d.set(x,v)}}for(const[p,g]of l)c.has(p)||(g.remove(),d.get(p)?.forEach(x=>x()),d.delete(p));let m=e.firstChild;for(const p of c.values())p===m?m=m.nextSibling:e.insertBefore(p,m);l.clear();for(const[p,g]of c)l.set(p,g)}))}$condition(e,t,s,n){let i=null;this.track(S(()=>{i&&(i.remove(),i=null);const l=t.get();i=K(()=>l?s():n?.()??null),i&&e.appendChild(i)}))}$swap(e,t,s,n){let i=null;this.track(S(()=>{i&&(i.destroy(),i=null),e.textContent="";const l=t.get(),d=s[l]??Wt(l,s)??n;d&&(i=K(()=>{const u=new d;return u.mount(e),u}))})),this.track(()=>i?.destroy())}}async function Ut(r,e,t){const s=document.querySelector(e);s.textContent="";const n=P.get(N);let i=null,l=!1,d=null,u=!!t?.hot?.data.hmr;const c=async m=>{i&&(i.destroy(),i=null,s.textContent=""),m?(d||(d=(await Ht(()=>import("./obs-shell.component-Di2loKot.js"),[])).ObsShellComponent),i=K(()=>new d)):(!u&&t?.onInit&&(await t.onInit(),u=!0),i=K(()=>new r)),K(()=>i.mount(s)),l=m};await c(ke(location.pathname).startsWith("/_obs")),S(()=>{const m=n.route.get().startsWith("/_obs");m!==l&&c(m)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>i?.destroy()),t.hot.accept())}class F extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Yt=10,me=[];let fe=[],ie=null;function Qt(r){me.push(r),me.length>Yt&&me.shift()}function Xt(r,e,t){const s={code:r,message:e,url:typeof location<"u"?location.href:"",context:[...me],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),fe.push(s),Jt()}function Jt(){ie||(ie=setTimeout(ct,5e3))}function ct(){if(ie&&(clearTimeout(ie),ie=null),fe.length===0)return;const r=fe;fe=[];for(const e of r){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ct()});const Zt=3e4,es=2,ce=new Map,ut=new WeakMap;function ts(r){if(r instanceof F)return r.traceId;if(r!=null&&typeof r=="object")return ut.get(r)}async function f(r){if(r.method==="GET"){const e=ce.get(r.url);if(e)return e;const t=Ge(r,es);return ce.set(r.url,t),t.then(()=>ce.delete(r.url),()=>ce.delete(r.url)),t}return Ge(r,0)}async function Ge(r,e){const t=r.timeout??Zt;let s;for(let n=0;n<=e;n++){const i=crypto.randomUUID();try{return await ns(ss(r,i),t)}catch(l){if(s=l,!(l instanceof F)&&l!=null&&typeof l=="object"&&ut.set(l,i),l instanceof F||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function ss(r,e){const t={"X-Trace-Id":e},s={method:r.method,headers:t};r.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(r.body));const n=await fetch(r.url,s),i=n.headers.get("x-trace-id")??e;if(Qt({type:"api",detail:`${r.method} ${r.url}`,timestamp:new Date().toISOString()}),!n.ok){const l=await n.json().catch(()=>({error:n.statusText}));throw new F(n.status,l.error??n.statusText,l.details,i)}return n.json()}function ns(r,e){let t;const s=new Promise((n,i)=>{t=setTimeout(()=>i(new Error("Request timeout")),e)});return Promise.race([r,s]).finally(()=>clearTimeout(t))}async function T(r,e,t){oe(()=>{r.set(!0),e.set(null)});try{const s=await t();return r.set(!1),s}catch(s){const n=is(s);oe(()=>{r.set(!1),e.set(n)}),Xt(n.code,n.message,ts(s));return}}function is(r){return r instanceof F?r.status===401?{code:"auth",message:"Unauthorized"}:r.status===409?{code:"conflict",message:"Data has changed — please try again"}:r.status===400?{code:"validation",message:r.message}:{code:"server",message:"Server error"}:r instanceof Error?r.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function rs(r){return{me:()=>f({method:"GET",url:`${r}/auth/me`}),login:e=>f({method:"POST",url:`${r}/auth/login`,body:e}),logout:()=>f({method:"POST",url:`${r}/auth/logout`,body:{}})}}class D{constructor(){this.api=rs("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await T(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await T(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await T(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const qe={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},o=Kt({...qe,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...qe,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),O=r=>`var(--${r})`,a=qt({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),w=(r=O("radius"))=>`
...
`;function os(r){return{async me(){return f({method:"GET",url:`${r}/players/me`})},async register(e){return f({method:"POST",url:`${r}/players/register`,body:e})},async updateHandicap(e){return f({method:"POST",url:`${r}/players/me/handicap`,body:e})},async myHandicapHistory(){return f({method:"GET",url:`${r}/players/me/handicap-history`})},async updateProfile(e){return f({method:"POST",url:`${r}/players/me/profile`,body:e})},async search(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/players/search${s?"?"+s:""}`})}}}function as(r){return{async list(){return f({method:"GET",url:`${r}/friends`})},async add(e){return f({method:"POST",url:`${r}/friends`,body:e})},async remove(e){return f({method:"DELETE",url:`${r}/friends/${e.friendId}`})}}}function ls(r){return{async list(){return f({method:"GET",url:`${r}/clubs`})},async get(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/clubs/get${s?"?"+s:""}`})},async create(e){return f({method:"POST",url:`${r}/clubs`,body:e})},async update(e){return f({method:"POST",url:`${r}/clubs/update`,body:e})},async remove(e){return f({method:"DELETE",url:`${r}/clubs/${e.id}`})}}}function ds(r){return{async list(){return f({method:"GET",url:`${r}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/courses/by-club${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/courses/get${s?"?"+s:""}`})},async create(e){return f({method:"POST",url:`${r}/courses`,body:e})},async update(e){return f({method:"POST",url:`${r}/courses/update`,body:e})},async updateHole(e){return f({method:"POST",url:`${r}/courses/holes/update`,body:e})},async validate(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/courses/validate${s?"?"+s:""}`})},async remove(e){return f({method:"DELETE",url:`${r}/courses/${e.id}`})}}}function cs(r){return{async listByCourse(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/tees/by-course${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/tees/get${s?"?"+s:""}`})},async create(e){return f({method:"POST",url:`${r}/tees`,body:e})},async update(e){return f({method:"POST",url:`${r}/tees/update`,body:e})},async remove(e){return f({method:"DELETE",url:`${r}/tees/${e.id}`})}}}function us(r){return{async create(e){return f({method:"POST",url:`${r}/guest-players`,body:e})}}}function hs(r){return{async latest(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/handicap/latest${s?"?"+s:""}`})},async history(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/handicap/history${s?"?"+s:""}`})},async record(e){return f({method:"POST",url:`${r}/handicap/record`,body:e})}}}function ps(r){return{async list(){return f({method:"GET",url:`${r}/rounds`})},async balls(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/rounds/balls${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/rounds/get${s?"?"+s:""}`})},async create(e){return f({method:"POST",url:`${r}/rounds`,body:e})},async createFromDraft(e){return f({method:"POST",url:`${r}/rounds/from-draft`,body:e})},async update(e){return f({method:"POST",url:`${r}/rounds/update`,body:e})},async remove(e){return f({method:"DELETE",url:`${r}/rounds/${e.id}`})}}}function ms(r){return{async listByRound(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/score-events/by-round${s?"?"+s:""}`})},async append(e){return f({method:"POST",url:`${r}/score-events`,body:e})}}}function fs(r){return{async forBall(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/scorecards/for-ball${s?"?"+s:""}`})},async forRound(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/scorecards/for-round${s?"?"+s:""}`})}}}function gs(r){return{async forRound(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/leaderboards/for-round${s?"?"+s:""}`})}}}function bs(r){return{async create(e){return f({method:"POST",url:`${r}/friendly-rounds`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/friendly-rounds/by-token${s?"?"+s:""}`})},async balls(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/friendly-rounds/balls${s?"?"+s:""}`})},async scorecard(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/friendly-rounds/scorecard${s?"?"+s:""}`})},async result(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/friendly-rounds/result${s?"?"+s:""}`})},async score(e){return f({method:"POST",url:`${r}/friendly-rounds/score`,body:e})},async setup(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/friendly-rounds/setup${s?"?"+s:""}`})},async editSetup(e){return f({method:"POST",url:`${r}/friendly-rounds/setup`,body:e})},async remove(e){return f({method:"DELETE",url:`${r}/friendly-rounds/${e.token}`})},async finish(e){return f({method:"POST",url:`${r}/friendly-rounds/finish`,body:e})},async reopen(e){return f({method:"POST",url:`${r}/friendly-rounds/reopen`,body:e})},async join(e){return f({method:"POST",url:`${r}/friendly-rounds/join`,body:e})},async leave(e){return f({method:"POST",url:`${r}/friendly-rounds/leave`,body:e})},async claimGuest(e){return f({method:"POST",url:`${r}/friendly-rounds/claim-guest`,body:e})}}}function _s(r){return{async myRounds(){return f({method:"GET",url:`${r}/dashboard/my-rounds`})}}}function ys(r){return{async courses(){return f({method:"GET",url:`${r}/setup/courses`})},async teesByCourse(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/setup/tees/by-course${s?"?"+s:""}`})},async formats(){return f({method:"GET",url:`${r}/setup/formats`})},async aggregations(){return f({method:"GET",url:`${r}/setup/aggregations`})}}}function vs(r){return{async get(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/competitions/get${s?"?"+s:""}`})},async participants(e){const t=new URLSearchParams;for(const[n,i]of Object.entries(e))i!==void 0&&t.set(n,String(i));const s=t.toString();return f({method:"GET",url:`${r}/competitions/participants${s?"?"+s:""}`})},async leaderboard(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[i,l]of Object.entries(e))!t.has(i)&&l!==void 0&&s.set(i,String(l));const n=s.toString();return f({method:"GET",url:`${r}/competitions/${e.id}/leaderboard${n?"?"+n:""}`})},async results(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[i,l]of Object.entries(e))!t.has(i)&&l!==void 0&&s.set(i,String(l));const n=s.toString();return f({method:"GET",url:`${r}/competitions/${e.id}/results${n?"?"+n:""}`})},async list(){return f({method:"GET",url:`${r}/competitions`})},async create(e){return f({method:"POST",url:`${r}/competitions`,body:e})},async update(e){return f({method:"POST",url:`${r}/competitions/update`,body:e})},async transition(e){return f({method:"POST",url:`${r}/competitions/transition`,body:e})},async createRound(e){const t=new Set(["id"]),s={};for(const[n,i]of Object.entries(e))t.has(n)||(s[n]=i);return f({method:"POST",url:`${r}/competitions/${e.id}/rounds`,body:s})},async applyCut(e){const t=new Set(["id"]),s={};for(const[n,i]of Object.entries(e))t.has(n)||(s[n]=i);return f({method:"POST",url:`${r}/competitions/${e.id}/cut`,body:s})},async finalize(e){const t=new Set(["id"]),s={};for(const[n,i]of Object.entries(e))t.has(n)||(s[n]=i);return f({method:"POST",url:`${r}/competitions/${e.id}/finalize`,body:s})},async addParticipant(e){return f({method:"POST",url:`${r}/competitions/participants/add`,body:e})},async removeParticipant(e){return f({method:"POST",url:`${r}/competitions/participants/remove`,body:e})},async withdrawParticipant(e){return f({method:"POST",url:`${r}/competitions/participants/withdraw`,body:e})}}}const j="/tapscore/".replace(/\/+$/,"")+"/api",_={players:os(j),friends:as(j),clubs:ls(j),courses:ds(j),tees:cs(j),guestPlayers:us(j),handicap:hs(j),rounds:ps(j),scoreEvents:ms(j),scorecards:fs(j),leaderboards:gs(j),friendlyRounds:bs(j),dashboard:_s(j),setup:ys(j),competitions:vs(j)};function ws(r){return[...r.played?["Played"]:[],...r.created?["Created"]:[]].join(" · ")}function xs(r,e){const t=new Map;for(const s of e)t.set(s.round.id,{round:s.round,token:s.friendlyRound.shareToken,played:!1,created:!0});for(const s of r){const n=t.get(s.round.id);n?n.played=!0:t.set(s.round.id,{round:s.round,token:s.shareToken,played:!0,created:!1})}return[...t.values()].sort((s,n)=>n.round.date.localeCompare(s.round.date)||s.round.id.localeCompare(n.round.id))}function $s(r,e){return r.filter(t=>t.played&&!t.created&&!e.has(t.round.id)).slice().sort((t,s)=>s.round.date.localeCompare(t.round.date)||t.round.id.localeCompare(s.round.id))}function Ke(r,e){return r.some(t=>t.round.id===e)?r.filter(t=>t.round.id!==e):r}const ht="tapscore.seen-rounds.v1",ks=500;function be(){try{return typeof localStorage<"u"?localStorage:null}catch{return null}}function Ee(r=be()){if(!r)return[];let e;try{e=r.getItem(ht)}catch{return[]}if(!e)return[];try{const t=JSON.parse(e);return Array.isArray(t)?t.filter(s=>typeof s=="string"):[]}catch{return[]}}function Ve(r=be()){return new Set(Ee(r))}function pt(r,e){try{r.setItem(ht,JSON.stringify(e))}catch{}}function Ss(r,e=be()){if(!e)return[];const t=Ee(e).filter(n=>n!==r),s=[r,...t].slice(0,ks);return pt(e,s),s}function mt(r,e=be()){if(!e)return[];const t=Ee(e),s=t.filter(n=>n!==r);return s.length!==t.length&&pt(e,s),s}const ft="tapscore.device-rounds.v1",Is=50;function Ce(){try{return typeof localStorage<"u"?localStorage:null}catch{return null}}function Ne(r=Ce()){if(!r)return[];let e;try{e=r.getItem(ft)}catch{return[]}if(!e)return[];try{const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ts):[]}catch{return[]}}function Ts(r){if(typeof r!="object"||r===null)return!1;const e=r;return typeof e.token=="string"&&typeof e.courseName=="string"&&(e.status==="not_started"||e.status==="active"||e.status==="complete")&&typeof e.lastSeenAt=="string"}function gt(r,e){try{r.setItem(ft,JSON.stringify(e))}catch{}}function ge(r,e=Ce()){if(!e)return[];const t=Ne(e).filter(n=>n.token!==r.token),s=[r,...t].slice(0,Is);return gt(e,s),s}function bt(r,e=Ce()){if(!e)return[];const t=Ne(e),s=t.filter(n=>n.token!==r);return s.length!==t.length&&gt(e,s),s}class Pe{mine=new h(null);mineLoading=new h(!1);mineError=new h(null);myRounds=new y(()=>{const e=this.mine.get();return e?xs(e.produced,e.created):[]});deviceRounds=new h([]);seenIds=new h(Ve());newRounds=new y(()=>$s(this.myRounds.get(),this.seenIds.get()));async loadMine(){this.seenIds.set(Ve());const e=await T(this.mineLoading,this.mineError,()=>_.dashboard.myRounds());e&&this.mine.set(e)}loadDevice(){this.deviceRounds.set(Ne())}async remove(e,t){try{await _.friendlyRounds.remove({token:e})}catch{return!1}const s=this.mine.get();return s&&this.mine.set({produced:Ke(s.produced,t),created:Ke(s.created,t)}),this.deviceRounds.set(bt(e)),mt(t),!0}}const Es=b(`
...
`);class Cs extends I{static styles=`
        .tabbar {
            display: flex;
    ...
    `;let B=Le;function Ns(r){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function _t(){return Ns()}class ae{loading=new h(!1);error=new h(null);descriptors=new h([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await T(this.loading,this.error,()=>_.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=_t()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=this.byId(e);return!t||this.isSideFormat(e)?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function yt(r){const e=P.get(ae);return e.load(),e.labelOf(r.formatId)??`${r.scoringMode} · ${r.teamShape}`}function Ps(r){return r.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:ws(e)||null,date:e.round.date,formats:e.round.formatSlots.map(yt).join(" · ")}))}function zs(r){return r.map(e=>({key:e.token,token:e.token,roundId:null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:null,formats:null}))}const re={fromMyRounds:Ps,fromDeviceRounds:zs},js=14,Rs=1440*60*1e3;function te(r,e){return e(r)}function Os(r,e,t,s=js){const n=e-s*Rs,i=[],l=[];for(const d of r){const u=te(d,t);if(u.status==="complete"){const c=u.completedAt?Date.parse(u.completedAt):NaN;(Number.isNaN(c)||c>=n)&&l.push(d)}else i.push(d)}return i.sort((d,u)=>We(te(d,t).lastActivityAt,te(u,t).lastActivityAt)),l.sort((d,u)=>We(te(d,t).completedAt,te(u,t).completedAt)),{ongoing:i,finished:l}}function We(r,e){const t=r?Date.parse(r):NaN,s=e?Date.parse(e):NaN,n=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,i=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return n===i?0:i-n}const Ls=b(`
    <div class="landing">
...
`),Ds='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Ms=b(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Ds}</button>
    </div>
`),vt={not_started:"Not started",active:"Live",complete:"Finished"};class Ue extends I{static styles=`
        .landing {
...
`),As='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Bs=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${As}</button>
    </div>
`);class Gs extends I{static styles=`
    ...
    `;svc=this.inject(Pe);auth=this.inject(D);router=this.inject(N);loggedIn=new y(()=>this.auth.currentUser.get()!==null);rows=new y(()=>Hs(this.loggedIn.get()?re.fromMyRounds(this.svc.myRounds.get()):re.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new h(!1);deleteTarget=new h(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(Fs,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(s,n,i)=>this.roundRow(s,i),s=>s.key),this.spawn(B,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const s=this.deleteTarget.get();return`Delete ${s?`“${s.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const s=this.deleteTarget.get();s&&this.svc.remove(s.token,s.roundId)}});const t=s=>{s.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(Bs,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},course:()=>e.courseName||"Round",role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>vt[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>e.date??"",formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",e.courseName||"this round")}}},t)}}const qs=180,Qe=4,Ks=12;function Z(r,e){return e<=0?0:Math.max(0,Math.min(e-1,r))}function Vs(r){const{dragDistance:e,velocity:t,itemWidth:s}=r;if(Math.abs(e)<Ks)return 0;const n=e+t*qs,i=Math.round(-n/s);return Math.max(-Qe,Math.min(Qe,i))}const Xe="tapscore:pending-scores:v1",Ws=336*60*60*1e3,Je=200;function Us(){try{return globalThis.localStorage??null}catch{return null}}function Ys(r){if(typeof r!="object"||r===null)return!1;const e=r;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Qs{entries=[];storage;constructor(e=Us(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=Ws);return t.length>Je?t.slice(t.length-Je):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Xe);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ys):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Xe,JSON.stringify(this.entries))}catch{}}}const Xs=["1st","2nd","3rd","4th","5th","6th","7th","8th"],U=(r,e)=>`${r}|${e}`;function wt(r){return r.players.map(e=>e.displayName).join(" & ")||r.label||"Ball"}function Js(r,e,t){return r?!(r.minPar!==void 0&&e<r.minPar||r.maxPar!==void 0&&e>r.maxPar||r.pars&&!r.pars.includes(e)||r.holes&&!r.holes.includes(t)):!0}class ee{constructor(e=new Qs){this.queue=e}queue;loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);startList=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);resultCursor=null;holeIdx=new h(0);groupIdx=new h(0);selectedSlot=new h(null);token=null;loadSeq=0;resultSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const n=++this.loadSeq;s&&this.resetForNewToken(t),P.get(ae).load();const i=await T(this.loading,this.error,()=>_.friendlyRounds.byToken({token:e}));if(!i||n!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(i.friendlyRound),this.round.set(i.round),this.startList.set(i.startList),ge({token:e,courseName:i.round.courseNameSnapshot??"",status:i.round.status,completedAt:i.round.completedAt,lastSeenAt:new Date().toISOString()}),P.get(D).currentUser.get()&&Ss(i.round.id),this.pendingSlotIndex!==null){const c=i.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,c!==null&&this.selectedSlot.set(c)}const[l,d]=await Promise.all([_.friendlyRounds.balls({token:e}).catch(()=>[]),_.friendlyRounds.scorecard({token:e}).catch(()=>[])]);n!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(l),await this.flushPending())}deleting=new h(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await _.friendlyRounds.remove({token:e}),bt(e);const t=this.round.get()?.id;return t&&mt(t),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new h(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.finish({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:t.completedAt}),ge({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.reopen({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:null}),ge({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await T(this.resultLoading,this.resultError,()=>_.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await _.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}ballNameById=new y(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,wt(t));for(const t of this.result.get()?.slots??[])for(const s of t.subjectLabels??[])e.set(s.ballId,s.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new y(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,n)=>{for(const i of s.ballIds)e.set(i,`Group ${n+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Z(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(l=>l.id===e);if(!t||!s)return"";const n=t.playHoles.filter(l=>l.courseHoleNumber===s.courseHoleNumber).sort((l,d)=>l.ordinal-d.ordinal);if(n.length===1)return`${s.courseHoleNumber}`;const i=n.findIndex(l=>l.id===e);return`${s.courseHoleNumber} (${Xs[i]??`${i+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Z(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Z(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(U(e,t));return s?s.strokes:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(U(e,t))?.status??null}metadataFor(e,t,s){const n=this.cells.get().get(U(e,t));return n&&n.metadata!==void 0?n.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=P.get(ae),t=this.round.get()?.formatSlots??[],s=[],n=new Set;for(const i of t){const l=e.byId(i.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of l)n.has(d.key)||(n.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Js(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,n){const i=U(e,t),l=crypto.randomUUID();this.patchCell(i,{strokes:s,metadata:n,status:"saving",clientEventId:l});const d=this.token;d&&(this.enqueue(d,e,t,s,n,l),await this.post(d,e,t,s,n,l))}async retry(e,t){const s=U(e,t),n=this.cells.get().get(s);if(!n)return;this.patchCell(s,{...n,status:"saving"});const i=this.token;i&&(this.enqueue(i,e,t,n.strokes,n.metadata,n.clientEventId),await this.post(i,e,t,n.strokes,n.metadata,n.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(U(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,n,i,l){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:l,...i!==void 0?{metadata:i}:{},queuedAt:Date.now()})}async post(e,t,s,n,i,l){const d=U(t,s);try{await _.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:l,...i!=null?{metadata:i}:{}}),this.queue.remove(l);const u=this.cells.get().get(d);u&&u.clientEventId===l&&this.patchCell(d,{...u,status:"saved"});const c=this.round.get();e===this.token&&c&&c.status==="not_started"&&this.round.set({...c,status:"active"})}catch{const u=this.cells.get().get(d);u&&u.clientEventId===l&&this.patchCell(d,{...u,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0);const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const Y=60,Ze=8,Ie=4,Zs=Array.from({length:Ie*2+1},(r,e)=>e-Ie),en="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",tn=b(`
...
`);class an extends I{static styles=`
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Ze}px; flex-shrink: 0; }
...
</div>`}function wn(r,e){const t=r.matches.map(s=>{const n=k(s.sideA.ballIds.map(e).join(" & ")),i=k(s.sideB.ballIds.map(e).join(" & ")),l=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,u=s.leader==="a"?" lb-mp__team--lead":"",c=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    <div class="lb-mp__team lb-mp__team--a${u}">${n}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${k(l)}</span><span class="lb-mp__status">${k(d)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${c}">${i}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${k(r.title)}</h4>${t}
</div>`}const xn={ranked:vn,match_summary:(r,e)=>wn(r,e)},$n={"default-score-grid":fn,"compact-match-grid":gn,"category-matrix-grid":bn};function kn(r){return r.componentId??"default-score-grid"}function Sn(r){return`<div class="lb-diag">Unrenderable result section <code>${k(r)}</code> — no generic view yet. Results are not hidden.</div>`}function In(r){return`<div class="lb-diag">Unsupported score-grid component <code>${k(r)}</code> — no generic view yet. Results are not hidden.</div>`}function Tn(r,e,t){const s=xn[r.kind];return s?s(r,e,t):Sn(r.kind)}function En(r,e,t,s){const n=kn(r),i=$n[n];return i?i(r,e,t,s):In(n)}function Cn(r,e,t=xt){return r.leaderboard.length===0&&r.cards.length===0?`<div class="lb-empty">No scores entered yet for ${k(r.formatLabel)}.</div>`:r.leaderboard.map(n=>Tn(n,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${k(r.formatLabel)}.</div>`}function Nn(r,e,t,s={}){if(r.cards.length===0)return"";const n=s.mode??"product";return r.cards.map(i=>En(i,e,t,{mode:n})).join(`
`)}const Pn=b(`
...
`);class zn extends I{static styles=`
    ...
    `;svc=this.inject(ee);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Pn,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=u=>this.svc.nameOf(u),i=Cn(t,s,u=>this.svc.groupLabelOf(u)),l=Nn(t,e.routeSections,s),d=l?`<h3 class="lb-cards__head">Scorecard</h3>${l}`:"";return i+d}}function jn(r,e){if(!e)return[];const t=[],s=new Set;for(const n of r)for(const i of n.players){if(i.playerId===e)return[];i.guestPlayerId===null||s.has(i.guestPlayerId)||(s.add(i.guestPlayerId),t.push({guestPlayerId:i.guestPlayerId,displayName:i.displayName}))}return t}const Rn=b(`
...
`);class Ln extends I{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${E()}
    ...
    `;svc=this.inject(ee);auth=this.inject(D);router=this.inject(N);tokenQ=this.router.query("token");claiming=new h(!1);error=new h("");claimable(){return jn(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async claim(e){const t=this.tokenQ.get();if(!(!t||this.claiming.get())){this.error.set(""),this.claiming.set(!0);try{await _.friendlyRounds.claimGuest({token:t,guestPlayerId:e}),await this.svc.loadByToken(t)}catch(s){this.error.set(s instanceof F&&s.status===409?"Already claimed — or you already play in this round under your account.":s instanceof F&&s.status===404?"That guest is no longer claimable on this round.":"Could not claim right now. Try again.")}finally{this.claiming.set(!1)}}}render(){const e=this.wire(Rn,{root:{className:()=>this.claimable().length>0?"claim-card":"claim-card hidden"},err:{textContent:()=>this.error.get()}});return this.$each(this.ref(e,"rows"),()=>this.claimable(),(t,s,n)=>this.wireEl(On,{name:()=>t.displayName,claim:{disabled:()=>this.claiming.get(),onclick:()=>{this.claim(t.guestPlayerId)}}},n),t=>t.guestPlayerId),e}}function Q(r){return typeof r=="object"&&r!==null&&typeof r.get=="function"}const z=r=>`var(--${r})`,De=class De extends I{constructor(){super(...arguments),this.open=new h(!1),this.highlightIndex=new h(-1),this.optionEls=[],this.onOutsidePointer=e=>{this.wrapperEl.contains(e.target)||this.open.set(!1)}}render(){const e=document.createElement("div");e.className="ui-select",this.wrapperEl=e;const t=this.props.zIndex??50;this.triggerEl=document.createElement("button"),this.triggerEl.className="ui-select__trigger",this.triggerEl.setAttribute("type","button"),this.triggerEl.setAttribute("role","combobox"),this.triggerEl.setAttribute("aria-haspopup","listbox");const s=document.createElement("span");s.className="ui-select__trigger-label",this.triggerEl.appendChild(s);const n=document.createElement("span");n.className="ui-select__chevron",n.textContent="▾",n.setAttribute("aria-hidden","true"),this.triggerEl.appendChild(n),this.triggerEl.addEventListener("click",l=>{l.stopPropagation(),this.toggle()}),this.triggerEl.addEventListener("keydown",l=>{this.handleTriggerKeydown(l)}),e.appendChild(this.triggerEl),this.dropdownEl=document.createElement("div"),this.dropdownEl.className="ui-select__dropdown",this.dropdownEl.setAttribute("role","listbox"),this.dropdownEl.style.zIndex=String(t),this.dropdownEl.addEventListener("keydown",l=>{this.handleDropdownKeydown(l)}),e.appendChild(this.dropdownEl);const i=l=>{this.optionEls=[],this.dropdownEl.textContent="";for(let d=0;d<l.length;d++){const u=l[d],c=document.createElement("button");if(c.className="ui-select__option",c.setAttribute("type","button"),c.id=`ui-select-opt-${d}`,u.disabled){c.classList.add("ui-select__option--header"),c.disabled=!0,c.setAttribute("role","presentation"),c.setAttribute("aria-disabled","true");const g=document.createElement("span");g.className="ui-select__option-label",g.textContent=u.label,c.appendChild(g),this.dropdownEl.appendChild(c),this.optionEls.push(c);continue}if(c.setAttribute("role","option"),u.icon){const g=document.createElement("span");g.className="ui-select__option-icon",g.textContent=u.icon,c.appendChild(g)}const m=document.createElement("span");m.className="ui-select__option-label",m.textContent=u.label,c.appendChild(m);const p=document.createElement("span");p.className="ui-select__check",p.setAttribute("aria-hidden","true"),c.appendChild(p),c.addEventListener("click",g=>{g.stopPropagation(),this.selectOption(u.value)}),c.addEventListener("mouseenter",()=>{this.highlightIndex.set(d)}),this.dropdownEl.appendChild(c),this.optionEls.push(c)}};return Q(this.props.options)?this.track(S(()=>{const l=Q(this.props.options)?this.props.options.get():this.props.options;i(l)})):i(this.props.options),this.track(S(()=>{const l=this.props.value.get(),d=Q(this.props.options)?this.props.options.get():this.props.options,u=d.find(c=>c.value===l);u?(s.textContent=u.icon?`${u.icon} ${u.label}`:u.label,this.triggerEl.classList.remove("ui-select__trigger--placeholder")):(s.textContent=this.props.placeholder??"",this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!this.props.placeholder));for(let c=0;c<d.length;c++){const m=this.optionEls[c];if(!m)continue;const p=d[c].value===l;m.setAttribute("aria-selected",String(p)),m.classList.toggle("ui-select__option--selected",p);const g=m.querySelector(".ui-select__check");g&&(g.textContent=p?"✓":"")}})),this.track(S(()=>{const l=this.open.get();if(this.dropdownEl.classList.toggle("open",l),n.classList.toggle("ui-select__chevron--open",l),this.triggerEl.setAttribute("aria-expanded",String(l)),l?document.addEventListener("pointerdown",this.onOutsidePointer,!0):document.removeEventListener("pointerdown",this.onOutsidePointer,!0),l){const d=Q(this.props.options)?this.props.options.get():this.props.options,u=this.props.value.get(),c=d.findIndex(p=>p.value===u),m=d.findIndex(p=>!p.disabled);this.highlightIndex.set(c>=0?c:m)}})),this.track(S(()=>{const l=this.highlightIndex.get();for(let d=0;d<this.optionEls.length;d++)this.optionEls[d].classList.toggle("ui-select__option--highlighted",d===l);l>=0&&this.optionEls[l]&&(this.triggerEl.setAttribute("aria-activedescendant",`ui-select-opt-${l}`),this.optionEls[l].scrollIntoView({block:"nearest"}))})),this.props.disabled!=null&&(Q(this.props.disabled)?this.track(S(()=>{const l=this.props.disabled.get();this.triggerEl.classList.toggle("ui-select__trigger--disabled",l),this.triggerEl.disabled=l})):this.props.disabled&&(this.triggerEl.classList.add("ui-select__trigger--disabled"),this.triggerEl.disabled=!0)),e}toggle(){this.open.update(e=>!e)}selectOption(e){oe(()=>{this.props.value.set(e),this.open.set(!1)}),this.triggerEl.focus()}handleTriggerKeydown(e){switch(e.key){case"Enter":case" ":e.preventDefault(),this.toggle();break;case"ArrowDown":e.preventDefault(),this.open.get()?this.moveHighlight(1):this.open.set(!0);break;case"ArrowUp":e.preventDefault(),this.open.get()?this.moveHighlight(-1):this.open.set(!0);break;case"Escape":this.open.get()&&(e.preventDefault(),this.open.set(!1));break}}handleDropdownKeydown(e){switch(e.key){case"ArrowDown":e.preventDefault(),this.moveHighlight(1);break;case"ArrowUp":e.preventDefault(),this.moveHighlight(-1);break;case"Enter":case" ":{e.preventDefault();const t=this.highlightIndex.get(),s=Q(this.props.options)?this.props.options.get():this.props.options;t>=0&&t<s.length&&!s[t].disabled&&this.selectOption(s[t].value);break}case"Escape":e.preventDefault(),this.open.set(!1),this.triggerEl.focus();break;case"Tab":this.open.set(!1);break}}moveHighlight(e){const t=Q(this.props.options)?this.props.options.get():this.props.options;if(t.length===0||!t.some(n=>!n.disabled))return;let s=this.highlightIndex.get();do s+=e,s<0&&(s=t.length-1),s>=t.length&&(s=0);while(t[s].disabled);this.highlightIndex.set(s)}onDestroy(){document.removeEventListener("pointerdown",this.onOutsidePointer,!0)}};De.styles=`
        .ui-select {
            position: relative;
    ...
    `;let le=De;function Dn(r,e,t){if(!e||t!=="not_started")return!1;for(const s of r)for(const n of s.players)if(n.playerId===e)return!1;return!0}function Mn(r){if(!r)return{visible:!1,blockedMessage:null};const e=r.viewer.join;return e.allowed?{visible:!0,blockedMessage:null}:e.code==="window_not_open"||e.code==="window_closed"?{visible:!0,blockedMessage:e.message??"Sign-up is closed right now."}:{visible:!1,blockedMessage:null}}const tt="new";function Hn(r,e=!0){const t=r.map((n,i)=>{const l=n.ballIds.length,d=[`Group ${i+1}`];return n.startTime.includes(":")&&d.push(n.startTime),{value:n.id,label:`${d.join(" · ")} — ${l} of ${n.capacity}`,disabled:l>=n.capacity}}),s=t.find(n=>!n.disabled);return e&&t.push({value:tt,label:"Start a new group",disabled:!1}),{options:t,defaultValue:s?.value??(e?tt:"")}}const Fn=b(`
...
`);class An extends I{static styles=`
    ...
    `;svc=this.inject(ee);auth=this.inject(D);router=this.inject(N);tokenQ=this.router.query("token");joining=new h(!1);error=new h("");diagnostics=new h([]);teeId=new h("");tees=new h([]);loadedForCourseId=null;groupChoice=new h("");policyState(){return Mn(this.svc.startList.get())}eligible(){return this.policyState().visible&&Dn(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,_.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),n=await _.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});n.ok?await this.svc.loadByToken(e):this.diagnostics.set(n.diagnostics)}catch(s){this.error.set(s instanceof F&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(S(()=>this.ensureTeesLoaded()));const e=new y(()=>Hn(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(S(()=>{const i=e.get(),l=this.groupChoice.get();(!l||!i.options.some(d=>d.value===l&&!d.disabled))&&this.groupChoice.set(i.defaultValue)}));const t=this.wire(Fn,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(i=>i.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new le({value:this.teeId,options:{get:()=>this.tees.get().map(i=>({value:i.id,label:i.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const n=new le({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return n.mount(this.ref(t,"groupHost")),this.track(()=>n.destroy()),t}}const Bn=b(`
...
`);class Gn extends I{static styles=`
        .edit-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${E()}
    ...
    `;router=this.inject(N);tokenQ=this.router.query("token");editable=new h(!1);render(){const e=this.tokenQ.get();return e&&_.friendlyRounds.setup({token:e}).then(t=>this.editable.set(t.editable===!0)).catch(()=>this.editable.set(!1)),this.wire(Bn,{root:{className:()=>this.editable.get()?"edit-card":"edit-card hidden"},edit:{onclick:()=>{const t=this.tokenQ.get();t&&this.router.navigate("/create",{query:{token:t}})}}})}}function qn(r,e){if(!e)return!1;for(const t of r)for(const s of t.players)if(s.playerId===e)return!0;return!1}const Kn=b(`
...
`);class Vn extends I{static styles=`
    ...
    `;svc=this.inject(ee);auth=this.inject(D);router=this.inject(N);tokenQ=this.router.query("token");open=new h(!1);leaving=new h(!1);error=new h("");diagnostics=new h([]);eligible(){return qn(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.error.set(""),this.diagnostics.set([]),this.leaving.set(!0);try{const t=await _.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){const e=this.wire(Kn,{root:{className:()=>this.eligible()?"leave-card":"leave-card hidden"},leaveBtn:{onclick:()=>this.open.set(!0),disabled:()=>this.leaving.get()},diag:{textContent:()=>this.diagnostics.get().map(t=>t.message).join(" · ")},err:{textContent:()=>this.error.get()}});return this.spawn(B,this.ref(e,"confirmHost"),{open:this.open,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}}),e}}function Wn(r){return!(r.tab!=="leaderboard"||!r.pageVisible||r.status==="complete")}const Un=2e4;function Yn(r){if(!(r===null||r===""))return/^\d+$/.test(r)?Number(r):r}const Qn=b(`
...
`),Xn=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Jn=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Zn extends I{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);function ot(r){return r.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Ri extends I{static styles=`
        .friends {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(_e);auth=this.inject(D);router=this.inject(N);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Pi,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:n=>this.svc.setQuery(n.target.value)},searchHint:{textContent:()=>{const n=this.svc.query.get().trim();return n.length>0&&!st(n)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const n=this.svc.query.get().trim();return st(n)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===n&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(n,i,l)=>this.wireEl(zi,{initials:()=>ot(n.displayName),name:()=>n.displayName,username:()=>`@${n.username}`,hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(n.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const d=this.svc.results.get().find(u=>u.id===n.id);d&&!d.isFriend&&this.svc.add(d)}},added:{className:()=>this.isFriendNow(n.id)?"friend-row__added":"friend-row__added hidden"}},l),n=>n.id);const s=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>Re(this.svc.friends.get(),this.svc.sortMode.get()),(n,i,l)=>this.wireEl(ji,{initials:()=>ot(n.displayName),name:()=>n.displayName,subtitle:()=>{const d=this.svc.friends.get().find(u=>u.id===n.id)??n;return fi(d,s)},hcp:()=>n.handicapIndex===null?"–":n.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(n.id)}}},l),n=>n.id),t}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Oi=b(`
    <div class="profile">
...
`);class Bi extends I{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),nr=b('<option bind="option"></option>');class ir extends I{competitions=this.inject(J);state=this.inject(de);router=this.inject(N);render(){const e=new y(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(tr,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Hi(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,i)=>this.wireEl(nr,{option:{value:()=>s.id,textContent:()=>s.name}},i),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,i)=>this.wireEl(sr,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>er[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},i),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function rr(r,e,t){return JSON.stringify({entry:r,points:e,columns:t})}function or(r){return r.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const ar=b(`
    <div>
...
`),lr=b('<button bind="button" type="button"></button>'),dr=b('<th bind="cell"></th>'),cr=b('<tr bind="row"></tr>'),ur=b('<td bind="cell"><span bind="value"></span></td>'),hr=b(`
...
`);class _r extends I{static styles=`
    ...
    `;router=this.inject(N);render(){const e=this.wire(br,{});return this.spawn(Cs,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Ue,"/history":Gs,"/round":Zn,"/create":Ei,"/login":Ni,"/friends":Ri,"/profile":Di,"/competitions":Bi,"/competition":gr},Ue),e}}P.get(Vt);const at=P.get(N),lt=P.get(D);await Ut(_r,"#app",{hot:void 0,onInit:async()=>{await lt.load(),lt.currentUser.get()&&at.route.get()==="/login"&&at.navigate("/",!0)}});export{I as C,N as R,h as S,Vt as T,f as a,oe as b,y as c,S as e,T as r,b as t};
