(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const o of n.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const Ye="modulepreload",Je=function(i){return"/tapscore/"+i},fe={},Ze=function(e,t,s){let r=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");r=c(t.map(u=>{if(u=Je(u),u in fe)return;fe[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const g=document.createElement("link");if(g.rel=f?"stylesheet":Ye,f||(g.as="script"),g.crossOrigin="",g.href=u,d&&g.setAttribute("nonce",d),document.head.appendChild(g),f)return new Promise((v,O)=>{g.addEventListener("load",v),g.addEventListener("error",()=>O(new Error(`Unable to preload CSS for ${u}`)))})}))}function n(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return r.then(o=>{for(const d of o||[])d.status==="rejected"&&n(d.reason);return e().catch(n)})};class et{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){Oe(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const F=new et;function Oe(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return F.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,F.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){F.runTracked(s,()=>{const r=e();Object.is(t.val,r)||(t.val=r,F.notify(t.subs))})},deps:new Set};s.run()}get(){return F.subscribe(this.subs),this.val}peek(){return this.val}}function x(i){const e={run(){F.runTracked(e,i)},deps:new Set};return e.run(),()=>Oe(e)}function X(i){F.batch(i)}function D(i){return F.untrack(i)}class tt{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const M=new tt,U="/tapscore/".replace(/\/+$/,"");function oe(i){return U?i===U?"/":i.startsWith(U+"/")?i.slice(U.length):i:i}function st(i){return U+i}class N{constructor(){this.route=new h(oe(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>X(()=>{this.route.set(oe(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},r=e.indexOf("#"),n=r>=0?e.slice(r):"",o=r>=0?e.slice(0,r):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,u=d>=0?o.slice(d+1):"",f=s.query!==void 0?nt(s.query):u?"?"+u:"",m=st(c)+f+n;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),X(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:r=>{r.preventDefault(),this.navigate(e)},className:()=>{const r=this.route.get();return r===s||r.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const s=this.route.get().split("/"),r={};for(const[n,o]of t.entries())o.startsWith(":")&&(r[o.slice(1)]=s[n]??"");return r})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function nt(i){const e=new URLSearchParams;for(const[s,r]of Object.entries(i))r==null||r===""||e.set(s,String(r));const t=e.toString();return t?"?"+t:""}function rt(i){return e=>i[e]}function it(i,e){const t=(r,n,o)=>{const d=Object.entries(r).map(([c,u])=>`--${c}:${u}`).join(";");return`${n}{color-scheme:${o};${d}}`},s=document.createElement("style");return s.textContent=t(i,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),r=>`var(--${r})`}const ge="basics-js-theme";class ot{constructor(){this.dark=new h(!1);const e=localStorage.getItem(ge),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),x(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ge,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(i){const e=document.createElement("template");return e.innerHTML=i,e}function at(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const be=new Set;class E{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!be.has(t)){be.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return M.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const r=D(()=>{const n=new e(s[0]);return n.mount(t),n});return this.children.push(r),r}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const r=s??(o=>this.track(o)),n=e.content.cloneNode(!0);for(const o of n.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")r(x(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?o.addEventListener(c.slice(2),u):typeof u=="function"?r(x(()=>{const m=u();f?o.setAttribute(c,String(m)):o[c]=m})):f?o.setAttribute(c,String(u)):o[c]=u}}return n}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const r=this.ref(t,e);return r?(typeof s=="string"?r.textContent=s:typeof s=="function"&&s.prototype instanceof E?this.spawn(s,r):typeof s=="function"&&s(r,{spawn:(n,o,...d)=>this.spawn(n,o,...d),track:n=>this.track(n)}),!0):!1}$each(e,t,s,r=(n,o)=>o){const n=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(x(()=>{const c=n(),u=new Map;for(const[m,g]of c.entries()){const v=r(g,m);if(o.has(v))u.set(v,o.get(v));else{const O=[];u.set(v,D(()=>s(g,m,$=>O.push($)))),d.set(v,O)}}for(const[m,g]of o)u.has(m)||(g.remove(),d.get(m)?.forEach(v=>v()),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);o.clear();for(const[m,g]of u)o.set(m,g)}))}$condition(e,t,s,r){let n=null;this.track(x(()=>{n&&(n.remove(),n=null);const o=t.get();n=D(()=>o?s():r?.()??null),n&&e.appendChild(n)}))}$swap(e,t,s,r){let n=null;this.track(x(()=>{n&&(n.destroy(),n=null),e.textContent="";const o=t.get(),d=s[o]??at(o,s)??r;d&&(n=D(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>n?.destroy())}}async function lt(i,e,t){const s=document.querySelector(e);s.textContent="";const r=M.get(N);let n=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{n&&(n.destroy(),n=null,s.textContent=""),f?(d||(d=(await Ze(()=>import("./obs-shell.component-Dc_k6nPq.js"),[])).ObsShellComponent),n=D(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),n=D(()=>new i)),D(()=>n.mount(s)),o=f};await u(oe(location.pathname).startsWith("/_obs")),x(()=>{const f=r.route.get().startsWith("/_obs");f!==o&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>n?.destroy()),t.hot.accept())}class z extends Error{constructor(e,t,s,r){super(t),this.status=e,this.details=s,this.traceId=r,this.name="ApiError"}}const dt=10,J=[];let Z=[],W=null;function ct(i){J.push(i),J.length>dt&&J.shift()}function ut(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...J],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Z.push(s),ht()}function ht(){W||(W=setTimeout(He,5e3))}function He(){if(W&&(clearTimeout(W),W=null),Z.length===0)return;const i=Z;Z=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&He()});const pt=3e4,mt=2,V=new Map,Me=new WeakMap;function ft(i){if(i instanceof z)return i.traceId;if(i!=null&&typeof i=="object")return Me.get(i)}async function p(i){if(i.method==="GET"){const e=V.get(i.url);if(e)return e;const t=ye(i,mt);return V.set(i.url,t),t.then(()=>V.delete(i.url),()=>V.delete(i.url)),t}return ye(i,0)}async function ye(i,e){const t=i.timeout??pt;let s;for(let r=0;r<=e;r++){const n=crypto.randomUUID();try{return await bt(gt(i,n),t)}catch(o){if(s=o,!(o instanceof z)&&o!=null&&typeof o=="object"&&Me.set(o,n),o instanceof z||r===e)break;await new Promise(d=>setTimeout(d,1e3*2**r))}}throw s}async function gt(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const r=await fetch(i.url,s),n=r.headers.get("x-trace-id")??e;if(ct({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!r.ok){const o=await r.json().catch(()=>({error:r.statusText}));throw new z(r.status,o.error??r.statusText,o.details,n)}return r.json()}function bt(i,e){let t;const s=new Promise((r,n)=>{t=setTimeout(()=>n(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}async function I(i,e,t){X(()=>{i.set(!0),e.set(null)});try{const s=await t();return i.set(!1),s}catch(s){const r=yt(s);X(()=>{i.set(!1),e.set(r)}),ut(r.code,r.message,ft(s));return}}function yt(i){return i instanceof z?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function _t(i){return{me:()=>p({method:"GET",url:`${i}/auth/me`}),login:e=>p({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>p({method:"POST",url:`${i}/auth/logout`,body:{}})}}class L{constructor(){this.api=_t("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await I(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await I(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await I(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const _e={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},l=it({..._e,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{..._e,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),T=i=>`var(--${i})`,a=rt({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),w=(i=T("radius"))=>`
...
`);class xt extends E{static styles=`
        .tabbar {
            display: flex;
...
`),ve={not_started:"Not started",active:"Live",complete:"Done"};class xe extends E{static styles=`
        .landing {
    ...
    `;svc=this.inject(Rt);auth=this.inject(L);router=this.inject(N);render(){this.svc.load();const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.loadMine();const t=this.wire(Gt,{createBtn:{onclick:()=>this.router.navigate("/create")},signin:{className:()=>e()?"landing__signin hidden":"landing__signin",onclick:()=>this.router.navigate("/login")},mySection:{className:()=>e()?"landing__mine":"landing__mine hidden"},myCount:()=>{const s=this.svc.myRounds.get().length;return s===0?"":`${s} on the card`},myEmpty:{className:()=>e()&&this.svc.myRounds.get().length===0&&!this.svc.mineLoading.get()?"landing__empty":"landing__empty hidden"},count:()=>{const s=this.svc.rounds.get().length;return s===0?"":`${s} on the card`},empty:{className:()=>this.svc.rounds.get().length===0?"landing__empty":"landing__empty hidden"}});return this.$each(this.ref(t,"list"),this.svc.rounds,(s,r,n)=>this.wireEl(qt,{row:{onclick:()=>this.router.navigate("/round",{query:{token:s.friendlyRound.shareToken}})},course:()=>s.round.courseNameSnapshot??"Round",status:{textContent:()=>ve[s.round.status]??s.round.status,className:()=>`round-row__status s-${s.round.status}`},date:()=>s.round.date,formats:()=>s.round.formatSlots.map(ae).join(" · ")},n),s=>s.friendlyRound.id),this.$each(this.ref(t,"myList"),this.svc.myRounds,(s,r,n)=>this.wireEl(At,{row:{disabled:()=>s.token===null,onclick:()=>{s.token!==null&&this.router.navigate("/round",{query:{token:s.token}})}},course:()=>s.round.courseNameSnapshot??"Round",role:()=>Mt(s),status:{textContent:()=>ve[s.round.status]??s.round.status,className:()=>`round-row__status s-${s.round.status}`},date:()=>s.round.date,formats:()=>s.round.formatSlots.map(ae).join(" · ")},n),s=>s.round.id),t}}const Dt=180,we=4,Kt=12;function K(i,e){return e<=0?0:Math.max(0,Math.min(e-1,i))}function Ut(i){const{dragDistance:e,velocity:t,itemWidth:s}=i;if(Math.abs(e)<Kt)return 0;const r=e+t*Dt,n=Math.round(-r/s);return Math.max(-we,Math.min(we,n))}const $e="tapscore:pending-scores:v1",Wt=336*60*60*1e3,ke=200;function Xt(){try{return globalThis.localStorage??null}catch{return null}}function Qt(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Vt{entries=[];storage;constructor(e=Xt(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=Wt);return t.length>ke?t.slice(t.length-ke):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem($e);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Qt):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem($e,JSON.stringify(this.entries))}catch{}}}const Yt=["1st","2nd","3rd","4th","5th","6th","7th","8th"],G=(i,e)=>`${i}|${e}`;function Le(i){return i.players.map(e=>e.displayName).join(" & ")||i.label||"Ball"}function Jt(i,e,t){return i?!(i.minPar!==void 0&&e<i.minPar||i.maxPar!==void 0&&e>i.maxPar||i.pars&&!i.pars.includes(e)||i.holes&&!i.holes.includes(t)):!0}class Q{constructor(e=new Vt){this.queue=e}queue;loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);resultCursor=null;holeIdx=new h(0);groupIdx=new h(0);selectedSlot=new h(null);token=null;loadSeq=0;resultSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const r=++this.loadSeq;s&&this.resetForNewToken(t),M.get(ee).load();const n=await I(this.loading,this.error,()=>_.friendlyRounds.byToken({token:e}));if(!n||r!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(n.friendlyRound),this.round.set(n.round),this.pendingSlotIndex!==null){const u=n.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,u!==null&&this.selectedSlot.set(u)}const[o,d]=await Promise.all([_.friendlyRounds.balls({token:e}).catch(()=>[]),_.friendlyRounds.scorecard({token:e}).catch(()=>[])]);r!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(o),await this.flushPending())}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await I(this.resultLoading,this.resultError,()=>_.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await _.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}ballNameById=new S(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Le(t));return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new S(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,r)=>{for(const n of s.ballIds)e.set(n,`Group ${r+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return K(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(o=>o.id===e);if(!t||!s)return"";const r=t.playHoles.filter(o=>o.courseHoleNumber===s.courseHoleNumber).sort((o,d)=>o.ordinal-d.ordinal);if(r.length===1)return`${s.courseHoleNumber}`;const n=r.findIndex(o=>o.id===e);return`${s.courseHoleNumber} (${Yt[n]??`${n+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(K(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(K(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(G(e,t));return s?s.strokes:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(G(e,t))?.status??null}metadataFor(e,t,s){const r=this.cells.get().get(G(e,t));return r&&r.metadata!==void 0?r.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=M.get(ee),t=this.round.get()?.formatSlots??[],s=[],r=new Set;for(const n of t){const o=e.byId(n.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of o)r.has(d.key)||(r.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Jt(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,r){const n=G(e,t),o=crypto.randomUUID();this.patchCell(n,{strokes:s,metadata:r,status:"saving",clientEventId:o});const d=this.token;d&&(this.enqueue(d,e,t,s,r,o),await this.post(d,e,t,s,r,o))}async retry(e,t){const s=G(e,t),r=this.cells.get().get(s);if(!r)return;this.patchCell(s,{...r,status:"saving"});const n=this.token;n&&(this.enqueue(n,e,t,r.strokes,r.metadata,r.clientEventId),await this.post(n,e,t,r.strokes,r.metadata,r.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(G(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,r,n,o){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:r,eventType:r===null?"score_cleared":"score_entered",clientEventId:o,...n!==void 0?{metadata:n}:{},queuedAt:Date.now()})}async post(e,t,s,r,n,o){const d=G(t,s);try{await _.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:r,eventType:r===null?"score_cleared":"score_entered",clientEventId:o,...n!=null?{metadata:n}:{}}),this.queue.remove(o);const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0);const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const q=60,Se=8,le=4,Zt=Array.from({length:le*2+1},(i,e)=>e-le),es="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",ts=b(`
...
</div>`}function _s(i,e){const t=i.matches.map(s=>{const r=y(s.sideA.ballIds.map(e).join(" & ")),n=y(s.sideB.ballIds.map(e).join(" & ")),o=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,c=s.leader==="a"?" lb-mp__team--lead":"",u=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const vs={ranked:ys,match_summary:(i,e)=>_s(i,e)},xs={"default-score-grid":ms,"compact-match-grid":fs,"category-matrix-grid":gs};function ws(i){return i.componentId??"default-score-grid"}function $s(i){return`<div class="lb-diag">Unrenderable result section <code>${y(i)}</code> — no generic view yet. Results are not hidden.</div>`}function ks(i){return`<div class="lb-diag">Unsupported score-grid component <code>${y(i)}</code> — no generic view yet. Results are not hidden.</div>`}function Ss(i,e,t){const s=vs[i.kind];return s?s(i,e,t):$s(i.kind)}function Is(i,e,t,s){const r=ws(i),n=xs[r];return n?n(i,e,t,s):ks(r)}function Ts(i,e,t=Re){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${y(i.formatLabel)}.</div>`:i.leaderboard.map(r=>Ss(r,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${y(i.formatLabel)}.</div>`}function Es(i,e,t,s={}){if(i.cards.length===0)return"";const r=s.mode??"product";return i.cards.map(n=>Is(n,e,t,{mode:r})).join(`
`)}const Cs=b(`
...
`);class Ps extends E{static styles=`
    ...
    `;svc=this.inject(Q);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Cs,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=c=>this.svc.nameOf(c),n=Ts(t,s,c=>this.svc.groupLabelOf(c)),o=Es(t,e.routeSections,s),d=o?`<h3 class="lb-cards__head">Scorecard</h3>${o}`:"";return n+d}}function js(i,e){if(!e)return[];const t=[],s=new Set;for(const r of i)for(const n of r.players){if(n.playerId===e)return[];n.guestPlayerId===null||s.has(n.guestPlayerId)||(s.add(n.guestPlayerId),t.push({guestPlayerId:n.guestPlayerId,displayName:n.displayName}))}return t}const Ns=b(`
...
`);class Os extends E{static styles=`
    ...
    `;let te=ue;function Hs(i,e,t){if(!e||t!=="not_started")return!1;for(const s of i)for(const r of s.players)if(r.playerId===e)return!1;return!0}const Ms=b(`
...
`);class Ls extends E{static styles=`
    ...
    `;svc=this.inject(Q);auth=this.inject(L);router=this.inject(N);tokenQ=this.router.query("token");joining=new h(!1);error=new h("");diagnostics=new h([]);teeId=new h("");tees=new h([]);loadedForCourseId=null;eligible(){return Hs(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,_.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}diagnosticMessage(e){return e.code==="missing_gender"||e.code==="missing_handicap_index"?`${e.message} — <a data-nav="/profile">update your profile</a>.`:e.message}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=await _.friendlyRounds.join({token:e,teeId:t});s.ok?await this.svc.loadByToken(e):this.diagnostics.set(s.diagnostics)}catch(s){this.error.set(s instanceof z&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(x(()=>this.ensureTeesLoaded()));const e=this.wire(Ms,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{innerHTML:()=>this.diagnostics.get().map(s=>this.diagnosticMessage(s)).join(" · "),onclick:s=>{const n=s.target.closest("[data-nav]")?.getAttribute("data-nav");n&&(s.preventDefault(),this.router.navigate(n))}},err:{textContent:()=>this.error.get()}}),t=new te({value:this.teeId,options:{get:()=>this.tees.get().map(s=>({value:s.id,label:s.name}))},placeholder:"Tee"});return t.mount(this.ref(e,"teeHost")),this.track(()=>t.destroy()),e}}function Rs(i){return!(i.tab!=="leaderboard"||!i.pageVisible||i.status==="complete")}const Fs=2e4;function Bs(i){if(!(i===null||i===""))return/^\d+$/.test(i)?Number(i):i}const Gs=b(`
...
`),qs=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),As=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Ds extends E{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class an extends E{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class dn extends E{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`);function je(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class pn extends E{static styles=`
        .friends {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class yn extends E{static styles=`
    ...
    `;router=this.inject(N);render(){const e=this.wire(bn,{});return this.spawn(xt,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":xe,"/round":Ds,"/create":an,"/login":dn,"/friends":pn,"/profile":gn},xe),e}}M.get(ot);const Ne=M.get(N),ze=M.get(L);await lt(yn,"#app",{hot:void 0,onInit:async()=>{await ze.load(),ze.currentUser.get()&&Ne.route.get()==="/login"&&Ne.navigate("/",!0)}});export{E as C,N as R,h as S,ot as T,p as a,X as b,S as c,x as e,I as r,b as t};
