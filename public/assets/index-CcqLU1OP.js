(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Vr="modulepreload",Ur=function(s){return"/tapscore/"+s},un={},Kr=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=Ur(u),u in un)return;un[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Vr,f||(h.as="script"),h.crossOrigin="",h.href=u,o&&h.setAttribute("nonce",o),document.head.appendChild(h),f)return new Promise((g,v)=>{h.addEventListener("load",g),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=d,window.dispatchEvent(o),!o.defaultPrevented)throw d}return i.then(d=>{for(const o of d||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})},xi="/tapscore/".replace(/\/+$/,""),Ss=xi+"/api",jt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Wr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function $i(s,e){const t={};for(const[n,i]of Wr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const ki=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Yr={thin:"1px",medium:"3px",thick:"5px"};function Si(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Yr[e.toLowerCase()]??e}function Qr(){return ki.map(s=>{const e=Si(jt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Ti={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Pi={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Xr={...Pi,"done-opacity":"0.35"},Jr={...Ti,...Pi,...jt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Zr={...Ti,...Xr,...jt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class ea{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Ii(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ve=new ea;function Ii(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ve.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ve.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ve.notify(t.subs))})},deps:new Set};n.run()}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}}function E(s){const e={run(){ve.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Ii(e)}}function rt(s){ve.batch(s)}function X(s){return ve.untrack(s)}class ta{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const U=new ta,Ye=xi;function Ts(s){return Ye?s===Ye?"/":s.startsWith(Ye+"/")?s.slice(Ye.length):s:s}function sa(s){return Ye+s}class j{constructor(){this.route=new p(Ts(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>rt(()=>{this.route.set(Ts(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,o=d.indexOf("?"),c=o>=0?d.slice(0,o):d,u=o>=0?d.slice(o+1):"",f=n.query!==void 0?na(n.query):u?"?"+u:"",m=sa(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),rt(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function na(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function ia(s){return e=>s[e]}const ra="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",hn="data-basics-global";function aa(){if(document.head.querySelector(`style[${hn}]`))return;const s=document.createElement("style");s.setAttribute(hn,""),s.textContent=Qr()+ra,document.head.appendChild(s)}function oa(s,e){aa();const t=new Set(ki),n=(r,d,o)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?Si(f):f}`).join(";");return`${d}{color-scheme:${o};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const pn="basics-js-theme";class la{constructor(){this.dark=new p(!1);const e=localStorage.getItem(pn),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),E(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(pn,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function da(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const fn=new Set;class H{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!fn.has(t)){fn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return U.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=X(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){X(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const o=t[d.getAttribute("bind")];if(o)if(typeof o=="function")i(E(()=>{const c=o();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(o)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(E(()=>{const m=u();f?d.setAttribute(c,String(m)):d[c]=m})):f?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof H?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...o)=>this.spawn(r,d,...o),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,o=new Map;this.track(()=>{for(const c of o.values())c.forEach(u=>u());o.clear()}),this.track(E(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(d.has(g))u.set(g,d.get(g));else{const v=[];u.set(g,X(()=>n(h,m,w=>v.push(w)))),o.set(g,v)}}for(const[m,h]of d)u.has(m)||(h.remove(),X(()=>o.get(m)?.forEach(g=>g())),o.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(E(()=>{r&&(r.remove(),r=null);const d=t.get();r=X(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(E(()=>{if(r){const c=r;r=null,X(()=>c.destroy())}e.textContent="";const d=t.get(),o=n[d]??da(d,n)??i;o&&(r=X(()=>{const c=new o;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ct=new Set;function ca(s){return Ct.add(s),()=>Ct.delete(s)}function ua(){for(const s of Array.from(Ct)){Ct.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function ha(s,e,t){const n=document.querySelector(e);n.textContent="";const i=U.get(j);let r=null,d=!1,o=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(o||(o=(await Kr(()=>import("./obs-shell.component-BGaaN0cV.js"),[])).ObsShellComponent),r=X(()=>new o)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=X(()=>new s)),X(()=>r.mount(n)),d=f};await u(Ts(location.pathname).startsWith("/_obs")),E(()=>{const f=i.route.get().startsWith("/_obs");f!==d&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,ua(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class K extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const pa=10,Tt=[];let Pt=[],tt=null;function fa(s){Tt.push(s),Tt.length>pa&&Tt.shift()}function Ci(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Tt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Pt.push(n),ma()}function ma(){tt||(tt=setTimeout(Ei,5e3))}function Ei(){if(tt&&(clearTimeout(tt),tt=null),Pt.length===0)return;const s=Pt;Pt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ss}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ss}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ei()});const ga=3e4,ba=2,mt=new Map,Ni=new WeakMap;function ya(s){if(s instanceof K)return s.traceId;if(s!=null&&typeof s=="object")return Ni.get(s)}async function y(s){if(s.method==="GET"){const e=mt.get(s.url);if(e)return e;const t=mn(s,ba);return mt.set(s.url,t),t.then(()=>mt.delete(s.url),()=>mt.delete(s.url)),t}return mn(s,0)}async function mn(s,e){const t=s.timeout??ga;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await va(_a(s,r),t)}catch(d){if(n=d,!(d instanceof K)&&d!=null&&typeof d=="object"&&Ni.set(d,r),d instanceof K||i===e)break;await new Promise(o=>setTimeout(o,1e3*2**i))}}throw n}async function _a(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(fa({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new K(i.status,d.error??i.statusText,d.details,r)}return i.json()}function va(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Ps=new Set;let is=!1;function wa(s){return Ps.add(s),()=>{Ps.delete(s)}}function Ri(){if(!is){is=!0;try{for(const s of[...Ps])try{s()}catch(e){try{Ci("session-listener",xa(e))}catch{}}}finally{is=!1}}}function xa(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function G(s,e,t,n={}){rt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=$a(i);rt(()=>{s.set(!1),e.set(r)}),Ci(r.code,r.message,ya(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Ri();return}}function $a(s){return s instanceof K?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const rs={sessionExpiry:!1};function ka(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class D{constructor(){this.api=ka(Ss),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=wa(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=ca(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await G(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await G(this.loading,this.error,()=>this.api.login({username:e,password:t}),rs);return n?(this.currentUser.set(n),!0):!1}async logout(){await G(this.loading,this.error,()=>this.api.logout(),rs);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await G(this.loading,this.error,()=>this.api.logoutAll(),rs),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Oi={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Sa={...Oi,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Ta={...Oi,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Pa=$i(Sa,Jr),Ia=$i(Ta,Zr),l=oa(Pa,Ia),z=s=>`var(--${s})`,I=(s,e)=>`var(--${s}, ${e})`,C=s=>{const e=jt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=ia({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),gt=s=>`
    background: ${I(`btn-${s}-bg`,C(`btn-${s}-bg`))};
    color: ${I(`btn-${s}-fg`,C(`btn-${s}-fg`))};
    border-color: ${I(`btn-${s}-border`,C(`btn-${s}-border`))};
    box-shadow: ${I(`btn-${s}-shadow`,C(`btn-${s}-shadow`))};
    &:hover {
        background: ${I(`btn-${s}-bg-hover`,C(`btn-${s}-bg-hover`))};
        color: ${I(`btn-${s}-fg-hover`,C(`btn-${s}-fg-hover`))};
        border-color: ${I(`btn-${s}-border-hover`,C(`btn-${s}-border-hover`))};
    }`,Mi=`
    background: ${I("btn-disabled-bg",C("btn-disabled-bg"))};
    color: ${I("btn-disabled-fg",C("btn-disabled-fg"))};
    border-color: ${I("btn-disabled-border",C("btn-disabled-border"))};
    box-shadow: none;
    opacity: ${I("btn-disabled-opacity",C("btn-disabled-opacity"))};
    cursor: not-allowed;`,Ca={primary:gt("primary"),secondary:gt("secondary"),ghost:gt("ghost"),danger:gt("danger"),disabled:Mi},$=(s=I("btn-radius",C("btn-radius")),e="secondary")=>`
    /*
     ...
     */
    border: ${I("btn-border-width",C("btn-border-width"))} solid transparent;
    border-radius: ${s};
    padding: ${I("btn-padding-y",C("btn-padding-y"))} ${I("btn-padding-x",C("btn-padding-x"))};
    font-family: ${z("font-ui")};
    font-size: ${I("btn-font-size",C("btn-font-size"))};
    line-height: ${I("btn-line-height",C("btn-line-height"))};
    font-weight: ${I("btn-font-weight",C("btn-font-weight"))};
    cursor: pointer;
    transition:
    ...
    &:focus-visible {
        outline: none;
        box-shadow: 0 0 0 ${I("btn-focus-ring-width",C("btn-focus-ring-width"))} ${I("btn-focus-ring",C("btn-focus-ring"))};
    }
    ${Ca[e]}
    &:disabled {${Mi}}
`,Ea=`max(${I("field-border-width",C("field-border-width"))}, ${I("field-rule-width",C("field-rule-width"))})`,bt=(s,e)=>`
    border-top-color: ${s};
    border-right-color: ${s};
    border-left-color: ${s};
    border-bottom-color: ${e};`,ne=()=>`
    border-style: solid;
    border-top-width: ${I("field-border-width",C("field-border-width"))};
    border-right-width: ${I("field-border-width",C("field-border-width"))};
    border-left-width: ${I("field-border-width",C("field-border-width"))};
    border-bottom-width: ${Ea};
    ${bt(I("field-border",C("field-border")),I("field-rule",C("field-rule")))}
    border-radius: ${I("field-radius",C("field-radius"))};
    padding: ${I("field-padding-y",C("field-padding-y"))} ${I("field-padding-x",C("field-padding-x"))};
    background: ${I("field-bg",C("field-bg"))};
    color: ${z("text")};
    font-family: ${z("font-ui")};
    font-size: ${I("field-font-size",C("field-font-size"))};
    line-height: ${I("field-line-height",C("field-line-height"))};
    font-weight: 400;
    transition:
        border-color ${z("dur-fast")} ${z("ease-standard")},
        box-shadow ${z("dur-fast")} ${z("ease-standard")},
    ...
    &:focus-visible {
        outline: none;
        ${bt(I("field-focus-border",C("field-focus-border")),I("field-focus-border",C("field-focus-border")))}
        background: ${I("field-bg-focus",C("field-bg-focus"))};
        box-shadow: 0 0 0 ${I("field-focus-ring-width",C("field-focus-ring-width"))} ${I("field-focus-ring",C("field-focus-ring"))};
    }
    &[aria-invalid='true'] {
        ${bt(I("field-invalid-border",C("field-invalid-border")),I("field-invalid-rule",C("field-invalid-rule")))}
    }
    &[aria-invalid='true']:focus-visible {
        ${bt(I("field-invalid-border",C("field-invalid-border")),I("field-invalid-rule",C("field-invalid-rule")))}
        background: ${I("field-bg-focus",C("field-bg-focus"))};
        box-shadow: 0 0 0 ${I("field-focus-ring-width",C("field-focus-ring-width"))} ${I("field-invalid-ring",C("field-invalid-ring"))};
    }
`,Na=()=>`
    display: block;
    font-family: ${z("font-ui")};
...
`;function Ra(s){return{async me(){return y({method:"GET",url:`${s}/players/me`})},async register(e){return y({method:"POST",url:`${s}/players/register`,body:e})},async updateHandicap(e){return y({method:"POST",url:`${s}/players/me/handicap`,body:e})},async confirmHandicap(){return y({method:"POST",url:`${s}/players/me/handicap/confirm`,body:{}})},async myHandicapHistory(){return y({method:"GET",url:`${s}/players/me/handicap-history`})},async updateProfile(e){return y({method:"POST",url:`${s}/players/me/profile`,body:e})},async search(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/players/search${n?"?"+n:""}`})}}}function Oa(s){return{async list(){return y({method:"GET",url:`${s}/friends`})},async add(e){return y({method:"POST",url:`${s}/friends`,body:e})},async remove(e){return y({method:"DELETE",url:`${s}/friends/${e.friendId}`})}}}function Ma(s){return{async list(){return y({method:"GET",url:`${s}/clubs`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/clubs/get${n?"?"+n:""}`})},async create(e){return y({method:"POST",url:`${s}/clubs`,body:e})},async update(e){return y({method:"POST",url:`${s}/clubs/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${s}/clubs/${e.id}`})}}}function Ha(s){return{async list(){return y({method:"GET",url:`${s}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/courses/by-club${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/courses/get${n?"?"+n:""}`})},async create(e){return y({method:"POST",url:`${s}/courses`,body:e})},async update(e){return y({method:"POST",url:`${s}/courses/update`,body:e})},async updateHole(e){return y({method:"POST",url:`${s}/courses/holes/update`,body:e})},async validate(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/courses/validate${n?"?"+n:""}`})},async remove(e){return y({method:"DELETE",url:`${s}/courses/${e.id}`})}}}function Aa(s){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/tees/by-course${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/tees/get${n?"?"+n:""}`})},async create(e){return y({method:"POST",url:`${s}/tees`,body:e})},async update(e){return y({method:"POST",url:`${s}/tees/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${s}/tees/${e.id}`})}}}function La(s){return{async create(e){return y({method:"POST",url:`${s}/guest-players`,body:e})}}}function za(s){return{async latest(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/handicap/latest${n?"?"+n:""}`})},async history(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/handicap/history${n?"?"+n:""}`})},async record(e){return y({method:"POST",url:`${s}/handicap/record`,body:e})}}}function Ba(s){return{async list(){return y({method:"GET",url:`${s}/rounds`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/rounds/balls${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/rounds/get${n?"?"+n:""}`})},async create(e){return y({method:"POST",url:`${s}/rounds`,body:e})},async createFromDraft(e){return y({method:"POST",url:`${s}/rounds/from-draft`,body:e})},async update(e){return y({method:"POST",url:`${s}/rounds/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${s}/rounds/${e.id}`})}}}function Fa(s){return{async listByRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/score-events/by-round${n?"?"+n:""}`})},async append(e){return y({method:"POST",url:`${s}/score-events`,body:e})}}}function Ga(s){return{async forBall(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/scorecards/for-ball${n?"?"+n:""}`})},async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/scorecards/for-round${n?"?"+n:""}`})}}}function ja(s){return{async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/leaderboards/for-round${n?"?"+n:""}`})}}}function Da(s){return{async create(e){return y({method:"POST",url:`${s}/friendly-rounds`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/by-token${n?"?"+n:""}`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/balls${n?"?"+n:""}`})},async scorecard(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/scorecard${n?"?"+n:""}`})},async result(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/result${n?"?"+n:""}`})},async score(e){return y({method:"POST",url:`${s}/friendly-rounds/score`,body:e})},async setup(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/setup${n?"?"+n:""}`})},async editSetup(e){return y({method:"POST",url:`${s}/friendly-rounds/setup`,body:e})},async remove(e){return y({method:"DELETE",url:`${s}/friendly-rounds/${e.token}`})},async finish(e){return y({method:"POST",url:`${s}/friendly-rounds/finish`,body:e})},async reopen(e){return y({method:"POST",url:`${s}/friendly-rounds/reopen`,body:e})},async setVisibility(e){return y({method:"POST",url:`${s}/friendly-rounds/visibility`,body:e})},async join(e){return y({method:"POST",url:`${s}/friendly-rounds/join`,body:e})},async leave(e){return y({method:"POST",url:`${s}/friendly-rounds/leave`,body:e})},async claimGuest(e){return y({method:"POST",url:`${s}/friendly-rounds/claim-guest`,body:e})},async renameGuest(e){return y({method:"POST",url:`${s}/friendly-rounds/rename-guest`,body:e})},async claimSeat(e){return y({method:"POST",url:`${s}/friendly-rounds/claim-seat`,body:e})},async releaseSeat(e){return y({method:"POST",url:`${s}/friendly-rounds/release-seat`,body:e})}}}function qa(s){return{async myRounds(){return y({method:"GET",url:`${s}/dashboard/my-rounds`})},async friendsActivity(){return y({method:"GET",url:`${s}/dashboard/friends-activity`})}}}function Va(s){return{async clubs(){return y({method:"GET",url:`${s}/setup/clubs`})},async courses(){return y({method:"GET",url:`${s}/setup/courses`})},async teesByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/setup/tees/by-course${n?"?"+n:""}`})},async formats(){return y({method:"GET",url:`${s}/setup/formats`})},async aggregations(){return y({method:"GET",url:`${s}/setup/aggregations`})},async formations(){return y({method:"GET",url:`${s}/setup/formations`})}}}function Ua(s){return{async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/competitions/get${n?"?"+n:""}`})},async participants(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/competitions/participants${n?"?"+n:""}`})},async leaderboard(e){const t=new Set(["id"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/competitions/${e.id}/leaderboard${i?"?"+i:""}`})},async results(e){const t=new Set(["id"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/competitions/${e.id}/results${i?"?"+i:""}`})},async list(){return y({method:"GET",url:`${s}/competitions`})},async create(e){return y({method:"POST",url:`${s}/competitions`,body:e})},async update(e){return y({method:"POST",url:`${s}/competitions/update`,body:e})},async transition(e){return y({method:"POST",url:`${s}/competitions/transition`,body:e})},async createRound(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return y({method:"POST",url:`${s}/competitions/${e.id}/rounds`,body:n})},async applyCut(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return y({method:"POST",url:`${s}/competitions/${e.id}/cut`,body:n})},async finalize(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return y({method:"POST",url:`${s}/competitions/${e.id}/finalize`,body:n})},async addParticipant(e){return y({method:"POST",url:`${s}/competitions/participants/add`,body:e})},async removeParticipant(e){return y({method:"POST",url:`${s}/competitions/participants/remove`,body:e})},async withdrawParticipant(e){return y({method:"POST",url:`${s}/competitions/participants/withdraw`,body:e})}}}function Ka(s){return{async myRoles(){return y({method:"GET",url:`${s}/me/roles`})},async adminStats(){return y({method:"GET",url:`${s}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/admin/rounds${n?"?"+n:""}`})},async adminPlayers(){return y({method:"GET",url:`${s}/admin/players`})},async adminGrantRole(e){return y({method:"POST",url:`${s}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return y({method:"POST",url:`${s}/admin/roles/revoke`,body:e})}}}function Wa(s){return{async myConfig(){return y({method:"GET",url:`${s}/players/me/stats-config`})},async putMyConfig(e){return y({method:"PUT",url:`${s}/players/me/stats-config`,body:e})},async myStats(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/players/me/stats${n?"?"+n:""}`})},async myRoundStats(e){const t=new Set(["roundId"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/players/me/rounds/${e.roundId}/stats${i?"?"+i:""}`})},async appendEvents(e){return y({method:"POST",url:`${s}/friendly-rounds/stat-events`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/stats${n?"?"+n:""}`})},async configsByToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return y({method:"GET",url:`${s}/friendly-rounds/stats-configs${n?"?"+n:""}`})}}}function Ya(s){return{async profile(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/friends/${e.playerId}/profile${i?"?"+i:""}`})},async rounds(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/friends/${e.playerId}/rounds${i?"?"+i:""}`})},async courses(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/friends/${e.playerId}/courses${i?"?"+i:""}`})}}}function Qa(s){return{async round(e){const t=new Set(["roundId"]),n=new URLSearchParams;for(const[r,d]of Object.entries(e))!t.has(r)&&d!==void 0&&n.set(r,String(d));const i=n.toString();return y({method:"GET",url:`${s}/spectate/rounds/${e.roundId}${i?"?"+i:""}`})}}}const q="/tapscore/".replace(/\/+$/,"")+"/api",_={players:Ra(q),friends:Oa(q),clubs:Ma(q),courses:Ha(q),tees:Aa(q),guestPlayers:La(q),handicap:za(q),rounds:Ba(q),scoreEvents:Fa(q),scorecards:Ga(q),leaderboards:ja(q),friendlyRounds:Da(q),dashboard:qa(q),setup:Va(q),competitions:Ua(q),admin:Ka(q),playerStats:Wa(q),friendProfile:Ya(q),spectate:Qa(q)};function Xa(s){return[...s.played?["Played"]:[],...s.created?["Created"]:[]].join(" · ")}function Ja(s,e){const t=new Map;for(const n of e)t.set(n.round.id,{round:n.round,token:n.friendlyRound.shareToken,holesPlayed:null,played:!1,created:!0});for(const n of s){const i=t.get(n.round.id);i?(i.played=!0,i.holesPlayed=n.progress?.holesPlayed??null):t.set(n.round.id,{round:n.round,token:n.shareToken,holesPlayed:n.progress?.holesPlayed??null,played:!0,created:!1})}return[...t.values()].sort((n,i)=>(i.round.lastActivityAt??"").localeCompare(n.round.lastActivityAt??"")||i.round.date.localeCompare(n.round.date)||n.round.id.localeCompare(i.round.id))}function Za(s,e){return s.filter(t=>t.played&&!t.created&&!e.has(t.round.id)).slice().sort((t,n)=>n.round.date.localeCompare(t.round.date)||t.round.id.localeCompare(n.round.id))}function yt(s,e){return s.some(t=>t.round.id===e)?s.filter(t=>t.round.id!==e):s}function Z(){try{return globalThis.localStorage??null}catch{return null}}function pt(s,e,t){return{read(n=Z()){if(!n)return e.empty;let i;try{i=n.getItem(s)}catch{return e.empty}if(!i)return e.empty;try{return e.decode(i)}catch{return e.empty}},write(n,i=Z()){if(!i)return e.empty;const r=t!==void 0&&Array.isArray(n)?n.slice(0,t):n;try{i.setItem(s,e.encode(r))}catch{}return r}}}function zs(s){return{decode(e){const t=JSON.parse(e);return Array.isArray(t)?t.filter(s):[]},encode:e=>JSON.stringify(e),get empty(){return[]}}}const eo=500,Bs=pt("tapscore.seen-rounds.v1",zs(s=>typeof s=="string"),eo);function Dt(s=Z()){return Bs.read(s)}function as(s=Z()){return new Set(Dt(s))}function to(s,e=Z()){return Dt(e).includes(s)}function so(s,e=Z()){if(!e)return[];const t=Dt(e).filter(n=>n!==s);return Bs.write([s,...t],e)}function Hi(s,e=Z()){if(!e)return[];const t=Dt(e),n=t.filter(i=>i!==s);return n.length!==t.length&&Bs.write(n,e),n}const no=50,Fs=pt("tapscore.device-rounds.v1",zs(io),no);function qt(s=Z()){return Fs.read(s)}function io(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.courseName=="string"&&(e.status==="not_started"||e.status==="active"||e.status==="complete")&&typeof e.lastSeenAt=="string"}function Qe(s,e=Z()){if(!e)return[];const t=qt(e).filter(n=>n.token!==s.token);return Fs.write([s,...t],e)}function Ai(s,e=Z()){if(!e)return[];const t=qt(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&Fs.write(n,e),n}class Vt{mine=new p(null);mineLoading=new p(!1);mineError=new p(null);myRounds=new k(()=>{const e=this.mine.get();return e?Ja(e.produced,e.created):[]});deviceRounds=new p([]);seenIds=new p(as());newRounds=new k(()=>Za(this.myRounds.get(),this.seenIds.get()));async loadMine(){this.seenIds.set(as());const e=await G(this.mineLoading,this.mineError,()=>_.dashboard.myRounds());e&&this.mine.set(e)}loadDevice(){this.deviceRounds.set(qt())}clear(){this.mine.set(null),this.mineError.set(null),this.mineLoading.set(!1),this.seenIds.set(as()),this.loadDevice()}async remove(e,t){try{await _.friendlyRounds.remove({token:e})}catch(i){if(!(i instanceof K)||i.status!==404)return!1}const n=this.mine.get();return n&&this.mine.set({produced:yt(n.produced,t),created:yt(n.created,t)}),this.deviceRounds.set(Ai(e)),Hi(t),!0}async leave(e,t){try{const i=await _.friendlyRounds.leave({token:e});if(!i.ok)return{ok:!1,message:i.diagnostics.map(r=>r.message).join(" · ")}}catch{return{ok:!1,message:"Could not remove you right now. Try again."}}const n=this.mine.get();return n&&this.mine.set({produced:yt(n.produced,t),created:yt(n.created,t)}),{ok:!0}}}const ro={DEV:!1};function ao(s,e){return s===void 0||s===""?e:s!=="0"&&s.toLowerCase()!=="false"}const gn=ro??{},Li={competitions:ao(gn.VITE_FEATURE_COMPETITIONS,!!gn.DEV)},oo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5 12 4l8 7.5"/><path d="M6 10v10h12V10"/><path d="M10 20v-5.5h4V20"/></svg>',lo='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M3.5 20c.5-3.5 2.7-5.5 5.5-5.5s5 2 5.5 5.5"/><circle cx="16.5" cy="9.5" r="2.8"/><path d="M16.8 14.6c2.2.4 3.5 2 3.9 4.9"/></svg>',co='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4h8v3a4 4 0 0 1-8 0V4Z"/><path d="M8 5H5v2a3 3 0 0 0 3 3"/><path d="M16 5h3v2a3 3 0 0 1-3 3"/><path d="M10 12.5V15h4v-2.5"/><path d="M9 20h6"/><path d="M12 15v5"/></svg>';function uo(s){const e=[{key:"home",label:"Home",href:"/",icon:oo},{key:"friends",label:"Friends",href:"/friends",icon:lo}];return s.competitions&&e.push({key:"comps",label:"Comps",href:"/competitions",icon:co}),e}const ho=["/login","/round"];function Gs(s){return!ho.includes(s)}function bn(s,e){return e&&Gs(s)}function po(s){return Gs(s)&&s!=="/create"}const fo=b(`
...
`);class go extends H{static styles=`
        .dock {
    ...
    `;router=this.inject(j);auth=this.inject(D);landing=this.inject(Vt);newCount=new k(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(fo,{bar:{className:()=>bn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return po(r)?bn(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=uo(Li),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(mo,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const o=this.newCount.get();return o===0?"":String(o)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,o)=>i(r,o),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,o)=>i(r,o),r=>r.key),e}}const zi=["tee","approach","putting","shortGame","penalties","recovery"],It={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function Bi(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function bo(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const yo="Track statistics",_o="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function Fi(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Et(s,e){return s[e]}function vo(s,e){if(!s.enabled)return!0;const t=Fi(e);return t===null?!1:!Et(s,t)}function wo(s,e){if(!s.enabled)return null;const t=Fi(e);return t===null||Et(s,t)?null:`Needs ${Bi(t)}`}function xo(s,e,t){return ko({...s,[e]:t})}function $o(s,e){return{...s,enabled:e}}function ko(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function os(s){const e={...It,enabled:s.enabled};for(const t of zi)e[t]=s[t];return e}function So(s){return s.avatarVersion?`${q}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function To(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(_t(t[0])+_t(t[t.length-1])).toUpperCase();if(t.length===1)return _t(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?_t(n).toUpperCase():"•"}function _t(s){return[...s][0]??""}const vt=512,Po=2*1024*1024;function Io(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Co=.85;class Xe extends Error{}async function Eo(s){let e;try{e=await createImageBitmap(s)}catch{throw new Xe("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Io(e.width,e.height),r=document.createElement("canvas");r.width=vt,r.height=vt;const d=r.getContext("2d");if(!d)throw new Xe("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,vt,vt);const o=await new Promise(c=>r.toBlob(c,"image/jpeg",Co));if(!o)throw new Xe("That image could not be processed.");if(o.size>Po)throw new Xe("That image is too large.");return o}finally{e.close()}}async function No(s){const e=await fetch(`${q}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await Gi(e);return await e.json()}async function Ro(){const s=await fetch(`${q}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await Gi(s)}async function Gi(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new K(t,Oo(e.error,s.status))}function Oo(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Ue{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(It);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await G(this.loading,this.error,()=>Promise.all([_.players.me(),_.players.myHandicapHistory(),_.clubs.list(),_.playerStats.myConfig().catch(()=>null),_.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,o]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?os(d):It),this.hasRecordedStats.set((o?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(It),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await G(this.saving,this.saveError,()=>_.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await G(this.saving,this.saveError,()=>_.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await G(this.saving,this.saveError,()=>_.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await G(this.saving,this.saveError,()=>_.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await G(this.statsSaving,this.statsError,()=>_.playerStats.putMyConfig(os(e)));return t?(this.statsConfig.set(os(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await Eo(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof Xe?i.message:"That image could not be prepared."}),!1}const n=await G(this.avatarSaving,this.avatarError,()=>No(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await G(this.avatarSaving,this.avatarError,()=>Ro().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function wt(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function ls(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Nt(s,e="frecency"){return e==="alpha"?[...s].sort(ls):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,o=r>0;if(d!==o)return d?-1:1;if(!d)return ls(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:ls(t,n)})}const Mo=1440*60*1e3;function Ho(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/Mo);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function Ao(s,e){if(s.sharedRoundCount<=0)return"never played";const t=Ho(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function Lo(s){return s.isMutual?null:"hasn't added you back"}const ji=2;function yn(s){return s.trim().length>=ji}function Di(s){return Nt(s,"frecency")}function zo(s,e){return Di([...s.filter(t=>t.id!==e.id),e])}function Bo(s,e){return s.filter(t=>t.id!==e)}function _n(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function Fo(s,e,t=()=>{},n=300){let i=0,r;return d=>{const o=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,o.length<ji){e(o,[]);return}r=setTimeout(()=>{s(o).then(u=>{c===i&&e(o,u)},u=>{c===i&&t(o,u)})},n)}}const qi=pt("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function Go(s=Z()){return qi.read(s)}function jo(s,e=Z()){qi.write(s,e)}class Ut{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(Go());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Fo(e=>_.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await G(this.loading,this.error,()=>_.friends.list());t&&(this.friends.set(Di(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await G(this.mutating,this.mutateError,()=>_.friends.add({friendId:e.id}))&&(this.friends.set(zo(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(_n(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),jo(e)}async remove(e){await G(this.mutating,this.mutateError,()=>_.friends.remove({friendId:e}))&&(this.friends.set(Bo(this.friends.get(),e)),this.results.set(_n(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class js{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await _.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Je(s,e){return s instanceof K&&s.status===401?(Ri(),"Your session expired — sign in again."):e}function Rt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function Do(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${Rt(s.scoreToPar)}`}function Vi(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function Ui(s){return(s.courseName??"").trim()||null}function qo(s){const e=[];for(const t of s){const n=t.friends[0],i=Vi(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:Ui(t),progress:Do(n)})}return e}function Vo(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function Uo(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function Ko(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function Wo(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${Rt(s.scoreToPar)}`}function Yo(s){const e=[];for(const t of s){const n=t.friends[0],i=Vi(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:Ui(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function Ki(s){if(s instanceof K){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const De={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function Qo(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function Xo(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function Jo(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${Rt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${Rt(s.scoreToPar)}`}}}function Zo(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function el(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function tl(s){return s===1?"1 course played":`${s} courses played`}const ds={rounds:[],nextCursor:null,hasMore:!1};function vn(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function Wi(s){return s.hasMore&&s.nextCursor!==null}class Kt{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(ds);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await _.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Je(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await _.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(vn(ds,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Je(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!Wi(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await _.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(vn(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Je(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await _.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Je(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=Ki(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(ds),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function Yi(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function sl(s){return Math.round(Yi(s))}function nl(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,o=r+(e>n-d?1:0);return o===0?0:-o}function il(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function me(){return il()}const Re=10;class qe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await G(this.loading,this.error,()=>_.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=me()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=me()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=me()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=me()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=me()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=me()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Re:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const wn=["scramble","foursomes","greensomes"];class rl{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof _.setup?.formations=="function")return this.inFlight=(async()=>{const e=await G(this.loading,this.error,()=>_.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=wn.indexOf(n);return i===-1?wn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=me()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const al=180,xn=4,ol=12;function Ge(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function ll(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<ol)return 0;const i=e+t*al,r=Math.round(-i/n);return Math.max(-xn,Math.min(xn,r))}const $n="tapscore:pending-scores:v1",dl=336*60*60*1e3,kn=200;function cl(){try{return globalThis.localStorage??null}catch{return null}}function ul(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class hl{entries=[];storage;constructor(e=cl(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=dl);return t.length>kn?t.slice(t.length-kn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem($n);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(ul):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem($n,JSON.stringify(this.entries))}catch{}}}const _e=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","putts","penalties","penalty_source"],pl={minPar:4},fl={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Missed where",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},ml={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Around the green"}]}};function Is(s){return fl[s]}function Sn(s){return ml[s]}function gl(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function Qi(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function bl(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function yl(s,e,t){return e-t<=s-2?"1":"0"}function Cs(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class _l{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=Tn(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=Tn(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!bl(this.par,this.strokes,e)?null:yl(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Cs(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of _e)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Cs(this).state};`,e}get prompts(){const e=[];for(const t of _e)this.isVisible(t)&&e.push({key:t,label:Is(t),control:Sn(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Qi(pl,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune())}step(e,t){const n=Sn(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<_e.length;e++){let t=!1;for(const n of _e){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),vl(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of _e){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function vl(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function Tn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of _e){const n=s[t];n!==void 0&&e.set(t,n)}return e}const Pn="tapscore:pending-stat-events:v1",wl=336*60*60*1e3,In=500;function xl(){try{return globalThis.localStorage??null}catch{return null}}function $l(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function kl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&_e.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Sl{entries=[];storage;makeId;constructor(e=xl(),t=Date.now(),n=$l){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const o of i){const c={token:e,playHoleId:t,playerId:n,key:o.key,value:o.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===o.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=wl);return t.length>In?t.slice(t.length-In):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Pn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(kl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Pn,JSON.stringify(this.entries))}catch{}}}const Tl=50;function Pl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const Ds=pt("tapscore.result-cursors.v1",zs(Pl),Tl);function qs(s=Z()){return Ds.read(s)}function Il(s,e=Z()){return qs(e).find(t=>t.token===s)?.cursor??null}function Cl(s,e,t=Z()){if(!t)return[];const n=qs(t).filter(i=>i.token!==s);return Ds.write([{token:s,cursor:e},...n],t)}function El(s,e=Z()){if(!e)return[];const t=qs(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&Ds.write(n,e),n}const Nl=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Pe=(s,e)=>`${s}|${e}`;function Vs(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function Rl(s,e,t){return Qi(s,e,t)}function cs(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Ol(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function Ml(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class fe{constructor(e=new hl,t=new Sl){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),U.get(qe).load();const r=await G(this.loading,this.error,()=>_.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Qe({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!to(r.round.id))),U.get(D).currentUser.get()&&so(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,o,c,u]=await Promise.all([_.friendlyRounds.balls({token:e}).catch(()=>[]),_.friendlyRounds.scorecard({token:e}).catch(()=>[]),_.playerStats.configsByToken({token:e}).catch(()=>null),_.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(o),this.balls.set(d),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await _.friendlyRounds.remove({token:e}),Ai(e);const t=this.round.get()?.id;return t&&Hi(t),El(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await G(this.resultLoading,this.resultError,()=>_.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await _.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await _.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await _.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?Il(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Cl(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await _.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Qe({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Vs(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new k(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(d=>n.subjectLabels?.some(o=>o.ballId===d&&o.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const d=r.entries.find(o=>i(o.ballIds));if(!d)continue;return d.total===null?null:d.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-d.paceDelta:d.paceDelta}:{kind:"total",total:d.total}}if(r.kind==="match_summary"){const d=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!d)continue;if(d.thru===0&&!d.finished)return null;const o=i(d.sideA.ballIds)?"a":"b";if(d.leader===null||d.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=d.leader===o;return{kind:"match",text:`${d.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Ge(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,o)=>d.ordinal-o.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${Nl[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Ge(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Ge(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(d=>{const o=n.get(d.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return o?.strokes===null||o===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Pe(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Pe(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const o=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===o)?.strokeIndex??d.baseStrokeIndex;return nl(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Cs(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new _l(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Ol(t):new Map;for(const i of _e){const r=cs(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=cs(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=cs({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await _.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return Ml(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Pe(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=U.get(qe),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const o of d)i.has(o.key)||(i.add(o.key),n.push(o))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Rl(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Pe(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const o=this.token;o&&(this.enqueue(o,e,t,n,i,d),await this.post(o,e,t,n,i,d))}async retry(e,t){const n=Pe(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Pe(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const o=Pe(t,n);try{await _.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class Xi{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await _.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=Ki(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Je(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await _.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Vs(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new k(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class Ji{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await _.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await G(this.loading,this.error,()=>Promise.all([_.admin.adminStats(),_.admin.adminRounds({limit:100}),_.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const Hl=["last5","last10","last20","thisYear","all","custom"];function Ot(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function Al(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function Us(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const st={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function Ll(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function zl(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function us(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function Bl(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Wt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function Zi(s){return`${s.getFullYear()}-`}function er(s,e,t,n){const i=Wt(t);switch(s){case"last5":case"last10":case"last20":{const r=Us(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=Zi(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>zl(e,r))}}function tr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=Us(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${Zi(r)}01-01`;return!n.some(o=>o.date<d)}case"all":return!0;case"custom":{if(Ll(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(o=>o.date<d)}}}const Fl="Unnamed course";function Gl(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??Fl,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Mt="last10";function jl(s){return Hl.includes(s)}const sr=pt("tapscore.stats.window.v1",{decode:s=>jl(s)?s:Mt,encode:s=>s,empty:Mt});function Es(s=Z()){return sr.read(s)}function Cn(s,e=Z()){sr.write(s,e)}function x(s,e){return{value:e===0?null:s/e,n:s,d:e}}const at=5;function Le(s,e=at){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const Ns=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0});function Dl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker}}function ql(s){let e=Ns;for(const t of s)e=Dl(e,t);return e}const Me=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function Ks(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function Vl(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function Ul(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function nr(s){return x(s.fairwayHits,s.teeRecorded)}function Kl(s){return x(s.troubleCount,s.teeRecorded)}function Wl(s){return x(s.holesWithPenalty,s.penaltiesRecorded)}function Yl(s){return{penalty:x(s.strokesVsParPenalty,s.holesScoredPenalty),clean:x(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function Ql(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return x(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Xl(s){return x(s.recoverySuccesses,s.recoveryAttempts)}function Jl(s,e){return x(s.penaltiesTotal,e)}function Zl(s){return{fairway:x(s.strokesVsParFairway,s.holesScoredFairway),inPlay:x(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:x(s.strokesVsParTrouble,s.holesScoredTrouble)}}function ed(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return x(e,s.holesScoredTrouble*s.holesScoredFairway)}function ir(s){return x(s.girHits,s.girRecorded)}function td(s){return{fairway:x(s.girHitsFairway,s.girRecordedFairway),inPlay:x(s.girHitsInPlay,s.girRecordedInPlay),trouble:x(s.girHitsTrouble,s.girRecordedTrouble)}}function sd(s){return{par3:x(s.girHitsPar3,s.girRecordedPar3),par4:x(s.girHitsPar4,s.girRecordedPar4),par5:x(s.girHitsPar5,s.girRecordedPar5)}}function nd(s){const e=x(s.strokesVsParGirHit,s.girHolesScored),t=x(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:x(n,s.holesScoredGirMiss*s.girHolesScored)}}function id(s,e){return x(Ul(s,e),s.girFirstPuttRecorded)}function rd(s){let e=0;for(const t of Me)e+=Ks(s,t);return e}function ad(s,e){return x(Ks(s,e),rd(s))}function od(s){return x(s.birdiesOnGir,s.girHolesScored)}function ld(s){return x(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function dd(s){const e=s.greenMissRecorded;return{long:x(s.greenMissLong,e),short:x(s.greenMissShort,e),left:x(s.greenMissLeft,e),right:x(s.greenMissRight,e)}}function cd(s){return{left:x(s.teeMissLeft,s.teeMissRecorded),right:x(s.teeMissRight,s.teeMissRecorded),troubleLeft:x(s.teeTroubleLeft,s.teeMissLeft),troubleRight:x(s.teeTroubleRight,s.teeMissRight)}}function ud(s){const e=s.penaltySourceRecorded;return{tee:x(s.penaltiesTee,e),approach:x(s.penaltiesApproach,e),short:x(s.penaltiesShort,e)}}function hd(s,e){return x(Vl(s,e),Ks(s,e))}function pd(s){return x(s.threePutts,s.puttsRecorded)}function fd(s){const e=s.puttsRecorded;return{zero:x(s.holesZeroPutt,e),one:x(s.holesOnePutt,e),two:x(s.holesTwoPutt,e),threePlus:x(s.threePutts,e)}}function md(s){return{par3:x(s.puttsTotalPar3,s.puttsRecordedPar3),par4:x(s.puttsTotalPar4,s.puttsRecordedPar4),par5:x(s.puttsTotalPar5,s.puttsRecordedPar5)}}function gd(s){return x(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function bd(s){return x(s.puttsTotalGir,s.puttsRecordedGir)}function yd(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return x(e,t)}function rr(s){return{standard:x(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:x(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:x(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function _d(s){return x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function vd(s){return x(s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function wd(s){return x(s.holesMultiChipBunker,s.scrambleAttemptsBunker)}function xd(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function $d(s){return{standard:x(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:x(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:x(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:x(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function kd(s){return{par3:x(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:x(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:x(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Sd(s,e){return x(s.doubleBogeyPlus,e)}function Td(s){return x(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Pd=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],Id=18;function Cd(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let f=r.get(c.holeCount);if(f||(f={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,f)),f.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;f.completeRounds+=1;const h=u.strokesTotal-u.parTotal;(f.best===null||h<f.best.vsPar)&&(f.best={vsPar:h,strokes:u.strokesTotal})}const d=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let o=0;for(const c of d)o+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:o,lengths:d,avgVsParPer18:x(n*Id,t),scoreTypeCounts:i}}const ar=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),Ed=Object.freeze({inside2m:1.25,outside2m:2.12}),Nd=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),or=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),de=["tee","approach","shortGame","putting","penalties"];function ot(s,e=or,t=ar,n=Ed,i=Nd){const r=s.attHolesPar3Gir+s.attHolesPar3Miss,d=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,o=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,c=r+d+o,u={attributed:c,holesScored:s.holesScored};if(c===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const f=d+o,m=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,h=s.attMissStandard+s.attMissHard+s.attMissBunker,g=r*e.eHole[3]+d*e.eHole[4]+o*e.eHole[5],w=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+r*e.eHole[3],T=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m,R=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,L=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,V=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),O=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),W=s.attStrokes-s.attPutts-s.attPenalties-f-m+T+V-w,ae=m-h+R-L,oe=s.attPutts-(T+R),Dr=s.attPenalties,qr=s.attStrokes-g;return{tee:O,approach:W,shortGame:ae,putting:oe,penalties:Dr,total:qr,coverage:u}}const lr=9;function xe(s,e){return dr(s,Ve(s,e))}function En(s){return dr(s,s.total)}function dr(s,e){return e===null||s.coverage.attributed<lr?null:e*18/s.coverage.attributed}function Ve(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function cr(s,e){const t=n=>Nn(xe(s,n),e.map(i=>xe(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:Nn(En(s),e.map(En))}}function Ws(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function Ys(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function Nn(s,e){if(s===null)return null;const t=Ys(e);return t===null?null:s-t}function Rd(s){return s.penalties}const Rn=1,Od=2,Md=.75,Hd=4,Ad=3,Ld=12,zd=5,Bd=2,Fd=10,On=.35;function Gd(s,e,t,n){const i=cr(e,t),r=[];let d=0;const o=(T,R)=>{r.push({line:T,magnitude:R,order:d++})};let c=null,u=null;for(const T of de){const R=Ws(i,T);R!==null&&((c===null||R<c.delta)&&(c={component:T,delta:R}),(u===null||R>u.delta)&&(u={component:T,delta:R}))}c!==null&&c.delta<=-Rn&&o({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=Rn&&o({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=Ys(t.map(Rd)),m=e.penalties;f!==null&&m!==null&&m>=f+Od&&o({id:"penalties_spike",params:{penalties:m,baseline:f}},0),s.teeMissRecorded>=Fd&&s.teeMissLeft>=On*s.teeMissRecorded&&s.teeMissRight>=On*s.teeMissRecorded&&o({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=Ad&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&o({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const h=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,g=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;h>=Hd&&g>=Md*h&&o({id:"scramble_streak",params:{successes:g,attempts:h}},0),s.threePutts===0&&s.puttsTotal>=Ld&&o({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const v=xe(e,"putting"),w=t.map(T=>xe(T,"putting")).filter(T=>T!==null);return v!==null&&w.length>=zd&&w.every(T=>v<T)&&o({id:"best_putting_round",params:{putting:v,rounds:w.length}},0),s.bounceBackOpportunities>=Bd&&s.bounceBackSuccesses===s.bounceBackOpportunities&&o({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((T,R)=>R.magnitude-T.magnitude||T.order-R.order),r.slice(0,Math.max(0,n)).map(T=>T.line)}const jd=["tee","approach","putting","shortGame","scoring"];function Dd(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const qd=3,ur={rounds:[],totals:Ns,waterfall:ot(Ns),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function Qs(s){const e=Wt(s);if(e.length===0)return ur;const t=ql(e.map(r=>r.measures)),n=e.map(r=>ot(r.measures)),i=e.length;return{rounds:e.map((r,d)=>{const o=n[d];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:r.measures.holesScored===0?null:r.measures.strokesTotal-r.measures.parTotal,waterfall:o}}),totals:t,waterfall:ot(t),priorities:Vd(n),trends:Ud(e),tee:Kd(t,i),approach:Wd(t),putting:Yd(t),shortGame:Qd(t),scoring:Xd(t,i),results:Cd(e)}}function Vd(s){const e=de.map(n=>{const i=s.map(r=>xe(r,n));return{component:n,per18:Ys(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>de.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function hs(s){return Le(s)==="percentage"?s.value:null}function Ud(s){const e=[...s].reverse(),t=(n,i,r,d)=>{const o=[];for(const c of e){const u=d(c.measures);u!==null&&o.push(u)}return o.length>=qd?{id:n,title:i,kind:r,points:o}:null};return[t("fairway","Fairways","percentage",n=>hs(nr(n))),t("gir","Greens","percentage",n=>hs(ir(n))),t("putting","Putting","strokesLost",n=>xe(ot(n),"putting")),t("scramble","Scrambling","percentage",n=>hs(rr(n).overall))].filter(n=>n!==null)}function Kd(s,e){return s.teeRecorded<=0?null:{fairway:nr(s),inPlayOnly:x(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:Kl(s),troubleTax:ed(s),vsParByTee:Zl(s),recovery:Xl(s),teeMiss:cd(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:Jl(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:Wl(s),penaltyTax:Ql(s),vsParByPenalty:Yl(s),penaltySource:ud(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function Wd(s){if(s.girRecorded<=0)return null;const e={};for(const t of Me)e[t]=id(s,t);return{gir:ir(s),girByTee:td(s),girFirstPuttMix:e,birdieConversion:od(s),hardChipShare:ld(s),girByPar:sd(s),greenMiss:dd(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:nd(s)}}function Yd(s){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const e={};for(const t of Me)e[t]=ad(s,t);return{ladder:Me.map(t=>({bucket:t,made:hd(s,t),baseline:Math.max(0,2-ar[t])})),firstPuttSpread:e,threePutt:pd(s),threePuttsFromOver8m:gd(s),puttsPerGirHole:bd(s),puttsAfterMissedGreen:yd(s),puttDistribution:fd(s),puttsPerHoleByPar:md(s)}}function Qd(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:rr(s),chipInside2m:$d(s),conversionInside2m:x(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:_d(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,multiChip:vd(s),multiChipBunker:wd(s),extraShortGameStrokes:xd(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded}}function Xd(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:kd(s),doubleBogeyPlusPerRound:Sd(s,e),bounceBack:Td(s)}}function hr(s){let e=0;for(const t of s)for(const n of de){const i=Ve(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Jd(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function Xs(s){const e=U.get(qe);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function Zd(s){const e=U.get(qe);return e.load(),e.labelOf(s)??s}function ec(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:Xa(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(Xs).join(" · ")}))}function tc(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function lt(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Ht(s){return s.courseName?lt(s)===s.courseName?null:s.courseName:null}function Ae(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const nt={fromMyRounds:ec,fromDeviceRounds:tc};function ce(s){switch(Le(s)){case"absent":return null;case"fraction":return`${J(s.n)} of ${J(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function sc(s){return Le(s)!=="percentage"?null:`${J(s.n)} of ${J(s.d)}`}function se(s){const e=ce(s);if(e===null)return null;const t=sc(s);return t===null?e:`${e} (${t})`}function dt(s,e=2,t=!1){return Le(s)==="absent"||s.value===null?null:t?Se(s.value,e):$e(s.value,e)}function Yt(s){return{one:s,many:`${s}s`}}const be=Yt("round"),le=Yt("hole"),Rs=Yt("green"),Js="thin sample";function pr(s,e){switch(Le(s)){case"absent":return null;case"fraction":return`over ${ee(s.d,e)} — ${Js}`;case"percentage":return`over ${ee(s.d,e)}`}}function re(s,e){const t=dt(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=pr(s,e.unit);return i===null?n:`${n} (${i})`}const nc={one:"hole from trouble",many:"holes from trouble"},ic={one:"from the fairway",many:"from the fairway"};function rc(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${ee(e,nc)} vs ${ee(t,ic)}`;return e<at||t<at?`${n} — ${Js}`:n}function fr(s,e,t,n){if(s.d<=0||t.d<=0)return null;const i=`over ${ee(s.d,e)} vs ${ee(t.d,n)}`;return s.d<at||t.d<at?`${i} — ${Js}`:i}const ac={one:"hole with the green missed",many:"holes with the green missed"},oc={one:"green hit",many:"greens hit"},lc={one:"hole with a penalty",many:"holes with a penalty"},dc={one:"without",many:"without"},cc=Yt("penalty hole");function uc(s){return fr(s.miss,ac,s.hit,oc)}function hc(s){return fr(s.penalty,lc,s.clean,dc)}function pc(s){return Le(s)==="fraction"}function J(s){return s===Math.round(s)?String(Math.round(s)):$e(s,1)}function ee(s,e){return`${J(s)} ${s===1?e.one:e.many}`}function $e(s,e=1){return s.toFixed(e)}function Se(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return $e(0,e);const i=$e(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function fc(s){return`${Se(s)} per 18`}function Qt(s){return s===0?"E":Se(s,s===Math.round(s)?0:1)}function Xt(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function ps(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function mc(s){return s==="indoor"?"Indoor":"Outdoor"}function gc(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function mr(s){return Ae(s)}const gr="Statistics",bc="All statistics →";function yc(s){return s==="custom"?Mt:s}function _c(s,e,t){return Us(s)!==null||!t?Ot(s):`${Ot(s)} — newest ${e}`}function vc(s){return x(s.strokesTotal-s.parTotal,s.holesScored)}function wc(s){const e=[],t=vc(s.totals),n=dt(t,2,!0);if(n!==null){const c=Le(t)==="fraction"?pr(t,le):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:ce(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,o=d===null?null:ce(d.gir);return o!==null&&e.push({id:"gir",value:o,label:"Greens in regulation",note:null}),e}function xc(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${Xt(e.component)}`}function $c(s){const e=yc(s.preset),t=er(e,st,s.rows,s.now);if(t.length===0)return null;const n=Qs(t),i=wc(n);if(i.length===0)return null;const r=tr({preset:e,filter:st,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:_c(e,t.length,r),tiles:i,priorityLine:xc(n)}}function kc(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${gr}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class Jt{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(Es());loaded=!1;loading=!1;card=new k(()=>{const e=this.rows.get();return e===null?null:$c({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(Es())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await _.playerStats.myStats({limit:Jt.PAGE_SIZE});this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof K&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const dn=class dn extends H{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(E(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};dn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let Os=dn;const A=s=>`var(--${s})`,cn=class cn extends H{render(){const e=document.createElement("div"),t=(c,u)=>{typeof u=="function"?this.track(E(()=>{c.textContent=u()})):c.textContent=u};this.spawn(Os,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200";const n=document.createElement("h2");n.className="ui-confirm__title",t(n,this.props.title??"Confirm"),this.dialogEl.appendChild(n);const i=document.createElement("p");i.className="ui-confirm__message",t(i,this.props.message),this.dialogEl.appendChild(i);const r=document.createElement("div");r.className="ui-confirm__actions";const d=document.createElement("button");d.className="ui-confirm__btn ui-confirm__btn--cancel",t(d,this.props.cancelLabel??"Cancel"),d.addEventListener("click",c=>{c.stopPropagation(),this.handleCancel()}),r.appendChild(d);const o=document.createElement("button");return o.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(o,this.props.confirmLabel??"Confirm"),o.addEventListener("click",c=>{c.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),r.appendChild(o),this.dialogEl.appendChild(r),this.dialogEl.addEventListener("click",c=>c.stopPropagation()),e.appendChild(this.dialogEl),this.track(E(()=>{this.dialogEl.classList.toggle("open",this.props.open.get())})),e}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}};cn.styles=`
        .ui-confirm {
            position: fixed;
            top: 50%;
            left: 50%;
    ...
    `;let ie=cn;async function Sc(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Tc="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Te(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function we(s){const e=()=>So(s());return{avatarPhoto:{src:()=>e()??Tc,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return To(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function He(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function Pc(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Ic(s){return Pc(s).map(e=>e.kind)}function Mn(s){return s.signedIn?"avatar":"signin"}const Cc=b(`
...
`);class Ec extends H{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
    ...
    `;auth=this.inject(D);profile=this.inject(Ue);friends=this.inject(Ut);activity=this.inject(js);friendProfile=this.inject(Kt);spectate=this.inject(Xi);admins=this.inject(Ji);homeStats=this.inject(Jt);landing=this.inject(Vt);router=this.inject(j);open=new p(!1);state=new k(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));signOutAllOpen=new p(!1);has(e){return Ic(this.state.get()).includes(e)}rowClass(e,t=""){const n=`acct__row${t}`;return this.has(e)?n:`${n} hidden`}async signOut(e={}){await Sc({auth:this.auth,profile:this.profile,friends:this.friends,activity:this.activity,friendProfile:this.friendProfile,spectate:this.spectate,admins:this.admins,homeStats:this.homeStats,landing:this.landing,navigate:t=>this.router.navigate(t)},e)}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(Cc,{signin:{className:()=>Mn(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},...we(()=>{const u=this.profile.player.get();return{id:u?.id??"",avatarVersion:u?.avatarVersion??null,displayName:this.state.get().displayName,username:this.state.get().username}}),avatar:{className:()=>Mn(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden","aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const u=this.state.get();return(u.displayName??"").trim()||(u.username??"").trim()||"Signed in"},idUser:()=>{const u=(this.state.get().username??"").trim();return u===""?"":`@${u}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOut()}},signoutAll:{className:()=>this.rowClass("signout-all"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOutAllOpen.set(!0)}}});this.spawn(ie,this.ref(e,"confirmHost"),{open:this.signOutAllOpen,title:"Sign out everywhere?",message:"Every device signed in to this account is signed out, including this one. Rounds and scores are untouched — you can sign back in with your password.",confirmLabel:"Sign out everywhere",cancelLabel:"Cancel",onconfirm:()=>{this.signOut({everywhere:!0})}});const t=this.ref(e,"root"),n=e.querySelector('[bind="avatar"]'),i=u=>{u.key==="Escape"&&this.open.get()&&(this.open.set(!1),n?.focus())},r=u=>{if(!this.open.get())return;const f=u.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let d=!1;const o=()=>{d||(d=!0,window.addEventListener("keydown",i),document.addEventListener("pointerdown",r,!0))},c=()=>{d&&(d=!1,window.removeEventListener("keydown",i),document.removeEventListener("pointerdown",r,!0))};return this.track(E(()=>{this.open.get()?o():c()})),this.track(c),e}}function je(s){return s.token===null?null:s.created?"delete":s.played?"leave":null}function br(s){return s==="delete"?"Delete round":"Remove me from this round"}const Nc=14,Rc=1440*60*1e3;function We(s,e){return e(s)}function Oc(s,e,t,n=Nc){const i=e-n*Rc,r=[],d=[];for(const o of s){const c=We(o,t);if(c.status==="complete"){const u=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(u)||u>=i)&&d.push(o)}else r.push(o)}return r.sort((o,c)=>Hn(We(o,t).lastActivityAt,We(c,t).lastActivityAt)),d.sort((o,c)=>Hn(We(o,t).completedAt,We(c,t).completedAt)),{ongoing:r,finished:d}}function Hn(s,e){const t=s?Date.parse(s):NaN,n=e?Date.parse(e):NaN,i=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(n)?Number.NEGATIVE_INFINITY:n;return i===r?0:r-i}const Mc=3,yr=4;function fs(s){return s==null||!Number.isFinite(s)?null:`HCP ${s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}`}function _r(s){return s>yr}function Hc(s){return s.rows===0||s.finished>0?!1:!_r(s.ongoing)}function Ac(s){return s.rows===0}const Lc=b(`
...
`),zc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Zs=`
...
`,Bc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${Zs}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${zc}</button>
...
`),jc=b(`
    <button bind="row" type="button" class="round-summary recent-row">
        ${Te("recent-row__avatar")}
        <span class="recent-row__content">${Zs}</span>
    </button>
`);class An extends H{static styles=`
        .landing {
    ...
    `;svc=this.inject(Vt);profile=this.inject(Ue);activity=this.inject(js);homeStats=this.inject(Jt);auth=this.inject(D);router=this.inject(j);loggedIn=new k(()=>this.auth.currentUser.get()!==null);rows=new k(()=>this.loggedIn.get()?nt.fromMyRounds(this.svc.myRounds.get()):nt.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new k(()=>Oc(this.rows.get(),Date.now(),e=>e));ongoing=new k(()=>this.parts.get().ongoing);finished=new k(()=>this.parts.get().finished);ongoingShown=new k(()=>this.ongoing.get().slice(0,yr));finishedShown=new k(()=>this.finished.get().slice(0,Mc));counts=new k(()=>({rows:this.rows.get().length,ongoing:this.ongoing.get().length,finished:this.finished.get().length}));newRows=new k(()=>this.loggedIn.get()?nt.fromMyRounds(this.svc.newRounds.get()):[]);chips=new k(()=>this.loggedIn.get()?qo(this.activity.feed.get()?.live??[]):[]);recents=new k(()=>this.loggedIn.get()?Yo(this.activity.feed.get()?.recent??[]):[]);statsCard=new k(()=>this.loggedIn.get()?this.homeStats.card.get():null);statsTiles=new k(()=>this.statsCard.get()?.tiles??[]);deleteOpen=new p(!1);leaveOpen=new p(!1);actionTarget=new p(null);actionError=new p("");openRoundMenu=new p(null);askAction(e,t,n,i){this.openRoundMenu.set(null),this.actionError.set(""),this.actionTarget.set({token:t,roundId:n,name:i,action:e}),e==="delete"?this.deleteOpen.set(!0):this.leaveOpen.set(!0)}render(){this.loggedIn.get()?(this.svc.loadMine(),this.profile.load(),this.activity.load(),this.homeStats.refreshPreset(),this.homeStats.load(!0)):this.svc.loadDevice();const e=this.wire(Lc,{head:{className:()=>this.loggedIn.get()?"landing__head hidden":"landing__head"},identity:{className:()=>this.loggedIn.get()?"landing__identity":"landing__identity hidden","aria-label":()=>{const r=this.identityName(),d=fs(this.profile.player.get()?.handicapIndex);return d?`${r}, ${d}`:r},onclick:()=>this.router.navigate("/profile")},...we(()=>{const r=this.profile.player.get();return{id:r?.id??"",avatarVersion:r?.avatarVersion??null,displayName:r?.displayName??null,username:r?.username??this.auth.currentUser.get()?.username??null}}),identityName:()=>this.identityName(),identityHcp:{textContent:()=>fs(this.profile.player.get()?.handicapIndex)??"",className:()=>fs(this.profile.player.get()?.handicapIndex)===null?"landing__identity-hcp hidden":"landing__identity-hcp"},history:{className:()=>Hc(this.counts.get())?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},outNowSection:{className:()=>this.chips.get().length>0?"landing__section-block landing__outnow":"landing__section-block landing__outnow hidden"},outNowContext:()=>Uo(this.activity.feed.get()?.live??[])??"",recentlySection:{className:()=>this.recents.get().length>0?"landing__section-block landing__recently":"landing__section-block landing__recently hidden"},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const r=this.newRows.get().length;return r===0?"":String(r)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block landing__ongoing":"landing__section-block landing__ongoing hidden"},ongoingCount:()=>{const r=this.ongoing.get().length;return r===0?"":String(r)},ongoingMore:{className:()=>_r(this.counts.get().ongoing)?"landing__ongoing-foot":"landing__ongoing-foot hidden","aria-label":()=>"Show all ongoing rounds",onclick:()=>this.router.navigate("/history")},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block landing__finished":"landing__section-block landing__finished hidden"},finishedCount:()=>{const r=this.finished.get().length;return r===0?"":String(r)},finishedAll:{"aria-label":()=>"All rounds",onclick:()=>this.router.navigate("/history")},stats:{className:()=>this.statsCard.get()===null?"landing__stats hidden":"landing__stats","aria-label":()=>{const r=this.statsCard.get();return r===null?"":kc(r)},onclick:()=>this.router.navigate("/stats")},statsWindow:()=>this.statsCard.get()?.windowLabel??"",statsPriority:{textContent:()=>this.statsCard.get()?.priorityLine??"",className:()=>this.statsCard.get()?.priorityLine?"landing__stats-priority":"landing__stats-priority hidden"},statsTitle:()=>gr,statsFoot:()=>bc,empty:{className:()=>Ac(this.counts.get())?"landing__empty":"landing__empty hidden"},actionError:{textContent:()=>this.actionError.get()}});this.$each(this.ref(e,"outNowList"),this.chips,(r,d,o)=>this.wireEl(Fc,{chip:{"aria-label":()=>Vo(r),onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},...we(()=>{const c=this.chips.get().find(u=>u.roundId===r.roundId)??r;return{id:c.playerId,avatarVersion:c.avatarVersion,displayName:c.displayName}}),who:()=>r.title,line:()=>r.progress},o),r=>r.roundId),this.$each(this.ref(e,"recentlyList"),this.recents,(r,d,o)=>this.wireEl(jc,{row:{onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},...we(()=>({id:r.playerId,avatarVersion:r.avatarVersion,displayName:r.displayName})),title:()=>r.friendLabel,course:{textContent:()=>r.title,className:()=>r.title?"round-summary__course":"round-summary__course hidden"},date:()=>Ae(r.date),progress:{textContent:"",className:"round-summary__progress hidden"},formats:{textContent:()=>(r.formatIds??[]).map(Zd).join(" · "),className:()=>(r.formatIds??[]).length>0?"round-summary__formats":"round-summary__formats hidden"}},o),r=>r.roundId),this.$each(this.ref(e,"newList"),this.newRows,(r,d,o)=>this.roundRow(r,o),r=>r.key),this.$each(this.ref(e,"ongoingList"),this.ongoingShown,(r,d,o)=>this.roundRow(r,o,!0),r=>r.key),this.$each(this.ref(e,"finishedList"),this.finishedShown,(r,d,o)=>this.roundRow(r,o),r=>r.key),this.$each(this.ref(e,"statsTiles"),this.statsTiles,(r,d,o)=>this.wireEl(Gc,{value:()=>r.value,label:()=>r.label,note:{textContent:()=>r.note??"",className:()=>r.note===null?"stat-tile__note hidden":"stat-tile__note"}},o),r=>`${r.id}:${r.value}:${r.note??""}`),this.spawn(ie,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const r=this.actionTarget.get();return`Delete ${r?`“${r.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.remove(r.token,r.roundId).then(d=>{d||this.actionError.set("Could not delete the round. Try again.")})}}),this.spawn(ie,this.ref(e,"confirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.actionTarget.get();r&&this.svc.leave(r.token,r.roundId).then(d=>{d.ok||this.actionError.set(d.message)})}});const t=r=>{r.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1),r.key==="Escape"&&this.leaveOpen.get()&&this.leaveOpen.set(!1),r.key==="Escape"&&this.openRoundMenu.get()!==null&&this.openRoundMenu.set(null)};window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t));const n=this.ref(e,"root"),i=r=>{if(this.openRoundMenu.get()===null)return;const d=r.target;d instanceof Node&&n.contains(d)||this.openRoundMenu.set(null)};return document.addEventListener("pointerdown",i,!0),this.track(()=>document.removeEventListener("pointerdown",i,!0)),e}identityName(){const e=this.profile.player.get(),t=(e?.displayName??"").trim();if(t!=="")return t;const n=(e?.username??this.auth.currentUser.get()?.username??"").trim();return n===""?"Signed in":n}roundRow(e,t,n=!1){return this.wireEl(Bc,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>lt(e),course:{textContent:()=>Ht(e)??"",className:()=>Ht(e)?"round-summary__course":"round-summary__course hidden"},date:()=>Ae(e.date),progress:{textContent:()=>n&&e.holesPlayed&&e.holesPlayed>0?`Thru ${e.holesPlayed}`:"",className:()=>n&&e.holesPlayed&&e.holesPlayed>0?"round-summary__progress":"round-summary__progress hidden"},formats:{textContent:()=>e.formats??"",className:()=>e.formats?"round-summary__formats":"round-summary__formats hidden"},actions:{className:()=>je(e)===null?"round-row__actions hidden":"round-row__actions"},menuButton:{"aria-expanded":()=>this.openRoundMenu.get()===e.key?"true":"false",onclick:()=>this.openRoundMenu.set(this.openRoundMenu.get()===e.key?null:e.key)},menu:{className:()=>this.openRoundMenu.get()===e.key?"round-row__menu":"round-row__menu hidden"},action:{textContent:()=>{const i=je(e);return i?br(i):""},onclick:()=>{const i=je(e);!i||e.token===null||this.askAction(i,e.token,e.roundId??"",lt(e))}}},t)}}function Dc(s){return[...s].sort((e,t)=>{const n=Ln(e),i=Ln(t);return i!==n?i-n:e.key.localeCompare(t.key)})}function Ln(s){const e=s.completedAt??s.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const qc=b(`
    <div class="history">
...
`),Vc='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Uc=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${Zs}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Vc}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
    </div>
`);class Kc extends H{static styles=`
        .history {
...
`),en='<button bind="infoTrigger" class="stats__info" type="button"></button>',tn=`
...
`,Ie=60,zn=8,Ms=4,eu=Array.from({length:Ms*2+1},(s,e)=>e-Ms),tu="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",su=b(`
...
`),lu=b('<button bind="btn" class="se-seg" type="button"></button>'),du=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),cu=b('<div bind="rule" class="se-stats__rule"></div>');class uu extends H{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${zn}px; flex-shrink: 0; }
            & .se-row__slot { width: ${Ie}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
    ...
    `;svc=this.inject(fe);holeIdx=this.svc.holeIdx;modalOpen=this.svc.keypadOpen;currentBallIdx=new p(0);holeCompleteOnEntry=!1;extendedOpen=new p(!1);extendedScore=new p(10);statsOpen=new p(!1);explainOpen=new p(!1);pendingMeta=new p({});lastMetaKey=null;toastMsg=new p(null);hcpInfoBallId=new p(null);dragOffset=new p(0);transitioning=new p(!1);ptr=null;pendingSteps=null;settleTimer=null;advanceTimer=null;flashTimer=null;hasScoring=new k(()=>this.svc.balls.get().length>0);group=()=>this.svc.group();playedOrder=()=>this.svc.playedOrder();holeIndex=()=>this.svc.holeIndex();currentHole=()=>this.svc.currentPlayedHole();occAtOffset=e=>{const t=this.playedOrder();return t[Ge(this.holeIndex()+e,t.length)]??null};ballsInGroup=()=>{const e=this.group();if(!e)return[];const t=new Map(this.svc.balls.get().map(n=>[n.id,n]));return e.ballIds.map(n=>t.get(n)).filter(n=>!!n)};parFor=e=>this.svc.parFor(e);occLabel=e=>this.svc.occLabel(e);ballName=e=>Vs(e);metaInputs=()=>this.svc.metadataInputsForHole(this.svc.currentPlayHole()).filter(e=>e.kind==="boolean");displayScore=e=>e===null?"–":String(e);hintText=(e,t)=>{const n=this.svc.strokesHintFor(e,t);return n===null?null:n===0?"0":n>0?`-${n}`:`+${-n}`};toParValue=e=>{let t=0,n=0,i=!1;for(const r of this.playedOrder()){const d=this.svc.strokesFor(e.id,r.playHoleId);d!==null&&d>0&&(t+=d,n+=this.parFor(r.playHoleId),i=!0)}return i?t-n:null};hcpLine=e=>{const t=this.ballsInGroup().find(d=>d.id===e);if(!t||t.pending)return null;const n=t.players.length>1?t.courseHandicap:t.players[0]?.courseHandicap??t.courseHandicap;if(n===null)return null;const i=t.players.length>1?`Team · HCP ${n}`:`HCP ${n}`,r=this.svc.effectivePlayingHandicap(t);return r!==null&&r!==n?`${i} → ${r}`:i};rowDerivation=e=>{const t=this.ballsInGroup().find(n=>n.id===e);return!t||t.pending?null:this.svc.presentedSlot(t)?.handicapDerivation??null};selectedFormatLabel=()=>{const e=this.svc.round.get()?.formatSlots.find(t=>t.slotDefId===this.svc.selectedSlotDefId());return e?Xs(e):null};hcpCards=e=>{const t=this.selectedFormatLabel(),n=[];for(const i of e.steps)switch(i.kind){case"course_handicap":{const r=i.handicapIndex!==null&&i.slope!==null&&i.courseRating!==null&&i.par!==null,d=i.teeName?`the ${i.teeName} tees`:"these tees";n.push({title:`Course handicap · ${i.producerLabel}`,text:r?`Exact handicap ${i.handicapIndex}, adjusted for the difficulty of ${d}.`:`The handicap ${i.producerLabel} plays this course off.`,math:r?`${i.handicapIndex} × ${i.slope} ÷ 113 + (${i.courseRating} − ${i.par}), rounded — the World Handicap System formula.`:null,result:i.result});break}case"team_combination":n.push({title:"Team handicap",text:"The team plays off a share of each member's handicap.",math:`${i.parts.map(r=>`${r.pct}% of ${r.producerLabel}'s ${r.ch}`).join(" + ")}, rounded.`,result:i.result});break;case"allowance":i.pct!==100&&n.push({title:"Allowance",text:`${t??"This format"} is played at ${i.pct}% handicap.`,math:null,result:i.result});break;case"match_delta":n.push(i.ownPh===i.lowestPh?{title:"Match difference",text:"Lowest handicap in the match — plays off scratch, and the others get the difference.",math:null,result:i.result}:{title:"Match difference",text:"In match formats only the difference matters: the lowest ball plays off 0, this ball gets the rest.",math:`${i.ownPh} − ${i.lowestPh} = ${i.result}.`,result:i.result});break}return n};figureText=e=>{const t=this.svc.slotStandingFor(e);if(t===null){const n=this.toParValue(e);return n===null?"–":n===0?"E":n>0?`+${n}`:`${n}`}switch(t.kind){case"pace":{const n=t.delta;return n===0?"E":n>0?`+${n}`:`${n}`}case"total":return String(t.total);case"match":return t.text}};figureClass=e=>{const t=this.svc.slotStandingFor(e);let n,i=!1;if(t===null){const r=this.toParValue(e);n=r===null||r===0?"even":r<0?"under":"over"}else t.kind==="pace"?n=t.delta===0?"even":t.delta<0?"under":"over":t.kind==="total"?n="even":(n=t.tone,i=!0);return`se-row__topar ${n}${i?" se-row__topar--match":""}`};scoreLabel=(e,t)=>{if(e===1)return"HIO";const n=e-t;return n<=-4||n>=5?"OTHER":{"-3":"ALBA","-2":"EAGLE","-1":"BIRDIE",0:"PAR",1:"BOGEY",2:"DOUBLE",3:"TRIPLE",4:"QUAD"}[String(n)]??""};render(){this.track(()=>{this.advanceTimer&&clearTimeout(this.advanceTimer),this.flashTimer&&clearTimeout(this.flashTimer),this.settleTimer&&clearTimeout(this.settleTimer),this.modalOpen.set(!1)}),this.track(E(()=>{const o=this.ballsInGroup().length;o>0&&this.currentBallIdx.get()>=o&&this.selectBall(0)}));const e=this.wire(su,{root:{className:()=>this.hasScoring.get()?"se":"se hidden"},close:{onclick:()=>{this.statsOpen.set(!1),this.modalOpen.set(!1),this.svc.closeStatStep()}},modal:{className:()=>this.modalOpen.get()?"se-modal":"se-modal hidden"},modalTitle:()=>{const o=this.currentHole();return o?`Hole ${this.occLabel(o.playHoleId)} · Par ${this.parFor(o.playHoleId)}`:""},modalPrev:{onclick:()=>this.stepHole(-1),disabled:()=>!this.svc.canPrevHole()},modalNext:{onclick:()=>this.stepHole(1),disabled:()=>!this.svc.canNextHole()},extended:{className:()=>this.extendedOpen.get()?"se-pad__ext":"se-pad__ext hidden"},extVal:()=>String(this.extendedScore.get()),extMinus:{onclick:()=>this.extendedScore.set(Math.max(10,this.extendedScore.get()-1))},extPlus:{onclick:()=>this.extendedScore.set(this.extendedScore.get()+1)},extCancel:{onclick:()=>this.extendedOpen.set(!1)},extOk:{onclick:()=>{this.extendedOpen.set(!1),this.commit(this.extendedScore.get())}},toast:{className:()=>this.toastMsg.get()?"se-toast":"se-toast hidden",textContent:()=>this.toastMsg.get()??""},hcpModal:{className:()=>this.hcpInfoBallId.get()!==null?"se-hcp":"se-hcp hidden",onclick:o=>{o.target===o.currentTarget&&this.hcpInfoBallId.set(null)}},hcpClose:{onclick:()=>this.hcpInfoBallId.set(null)},hcpTitle:()=>{const o=this.hcpInfoBallId.get(),c=o?this.ballsInGroup().find(u=>u.id===o):null;return c?this.ballName(c):""},hcpFormat:()=>this.selectedFormatLabel()??"",hcpEff:()=>{const o=this.hcpInfoBallId.get(),c=o?this.rowDerivation(o):null;return c?String(c.effectivePh):""},stats:{className:()=>this.statsOpen.get()?"se-stats":"se-stats hidden"},statsBack:{onclick:()=>{this.statsOpen.set(!1),this.explainOpen.set(!1),this.svc.closeStatStep()}},statExplain:{textContent:Be.explainerTrigger,onclick:()=>this.explainOpen.set(!0)},infoSheet:{className:()=>this.explainOpen.get()?"stats-info":"stats-info hidden",onclick:o=>{o.target===o.currentTarget&&this.explainOpen.set(!1)}},infoTitle:{textContent:Be.explainerTitle},infoDone:{onclick:()=>this.explainOpen.set(!1)},statsHole:()=>{const o=this.currentHole();return o?`Hole ${this.occLabel(o.playHoleId)} · Par ${this.parFor(o.playHoleId)}`:""},statsTitle:()=>{const o=this.ballsInGroup()[this.currentBallIdx.get()];return o?this.ballName(o):""},statsScore:()=>{const o=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();return!o||!c?"":this.displayScore(this.svc.strokesFor(o.id,c.playHoleId))},statsNext:{textContent:()=>this.hasMoreUnscored()?"Next ›":"Done ›",onclick:()=>{this.statsOpen.set(!1),this.explainOpen.set(!1),this.svc.closeStatStep(),this.apply({kind:"statsDone"})}}}),t=this.ref(e,"viewport"),n=this.ref(e,"track");this.bindCarouselPointer(t,n),this.track(E(()=>{n.style.transition=this.transitioning.get()?tu:"none",n.style.transform=`translateX(${this.dragOffset.get()}px)`})),this.$each(n,new k(()=>eu),(o,c,u)=>this.holeItem(o,u),o=>o),this.$each(this.ref(e,"rows"),new k(()=>{const o=this.playedOrder(),c=this.holeIndex(),u=o[c];if(!u)return[];const f=c>0?o[c-1].playHoleId:null;return this.ballsInGroup().map(m=>({ball:m,ph:u.playHoleId,prevPh:f}))}),(o,c,u)=>this.playerRow(o.ball,o.ph,o.prevPh,u),o=>`${o.ball.id}|${o.ph}|${o.ball.pending}`),this.$each(this.ref(e,"hcpSteps"),new k(()=>{const o=this.hcpInfoBallId.get(),c=o?this.rowDerivation(o):null;return c?this.hcpCards(c):[]}),(o,c,u)=>this.wireEl(ru,{ctitle:{textContent:o.title},ctext:{textContent:o.text},cmath:{textContent:o.math??"",hidden:o.math===null},cresult:{textContent:String(o.result)}},u),(o,c)=>`${c}|${o.title}|${o.result}`),this.$each(this.ref(e,"modalList"),new k(()=>this.ballsInGroup()),(o,c,u)=>this.modalRow(o,c,u),o=>o.id);const i=this.ref(e,"keys");for(const o of[1,2,3,4,5,6,7,8,9])i.appendChild(this.numberKey(o));i.appendChild(this.specialKey("10+","","se-key",()=>this.openExtended())),i.appendChild(this.specialKey("✕","clear","se-key clear",()=>this.commit(null))),i.appendChild(this.specialKey("0","pick up","se-key muted",()=>this.commit(0))),this.$each(this.ref(e,"statsBody"),new k(()=>this.statBodyRows()),(o,c,u)=>this.statBodyRow(o,u),o=>o.key),this.$each(this.ref(e,"infoCards"),new k(()=>this.statExplainerCards()),(o,c,u)=>this.wireEl(es,{ctitle:{textContent:o.title},ctext:{textContent:o.text}},u),o=>o.key),this.track(E(()=>{if(!this.modalOpen.get()){this.lastMetaKey=null,this.svc.seedStatStep(null);return}const o=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();if(!o||!c)return;this.seedStatStepForCursor();const u=`${o.id}|${c.playHoleId}`;if(u===this.lastMetaKey)return;this.lastMetaKey=u;const f={};for(const m of this.metaInputs())f[m.key]=this.svc.metadataFor(o.id,c.playHoleId,m.key)===!0;this.pendingMeta.set(f)}));const r=()=>{document.visibilityState==="hidden"&&this.svc.flushStats()},d=()=>this.svc.flushStats();return document.addEventListener("visibilitychange",r),window.addEventListener("pagehide",d),this.track(()=>{document.removeEventListener("visibilitychange",r),window.removeEventListener("pagehide",d),this.svc.closeStatStep()}),e}holeItem(e,t){return this.wireEl(nu,{item:{className:()=>{const n=e===-1&&this.holeIndex()<=0;return`se-hole${e===0?" active":""}${n?" gone":""}`}},hnum:{textContent:()=>{const n=this.occAtOffset(e);return n?this.occLabel(n.playHoleId):""}},hpar:{textContent:()=>{const n=this.occAtOffset(e);return n?`Par ${this.parFor(n.playHoleId)}`:""}}},t)}playerRow(e,t,n,i){return e.pending?this.wireEl(Bn,{name:{textContent:this.ballName(e),className:"se-row__name se-row__name--pending"},hcp:{textContent:"open seat"},topar:{textContent:"",className:"se-row__topar"},prev:{textContent:""},cval:{textContent:"–"},circle:{className:"se-row__circle empty se-row__circle--pending"}},i):this.wireEl(Bn,{name:{textContent:this.ballName(e)},hcp:{textContent:()=>this.hcpLine(e.id)??"",hidden:()=>this.hcpLine(e.id)===null},hcpInfo:{className:()=>this.rowDerivation(e.id)!==null?"se-row__hcpinfo":"se-row__hcpinfo hidden",onclick:()=>this.hcpInfoBallId.set(e.id)},topar:{textContent:()=>this.figureText(e),className:()=>this.figureClass(e)},prev:{textContent:()=>n?this.displayScore(this.svc.strokesFor(e.id,n)):""},cval:{textContent:()=>{const r=this.svc.strokesFor(e.id,t);return r!==null?this.displayScore(r):this.hintText(e.id,t)??"–"}},circle:{className:()=>this.svc.strokesFor(e.id,t)!==null?"se-row__circle":this.hintText(e.id,t)!==null?"se-row__circle empty hint":"se-row__circle empty",onclick:()=>this.openModalForBall(e.id)}},i)}modalRow(e,t,n){const i=()=>{if(e.pending)return"Open seat — claim to score";const r=e.players.length>1?e.courseHandicap:e.players[0]?.courseHandicap??e.courseHandicap,d=r===null?"–":String(r),o=e.players.length>1?`Team · HCP ${d}`:`HCP ${d}`,c=this.svc.effectivePlayingHandicap(e);return r!==null&&c!==null&&c!==r?`${o} → ${c}`:o};return this.wireEl(iu,{mrow:{className:()=>this.currentBallIdx.get()===t?"se-mrow sel":"se-mrow",onclick:()=>this.selectBall(t)},mname:{textContent:this.ballName(e)},mhcp:{textContent:i},mval:{textContent:()=>{const r=this.currentHole();if(!r)return"–";const d=this.svc.strokesFor(e.id,r.playHoleId);return d!==null?this.displayScore(d):this.hintText(e.id,r.playHoleId)??"–"},className:()=>{const r=this.currentHole();return!!r&&this.svc.strokesFor(e.id,r.playHoleId)===null&&!!r&&this.hintText(e.id,r.playHoleId)!==null?"se-mrow__val se-mrow__val--hint":"se-mrow__val"}}},n)}numberKey(e){return this.wireEl(Fn,{key:{className:()=>{const t=this.currentHole();return(t?e===this.parFor(t.playHoleId):!1)?"se-key par":"se-key"},onclick:()=>this.commit(e)},num:{textContent:String(e)},lbl:{textContent:()=>{const t=this.currentHole();return t?this.scoreLabel(e,this.parFor(t.playHoleId)):""}}})}specialKey(e,t,n,i){return this.wireEl(Fn,{key:{className:n,onclick:i},num:{textContent:e},lbl:{textContent:t}})}openModalForBall(e){const t=this.ballsInGroup().findIndex(n=>n.id===e);this.selectBall(t<0?0:t),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.noteHoleEntered(),this.modalOpen.set(!0)}selectBall(e){this.currentBallIdx.set(e),this.seedStatStepForCursor()}seedStatStepForCursor(){const e=this.ballsInGroup()[this.currentBallIdx.get()],t=this.currentHole(),n=e?this.svc.statSubject(e):null;this.svc.seedStatStep(n&&t?{playerId:n,playHoleId:t.playHoleId}:null)}advanceState(){const e=this.currentHole();return{balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId,label:this.occLabel(e.playHoleId)}:null,holeIndex:this.holeIndex(),holeCount:this.playedOrder().length,holeCompleteOnEntry:this.holeCompleteOnEntry,collectsStats:this.metaInputs().length>0||this.svc.statPrompts().length>0}}noteHoleEntered(){this.holeCompleteOnEntry=Yc(this.advanceState())}stepHole(e){this.advanceTimer&&(clearTimeout(this.advanceTimer),this.advanceTimer=null),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.svc.closeStatStep(),e<0?this.svc.prevHole():this.svc.nextHole(),this.selectBall(0),this.noteHoleEntered()}openExtended(){this.extendedScore.set(10),this.extendedOpen.set(!0)}commit(e){this.apply({kind:"score",value:e})}apply(e){this.execute(Xc(this.advanceState(),e))}execute(e){const t=e.write;if(t){const i=this.ballsInGroup()[t.ballIndex];i&&this.svc.setScore(i.id,t.holeId,t.value,t.withMetadata?this.metaSnapshot():void 0)}const n=e.move;switch(n.kind){case"noop":case"stay":return;case"moveToBall":this.selectBall(n.ballIndex);return;case"openStats":this.statsOpen.set(!0);return;case"roundComplete":this.modalOpen.set(!1),this.svc.finishFlowOpen.set(!0);return;case"holeComplete":{this.flash(n.toast),this.advanceTimer&&clearTimeout(this.advanceTimer),this.advanceTimer=setTimeout(()=>{this.advanceTimer=null,this.currentHole()?.playHoleId===n.fromHoleId&&(this.holeIdx.set(Ge(n.toHoleIndex,this.playedOrder().length)),this.selectBall(0),this.noteHoleEntered())},n.delayMs);return}}}hasMoreUnscored=()=>{const e=this.currentHole();return Qc({balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId}:null})};metaSnapshot(){const e=this.metaInputs();if(e.length===0)return;const t=this.pendingMeta.get(),n={};for(const i of e)n[i.key]=t[i.key]===!0;return n}setMeta(e,t){const n=this.pendingMeta.get();this.pendingMeta.set({...n,[e]:t});const i=this.ballsInGroup()[this.currentBallIdx.get()],r=this.currentHole();if(!i||!r)return;const d=this.svc.strokesFor(i.id,r.playHoleId);d!==null&&this.svc.setScore(i.id,r.playHoleId,d,this.metaSnapshot())}metaChip(e,t){return this.wireEl(au,{glabel:{textContent:e.label},miss:{className:()=>this.pendingMeta.get()[e.key]?"se-seg":"se-seg on-miss",onclick:()=>this.setMeta(e.key,!1)},hit:{className:()=>this.pendingMeta.get()[e.key]?"se-seg on-hit":"se-seg",onclick:()=>this.setMeta(e.key,!0)}},t)}metaInputsForStep=()=>{const e=new Set(this.svc.statPrompts().map(t=>t.key));return this.metaInputs().filter(t=>!e.has(t.key))};statBodyRows=()=>{const e=this.metaInputsForStep(),t=this.svc.statPrompts(),n=e.map(i=>({kind:"meta",key:`meta:${i.key}`,input:i}));e.length>0&&t.length>0&&n.push({kind:"rule",key:"rule"});for(const i of t)n.push({kind:"stat",key:`stat:${i.key}`,prompt:i});return n};statBodyRow(e,t){return e.kind==="meta"?this.metaChip(e.input,t):e.kind==="rule"?this.wireEl(cu,{},t):e.prompt.control.kind==="segments"?this.statSegments(e.prompt,t):this.statStepper(e.prompt,t)}statSegments(e,t){const n=e.control,i=n.kind==="segments"?n.options:[],r=i.length>=4?" tight":"",d=this.wireEl(ou,{glabel:{textContent:e.label},gnote:{textContent:()=>e.key==="gir"?this.girNote():"",className:()=>e.key==="gir"&&this.girNote()!==""?`se-stats__note${this.svc.statGirState().state==="disagree"?" warn":""}`:"se-stats__note hidden"},seg:{role:"group","aria-label":()=>e.key==="gir"?this.girAria():e.label}},t),o=this.ref(d,"seg");for(const c of i){const u=this.wireEl(lu,{btn:{textContent:c.label,className:()=>`se-seg${r}${this.svc.statValue(e.key)===c.value?" on-neutral":""}`,onclick:()=>this.answerStat(e.key,this.svc.statValue(e.key)===c.value?null:c.value)}},t);o?.appendChild(u)}return d}statStepper(e,t){const n=e.control,i=n.kind==="stepper"?n.min:0,r=n.kind==="stepper"?n.max:null;return this.wireEl(du,{glabel:{textContent:e.label},minus:{onclick:()=>this.stepStat(e.key,-1),"aria-label":`Fewer ${e.label}`},plus:{onclick:()=>this.stepStat(e.key,1),"aria-label":`More ${e.label}`},val:{textContent:()=>gl(this.svc.statStepperValue(e.key,i),r),className:()=>this.svc.statIsAnswered(e.key)?"se-stats__step-val":"se-stats__step-val unanswered","aria-label":()=>this.svc.statIsAnswered(e.key)?`${e.label} ${this.svc.statStepperValue(e.key,i)}`:`${e.label} not answered`}},t)}girNote(){const e=this.svc.statGirState();return e.state==="pending"?Be.girPending:e.state==="disagree"?e.derived==="1"?Be.girDisagreeHit:Be.girDisagreeMiss:""}girAria(){const e=this.svc.statGirState();return e.state==="pending"?Be.girPendingAria:e.state==="disagree"?`${Is("gir")}, ${e.stored==="1"?"Hit":"Miss"}, your score disagrees`:Is("gir")}statExplainerCards(){return this.svc.statPrompts().map(e=>({key:e.key,title:e.label,text:Zc(e.key)}))}answerStat(e,t){this.svc.answerStat(e,t),this.mirrorStatToMeta(e)}stepStat(e,t){this.svc.stepStat(e,t),this.mirrorStatToMeta(e)}mirrorStatToMeta(e){if(!this.metaInputs().some(n=>n.key===e))return;const t=this.svc.statValue(e);t!==null&&this.setMeta(e,t==="1")}flash(e){this.toastMsg.set(e),this.flashTimer&&clearTimeout(this.flashTimer),this.flashTimer=setTimeout(()=>{this.flashTimer=null,this.toastMsg.get()===e&&this.toastMsg.set(null)},1100)}snap(e){this.pendingSteps=e,this.transitioning.set(!0),this.dragOffset.set(-e*Ie),this.settleTimer&&clearTimeout(this.settleTimer),this.settleTimer=setTimeout(()=>this.finishSettle(),420)}finishSettle(){if(this.pendingSteps===null)return;const e=this.pendingSteps;this.pendingSteps=null,this.settleTimer&&(clearTimeout(this.settleTimer),this.settleTimer=null),this.transitioning.set(!1),e!==0&&this.holeIdx.set(Ge(this.holeIndex()+e,this.playedOrder().length)),this.dragOffset.set(0)}bindCarouselPointer(e,t){t.addEventListener("transitionend",i=>{i.propertyName==="transform"&&this.finishSettle()}),e.addEventListener("pointerdown",i=>{this.ptr||this.transitioning.get()||this.playedOrder().length<=1||(this.ptr={id:i.pointerId,startX:i.clientX,startY:i.clientY,lastX:i.clientX,lastTime:Date.now(),velocity:0,horiz:!1},this.dragOffset.set(0),e.setPointerCapture?.(i.pointerId))}),e.addEventListener("pointermove",i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const d=i.clientX-r.startX,o=i.clientY-r.startY;if(!r.horiz){if(Math.abs(o)>Math.abs(d)&&Math.abs(o)>8||Math.abs(d)<=8)return;r.horiz=!0}const c=Date.now(),u=Math.max(1,c-r.lastTime);r.velocity=(i.clientX-r.lastX)/u,r.lastX=i.clientX,r.lastTime=c,this.dragOffset.set(d)});const n=i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const d=i.clientX-r.startX,o=r.horiz;if(this.ptr=null,e.releasePointerCapture?.(i.pointerId),!o){this.dragOffset.set(0);return}this.snap(ll({dragDistance:d,velocity:r.velocity,itemWidth:Ie}))};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",i=>{!this.ptr||this.ptr.id!==i.pointerId||(this.ptr=null,e.releasePointerCapture?.(i.pointerId),this.snap(0))})}}function hu(s,e){const t=[...s].sort((r,d)=>r.canonicalOrdinal-d.canonicalOrdinal);if(e.length===0)return[{label:"TOT",holes:t,playHoleIds:new Set(t.map(r=>r.playHoleId))}];const n=[...e].sort((r,d)=>r.fromCanonicalOrdinal-d.fromCanonicalOrdinal),i=[];for(const r of n){const d=t.filter(o=>o.canonicalOrdinal>=r.fromCanonicalOrdinal&&o.canonicalOrdinal<=r.toCanonicalOrdinal);d.length!==0&&i.push({label:r.label,holes:d,playHoleIds:new Set(d.map(o=>o.playHoleId))})}return i}function vr(s,e){const t=s.cells.filter(n=>e.has(n.playHoleId));if(s.aggregate==="sum"){const n=t.map(i=>i.value).filter(i=>i!==null);return n.length===0?"—":String(n.reduce((i,r)=>i+r,0))}if(s.aggregate==="last"){for(let n=t.length-1;n>=0;n--){const i=t[n].value;if(i!==null)return Number.isInteger(i)?String(i):i.toFixed(1)}return"—"}return"—"}function pu(s,e){if(s.aggregate==="sum"){const t=s.cells.map(n=>n.value).filter(n=>n!==null);return t.length===0?"—":String(t.reduce((n,i)=>n+i,0))}if(s.aggregate==="last"){const t=e[e.length-1];return t?vr(s,t.playHoleIds):"—"}return"—"}function fu(s){const e=s?.marker;if(e){const t=e.tone;return{kind:"marker",template:e.template,tone:t==="success"||t==="warning"||t==="danger"?t:null,label:e.label?e.label:null,teamFill:s?.team??null}}return s?.team?{kind:"pill",team:s.team}:{kind:"plain"}}function mu(s){return s.filter(e=>!(e.startsWith("slot #")||/^HCP -?\d/.test(e)||/^PH -?\d/.test(e)))}const At=" & ";function wr(s){return s.componentId??"default-score-grid"}function sn(s,e,t,n={}){const i=hu(s.holes,e),r=n.mode??"product",d=s.rows.map(o=>{const c=new Map(o.cells.map(u=>[u.playHoleId,u]));return{kind:o.kind,emphasis:o.emphasis===!0,team:o.team??null,subjectName:o.subjectBallId?t(o.subjectBallId):null,labelText:o.label,groups:i.map(u=>({cells:u.holes.map(f=>{const m=c.get(f.playHoleId);return{text:m?.display??"",title:m?.title?m.title:null,decoration:fu(m)}}),subtotal:vr(o,u.playHoleIds)})),total:pu(o,i)}});return{componentId:wr(s),subjectBallIds:[...s.subjectBallIds],title:{groups:s.title.groups.map(o=>o.map(c=>t(c))),joiner:s.title.joiner,nameJoiner:At},subtitleFacts:r==="verification"?[...s.subtitleFacts]:mu(s.subtitleFacts),footnotes:[...s.footnotes],caption:s.caption??null,totals:s.totals.map(o=>({label:o.label,value:String(o.value??"—")})),columnGroups:i.map(o=>({label:o.label,columns:o.holes.map(c=>({label:c.occurrenceLabel}))})),hasTotalColumn:i.length>1,rows:d}}function gs(s){return[...new Set(s)].sort().join("\0")}function gu(s,e){const t=new Map;e.forEach((i,r)=>{if(i.ballIds.length===0)return;const d=gs(i.ballIds);t.set(d,t.has(d)?null:r)});const n=new Map;for(const i of s){if(i.subjectBallIds.length===0)continue;const r=gs(i.subjectBallIds);n.set(r,(n.get(r)??0)+1)}return s.map(i=>{if(i.subjectBallIds.length===0)return{kind:"standalone"};const r=gs(i.subjectBallIds);if((n.get(r)??0)!==1)return{kind:"standalone"};const d=t.get(r);return d==null?{kind:"standalone"}:{kind:"attached",entryIndex:d}})}function bu(s,e){const t=new Set(s.map(e));return t.size!==1?null:[...t][0]??null}function yu(s,e){if(s===void 0)return null;const t=e==="high"?-s:s;return{text:t===0?"E":t>0?`+${t}`:`−${Math.abs(t)}`,tone:t===0?"even":t>0?"over":"under"}}const _u=()=>null;function vu(s,e,t=_u){return{kind:"ranked",metricLabel:s.metricLabel,hasPace:s.entries.some(n=>n.paceDelta!==void 0),entries:s.entries.map(n=>({position:n.position,lead:n.position===1,name:n.ballIds.map(e).join(At),group:bu(n.ballIds,t),total:String(n.total??"—"),holesPlayed:n.holesPlayed,pace:yu(n.paceDelta,s.direction)}))}}function wu(s,e){return{kind:"match_summary",title:s.title,matches:s.matches.map(t=>({sideAName:t.sideA.ballIds.map(e).join(At),sideBName:t.sideB.ballIds.map(e).join(At),leader:t.leader,standing:t.magnitude===0?"AS":`${t.magnitude} UP`,status:t.finished?"Final":`thru ${t.thru}`}))}}function Hs(s,e){return[s,...[...new Set(e)].sort()].join("|")}const xu=new Map;function $u(s){const e=s.cards??[],t=(s.leaderboard??[]).find(d=>d.kind==="ranked")??null;if(!t)return{rankedSection:null,slotDefId:s.slotDefId,attached:xu,standalone:[...e]};const n=gu(e,t.entries),i=new Map,r=[];return e.forEach((d,o)=>{const c=n[o],u=c?.kind==="attached"?t.entries[c.entryIndex]:void 0;if(!u){r.push(d);return}i.set(Hs(s.slotDefId,u.ballIds),d)}),{rankedSection:t,slotDefId:s.slotDefId,attached:i,standalone:r}}class ku{open=new Set;isOpen(e){return this.open.has(e)}toggle(e){return this.set(e,!this.open.has(e))}set(e,t){return t?this.open.add(e):this.open.delete(e),t}keys(){return[...this.open].sort()}retain(e){const t=new Set(e);for(const n of[...this.open])t.has(n)||this.open.delete(n)}}const nn={ring:{meaning:"a single-unit decided result",fill:"#d63b2f",visual:"red filled circle — the Gamebook birdie mark (score to par −1)"},double_ring:{meaning:"a two-unit decided result; more emphatic than a ring",fill:"#e0862c",teamFillBorder:"border-width: 3px; border-style: double;",visual:"orange filled circle (score to par −2); doubled white border when team-filled"},diamond:{meaning:"a rare / high-magnitude decided result — the strongest form",fill:"#e0b41f",visual:"yellow filled circle — hole-in-one / albatross territory"},dot:{meaning:"a lightweight per-hole flag where a full ring would be too heavy",visual:"the bare base shape (no fill, no border) — inherits cell colour"},badge:{meaning:"a labelled status needing short text or a number, not just a shape",rule:["width: auto; min-width: 1.8em;","padding-left: 0.45em; padding-right: 0.45em;","border: 2px solid currentColor;"],tones:{success:"#267348",warning:"#946200",danger:"#9b332a"},visual:"outline pill in the tone colour, text inside"},square:{meaning:"a one-step negative score relation",fill:"#5b9bd5",boxy:!0,visual:"light-blue filled square (score to par +1)"},double_square:{meaning:"a stronger negative score relation",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square (score to par +2)"},box_badge:{meaning:"an angular labelled state that must not read as a round marker",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square carrying its value (+3 or worse)"}};function ct(s){return`lb-mark--${s}`}const Ze=()=>Object.entries(nn);function xr(s){return s.join(`
            `)}function bs(s,e){return s.map((t,n)=>`& .${ct(t)}${n===s.length-1?` { ${e} }`:","}`)}function Su(){const s=[];s.push("/* Outline forms keep currentColor + tone tints. */");for(const[r,d]of Ze())if(!(!d.rule&&!d.tones)){if(d.rule){s.push(`& .${ct(r)} {`);for(const o of d.rule)s.push(`    ${o}`);s.push("}")}for(const[o,c]of Object.entries(d.tones??{}))s.push(`& .${ct(r)}.lb-mark-tone--${o} { color: ${c}; }`)}s.push("/* Filled forms — declared after the tone rules so white text wins. */");const e=Ze().filter(([,r])=>r.boxy).map(([r])=>r),t=[],n=new Set;for(const[r,d]of Ze()){if(d.fill===void 0||n.has(r))continue;const o=Ze().filter(([,c])=>c.fill===d.fill).map(([c])=>c);for(const c of o)n.add(c);t.push({fill:d.fill,ids:o})}let i=-1;if(e.length>0){const r=t.findIndex(d=>d.ids.some(o=>nn[o].boxy));i=r===-1?t.length:r}return t.forEach((r,d)=>{d===i&&s.push(...bs(e,"border-radius: 3px;")),s.push(...bs(r.ids,`background: ${r.fill}; color: #fff;`))}),i===t.length&&s.push(...bs(e,"border-radius: 3px;")),xr(s)}function Tu(){const s=[];for(const[e,t]of Ze()){if(!t.teamFillBorder)continue;const n=ct(e);s.push(`& .${n}.lb-mark-fill--a,`,`& .${n}.lb-mark-fill--b { ${t.teamFillBorder} }`)}return xr(s)}const $r=()=>null;function F(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function Pu(s){return s.kind==="si"?"lb-c-si":s.kind==="given"?"lb-c-given":s.kind==="status"?"lb-c-status":s.kind==="category"?"lb-c-cat":""}function Iu(s){const e=[s.kind==="category"?"lb-r-cat":`lb-r-${s.kind}`];return(s.kind==="si"||s.kind==="given")&&e.push("lb-r-dim"),s.team&&e.push(`lb-team-${s.team}`),e.join(" ")}function Cu(s,e,t){const n=s.title!==null?` title="${F(s.title)}"`:"",i=t(F(s.text)),r=s.decoration;let d;if(r.kind==="marker"){const o=r.tone?` lb-mark-tone--${r.tone}`:"",c=r.teamFill?` lb-mark-fill--${r.teamFill}`:"",u=r.label!==null?` title="${F(r.label)}" aria-label="${F(r.label)}"`:"";d=`<span class="lb-mark ${ct(r.template)}${o}${c}"${u}>${i}</span>`}else r.kind==="pill"?d=`<span class="lb-pill lb-pill--${r.team}">${i}</span>`:d=i;return`<td class="${Pu(e)}"${n}>${d}</td>`}function rn(s,e){const t=m=>{const h=s.columnGroups[m],g=`<tr><th class="lb-rowlabel">Hole</th>${h.columns.map(w=>`<th>${F(w.label)}</th>`).join("")}<th class="lb-sum">${F(h.label)}</th></tr>`,v=s.rows.map(w=>{const T=W=>w.emphasis?`<strong>${W}</strong>`:W,R=w.groups[m],L=R.cells.map(W=>Cu(W,w,T)).join(""),V=`<td class="lb-sum">${T(R.subtotal)}</td>`,O=w.subjectName!==null?F(w.subjectName)+(w.labelText?" "+F(w.labelText):""):F(w.labelText);return`<tr class="${Iu(w)}"><th class="lb-rowlabel">${O}</th>${L}${V}</tr>`}).join("");return`<div class="lb-card__scroll"><table class="lb-grid"><thead>${g}</thead><tbody>${v}</tbody></table></div>`},n=s.columnGroups.map((m,h)=>t(h)).join(""),i=s.title.groups.map(m=>m.map(h=>F(h)).join(s.title.nameJoiner)).filter(Boolean).join(s.title.joiner),r=s.subtitleFacts.length?`<div class="lb-card__sub">${s.subtitleFacts.map(F).join(" · ")}</div>`:"",d=e.mode==="verification"&&s.footnotes.length?`<div class="lb-card__notes"><span class="lb-card__notes-label">Points breakdown</span>${s.footnotes.map(m=>`<span class="lb-card__note">${F(m)}</span>`).join("")}</div>`:"",o=e.mode==="verification"&&s.caption?`<p class="lb-card__caption">${F(s.caption)}</p>`:"",c=s.totals.length?`<ul class="lb-card__totals">${s.totals.map(m=>`<li>${F(m.label)} = <strong>${m.value}</strong></li>`).join("")}</ul>`:"",u=i?`<header class="lb-card__head"><h4>${i}</h4>${r}</header>`:r;return`<article class="${e.cardModifier?`lb-card ${e.cardModifier}`:"lb-card"}">
  ${u}
  ${n}
  ${d}${o}${c}
</article>`}function Eu(s,e,t,n){return rn(sn(s,e,t,n),n)}function Nu(s,e,t,n){return rn(sn(s,e,t,n),{...n,cardModifier:"lb-card--compact-match"})}function Ru(s,e,t,n){return rn(sn(s,e,t,n),{...n,cardModifier:"lb-card--category-matrix"})}function Ou(s){return s.pace===null?'<td class="lb-rank__pace"></td>':`<td class="lb-rank__pace lb-rank__pace--${s.pace.tone}">${F(s.pace.text)}</td>`}function Mu(s){return`lb-panel-${s.replace(/[^a-zA-Z0-9_-]+/g,"-")}`}function Hu(s,e,t=$r,n=null){const i=vu(s,e,t),r=i.hasPace,d=n!==null,o=(r?5:4)+(d?1:0),c=i.entries.map((g,v)=>{const w=g.group?` <span class="lb-rank__group">${F(g.group)}</span>`:"",T=`
  <td class="lb-rank__total">${g.total}</td>${r?`
  ${Ou(g)}`:""}
  <td class="lb-rank__thru">${g.holesPlayed}</td>`,R=s.entries[v],L=n&&R?n.plan.attached.get(Hs(n.plan.slotDefId,R.ballIds)):void 0;if(!n)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${F(g.name)}</span>${w}</span></td>${T}
</tr>`;if(!R||!L)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${F(g.name)}</span>${w}</span></td>${T}
  <td class="lb-rank__disclosure"></td>
</tr>`;const V=Hs(n.plan.slotDefId,R.ballIds),O=n.isOpen(V),W=Mu(V),ae=kr(L,n.routeSections,e,{mode:n.mode??"product"}),oe=["lb-rank__row--expandable"];return g.lead&&oe.push("lb-rank__lead"),O&&oe.push("lb-rank__row--open"),`<tr class="${oe.join(" ")}" data-expand-key="${F(V)}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${O}" aria-controls="${F(W)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${F(g.name)}</span>${w}</span></button></td>${T}
  <td class="lb-rank__disclosure"><span class="lb-rank__chev" aria-hidden="true"></span></td>
</tr>
<tr class="lb-rank__panel${O?" lb-rank__panel--open":""}" data-panel-key="${F(V)}">
  <td class="lb-rank__panelcell" colspan="${o}"><div class="lb-rank__panelwrap" id="${F(W)}"><div class="lb-rank__panelbox">${ae}</div></div></td>
</tr>`}).join(""),u=r?`
  ...
  <table class="lb-rank">
...
</div>`}function Au(s,e){const t=wu(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",d=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    ...
    <div class="lb-mp__team lb-mp__team--b${d}">${F(i.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${F(t.title)}</h4>${n}
</div>`}const Lu={ranked:Hu,match_summary:(s,e)=>Au(s,e)},zu={"default-score-grid":Eu,"compact-match-grid":Nu,"category-matrix-grid":Ru};function Bu(s){return`<div class="lb-diag">Unrenderable result section <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Fu(s){return`<div class="lb-diag">Unsupported score-grid component <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Gu(s,e,t,n=null){const i=Lu[s.kind];return i?i(s,e,t,n):Bu(s.kind)}function kr(s,e,t,n){const i=wr(s),r=zu[i];return r?r(s,e,t,n):Fu(i)}function Sr(s,e,t=$r,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${F(s.formatLabel)}.</div>`:s.leaderboard.map(r=>Gu(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${F(s.formatLabel)}.</div>`}function Tr(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>kr(r,e,t,{mode:i})).join(`
`)}const ju=b(`
...
`);class an extends H{static styles=`
    ...
    `;svc=this.inject(fe);expansion=new ku;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(ju,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=$u(t);this.expansion.retain(r.attached.keys());const d=Sr(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),o=Tr(r.standalone,e.routeSections,n),c=o?`<h3 class="lb-cards__head">Scorecard</h3>${o}`:"";return d+c}}function Du(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const qu=b(`
...
`);class Uu extends H{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `,it.seq=0;let he=it;function Wu(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Yu(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Qu(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Xu=b(`
...
`);class eh extends H{static styles=`
        .seat-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
...
`);class rh extends H{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(j);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return sh(this.svc.startList.get())}eligible(){return this.policyState().visible&&th(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,_.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await _.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof K&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(E(()=>this.ensureTeesLoaded()));const e=new k(()=>nh(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(E(()=>{const r=e.get(),d=this.groupChoice.get();(!d||!r.options.some(o=>o.value===d&&!o.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(ih,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new he({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new he({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const Dn=1440*60*1e3;function ah(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>Dn?!0:e-t>=Dn}function oh(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function lh(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!oh(s.balls,s.playerId)||!ah(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ye(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Lt(s){return s<0?`+${String(-s)}`:String(s)}const dh=b(`
...
`);class ch extends H{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${N()}
    ...
    `;svc=this.inject(fe);auth=this.inject(D);profile=this.inject(Ue);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return lh({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Lt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ye(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(E(()=>this.ensureProfileLoaded())),this.wire(dh,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Lt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function uh(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const hh=b(`
...
`);class ph extends H{static styles=`
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(j);tokenQ=this.router.query("token");editable=new p(!1);deleteOpen=new p(!1);finishOpen=new p(!1);finishAsReopen=new p(!1);leaveOpen=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);isComplete(){return this.svc.round.get()?.status==="complete"}canLeave(){return uh(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}canDelete(){const e=this.auth.currentUser.get()?.id??null;return e!==null&&this.svc.friendlyRound.get()?.creatorPlayerId===e}clear(){this.error.set(""),this.diagnostics.set([])}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.clear(),this.leaving.set(!0);try{const t=await _.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){this.track(E(()=>{const r=this.tokenQ.get();this.editable.set(!1),r&&_.friendlyRounds.setup({token:r}).then(d=>{this.tokenQ.get()===r&&this.editable.set(d.editable===!0)}).catch(()=>{})})),this.track(E(()=>{this.props.open.get()&&this.clear()}));const e=this.wire(hh,{root:{className:()=>this.props.open.get()?"rmanage":"rmanage hidden"},backdrop:{onclick:()=>this.props.open.set(!1)},close:{onclick:()=>this.props.open.set(!1)},editRow:{className:()=>this.editable.get()?"rmanage__row":"rmanage__row hidden",onclick:()=>{const r=this.tokenQ.get();r&&(this.props.open.set(!1),this.router.navigate("/create",{query:{token:r}}))}},leaveRow:{className:()=>this.canLeave()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.leaveOpen.set(!0),disabled:()=>this.leaving.get()},finishRow:{onclick:()=>{this.finishAsReopen.set(this.isComplete()),this.finishOpen.set(!0)},disabled:()=>this.svc.finishing.get()},finishTitle:()=>this.isComplete()?"Reopen round":"Finish round",finishSub:()=>this.isComplete()?"Move it back to your ongoing rounds.":"Move it to your finished rounds. Nothing is locked.",deleteRow:{className:()=>this.canDelete()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.deleteOpen.set(!0),disabled:()=>this.svc.deleting.get()},diag:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},err:{textContent:()=>this.error.get()}});this.spawn(ie,this.ref(e,"deleteConfirmHost"),{open:this.deleteOpen,title:"Delete round?",message:"This permanently removes the round and all its scores for everyone. This can't be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.clear(),this.svc.deleteRound().then(r=>{r?this.router.navigate("/"):this.error.set("Could not delete the round. Try again.")})}}),this.spawn(ie,this.ref(e,"finishConfirmHost"),{open:this.finishOpen,title:()=>this.finishAsReopen.get()?"Reopen this round?":"Finish this round?",message:()=>this.finishAsReopen.get()?"It'll move back to your ongoing rounds.":"It'll move to your finished rounds. You can still edit or reopen it any time.",confirmLabel:()=>this.finishAsReopen.get()?"Reopen round":"Finish round",cancelLabel:"Cancel",onconfirm:()=>{this.clear(),(this.finishAsReopen.get()?this.svc.reopenRound():this.svc.finishRound()).then(d=>{d||this.error.set("Could not update the round. Try again.")})}}),this.spawn(ie,this.ref(e,"leaveConfirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}});let t=null;const n=this.ref(e,"close");this.track(E(()=>{this.props.open.get()?(t=document.activeElement instanceof HTMLElement?document.activeElement:null,queueMicrotask(()=>n.focus())):t&&(t.focus(),t=null)}));const i=r=>{if(r.key==="Escape"){if(this.deleteOpen.get())return void this.deleteOpen.set(!1);if(this.finishOpen.get())return void this.finishOpen.set(!1);if(this.leaveOpen.get())return void this.leaveOpen.set(!1);this.props.open.get()&&this.props.open.set(!1)}};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),e}}function fh(s){const{balls:e,groups:t,strokesFor:n}=s,i=new Set(e.filter(d=>!d.pending).map(d=>d.id));let r=0;for(const d of t)for(const o of d.ballIds)if(i.has(o))for(const c of d.playedOrder)n(o,c.playHoleId)===null&&r++;return r}function mh(s){return s<=0?null:s===1?"1 score is still missing.":`${s} scores are still missing.`}function gh(s,e,t=!0){if(s===null||e===null||s<=0)return null;const n=s-e;return n===0?null:s===1&&t||n<=-3?"diamond":n===-2?"double_ring":n===-1?"ring":n===1?"square":n===2?"double_square":"box_badge"}function bh(s){const e=s.par,t=s.score,n=t===0,i=n?null:t,r=s.stats;return{id:s.playHoleId,ordinal:s.ordinal,holeNumber:s.courseHoleNumber,par:e,lengthM:s.lengthM,strokes:i,isPickedUp:n,vsPar:i===null?null:i-e,marker:gh(i,e),tee:r.teeResult,gir:r.gir,putts:r.putts,firstPutt:r.firstPutt,shortGame:r.shortGameDifficulty,penalties:r.penalties,recoveryOk:r.recoveryOk}}function yh(s){return(s.penalties??0)>0}const As=10,_h=3;function vh(s){const{round:e,holes:t,history:n,windowSize:i=As,insightLimit:r=_h}=s,d=Qs([e]),o=d.waterfall,u=wh(e,n,i).map(m=>ot(m.measures)),f=d.rounds[0];return{roundId:e.roundId,date:e.date,courseName:e.courseName,name:e.name,holeCount:e.holeCount,strokes:f?.strokes??null,vsPar:f?.vsPar??null,cells:[...t].sort((m,h)=>m.ordinal-h.ordinal).map(bh),panels:d,waterfall:o,deltas:u.length===0?null:cr(o,u),windowCount:u.length,insights:Gd(e.measures,o,u,r)}}function wh(s,e,t){const n=e.filter(d=>d.roundId!==s.roundId);n.push(s);const i=Wt(n),r=i.findIndex(d=>d.roundId===s.roundId);return r===-1?[]:i.slice(r+1,r+1+Math.max(0,t))}function qn(s,e,t){const n=Wt(s),i=n.findIndex(r=>r.roundId===e);return i===-1?!1:n.length-(i+1)>=t}function Vn(s){const e=(s.name??"").trim();if(e!=="")return e;const t=(s.courseName??"").trim();return t===""?"Round":t}function Pr(s){const{signedInPlayerId:e,statConfigPlayerIds:t,statRows:n,holesUnscored:i}=s;return e===null||e===""?{reason:"notSignedIn",playerId:null}:t.has(e)?n.some(d=>d.playerId===e&&xh(d))?i!==0?{reason:"roundUnfinished",playerId:null}:{reason:"eligible",playerId:e}:{reason:"noStatsRecorded",playerId:null}:{reason:"noStatsConfigured",playerId:null}}function xh(s){return s.teeResult!==null||s.gir!==null||s.firstPutt!==null||s.putts!==null||s.shortGameDifficulty!==null||s.penalties!==null||s.recoveryOk!==null}function Ir(s){const{playerId:e,balls:t,groups:n,strokesFor:i}=s,r=t.find(o=>o.players.some(c=>c.playerId===e));if(!r)return null;const d=n.find(o=>o.ballIds.includes(r.id));return d?d.playedOrder.filter(o=>i(r.id,o.playHoleId)===null).length:null}function Cr(s,e=typeof navigator>"u"?"en":navigator.language){const t=(s?.name??"").trim();if(t)return t;const n=s?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n||"Round"}const $h=b(`
...
`);class kh extends H{static styles=`
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(j);stage=new p("prompt");error=new p("");render(){this.track(E(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire($h,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>mh(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(an,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=Cr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return fh({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return Pr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:Ir({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Oe{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(Es());filter=new p(st);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new k(()=>er(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new k(()=>Qs(this.windowRounds.get()));courses=new k(()=>Gl(this.loadedRounds.get()));overFiltered=new k(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await G(this.loading,this.error,()=>_.playerStats.myStats({limit:Oe.PAGE_SIZE}));t&&(this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded())}select(e){this.preset.set(e),Cn(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),Cn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(st),this.select(Mt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Oe.MAX_PAGES&&tr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await _.playerStats.myStats({limit:Oe.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Oe.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(st),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class ut{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=U.get(Oe);inFlight=null;model=new k(()=>{const e=this.round.get();return e===null?null:vh({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await _.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Un(d)),this.failure.set(Kn(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(Un(d)),this.failure.set(Kn(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const o of d)n.has(o.roundId)||(n.add(o.roundId),t.push(o))};if(i(this.dashboard.loadedRounds.get()),qn(t,e,As))return t;let r=null;for(let d=0;d<ut.MAX_PAGES;d++){const o=await _.playerStats.myStats({limit:ut.PAGE_SIZE,cursor:r??void 0});if(i(o.rounds),qn(t,e,As)||o.nextCursor===null)return t;r=o.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function Un(s){if(s instanceof K){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function Kn(s){return s instanceof K&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const te=100;function ts(s){return s>0?"loss":s<0?"gain":"zero"}function Ke(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function M(s){return String(Math.round(s*1e3)/1e3)}function ss(s){return s<0?0:s>1?1:s}function ke(s,e){return`<svg class="chart" viewBox="0 0 ${te} ${M(s)}" preserveAspectRatio="none" style="height:${M(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function on(s,e,t,n=1){return`<path d="M${M(s)} 0 L${M(s)} ${M(e)}" stroke="${t}" stroke-width="${M(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function pe(s,e,t,n,i){return`<rect x="${M(s)}" y="${M(e)}" width="${M(t)}" height="${M(n)}" fill="${i}"/>`}const Sh=1;function Th(s,e){const t=te/2,n=ts(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:Sh,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function Er(s,e,t,n=10){const i=Th(s,e),r=i.bar&&i.bar.width>0?pe(i.bar.x,0,i.bar.width,n,Ke(i.tone,t)):"";return ke(n,[pe(0,0,te,n,t.track),r,on(i.zeroX,n,t.rule)].join(""))}function Ph(s){const e=[];let t=0;for(const n of s){const i=te*ss(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function Ih(s,e,t=12){const n=Ph(s).filter(i=>i.width>0).map(i=>pe(i.x,0,i.width,t,i.color)).join("");return ke(t,pe(0,0,te,t,e.track)+n)}const Wn=2,Ch=1e-4;function Eh(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=Wn,d=Math.max(0,e-Wn*2);return s.map((o,c)=>({x:s.length===1?te/2:c/(s.length-1)*te,y:i===0?e/2:r+d-(o-t)/i*d}))}function Nh(s){return s.map((e,t)=>`${t===0?"M":"L"}${M(e.x)} ${M(e.y)}`).join(" ")}function Rh(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Ch?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Oh(s,e,t,n=34){const i=Eh(s,n);if(i.length===0)return ke(n,"");const r=Ke(Rh(s,e),t),d=`<path d="${Nh(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,o=i[i.length-1],c=`<path d="M${M(o.x)} ${M(o.y)} L${M(o.x)} ${M(o.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(n,d+c)}const Mh=.5;function Hh(s,e,t=12){const n=te/2,i=de.length-1,r=Math.max(1,(t-i)/de.length),d=[];return de.forEach((o,c)=>{const u=Ve(s,o);if(u===null||!(e>0))return;const f=Math.max(u===0?0:Mh,n*Math.min(1,Math.abs(u)/e));d.push({component:o,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:ts(u)})}),d}function Ah(s,e,t,n=12){const i=Hh(s,e,n).filter(r=>r.width>0).map(r=>pe(r.x,r.y,r.width,r.height,Ke(r.tone,t))).join("");return ke(n,on(te/2,n,t.rule)+i)}const Nr=1,Yn=.02;function Lh(s,e){const t=e>0?te*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=ss(s),i=e<=0?"neutral":s>e+Yn?"gain":s<e-Yn?"loss":"neutral";return{bar:{width:Math.max(Nr,te*n),tone:i},tickX:t}}function zh(s,e,t,n=10){const i=Lh(s,e),r=i.bar?pe(0,0,i.bar.width,n,Ke(i.bar.tone,t)):"",d=i.tickX===null?"":on(i.tickX,n,t.rule,2);return ke(n,pe(0,0,te,n,t.track)+r+d)}function Bh(s){return s===null?null:Math.max(Nr,te*ss(s))}function Rr(s,e,t=e.neutral,n=8){const i=Bh(s),r=i===null?"":pe(0,0,i,n,t);return ke(n,pe(0,0,te,n,e.track)+r)}const Qn=100,zt=50,Fh=16,xt=22,Xn=44,Gh=3,jh=33,Dh={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function et(s,e){const t=(s-90)*Math.PI/180;return{x:zt+e*Math.cos(t),y:zt+e*Math.sin(t)}}function Jn(s,e,t,n){const i=e-s>180?1:0,r=et(s,n),d=et(e,n),o=et(e,t),c=et(s,t);return`M${M(r.x)} ${M(r.y)} A${M(n)} ${M(n)} 0 ${i} 1 ${M(d.x)} ${M(d.y)} L${M(o.x)} ${M(o.y)} A${M(t)} ${M(t)} 0 ${i} 0 ${M(c.x)} ${M(c.y)} Z`}function qh(s){const e=Math.max(s.long,s.short,s.left,s.right),t=Gh/2,n=[];for(const i of["long","right","short","left"]){const r=Dh[i],d=r.from+t,o=r.to-t,c=e>0?ss(s[i]/e):0,u=xt+(Xn-xt)*c,f=et((r.from+r.to)/2,jh);n.push({id:i,trackPath:Jn(d,o,xt,Xn),valuePath:Jn(d,o,xt,u),labelX:f.x,labelY:f.y})}return n}function Vh(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${M(zt)}" cy="${M(zt)}" r="${M(Fh)}" fill="${t.track}"/>`+s.map(r=>`<text x="${M(r.labelX)}" y="${M(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${Qn} ${Qn}" preserveAspectRatio="xMidYMid meet" style="width:${M(n)}px;height:${M(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const Uh=60,Bt=58,Kh=2,Wh={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function Yh(s,e){const t=Bt-Kh,n=d=>e>0?d/e*t:0,i=[],r=(d,o)=>{const c=Wh[d];let u=Bt;for(const f of o){const m=n(f.count);u-=m,i.push({id:f.id,column:d,tone:f.tone,x:c.x,y:u,width:c.width,height:m})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function Qh(s,e,t){const n=s.filter(i=>i.height>0).map(i=>pe(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${M(Bt)} L${M(te)} ${M(Bt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(Uh,n)}const ns={gain:l("accent-strong"),loss:l("danger"),zero:l("border-strong"),neutral:l("accent"),track:l("surface-sunken"),rule:l("border")},S={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",sandSave:"Missed greens from a bunker where you still got up and down.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",multiChipBunker:"Bunker holes that took more than one shot to get out.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function Fe(s){return pc(s)?null:s.value}function Y(s,e,t){return{kind:"bar",id:s,title:e,share:Fe(t),value:ce(t)}}function B(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function Xh(s,e){switch(s){case"tee":{const t=e.tee&&se(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&se(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?re(e.putting.puttsPerGirHole,{unit:Rs,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&se(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?re(e.scoring.doubleBogeyPlusPerRound,{unit:be,label:"doubles or worse per round"}):null}}function Jh(s){const e=rc(s.vsParByTee),t=e?`${S.troubleTax} Measured ${e}.`:S.troubleTax;return B("troubleTax","Trouble tax",dt(s.troubleTax,2,!0),t)}function Zn(s){return s===null?null:`Measured ${s}.`}function _s(s){return re(s,{unit:le,signed:!0})}function Zh(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>ce(i)??"",n=(i,r)=>`${i} ${ce(r)??S.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:qh(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function ep(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:Yh(e,s.teeRecorded),text:[`Left ${J(e.leftInPlay+e.leftTrouble)}`,`Fairway ${J(e.fairway)}`,`Right ${J(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function tp(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function ei(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:Fe(t.fairway),value:ce(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:Fe(t.inPlayOnly),value:ce(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:Fe(t.trouble),value:ce(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:S.teeFanHead},ep(t),{kind:"note",id:"teeFanNote",text:S.teeFan}]:[],...tp(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},{kind:"note",id:"vsParByTeeNote",text:S.vsParByTee},B("vsParFairway","From the fairway",_s(t.vsParByTee.fairway)),B("vsParInPlay","From in play",_s(t.vsParByTee.inPlay)),B("vsParTrouble","From trouble",_s(t.vsParByTee.trouble))]:[],Jh(t),B("recovery","Recovery",se(t.recovery),S.recovery),...t.penaltiesRecordedHoles>0?[B("penalties","Penalties",re(t.penaltiesPerRound,{unit:be}),`${S.penalties} Recorded on ${ee(t.penaltiesRecordedHoles,le)}.`),B("penaltyHoleShare","Holes with a penalty",se(t.penaltyHoleShare)),B("penaltyTax","Penalty tax",dt(t.penaltyTax,2,!0),Zn(hc(t.vsParByPenalty)))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:S.greenMissHead},Zh(t),{kind:"note",id:"greenMissNote",text:S.greenMiss}]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},Y("girFairway","From the fairway",t.girByTee.fairway),Y("girInPlay","From in play",t.girByTee.inPlay),Y("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},Y("girPar3","Par 3",t.girByPar.par3),Y("girPar4","Par 4",t.girByPar.par4),Y("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:S.proximityProxy},...Me.map(n=>Y(`mix-${n}`,ps(n),t.girFirstPuttMix[n])),B("birdieConversion","Birdie conversion",se(t.birdieConversion),S.birdieConversion),...t.hardChipShare.d>0?[B("hardChipShare","Hard misses",se(t.hardChipShare),S.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},B("vsParGreenHit","Green hit",re(t.costOfMissedGreen.hit,{unit:Rs,signed:!0})),B("vsParGreenMissed","Green missed",re(t.costOfMissedGreen.miss,{unit:le,signed:!0})),B("missedGreenTax","Missed-green tax",dt(t.costOfMissedGreen.delta,2,!0),Zn(uc(t.costOfMissedGreen)))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[Me[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},{kind:"note",id:"firstPuttNote",text:S.firstPuttSpread},...Me.map(n=>Y(`spread-${n}`,ps(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:S.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:ps(n.bucket),made:Fe(n.made),baseline:n.baseline,value:ce(n.made)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},Y("putts-zero","No putts",t.puttDistribution.zero),Y("putts-one","One putt",t.puttDistribution.one),Y("putts-two","Two putts",t.puttDistribution.two),Y("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],B("threePutt","Three-putts",se(t.threePutt),S.threePutt),B("longThreePutt","Three-putts from over 8 m",se(t.threePuttsFromOver8m),S.longThreePutt),B("puttsPerGir","Putts per green hit",re(t.puttsPerGirHole,{unit:Rs}),S.puttsPerGir),...t.puttsAfterMissedGreen.d>0?[B("puttsAfterMissedGreen","Putts after a missed green",re(t.puttsAfterMissedGreen,{unit:le}),S.puttsAfterMissedGreen)]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},B("puttsPar3","Par 3",re(t.puttsPerHoleByPar.par3,{unit:le})),B("puttsPar4","Par 4",re(t.puttsPerHoleByPar.par4,{unit:le})),B("puttsPar5","Par 5",re(t.puttsPerHoleByPar.par5,{unit:le}))]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},Y("scrambleStandard","Standard",t.scramble.standard),Y("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[Y("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[B("sandSave","Sand save",se(t.sandSave),S.sandSave)]:[],...t.shortGameStrokesRecorded>0?[B("multiChipBunker","More than one from sand",se(t.multiChipBunker),S.multiChipBunker),B("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes),S.extraShortGameStrokes),B("multiChip","More than one chip",se(t.multiChip),S.multiChip)]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},Y("chipStandard","Standard",t.chipInside2m.standard),Y("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[Y("chipBunker","Bunker",t.chipInside2m.bunker)]:[],B("conversionInside2m","Holed from inside 2 m",se(t.conversionInside2m),S.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},{kind:"note",id:"chipInsNote",text:S.chipIns},B("chipInsStandard","Standard",J(t.chipIns.standard)),B("chipInsHard","Hard",J(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[B("chipInsBunker","Bunker",J(t.chipIns.bunker))]:[]]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>re(i,{unit:le,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},B("par3","Par 3",n(t.avgVsParByParGroup.par3)),B("par4","Par 4",n(t.avgVsParByParGroup.par4)),B("par5","Par 5",n(t.avgVsParByParGroup.par5)),B("doubles","Doubles or worse",re(t.doubleBogeyPlusPerRound,{unit:be}),S.doubleBogeyPlus),B("bounceBack","Bounce-back",se(t.bounceBack),S.bounceBack)]}}}function sp(s){if(!s||s.rounds===0)return"";const e=ee(s.rounds,be),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${ee(t.holeCount,le)}`;const n=s.lengths.map(i=>`${J(i.rounds)} × ${ee(i.holeCount,le)}`).join(", ");return`${e} — ${n}`}function np(s){return s===18?"Best 18":s===9?"Best 9":`Best ${J(s)} holes`}const ip=18;function rp(s){const e=s.lengths.some(i=>i.holeCount!==ip),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${ee(s.holesScored,le)}`;return e?`${n}, scaled to 18`:n}function vs(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:Se(s.avgVsParPer18.value,1),qualifier:rp(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:np(t.holeCount),value:Qt(n.vsPar),qualifier:`${J(n.strokes)} strokes`,hero:!1})}return e}function ap(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function $t(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return Pd.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:ap(t),share:Fe(x(n,e)),value:ce(x(n,e))??J(n)}})}function op(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function ti(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const ge={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s=or.calibratedAt){return s===null?"Tapscore reference baseline v1 is one set of expected scores per hole and per lie. It is still provisional, so treat the order of the rows as the reading and the sizes as rough.":`Tapscore reference baseline v1 is one set of expected scores per hole and per lie, frozen on ${s}. Everyone is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${lr} attributed holes is left out of the comparison entirely.`},total(s){const e=lp(s.rowsPer18);if(e===null)return null;const t=Se(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${ee(e.recorded,cc)} you labelled, ${J(e.tee)} came off the tee, ${J(e.approach)} on the approach and ${J(e.short)} around the green.`}};function lp(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function Ft(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Gt(s){const e=[{id:"holes",title:"Holes counted",body:ge.holesCounted(s)},{id:"rows",title:"The five rows",body:ge.fiveRows()},{id:"baseline",title:"The baseline",body:ge.baseline()},{id:"per18",title:"Per 18 holes",body:ge.per18()}],t=ge.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=ge.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:S.penaltySourceInfoTitle,body:n}),e}const Q={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},si={title:"Your round",seeWholeRound:"See the whole round"};function dp(s){const e=[mr(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function Or(s,e){return s===null?null:e===null?String(s):`${s} (${Qt(e)})`}function cp(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function up(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function hp(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Qt(s.vsPar)})`}function pp(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function fp(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function mp(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function gp(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function ln(s){const e=[],t=hp(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:pp(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:fp(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:mp(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function bp(s){return s===null?[]:ln(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function ni(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(gp(s.marker).toLowerCase())):e.push("no score");for(const t of ln(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function Mr(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=$e(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function ii(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function ws(s,e=1){return typeof s=="number"?$e(Math.abs(s),e):""}function Ce(s){return typeof s=="number"?String(Math.round(s)):""}function ri(s){return typeof s=="string"?s:"tee"}function yp(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${ii(ri(e.component))} was ${ws(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${ii(ri(e.component))} cost you ${ws(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${ws(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Ce(e.left)} left and ${Ce(e.right)} right of ${Ce(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Ce(e.successes)} of the ${Ce(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Ce(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Ce(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const _p=b(`
...
${tn}
    `;round=this.inject(fe);stats=this.inject(ut);auth=this.inject(D);router=this.inject(j);colors=ns;infoOpen=new p(!1);render(){this.track(E(()=>{const i=this.eligibleRoundId();X(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(_p,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>si.title,score:()=>{const i=e();return i===null?"":Or(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>si.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ve(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...de],(i,r,d)=>this.wireEl(wp,{label:()=>Xt(i),amount:{textContent:()=>{const o=n(i);return o===null?S.notRecorded:Se(o)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const o=n(i);return o===null?"":`color:${Ke(ts(o),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Gt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(r=>xe(i.waterfall,r)),penaltySource:Ft(i.panels.totals)})},(i,r,d)=>this.wireEl(es,{ctitle:()=>i.title,ctext:()=>i.body},d),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl(vp,{text:()=>yp(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:Pr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:Ir({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return Q.waterfallHint;let t=null;for(const n of de){const i=Ws(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?Q.waterfallHint:Mr(t,e.windowCount)}}function ai(s){return!(!s.pageVisible||s.status==="complete")}function $p(s,e){return e&&!s}const kp=2,oi=3,Sp=75e3;function Tp(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${q}/friendly-rounds/events?${t.toString()}`}function Pp(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Ip(s){const e=s.eventSourceFactory??(L=>new EventSource(L)),t=s.setTimer??((L,V)=>setTimeout(L,V)),n=s.clearTimer??(L=>clearTimeout(L)),i=s.livenessTimeoutMs??Sp,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,o=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(T,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},v=()=>{d=!0,m(),g()},w=()=>{if(g(),++o>=oi){v(),s.onDegrade();return}R()};function T(){if(!d){if(!r()){h();return}w()}}function R(){if(d)return;let L;try{L=e(Tp(s.token,f))}catch{v(),s.onDegrade();return}c=L,L.onopen=()=>{o=0},L.onmessage=V=>{if(d||c!==L)return;h();let O;try{O=JSON.parse(V.data)}catch{return}Pp(O)&&(O.latestEventId!==null&&(f=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},L.onerror=()=>{d||c!==L||(L.readyState===kp||++o>=oi)&&(v(),s.onDegrade())},h()}return R(),{stop:()=>{d||v()}}}const Cp=2e4;function Ep(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Np=b(`
...
`),Rp=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Op=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Mp extends H{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class df extends H{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
            ...
            & .player {
                ...
                & .player__name { ${ne()} flex: 1; padding: ${a("md")}; font-size: 1rem; }
                & .player__remove {
                    ${$()}
                ...
                & .player__index { ${ne()} flex: 1; min-width: 0; padding: ${a("md")}; font-size: 1rem; }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { ${ne()} width: 56px; padding: ${a("xs")} ${a("sm")}; font-size: 0.95rem; }
                    }
                }
                ...
                & .grp__start {
                    ...
                    & .grp__time { ${ne()} flex: 1; min-width: 0; padding: ${a("sm")} ${a("md")}; font-size: 1rem; font-family: inherit; }
...
`);class mf extends H{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
    ...
    `;auth=this.inject(D);router=this.inject(j);nextQ=this.router.query("next");mode=new p("login");busy=new p(!1);formError=new p("");username="";password="";displayName="";hcp="";gender=new p(null);clubs=new p([]);homeClubId=new p("");clubsRequested=!1;async loadClubs(){if(!this.clubsRequested){this.clubsRequested=!0;try{this.clubs.set(await _.setup.clubs())}catch{}}}destination(e){const t=this.nextQ.get();return t&&t.startsWith("/")?t:e}async submit(){if(this.formError.set(""),this.mode.get()==="login"){if(!this.username.trim()||this.password===""){this.formError.set("Enter your username and password.");return}this.busy.set(!0);try{const n=await Ar(this.username.trim(),this.password);this.auth.currentUser.set(n),this.auth.error.set(null),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(mi(n,"login"))}finally{this.busy.set(!1)}return}const e=this.hcp.trim(),t=e===""?null:ye(e);if(e!==""&&t===null){this.formError.set("Handicap index must be a number (or leave it empty).");return}if(this.password.length<8){this.formError.set("Password must be at least 8 characters.");return}if(!this.username.trim()||!this.displayName.trim()){this.formError.set("Username and display name are required.");return}this.busy.set(!0);try{const n=await _.players.register({username:this.username.trim(),password:this.password,displayName:this.displayName.trim(),handicapIndex:t,gender:this.gender.get(),homeClubId:this.homeClubId.get()||null});this.auth.currentUser.set({id:n.id,username:n.username}),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(mi(n,"register"))}finally{this.busy.set(!1)}}render(){const e=()=>this.mode.get()==="register",t=()=>this.auth.loading.get()||this.busy.get(),n=this.wire(ff,{root:{inert:()=>t()},error:{className:()=>this.formError.get()?"error show":"error",textContent:()=>this.formError.get()},form:{onsubmit:async d=>{d.preventDefault(),await this.submit()}},username:{oninput:d=>{this.username=d.target.value}},password:{autocomplete:()=>e()?"new-password":"current-password",oninput:d=>{this.password=d.target.value}},registerFields:{className:()=>e()?"login__register":"login__register hidden"},displayName:{oninput:d=>{this.displayName=d.target.value}},hcp:{oninput:d=>{this.hcp=d.target.value}},submit:{textContent:()=>t()?e()?"Creating account…":"Signing in…":e()?"Create account":"Sign in"},toggle:{textContent:()=>e()?"Have an account? Sign in":"New here? Create an account",onclick:()=>{this.formError.set(""),this.auth.error.set(null);const d=!e();this.mode.set(d?"register":"login"),d&&this.loadClubs()}}}),i=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(n,"gender"),()=>i,(d,o,c)=>this.wireEl(b('<button bind="b" type="button"></button>'),{b:{textContent:()=>d.label,className:()=>this.gender.get()===d.value?"on":"",onclick:()=>this.gender.set(d.value)}},c),d=>d.label);const r=new he({value:this.homeClubId,options:{get:()=>[{value:"",label:"No home club"},...this.clubs.get().map(d=>({value:d.id,label:d.name}))]},placeholder:"No home club"});return r.mount(this.ref(n,"club")),this.track(()=>r.destroy()),n}}const gf=b(`
    <div class="friends">
...
`),bf='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',yf=b(`
    <div class="friend-row">
        ${Te("friend-row__badge")}
...
`),gi=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${bf}</button>
    </div>
`);class _f extends H{static styles=`
        .friends {
    ...
    `;svc=this.inject(Ut);auth=this.inject(D);router=this.inject(j);removeOpen=new p(!1);removeTarget=new p(null);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(gf,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:r=>this.svc.setQuery(r.target.value)},searchHint:{textContent:()=>{const r=this.svc.query.get().trim();return r.length>0&&!yn(r)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const r=this.svc.query.get().trim();return yn(r)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===r&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&wt(this.svc.friends.get()).mutual.length===0?"friends__empty":"friends__empty hidden"},connectionsSection:{className:()=>wt(this.svc.friends.get()).addedByMe.length>0?"friends__section":"friends__section hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(r,d,o)=>this.wireEl(yf,{...we(()=>this.svc.results.get().find(c=>c.id===r.id)??r),name:()=>r.displayName,username:()=>r.homeClubName?`@${r.username} · ${r.homeClubName}`:`@${r.username}`,hcp:()=>r.handicapIndex===null?"–":r.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(r.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const c=this.svc.results.get().find(u=>u.id===r.id);c&&!c.isFriend&&this.svc.add(c)}},added:{className:()=>this.isFriendNow(r.id)?"friend-row__added":"friend-row__added hidden"}},o),r=>r.id);const n=new Date().toISOString();this.$each(this.ref(t,"friends"),()=>Nt(wt(this.svc.friends.get()).mutual,this.svc.sortMode.get()),(r,d,o)=>this.wireEl(gi,this.friendRowBindings(r,n),o),r=>r.id),this.$each(this.ref(t,"connections"),()=>Nt(wt(this.svc.friends.get()).addedByMe,this.svc.sortMode.get()),(r,d,o)=>this.wireEl(gi,this.friendRowBindings(r,n),o),r=>r.id),this.spawn(ie,this.ref(t,"removeConfirmHost"),{open:this.removeOpen,title:()=>{const r=this.removeTarget.get();return r?`Remove ${r.displayName} from friends?`:"Remove friend?"},message:()=>{const r=this.removeTarget.get();return r?`${r.displayName} will disappear from your friends list. You can add them again later.`:"They will disappear from your friends list. You can add them again later."},confirmLabel:"Remove friend",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.removeTarget.get();r&&this.svc.remove(r.id)}});const i=r=>{r.key==="Escape"&&this.removeOpen.get()&&this.removeOpen.set(!1)};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),t}liveFriend(e){return this.svc.friends.get().find(t=>t.id===e.id)??e}askRemove(e){const t=this.liveFriend(e);this.removeTarget.set({id:t.id,displayName:t.displayName}),this.removeOpen.set(!0)}friendRowBindings(e,t){return{...we(()=>this.svc.friends.get().find(n=>n.id===e.id)??e),open:{disabled:()=>!this.liveFriend(e).isMutual,onclick:()=>{const n=this.liveFriend(e);n.isMutual&&this.router.navigate("/friend",{query:{id:e.id,name:n.displayName}})}},name:()=>e.displayName,subtitle:()=>Ao(this.liveFriend(e),t),connection:()=>Lo(this.liveFriend(e))??"",hcp:()=>e.handicapIndex===null?"–":e.handicapIndex.toFixed(1),remove:{"aria-label":()=>`Remove ${this.liveFriend(e).displayName} from friends`,title:()=>`Remove ${this.liveFriend(e).displayName} from friends`,disabled:()=>this.svc.mutating.get()||this.removeOpen.get(),onclick:()=>this.askRemove(e)}}}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Lr=b(`
...
`);function zr(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Qo(s),subtitle:()=>Xo(s,Ae),progress:()=>Jo(s)}}function Br(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class wf extends H{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Kt);activity=this.inject(js);auth=this.inject(D);router=this.inject(j);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(E(()=>{const h=e.get();X(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new k(()=>{const h=e.get();return h?Ko(this.activity.feed.get(),h):null}),o=()=>this.svc.unavailable.get(),c=()=>n()&&o()===null&&i()!==null,u=()=>n()&&o()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(vf,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&o()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=o();return h?De[h].title:""}},refusalMsg:{textContent:()=>{const h=o();return h?De[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...we(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?Zo(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?Wo(h):""},onclick:()=>{const h=d.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>tl(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,v)=>this.wireEl(Lr,zr(h,f),v),h=>h.roundId),m}}const xf=b(`
    <div class="frounds">
...
`);class $f extends H{static styles=`
        .frounds {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class Tf extends H{static styles=`
        .fcourses {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Kt);auth=this.inject(D);router=this.inject(j);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(E(()=>{const c=e.get();X(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],d=()=>(t.get()??"").trim(),o=this.wire(kf,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}})},subtitle:{textContent:()=>{const c=d();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?De[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?De[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(d())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(o,"list"),r,(c,u,f)=>this.wireEl(Sf,{name:()=>c.courseName??"Course",facts:()=>el(c,Ae)},f),c=>c.courseId),o}}function Pf(s,e,t){const n=ht(e);if(n){const o=yi(s);return o?`Watching · ${o} ${n}`:`Watching · ${n}`}const i=yi(s)??"this",r=ht(t),d=r?` at ${r}`:"";return`Watching · ${i} round${d}`}function If(s,e,t,n){const i=ht(s)===null?null:ht(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Cf="You're watching this round. Only its players can enter scores.",bi={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function yi(s){const e=ht(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function ht(s){return(s??"").trim()||null}const Ef=b(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${Cf}</p>
        </div>
    </div>
`);class Nf extends H{static styles=`
        .spectate {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${an.styles}
    `;svc=this.inject(Xi);auth=this.inject(D);router=this.inject(j);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(E(()=>{const c=e.get();X(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim()||null;return this.wire(Ef,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(d()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?bi[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?bi[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Pf(d(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?If(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Ae(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const d=i.length>1?`<h2 class="spectate__slot-head">${Rf(r.formatLabel)}</h2>`:"",o=Sr(r,t,n),c=Tr(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return d+o+u}).join("")}}function Rf(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const Of=b(`
    <div class="profile">
...
`);class Af extends H{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { ${ne()} width: 90px; padding: ${a("md")}; font-size: 1rem; text-align: center; }
                    & button {
                        ${$()}
...
`),zf=b('<h3 bind="text" class="block__subhead"></h3>'),Bf=b('<p bind="text" class="block__note"></p>'),Ff=b(`
...
`),Uf=b('<div bind="panels" class="statspanels"></div>');class Fr extends H{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
    ...
    `;expanded=new p([]);colors=ns;render(){const e=this.wire(Uf,{}),t=()=>this.props.model();return this.$each(this.ref(e,"panels"),()=>[...jd],(n,i,r)=>{const d=()=>this.expanded.get().includes(n),o=this.wireEl(Lf,{panel:{className:()=>t()[n]?"panel":"panel hidden"},head:{"aria-expanded":()=>String(d()),onclick:()=>this.togglePanel(n)},title:()=>Dd(n),headline:()=>Xh(n,t())??"",body:{className:()=>d()?"panel__body":"panel__body hidden"}},r);return this.$each(this.ref(o,"body"),()=>ei(n,t()),(c,u,f)=>this.renderBlock(n,c,f),c=>c.id),o},n=>n),e}renderBlock(e,t,n){switch(t.kind){case"subhead":return this.wireEl(zf,{text:()=>t.text},n);case"note":return this.wireEl(Bf,{text:()=>t.text},n);case"split":{const i=()=>this.blockNow(e,t.id)??t;return this.wireEl(Ff,{bar:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":Ih(r.segments.map(d=>({id:d.id,share:d.share??0,color:this.segmentColor(d.tone)})),this.colors)}},legend:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":r.segments.map(d=>`<span class="legend__key"><span class="legend__swatch" style="background:${this.segmentColor(d.tone)}"></span><span>${d.title}</span><span class="legend__value">${d.value??S.notRecorded}</span></span>`).join("")}}},n)}case"bar":return this.wireEl(Gf,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="bar"||i.share===null?"":Rr(i.share,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value)},n);case"rung":return this.wireEl(jf,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="rung"?"":zh(i.made,i.baseline,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value)},n);case"figure":return this.wireEl(Df,{title:()=>t.title,hint:()=>{const i=this.blockNow(e,t.id)??t;return(i.kind==="figure"?i.hint:t.hint)??""},value:this.valueBinding(e,t.id,()=>t.value)},n);case"compass":return this.wireEl(qf,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="compass"?"":Vh(i.sectors,i.labels,this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="compass"?i.text:t.text}},n);case"fan":return this.wireEl(Vf,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="fan"?"":Qh(i.columns,this.toneColors(),this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="fan"?i.text:t.text}},n)}}toneColors(){return{fairway:this.segmentColor("fairway"),inplay:this.segmentColor("inplay"),trouble:this.segmentColor("trouble")}}valueBinding(e,t,n){const i=()=>{const r=this.blockNow(e,t);return r&&"value"in r?r.value:n()};return{textContent:()=>i()??S.notRecorded,className:()=>i()===null?"block__value block__value--absent":"block__value"}}segmentColor(e){switch(e){case"fairway":return this.colors.gain;case"inplay":return this.colors.neutral;case"trouble":return this.colors.loss}}togglePanel(e){const t=this.expanded.get();this.expanded.set(t.includes(e)?t.filter(n=>n!==e):[...t,e])}blockNow(e,t){return ei(e,this.props.model()).find(n=>n.id===t)}}const Kf=b(`
    <div class="stats">
...
${tn}
    `;svc=this.inject(Oe);auth=this.inject(D);router=this.inject(j);filterOpen=new p(!1);prioritiesInfoOpen=new p(!1);colors=ns;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Kf,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>S.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>S.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>sp(t().results),resultsCard:{className:()=>vs(t().results).length===0&&$t(t().results).length===0?"results hidden":"results"},histHead:()=>$t(t().results).length===0?"":S.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>S.prioritiesHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>S.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>S.roundsHint,pickHint:()=>n()?S.filterRoundsHint:""});return this.setHeading(i,"resultsSec",S.resultsHeading),this.setHeading(i,"prioritiesSec",S.priorities),this.setHeading(i,"trendsSec",S.trends),this.setHeading(i,"roundsSec",S.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>vs(t().results),(r,d,o)=>this.wireEl(Yf,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},o),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>$t(t().results),(r,d,o)=>this.wireEl(Qf,{title:()=>r.title,bar:{innerHTML:()=>Rr((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},o),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,o)=>this.wireEl(Xf,{title:()=>Xt(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":Er(c.per18,Jd(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?fc(c.per18):S.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.per18===null?op(c.roundsInWindow):`over ${ee(c.roundsCovered,be)}`:""}}},o),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Gt({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:Ft(t().totals)}),(r,d,o)=>this.wireEl(es,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},o),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,o)=>this.wireEl(Jf,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Oh(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return tm(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ee(c.points.length,be)}}},o),r=>r.id),this.spawn(Fr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,o)=>this.wireEl(Zf,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${ti(r)} — hole by hole`},label:()=>ti(r),subtitle:()=>sm(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(Bl(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Ah(c.waterfall,hr(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Qt(c.vsPar)}}},o),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(E(()=>t.set(this.svc.preset.get()))),this.track(E(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Ot(r)} — ${Al(r)}`}),i=new he({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Ot("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(_i,{chip:{textContent:()=>mc(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(us(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(_i,{chip:{textContent:()=>gc(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(us(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(Wf,{name:()=>i.name,count:()=>ee(i.roundCount,be),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(us(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return vs(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return $t(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Gt({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:Ft(t.totals)}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ee(e,be):`${$e(e,0)} of ${ee(t,be)}`}statusLine(){const e=this.svc.extendError.get();return e?`${S.extendProblemPrefix}${e.message}`:this.svc.extending.get()?S.extending:this.svc.budgetSpent()?S.budgetSpent:this.svc.loading.get()?S.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?S.windowEmpty:this.svc.loadedCount()===0?S.noStats:""}}function tm(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:Se(e)}function sm(s){const e=[mr(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${$e(s.holeCount,0)} holes`),e.join(" · ")}const nm=b(`
...
`),om=b('<li bind="text" class="roundstats__legenditem"></li>');function lm(){const s=[];for(const[e,t]of Object.entries(nn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
...
${tn}
    `;svc=this.inject(ut);auth=this.inject(D);router=this.inject(j);colors=ns;openHole=new p(null);infoOpen=new p(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(E(()=>{const o=e.get();X(()=>{this.openHole.set(null),o&&this.svc.load(o)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",d=this.wire(nm,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":Vn(t()),subtitle:()=>this.subtitle(),score:()=>{const o=t();return o===null?"":Or(o.strokes,o.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>Q.waterfallHeading,wfHint:()=>Q.waterfallHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:o=>{o.target===o.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>Q.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const o=this.selected();return o===null?"":cp(o)},detailEmpty:()=>{const o=this.selected();return o===null?"":ln(o).length===0?Q.nothingRecordedOnHole:""}});return this.setHeading(d,"stripSec",Q.holeStripHeading),this.$each(this.ref(d,"strip"),()=>t()?.cells??[],(o,c,u)=>this.wireEl(im,{cell:{className:()=>{const f=this.cellNow(o.id)??o;return f.marker===null?"cell":`cell cell--${f.marker}`},"aria-pressed":()=>String(this.openHole.get()===o.id),"aria-label":()=>ni(this.cellNow(o.id)??o),title:()=>ni(this.cellNow(o.id)??o),onclick:()=>this.openHole.set(this.openHole.get()===o.id?null:o.id)},hole:()=>String((this.cellNow(o.id)??o).holeNumber),score:()=>up(this.cellNow(o.id)??o),tee:{className:()=>(this.cellNow(o.id)??o).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const f=this.cellNow(o.id)??o;return f.tee===null?"":`background:${this.teeColor(f.tee)}`}},gir:{className:()=>{const f=this.cellNow(o.id)??o;return f.gir===null?"cell__gir cell__gir--absent":f.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const f=this.cellNow(o.id)??o;return f.putts===null?"":String(f.putts)},pen:{className:()=>yh(this.cellNow(o.id)??o)?"cell__pen":"cell__pen cell__pen--absent"}},u),o=>o.id),this.$each(this.ref(d,"detailLines"),()=>bp(this.selected()),(o,c,u)=>this.wireEl(rm,{label:()=>o.label,value:()=>o.value},u),o=>o.key),this.$each(this.ref(d,"deltas"),()=>{const o=t();return o===null?[]:de.filter(c=>Ve(o.waterfall,c)!==null)},(o,c,u)=>this.wireEl(am,{title:()=>Xt(o),sentence:()=>{const f=t();if(f===null||f.deltas===null)return"";const m=Ws(f.deltas,o);return m===null?"":Mr(m,f.windowCount)},value:{textContent:()=>{const f=this.componentValue(o);return f===null?"":Se(f)},style:()=>{const f=this.componentValue(o);return f===null?"":`color:${Ke(ts(f),this.colors)}`}},bar:{innerHTML:()=>{const f=t(),m=this.componentValue(o);return f===null||m===null?"":Er(m,hr([f.waterfall]),this.colors)}}},u),o=>o),this.$each(this.ref(d,"infoCards"),()=>{const o=t();return o===null?[]:Gt({attributed:o.waterfall.coverage.attributed,holesScored:o.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(c=>xe(o.waterfall,c)),penaltySource:Ft(o.panels.totals)})},(o,c,u)=>this.wireEl(es,{ctitle:()=>o.title,ctext:()=>o.body},u),o=>o.id),this.spawn(Fr,this.ref(d,"panels"),{model:()=>t()?.panels??ur}),this.$each(this.ref(d,"legend"),()=>[Q.legendTee,Q.legendGir,Q.legendPutts,Q.legendPenalty,Q.legendAbsence],(o,c,u)=>this.wireEl(om,{text:()=>o},u),o=>o),d}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Ve(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":dp({...e,title:Vn(e)})}stateLine(){if(this.auth.currentUser.get()===null)return Q.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return Q.loading;case"notFound":return Q.noStatsInRound;case"notAuthorized":return Q.notSignedIn;case"failed":return`${Q.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?Q.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const cm=b(`
    <div class="admin">
...
`),fm={not_started:"Not started",active:"Playing",complete:"Done"},mm={private:"Private",friends:"Friends",link:"Link"};function gm(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function bm(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class ym extends H{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Ji);auth=this.inject(D);router=this.inject(j);tab=new p("rounds");grantOpen=new p(!1);grantTarget=new p(null);mutating=new p(!1);denied=new k(()=>this.auth.currentUser.get()===null||!this.svc.isSuperAdmin());render(){this.svc.loadRoles().then(()=>{this.svc.isSuperAdmin()&&this.svc.load()});const e=this.wire(cm,{back:{onclick:()=>this.router.navigate("/")},denied:{className:()=>this.denied.get()?"admin__denied":"admin__denied hidden"},body:{className:()=>this.denied.get()?"admin__body hidden":"admin__body"},loading:{className:()=>this.svc.loading.get()?"admin__loading":"admin__loading hidden"},tabRounds:{className:()=>this.tab.get()==="rounds"?"active":"",onclick:()=>this.tab.set("rounds")},tabPlayers:{className:()=>this.tab.get()==="players"?"active":"",onclick:()=>this.tab.set("players")},roundList:{className:()=>this.tab.get()==="rounds"?"admin__list":"admin__list hidden"},playerList:{className:()=>this.tab.get()==="players"?"admin__list":"admin__list hidden"}}),t=new k(()=>{const n=this.svc.stats.get();return n?[{key:"rounds",label:"Rounds",value:n.rounds},{key:"active",label:"Playing",value:n.roundsActive},{key:"week",label:"Last 7d",value:n.roundsLast7Days},{key:"players",label:"Players",value:n.players},{key:"guests",label:"Guests",value:n.guests},{key:"scores",label:"Scores",value:n.scoreEvents}]:[]});return this.$each(this.ref(e,"stats"),t,(n,i,r)=>this.wireEl(um,{value:()=>String(n.value),label:()=>n.label},r),n=>n.key),this.$each(this.ref(e,"roundList"),this.svc.rounds,(n,i,r)=>this.wireEl(hm,{row:{disabled:()=>n.shareToken===null,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},course:()=>n.courseName??"Unknown course",visibility:()=>mm[n.visibility],status:()=>fm[n.status],who:()=>{const d=n.creatorName?`by ${n.creatorName}`:"by a guest",o=n.participants.join(", ");return o?`${d} — ${o}`:d},meta:()=>`${n.date} · ${gm(n)}`},r),n=>n.roundId),this.$each(this.ref(e,"playerList"),this.svc.players,(n,i,r)=>this.wireEl(pm,{name:()=>n.displayName,roleChip:()=>n.roles.includes("super_admin")?"admin":"",meta:()=>bm(n),toggle:{textContent:()=>n.roles.includes("super_admin")?"Revoke admin":"Make admin",disabled:()=>this.mutating.get(),onclick:()=>{this.grantTarget.set(n),this.grantOpen.set(!0)}}},r),n=>n.playerId),this.spawn(ie,this.ref(e,"confirmHost"),{open:this.grantOpen,title:()=>this.grantTarget.get()?.roles.includes("super_admin")?"Revoke admin?":"Make admin?",message:()=>{const n=this.grantTarget.get();return n?n.roles.includes("super_admin")?`Remove the super admin role from ${n.displayName}?`:`Give ${n.displayName} the super admin role? They will be able to see every player's rounds.`:""},confirmLabel:"Confirm",cancelLabel:"Cancel",onconfirm:()=>{const n=this.grantTarget.get();n&&this.toggleAdmin(n)}}),e}async toggleAdmin(e){this.mutating.set(!0);try{const t={playerId:e.playerId,role:"super_admin"};e.roles.includes("super_admin")?await _.admin.adminRevokeRole(t):await _.admin.adminGrantRole(t),await this.svc.load(!0)}finally{this.mutating.set(!1)}}}function _m(s,e){return s?e!==null&&s.ownerPlayerId===e?!0:s.rounds.some(t=>typeof t.shareToken=="string"):!1}class ze{list=new p([]);listLoading=new p(!1);listError=new p(null);listLoaded=new p(!1);detail=new p(null);detailId=new p(null);detailLoading=new p(!1);detailError=new p(null);participants=new p([]);board=new p(null);boardRefusal=new p(null);boardLoading=new p(!1);results=new p(null);resultsRefusal=new p(null);mutating=new p(!1);mutateError=new p(null);async loadList(e=!1){if(!e&&(this.listLoaded.get()||this.listLoading.get()))return;const t=await G(this.listLoading,this.listError,()=>_.competitions.list());t&&(this.list.set(t),this.listLoaded.set(!0))}async loadDetail(e,t=!1){if(!t&&this.detailId.get()===e&&this.detail.get()!==null&&!this.detailLoading.get()||this.detailLoading.get()&&this.detailId.get()===e)return;this.detailId.set(e);const n=await G(this.detailLoading,this.detailError,()=>Promise.all([_.competitions.get({id:e}),_.competitions.participants({competitionId:e})]));if(!n)return;const[i,r]=n;this.detailId.get()===e&&(this.detail.set(i),this.participants.set(r),await this.loadBoard(e),i.lifecycle==="finalized"&&await this.loadResults(e))}async loadBoard(e){this.boardLoading.set(!0);try{const t=await _.competitions.leaderboard({id:e});t.ok?(this.board.set(t.value),this.boardRefusal.set(null)):(this.board.set(null),this.boardRefusal.set(t.refusal.message))}catch{this.board.set(null),this.boardRefusal.set(null)}finally{this.boardLoading.set(!1)}}async loadResults(e){try{const t=await _.competitions.results({id:e});t.ok?(this.results.set(t.value),this.resultsRefusal.set(null)):(this.results.set(null),this.resultsRefusal.set(t.refusal.message))}catch{this.results.set(null)}}async create(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await _.competitions.create({name:e});return this.list.set([t,...this.list.get()]),t}catch(t){return this.mutateError.set(Ne(t)),null}finally{this.mutating.set(!1)}}transition(e,t){return this.mutate(()=>_.competitions.transition({id:e,to:t}),()=>this.loadDetail(e,!0))}updateConfig(e){return this.mutate(()=>_.competitions.update(e),()=>this.loadDetail(e.id,!0))}async addPlayer(e,t,n){return this.rosterMutate(e,()=>_.competitions.addParticipant({competitionId:e,playerId:t,category:n}))}async addGuest(e,t,n){this.mutating.set(!0),this.mutateError.set(null);let i;try{i=(await _.guestPlayers.create(t)).id}catch(r){return this.mutating.set(!1),this.mutateError.set(Ne(r)),Ne(r)}return this.mutating.set(!1),this.rosterMutate(e,()=>_.competitions.addParticipant({competitionId:e,guestPlayerId:i,category:n}))}removeParticipant(e,t){return this.rosterMutate(e,()=>_.competitions.removeParticipant({participantId:t}))}withdrawParticipant(e,t){return this.rosterMutate(e,()=>_.competitions.withdrawParticipant({participantId:t}))}async createRound(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await _.competitions.createRound(e);if(t.ok)return await this.loadDetail(e.id,!0),{ok:!0,shareToken:t.shareToken};const n="refusal"in t?t.refusal.message:t.diagnostics.map(i=>i.message).join(" · ");return this.mutateError.set(n),{ok:!1,message:n}}catch(t){const n=Ne(t);return this.mutateError.set(n),{ok:!1,message:n}}finally{this.mutating.set(!1)}}async applyCut(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await _.competitions.applyCut({id:e});return t.ok?(await this.loadDetail(e,!0),{ok:!0,outcome:t.value}):(this.mutateError.set(t.refusal.message),{ok:!1,message:t.refusal.message})}catch(t){const n=Ne(t);return this.mutateError.set(n),{ok:!1,message:n}}finally{this.mutating.set(!1)}}async finalize(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await _.competitions.finalize({id:e});return t.ok?(await this.loadDetail(e,!0),{ok:!0,outcome:t.value}):(this.mutateError.set(t.refusal.message),{ok:!1,message:t.refusal.message})}catch(t){const n=Ne(t);return this.mutateError.set(n),{ok:!1,message:n}}finally{this.mutating.set(!1)}}clear(){this.list.set([]),this.listLoaded.set(!1),this.detail.set(null),this.detailId.set(null),this.participants.set([]),this.board.set(null),this.boardRefusal.set(null),this.results.set(null),this.resultsRefusal.set(null),this.listError.set(null),this.detailError.set(null),this.mutateError.set(null)}async mutate(e,t){this.mutating.set(!0),this.mutateError.set(null);try{const n=await e();return n.ok?(await t(),null):(this.mutateError.set(n.refusal.message),n.refusal.message)}catch(n){const i=Ne(n);return this.mutateError.set(i),i}finally{this.mutating.set(!1)}}rosterMutate(e,t){return this.mutate(t,async()=>{const n=await _.competitions.participants({competitionId:e});this.participants.set(n)})}}function Ne(s){return s&&typeof s=="object"&&"message"in s&&typeof s.message=="string"?s.message:"Something went wrong. Try again."}function Gr(s){switch(s){case"draft":return"Draft";case"setup":return"Setup";case"active":return"Live";case"finalized":return"Finalized"}}function jr(s){return`comp-chip comp-chip--${s}`}function ks(s){switch(s){case"draft":return{to:"setup",label:"Open setup"};case"setup":return{to:"active",label:"Start competition"};default:return null}}function Ls(s){return s==="draft"||s==="setup"}function vm(s){return s==="setup"||s==="active"}const wm=b(`
    <div class="comps">
...
`);class $m extends H{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
            ...
            & .comps__create {
                ...
                gap: ${a("sm")};
                margin-bottom: ${a("md")};
                & input { ${ne()} flex: 1; padding: ${a("md")}; font-size: 1rem; }
                & button {
                    ${$()}
                    padding: ${a("md")} ${a("lg")};
                    font-family: inherit; font-size: 0.95rem; font-weight: 700;
...
`),Om=b('<button bind="chip" class="cd__friendchip" type="button"></button>');class Mm extends H{competitions=this.inject(ze);state=this.inject(ft);render(){const e=()=>this.state.id.get()??"",t=this.wire(Nm,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&Ls(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(Rm,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&Ls(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(Om,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(d=>d.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const Hm={not_started:"Not started",active:"Live",complete:"Finished"},Am=b(`
    <section class="cd__section">
...
`),zm=b('<option bind="option"></option>');class Bm extends H{competitions=this.inject(ze);state=this.inject(ft);router=this.inject(j);render(){const e=new k(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Am,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&vm(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(zm,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(Lm,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>Hm[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Fm(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function Gm(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const jm=b(`
    <div>
...
`),Dm=b('<button bind="button" type="button"></button>'),qm=b('<th bind="cell"></th>'),Vm=b('<tr bind="row"></tr>'),Um=b('<td bind="cell"><span bind="value"></span></td>'),Km=b(`
...
`);class Xm extends H{static styles=`
        .cd {
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${a("xs")};
                    ...
                    & input, & select { ${ne()} padding: ${a("sm")} ${a("md")}; font-size: 0.95rem; }
                }
            ...
            & .cd__official-banner {
                ${N()} padding: ${a("sm")} ${a("lg")}; margin-bottom: ${a("sm")};
                background: ${l("accent-soft")}; color: ${l("accent")};
    ...
    `;competitions=this.inject(ze);state=this.inject(ft);router=this.inject(j);render(){const e=()=>this.competitions.detail.get();this.track(E(()=>{const n=this.state.id.get();n&&X(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(Qm,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>Gr(this.state.lifecycle.get()),className:()=>jr(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&ks(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>ks(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=ks(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(Em,this.ref(t,"setup")),this.spawn(Mm,this.ref(t,"roster")),this.spawn(Bm,this.ref(t,"rounds")),this.spawn(Ym,this.ref(t,"results")),t}}const Jm=b(`
    <div class="app-shell">
...
`);class Zm extends H{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(j);render(){const e=this.wire(Jm,{header:{className:()=>Gs(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Ec,this.ref(e,"account")),this.spawn(go,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":An,"/history":Kc,"/round":Mp,"/create":df,"/login":mf,"/friends":_f,"/friend":wf,"/friend-rounds":$f,"/friend-courses":Tf,"/spectate":Nf,"/profile":Af,"/stats":em,"/round-stats":dm,"/admin":ym,...Li.competitions?{"/competitions":$m,"/competition":Xm}:{}},An),e}}class eg extends D{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Ar(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await cf()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await uf(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await hf();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}U.get(la);const vi=U.get(j);U.set(D,new eg);const wi=U.get(D);await ha(Zm,"#app",{hot:void 0,onInit:async()=>{await wi.load(),wi.currentUser.get()&&vi.route.get()==="/login"&&vi.navigate("/",!0)}});export{Ss as A,H as C,j as R,p as S,la as T,y as a,rt as b,k as c,Zr as d,E as e,Jr as n,G as r,b as t};
