(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const Bt="modulepreload",Gt=function(i){return"/tapscore/"+i},Fe={},qt=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let u=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");n=u(t.map(c=>{if(c=Gt(c),c in Fe)return;Fe[c]=!0;const m=c.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const f=document.createElement("link");if(f.rel=m?"stylesheet":Bt,m||(f.as="script"),f.crossOrigin="",f.href=c,d&&f.setAttribute("nonce",d),document.head.appendChild(f),m)return new Promise((x,v)=>{f.addEventListener("load",x),f.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return n.then(l=>{for(const d of l||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};class Kt{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){pt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const W=new Kt;function pt(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,W.notify(this.subs))}update(e){this.set(e(this.val))}}class y{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){W.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,W.notify(t.subs))})},deps:new Set};s.run()}get(){return W.subscribe(this.subs),this.val}peek(){return this.val}}function $(i){const e={run(){W.runTracked(e,i)},deps:new Set};return e.run(),()=>pt(e)}function ae(i){W.batch(i)}function V(i){return W.untrack(i)}class Vt{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const P=new Vt,ie="/tapscore/".replace(/\/+$/,"");function Se(i){return ie?i===ie?"/":i.startsWith(ie+"/")?i.slice(ie.length):i:i}function Wt(i){return ie+i}class N{constructor(){this.route=new h(Se(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>ae(()=>{this.route.set(Se(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",l=n>=0?e.slice(0,n):e,d=l.indexOf("?"),u=d>=0?l.slice(0,d):l,c=d>=0?l.slice(d+1):"",m=s.query!==void 0?Ut(s.query):c?"?"+c:"",p=Wt(u)+m+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),ae(()=>{this.route.set(u),this.search.set(m)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new y(()=>{const s=this.route.get().split("/"),n={};for(const[r,l]of t.entries())l.startsWith(":")&&(n[l.slice(1)]=s[r]??"");return n})}query(e){return new y(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new y(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Ut(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function Qt(i){return e=>i[e]}function Yt(i,e){const t=(n,r,l)=>{const d=Object.entries(n).map(([u,c])=>`--${u}:${c}`).join(";");return`${r}{color-scheme:${l};${d}}`},s=document.createElement("style");return s.textContent=t(i,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const Be="basics-js-theme";class Xt{constructor(){this.dark=new h(!1);const e=localStorage.getItem(Be),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),$(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(Be,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(i){const e=document.createElement("template");return e.innerHTML=i,e}function Jt(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const Ge=new Set;class I{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Ge.has(t)){Ge.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return P.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=V(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(l=>this.track(l)),r=e.content.cloneNode(!0);for(const l of r.querySelectorAll("[bind]")){const d=t[l.getAttribute("bind")];if(d)if(typeof d=="function")n($(()=>{const u=d();l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement?l.value=String(u):l.textContent=String(u)}));else for(const[u,c]of Object.entries(d)){const m=u.includes("-");u.startsWith("on")&&typeof c=="function"?l.addEventListener(u.slice(2),c):typeof c=="function"?n($(()=>{const p=c();m?l.setAttribute(u,String(p)):l[u]=p})):m?l.setAttribute(u,String(c)):l[u]=c}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof I?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,l,...d)=>this.spawn(r,l,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,l)=>l){const r=typeof t=="function"?t:()=>t.get(),l=new Map,d=new Map;this.track(()=>{for(const u of d.values())u.forEach(c=>c());d.clear()}),this.track($(()=>{const u=r(),c=new Map;for(const[p,f]of u.entries()){const x=n(f,p);if(l.has(x))c.set(x,l.get(x));else{const v=[];c.set(x,V(()=>s(f,p,k=>v.push(k)))),d.set(x,v)}}for(const[p,f]of l)c.has(p)||(f.remove(),d.get(p)?.forEach(x=>x()),d.delete(p));let m=e.firstChild;for(const p of c.values())p===m?m=m.nextSibling:e.insertBefore(p,m);l.clear();for(const[p,f]of c)l.set(p,f)}))}$condition(e,t,s,n){let r=null;this.track($(()=>{r&&(r.remove(),r=null);const l=t.get();r=V(()=>l?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track($(()=>{r&&(r.destroy(),r=null),e.textContent="";const l=t.get(),d=s[l]??Jt(l,s)??n;d&&(r=V(()=>{const u=new d;return u.mount(e),u}))})),this.track(()=>r?.destroy())}}async function Zt(i,e,t){const s=document.querySelector(e);s.textContent="";const n=P.get(N);let r=null,l=!1,d=null,u=!!t?.hot?.data.hmr;const c=async m=>{r&&(r.destroy(),r=null,s.textContent=""),m?(d||(d=(await qt(()=>import("./obs-shell.component-Bpb2bWKT.js"),[])).ObsShellComponent),r=V(()=>new d)):(!u&&t?.onInit&&(await t.onInit(),u=!0),r=V(()=>new i)),V(()=>r.mount(s)),l=m};await c(Se(location.pathname).startsWith("/_obs")),$(()=>{const m=n.route.get().startsWith("/_obs");m!==l&&c(m)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>r?.destroy()),t.hot.accept())}class F extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const es=10,me=[];let ge=[],re=null;function ts(i){me.push(i),me.length>es&&me.shift()}function ss(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...me],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),ge.push(s),ns()}function ns(){re||(re=setTimeout(mt,5e3))}function mt(){if(re&&(clearTimeout(re),re=null),ge.length===0)return;const i=ge;ge=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&mt()});const is=3e4,rs=2,ce=new Map,gt=new WeakMap;function os(i){if(i instanceof F)return i.traceId;if(i!=null&&typeof i=="object")return gt.get(i)}async function g(i){if(i.method==="GET"){const e=ce.get(i.url);if(e)return e;const t=qe(i,rs);return ce.set(i.url,t),t.then(()=>ce.delete(i.url),()=>ce.delete(i.url)),t}return qe(i,0)}async function qe(i,e){const t=i.timeout??is;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await ls(as(i,r),t)}catch(l){if(s=l,!(l instanceof F)&&l!=null&&typeof l=="object"&&gt.set(l,r),l instanceof F||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function as(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(ts({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const l=await n.json().catch(()=>({error:n.statusText}));throw new F(n.status,l.error??n.statusText,l.details,r)}return n.json()}function ls(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}async function C(i,e,t){ae(()=>{i.set(!0),e.set(null)});try{const s=await t();return i.set(!1),s}catch(s){const n=ds(s);ae(()=>{i.set(!1),e.set(n)}),ss(n.code,n.message,os(s));return}}function ds(i){return i instanceof F?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function cs(i){return{me:()=>g({method:"GET",url:`${i}/auth/me`}),login:e=>g({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>g({method:"POST",url:`${i}/auth/logout`,body:{}})}}class L{constructor(){this.api=cs("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await C(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await C(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await C(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Ke={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},o=Yt({...Ke,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...Ke,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),O=i=>`var(--${i})`,a=Qt({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),w=(i=O("radius"))=>`
...
`);class Ls extends I{static styles=`
        .tabbar {
            display: flex;
    ...
    `;let B=De;function Ds(i){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function $t(){return Ds()}class le{loading=new h(!1);error=new h(null);descriptors=new h([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await C(this.loading,this.error,()=>b.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=$t()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=this.byId(e);return!t||this.isSideFormat(e)?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function kt(i){const e=P.get(le);return e.load(),e.labelOf(i.formatId)??`${i.scoringMode} · ${i.teamShape}`}function Ms(i){return i.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:Is(e)||null,date:e.round.date,formats:e.round.formatSlots.map(kt).join(" · ")}))}function Hs(i){return i.map(e=>({key:e.token,token:e.token,roundId:null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:null,formats:null}))}const oe={fromMyRounds:Ms,fromDeviceRounds:Hs},As=14,Fs=1440*60*1e3;function se(i,e){return e(i)}function Bs(i,e,t,s=As){const n=e-s*Fs,r=[],l=[];for(const d of i){const u=se(d,t);if(u.status==="complete"){const c=u.completedAt?Date.parse(u.completedAt):NaN;(Number.isNaN(c)||c>=n)&&l.push(d)}else r.push(d)}return r.sort((d,u)=>Qe(se(d,t).lastActivityAt,se(u,t).lastActivityAt)),l.sort((d,u)=>Qe(se(d,t).completedAt,se(u,t).completedAt)),{ongoing:r,finished:l}}function Qe(i,e){const t=i?Date.parse(i):NaN,s=e?Date.parse(e):NaN,n=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return n===r?0:r-n}const Gs=_(`
    <div class="landing">
...
`),qs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Ks=_(`
    <div class="round-row">
...
`),Us='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Qs=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="course" class="round-row__course"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Us}</button>
    </div>
`);class Ys extends I{static styles=`
        .history {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class pn extends I{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
...
</div>`}function En(i,e){const t=i.matches.map(s=>{const n=S(s.sideA.ballIds.map(e).join(" & ")),r=S(s.sideB.ballIds.map(e).join(" & ")),l=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,u=s.leader==="a"?" lb-mp__team--lead":"",c=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Nn={ranked:Tn,match_summary:(i,e)=>En(i,e)},Pn={"default-score-grid":wn,"compact-match-grid":xn,"category-matrix-grid":$n};function zn(i){return i.componentId??"default-score-grid"}function Rn(i){return`<div class="lb-diag">Unrenderable result section <code>${S(i)}</code> — no generic view yet. Results are not hidden.</div>`}function jn(i){return`<div class="lb-diag">Unsupported score-grid component <code>${S(i)}</code> — no generic view yet. Results are not hidden.</div>`}function On(i,e,t){const s=Nn[i.kind];return s?s(i,e,t):Rn(i.kind)}function Ln(i,e,t,s){const n=zn(i),r=Pn[n];return r?r(i,e,t,s):jn(n)}function Dn(i,e,t=Ct){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${S(i.formatLabel)}.</div>`:i.leaderboard.map(n=>On(n,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${S(i.formatLabel)}.</div>`}function Mn(i,e,t,s={}){if(i.cards.length===0)return"";const n=s.mode??"product";return i.cards.map(r=>Ln(r,e,t,{mode:n})).join(`
`)}const Hn=_(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class An extends I{static styles=`
        .lb {
    ...
    `;svc=this.inject(Z);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(Hn,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=u=>{const c=this.svc.nameOf(u);return this.svc.isPending(u)?`${c} (open seat)`:c},r=Dn(t,s,u=>this.svc.groupLabelOf(u)),l=Mn(t,e.routeSections,s),d=l?`<h3 class="lb-cards__head">Scorecard</h3>${l}`:"";return r+d}}function Fn(i,e){if(!e)return[];const t=[],s=new Set;for(const n of i)for(const r of n.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Bn=_(`
...
`);class si extends I{static styles=`
    ...
    `;svc=this.inject(Z);auth=this.inject(L);router=this.inject(N);tokenQ=this.router.query("token");joining=new h(!1);error=new h("");diagnostics=new h([]);teeId=new h("");tees=new h([]);loadedForCourseId=null;groupChoice=new h("");policyState(){return Zn(this.svc.startList.get())}eligible(){return this.policyState().visible&&Jn(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,b.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),n=await b.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});n.ok?await this.svc.loadByToken(e):this.diagnostics.set(n.diagnostics)}catch(s){this.error.set(s instanceof F&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track($(()=>this.ensureTeesLoaded()));const e=new y(()=>ei(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track($(()=>{const r=e.get(),l=this.groupChoice.get();(!l||!r.options.some(d=>d.value===l&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(ti,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new G({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const n=new G({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return n.mount(this.ref(t,"groupHost")),this.track(()=>n.destroy()),t}}const ni=_(`
...
`);class ii extends I{static styles=`
    ...
    `;router=this.inject(N);tokenQ=this.router.query("token");editable=new h(!1);render(){const e=this.tokenQ.get();return e&&b.friendlyRounds.setup({token:e}).then(t=>this.editable.set(t.editable===!0)).catch(()=>this.editable.set(!1)),this.wire(ni,{root:{className:()=>this.editable.get()?"edit-card":"edit-card hidden"},edit:{onclick:()=>{const t=this.tokenQ.get();t&&this.router.navigate("/create",{query:{token:t}})}}})}}function ri(i,e){if(!e)return!1;for(const t of i)for(const s of t.players)if(s.playerId===e)return!0;return!1}const oi=_(`
...
`);class ai extends I{static styles=`
        .leave-card {
...
`),hi=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),pi=_('<button bind="pill" class="round-view__grp" type="button"></button>');class mi extends I{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Wi extends I{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`);function ct(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Xi extends I{static styles=`
        .friends {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class rr extends I{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),vr=_('<option bind="option"></option>');class wr extends I{competitions=this.inject(ee);state=this.inject(de);router=this.inject(N);render(){const e=new y(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(_r,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&sr(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,r)=>this.wireEl(vr,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,r)=>this.wireEl(yr,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>br[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function xr(i,e,t){return JSON.stringify({entry:i,points:e,columns:t})}function $r(i){return i.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const kr=_(`
    <div>
...
`),Sr=_('<button bind="button" type="button"></button>'),Ir=_('<th bind="cell"></th>'),Cr=_('<tr bind="row"></tr>'),Tr=_('<td bind="cell"><span bind="value"></span></td>'),Er=_(`
...
`);class Or extends I{static styles=`
    ...
    `;router=this.inject(N);render(){const e=this.wire(jr,{});return this.spawn(Ls,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Ye,"/history":Ys,"/round":mi,"/create":Gi,"/login":Wi,"/friends":Xi,"/profile":er,...xt.competitions?{"/competitions":rr,"/competition":Rr}:{}},Ye),e}}P.get(Xt);const ut=P.get(N),ht=P.get(L);await Zt(Or,"#app",{hot:void 0,onInit:async()=>{await ht.load(),ht.currentUser.get()&&ut.route.get()==="/login"&&ut.navigate("/",!0)}});export{I as C,N as R,h as S,Xt as T,g as a,ae as b,y as c,$ as e,C as r,_ as t};
