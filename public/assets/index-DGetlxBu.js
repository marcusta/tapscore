(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))s(r);new MutationObserver(r=>{for(const n of r)if(n.type==="childList")for(const i of n.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&s(i)}).observe(document,{childList:!0,subtree:!0});function t(r){const n={};return r.integrity&&(n.integrity=r.integrity),r.referrerPolicy&&(n.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?n.credentials="include":r.crossOrigin==="anonymous"?n.credentials="omit":n.credentials="same-origin",n}function s(r){if(r.ep)return;r.ep=!0;const n=t(r);fetch(r.href,n)}})();const Le="modulepreload",Be=function(o){return"/tapscore/"+o},me={},Fe=function(e,t,s){let r=Promise.resolve();if(t&&t.length>0){let d=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),c=i?.nonce||i?.getAttribute("nonce");r=d(t.map(u=>{if(u=Be(u),u in me)return;me[u]=!0;const p=u.endsWith(".css"),f=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const g=document.createElement("link");if(g.rel=p?"stylesheet":Le,p||(g.as="script"),g.crossOrigin="",g.href=u,c&&g.setAttribute("nonce",c),document.head.appendChild(g),p)return new Promise((w,N)=>{g.addEventListener("load",w),g.addEventListener("error",()=>N(new Error(`Unable to preload CSS for ${u}`)))})}))}function n(i){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=i,window.dispatchEvent(c),!c.defaultPrevented)throw i}return r.then(i=>{for(const c of i||[])c.status==="rejected"&&n(c.reason);return e().catch(n)})};class Ae{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){Ie(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const H=new Ae;function Ie(o){for(const e of o.deps)e.delete(o);o.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return H.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,H.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){H.runTracked(s,()=>{const r=e();Object.is(t.val,r)||(t.val=r,H.notify(t.subs))})},deps:new Set};s.run()}get(){return H.subscribe(this.subs),this.val}peek(){return this.val}}function _(o){const e={run(){H.runTracked(e,o)},deps:new Set};return e.run(),()=>Ie(e)}function U(o){H.batch(o)}function A(o){return H.untrack(o)}class qe{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const O=new qe,K="/tapscore/".replace(/\/+$/,"");function ne(o){return K?o===K?"/":o.startsWith(K+"/")?o.slice(K.length):o:o}function De(o){return K+o}class j{constructor(){this.route=new h(ne(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>U(()=>{this.route.set(ne(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},r=e.indexOf("#"),n=r>=0?e.slice(r):"",i=r>=0?e.slice(0,r):e,c=i.indexOf("?"),d=c>=0?i.slice(0,c):i,u=c>=0?i.slice(c+1):"",p=s.query!==void 0?Ge(s.query):u?"?"+u:"",f=De(d)+p+n;(s.replace?history.replaceState:history.pushState).call(history,null,"",f),U(()=>{this.route.set(d),this.search.set(p)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:r=>{r.preventDefault(),this.navigate(e)},className:()=>{const r=this.route.get();return r===s||r.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const s=this.route.get().split("/"),r={};for(const[n,i]of t.entries())i.startsWith(":")&&(r[i.slice(1)]=s[n]??"");return r})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Ge(o){const e=new URLSearchParams;for(const[s,r]of Object.entries(o))r==null||r===""||e.set(s,String(r));const t=e.toString();return t?"?"+t:""}function Ke(o){return e=>o[e]}function We(o,e){const t=(r,n,i)=>{const c=Object.entries(r).map(([d,u])=>`--${d}:${u}`).join(";");return`${n}{color-scheme:${i};${c}}`},s=document.createElement("style");return s.textContent=t(o,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),r=>`var(--${r})`}const fe="basics-js-theme";class Ue{constructor(){this.dark=new h(!1);const e=localStorage.getItem(fe),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),_(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(fe,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(o){const e=document.createElement("template");return e.innerHTML=o,e}function Qe(o,e){let t;for(const s of Object.keys(e))o.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const ge=new Set;class E{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!ge.has(t)){ge.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return O.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const r=A(()=>{const n=new e(s[0]);return n.mount(t),n});return this.children.push(r),r}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const r=s??(i=>this.track(i)),n=e.content.cloneNode(!0);for(const i of n.querySelectorAll("[bind]")){const c=t[i.getAttribute("bind")];if(c)if(typeof c=="function")r(_(()=>{const d=c();i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value=String(d):i.textContent=String(d)}));else for(const[d,u]of Object.entries(c)){const p=d.includes("-");d.startsWith("on")&&typeof u=="function"?i.addEventListener(d.slice(2),u):typeof u=="function"?r(_(()=>{const f=u();p?i.setAttribute(d,String(f)):i[d]=f})):p?i.setAttribute(d,String(u)):i[d]=u}}return n}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const r=this.ref(t,e);return r?(typeof s=="string"?r.textContent=s:typeof s=="function"&&s.prototype instanceof E?this.spawn(s,r):typeof s=="function"&&s(r,{spawn:(n,i,...c)=>this.spawn(n,i,...c),track:n=>this.track(n)}),!0):!1}$each(e,t,s,r=(n,i)=>i){const n=typeof t=="function"?t:()=>t.get(),i=new Map,c=new Map;this.track(()=>{for(const d of c.values())d.forEach(u=>u());c.clear()}),this.track(_(()=>{const d=n(),u=new Map;for(const[f,g]of d.entries()){const w=r(g,f);if(i.has(w))u.set(w,i.get(w));else{const N=[];u.set(w,A(()=>s(g,f,k=>N.push(k)))),c.set(w,N)}}for(const[f,g]of i)u.has(f)||(g.remove(),c.get(f)?.forEach(w=>w()),c.delete(f));let p=e.firstChild;for(const f of u.values())f===p?p=p.nextSibling:e.insertBefore(f,p);i.clear();for(const[f,g]of u)i.set(f,g)}))}$condition(e,t,s,r){let n=null;this.track(_(()=>{n&&(n.remove(),n=null);const i=t.get();n=A(()=>i?s():r?.()??null),n&&e.appendChild(n)}))}$swap(e,t,s,r){let n=null;this.track(_(()=>{n&&(n.destroy(),n=null),e.textContent="";const i=t.get(),c=s[i]??Qe(i,s)??r;c&&(n=A(()=>{const d=new c;return d.mount(e),d}))})),this.track(()=>n?.destroy())}}async function Xe(o,e,t){const s=document.querySelector(e);s.textContent="";const r=O.get(j);let n=null,i=!1,c=null,d=!!t?.hot?.data.hmr;const u=async p=>{n&&(n.destroy(),n=null,s.textContent=""),p?(c||(c=(await Fe(()=>import("./obs-shell.component-CErPLeWN.js"),[])).ObsShellComponent),n=A(()=>new c)):(!d&&t?.onInit&&(await t.onInit(),d=!0),n=A(()=>new o)),A(()=>n.mount(s)),i=p};await u(ne(location.pathname).startsWith("/_obs")),_(()=>{const p=r.route.get().startsWith("/_obs");p!==i&&u(p)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>n?.destroy()),t.hot.accept())}class G extends Error{constructor(e,t,s,r){super(t),this.status=e,this.details=s,this.traceId=r,this.name="ApiError"}}const Ve=10,V=[];let Y=[],W=null;function Ye(o){V.push(o),V.length>Ve&&V.shift()}function Ze(o,e,t){const s={code:o,message:e,url:typeof location<"u"?location.href:"",context:[...V],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Y.push(s),Je()}function Je(){W||(W=setTimeout(Te,5e3))}function Te(){if(W&&(clearTimeout(W),W=null),Y.length===0)return;const o=Y;Y=[];for(const e of o){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Te()});const et=3e4,tt=2,Q=new Map,Ee=new WeakMap;function st(o){if(o instanceof G)return o.traceId;if(o!=null&&typeof o=="object")return Ee.get(o)}async function m(o){if(o.method==="GET"){const e=Q.get(o.url);if(e)return e;const t=be(o,tt);return Q.set(o.url,t),t.then(()=>Q.delete(o.url),()=>Q.delete(o.url)),t}return be(o,0)}async function be(o,e){const t=o.timeout??et;let s;for(let r=0;r<=e;r++){const n=crypto.randomUUID();try{return await rt(nt(o,n),t)}catch(i){if(s=i,!(i instanceof G)&&i!=null&&typeof i=="object"&&Ee.set(i,n),i instanceof G||r===e)break;await new Promise(c=>setTimeout(c,1e3*2**r))}}throw s}async function nt(o,e){const t={"X-Trace-Id":e},s={method:o.method,headers:t};o.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(o.body));const r=await fetch(o.url,s),n=r.headers.get("x-trace-id")??e;if(Ye({type:"api",detail:`${o.method} ${o.url}`,timestamp:new Date().toISOString()}),!r.ok){const i=await r.json().catch(()=>({error:r.statusText}));throw new G(r.status,i.error??r.statusText,i.details,n)}return r.json()}function rt(o,e){let t;const s=new Promise((r,n)=>{t=setTimeout(()=>n(new Error("Request timeout")),e)});return Promise.race([o,s]).finally(()=>clearTimeout(t))}async function x(o,e,t){U(()=>{o.set(!0),e.set(null)});try{const s=await t();return o.set(!1),s}catch(s){const r=ot(s);U(()=>{o.set(!1),e.set(r)}),Ze(r.code,r.message,st(s));return}}function ot(o){return o instanceof G?o.status===401?{code:"auth",message:"Unauthorized"}:o.status===409?{code:"conflict",message:"Data has changed — please try again"}:o.status===400?{code:"validation",message:o.message}:{code:"server",message:"Server error"}:o instanceof Error?o.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function it(o){return{me:()=>m({method:"GET",url:`${o}/auth/me`}),login:e=>m({method:"POST",url:`${o}/auth/login`,body:e}),logout:()=>m({method:"POST",url:`${o}/auth/logout`,body:{}})}}class ie{constructor(){this.api=it("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await x(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await x(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await x(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const ye={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},a=We({...ye,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...ye,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),T=o=>`var(--${o})`,l=Ke({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),S=(o=T("radius"))=>`
...
`);class lt extends E{static styles=`
        .tabbar {
            display: flex;
...
`),St={not_started:"Not started",active:"Live",complete:"Done"};class _e extends E{static styles=`
        .landing {
    ...
    `;svc=this.inject(xt);router=this.inject(j);render(){this.svc.load();const e=this.wire($t,{createBtn:{onclick:()=>this.router.navigate("/create")},signin:{onclick:()=>this.router.navigate("/login")},count:()=>{const t=this.svc.rounds.get().length;return t===0?"":`${t} on the card`},empty:{className:()=>this.svc.rounds.get().length===0?"landing__empty":"landing__empty hidden"}});return this.$each(this.ref(e,"list"),this.svc.rounds,(t,s,r)=>this.wireEl(kt,{row:{onclick:()=>this.router.navigate("/round",{query:{token:t.friendlyRound.shareToken}})},course:()=>t.round.courseNameSnapshot??"Round",status:{textContent:()=>St[t.round.status]??t.round.status,className:()=>`round-row__status s-${t.round.status}`},date:()=>t.round.date,formats:()=>t.round.formatSlots.map(ae).join(" · ")},r),t=>t.friendlyRound.id),e}}const It=180,ve=4,Tt=12;function D(o,e){return e<=0?0:Math.max(0,Math.min(e-1,o))}function Et(o){const{dragDistance:e,velocity:t,itemWidth:s}=o;if(Math.abs(e)<Tt)return 0;const r=e+t*It,n=Math.round(-r/s);return Math.max(-ve,Math.min(ve,n))}const Pt=["1st","2nd","3rd","4th","5th","6th","7th","8th"],q=(o,e)=>`${o}|${e}`;function Pe(o){return o.players.map(e=>e.displayName).join(" & ")||o.label||"Ball"}function Ct(o,e,t){return o?!(o.minPar!==void 0&&e<o.minPar||o.maxPar!==void 0&&e>o.maxPar||o.pars&&!o.pars.includes(e)||o.holes&&!o.holes.includes(t)):!0}class le{loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);holeIdx=new h(0);groupIdx=new h(0);selectedSlot=new h(0);token=null;loadSeq=0;resultSeq=0;async loadByToken(e,t){const s=e!==this.token;this.token=e;const r=++this.loadSeq;s&&this.resetForNewToken(t),O.get(Z).load();const n=await x(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!n||r!==this.loadSeq||e!==this.token)return;this.friendlyRound.set(n.friendlyRound),this.round.set(n.round);const[i,c]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[])]);r!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(c),this.balls.set(i))}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await x(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&this.result.set(s)}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Pe(t));return e});nameOf(e){return this.ballNameById.get().get(e)??e}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return D(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(i=>i.id===e);if(!t||!s)return"";const r=t.playHoles.filter(i=>i.courseHoleNumber===s.courseHoleNumber).sort((i,c)=>i.ordinal-c.ordinal);if(r.length===1)return`${s.courseHoleNumber}`;const n=r.findIndex(i=>i.id===e);return`${s.courseHoleNumber} (${Pt[n]??`${n+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(D(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(D(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(q(e,t));return s?s.strokes:this.scorecards.get().find(i=>i.ballId===e)?.holes.find(i=>i.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(q(e,t))?.status??null}metadataFor(e,t,s){const r=this.cells.get().get(q(e,t));return r&&r.metadata!==void 0?r.metadata?.[s]:this.scorecards.get().find(c=>c.ballId===e)?.holes.find(c=>c.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=O.get(Z),t=this.round.get()?.formatSlots??[],s=[],r=new Set;for(const n of t){const i=e.byId(n.formatId)?.requirements.scoreEntry?.metadata??[];for(const c of i)r.has(c.key)||(r.add(c.key),s.push(c))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Ct(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,r){const n=q(e,t),i=crypto.randomUUID();this.patchCell(n,{strokes:s,metadata:r,status:"saving",clientEventId:i}),await this.post(e,t,s,r,i)}async retry(e,t){const s=q(e,t),r=this.cells.get().get(s);r&&(this.patchCell(s,{...r,status:"saving"}),await this.post(e,t,r.strokes,r.metadata,r.clientEventId))}async post(e,t,s,r,n){if(!this.token)return;const i=q(e,t);try{await v.friendlyRounds.score({token:this.token,ballId:e,playHoleId:t,strokes:s,eventType:s===null?"score_cleared":"score_entered",clientEventId:n,...r!=null?{metadata:r}:{}});const c=this.cells.get().get(i);c&&c.clientEventId===n&&this.patchCell(i,{...c,status:"saved"});const d=this.round.get();d&&d.status==="not_started"&&this.round.set({...d,status:"active"})}catch{const c=this.cells.get().get(i);c&&c.clientEventId===n&&this.patchCell(i,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.friendlyRound.set(null),this.round.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.selectedSlot.set(e?.selectedSlot??0)}}const B=60,we=8,re=4,zt=Array.from({length:re*2+1},(o,e)=>e-re),jt="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Ot=b(`
...
`),Mt=b('<button bind="chip" class="se-chip" type="button"></button>');class Lt extends E{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${we}px; flex-shrink: 0; }
...
</div>`}function Xt(o,e){const t=o.matches.map(s=>{const r=y(s.sideA.ballIds.map(e).join(" & ")),n=y(s.sideB.ballIds.map(e).join(" & ")),i=s.magnitude===0?"AS":`${s.magnitude} UP`,c=s.finished?"Final":`thru ${s.thru}`,d=s.leader==="a"?" lb-mp__team--lead":"",u=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Vt={ranked:Qt,match_summary:Xt},Yt={"default-score-grid":Kt,"compact-match-grid":Wt,"category-matrix-grid":Ut};function Zt(o){return o.componentId??"default-score-grid"}function Jt(o){return`<div class="lb-diag">Unrenderable result section <code>${y(o)}</code> — no generic view yet. Results are not hidden.</div>`}function es(o){return`<div class="lb-diag">Unsupported score-grid component <code>${y(o)}</code> — no generic view yet. Results are not hidden.</div>`}function ts(o,e){const t=Vt[o.kind];return t?t(o,e):Jt(o.kind)}function ss(o,e,t,s){const r=Zt(o),n=Yt[r];return n?n(o,e,t,s):es(r)}function ns(o,e){return o.leaderboard.length===0&&o.cards.length===0?`<div class="lb-empty">No scores entered yet for ${y(o.formatLabel)}.</div>`:o.leaderboard.map(s=>ts(s,e)).join("")||`<div class="lb-empty">No leaderboard metric for ${y(o.formatLabel)}.</div>`}function rs(o,e,t,s={}){if(o.cards.length===0)return"";const r=s.mode??"product";return o.cards.map(n=>ss(n,e,t,{mode:r})).join(`
`)}const os=b(`
...
`),ls=b('<button bind="pill" class="round-view__fmt" type="button"></button>');class cs extends E{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class ws extends E{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .player {
                ...
                & .player__name { flex: 1; padding: ${l("md")}; font-size: 1rem; ${R()} }
                & .player__remove {
                ...
                & .player__index { flex: 1; min-width: 0; padding: ${l("md")}; font-size: 1rem; ${R()} }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { width: 56px; padding: ${l("xs")} ${l("sm")}; ${R()} font-size: 0.95rem; }
                    }
                }
                ...
                & .fslot__flat {
                    ...
                    color: ${a("text-muted")};
                    &[hidden] { display: none; }
                    & .fslot__pct { width: 70px; padding: ${l("sm")}; font-size: 1rem; ${R()} }
                }
                & .fslot__bands {
                    display: flex; flex-direction: column; gap: ${l("xs")};
                    &[hidden] { display: none; }
                ...
                & .brow {
                    ...
                    & .brow__pct, & .brow__upto { width: 56px; padding: ${l("sm")}; font-size: 0.95rem; ${R()} }
...
`);class $s extends E{static styles=`
    ...
    `;auth=this.inject(ie);router=this.inject(j);username="";password="";render(){return this.wire(xs,{root:{inert:()=>this.auth.loading.get()},error:{className:()=>this.auth.error.get()?"error show":"error",textContent:()=>this.auth.error.get()?.message??""},form:{onsubmit:async e=>{e.preventDefault(),await this.auth.login(this.username,this.password)&&this.router.navigate("/rounds",!0)}},username:{oninput:e=>{this.username=e.target.value}},password:{oninput:e=>{this.password=e.target.value}},submit:{textContent:()=>this.auth.loading.get()?"Signing in…":"Sign in"}})}}class ks{loading=new h(!1);error=new h(null);guests=new h([]);async load(){const e=await x(this.loading,this.error,()=>v.guestPlayers.list());e&&this.guests.set(e)}async create(e){const t=await x(this.loading,this.error,()=>v.guestPlayers.create(e));return t&&this.guests.update(s=>[...s,t]),t??null}}const Ss=b(`
    <div class="players">
...
`);function Ts(o){return o.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Es extends E{static styles=`
        .players {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class js extends E{static styles=`
    ...
    `;svc=this.inject(Ps);router=this.inject(j);render(){this.svc.load();const e=this.wire(Cs,{subtitle:()=>{const s=this.svc.rounds.get().length;return s===0?"No rounds yet — tee one up.":`${s} round${s===1?"":"s"} on the card.`},newBtn:{onclick:()=>this.router.navigate("/create")}}),t={not_started:"Not started",active:"Live",complete:"Done"};return this.$each(this.ref(e,"list"),this.svc.rounds,(s,r,n)=>this.wireEl(zs,{row:{onclick:()=>this.router.navigate("/score",{query:{roundId:s.id}})},course:()=>s.courseNameSnapshot??"Round",status:{textContent:()=>t[s.status]??s.status,className:()=>`round-row__status s-${s.status}`},date:()=>s.date,formats:()=>s.formatSlots.map(ae).join(" · ")},n),s=>s.id),e}}class Os{loading=new h(!1);error=new h(null);roundId=new h(null);round=new h(null);course=new h(null);balls=new h([]);strokes=new h(new Map);holes=new $(()=>this.course.get()?.holes??[]);playHoleIdByCourseHole=new $(()=>{const e=new Map;for(const t of this.round.get()?.playHoles??[])e.has(t.courseHoleNumber)||e.set(t.courseHoleNumber,t.id);return e});async load(e){if(this.roundId.get()===e&&this.round.get())return;this.roundId.set(e);const t=await x(this.loading,this.error,()=>v.rounds.get({id:e}));if(!t)return;this.round.set(t);const[s,r,n]=await Promise.all([x(this.loading,this.error,()=>v.courses.get({id:t.courseId})),x(this.loading,this.error,()=>v.rounds.balls({roundId:e})),x(this.loading,this.error,()=>v.scorecards.forRound({roundId:e}))]);if(s&&this.course.set(s),r&&this.balls.set(r),n){const i=new Map;for(const c of n)for(const d of c.holes)i.set(`${c.ballId} ${d.holeNumber}`,d.strokes);this.strokes.set(i)}}strokesFor(e,t){return this.strokes.get().get(`${e} ${t}`)??null}async setStrokes(e,t,s){const r=this.roundId.get();if(!r)return;const n=this.playHoleIdByCourseHole.get().get(t);if(!n)return;this.strokes.update(c=>new Map(c).set(`${e.id} ${t}`,s));const i=e.players.length===1?e.players[0]:null;await x(this.loading,this.error,()=>v.scoreEvents.append({roundId:r,ballId:e.id,playHoleId:n,strokes:s,eventType:s===null?"score_cleared":"score_entered",clientEventId:crypto.randomUUID(),sourcePlayerId:i?.playerId??null,sourceGuestPlayerId:i?.guestPlayerId??null}))}}const Ns=b(`
    <div class="score">
...
`),Rs=b('<button bind="dot" type="button" class="score-dot"></button>'),Hs=b(`
    <div class="ball-row">
...
`),Fs=b('<div bind="row" class="results-slot"></div>');class As extends E{static styles=`
        .results {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class Ds extends E{static styles=`
    ...
    `;router=this.inject(j);render(){const e=this.wire(qs,{});return this.spawn(lt,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":_e,"/round":cs,"/create":ws,"/login":$s,"/rounds":js,"/players":Es,"/score":Ms,"/results":As},_e),e}}O.get(Ue);const ke=O.get(j),Se=O.get(ie);await Xe(Ds,"#app",{hot:void 0,onInit:async()=>{await Se.load(),Se.currentUser.get()&&ke.route.get()==="/login"&&ke.navigate("/",!0)}});export{E as C,j as R,h as S,Ue as T,m as a,U as b,$ as c,_ as e,x as r,b as t};
