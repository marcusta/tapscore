...
</tr>`;const A=tt(s.plan.slotDefId,j.ballIds),F=s.isOpen(A),J=sa(A),Ls=Ns(I,s.routeSections,e,{mode:s.mode??"product"}),Ae=["lb-rank__row--expandable"];return b.lead&&Ae.push("lb-rank__lead"),F&&Ae.push("lb-rank__row--open"),`<tr class="${Ae.join(" ")}" data-expand-key="${P(A)}">
  <td class="lb-rank__pos">${b.position}</td>
