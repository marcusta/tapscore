(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const gr="modulepreload",br=function(s){return"/tapscore/"+s},Gs={},_r=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),l=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=br(u),u in Gs)return;Gs[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":gr,f||(h.as="script"),h.crossOrigin="",h.href=u,l&&h.setAttribute("nonce",l),document.head.appendChild(h),f)return new Promise((g,y)=>{h.addEventListener("load",g),h.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=d,window.dispatchEvent(l),!l.defaultPrevented)throw d}return i.then(d=>{for(const l of d||[])l.status==="rejected"&&r(l.reason);return e().catch(r)})},Xn="/tapscore/".replace(/\/+$/,""),os=Xn+"/api",Ct={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},yr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Jn(s,e){const t={};for(const[n,i]of yr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Zn=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],vr={thin:"1px",medium:"3px",thick:"5px"};function ei(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":vr[e.toLowerCase()]??e}function wr(){return Zn.map(s=>{const e=ei(Ct[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const ti={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},si={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},xr={...si,"done-opacity":"0.35"},$r={...ti,...si,...Ct,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},kr={...ti,...xr,...Ct,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Sr{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;ni(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const _e=new Sr;function ni(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return _e.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,_e.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){_e.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,_e.notify(t.subs))})},deps:new Set};n.run()}get(){return _e.subscribe(this.subs),this.val}peek(){return this.val}}function P(s){const e={run(){_e.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,ni(e)}}function st(s){_e.batch(s)}function Y(s){return _e.untrack(s)}class Tr{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const V=new Tr,Ve=Xn;function ls(s){return Ve?s===Ve?"/":s.startsWith(Ve+"/")?s.slice(Ve.length):s:s}function Pr(s){return Ve+s}class B{constructor(){this.route=new p(ls(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>st(()=>{this.route.set(ls(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,l=d.indexOf("?"),c=l>=0?d.slice(0,l):d,u=l>=0?d.slice(l+1):"",f=n.query!==void 0?Ir(n.query):u?"?"+u:"",m=Pr(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),st(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Ir(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function Cr(s){return e=>s[e]}const Er="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",qs="data-basics-global";function Nr(){if(document.head.querySelector(`style[${qs}]`))return;const s=document.createElement("style");s.setAttribute(qs,""),s.textContent=wr()+Er,document.head.appendChild(s)}function Rr(s,e){Nr();const t=new Set(Zn),n=(r,d,l)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?ei(f):f}`).join(";");return`${d}{color-scheme:${l};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const Vs="basics-js-theme";class Or{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Vs),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),P(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(Vs,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function zr(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Us=new Set;class R{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Us.has(t)){Us.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return V.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=Y(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){Y(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const l=t[d.getAttribute("bind")];if(l)if(typeof l=="function")i(P(()=>{const c=l();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(l)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(P(()=>{const m=u();f?d.setAttribute(c,String(m)):d[c]=m})):f?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof R?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...l)=>this.spawn(r,d,...l),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,l=new Map;this.track(()=>{for(const c of l.values())c.forEach(u=>u());l.clear()}),this.track(P(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(d.has(g))u.set(g,d.get(g));else{const y=[];u.set(g,Y(()=>n(h,m,w=>y.push(w)))),l.set(g,y)}}for(const[m,h]of d)u.has(m)||(h.remove(),Y(()=>l.get(m)?.forEach(g=>g())),l.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(P(()=>{r&&(r.remove(),r=null);const d=t.get();r=Y(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(P(()=>{if(r){const c=r;r=null,Y(()=>c.destroy())}e.textContent="";const d=t.get(),l=n[d]??zr(d,n)??i;l&&(r=Y(()=>{const c=new l;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const wt=new Set;function Hr(s){return wt.add(s),()=>wt.delete(s)}function Ar(){for(const s of Array.from(wt)){wt.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Lr(s,e,t){const n=document.querySelector(e);n.textContent="";const i=V.get(B);let r=null,d=!1,l=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(l||(l=(await _r(()=>import("./obs-shell.component-D8AS0l22.js"),[])).ObsShellComponent),r=Y(()=>new l)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=Y(()=>new s)),Y(()=>r.mount(n)),d=f};await u(ls(location.pathname).startsWith("/_obs")),P(()=>{const f=i.route.get().startsWith("/_obs");f!==d&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Ar(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class U extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const Mr=10,_t=[];let yt=[],Xe=null;function Fr(s){_t.push(s),_t.length>Mr&&_t.shift()}function ii(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[..._t],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),yt.push(n),Br()}function Br(){Xe||(Xe=setTimeout(ri,5e3))}function ri(){if(Xe&&(clearTimeout(Xe),Xe=null),yt.length===0)return;const s=yt;yt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${os}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${os}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ri()});const jr=3e4,Dr=2,dt=new Map,ai=new WeakMap;function Gr(s){if(s instanceof U)return s.traceId;if(s!=null&&typeof s=="object")return ai.get(s)}async function _(s){if(s.method==="GET"){const e=dt.get(s.url);if(e)return e;const t=Ks(s,Dr);return dt.set(s.url,t),t.then(()=>dt.delete(s.url),()=>dt.delete(s.url)),t}return Ks(s,0)}async function Ks(s,e){const t=s.timeout??jr;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await Vr(qr(s,r),t)}catch(d){if(n=d,!(d instanceof U)&&d!=null&&typeof d=="object"&&ai.set(d,r),d instanceof U||i===e)break;await new Promise(l=>setTimeout(l,1e3*2**i))}}throw n}async function qr(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Fr({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new U(i.status,d.error??i.statusText,d.details,r)}return i.json()}function Vr(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const ds=new Set;let jt=!1;function Ur(s){return ds.add(s),()=>{ds.delete(s)}}function oi(){if(!jt){jt=!0;try{for(const s of[...ds])try{s()}catch(e){try{ii("session-listener",Kr(e))}catch{}}}finally{jt=!1}}}function Kr(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function F(s,e,t,n={}){st(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=Wr(i);st(()=>{s.set(!1),e.set(r)}),ii(r.code,r.message,Gr(i)),r.code==="auth"&&n.sessionExpiry!==!1&&oi();return}}function Wr(s){return s instanceof U?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const Dt={sessionExpiry:!1};function Yr(s){return{me:()=>_({method:"GET",url:`${s}/auth/me`}),login:e=>_({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>_({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>_({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class j{constructor(){this.api=Yr(os),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Ur(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Hr(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await F(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await F(this.loading,this.error,()=>this.api.login({username:e,password:t}),Dt);return n?(this.currentUser.set(n),!0):!1}async logout(){await F(this.loading,this.error,()=>this.api.logout(),Dt);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await F(this.loading,this.error,()=>this.api.logoutAll(),Dt),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const li={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Qr={...li,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Xr={...li,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Jr=Jn(Qr,$r),Zr=Jn(Xr,kr),o=Rr(Jr,Zr),A=s=>`var(--${s})`,S=(s,e)=>`var(--${s}, ${e})`,T=s=>{const e=Ct[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=Cr({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ct=s=>`
    ...
    cursor: not-allowed;`,ea={primary:ct("primary"),secondary:ct("secondary"),ghost:ct("ghost"),danger:ct("danger"),disabled:di},x=(s=S("btn-radius",T("btn-radius")),e="secondary")=>`
    /*
    ...
    ${ea[e]}
    &:disabled {${di}}
`,ta=`max(${S("field-border-width",T("field-border-width"))}, ${S("field-rule-width",T("field-rule-width"))})`,ut=(s,e)=>`
    border-top-color: ${s};
...
`);class Ba extends R{static styles=`
    ...
    `;router=this.inject(B);auth=this.inject(j);landing=this.inject(Rt);newCount=new $(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Ma,{bar:{className:()=>Qs(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return La(r)?Qs(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Ha(hi),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(Fa,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const l=this.newCount.get();return l===0?"":String(l)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,l)=>i(r,l),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,l)=>i(r,l),r=>r.key),e}}const pi=["tee","approach","putting","shortGame","penalties","recovery"],vt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function fi(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function ja(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Da="Track statistics",Ga="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function mi(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function xt(s,e){return s[e]}function qa(s,e){if(!s.enabled)return!0;const t=mi(e);return t===null?!1:!xt(s,t)}function Va(s,e){if(!s.enabled)return null;const t=mi(e);return t===null||xt(s,t)?null:`Needs ${fi(t)}`}function Ua(s,e,t){return Wa({...s,[e]:t})}function Ka(s,e){return{...s,enabled:e}}function Wa(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function qt(s){const e={...vt,enabled:s.enabled};for(const t of pi)e[t]=s[t];return e}function Ya(s){return s.avatarVersion?`${D}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function Qa(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(ht(t[0])+ht(t[t.length-1])).toUpperCase();if(t.length===1)return ht(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?ht(n).toUpperCase():"•"}function ht(s){return[...s][0]??""}const pt=512,Xa=2*1024*1024;function Ja(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Za=.85;class Ke extends Error{}async function eo(s){let e;try{e=await createImageBitmap(s)}catch{throw new Ke("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Ja(e.width,e.height),r=document.createElement("canvas");r.width=pt,r.height=pt;const d=r.getContext("2d");if(!d)throw new Ke("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,pt,pt);const l=await new Promise(c=>r.toBlob(c,"image/jpeg",Za));if(!l)throw new Ke("That image could not be processed.");if(l.size>Xa)throw new Ke("That image is too large.");return l}finally{e.close()}}async function to(s){const e=await fetch(`${D}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await gi(e);return await e.json()}async function so(){const s=await fetch(`${D}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await gi(s)}async function gi(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new U(t,no(e.error,s.status))}function no(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Be{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(vt);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await F(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null),v.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,l]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?qt(d):vt),this.hasRecordedStats.set((l?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(vt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await F(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await F(this.saving,this.saveError,()=>v.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await F(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await F(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await F(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(qt(e)));return t?(this.statsConfig.set(qt(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await eo(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof Ke?i.message:"That image could not be prepared."}),!1}const n=await F(this.avatarSaving,this.avatarError,()=>to(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await F(this.avatarSaving,this.avatarError,()=>so().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function ft(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function Vt(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function $t(s,e="frecency"){return e==="alpha"?[...s].sort(Vt):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,l=r>0;if(d!==l)return d?-1:1;if(!d)return Vt(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:Vt(t,n)})}const io=1440*60*1e3;function ro(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/io);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function ao(s,e){if(s.sharedRoundCount<=0)return"never played";const t=ro(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function oo(s){return s.isMutual?null:"hasn't added you back"}const bi=2;function Xs(s){return s.trim().length>=bi}function _i(s){return $t(s,"frecency")}function lo(s,e){return _i([...s.filter(t=>t.id!==e.id),e])}function co(s,e){return s.filter(t=>t.id!==e)}function Js(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function uo(s,e,t=()=>{},n=300){let i=0,r;return d=>{const l=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,l.length<bi){e(l,[]);return}r=setTimeout(()=>{s(l).then(u=>{c===i&&e(l,u)},u=>{c===i&&t(l,u)})},n)}}const yi=ot("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function ho(s=Q()){return yi.read(s)}function po(s,e=Q()){yi.write(s,e)}class Ot{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(ho());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=uo(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await F(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(_i(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await F(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(lo(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Js(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),po(e)}async remove(e){await F(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(co(this.friends.get(),e)),this.results.set(Js(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class xs{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await v.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function We(s,e){return s instanceof U&&s.status===401?(oi(),"Your session expired — sign in again."):e}function kt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function fo(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${kt(s.scoreToPar)}`}function vi(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function wi(s){return(s.courseName??"").trim()||null}function mo(s){const e=[];for(const t of s){const n=t.friends[0],i=vi(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:wi(t),progress:fo(n)})}return e}function go(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function bo(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function _o(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function yo(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${kt(s.scoreToPar)}`}function vo(s){const e=[];for(const t of s){const n=t.friends[0],i=vi(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,displayName:n.displayName,title:wi(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function xi(s){if(s instanceof U){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Ae={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function wo(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function xo(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function $o(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${kt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${kt(s.scoreToPar)}`}}}function ko(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function So(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function To(s){return s===1?"1 course played":`${s} courses played`}const Ut={rounds:[],nextCursor:null,hasMore:!1};function Zs(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function $i(s){return s.hasMore&&s.nextCursor!==null}class zt{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(Ut);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await v.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(We(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(Zs(Ut,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(We(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!$i(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(Zs(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(We(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await v.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(We(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=xi(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(Ut),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function ki(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function Po(s){return Math.round(ki(s))}function Io(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,l=r+(e>n-d?1:0);return l===0?0:-l}function Co(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function he(){return Co()}const Te=10;class Le{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await F(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=he()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=he()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=he()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=he()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=he()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=he()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Te:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const en=["scramble","foursomes","greensomes"];class Eo{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof v.setup?.formations=="function")return this.inFlight=(async()=>{const e=await F(this.loading,this.error,()=>v.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=en.indexOf(n);return i===-1?en.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=he()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const No=180,tn=4,Ro=12;function ze(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function Oo(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<Ro)return 0;const i=e+t*No,r=Math.round(-i/n);return Math.max(-tn,Math.min(tn,r))}const sn="tapscore:pending-scores:v1",zo=336*60*60*1e3,nn=200;function Ho(){try{return globalThis.localStorage??null}catch{return null}}function Ao(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Lo{entries=[];storage;constructor(e=Ho(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=zo);return t.length>nn?t.slice(t.length-nn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(sn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ao):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(sn,JSON.stringify(this.entries))}catch{}}}const ge=["tee_result","recovery_ok","gir","short_game_difficulty","first_putt","putts","penalties"],Mo={minPar:4},Fo={tee_result:"Tee shot",recovery_ok:"Recovery",gir:"Green in regulation",short_game_difficulty:"Short game",first_putt:"First putt",putts:"Putts",penalties:"Penalties"},Bo={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"}]},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null}};function jo(s){return Fo[s]}function rn(s){return Bo[s]}function Do(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function Si(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}class Go{modules;par;holeNumber;persistedMap;draft=new Map;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=an(i),this.draft=new Map(r),this.prune()}refresh(e,t){const n=this.signature();return this.modules=e,this.persistedMap=an(t),this.prune(),this.signature()!==n}signature(){let e="";for(const t of ge)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e}get prompts(){const e=[];for(const t of ge)this.isVisible(t)&&e.push({key:t,label:jo(t),control:rn(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Si(Mo,this.par,this.holeNumber)?"visible":"unreadable";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(this.record(e,t),this.prune())}step(e,t){const n=rn(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<ge.length;e++){let t=!1;for(const n of ge){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),qo(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of ge){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function qo(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function an(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of ge){const n=s[t];n!==void 0&&e.set(t,n)}return e}const on="tapscore:pending-stat-events:v1",Vo=336*60*60*1e3,ln=500;function Uo(){try{return globalThis.localStorage??null}catch{return null}}function Ko(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Wo(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&ge.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Yo{entries=[];storage;makeId;constructor(e=Uo(),t=Date.now(),n=Ko){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const l of i){const c={token:e,playHoleId:t,playerId:n,key:l.key,value:l.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===l.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Vo);return t.length>ln?t.slice(t.length-ln):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(on);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Wo):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(on,JSON.stringify(this.entries))}catch{}}}const Qo=50;function Xo(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const $s=ot("tapscore.result-cursors.v1",_s(Xo),Qo);function ks(s=Q()){return $s.read(s)}function Jo(s,e=Q()){return ks(e).find(t=>t.token===s)?.cursor??null}function Zo(s,e,t=Q()){if(!t)return[];const n=ks(t).filter(i=>i.token!==s);return $s.write([{token:s,cursor:e},...n],t)}function el(s,e=Q()){if(!e)return[];const t=ks(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&$s.write(n,e),n}const tl=["1st","2nd","3rd","4th","5th","6th","7th","8th"],xe=(s,e)=>`${s}|${e}`;function Ss(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function sl(s,e,t){return Si(s,e,t)}function Kt(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function nl(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),e}function il(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class ce{constructor(e=new Lo,t=new Yo){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),V.get(Le).load();const r=await F(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Ue({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!Ta(r.round.id))),V.get(j).currentUser.get()&&Pa(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,l,c,u]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[]),v.playerStats.configsByToken({token:e}).catch(()=>null),v.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(l),this.balls.set(d),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),ui(e);const t=this.round.get()?.id;return t&&ci(t),el(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Ue({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Ue({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await F(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?Jo(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Zo(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Ue({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Ss(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new $(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(d=>n.subjectLabels?.some(l=>l.ballId===d&&l.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const d=r.entries.find(l=>i(l.ballIds));if(!d)continue;return d.total===null?null:d.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-d.paceDelta:d.paceDelta}:{kind:"total",total:d.total}}if(r.kind==="match_summary"){const d=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!d)continue;if(d.thru===0&&!d.finished)return null;const l=i(d.sideA.ballIds)?"a":"b";if(d.leader===null||d.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=d.leader===l;return{kind:"match",text:`${d.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return ze(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,l)=>d.ordinal-l.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${tl[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(ze(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(ze(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const n=this.cells.get().get(xe(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(xe(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const l=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===l)?.strokeIndex??d.baseStrokeIndex;return Io(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.flushStats(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e))&&this.bumpStatRev()}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);return!t||!n?null:new Go(t,n.par,n.courseHoleNumber,this.persistedStats(e))}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?nl(t):new Map;for(const i of ge){const r=Kt(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=Kt(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=Kt({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await v.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return il(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(xe(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=V.get(Le),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const l of d)i.has(l.key)||(i.add(l.key),n.push(l))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>sl(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=xe(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const l=this.token;l&&(this.enqueue(l,e,t,n,i,d),await this.post(l,e,t,n,i,d))}async retry(e,t){const n=xe(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(xe(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const l=xe(t,n);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(l);c&&c.clientEventId===d&&this.patchCell(l,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class Ti{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await v.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=xi(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(We(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await v.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Ss(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new $(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class Pi{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await F(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const rl=["last5","last10","last20","thisYear","all","custom"];function St(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function al(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function Ts(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const Je={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function ol(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function ll(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function Wt(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function dl(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Ht(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function Ii(s){return`${s.getFullYear()}-`}function Ci(s,e,t,n){const i=Ht(t);switch(s){case"last5":case"last10":case"last20":{const r=Ts(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=Ii(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>ll(e,r))}}function Ei(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=Ts(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${Ii(r)}01-01`;return!n.some(l=>l.date<d)}case"all":return!0;case"custom":{if(ol(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(l=>l.date<d)}}}const cl="Unnamed course";function ul(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??cl,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Tt="last10";function hl(s){return rl.includes(s)}const Ni=ot("tapscore.stats.window.v1",{decode:s=>hl(s)?s:Tt,encode:s=>s,empty:Tt});function cs(s=Q()){return Ni.read(s)}function dn(s,e=Q()){Ni.write(s,e)}function O(s,e){return{value:e===0?null:s/e,n:s,d:e}}const us=5;function Ee(s,e=us){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const hs=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,girRecorded:0,girHits:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0});function pl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved}}function fl(s){let e=hs;for(const t of s)e=pl(e,t);return e}const ye=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function At(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function ml(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function gl(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function bl(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function Ri(s){return O(s.fairwayHits,s.teeRecorded)}function _l(s){return O(s.troubleCount,s.teeRecorded)}function yl(s){return O(s.recoverySuccesses,s.recoveryAttempts)}function vl(s,e){return O(s.penaltiesTotal,e)}function wl(s){return{fairway:O(s.strokesVsParFairway,s.holesScoredFairway),inPlay:O(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:O(s.strokesVsParTrouble,s.holesScoredTrouble)}}function xl(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return O(e,s.holesScoredTrouble*s.holesScoredFairway)}function Oi(s){return O(s.girHits,s.girRecorded)}function $l(s){return{fairway:O(s.girHitsFairway,s.girRecordedFairway),inPlay:O(s.girHitsInPlay,s.girRecordedInPlay),trouble:O(s.girHitsTrouble,s.girRecordedTrouble)}}function kl(s,e){return O(bl(s,e),s.girFirstPuttRecorded)}function Sl(s){let e=0;for(const t of ye)e+=At(s,t);return e}function Tl(s,e){return O(At(s,e),Sl(s))}function Pl(s){return O(s.birdiesOnGir,s.girHolesScored)}function Il(s){return O(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}function Cl(s,e){return O(gl(s,e),At(s,e))}function El(s){return O(s.threePutts,s.puttsRecorded)}function Nl(s){return O(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function Rl(s){return O(s.puttsTotalGir,s.puttsRecordedGir)}function Ol(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return O(e,t)}function zi(s){return{standard:O(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:O(s.scrambleSuccessesHard,s.scrambleAttemptsHard),overall:O(s.scrambleSuccessesStandard+s.scrambleSuccessesHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}}function zl(s){return{standard:O(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:O(s.scrambleInside2mHard,s.scrambleFirstPuttHard),overall:O(s.scrambleInside2mStandard+s.scrambleInside2mHard,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard)}}function Hl(s){return{par3:O(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:O(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:O(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Al(s,e){return O(s.doubleBogeyPlus,e)}function Ll(s){return O(s.bounceBackSuccesses,s.bounceBackOpportunities)}const cn=18;function Ml(s){let e=0,t=0,n=null,i=0,r=0;for(const d of s){const l=d.measures;l.holesScored>0&&(r+=1,i+=l.strokesTotal-l.parTotal),d.holeCount===cn&&l.holesScored===cn&&(e+=1,t+=l.strokesTotal,(n===null||l.strokesTotal<n)&&(n=l.strokesTotal))}return{rounds:s.length,completeRounds:e,averageScore:O(t,e),bestScore:n,avgVsParPerRound:O(i,r)}}const Hi=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),Fl=Object.freeze({inside2m:1.25,outside2m:2.12}),Bl=Object.freeze({standard:1.7,hard:2.1}),le=["putting","shortGame","penalties","longGame"],jl=.8;function nt(s,e=Hi,t=Fl,n=Bl){let i=0,r=0,d=0;for(const L of ye){const N=At(s,L);i+=N,r+=ml(s,L),d+=N*e[L]}const l=i===0?null:r-d,c=(L,N,G,E)=>{const K=Math.max(0,N-L);return L*(t.inside2m-E)+K*(t.outside2m-E)+G*(1-(1+E))},u=s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard,f=s.scrambleHoledStandard+s.scrambleHoledHard,m=u===0&&f===0?null:c(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard,s.scrambleHoledStandard,n.standard)+c(s.scrambleInside2mHard,s.scrambleFirstPuttHard,s.scrambleHoledHard,n.hard),h=s.penaltiesTotal,g=s.holesScored===0?null:s.strokesTotal-s.parTotal,y={holesScored:s.holesScored,puttsRecorded:s.puttsRecorded},w=s.puttsRecorded>=jl*s.holesScored,z=g===null||l===null||m===null||!w?null:g-l-m-h;return{putting:l,shortGame:m,penalties:h,longGame:z,total:g,coverage:y}}function Me(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Ai(s,e){return{putting:Ge(s.putting,e.map(Li)),shortGame:Ge(s.shortGame,e.map(Dl)),penalties:Ge(s.penalties,e.map(Mi)),longGame:Ge(s.longGame,e.map(Gl)),total:Ge(s.total,e.map(ql))}}function Ps(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Is(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function Ge(s,e){if(s===null)return null;const t=Is(e);return t===null?null:s-t}function Li(s){return s.putting}function Dl(s){return s.shortGame}function Mi(s){return s.penalties}function Gl(s){return s.longGame}function ql(s){return s.total}const un=1,Vl=2,Ul=.75,Kl=4,Wl=3,Yl=12,Ql=5,Xl=2;function Jl(s,e,t,n){const i=Ai(e,t),r=[];let d=0;const l=(y,w)=>{r.push({line:y,magnitude:w,order:d++})};let c=null,u=null;for(const y of le){const w=Ps(i,y);w!==null&&((c===null||w<c.delta)&&(c={component:y,delta:w}),(u===null||w>u.delta)&&(u={component:y,delta:w}))}c!==null&&c.delta<=-un&&l({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=un&&l({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=Is(t.map(Mi));f!==null&&s.penaltiesTotal>=f+Vl&&l({id:"penalties_spike",params:{penalties:s.penaltiesTotal,baseline:f}},0),s.scrambleAttemptsHard>=Wl&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&l({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard,h=s.scrambleSuccessesStandard+s.scrambleSuccessesHard;m>=Kl&&h>=Ul*m&&l({id:"scramble_streak",params:{successes:h,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=Yl&&l({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const g=t.map(Li).filter(y=>y!==null);return e.putting!==null&&g.length>=Ql&&g.every(y=>e.putting<y)&&l({id:"best_putting_round",params:{putting:e.putting,rounds:g.length}},0),s.bounceBackOpportunities>=Xl&&s.bounceBackSuccesses===s.bounceBackOpportunities&&l({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((y,w)=>w.magnitude-y.magnitude||y.order-w.order),r.slice(0,Math.max(0,n)).map(y=>y.line)}const Zl=["tee","approach","putting","shortGame","scoring"];function ed(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const td=3,Fi={rounds:[],totals:hs,waterfall:nt(hs),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function Cs(s){const e=Ht(s);if(e.length===0)return Fi;const t=fl(e.map(r=>r.measures)),n=e.map(r=>nt(r.measures)),i=e.length;return{rounds:e.map((r,d)=>{const l=n[d];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:l.total,waterfall:l}}),totals:t,waterfall:nt(t),priorities:sd(n),trends:nd(e),tee:id(t,i),approach:rd(t),putting:ad(t),shortGame:od(t),scoring:ld(t,i),results:Ml(e)}}function sd(s){const e=le.map(n=>{const i=s.map(r=>Me(r,n));return{component:n,perRound:Is(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>le.indexOf(n);return e.sort((n,i)=>n.perRound!==null&&i.perRound!==null?n.perRound===i.perRound?t(n.component)-t(i.component):i.perRound-n.perRound:n.perRound!==null?-1:i.perRound!==null?1:t(n.component)-t(i.component))}function Yt(s){return Ee(s)==="percentage"?s.value:null}function nd(s){const e=[...s].reverse(),t=(n,i,r,d)=>{const l=[];for(const c of e){const u=d(c.measures);u!==null&&l.push(u)}return l.length>=td?{id:n,title:i,kind:r,points:l}:null};return[t("fairway","Fairways","percentage",n=>Yt(Ri(n))),t("gir","Greens","percentage",n=>Yt(Oi(n))),t("putting","Putting","strokesLost",n=>nt(n).putting),t("scramble","Scrambling","percentage",n=>Yt(zi(n).overall))].filter(n=>n!==null)}function id(s,e){return s.teeRecorded<=0?null:{fairway:Ri(s),inPlayOnly:O(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:_l(s),troubleTax:xl(s),vsParByTee:wl(s),recovery:yl(s),penaltiesPerRound:vl(s,e),penaltiesRecordedHoles:s.penaltiesRecorded}}function rd(s){if(s.girRecorded<=0)return null;const e={};for(const t of ye)e[t]=kl(s,t);return{gir:Oi(s),girByTee:$l(s),girFirstPuttMix:e,birdieConversion:Pl(s),hardChipShare:Il(s)}}function ad(s){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const e={};for(const t of ye)e[t]=Tl(s,t);return{ladder:ye.map(t=>({bucket:t,made:Cl(s,t),baseline:Math.max(0,2-Hi[t])})),firstPuttSpread:e,threePutt:El(s),threePuttsFromOver8m:Nl(s),puttsPerGirHole:Rl(s),puttsAfterMissedGreen:Ol(s)}}function od(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:zi(s),chipInside2m:zl(s),conversionInside2m:O(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,overall:s.scrambleHoledStandard+s.scrambleHoledHard}}}function ld(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Hl(s),doubleBogeyPlusPerRound:Al(s,e),bounceBack:Ll(s)}}function Bi(s){let e=0;for(const t of s)for(const n of le){const i=Me(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function dd(s){let e=0;for(const t of s)t.perRound!==null&&(e=Math.max(e,Math.abs(t.perRound)));return e}function Es(s){const e=V.get(Le);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function cd(s){const e=V.get(Le);return e.load(),e.labelOf(s)??s}function ud(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:xa(e)||null,date:e.round.date,formats:e.round.formatSlots.map(Es).join(" · ")}))}function hd(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,date:e.date??null,formats:null}))}function He(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Oe(s){return s.courseName?He(s)===s.courseName?null:s.courseName:null}function ve(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const Ze={fromMyRounds:ud,fromDeviceRounds:hd};function be(s){switch(Ee(s)){case"absent":return null;case"fraction":return`${fe(s.n)} of ${fe(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function pd(s){return Ee(s)!=="percentage"?null:`${fe(s.n)} of ${fe(s.d)}`}function ie(s){const e=be(s);if(e===null)return null;const t=pd(s);return t===null?e:`${e} (${t})`}function Ns(s,e=2,t=!1){return Ee(s)==="absent"||s.value===null?null:t?je(s.value,e):we(s.value,e)}function Rs(s){return{one:s,many:`${s}s`}}const re=Rs("round"),et=Rs("hole"),ji=Rs("green"),Di="thin sample";function Gi(s,e){switch(Ee(s)){case"absent":return null;case"fraction":return`over ${oe(s.d,e)} — ${Di}`;case"percentage":return`over ${oe(s.d,e)}`}}function ae(s,e){const t=Ns(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=Gi(s,e.unit);return i===null?n:`${n} (${i})`}const fd={one:"hole from trouble",many:"holes from trouble"},md={one:"from the fairway",many:"from the fairway"};function gd(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${oe(e,fd)} vs ${oe(t,md)}`;return e<us||t<us?`${n} — ${Di}`:n}function bd(s){return Ee(s)==="fraction"}function fe(s){return s===Math.round(s)?String(Math.round(s)):we(s,1)}function oe(s,e){return`${fe(s)} ${s===1?e.one:e.many}`}function we(s,e=1){return s.toFixed(e)}function je(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return we(0,e);const i=we(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function _d(s){return`${je(s)}/round`}function Os(s){return s===0?"E":je(s,s===Math.round(s)?0:1)}function Lt(s){switch(s){case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"longGame":return"Long game"}}function yd(s){switch(s){case"putting":return"Putts taken vs expected from where you started";case"shortGame":return"Chips and pitches vs an average short-game shot";case"penalties":return"Strokes added by penalties";case"longGame":return"Tee shots and approaches — what the rest did not explain"}}function Qt(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function vd(s){return s==="indoor"?"Indoor":"Outdoor"}function wd(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function qi(s){return ve(s)}const Vi="Statistics",xd="All statistics →";function $d(s){return s==="custom"?Tt:s}function kd(s,e,t){return Ts(s)!==null||!t?St(s):`${St(s)} — newest ${e}`}function Sd(s){return O(s.strokesTotal-s.parTotal,s.holesScored)}function Td(s){const e=[],t=Sd(s.totals),n=Ns(t,2,!0);if(n!==null){const c=Ee(t)==="fraction"?Gi(t,et):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:be(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,l=d===null?null:be(d.gir);return l!==null&&e.push({id:"gir",value:l,label:"Greens in regulation",note:null}),e}function Pd(s){const e=s.priorities.find(t=>t.perRound!==null);return!e||e.perRound===null||e.perRound<=0?null:`Costing you most: ${Lt(e.component)}`}function Id(s){const e=$d(s.preset),t=Ci(e,Je,s.rows,s.now);if(t.length===0)return null;const n=Cs(t),i=Td(n);if(i.length===0)return null;const r=Ei({preset:e,filter:Je,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:kd(e,t.length,r),tiles:i,priorityLine:Pd(n)}}function Cd(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${Vi}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class Mt{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(cs());loaded=!1;loading=!1;card=new $(()=>{const e=this.rows.get();return e===null?null:Id({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(cs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await v.playerStats.myStats({limit:Mt.PAGE_SIZE});this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof U&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const js=class js extends R{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(P(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};js.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let ee=Ds;async function Ed(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Nd="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Ne(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Ie(s){const e=()=>Ya(s());return{avatarPhoto:{src:()=>e()??Nd,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return Qa(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Fe(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function Rd(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Od(s){return Rd(s).map(e=>e.kind)}function hn(s){return s.signedIn?"avatar":"signin"}const zd=b(`
...
`);class Hd extends R{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),Gd='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',qd=b(`
    <div class="round-row">
        ...
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Gd}</button>
...
`),Yd={not_started:"Not started",active:"Live",complete:"Finished"};class fn extends R{static styles=`
        .landing {
            ...
            & .round-row {
                ...
                & .round-row__formats::before { content: '·'; margin-right: ${a("sm")}; }
    ...
    `;svc=this.inject(Rt);profile=this.inject(Be);activity=this.inject(xs);homeStats=this.inject(Mt);auth=this.inject(j);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>this.loggedIn.get()?Ze.fromMyRounds(this.svc.myRounds.get()):Ze.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new $(()=>Md(this.rows.get(),Date.now(),e=>e));ongoing=new $(()=>this.parts.get().ongoing);finished=new $(()=>this.parts.get().finished);ongoingShown=new $(()=>this.ongoing.get().slice(0,Ui));finishedShown=new $(()=>this.finished.get().slice(0,Fd));counts=new $(()=>({rows:this.rows.get().length,ongoing:this.ongoing.get().length,finished:this.finished.get().length}));newRows=new $(()=>this.loggedIn.get()?Ze.fromMyRounds(this.svc.newRounds.get()):[]);chips=new $(()=>this.loggedIn.get()?mo(this.activity.feed.get()?.live??[]):[]);recents=new $(()=>this.loggedIn.get()?vo(this.activity.feed.get()?.recent??[]):[]);statsCard=new $(()=>this.loggedIn.get()?this.homeStats.card.get():null);statsTiles=new $(()=>this.statsCard.get()?.tiles??[]);deleteOpen=new p(!1);deleteTarget=new p(null);openRoundMenu=new p(null);askDelete(e,t,n){this.openRoundMenu.set(null),this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?(this.svc.loadMine(),this.profile.load(),this.activity.load(),this.homeStats.refreshPreset(),this.homeStats.load(!0)):this.svc.loadDevice();const e=this.wire(Dd,{head:{className:()=>this.loggedIn.get()?"landing__head hidden":"landing__head"},identity:{className:()=>this.loggedIn.get()?"landing__identity":"landing__identity hidden","aria-label":()=>{const r=this.identityName(),d=Xt(this.profile.player.get()?.handicapIndex);return d?`${r}, ${d}`:r},onclick:()=>this.router.navigate("/profile")},...Ie(()=>{const r=this.profile.player.get();return{id:r?.id??"",avatarVersion:r?.avatarVersion??null,displayName:r?.displayName??null,username:r?.username??this.auth.currentUser.get()?.username??null}}),identityName:()=>this.identityName(),identityHcp:{textContent:()=>Xt(this.profile.player.get()?.handicapIndex)??"",className:()=>Xt(this.profile.player.get()?.handicapIndex)===null?"landing__identity-hcp hidden":"landing__identity-hcp"},history:{className:()=>Bd(this.counts.get())?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},outNowSection:{className:()=>this.chips.get().length>0?"landing__section-block landing__outnow":"landing__section-block landing__outnow hidden"},outNowContext:()=>bo(this.activity.feed.get()?.live??[])??"",recentlySection:{className:()=>this.recents.get().length>0?"landing__section-block landing__recently":"landing__section-block landing__recently hidden"},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const r=this.newRows.get().length;return r===0?"":String(r)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block landing__ongoing":"landing__section-block landing__ongoing hidden"},ongoingCount:()=>{const r=this.ongoing.get().length;return r===0?"":String(r)},ongoingMore:{className:()=>Ki(this.counts.get().ongoing)?"landing__ongoing-foot":"landing__ongoing-foot hidden","aria-label":()=>"Show all ongoing rounds",onclick:()=>this.router.navigate("/history")},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block landing__finished":"landing__section-block landing__finished hidden"},finishedCount:()=>{const r=this.finished.get().length;return r===0?"":String(r)},finishedAll:{"aria-label":()=>"All rounds",onclick:()=>this.router.navigate("/history")},stats:{className:()=>this.statsCard.get()===null?"landing__stats hidden":"landing__stats","aria-label":()=>{const r=this.statsCard.get();return r===null?"":Cd(r)},onclick:()=>this.router.navigate("/stats")},statsWindow:()=>this.statsCard.get()?.windowLabel??"",statsPriority:{textContent:()=>this.statsCard.get()?.priorityLine??"",className:()=>this.statsCard.get()?.priorityLine?"landing__stats-priority":"landing__stats-priority hidden"},statsTitle:()=>Vi,statsFoot:()=>xd,empty:{className:()=>jd(this.counts.get())?"landing__empty":"landing__empty hidden"}});this.$each(this.ref(e,"outNowList"),this.chips,(r,d,l)=>this.wireEl(Ud,{chip:{"aria-label":()=>go(r),onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},...Ie(()=>{const c=this.chips.get().find(u=>u.roundId===r.roundId)??r;return{id:c.playerId,avatarVersion:c.avatarVersion,displayName:c.displayName}}),who:()=>r.title,line:()=>r.progress},l),r=>r.roundId),this.$each(this.ref(e,"recentlyList"),this.recents,(r,d,l)=>this.wireEl(Wd,{row:{onclick:()=>this.router.navigate("/spectate",{query:{id:r.roundId,name:r.displayName}})},who:()=>r.friendLabel,what:()=>r.title,formats:()=>{const c=(r.formatIds??[]).map(cd);return c.length>0?` · ${c.join(" · ")}`:""},when:()=>ve(r.date)},l),r=>r.roundId),this.$each(this.ref(e,"newList"),this.newRows,(r,d,l)=>this.roundRow(r,l),r=>r.key),this.$each(this.ref(e,"ongoingList"),this.ongoingShown,(r,d,l)=>this.roundRow(r,l,!0),r=>r.key),this.$each(this.ref(e,"finishedList"),this.finishedShown,(r,d,l)=>this.finishedRow(r,l),r=>r.key),this.$each(this.ref(e,"statsTiles"),this.statsTiles,(r,d,l)=>this.wireEl(Kd,{value:()=>r.value,label:()=>r.label,note:{textContent:()=>r.note??"",className:()=>r.note===null?"stat-tile__note hidden":"stat-tile__note"}},l),r=>`${r.id}:${r.value}:${r.note??""}`),this.spawn(ee,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const r=this.deleteTarget.get();return`Delete ${r?`“${r.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.deleteTarget.get();r&&this.svc.remove(r.token,r.roundId)}});const t=r=>{r.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1),r.key==="Escape"&&this.openRoundMenu.get()!==null&&this.openRoundMenu.set(null)};window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t));const n=this.ref(e,"root"),i=r=>{if(this.openRoundMenu.get()===null)return;const d=r.target;d instanceof Node&&n.contains(d)||this.openRoundMenu.set(null)};return document.addEventListener("pointerdown",i,!0),this.track(()=>document.removeEventListener("pointerdown",i,!0)),e}identityName(){const e=this.profile.player.get(),t=(e?.displayName??"").trim();if(t!=="")return t;const n=(e?.username??this.auth.currentUser.get()?.username??"").trim();return n===""?"Signed in":n}finishedRow(e,t){return this.wireEl(Vd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>He(e),course:{textContent:()=>Oe(e)??"",className:()=>Oe(e)?"finished-row__course":"finished-row__course hidden"},date:()=>ve(e.date),formats:()=>e.formats??""},t)}roundRow(e,t,n=!1){return this.wireEl(qd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>He(e),course:{textContent:()=>Oe(e)??"",className:()=>Oe(e)?"round-row__course":"round-row__course hidden"},date:()=>ve(e.date),progress:{textContent:()=>n&&e.holesPlayed&&e.holesPlayed>0?`Thru ${e.holesPlayed}`:"",className:()=>n&&e.holesPlayed&&e.holesPlayed>0?"round-row__progress":"round-row__progress hidden"},formats:{textContent:()=>e.formats??"",className:()=>e.formats?"round-row__formats":"round-row__formats hidden"},actions:{className:()=>e.token===null?"round-row__actions hidden":"round-row__actions"},menuButton:{"aria-expanded":()=>this.openRoundMenu.get()===e.key?"true":"false",onclick:()=>this.openRoundMenu.set(this.openRoundMenu.get()===e.key?null:e.key)},menu:{className:()=>this.openRoundMenu.get()===e.key?"round-row__menu":"round-row__menu hidden"},delete:{onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",He(e))}}},t)}}function Qd(s){return[...s].sort((e,t)=>{const n=mn(e),i=mn(t);return i!==n?i-n:e.key.localeCompare(t.key)})}function mn(s){const e=s.completedAt??s.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const Xd=b(`
    <div class="history">
...
`);class ec extends R{static styles=`
    ...
    `;svc=this.inject(Rt);auth=this.inject(j);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>Qd(this.loggedIn.get()?Ze.fromMyRounds(this.svc.myRounds.get()):Ze.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,n){this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(Xd,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"},list:{className:()=>this.rows.get().length===0?"history__list hidden":"history__list"}});this.$each(this.ref(e,"list"),this.rows,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.spawn(ee,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const n=this.deleteTarget.get();return`Delete ${n?`“${n.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const n=this.deleteTarget.get();n&&this.svc.remove(n.token,n.roundId)}});const t=n=>{n.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(Zd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>He(e),course:{textContent:()=>Oe(e)??"",className:()=>Oe(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>Yd[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>ve(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",He(e))}}},t)}}const tc=700;function sc(s){if(!s.currentHole)return!1;const e=s.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function nc(s){return s.currentHole?s.balls.some((e,t)=>t!==s.currentBallIndex&&!e.scored):!1}function Jt(s){const e=s.currentHole;if(!e)return{kind:"noop"};const t=s.balls,n=s.currentBallIndex;for(let i=n+1;i<t.length;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};for(let i=0;i<n;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};return s.holeIndex>=s.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:s.holeIndex+1,delayMs:tc}}function ic(s,e){const t=s.currentHole;if(e.kind==="statsDone")return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Jt(s)};const n=s.balls[s.currentBallIndex];if(!t||!n)return{write:null,move:{kind:"noop"}};if(n.pending)return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Jt(s)};const i={ballIndex:s.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&s.collectsStats?{write:i,move:{kind:"openStats"}}:s.holeCompleteOnEntry?{write:i,move:{kind:"stay"}}:{write:i,move:Jt(s)}}const $e=60,gn=8,fs=4,rc=Array.from({length:fs*2+1},(s,e)=>e-fs),ac="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",oc=b(`
...
`),mc=b('<div bind="rule" class="se-stats__rule"></div>');class gc extends R{static styles=`
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${gn}px; flex-shrink: 0; }
            & .se-row__slot { width: ${$e}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
...
<tr class="lb-rank__panel${E?" lb-rank__panel--open":""}" data-panel-key="${M(G)}">
  ...
  <h4 class="lb-section__title">${M(i.metricLabel)}</h4>
  <table class="lb-rank">
    <colgroup>
    ...
    <div class="lb-mp__team lb-mp__team--a${r}">${M(i.sideAName)}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${M(i.standing)}</span><span class="lb-mp__status">${M(i.status)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${d}">${M(i.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${M(t.title)}</h4>${n}
</div>`}const Dc={ranked:Bc,match_summary:(s,e)=>jc(s,e)},Gc={"default-score-grid":Hc,"compact-match-grid":Ac,"category-matrix-grid":Lc};function qc(s){return`<div class="lb-diag">Unrenderable result section <code>${M(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Vc(s){return`<div class="lb-diag">Unsupported score-grid component <code>${M(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Uc(s,e,t,n=null){const i=Dc[s.kind];return i?i(s,e,t,n):qc(s.kind)}function Ji(s,e,t,n){const i=Yi(s),r=Gc[i];return r?r(s,e,t,n):Vc(i)}function Zi(s,e,t=Xi,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${M(s.formatLabel)}.</div>`:s.leaderboard.map(r=>Uc(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${M(s.formatLabel)}.</div>`}function er(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Ji(r,e,t,{mode:i})).join(`
`)}const Kc=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class Ls extends R{static styles=`
        .lb {
...
`);class mu extends R{static styles=`
    ...
    `;svc=this.inject(ce);auth=this.inject(j);profile=this.inject(Be);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return pu({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":It(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=pe(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(P(()=>this.ensureProfileLoaded())),this.wire(fu,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${It(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function gu(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const bu=b(`
...
`);class Cu extends R{static styles=`
    ...
    `;svc=this.inject(ce);auth=this.inject(j);router=this.inject(B);stage=new p("prompt");error=new p("");render(){this.track(P(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(Iu,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>vu(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(Ls,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=nr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return yu({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return tr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:sr({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Pe{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(cs());filter=new p(Je);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new $(()=>Ci(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new $(()=>Cs(this.windowRounds.get()));courses=new $(()=>ul(this.loadedRounds.get()));overFiltered=new $(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await F(this.loading,this.error,()=>v.playerStats.myStats({limit:Pe.PAGE_SIZE}));t&&(this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded())}select(e){this.preset.set(e),dn(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),dn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(Je),this.select(Tt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Pe.MAX_PAGES&&Ei({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await v.playerStats.myStats({limit:Pe.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Pe.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(Je),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class rt{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=V.get(Pe);inFlight=null;model=new $(()=>{const e=this.round.get();return e===null?null:Su({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await v.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(kn(d)),this.failure.set(Sn(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(kn(d)),this.failure.set(Sn(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const l of d)n.has(l.roundId)||(n.add(l.roundId),t.push(l))};if(i(this.dashboard.loadedRounds.get()),xn(t,e,gs))return t;let r=null;for(let d=0;d<rt.MAX_PAGES;d++){const l=await v.playerStats.myStats({limit:rt.PAGE_SIZE,cursor:r??void 0});if(i(l.rounds),xn(t,e,gs)||l.nextCursor===null)return t;r=l.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function kn(s){if(s instanceof U){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function Sn(s){return s instanceof U&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const Z=100;function Ft(s){return s>0?"loss":s<0?"gain":"zero"}function De(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function X(s){return String(Math.round(s*1e3)/1e3)}function Ms(s){return s<0?0:s>1?1:s}function Ce(s,e){return`<svg class="chart" viewBox="0 0 ${Z} ${X(s)}" preserveAspectRatio="none" style="height:${X(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function Fs(s,e,t,n=1){return`<path d="M${X(s)} 0 L${X(s)} ${X(e)}" stroke="${t}" stroke-width="${X(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function me(s,e,t,n,i){return`<rect x="${X(s)}" y="${X(e)}" width="${X(t)}" height="${X(n)}" fill="${i}"/>`}const Eu=1;function Nu(s,e){const t=Z/2,n=Ft(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:Eu,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function ir(s,e,t,n=10){const i=Nu(s,e),r=i.bar&&i.bar.width>0?me(i.bar.x,0,i.bar.width,n,De(i.tone,t)):"";return Ce(n,[me(0,0,Z,n,t.track),r,Fs(i.zeroX,n,t.rule)].join(""))}function Ru(s){const e=[];let t=0;for(const n of s){const i=Z*Ms(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function Ou(s,e,t=12){const n=Ru(s).filter(i=>i.width>0).map(i=>me(i.x,0,i.width,t,i.color)).join("");return Ce(t,me(0,0,Z,t,e.track)+n)}const Tn=2,zu=1e-4;function Hu(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=Tn,d=Math.max(0,e-Tn*2);return s.map((l,c)=>({x:s.length===1?Z/2:c/(s.length-1)*Z,y:i===0?e/2:r+d-(l-t)/i*d}))}function Au(s){return s.map((e,t)=>`${t===0?"M":"L"}${X(e.x)} ${X(e.y)}`).join(" ")}function Lu(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=zu?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Mu(s,e,t,n=34){const i=Hu(s,n);if(i.length===0)return Ce(n,"");const r=De(Lu(s,e),t),d=`<path d="${Au(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,l=i[i.length-1],c=`<path d="M${X(l.x)} ${X(l.y)} L${X(l.x)} ${X(l.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Ce(n,d+c)}const Fu=.5;function Bu(s,e,t=8){const n=Z/2,i=le.length-1,r=Math.max(1,(t-i)/le.length),d=[];return le.forEach((l,c)=>{const u=Me(s,l);if(u===null||!(e>0))return;const f=Math.max(u===0?0:Fu,n*Math.min(1,Math.abs(u)/e));d.push({component:l,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:Ft(u)})}),d}function ju(s,e,t,n=8){const i=Bu(s,e,n).filter(r=>r.width>0).map(r=>me(r.x,r.y,r.width,r.height,De(r.tone,t))).join("");return Ce(n,Fs(Z/2,n,t.rule)+i)}const rr=1,Pn=.02;function Du(s,e){const t=e>0?Z*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=Ms(s),i=e<=0?"neutral":s>e+Pn?"gain":s<e-Pn?"loss":"neutral";return{bar:{width:Math.max(rr,Z*n),tone:i},tickX:t}}function Gu(s,e,t,n=10){const i=Du(s,e),r=i.bar?me(0,0,i.bar.width,n,De(i.bar.tone,t)):"",d=i.tickX===null?"":Fs(i.tickX,n,t.rule,2);return Ce(n,me(0,0,Z,n,t.track)+r+d)}function qu(s){return s===null?null:Math.max(rr,Z*Ms(s))}function Vu(s,e,t=e.neutral,n=8){const i=qu(s),r=i===null?"":me(0,0,i,n,t);return Ce(n,me(0,0,Z,n,e.track)+r)}const Bt={gain:o("accent-strong"),loss:o("danger"),zero:o("border-strong"),neutral:o("accent"),track:o("surface-sunken"),rule:o("border")},I={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Strokes lost per round against a fixed baseline, worst first. Positive costs you shots.",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s four waterfall terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",resultsHeading:"Results",resultsHint:"Your scoring across the rounds in this window.",averageScore:"Complete 18-hole rounds only — part rounds and nine-holers are left out.",bestScore:"Your lowest complete 18-hole round in this window.",avgVsParPerRound:"Per round, over every round with a score — nine-hole rounds included.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function Qe(s){return bd(s)?null:s.value}function ue(s,e,t){return{kind:"bar",id:s,title:e,share:Qe(t),value:be(t)}}function q(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function Uu(s,e){switch(s){case"tee":{const t=e.tee&&ie(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&ie(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?ae(e.putting.puttsPerGirHole,{unit:ji,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&ie(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?ae(e.scoring.doubleBogeyPlusPerRound,{unit:re,label:"doubles or worse per round"}):null}}function Ku(s){const e=gd(s.vsParByTee),t=e?`${I.troubleTax} Measured ${e}.`:I.troubleTax;return q("troubleTax","Trouble tax",Ns(s.troubleTax,2,!0),t)}function ss(s){return ae(s,{unit:et,signed:!0})}function Wu(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function In(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:Qe(t.fairway),value:be(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:Qe(t.inPlayOnly),value:be(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:Qe(t.trouble),value:be(t.trouble)}]},...Wu(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},{kind:"note",id:"vsParByTeeNote",text:I.vsParByTee},q("vsParFairway","From the fairway",ss(t.vsParByTee.fairway)),q("vsParInPlay","From in play",ss(t.vsParByTee.inPlay)),q("vsParTrouble","From trouble",ss(t.vsParByTee.trouble))]:[],Ku(t),q("recovery","Recovery",ie(t.recovery),I.recovery),...t.penaltiesRecordedHoles>0?[q("penalties","Penalties",ae(t.penaltiesPerRound,{unit:re}),`${I.penalties} Recorded on ${oe(t.penaltiesRecordedHoles,et)}.`)]:[]]:[]}case"approach":{const t=e.approach;return t?[{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},ue("girFairway","From the fairway",t.girByTee.fairway),ue("girInPlay","From in play",t.girByTee.inPlay),ue("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:I.proximityProxy},...ye.map(n=>ue(`mix-${n}`,Qt(n),t.girFirstPuttMix[n])),q("birdieConversion","Birdie conversion",ie(t.birdieConversion),I.birdieConversion),...t.hardChipShare.d>0?[q("hardChipShare","Hard misses",ie(t.hardChipShare),I.hardChipShare)]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[ye[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},{kind:"note",id:"firstPuttNote",text:I.firstPuttSpread},...ye.map(n=>ue(`spread-${n}`,Qt(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:I.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:Qt(n.bucket),made:Qe(n.made),baseline:n.baseline,value:be(n.made)})),q("threePutt","Three-putts",ie(t.threePutt),I.threePutt),q("longThreePutt","Three-putts from over 8 m",ie(t.threePuttsFromOver8m),I.longThreePutt),q("puttsPerGir","Putts per green hit",ae(t.puttsPerGirHole,{unit:ji}),I.puttsPerGir),...t.puttsAfterMissedGreen.d>0?[q("puttsAfterMissedGreen","Putts after a missed green",ae(t.puttsAfterMissedGreen,{unit:et}),I.puttsAfterMissedGreen)]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},ue("scrambleStandard","Standard",t.scramble.standard),ue("scrambleHard","Hard",t.scramble.hard),{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},ue("chipStandard","Standard",t.chipInside2m.standard),ue("chipHard","Hard",t.chipInside2m.hard),q("conversionInside2m","Holed from inside 2 m",ie(t.conversionInside2m),I.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},{kind:"note",id:"chipInsNote",text:I.chipIns},q("chipInsStandard","Standard",fe(t.chipIns.standard)),q("chipInsHard","Hard",fe(t.chipIns.hard))]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>ae(i,{unit:et,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},q("par3","Par 3",n(t.avgVsParByParGroup.par3)),q("par4","Par 4",n(t.avgVsParByParGroup.par4)),q("par5","Par 5",n(t.avgVsParByParGroup.par5)),q("doubles","Doubles or worse",ae(t.doubleBogeyPlusPerRound,{unit:re}),I.doubleBogeyPlus),q("bounceBack","Bounce-back",ie(t.bounceBack),I.bounceBack)]}}}function Cn(s){if(!s)return[];const e=[q("rounds","Rounds",fe(s.rounds))];return s.completeRounds>0&&e.push(q("averageScore","Average score",ae(s.averageScore,{unit:re,decimals:1}),I.averageScore)),s.bestScore!==null&&e.push(q("bestScore","Best score",fe(s.bestScore),I.bestScore)),s.avgVsParPerRound.d>0&&e.push(q("avgVsPar","Average vs par",ae(s.avgVsParPerRound,{unit:re,decimals:1,signed:!0}),I.avgVsParPerRound)),e}function Yu(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function En(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const W={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},Nn={title:"Your round",seeWholeRound:"See the whole round"};function Qu(s){const e=[qi(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function ar(s,e){return s===null?null:e===null?String(s):`${s} (${Os(e)})`}function Xu(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function Ju(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function Zu(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Os(s.vsPar)})`}function eh(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function th(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function sh(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function nh(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function Bs(s){const e=[],t=Zu(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:eh(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:th(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:sh(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function ih(s){return s===null?[]:Bs(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function Rn(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(nh(s.marker).toLowerCase())):e.push("no score");for(const t of Bs(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function or(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=we(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function On(s){switch(s){case"putting":return"Putting";case"shortGame":return"Your short game";case"penalties":return"Penalties";case"longGame":return"Tee to green"}}function ns(s,e=1){return typeof s=="number"?we(Math.abs(s),e):""}function mt(s){return typeof s=="number"?String(Math.round(s)):""}function zn(s){return typeof s=="string"?s:"longGame"}function rh(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${On(zn(e.component))} was ${ns(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${On(zn(e.component))} cost you ${ns(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${ns(e.baseline)} in a normal round.`}case"scramble_streak":return`You saved par ${mt(e.successes)} of the ${mt(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${mt(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${mt(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const ah=b(`
...
`);class dh extends R{static styles=`
    ...
    `;round=this.inject(ce);stats=this.inject(rt);auth=this.inject(j);router=this.inject(B);colors=Bt;render(){this.track(P(()=>{const i=this.eligibleRoundId();Y(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(ah,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>Nn.title,score:()=>{const i=e();return i===null?"":ar(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),open:{textContent:()=>Nn.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Me(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...le],(i,r,d)=>this.wireEl(lh,{label:()=>Lt(i),amount:{textContent:()=>{const l=n(i);return l===null?I.notRecorded:je(l)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const l=n(i);return l===null?"":`color:${De(Ft(l),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl(oh,{text:()=>rh(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:tr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:sr({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return W.waterfallHint;let t=null;for(const n of le){const i=Ps(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?W.waterfallHint:or(t,e.windowCount)}}function Hn(s){return!(!s.pageVisible||s.status==="complete")}function ch(s,e){return e&&!s}const uh=2,An=3,hh=75e3;function ph(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${D}/friendly-rounds/events?${t.toString()}`}function fh(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function mh(s){const e=s.eventSourceFactory??(N=>new EventSource(N)),t=s.setTimer??((N,G)=>setTimeout(N,G)),n=s.clearTimer??(N=>clearTimeout(N)),i=s.livenessTimeoutMs??hh,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,l=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(z,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},y=()=>{d=!0,m(),g()},w=()=>{if(g(),++l>=An){y(),s.onDegrade();return}L()};function z(){if(!d){if(!r()){h();return}w()}}function L(){if(d)return;let N;try{N=e(ph(s.token,f))}catch{y(),s.onDegrade();return}c=N,N.onopen=()=>{l=0},N.onmessage=G=>{if(d||c!==N)return;h();let E;try{E=JSON.parse(G.data)}catch{return}fh(E)&&(E.latestEventId!==null&&(f=E.latestEventId),s.onEvent({latestEventId:E.latestEventId,status:E.status}))},N.onerror=()=>{d||c!==N||(N.readyState===uh||++l>=An)&&(y(),s.onDegrade())},h()}return L(),{stop:()=>{d||y()}}}const gh=2e4;function bh(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const _h=b(`
...
`);function ur(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>wo(s),subtitle:()=>xo(s,ve),progress:()=>$o(s)}}function hr(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class op extends R{static styles=`
    ...
    `;svc=this.inject(zt);activity=this.inject(xs);auth=this.inject(j);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(P(()=>{const h=e.get();Y(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new $(()=>{const h=e.get();return h?_o(this.activity.feed.get(),h):null}),l=()=>this.svc.unavailable.get(),c=()=>n()&&l()===null&&i()!==null,u=()=>n()&&l()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(ap,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&l()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=l();return h?Ae[h].title:""}},refusalMsg:{textContent:()=>{const h=l();return h?Ae[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...Ie(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?ko(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?yo(h):""},onclick:()=>{const h=d.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>To(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,y)=>this.wireEl(cr,ur(h,f),y),h=>h.roundId),m}}const lp=b(`
    <div class="frounds">
...
`);class hp extends R{static styles=`
    ...
    `;svc=this.inject(zt);auth=this.inject(j);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(P(()=>{const c=e.get();Y(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],d=()=>(t.get()??"").trim(),l=this.wire(cp,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}})},subtitle:{textContent:()=>{const c=d();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ae[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ae[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(d())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(l,"list"),r,(c,u,f)=>this.wireEl(up,{name:()=>c.courseName??"Course",facts:()=>So(c,ve)},f),c=>c.courseId),l}}function pp(s,e,t){const n=at(e);if(n){const l=Kn(s);return l?`Watching · ${l} ${n}`:`Watching · ${n}`}const i=Kn(s)??"this",r=at(t),d=r?` at ${r}`:"";return`Watching · ${i} round${d}`}function fp(s,e,t,n){const i=at(s)===null?null:at(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const mp="You're watching this round. Only its players can enter scores.",Un={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Kn(s){const e=at(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function at(s){return(s??"").trim()||null}const gp=b(`
    <div class="spectate">
...
`),Ep=b('<div bind="panels" class="statspanels"></div>');class pr extends R{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
...
`);class Lp extends R{static styles=`
    ...
    `;svc=this.inject(Pe);auth=this.inject(j);router=this.inject(B);filterOpen=new p(!1);colors=Bt;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Np,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>I.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>I.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsHint:()=>I.resultsHint,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>I.prioritiesHint,trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>I.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>I.roundsHint,pickHint:()=>n()?I.filterRoundsHint:""});return this.setHeading(i,"resultsSec",I.resultsHeading),this.setHeading(i,"prioritiesSec",I.priorities),this.setHeading(i,"trendsSec",I.trends),this.setHeading(i,"roundsSec",I.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"results"),()=>Cn(t().results),(r,d,l)=>this.wireEl(Op,{title:()=>r.kind==="figure"?r.title:"",hint:()=>r.kind==="figure"?r.hint??"":"",value:{textContent:()=>{const u=Cn(t().results).find(f=>f.id===r.id)??r;return u.kind==="figure"?u.value??I.notRecorded:""}}},l),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,l)=>this.wireEl(zp,{title:()=>Lt(r.component),subtitle:()=>yd(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.perRound===null||c===void 0?"":ir(c.perRound,dd(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.perRound!==null?_d(c.perRound):I.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.perRound===null?Yu(c.roundsInWindow):`over ${oe(c.roundsCovered,re)}`:""}}},l),r=>r.component),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,l)=>this.wireEl(Hp,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Mu(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return Mp(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return oe(c.points.length,re)}}},l),r=>r.id),this.spawn(pr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,l)=>this.wireEl(Ap,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${En(r)} — hole by hole`},label:()=>En(r),subtitle:()=>Fp(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(dl(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return ju(c.waterfall,Bi(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Os(c.vsPar)}}},l),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(P(()=>t.set(this.svc.preset.get()))),this.track(P(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${St(r)} — ${al(r)}`}),i=new de({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:St("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(Wn,{chip:{textContent:()=>vd(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(Wt(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(Wn,{chip:{textContent:()=>wd(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(Wt(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(Rp,{name:()=>i.name,count:()=>oe(i.roundCount,re),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(Wt(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?oe(e,re):`${we(e,0)} of ${oe(t,re)}`}statusLine(){const e=this.svc.extendError.get();return e?`${I.extendProblemPrefix}${e.message}`:this.svc.extending.get()?I.extending:this.svc.budgetSpent()?I.budgetSpent:this.svc.loading.get()?I.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?I.windowEmpty:this.svc.loadedCount()===0?I.noStats:""}}function Mp(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:je(e)}function Fp(s){const e=[qi(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${we(s.holeCount,0)} holes`),e.join(" · ")}const Bp=b(`
...
`),qp=b('<li bind="text" class="roundstats__legenditem"></li>');function Vp(){const s=[];for(const[e,t]of Object.entries(Hs))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
    ...
    `;svc=this.inject(rt);auth=this.inject(j);router=this.inject(B);colors=Bt;openHole=new p(null);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(P(()=>{const l=e.get();Y(()=>{this.openHole.set(null),l&&this.svc.load(l)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",d=this.wire(Bp,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":$n(t()),subtitle:()=>this.subtitle(),score:()=>{const l=t();return l===null?"":ar(l.strokes,l.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>W.waterfallHeading,wfHint:()=>W.waterfallHint,legendHeading:()=>W.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const l=this.selected();return l===null?"":Xu(l)},detailEmpty:()=>{const l=this.selected();return l===null?"":Bs(l).length===0?W.nothingRecordedOnHole:""}});return this.setHeading(d,"stripSec",W.holeStripHeading),this.$each(this.ref(d,"strip"),()=>t()?.cells??[],(l,c,u)=>this.wireEl(jp,{cell:{className:()=>{const f=this.cellNow(l.id)??l;return f.marker===null?"cell":`cell cell--${f.marker}`},"aria-pressed":()=>String(this.openHole.get()===l.id),"aria-label":()=>Rn(this.cellNow(l.id)??l),title:()=>Rn(this.cellNow(l.id)??l),onclick:()=>this.openHole.set(this.openHole.get()===l.id?null:l.id)},hole:()=>String((this.cellNow(l.id)??l).holeNumber),score:()=>Ju(this.cellNow(l.id)??l),tee:{className:()=>(this.cellNow(l.id)??l).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const f=this.cellNow(l.id)??l;return f.tee===null?"":`background:${this.teeColor(f.tee)}`}},gir:{className:()=>{const f=this.cellNow(l.id)??l;return f.gir===null?"cell__gir cell__gir--absent":f.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const f=this.cellNow(l.id)??l;return f.putts===null?"":String(f.putts)},pen:{className:()=>$u(this.cellNow(l.id)??l)?"cell__pen":"cell__pen cell__pen--absent"}},u),l=>l.id),this.$each(this.ref(d,"detailLines"),()=>ih(this.selected()),(l,c,u)=>this.wireEl(Dp,{label:()=>l.label,value:()=>l.value},u),l=>l.key),this.$each(this.ref(d,"deltas"),()=>{const l=t();return l===null?[]:le.filter(c=>Me(l.waterfall,c)!==null)},(l,c,u)=>this.wireEl(Gp,{title:()=>Lt(l),sentence:()=>{const f=t();if(f===null||f.deltas===null)return"";const m=Ps(f.deltas,l);return m===null?"":or(m,f.windowCount)},value:{textContent:()=>{const f=this.componentValue(l);return f===null?"":je(f)},style:()=>{const f=this.componentValue(l);return f===null?"":`color:${De(Ft(f),this.colors)}`}},bar:{innerHTML:()=>{const f=t(),m=this.componentValue(l);return f===null||m===null?"":ir(m,Bi([f.waterfall]),this.colors)}}},u),l=>l),this.spawn(pr,this.ref(d,"panels"),{model:()=>t()?.panels??Fi}),this.$each(this.ref(d,"legend"),()=>[W.legendTee,W.legendGir,W.legendPutts,W.legendPenalty,W.legendAbsence],(l,c,u)=>this.wireEl(qp,{text:()=>l},u),l=>l),d}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Me(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":Qu({...e,title:$n(e)})}stateLine(){if(this.auth.currentUser.get()===null)return W.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return W.loading;case"notFound":return W.noStatsInRound;case"notAuthorized":return W.notSignedIn;case"failed":return`${W.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?W.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const Kp=b(`
    <div class="admin">
...
`),Pf=b('<button bind="button" type="button"></button>'),If=b('<th bind="cell"></th>'),Cf=b('<tr bind="row"></tr>'),Ef=b('<td bind="cell"><span bind="value"></span></td>'),Nf=b(`
...
`);class Hf extends R{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class Lf extends R{static styles=`
    ...
    `;router=this.inject(B);render(){const e=this.wire(Af,{header:{className:()=>ws(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Hd,this.ref(e,"account")),this.spawn(Ba,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":fn,"/history":ec,"/round":wh,"/create":Yh,"/login":tp,"/friends":rp,"/friend":op,"/friend-rounds":dp,"/friend-courses":hp,"/spectate":bp,"/profile":xp,"/stats":Lp,"/round-stats":Up,"/admin":tf,...hi.competitions?{"/competitions":of,"/competition":Hf}:{}},fn),e}}class Mf extends j{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await dr(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await Qh()),this.error.set(null)}catch(e){e instanceof U&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Xh(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof U&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await Jh();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof U&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}V.get(Or);const Yn=V.get(B);V.set(j,new Mf);const Qn=V.get(j);await Lr(Lf,"#app",{hot:void 0,onInit:async()=>{await Qn.load(),Qn.currentUser.get()&&Yn.route.get()==="/login"&&Yn.navigate("/",!0)}});export{os as A,R as C,B as R,p as S,Or as T,_ as a,st as b,$ as c,kr as d,P as e,$r as n,F as r,b as t};
