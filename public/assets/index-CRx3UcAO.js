(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Fs="modulepreload",Bs=function(n){return"/tapscore/"+n},_t={},Gs=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=a?.nonce||a?.getAttribute("nonce");i=c(t.map(u=>{if(u=Bs(u),u in _t)return;_t[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Fs,f||(h.as="script"),h.crossOrigin="",h.href=u,d&&h.setAttribute("nonce",d),document.head.appendChild(h),f)return new Promise((b,g)=>{h.addEventListener("load",b),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return i.then(a=>{for(const d of a||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},ts="/tapscore/".replace(/\/+$/,""),st=ts+"/api",Le={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},qs=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function ss(n,e){const t={};for(const[s,i]of qs)if(s in n)for(const r of i)r in n||(t[r]=`var(--${s})`);return{...e,...t,...n}}const ns=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Ks={thin:"1px",medium:"3px",thick:"5px"};function is(n){const e=n.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Ks[e.toLowerCase()]??e}function Vs(){return ns.map(n=>{const e=is(Le[n]);return`@property --${n}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const rs={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},as={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Us={...as,"done-opacity":"0.35"},Ws={...rs,...as,...Le,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ys={...rs,...Us,...Le,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Qs{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;os(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const X=new Qs;function os(n){for(const e of n.deps)e.delete(n);n.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return X.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,X.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){X.runTracked(s,()=>{const i=e();Object.is(t.val,i)||(t.val=i,X.notify(t.subs))})},deps:new Set};s.run()}get(){return X.subscribe(this.subs),this.val}peek(){return this.val}}function N(n){const e={run(){X.runTracked(e,n)},deps:new Set};return e.run(),()=>{e.disposed=!0,os(e)}}function me(n){X.batch(n)}function V(n){return X.untrack(n)}class Xs{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const B=new Xs,le=ts;function nt(n){return le?n===le?"/":n.startsWith(le+"/")?n.slice(le.length):n:n}function Js(n){return le+n}class M{constructor(){this.route=new p(nt(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>me(()=>{this.route.set(nt(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",a=i>=0?e.slice(0,i):e,d=a.indexOf("?"),c=d>=0?a.slice(0,d):a,u=d>=0?a.slice(d+1):"",f=s.query!==void 0?Zs(s.query):u?"?"+u:"",m=Js(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),me(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===s||i.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const s=this.route.get().split("/"),i={};for(const[r,a]of t.entries())a.startsWith(":")&&(i[a.slice(1)]=s[r]??"");return i})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Zs(n){const e=new URLSearchParams;for(const[s,i]of Object.entries(n))i==null||i===""||e.set(s,String(i));const t=e.toString();return t?"?"+t:""}function en(n){return e=>n[e]}const tn="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",vt="data-basics-global";function sn(){if(document.head.querySelector(`style[${vt}]`))return;const n=document.createElement("style");n.setAttribute(vt,""),n.textContent=Vs()+tn,document.head.appendChild(n)}function nn(n,e){sn();const t=new Set(ns),s=(r,a,d)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?is(f):f}`).join(";");return`${a}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=s(n,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const wt="basics-js-theme";class rn{constructor(){this.dark=new p(!1);const e=localStorage.getItem(wt),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),N(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(wt,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(n){const e=document.createElement("template");return e.innerHTML=n,e}function an(n,e){let t;for(const s of Object.keys(e))n.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const xt=new Set;class R{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!xt.has(t)){xt.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return B.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const i=V(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){V(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const i=s??(a=>this.track(a)),r=e.content.cloneNode(!0);for(const a of r.querySelectorAll("[bind]")){const d=t[a.getAttribute("bind")];if(d)if(typeof d=="function")i(N(()=>{const c=d();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(c):a.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?a.addEventListener(c.slice(2),u):typeof u=="function"?i(N(()=>{const m=u();f?a.setAttribute(c,String(m)):a[c]=m})):f?a.setAttribute(c,String(u)):a[c]=u}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const i=this.ref(t,e);return i?(typeof s=="string"?i.textContent=s:typeof s=="function"&&s.prototype instanceof R?this.spawn(s,i):typeof s=="function"&&s(i,{spawn:(r,a,...d)=>this.spawn(r,a,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,i=(r,a)=>a){const r=typeof t=="function"?t:()=>t.get(),a=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(N(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const b=i(h,m);if(a.has(b))u.set(b,a.get(b));else{const g=[];u.set(b,V(()=>s(h,m,x=>g.push(x)))),d.set(b,g)}}for(const[m,h]of a)u.has(m)||(h.remove(),V(()=>d.get(m)?.forEach(b=>b())),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);a.clear();for(const[m,h]of u)a.set(m,h)}))}$condition(e,t,s,i){let r=null;this.track(N(()=>{r&&(r.remove(),r=null);const a=t.get();r=V(()=>a?s():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,i){let r=null;this.track(N(()=>{if(r){const c=r;r=null,V(()=>c.destroy())}e.textContent="";const a=t.get(),d=s[a]??an(a,s)??i;d&&(r=V(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Pe=new Set;function on(n){return Pe.add(n),()=>Pe.delete(n)}function ln(){for(const n of Array.from(Pe)){Pe.delete(n);try{n()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function dn(n,e,t){const s=document.querySelector(e);s.textContent="";const i=B.get(M);let r=null,a=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await Gs(()=>import("./obs-shell.component-D6pZ477b.js"),[])).ObsShellComponent),r=V(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=V(()=>new n)),V(()=>r.mount(s)),a=f};await u(nt(location.pathname).startsWith("/_obs")),N(()=>{const f=i.route.get().startsWith("/_obs");f!==a&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,ln(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class K extends Error{constructor(e,t,s,i){super(t),this.status=e,this.details=s,this.traceId=i,this.name="ApiError"}}const cn=10,Ie=[];let Te=[],ue=null;function un(n){Ie.push(n),Ie.length>cn&&Ie.shift()}function ls(n,e,t){const s={code:n,message:e,url:typeof location<"u"?location.href:"",context:[...Ie],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Te.push(s),hn()}function hn(){ue||(ue=setTimeout(ds,5e3))}function ds(){if(ue&&(clearTimeout(ue),ue=null),Te.length===0)return;const n=Te;Te=[];for(const e of n){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${st}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${st}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ds()});const pn=3e4,mn=2,ve=new Map,cs=new WeakMap;function fn(n){if(n instanceof K)return n.traceId;if(n!=null&&typeof n=="object")return cs.get(n)}async function y(n){if(n.method==="GET"){const e=ve.get(n.url);if(e)return e;const t=$t(n,mn);return ve.set(n.url,t),t.then(()=>ve.delete(n.url),()=>ve.delete(n.url)),t}return $t(n,0)}async function $t(n,e){const t=n.timeout??pn;let s;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await bn(gn(n,r),t)}catch(a){if(s=a,!(a instanceof K)&&a!=null&&typeof a=="object"&&cs.set(a,r),a instanceof K||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw s}async function gn(n,e){const t={"X-Trace-Id":e},s={method:n.method,headers:t};n.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(n.body));const i=await fetch(n.url,s),r=i.headers.get("x-trace-id")??e;if(un({type:"api",detail:`${n.method} ${n.url}`,timestamp:new Date().toISOString()}),!i.ok){const a=await i.json().catch(()=>({error:i.statusText}));throw new K(i.status,a.error??i.statusText,a.details,r)}return i.json()}function bn(n,e){let t;const s=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([n,s]).finally(()=>clearTimeout(t))}const it=new Set;let Ge=!1;function yn(n){return it.add(n),()=>{it.delete(n)}}function _n(){if(!Ge){Ge=!0;try{for(const n of[...it])try{n()}catch(e){try{ls("session-listener",vn(e))}catch{}}}finally{Ge=!1}}}function vn(n){try{if(n instanceof Error){const e=n.message;if(typeof e=="string")return e}return String(n)}catch{return"listener threw a value that could not be described"}}async function z(n,e,t,s={}){me(()=>{n.set(!0),e.set(null)});try{const i=await t();return n.set(!1),i}catch(i){const r=wn(i);me(()=>{n.set(!1),e.set(r)}),ls(r.code,r.message,fn(i)),r.code==="auth"&&s.sessionExpiry!==!1&&_n();return}}function wn(n){return n instanceof K?n.status===401?{code:"auth",message:"Unauthorized"}:n.status===409?{code:"conflict",message:"Data has changed — please try again"}:n.status===400?{code:"validation",message:n.message}:n.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:n instanceof Error?n.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const qe={sessionExpiry:!1};function xn(n){return{me:()=>y({method:"GET",url:`${n}/auth/me`}),login:e=>y({method:"POST",url:`${n}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${n}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${n}/auth/logout-all`,body:{}})}}class H{constructor(){this.api=xn(st),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=yn(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=on(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await z(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await z(this.loading,this.error,()=>this.api.login({username:e,password:t}),qe);return s?(this.currentUser.set(s),!0):!1}async logout(){await z(this.loading,this.error,()=>this.api.logout(),qe);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await z(this.loading,this.error,()=>this.api.logoutAll(),qe),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const us={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},$n={...us,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},kn={...us,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Sn=ss($n,Ws),Cn=ss(kn,Ys),o=nn(Sn,Cn),E=n=>`var(--${n})`,$=(n,e)=>`var(--${n}, ${e})`,k=n=>{const e=Le[n];if(e===void 0)throw new Error(`unknown control token: --${n}`);return e},l=en({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),we=n=>`
    background: ${$(`btn-${n}-bg`,k(`btn-${n}-bg`))};
    color: ${$(`btn-${n}-fg`,k(`btn-${n}-fg`))};
    border-color: ${$(`btn-${n}-border`,k(`btn-${n}-border`))};
    box-shadow: ${$(`btn-${n}-shadow`,k(`btn-${n}-shadow`))};
    &:hover {
        background: ${$(`btn-${n}-bg-hover`,k(`btn-${n}-bg-hover`))};
        color: ${$(`btn-${n}-fg-hover`,k(`btn-${n}-fg-hover`))};
        border-color: ${$(`btn-${n}-border-hover`,k(`btn-${n}-border-hover`))};
    }`,hs=`
    ...
    cursor: not-allowed;`,In={primary:we("primary"),secondary:we("secondary"),ghost:we("ghost"),danger:we("danger"),disabled:hs},C=(n=$("btn-radius",k("btn-radius")),e="secondary")=>`
    /*
    ...
    ${In[e]}
    &:disabled {${hs}}
`,Tn=`max(${$("field-border-width",k("field-border-width"))}, ${$("field-rule-width",k("field-rule-width"))})`,xe=(n,e)=>`
    border-top-color: ${n};
    ...
    border-bottom-width: ${Tn};
    ${xe($("field-border",k("field-border")),$("field-rule",k("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${xe($("field-focus-border",k("field-focus-border")),$("field-focus-border",k("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${xe($("field-invalid-border",k("field-invalid-border")),$("field-invalid-rule",k("field-invalid-rule")))}
    }
...
`;function Nn(n){return{async me(){return y({method:"GET",url:`${n}/players/me`})},async register(e){return y({method:"POST",url:`${n}/players/register`,body:e})},async updateHandicap(e){return y({method:"POST",url:`${n}/players/me/handicap`,body:e})},async confirmHandicap(){return y({method:"POST",url:`${n}/players/me/handicap/confirm`,body:{}})},async myHandicapHistory(){return y({method:"GET",url:`${n}/players/me/handicap-history`})},async updateProfile(e){return y({method:"POST",url:`${n}/players/me/profile`,body:e})},async search(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/players/search${s?"?"+s:""}`})}}}function Pn(n){return{async list(){return y({method:"GET",url:`${n}/friends`})},async add(e){return y({method:"POST",url:`${n}/friends`,body:e})},async remove(e){return y({method:"DELETE",url:`${n}/friends/${e.friendId}`})}}}function On(n){return{async list(){return y({method:"GET",url:`${n}/clubs`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/clubs/get${s?"?"+s:""}`})},async create(e){return y({method:"POST",url:`${n}/clubs`,body:e})},async update(e){return y({method:"POST",url:`${n}/clubs/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${n}/clubs/${e.id}`})}}}function Rn(n){return{async list(){return y({method:"GET",url:`${n}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/courses/by-club${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/courses/get${s?"?"+s:""}`})},async create(e){return y({method:"POST",url:`${n}/courses`,body:e})},async update(e){return y({method:"POST",url:`${n}/courses/update`,body:e})},async updateHole(e){return y({method:"POST",url:`${n}/courses/holes/update`,body:e})},async validate(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/courses/validate${s?"?"+s:""}`})},async remove(e){return y({method:"DELETE",url:`${n}/courses/${e.id}`})}}}function zn(n){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/tees/by-course${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/tees/get${s?"?"+s:""}`})},async create(e){return y({method:"POST",url:`${n}/tees`,body:e})},async update(e){return y({method:"POST",url:`${n}/tees/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${n}/tees/${e.id}`})}}}function jn(n){return{async create(e){return y({method:"POST",url:`${n}/guest-players`,body:e})}}}function Ln(n){return{async latest(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/handicap/latest${s?"?"+s:""}`})},async history(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/handicap/history${s?"?"+s:""}`})},async record(e){return y({method:"POST",url:`${n}/handicap/record`,body:e})}}}function An(n){return{async list(){return y({method:"GET",url:`${n}/rounds`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/rounds/balls${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/rounds/get${s?"?"+s:""}`})},async create(e){return y({method:"POST",url:`${n}/rounds`,body:e})},async createFromDraft(e){return y({method:"POST",url:`${n}/rounds/from-draft`,body:e})},async update(e){return y({method:"POST",url:`${n}/rounds/update`,body:e})},async remove(e){return y({method:"DELETE",url:`${n}/rounds/${e.id}`})}}}function Dn(n){return{async listByRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/score-events/by-round${s?"?"+s:""}`})},async append(e){return y({method:"POST",url:`${n}/score-events`,body:e})}}}function Mn(n){return{async forBall(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/scorecards/for-ball${s?"?"+s:""}`})},async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/scorecards/for-round${s?"?"+s:""}`})}}}function Hn(n){return{async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/leaderboards/for-round${s?"?"+s:""}`})}}}function Fn(n){return{async create(e){return y({method:"POST",url:`${n}/friendly-rounds`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/by-token${s?"?"+s:""}`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/balls${s?"?"+s:""}`})},async scorecard(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/scorecard${s?"?"+s:""}`})},async result(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/result${s?"?"+s:""}`})},async score(e){return y({method:"POST",url:`${n}/friendly-rounds/score`,body:e})},async setup(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/setup${s?"?"+s:""}`})},async editSetup(e){return y({method:"POST",url:`${n}/friendly-rounds/setup`,body:e})},async remove(e){return y({method:"DELETE",url:`${n}/friendly-rounds/${e.token}`})},async finish(e){return y({method:"POST",url:`${n}/friendly-rounds/finish`,body:e})},async reopen(e){return y({method:"POST",url:`${n}/friendly-rounds/reopen`,body:e})},async join(e){return y({method:"POST",url:`${n}/friendly-rounds/join`,body:e})},async leave(e){return y({method:"POST",url:`${n}/friendly-rounds/leave`,body:e})},async claimGuest(e){return y({method:"POST",url:`${n}/friendly-rounds/claim-guest`,body:e})},async renameGuest(e){return y({method:"POST",url:`${n}/friendly-rounds/rename-guest`,body:e})},async claimSeat(e){return y({method:"POST",url:`${n}/friendly-rounds/claim-seat`,body:e})},async releaseSeat(e){return y({method:"POST",url:`${n}/friendly-rounds/release-seat`,body:e})}}}function Bn(n){return{async myRounds(){return y({method:"GET",url:`${n}/dashboard/my-rounds`})}}}function Gn(n){return{async clubs(){return y({method:"GET",url:`${n}/setup/clubs`})},async courses(){return y({method:"GET",url:`${n}/setup/courses`})},async teesByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/setup/tees/by-course${s?"?"+s:""}`})},async formats(){return y({method:"GET",url:`${n}/setup/formats`})},async aggregations(){return y({method:"GET",url:`${n}/setup/aggregations`})}}}function qn(n){return{async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/competitions/get${s?"?"+s:""}`})},async participants(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/competitions/participants${s?"?"+s:""}`})},async leaderboard(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[r,a]of Object.entries(e))!t.has(r)&&a!==void 0&&s.set(r,String(a));const i=s.toString();return y({method:"GET",url:`${n}/competitions/${e.id}/leaderboard${i?"?"+i:""}`})},async results(e){const t=new Set(["id"]),s=new URLSearchParams;for(const[r,a]of Object.entries(e))!t.has(r)&&a!==void 0&&s.set(r,String(a));const i=s.toString();return y({method:"GET",url:`${n}/competitions/${e.id}/results${i?"?"+i:""}`})},async list(){return y({method:"GET",url:`${n}/competitions`})},async create(e){return y({method:"POST",url:`${n}/competitions`,body:e})},async update(e){return y({method:"POST",url:`${n}/competitions/update`,body:e})},async transition(e){return y({method:"POST",url:`${n}/competitions/transition`,body:e})},async createRound(e){const t=new Set(["id"]),s={};for(const[i,r]of Object.entries(e))t.has(i)||(s[i]=r);return y({method:"POST",url:`${n}/competitions/${e.id}/rounds`,body:s})},async applyCut(e){const t=new Set(["id"]),s={};for(const[i,r]of Object.entries(e))t.has(i)||(s[i]=r);return y({method:"POST",url:`${n}/competitions/${e.id}/cut`,body:s})},async finalize(e){const t=new Set(["id"]),s={};for(const[i,r]of Object.entries(e))t.has(i)||(s[i]=r);return y({method:"POST",url:`${n}/competitions/${e.id}/finalize`,body:s})},async addParticipant(e){return y({method:"POST",url:`${n}/competitions/participants/add`,body:e})},async removeParticipant(e){return y({method:"POST",url:`${n}/competitions/participants/remove`,body:e})},async withdrawParticipant(e){return y({method:"POST",url:`${n}/competitions/participants/withdraw`,body:e})}}}function Kn(n){return{async myRoles(){return y({method:"GET",url:`${n}/me/roles`})},async adminStats(){return y({method:"GET",url:`${n}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/admin/rounds${s?"?"+s:""}`})},async adminPlayers(){return y({method:"GET",url:`${n}/admin/players`})},async adminGrantRole(e){return y({method:"POST",url:`${n}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return y({method:"POST",url:`${n}/admin/roles/revoke`,body:e})}}}function Vn(n){return{async myConfig(){return y({method:"GET",url:`${n}/players/me/stats-config`})},async putMyConfig(e){return y({method:"PUT",url:`${n}/players/me/stats-config`,body:e})},async myStats(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/players/me/stats${s?"?"+s:""}`})},async myRoundStats(e){const t=new Set(["roundId"]),s=new URLSearchParams;for(const[r,a]of Object.entries(e))!t.has(r)&&a!==void 0&&s.set(r,String(a));const i=s.toString();return y({method:"GET",url:`${n}/players/me/rounds/${e.roundId}/stats${i?"?"+i:""}`})},async appendEvents(e){return y({method:"POST",url:`${n}/friendly-rounds/stat-events`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/stats${s?"?"+s:""}`})},async configsByToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const s=t.toString();return y({method:"GET",url:`${n}/friendly-rounds/stats-configs${s?"?"+s:""}`})}}}const D="/tapscore/".replace(/\/+$/,"")+"/api",v={players:Nn(D),friends:Pn(D),clubs:On(D),courses:Rn(D),tees:zn(D),guestPlayers:jn(D),handicap:Ln(D),rounds:An(D),scoreEvents:Dn(D),scorecards:Mn(D),leaderboards:Hn(D),friendlyRounds:Fn(D),dashboard:Bn(D),setup:Gn(D),competitions:qn(D),admin:Kn(D),playerStats:Vn(D)};function Un(n){return[...n.played?["Played"]:[],...n.created?["Created"]:[]].join(" · ")}function Wn(n,e){const t=new Map;for(const s of e)t.set(s.round.id,{round:s.round,token:s.friendlyRound.shareToken,played:!1,created:!0});for(const s of n){const i=t.get(s.round.id);i?i.played=!0:t.set(s.round.id,{round:s.round,token:s.shareToken,played:!0,created:!1})}return[...t.values()].sort((s,i)=>i.round.date.localeCompare(s.round.date)||s.round.id.localeCompare(i.round.id))}function Yn(n,e){return n.filter(t=>t.played&&!t.created&&!e.has(t.round.id)).slice().sort((t,s)=>s.round.date.localeCompare(t.round.date)||t.round.id.localeCompare(s.round.id))}function kt(n,e){return n.some(t=>t.round.id===e)?n.filter(t=>t.round.id!==e):n}function G(){try{return globalThis.localStorage??null}catch{return null}}function Ae(n,e,t){return{read(s=G()){if(!s)return e.empty;let i;try{i=s.getItem(n)}catch{return e.empty}if(!i)return e.empty;try{return e.decode(i)}catch{return e.empty}},write(s,i=G()){if(!i)return e.empty;const r=t!==void 0&&Array.isArray(s)?s.slice(0,t):s;try{i.setItem(n,e.encode(r))}catch{}return r}}}function dt(n){return{decode(e){const t=JSON.parse(e);return Array.isArray(t)?t.filter(n):[]},encode:e=>JSON.stringify(e),get empty(){return[]}}}const Qn=500,ct=Ae("tapscore.seen-rounds.v1",dt(n=>typeof n=="string"),Qn);function De(n=G()){return ct.read(n)}function Ke(n=G()){return new Set(De(n))}function Xn(n,e=G()){return De(e).includes(n)}function Jn(n,e=G()){if(!e)return[];const t=De(e).filter(s=>s!==n);return ct.write([n,...t],e)}function ps(n,e=G()){if(!e)return[];const t=De(e),s=t.filter(i=>i!==n);return s.length!==t.length&&ct.write(s,e),s}const Zn=50,ut=Ae("tapscore.device-rounds.v1",dt(ei),Zn);function Me(n=G()){return ut.read(n)}function ei(n){if(typeof n!="object"||n===null)return!1;const e=n;return typeof e.token=="string"&&typeof e.courseName=="string"&&(e.status==="not_started"||e.status==="active"||e.status==="complete")&&typeof e.lastSeenAt=="string"}function de(n,e=G()){if(!e)return[];const t=Me(e).filter(s=>s.token!==n.token);return ut.write([n,...t],e)}function ms(n,e=G()){if(!e)return[];const t=Me(e),s=t.filter(i=>i.token!==n);return s.length!==t.length&&ut.write(s,e),s}class He{mine=new p(null);mineLoading=new p(!1);mineError=new p(null);myRounds=new S(()=>{const e=this.mine.get();return e?Wn(e.produced,e.created):[]});deviceRounds=new p([]);seenIds=new p(Ke());newRounds=new S(()=>Yn(this.myRounds.get(),this.seenIds.get()));async loadMine(){this.seenIds.set(Ke());const e=await z(this.mineLoading,this.mineError,()=>v.dashboard.myRounds());e&&this.mine.set(e)}loadDevice(){this.deviceRounds.set(Me())}clear(){this.mine.set(null),this.mineError.set(null),this.mineLoading.set(!1),this.seenIds.set(Ke()),this.loadDevice()}async remove(e,t){try{await v.friendlyRounds.remove({token:e})}catch{return!1}const s=this.mine.get();return s&&this.mine.set({produced:kt(s.produced,t),created:kt(s.created,t)}),this.deviceRounds.set(ms(e)),ps(t),!0}}const ti={DEV:!1};function si(n,e){return n===void 0||n===""?e:n!=="0"&&n.toLowerCase()!=="false"}const St=ti??{},fs={competitions:si(St.VITE_FEATURE_COMPETITIONS,!!St.DEV)},ni='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5 12 4l8 7.5"/><path d="M6 10v10h12V10"/><path d="M10 20v-5.5h4V20"/></svg>',ii='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M3.5 20c.5-3.5 2.7-5.5 5.5-5.5s5 2 5.5 5.5"/><circle cx="16.5" cy="9.5" r="2.8"/><path d="M16.8 14.6c2.2.4 3.5 2 3.9 4.9"/></svg>',ri='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4h8v3a4 4 0 0 1-8 0V4Z"/><path d="M8 5H5v2a3 3 0 0 0 3 3"/><path d="M16 5h3v2a3 3 0 0 1-3 3"/><path d="M10 12.5V15h4v-2.5"/><path d="M9 20h6"/><path d="M12 15v5"/></svg>';function ai(n){const e=[{key:"home",label:"Home",href:"/",icon:ni},{key:"friends",label:"Friends",href:"/friends",icon:ii}];return n.competitions&&e.push({key:"comps",label:"Comps",href:"/competitions",icon:ri}),e}const oi=["/login","/round"];function gs(n){return!oi.includes(n)}function li(n,e){return e&&gs(n)}const di=_(`
...
`);class ui extends R{static styles=`
        .tabbar {
            display: flex;
    ...
    `;router=this.inject(M);auth=this.inject(H);landing=this.inject(He);newCount=new S(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(di,{root:{className:()=>li(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"}}),t=ai(fs);return this.$each(this.ref(e,"root"),()=>t,(s,i,r)=>this.wireEl(ci,{link:{...this.router.link(s.href),href:s.href},icon:{innerHTML:()=>s.icon},label:()=>s.label,badge:{textContent:()=>{if(s.key!=="home")return"";const a=this.newCount.get();return a===0?"":String(a)},className:()=>(s.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},r),s=>s.key),e}}const bs=["tee","approach","putting","shortGame","penalties","recovery"],Ee={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function ys(n){switch(n){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function hi(n){switch(n){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const pi="Track statistics",mi="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function _s(n){switch(n){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Oe(n,e){return n[e]}function fi(n,e){if(!n.enabled)return!0;const t=_s(e);return t===null?!1:!Oe(n,t)}function gi(n,e){if(!n.enabled)return null;const t=_s(e);return t===null||Oe(n,t)?null:`Needs ${ys(t)}`}function bi(n,e,t){return _i({...n,[e]:t})}function yi(n,e){return{...n,enabled:e}}function _i(n){const e={...n};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function Ve(n){const e={...Ee,enabled:n.enabled};for(const t of bs)e[t]=n[t];return e}class ye{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(Ee);statsSaving=new p(!1);statsError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await z(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null)]));if(!t)return;const[s,i,r,a]=t;this.player.set(s),this.history.set(i),this.clubs.set(r),this.statsConfig.set(a?Ve(a):Ee)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Ee),this.statsError.set(null)}async saveIndex(e){return await z(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await z(this.saving,this.saveError,()=>v.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await z(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await z(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await z(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(Ve(e)));return t?(this.statsConfig.set(Ve(t)),!0):!1}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function Ue(n,e){return n.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function ht(n,e="frecency"){return e==="alpha"?[...n].sort(Ue):[...n].sort((t,s)=>{const i=t.frecency,r=s.frecency,a=i>0,d=r>0;if(a!==d)return a?-1:1;if(!a)return Ue(t,s);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=s.lastPlayedAt?Date.parse(s.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:Ue(t,s)})}const vi=1440*60*1e3;function wi(n,e){if(!n)return null;const t=Date.parse(n),s=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(s))return null;const i=Math.floor((s-t)/vi);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function xi(n,e){if(n.sharedRoundCount<=0)return"never played";const t=wi(n.lastPlayedAt,e),s=`played ${n.sharedRoundCount}×`;return t?`${s}, ${t}`:s}const vs=2;function Ct(n){return n.trim().length>=vs}function ws(n){return ht(n,"frecency")}function $i(n,e){return ws([...n.filter(t=>t.id!==e.id),e])}function ki(n,e){return n.filter(t=>t.id!==e)}function It(n,e,t){return n.map(s=>s.id===e?{...s,isFriend:t}:s)}function Si(n,e,t=()=>{},s=300){let i=0,r;return a=>{const d=a.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<vs){e(d,[]);return}r=setTimeout(()=>{n(d).then(u=>{c===i&&e(d,u)},u=>{c===i&&t(d,u)})},s)}}const xs=Ae("tapscore.friends.sort.v1",{decode:n=>n==="alpha"?"alpha":"frecency",encode:n=>n,empty:"frecency"});function Ci(n=G()){return xs.read(n)}function Ii(n,e=G()){xs.write(n,e)}class Fe{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(Ci());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Si(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await z(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(ws(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await z(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set($i(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,sharedRoundCount:0,lastPlayedAt:null,frecency:0})),this.results.set(It(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),Ii(e)}async remove(e){await z(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(ki(this.friends.get(),e)),this.results.set(It(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class $s{roles=new p([]);rolesLoaded=!1;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}async loadRoles(e=!1){if(!(!e&&this.rolesLoaded)){this.rolesLoaded=!0;try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}}}clear(){this.roles.set([]),this.rolesLoaded=!1,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await z(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[s,i,r]=t;this.stats.set(s),this.rounds.set(i),this.players.set(r)}}const bt=class bt extends R{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(N(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};bt.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let rt=bt;const T=n=>`var(--${n})`,yt=class yt extends R{render(){const e=document.createElement("div"),t=(c,u)=>{typeof u=="function"?this.track(N(()=>{c.textContent=u()})):c.textContent=u};this.spawn(rt,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200";const s=document.createElement("h2");s.className="ui-confirm__title",t(s,this.props.title??"Confirm"),this.dialogEl.appendChild(s);const i=document.createElement("p");i.className="ui-confirm__message",t(i,this.props.message),this.dialogEl.appendChild(i);const r=document.createElement("div");r.className="ui-confirm__actions";const a=document.createElement("button");a.className="ui-confirm__btn ui-confirm__btn--cancel",t(a,this.props.cancelLabel??"Cancel"),a.addEventListener("click",c=>{c.stopPropagation(),this.handleCancel()}),r.appendChild(a);const d=document.createElement("button");return d.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(d,this.props.confirmLabel??"Confirm"),d.addEventListener("click",c=>{c.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),r.appendChild(d),this.dialogEl.appendChild(r),this.dialogEl.addEventListener("click",c=>c.stopPropagation()),e.appendChild(this.dialogEl),this.track(N(()=>{this.dialogEl.classList.toggle("open",this.props.open.get())})),e}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}};yt.styles=`
        .ui-confirm {
            position: fixed;
            top: 50%;
            left: 50%;
    ...
    `;let U=yt;async function Ti(n,e={}){e.everywhere?await n.auth.logoutEverywhere():await n.auth.logout(),n.profile.clear(),n.friends.clear(),n.admins.clear(),n.landing.clear(),n.navigate("/")}function Ei(n){if(!n.signedIn)return[];const e=[{kind:"identity",displayName:(n.displayName??"").trim()||(n.username??"").trim()||"Signed in",username:(n.username??"").trim()},{kind:"profile",label:"Profile"}];return n.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Ni(n){return Ei(n).map(e=>e.kind)}function Tt(n){return n.signedIn?"avatar":"signin"}function Pi(n,e){const t=(n??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return($e(t[0])+$e(t[t.length-1])).toUpperCase();if(t.length===1)return $e(t[0]).toUpperCase();const s=(e??"").trim();return s.length>0?$e(s).toUpperCase():"•"}function $e(n){return[...n][0]??""}const Oi=_(`
...
`);class Ri extends R{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
    ...
    `;auth=this.inject(H);profile=this.inject(ye);friends=this.inject(Fe);admins=this.inject($s);landing=this.inject(He);router=this.inject(M);open=new p(!1);state=new S(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));signOutAllOpen=new p(!1);has(e){return Ni(this.state.get()).includes(e)}rowClass(e,t=""){const s=`acct__row${t}`;return this.has(e)?s:`${s} hidden`}async signOut(e={}){await Ti({auth:this.auth,profile:this.profile,friends:this.friends,admins:this.admins,landing:this.landing,navigate:t=>this.router.navigate(t)},e)}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(Oi,{signin:{className:()=>Tt(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},avatar:{className:()=>Tt(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden",textContent:()=>{const u=this.state.get();return Pi(u.displayName,u.username)},"aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const u=this.state.get();return(u.displayName??"").trim()||(u.username??"").trim()||"Signed in"},idUser:()=>{const u=(this.state.get().username??"").trim();return u===""?"":`@${u}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOut()}},signoutAll:{className:()=>this.rowClass("signout-all"," acct__row--quiet"),onclick:()=>{this.open.set(!1),this.signOutAllOpen.set(!0)}}});this.spawn(U,this.ref(e,"confirmHost"),{open:this.signOutAllOpen,title:"Sign out everywhere?",message:"Every device signed in to this account is signed out, including this one. Rounds and scores are untouched — you can sign back in with your password.",confirmLabel:"Sign out everywhere",cancelLabel:"Cancel",onconfirm:()=>{this.signOut({everywhere:!0})}});const t=this.ref(e,"root"),s=e.querySelector('[bind="avatar"]'),i=u=>{u.key==="Escape"&&this.open.get()&&(this.open.set(!1),s?.focus())},r=u=>{if(!this.open.get())return;const f=u.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let a=!1;const d=()=>{a||(a=!0,window.addEventListener("keydown",i),document.addEventListener("pointerdown",r,!0))},c=()=>{a&&(a=!1,window.removeEventListener("keydown",i),document.removeEventListener("pointerdown",r,!0))};return this.track(N(()=>{this.open.get()?d():c()})),this.track(c),e}}function zi(n){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function re(){return zi()}const Ne=10;class fe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await z(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=re()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=re()){return e.labels?.[t]??e.labels?.en??""}presets(e=re()){return this.descriptors.get().filter(s=>s.preset).sort((s,i)=>{const r=s.preset?.rank??Number.POSITIVE_INFINITY,a=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==a?r-a:(this.labelOf(s,e)??s.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=re()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{},i=s.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:s.teamSize?.min??2,max:s.teamSize?.max??2}}}if(t.slotBallCount){const s=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:s?Ne:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function ks(n){const e=B.get(fe);return e.load(),e.labelOf(n.formatId)??`${n.scoringMode} · ${n.teamShape}`}function ji(n){return n.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:Un(e)||null,date:e.round.date,formats:e.round.formatSlots.map(ks).join(" · ")}))}function Li(n){return n.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:e.date??null,formats:null}))}function ge(n){const e=(n.name??"").trim();return e||n.courseName||"Round"}function Re(n){return n.courseName?ge(n)===n.courseName?null:n.courseName:null}function Ss(n,e=typeof navigator>"u"?"en":navigator.language){return n?/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n:""}const he={fromMyRounds:ji,fromDeviceRounds:Li},Ai=14,Di=1440*60*1e3;function oe(n,e){return e(n)}function Mi(n,e,t,s=Ai){const i=e-s*Di,r=[],a=[];for(const d of n){const c=oe(d,t);if(c.status==="complete"){const u=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(u)||u>=i)&&a.push(d)}else r.push(d)}return r.sort((d,c)=>Et(oe(d,t).lastActivityAt,oe(c,t).lastActivityAt)),a.sort((d,c)=>Et(oe(d,t).completedAt,oe(c,t).completedAt)),{ongoing:r,finished:a}}function Et(n,e){const t=n?Date.parse(n):NaN,s=e?Date.parse(e):NaN,i=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return i===r?0:r-i}const Hi=_(`
    <div class="landing">
...
`),Fi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Bi=_(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Fi}</button>
    </div>
`),Cs={not_started:"Not started",active:"Live",complete:"Finished"};class Nt extends R{static styles=`
        .landing {
    ...
    `;svc=this.inject(He);auth=this.inject(H);router=this.inject(M);loggedIn=new S(()=>this.auth.currentUser.get()!==null);rows=new S(()=>this.loggedIn.get()?he.fromMyRounds(this.svc.myRounds.get()):he.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new S(()=>Mi(this.rows.get(),Date.now(),e=>e));ongoing=new S(()=>this.parts.get().ongoing);finished=new S(()=>this.parts.get().finished);newRows=new S(()=>this.loggedIn.get()?he.fromMyRounds(this.svc.newRounds.get()):[]);deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=()=>this.rows.get().length>0,t=this.wire(Hi,{createBtn:{onclick:()=>this.router.navigate("/create")},history:{className:()=>e()?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const i=this.newRows.get().length;return i===0?"":String(i)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block":"landing__section-block hidden"},ongoingCount:()=>{const i=this.ongoing.get().length;return i===0?"":String(i)},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block":"landing__section-block hidden"},finishedCount:()=>{const i=this.finished.get().length;return i===0?"":String(i)},empty:{className:()=>e()?"landing__empty hidden":"landing__empty"}});this.$each(this.ref(t,"newList"),this.newRows,(i,r,a)=>this.roundRow(i,a),i=>i.key),this.$each(this.ref(t,"ongoingList"),this.ongoing,(i,r,a)=>this.roundRow(i,a),i=>i.key),this.$each(this.ref(t,"finishedList"),this.finished,(i,r,a)=>this.roundRow(i,a),i=>i.key),this.spawn(U,this.ref(t,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const i=this.deleteTarget.get();return`Delete ${i?`“${i.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const i=this.deleteTarget.get();i&&this.svc.remove(i.token,i.roundId)}});const s=i=>{i.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",s),this.track(()=>window.removeEventListener("keydown",s)),t}roundRow(e,t){return this.wireEl(Bi,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>ge(e),course:{textContent:()=>Re(e)??"",className:()=>Re(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>Cs[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>Ss(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",ge(e))}}},t)}}function Gi(n){return[...n].sort((e,t)=>{const s=Pt(e),i=Pt(t);return i!==s?i-s:e.key.localeCompare(t.key)})}function Pt(n){const e=n.completedAt??n.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const qi=_(`
    <div class="history">
...
`),Ki='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Vi=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="title" class="round-row__title"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Ki}</button>
    </div>
`);class Ui extends R{static styles=`
        .history {
    ...
    `;svc=this.inject(He);auth=this.inject(H);router=this.inject(M);loggedIn=new S(()=>this.auth.currentUser.get()!==null);rows=new S(()=>Gi(this.loggedIn.get()?he.fromMyRounds(this.svc.myRounds.get()):he.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(qi,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(s,i,r)=>this.roundRow(s,r),s=>s.key),this.spawn(U,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const s=this.deleteTarget.get();return`Delete ${s?`“${s.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const s=this.deleteTarget.get();s&&this.svc.remove(s.token,s.roundId)}});const t=s=>{s.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(Vi,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>ge(e),course:{textContent:()=>Re(e)??"",className:()=>Re(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>Cs[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>Ss(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",ge(e))}}},t)}}function Is(n){return n.handicapIndex*(n.slope/113)+(n.courseRating-n.par)}function Wi(n){return Math.round(Is(n))}function Yi(n,e,t){const s=t;if(s<=0)return 0;if(n>=0){const c=Math.floor(n/s),u=n-c*s;return c+(e>=1&&e<=u?1:0)}const i=-n,r=Math.floor(i/s),a=i-r*s,d=r+(e>s-a?1:0);return d===0?0:-d}const Qi=180,Ot=4,Xi=12;function ae(n,e){return e<=0?0:Math.max(0,Math.min(e-1,n))}function Ji(n){const{dragDistance:e,velocity:t,itemWidth:s}=n;if(Math.abs(e)<Xi)return 0;const i=e+t*Qi,r=Math.round(-i/s);return Math.max(-Ot,Math.min(Ot,r))}const Rt="tapscore:pending-scores:v1",Zi=336*60*60*1e3,zt=200;function er(){try{return globalThis.localStorage??null}catch{return null}}function tr(n){if(typeof n!="object"||n===null)return!1;const e=n;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class sr{entries=[];storage;constructor(e=er(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=Zi);return t.length>zt?t.slice(t.length-zt):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Rt);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(tr):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Rt,JSON.stringify(this.entries))}catch{}}}const Q=["tee_result","recovery_ok","gir","short_game_difficulty","first_putt","putts","penalties"],nr={minPar:4},ir={tee_result:"Tee shot",recovery_ok:"Recovery",gir:"Green in regulation",short_game_difficulty:"Short game",first_putt:"First putt",putts:"Putts",penalties:"Penalties"},rr={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"}]},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null}};function ar(n){return ir[n]}function jt(n){return rr[n]}function or(n,e){return e!==null&&n>=e?`${n}+`:`${n}`}function Ts(n,e,t){return n?!(n.minPar!=null&&e<n.minPar||n.maxPar!=null&&e>n.maxPar||n.pars!=null&&!n.pars.includes(e)||n.holes!=null&&!n.holes.includes(t)):!0}class lr{modules;par;holeNumber;persistedMap;draft=new Map;constructor(e,t,s,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=s,this.persistedMap=Lt(i),this.draft=new Map(r),this.prune()}refresh(e,t){const s=this.signature();return this.modules=e,this.persistedMap=Lt(t),this.prune(),this.signature()!==s}signature(){let e="";for(const t of Q)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e}get prompts(){const e=[];for(const t of Q)this.isVisible(t)&&e.push({key:t,label:ar(t),control:jt(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Ts(nr,this.par,this.holeNumber)?"visible":"unreadable";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const s=Number.parseInt(t,10);return Number.isNaN(s)?null:s}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(this.record(e,t),this.prune())}step(e,t){const s=jt(e);if(!this.isVisible(e)||s.kind!=="stepper")return;let i=(this.intValue(e)??s.min)+t;i<s.min&&(i=s.min),s.max!==null&&i>s.max&&(i=s.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<Q.length;e++){let t=!1;for(const s of Q){const i=this.draft.get(s),r=this.visibility(s);r!=="visible"&&(r==="contradicted"?this.record(s,null):this.draft.delete(s),dr(i,this.draft.get(s))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of Q){const s=this.draft.get(t);s!==void 0&&e.push({key:t,value:"set"in s?s.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function dr(n,e){return n===void 0||e===void 0?n===e:"set"in n?"set"in e&&n.set===e.set:!("set"in e)}function Lt(n){if(n instanceof Map)return new Map(n);const e=new Map;for(const t of Q){const s=n[t];s!==void 0&&e.set(t,s)}return e}const At="tapscore:pending-stat-events:v1",cr=336*60*60*1e3,Dt=500;function ur(){try{return globalThis.localStorage??null}catch{return null}}function hr(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function pr(n){if(typeof n!="object"||n===null)return!1;const e=n;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&Q.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class mr{entries=[];storage;makeId;constructor(e=ur(),t=Date.now(),s=hr){this.storage=e,this.makeId=s,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,s,i,r=Date.now()){if(i.length===0)return[];const a=[];for(const d of i){const c={token:e,playHoleId:t,playerId:s,key:d.key,value:d.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===s&&f.key===d.key);u>=0?this.entries[u]=c:this.entries.push(c),a.push(c)}return this.entries=this.applyHygiene(r),this.persist(),a}ack(e){if(e.length===0)return;const t=new Set(e),s=this.entries.filter(i=>!t.has(i.clientEventId));s.length!==this.entries.length&&(this.entries=s,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=cr);return t.length>Dt?t.slice(t.length-Dt):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(At);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(pr):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(At,JSON.stringify(this.entries))}catch{}}}const fr=50;function gr(n){if(typeof n!="object"||n===null)return!1;const e=n;return typeof e.token=="string"&&typeof e.cursor=="string"}const pt=Ae("tapscore.result-cursors.v1",dt(gr),fr);function mt(n=G()){return pt.read(n)}function br(n,e=G()){return mt(e).find(t=>t.token===n)?.cursor??null}function yr(n,e,t=G()){if(!t)return[];const s=mt(t).filter(i=>i.token!==n);return pt.write([{token:n,cursor:e},...s],t)}function _r(n,e=G()){if(!e)return[];const t=mt(e),s=t.filter(i=>i.token!==n);return s.length!==t.length&&pt.write(s,e),s}const vr=["1st","2nd","3rd","4th","5th","6th","7th","8th"],ee=(n,e)=>`${n}|${e}`;function Es(n){return n.players.map(e=>e.displayName).join(" & ")||n.label||"Ball"}function wr(n,e,t){return Ts(n,e,t)}function We(n,e){return`${n.playHoleId}:${n.playerId}:${e}`}function xr(n){const e=new Map;return n.teeResult!==null&&e.set("tee_result",n.teeResult),n.recoveryOk!==null&&e.set("recovery_ok",n.recoveryOk?"1":"0"),n.gir!==null&&e.set("gir",n.gir?"1":"0"),n.shortGameDifficulty!==null&&e.set("short_game_difficulty",n.shortGameDifficulty),n.firstPutt!==null&&e.set("first_putt",n.firstPutt),n.putts!==null&&e.set("putts",String(n.putts)),n.penalties!==null&&e.set("penalties",String(n.penalties)),e}function $r(n){const e=n?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class J{constructor(e=new sr,t=new mr){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const i=++this.loadSeq;s&&this.resetForNewToken(t),B.get(fe).load();const r=await z(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),de({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!Xn(r.round.id))),B.get(H).currentUser.get()&&Jn(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[a,d,c,u]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[]),v.playerStats.configsByToken({token:e}).catch(()=>null),v.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(d),this.balls.set(a),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),ms(e);const t=this.round.get()?.id;return t&&ps(t),_r(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:t.completedAt}),de({token:e,courseName:s.courseNameSnapshot??"",name:s.name,date:s.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:null}),de({token:e,courseName:s.courseNameSnapshot??"",name:s.name,date:s.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await z(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,s=this.loadSeq;let i;try{i=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||s!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,s=this.loadSeq,i=()=>t!==this.quietSeq||s!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const a=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(a===null||i())return;this.balls.set(a)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?br(e):null}setResultCursor(e,t){const s=t!==null&&t!==this.resultCursor;this.resultCursor=t,s&&yr(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,s.cursor),s.unchanged||this.result.set(s.result))}onLiveResultEvent(e){const t=this.token,s=this.round.get();if(t&&s&&e.status!==s.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...s,status:e.status,completedAt:i}),de({token:t,courseName:s.courseNameSnapshot??"",name:s.name,date:s.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new S(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Es(t));for(const t of this.result.get()?.slots??[])for(const s of t.subjectLabels??[])e.set(s.ballId,s.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new S(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,i)=>{for(const r of s.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return ae(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(a=>a.id===e);if(!t||!s)return"";const i=t.playHoles.filter(a=>a.courseHoleNumber===s.courseHoleNumber).sort((a,d)=>a.ordinal-d.ordinal);if(i.length===1)return`${s.courseHoleNumber}`;const r=i.findIndex(a=>a.id===e);return`${s.courseHoleNumber} (${vr[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(ae(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(ae(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(ee(e,t));return s?s.strokes:this.scorecards.get().find(a=>a.ballId===e)?.holes.find(a=>a.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(ee(e,t))?.status??null}strokesHintFor(e,t){const s=this.round.get();if(!s)return null;const i=this.balls.get().find(m=>m.id===e);if(!i||i.pending)return null;const r=this.selectedSlotDefId(),d=(i.slots.find(m=>m.slotDefId===r)??i.slots[0])?.playingHandicap;if(d==null)return null;const c=this.playHoleById(t);if(!c)return null;const u=i.players[0]?.teeName??null,f=c.tees.find(m=>m.teeName===u)?.strokeIndex??c.baseStrokeIndex;return Yi(d,f,s.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.flushStats(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e))&&this.bumpStatRev()}setStatCell(e,t){const s=t===null?null:e;this.statCell===s&&this.statStep===t||(this.statCell=s,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),s=this.playHoleById(e.playHoleId);return!t||!s?null:new lr(t,s.par,s.courseHoleNumber,this.persistedStats(e))}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),s=t?xr(t):new Map;for(const i of Q){const r=We(e,i);if(!this.statLocal.has(r))continue;const a=this.statLocal.get(r)??null;a===null?s.delete(i):s.set(i,a)}return s}flushStats(){const e=this.statCell,t=this.statStep,s=this.token;if(!e||!t||!s)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(s,e.playHoleId,e.playerId,i),this.postStats(s),!0}writeStatLocal(e,t,s){const i=We(e,t);this.statLocal.set(i,s),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const s=We({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(s,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,s]of[...this.statConfirmedAt])e<=s||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const s=await this.sendStatEvents(e,t);if(s==="later")return;if(s==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await v.playerStats.appendEvents({token:e,items:t.map(s=>({playHoleId:s.playHoleId,playerId:s.playerId,key:s.key,value:s.value,clientEventId:s.clientEventId}))}),"ok"}catch(s){return $r(s)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,s){const i=this.cells.get().get(ee(e,t));return i&&i.metadata!==void 0?i.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=B.get(fe),t=this.round.get()?.formatSlots??[],s=[],i=new Set;for(const r of t){const a=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of a)i.has(d.key)||(i.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>wr(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,i){const r=ee(e,t),a=crypto.randomUUID();this.patchCell(r,{strokes:s,metadata:i,status:"saving",clientEventId:a});const d=this.token;d&&(this.enqueue(d,e,t,s,i,a),await this.post(d,e,t,s,i,a))}async retry(e,t){const s=ee(e,t),i=this.cells.get().get(s);if(!i)return;this.patchCell(s,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(ee(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,i,r,a){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:a,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,s,i,r,a){const d=ee(t,s);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:a,...r!=null?{metadata:r}:{}}),this.queue.remove(a);const c=this.cells.get().get(d);c&&c.clientEventId===a&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===a&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const kr=700;function Sr(n){if(!n.currentHole)return!1;const e=n.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function Cr(n){return n.currentHole?n.balls.some((e,t)=>t!==n.currentBallIndex&&!e.scored):!1}function Ye(n){const e=n.currentHole;if(!e)return{kind:"noop"};const t=n.balls,s=n.currentBallIndex;for(let i=s+1;i<t.length;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};for(let i=0;i<s;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};return n.holeIndex>=n.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:n.holeIndex+1,delayMs:kr}}function Ir(n,e){const t=n.currentHole;if(e.kind==="statsDone")return n.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Ye(n)};const s=n.balls[n.currentBallIndex];if(!t||!s)return{write:null,move:{kind:"noop"}};if(s.pending)return n.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Ye(n)};const i={ballIndex:n.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&n.collectsStats?{write:i,move:{kind:"openStats"}}:n.holeCompleteOnEntry?{write:i,move:{kind:"stay"}}:{write:i,move:Ye(n)}}const te=60,Mt=8,at=4,Tr=Array.from({length:at*2+1},(n,e)=>e-at),Er="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Nr=_(`
...
`),jr=_('<button bind="btn" class="se-seg" type="button"></button>'),Lr=_(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),Ar=_('<div bind="rule" class="se-stats__rule"></div>');class Dr extends R{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Mt}px; flex-shrink: 0; }
            & .se-row__slot { width: ${te}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
    ...
    `;svc=this.inject(J);holeIdx=this.svc.holeIdx;modalOpen=this.svc.keypadOpen;currentBallIdx=new p(0);holeCompleteOnEntry=!1;extendedOpen=new p(!1);extendedScore=new p(10);statsOpen=new p(!1);pendingMeta=new p({});lastMetaKey=null;toastMsg=new p(null);dragOffset=new p(0);transitioning=new p(!1);ptr=null;pendingSteps=null;settleTimer=null;advanceTimer=null;flashTimer=null;hasScoring=new S(()=>this.svc.balls.get().length>0);group=()=>this.svc.group();playedOrder=()=>this.svc.playedOrder();holeIndex=()=>this.svc.holeIndex();currentHole=()=>this.svc.currentPlayedHole();occAtOffset=e=>{const t=this.playedOrder();return t[ae(this.holeIndex()+e,t.length)]??null};ballsInGroup=()=>{const e=this.group();if(!e)return[];const t=new Map(this.svc.balls.get().map(s=>[s.id,s]));return e.ballIds.map(s=>t.get(s)).filter(s=>!!s)};parFor=e=>this.svc.parFor(e);occLabel=e=>this.svc.occLabel(e);ballName=e=>Es(e);metaInputs=()=>this.svc.metadataInputsForHole(this.svc.currentPlayHole()).filter(e=>e.kind==="boolean");displayScore=e=>e===null?"–":String(e);hintText=(e,t)=>{const s=this.svc.strokesHintFor(e,t);return s===null?null:s===0?"0":s>0?`-${s}`:`+${-s}`};toParValue=e=>{let t=0,s=0,i=!1;for(const r of this.playedOrder()){const a=this.svc.strokesFor(e.id,r.playHoleId);a!==null&&a>0&&(t+=a,s+=this.parFor(r.playHoleId),i=!0)}return i?t-s:null};hcpLine=e=>{const t=this.ballsInGroup().find(i=>i.id===e);if(!t||t.pending)return null;const s=t.players.length>1?t.courseHandicap:t.players[0]?.courseHandicap??t.courseHandicap;return s===null?null:t.players.length>1?`Team · HCP ${s}`:`HCP ${s}`};toParText=e=>{const t=this.toParValue(e);return t===null?"–":t===0?"E":t>0?`+${t}`:`${t}`};toParClass=e=>{const t=this.toParValue(e);return`se-row__topar ${t===null||t===0?"even":t<0?"under":"over"}`};scoreLabel=(e,t)=>{if(e===1)return"HIO";const s=e-t;return s<=-4||s>=5?"OTHER":{"-3":"ALBA","-2":"EAGLE","-1":"BIRDIE",0:"PAR",1:"BOGEY",2:"DOUBLE",3:"TRIPLE",4:"QUAD"}[String(s)]??""};render(){this.track(()=>{this.advanceTimer&&clearTimeout(this.advanceTimer),this.flashTimer&&clearTimeout(this.flashTimer),this.settleTimer&&clearTimeout(this.settleTimer),this.modalOpen.set(!1)}),this.track(N(()=>{const d=this.ballsInGroup().length;d>0&&this.currentBallIdx.get()>=d&&this.selectBall(0)}));const e=this.wire(Nr,{root:{className:()=>this.hasScoring.get()?"se":"se hidden"},close:{onclick:()=>{this.statsOpen.set(!1),this.modalOpen.set(!1),this.svc.flushStats()}},modal:{className:()=>this.modalOpen.get()?"se-modal":"se-modal hidden"},modalTitle:()=>{const d=this.currentHole();return d?`Hole ${this.occLabel(d.playHoleId)} · Par ${this.parFor(d.playHoleId)}`:""},modalPrev:{onclick:()=>this.stepHole(-1),disabled:()=>!this.svc.canPrevHole()},modalNext:{onclick:()=>this.stepHole(1),disabled:()=>!this.svc.canNextHole()},extended:{className:()=>this.extendedOpen.get()?"se-pad__ext":"se-pad__ext hidden"},extVal:()=>String(this.extendedScore.get()),extMinus:{onclick:()=>this.extendedScore.set(Math.max(10,this.extendedScore.get()-1))},extPlus:{onclick:()=>this.extendedScore.set(this.extendedScore.get()+1)},extCancel:{onclick:()=>this.extendedOpen.set(!1)},extOk:{onclick:()=>{this.extendedOpen.set(!1),this.commit(this.extendedScore.get())}},toast:{className:()=>this.toastMsg.get()?"se-toast":"se-toast hidden",textContent:()=>this.toastMsg.get()??""},stats:{className:()=>this.statsOpen.get()?"se-stats":"se-stats hidden"},statsBack:{onclick:()=>{this.statsOpen.set(!1),this.svc.flushStats()}},statsHole:()=>{const d=this.currentHole();return d?`Hole ${this.occLabel(d.playHoleId)} · Par ${this.parFor(d.playHoleId)}`:""},statsTitle:()=>{const d=this.ballsInGroup()[this.currentBallIdx.get()];return d?this.ballName(d):""},statsScore:()=>{const d=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();return!d||!c?"":this.displayScore(this.svc.strokesFor(d.id,c.playHoleId))},statsNext:{textContent:()=>this.hasMoreUnscored()?"Next ›":"Done ›",onclick:()=>{this.statsOpen.set(!1),this.svc.flushStats(),this.apply({kind:"statsDone"})}}}),t=this.ref(e,"viewport"),s=this.ref(e,"track");this.bindCarouselPointer(t,s),this.track(N(()=>{s.style.transition=this.transitioning.get()?Er:"none",s.style.transform=`translateX(${this.dragOffset.get()}px)`})),this.$each(s,new S(()=>Tr),(d,c,u)=>this.holeItem(d,u),d=>d),this.$each(this.ref(e,"rows"),new S(()=>{const d=this.playedOrder(),c=this.holeIndex(),u=d[c];if(!u)return[];const f=c>0?d[c-1].playHoleId:null;return this.ballsInGroup().map(m=>({ball:m,ph:u.playHoleId,prevPh:f}))}),(d,c,u)=>this.playerRow(d.ball,d.ph,d.prevPh,u),d=>`${d.ball.id}|${d.ph}|${d.ball.pending}`),this.$each(this.ref(e,"modalList"),new S(()=>this.ballsInGroup()),(d,c,u)=>this.modalRow(d,c,u),d=>d.id);const i=this.ref(e,"keys");for(const d of[1,2,3,4,5,6,7,8,9])i.appendChild(this.numberKey(d));i.appendChild(this.specialKey("10+","","se-key",()=>this.openExtended())),i.appendChild(this.specialKey("✕","clear","se-key clear",()=>this.commit(null))),i.appendChild(this.specialKey("0","pick up","se-key muted",()=>this.commit(0))),this.$each(this.ref(e,"statsBody"),new S(()=>this.statBodyRows()),(d,c,u)=>this.statBodyRow(d,u),d=>d.key),this.track(N(()=>{if(!this.modalOpen.get()){this.lastMetaKey=null,this.svc.seedStatStep(null);return}const d=this.ballsInGroup()[this.currentBallIdx.get()],c=this.currentHole();if(!d||!c)return;this.seedStatStepForCursor();const u=`${d.id}|${c.playHoleId}`;if(u===this.lastMetaKey)return;this.lastMetaKey=u;const f={};for(const m of this.metaInputs())f[m.key]=this.svc.metadataFor(d.id,c.playHoleId,m.key)===!0;this.pendingMeta.set(f)}));const r=()=>{document.visibilityState==="hidden"&&this.svc.flushStats()},a=()=>this.svc.flushStats();return document.addEventListener("visibilitychange",r),window.addEventListener("pagehide",a),this.track(()=>{document.removeEventListener("visibilitychange",r),window.removeEventListener("pagehide",a),this.svc.flushStats()}),e}holeItem(e,t){return this.wireEl(Pr,{item:{className:()=>{const s=e===-1&&this.holeIndex()<=0;return`se-hole${e===0?" active":""}${s?" gone":""}`}},hnum:{textContent:()=>{const s=this.occAtOffset(e);return s?this.occLabel(s.playHoleId):""}},hpar:{textContent:()=>{const s=this.occAtOffset(e);return s?`Par ${this.parFor(s.playHoleId)}`:""}}},t)}playerRow(e,t,s,i){return e.pending?this.wireEl(Ht,{name:{textContent:this.ballName(e),className:"se-row__name se-row__name--pending"},hcp:{textContent:"open seat"},topar:{textContent:"",className:"se-row__topar"},prev:{textContent:""},cval:{textContent:"–"},circle:{className:"se-row__circle empty se-row__circle--pending"}},i):this.wireEl(Ht,{name:{textContent:this.ballName(e)},hcp:{textContent:()=>this.hcpLine(e.id)??"",hidden:()=>this.hcpLine(e.id)===null},topar:{textContent:()=>this.toParText(e),className:()=>this.toParClass(e)},prev:{textContent:()=>s?this.displayScore(this.svc.strokesFor(e.id,s)):""},cval:{textContent:()=>{const r=this.svc.strokesFor(e.id,t);return r!==null?this.displayScore(r):this.hintText(e.id,t)??"–"}},circle:{className:()=>this.svc.strokesFor(e.id,t)!==null?"se-row__circle":this.hintText(e.id,t)!==null?"se-row__circle empty hint":"se-row__circle empty",onclick:()=>this.openModalForBall(e.id)}},i)}modalRow(e,t,s){const i=e.players.length>1?e.courseHandicap:e.players[0]?.courseHandicap??e.courseHandicap,r=i===null?"–":String(i),a=e.pending?"Open seat — claim to score":e.players.length>1?`Team · HCP ${r}`:`HCP ${r}`;return this.wireEl(Or,{mrow:{className:()=>this.currentBallIdx.get()===t?"se-mrow sel":"se-mrow",onclick:()=>this.selectBall(t)},mname:{textContent:this.ballName(e)},mhcp:{textContent:a},mval:{textContent:()=>{const d=this.currentHole();if(!d)return"–";const c=this.svc.strokesFor(e.id,d.playHoleId);return c!==null?this.displayScore(c):this.hintText(e.id,d.playHoleId)??"–"},className:()=>{const d=this.currentHole();return!!d&&this.svc.strokesFor(e.id,d.playHoleId)===null&&!!d&&this.hintText(e.id,d.playHoleId)!==null?"se-mrow__val se-mrow__val--hint":"se-mrow__val"}}},s)}numberKey(e){return this.wireEl(Ft,{key:{className:()=>{const t=this.currentHole();return(t?e===this.parFor(t.playHoleId):!1)?"se-key par":"se-key"},onclick:()=>this.commit(e)},num:{textContent:String(e)},lbl:{textContent:()=>{const t=this.currentHole();return t?this.scoreLabel(e,this.parFor(t.playHoleId)):""}}})}specialKey(e,t,s,i){return this.wireEl(Ft,{key:{className:s,onclick:i},num:{textContent:e},lbl:{textContent:t}})}openModalForBall(e){const t=this.ballsInGroup().findIndex(s=>s.id===e);this.selectBall(t<0?0:t),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.noteHoleEntered(),this.modalOpen.set(!0)}selectBall(e){this.currentBallIdx.set(e),this.seedStatStepForCursor()}seedStatStepForCursor(){const e=this.ballsInGroup()[this.currentBallIdx.get()],t=this.currentHole(),s=e?this.svc.statSubject(e):null;this.svc.seedStatStep(s&&t?{playerId:s,playHoleId:t.playHoleId}:null)}advanceState(){const e=this.currentHole();return{balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId,label:this.occLabel(e.playHoleId)}:null,holeIndex:this.holeIndex(),holeCount:this.playedOrder().length,holeCompleteOnEntry:this.holeCompleteOnEntry,collectsStats:this.metaInputs().length>0||this.svc.statPrompts().length>0}}noteHoleEntered(){this.holeCompleteOnEntry=Sr(this.advanceState())}stepHole(e){this.advanceTimer&&(clearTimeout(this.advanceTimer),this.advanceTimer=null),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.svc.flushStats(),e<0?this.svc.prevHole():this.svc.nextHole(),this.selectBall(0),this.noteHoleEntered()}openExtended(){this.extendedScore.set(10),this.extendedOpen.set(!0)}commit(e){this.apply({kind:"score",value:e})}apply(e){this.execute(Ir(this.advanceState(),e))}execute(e){const t=e.write;if(t){const i=this.ballsInGroup()[t.ballIndex];i&&this.svc.setScore(i.id,t.holeId,t.value,t.withMetadata?this.metaSnapshot():void 0)}const s=e.move;switch(s.kind){case"noop":case"stay":return;case"moveToBall":this.selectBall(s.ballIndex);return;case"openStats":this.statsOpen.set(!0);return;case"roundComplete":this.flash(s.toast),this.modalOpen.set(!1);return;case"holeComplete":{this.flash(s.toast),this.advanceTimer&&clearTimeout(this.advanceTimer),this.advanceTimer=setTimeout(()=>{this.advanceTimer=null,this.currentHole()?.playHoleId===s.fromHoleId&&(this.holeIdx.set(ae(s.toHoleIndex,this.playedOrder().length)),this.selectBall(0),this.noteHoleEntered())},s.delayMs);return}}}hasMoreUnscored=()=>{const e=this.currentHole();return Cr({balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId}:null})};metaSnapshot(){const e=this.metaInputs();if(e.length===0)return;const t=this.pendingMeta.get(),s={};for(const i of e)s[i.key]=t[i.key]===!0;return s}setMeta(e,t){const s=this.pendingMeta.get();this.pendingMeta.set({...s,[e]:t});const i=this.ballsInGroup()[this.currentBallIdx.get()],r=this.currentHole();if(!i||!r)return;const a=this.svc.strokesFor(i.id,r.playHoleId);a!==null&&this.svc.setScore(i.id,r.playHoleId,a,this.metaSnapshot())}metaChip(e,t){return this.wireEl(Rr,{glabel:{textContent:e.label},miss:{className:()=>this.pendingMeta.get()[e.key]?"se-seg":"se-seg on-miss",onclick:()=>this.setMeta(e.key,!1)},hit:{className:()=>this.pendingMeta.get()[e.key]?"se-seg on-hit":"se-seg",onclick:()=>this.setMeta(e.key,!0)}},t)}metaInputsForStep=()=>{const e=new Set(this.svc.statPrompts().map(t=>t.key));return this.metaInputs().filter(t=>!e.has(t.key))};statBodyRows=()=>{const e=this.metaInputsForStep(),t=this.svc.statPrompts(),s=e.map(i=>({kind:"meta",key:`meta:${i.key}`,input:i}));e.length>0&&t.length>0&&s.push({kind:"rule",key:"rule"});for(const i of t)s.push({kind:"stat",key:`stat:${i.key}`,prompt:i});return s};statBodyRow(e,t){return e.kind==="meta"?this.metaChip(e.input,t):e.kind==="rule"?this.wireEl(Ar,{},t):e.prompt.control.kind==="segments"?this.statSegments(e.prompt,t):this.statStepper(e.prompt,t)}statSegments(e,t){const s=e.control,i=s.kind==="segments"?s.options:[],r=i.length>=4?" tight":"",a=this.wireEl(zr,{glabel:{textContent:e.label}},t),d=this.ref(a,"seg");for(const c of i){const u=this.wireEl(jr,{btn:{textContent:c.label,className:()=>`se-seg${r}${this.svc.statValue(e.key)===c.value?" on-neutral":""}`,onclick:()=>this.answerStat(e.key,this.svc.statValue(e.key)===c.value?null:c.value)}},t);d?.appendChild(u)}return a}statStepper(e,t){const s=e.control,i=s.kind==="stepper"?s.min:0,r=s.kind==="stepper"?s.max:null;return this.wireEl(Lr,{glabel:{textContent:e.label},minus:{onclick:()=>this.stepStat(e.key,-1),"aria-label":`Fewer ${e.label}`},plus:{onclick:()=>this.stepStat(e.key,1),"aria-label":`More ${e.label}`},val:{textContent:()=>or(this.svc.statStepperValue(e.key,i),r),className:()=>this.svc.statIsAnswered(e.key)?"se-stats__step-val":"se-stats__step-val unanswered","aria-label":()=>this.svc.statIsAnswered(e.key)?`${e.label} ${this.svc.statStepperValue(e.key,i)}`:`${e.label} not answered`}},t)}answerStat(e,t){this.svc.answerStat(e,t),this.mirrorStatToMeta(e)}stepStat(e,t){this.svc.stepStat(e,t),this.mirrorStatToMeta(e)}mirrorStatToMeta(e){if(!this.metaInputs().some(s=>s.key===e))return;const t=this.svc.statValue(e);t!==null&&this.setMeta(e,t==="1")}flash(e){this.toastMsg.set(e),this.flashTimer&&clearTimeout(this.flashTimer),this.flashTimer=setTimeout(()=>{this.flashTimer=null,this.toastMsg.get()===e&&this.toastMsg.set(null)},1100)}snap(e){this.pendingSteps=e,this.transitioning.set(!0),this.dragOffset.set(-e*te),this.settleTimer&&clearTimeout(this.settleTimer),this.settleTimer=setTimeout(()=>this.finishSettle(),420)}finishSettle(){if(this.pendingSteps===null)return;const e=this.pendingSteps;this.pendingSteps=null,this.settleTimer&&(clearTimeout(this.settleTimer),this.settleTimer=null),this.transitioning.set(!1),e!==0&&this.holeIdx.set(ae(this.holeIndex()+e,this.playedOrder().length)),this.dragOffset.set(0)}bindCarouselPointer(e,t){t.addEventListener("transitionend",i=>{i.propertyName==="transform"&&this.finishSettle()}),e.addEventListener("pointerdown",i=>{this.ptr||this.transitioning.get()||this.playedOrder().length<=1||(this.ptr={id:i.pointerId,startX:i.clientX,startY:i.clientY,lastX:i.clientX,lastTime:Date.now(),velocity:0,horiz:!1},this.dragOffset.set(0),e.setPointerCapture?.(i.pointerId))}),e.addEventListener("pointermove",i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const a=i.clientX-r.startX,d=i.clientY-r.startY;if(!r.horiz){if(Math.abs(d)>Math.abs(a)&&Math.abs(d)>8||Math.abs(a)<=8)return;r.horiz=!0}const c=Date.now(),u=Math.max(1,c-r.lastTime);r.velocity=(i.clientX-r.lastX)/u,r.lastX=i.clientX,r.lastTime=c,this.dragOffset.set(a)});const s=i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const a=i.clientX-r.startX,d=r.horiz;if(this.ptr=null,e.releasePointerCapture?.(i.pointerId),!d){this.dragOffset.set(0);return}this.snap(Ji({dragDistance:a,velocity:r.velocity,itemWidth:te}))};e.addEventListener("pointerup",s),e.addEventListener("pointercancel",i=>{!this.ptr||this.ptr.id!==i.pointerId||(this.ptr=null,e.releasePointerCapture?.(i.pointerId),this.snap(0))})}}function Mr(n,e){const t=[...n].sort((r,a)=>r.canonicalOrdinal-a.canonicalOrdinal);if(e.length===0)return[{label:"TOT",holes:t,playHoleIds:new Set(t.map(r=>r.playHoleId))}];const s=[...e].sort((r,a)=>r.fromCanonicalOrdinal-a.fromCanonicalOrdinal),i=[];for(const r of s){const a=t.filter(d=>d.canonicalOrdinal>=r.fromCanonicalOrdinal&&d.canonicalOrdinal<=r.toCanonicalOrdinal);a.length!==0&&i.push({label:r.label,holes:a,playHoleIds:new Set(a.map(d=>d.playHoleId))})}return i}function Ns(n,e){const t=n.cells.filter(s=>e.has(s.playHoleId));if(n.aggregate==="sum"){const s=t.map(i=>i.value).filter(i=>i!==null);return s.length===0?"—":String(s.reduce((i,r)=>i+r,0))}if(n.aggregate==="last"){for(let s=t.length-1;s>=0;s--){const i=t[s].value;if(i!==null)return Number.isInteger(i)?String(i):i.toFixed(1)}return"—"}return"—"}function Hr(n,e){if(n.aggregate==="sum"){const t=n.cells.map(s=>s.value).filter(s=>s!==null);return t.length===0?"—":String(t.reduce((s,i)=>s+i,0))}if(n.aggregate==="last"){const t=e[e.length-1];return t?Ns(n,t.playHoleIds):"—"}return"—"}function Fr(n){const e=n?.marker;if(e){const t=e.tone;return{kind:"marker",template:e.template,tone:t==="success"||t==="warning"||t==="danger"?t:null,label:e.label?e.label:null,teamFill:n?.team??null}}return n?.team?{kind:"pill",team:n.team}:{kind:"plain"}}function Br(n){return n.filter(e=>!(e.startsWith("slot #")||/^HCP -?\d/.test(e)||/^PH -?\d/.test(e)))}const ze=" & ";function Ps(n){return n.componentId??"default-score-grid"}function ft(n,e,t,s={}){const i=Mr(n.holes,e),r=s.mode??"product",a=n.rows.map(d=>{const c=new Map(d.cells.map(u=>[u.playHoleId,u]));return{kind:d.kind,emphasis:d.emphasis===!0,team:d.team??null,subjectName:d.subjectBallId?t(d.subjectBallId):null,labelText:d.label,groups:i.map(u=>({cells:u.holes.map(f=>{const m=c.get(f.playHoleId);return{text:m?.display??"",title:m?.title?m.title:null,decoration:Fr(m)}}),subtotal:Ns(d,u.playHoleIds)})),total:Hr(d,i)}});return{componentId:Ps(n),subjectBallIds:[...n.subjectBallIds],title:{groups:n.title.groups.map(d=>d.map(c=>t(c))),joiner:n.title.joiner,nameJoiner:ze},subtitleFacts:r==="verification"?[...n.subtitleFacts]:Br(n.subtitleFacts),footnotes:[...n.footnotes],caption:n.caption??null,totals:n.totals.map(d=>({label:d.label,value:String(d.value??"—")})),columnGroups:i.map(d=>({label:d.label,columns:d.holes.map(c=>({label:c.occurrenceLabel}))})),hasTotalColumn:i.length>1,rows:a}}function Qe(n){return[...new Set(n)].sort().join("\0")}function Gr(n,e){const t=new Map;e.forEach((i,r)=>{if(i.ballIds.length===0)return;const a=Qe(i.ballIds);t.set(a,t.has(a)?null:r)});const s=new Map;for(const i of n){if(i.subjectBallIds.length===0)continue;const r=Qe(i.subjectBallIds);s.set(r,(s.get(r)??0)+1)}return n.map(i=>{if(i.subjectBallIds.length===0)return{kind:"standalone"};const r=Qe(i.subjectBallIds);if((s.get(r)??0)!==1)return{kind:"standalone"};const a=t.get(r);return a==null?{kind:"standalone"}:{kind:"attached",entryIndex:a}})}function qr(n,e){const t=new Set(n.map(e));return t.size!==1?null:[...t][0]??null}function Kr(n,e){if(n===void 0)return null;const t=e==="high"?-n:n;return{text:t===0?"E":t>0?`+${t}`:`−${Math.abs(t)}`,tone:t===0?"even":t>0?"over":"under"}}const Vr=()=>null;function Ur(n,e,t=Vr){return{kind:"ranked",metricLabel:n.metricLabel,hasPace:n.entries.some(s=>s.paceDelta!==void 0),entries:n.entries.map(s=>({position:s.position,lead:s.position===1,name:s.ballIds.map(e).join(ze),group:qr(s.ballIds,t),total:String(s.total??"—"),holesPlayed:s.holesPlayed,pace:Kr(s.paceDelta,n.direction)}))}}function Wr(n,e){return{kind:"match_summary",title:n.title,matches:n.matches.map(t=>({sideAName:t.sideA.ballIds.map(e).join(ze),sideBName:t.sideB.ballIds.map(e).join(ze),leader:t.leader,standing:t.magnitude===0?"AS":`${t.magnitude} UP`,status:t.finished?"Final":`thru ${t.thru}`}))}}function ot(n,e){return[n,...[...new Set(e)].sort()].join("|")}const Yr=new Map;function Qr(n){const e=n.cards??[],t=(n.leaderboard??[]).find(a=>a.kind==="ranked")??null;if(!t)return{rankedSection:null,slotDefId:n.slotDefId,attached:Yr,standalone:[...e]};const s=Gr(e,t.entries),i=new Map,r=[];return e.forEach((a,d)=>{const c=s[d],u=c?.kind==="attached"?t.entries[c.entryIndex]:void 0;if(!u){r.push(a);return}i.set(ot(n.slotDefId,u.ballIds),a)}),{rankedSection:t,slotDefId:n.slotDefId,attached:i,standalone:r}}class Xr{open=new Set;isOpen(e){return this.open.has(e)}toggle(e){return this.set(e,!this.open.has(e))}set(e,t){return t?this.open.add(e):this.open.delete(e),t}keys(){return[...this.open].sort()}retain(e){const t=new Set(e);for(const s of[...this.open])t.has(s)||this.open.delete(s)}}const Os={ring:{meaning:"a single-unit decided result",fill:"#d63b2f",visual:"red filled circle — the Gamebook birdie mark (score to par −1)"},double_ring:{meaning:"a two-unit decided result; more emphatic than a ring",fill:"#e0862c",teamFillBorder:"border-width: 3px; border-style: double;",visual:"orange filled circle (score to par −2); doubled white border when team-filled"},diamond:{meaning:"a rare / high-magnitude decided result — the strongest form",fill:"#e0b41f",visual:"yellow filled circle — hole-in-one / albatross territory"},dot:{meaning:"a lightweight per-hole flag where a full ring would be too heavy",visual:"the bare base shape (no fill, no border) — inherits cell colour"},badge:{meaning:"a labelled status needing short text or a number, not just a shape",rule:["width: auto; min-width: 1.8em;","padding-left: 0.45em; padding-right: 0.45em;","border: 2px solid currentColor;"],tones:{success:"#267348",warning:"#946200",danger:"#9b332a"},visual:"outline pill in the tone colour, text inside"},square:{meaning:"a one-step negative score relation",fill:"#5b9bd5",boxy:!0,visual:"light-blue filled square (score to par +1)"},double_square:{meaning:"a stronger negative score relation",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square (score to par +2)"},box_badge:{meaning:"an angular labelled state that must not read as a round marker",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square carrying its value (+3 or worse)"}};function be(n){return`lb-mark--${n}`}const ce=()=>Object.entries(Os);function Rs(n){return n.join(`
            `)}function Xe(n,e){return n.map((t,s)=>`& .${be(t)}${s===n.length-1?` { ${e} }`:","}`)}function Jr(){const n=[];n.push("/* Outline forms keep currentColor + tone tints. */");for(const[r,a]of ce())if(!(!a.rule&&!a.tones)){if(a.rule){n.push(`& .${be(r)} {`);for(const d of a.rule)n.push(`    ${d}`);n.push("}")}for(const[d,c]of Object.entries(a.tones??{}))n.push(`& .${be(r)}.lb-mark-tone--${d} { color: ${c}; }`)}n.push("/* Filled forms — declared after the tone rules so white text wins. */");const e=ce().filter(([,r])=>r.boxy).map(([r])=>r),t=[],s=new Set;for(const[r,a]of ce()){if(a.fill===void 0||s.has(r))continue;const d=ce().filter(([,c])=>c.fill===a.fill).map(([c])=>c);for(const c of d)s.add(c);t.push({fill:a.fill,ids:d})}let i=-1;if(e.length>0){const r=t.findIndex(a=>a.ids.some(d=>Os[d].boxy));i=r===-1?t.length:r}return t.forEach((r,a)=>{a===i&&n.push(...Xe(e,"border-radius: 3px;")),n.push(...Xe(r.ids,`background: ${r.fill}; color: #fff;`))}),i===t.length&&n.push(...Xe(e,"border-radius: 3px;")),Rs(n)}function Zr(){const n=[];for(const[e,t]of ce()){if(!t.teamFillBorder)continue;const s=be(e);n.push(`& .${s}.lb-mark-fill--a,`,`& .${s}.lb-mark-fill--b { ${t.teamFillBorder} }`)}return Rs(n)}const zs=()=>null;function P(n){return String(n).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function ea(n){return n.kind==="si"?"lb-c-si":n.kind==="given"?"lb-c-given":n.kind==="status"?"lb-c-status":n.kind==="category"?"lb-c-cat":""}function ta(n){const e=[n.kind==="category"?"lb-r-cat":`lb-r-${n.kind}`];return(n.kind==="si"||n.kind==="given")&&e.push("lb-r-dim"),n.team&&e.push(`lb-team-${n.team}`),e.join(" ")}function sa(n,e,t){const s=n.title!==null?` title="${P(n.title)}"`:"",i=t(P(n.text)),r=n.decoration;let a;if(r.kind==="marker"){const d=r.tone?` lb-mark-tone--${r.tone}`:"",c=r.teamFill?` lb-mark-fill--${r.teamFill}`:"",u=r.label!==null?` title="${P(r.label)}" aria-label="${P(r.label)}"`:"";a=`<span class="lb-mark ${be(r.template)}${d}${c}"${u}>${i}</span>`}else r.kind==="pill"?a=`<span class="lb-pill lb-pill--${r.team}">${i}</span>`:a=i;return`<td class="${ea(e)}"${s}>${a}</td>`}function gt(n,e){const t=m=>{const h=n.columnGroups[m],b=`<tr><th class="lb-rowlabel">Hole</th>${h.columns.map(x=>`<th>${P(x.label)}</th>`).join("")}<th class="lb-sum">${P(h.label)}</th></tr>`,g=n.rows.map(x=>{const O=Z=>x.emphasis?`<strong>${Z}</strong>`:Z,L=x.groups[m],I=L.cells.map(Z=>sa(Z,x,O)).join(""),A=`<td class="lb-sum">${O(L.subtotal)}</td>`,F=x.subjectName!==null?P(x.subjectName)+(x.labelText?" "+P(x.labelText):""):P(x.labelText);return`<tr class="${ta(x)}"><th class="lb-rowlabel">${F}</th>${I}${A}</tr>`}).join("");return`<div class="lb-card__scroll"><table class="lb-grid"><thead>${b}</thead><tbody>${g}</tbody></table></div>`},s=n.columnGroups.map((m,h)=>t(h)).join(""),i=n.title.groups.map(m=>m.map(h=>P(h)).join(n.title.nameJoiner)).filter(Boolean).join(n.title.joiner),r=n.subtitleFacts.length?`<div class="lb-card__sub">${n.subtitleFacts.map(P).join(" · ")}</div>`:"",a=e.mode==="verification"&&n.footnotes.length?`<div class="lb-card__notes"><span class="lb-card__notes-label">Points breakdown</span>${n.footnotes.map(m=>`<span class="lb-card__note">${P(m)}</span>`).join("")}</div>`:"",d=e.mode==="verification"&&n.caption?`<p class="lb-card__caption">${P(n.caption)}</p>`:"",c=n.totals.length?`<ul class="lb-card__totals">${n.totals.map(m=>`<li>${P(m.label)} = <strong>${m.value}</strong></li>`).join("")}</ul>`:"",u=i?`<header class="lb-card__head"><h4>${i}</h4>${r}</header>`:r;return`<article class="${e.cardModifier?`lb-card ${e.cardModifier}`:"lb-card"}">
  ${u}
  ${s}
  ${a}${d}${c}
</article>`}function na(n,e,t,s){return gt(ft(n,e,t,s),s)}function ia(n,e,t,s){return gt(ft(n,e,t,s),{...s,cardModifier:"lb-card--compact-match"})}function ra(n,e,t,s){return gt(ft(n,e,t,s),{...s,cardModifier:"lb-card--category-matrix"})}function aa(n){return n.pace===null?'<td class="lb-rank__pace"></td>':`<td class="lb-rank__pace lb-rank__pace--${n.pace.tone}">${P(n.pace.text)}</td>`}function oa(n){return`lb-panel-${n.replace(/[^a-zA-Z0-9_-]+/g,"-")}`}function la(n,e,t=zs,s=null){const i=Ur(n,e,t),r=i.hasPace,a=s!==null,d=(r?5:4)+(a?1:0),c=i.entries.map((b,g)=>{const x=b.group?` <span class="lb-rank__group">${P(b.group)}</span>`:"",O=`
  <td class="lb-rank__total">${b.total}</td>${r?`
  ${aa(b)}`:""}
  <td class="lb-rank__thru">${b.holesPlayed}</td>`,L=n.entries[g],I=s&&L?s.plan.attached.get(ot(s.plan.slotDefId,L.ballIds)):void 0;if(!s)return`<tr class="${b.lead?"lb-rank__lead":""}">
...
</tr>`;const A=ot(s.plan.slotDefId,L.ballIds),F=s.isOpen(A),Z=oa(A),Hs=js(I,s.routeSections,e,{mode:s.mode??"product"}),Be=["lb-rank__row--expandable"];return b.lead&&Be.push("lb-rank__lead"),F&&Be.push("lb-rank__row--open"),`<tr class="${Be.join(" ")}" data-expand-key="${P(A)}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${F}" aria-controls="${P(Z)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${P(b.name)}</span>${x}</span></button></td>${O}
...
<tr class="lb-rank__panel${F?" lb-rank__panel--open":""}" data-panel-key="${P(A)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${P(Z)}"><div class="lb-rank__panelbox">${Hs}</div></div></td>
</tr>`}).join(""),u=r?`
  ...
  <h4 class="lb-section__title">${P(i.metricLabel)}</h4>
  <table class="lb-rank">
    <colgroup>
...
</div>`}function da(n,e){const t=Wr(n,e),s=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",a=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    <div class="lb-mp__team lb-mp__team--a${r}">${P(i.sideAName)}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${P(i.standing)}</span><span class="lb-mp__status">${P(i.status)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${a}">${P(i.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${P(t.title)}</h4>${s}
</div>`}const ca={ranked:la,match_summary:(n,e)=>da(n,e)},ua={"default-score-grid":na,"compact-match-grid":ia,"category-matrix-grid":ra};function ha(n){return`<div class="lb-diag">Unrenderable result section <code>${P(n)}</code> — no generic view yet. Results are not hidden.</div>`}function pa(n){return`<div class="lb-diag">Unsupported score-grid component <code>${P(n)}</code> — no generic view yet. Results are not hidden.</div>`}function ma(n,e,t,s=null){const i=ca[n.kind];return i?i(n,e,t,s):ha(n.kind)}function js(n,e,t,s){const i=Ps(n),r=ua[i];return r?r(n,e,t,s):pa(i)}function fa(n,e,t=zs,s=null){return n.leaderboard.length===0&&n.cards.length===0?`<div class="lb-empty">No scores entered yet for ${P(n.formatLabel)}.</div>`:n.leaderboard.map(r=>ma(r,e,t,s&&r===s.plan.rankedSection?s:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${P(n.formatLabel)}.</div>`}function ga(n,e,t,s={}){if(n.length===0)return"";const i=s.mode??"product";return n.map(r=>js(r,e,t,{mode:i})).join(`
`)}const ba=_(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class ya extends R{static styles=`
        .lb {
    ...
    `;svc=this.inject(J);expansion=new Xr;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(ba,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const s=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(s))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const s=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(s)&&(this.applyOpen(t,this.expansion.set(s,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const s=e.nextElementSibling;s?.classList.contains("lb-rank__panel")&&s.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=Qr(t);this.expansion.retain(r.attached.keys());const a=fa(t,s,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),d=ga(r.standalone,e.routeSections,s),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return a+c}}function _a(n,e){if(!e)return[];const t=[],s=new Set;for(const i of n)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const va=_(`
...
`);class xa extends R{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${j()}
    ...
    `,pe.seq=0;let Y=pe;function ka(n){if(!n)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=n.seats.length>0,t=n.claimedSeats.some(r=>r.viewerMayRelease),s=n.viewer.claimSeat.allowed,i=n.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&i,blockedMessage:e&&!s&&!i?n.viewer.claimSeat.message??n.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Sa(n,e){const t=[];if(n.groupId!==null&&e.length>0){const s=e.findIndex(i=>i.id===n.groupId);if(s>=0){t.push(`Group ${s+1}`);const i=e[s].startTime;i.includes(":")&&t.push(i)}}return n.category!==null&&t.push(n.category),t.join(" · ")}function Ca(n){return(n?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Ia=_(`
...
`);class ja extends R{static styles=`
    ...
    `;svc=this.inject(J);auth=this.inject(H);router=this.inject(M);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Oa(this.svc.startList.get())}eligible(){return this.policyState().visible&&Pa(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),i=await v.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(s){this.error.set(s instanceof K&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(N(()=>this.ensureTeesLoaded()));const e=new S(()=>Ra(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(N(()=>{const r=e.get(),a=this.groupChoice.get();(!a||!r.options.some(d=>d.value===a&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(za,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new Y({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const i=new Y({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const qt=1440*60*1e3;function La(n,e){if(n===null)return!0;const t=new Date(n).getTime();return!Number.isFinite(t)||t-e>qt?!0:e-t>=qt}function Aa(n,e){if(!e)return!1;for(const t of n)for(const s of t.players)if(s.playerId===e)return!0;return!1}function Da(n){const e={visible:!1,index:null};return n.settled||!n.profileLoaded||!n.firstOpen||!Aa(n.balls,n.playerId)||!La(n.handicapConfirmedAt,n.now)?e:{visible:!0,index:n.handicapIndex}}function W(n){const e=n.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),s=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(s)?t?-s:s:null}function je(n){return n<0?`+${String(-n)}`:String(n)}const Ma=_(`
...
`);class Ha extends R{static styles=`
        .hcp-checkin {
            margin-bottom: ${l("lg")};
            padding: ${l("md")} ${l("lg")};
            ${j()}
    ...
    `;svc=this.inject(J);auth=this.inject(H);profile=this.inject(ye);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return Da({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":je(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=W(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(N(()=>this.ensureProfileLoaded())),this.wire(Ma,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${je(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function Fa(n,e){if(!e)return!1;for(const t of n)for(const s of t.players)if(s.playerId===e)return!0;return!1}const Ba=_(`
...
`);class Ga extends R{static styles=`
    ...
    `;svc=this.inject(J);auth=this.inject(H);router=this.inject(M);tokenQ=this.router.query("token");editable=new p(!1);deleteOpen=new p(!1);finishOpen=new p(!1);finishAsReopen=new p(!1);leaveOpen=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);isComplete(){return this.svc.round.get()?.status==="complete"}canLeave(){return Fa(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}clear(){this.error.set(""),this.diagnostics.set([])}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.clear(),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){this.track(N(()=>{const r=this.tokenQ.get();this.editable.set(!1),r&&v.friendlyRounds.setup({token:r}).then(a=>{this.tokenQ.get()===r&&this.editable.set(a.editable===!0)}).catch(()=>{})})),this.track(N(()=>{this.props.open.get()&&this.clear()}));const e=this.wire(Ba,{root:{className:()=>this.props.open.get()?"rmanage":"rmanage hidden"},backdrop:{onclick:()=>this.props.open.set(!1)},close:{onclick:()=>this.props.open.set(!1)},editRow:{className:()=>this.editable.get()?"rmanage__row":"rmanage__row hidden",onclick:()=>{const r=this.tokenQ.get();r&&(this.props.open.set(!1),this.router.navigate("/create",{query:{token:r}}))}},leaveRow:{className:()=>this.canLeave()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.leaveOpen.set(!0),disabled:()=>this.leaving.get()},finishRow:{onclick:()=>{this.finishAsReopen.set(this.isComplete()),this.finishOpen.set(!0)},disabled:()=>this.svc.finishing.get()},finishTitle:()=>this.isComplete()?"Reopen round":"Finish round",finishSub:()=>this.isComplete()?"Move it back to your ongoing rounds.":"Move it to your finished rounds. Nothing is locked.",deleteRow:{onclick:()=>this.deleteOpen.set(!0),disabled:()=>this.svc.deleting.get()},diag:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},err:{textContent:()=>this.error.get()}});this.spawn(U,this.ref(e,"deleteConfirmHost"),{open:this.deleteOpen,title:"Delete round?",message:"This permanently removes the round and all its scores for everyone. This can't be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.clear(),this.svc.deleteRound().then(r=>{r?this.router.navigate("/"):this.error.set("Could not delete the round. Try again.")})}}),this.spawn(U,this.ref(e,"finishConfirmHost"),{open:this.finishOpen,title:()=>this.finishAsReopen.get()?"Reopen this round?":"Finish this round?",message:()=>this.finishAsReopen.get()?"It'll move back to your ongoing rounds.":"It'll move to your finished rounds. You can still edit or reopen it any time.",confirmLabel:()=>this.finishAsReopen.get()?"Reopen round":"Finish round",cancelLabel:"Cancel",onconfirm:()=>{this.clear(),(this.finishAsReopen.get()?this.svc.reopenRound():this.svc.finishRound()).then(a=>{a||this.error.set("Could not update the round. Try again.")})}}),this.spawn(U,this.ref(e,"leaveConfirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}});let t=null;const s=this.ref(e,"close");this.track(N(()=>{this.props.open.get()?(t=document.activeElement instanceof HTMLElement?document.activeElement:null,queueMicrotask(()=>s.focus())):t&&(t.focus(),t=null)}));const i=r=>{if(r.key==="Escape"){if(this.deleteOpen.get())return void this.deleteOpen.set(!1);if(this.finishOpen.get())return void this.finishOpen.set(!1);if(this.leaveOpen.get())return void this.leaveOpen.set(!1);this.props.open.get()&&this.props.open.set(!1)}};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),e}}function qa(n,e=typeof navigator>"u"?"en":navigator.language){const t=(n?.name??"").trim();if(t)return t;const s=n?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s||"Round"}function Kt(n){return!(!n.pageVisible||n.status==="complete")}function Ka(n,e){return e&&!n}const Va=2,Vt=3,Ua=75e3;function Wa(n,e=null){const t=new URLSearchParams({token:n});return e!==null&&t.set("since",e),`${D}/friendly-rounds/events?${t.toString()}`}function Ya(n){if(typeof n!="object"||n===null)return!1;const e=n;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Qa(n){const e=n.eventSourceFactory??(I=>new EventSource(I)),t=n.setTimer??((I,A)=>setTimeout(I,A)),s=n.clearTimer??(I=>clearTimeout(I)),i=n.livenessTimeoutMs??Ua,r=n.isPageVisible??(()=>typeof document>"u"||!document.hidden);let a=!1,d=0,c=null,u=null,f=n.since??null;const m=()=>{u!==null&&(s(u),u=null)},h=()=>{m(),u=t(O,i)},b=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{a=!0,m(),b()},x=()=>{if(b(),++d>=Vt){g(),n.onDegrade();return}L()};function O(){if(!a){if(!r()){h();return}x()}}function L(){if(a)return;let I;try{I=e(Wa(n.token,f))}catch{g(),n.onDegrade();return}c=I,I.onopen=()=>{d=0},I.onmessage=A=>{if(a||c!==I)return;h();let F;try{F=JSON.parse(A.data)}catch{return}Ya(F)&&(F.latestEventId!==null&&(f=F.latestEventId),n.onEvent({latestEventId:F.latestEventId,status:F.status}))},I.onerror=()=>{a||c!==I||(I.readyState===Va||++d>=Vt)&&(g(),n.onDegrade())},h()}return L(),{stop:()=>{a||g()}}}const Xa=2e4;function Ja(n){if(!(n===null||n===""))return/^\d+$/.test(n)?Number(n):n}const Za=_(`
...
`),eo=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),to=_('<button bind="pill" class="round-view__grp" type="button"></button>');class so extends R{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
    ...
    `;svc=this.inject(J);router=this.inject(M);tokenQ=this.router.query("token");initPos=this.readUrlPosition();tab=new p(this.initPos.tab);pageVisible=new p(!document.hidden);hasRound=new S(()=>this.svc.round.get()!==null);hasScoring=new S(()=>this.svc.balls.get().length>0);manageOpen=new p(!1);shareUrl=new S(()=>{const e=this.tokenQ.get(),t="/tapscore/".replace(/\/+$/,"");return e?`${location.origin}${t}/round?token=${e}`:""});render(){this.track(N(()=>{const h=this.tokenQ.get();h&&this.svc.loadByToken(h,this.initPos).then(()=>{this.tab.get()==="leaderboard"&&this.svc.loadResult()})}));const e=()=>{this.svc.flushPending()};window.addEventListener("online",e),this.track(()=>window.removeEventListener("online",e));let t=null,s=null,i=null,r=!1;const a=h=>!r&&Kt({pageVisible:h,status:this.svc.round.get()?.status??null}),d=()=>{const h=!document.hidden,b=Ka(this.pageVisible.get(),h),g=a(h);this.pageVisible.set(h),b&&this.tokenQ.get()&&this.svc.refreshAll({feedWillReconnect:g})};document.addEventListener("visibilitychange",d),this.track(()=>document.removeEventListener("visibilitychange",d));const c=()=>{i!==null&&(clearInterval(i),i=null)},u=()=>{i===null&&(i=setInterval(()=>{this.svc.pollResult(),this.svc.refreshScorecard()},Xa))};this.track(N(()=>{const h=this.tokenQ.get()||null,b=Kt({pageVisible:this.pageVisible.get(),status:this.svc.round.get()?.status??null});if(s!==h&&(t?.stop(),t=null,s=null,c(),r=!1),!b){t?.stop(),t=null,s=null,c(),r=!1;return}if(r){u();return}if(t===null&&h){s=h;try{const g=Qa({token:h,since:this.svc.persistedCursor(h),onEvent:x=>this.svc.onLiveResultEvent(x),onDegrade:()=>{t=null,r=!0,u()}});r||(t=g)}catch{t=null,r=!0,u()}}})),this.track(()=>{t?.stop(),t=null,s=null,c()}),this.track(N(()=>{const h=this.tab.get(),b=this.svc.selectedSlotDefId(),g=this.svc.holeIdx.get();if(this.router.route.get()!=="/round"||!this.hasRound.get())return;const x=this.tokenQ.get();if(!x)return;const O={token:x};h==="leaderboard"&&(O.tab="board");const L=this.svc.round.get()?.formatSlots[0]?.slotDefId??null;b&&b!==L&&(O.slot=b),g>0&&(O.hole=g+1),this.router.navigate(this.router.route.get(),{replace:!0,query:O})}));const f={not_started:"Not started",active:"Live",complete:"Finished"},m=this.wire(Za,{back:{onclick:()=>this.router.navigate("/")},notfound:{className:()=>!this.hasRound.get()&&!this.svc.loading.get()?"round-view__notfound":"round-view__notfound hidden"},body:{className:()=>this.hasRound.get()?"round-view__body":"round-view__body hidden"},title:()=>qa(this.svc.round.get()),course:()=>this.svc.round.get()?.courseNameSnapshot??"",status:()=>{const h=this.svc.round.get()?.status??"not_started";return f[h]??h},scorePanel:{className:()=>this.tab.get()==="score"?"round-view__panel":"round-view__panel hidden"},groupTabs:{className:()=>this.svc.groups().length>1?"round-view__groups":"round-view__groups hidden"},lbPanel:{className:()=>this.tab.get()==="leaderboard"?"round-view__panel":"round-view__panel hidden"},shareUrl:{value:()=>this.shareUrl.get()},copy:{onclick:()=>{navigator.clipboard?.writeText(this.shareUrl.get())}},manageBtn:{className:()=>this.hasRound.get()?"round-view__manage":"round-view__manage hidden",onclick:()=>this.manageOpen.set(!0)},dock:{className:()=>this.hasRound.get()&&!this.svc.keypadOpen.get()?"round-view__dock":"round-view__dock hidden"},holebar:{className:()=>this.tab.get()==="score"&&this.hasScoring.get()?"round-hole":"round-hole hidden"},holePar:()=>String(this.svc.parFor(this.svc.currentPlayedHole()?.playHoleId??null)),holeNum:()=>{const h=this.svc.currentPlayedHole();return h?this.svc.occLabel(h.playHoleId):""},holeSi:()=>{const h=this.svc.currentPlayHole()?.baseStrokeIndex;return h!=null?String(h):"–"},holePrev:{onclick:()=>this.svc.prevHole(),disabled:()=>!this.svc.canPrevHole()},holeNext:{onclick:()=>this.svc.nextHole(),disabled:()=>!this.svc.canNextHole()},tabScore:{className:()=>this.tab.get()==="score"?"round-tabs__tab active":"round-tabs__tab",onclick:()=>this.tab.set("score")},tabBoard:{className:()=>this.tab.get()==="leaderboard"?"round-tabs__tab active":"round-tabs__tab",onclick:()=>{this.tab.set("leaderboard"),this.svc.loadResult()}}});return this.$each(this.ref(m,"groupTabs"),new S(()=>this.svc.groups()),(h,b,g)=>this.groupPill(b,g),h=>h.id),this.$each(this.ref(m,"formats"),new S(()=>this.svc.round.get()?.formatSlots??[]),(h,b,g)=>this.slotPill(h,b,g),h=>h.slotDefId),this.spawn(Ha,this.ref(m,"hcpCheckin")),this.spawn(Dr,this.ref(m,"scoring")),this.spawn(ya,this.ref(m,"leaderboard")),this.spawn(Na,this.ref(m,"seats")),this.spawn(xa,this.ref(m,"claim")),this.spawn(ja,this.ref(m,"join")),this.spawn(Ga,this.ref(m,"manageHost"),{open:this.manageOpen}),m}readUrlPosition(){const e=new URLSearchParams(location.search),t=e.get("slot"),s=Number(e.get("hole"));return{tab:e.get("tab")==="board"?"leaderboard":"score",selectedSlot:Ja(t),holeIdx:Number.isFinite(s)&&s>0?s-1:0}}groupPill(e,t){return this.wireEl(to,{pill:{textContent:()=>{const s=this.svc.groups()[e];if(!s)return`Group ${e+1}`;const i=[`Group ${e+1}`];s.startTime.includes(":")&&i.push(s.startTime);const r=this.svc.playHoleById(s.startPlayHoleId)?.courseHoleNumber;return r!==void 0&&s.startOrdinal!==1&&i.push(`H${r}`),i.join(" · ")},className:()=>this.svc.groupIdx.get()===e?"round-view__grp active":"round-view__grp",onclick:()=>this.svc.groupIdx.set(e)}},t)}slotPill(e,t,s){return this.wireEl(eo,{pill:{textContent:()=>ks(e),className:()=>this.tab.get()==="leaderboard"&&this.svc.selectedSlotDefId()===e.slotDefId?"round-view__fmt active":"round-view__fmt",onclick:()=>{this.svc.selectSlot(e.slotDefId),this.tab.get()!=="leaderboard"&&(this.tab.set("leaderboard"),this.svc.loadResult())}}},s)}}function Ls(n){return n.formatIndex??n.slotIndex??null}function no(n,e){return n.filter(t=>Ls(t)===e)}function io(n){return n.filter(e=>!e.path?.startsWith("producers")&&!e.path?.startsWith("playingGroups")&&e.path!=="route"&&Ls(e)===null)}function se(n){return`${n} ${n===1?"player":"players"}`}function ke(n,e){const t=n.formatId?e(n.formatId)??n.formatId:null,s=n.teamLabel;switch(n.code){case"team_size_above_max":if(t&&s&&n.actual!==void 0&&n.allowedMax!==void 0)return`${s} has ${se(n.actual)} — ${t} allows at most ${n.allowedMax} per team.`;break;case"team_size_below_min":if(t&&s&&n.actual!==void 0&&n.allowedMin!==void 0)return`${s} has ${se(n.actual)} — ${t} needs at least ${n.allowedMin} per team.`;break;case"empty_team_grouping":if(t&&s)return`${s} has no players — add at least one, or remove the team.`;break;case"team_count_above_max":if(t&&n.actual!==void 0&&n.allowedMax!==void 0)return`${n.actual} teams — ${t} allows at most ${n.allowedMax}.`;break;case"team_count_below_min":if(t&&n.actual!==void 0&&n.allowedMin!==void 0)return`${n.actual} teams — ${t} needs at least ${n.allowedMin}.`;break;case"slot_ball_count_above_max":if(t&&n.actual!==void 0&&n.allowedMax!==void 0)return`${se(n.actual)} in ${t} — it scores at most ${n.allowedMax}.`;break;case"slot_ball_count_below_min":if(t&&n.actual!==void 0&&n.allowedMin!==void 0)return`${se(n.actual)} in ${t} — it needs at least ${n.allowedMin}.`;break;case"slot_ball_count_not_multiple":if(t&&n.actual!==void 0)return`${t} pairs its balls, so it needs an even number — ${se(n.actual)} won't pair up.`;break;case"missing_team_grouping":if(t)return`${t} compares teams — under Teams, group the players into “Separate balls (a side)” teams, then tick them under “Scores”.`;break;case"ball_mode_violation":if(t&&n.actual!==void 0)return n.actual>1?`${t} is played with everyone on their own ball — a “One combined ball” team can’t play it. Use a “Separate balls (a side)” team instead.`:`${t} is played on one shared team ball — under Teams, group the players into a “One combined ball” team, then tick that team instead of the individual players.`;break;case"producer_count_violation":if(t&&n.actual!==void 0&&n.allowedMin!==void 0&&n.allowedMax!==void 0){if(n.allowedMax===1&&n.actual>1)return`${t} is played with everyone on their own ball — a “One combined ball” team can’t play it. Use a “Separate balls (a side)” team instead.`;const i=n.allowedMin===n.allowedMax?`exactly ${se(n.allowedMin)}`:`${n.allowedMin}–${n.allowedMax} players`;return`A ball in ${t} has ${se(n.actual)} — it needs ${i} per ball.`}break;case"producer_has_scores":return n.message;case"scored_ball_orphaned":return n.message;case"edit_locked_course_route":return"Scores have already been recorded — the course and route are locked for this round.";case"round_complete":return"This round is complete — its setup can no longer be edited.";case"not_editable":return"This round can no longer be edited."}return n.message}function ro(n){return n?n.type==="flat"?String(n.pct):n.bands.length>0?String(n.bands[0].pct):"100":"100"}function ao(n){const e={};if(!n||typeof n!="object")return e;for(const[t,s]of Object.entries(n))typeof s=="string"&&(e[t]=s);return e}function oo(n){const e=n.roundType;if(e==="full_18"||e==="front_9"||e==="back_9")return{preset:e,startHole:lo(n)};const t=(n.route?.playHoles??[]).map(a=>a.courseHoleNumber),s=t[0]??1,i=new Set(t);return{preset:t.length<=9&&[...i].every(a=>a<=9)?"front_9":t.length<=9&&[...i].every(a=>a>=10)?"back_9":"full_18",startHole:s}}function lo(n){return n.roundType==="back_9"?10:1}function co(n,e=()=>""){let t=1,s=1,i=1,r=1;const a=new Map,d=n.producers.map(g=>{const x=t++;a.set(g.producerDefId,x);const O=g.playerRef.kind==="guest";return{key:x,name:e(g.producerDefId),handicapIndex:je(g.handicapIndex),gender:g.gender??"M",teeId:g.teeId,producerDefId:g.producerDefId,...O?{guestPlayerId:g.playerRef.id,guestOriginalName:e(g.producerDefId)}:{playerId:g.playerRef.id,genderKnown:g.gender!=null}}}),c=new Map;(n.teams??[]).forEach(g=>{c.set(g.id,s++)});const u=(n.teams??[]).map(g=>{const x=c.get(g.id),O={},L={};for(const I of g.members)if("producerDefId"in I){const A=a.get(I.producerDefId);A!==void 0&&(O[A]=String(I.allowancePct))}else{const A=c.get(I.teamId);A!==void 0&&(L[A]=!0)}return{key:x,kind:g.kind??"single_ball",formation:g.formation??"scramble",pctByPlayer:O,memberTeams:L,autoCreated:!1}}),f=(n.playingGroups??[]).map(g=>{const x={};for(const O of g.members){const L=a.get(O);L!==void 0&&(x[L]=!0)}return{key:i++,startTime:g.startTime??"",startHole:g.startHole??null,members:x}}),m=n.formats.map(g=>{const x={},O={},L=g.subjects;if(L){const I=new Set;for(const A of L)if(A.kind==="player"){const F=a.get(A.producerDefId);F!==void 0&&I.add(F)}else{const F=c.get(A.teamId);F!==void 0&&(O[F]=!0)}for(const A of d)x[A.key]=I.has(A.key)}return{key:r++,formatId:g.formatId,allowancePct:ro(g.allowanceConfig),subjectPlayers:x,subjectTeams:O,config:ao(g.formatConfig)}}),{preset:h,startHole:b}=oo(n);return{courseId:n.courseId,preset:h,startHole:b,players:d,teams:u,groups:f,formatSlots:m,nextKey:t,nextTeamKey:s,nextGroupKey:i,nextSlotKey:r}}function uo(n){return n.toLowerCase().startsWith("sv")?"Spel":"Game"}function ho(n,e){return new Intl.DateTimeFormat(e,{dateStyle:"medium"}).format(n)}function po(n=new Date,e=typeof navigator>"u"?"en":navigator.language,t=[]){const s=`${uo(e)} ${ho(n,e)}`,i=new Set(t.map(r=>r.trim().toLowerCase()).filter(r=>r.length>0));if(!i.has(s.toLowerCase()))return s;for(let r=2;r<=99;r++){const a=`${s} (${r})`;if(!i.has(a.toLowerCase()))return a}return s}const mo=["scramble","greensomes","foursomes","custom"],Se=2,fo="ABCDEFGH",go={full_18:"Full 18",front_9:"Front 9",back_9:"Back 9"};class bo{loading=new p(!1);error=new p(null);courses=new p([]);tees=new p([]);roundName=new p("");courseId=new p("");preset=new p("full_18");startHole=new p(1);players=new p([]);teams=new p([]);groups=new p([]);formatSlots=new p([]);picked=new p([]);customOpen=new p(!1);submitting=new p(!1);diagnostics=new p([]);submitError=new p(null);editToken=new p(null);hasScores=new p(!1);editStatus=new p(null);editBlockedReason=new p(null);editPlayedAt=null;catalog=B.get(fe);nextKey=1;nextSlotKey=1;nextTeamKey=1;nextGroupKey=1;nextPickKey=1;reset(){this.courses.set([]),this.tees.set([]),this.roundName.set(""),this.courseId.set(""),this.preset.set("full_18"),this.startHole.set(1),this.players.set([]),this.teams.set([]),this.groups.set([]),this.formatSlots.set([]),this.picked.set([]),this.customOpen.set(!1),this.diagnostics.set([]),this.submitError.set(null),this.submitting.set(!1),this.error.set(null),this.editToken.set(null),this.hasScores.set(!1),this.editStatus.set(null),this.editBlockedReason.set(null),this.editPlayedAt=null,this.nextKey=1,this.nextSlotKey=1,this.nextTeamKey=1,this.nextGroupKey=1,this.nextPickKey=1}async load(){this.seedDefaultName(),this.catalog.load().then(()=>this.ensureDefaultGame());const e=await z(this.loading,this.error,()=>v.setup.courses());e&&(this.courses.set(e),!this.courseId.get()&&e.length>0&&await this.selectCourse(e[0].id))}seedDefaultName(e=new Date){if(this.roundName.get()!=="")return;const t=Me().map(s=>s.name??"").filter(s=>s!=="");this.roundName.set(po(e,void 0,t))}async loadForEdit(e){this.reset(),this.editToken.set(e),await this.catalog.load();const t=await z(this.loading,this.error,()=>v.friendlyRounds.setup({token:e}));if(!t)return;if(this.editStatus.set(t.status),!t.editable){this.editBlockedReason.set(t.reason);return}if(t.draft.producers.some(c=>"placeholder"in c)){this.editBlockedReason.set("has_open_seats");return}this.hasScores.set(t.hasScores),this.editPlayedAt=t.draft.playedAt,this.roundName.set(t.draft.name??"");const s=await z(this.loading,this.error,()=>v.setup.courses());s&&this.courses.set(s);const i=await z(this.loading,this.error,()=>v.setup.teesByCourse({courseId:t.draft.courseId}));this.tees.set(i??[]);const r=await z(this.loading,this.error,()=>v.friendlyRounds.balls({token:e})),a=new Map;for(const c of r??[])for(const u of c.players)a.set(u.producerDefId,u.displayName);const d=co(t.draft,c=>a.get(c)??"");this.courseId.set(d.courseId),this.preset.set(d.preset),this.startHole.set(d.startHole),this.players.set(d.players),this.teams.set(d.teams),this.groups.set(d.groups),this.formatSlots.set(d.formatSlots),this.picked.set([]),this.customOpen.set(!0),this.nextKey=d.nextKey,this.nextTeamKey=d.nextTeamKey,this.nextGroupKey=d.nextGroupKey,this.nextSlotKey=d.nextSlotKey}async selectCourse(e){this.courseId.set(e),this.preset.set("full_18"),this.startHole.set(1);const s=await z(this.loading,this.error,()=>v.setup.teesByCourse({courseId:e}))??[];this.tees.set(s);const i=new Set(s.map(a=>a.id)),r=s[0]?.id??"";this.players.set(this.players.get().map(a=>({...a,teeId:i.has(a.teeId)?a.teeId:r}))),this.players.get().length===0&&this.addPlayer()}addPlayer(){const e=this.tees.get()[0]?.id??"";this.players.set([...this.players.get(),{key:this.nextKey++,name:"",handicapIndex:"",gender:"M",teeId:e}]),this.syncGamesToRoster()}addMe(e){this.addFriend(e)}addFriend(e){if(this.hasPlayer(e.id))return;const t=this.tees.get()[0]?.id??"";this.players.set([...this.players.get(),{key:this.nextKey++,name:e.displayName,handicapIndex:e.handicapIndex===null?"":je(e.handicapIndex),gender:e.gender??"M",genderKnown:e.gender!=null,teeId:t,playerId:e.id}]),this.syncGamesToRoster()}hasPlayer(e){return this.players.get().some(t=>t.playerId===e)}removePlayer(e){this.players.set(this.players.get().filter(t=>t.key!==e)),this.groups.set(this.groups.get().map(t=>{if(t.members[e]===void 0)return t;const s={...t.members};return delete s[e],{...t,members:s}})),this.syncGamesToRoster()}patchPlayer(e,t){this.players.set(this.players.get().map(s=>s.key===e?{...s,...t}:s))}ensureDefaultGame(){if(this.editToken.get()||this.formatSlots.get().length>0||this.picked.get().length>0||this.catalog.byId("stableford_individual")&&(this.pickGame("stableford_individual"),this.formatSlots.get().length>0))return;const e=this.catalog.descriptors.get()[0];e&&this.addFormatSlot(e.id)}addFormatSlot(e){const t=e??this.catalog.byId("stableford_individual")?.id??this.catalog.descriptors.get()[0]?.id??"",s={key:this.nextSlotKey++,formatId:t,allowancePct:"100",subjectPlayers:{},subjectTeams:{},config:this.defaultConfigFor(t)};this.formatSlots.set([...this.formatSlots.get(),s])}setSlotAllowance(e,t){this.patchFormatSlot(e,{allowancePct:t})}defaultConfigFor(e){return{...this.catalog.byId(e)?.defaults.formatConfig??{}}}setSlotConfig(e,t,s){const i=this.slotByKey(e);i&&this.patchFormatSlot(e,{config:{...i.config,[t]:s}})}slotConfigValue(e,t){return this.slotByKey(e)?.config[t.key]??t.default}removeFormatSlot(e){this.formatSlots.set(this.formatSlots.get().filter(t=>t.key!==e))}patchFormatSlot(e,t){this.formatSlots.set(this.formatSlots.get().map(s=>s.key===e?{...s,...t}:s))}setSlotFormat(e,t){this.patchFormatSlot(e,{formatId:t,config:this.defaultConfigFor(t)})}slotByKey(e){return this.formatSlots.get().find(t=>t.key===e)??null}teamLetter(e){return fo[e]??`T${e+1}`}presetGames(){return this.catalog.presets()}shapeOfGame(e){const t=this.catalog.byId(e);return t?this.catalog.playableShape(t):null}isIndividualShape(e){return e.size.max===1&&e.count.max===void 0}isIndividualGame(e){const t=this.shapeOfGame(e);return t?this.isIndividualShape(t):!1}minPlayersFor(e){const t=this.shapeOfGame(e);return!t||this.isIndividualShape(t)?0:t.count.min*t.size.min}gameFits(e){return this.players.get().length>=this.minPlayersFor(e)}gameNeedsText(e){const t=this.minPlayersFor(e),s=Math.max(0,t-this.players.get().length);return`Needs ${t} players — add ${s} more.`}gameShapeText(e){const t=this.shapeOfGame(e);if(!t)return"";if(this.isIndividualShape(t))return"Everyone plays their own ball";const s=t.count.max===t.count.min?`${t.count.min} balls`:`${t.count.min}+ balls`,i=t.size.max===1?"one player each":t.size.min===t.size.max?`${t.size.min} players each`:t.size.min===1?"each a player or a team":`${t.size.min}–${t.size.max} players each`;return`${s} · ${i}`}isGamePicked(e){return this.picked.get().some(t=>t.formatId===e)}pickedByKey(e){return this.picked.get().find(t=>t.key===e)??null}gameLabel(e){return this.catalog.labelOf(e)??e}toggleGame(e){const t=this.picked.get().find(s=>s.formatId===e);t?this.unpickGame(t.key):this.pickGame(e)}pickGame(e){const t=this.shapeOfGame(e);if(!t||this.isGamePicked(e)||!this.gameFits(e))return;const s=this.isIndividualShape(t)?null:this.adoptableTeams(t),i=s?{key:this.nextPickKey++,formatId:e,ballCount:s.length,ballByPlayer:this.assignmentFromTeams(s),ballTeams:Object.fromEntries(s.map((r,a)=>[a,r.key]))}:{key:this.nextPickKey++,formatId:e,ballCount:this.isIndividualShape(t)?0:t.count.min,ballByPlayer:this.defaultAssignment(t,this.isIndividualShape(t)?0:t.count.min),ballTeams:{}};this.picked.set([...this.picked.get(),i]),this.regenerateGame(i)}adoptableTeams(e){const t=this.teams.get().filter(i=>i.kind==="multi_ball");if(t.length===0||t.length<e.count.min||e.count.max!==void 0&&t.length>e.count.max)return null;const s=new Set;for(const i of t){const r=this.teamMemberCount(i.key);if(r<e.size.min||r>e.size.max)return null;for(const a of Object.keys(i.pctByPlayer)){if(s.has(Number(a)))return null;s.add(Number(a))}}return t}assignmentFromTeams(e){const t={};for(const s of this.players.get()){const i=e.findIndex(r=>r.pctByPlayer[s.key]!==void 0);i>=0&&(t[s.key]=i)}return t}unpickGame(e){this.picked.set(this.picked.get().filter(t=>t.key!==e)),this.formatSlots.set(this.formatSlots.get().filter(t=>t.gameKey!==e)),this.collectUnreferencedTeams()}collectUnreferencedTeams(){const e=new Set;for(const s of this.formatSlots.get())for(const[i,r]of Object.entries(s.subjectTeams))r&&e.add(Number(i));for(const s of this.picked.get())for(const i of Object.values(s.ballTeams))e.add(i);const t=this.teams.get().filter(s=>!s.autoCreated||e.has(s.key));t.length!==this.teams.get().length&&this.teams.set(t)}defaultAssignment(e,t){const s={};if(t<=0)return s;const i=this.players.get(),r=i.length%t===0?i.length/t:e.size.min,a=Math.max(1,Math.min(r,e.size.max));let d=0;for(let c=0;c<t&&d<i.length;c++)for(let u=0;u<a&&d<i.length;u++,d++)s[i[d].key]=c;return s}gameBalls(e){const t=this.pickedByKey(e);return t?Array.from({length:t.ballCount},(s,i)=>i):[]}ballOf(e,t){const s=this.pickedByKey(e)?.ballByPlayer[t];return s===void 0?null:s}assignBall(e,t,s){const i=this.pickedByKey(e);if(!i)return;const r={...i.ballByPlayer};s===null?delete r[t]:r[t]=s,this.applyGameEdit({...i,ballByPlayer:r})}applyGameEdit(e){this.picked.set(this.picked.get().map(t=>t.key===e.key?e:t)),this.regenerateGame(e),this.syncGamesFromTeams(e.key)}syncGamesFromTeams(e){const t=new Map(this.teams.get().map(r=>[r.key,r])),s=[],i=this.picked.get().map(r=>{if(r.key===e)return r;const a={...r.ballByPlayer};let d=!1;for(const[u,f]of Object.entries(r.ballTeams)){const m=t.get(f);if(!m)continue;const h=Number(u);for(const[b,g]of Object.entries(a)){const x=Number(b);g===h&&m.pctByPlayer[x]===void 0&&(delete a[x],d=!0)}for(const b of Object.keys(m.pctByPlayer)){const g=Number(b);a[g]!==h&&(a[g]=h,d=!0)}}if(!d)return r;const c={...r,ballByPlayer:a};return s.push(c),c});this.picked.set(i);for(const r of s)this.regenerateGame(r)}forkGame(e){const t=this.pickedByKey(e);if(!t)return;const s=this.teams.get(),i={},r=[];let a=-1;for(const[c,u]of Object.entries(t.ballTeams)){const f=s.findIndex(h=>h.key===u);if(f<0)continue;const m=s[f];r.push({...m,key:this.nextTeamKey++,pctByPlayer:{...m.pctByPlayer},memberTeams:{...m.memberTeams},autoCreated:!0}),i[Number(c)]=r.at(-1).key,f>a&&(a=f)}this.teams.set([...s.slice(0,a+1),...r,...s.slice(a+1)]);const d={...t,ballTeams:i};this.picked.set(this.picked.get().map(c=>c.key===e?d:c)),this.regenerateGame(d)}canAddBall(e){const t=this.pickedByKey(e);if(!t||t.ballCount===0)return!1;const s=this.shapeOfGame(t.formatId);return!!s&&(s.count.max===void 0||t.ballCount<s.count.max)}addBall(e){const t=this.pickedByKey(e);!t||!this.canAddBall(e)||this.applyGameEdit({...t,ballCount:t.ballCount+1})}slotForGame(e){return this.formatSlots.get().find(t=>t.gameKey===e)??null}ballMembers(e,t){const s=this.pickedByKey(e);return s?this.players.get().filter(i=>s.ballByPlayer[i.key]===t):[]}sittingOut(e){const t=this.pickedByKey(e);return!t||t.ballCount===0?[]:this.players.get().filter(s=>t.ballByPlayer[s.key]===void 0)}regenerateGame(e){const t=this.shapeOfGame(e.formatId);if(!t)return;const s=this.players.get(),i={},r={},a=[];let d=this.teams.get();for(let m=0;m<e.ballCount;m++){const h=s.filter(I=>e.ballByPlayer[I.key]===m),b=e.ballTeams[m];if(h.length===0){b!==void 0&&(r[m]=b);continue}if(h.length===1&&t.size.min===1){i[h[0].key]=!0,b!==void 0&&(r[m]=b);continue}const g=d.find(I=>I.key===e.ballTeams[m]),x=Object.fromEntries(h.map(I=>[I.key,g?.pctByPlayer[I.key]??"100"]));if(g){d=d.map(I=>I.key===g.key?{...I,kind:"multi_ball",pctByPlayer:x}:I),r[m]=g.key,a.push(g.key);continue}const O={key:this.nextTeamKey++,kind:"multi_ball",formation:"custom",pctByPlayer:x,memberTeams:{},autoCreated:!0},L=this.lastTeamIndexOf(d,r,e);d=[...d.slice(0,L+1),O,...d.slice(L+1)],r[m]=O.key,a.push(O.key)}if(e.ballCount>0)for(const m of s)i[m.key]===void 0&&(i[m.key]=!1);this.teams.set(d),this.picked.set(this.picked.get().map(m=>m.key===e.key?{...m,ballTeams:r}:m));const c=this.formatSlots.get(),u=c.find(m=>m.gameKey===e.key),f={key:u?.key??this.nextSlotKey++,formatId:e.formatId,allowancePct:u?.allowancePct??"100",subjectPlayers:i,subjectTeams:Object.fromEntries(a.map(m=>[m,!0])),config:u?.config??this.defaultConfigFor(e.formatId),gameKey:e.key};this.formatSlots.set(u?c.map(m=>m.key===f.key?f:m):[...c,f]),this.collectUnreferencedTeams()}lastTeamIndexOf(e,t,s){const i=new Set([...Object.values(t),...Object.values(s.ballTeams)]);let r=e.length-1;for(const[a,d]of e.entries())i.has(d.key)&&(r=a);return r}syncGamesToRoster(){const e=this.players.get(),t=new Set(e.map(i=>i.key)),s=this.picked.get().map(i=>{if(i.ballCount===0)return i;const r=this.shapeOfGame(i.formatId)?.size.min??1,a={};for(const[d,c]of Object.entries(i.ballByPlayer))t.has(Number(d))&&c<i.ballCount&&(a[Number(d)]=c);for(const d of e)if(a[d.key]===void 0){for(let c=0;c<i.ballCount;c++)if(Object.values(a).filter(f=>f===c).length<r){a[d.key]=c;break}}return{...i,ballByPlayer:a}});this.picked.set(s);for(const i of s)this.regenerateGame(i);this.syncGamesFromTeams(-1)}gameWarnings(e){const t=this.pickedByKey(e),s=t?this.shapeOfGame(t.formatId):null;if(!t||!s)return[];const i=this.gameLabel(t.formatId);if(!this.gameFits(t.formatId))return[`${i}: ${this.gameNeedsText(t.formatId)}`];const r=[];for(let a=0;a<t.ballCount;a++){const d=this.ballMembers(e,a).length,c=`${i} ball ${this.teamLetter(a)}`;if(d<s.size.min){const u=s.size.min-d;r.push(`${c} needs ${u} more player${u===1?"":"s"}.`)}else d>s.size.max&&r.push(`${c} takes at most ${s.size.max}.`)}return r}gameSummary(e){const t=this.pickedByKey(e);if(!t)return"";const s=r=>r.name.trim()||"Player",i=[];if(t.ballCount===0)i.push("everyone");else{const r=[];for(let d=0;d<t.ballCount;d++){const c=this.ballMembers(e,d);c.length>0&&r.push(c.map(s).join(" & "))}i.push(r.join(" vs "));const a=this.sittingOut(e);a.length>0&&i.push(`${a.map(s).join(", ")} sitting out`)}return i.push(`${this.slotForGame(e)?.allowancePct??"100"}% allowance`),i.filter(r=>r!=="").join(" · ")}teamsOfGame(e){const t=this.pickedByKey(e);if(!t)return[];const s=this.slotForGame(e)?.subjectTeams??{},i=[];for(let r=0;r<t.ballCount;r++){const a=this.teamByKey(t.ballTeams[r]??-1);a&&s[a.key]&&i.push(a)}return i}gameSharedWith(e){const t=new Set(this.teamsOfGame(e).map(r=>r.key));if(t.size===0)return[];const s=this.slotForGame(e)?.key,i=[];for(const r of this.formatSlots.get()){if(r.key===s)continue;Object.entries(r.subjectTeams).some(([d,c])=>c&&t.has(Number(d)))&&i.push(this.gameLabel(r.formatId))}return i}gameSharesSides(e){return this.gameSharedWith(e).length>0}gameSidesText(e){const t=this.pickedByKey(e);if(!t||this.teamsOfGame(e).length===0)return"";const s=this.slotForGame(e)?.subjectTeams??{},i=[];for(let d=0;d<t.ballCount;d++){const c=this.teamByKey(t.ballTeams[d]??-1);if(c&&s[c.key]){i.push(this.teamLabel(c));continue}const u=this.ballMembers(e,d);u.length>0&&i.push(u.map(f=>f.name.trim()||"Player").join(" & "))}const r=i.join(" vs "),a=this.gameSharedWith(e);return a.length===0?`Sides: ${r}.`:`Sides: ${r} — shared with ${this.joinLabels(a)}.`}joinLabels(e){return e.length<=1?e.join(""):`${e.slice(0,-1).join(", ")} and ${e.at(-1)}`}adjustGame(e){this.gameSharesSides(e)&&this.forkGame(e);const t=new Set(Object.values(this.pickedByKey(e)?.ballTeams??{}));this.teams.set(this.teams.get().map(s=>t.has(s.key)?{...s,autoCreated:!1}:s)),this.formatSlots.set(this.formatSlots.get().map(s=>s.gameKey===e?{...s,gameKey:void 0}:s)),this.picked.set(this.picked.get().filter(s=>s.key!==e)),this.customOpen.set(!0)}addCustomGame(){this.customOpen.set(!0);const e=new Set(this.formatSlots.get().map(s=>s.formatId)),t=this.catalog.descriptors.get().find(s=>!e.has(s.id));this.addFormatSlot(t?.id)}showFlexible(){return this.customOpen.get()||this.customSlots().length>0||this.customTeams().length>0}customSlots(){return this.formatSlots.get().filter(e=>e.gameKey===void 0)}customTeams(){const e=this.cardOwnedTeamKeys();return this.teams.get().filter(t=>!e.has(t.key))}cardOwnedTeamKeys(){const e=new Set;for(const t of this.picked.get())for(const s of Object.values(t.ballTeams))e.add(s);return e}slotIndex(e){return this.formatSlots.get().findIndex(t=>t.key===e)}formations=mo;addTeam(){this.teams.set([...this.teams.get(),{key:this.nextTeamKey++,kind:"single_ball",formation:"scramble",pctByPlayer:{},memberTeams:{},autoCreated:!1}])}teamKindOf(e){return this.teamByKey(e)?.kind??"single_ball"}setTeamKind(e,t){this.teams.set(this.teams.get().map(s=>s.key===e?{...s,kind:t,memberTeams:t==="single_ball"?{}:s.memberTeams}:s)),this.pruneStaleTeamSubjects()}eligibleNestedTeams(e){return this.teams.get().filter(t=>t.key!==e&&t.kind==="single_ball")}teamHasTeamMember(e,t){return this.teamByKey(e)?.memberTeams[t]===!0}setTeamMemberTeam(e,t,s){const i=this.teamByKey(e);if(!i||i.kind!=="multi_ball"||t===e)return;const r={...i.memberTeams};if(s){if(this.teamMemberCount(e)>=Ne)return;r[t]=!0}else delete r[t];this.teams.set(this.teams.get().map(a=>a.key===e?{...a,memberTeams:r}:a))}teamMemberCount(e){const t=this.teamByKey(e);return t?Object.keys(t.pctByPlayer).length+Object.keys(t.memberTeams).filter(s=>t.memberTeams[Number(s)]).length:0}pruneStaleTeamSubjects(){this.formatSlots.set(this.formatSlots.get().map(e=>{let t=!1;const s={...e.subjectTeams};for(const i of this.teams.get())s[i.key]===!0&&!this.teamKindFitsFormat(e.formatId,i.kind)&&(delete s[i.key],t=!0);return t?{...e,subjectTeams:s}:e}))}isSideFormat(e){return this.catalog.isSideFormat(e)}teamKindFitsFormat(e,t){return this.isSideFormat(e)?t==="multi_ball":t==="single_ball"||this.catalog.acceptsSideSubjects(e)}removeTeam(e){this.teams.set(this.teams.get().filter(t=>t.key!==e).map(t=>{if(t.memberTeams[e]===void 0)return t;const s={...t.memberTeams};return delete s[e],{...t,memberTeams:s}})),this.formatSlots.set(this.formatSlots.get().map(t=>{if(t.subjectTeams[e]===void 0)return t;const s={...t.subjectTeams};return delete s[e],{...t,subjectTeams:s}}))}teamByKey(e){return this.teams.get().find(t=>t.key===e)??null}teamLabel(e){const t=this.teams.get().findIndex(s=>s.key===e.key);return`Team ${this.teamLetter(Math.max(0,t))}`}setTeamFormation(e,t){this.teams.set(this.teams.get().map(s=>s.key===e?{...s,formation:t}:s))}teamMemberIn(e,t){return this.teamByKey(e)?.pctByPlayer[t]!==void 0}setTeamMember(e,t,s){const i=this.teamByKey(e);if(!i)return;const r={...i.pctByPlayer};if(s){if(r[t]!==void 0||this.teamMemberCount(e)>=Ne)return;r[t]=r[t]??"100"}else delete r[t];this.teams.set(this.teams.get().map(a=>a.key===e?{...a,pctByPlayer:r}:a))}teamSize(e){return this.teamMemberCount(e)}teamAtMaxSize(e){return this.teamSize(e)>=Ne}teamBallCh(e){const t=this.teamByKey(e);if(!t)return null;let s=0;for(const i of this.players.get()){const r=t.pctByPlayer[i.key];if(r===void 0)continue;const a=this.derivedCH(i);if(!a)return null;s+=this.parsePct(r)*a.ch/100}return Math.round(s)}teamsBelowMin(){return this.teams.get().filter(e=>this.teamMemberCount(e.key)>0&&this.teamMemberCount(e.key)<Se)}isTeamLive(e){const t=Object.keys(e.pctByPlayer).length;if(e.kind==="single_ball")return t>=Se;let s=t;for(const i of this.teams.get())e.memberTeams[i.key]===!0&&i.kind==="single_ball"&&Object.keys(i.pctByPlayer).length>=Se&&s++;return s>=Se}liveTeamKeySet(){return new Set(this.teams.get().filter(e=>this.isTeamLive(e)).map(e=>e.key))}setTeamPct(e,t,s){const i=this.teamByKey(e);!i||i.pctByPlayer[t]===void 0||this.teams.set(this.teams.get().map(r=>r.key===e?{...r,pctByPlayer:{...r.pctByPlayer,[t]:s}}:r))}groupsEnabled(){return this.groups.get().length>0}splitIntoGroups(){if(this.groupsEnabled())return;const e={};for(const t of this.players.get())e[t.key]=!0;this.groups.set([{key:this.nextGroupKey++,startTime:"",startHole:null,members:e},{key:this.nextGroupKey++,startTime:"",startHole:null,members:{}}])}clearGroups(){this.groups.set([])}addGroup(){this.groupsEnabled()&&this.groups.set([...this.groups.get(),{key:this.nextGroupKey++,startTime:"",startHole:null,members:{}}])}removeGroup(e){const t=this.groups.get().filter(s=>s.key!==e);this.groups.set(t.length>1?t:[])}groupByKey(e){return this.groups.get().find(t=>t.key===e)??null}groupLabel(e){const t=this.groups.get().findIndex(s=>s.key===e.key);return`Group ${Math.max(0,t)+1}`}groupMemberIn(e,t){return this.groupByKey(e)?.members[t]===!0}setGroupMember(e,t,s){this.groups.set(this.groups.get().map(i=>{const r=i.key===e,a=i.members[t]===!0;if(r&&s&&!a)return{...i,members:{...i.members,[t]:!0}};if(a&&(!r||!s)){const d={...i.members};return delete d[t],{...i,members:d}}return i}))}setGroupStartTime(e,t){this.groups.set(this.groups.get().map(s=>s.key===e?{...s,startTime:t}:s))}setGroupStartHole(e,t){this.groups.set(this.groups.get().map(s=>s.key===e?{...s,startHole:t}:s))}groupSize(e){const t=this.groupByKey(e);return t?this.players.get().filter(s=>t.members[s.key]===!0).length:0}ungroupedPlayers(){if(!this.groupsEnabled())return[];const e=new Set;for(const t of this.groups.get())for(const s of Object.keys(t.members))t.members[Number(s)]&&e.add(Number(s));return this.players.get().filter(t=>!e.has(t.key))}crossGroupTeamWarnings(){if(!this.groupsEnabled())return[];const e=new Map;this.groups.get().forEach((s,i)=>{for(const r of Object.keys(s.members))s.members[Number(r)]&&e.set(Number(r),i)});const t=[];for(const s of this.teams.get()){if(s.kind!=="single_ball"||!this.isTeamLive(s))continue;const i=new Set;for(const r of Object.keys(s.pctByPlayer)){const a=e.get(Number(r));a!==void 0&&i.add(a)}i.size>1&&t.push(`${this.teamLabel(s)} plays one combined ball, but its players are in different groups — keep them in the same group.`)}return t}buildGroups(e,t){return this.groups.get().map(s=>({members:e.filter(i=>s.members[i.key]===!0).map(i=>t.get(i.key)),...s.startTime.trim()!==""?{startTime:s.startTime.trim()}:{},...s.startHole!==null?{startHole:s.startHole}:{}})).filter(s=>s.members.length>0)}diagnosticsForGroups(){return this.diagnostics.get().filter(e=>e.path?.startsWith("playingGroups"))}subjectPlayerIn(e,t){return this.slotByKey(e)?.subjectPlayers[t]!==!1}setSubjectPlayer(e,t,s){const i=this.slotByKey(e);i&&this.patchFormatSlot(e,{subjectPlayers:{...i.subjectPlayers,[t]:s}})}subjectTeamIn(e,t){return this.slotByKey(e)?.subjectTeams[t]===!0}setSubjectTeam(e,t,s){const i=this.slotByKey(e);i&&this.patchFormatSlot(e,{subjectTeams:{...i.subjectTeams,[t]:s}})}selectedCourse(){return this.courses.get().find(e=>e.id===this.courseId.get())??null}teeById(e){return this.tees.get().find(t=>t.id===e)??null}presetLabel(e){return go[e]}presetHoles(){const e=(this.selectedCourse()?.holes??[]).map(t=>t.holeNumber).sort((t,s)=>t-s);switch(this.preset.get()){case"front_9":return e.filter(t=>t<=9);case"back_9":return e.filter(t=>t>=10);default:return e}}startHoleOptions(){return this.presetHoles()}setPreset(e){this.preset.set(e);const t=this.presetHoles();t.includes(this.startHole.get())||this.startHole.set(t[0]??1),this.groups.set(this.groups.get().map(s=>s.startHole!==null&&!t.includes(s.startHole)?{...s,startHole:null}:s))}derivedCH(e){const t=W(e.handicapIndex);if(t===null)return null;const s=this.teeById(e.teeId);if(!s)return null;const i=s.ratings.find(a=>a.gender===e.gender);if(!i)return null;const r={handicapIndex:t,slope:i.slope,courseRating:i.courseRating,par:i.par};return{ch:Wi(r),raw:Is(r),rating:i,teeName:s.name}}diagnosticsForPlayer(e){return this.diagnostics.get().filter(t=>t.path?.startsWith(`producers[${e}]`))}humanizedRoster(){return this.diagnostics.get().filter(e=>e.path==="producers").map(e=>ke(e,t=>this.catalog.labelOf(t)))}humanizedRoute(){return this.diagnostics.get().filter(e=>e.path==="route").map(e=>ke(e,t=>this.catalog.labelOf(t)))}playersInNoFormat(){const e=this.players.get(),t=new Set;for(const s of this.formatSlots.get()){for(const i of e)s.subjectPlayers[i.key]!==!1&&t.add(i.key);for(const i of this.teams.get())if(s.subjectTeams[i.key]===!0)for(const r of e)i.pctByPlayer[r.key]!==void 0&&t.add(r.key)}return e.filter(s=>!t.has(s.key))}diagnosticsForFormat(e){return no(this.diagnostics.get(),e)}humanizedForFormat(e){return this.diagnosticsForFormat(e).map(t=>ke(t,s=>this.catalog.labelOf(s)))}generalDiagnostics(){return io(this.diagnostics.get())}humanizedGeneral(){return this.generalDiagnostics().map(e=>ke(e,t=>this.catalog.labelOf(t)))}parsePct(e){const t=Number.parseInt(e,10);return Number.isFinite(t)?t:100}buildTeams(e,t){const s=this.liveTeamKeySet(),i=[];for(const r of this.teams.get()){if(!s.has(r.key))continue;const a=e.filter(d=>r.pctByPlayer[d.key]!==void 0).map(d=>({producerDefId:t.get(d.key),allowancePct:this.parsePct(r.pctByPlayer[d.key])}));if(r.kind==="multi_ball")for(const d of this.teams.get())r.memberTeams[d.key]===!0&&d.key!==r.key&&d.kind==="single_ball"&&s.has(d.key)&&a.push({teamId:String(d.key)});i.push({id:String(r.key),label:this.teamLabel(r),formation:r.formation,kind:r.kind,members:a})}return i}buildFormats(e,t){const s=this.liveTeamKeySet();return this.formatSlots.get().map(i=>{const r=this.isSideFormat(i.formatId),a=[];if(!r)for(const d of e)i.subjectPlayers[d.key]!==!1&&a.push({kind:"player",producerDefId:t.get(d.key)});for(const d of this.teams.get())i.subjectTeams[d.key]===!0&&s.has(d.key)&&this.teamKindFitsFormat(i.formatId,d.kind)&&a.push({kind:"team",teamId:String(d.key)});return{formatId:i.formatId,allowanceConfig:{type:"flat",pct:this.parsePct(i.allowancePct)},subjects:a,...Object.keys(i.config).length>0?{formatConfig:{...i.config}}:{}}})}buildRoute(){const e=this.presetHoles(),t=this.startHole.get(),s=e.indexOf(t);return s<=0?{roundType:this.preset.get()}:{roundType:"custom_holes",route:{playHoles:[...e.slice(s),...e.slice(0,s)].map(r=>({courseHoleNumber:r})),routeHandicapPolicy:{type:"explicit",postingEligible:!1}}}}slotSubjectCount(e){const t=this.liveTeamKeySet(),s=this.isSideFormat(e.formatId);let i=0;if(!s)for(const r of this.players.get())e.subjectPlayers[r.key]!==!1&&i++;for(const r of this.teams.get())e.subjectTeams[r.key]===!0&&t.has(r.key)&&this.teamKindFitsFormat(e.formatId,r.kind)&&i++;return i}noSubjectsMessage(e){const t=this.catalog.labelOf(e.formatId)??e.formatId;if(e.gameKey!==void 0)return`${t} has nobody playing — put players on a ball above.`;if(!this.isSideFormat(e.formatId))return`${t} has nothing to score — tick at least one player or team under “Scores”.`;const s=this.teams.get();if(s.some(d=>d.kind==="multi_ball"&&this.isTeamLive(d)))return`${t} has no teams ticked — tick the teams it plays under “Scores”.`;if(s.some(d=>d.kind==="single_ball"&&this.isTeamLive(d)))return`${t} is played between teams whose players play their own balls — a “One combined ball” team doesn’t fit. Under Teams, switch the team to “Separate balls (a side)”, then tick it under “Scores”.`;const i=this.catalog.classifyId(e.formatId),r=i?.teamCount?.min!==void 0&&i.teamCount.min===i.teamCount.max?`${i.teamCount.min} teams`:i?.teamCount?.min!==void 0?`at least ${i.teamCount.min} teams`:"teams",a=i&&i.teamSize.min===i.teamSize.max?` of ${i.teamSize.min} players`:"";return`${t} is a team game — under Teams, create ${r}${a} with kind “Separate balls (a side)”, add the players, then tick the teams under “Scores”.`}async submit(){this.diagnostics.set([]),this.submitError.set(null);const e=this.players.get();if(!this.courseId.get())return this.submitError.set("Pick a course first."),{ok:!1};if(e.length===0)return this.submitError.set("Add at least one player."),{ok:!1};if(this.formatSlots.get().length===0)return this.submitError.set("Add at least one format."),{ok:!1};const t=[];if(e.forEach((i,r)=>{i.name.trim()||t.push({code:"missing_name",message:"Name required",path:`producers[${r}].name`}),W(i.handicapIndex)===null&&t.push({code:"missing_index",message:"Handicap index required",path:`producers[${r}].handicapIndex`}),i.teeId||t.push({code:"missing_tee",message:"Pick a tee",path:`producers[${r}].teeId`})}),this.formatSlots.get().forEach((i,r)=>{this.slotSubjectCount(i)===0&&t.push({code:"no_subjects",message:this.noSubjectsMessage(i),formatIndex:r,path:`formats[${r}]`})}),t.length>0)return this.diagnostics.set(t),{ok:!1};const s=this.editToken.get();this.submitting.set(!0);try{const i=new Map;e.forEach((b,g)=>{i.set(b.key,b.producerDefId??(s?`p-${b.key}`:`p${g+1}`))});const r=[];for(const b of e){const g=W(b.handicapIndex),x=b.playerId?{kind:"player",id:b.playerId}:b.guestPlayerId?{kind:"guest",id:b.guestPlayerId}:{kind:"guest",id:(await v.guestPlayers.create({displayName:b.name.trim(),gender:b.gender,handicapIndex:g})).id};r.push({producerDefId:i.get(b.key),playerRef:x,handicapIndex:g,gender:b.gender,teeId:b.teeId})}const{roundType:a,route:d}=this.buildRoute(),c=this.buildTeams(e,i),u=this.buildGroups(e,i),f=this.roundName.get().trim(),m={courseId:this.courseId.get(),playedAt:this.editPlayedAt??new Date().toISOString().slice(0,10),...f?{name:f}:{},roundType:a,...d?{route:d}:{},producers:r,...c.length>0?{teams:c}:{},formats:this.buildFormats(e,i),...u.length>0?{playingGroups:u}:{}};if(s){for(const g of e){const x=g.name.trim();!g.guestPlayerId||g.guestOriginalName===void 0||x!==g.guestOriginalName&&(await v.friendlyRounds.renameGuest({token:s,guestPlayerId:g.guestPlayerId,displayName:x}),this.players.set(this.players.get().map(O=>O.key===g.key?{...O,guestOriginalName:x}:O)))}const b=await v.friendlyRounds.editSetup({token:s,draft:m});return b.ok?{ok:!0,token:s}:(this.diagnostics.set(b.diagnostics),{ok:!1})}const h=await v.friendlyRounds.create({draft:m});return h.ok?(de({token:h.friendlyRound.shareToken,courseName:h.round.courseNameSnapshot??"",name:h.round.name,date:h.round.date,status:h.round.status,completedAt:h.round.completedAt,lastSeenAt:new Date().toISOString()}),{ok:!0,token:h.friendlyRound.shareToken}):(this.diagnostics.set(h.diagnostics),{ok:!1})}catch(i){return this.submitError.set(i instanceof K?i.message==="Validation failed"?["The server could not read this setup — this should not happen, please report it.",...(i.details??[]).slice(0,3).map(r=>`${r.path}: ${r.message}`)].join(`
`):i.message:s?"Could not save the round. Try again.":"Could not create the round. Try again."),{ok:!1}}finally{this.submitting.set(!1)}}}const yo=["full_18","front_9","back_9"],Ze=()=>re()==="sv"?",":".",_o=_(`
...
`);class Eo extends R{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .player {
                ...
                & .player__name { ${q()} flex: 1; padding: ${l("md")}; font-size: 1rem; }
                & .player__remove {
                    ${C()}
                ...
                & .player__index { ${q()} flex: 1; min-width: 0; padding: ${l("md")}; font-size: 1rem; }
            ...
            & .setup__friends {
                margin-top: ${l("sm")}; padding: ${l("sm")}; ${j()}
                &.hidden { display: none; }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { ${q()} width: 56px; padding: ${l("xs")} ${l("sm")}; font-size: 0.95rem; }
                    }
                }
                ...
                & .grp__start {
                    ...
                    & .grp__time { ${q()} flex: 1; min-width: 0; padding: ${l("sm")} ${l("md")}; font-size: 1rem; font-family: inherit; }
        ...
        .hcp {
            ...
            & .hcp__bs { ${C()} width: 44px; height: 44px; flex-shrink: 0; font-size: 1.1rem; }
            ...
            & .hcp__cancel { ${C()} flex: 1; padding: ${l("md")}; font-family: inherit; font-weight: 700; font-size: 0.95rem; }
            & .hcp__ok {
                ${C()}
...
`)},create:{disabled:()=>this.svc.submitting.get(),textContent:()=>this.svc.submitting.get()?t?"Saving…":"Creating…":t?"Save changes":"Create round",onclick:async()=>{const h=await this.svc.submit();h.ok&&this.router.navigate("/round",{query:{token:h.token}})}},hcpPad:{className:()=>this.hcpPadFor.get()!==null?"hcp":"hcp hidden"},hcpBackdrop:{onclick:()=>this.hcpPadFor.set(null)},hcpName:{textContent:()=>this.hcpPlayer()?.name?.trim()||"Player"},hcpCh:{textContent:()=>{const h=this.hcpPlayer();if(!h)return"";const b=this.svc.derivedCH({...h,handicapIndex:this.hcpDraft.get()});return b?`Course handicap ${b.ch} · ${b.teeName}`:"WHS index — “+” means a plus handicap."}},hcpVal:{className:()=>this.hcpDraft.get()?"hcp__val":"hcp__val empty",textContent:()=>this.hcpDraft.get()||"HCP index"},hcpBack:{onclick:()=>this.hcpDraft.set(this.hcpDraft.get().slice(0,-1))},hcpCancel:{onclick:()=>this.hcpPadFor.set(null)},hcpOk:{disabled:()=>this.hcpDraft.get()!==""&&W(this.hcpDraft.get())===null,onclick:()=>this.hcpCommit()}}),c=this.ref(d,"hcpKeys");for(const h of["1","2","3","4","5","6","7","8","9"])c.appendChild(this.hcpKey(h,"",()=>this.hcpAppendDigit(h)));c.appendChild(this.wireEl(Ut,{key:{className:()=>this.hcpDraft.get().startsWith("+")?"hcp-key on":"hcp-key",onclick:()=>this.hcpTogglePlus()},num:{textContent:"+"},lbl:{textContent:"plus hcp"}})),c.appendChild(this.hcpKey("0","",()=>this.hcpAppendDigit("0"))),c.appendChild(this.hcpKey(Ze(),"",()=>this.hcpAppendSep()));const u=h=>{if(this.hcpPadFor.get()!==null){if(h.key>="0"&&h.key<="9")this.hcpAppendDigit(h.key);else if(h.key===","||h.key===".")this.hcpAppendSep();else if(h.key==="+"||h.key==="-")this.hcpTogglePlus();else if(h.key==="Backspace")this.hcpDraft.set(this.hcpDraft.get().slice(0,-1));else if(h.key==="Enter")this.hcpCommit();else if(h.key==="Escape")this.hcpPadFor.set(null);else return;h.preventDefault()}};document.addEventListener("keydown",u),this.track(()=>document.removeEventListener("keydown",u));const f=this.ref(d,"hcpPad");document.body.appendChild(f),this.track(()=>f.remove()),this.$each(this.ref(d,"presets"),()=>yo,(h,b,g)=>this.wireEl(_('<button bind="b" type="button"></button>'),{b:{textContent:()=>this.svc.presetLabel(h),className:()=>this.svc.preset.get()===h?"on":"",disabled:()=>i(),onclick:()=>{i()||this.svc.setPreset(h)}}},g),h=>h);const m=h=>this.track(h);return this.mountSelect(this.ref(d,"course"),m,{value:this.bound(m,()=>this.svc.courseId.get(),h=>{h&&h!==this.svc.courseId.get()&&this.svc.selectCourse(h)}),options:{get:()=>{const h=[];let b="";for(const g of this.svc.courses.get())g.clubName!==b&&(h.push({value:`__club:${g.clubName}`,label:g.clubName,disabled:!0}),b=g.clubName),h.push({value:g.id,label:g.name});return h}},placeholder:"Select a course",disabled:{get:()=>i()}}),this.mountSelect(this.ref(d,"startHole"),m,{value:this.bound(m,()=>String(this.svc.startHole.get()),h=>this.svc.startHole.set(Number(h))),options:{get:()=>this.svc.startHoleOptions().map(h=>({value:String(h),label:String(h)}))},disabled:{get:()=>i()}}),this.$each(this.ref(d,"friendRows"),()=>ht(this.friends.friends.get().filter(h=>!this.svc.hasPlayer(h.id)),"frecency"),(h,b,g)=>this.wireEl(Co,{row:{onclick:()=>this.svc.addFriend({id:h.id,displayName:h.displayName,handicapIndex:h.handicapIndex,gender:h.gender})},name:()=>h.displayName,username:()=>`@${h.username}`,hcp:()=>h.handicapIndex===null?"–":h.handicapIndex.toFixed(1)},g),h=>h.id),this.$each(this.ref(d,"players"),this.svc.players,(h,b,g)=>this.playerRow(h.key,g),h=>h.key),this.$each(this.ref(d,"cards"),()=>[...this.svc.presetGames().map(h=>h.id),"__custom"],(h,b,g)=>h==="__custom"?this.wireEl(Yt,{card:{className:()=>"gcard gcard--custom",onclick:()=>this.svc.addCustomGame()},name:{textContent:"+ Custom game"},tag:{textContent:"Anything the cards don't cover — teams and formats by hand."},shape:{textContent:""}},g):this.gameCard(h,g),h=>h),this.$each(this.ref(d,"games"),this.svc.picked,(h,b,g)=>this.gamePanel(h.key,g),h=>h.key),this.$each(this.ref(d,"teams"),()=>this.svc.customTeams(),(h,b,g)=>this.teamCard(h.key,g),h=>h.key),this.$each(this.ref(d,"groups"),this.svc.groups,(h,b,g)=>this.groupCard(h.key,g),h=>h.key),this.$each(this.ref(d,"formats"),()=>this.svc.customSlots(),(h,b,g)=>this.formatCard(h.key,g),h=>h.key),d}mountSelect(e,t,s){const i=new Y(s);i.mount(e),t(()=>i.destroy())}bound(e,t,s){const i=new p(t());return e(N(()=>i.set(t()))),e(N(()=>{const r=i.get();queueMicrotask(()=>s(r))})),i}eachInto(e,t,s,i,r){const a=new Map,d=new Map;t(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),t(N(()=>{const c=s(),u=new Map;for(const[m,h]of c.entries()){const b=r(h,m);if(a.has(b))u.set(b,a.get(b));else{const g=[];u.set(b,i(h,m,x=>g.push(x))),d.set(b,g)}}for(const[m,h]of a)u.has(m)||(h.remove(),d.get(m)?.forEach(b=>b()),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);a.clear();for(const[m,h]of u)a.set(m,h)}))}gameCard(e,t){const s=()=>this.svc.gameFits(e);return this.wireEl(Yt,{card:{className:()=>this.svc.isGamePicked(e)?"gcard on":"gcard",disabled:()=>!s(),onclick:()=>this.svc.toggleGame(e)},name:{textContent:()=>this.svc.gameLabel(e)},tag:{textContent:()=>s()?this.svc.catalog.taglineOf(e):this.svc.gameNeedsText(e)},shape:{textContent:()=>s()?this.svc.gameShapeText(e):""}},t)}gamePanel(e,t){const s=()=>this.svc.pickedByKey(e),i=()=>this.svc.slotForGame(e),r=()=>s()?.formatId??"",a=()=>(s()?.ballCount??0)>0,d=this.wireEl(Io,{title:{textContent:()=>this.svc.gameLabel(r())},remove:{onclick:()=>this.svc.unpickGame(e)},desc:{textContent:()=>this.svc.catalog.byId(r())?.description??""},allowance:{value:i()?.allowancePct??"100",oninput:c=>{const u=i();u&&this.svc.setSlotAllowance(u.key,c.target.value)}},ballGroup:{hidden:()=>!a()},addBall:{className:()=>this.svc.canAddBall(e)?"gaddball":"gaddball hidden",onclick:()=>this.svc.addBall(e)},err:{textContent:()=>{const c=i();return[...this.svc.gameWarnings(e),...c?this.svc.humanizedForFormat(this.svc.slotIndex(c.key)):[]].join(" · ")}},sides:{textContent:()=>this.svc.gameSidesText(e)},fork:{className:()=>this.svc.gameSharesSides(e)?"gadjust":"gadjust hidden",onclick:()=>this.svc.forkGame(e)},summary:{textContent:()=>this.svc.gameSummary(e)},adjust:{onclick:()=>this.svc.adjustGame(e)}},t);return this.eachInto(this.ref(d,"configFields"),t,()=>this.svc.catalog.byId(r())?.configFields??[],(c,u,f)=>{const m=i();if(m)return this.configField(m.key,c,f);const h=document.createElement("div");return h.className="fslot__configs",h},c=>`${r()}:${c.key}`),this.eachInto(this.ref(d,"ballRows"),t,()=>a()?this.svc.players.get():[],(c,u,f)=>this.ballRow(e,c.key,f),c=>c.key),d}ballRow(e,t,s){const i=this.wireEl(To,{name:{textContent:()=>this.svc.players.get().find(r=>r.key===t)?.name?.trim()||"Player"}},s);return this.eachInto(this.ref(i,"seg"),s,()=>[...this.svc.gameBalls(e),null],(r,a,d)=>this.wireEl(_('<button bind="b" type="button"></button>'),{b:{textContent:()=>r===null?"–":this.svc.teamLetter(r),className:()=>this.svc.ballOf(e,t)===r?"on":"",onclick:()=>this.svc.assignBall(e,t,r)}},d),r=>String(r)),i}formatCard(e,t){const s=()=>this.svc.slotByKey(e),i=()=>s()?.formatId??"",r=this.wireEl(wo,{remove:{onclick:()=>this.svc.removeFormatSlot(e)},desc:{textContent:()=>this.svc.catalog.byId(i())?.description??""},allowance:{value:this.svc.slotByKey(e)?.allowancePct??"100",oninput:d=>this.svc.setSlotAllowance(e,d.target.value)},allowanceHint:{textContent:()=>this.svc.isSideFormat(i())?"applied to each side member’s ball":"of each player’s course handicap"},err:{textContent:()=>this.svc.humanizedForFormat(this.svc.slotIndex(e)).join(" · ")}},t);this.mountSelect(this.ref(r,"format"),t,{value:this.bound(t,()=>i(),d=>{d&&d!==this.svc.slotByKey(e)?.formatId&&this.svc.setSlotFormat(e,d)}),options:{get:()=>this.svc.catalog.descriptors.get().map(d=>({value:d.id,label:this.svc.catalog.labelOf(d)??d.label}))}}),this.eachInto(this.ref(r,"configFields"),t,()=>this.svc.catalog.byId(i())?.configFields??[],(d,c,u)=>this.configField(e,d,u),d=>`${i()}:${d.key}`);const a=()=>{const d=this.svc.isSideFormat(i()),c=[];d||c.push(...this.svc.players.get().map(u=>({kind:"player",subKey:u.key})));for(const u of this.svc.customTeams())this.svc.teamKindFitsFormat(i(),u.kind)&&c.push({kind:"team",subKey:u.key});return c};return this.eachInto(this.ref(r,"subjectRows"),t,a,(d,c,u)=>this.subjectRow(e,d.kind,d.subKey,u),d=>`${d.kind}${d.subKey}`),r}configField(e,t,s){const i=this.wireEl(xo,{label:{textContent:()=>this.svc.catalog.configLabelOf(t)}},s);return this.eachInto(this.ref(i,"options"),s,()=>t.options,(r,a,d)=>this.wireEl($o,{opt:{textContent:()=>this.svc.catalog.configLabelOf(r),className:()=>this.svc.slotConfigValue(e,t)===r.value?"on":"",onclick:()=>this.svc.setSlotConfig(e,t.key,r.value)}},d),r=>r.value),i}subjectRow(e,t,s,i){const r=()=>{if(t==="player")return this.svc.players.get().find(u=>u.key===s)?.name?.trim()||"Player";const c=this.svc.teamByKey(s);return c?`${this.svc.teamLabel(c)} (${c.kind==="multi_ball"?"side":"team"})`:"Team"},a=()=>t==="player"?this.svc.subjectPlayerIn(e,s):this.svc.subjectTeamIn(e,s),d=c=>t==="player"?this.svc.setSubjectPlayer(e,s,c):this.svc.setSubjectTeam(e,s,c);return this.wireEl(Wt,{chk:{checked:()=>a(),onchange:c=>d(c.target.checked)},name:{textContent:()=>r()}},i)}groupCard(e,t){const s=this.wireEl(So,{remove:{onclick:()=>this.svc.removeGroup(e)},groupName:{textContent:()=>{const i=this.svc.groupByKey(e);return i?this.svc.groupLabel(i):"Group"}},time:{value:this.svc.groupByKey(e)?.startTime??"",oninput:i=>this.svc.setGroupStartTime(e,i.target.value)},meta:{textContent:()=>{const i=this.svc.groupSize(e);return i===0?"Tick the players who walk with this group.":`${i} player${i===1?"":"s"}`}}},t);return this.mountSelect(this.ref(s,"hole"),t,{value:this.bound(t,()=>{const i=this.svc.groupByKey(e)?.startHole;return i==null?"":String(i)},i=>this.svc.setGroupStartHole(e,i===""?null:Number(i))),options:{get:()=>[{value:"",label:"First hole"},...this.svc.startHoleOptions().map(i=>({value:String(i),label:`Hole ${i}`}))]}}),this.eachInto(this.ref(s,"memberRows"),t,()=>this.svc.players.get(),(i,r,a)=>this.groupMemberRow(e,i.key,a),i=>i.key),s}groupMemberRow(e,t,s){return this.wireEl(Wt,{chk:{checked:()=>this.svc.groupMemberIn(e,t),onchange:i=>this.svc.setGroupMember(e,t,i.target.checked)},name:{textContent:()=>this.svc.players.get().find(i=>i.key===t)?.name?.trim()||"Player"}},s)}teamCard(e,t){const s=()=>this.svc.teamKindOf(e)==="multi_ball",i=this.wireEl(ko,{remove:{onclick:()=>this.svc.removeTeam(e)},teamName:{textContent:()=>{const r=this.svc.teamByKey(e);return r?this.svc.teamLabel(r):"Team"}},compGroup:{hidden:()=>s()},membersLabel:{textContent:()=>s()?"Members (each a ball)":"Members & allowance"},teamMeta:{textContent:()=>{const r=this.svc.teamSize(e);if(r===0)return s()?"Tick at least 2 members — a side needs ≥2 balls.":"Tick at least 2 players to form a team ball.";if(r<2)return"Add one more member — a team needs at least 2.";if(s())return`${r} balls · a side (scored together by a side format)`;const a=this.svc.teamBallCh(e);return a===null?`${r} players`:`${r} players · plays off HCP ${a}`}}},t);return this.mountSelect(this.ref(i,"kindSel"),t,{value:this.bound(t,()=>this.svc.teamKindOf(e),r=>this.svc.setTeamKind(e,r==="multi_ball"?"multi_ball":"single_ball")),options:{get:()=>[{value:"single_ball",label:"One combined ball"},{value:"multi_ball",label:"Separate balls (a side)"}]}}),this.mountSelect(this.ref(i,"formation"),t,{value:this.bound(t,()=>this.svc.teamByKey(e)?.formation??"scramble",r=>this.svc.setTeamFormation(e,r)),options:{get:()=>this.svc.formations.map(r=>({value:r,label:r[0].toUpperCase()+r.slice(1)}))}}),this.eachInto(this.ref(i,"memberRows"),t,()=>{const r=this.svc.players.get().map(a=>({kind:"player",mKey:a.key}));if(s())for(const a of this.svc.eligibleNestedTeams(e))r.push({kind:"team",mKey:a.key});return r},(r,a,d)=>r.kind==="player"?this.teamMemberRow(e,r.mKey,d):this.teamNestedRow(e,r.mKey,d),r=>`${r.kind}${r.mKey}`),i}teamNestedRow(e,t,s){const i=()=>this.svc.teamHasTeamMember(e,t);return this.wireEl(Qt,{chk:{checked:()=>i(),disabled:()=>!i()&&this.svc.teamAtMaxSize(e),onchange:r=>this.svc.setTeamMemberTeam(e,t,r.target.checked)},name:{textContent:()=>{const r=this.svc.teamByKey(t);return r?`${this.svc.teamLabel(r)} (combined ball)`:"Team"}},pctWrap:{hidden:()=>!0},pct:{value:"100",oninput:()=>{}}},s)}teamMemberRow(e,t,s){const i=()=>this.svc.players.get().find(a=>a.key===t)??null,r=()=>this.svc.teamMemberIn(e,t);return this.wireEl(Qt,{chk:{checked:()=>r(),disabled:()=>!r()&&this.svc.teamAtMaxSize(e),onchange:a=>this.svc.setTeamMember(e,t,a.target.checked)},name:{textContent:()=>i()?.name?.trim()||"Player"},pctWrap:{hidden:()=>!r()||this.svc.teamKindOf(e)==="multi_ball"},pct:{value:this.svc.teamByKey(e)?.pctByPlayer[t]??"100",oninput:a=>this.svc.setTeamPct(e,t,a.target.value)}},s)}hcpPlayer(){const e=this.hcpPadFor.get();return e===null?null:this.svc.players.get().find(t=>t.key===e)??null}openHcpPad(e){this.hcpDraft.set(this.svc.players.get().find(t=>t.key===e)?.handicapIndex??""),this.hcpPadFor.set(e)}hcpAppendDigit(e){const t=this.hcpDraft.get(),[s,i]=t.replace("+","").split(/[.,]/);if(i!==void 0){if(i.length>=1)return}else if(s.length>=2)return;this.hcpDraft.set(t+e)}hcpAppendSep(){const e=this.hcpDraft.get();/[.,]/.test(e)||this.hcpDraft.set(e.replace("+","")===""?`${e}0${Ze()}`:e+Ze())}hcpTogglePlus(){const e=this.hcpDraft.get();this.hcpDraft.set(e.startsWith("+")?e.slice(1):`+${e.replace("-","")}`)}hcpCommit(){const e=this.hcpPadFor.get();e!==null&&(this.hcpDraft.get()!==""&&W(this.hcpDraft.get())===null||(this.svc.patchPlayer(e,{handicapIndex:this.hcpDraft.get()}),this.hcpPadFor.set(null)))}hcpKey(e,t,s){return this.wireEl(Ut,{key:{onclick:s},num:{textContent:e},lbl:{textContent:t}})}playerRow(e,t){const s=()=>this.svc.players.get().find(a=>a.key===e)??null,i=()=>this.svc.players.get().findIndex(a=>a.key===e),r=this.wireEl(vo,{name:{value:s()?.name??"",readOnly:()=>!!s()?.playerId,oninput:a=>this.svc.patchPlayer(e,{name:a.target.value})},index:{value:()=>s()?.handicapIndex??"",onclick:()=>this.openHcpPad(e),onfocus:a=>{a.target.blur(),this.openHcpPad(e)}},remove:{onclick:()=>this.svc.removePlayer(e)},ch:{textContent:()=>{const a=s();if(!a)return"";const d=this.svc.derivedCH(a);if(!d)return"";const c=d.rating;return`Course handicap ${d.ch}  ·  ${a.handicapIndex} × ${c.slope}/113 + (${c.courseRating} − ${c.par}) = ${d.raw.toFixed(1)}`}},err:{textContent:()=>this.svc.diagnosticsForPlayer(i()).map(a=>a.message).join(" · ")}},t);return this.mountSelect(this.ref(r,"gender"),t,{value:this.bound(t,()=>s()?.gender??"M",a=>this.svc.patchPlayer(e,{gender:a})),options:{get:()=>[{value:"M",label:"M"},{value:"F",label:"F"}]},disabled:{get:()=>s()?.genderKnown===!0}}),this.mountSelect(this.ref(r,"tee"),t,{value:this.bound(t,()=>s()?.teeId??"",a=>this.svc.patchPlayer(e,{teeId:a})),options:{get:()=>this.svc.tees.get().map(a=>({value:a.id,label:a.name}))},placeholder:"Tee"}),r}}function As(n,e){return y({method:"POST",url:`${D}/auth/login`,body:{username:n,password:e}})}function No(){return y({method:"GET",url:`${D}/auth/me`})}function Po(){return y({method:"POST",url:`${D}/auth/logout`,body:{}})}function Oo(){return y({method:"POST",url:`${D}/auth/logout-all`,body:{}})}const et="Something went wrong on our end. Try again in a moment.";function Ro(n,e){const t=(n.details??[]).map(i=>i.path),s=i=>t.some(r=>r===`/${i}`);return s("password")?e==="register"?"Password must be at least 8 characters.":"Enter your password.":s("username")?"Enter your username.":s("displayName")?"Enter a display name.":s("handicapIndex")?"Handicap index must be a number (or leave it empty).":s("homeClubId")?'Pick a home club from the list, or leave it as "No home club".':e==="register"?"Check the details above and try again.":"Enter your username and password."}function Xt(n,e){if(n instanceof K)switch(n.status){case 400:return Ro(n,e);case 401:return"Wrong username or password.";case 404:return"That club is no longer available — pick another home club.";case 409:return e==="register"?"That username is taken. Pick another one.":et;case 429:return"Too many sign-in attempts. Wait a minute, then try again.";default:return n.status>=500?et:"That request could not be completed."}return n instanceof Error&&n.message==="Request timeout"?"That took too long. Check your connection and try again.":n instanceof Error?"Cannot reach the server. Check your connection and try again.":et}const zo=_(`
...
`);class jo extends R{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
    ...
    `;auth=this.inject(H);router=this.inject(M);nextQ=this.router.query("next");mode=new p("login");busy=new p(!1);formError=new p("");username="";password="";displayName="";hcp="";gender=new p(null);clubs=new p([]);homeClubId=new p("");clubsRequested=!1;async loadClubs(){if(!this.clubsRequested){this.clubsRequested=!0;try{this.clubs.set(await v.setup.clubs())}catch{}}}destination(e){const t=this.nextQ.get();return t&&t.startsWith("/")?t:e}async submit(){if(this.formError.set(""),this.mode.get()==="login"){if(!this.username.trim()||this.password===""){this.formError.set("Enter your username and password.");return}this.busy.set(!0);try{const s=await As(this.username.trim(),this.password);this.auth.currentUser.set(s),this.auth.error.set(null),this.router.navigate(this.destination("/"),!0)}catch(s){this.formError.set(Xt(s,"login"))}finally{this.busy.set(!1)}return}const e=this.hcp.trim(),t=e===""?null:W(e);if(e!==""&&t===null){this.formError.set("Handicap index must be a number (or leave it empty).");return}if(this.password.length<8){this.formError.set("Password must be at least 8 characters.");return}if(!this.username.trim()||!this.displayName.trim()){this.formError.set("Username and display name are required.");return}this.busy.set(!0);try{const s=await v.players.register({username:this.username.trim(),password:this.password,displayName:this.displayName.trim(),handicapIndex:t,gender:this.gender.get(),homeClubId:this.homeClubId.get()||null});this.auth.currentUser.set({id:s.id,username:s.username}),this.router.navigate(this.destination("/"),!0)}catch(s){this.formError.set(Xt(s,"register"))}finally{this.busy.set(!1)}}render(){const e=()=>this.mode.get()==="register",t=()=>this.auth.loading.get()||this.busy.get(),s=this.wire(zo,{root:{inert:()=>t()},error:{className:()=>this.formError.get()?"error show":"error",textContent:()=>this.formError.get()},form:{onsubmit:async a=>{a.preventDefault(),await this.submit()}},username:{oninput:a=>{this.username=a.target.value}},password:{autocomplete:()=>e()?"new-password":"current-password",oninput:a=>{this.password=a.target.value}},registerFields:{className:()=>e()?"login__register":"login__register hidden"},displayName:{oninput:a=>{this.displayName=a.target.value}},hcp:{oninput:a=>{this.hcp=a.target.value}},submit:{textContent:()=>t()?e()?"Creating account…":"Signing in…":e()?"Create account":"Sign in"},toggle:{textContent:()=>e()?"Have an account? Sign in":"New here? Create an account",onclick:()=>{this.formError.set(""),this.auth.error.set(null);const a=!e();this.mode.set(a?"register":"login"),a&&this.loadClubs()}}}),i=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(s,"gender"),()=>i,(a,d,c)=>this.wireEl(_('<button bind="b" type="button"></button>'),{b:{textContent:()=>a.label,className:()=>this.gender.get()===a.value?"on":"",onclick:()=>this.gender.set(a.value)}},c),a=>a.label);const r=new Y({value:this.homeClubId,options:{get:()=>[{value:"",label:"No home club"},...this.clubs.get().map(a=>({value:a.id,label:a.name}))]},placeholder:"No home club"});return r.mount(this.ref(s,"club")),this.track(()=>r.destroy()),s}}const Lo=_(`
    <div class="friends">
...
`);function Jt(n){return n.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Mo extends R{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject(Fe);auth=this.inject(H);router=this.inject(M);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Lo,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:i=>this.svc.setQuery(i.target.value)},searchHint:{textContent:()=>{const i=this.svc.query.get().trim();return i.length>0&&!Ct(i)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const i=this.svc.query.get().trim();return Ct(i)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===i&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(i,r,a)=>this.wireEl(Ao,{initials:()=>Jt(i.displayName),name:()=>i.displayName,username:()=>i.homeClubName?`@${i.username} · ${i.homeClubName}`:`@${i.username}`,hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(i.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const d=this.svc.results.get().find(c=>c.id===i.id);d&&!d.isFriend&&this.svc.add(d)}},added:{className:()=>this.isFriendNow(i.id)?"friend-row__added":"friend-row__added hidden"}},a),i=>i.id);const s=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>ht(this.svc.friends.get(),this.svc.sortMode.get()),(i,r,a)=>this.wireEl(Do,{initials:()=>Jt(i.displayName),name:()=>i.displayName,subtitle:()=>{const d=this.svc.friends.get().find(c=>c.id===i.id)??i;return xi(d,s)},hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(i.id)}}},a),i=>i.id),t}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Ho=_(`
    <div class="profile">
...
`);class Go extends R{static styles=`
        .profile {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { ${q()} width: 90px; padding: ${l("md")}; font-size: 1rem; text-align: center; }
                    & button {
                        ${C()}
    ...
    `;svc=this.inject(ye);auth=this.inject(H);router=this.inject(M);indexDraft=new p("");localErr=new p("");render(){this.auth.currentUser.get()&&this.svc.load();const e=()=>this.auth.currentUser.get()!==null,t=this.wire(Ho,{anon:{className:()=>e()?"profile__anon hidden":"profile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/profile"}})},body:{className:()=>e()?"profile__body":"profile__body hidden"},name:()=>this.svc.player.get()?.displayName??"…",username:()=>{const a=this.svc.player.get();return a?`@${a.username}`:""},hcp:()=>{const a=this.svc.player.get()?.handicapIndex;return a==null?"–":a<0?`+${(-a).toFixed(1)}`:a.toFixed(1)},index:{value:()=>this.indexDraft.get(),oninput:a=>this.indexDraft.set(a.target.value)},save:{disabled:()=>this.svc.saving.get()||this.indexDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},form:{onsubmit:async a=>{a.preventDefault(),this.localErr.set("");const d=W(this.indexDraft.get());if(d===null||d<-10||d>54){this.localErr.set("Enter an index between +10 and 54 (use “+” for a plus handicap).");return}await this.svc.saveIndex(d)&&this.indexDraft.set("")}},saveErr:{textContent:()=>this.localErr.get()||this.svc.saveError.get()?.message||""},genderErr:{textContent:()=>this.svc.saveError.get()?.message||""},clubErr:{textContent:()=>this.svc.saveError.get()?.message||""},masterTitle:()=>pi,masterHint:()=>mi,master:{checked:()=>this.svc.statsConfig.get().enabled,disabled:()=>this.statsBusy(),onchange:a=>{this.saveStats(a,(d,c)=>yi(d,c),d=>d.enabled)}},statsErr:{textContent:()=>this.svc.statsError.get()?.message||""},historyEmpty:{className:()=>this.svc.history.get().length===0?"profile__empty":"profile__empty hidden"}});this.$each(this.ref(t,"history"),this.svc.history,(a,d,c)=>this.wireEl(Fo,{index:()=>a.handicapIndex.toFixed(1),source:()=>a.source,date:()=>a.effectiveDate},c),a=>a.id),this.$each(this.ref(t,"statModules"),()=>[...bs],(a,d,c)=>{const u=()=>this.svc.statsConfig.get(),f=()=>fi(u(),a);return this.wireEl(Bo,{row:{className:()=>f()?"statrow statrow--locked":"statrow"},title:()=>ys(a),ann:()=>gi(u(),a)??"",hint:()=>hi(a),chk:{checked:()=>Oe(u(),a),disabled:()=>f()||this.statsBusy(),onchange:m=>{this.saveStats(m,(h,b)=>bi(h,a,b),h=>Oe(h,a))}}},c)},a=>a);const s=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(t,"gender"),()=>s,(a,d,c)=>this.wireEl(_('<button bind="b" type="button"></button>'),{b:{textContent:()=>a.label,className:()=>this.svc.player.get()?.gender===a.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.saveGender(a.value)}}},c),a=>a.label);const i=new p(this.svc.player.get()?.homeClubId??"");this.track(N(()=>i.set(this.svc.player.get()?.homeClubId??""))),this.track(N(()=>{const a=i.get();queueMicrotask(()=>{a!==(this.svc.player.get()?.homeClubId??"")&&this.svc.saveHomeClub(a===""?null:a)})}));const r=new Y({value:i,options:{get:()=>[{value:"",label:"No home club"},...this.svc.clubs.get().map(a=>({value:a.id,label:a.name}))]},placeholder:"No home club",disabled:{get:()=>this.svc.saving.get()}});return r.mount(this.ref(t,"club")),this.track(()=>r.destroy()),t}statsBusy(){return this.svc.statsSaving.get()||this.svc.saving.get()}async saveStats(e,t,s){const i=e.target;await this.svc.saveStatsConfig(t(this.svc.statsConfig.get(),i.checked)),i.checked=s(this.svc.statsConfig.get())}}const qo=_(`
    <div class="admin">
...
`),Wo={not_started:"Not started",active:"Playing",complete:"Done"};function Yo(n){const e=[`${n.participants.length} players`,`${n.scoreEventCount} scores`];return n.lastEventAt?e.push(`last ${n.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Qo(n){const e=[`@${n.username}`,`${n.roundCount} rounds`];return n.lastRoundDate&&e.push(`last ${n.lastRoundDate}`),n.handicapIndex!==null&&e.push(`hcp ${n.handicapIndex}`),n.deletedAt&&e.push("DELETED"),e.join(" · ")}class Xo extends R{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject($s);auth=this.inject(H);router=this.inject(M);tab=new p("rounds");grantOpen=new p(!1);grantTarget=new p(null);mutating=new p(!1);denied=new S(()=>this.auth.currentUser.get()===null||!this.svc.isSuperAdmin());render(){this.svc.loadRoles().then(()=>{this.svc.isSuperAdmin()&&this.svc.load()});const e=this.wire(qo,{back:{onclick:()=>this.router.navigate("/")},denied:{className:()=>this.denied.get()?"admin__denied":"admin__denied hidden"},body:{className:()=>this.denied.get()?"admin__body hidden":"admin__body"},loading:{className:()=>this.svc.loading.get()?"admin__loading":"admin__loading hidden"},tabRounds:{className:()=>this.tab.get()==="rounds"?"active":"",onclick:()=>this.tab.set("rounds")},tabPlayers:{className:()=>this.tab.get()==="players"?"active":"",onclick:()=>this.tab.set("players")},roundList:{className:()=>this.tab.get()==="rounds"?"admin__list":"admin__list hidden"},playerList:{className:()=>this.tab.get()==="players"?"admin__list":"admin__list hidden"}}),t=new S(()=>{const s=this.svc.stats.get();return s?[{key:"rounds",label:"Rounds",value:s.rounds},{key:"active",label:"Playing",value:s.roundsActive},{key:"week",label:"Last 7d",value:s.roundsLast7Days},{key:"players",label:"Players",value:s.players},{key:"guests",label:"Guests",value:s.guests},{key:"scores",label:"Scores",value:s.scoreEvents}]:[]});return this.$each(this.ref(e,"stats"),t,(s,i,r)=>this.wireEl(Ko,{value:()=>String(s.value),label:()=>s.label},r),s=>s.key),this.$each(this.ref(e,"roundList"),this.svc.rounds,(s,i,r)=>this.wireEl(Vo,{row:{disabled:()=>s.shareToken===null,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},course:()=>s.courseName??"Unknown course",status:()=>Wo[s.status],who:()=>{const a=s.creatorName?`by ${s.creatorName}`:"by a guest",d=s.participants.join(", ");return d?`${a} — ${d}`:a},meta:()=>`${s.date} · ${Yo(s)}`},r),s=>s.roundId),this.$each(this.ref(e,"playerList"),this.svc.players,(s,i,r)=>this.wireEl(Uo,{name:()=>s.displayName,roleChip:()=>s.roles.includes("super_admin")?"admin":"",meta:()=>Qo(s),toggle:{textContent:()=>s.roles.includes("super_admin")?"Revoke admin":"Make admin",disabled:()=>this.mutating.get(),onclick:()=>{this.grantTarget.set(s),this.grantOpen.set(!0)}}},r),s=>s.playerId),this.spawn(U,this.ref(e,"confirmHost"),{open:this.grantOpen,title:()=>this.grantTarget.get()?.roles.includes("super_admin")?"Revoke admin?":"Make admin?",message:()=>{const s=this.grantTarget.get();return s?s.roles.includes("super_admin")?`Remove the super admin role from ${s.displayName}?`:`Give ${s.displayName} the super admin role? They will be able to see every player's rounds.`:""},confirmLabel:"Confirm",cancelLabel:"Cancel",onconfirm:()=>{const s=this.grantTarget.get();s&&this.toggleAdmin(s)}}),e}async toggleAdmin(e){this.mutating.set(!0);try{const t={playerId:e.playerId,role:"super_admin"};e.roles.includes("super_admin")?await v.admin.adminRevokeRole(t):await v.admin.adminGrantRole(t),await this.svc.load(!0)}finally{this.mutating.set(!1)}}}function Jo(n,e){return n?e!==null&&n.ownerPlayerId===e?!0:n.rounds.some(t=>typeof t.shareToken=="string"):!1}class ie{list=new p([]);listLoading=new p(!1);listError=new p(null);listLoaded=new p(!1);detail=new p(null);detailId=new p(null);detailLoading=new p(!1);detailError=new p(null);participants=new p([]);board=new p(null);boardRefusal=new p(null);boardLoading=new p(!1);results=new p(null);resultsRefusal=new p(null);mutating=new p(!1);mutateError=new p(null);async loadList(e=!1){if(!e&&(this.listLoaded.get()||this.listLoading.get()))return;const t=await z(this.listLoading,this.listError,()=>v.competitions.list());t&&(this.list.set(t),this.listLoaded.set(!0))}async loadDetail(e,t=!1){if(!t&&this.detailId.get()===e&&this.detail.get()!==null&&!this.detailLoading.get()||this.detailLoading.get()&&this.detailId.get()===e)return;this.detailId.set(e);const s=await z(this.detailLoading,this.detailError,()=>Promise.all([v.competitions.get({id:e}),v.competitions.participants({competitionId:e})]));if(!s)return;const[i,r]=s;this.detailId.get()===e&&(this.detail.set(i),this.participants.set(r),await this.loadBoard(e),i.lifecycle==="finalized"&&await this.loadResults(e))}async loadBoard(e){this.boardLoading.set(!0);try{const t=await v.competitions.leaderboard({id:e});t.ok?(this.board.set(t.value),this.boardRefusal.set(null)):(this.board.set(null),this.boardRefusal.set(t.refusal.message))}catch{this.board.set(null),this.boardRefusal.set(null)}finally{this.boardLoading.set(!1)}}async loadResults(e){try{const t=await v.competitions.results({id:e});t.ok?(this.results.set(t.value),this.resultsRefusal.set(null)):(this.results.set(null),this.resultsRefusal.set(t.refusal.message))}catch{this.results.set(null)}}async create(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await v.competitions.create({name:e});return this.list.set([t,...this.list.get()]),t}catch(t){return this.mutateError.set(ne(t)),null}finally{this.mutating.set(!1)}}transition(e,t){return this.mutate(()=>v.competitions.transition({id:e,to:t}),()=>this.loadDetail(e,!0))}updateConfig(e){return this.mutate(()=>v.competitions.update(e),()=>this.loadDetail(e.id,!0))}async addPlayer(e,t,s){return this.rosterMutate(e,()=>v.competitions.addParticipant({competitionId:e,playerId:t,category:s}))}async addGuest(e,t,s){this.mutating.set(!0),this.mutateError.set(null);let i;try{i=(await v.guestPlayers.create(t)).id}catch(r){return this.mutating.set(!1),this.mutateError.set(ne(r)),ne(r)}return this.mutating.set(!1),this.rosterMutate(e,()=>v.competitions.addParticipant({competitionId:e,guestPlayerId:i,category:s}))}removeParticipant(e,t){return this.rosterMutate(e,()=>v.competitions.removeParticipant({participantId:t}))}withdrawParticipant(e,t){return this.rosterMutate(e,()=>v.competitions.withdrawParticipant({participantId:t}))}async createRound(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await v.competitions.createRound(e);if(t.ok)return await this.loadDetail(e.id,!0),{ok:!0,shareToken:t.shareToken};const s="refusal"in t?t.refusal.message:t.diagnostics.map(i=>i.message).join(" · ");return this.mutateError.set(s),{ok:!1,message:s}}catch(t){const s=ne(t);return this.mutateError.set(s),{ok:!1,message:s}}finally{this.mutating.set(!1)}}async applyCut(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await v.competitions.applyCut({id:e});return t.ok?(await this.loadDetail(e,!0),{ok:!0,outcome:t.value}):(this.mutateError.set(t.refusal.message),{ok:!1,message:t.refusal.message})}catch(t){const s=ne(t);return this.mutateError.set(s),{ok:!1,message:s}}finally{this.mutating.set(!1)}}async finalize(e){this.mutating.set(!0),this.mutateError.set(null);try{const t=await v.competitions.finalize({id:e});return t.ok?(await this.loadDetail(e,!0),{ok:!0,outcome:t.value}):(this.mutateError.set(t.refusal.message),{ok:!1,message:t.refusal.message})}catch(t){const s=ne(t);return this.mutateError.set(s),{ok:!1,message:s}}finally{this.mutating.set(!1)}}clear(){this.list.set([]),this.listLoaded.set(!1),this.detail.set(null),this.detailId.set(null),this.participants.set([]),this.board.set(null),this.boardRefusal.set(null),this.results.set(null),this.resultsRefusal.set(null),this.listError.set(null),this.detailError.set(null),this.mutateError.set(null)}async mutate(e,t){this.mutating.set(!0),this.mutateError.set(null);try{const s=await e();return s.ok?(await t(),null):(this.mutateError.set(s.refusal.message),s.refusal.message)}catch(s){const i=ne(s);return this.mutateError.set(i),i}finally{this.mutating.set(!1)}}rosterMutate(e,t){return this.mutate(t,async()=>{const s=await v.competitions.participants({competitionId:e});this.participants.set(s)})}}function ne(n){return n&&typeof n=="object"&&"message"in n&&typeof n.message=="string"?n.message:"Something went wrong. Try again."}function Ds(n){switch(n){case"draft":return"Draft";case"setup":return"Setup";case"active":return"Live";case"finalized":return"Finalized"}}function Ms(n){return`comp-chip comp-chip--${n}`}function tt(n){switch(n){case"draft":return{to:"setup",label:"Open setup"};case"setup":return{to:"active",label:"Start competition"};default:return null}}function lt(n){return n==="draft"||n==="setup"}function Zo(n){return n==="setup"||n==="active"}const el=_(`
    <div class="comps">
...
`);class sl extends R{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
            ...
            & .comps__create {
                ...
                gap: ${l("sm")};
                margin-bottom: ${l("md")};
                & input { ${q()} flex: 1; padding: ${l("md")}; font-size: 1rem; }
                & button {
                    ${C()}
                    padding: ${l("md")} ${l("lg")};
...
`),hl=_('<button bind="chip" class="cd__friendchip" type="button"></button>');class pl extends R{competitions=this.inject(ie);state=this.inject(_e);render(){const e=()=>this.state.id.get()??"",t=this.wire(cl,{count:()=>{const s=this.competitions.participants.get().length;return s===0?"":String(s)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&lt(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:s=>{s.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:s=>this.state.guestNameDraft.set(s.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:s=>this.state.guestGenderDraft.set(s.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:s=>this.state.guestHcpDraft.set(s.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(s,i,r)=>this.wireEl(ul,{name:()=>s.displayNameSnapshot,category:{textContent:()=>s.category??"",className:()=>s.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>s.withdrawnAt?"Withdrawn":s.cutAfterRound!==null?`Cut R${s.cutAfterRound}`:"",className:()=>s.withdrawnAt||s.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!s.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),s.id)}},remove:{className:()=>this.state.admin.get()&&lt(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),s.id)}}},r),s=>JSON.stringify({id:s.id,name:s.displayNameSnapshot,category:s.category,withdrawnAt:s.withdrawnAt,cutAfterRound:s.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(s,i,r)=>this.wireEl(hl,{chip:{textContent:()=>s.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(a=>a.playerId===s.id),onclick:()=>{this.competitions.addPlayer(e(),s.id,null)}}},r),s=>s.id),t}}const ml={not_started:"Not started",active:"Live",complete:"Finished"},fl=_(`
    <section class="cd__section">
...
`),bl=_('<option bind="option"></option>');class yl extends R{competitions=this.inject(ie);state=this.inject(_e);router=this.inject(M);render(){const e=new S(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(fl,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Zo(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,i,r)=>this.wireEl(bl,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,i,r)=>this.wireEl(gl,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>ml[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function _l(n,e,t){return JSON.stringify({entry:n,points:e,columns:t})}function vl(n){return n.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const wl=_(`
    <div>
...
`),xl=_('<button bind="button" type="button"></button>'),$l=_('<th bind="cell"></th>'),kl=_('<tr bind="row"></tr>'),Sl=_('<td bind="cell"><span bind="value"></span></td>'),Cl=_(`
...
`),Il=_('<span bind="part"><span bind="separator"></span><span bind="value"></span></span>');class Tl extends R{competitions=this.inject(ie);state=this.inject(_e);render(){const e=new S(()=>{if(this.state.lifecycle.get()!=="finalized")return(this.competitions.board.get()?.view.entries??[]).map(m=>({entry:m,points:null}));const u=this.competitions.results.get()?.resultSets??[],f=Math.min(this.state.resultSetIndex.get(),u.length-1);return(u[f]?.entries??[]).map(m=>({entry:m.entry,points:m.points}))}),t=new S(()=>{const u=this.competitions.board.get()?.view.rounds??[];if(u.length>0)return u;const f=new Set;for(const m of e.get())for(const h of m.entry.rounds)f.add(h.roundNumber);return[...f].sort((m,h)=>m-h).map(m=>({roundNumber:m,postCut:!1}))}),s=()=>this.state.lifecycle.get()==="finalized",i=()=>s()?(this.competitions.results.get()?.resultSets.length??0)>0:this.competitions.board.get()!==null,r=()=>this.state.cutOutcome.get(),a=u=>u.length===0?"—":u.map(f=>f.displayName).join(", "),d=this.wire(wl,{admin:{className:()=>this.state.admin.get()&&this.state.lifecycle.get()==="active"?"cd__section cd__admin":"cd__section cd__admin hidden"},cutOutcome:{className:()=>r()?"cd__cutoutcome":"cd__cutoutcome hidden"},advancedLabel:()=>`Advanced (${r()?.advanced.length??0}):`,advanced:()=>a(r()?.advanced??[]),cutLabel:()=>`Cut (${r()?.cut.length??0}):`,cut:()=>a(r()?.cut??[]),applyCut:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.cutConfirmOpen.set(!0)},finalize:{disabled:()=>this.competitions.mutating.get(),onclick:()=>this.state.finalizeConfirmOpen.set(!0)},title:()=>s()?"Official results":"Leaderboard",board:{className:()=>s()?"cd__board cb cb--official":"cd__board"},official:{textContent:()=>{const u=this.competitions.results.get()?.finalizedAt.slice(0,10)??"";return s()&&u?`Official results · finalized ${u}`:""},className:()=>s()?"cd__official-banner":"cd__official-banner hidden"},boardHead:{className:()=>s()?"cb-head hidden":"cb-head"},metric:()=>this.competitions.board.get()?.view.metricLabel??"",operator:()=>{const u=this.competitions.board.get();return u?u.view.operator.kind==="best_n"?`Best ${u.view.operator.n} of ${u.view.rounds.length}`:"Total across rounds":""},defaulted:{className:()=>this.competitions.board.get()?.defaulted?"cb-head__hint":"cb-head__hint hidden"},empty:{className:()=>i()&&e.get().length===0?"cb-empty":"cb-empty hidden"},table:{className:()=>i()&&e.get().length>0?"cb":"cb hidden"},refusal:{textContent:()=>s()?this.competitions.resultsRefusal.get()??"":this.competitions.board.get()===null?this.competitions.boardRefusal.get()??"":""}}),c=new S(()=>[{text:"#",className:"cb-pos"},{text:"Player",className:"cb-who"},...t.get().map((u,f,m)=>({text:`R${u.roundNumber}`,className:`cb-c${u.postCut&&!m.slice(0,f).some(h=>h.postCut)?" cb-c--divider":""}`})),{text:"Total",className:"cb-total"},...s()?[{text:"Pts",className:"cb-points"}]:[]]);return this.$each(this.ref(d,"headers"),c,(u,f,m)=>this.wireEl($l,{cell:{textContent:()=>u.text,className:()=>u.className}},m),u=>`${u.text}:${u.className}`),this.$each(this.ref(d,"rows"),e,(u,f,m)=>this.boardRow(u,t.get(),m),u=>_l(u.entry,u.points,t.get())),this.$each(this.ref(d,"switcher"),new S(()=>s()?this.competitions.results.get()?.resultSets??[]:[]),(u,f,m)=>this.wireEl(xl,{button:{textContent:()=>u.scoringType.toUpperCase(),className:()=>this.state.resultSetIndex.get()===f?"on":"",onclick:()=>this.state.resultSetIndex.set(f)}},m),u=>u.scoringType),this.spawn(U,this.ref(d,"cutConfirm"),{open:this.state.cutConfirmOpen,title:"Apply cut?",message:"This evaluates the configured cut against the current aggregate and marks who advances. Cut players are left out of later rounds.",confirmLabel:"Apply cut",cancelLabel:"Cancel",onconfirm:async()=>{const u=await this.competitions.applyCut(this.state.id.get()??"");u.ok&&this.state.cutOutcome.set(u.outcome)}}),this.spawn(U,this.ref(d,"finalizeConfirm"),{open:this.state.finalizeConfirmOpen,title:"Finalize competition?",message:"Finalizing freezes the official results and locks the competition. This cannot be undone.",confirmLabel:"Finalize",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.competitions.finalize(this.state.id.get()??"")}}),d}boardRow(e,t,s){const i=e.entry,r=i.withdrawn||i.cutAfterRound!==null,a=["cb-row"];i.withdrawn?a.push("cb-row--withdrawn"):i.cutAfterRound!==null?a.push("cb-row--cut"):i.position===1&&a.push("cb-row--lead"),i.incomplete&&a.push("cb-row--incomplete");const d=t.findIndex(m=>m.postCut),c=new Map(i.rounds.map(m=>[m.roundNumber,m])),u=[{kind:"position",text:r?"—":String(i.position)},{kind:"who",entry:i},...t.map((m,h)=>({kind:"round",cell:c.get(m.roundNumber)??null,divider:h===d})),{kind:"total",text:i.total===null?"—":String(i.total)},...e.points===null?[]:[{kind:"points",text:String(e.points)}]],f=this.wireEl(kl,{row:{className:()=>a.join(" ")}},s);return this.$each(f,new S(()=>u),(m,h,b)=>this.boardCell(m,b),(m,h)=>h),f}boardCell(e,t){if(e.kind==="who")return this.whoCell(e.entry,t);const s=e.kind==="position"?"cb-pos":e.kind==="total"?"cb-total":e.kind==="points"?"cb-points":`cb-c cb-c--${e.cell?.status??"missing"}${e.divider?" cb-c--divider":""}`,i=e.kind==="round"?e.cell?.value===null||!e.cell?"—":String(e.cell.value):e.text;return this.wireEl(Sl,{cell:{className:()=>s},value:{textContent:()=>i,className:()=>e.kind==="round"&&e.cell?.status==="dropped"?"cb-struck":""}},t)}whoCell(e,t){const s=e.withdrawn?"WD":e.cutAfterRound!==null?`Cut R${e.cutAfterRound}`:"",i=vl(e),r=this.wireEl(Cl,{cell:{},name:()=>e.displayName,category:{textContent:()=>e.category??"",className:()=>e.category?"cb-tag cb-cat":"cb-tag cb-cat hidden"},status:{textContent:()=>s,className:()=>s?"cb-tag cb-tag--out":"cb-tag cb-tag--out hidden"},equals:{className:()=>i.length===0?"hidden":""},total:()=>e.total===null?"—":String(e.total)},t);return this.$each(r.querySelector('[bind="parts"]'),new S(()=>i),(a,d,c)=>this.wireEl(Il,{separator:()=>d===0?"":" + ",value:{textContent:()=>a.text,className:()=>a.dropped?"cb-struck":""}},c),(a,d)=>d),r}}const El=_(`
    <div class="cd">
...
`);class Nl extends R{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${l("xs")};
                    ...
                    & input, & select { ${q()} padding: ${l("sm")} ${l("md")}; font-size: 0.95rem; }
                }
            ...
            & .cd__official-banner {
                ${j()} padding: ${l("sm")} ${l("lg")}; margin-bottom: ${l("sm")};
                background: ${o("accent-soft")}; color: ${o("accent")};
    ...
    `;competitions=this.inject(ie);state=this.inject(_e);router=this.inject(M);render(){const e=()=>this.competitions.detail.get();this.track(N(()=>{const s=this.state.id.get();s&&V(()=>{this.state.enter(),this.competitions.loadDetail(s)})})),this.state.initialize();const t=this.wire(El,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>Ds(this.state.lifecycle.get()),className:()=>Ms(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&tt(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>tt(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const s=tt(this.state.lifecycle.get()),i=this.state.id.get();s&&i&&this.competitions.transition(i,s.to)}}});return this.spawn(dl,this.ref(t,"setup")),this.spawn(pl,this.ref(t,"roster")),this.spawn(yl,this.ref(t,"rounds")),this.spawn(Tl,this.ref(t,"results")),t}}const Pl=_(`
    <div class="app-shell">
...
`);class Ol extends R{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(M);render(){const e=this.wire(Pl,{header:{className:()=>gs(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Ri,this.ref(e,"account")),this.spawn(ui,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Nt,"/history":Ui,"/round":so,"/create":Eo,"/login":jo,"/friends":Mo,"/profile":Go,"/admin":Xo,...fs.competitions?{"/competitions":sl,"/competition":Nl}:{}},Nt),e}}class Rl extends H{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await As(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await No()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Po(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await Oo();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}B.get(rn);const Zt=B.get(M);B.set(H,new Rl);const es=B.get(H);await dn(Ol,"#app",{hot:void 0,onInit:async()=>{await es.load(),es.currentUser.get()&&Zt.route.get()==="/login"&&Zt.navigate("/",!0)}});export{st as A,R as C,M as R,p as S,rn as T,y as a,me as b,S as c,Ys as d,N as e,Ws as n,z as r,_ as t};
