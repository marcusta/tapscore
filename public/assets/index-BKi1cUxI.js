...
`);class Ts extends P{static styles=`
        .lb {
        ...
        .setup {
            ...
            & .fslot {
                ...
                & .brow {
                    ...
                    & .brow__del { margin-left: auto; width: 30px; height: 30px; ${$()} font-size: 0.8rem; color: ${l("text-muted")}; }
                }
                & .fslot__addband {
