(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&n(l)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const hr="modulepreload",pr=function(s){return"/tapscore/"+s},Fs={},fr=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");i=c(t.map(u=>{if(u=pr(u),u in Fs)return;Fs[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":hr,f||(h.as="script"),h.crossOrigin="",h.href=u,d&&h.setAttribute("nonce",d),document.head.appendChild(h),f)return new Promise((g,_)=>{h.addEventListener("load",g),h.addEventListener("error",()=>_(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return i.then(l=>{for(const d of l||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Kn="/tapscore/".replace(/\/+$/,""),ns=Kn+"/api",Tt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},mr=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Wn(s,e){const t={};for(const[n,i]of mr)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Yn=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],gr={thin:"1px",medium:"3px",thick:"5px"};function Qn(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":gr[e.toLowerCase()]??e}function br(){return Yn.map(s=>{const e=Qn(Tt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Xn={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Jn={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},_r={...Jn,"done-opacity":"0.35"},yr={...Xn,...Jn,...Tt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},vr={...Xn,..._r,...Tt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class wr{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Zn(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const me=new wr;function Zn(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return me.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,me.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){me.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,me.notify(t.subs))})},deps:new Set};n.run()}get(){return me.subscribe(this.subs),this.val}peek(){return this.val}}function I(s){const e={run(){me.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Zn(e)}}function Ze(s){me.batch(s)}function K(s){return me.untrack(s)}class xr{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const q=new xr,Ge=Kn;function is(s){return Ge?s===Ge?"/":s.startsWith(Ge+"/")?s.slice(Ge.length):s:s}function $r(s){return Ge+s}class B{constructor(){this.route=new p(is(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>Ze(()=>{this.route.set(is(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",l=i>=0?e.slice(0,i):e,d=l.indexOf("?"),c=d>=0?l.slice(0,d):l,u=d>=0?l.slice(d+1):"",f=n.query!==void 0?kr(n.query):u?"?"+u:"",m=$r(c)+f+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),Ze(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const n=this.route.get().split("/"),i={};for(const[r,l]of t.entries())l.startsWith(":")&&(i[l.slice(1)]=n[r]??"");return i})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function kr(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function Sr(s){return e=>s[e]}const Tr="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Bs="data-basics-global";function Ir(){if(document.head.querySelector(`style[${Bs}]`))return;const s=document.createElement("style");s.setAttribute(Bs,""),s.textContent=br()+Tr,document.head.appendChild(s)}function Pr(s,e){Ir();const t=new Set(Yn),n=(r,l,d)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?Qn(f):f}`).join(";");return`${l}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const js="basics-js-theme";class Cr{constructor(){this.dark=new p(!1);const e=localStorage.getItem(js),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),I(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(js,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function Er(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Ds=new Set;class N{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Ds.has(t)){Ds.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return q.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=K(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){K(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(l=>this.track(l)),r=e.content.cloneNode(!0);for(const l of r.querySelectorAll("[bind]")){const d=t[l.getAttribute("bind")];if(d)if(typeof d=="function")i(I(()=>{const c=d();l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement?l.value=String(c):l.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?l.addEventListener(c.slice(2),u):typeof u=="function"?i(I(()=>{const m=u();f?l.setAttribute(c,String(m)):l[c]=m})):f?l.setAttribute(c,String(u)):l[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof N?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,l,...d)=>this.spawn(r,l,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,l)=>l){const r=typeof t=="function"?t:()=>t.get(),l=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(I(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(l.has(g))u.set(g,l.get(g));else{const _=[];u.set(g,K(()=>n(h,m,w=>_.push(w)))),d.set(g,_)}}for(const[m,h]of l)u.has(m)||(h.remove(),K(()=>d.get(m)?.forEach(g=>g())),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);l.clear();for(const[m,h]of u)l.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(I(()=>{r&&(r.remove(),r=null);const l=t.get();r=K(()=>l?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(I(()=>{if(r){const c=r;r=null,K(()=>c.destroy())}e.textContent="";const l=t.get(),d=n[l]??Er(l,n)??i;d&&(r=K(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const _t=new Set;function Nr(s){return _t.add(s),()=>_t.delete(s)}function Rr(){for(const s of Array.from(_t)){_t.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Or(s,e,t){const n=document.querySelector(e);n.textContent="";const i=q.get(B);let r=null,l=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,n.textContent=""),f?(d||(d=(await fr(()=>import("./obs-shell.component-CyKxwAlE.js"),[])).ObsShellComponent),r=K(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=K(()=>new s)),K(()=>r.mount(n)),l=f};await u(is(location.pathname).startsWith("/_obs")),I(()=>{const f=i.route.get().startsWith("/_obs");f!==l&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Rr(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class V extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const zr=10,mt=[];let gt=[],Ye=null;function Lr(s){mt.push(s),mt.length>zr&&mt.shift()}function ei(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...mt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),gt.push(n),Ar()}function Ar(){Ye||(Ye=setTimeout(ti,5e3))}function ti(){if(Ye&&(clearTimeout(Ye),Ye=null),gt.length===0)return;const s=gt;gt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${ns}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${ns}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ti()});const Hr=3e4,Mr=2,ot=new Map,si=new WeakMap;function Fr(s){if(s instanceof V)return s.traceId;if(s!=null&&typeof s=="object")return si.get(s)}async function y(s){if(s.method==="GET"){const e=ot.get(s.url);if(e)return e;const t=Gs(s,Mr);return ot.set(s.url,t),t.then(()=>ot.delete(s.url),()=>ot.delete(s.url)),t}return Gs(s,0)}async function Gs(s,e){const t=s.timeout??Hr;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await jr(Br(s,r),t)}catch(l){if(n=l,!(l instanceof V)&&l!=null&&typeof l=="object"&&si.set(l,r),l instanceof V||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw n}async function Br(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Lr({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const l=await i.json().catch(()=>({error:i.statusText}));throw new V(i.status,l.error??i.statusText,l.details,r)}return i.json()}function jr(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const rs=new Set;let Mt=!1;function Dr(s){return rs.add(s),()=>{rs.delete(s)}}function ni(){if(!Mt){Mt=!0;try{for(const s of[...rs])try{s()}catch(e){try{ei("session-listener",Gr(e))}catch{}}}finally{Mt=!1}}}function Gr(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function M(s,e,t,n={}){Ze(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=qr(i);Ze(()=>{s.set(!1),e.set(r)}),ei(r.code,r.message,Fr(i)),r.code==="auth"&&n.sessionExpiry!==!1&&ni();return}}function qr(s){return s instanceof V?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const Ft={sessionExpiry:!1};function Vr(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class D{constructor(){this.api=Vr(ns),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Dr(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Nr(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await M(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await M(this.loading,this.error,()=>this.api.login({username:e,password:t}),Ft);return n?(this.currentUser.set(n),!0):!1}async logout(){await M(this.loading,this.error,()=>this.api.logout(),Ft);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await M(this.loading,this.error,()=>this.api.logoutAll(),Ft),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const ii={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},Ur={...ii,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Kr={...ii,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Wr=Wn(Ur,yr),Yr=Wn(Kr,vr),o=Pr(Wr,Yr),z=s=>`var(--${s})`,S=(s,e)=>`var(--${s}, ${e})`,T=s=>{const e=Tt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=Sr({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),lt=s=>`
    ...
    cursor: not-allowed;`,Qr={primary:lt("primary"),secondary:lt("secondary"),ghost:lt("ghost"),danger:lt("danger"),disabled:ri},x=(s=S("btn-radius",T("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Qr[e]}
    &:disabled {${ri}}
`,Xr=`max(${S("field-border-width",T("field-border-width"))}, ${S("field-rule-width",T("field-rule-width"))})`,dt=(s,e)=>`
    border-top-color: ${s};
...
`);class Aa extends N{static styles=`
        .dock {
    ...
    `;router=this.inject(B);auth=this.inject(D);landing=this.inject(Ct);newCount=new $(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(za,{bar:{className:()=>Us(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return Oa(r)?Us(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Na(li),n=Math.ceil(t.length/2),i=(r,l)=>this.wireEl(La,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const d=this.newCount.get();return d===0?"":String(d)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},l);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,l,d)=>i(r,d),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,l,d)=>i(r,d),r=>r.key),e}}const di=["tee","approach","putting","shortGame","penalties","recovery"],bt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function ci(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Ha(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Ma="Track statistics",Fa="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function ui(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function yt(s,e){return s[e]}function Ba(s,e){if(!s.enabled)return!0;const t=ui(e);return t===null?!1:!yt(s,t)}function ja(s,e){if(!s.enabled)return null;const t=ui(e);return t===null||yt(s,t)?null:`Needs ${ci(t)}`}function Da(s,e,t){return qa({...s,[e]:t})}function Ga(s,e){return{...s,enabled:e}}function qa(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function jt(s){const e={...bt,enabled:s.enabled};for(const t of di)e[t]=s[t];return e}function Va(s){return s.avatarVersion?`${j}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function Ua(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(ct(t[0])+ct(t[t.length-1])).toUpperCase();if(t.length===1)return ct(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?ct(n).toUpperCase():"•"}function ct(s){return[...s][0]??""}const ut=512,Ka=2*1024*1024;function Wa(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Ya=.85;class Ve extends Error{}async function Qa(s){let e;try{e=await createImageBitmap(s)}catch{throw new Ve("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=Wa(e.width,e.height),r=document.createElement("canvas");r.width=ut,r.height=ut;const l=r.getContext("2d");if(!l)throw new Ve("This browser cannot process images.");l.drawImage(e,t,n,i,i,0,0,ut,ut);const d=await new Promise(c=>r.toBlob(c,"image/jpeg",Ya));if(!d)throw new Ve("That image could not be processed.");if(d.size>Ka)throw new Ve("That image is too large.");return d}finally{e.close()}}async function Xa(s){const e=await fetch(`${j}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await hi(e);return await e.json()}async function Ja(){const s=await fetch(`${j}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await hi(s)}async function hi(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new V(t,Za(e.error,s.status))}function Za(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Me{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(bt);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await M(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null),v.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,l,d]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(l?jt(l):bt),this.hasRecordedStats.set((d?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(bt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await M(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await M(this.saving,this.saveError,()=>v.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await M(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await M(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await M(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(jt(e)));return t?(this.statsConfig.set(jt(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await Qa(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof Ve?i.message:"That image could not be prepared."}),!1}const n=await M(this.avatarSaving,this.avatarError,()=>Xa(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await M(this.avatarSaving,this.avatarError,()=>Ja().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function ht(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function Dt(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function vt(s,e="frecency"){return e==="alpha"?[...s].sort(Dt):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,l=i>0,d=r>0;if(l!==d)return l?-1:1;if(!l)return Dt(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:Dt(t,n)})}const eo=1440*60*1e3;function to(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/eo);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function so(s,e){if(s.sharedRoundCount<=0)return"never played";const t=to(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function no(s){return s.isMutual?null:"hasn't added you back"}const pi=2;function Ks(s){return s.trim().length>=pi}function fi(s){return vt(s,"frecency")}function io(s,e){return fi([...s.filter(t=>t.id!==e.id),e])}function ro(s,e){return s.filter(t=>t.id!==e)}function Ws(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function ao(s,e,t=()=>{},n=300){let i=0,r;return l=>{const d=l.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<pi){e(d,[]);return}r=setTimeout(()=>{s(d).then(u=>{c===i&&e(d,u)},u=>{c===i&&t(d,u)})},n)}}const mi=rt("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function oo(s=W()){return mi.read(s)}function lo(s,e=W()){mi.write(s,e)}class Et{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(oo());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=ao(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await M(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(fi(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await M(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(io(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Ws(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),lo(e)}async remove(e){await M(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(ro(this.friends.get(),e)),this.results.set(Ws(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class ys{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await v.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Ue(s,e){return s instanceof V&&s.status===401?(ni(),"Your session expired — sign in again."):e}function wt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function co(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${wt(s.scoreToPar)}`}function gi(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function bi(s){return(s.courseName??"").trim()||null}function uo(s){const e=[];for(const t of s){const n=t.friends[0],i=gi(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:bi(t),progress:co(n)})}return e}function ho(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function po(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function fo(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function mo(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${wt(s.scoreToPar)}`}function go(s){const e=[];for(const t of s){const n=t.friends[0],i=gi(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,displayName:n.displayName,title:bi(t)??"A round",date:t.date})}return e}function _i(s){if(s instanceof V){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const ze={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function bo(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function _o(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function yo(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${wt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${wt(s.scoreToPar)}`}}}function vo(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function wo(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function xo(s){return s===1?"1 course played":`${s} courses played`}const Gt={rounds:[],nextCursor:null,hasMore:!1};function Ys(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function yi(s){return s.hasMore&&s.nextCursor!==null}class Nt{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(Gt);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await v.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Ue(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(Ys(Gt,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ue(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!yi(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await v.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(Ys(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ue(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await v.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Ue(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=_i(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(Gt),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function vi(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function $o(s){return Math.round(vi(s))}function ko(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),l=i-r*n,d=r+(e>n-l?1:0);return d===0?0:-d}function So(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function $e(){return So()}const xe=10;class et{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await M(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=$e()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=$e()){return e.labels?.[t]??e.labels?.en??""}presets(e=$e()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,l=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==l?r-l:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=$e()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?xe:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const Qs=["scramble","foursomes","greensomes"];class To{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof v.setup?.formations=="function")return this.inFlight=(async()=>{const e=await M(this.loading,this.error,()=>v.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=Qs.indexOf(n);return i===-1?Qs.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=$e()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const Io=180,Xs=4,Po=12;function Re(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function Co(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<Po)return 0;const i=e+t*Io,r=Math.round(-i/n);return Math.max(-Xs,Math.min(Xs,r))}const Js="tapscore:pending-scores:v1",Eo=336*60*60*1e3,Zs=200;function No(){try{return globalThis.localStorage??null}catch{return null}}function Ro(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Oo{entries=[];storage;constructor(e=No(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Eo);return t.length>Zs?t.slice(t.length-Zs):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Js);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Ro):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Js,JSON.stringify(this.entries))}catch{}}}const he=["tee_result","recovery_ok","gir","short_game_difficulty","first_putt","putts","penalties"],zo={minPar:4},Lo={tee_result:"Tee shot",recovery_ok:"Recovery",gir:"Green in regulation",short_game_difficulty:"Short game",first_putt:"First putt",putts:"Putts",penalties:"Penalties"},Ao={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"}]},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null}};function Ho(s){return Lo[s]}function en(s){return Ao[s]}function Mo(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function wi(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}class Fo{modules;par;holeNumber;persistedMap;draft=new Map;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=tn(i),this.draft=new Map(r),this.prune()}refresh(e,t){const n=this.signature();return this.modules=e,this.persistedMap=tn(t),this.prune(),this.signature()!==n}signature(){let e="";for(const t of he)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e}get prompts(){const e=[];for(const t of he)this.isVisible(t)&&e.push({key:t,label:Ho(t),control:en(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&wi(zo,this.par,this.holeNumber)?"visible":"unreadable";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(this.record(e,t),this.prune())}step(e,t){const n=en(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<he.length;e++){let t=!1;for(const n of he){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),Bo(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of he){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function Bo(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function tn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of he){const n=s[t];n!==void 0&&e.set(t,n)}return e}const sn="tapscore:pending-stat-events:v1",jo=336*60*60*1e3,nn=500;function Do(){try{return globalThis.localStorage??null}catch{return null}}function Go(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function qo(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&he.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Vo{entries=[];storage;makeId;constructor(e=Do(),t=Date.now(),n=Go){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const l=[];for(const d of i){const c={token:e,playHoleId:t,playerId:n,key:d.key,value:d.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(f=>f.token===e&&f.playHoleId===t&&f.playerId===n&&f.key===d.key);u>=0?this.entries[u]=c:this.entries.push(c),l.push(c)}return this.entries=this.applyHygiene(r),this.persist(),l}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=jo);return t.length>nn?t.slice(t.length-nn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(sn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(qo):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(sn,JSON.stringify(this.entries))}catch{}}}const Uo=50;function Ko(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const vs=rt("tapscore.result-cursors.v1",ms(Ko),Uo);function ws(s=W()){return vs.read(s)}function Wo(s,e=W()){return ws(e).find(t=>t.token===s)?.cursor??null}function Yo(s,e,t=W()){if(!t)return[];const n=ws(t).filter(i=>i.token!==s);return vs.write([{token:s,cursor:e},...n],t)}function Qo(s,e=W()){if(!e)return[];const t=ws(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&vs.write(n,e),n}const Xo=["1st","2nd","3rd","4th","5th","6th","7th","8th"],_e=(s,e)=>`${s}|${e}`;function xs(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function Jo(s,e,t){return wi(s,e,t)}function qt(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Zo(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),e}function el(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class ce{constructor(e=new Oo,t=new Vo){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),q.get(et).load();const r=await M(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),qe({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!xa(r.round.id))),q.get(D).currentUser.get()&&$a(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[l,d,c,u]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[]),v.playerStats.configsByToken({token:e}).catch(()=>null),v.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(f=>[f.playerId,f.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(d),this.balls.set(l),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await v.friendlyRounds.remove({token:e}),oi(e);const t=this.round.get()?.id;return t&&ai(t),Qo(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await v.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await M(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await v.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await v.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const l=await v.friendlyRounds.balls({token:e}).catch(()=>null);if(l===null||i())return;this.balls.set(l)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?Wo(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Yo(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await v.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),qe({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,xs(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new $(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(l=>n.subjectLabels?.some(d=>d.ballId===l&&d.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const l=r.entries.find(d=>i(d.ballIds));if(!l)continue;return l.total===null?null:l.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-l.paceDelta:l.paceDelta}:{kind:"total",total:l.total}}if(r.kind==="match_summary"){const l=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!l)continue;if(l.thru===0&&!l.finished)return null;const d=i(l.sideA.ballIds)?"a":"b";if(l.leader===null||l.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=l.leader===d;return{kind:"match",text:`${l.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Re(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(l=>l.id===e);if(!t||!n)return"";const i=t.playHoles.filter(l=>l.courseHoleNumber===n.courseHoleNumber).sort((l,d)=>l.ordinal-d.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(l=>l.id===e);return`${n.courseHoleNumber} (${Xo[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Re(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Re(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const n=this.cells.get().get(_e(e,t));return n?n.strokes:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(_e(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const l=this.playHoleById(t);if(!l)return null;const d=i.players[0]?.teeName??null,c=l.tees.find(u=>u.teeName===d)?.strokeIndex??l.baseStrokeIndex;return ko(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.flushStats(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e))&&this.bumpStatRev()}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);return!t||!n?null:new Fo(t,n.par,n.courseHoleNumber,this.persistedStats(e))}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Zo(t):new Map;for(const i of he){const r=qt(e,i);if(!this.statLocal.has(r))continue;const l=this.statLocal.get(r)??null;l===null?n.delete(i):n.set(i,l)}return n}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=qt(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=qt({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await v.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return el(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(_e(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=q.get(et),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const l=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of l)i.has(d.key)||(i.add(d.key),n.push(d))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Jo(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=_e(e,t),l=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:l});const d=this.token;d&&(this.enqueue(d,e,t,n,i,l),await this.post(d,e,t,n,i,l))}async retry(e,t){const n=_e(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(_e(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,l){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:l,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,l){const d=_e(t,n);try{await v.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:l,...r!=null?{metadata:r}:{}}),this.queue.remove(l);const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class xi{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await v.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=_i(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Ue(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await v.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,xs(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new $(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class $i{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await M(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const tl=["last5","last10","last20","thisYear","all","custom"];function xt(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function sl(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function $s(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const Qe={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function nl(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function il(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function Vt(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function rl(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Rt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function ki(s){return`${s.getFullYear()}-`}function Si(s,e,t,n){const i=Rt(t);switch(s){case"last5":case"last10":case"last20":{const r=$s(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=ki(n);return i.filter(l=>l.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>il(e,r))}}function Ti(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const l=$s(e);return l===null?!1:n.length<l}case"thisYear":{const l=`${ki(r)}01-01`;return!n.some(d=>d.date<l)}case"all":return!0;case"custom":{if(nl(t))return!1;if(t.from===null)return!0;const l=t.from;return!n.some(d=>d.date<l)}}}const al="Unnamed course";function ol(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??al,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const $t="last10";function ll(s){return tl.includes(s)}const Ii=rt("tapscore.stats.window.v1",{decode:s=>ll(s)?s:$t,encode:s=>s,empty:$t});function as(s=W()){return Ii.read(s)}function rn(s,e=W()){Ii.write(s,e)}function H(s,e){return{value:e===0?null:s/e,n:s,d:e}}const os=5;function Ie(s,e=os){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const ls=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,girRecorded:0,girHits:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0});function dl(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved}}function cl(s){let e=ls;for(const t of s)e=dl(e,t);return e}const Ot=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function Pi(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function ul(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function hl(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function pl(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function Ci(s){return H(s.fairwayHits,s.teeRecorded)}function fl(s){return H(s.troubleCount,s.teeRecorded)}function ml(s){return H(s.recoverySuccesses,s.recoveryAttempts)}function gl(s,e){return H(s.penaltiesTotal,e)}function bl(s){return{fairway:H(s.strokesVsParFairway,s.holesScoredFairway),inPlay:H(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:H(s.strokesVsParTrouble,s.holesScoredTrouble)}}function _l(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return H(e,s.holesScoredTrouble*s.holesScoredFairway)}function Ei(s){return H(s.girHits,s.girRecorded)}function yl(s){return{fairway:H(s.girHitsFairway,s.girRecordedFairway),inPlay:H(s.girHitsInPlay,s.girRecordedInPlay),trouble:H(s.girHitsTrouble,s.girRecordedTrouble)}}function vl(s,e){return H(pl(s,e),s.girFirstPuttRecorded)}function wl(s){return H(s.birdiesOnGir,s.girHolesScored)}function xl(s,e){return H(hl(s,e),Pi(s,e))}function $l(s){return H(s.threePutts,s.puttsRecorded)}function kl(s){return H(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function Sl(s){return H(s.puttsTotalGir,s.puttsRecordedGir)}function Ni(s){return{standard:H(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:H(s.scrambleSuccessesHard,s.scrambleAttemptsHard),overall:H(s.scrambleSuccessesStandard+s.scrambleSuccessesHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard)}}function Tl(s){return{standard:H(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:H(s.scrambleInside2mHard,s.scrambleFirstPuttHard),overall:H(s.scrambleInside2mStandard+s.scrambleInside2mHard,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard)}}function Il(s){return{par3:H(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:H(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:H(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Pl(s,e){return H(s.doubleBogeyPlus,e)}function Cl(s){return H(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Ri=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),El=1.85,Nl=Object.freeze({inside2m:1.25,outside2m:2.12}),ie=["putting","shortGame","penalties","longGame"],Rl=.8;function tt(s,e=Ri,t=Nl,n=El){let i=0,r=0,l=0;for(const C of Ot){const G=Pi(s,C);i+=G,r+=ul(s,C),l+=G*e[C]}const d=i===0?null:r-l,c=s.scrambleInside2mStandard+s.scrambleInside2mHard,u=s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard,f=Math.max(0,u-c),m=s.scrambleHoledStandard+s.scrambleHoledHard,h=u===0&&m===0?null:c*(t.inside2m-n)+f*(t.outside2m-n)+m*(1-(1+n)),g=s.penaltiesTotal,_=s.holesScored===0?null:s.strokesTotal-s.parTotal,w={holesScored:s.holesScored,puttsRecorded:s.puttsRecorded},R=s.puttsRecorded>=Rl*s.holesScored,F=_===null||d===null||h===null||!R?null:_-d-h-g;return{putting:d,shortGame:h,penalties:g,longGame:F,total:_,coverage:w}}function Le(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Oi(s,e){return{putting:je(s.putting,e.map(zi)),shortGame:je(s.shortGame,e.map(Ol)),penalties:je(s.penalties,e.map(Li)),longGame:je(s.longGame,e.map(zl)),total:je(s.total,e.map(Ll))}}function ks(s,e){switch(e){case"putting":return s.putting;case"shortGame":return s.shortGame;case"penalties":return s.penalties;case"longGame":return s.longGame}}function Ss(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function je(s,e){if(s===null)return null;const t=Ss(e);return t===null?null:s-t}function zi(s){return s.putting}function Ol(s){return s.shortGame}function Li(s){return s.penalties}function zl(s){return s.longGame}function Ll(s){return s.total}const an=1,Al=2,Hl=.75,Ml=4,Fl=12,Bl=5,jl=2;function Dl(s,e,t,n){const i=Oi(e,t),r=[];let l=0;const d=(_,w)=>{r.push({line:_,magnitude:w,order:l++})};let c=null,u=null;for(const _ of ie){const w=ks(i,_);w!==null&&((c===null||w<c.delta)&&(c={component:_,delta:w}),(u===null||w>u.delta)&&(u={component:_,delta:w}))}c!==null&&c.delta<=-an&&d({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=an&&d({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const f=Ss(t.map(Li));f!==null&&s.penaltiesTotal>=f+Al&&d({id:"penalties_spike",params:{penalties:s.penaltiesTotal,baseline:f}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard,h=s.scrambleSuccessesStandard+s.scrambleSuccessesHard;m>=Ml&&h>=Hl*m&&d({id:"scramble_streak",params:{successes:h,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=Fl&&d({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const g=t.map(zi).filter(_=>_!==null);return e.putting!==null&&g.length>=Bl&&g.every(_=>e.putting<_)&&d({id:"best_putting_round",params:{putting:e.putting,rounds:g.length}},0),s.bounceBackOpportunities>=jl&&s.bounceBackSuccesses===s.bounceBackOpportunities&&d({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((_,w)=>w.magnitude-_.magnitude||_.order-w.order),r.slice(0,Math.max(0,n)).map(_=>_.line)}const Gl=["tee","approach","putting","shortGame","scoring"];function ql(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const Vl=3,Ai={rounds:[],totals:ls,waterfall:tt(ls),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null};function Ts(s){const e=Rt(s);if(e.length===0)return Ai;const t=cl(e.map(r=>r.measures)),n=e.map(r=>tt(r.measures)),i=e.length;return{rounds:e.map((r,l)=>{const d=n[l];return{id:r.roundId,date:r.date,courseName:r.courseName,name:r.name,holeCount:r.holeCount,strokes:r.measures.holesScored===0?null:r.measures.strokesTotal,vsPar:d.total,waterfall:d}}),totals:t,waterfall:tt(t),priorities:Ul(n),trends:Kl(e),tee:Wl(t,i),approach:Yl(t),putting:Ql(t),shortGame:Xl(t),scoring:Jl(t,i)}}function Ul(s){const e=ie.map(n=>{const i=s.map(r=>Le(r,n));return{component:n,perRound:Ss(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>ie.indexOf(n);return e.sort((n,i)=>n.perRound!==null&&i.perRound!==null?n.perRound===i.perRound?t(n.component)-t(i.component):i.perRound-n.perRound:n.perRound!==null?-1:i.perRound!==null?1:t(n.component)-t(i.component))}function Ut(s){return Ie(s)==="percentage"?s.value:null}function Kl(s){const e=[...s].reverse(),t=(n,i,r,l)=>{const d=[];for(const c of e){const u=l(c.measures);u!==null&&d.push(u)}return d.length>=Vl?{id:n,title:i,kind:r,points:d}:null};return[t("fairway","Fairways","percentage",n=>Ut(Ci(n))),t("gir","Greens","percentage",n=>Ut(Ei(n))),t("putting","Putting","strokesLost",n=>tt(n).putting),t("scramble","Scrambling","percentage",n=>Ut(Ni(n).overall))].filter(n=>n!==null)}function Wl(s,e){return s.teeRecorded<=0?null:{fairway:Ci(s),inPlayOnly:H(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:fl(s),troubleTax:_l(s),vsParByTee:bl(s),recovery:ml(s),penaltiesPerRound:gl(s,e)}}function Yl(s){if(s.girRecorded<=0)return null;const e={};for(const t of Ot)e[t]=vl(s,t);return{gir:Ei(s),girByTee:yl(s),girFirstPuttMix:e,birdieConversion:wl(s)}}function Ql(s){return s.puttsRecorded<=0&&s.firstPuttRecorded<=0?null:{ladder:Ot.map(e=>({bucket:e,made:xl(s,e),baseline:Math.max(0,2-Ri[e])})),threePutt:$l(s),threePuttsFromOver8m:kl(s),puttsPerGirHole:Sl(s)}}function Xl(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:Ni(s),chipInside2m:Tl(s),conversionInside2m:H(t,n),chipIns:s.scrambleHoledStandard+s.scrambleHoledHard}}function Jl(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Il(s),doubleBogeyPlusPerRound:Pl(s,e),bounceBack:Cl(s)}}function Hi(s){let e=0;for(const t of s)for(const n of ie){const i=Le(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Zl(s){let e=0;for(const t of s)t.perRound!==null&&(e=Math.max(e,Math.abs(t.perRound)));return e}function Is(s){const e=q.get(et);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function ed(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:_a(e)||null,date:e.round.date,formats:e.round.formatSlots.map(Is).join(" · ")}))}function td(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:e.date??null,formats:null}))}function Oe(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Ee(s){return s.courseName?Oe(s)===s.courseName?null:s.courseName:null}function ge(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const Xe={fromMyRounds:ed,fromDeviceRounds:td};function fe(s){switch(Ie(s)){case"absent":return null;case"fraction":return`${Ae(s.n)} of ${Ae(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function sd(s){return Ie(s)!=="percentage"?null:`${Ae(s.n)} of ${Ae(s.d)}`}function ae(s){const e=fe(s);if(e===null)return null;const t=sd(s);return t===null?e:`${e} (${t})`}function Ps(s,e=2,t=!1){return Ie(s)==="absent"||s.value===null?null:t?Fe(s.value,e):be(s.value,e)}function Cs(s){return{one:s,many:`${s}s`}}const pe=Cs("round"),Mi=Cs("hole"),Fi=Cs("green"),Bi="thin sample";function ji(s,e){switch(Ie(s)){case"absent":return null;case"fraction":return`over ${oe(s.d,e)} — ${Bi}`;case"percentage":return`over ${oe(s.d,e)}`}}function Ne(s,e){const t=Ps(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=ji(s,e.unit);return i===null?n:`${n} (${i})`}const nd={one:"hole from trouble",many:"holes from trouble"},id={one:"from the fairway",many:"from the fairway"};function rd(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${oe(e,nd)} vs ${oe(t,id)}`;return e<os||t<os?`${n} — ${Bi}`:n}function ad(s){return Ie(s)==="fraction"}function Ae(s){return s===Math.round(s)?String(Math.round(s)):be(s,1)}function oe(s,e){return`${Ae(s)} ${s===1?e.one:e.many}`}function be(s,e=1){return s.toFixed(e)}function Fe(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return be(0,e);const i=be(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function od(s){return`${Fe(s)}/round`}function Es(s){return s===0?"E":Fe(s,s===Math.round(s)?0:1)}function zt(s){switch(s){case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"longGame":return"Long game"}}function ld(s){switch(s){case"putting":return"Putts taken vs expected from where you started";case"shortGame":return"Chips and pitches vs an average short-game shot";case"penalties":return"Strokes added by penalties";case"longGame":return"Tee shots and approaches — what the rest did not explain"}}function on(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function dd(s){return s==="indoor"?"Indoor":"Outdoor"}function cd(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Di(s){return ge(s)}const Gi="Statistics",ud="All statistics →";function hd(s){return s==="custom"?$t:s}function pd(s,e,t){return $s(s)!==null||!t?xt(s):`${xt(s)} — newest ${e}`}function fd(s){return H(s.strokesTotal-s.parTotal,s.holesScored)}function md(s){const e=[],t=fd(s.totals),n=Ps(t,2,!0);if(n!==null){const c=Ie(t)==="fraction"?ji(t,Mi):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:fe(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const l=s.approach,d=l===null?null:fe(l.gir);return d!==null&&e.push({id:"gir",value:d,label:"Greens in regulation",note:null}),e}function gd(s){const e=s.priorities.find(t=>t.perRound!==null);return!e||e.perRound===null||e.perRound<=0?null:`Costing you most: ${zt(e.component)}`}function bd(s){const e=hd(s.preset),t=Si(e,Qe,s.rows,s.now);if(t.length===0)return null;const n=Ts(t),i=md(n);if(i.length===0)return null;const r=Ti({preset:e,filter:Qe,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:pd(e,t.length,r),tiles:i,priorityLine:gd(n)}}function _d(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${Gi}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class Lt{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(as());loaded=!1;loading=!1;card=new $(()=>{const e=this.rows.get();return e===null?null:bd({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date})});refreshPreset(){this.preset.set(as())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await v.playerStats.myStats({limit:Lt.PAGE_SIZE});this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof V&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const Hs=class Hs extends N{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(I(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};Hs.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let ee=Ms;async function yd(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const vd="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Pe(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Se(s){const e=()=>Va(s());return{avatarPhoto:{src:()=>e()??vd,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return Ua(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function He(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function wd(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function xd(s){return wd(s).map(e=>e.kind)}function ln(s){return s.signedIn?"avatar":"signin"}const $d=b(`
...
`);class kd extends N{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),Rd='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Od=b(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Rd}</button>
    </div>
`),zd=b(`
...
`,cs={not_started:"Not started",active:"Live",complete:"Finished"};class un extends N{static styles=`
        .landing {
    ...
    `;svc=this.inject(Ct);profile=this.inject(Me);activity=this.inject(ys);homeStats=this.inject(Lt);auth=this.inject(D);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>this.loggedIn.get()?Xe.fromMyRounds(this.svc.myRounds.get()):Xe.fromDeviceRounds(this.svc.deviceRounds.get()));parts=new $(()=>Id(this.rows.get(),Date.now(),e=>e));ongoing=new $(()=>this.parts.get().ongoing);finished=new $(()=>this.parts.get().finished);ongoingShown=new $(()=>this.ongoing.get().slice(0,qi));finishedShown=new $(()=>this.finished.get().slice(0,Pd));counts=new $(()=>({rows:this.rows.get().length,ongoing:this.ongoing.get().length,finished:this.finished.get().length}));newRows=new $(()=>this.loggedIn.get()?Xe.fromMyRounds(this.svc.newRounds.get()):[]);chips=new $(()=>this.loggedIn.get()?uo(this.activity.feed.get()?.live??[]):[]);recents=new $(()=>this.loggedIn.get()?go(this.activity.feed.get()?.recent??[]):[]);statsCard=new $(()=>this.loggedIn.get()?this.homeStats.card.get():null);statsTiles=new $(()=>this.statsCard.get()?.tiles??[]);deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,n){this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?(this.svc.loadMine(),this.profile.load(),this.activity.load(),this.homeStats.refreshPreset(),this.homeStats.load(!0)):this.svc.loadDevice();const e=this.wire(Nd,{head:{className:()=>this.loggedIn.get()?"landing__head hidden":"landing__head"},identity:{className:()=>this.loggedIn.get()?"landing__identity":"landing__identity hidden","aria-label":()=>{const n=this.identityName(),i=Kt(this.profile.player.get()?.handicapIndex);return i?`${n}, ${i}`:n},onclick:()=>this.router.navigate("/profile")},...Se(()=>{const n=this.profile.player.get();return{id:n?.id??"",avatarVersion:n?.avatarVersion??null,displayName:n?.displayName??null,username:n?.username??this.auth.currentUser.get()?.username??null}}),identityName:()=>this.identityName(),identityHcp:{textContent:()=>Kt(this.profile.player.get()?.handicapIndex)??"",className:()=>Kt(this.profile.player.get()?.handicapIndex)===null?"landing__identity-hcp hidden":"landing__identity-hcp"},history:{className:()=>Cd(this.counts.get())?"landing__history":"landing__history hidden",onclick:()=>this.router.navigate("/history")},outNowSection:{className:()=>this.chips.get().length>0?"landing__section-block landing__outnow":"landing__section-block landing__outnow hidden"},outNowContext:()=>po(this.activity.feed.get()?.live??[])??"",recentlySection:{className:()=>this.recents.get().length>0?"landing__section-block landing__recently":"landing__section-block landing__recently hidden"},newSection:{className:()=>this.newRows.get().length>0?"landing__section-block landing__new":"landing__section-block landing__new hidden"},newCount:()=>{const n=this.newRows.get().length;return n===0?"":String(n)},ongoingSection:{className:()=>this.ongoing.get().length>0?"landing__section-block":"landing__section-block hidden"},ongoingCount:()=>{const n=this.ongoing.get().length;return n===0?"":String(n)},ongoingMore:{className:()=>Vi(this.counts.get().ongoing)?"landing__more":"landing__more hidden","aria-label":()=>"Show all ongoing rounds",onclick:()=>this.router.navigate("/history")},finishedSection:{className:()=>this.finished.get().length>0?"landing__section-block landing__finished":"landing__section-block landing__finished hidden"},finishedCount:()=>{const n=this.finished.get().length;return n===0?"":String(n)},finishedAll:{"aria-label":()=>"All rounds",onclick:()=>this.router.navigate("/history")},stats:{className:()=>this.statsCard.get()===null?"landing__stats hidden":"landing__stats","aria-label":()=>{const n=this.statsCard.get();return n===null?"":_d(n)},onclick:()=>this.router.navigate("/stats")},statsWindow:()=>this.statsCard.get()?.windowLabel??"",statsPriority:{textContent:()=>this.statsCard.get()?.priorityLine??"",className:()=>this.statsCard.get()?.priorityLine?"landing__stats-priority":"landing__stats-priority hidden"},statsTitle:()=>Gi,statsFoot:()=>ud,empty:{className:()=>Ed(this.counts.get())?"landing__empty":"landing__empty hidden"}});this.$each(this.ref(e,"outNowList"),this.chips,(n,i,r)=>this.wireEl(Ld,{chip:{"aria-label":()=>ho(n),onclick:()=>this.router.navigate("/spectate",{query:{id:n.roundId,name:n.displayName}})},...Se(()=>{const l=this.chips.get().find(d=>d.roundId===n.roundId)??n;return{id:l.playerId,avatarVersion:l.avatarVersion,displayName:l.displayName}}),who:()=>n.title,line:()=>n.progress},r),n=>n.roundId),this.$each(this.ref(e,"recentlyList"),this.recents,(n,i,r)=>this.wireEl(Hd,{row:{onclick:()=>this.router.navigate("/spectate",{query:{id:n.roundId,name:n.displayName}})},who:()=>n.friendLabel,what:()=>n.title,when:()=>ge(n.date)},r),n=>n.roundId),this.$each(this.ref(e,"newList"),this.newRows,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.$each(this.ref(e,"ongoingList"),this.ongoingShown,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.$each(this.ref(e,"finishedList"),this.finishedShown,(n,i,r)=>this.finishedRow(n,r),n=>n.key),this.$each(this.ref(e,"statsTiles"),this.statsTiles,(n,i,r)=>this.wireEl(Ad,{value:()=>n.value,label:()=>n.label,note:{textContent:()=>n.note??"",className:()=>n.note===null?"stat-tile__note hidden":"stat-tile__note"}},r),n=>`${n.id}:${n.value}:${n.note??""}`),this.spawn(ee,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const n=this.deleteTarget.get();return`Delete ${n?`“${n.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const n=this.deleteTarget.get();n&&this.svc.remove(n.token,n.roundId)}});const t=n=>{n.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}identityName(){const e=this.profile.player.get(),t=(e?.displayName??"").trim();if(t!=="")return t;const n=(e?.username??this.auth.currentUser.get()?.username??"").trim();return n===""?"Signed in":n}finishedRow(e,t){return this.wireEl(zd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Oe(e),course:{textContent:()=>Ee(e)??"",className:()=>Ee(e)?"finished-row__course":"finished-row__course hidden"},date:()=>ge(e.date),status:{textContent:()=>cs[e.status]??e.status,className:()=>`finished-row__status s-${e.status}`}},t)}roundRow(e,t){return this.wireEl(Od,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Oe(e),course:{textContent:()=>Ee(e)??"",className:()=>Ee(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>cs[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>ge(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",Oe(e))}}},t)}}function Md(s){return[...s].sort((e,t)=>{const n=hn(e),i=hn(t);return i!==n?i-n:e.key.localeCompare(t.key)})}function hn(s){const e=s.completedAt??s.lastActivityAt,t=e?Date.parse(e):NaN;return Number.isNaN(t)?Number.NEGATIVE_INFINITY:t}const Fd=b(`
    <div class="history">
...
`),Bd='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',jd=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="title" class="round-row__title"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Bd}</button>
    </div>
`);class Dd extends N{static styles=`
        .history {
    ...
    `;svc=this.inject(Ct);auth=this.inject(D);router=this.inject(B);loggedIn=new $(()=>this.auth.currentUser.get()!==null);rows=new $(()=>Md(this.loggedIn.get()?Xe.fromMyRounds(this.svc.myRounds.get()):Xe.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new p(!1);deleteTarget=new p(null);askDelete(e,t,n){this.deleteTarget.set({token:e,roundId:t,name:n}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(Fd,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(n,i,r)=>this.roundRow(n,r),n=>n.key),this.spawn(ee,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const n=this.deleteTarget.get();return`Delete ${n?`“${n.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const n=this.deleteTarget.get();n&&this.svc.remove(n.token,n.roundId)}});const t=n=>{n.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(jd,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},title:()=>Oe(e),course:{textContent:()=>Ee(e)??"",className:()=>Ee(e)?"round-row__course":"round-row__course hidden"},role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>cs[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>ge(e.date),formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",Oe(e))}}},t)}}const Gd=700;function qd(s){if(!s.currentHole)return!1;const e=s.balls.filter(t=>!t.pending);return e.length>0&&e.every(t=>t.scored)}function Vd(s){return s.currentHole?s.balls.some((e,t)=>t!==s.currentBallIndex&&!e.scored):!1}function Wt(s){const e=s.currentHole;if(!e)return{kind:"noop"};const t=s.balls,n=s.currentBallIndex;for(let i=n+1;i<t.length;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};for(let i=0;i<n;i++)if(!t[i].scored)return{kind:"moveToBall",ballIndex:i};return s.holeIndex>=s.holeCount-1?{kind:"roundComplete",toast:"Round complete"}:{kind:"holeComplete",toast:`Hole ${e.label} done`,fromHoleId:e.id,toHoleIndex:s.holeIndex+1,delayMs:Gd}}function Ud(s,e){const t=s.currentHole;if(e.kind==="statsDone")return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Wt(s)};const n=s.balls[s.currentBallIndex];if(!t||!n)return{write:null,move:{kind:"noop"}};if(n.pending)return s.holeCompleteOnEntry?{write:null,move:{kind:"stay"}}:{write:null,move:Wt(s)};const i={ballIndex:s.currentBallIndex,holeId:t.id,value:e.value,withMetadata:e.value!==null};return e.value!==null&&e.value>0&&s.collectsStats?{write:i,move:{kind:"openStats"}}:s.holeCompleteOnEntry?{write:i,move:{kind:"stay"}}:{write:i,move:Wt(s)}}const ye=60,pn=8,us=4,Kd=Array.from({length:us*2+1},(s,e)=>e-us),Wd="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Yd=b(`
...
`),tc=b('<button bind="btn" class="se-seg" type="button"></button>'),sc=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),nc=b('<div bind="rule" class="se-stats__rule"></div>');class ic extends N{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${pn}px; flex-shrink: 0; }
...
</tr>`;if(!F||!C)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${A(g.name)}</span>${w}</span></td>${R}
  <td class="lb-rank__disclosure"></td>
</tr>`;const G=hs(n.plan.slotDefId,F.ballIds),E=n.isOpen(G),Y=Ic(G),te=Qi(C,n.routeSections,e,{mode:n.mode??"product"}),se=["lb-rank__row--expandable"];return g.lead&&se.push("lb-rank__lead"),E&&se.push("lb-rank__row--open"),`<tr class="${se.join(" ")}" data-expand-key="${A(G)}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${E}" aria-controls="${A(Y)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${A(g.name)}</span>${w}</span></button></td>${R}
  <td class="lb-rank__disclosure"><span class="lb-rank__chev" aria-hidden="true"></span></td>
</tr>
<tr class="lb-rank__panel${E?" lb-rank__panel--open":""}" data-panel-key="${A(G)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${A(Y)}"><div class="lb-rank__panelbox">${te}</div></div></td>
</tr>`}).join(""),u=r?`
  ...
  <table class="lb-rank">
...
</div>`}function Cc(s,e){const t=fc(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",l=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    ...
    <div class="lb-mp__team lb-mp__team--b${l}">${A(i.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${A(t.title)}</h4>${n}
</div>`}const Ec={ranked:Pc,match_summary:(s,e)=>Cc(s,e)},Nc={"default-score-grid":$c,"compact-match-grid":kc,"category-matrix-grid":Sc};function Rc(s){return`<div class="lb-diag">Unrenderable result section <code>${A(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Oc(s){return`<div class="lb-diag">Unsupported score-grid component <code>${A(s)}</code> — no generic view yet. Results are not hidden.</div>`}function zc(s,e,t,n=null){const i=Ec[s.kind];return i?i(s,e,t,n):Rc(s.kind)}function Qi(s,e,t,n){const i=Ki(s),r=Nc[i];return r?r(s,e,t,n):Oc(i)}function Xi(s,e,t=Yi,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${A(s.formatLabel)}.</div>`:s.leaderboard.map(r=>zc(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${A(s.formatLabel)}.</div>`}function Ji(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Qi(r,e,t,{mode:i})).join(`
`)}const Lc=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class Zi extends N{static styles=`
        .lb {
    ...
    `;svc=this.inject(ce);expansion=new bc;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Lc,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=gc(t);this.expansion.retain(r.attached.keys());const l=Xi(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),d=Ji(r.standalone,e.routeSections,n),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return l+c}}function Ac(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Hc=b(`
...
`);class Fc extends N{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${P()}
    ...
    `,Je.seq=0;let re=Je;function jc(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Dc(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Gc(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const qc=b(`
...
`);class Kc extends N{static styles=`
        .seat-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${P()}
...
`);class Jc extends N{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${P()}
    ...
    `;svc=this.inject(ce);auth=this.inject(D);router=this.inject(B);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Yc(this.svc.startList.get())}eligible(){return this.policyState().visible&&Wc(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await v.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof V&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(I(()=>this.ensureTeesLoaded()));const e=new $(()=>Qc(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(I(()=>{const r=e.get(),l=this.groupChoice.get();(!l||!r.options.some(d=>d.value===l&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Xc,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new re({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new re({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const _n=1440*60*1e3;function Zc(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>_n?!0:e-t>=_n}function eu(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function tu(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!eu(s.balls,s.playerId)||!Zc(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function le(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function St(s){return s<0?`+${String(-s)}`:String(s)}const su=b(`
...
`);class nu extends N{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${P()}
    ...
    `;svc=this.inject(ce);auth=this.inject(D);profile=this.inject(Me);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return tu({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":St(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=le(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(I(()=>this.ensureProfileLoaded())),this.wire(su,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${St(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function iu(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const ru=b(`
...
`);class au extends N{static styles=`
    ...
    `;svc=this.inject(ce);auth=this.inject(D);router=this.inject(B);tokenQ=this.router.query("token");editable=new p(!1);deleteOpen=new p(!1);finishOpen=new p(!1);finishAsReopen=new p(!1);leaveOpen=new p(!1);leaving=new p(!1);error=new p("");diagnostics=new p([]);isComplete(){return this.svc.round.get()?.status==="complete"}canLeave(){return iu(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}clear(){this.error.set(""),this.diagnostics.set([])}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.clear(),this.leaving.set(!0);try{const t=await v.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){this.track(I(()=>{const r=this.tokenQ.get();this.editable.set(!1),r&&v.friendlyRounds.setup({token:r}).then(l=>{this.tokenQ.get()===r&&this.editable.set(l.editable===!0)}).catch(()=>{})})),this.track(I(()=>{this.props.open.get()&&this.clear()}));const e=this.wire(ru,{root:{className:()=>this.props.open.get()?"rmanage":"rmanage hidden"},backdrop:{onclick:()=>this.props.open.set(!1)},close:{onclick:()=>this.props.open.set(!1)},editRow:{className:()=>this.editable.get()?"rmanage__row":"rmanage__row hidden",onclick:()=>{const r=this.tokenQ.get();r&&(this.props.open.set(!1),this.router.navigate("/create",{query:{token:r}}))}},leaveRow:{className:()=>this.canLeave()?"rmanage__row rmanage__row--danger":"rmanage__row rmanage__row--danger hidden",onclick:()=>this.leaveOpen.set(!0),disabled:()=>this.leaving.get()},finishRow:{onclick:()=>{this.finishAsReopen.set(this.isComplete()),this.finishOpen.set(!0)},disabled:()=>this.svc.finishing.get()},finishTitle:()=>this.isComplete()?"Reopen round":"Finish round",finishSub:()=>this.isComplete()?"Move it back to your ongoing rounds.":"Move it to your finished rounds. Nothing is locked.",deleteRow:{onclick:()=>this.deleteOpen.set(!0),disabled:()=>this.svc.deleting.get()},diag:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},err:{textContent:()=>this.error.get()}});this.spawn(ee,this.ref(e,"deleteConfirmHost"),{open:this.deleteOpen,title:"Delete round?",message:"This permanently removes the round and all its scores for everyone. This can't be undone.",confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.clear(),this.svc.deleteRound().then(r=>{r?this.router.navigate("/"):this.error.set("Could not delete the round. Try again.")})}}),this.spawn(ee,this.ref(e,"finishConfirmHost"),{open:this.finishOpen,title:()=>this.finishAsReopen.get()?"Reopen this round?":"Finish this round?",message:()=>this.finishAsReopen.get()?"It'll move back to your ongoing rounds.":"It'll move to your finished rounds. You can still edit or reopen it any time.",confirmLabel:()=>this.finishAsReopen.get()?"Reopen round":"Finish round",cancelLabel:"Cancel",onconfirm:()=>{this.clear(),(this.finishAsReopen.get()?this.svc.reopenRound():this.svc.finishRound()).then(l=>{l||this.error.set("Could not update the round. Try again.")})}}),this.spawn(ee,this.ref(e,"leaveConfirmHost"),{open:this.leaveOpen,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}});let t=null;const n=this.ref(e,"close");this.track(I(()=>{this.props.open.get()?(t=document.activeElement instanceof HTMLElement?document.activeElement:null,queueMicrotask(()=>n.focus())):t&&(t.focus(),t=null)}));const i=r=>{if(r.key==="Escape"){if(this.deleteOpen.get())return void this.deleteOpen.set(!1);if(this.finishOpen.get())return void this.finishOpen.set(!1);if(this.leaveOpen.get())return void this.leaveOpen.set(!1);this.props.open.get()&&this.props.open.set(!1)}};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),e}}class ke{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(as());filter=new p(Qe);extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new $(()=>Si(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new $(()=>Ts(this.windowRounds.get()));courses=new $(()=>ol(this.loadedRounds.get()));overFiltered=new $(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await M(this.loading,this.error,()=>v.playerStats.myStats({limit:ke.PAGE_SIZE}));t&&(this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded())}select(e){this.preset.set(e),rn(e),this.extendIfNeeded()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),rn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(Qe),this.select($t)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<ke.MAX_PAGES&&Ti({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await v.playerStats.myStats({limit:ke.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=ke.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(Qe),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}function ou(s,e,t=!0){if(s===null||e===null||s<=0)return null;const n=s-e;return n===0?null:s===1&&t||n<=-3?"diamond":n===-2?"double_ring":n===-1?"ring":n===1?"square":n===2?"double_square":"box_badge"}function lu(s){const e=s.par,t=s.score,n=t===0,i=n?null:t,r=s.stats;return{id:s.playHoleId,ordinal:s.ordinal,holeNumber:s.courseHoleNumber,par:e,lengthM:s.lengthM,strokes:i,isPickedUp:n,vsPar:i===null?null:i-e,marker:ou(i,e),tee:r.teeResult,gir:r.gir,putts:r.putts,firstPutt:r.firstPutt,shortGame:r.shortGameDifficulty,penalties:r.penalties,recoveryOk:r.recoveryOk}}function du(s){return(s.penalties??0)>0}const ps=10,cu=3;function uu(s){const{round:e,holes:t,history:n,windowSize:i=ps,insightLimit:r=cu}=s,l=Ts([e]),d=l.waterfall,u=hu(e,n,i).map(m=>tt(m.measures)),f=l.rounds[0];return{roundId:e.roundId,date:e.date,courseName:e.courseName,name:e.name,holeCount:e.holeCount,strokes:f?.strokes??null,vsPar:f?.vsPar??null,cells:[...t].sort((m,h)=>m.ordinal-h.ordinal).map(lu),panels:l,waterfall:d,deltas:u.length===0?null:Oi(d,u),windowCount:u.length,insights:Dl(e.measures,d,u,r)}}function hu(s,e,t){const n=e.filter(l=>l.roundId!==s.roundId);n.push(s);const i=Rt(n),r=i.findIndex(l=>l.roundId===s.roundId);return r===-1?[]:i.slice(r+1,r+1+Math.max(0,t))}function yn(s,e,t){const n=Rt(s),i=n.findIndex(r=>r.roundId===e);return i===-1?!1:n.length-(i+1)>=t}function vn(s){const e=(s.name??"").trim();if(e!=="")return e;const t=(s.courseName??"").trim();return t===""?"Round":t}function pu(s){const{signedInPlayerId:e,statConfigPlayerIds:t,statRows:n,holesUnscored:i}=s;return e===null||e===""?{reason:"notSignedIn",playerId:null}:t.has(e)?n.some(l=>l.playerId===e&&fu(l))?i!==0?{reason:"roundUnfinished",playerId:null}:{reason:"eligible",playerId:e}:{reason:"noStatsRecorded",playerId:null}:{reason:"noStatsConfigured",playerId:null}}function fu(s){return s.teeResult!==null||s.gir!==null||s.firstPutt!==null||s.putts!==null||s.shortGameDifficulty!==null||s.penalties!==null||s.recoveryOk!==null}function mu(s){const{playerId:e,balls:t,groups:n,strokesFor:i}=s,r=t.find(d=>d.players.some(c=>c.playerId===e));if(!r)return null;const l=n.find(d=>d.ballIds.includes(r.id));return l?l.playedOrder.filter(d=>i(r.id,d.playHoleId)===null).length:null}class nt{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=q.get(ke);inFlight=null;model=new $(()=>{const e=this.round.get();return e===null?null:uu({round:e,holes:this.holes.get(),history:this.history.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await v.playerStats.myRoundStats({roundId:e})}catch(l){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(wn(l)),this.failure.set(xn(l));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(l){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(wn(l)),this.failure.set(xn(l));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(l=>l.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(l=>l.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=l=>{for(const d of l)n.has(d.roundId)||(n.add(d.roundId),t.push(d))};if(i(this.dashboard.loadedRounds.get()),yn(t,e,ps))return t;let r=null;for(let l=0;l<nt.MAX_PAGES;l++){const d=await v.playerStats.myStats({limit:nt.PAGE_SIZE,cursor:r??void 0});if(i(d.rounds),yn(t,e,ps)||d.nextCursor===null)return t;r=d.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function wn(s){if(s instanceof V){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function xn(s){return s instanceof V&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const Z=100;function At(s){return s>0?"loss":s<0?"gain":"zero"}function Be(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function Q(s){return String(Math.round(s*1e3)/1e3)}function zs(s){return s<0?0:s>1?1:s}function Te(s,e){return`<svg class="chart" viewBox="0 0 ${Z} ${Q(s)}" preserveAspectRatio="none" style="height:${Q(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function Ls(s,e,t,n=1){return`<path d="M${Q(s)} 0 L${Q(s)} ${Q(e)}" stroke="${t}" stroke-width="${Q(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function de(s,e,t,n,i){return`<rect x="${Q(s)}" y="${Q(e)}" width="${Q(t)}" height="${Q(n)}" fill="${i}"/>`}const gu=1;function bu(s,e){const t=Z/2,n=At(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:gu,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function er(s,e,t,n=10){const i=bu(s,e),r=i.bar&&i.bar.width>0?de(i.bar.x,0,i.bar.width,n,Be(i.tone,t)):"";return Te(n,[de(0,0,Z,n,t.track),r,Ls(i.zeroX,n,t.rule)].join(""))}function _u(s){const e=[];let t=0;for(const n of s){const i=Z*zs(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function yu(s,e,t=12){const n=_u(s).filter(i=>i.width>0).map(i=>de(i.x,0,i.width,t,i.color)).join("");return Te(t,de(0,0,Z,t,e.track)+n)}const $n=2,vu=1e-4;function wu(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=$n,l=Math.max(0,e-$n*2);return s.map((d,c)=>({x:s.length===1?Z/2:c/(s.length-1)*Z,y:i===0?e/2:r+l-(d-t)/i*l}))}function xu(s){return s.map((e,t)=>`${t===0?"M":"L"}${Q(e.x)} ${Q(e.y)}`).join(" ")}function $u(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=vu?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function ku(s,e,t,n=34){const i=wu(s,n);if(i.length===0)return Te(n,"");const r=Be($u(s,e),t),l=`<path d="${xu(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,d=i[i.length-1],c=`<path d="M${Q(d.x)} ${Q(d.y)} L${Q(d.x)} ${Q(d.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Te(n,l+c)}const Su=.5;function Tu(s,e,t=8){const n=Z/2,i=ie.length-1,r=Math.max(1,(t-i)/ie.length),l=[];return ie.forEach((d,c)=>{const u=Le(s,d);if(u===null||!(e>0))return;const f=Math.max(u===0?0:Su,n*Math.min(1,Math.abs(u)/e));l.push({component:d,x:u>=0?n:n-f,y:c*(r+1),width:f,height:r,tone:At(u)})}),l}function Iu(s,e,t,n=8){const i=Tu(s,e,n).filter(r=>r.width>0).map(r=>de(r.x,r.y,r.width,r.height,Be(r.tone,t))).join("");return Te(n,Ls(Z/2,n,t.rule)+i)}const tr=1,kn=.02;function Pu(s,e){const t=e>0?Z*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=zs(s),i=e<=0?"neutral":s>e+kn?"gain":s<e-kn?"loss":"neutral";return{bar:{width:Math.max(tr,Z*n),tone:i},tickX:t}}function Cu(s,e,t,n=10){const i=Pu(s,e),r=i.bar?de(0,0,i.bar.width,n,Be(i.bar.tone,t)):"",l=i.tickX===null?"":Ls(i.tickX,n,t.rule,2);return Te(n,de(0,0,Z,n,t.track)+r+l)}function Eu(s){return s===null?null:Math.max(tr,Z*zs(s))}function Nu(s,e,t=e.neutral,n=8){const i=Eu(s),r=i===null?"":de(0,0,i,n,t);return Te(n,de(0,0,Z,n,e.track)+r)}const Ht={gain:o("accent-strong"),loss:o("danger"),zero:o("border-strong"),neutral:o("accent"),track:o("surface-sunken"),rule:o("border")},L={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Strokes lost per round against a fixed baseline, worst first. Positive costs you shots.",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s four waterfall terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function We(s){return ad(s)?null:s.value}function ue(s,e,t){return{kind:"bar",id:s,title:e,share:We(t),value:fe(t)}}function X(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function Ru(s,e){switch(s){case"tee":{const t=e.tee&&ae(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&ae(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?Ne(e.putting.puttsPerGirHole,{unit:Fi,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&ae(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?Ne(e.scoring.doubleBogeyPlusPerRound,{unit:pe,label:"doubles or worse per round"}):null}}function Ou(s){const e=rd(s.vsParByTee),t=e?`${L.troubleTax} Measured ${e}.`:L.troubleTax;return X("troubleTax","Trouble tax",Ps(s.troubleTax,2,!0),t)}function Sn(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:We(t.fairway),value:fe(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:We(t.inPlayOnly),value:fe(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:We(t.trouble),value:fe(t.trouble)}]},Ou(t),X("recovery","Recovery",ae(t.recovery),L.recovery),X("penalties","Penalties",Ne(t.penaltiesPerRound,{unit:pe}),L.penalties)]:[]}case"approach":{const t=e.approach;return t?[{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},ue("girFairway","From the fairway",t.girByTee.fairway),ue("girInPlay","From in play",t.girByTee.inPlay),ue("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:L.proximityProxy},...Ot.map(n=>ue(`mix-${n}`,on(n),t.girFirstPuttMix[n])),X("birdieConversion","Birdie conversion",ae(t.birdieConversion),L.birdieConversion)]:[]}case"putting":{const t=e.putting;return t?[{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:L.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:on(n.bucket),made:We(n.made),baseline:n.baseline,value:fe(n.made)})),X("threePutt","Three-putts",ae(t.threePutt),L.threePutt),X("longThreePutt","Three-putts from over 8 m",ae(t.threePuttsFromOver8m),L.longThreePutt),X("puttsPerGir","Putts per green hit",Ne(t.puttsPerGirHole,{unit:Fi}),L.puttsPerGir)]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},ue("scrambleStandard","Standard",t.scramble.standard),ue("scrambleHard","Hard",t.scramble.hard),{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},ue("chipStandard","Standard",t.chipInside2m.standard),ue("chipHard","Hard",t.chipInside2m.hard),X("conversionInside2m","Holed from inside 2 m",ae(t.conversionInside2m),L.conversionInside2m),X("chipIns","Chip-ins",Ae(t.chipIns),L.chipIns)]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>Ne(i,{unit:Mi,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},X("par3","Par 3",n(t.avgVsParByParGroup.par3)),X("par4","Par 4",n(t.avgVsParByParGroup.par4)),X("par5","Par 5",n(t.avgVsParByParGroup.par5)),X("doubles","Doubles or worse",Ne(t.doubleBogeyPlusPerRound,{unit:pe}),L.doubleBogeyPlus),X("bounceBack","Bounce-back",ae(t.bounceBack),L.bounceBack)]}}}function zu(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function Tn(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const U={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},In={title:"Your round",seeWholeRound:"See the whole round"};function Lu(s){const e=[Di(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function sr(s,e){return s===null?null:e===null?String(s):`${s} (${Es(e)})`}function Au(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function Hu(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function Mu(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${Es(s.vsPar)})`}function Fu(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function Bu(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function ju(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function Du(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function As(s){const e=[],t=Mu(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:Fu(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:Bu(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:ju(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Gu(s){return s===null?[]:As(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function Pn(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(Du(s.marker).toLowerCase())):e.push("no score");for(const t of As(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function nr(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=be(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function Cn(s){switch(s){case"putting":return"Putting";case"shortGame":return"Your short game";case"penalties":return"Penalties";case"longGame":return"Tee to green"}}function Jt(s,e=1){return typeof s=="number"?be(Math.abs(s),e):""}function Zt(s){return typeof s=="number"?String(Math.round(s)):""}function En(s){return typeof s=="string"?s:"longGame"}function qu(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${Cn(En(e.component))} was ${Jt(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${Cn(En(e.component))} cost you ${Jt(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${Jt(e.baseline)} in a normal round.`}case"scramble_streak":return`You saved par ${Zt(e.successes)} of the ${Zt(e.attempts)} times you missed the green.`;case"three_putt_free":return`No three-putts — ${Zt(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Vu=b(`
...
`);class Wu extends N{static styles=`
    ...
    `;round=this.inject(ce);stats=this.inject(nt);auth=this.inject(D);router=this.inject(B);colors=Ht;render(){this.track(I(()=>{const i=this.eligibleRoundId();K(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Vu,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>In.title,score:()=>{const i=e();return i===null?"":sr(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),open:{textContent:()=>In.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Le(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...ie],(i,r,l)=>this.wireEl(Ku,{label:()=>zt(i),amount:{textContent:()=>{const d=n(i);return d===null?L.notRecorded:Fe(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Be(At(d),this.colors)}`}}},l),i=>i),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,l)=>this.wireEl(Uu,{text:()=>qu(i)},l),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:pu({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:mu({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return U.waterfallHint;let t=null;for(const n of ie){const i=ks(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?U.waterfallHint:nr(t,e.windowCount)}}function Yu(s,e=typeof navigator>"u"?"en":navigator.language){const t=(s?.name??"").trim();if(t)return t;const n=s?.date??"";return/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n||"Round"}function Nn(s){return!(!s.pageVisible||s.status==="complete")}function Qu(s,e){return e&&!s}const Xu=2,Rn=3,Ju=75e3;function Zu(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${j}/friendly-rounds/events?${t.toString()}`}function eh(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function th(s){const e=s.eventSourceFactory??(C=>new EventSource(C)),t=s.setTimer??((C,G)=>setTimeout(C,G)),n=s.clearTimer??(C=>clearTimeout(C)),i=s.livenessTimeoutMs??Ju,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let l=!1,d=0,c=null,u=null,f=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(R,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},_=()=>{l=!0,m(),g()},w=()=>{if(g(),++d>=Rn){_(),s.onDegrade();return}F()};function R(){if(!l){if(!r()){h();return}w()}}function F(){if(l)return;let C;try{C=e(Zu(s.token,f))}catch{_(),s.onDegrade();return}c=C,C.onopen=()=>{d=0},C.onmessage=G=>{if(l||c!==C)return;h();let E;try{E=JSON.parse(G.data)}catch{return}eh(E)&&(E.latestEventId!==null&&(f=E.latestEventId),s.onEvent({latestEventId:E.latestEventId,status:E.status}))},C.onerror=()=>{l||c!==C||(C.readyState===Xu||++d>=Rn)&&(_(),s.onDegrade())},h()}return F(),{stop:()=>{l||_()}}}const sh=2e4;function nh(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const ih=b(`
...
`),rh=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),ah=b('<button bind="pill" class="round-view__grp" type="button"></button>');class oh extends N{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Lh extends N{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class jh extends N{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
    ...
    `;auth=this.inject(D);router=this.inject(B);nextQ=this.router.query("next");mode=new p("login");busy=new p(!1);formError=new p("");username="";password="";displayName="";hcp="";gender=new p(null);clubs=new p([]);homeClubId=new p("");clubsRequested=!1;async loadClubs(){if(!this.clubsRequested){this.clubsRequested=!0;try{this.clubs.set(await v.setup.clubs())}catch{}}}destination(e){const t=this.nextQ.get();return t&&t.startsWith("/")?t:e}async submit(){if(this.formError.set(""),this.mode.get()==="login"){if(!this.username.trim()||this.password===""){this.formError.set("Enter your username and password.");return}this.busy.set(!0);try{const n=await rr(this.username.trim(),this.password);this.auth.currentUser.set(n),this.auth.error.set(null),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(Bn(n,"login"))}finally{this.busy.set(!1)}return}const e=this.hcp.trim(),t=e===""?null:le(e);if(e!==""&&t===null){this.formError.set("Handicap index must be a number (or leave it empty).");return}if(this.password.length<8){this.formError.set("Password must be at least 8 characters.");return}if(!this.username.trim()||!this.displayName.trim()){this.formError.set("Username and display name are required.");return}this.busy.set(!0);try{const n=await v.players.register({username:this.username.trim(),password:this.password,displayName:this.displayName.trim(),handicapIndex:t,gender:this.gender.get(),homeClubId:this.homeClubId.get()||null});this.auth.currentUser.set({id:n.id,username:n.username}),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(Bn(n,"register"))}finally{this.busy.set(!1)}}render(){const e=()=>this.mode.get()==="register",t=()=>this.auth.loading.get()||this.busy.get(),n=this.wire(Bh,{root:{inert:()=>t()},error:{className:()=>this.formError.get()?"error show":"error",textContent:()=>this.formError.get()},form:{onsubmit:async l=>{l.preventDefault(),await this.submit()}},username:{oninput:l=>{this.username=l.target.value}},password:{autocomplete:()=>e()?"new-password":"current-password",oninput:l=>{this.password=l.target.value}},registerFields:{className:()=>e()?"login__register":"login__register hidden"},displayName:{oninput:l=>{this.displayName=l.target.value}},hcp:{oninput:l=>{this.hcp=l.target.value}},submit:{textContent:()=>t()?e()?"Creating account…":"Signing in…":e()?"Create account":"Sign in"},toggle:{textContent:()=>e()?"Have an account? Sign in":"New here? Create an account",onclick:()=>{this.formError.set(""),this.auth.error.set(null);const l=!e();this.mode.set(l?"register":"login"),l&&this.loadClubs()}}}),i=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(n,"gender"),()=>i,(l,d,c)=>this.wireEl(b('<button bind="b" type="button"></button>'),{b:{textContent:()=>l.label,className:()=>this.gender.get()===l.value?"on":"",onclick:()=>this.gender.set(l.value)}},c),l=>l.label);const r=new re({value:this.homeClubId,options:{get:()=>[{value:"",label:"No home club"},...this.clubs.get().map(l=>({value:l.id,label:l.name}))]},placeholder:"No home club"});return r.mount(this.ref(n,"club")),this.track(()=>r.destroy()),n}}const Dh=b(`
    <div class="friends">
...
`),Gh='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',qh=b(`
...
`),jn=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Gh}</button>
    </div>
`);class Vh extends N{static styles=`
        .friends {
...
`);function or(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>bo(s),subtitle:()=>_o(s,ge),progress:()=>yo(s)}}function lr(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class Kh extends N{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Nt);activity=this.inject(ys);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();K(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",l=new $(()=>{const h=e.get();return h?fo(this.activity.feed.get(),h):null}),d=()=>this.svc.unavailable.get(),c=()=>n()&&d()===null&&i()!==null,u=()=>n()&&d()===null&&i()===null,f=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(Uh,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&d()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=d();return h?ze[h].title:""}},refusalMsg:{textContent:()=>{const h=d();return h?ze[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...Se(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?vo(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>l.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=l.get();return h?mo(h):""},onclick:()=>{const h=l.get();h&&f(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>xo(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,_)=>this.wireEl(ar,or(h,f),_),h=>h.roundId),m}}const Wh=b(`
    <div class="frounds">
...
`);class Yh extends N{static styles=`
        .frounds {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class Jh extends N{static styles=`
    ...
    `;svc=this.inject(Nt);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();K(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],l=()=>(t.get()??"").trim(),d=this.wire(Qh,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:l()}})},subtitle:{textContent:()=>{const c=l();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?ze[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?ze[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(l())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,u,f)=>this.wireEl(Xh,{name:()=>c.courseName??"Course",facts:()=>wo(c,ge)},f),c=>c.courseId),d}}function Zh(s,e,t){const n=it(e);if(n){const d=Gn(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=Gn(s)??"this",r=it(t),l=r?` at ${r}`:"";return`Watching · ${i} round${l}`}function ep(s,e,t,n){const i=it(s)===null?null:it(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const tp="You're watching this round. Only its players can enter scores.",Dn={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Gn(s){const e=it(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function it(s){return(s??"").trim()||null}const sp=b(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${tp}</p>
        </div>
    </div>
`);class np extends N{static styles=`
        .spectate {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${Zi.styles}
    `;svc=this.inject(xi);auth=this.inject(D);router=this.inject(B);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();K(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),l=()=>(t.get()??"").trim()||null;return this.wire(sp,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(l()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Dn[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Dn[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Zh(l(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?ep(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>ge(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const l=i.length>1?`<h2 class="spectate__slot-head">${ip(r.formatLabel)}</h2>`:"",d=Xi(r,t,n),c=Ji(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return l+d+u}).join("")}}function ip(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const rp=b(`
    <div class="profile">
...
`);class lp extends N{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),cp=b('<h3 bind="text" class="block__subhead"></h3>'),up=b('<p bind="text" class="block__note"></p>'),hp=b(`
...
`),gp=b('<div bind="panels" class="statspanels"></div>');class dr extends N{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
...
`);class xp extends N{static styles=`
        .stats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(ke);auth=this.inject(D);router=this.inject(B);filterOpen=new p(!1);colors=Ht;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(bp,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>L.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>L.filterClear,onclick:()=>this.svc.clearFilter()},empty:()=>this.emptyLine(),prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>L.prioritiesHint,trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>L.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>L.roundsHint,pickHint:()=>n()?L.filterRoundsHint:""});return this.setHeading(i,"prioritiesSec",L.priorities),this.setHeading(i,"trendsSec",L.trends),this.setHeading(i,"roundsSec",L.roundsHeading),this.mountPicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,l,d)=>this.wireEl(yp,{title:()=>zt(r.component),subtitle:()=>ld(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.perRound===null||c===void 0?"":er(c.perRound,Zl(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.perRound!==null?od(c.perRound):L.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.perRound===null?zu(c.roundsInWindow):`over ${oe(c.roundsCovered,pe)}`:""}}},d),r=>r.component),this.$each(this.ref(i,"trends"),()=>t().trends,(r,l,d)=>this.wireEl(vp,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return ku(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return $p(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return oe(c.points.length,pe)}}},d),r=>r.id),this.spawn(dr,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,l,d)=>this.wireEl(wp,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${Tn(r)} — hole by hole`},label:()=>Tn(r),subtitle:()=>kp(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(rl(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Iu(c.waterfall,Hi(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":Es(c.vsPar)}}},d),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(I(()=>t.set(this.svc.preset.get()))),this.track(I(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${xt(r)} — ${sl(r)}`}),i=new re({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:xt("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,l)=>this.wireEl(qn,{chip:{textContent:()=>dd(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(Vt(this.svc.filter.get(),"venueTypes",i))}},l),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,l)=>this.wireEl(qn,{chip:{textContent:()=>cd(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(Vt(this.svc.filter.get(),"roundTypes",i))}},l),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,l)=>this.wireEl(_p,{name:()=>i.name,count:()=>oe(i.roundCount,pe),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(Vt(this.svc.filter.get(),"courseIds",i.id))}},l),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?oe(e,pe):`${be(e,0)} of ${oe(t,pe)}`}statusLine(){const e=this.svc.extendError.get();return e?`${L.extendProblemPrefix}${e.message}`:this.svc.extending.get()?L.extending:this.svc.budgetSpent()?L.budgetSpent:this.svc.loading.get()?L.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?L.windowEmpty:this.svc.loadedCount()===0?L.noStats:""}}function $p(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:Fe(e)}function kp(s){const e=[Di(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${be(s.holeCount,0)} holes`),e.join(" · ")}const Sp=b(`
...
`),Cp=b('<li bind="text" class="roundstats__legenditem"></li>');function Ep(){const s=[];for(const[e,t]of Object.entries(Rs))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class Np extends N{static styles=`
        .roundstats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(nt);auth=this.inject(D);router=this.inject(B);colors=Ht;openHole=new p(null);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(I(()=>{const r=e.get();K(()=>{this.openHole.set(null),r&&this.svc.load(r)})}));const i=this.wire(Sp,{back:{onclick:()=>this.router.navigate("/stats")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":vn(t()),subtitle:()=>this.subtitle(),score:()=>{const r=t();return r===null?"":sr(r.strokes,r.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>U.waterfallHeading,wfHint:()=>U.waterfallHint,legendHeading:()=>U.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const r=this.selected();return r===null?"":Au(r)},detailEmpty:()=>{const r=this.selected();return r===null?"":As(r).length===0?U.nothingRecordedOnHole:""}});return this.setHeading(i,"stripSec",U.holeStripHeading),this.$each(this.ref(i,"strip"),()=>t()?.cells??[],(r,l,d)=>this.wireEl(Tp,{cell:{className:()=>{const c=this.cellNow(r.id)??r;return c.marker===null?"cell":`cell cell--${c.marker}`},"aria-pressed":()=>String(this.openHole.get()===r.id),"aria-label":()=>Pn(this.cellNow(r.id)??r),title:()=>Pn(this.cellNow(r.id)??r),onclick:()=>this.openHole.set(this.openHole.get()===r.id?null:r.id)},hole:()=>String((this.cellNow(r.id)??r).holeNumber),score:()=>Hu(this.cellNow(r.id)??r),tee:{className:()=>(this.cellNow(r.id)??r).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const c=this.cellNow(r.id)??r;return c.tee===null?"":`background:${this.teeColor(c.tee)}`}},gir:{className:()=>{const c=this.cellNow(r.id)??r;return c.gir===null?"cell__gir cell__gir--absent":c.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const c=this.cellNow(r.id)??r;return c.putts===null?"":String(c.putts)},pen:{className:()=>du(this.cellNow(r.id)??r)?"cell__pen":"cell__pen cell__pen--absent"}},d),r=>r.id),this.$each(this.ref(i,"detailLines"),()=>Gu(this.selected()),(r,l,d)=>this.wireEl(Ip,{label:()=>r.label,value:()=>r.value},d),r=>r.key),this.$each(this.ref(i,"deltas"),()=>{const r=t();return r===null?[]:ie.filter(l=>Le(r.waterfall,l)!==null)},(r,l,d)=>this.wireEl(Pp,{title:()=>zt(r),sentence:()=>{const c=t();if(c===null||c.deltas===null)return"";const u=ks(c.deltas,r);return u===null?"":nr(u,c.windowCount)},value:{textContent:()=>{const c=this.componentValue(r);return c===null?"":Fe(c)},style:()=>{const c=this.componentValue(r);return c===null?"":`color:${Be(At(c),this.colors)}`}},bar:{innerHTML:()=>{const c=t(),u=this.componentValue(r);return c===null||u===null?"":er(u,Hi([c.waterfall]),this.colors)}}},d),r=>r),this.spawn(dr,this.ref(i,"panels"),{model:()=>t()?.panels??Ai}),this.$each(this.ref(i,"legend"),()=>[U.legendTee,U.legendGir,U.legendPutts,U.legendPenalty,U.legendAbsence],(r,l,d)=>this.wireEl(Cp,{text:()=>r},d),r=>r),i}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Le(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":Lu({...e,title:vn(e)})}stateLine(){if(this.auth.currentUser.get()===null)return U.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return U.loading;case"notFound":return U.noStatsInRound;case"notAuthorized":return U.notSignedIn;case"failed":return`${U.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?U.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const Rp=b(`
    <div class="admin">
...
`),Ap={not_started:"Not started",active:"Playing",complete:"Done"},Hp={private:"Private",friends:"Friends",link:"Link"};function Mp(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Fp(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Bp extends N{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class Vp extends N{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),tf=b('<button bind="chip" class="cd__friendchip" type="button"></button>');class sf extends N{competitions=this.inject(Ce);state=this.inject(at);render(){const e=()=>this.state.id.get()??"",t=this.wire(Zp,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&fs(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(ef,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&fs(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(tf,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(l=>l.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const nf={not_started:"Not started",active:"Live",complete:"Finished"},rf=b(`
    <section class="cd__section">
...
`),of=b('<option bind="option"></option>');class lf extends N{competitions=this.inject(Ce);state=this.inject(at);router=this.inject(B);render(){const e=new $(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(rf,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Dp(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(of,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(af,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>nf[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function df(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function cf(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const uf=b(`
    <div>
...
`),hf=b('<button bind="button" type="button"></button>'),pf=b('<th bind="cell"></th>'),ff=b('<tr bind="row"></tr>'),mf=b('<td bind="cell"><span bind="value"></span></td>'),gf=b(`
...
`);class vf extends N{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class xf extends N{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(B);render(){const e=this.wire(wf,{header:{className:()=>_s(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(kd,this.ref(e,"account")),this.spawn(Aa,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":un,"/history":Dd,"/round":oh,"/create":Lh,"/login":jh,"/friends":Vh,"/friend":Kh,"/friend-rounds":Yh,"/friend-courses":Jh,"/spectate":np,"/profile":lp,"/stats":xp,"/round-stats":Np,"/admin":Bp,...li.competitions?{"/competitions":Vp,"/competition":vf}:{}},un),e}}class $f extends D{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await rr(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await Ah()),this.error.set(null)}catch(e){e instanceof V&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Hh(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof V&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await Mh();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof V&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}q.get(Cr);const Vn=q.get(B);q.set(D,new $f);const Un=q.get(D);await Or(xf,"#app",{hot:void 0,onInit:async()=>{await Un.load(),Un.currentUser.get()&&Vn.route.get()==="/login"&&Vn.navigate("/",!0)}});export{ns as A,N as C,B as R,p as S,Cr as T,y as a,Ze as b,$ as c,vr as d,I as e,yr as n,M as r,b as t};
