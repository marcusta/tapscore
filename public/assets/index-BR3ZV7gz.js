...
`);class qn extends z{static styles=`
        .tabbar {
            display: flex;
...
`);class ii extends z{static styles=`
        .acct {
            position: relative;
            display: flex;
...
`),ls={not_started:"Not started",active:"Live",complete:"Finished"};class wt extends z{static styles=`
        .landing {
...
`);class yi extends z{static styles=`
        .history {
...
`);class Ki extends z{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
  ...
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${P(f.name)}</span>${u}</span></td>${y}`;const O=Ye(s.plan.slotDefId,g.ballIds),L=s.isOpen(O),C=mr(O),A=gs(x,s.routeSections,e,{mode:s.mode??"product"}),F=["lb-rank__row--expandable"];return f.lead&&F.push("lb-rank__lead"),L&&F.push("lb-rank__row--open"),`<tr class="${F.join(" ")}" data-expand-key="${P(O)}">
  <td class="lb-rank__pos">${f.position}</td>
...
<tr class="lb-rank__panel${L?" lb-rank__panel--open":""}" data-panel-key="${P(O)}">
...
`);class Sr extends z{static styles=`
        .lb {
...
`);class Er extends z{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${j()}
    ...
    `,ue.seq=0;let W=ue;function Pr(i){if(!i)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=i.seats.length>0,t=i.claimedSeats.some(r=>r.viewerMayRelease),s=i.viewer.claimSeat.allowed,n=i.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&n,blockedMessage:e&&!s&&!n?i.viewer.claimSeat.message??i.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Or(i,e){const t=[];if(i.groupId!==null&&e.length>0){const s=e.findIndex(n=>n.id===i.groupId);if(s>=0){t.push(`Group ${s+1}`);const n=e[s].startTime;n.includes(":")&&t.push(n)}}return i.category!==null&&t.push(i.category),t.join(" · ")}function zr(i){return(i?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Rr=_(`
...
`);class Dr extends z{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${j()}
...
`);class Br extends z{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${j()}
...
`);class Kr extends z{static styles=`
...
`),to=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),so=_('<button bind="pill" class="round-view__grp" type="button"></button>');class no extends z{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Io extends z{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class Oo extends z{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function At(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Lo extends z{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Mo extends z{static styles=`
        .profile {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),qo={not_started:"Not started",active:"Playing",complete:"Done"};function Ko(i){const e=[`${i.participants.length} players`,`${i.scoreEventCount} scores`];return i.lastEventAt?e.push(`last ${i.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Vo(i){const e=[`@${i.username}`,`${i.roundCount} rounds`];return i.lastRoundDate&&e.push(`last ${i.lastRoundDate}`),i.handicapIndex!==null&&e.push(`hcp ${i.handicapIndex}`),i.deletedAt&&e.push("DELETED"),e.join(" · ")}class Uo extends z{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Jo extends z{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Ca extends z{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
