(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const d of r.addedNodes)d.tagName==="LINK"&&d.rel==="modulepreload"&&n(d)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const oa="modulepreload",la=function(s){return"/tapscore/"+s},wn={},da=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(p=>Promise.resolve(p).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const d=document.querySelector("meta[property=csp-nonce]"),o=d?.nonce||d?.getAttribute("nonce");i=c(t.map(u=>{if(u=la(u),u in wn)return;wn[u]=!0;const p=u.endsWith(".css"),m=p?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=p?"stylesheet":oa,p||(h.as="script"),h.crossOrigin="",h.href=u,o&&h.setAttribute("nonce",o),document.head.appendChild(h),p)return new Promise((g,v)=>{h.addEventListener("load",g),h.addEventListener("error",()=>v(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(d){const o=new Event("vite:preloadError",{cancelable:!0});if(o.payload=d,window.dispatchEvent(o),!o.defaultPrevented)throw d}return i.then(d=>{for(const o of d||[])o.status==="rejected"&&r(o.reason);return e().catch(r)})},Hi="/tapscore/".replace(/\/+$/,""),Es=Hi+"/api",Kt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},ca=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Mi(s,e){const t={};for(const[n,i]of ca)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Ai=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],ua={thin:"1px",medium:"3px",thick:"5px"};function zi(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":ua[e.toLowerCase()]??e}function ha(){return Ai.map(s=>{const e=zi(Kt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Li={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Bi={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},pa={...Bi,"done-opacity":"0.35"},fa={...Li,...Bi,...Kt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},ma={...Li,...pa,...Kt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class ga{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Fi(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const ve=new ga;function Fi(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class f{constructor(e){this.subs=new Set,this.val=e}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,ve.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){ve.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,ve.notify(t.subs))})},deps:new Set};n.run()}get(){return ve.subscribe(this.subs),this.val}peek(){return this.val}}function I(s){const e={run(){ve.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Fi(e)}}function at(s){ve.batch(s)}function J(s){return ve.untrack(s)}class ba{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const U=new ba,Xe=Hi;function Ns(s){return Xe?s===Xe?"/":s.startsWith(Xe+"/")?s.slice(Xe.length):s:s}function _a(s){return Xe+s}class G{constructor(){this.route=new f(Ns(location.pathname??"/")),this.search=new f(location.search??""),window.addEventListener("popstate",()=>at(()=>{this.route.set(Ns(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",d=i>=0?e.slice(0,i):e,o=d.indexOf("?"),c=o>=0?d.slice(0,o):d,u=o>=0?d.slice(o+1):"",p=n.query!==void 0?ya(n.query):u?"?"+u:"",m=_a(c)+p+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",m),at(()=>{this.route.set(c),this.search.set(p)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const n=this.route.get().split("/"),i={};for(const[r,d]of t.entries())d.startsWith(":")&&(i[d.slice(1)]=n[r]??"");return i})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function ya(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function va(s){return e=>s[e]}const wa="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",xn="data-basics-global";function xa(){if(document.head.querySelector(`style[${xn}]`))return;const s=document.createElement("style");s.setAttribute(xn,""),s.textContent=ha()+wa,document.head.appendChild(s)}function $a(s,e){xa();const t=new Set(Ai),n=(r,d,o)=>{const c=Object.entries(r).map(([u,p])=>`--${u}:${t.has(u)?zi(p):p}`).join(";");return`${d}{color-scheme:${o};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const $n="basics-js-theme";class ka{constructor(){this.dark=new f(!1);const e=localStorage.getItem($n),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),I(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem($n,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function Sa(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const kn=new Set;class M{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!kn.has(t)){kn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return U.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=J(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){J(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(d=>this.track(d)),r=e.content.cloneNode(!0);for(const d of r.querySelectorAll("[bind]")){const o=t[d.getAttribute("bind")];if(o)if(typeof o=="function")i(I(()=>{const c=o();d instanceof HTMLInputElement||d instanceof HTMLTextAreaElement?d.value=String(c):d.textContent=String(c)}));else for(const[c,u]of Object.entries(o)){const p=c.includes("-");c.startsWith("on")&&typeof u=="function"?d.addEventListener(c.slice(2),u):typeof u=="function"?i(I(()=>{const m=u();p?d.setAttribute(c,String(m)):d[c]=m})):p?d.setAttribute(c,String(u)):d[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof M?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,d,...o)=>this.spawn(r,d,...o),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,d)=>d){const r=typeof t=="function"?t:()=>t.get(),d=new Map,o=new Map;this.track(()=>{for(const c of o.values())c.forEach(u=>u());o.clear()}),this.track(I(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const g=i(h,m);if(d.has(g))u.set(g,d.get(g));else{const v=[];u.set(g,J(()=>n(h,m,w=>v.push(w)))),o.set(g,v)}}for(const[m,h]of d)u.has(m)||(h.remove(),J(()=>o.get(m)?.forEach(g=>g())),o.delete(m));let p=e.firstChild;for(const m of u.values())m===p?p=p.nextSibling:e.insertBefore(m,p);d.clear();for(const[m,h]of u)d.set(m,h)}))}$condition(e,t,n,i){let r=null;this.track(I(()=>{r&&(r.remove(),r=null);const d=t.get();r=J(()=>d?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(I(()=>{if(r){const c=r;r=null,J(()=>c.destroy())}e.textContent="";const d=t.get(),o=n[d]??Sa(d,n)??i;o&&(r=J(()=>{const c=new o;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Et=new Set;function Ta(s){return Et.add(s),()=>Et.delete(s)}function Pa(){for(const s of Array.from(Et)){Et.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ia(s,e,t){const n=document.querySelector(e);n.textContent="";const i=U.get(G);let r=null,d=!1,o=null,c=!!t?.hot?.data.hmr;const u=async p=>{r&&(r.destroy(),r=null,n.textContent=""),p?(o||(o=(await da(()=>import("./obs-shell.component-CV3hsvUD.js"),[])).ObsShellComponent),r=J(()=>new o)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=J(()=>new s)),J(()=>r.mount(n)),d=p};await u(Ns(location.pathname).startsWith("/_obs")),I(()=>{const p=i.route.get().startsWith("/_obs");p!==d&&u(p)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(p){console.error("[startApp] the root component threw while disposing",p)}if(r=null,Pa(),t.onDispose)try{t.onDispose()}catch(p){console.error("[startApp] onDispose threw",p)}}),t.hot.accept())}class K extends Error{constructor(e,t,n,i){super(t),this.status=e,this.details=n,this.traceId=i,this.name="ApiError"}}const Ca=10,Pt=[];let It=[],st=null;function Ea(s){Pt.push(s),Pt.length>Ca&&Pt.shift()}function ji(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Pt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),It.push(n),Na()}function Na(){st||(st=setTimeout(Gi,5e3))}function Gi(){if(st&&(clearTimeout(st),st=null),It.length===0)return;const s=It;It=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Es}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Es}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Gi()});const Ra=3e4,Oa=2,gt=new Map,Di=new WeakMap;function Ha(s){if(s instanceof K)return s.traceId;if(s!=null&&typeof s=="object")return Di.get(s)}async function _(s){if(s.method==="GET"){const e=gt.get(s.url);if(e)return e;const t=Sn(s,Oa);return gt.set(s.url,t),t.then(()=>gt.delete(s.url),()=>gt.delete(s.url)),t}return Sn(s,0)}async function Sn(s,e){const t=s.timeout??Ra;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await Aa(Ma(s,r),t)}catch(d){if(n=d,!(d instanceof K)&&d!=null&&typeof d=="object"&&Di.set(d,r),d instanceof K||i===e)break;await new Promise(o=>setTimeout(o,1e3*2**i))}}throw n}async function Ma(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Ea({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const d=await i.json().catch(()=>({error:i.statusText}));throw new K(i.status,d.error??i.statusText,d.details,r)}return i.json()}function Aa(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Rs=new Set;let ds=!1;function za(s){return Rs.add(s),()=>{Rs.delete(s)}}function qi(){if(!ds){ds=!0;try{for(const s of[...Rs])try{s()}catch(e){try{ji("session-listener",La(e))}catch{}}}finally{ds=!1}}}function La(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function j(s,e,t,n={}){at(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=Ba(i);at(()=>{s.set(!1),e.set(r)}),ji(r.code,r.message,Ha(i)),r.code==="auth"&&n.sessionExpiry!==!1&&qi();return}}function Ba(s){return s instanceof K?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const cs={sessionExpiry:!1};function Fa(s){return{me:()=>_({method:"GET",url:`${s}/auth/me`}),login:e=>_({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>_({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>_({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class D{constructor(){this.api=Fa(Es),this.currentUser=new f(null),this.loading=new f(!1),this.error=new f(null),this.offSessionExpired=za(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Ta(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await j(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await j(this.loading,this.error,()=>this.api.login({username:e,password:t}),cs);return n?(this.currentUser.set(n),!0):!1}async logout(){await j(this.loading,this.error,()=>this.api.logout(),cs);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await j(this.loading,this.error,()=>this.api.logoutAll(),cs),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Vi={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},ja={...Vi,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},Ga={...Vi,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},Da=Mi(ja,fa),qa=Mi(Ga,ma),l=$a(Da,qa),L=s=>`var(--${s})`,C=(s,e)=>`var(--${s}, ${e})`,E=s=>{const e=Kt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},a=va({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),bt=s=>`
    ...
    cursor: not-allowed;`,Va={primary:bt("primary"),secondary:bt("secondary"),ghost:bt("ghost"),danger:bt("danger"),disabled:Ui},$=(s=C("btn-radius",E("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Va[e]}
    &:disabled {${Ui}}
`,Ua=`max(${C("field-border-width",E("field-border-width"))}, ${C("field-rule-width",E("field-rule-width"))})`,_t=(s,e)=>`
    border-top-color: ${s};
    ...
    border-bottom-width: ${Ua};
    ${_t(C("field-border",E("field-border")),C("field-rule",E("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${_t(C("field-focus-border",E("field-focus-border")),C("field-focus-border",E("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${_t(C("field-invalid-border",E("field-invalid-border")),C("field-invalid-rule",E("field-invalid-rule")))}
    }
...
`);class Ro extends M{static styles=`
        .dock {
    ...
    `;router=this.inject(G);auth=this.inject(D);landing=this.inject(Xt);newCount=new k(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Eo,{bar:{className:()=>Pn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return Co(r)?Pn(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Po(Yi),n=Math.ceil(t.length/2),i=(r,d)=>this.wireEl(No,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const o=this.newCount.get();return o===0?"":String(o)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},d);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,d,o)=>i(r,o),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,d,o)=>i(r,o),r=>r.key),e}}const Xi=["tee","approach","putting","shortGame","penalties","recovery"],Ct={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function Qi(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Oo(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Ho="Track statistics",Mo="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function Ji(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Nt(s,e){return s[e]}function Ao(s,e){if(!s.enabled)return!0;const t=Ji(e);return t===null?!1:!Nt(s,t)}function zo(s,e){if(!s.enabled)return null;const t=Ji(e);return t===null||Nt(s,t)?null:`Needs ${Qi(t)}`}function Lo(s,e,t){return Fo({...s,[e]:t})}function Bo(s,e){return{...s,enabled:e}}function Fo(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function hs(s){const e={...Ct,enabled:s.enabled};for(const t of Xi)e[t]=s[t];return e}function jo(s){return s.avatarVersion?`${q}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function Go(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(vt(t[0])+vt(t[t.length-1])).toUpperCase();if(t.length===1)return vt(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?vt(n).toUpperCase():"•"}function vt(s){return[...s][0]??""}const wt=512,Do=2*1024*1024;function qo(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Vo=.85;class Je extends Error{}async function Uo(s){let e;try{e=await createImageBitmap(s)}catch{throw new Je("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=qo(e.width,e.height),r=document.createElement("canvas");r.width=wt,r.height=wt;const d=r.getContext("2d");if(!d)throw new Je("This browser cannot process images.");d.drawImage(e,t,n,i,i,0,0,wt,wt);const o=await new Promise(c=>r.toBlob(c,"image/jpeg",Vo));if(!o)throw new Je("That image could not be processed.");if(o.size>Do)throw new Je("That image is too large.");return o}finally{e.close()}}async function Ko(s){const e=await fetch(`${q}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await Zi(e);return await e.json()}async function Wo(){const s=await fetch(`${q}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await Zi(s)}async function Zi(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new K(t,Yo(e.error,s.status))}function Yo(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Se{loading=new f(!1);error=new f(null);player=new f(null);history=new f([]);clubs=new f([]);saving=new f(!1);saveError=new f(null);statsConfig=new f(Ct);statsSaving=new f(!1);statsError=new f(null);hasRecordedStats=new f(!1);avatarSaving=new f(!1);avatarError=new f(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await j(this.loading,this.error,()=>Promise.all([y.players.me(),y.players.myHandicapHistory(),y.clubs.list(),y.playerStats.myConfig().catch(()=>null),y.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,d,o]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.statsConfig.set(d?hs(d):Ct),this.hasRecordedStats.set((o?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Ct),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return await j(this.saving,this.saveError,()=>y.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async confirmHandicap(){const e=await j(this.saving,this.saveError,()=>y.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){const t=await j(this.saving,this.saveError,()=>y.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await j(this.saving,this.saveError,()=>y.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await j(this.statsSaving,this.statsError,()=>y.playerStats.putMyConfig(hs(e)));return t?(this.statsConfig.set(hs(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await Uo(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof Je?i.message:"That image could not be prepared."}),!1}const n=await j(this.avatarSaving,this.avatarError,()=>Ko(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await j(this.avatarSaving,this.avatarError,()=>Wo().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function xt(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function ps(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Rt(s,e="frecency"){return e==="alpha"?[...s].sort(ps):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,d=i>0,o=r>0;if(d!==o)return d?-1:1;if(!d)return ps(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,p=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==p?m-p:ps(t,n)})}const Xo=1440*60*1e3;function Qo(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/Xo);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function Jo(s,e){if(s.sharedRoundCount<=0)return"never played";const t=Qo(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function Zo(s){return s.isMutual?null:"hasn't added you back"}const er=2;function In(s){return s.trim().length>=er}function tr(s){return Rt(s,"frecency")}function el(s,e){return tr([...s.filter(t=>t.id!==e.id),e])}function tl(s,e){return s.filter(t=>t.id!==e)}function Cn(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function sl(s,e,t=()=>{},n=300){let i=0,r;return d=>{const o=d.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,o.length<er){e(o,[]);return}r=setTimeout(()=>{s(o).then(u=>{c===i&&e(o,u)},u=>{c===i&&t(o,u)})},n)}}const sr=Ke("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function nl(s=W()){return sr.read(s)}function il(s,e=W()){sr.write(s,e)}class Qt{loading=new f(!1);error=new f(null);friends=new f([]);loaded=new f(!1);sortMode=new f(nl());query=new f("");searching=new f(!1);searchError=new f(null);results=new f([]);resultsFor=new f("");mutating=new f(!1);mutateError=new f(null);runSearch=sl(e=>y.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await j(this.loading,this.error,()=>y.friends.list());t&&(this.friends.set(tr(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await j(this.mutating,this.mutateError,()=>y.friends.add({friendId:e.id}))&&(this.friends.set(el(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Cn(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),il(e)}async remove(e){await j(this.mutating,this.mutateError,()=>y.friends.remove({friendId:e}))&&(this.friends.set(tl(this.friends.get(),e)),this.results.set(Cn(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class Ws{feed=new f(null);loading=new f(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await y.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function Ze(s,e){return s instanceof K&&s.status===401?(qi(),"Your session expired — sign in again."):e}function Ot(s){return s===0?"E":s>0?`+${s}`:`${s}`}function rl(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${Ot(s.scoreToPar)}`}function nr(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function ir(s){return(s.courseName??"").trim()||null}function al(s){const e=[];for(const t of s){const n=t.friends[0],i=nr(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:ir(t),progress:rl(n)})}return e}function ol(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function ll(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function dl(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function cl(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${Ot(s.scoreToPar)}`}function ul(s){const e=[];for(const t of s){const n=t.friends[0],i=nr(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:ir(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function rr(s){if(s instanceof K){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const qe={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function hl(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function pl(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function fl(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${Ot(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${Ot(s.scoreToPar)}`}}}function ml(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function gl(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function bl(s){return s===1?"1 course played":`${s} courses played`}const fs={rounds:[],nextCursor:null,hasMore:!1};function En(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function ar(s){return s.hasMore&&s.nextCursor!==null}class Jt{playerId=new f(null);unavailable=new f(null);profile=new f(null);profileLoading=new f(!1);profileError=new f(null);profileLoaded=!1;rounds=new f(fs);roundsLoaded=new f(!1);roundsLoading=new f(!1);loadingMore=new f(!1);roundsError=new f(null);roundsGeneration=0;courses=new f([]);coursesHasMore=new f(!1);coursesLoaded=new f(!1);coursesLoading=new f(!1);coursesError=new f(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await y.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(Ze(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await y.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(En(fs,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ze(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!ar(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await y.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(En(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(Ze(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await y.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(Ze(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=rr(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(fs),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function or(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function _l(s){return Math.round(or(s))}function yl(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),d=i-r*n,o=r+(e>n-d?1:0);return o===0?0:-o}function vl(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function me(){return vl()}const Oe=10;class Ve{loading=new f(!1);error=new f(null);descriptors=new f([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await j(this.loading,this.error,()=>y.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=me()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=me()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=me()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=me()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=me()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,d=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==d?r-d:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=me()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Oe:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const Nn=["scramble","foursomes","greensomes"];class wl{loading=new f(!1);error=new f(null);descriptors=new f([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof y.setup?.formations=="function")return this.inFlight=(async()=>{const e=await j(this.loading,this.error,()=>y.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=Nn.indexOf(n);return i===-1?Nn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=me()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const xl=180,Rn=4,$l=12;function Ge(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function kl(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<$l)return 0;const i=e+t*xl,r=Math.round(-i/n);return Math.max(-Rn,Math.min(Rn,r))}const On="tapscore:pending-scores:v1",Sl=336*60*60*1e3,Hn=200;function Tl(){try{return globalThis.localStorage??null}catch{return null}}function Pl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Il{entries=[];storage;constructor(e=Tl(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Sl);return t.length>Hn?t.slice(t.length-Hn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(On);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Pl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(On,JSON.stringify(this.entries))}catch{}}}const ye=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","putts","penalties","penalty_source"],Cl={minPar:4},El={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Missed where",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},Nl={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Around the green"}]}};function Os(s){return El[s]}function Mn(s){return Nl[s]}function Rl(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function lr(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function Ol(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function Hl(s,e,t){return e-t<=s-2?"1":"0"}function Hs(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class Ml{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=An(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=An(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!Ol(this.par,this.strokes,e)?null:Hl(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Hs(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of ye)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Hs(this).state};`,e}get prompts(){const e=[];for(const t of ye)this.isVisible(t)&&e.push({key:t,label:Os(t),control:Mn(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&lr(Cl,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune())}step(e,t){const n=Mn(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<ye.length;e++){let t=!1;for(const n of ye){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),Al(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of ye){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function Al(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function An(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of ye){const n=s[t];n!==void 0&&e.set(t,n)}return e}const zn="tapscore:pending-stat-events:v1",zl=336*60*60*1e3,Ln=500;function Ll(){try{return globalThis.localStorage??null}catch{return null}}function Bl(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function Fl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&ye.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class jl{entries=[];storage;makeId;constructor(e=Ll(),t=Date.now(),n=Bl){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const d=[];for(const o of i){const c={token:e,playHoleId:t,playerId:n,key:o.key,value:o.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(p=>p.token===e&&p.playHoleId===t&&p.playerId===n&&p.key===o.key);u>=0?this.entries[u]=c:this.entries.push(c),d.push(c)}return this.entries=this.applyHygiene(r),this.persist(),d}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=zl);return t.length>Ln?t.slice(t.length-Ln):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(zn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Fl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(zn,JSON.stringify(this.entries))}catch{}}}const Gl=50;function Dl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const Ys=Ke("tapscore.result-cursors.v1",qs(Dl),Gl);function Xs(s=W()){return Ys.read(s)}function ql(s,e=W()){return Xs(e).find(t=>t.token===s)?.cursor??null}function Vl(s,e,t=W()){if(!t)return[];const n=Xs(t).filter(i=>i.token!==s);return Ys.write([{token:s,cursor:e},...n],t)}function Ul(s,e=W()){if(!e)return[];const t=Xs(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&Ys.write(n,e),n}const Kl=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Ie=(s,e)=>`${s}|${e}`;function Qs(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function Wl(s,e,t){return lr(s,e,t)}function ms(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Yl(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function Xl(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class fe{constructor(e=new Il,t=new jl){this.queue=e,this.statQueue=t}queue;statQueue;loading=new f(!1);error=new f(null);friendlyRound=new f(null);round=new f(null);startList=new f(null);balls=new f([]);firstOpen=new f(!1);firstOpenRoundId=null;scorecards=new f([]);cells=new f(new Map);statModules=new f(new Map);statRows=new f([]);statRev=new f(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new f(null);resultLoading=new f(!1);resultError=new f(null);resultCursor=null;holeIdx=new f(0);groupIdx=new f(0);keypadOpen=new f(!1);finishFlowOpen=new f(!1);selectedSlot=new f(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),U.get(Ve).load();const r=await j(this.loading,this.error,()=>y.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),Qe({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!_o(r.round.id))),U.get(D).currentUser.get()&&yo(r.round.id),this.pendingSlotIndex!==null){const m=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,m!==null&&this.selectedSlot.set(m)}const[d,o,c,u]=await Promise.all([y.friendlyRounds.balls({token:e}).catch(()=>[]),y.friendlyRounds.scorecard({token:e}).catch(()=>[]),y.playerStats.configsByToken({token:e}).catch(()=>null),y.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(p=>[p.playerId,p.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(o),this.balls.set(d),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new f(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await y.friendlyRounds.remove({token:e}),Wi(e);const t=this.round.get()?.id;return t&&Ki(t),Ul(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new f(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await y.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await y.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),Qe({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await j(this.resultLoading,this.resultError,()=>y.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await y.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await y.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const d=await y.friendlyRounds.balls({token:e}).catch(()=>null);if(d===null||i())return;this.balls.set(d)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?ql(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&Vl(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await y.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),Qe({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Qs(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new k(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(d=>n.subjectLabels?.some(o=>o.ballId===d&&o.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const d=r.entries.find(o=>i(o.ballIds));if(!d)continue;return d.total===null?null:d.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-d.paceDelta:d.paceDelta}:{kind:"total",total:d.total}}if(r.kind==="match_summary"){const d=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!d)continue;if(d.thru===0&&!d.finished)return null;const o=i(d.sideA.ballIds)?"a":"b";if(d.leader===null||d.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=d.leader===o;return{kind:"match",text:`${d.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Ge(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(d=>d.id===e);if(!t||!n)return"";const i=t.playHoles.filter(d=>d.courseHoleNumber===n.courseHoleNumber).sort((d,o)=>d.ordinal-o.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(d=>d.id===e);return`${n.courseHoleNumber} (${Kl[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Ge(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Ge(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(d=>{const o=n.get(d.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return o?.strokes===null||o===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Ie(e,t));return n?n.strokes:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Ie(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const d=this.playHoleById(t);if(!d)return null;const o=i.players[0]?.teeName??null,c=d.tees.find(u=>u.teeName===o)?.strokeIndex??d.baseStrokeIndex;return yl(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Hs(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new Ml(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Yl(t):new Map;for(const i of ye){const r=ms(e,i);if(!this.statLocal.has(r))continue;const d=this.statLocal.get(r)??null;d===null?n.delete(i):n.set(i,d)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=ms(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=ms({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await y.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return Xl(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Ie(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=U.get(Ve),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const d=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const o of d)i.has(o.key)||(i.add(o.key),n.push(o))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Wl(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Ie(e,t),d=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:d});const o=this.token;o&&(this.enqueue(o,e,t,n,i,d),await this.post(o,e,t,n,i,d))}async retry(e,t){const n=Ie(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Ie(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,d){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,d){const o=Ie(t,n);try{await y.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:d,...r!=null?{metadata:r}:{}}),this.queue.remove(d);const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(o);c&&c.clientEventId===d&&this.patchCell(o,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class dr{roundId=new f(null);view=new f(null);balls=new f([]);loading=new f(!1);error=new f(null);unavailable=new f(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await y.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=rr(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(Ze(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await y.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new k(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Qs(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new k(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class cr{roles=new f([]);rolesPromise=null;loading=new f(!1);error=new f(null);stats=new f(null);rounds=new f([]);players=new f([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await y.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await j(this.loading,this.error,()=>Promise.all([y.admin.adminStats(),y.admin.adminRounds({limit:100}),y.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const Ql=["last5","last10","last20","thisYear","all","custom"];function Ht(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function Jl(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function Js(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const nt={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function Zl(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function ed(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function gs(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function td(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function Zt(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function ur(s){return`${s.getFullYear()}-`}function hr(s,e,t,n){const i=Zt(t);switch(s){case"last5":case"last10":case"last20":{const r=Js(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=ur(n);return i.filter(d=>d.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>ed(e,r))}}function pr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const d=Js(e);return d===null?!1:n.length<d}case"thisYear":{const d=`${ur(r)}01-01`;return!n.some(o=>o.date<d)}case"all":return!0;case"custom":{if(Zl(t))return!1;if(t.from===null)return!0;const d=t.from;return!n.some(o=>o.date<d)}}}const sd="Unnamed course";function nd(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??sd,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Mt="last10";function id(s){return Ql.includes(s)}const fr=Ke("tapscore.stats.window.v1",{decode:s=>id(s)?s:Mt,encode:s=>s,empty:Mt});function Ms(s=W()){return fr.read(s)}function Bn(s,e=W()){fr.write(s,e)}function x(s,e){return{value:e===0?null:s/e,n:s,d:e}}const ot=5;function Le(s,e=ot){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const At=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0});function rd(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker}}function ad(s){let e=At;for(const t of s)e=rd(e,t);return e}const Me=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function Zs(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function od(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function ld(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function mr(s){return x(s.fairwayHits,s.teeRecorded)}function dd(s){return x(s.troubleCount,s.teeRecorded)}function cd(s){return x(s.holesWithPenalty,s.penaltiesRecorded)}function ud(s){return{penalty:x(s.strokesVsParPenalty,s.holesScoredPenalty),clean:x(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function hd(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return x(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function pd(s){return x(s.recoverySuccesses,s.recoveryAttempts)}function fd(s,e){return x(s.penaltiesTotal,e)}function md(s){return{fairway:x(s.strokesVsParFairway,s.holesScoredFairway),inPlay:x(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:x(s.strokesVsParTrouble,s.holesScoredTrouble)}}function gd(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return x(e,s.holesScoredTrouble*s.holesScoredFairway)}function gr(s){return x(s.girHits,s.girRecorded)}function bd(s){return{fairway:x(s.girHitsFairway,s.girRecordedFairway),inPlay:x(s.girHitsInPlay,s.girRecordedInPlay),trouble:x(s.girHitsTrouble,s.girRecordedTrouble)}}function _d(s){return{par3:x(s.girHitsPar3,s.girRecordedPar3),par4:x(s.girHitsPar4,s.girRecordedPar4),par5:x(s.girHitsPar5,s.girRecordedPar5)}}function yd(s){const e=x(s.strokesVsParGirHit,s.girHolesScored),t=x(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:x(n,s.holesScoredGirMiss*s.girHolesScored)}}function vd(s,e){return x(ld(s,e),s.girFirstPuttRecorded)}function wd(s){let e=0;for(const t of Me)e+=Zs(s,t);return e}function xd(s,e){return x(Zs(s,e),wd(s))}function $d(s){return x(s.birdiesOnGir,s.girHolesScored)}function kd(s){return x(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Sd(s){const e=s.greenMissRecorded;return{long:x(s.greenMissLong,e),short:x(s.greenMissShort,e),left:x(s.greenMissLeft,e),right:x(s.greenMissRight,e)}}function Td(s){return{left:x(s.teeMissLeft,s.teeMissRecorded),right:x(s.teeMissRight,s.teeMissRecorded),troubleLeft:x(s.teeTroubleLeft,s.teeMissLeft),troubleRight:x(s.teeTroubleRight,s.teeMissRight)}}function Pd(s){const e=s.penaltySourceRecorded;return{tee:x(s.penaltiesTee,e),approach:x(s.penaltiesApproach,e),short:x(s.penaltiesShort,e)}}function Id(s,e){return x(od(s,e),Zs(s,e))}function Cd(s){return x(s.threePutts,s.puttsRecorded)}function Ed(s){const e=s.puttsRecorded;return{zero:x(s.holesZeroPutt,e),one:x(s.holesOnePutt,e),two:x(s.holesTwoPutt,e),threePlus:x(s.threePutts,e)}}function Nd(s){return{par3:x(s.puttsTotalPar3,s.puttsRecordedPar3),par4:x(s.puttsTotalPar4,s.puttsRecordedPar4),par5:x(s.puttsTotalPar5,s.puttsRecordedPar5)}}function Rd(s){return x(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function Od(s){return x(s.puttsTotalGir,s.puttsRecordedGir)}function Hd(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return x(e,t)}function br(s){return{standard:x(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:x(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:x(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function Md(s){return x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function Ad(s){return x(s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function zd(s){return x(s.holesMultiChipBunker,s.scrambleAttemptsBunker)}function Ld(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Bd(s){return{standard:x(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:x(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:x(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:x(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function Fd(s){return{par3:x(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:x(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:x(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function jd(s,e){return x(s.doubleBogeyPlus,e)}function Gd(s){return x(s.bounceBackSuccesses,s.bounceBackOpportunities)}const Dd=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],qd=18;function Vd(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let p=r.get(c.holeCount);if(p||(p={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,p)),p.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;p.completeRounds+=1;const h=u.strokesTotal-u.parTotal;(p.best===null||h<p.best.vsPar)&&(p.best={vsPar:h,strokes:u.strokesTotal})}const d=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let o=0;for(const c of d)o+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:o,lengths:d,avgVsParPer18:x(n*qd,t),scoreTypeCounts:i}}const en=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),_r=Object.freeze({inside2m:1.25,outside2m:2.12}),yr=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),vr=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Ud=["scratch","hcp5","hcp12","hcp20"];function tn(s){return s===null?"hcp12":s<2.5?"scratch":s<8.5?"hcp5":s<16?"hcp12":"hcp20"}function Kd(s){return Math.round(4*s.eHole[3]+10*s.eHole[4]+4*s.eHole[5])}const Wd=Object.freeze({version:"v1-provisional-scratch",calibratedAt:null,eHole:Object.freeze({3:3.25,4:4.15,5:4.85}),eAfterTee:Object.freeze({4:Object.freeze({fairway:2.95,in_play:3.25,trouble:3.7}),5:Object.freeze({fairway:3.65,in_play:3.95,trouble:4.4})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Yd=Object.freeze({version:"v1-provisional-hcp5",calibratedAt:null,eHole:Object.freeze({3:3.4,4:4.45,5:5.1}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.2,in_play:3.6,trouble:4.05}),5:Object.freeze({fairway:3.9,in_play:4.25,trouble:4.55})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Xd=Object.freeze({version:"v1-provisional-hcp20",calibratedAt:null,eHole:Object.freeze({3:3.9,4:5.1,5:5.9}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.85,in_play:4.2,trouble:4.85}),5:Object.freeze({fairway:4.65,in_play:5,trouble:5.65})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Qd=Object.freeze({inside_1m:1.02,"1_to_2m":1.35,"2_to_4m":1.72,"4_to_8m":1.95,over_8m:2.2}),Jd=Object.freeze({inside_1m:1.03,"1_to_2m":1.4,"2_to_4m":1.78,"4_to_8m":2.02,over_8m:2.3}),Zd=Object.freeze({inside_1m:1.08,"1_to_2m":1.5,"2_to_4m":1.92,"4_to_8m":2.2,over_8m:2.55}),ec=Object.freeze({inside2m:1.19,outside2m:1.96}),tc=Object.freeze({inside2m:1.22,outside2m:2.03}),sc=Object.freeze({inside2m:1.29,outside2m:2.22}),nc=Object.freeze({standard:1.55,hard:1.9,bunker:1.75}),ic=Object.freeze({standard:1.62,hard:2,bunker:1.85}),rc=Object.freeze({standard:1.8,hard:2.25,bunker:2.08}),pt=Object.freeze({scratch:Object.freeze({tables:Wd,expected:Qd,chipOutcome:ec,chipBaseline:nc}),hcp5:Object.freeze({tables:Yd,expected:Jd,chipOutcome:tc,chipBaseline:ic}),hcp12:Object.freeze({tables:vr,expected:en,chipOutcome:_r,chipBaseline:yr}),hcp20:Object.freeze({tables:Xd,expected:Zd,chipOutcome:sc,chipBaseline:rc})}),ft=pt.hcp12,de=["tee","approach","shortGame","putting","penalties"];function wr(s,e=vr,t=en,n=_r,i=yr){const r=s.attHolesPar3Gir+s.attHolesPar3Miss,d=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,o=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,c=r+d+o,u={attributed:c,holesScored:s.holesScored};if(c===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const p=d+o,m=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,h=s.attMissStandard+s.attMissHard+s.attMissBunker,g=r*e.eHole[3]+d*e.eHole[4]+o*e.eHole[5],w=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+r*e.eHole[3],T=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m,R=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,z=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,V=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),O=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),Y=s.attStrokes-s.attPutts-s.attPenalties-p-m+T+V-w,ae=m-h+R-z,oe=s.attPutts-(T+R),ra=s.attPenalties,aa=s.attStrokes-g;return{tee:O,approach:Y,shortGame:ae,putting:oe,penalties:ra,total:aa,coverage:u}}function zt(s,e=ft){return wr(s,e.tables,e.expected,e.chipOutcome,e.chipBaseline)}const xr=9;function xe(s,e){return $r(s,Ue(s,e))}function Fn(s){return $r(s,s.total)}function $r(s,e){return e===null||s.coverage.attributed<xr?null:e*18/s.coverage.attributed}function Ue(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function kr(s,e){const t=n=>jn(xe(s,n),e.map(i=>xe(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:jn(Fn(s),e.map(Fn))}}function sn(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function nn(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function jn(s,e){if(s===null)return null;const t=nn(e);return t===null?null:s-t}function ac(s){return s.penalties}const Gn=1,oc=2,lc=.75,dc=4,cc=3,uc=12,hc=5,pc=2,fc=10,Dn=.35;function mc(s,e,t,n){const i=kr(e,t),r=[];let d=0;const o=(T,R)=>{r.push({line:T,magnitude:R,order:d++})};let c=null,u=null;for(const T of de){const R=sn(i,T);R!==null&&((c===null||R<c.delta)&&(c={component:T,delta:R}),(u===null||R>u.delta)&&(u={component:T,delta:R}))}c!==null&&c.delta<=-Gn&&o({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=Gn&&o({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const p=nn(t.map(ac)),m=e.penalties;p!==null&&m!==null&&m>=p+oc&&o({id:"penalties_spike",params:{penalties:m,baseline:p}},0),s.teeMissRecorded>=fc&&s.teeMissLeft>=Dn*s.teeMissRecorded&&s.teeMissRight>=Dn*s.teeMissRecorded&&o({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=cc&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&o({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const h=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,g=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;h>=dc&&g>=lc*h&&o({id:"scramble_streak",params:{successes:g,attempts:h}},0),s.threePutts===0&&s.puttsTotal>=uc&&o({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const v=xe(e,"putting"),w=t.map(T=>xe(T,"putting")).filter(T=>T!==null);return v!==null&&w.length>=hc&&w.every(T=>v<T)&&o({id:"best_putting_round",params:{putting:v,rounds:w.length}},0),s.bounceBackOpportunities>=pc&&s.bounceBackSuccesses===s.bounceBackOpportunities&&o({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((T,R)=>R.magnitude-T.magnitude||T.order-R.order),r.slice(0,Math.max(0,n)).map(T=>T.line)}const Sr=["auto",...Ud],As="auto";function Lt(s){switch(s){case"scratch":return"Scratch";case"hcp5":return"5 handicap";case"hcp12":return"12 handicap";case"hcp20":return"20+ handicap"}}function qn(s){return s==="auto"?"Match my handicap":Lt(s)}function gc(s,e){return s!=="auto"?`About ${Kd(pt[s].tables)} shots on a par 72.`:e===null?`No handicap on your profile yet, so this uses the ${Lt("hcp12")} reference.`:`Your ${rn(e)} handicap puts you on the ${Lt(tn(e))} reference.`}function rn(s){return s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}function an(s,e){return s==="auto"?tn(e):s}const bc=Object.freeze({cohort:tn(null),choice:As,handicapIndex:null});function _c(s,e){return{cohort:an(s,e),choice:s,handicapIndex:e}}function yc(s){return Sr.includes(s)}const Tr=Ke("tapscore.stats.sgBaseline.v1",{decode:s=>yc(s)?s:As,encode:s=>s,empty:As});function zs(s=W()){return Tr.read(s)}function vc(s,e=W()){Tr.write(s,e)}const Vn=Object.freeze(Object.keys(At));function wc(s){if(typeof s!="object"||s===null)return[...Vn];const e=s;return Vn.filter(t=>typeof e[t]!="number")}function Bt(s){if(s.length===0)return null;const e=wc(s[0].measures);if(e.length===0)return null;const t=e.slice(0,3).join(", "),n=e.length>3?` and ${e.length-3} more`:"";return`The server sent stats this app does not understand (missing ${t}${n}).`}const xc=["tee","approach","putting","shortGame","scoring"];function $c(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const kc=3,Pr={rounds:[],totals:At,waterfall:wr(At),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function on(s,e=ft){const t=Zt(s);if(t.length===0)return Pr;const n=ad(t.map(d=>d.measures)),i=t.map(d=>zt(d.measures,e)),r=t.length;return{rounds:t.map((d,o)=>{const c=i[o];return{id:d.roundId,date:d.date,courseName:d.courseName,name:d.name,holeCount:d.holeCount,strokes:d.measures.holesScored===0?null:d.measures.strokesTotal,vsPar:d.measures.holesScored===0?null:d.measures.strokesTotal-d.measures.parTotal,waterfall:c}}),totals:n,waterfall:zt(n,e),priorities:Sc(i),trends:Tc(t,e),tee:Pc(n,r),approach:Ic(n),putting:Cc(n),shortGame:Ec(n),scoring:Nc(n,r),results:Vd(t)}}function Sc(s){const e=de.map(n=>{const i=s.map(r=>xe(r,n));return{component:n,per18:nn(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>de.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function bs(s){return Le(s)==="percentage"?s.value:null}function Tc(s,e=ft){const t=[...s].reverse(),n=(i,r,d,o)=>{const c=[];for(const u of t){const p=o(u.measures);p!==null&&c.push(p)}return c.length>=kc?{id:i,title:r,kind:d,points:c}:null};return[n("fairway","Fairways","percentage",i=>bs(mr(i))),n("gir","Greens","percentage",i=>bs(gr(i))),n("putting","Putting","strokesLost",i=>xe(zt(i,e),"putting")),n("scramble","Scrambling","percentage",i=>bs(br(i).overall))].filter(i=>i!==null)}function Pc(s,e){return s.teeRecorded<=0?null:{fairway:mr(s),inPlayOnly:x(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:dd(s),troubleTax:gd(s),vsParByTee:md(s),recovery:pd(s),teeMiss:Td(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:fd(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:cd(s),penaltyTax:hd(s),vsParByPenalty:ud(s),penaltySource:Pd(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function Ic(s){if(s.girRecorded<=0)return null;const e={};for(const t of Me)e[t]=vd(s,t);return{gir:gr(s),girByTee:bd(s),girFirstPuttMix:e,birdieConversion:$d(s),hardChipShare:kd(s),girByPar:_d(s),greenMiss:Sd(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:yd(s)}}function Cc(s){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const e={};for(const t of Me)e[t]=xd(s,t);return{ladder:Me.map(t=>({bucket:t,made:Id(s,t),baseline:Math.max(0,2-en[t])})),firstPuttSpread:e,threePutt:Cd(s),threePuttsFromOver8m:Rd(s),puttsPerGirHole:Od(s),puttsAfterMissedGreen:Hd(s),puttDistribution:Ed(s),puttsPerHoleByPar:Nd(s)}}function Ec(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:br(s),chipInside2m:Bd(s),conversionInside2m:x(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:Md(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,multiChip:Ad(s),multiChipBunker:zd(s),extraShortGameStrokes:Ld(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded}}function Nc(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:Fd(s),doubleBogeyPlusPerRound:jd(s,e),bounceBack:Gd(s)}}function Ir(s){let e=0;for(const t of s)for(const n of de){const i=Ue(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Rc(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function ln(s){const e=U.get(Ve);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function Oc(s){const e=U.get(Ve);return e.load(),e.labelOf(s)??s}function Hc(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:fo(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(ln).join(" · ")}))}function Mc(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function lt(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Ft(s){return s.courseName?lt(s)===s.courseName?null:s.courseName:null}function ze(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const it={fromMyRounds:Hc,fromDeviceRounds:Mc};function ce(s){switch(Le(s)){case"absent":return null;case"fraction":return`${Z(s.n)} of ${Z(s.d)}`;case"percentage":return s.value===null?null:`${Math.round(s.value*100)}%`}}function Ac(s){return Le(s)!=="percentage"?null:`${Z(s.n)} of ${Z(s.d)}`}function se(s){const e=ce(s);if(e===null)return null;const t=Ac(s);return t===null?e:`${e} (${t})`}function dt(s,e=2,t=!1){return Le(s)==="absent"||s.value===null?null:t?Te(s.value,e):$e(s.value,e)}function es(s){return{one:s,many:`${s}s`}}const be=es("round"),le=es("hole"),Ls=es("green"),dn="thin sample";function Cr(s,e){switch(Le(s)){case"absent":return null;case"fraction":return`over ${ee(s.d,e)} — ${dn}`;case"percentage":return`over ${ee(s.d,e)}`}}function re(s,e){const t=dt(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=Cr(s,e.unit);return i===null?n:`${n} (${i})`}const zc={one:"hole from trouble",many:"holes from trouble"},Lc={one:"from the fairway",many:"from the fairway"};function Bc(s){const e=s.trouble.d,t=s.fairway.d;if(e<=0||t<=0)return null;const n=`over ${ee(e,zc)} vs ${ee(t,Lc)}`;return e<ot||t<ot?`${n} — ${dn}`:n}function Er(s,e,t,n){if(s.d<=0||t.d<=0)return null;const i=`over ${ee(s.d,e)} vs ${ee(t.d,n)}`;return s.d<ot||t.d<ot?`${i} — ${dn}`:i}const Fc={one:"hole with the green missed",many:"holes with the green missed"},jc={one:"green hit",many:"greens hit"},Gc={one:"hole with a penalty",many:"holes with a penalty"},Dc={one:"without",many:"without"},qc=es("penalty hole");function Vc(s){return Er(s.miss,Fc,s.hit,jc)}function Uc(s){return Er(s.penalty,Gc,s.clean,Dc)}function Kc(s){return Le(s)==="fraction"}function Z(s){return s===Math.round(s)?String(Math.round(s)):$e(s,1)}function ee(s,e){return`${Z(s)} ${s===1?e.one:e.many}`}function $e(s,e=1){return s.toFixed(e)}function Te(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return $e(0,e);const i=$e(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function Wc(s){return`${Te(s)} per 18`}function ts(s){return s===0?"E":Te(s,s===Math.round(s)?0:1)}function ss(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function _s(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function Yc(s){return s==="indoor"?"Indoor":"Outdoor"}function Xc(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Nr(s){return ze(s)}const Rr="Statistics",Qc="All statistics →";function Jc(s){return s==="custom"?Mt:s}function Zc(s,e,t){return Js(s)!==null||!t?Ht(s):`${Ht(s)} — newest ${e}`}function eu(s){return x(s.strokesTotal-s.parTotal,s.holesScored)}function tu(s){const e=[],t=eu(s.totals),n=dt(t,2,!0);if(n!==null){const c=Le(t)==="fraction"?Cr(t,le):null;e.push({id:"vsPar",value:n,label:"Vs par per hole",note:c})}const i=s.tee,r=i===null?null:ce(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit",note:null});const d=s.approach,o=d===null?null:ce(d.gir);return o!==null&&e.push({id:"gir",value:o,label:"Greens in regulation",note:null}),e}function su(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${ss(e.component)}`}function nu(s){const e=Jc(s.preset),t=hr(e,nt,s.rows,s.now);if(t.length===0)return null;const n=on(t,s.bundle??ft),i=tu(n);if(i.length===0)return null;const r=pr({preset:e,filter:nt,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:Zc(e,t.length,r),tiles:i,priorityLine:su(n)}}function iu(s){const e=s.tiles.map(n=>n.note===null?`${n.label} ${n.value}`:`${n.label} ${n.value}, ${n.note}`),t=[`${Rr}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class ns{static PAGE_SIZE=20;rows=new f(null);hasMore=new f(!1);preset=new f(Ms());sgChoice=new f(zs());profile=U.get(Se);loaded=!1;loading=!1;card=new k(()=>{const e=this.rows.get();if(e===null)return null;const t=an(this.sgChoice.get(),this.profile.player.get()?.handicapIndex??null);return nu({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date,bundle:pt[t]})});refreshPreset(){this.preset.set(Ms()),this.sgChoice.set(zs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await y.playerStats.myStats({limit:ns.PAGE_SIZE});if(Bt(t.rounds)!==null)return;this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof K&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const yn=class yn extends M{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(I(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};yn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let ie=vn;async function ru(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const au="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Pe(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function we(s){const e=()=>jo(s());return{avatarPhoto:{src:()=>e()??au,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return Go(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Ae(s,e="0.85rem"){return`
        position: relative;
    ...
    `}function ou(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function lu(s){return ou(s).map(e=>e.kind)}function Un(s){return s.signedIn?"avatar":"signin"}const du=b(`
...
`);class cu extends M{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),_u='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',cn=`
...
`,yu=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${cn}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${_u}</button>
...
`),xu=b(`
    <button bind="row" type="button" class="round-summary recent-row">
        ${Pe("recent-row__avatar")}
        <span class="recent-row__content">${cn}</span>
    </button>
`);class Wn extends M{static styles=`
        .landing {
...
`),Su='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Tu=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${cn}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Su}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
    </div>
`);class Pu extends M{static styles=`
        .history {
...
`),un='<button bind="infoTrigger" class="stats__info" type="button"></button>',hn=`
...
`,Ce=60,Xn=8,Fs=4,Hu=Array.from({length:Fs*2+1},(s,e)=>e-Fs),Mu="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Au=b(`
...
`),Gu=b('<button bind="btn" class="se-seg" type="button"></button>'),Du=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),qu=b('<div bind="rule" class="se-stats__rule"></div>');class Vu extends M{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Xn}px; flex-shrink: 0; }
            & .se-row__slot { width: ${Ce}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
...
</tr>`;if(!R||!z)return`<tr class="${g.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${F(g.name)}</span>${w}</span></td>${T}
  <td class="lb-rank__disclosure"></td>
</tr>`;const V=js(n.plan.slotDefId,R.ballIds),O=n.isOpen(V),Y=fh(V),ae=Fr(z,n.routeSections,e,{mode:n.mode??"product"}),oe=["lb-rank__row--expandable"];return g.lead&&oe.push("lb-rank__lead"),O&&oe.push("lb-rank__row--open"),`<tr class="${oe.join(" ")}" data-expand-key="${F(V)}">
  <td class="lb-rank__pos">${g.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${O}" aria-controls="${F(Y)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${F(g.name)}</span>${w}</span></button></td>${T}
...
<tr class="lb-rank__panel${O?" lb-rank__panel--open":""}" data-panel-key="${F(V)}">
  <td class="lb-rank__panelcell" colspan="${o}"><div class="lb-rank__panelwrap" id="${F(Y)}"><div class="lb-rank__panelbox">${ae}</div></div></td>
</tr>`}).join(""),u=r?`
...
</div>`}function gh(s,e){const t=th(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",d=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const bh={ranked:mh,match_summary:(s,e)=>gh(s,e)},_h={"default-score-grid":ch,"compact-match-grid":uh,"category-matrix-grid":hh};function yh(s){return`<div class="lb-diag">Unrenderable result section <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function vh(s){return`<div class="lb-diag">Unsupported score-grid component <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function wh(s,e,t,n=null){const i=bh[s.kind];return i?i(s,e,t,n):yh(s.kind)}function Fr(s,e,t,n){const i=zr(s),r=_h[i];return r?r(s,e,t,n):vh(i)}function jr(s,e,t=Br,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${F(s.formatLabel)}.</div>`:s.leaderboard.map(r=>wh(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${F(s.formatLabel)}.</div>`}function Gr(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>Fr(r,e,t,{mode:i})).join(`
`)}const xh=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class gn extends M{static styles=`
        .lb {
    ...
    `;svc=this.inject(fe);expansion=new ih;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(xh,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const p=this.svc.nameOf(u);return this.svc.isPending(u)?`${p} (open seat)`:p},i=u=>this.svc.groupLabelOf(u),r=nh(t);this.expansion.retain(r.attached.keys());const d=jr(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),o=Gr(r.standalone,e.routeSections,n),c=o?`<h3 class="lb-cards__head">Scorecard</h3>${o}`:"";return d+c}}function $h(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const kh=b(`
...
`);class Th extends M{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `,rt.seq=0;let ue=rt;function Ih(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Ch(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Eh(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Nh=b(`
...
`);class Hh extends M{static styles=`
        .seat-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
...
`);class Bh extends M{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${N()}
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(G);tokenQ=this.router.query("token");joining=new f(!1);error=new f("");diagnostics=new f([]);teeId=new f("");tees=new f([]);loadedForCourseId=null;groupChoice=new f("");policyState(){return Ah(this.svc.startList.get())}eligible(){return this.policyState().visible&&Mh(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,y.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await y.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof K&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(I(()=>this.ensureTeesLoaded()));const e=new k(()=>zh(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(I(()=>{const r=e.get(),d=this.groupChoice.get();(!d||!r.options.some(o=>o.value===d&&!o.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Lh,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new ue({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new ue({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const ti=1440*60*1e3;function Fh(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>ti?!0:e-t>=ti}function jh(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function Gh(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!jh(s.balls,s.playerId)||!Fh(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function _e(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Gt(s){return s<0?`+${String(-s)}`:String(s)}const Dh=b(`
...
`);class qh extends M{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${N()}
    ...
    `;svc=this.inject(fe);auth=this.inject(D);profile=this.inject(Se);settled=new f(!1);editing=new f(!1);text=new f("");busy=new f(!1);error=new f("");state(){const e=this.profile.player.get();return Gh({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Gt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=_e(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(I(()=>this.ensureProfileLoaded())),this.wire(Dh,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Gt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function Vh(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const Uh=b(`
...
`);class Kh extends M{static styles=`
...
`);class ip extends M{static styles=`
    ...
    `;svc=this.inject(fe);auth=this.inject(D);router=this.inject(G);stage=new f("prompt");error=new f("");render(){this.track(I(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(np,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>Yh(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(gn,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=Vr(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return Wh({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return Dr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:qr({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class He{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new f(!1);error=new f(null);loaded=new f(!1);loadedRounds=new f([]);roundsWithStats=new f(null);hasMore=new f(!1);preset=new f(Ms());filter=new f(nt);sgChoice=new f(zs());profile=U.get(Se);handicapIndex=new k(()=>this.profile.player.get()?.handicapIndex??null);sgCohort=new k(()=>an(this.sgChoice.get(),this.handicapIndex.get()));sgBundle=new k(()=>pt[this.sgCohort.get()]);sgInfo=new k(()=>_c(this.sgChoice.get(),this.handicapIndex.get()));extending=new f(!1);extendError=new f(null);pagesFetched=0;cursor=null;windowRounds=new k(()=>hr(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new k(()=>on(this.windowRounds.get(),this.sgBundle.get()));courses=new k(()=>nd(this.loadedRounds.get()));overFiltered=new k(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await j(this.loading,this.error,()=>y.playerStats.myStats({limit:He.PAGE_SIZE}));if(!t)return;const n=Bt(t.rounds);if(n!==null){this.error.set({code:"server",message:n});return}this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded()}select(e){this.preset.set(e),Bn(e),this.extendIfNeeded()}selectSgBaseline(e){this.sgChoice.set(e),vc(e)}async loadHandicap(){await this.profile.load()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),Bn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(nt),this.select(Mt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<He.MAX_PAGES&&pr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await y.playerStats.myStats({limit:He.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}const n=Bt(t.rounds);if(n!==null){this.extendError.set({code:"server",message:n});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=He.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(nt),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class ut{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new f("idle");failure=new f(null);roundId=new f(null);holes=new f([]);round=new f(null);history=new f([]);dashboard=U.get(He);inFlight=null;sgInfo=this.dashboard.sgInfo;model=new k(()=>{const e=this.round.get();return e===null?null:ep({round:e,holes:this.holes.get(),history:this.history.get(),bundle:this.dashboard.sgBundle.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.dashboard.loadHandicap(),this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await y.playerStats.myRoundStats({roundId:e})}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(ii(d)),this.failure.set(ri(d));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(d){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(ii(d)),this.failure.set(ri(d));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(d=>d.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(d=>d.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=d=>{for(const o of d)n.has(o.roundId)||(n.add(o.roundId),t.push(o))};if(i(this.dashboard.loadedRounds.get()),si(t,e,Gs))return t;let r=null;for(let d=0;d<ut.MAX_PAGES;d++){const o=await y.playerStats.myStats({limit:ut.PAGE_SIZE,cursor:r??void 0}),c=Bt(o.rounds);if(c!==null)throw new Error(c);if(i(o.rounds),si(t,e,Gs)||o.nextCursor===null)return t;r=o.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function ii(s){if(s instanceof K){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function ri(s){return s instanceof K&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const te=100;function as(s){return s>0?"loss":s<0?"gain":"zero"}function We(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function H(s){return String(Math.round(s*1e3)/1e3)}function os(s){return s<0?0:s>1?1:s}function ke(s,e){return`<svg class="chart" viewBox="0 0 ${te} ${H(s)}" preserveAspectRatio="none" style="height:${H(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function bn(s,e,t,n=1){return`<path d="M${H(s)} 0 L${H(s)} ${H(e)}" stroke="${t}" stroke-width="${H(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function pe(s,e,t,n,i){return`<rect x="${H(s)}" y="${H(e)}" width="${H(t)}" height="${H(n)}" fill="${i}"/>`}const rp=1;function ap(s,e){const t=te/2,n=as(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:rp,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function Ur(s,e,t,n=10){const i=ap(s,e),r=i.bar&&i.bar.width>0?pe(i.bar.x,0,i.bar.width,n,We(i.tone,t)):"";return ke(n,[pe(0,0,te,n,t.track),r,bn(i.zeroX,n,t.rule)].join(""))}function op(s){const e=[];let t=0;for(const n of s){const i=te*os(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function lp(s,e,t=12){const n=op(s).filter(i=>i.width>0).map(i=>pe(i.x,0,i.width,t,i.color)).join("");return ke(t,pe(0,0,te,t,e.track)+n)}const ai=2,dp=1e-4;function cp(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=ai,d=Math.max(0,e-ai*2);return s.map((o,c)=>({x:s.length===1?te/2:c/(s.length-1)*te,y:i===0?e/2:r+d-(o-t)/i*d}))}function up(s){return s.map((e,t)=>`${t===0?"M":"L"}${H(e.x)} ${H(e.y)}`).join(" ")}function hp(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=dp?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function pp(s,e,t,n=34){const i=cp(s,n);if(i.length===0)return ke(n,"");const r=We(hp(s,e),t),d=`<path d="${up(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,o=i[i.length-1],c=`<path d="M${H(o.x)} ${H(o.y)} L${H(o.x)} ${H(o.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(n,d+c)}const fp=.5;function mp(s,e,t=12){const n=te/2,i=de.length-1,r=Math.max(1,(t-i)/de.length),d=[];return de.forEach((o,c)=>{const u=Ue(s,o);if(u===null||!(e>0))return;const p=Math.max(u===0?0:fp,n*Math.min(1,Math.abs(u)/e));d.push({component:o,x:u>=0?n:n-p,y:c*(r+1),width:p,height:r,tone:as(u)})}),d}function gp(s,e,t,n=12){const i=mp(s,e,n).filter(r=>r.width>0).map(r=>pe(r.x,r.y,r.width,r.height,We(r.tone,t))).join("");return ke(n,bn(te/2,n,t.rule)+i)}const Kr=1,oi=.02;function bp(s,e){const t=e>0?te*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=os(s),i=e<=0?"neutral":s>e+oi?"gain":s<e-oi?"loss":"neutral";return{bar:{width:Math.max(Kr,te*n),tone:i},tickX:t}}function _p(s,e,t,n=10){const i=bp(s,e),r=i.bar?pe(0,0,i.bar.width,n,We(i.bar.tone,t)):"",d=i.tickX===null?"":bn(i.tickX,n,t.rule,2);return ke(n,pe(0,0,te,n,t.track)+r+d)}function yp(s){return s===null?null:Math.max(Kr,te*os(s))}function Wr(s,e,t=e.neutral,n=8){const i=yp(s),r=i===null?"":pe(0,0,i,n,t);return ke(n,pe(0,0,te,n,e.track)+r)}const li=100,Dt=50,vp=16,$t=22,di=44,wp=3,xp=33,$p={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function tt(s,e){const t=(s-90)*Math.PI/180;return{x:Dt+e*Math.cos(t),y:Dt+e*Math.sin(t)}}function ci(s,e,t,n){const i=e-s>180?1:0,r=tt(s,n),d=tt(e,n),o=tt(e,t),c=tt(s,t);return`M${H(r.x)} ${H(r.y)} A${H(n)} ${H(n)} 0 ${i} 1 ${H(d.x)} ${H(d.y)} L${H(o.x)} ${H(o.y)} A${H(t)} ${H(t)} 0 ${i} 0 ${H(c.x)} ${H(c.y)} Z`}function kp(s){const e=Math.max(s.long,s.short,s.left,s.right),t=wp/2,n=[];for(const i of["long","right","short","left"]){const r=$p[i],d=r.from+t,o=r.to-t,c=e>0?os(s[i]/e):0,u=$t+(di-$t)*c,p=tt((r.from+r.to)/2,xp);n.push({id:i,trackPath:ci(d,o,$t,di),valuePath:ci(d,o,$t,u),labelX:p.x,labelY:p.y})}return n}function Sp(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${H(Dt)}" cy="${H(Dt)}" r="${H(vp)}" fill="${t.track}"/>`+s.map(r=>`<text x="${H(r.labelX)}" y="${H(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${li} ${li}" preserveAspectRatio="xMidYMid meet" style="width:${H(n)}px;height:${H(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const Tp=60,qt=58,Pp=2,Ip={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function Cp(s,e){const t=qt-Pp,n=d=>e>0?d/e*t:0,i=[],r=(d,o)=>{const c=Ip[d];let u=qt;for(const p of o){const m=n(p.count);u-=m,i.push({id:p.id,column:d,tone:p.tone,x:c.x,y:u,width:c.width,height:m})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function Ep(s,e,t){const n=s.filter(i=>i.height>0).map(i=>pe(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${H(qt)} L${H(te)} ${H(qt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return ke(Tp,n)}const ls={gain:l("accent-strong"),loss:l("danger"),zero:l("border-strong"),neutral:l("accent"),track:l("surface-sunken"),rule:l("border")},S={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",filterBaseline:"Compared to",filterBaselineHint:"Which player the strokes-gained rows measure you against. It does not change which rounds are in the window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate the expected-putts table implies. For 4–8 m and over 8 m it sits at zero: the table expects two putts from there, so any make is ahead of it.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",sandSave:"Missed greens from a bunker where you still got up and down.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",multiChipBunker:"Bunker holes that took more than one shot to get out.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function je(s){return Kc(s)?null:s.value}function X(s,e,t){return{kind:"bar",id:s,title:e,share:je(t),value:ce(t)}}function B(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}function Np(s,e){switch(s){case"tee":{const t=e.tee&&se(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&se(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?re(e.putting.puttsPerGirHole,{unit:Ls,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&se(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?re(e.scoring.doubleBogeyPlusPerRound,{unit:be,label:"doubles or worse per round"}):null}}function Rp(s){const e=Bc(s.vsParByTee),t=e?`${S.troubleTax} Measured ${e}.`:S.troubleTax;return B("troubleTax","Trouble tax",dt(s.troubleTax,2,!0),t)}function ui(s){return s===null?null:`Measured ${s}.`}function ks(s){return re(s,{unit:le,signed:!0})}function Op(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>ce(i)??"",n=(i,r)=>`${i} ${ce(r)??S.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:kp(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function Hp(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:Cp(e,s.teeRecorded),text:[`Left ${Z(e.leftInPlay+e.leftTrouble)}`,`Fairway ${Z(e.fairway)}`,`Right ${Z(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function Mp(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function hi(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:je(t.fairway),value:ce(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:je(t.inPlayOnly),value:ce(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:je(t.trouble),value:ce(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:S.teeFanHead},Hp(t),{kind:"note",id:"teeFanNote",text:S.teeFan}]:[],...Mp(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},{kind:"note",id:"vsParByTeeNote",text:S.vsParByTee},B("vsParFairway","From the fairway",ks(t.vsParByTee.fairway)),B("vsParInPlay","From in play",ks(t.vsParByTee.inPlay)),B("vsParTrouble","From trouble",ks(t.vsParByTee.trouble))]:[],Rp(t),B("recovery","Recovery",se(t.recovery),S.recovery),...t.penaltiesRecordedHoles>0?[B("penalties","Penalties",re(t.penaltiesPerRound,{unit:be}),`${S.penalties} Recorded on ${ee(t.penaltiesRecordedHoles,le)}.`),B("penaltyHoleShare","Holes with a penalty",se(t.penaltyHoleShare)),B("penaltyTax","Penalty tax",dt(t.penaltyTax,2,!0),ui(Uc(t.vsParByPenalty)))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:S.greenMissHead},Op(t),{kind:"note",id:"greenMissNote",text:S.greenMiss}]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},X("girFairway","From the fairway",t.girByTee.fairway),X("girInPlay","From in play",t.girByTee.inPlay),X("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},X("girPar3","Par 3",t.girByPar.par3),X("girPar4","Par 4",t.girByPar.par4),X("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"First putt on greens hit"},{kind:"note",id:"mixNote",text:S.proximityProxy},...Me.map(n=>X(`mix-${n}`,_s(n),t.girFirstPuttMix[n])),B("birdieConversion","Birdie conversion",se(t.birdieConversion),S.birdieConversion),...t.hardChipShare.d>0?[B("hardChipShare","Hard misses",se(t.hardChipShare),S.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},B("vsParGreenHit","Green hit",re(t.costOfMissedGreen.hit,{unit:Ls,signed:!0})),B("vsParGreenMissed","Green missed",re(t.costOfMissedGreen.miss,{unit:le,signed:!0})),B("missedGreenTax","Missed-green tax",dt(t.costOfMissedGreen.delta,2,!0),ui(Vc(t.costOfMissedGreen)))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[Me[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},{kind:"note",id:"firstPuttNote",text:S.firstPuttSpread},...Me.map(n=>X(`spread-${n}`,_s(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"note",id:"ladderNote",text:S.ladderBaseline},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:_s(n.bucket),made:je(n.made),baseline:n.baseline,value:ce(n.made)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},X("putts-zero","No putts",t.puttDistribution.zero),X("putts-one","One putt",t.puttDistribution.one),X("putts-two","Two putts",t.puttDistribution.two),X("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],B("threePutt","Three-putts",se(t.threePutt),S.threePutt),B("longThreePutt","Three-putts from over 8 m",se(t.threePuttsFromOver8m),S.longThreePutt),B("puttsPerGir","Putts per green hit",re(t.puttsPerGirHole,{unit:Ls}),S.puttsPerGir),...t.puttsAfterMissedGreen.d>0?[B("puttsAfterMissedGreen","Putts after a missed green",re(t.puttsAfterMissedGreen,{unit:le}),S.puttsAfterMissedGreen)]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},B("puttsPar3","Par 3",re(t.puttsPerHoleByPar.par3,{unit:le})),B("puttsPar4","Par 4",re(t.puttsPerHoleByPar.par4,{unit:le})),B("puttsPar5","Par 5",re(t.puttsPerHoleByPar.par5,{unit:le}))]:[]]:[]}case"shortGame":{const t=e.shortGame;return t?[{kind:"subhead",id:"scrambleHead",text:"Scrambling"},X("scrambleStandard","Standard",t.scramble.standard),X("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[X("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[B("sandSave","Sand save",se(t.sandSave),S.sandSave)]:[],...t.shortGameStrokesRecorded>0?[B("multiChipBunker","More than one from sand",se(t.multiChipBunker),S.multiChipBunker),B("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes),S.extraShortGameStrokes),B("multiChip","More than one chip",se(t.multiChip),S.multiChip)]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},X("chipStandard","Standard",t.chipInside2m.standard),X("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[X("chipBunker","Bunker",t.chipInside2m.bunker)]:[],B("conversionInside2m","Holed from inside 2 m",se(t.conversionInside2m),S.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},{kind:"note",id:"chipInsNote",text:S.chipIns},B("chipInsStandard","Standard",Z(t.chipIns.standard)),B("chipInsHard","Hard",Z(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[B("chipInsBunker","Bunker",Z(t.chipIns.bunker))]:[]]:[]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>re(i,{unit:le,signed:!0});return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},B("par3","Par 3",n(t.avgVsParByParGroup.par3)),B("par4","Par 4",n(t.avgVsParByParGroup.par4)),B("par5","Par 5",n(t.avgVsParByParGroup.par5)),B("doubles","Doubles or worse",re(t.doubleBogeyPlusPerRound,{unit:be}),S.doubleBogeyPlus),B("bounceBack","Bounce-back",se(t.bounceBack),S.bounceBack)]}}}function Ap(s){if(!s||s.rounds===0)return"";const e=ee(s.rounds,be),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${ee(t.holeCount,le)}`;const n=s.lengths.map(i=>`${Z(i.rounds)} × ${ee(i.holeCount,le)}`).join(", ");return`${e} — ${n}`}function zp(s){return s===18?"Best 18":s===9?"Best 9":`Best ${Z(s)} holes`}const Lp=18;function Bp(s){const e=s.lengths.some(i=>i.holeCount!==Lp),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${ee(s.holesScored,le)}`;return e?`${n}, scaled to 18`:n}function Ss(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:Te(s.avgVsParPer18.value,1),qualifier:Bp(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:zp(t.holeCount),value:ts(n.vsPar),qualifier:`${Z(n.strokes)} strokes`,hero:!1})}return e}function Fp(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function kt(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return Dd.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:Fp(t),share:je(x(n,e)),value:ce(x(n,e))??Z(n)}})}function jp(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function pi(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const ge={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s,e){const t=s?.baseline??bc,n=e===void 0?pt[t.cohort].tables.calibratedAt:e,i=`under “${S.filterBaseline}” in Filters`,r=Lt(t.cohort),d=t.choice!=="auto"?`Measured against the ${r} reference — you picked this ${i}.`:t.handicapIndex===null?`Measured against the ${r} reference — no handicap on your profile yet. Change it ${i}.`:`Measured against the ${r} reference — matched to your ${rn(t.handicapIndex)} handicap. Change it ${i}.`,o="Each tier is one set of expected scores per hole and per lie.";return n===null?`${d} ${o} The tiers are still provisional, so treat the order of the rows as the reading and the sizes as rough.`:`${d} ${o} This tier was frozen on ${n}. Everyone on this reference is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${xr} attributed holes is left out of the comparison entirely.`},total(s){const e=Gp(s.rowsPer18);if(e===null)return null;const t=Te(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${ee(e.recorded,qc)} you labelled, ${Z(e.tee)} came off the tee, ${Z(e.approach)} on the approach and ${Z(e.short)} around the green.`}};function Gp(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function Vt(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Ut(s){const e=[{id:"holes",title:"Holes counted",body:ge.holesCounted(s)},{id:"rows",title:"The five rows",body:ge.fiveRows()},{id:"baseline",title:"The baseline",body:ge.baseline(s)},{id:"per18",title:"Per 18 holes",body:ge.per18()}],t=ge.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=ge.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:S.penaltySourceInfoTitle,body:n}),e}const Q={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},fi={title:"Your round",seeWholeRound:"See the whole round"};function Dp(s){const e=[Nr(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function Yr(s,e){return s===null?null:e===null?String(s):`${s} (${ts(e)})`}function qp(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function Vp(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function Up(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${ts(s.vsPar)})`}function Kp(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function Wp(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function Yp(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function Xp(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function _n(s){const e=[],t=Up(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:Kp(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:Wp(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:Yp(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Qp(s){return s===null?[]:_n(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function mi(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(Xp(s.marker).toLowerCase())):e.push("no score");for(const t of _n(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function Xr(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=$e(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function gi(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function Ts(s,e=1){return typeof s=="number"?$e(Math.abs(s),e):""}function Ee(s){return typeof s=="number"?String(Math.round(s)):""}function bi(s){return typeof s=="string"?s:"tee"}function Jp(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${gi(bi(e.component))} was ${Ts(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${gi(bi(e.component))} cost you ${Ts(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${Ts(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Ee(e.left)} left and ${Ee(e.right)} right of ${Ee(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Ee(e.successes)} of the ${Ee(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Ee(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Ee(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Zp=b(`
...
${hn}
    `;round=this.inject(fe);stats=this.inject(ut);auth=this.inject(D);router=this.inject(G);colors=ls;infoOpen=new f(!1);render(){this.track(I(()=>{const i=this.eligibleRoundId();J(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Zp,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>fi.title,score:()=>{const i=e();return i===null?"":Yr(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>fi.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ue(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...de],(i,r,d)=>this.wireEl(tf,{label:()=>ss(i),amount:{textContent:()=>{const o=n(i);return o===null?S.notRecorded:Te(o)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const o=n(i);return o===null?"":`color:${We(as(o),this.colors)}`}}},d),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Ut({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(r=>xe(i.waterfall,r)),penaltySource:Vt(i.panels.totals),baseline:this.stats.sgInfo.get()})},(i,r,d)=>this.wireEl(rs,{ctitle:()=>i.title,ctext:()=>i.body},d),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,d)=>this.wireEl(ef,{text:()=>Jp(i)},d),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:Dr({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:qr({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return Q.waterfallHint;let t=null;for(const n of de){const i=sn(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?Q.waterfallHint:Xr(t,e.windowCount)}}function _i(s){return!(!s.pageVisible||s.status==="complete")}function nf(s,e){return e&&!s}const rf=2,yi=3,af=75e3;function of(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${q}/friendly-rounds/events?${t.toString()}`}function lf(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function df(s){const e=s.eventSourceFactory??(z=>new EventSource(z)),t=s.setTimer??((z,V)=>setTimeout(z,V)),n=s.clearTimer??(z=>clearTimeout(z)),i=s.livenessTimeoutMs??af,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let d=!1,o=0,c=null,u=null,p=s.since??null;const m=()=>{u!==null&&(n(u),u=null)},h=()=>{m(),u=t(T,i)},g=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},v=()=>{d=!0,m(),g()},w=()=>{if(g(),++o>=yi){v(),s.onDegrade();return}R()};function T(){if(!d){if(!r()){h();return}w()}}function R(){if(d)return;let z;try{z=e(of(s.token,p))}catch{v(),s.onDegrade();return}c=z,z.onopen=()=>{o=0},z.onmessage=V=>{if(d||c!==z)return;h();let O;try{O=JSON.parse(V.data)}catch{return}lf(O)&&(O.latestEventId!==null&&(p=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},z.onerror=()=>{d||c!==z||(z.readyState===rf||++o>=yi)&&(v(),s.onDegrade())},h()}return R(),{stop:()=>{d||v()}}}const cf=2e4;function uf(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const hf=b(`
...
`),pf=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),ff=b('<button bind="pill" class="round-view__grp" type="button"></button>');class mf extends M{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Df extends M{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class Yf extends M{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`),Qf='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',Jf=b(`
    <div class="friend-row">
        ${Pe("friend-row__badge")}
...
`),Ii=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Qf}</button>
    </div>
`);class Zf extends M{static styles=`
        .friends {
    ...
    `;svc=this.inject(Qt);auth=this.inject(D);router=this.inject(G);removeOpen=new f(!1);removeTarget=new f(null);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Xf,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:r=>this.svc.setQuery(r.target.value)},searchHint:{textContent:()=>{const r=this.svc.query.get().trim();return r.length>0&&!In(r)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const r=this.svc.query.get().trim();return In(r)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===r&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&xt(this.svc.friends.get()).mutual.length===0?"friends__empty":"friends__empty hidden"},connectionsSection:{className:()=>xt(this.svc.friends.get()).addedByMe.length>0?"friends__section":"friends__section hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(r,d,o)=>this.wireEl(Jf,{...we(()=>this.svc.results.get().find(c=>c.id===r.id)??r),name:()=>r.displayName,username:()=>r.homeClubName?`@${r.username} · ${r.homeClubName}`:`@${r.username}`,hcp:()=>r.handicapIndex===null?"–":r.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(r.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const c=this.svc.results.get().find(u=>u.id===r.id);c&&!c.isFriend&&this.svc.add(c)}},added:{className:()=>this.isFriendNow(r.id)?"friend-row__added":"friend-row__added hidden"}},o),r=>r.id);const n=new Date().toISOString();this.$each(this.ref(t,"friends"),()=>Rt(xt(this.svc.friends.get()).mutual,this.svc.sortMode.get()),(r,d,o)=>this.wireEl(Ii,this.friendRowBindings(r,n),o),r=>r.id),this.$each(this.ref(t,"connections"),()=>Rt(xt(this.svc.friends.get()).addedByMe,this.svc.sortMode.get()),(r,d,o)=>this.wireEl(Ii,this.friendRowBindings(r,n),o),r=>r.id),this.spawn(ie,this.ref(t,"removeConfirmHost"),{open:this.removeOpen,title:()=>{const r=this.removeTarget.get();return r?`Remove ${r.displayName} from friends?`:"Remove friend?"},message:()=>{const r=this.removeTarget.get();return r?`${r.displayName} will disappear from your friends list. You can add them again later.`:"They will disappear from your friends list. You can add them again later."},confirmLabel:"Remove friend",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.removeTarget.get();r&&this.svc.remove(r.id)}});const i=r=>{r.key==="Escape"&&this.removeOpen.get()&&this.removeOpen.set(!1)};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),t}liveFriend(e){return this.svc.friends.get().find(t=>t.id===e.id)??e}askRemove(e){const t=this.liveFriend(e);this.removeTarget.set({id:t.id,displayName:t.displayName}),this.removeOpen.set(!0)}friendRowBindings(e,t){return{...we(()=>this.svc.friends.get().find(n=>n.id===e.id)??e),open:{disabled:()=>!this.liveFriend(e).isMutual,onclick:()=>{const n=this.liveFriend(e);n.isMutual&&this.router.navigate("/friend",{query:{id:e.id,name:n.displayName}})}},name:()=>e.displayName,subtitle:()=>Jo(this.liveFriend(e),t),connection:()=>Zo(this.liveFriend(e))??"",hcp:()=>e.handicapIndex===null?"–":e.handicapIndex.toFixed(1),remove:{"aria-label":()=>`Remove ${this.liveFriend(e).displayName} from friends`,title:()=>`Remove ${this.liveFriend(e).displayName} from friends`,disabled:()=>this.svc.mutating.get()||this.removeOpen.get(),onclick:()=>this.askRemove(e)}}}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Zr=b(`
...
`);function ea(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>hl(s),subtitle:()=>pl(s,ze),progress:()=>fl(s)}}function ta(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class tm extends M{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Jt);activity=this.inject(Ws);auth=this.inject(D);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const h=e.get();J(()=>{!h||!n()||(this.svc.setPlayer(h),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",d=new k(()=>{const h=e.get();return h?dl(this.activity.feed.get(),h):null}),o=()=>this.svc.unavailable.get(),c=()=>n()&&o()===null&&i()!==null,u=()=>n()&&o()===null&&i()===null,p=h=>this.router.navigate("/spectate",{query:{id:h,name:i()?.player.displayName??r()}}),m=this.wire(em,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>u()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&o()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const h=o();return h?qe[h].title:""}},refusalMsg:{textContent:()=>{const h=o();return h?qe[h].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...we(()=>{const h=i();return h?h.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const h=i()?.player.username;return h?`@${h}`:""}},identity:{textContent:()=>{const h=i();return h?ml(h.player.handicapIndex,h.player.homeClubName)??"":""}},live:{className:()=>d.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const h=d.get();return h?cl(h):""},onclick:()=>{const h=d.get();h&&p(h.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>bl(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(m,"recentList"),()=>i()?.recentRounds??[],(h,g,v)=>this.wireEl(Zr,ea(h,p),v),h=>h.roundId),m}}const sm=b(`
    <div class="frounds">
...
`);class am extends M{static styles=`
        .fcourses {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(Jt);auth=this.inject(D);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();J(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],d=()=>(t.get()??"").trim(),o=this.wire(im,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:d()}})},subtitle:{textContent:()=>{const c=d();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?qe[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?qe[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(d())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(o,"list"),r,(c,u,p)=>this.wireEl(rm,{name:()=>c.courseName??"Course",facts:()=>gl(c,ze)},p),c=>c.courseId),o}}function om(s,e,t){const n=ht(e);if(n){const o=Ei(s);return o?`Watching · ${o} ${n}`:`Watching · ${n}`}const i=Ei(s)??"this",r=ht(t),d=r?` at ${r}`:"";return`Watching · ${i} round${d}`}function lm(s,e,t,n){const i=ht(s)===null?null:ht(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const dm="You're watching this round. Only its players can enter scores.",Ci={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Ei(s){const e=ht(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function ht(s){return(s??"").trim()||null}const cm=b(`
    <div class="spectate">
...
`);class um extends M{static styles=`
        ...
        ${gn.styles}
    `;svc=this.inject(dr);auth=this.inject(D);router=this.inject(G);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(I(()=>{const c=e.get();J(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),d=()=>(t.get()??"").trim()||null;return this.wire(cm,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(d()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Ci[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Ci[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?om(d(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?lm(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>ze(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const d=i.length>1?`<h2 class="spectate__slot-head">${hm(r.formatLabel)}</h2>`:"",o=jr(r,t,n),c=Gr(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return d+o+u}).join("")}}function hm(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const pm=b(`
    <div class="profile">
...
`),_m=b('<h3 bind="text" class="block__subhead"></h3>'),ym=b('<p bind="text" class="block__note"></p>'),vm=b(`
...
`),Tm=b('<div bind="panels" class="statspanels"></div>');class sa extends M{static styles=`
        .statspanels {
            display: flex; flex-direction: column; gap: ${a("sm")};
...
`);class Hm extends M{static styles=`
        .stats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${hn}
    `;svc=this.inject(He);auth=this.inject(D);router=this.inject(G);filterOpen=new f(!1);prioritiesInfoOpen=new f(!1);colors=ls;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&(this.svc.load(),this.svc.loadHandicap());const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(Pm,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>S.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>S.filterClear,onclick:()=>this.svc.clearFilter()},sgLabel:()=>S.filterBaseline,sgWhat:()=>S.filterBaselineHint,sgHint:()=>gc(this.svc.sgChoice.get(),this.svc.handicapIndex.get()),empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>Ap(t().results),resultsCard:{className:()=>Ss(t().results).length===0&&kt(t().results).length===0?"results hidden":"results"},histHead:()=>kt(t().results).length===0?"":S.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>S.prioritiesHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>S.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>S.roundsHint,pickHint:()=>n()?S.filterRoundsHint:""});return this.setHeading(i,"resultsSec",S.resultsHeading),this.setHeading(i,"prioritiesSec",S.priorities),this.setHeading(i,"trendsSec",S.trends),this.setHeading(i,"roundsSec",S.roundsHeading),this.mountPicker(i),this.mountBaselinePicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>Ss(t().results),(r,d,o)=>this.wireEl(Cm,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},o),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>kt(t().results),(r,d,o)=>this.wireEl(Em,{title:()=>r.title,bar:{innerHTML:()=>Wr((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},o),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,d,o)=>this.wireEl(Nm,{title:()=>ss(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":Ur(c.per18,Rc(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?Wc(c.per18):S.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.per18===null?jp(c.roundsInWindow):`over ${ee(c.roundsCovered,be)}`:""}}},o),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Ut({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:Vt(t().totals),baseline:this.svc.sgInfo.get()}),(r,d,o)=>this.wireEl(rs,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},o),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,d,o)=>this.wireEl(Rm,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return pp(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return Mm(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ee(c.points.length,be)}}},o),r=>r.id),this.spawn(sa,this.ref(i,"panels"),{model:t}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,d,o)=>this.wireEl(Om,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${pi(r)} — hole by hole`},label:()=>pi(r),subtitle:()=>Am(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(td(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return gp(c.waterfall,Ir(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":ts(c.vsPar)}}},o),r=>r.id),i}mountPicker(e){const t=new f(this.svc.preset.get());this.track(I(()=>t.set(this.svc.preset.get()))),this.track(I(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Ht(r)} — ${Jl(r)}`}),i=new ue({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Ht("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountBaselinePicker(e){const t=new f(this.svc.sgChoice.get());this.track(I(()=>t.set(this.svc.sgChoice.get()))),this.track(I(()=>{const i=t.get();queueMicrotask(()=>{i!==this.svc.sgChoice.get()&&this.svc.selectSgBaseline(i)})}));const n=new ue({value:t,options:Sr.map(i=>({value:i,label:qn(i)})),placeholder:qn("auto")});n.mount(this.ref(e,"sgPicker")),this.track(()=>n.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,d)=>this.wireEl(Ni,{chip:{textContent:()=>Yc(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(gs(this.svc.filter.get(),"venueTypes",i))}},d),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,d)=>this.wireEl(Ni,{chip:{textContent:()=>Xc(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(gs(this.svc.filter.get(),"roundTypes",i))}},d),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,d)=>this.wireEl(Im,{name:()=>i.name,count:()=>ee(i.roundCount,be),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(gs(this.svc.filter.get(),"courseIds",i.id))}},d),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return Ss(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return kt(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Ut({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:Vt(t.totals),baseline:this.svc.sgInfo.get()}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ee(e,be):`${$e(e,0)} of ${ee(t,be)}`}statusLine(){const e=this.svc.extendError.get();return e?`${S.extendProblemPrefix}${e.message}`:this.svc.extending.get()?S.extending:this.svc.budgetSpent()?S.budgetSpent:this.svc.loading.get()?S.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?S.windowEmpty:this.svc.loadedCount()===0?S.noStats:""}}function Mm(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:Te(e)}function Am(s){const e=[Nr(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${$e(s.holeCount,0)} holes`),e.join(" · ")}const zm=b(`
...
`),jm=b('<li bind="text" class="roundstats__legenditem"></li>');function Gm(){const s=[];for(const[e,t]of Object.entries(fn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
...
${hn}
    `;svc=this.inject(ut);auth=this.inject(D);router=this.inject(G);colors=ls;openHole=new f(null);infoOpen=new f(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(I(()=>{const o=e.get();J(()=>{this.openHole.set(null),o&&this.svc.load(o)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",d=this.wire(zm,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":ni(t()),subtitle:()=>this.subtitle(),score:()=>{const o=t();return o===null?"":Yr(o.strokes,o.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>Q.waterfallHeading,wfHint:()=>Q.waterfallHint,infoTrigger:{textContent:()=>S.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:o=>{o.target===o.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ge.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>Q.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const o=this.selected();return o===null?"":qp(o)},detailEmpty:()=>{const o=this.selected();return o===null?"":_n(o).length===0?Q.nothingRecordedOnHole:""}});return this.setHeading(d,"stripSec",Q.holeStripHeading),this.$each(this.ref(d,"strip"),()=>t()?.cells??[],(o,c,u)=>this.wireEl(Lm,{cell:{className:()=>{const p=this.cellNow(o.id)??o;return p.marker===null?"cell":`cell cell--${p.marker}`},"aria-pressed":()=>String(this.openHole.get()===o.id),"aria-label":()=>mi(this.cellNow(o.id)??o),title:()=>mi(this.cellNow(o.id)??o),onclick:()=>this.openHole.set(this.openHole.get()===o.id?null:o.id)},hole:()=>String((this.cellNow(o.id)??o).holeNumber),score:()=>Vp(this.cellNow(o.id)??o),tee:{className:()=>(this.cellNow(o.id)??o).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const p=this.cellNow(o.id)??o;return p.tee===null?"":`background:${this.teeColor(p.tee)}`}},gir:{className:()=>{const p=this.cellNow(o.id)??o;return p.gir===null?"cell__gir cell__gir--absent":p.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const p=this.cellNow(o.id)??o;return p.putts===null?"":String(p.putts)},pen:{className:()=>Jh(this.cellNow(o.id)??o)?"cell__pen":"cell__pen cell__pen--absent"}},u),o=>o.id),this.$each(this.ref(d,"detailLines"),()=>Qp(this.selected()),(o,c,u)=>this.wireEl(Bm,{label:()=>o.label,value:()=>o.value},u),o=>o.key),this.$each(this.ref(d,"deltas"),()=>{const o=t();return o===null?[]:de.filter(c=>Ue(o.waterfall,c)!==null)},(o,c,u)=>this.wireEl(Fm,{title:()=>ss(o),sentence:()=>{const p=t();if(p===null||p.deltas===null)return"";const m=sn(p.deltas,o);return m===null?"":Xr(m,p.windowCount)},value:{textContent:()=>{const p=this.componentValue(o);return p===null?"":Te(p)},style:()=>{const p=this.componentValue(o);return p===null?"":`color:${We(as(p),this.colors)}`}},bar:{innerHTML:()=>{const p=t(),m=this.componentValue(o);return p===null||m===null?"":Ur(m,Ir([p.waterfall]),this.colors)}}},u),o=>o),this.$each(this.ref(d,"infoCards"),()=>{const o=t();return o===null?[]:Ut({attributed:o.waterfall.coverage.attributed,holesScored:o.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:de.map(c=>xe(o.waterfall,c)),penaltySource:Vt(o.panels.totals),baseline:this.svc.sgInfo.get()})},(o,c,u)=>this.wireEl(rs,{ctitle:()=>o.title,ctext:()=>o.body},u),o=>o.id),this.spawn(sa,this.ref(d,"panels"),{model:()=>t()?.panels??Pr}),this.$each(this.ref(d,"legend"),()=>[Q.legendTee,Q.legendGir,Q.legendPutts,Q.legendPenalty,Q.legendAbsence],(o,c,u)=>this.wireEl(jm,{text:()=>o},u),o=>o),d}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Ue(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":Dp({...e,title:ni(e)})}stateLine(){if(this.auth.currentUser.get()===null)return Q.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return Q.loading;case"notFound":return Q.noStatsInRound;case"notAuthorized":return Q.notSignedIn;case"failed":return`${Q.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?Q.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const qm=b(`
    <div class="admin">
...
`),Wm={not_started:"Not started",active:"Playing",complete:"Done"},Ym={private:"Private",friends:"Friends",link:"Link"};function Xm(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Qm(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Jm extends M{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class ng extends M{static styles=`
        .comps {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),pg=b('<button bind="chip" class="cd__friendchip" type="button"></button>');class fg extends M{competitions=this.inject(Be);state=this.inject(mt);render(){const e=()=>this.state.id.get()??"",t=this.wire(ug,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&Ds(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(hg,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&Ds(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(pg,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(d=>d.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const mg={not_started:"Not started",active:"Live",complete:"Finished"},gg=b(`
    <section class="cd__section">
...
`),_g=b('<option bind="option"></option>');class yg extends M{competitions=this.inject(Be);state=this.inject(mt);router=this.inject(G);render(){const e=new k(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(gg,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&eg(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(_g,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(bg,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>mg[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function vg(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function wg(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const xg=b(`
    <div>
...
`),$g=b('<button bind="button" type="button"></button>'),kg=b('<th bind="cell"></th>'),Sg=b('<tr bind="row"></tr>'),Tg=b('<td bind="cell"><span bind="value"></span></td>'),Pg=b(`
...
`);class Ng extends M{static styles=`
    ...
    `;competitions=this.inject(Be);state=this.inject(mt);router=this.inject(G);render(){const e=()=>this.competitions.detail.get();this.track(I(()=>{const n=this.state.id.get();n&&J(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(Eg,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>na(this.state.lifecycle.get()),className:()=>ia(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&Cs(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>Cs(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=Cs(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(cg,this.ref(t,"setup")),this.spawn(fg,this.ref(t,"roster")),this.spawn(yg,this.ref(t,"rounds")),this.spawn(Cg,this.ref(t,"results")),t}}const Rg=b(`
    <div class="app-shell">
...
`);class Og extends M{static styles=`
    ...
    `;router=this.inject(G);render(){const e=this.wire(Rg,{header:{className:()=>Ks(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(cu,this.ref(e,"account")),this.spawn(Ro,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Wn,"/history":Pu,"/round":mf,"/create":Df,"/login":Yf,"/friends":Zf,"/friend":tm,"/friend-rounds":nm,"/friend-courses":am,"/spectate":um,"/profile":gm,"/stats":Hm,"/round-stats":Dm,"/admin":Jm,...Yi.competitions?{"/competitions":ng,"/competition":Ng}:{}},Wn),e}}class Hg extends D{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Jr(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await qf()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Vf(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await Uf();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}U.get(ka);const Ri=U.get(G);U.set(D,new Hg);const Oi=U.get(D);await Ia(Og,"#app",{hot:void 0,onInit:async()=>{await Oi.load(),Oi.currentUser.get()&&Ri.route.get()==="/login"&&Ri.navigate("/",!0)}});export{Es as A,M as C,G as R,f as S,ka as T,_ as a,at as b,k as c,ma as d,I as e,fa as n,j as r,b as t};
