(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const $a="modulepreload",Sa=function(s){return"/tapscore/"+s},$n={},Ta=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");i=c(t.map(u=>{if(u=Sa(u),u in $n)return;$n[u]=!0;const h=u.endsWith(".css"),f=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const m=document.createElement("link");if(m.rel=h?"stylesheet":$a,h||(m.as="script"),m.crossOrigin="",m.href=u,d&&m.setAttribute("nonce",d),document.head.appendChild(m),h)return new Promise((_,g)=>{m.addEventListener("load",_),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return i.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},ji="/tapscore/".replace(/\/+$/,""),Bs=ji+"/api",Qt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","confirm-btn-min-height":"44px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Pa=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Ca(s,e){const t={};for(const[n,i]of Pa)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const Di=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Ia={thin:"1px",medium:"3px",thick:"5px"};function qi(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Ia[e.toLowerCase()]??e}function Ea(){return Di.map(s=>{const e=qi(Qt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Vi={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Ui={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Ra={...Ui,"done-opacity":"0.35"},Na={...Vi,...Ui,...Qt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Oa={...Vi,...Ra,...Qt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Ha{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Ki(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const $e=new Ha;function Ki(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return $e.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,$e.notify(this.subs))}update(e){this.set(e(this.val))}}class T{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){$e.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,$e.notify(t.subs))})},deps:new Set};n.run()}get(){return $e.subscribe(this.subs),this.val}peek(){return this.val}}function C(s){const e={run(){$e.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Ki(e)}}function dt(s){$e.batch(s)}function se(s){return $e.untrack(s)}class Ma{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const Y=new Ma,Ze=ji;function zs(s){return Ze?s===Ze?"/":s.startsWith(Ze+"/")?s.slice(Ze.length):s:s}function Aa(s){return Ze+s}class q{constructor(){this.route=new p(zs(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>dt(()=>{this.route.set(zs(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",o=i>=0?e.slice(0,i):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,u=d>=0?o.slice(d+1):"",h=n.query!==void 0?Ba(n.query):u?"?"+u:"",f=Aa(c)+h+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",f),dt(()=>{this.route.set(c),this.search.set(h)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new T(()=>{const n=this.route.get().split("/"),i={};for(const[r,o]of t.entries())o.startsWith(":")&&(i[o.slice(1)]=n[r]??"");return i})}query(e){return new T(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new T(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Ba(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function za(s){return e=>s[e]}const La="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Sn="data-basics-global";function Fa(){if(document.head.querySelector(`style[${Sn}]`))return;const s=document.createElement("style");s.setAttribute(Sn,""),s.textContent=Ea()+La,document.head.appendChild(s)}function Ga(s,e){Fa();const t=new Set(Di),n=(r,o,d)=>{const c=Object.entries(r).map(([u,h])=>`--${u}:${t.has(u)?qi(h):h}`).join(";");return`${o}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const Tn="basics-js-theme";class ja{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Tn),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),C(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(Tn,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function Da(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Pn=new Set;class M{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Pn.has(t)){Pn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return Y.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=se(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){se(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")i(C(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const h=c.includes("-");c.startsWith("on")&&typeof u=="function"?o.addEventListener(c.slice(2),u):typeof u=="function"?i(C(()=>{const f=u();h?o.setAttribute(c,String(f)):o[c]=f})):h?o.setAttribute(c,String(u)):o[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof M?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(C(()=>{const c=r(),u=new Map;for(const[f,m]of c.entries()){const _=i(m,f);if(o.has(_))u.set(_,o.get(_));else{const g=[];u.set(_,se(()=>n(m,f,v=>g.push(v)))),d.set(_,g)}}for(const[f,m]of o)u.has(f)||(m.remove(),se(()=>d.get(f)?.forEach(_=>_())),d.delete(f));let h=e.firstChild;for(const f of u.values())f===h?h=h.nextSibling:e.insertBefore(f,h);o.clear();for(const[f,m]of u)o.set(f,m)}))}$condition(e,t,n,i){let r=null;this.track(C(()=>{r&&(r.remove(),r=null);const o=t.get();r=se(()=>o?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(C(()=>{if(r){const c=r;r=null,se(()=>c.destroy())}e.textContent="";const o=t.get(),d=n[o]??Da(o,n)??i;d&&(r=se(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Mt=new Set;function qa(s){return Mt.add(s),()=>Mt.delete(s)}function Va(){for(const s of Array.from(Mt)){Mt.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ua(s,e,t){const n=document.querySelector(e);n.textContent="";const i=Y.get(q);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const u=async h=>{r&&(r.destroy(),r=null,n.textContent=""),h?(d||(d=(await Ta(()=>import("./obs-shell.component-DrEstPq0.js"),[])).ObsShellComponent),r=se(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=se(()=>new s)),se(()=>r.mount(n)),o=h};await u(zs(location.pathname).startsWith("/_obs")),C(()=>{const h=i.route.get().startsWith("/_obs");h!==o&&u(h)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(h){console.error("[startApp] the root component threw while disposing",h)}if(r=null,Va(),t.onDispose)try{t.onDispose()}catch(h){console.error("[startApp] onDispose threw",h)}}),t.hot.accept())}class J extends Error{constructor(e,t,n,i,r){super(t),this.status=e,this.details=n,this.traceId=i,this.detail=r,this.name="ApiError"}}const Ka=10,Rt=[];let Nt=[],rt=null;function Wa(s){Rt.push(s),Rt.length>Ka&&Rt.shift()}function Wi(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Rt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Nt.push(n),Ya()}function Ya(){rt||(rt=setTimeout(Yi,5e3))}function Yi(){if(rt&&(clearTimeout(rt),rt=null),Nt.length===0)return;const s=Nt;Nt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Bs}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Bs}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Yi()});const Xa=3e4,Qa=2,vt=new Map,Xi=new WeakMap;function Ja(s){if(s instanceof J)return s.traceId;if(s!=null&&typeof s=="object")return Xi.get(s)}async function y(s){if(s.method==="GET"){const e=vt.get(s.url);if(e)return e;const t=Cn(s,Qa);return vt.set(s.url,t),t.then(()=>vt.delete(s.url),()=>vt.delete(s.url)),t}return Cn(s,0)}async function Cn(s,e){const t=s.timeout??Xa;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await eo(Za(s,r),t)}catch(o){if(n=o,!(o instanceof J)&&o!=null&&typeof o=="object"&&Xi.set(o,r),o instanceof J||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw n}async function Za(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Wa({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const o=await i.json().catch(()=>({error:i.statusText}));throw new J(i.status,o.error??i.statusText,o.details,r,o.detail)}return i.json()}function eo(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Ls=new Set;let fs=!1;function to(s){return Ls.add(s),()=>{Ls.delete(s)}}function Qi(){if(!fs){fs=!0;try{for(const s of[...Ls])try{s()}catch(e){try{Wi("session-listener",so(e))}catch{}}}finally{fs=!1}}}function so(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function L(s,e,t,n={}){dt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=no(i);dt(()=>{s.set(!1),e.set(r)}),Wi(r.code,r.message,Ja(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Qi();return}}function no(s){return s instanceof J?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const ms={sessionExpiry:!1};function io(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class V{constructor(){this.api=io(Bs),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=to(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=qa(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await L(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await L(this.loading,this.error,()=>this.api.login({username:e,password:t}),ms);return n?(this.currentUser.set(n),!0):!1}async logout(){await L(this.loading,this.error,()=>this.api.logout(),ms);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await L(this.loading,this.error,()=>this.api.logoutAll(),ms),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Ji={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},ro={...Ji,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},ao={...Ji,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function Zi(s,e={}){const t=s==="light"?ro:ao,n=s==="light"?Na:Oa;return Ca({...t,...e},n)}const oo=Zi("light"),lo=Zi("dark"),l=Ga(oo,lo),z=s=>`var(--${s})`,I=(s,e)=>`var(--${s}, ${e})`,E=s=>{const e=Qt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},co=s=>I(s,E(s)),a=za({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),wt=s=>`
    ...
    cursor: not-allowed;`,uo={primary:wt("primary"),secondary:wt("secondary"),ghost:wt("ghost"),danger:wt("danger"),disabled:er},S=(s=I("btn-radius",E("btn-radius")),e="secondary")=>`
    /*
    ...
    ${uo[e]}
    &:disabled {${er}}
`,ho=`max(${I("field-border-width",E("field-border-width"))}, ${I("field-rule-width",E("field-rule-width"))})`,xt=(s,e)=>`
    border-top-color: ${s};
...
`);class Qo extends M{static styles=`
        .dock {
    ...
    `;router=this.inject(q);auth=this.inject(V);landing=this.inject(es);newCount=new T(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(Yo,{bar:{className:()=>En(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return Wo(r)?En(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=Uo(nr),n=Math.ceil(t.length/2),i=(r,o)=>this.wireEl(Xo,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const d=this.newCount.get();return d===0?"":String(d)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},o);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,o,d)=>i(r,d),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,o,d)=>i(r,d),r=>r.key),e}}const ir=["tee","approach","putting","shortGame","penalties","recovery"],Ot={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function rr(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function Jo(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const Zo="Track statistics",el="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function ar(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function At(s,e){return s[e]}function tl(s,e){if(!s.enabled)return!0;const t=ar(e);return t===null?!1:!At(s,t)}function sl(s,e){if(!s.enabled)return null;const t=ar(e);return t===null||At(s,t)?null:`Needs ${rr(t)}`}function nl(s,e,t){return rl({...s,[e]:t})}function il(s,e){return{...s,enabled:e}}function rl(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function bs(s){const e={...Ot,enabled:s.enabled};for(const t of ir)e[t]=s[t];return e}function al(s){return s.avatarVersion?`${W}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function ol(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return($t(t[0])+$t(t[t.length-1])).toUpperCase();if(t.length===1)return $t(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?$t(n).toUpperCase():"•"}function $t(s){return[...s][0]??""}const St=512,ll=2*1024*1024;function dl(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const cl=.85;class tt extends Error{}async function ul(s){let e;try{e=await createImageBitmap(s)}catch{throw new tt("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=dl(e.width,e.height),r=document.createElement("canvas");r.width=St,r.height=St;const o=r.getContext("2d");if(!o)throw new tt("This browser cannot process images.");o.drawImage(e,t,n,i,i,0,0,St,St);const d=await new Promise(c=>r.toBlob(c,"image/jpeg",cl));if(!d)throw new tt("That image could not be processed.");if(d.size>ll)throw new tt("That image is too large.");return d}finally{e.close()}}async function hl(s){const e=await fetch(`${W}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await or(e);return await e.json()}async function pl(){const s=await fetch(`${W}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await or(s)}async function or(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new J(t,fl(e.error,s.status))}function fl(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Ie{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);teeRoles=new p([]);saving=new p(!1);saveError=new p(null);saveTarget=new p(null);statsConfig=new p(Ot);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await L(this.loading,this.error,()=>Promise.all([w.players.me(),w.players.myHandicapHistory(),w.clubs.list(),w.setup.teeRoleCatalog().catch(()=>[]),w.playerStats.myConfig().catch(()=>null),w.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,o,d,c]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.teeRoles.set(o),this.statsConfig.set(d?bs(d):Ot),this.hasRecordedStats.set((c?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.teeRoles.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Ot),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return this.saveTarget.set("index"),await L(this.saving,this.saveError,()=>w.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveDisplayName(e){this.saveTarget.set("name");const t=await L(this.saving,this.saveError,()=>w.players.updateProfile({displayName:e}));return t?(this.player.set(t),!0):!1}async confirmHandicap(){this.saveTarget.set("index");const e=await L(this.saving,this.saveError,()=>w.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){this.saveTarget.set("gender");const t=await L(this.saving,this.saveError,()=>w.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){this.saveTarget.set("club");const t=await L(this.saving,this.saveError,()=>w.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async savePreferredTeeRole(e){this.saveTarget.set("tee");const t=await L(this.saving,this.saveError,()=>w.players.updateProfile({preferredTeeRoleKey:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await L(this.statsSaving,this.statsError,()=>w.playerStats.putMyConfig(bs(e)));return t?(this.statsConfig.set(bs(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await ul(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof tt?i.message:"That image could not be prepared."}),!1}const n=await L(this.avatarSaving,this.avatarError,()=>hl(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await L(this.avatarSaving,this.avatarError,()=>pl().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function Tt(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function ys(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Bt(s,e="frecency"){return e==="alpha"?[...s].sort(ys):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,o=i>0,d=r>0;if(o!==d)return o?-1:1;if(!o)return ys(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,h=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,f=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return f!==h?f-h:ys(t,n)})}const ml=1440*60*1e3;function gl(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/ml);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function bl(s,e){if(s.sharedRoundCount<=0)return"never played";const t=gl(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function yl(s){return`@${s.username}`}function _l(s){return s.homeClubName?.trim()??""}const lr=2;function Rn(s){return s.trim().length>=lr}function dr(s){return Bt(s,"frecency")}function vl(s,e){return dr([...s.filter(t=>t.id!==e.id),e])}function wl(s,e){return s.filter(t=>t.id!==e)}function Nn(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function xl(s,e,t=()=>{},n=300){let i=0,r;return o=>{const d=o.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<lr){e(d,[]);return}r=setTimeout(()=>{s(d).then(u=>{c===i&&e(d,u)},u=>{c===i&&t(d,u)})},n)}}const cr=Xe("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function kl(s=Z()){return cr.read(s)}function $l(s,e=Z()){cr.write(s,e)}class ts{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(kl());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=xl(e=>w.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await L(this.loading,this.error,()=>w.friends.list());t&&(this.friends.set(dr(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await L(this.mutating,this.mutateError,()=>w.friends.add({friendId:e.id}))&&(this.friends.set(vl(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Nn(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),$l(e)}async remove(e){await L(this.mutating,this.mutateError,()=>w.friends.remove({friendId:e}))&&(this.friends.set(wl(this.friends.get(),e)),this.results.set(Nn(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class sn{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await w.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function st(s,e){return s instanceof J&&s.status===401?(Qi(),"Your session expired — sign in again."):e}function zt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function Sl(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${zt(s.scoreToPar)}`}function ur(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function hr(s){return(s.courseName??"").trim()||null}function Tl(s){const e=[];for(const t of s){const n=t.friends[0],i=ur(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:hr(t),progress:Sl(n)})}return e}function Pl(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function Cl(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function Il(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function El(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${zt(s.scoreToPar)}`}function Rl(s){const e=[];for(const t of s){const n=t.friends[0],i=ur(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:hr(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function pr(s){if(s instanceof J){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Ke={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function Nl(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function Ol(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function Hl(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${zt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${zt(s.scoreToPar)}`}}}function Ml(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function Al(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function Bl(s){return s===1?"1 course played":`${s} courses played`}const _s={rounds:[],nextCursor:null,hasMore:!1};function On(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function fr(s){return s.hasMore&&s.nextCursor!==null}class ss{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p(_s);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await w.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(st(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await w.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(On(_s,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(st(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!fr(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await w.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(On(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(st(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await w.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(st(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=pr(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set(_s),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function mr(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function zl(s){return Math.round(mr(s))}function Ll(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),u=s-c*n;return c+(e>=1&&e<=u?1:0)}const i=-s,r=Math.floor(i/n),o=i-r*n,d=r+(e>n-o?1:0);return d===0?0:-d}function Fl(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function be(){return Fl()}const Ae=10;class We{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await L(this.loading,this.error,()=>w.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=be()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=be()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=be()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=be()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=be()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,o=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==o?r-o:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=be()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Ae:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const Hn=["scramble","foursomes","greensomes"];class Gl{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof w.setup?.formations=="function")return this.inFlight=(async()=>{const e=await L(this.loading,this.error,()=>w.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=Hn.indexOf(n);return i===-1?Hn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=be()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const jl=180,Mn=4,Dl=12;function Ve(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function ql(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<Dl)return 0;const i=e+t*jl,r=Math.round(-i/n);return Math.max(-Mn,Math.min(Mn,r))}const An="tapscore:pending-scores:v1",Vl=336*60*60*1e3,Bn=200;function Ul(){try{return globalThis.localStorage??null}catch{return null}}function Kl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class Wl{entries=[];storage;constructor(e=Ul(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=Vl);return t.length>Bn?t.slice(t.length-Bn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(An);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(Kl):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(An,JSON.stringify(this.entries))}catch{}}}const ke=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","putts","penalties","penalty_source"],Yl={minPar:4},Xl={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Missed where",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},Ql={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Around the green"}]}};function Fs(s){return Xl[s]}function zn(s){return Ql[s]}function Ln(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function gr(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function Jl(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function Zl(s,e,t){return e-t<=s-2?"1":"0"}function Gs(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class ed{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=Fn(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=Fn(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!Jl(this.par,this.strokes,e)?null:Zl(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Gs(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of ke)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Gs(this).state};`,e}get prompts(){const e=[];for(const t of ke)this.isVisible(t)&&e.push({key:t,label:Fs(t),control:zn(t)});return e}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&gr(Yl,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){this.isVisible(e)&&(e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune())}step(e,t){const n=zn(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<ke.length;e++){let t=!1;for(const n of ke){const i=this.draft.get(n),r=this.visibility(n);r!=="visible"&&(r==="contradicted"?this.record(n,null):this.draft.delete(n),td(i,this.draft.get(n))||(t=!0))}if(!t)return}}get batch(){const e=[];for(const t of ke){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function td(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function Fn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of ke){const n=s[t];n!==void 0&&e.set(t,n)}return e}const Gn="tapscore:pending-stat-events:v1",sd=336*60*60*1e3,jn=500;function nd(){try{return globalThis.localStorage??null}catch{return null}}function id(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function rd(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&ke.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class ad{entries=[];storage;makeId;constructor(e=nd(),t=Date.now(),n=id){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const o=[];for(const d of i){const c={token:e,playHoleId:t,playerId:n,key:d.key,value:d.value,clientEventId:this.makeId(),queuedAt:r},u=this.entries.findIndex(h=>h.token===e&&h.playHoleId===t&&h.playerId===n&&h.key===d.key);u>=0?this.entries[u]=c:this.entries.push(c),o.push(c)}return this.entries=this.applyHygiene(r),this.persist(),o}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=sd);return t.length>jn?t.slice(t.length-jn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Gn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(rd):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Gn,JSON.stringify(this.entries))}catch{}}}const od=50;function ld(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const nn=Xe("tapscore.result-cursors.v1",Js(ld),od);function rn(s=Z()){return nn.read(s)}function dd(s,e=Z()){return rn(e).find(t=>t.token===s)?.cursor??null}function cd(s,e,t=Z()){if(!t)return[];const n=rn(t).filter(i=>i.token!==s);return nn.write([{token:s,cursor:e},...n],t)}function ud(s,e=Z()){if(!e)return[];const t=rn(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&nn.write(n,e),n}const hd=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Re=(s,e)=>`${s}|${e}`;function an(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function pd(s,e,t){return gr(s,e,t)}function vs(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function fd(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function md(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class ge{constructor(e=new Wl,t=new ad){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),Y.get(We).load();const r=await L(this.loading,this.error,()=>w.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),et({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!Bo(r.round.id))),Y.get(V).currentUser.get()&&zo(r.round.id),this.pendingSlotIndex!==null){const f=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,f!==null&&this.selectedSlot.set(f)}const[o,d,c,u]=await Promise.all([w.friendlyRounds.balls({token:e}).catch(()=>[]),w.friendlyRounds.scorecard({token:e}).catch(()=>[]),w.playerStats.configsByToken({token:e}).catch(()=>null),w.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(h=>[h.playerId,h.modules]))),u&&(this.statRows.set(u),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(d),this.balls.set(o),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await w.friendlyRounds.remove({token:e}),sr(e);const t=this.round.get()?.id;return t&&tr(t),ud(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await w.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),et({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await w.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),et({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await L(this.resultLoading,this.resultError,()=>w.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await w.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await w.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const o=await w.friendlyRounds.balls({token:e}).catch(()=>null);if(o===null||i())return;this.balls.set(o)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?dd(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&cd(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await w.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),et({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new T(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,an(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new T(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(o=>n.subjectLabels?.some(d=>d.ballId===o&&d.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const o=r.entries.find(d=>i(d.ballIds));if(!o)continue;return o.total===null?null:o.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-o.paceDelta:o.paceDelta}:{kind:"total",total:o.total}}if(r.kind==="match_summary"){const o=r.matches.find(u=>i(u.sideA.ballIds)||i(u.sideB.ballIds));if(!o)continue;if(o.thru===0&&!o.finished)return null;const d=i(o.sideA.ballIds)?"a":"b";if(o.leader===null||o.magnitude===0)return{kind:"match",text:"AS",tone:"even"};const c=o.leader===d;return{kind:"match",text:`${o.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Ve(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(o=>o.id===e);if(!t||!n)return"";const i=t.playHoles.filter(o=>o.courseHoleNumber===n.courseHoleNumber).sort((o,d)=>o.ordinal-d.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(o=>o.id===e);return`${n.courseHoleNumber} (${hd[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Ve(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Ve(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(o=>{const d=n.get(o.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return d?.strokes===null||d===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Re(e,t));return n?n.strokes:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Re(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(u=>u.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const o=this.playHoleById(t);if(!o)return null;const d=i.players[0]?.teeName??null,c=o.tees.find(u=>u.teeName===d)?.strokeIndex??o.baseStrokeIndex;return Ll(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Gs(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new ed(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?fd(t):new Map;for(const i of ke){const r=vs(e,i);if(!this.statLocal.has(r))continue;const o=this.statLocal.get(r)??null;o===null?n.delete(i):n.set(i,o)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=vs(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=vs({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await w.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return md(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Re(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=Y.get(We),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const o=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of o)i.has(d.key)||(i.add(d.key),n.push(d))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>pd(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Re(e,t),o=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:o});const d=this.token;d&&(this.enqueue(d,e,t,n,i,o),await this.post(d,e,t,n,i,o))}async retry(e,t){const n=Re(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Re(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,o){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:o,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,o){const d=Re(t,n);try{await w.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:o,...r!=null?{metadata:r}:{}}),this.queue.remove(o);const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class br{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await w.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=pr(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(st(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await w.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new T(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,an(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new T(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class yr{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}canManageCourses(){return this.isSuperAdmin()||this.roles.get().some(e=>e.role==="course_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await w.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await L(this.loading,this.error,()=>Promise.all([w.admin.adminStats(),w.admin.adminRounds({limit:100}),w.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const gd=["last5","last10","last20","thisYear","all","custom"];function Lt(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function bd(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function on(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const at={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function yd(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function _d(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function ws(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function vd(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function ns(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function _r(s){return`${s.getFullYear()}-`}function vr(s,e,t,n){const i=ns(t);switch(s){case"last5":case"last10":case"last20":{const r=on(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=_r(n);return i.filter(o=>o.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>_d(e,r))}}function wr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const o=on(e);return o===null?!1:n.length<o}case"thisYear":{const o=`${_r(r)}01-01`;return!n.some(d=>d.date<o)}case"all":return!0;case"custom":{if(yd(t))return!1;if(t.from===null)return!0;const o=t.from;return!n.some(d=>d.date<o)}}}const wd="Unnamed course";function xd(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??wd,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const Ft="last10";function kd(s){return gd.includes(s)}const xr=Xe("tapscore.stats.window.v1",{decode:s=>kd(s)?s:Ft,encode:s=>s,empty:Ft});function js(s=Z()){return xr.read(s)}function Dn(s,e=Z()){xr.write(s,e)}function x(s,e){return{value:e===0?null:s/e,n:s,d:e}}const $d=5;function Sd(s,e=$d){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const Gt=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,scrambleSingleChipStandard:0,scrambleChipInStandard:0,scrambleChipOnePuttStandard:0,scrambleChipTwoPuttStandard:0,scrambleChipThreePuttStandard:0,scrambleSingleChipHard:0,scrambleChipInHard:0,scrambleChipOnePuttHard:0,scrambleChipTwoPuttHard:0,scrambleChipThreePuttHard:0,scrambleSingleChipBunker:0,scrambleChipInBunker:0,scrambleChipOnePuttBunker:0,scrambleChipTwoPuttBunker:0,scrambleChipThreePuttBunker:0,holesMultiChipStandard:0,holesMultiChipHard:0,scrambleInside2mResolvedStandard:0,scrambleInside2mSavedStandard:0,scrambleInside2mResolvedHard:0,scrambleInside2mSavedHard:0,scrambleInside2mResolvedBunker:0,scrambleInside2mSavedBunker:0,holesScoredMissStandard:0,strokesVsParMissStandard:0,holesScoredMissHard:0,strokesVsParMissHard:0,holesScoredMissBunker:0,strokesVsParMissBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0});function Td(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,scrambleSingleChipStandard:s.scrambleSingleChipStandard+e.scrambleSingleChipStandard,scrambleChipInStandard:s.scrambleChipInStandard+e.scrambleChipInStandard,scrambleChipOnePuttStandard:s.scrambleChipOnePuttStandard+e.scrambleChipOnePuttStandard,scrambleChipTwoPuttStandard:s.scrambleChipTwoPuttStandard+e.scrambleChipTwoPuttStandard,scrambleChipThreePuttStandard:s.scrambleChipThreePuttStandard+e.scrambleChipThreePuttStandard,scrambleSingleChipHard:s.scrambleSingleChipHard+e.scrambleSingleChipHard,scrambleChipInHard:s.scrambleChipInHard+e.scrambleChipInHard,scrambleChipOnePuttHard:s.scrambleChipOnePuttHard+e.scrambleChipOnePuttHard,scrambleChipTwoPuttHard:s.scrambleChipTwoPuttHard+e.scrambleChipTwoPuttHard,scrambleChipThreePuttHard:s.scrambleChipThreePuttHard+e.scrambleChipThreePuttHard,scrambleSingleChipBunker:s.scrambleSingleChipBunker+e.scrambleSingleChipBunker,scrambleChipInBunker:s.scrambleChipInBunker+e.scrambleChipInBunker,scrambleChipOnePuttBunker:s.scrambleChipOnePuttBunker+e.scrambleChipOnePuttBunker,scrambleChipTwoPuttBunker:s.scrambleChipTwoPuttBunker+e.scrambleChipTwoPuttBunker,scrambleChipThreePuttBunker:s.scrambleChipThreePuttBunker+e.scrambleChipThreePuttBunker,holesMultiChipStandard:s.holesMultiChipStandard+e.holesMultiChipStandard,holesMultiChipHard:s.holesMultiChipHard+e.holesMultiChipHard,scrambleInside2mResolvedStandard:s.scrambleInside2mResolvedStandard+e.scrambleInside2mResolvedStandard,scrambleInside2mSavedStandard:s.scrambleInside2mSavedStandard+e.scrambleInside2mSavedStandard,scrambleInside2mResolvedHard:s.scrambleInside2mResolvedHard+e.scrambleInside2mResolvedHard,scrambleInside2mSavedHard:s.scrambleInside2mSavedHard+e.scrambleInside2mSavedHard,scrambleInside2mResolvedBunker:s.scrambleInside2mResolvedBunker+e.scrambleInside2mResolvedBunker,scrambleInside2mSavedBunker:s.scrambleInside2mSavedBunker+e.scrambleInside2mSavedBunker,holesScoredMissStandard:s.holesScoredMissStandard+e.holesScoredMissStandard,strokesVsParMissStandard:s.strokesVsParMissStandard+e.strokesVsParMissStandard,holesScoredMissHard:s.holesScoredMissHard+e.holesScoredMissHard,strokesVsParMissHard:s.strokesVsParMissHard+e.strokesVsParMissHard,holesScoredMissBunker:s.holesScoredMissBunker+e.holesScoredMissBunker,strokesVsParMissBunker:s.strokesVsParMissBunker+e.strokesVsParMissBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker}}function Pd(s){let e=Gt;for(const t of s)e=Td(e,t);return e}const ze=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function is(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function Cd(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function Id(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function Ed(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function kr(s){return x(s.fairwayHits,s.teeRecorded)}function Rd(s){return x(s.troubleCount,s.teeRecorded)}function Nd(s){return x(s.holesScoredPenalty,s.holesScored)}function Od(s){return{penalty:x(s.strokesVsParPenalty,s.holesScoredPenalty),clean:x(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function Hd(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return x(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Md(s){return x(s.recoverySuccesses,s.recoveryAttempts)}function Ad(s,e){return x(s.penaltiesTotal,e)}function Bd(s){return{fairway:x(s.strokesVsParFairway,s.holesScoredFairway),inPlay:x(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:x(s.strokesVsParTrouble,s.holesScoredTrouble)}}function zd(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return x(e,s.holesScoredTrouble*s.holesScoredFairway)}function $r(s){return x(s.girHits,s.girRecorded)}function Ld(s){return{fairway:x(s.girHitsFairway,s.girRecordedFairway),inPlay:x(s.girHitsInPlay,s.girRecordedInPlay),trouble:x(s.girHitsTrouble,s.girRecordedTrouble)}}function Fd(s){return{par3:x(s.girHitsPar3,s.girRecordedPar3),par4:x(s.girHitsPar4,s.girRecordedPar4),par5:x(s.girHitsPar5,s.girRecordedPar5)}}function Gd(s){const e=x(s.strokesVsParGirHit,s.girHolesScored),t=x(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:x(n,s.holesScoredGirMiss*s.girHolesScored)}}function jd(s,e){return x(Ed(s,e),s.girFirstPuttRecorded)}function Dd(s){let e=0;for(const t of ze)e+=is(s,t);return e}function qd(s,e){return x(is(s,e),Dd(s))}function Vd(s){return x(s.birdiesOnGir,s.girHolesScored)}function Ud(s){return x(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function Kd(s){const e=s.greenMissRecorded;return{long:x(s.greenMissLong,e),short:x(s.greenMissShort,e),left:x(s.greenMissLeft,e),right:x(s.greenMissRight,e)}}function Wd(s){return{left:x(s.teeMissLeft,s.teeMissRecorded),right:x(s.teeMissRight,s.teeMissRecorded),troubleLeft:x(s.teeTroubleLeft,s.teeMissLeft),troubleRight:x(s.teeTroubleRight,s.teeMissRight)}}function Yd(s){const e=s.penaltySourceRecorded;return{tee:x(s.penaltiesTee,e),approach:x(s.penaltiesApproach,e),short:x(s.penaltiesShort,e)}}function Xd(s,e){return x(Id(s,e),is(s,e))}function Qd(s){return x(s.threePutts,s.puttsRecorded)}function Jd(s){const e=s.puttsRecorded;return{zero:x(s.holesZeroPutt,e),one:x(s.holesOnePutt,e),two:x(s.holesTwoPutt,e),threePlus:x(s.threePutts,e)}}function Zd(s){return{par3:x(s.puttsTotalPar3,s.puttsRecordedPar3),par4:x(s.puttsTotalPar4,s.puttsRecordedPar4),par5:x(s.puttsTotalPar5,s.puttsRecordedPar5)}}function ec(s){return x(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function tc(s){return x(s.puttsTotalGir,s.puttsRecordedGir)}function sc(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return x(e,t)}function Sr(s){return{standard:x(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:x(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:x(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function nc(s){return x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function ic(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function rc(s){return{standard:x(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:x(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:x(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:x(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function ac(s){const e=(t,n,i,r,o,d)=>({chipIn:x(t,d),onePutt:x(n,d),twoPutt:x(i,d),threePlus:x(r,d),multiChip:x(o,d)});return{standard:e(s.scrambleChipInStandard,s.scrambleChipOnePuttStandard,s.scrambleChipTwoPuttStandard,s.scrambleChipThreePuttStandard,s.holesMultiChipStandard,s.scrambleAttemptsStandard),hard:e(s.scrambleChipInHard,s.scrambleChipOnePuttHard,s.scrambleChipTwoPuttHard,s.scrambleChipThreePuttHard,s.holesMultiChipHard,s.scrambleAttemptsHard),bunker:e(s.scrambleChipInBunker,s.scrambleChipOnePuttBunker,s.scrambleChipTwoPuttBunker,s.scrambleChipThreePuttBunker,s.holesMultiChipBunker,s.scrambleAttemptsBunker),overall:e(s.scrambleChipInStandard+s.scrambleChipInHard+s.scrambleChipInBunker,s.scrambleChipOnePuttStandard+s.scrambleChipOnePuttHard+s.scrambleChipOnePuttBunker,s.scrambleChipTwoPuttStandard+s.scrambleChipTwoPuttHard+s.scrambleChipTwoPuttBunker,s.scrambleChipThreePuttStandard+s.scrambleChipThreePuttHard+s.scrambleChipThreePuttBunker,s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function oc(s){return{standard:x(s.scrambleInside2mSavedStandard,s.scrambleInside2mResolvedStandard),hard:x(s.scrambleInside2mSavedHard,s.scrambleInside2mResolvedHard),bunker:x(s.scrambleInside2mSavedBunker,s.scrambleInside2mResolvedBunker),overall:x(s.scrambleInside2mSavedStandard+s.scrambleInside2mSavedHard+s.scrambleInside2mSavedBunker,s.scrambleInside2mResolvedStandard+s.scrambleInside2mResolvedHard+s.scrambleInside2mResolvedBunker)}}function lc(s){return{standard:x(s.strokesVsParMissStandard,s.holesScoredMissStandard),hard:x(s.strokesVsParMissHard,s.holesScoredMissHard),bunker:x(s.strokesVsParMissBunker,s.holesScoredMissBunker),overall:x(s.strokesVsParMissStandard+s.strokesVsParMissHard+s.strokesVsParMissBunker,s.holesScoredMissStandard+s.holesScoredMissHard+s.holesScoredMissBunker)}}function dc(s){const e=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker;return{standard:x(s.scrambleAttemptsStandard,e),hard:x(s.scrambleAttemptsHard,e),bunker:x(s.scrambleAttemptsBunker,e),overall:x(e,e)}}function cc(s){return{par3:x(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:x(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:x(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function uc(s,e){return x(s.doubleBogeyPlus,e)}function hc(s){return x(s.bounceBackSuccesses,s.bounceBackOpportunities)}const pc=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],fc=18;function mc(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const u=c.measures;t+=u.holesScored,i.eagleOrBetter+=u.holesEagleOrBetter,i.birdie+=u.holesBirdie,i.par+=u.holesPar,i.bogey+=u.holesBogey,i.doubleBogeyPlus+=u.doubleBogeyPlus,u.holesScored>0&&(e+=1,n+=u.strokesTotal-u.parTotal);let h=r.get(c.holeCount);if(h||(h={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,h)),h.rounds+=1,!(c.holeCount>0&&u.holesScored===c.holeCount))continue;h.completeRounds+=1;const m=u.strokesTotal-u.parTotal;(h.best===null||m<h.best.vsPar)&&(h.best={vsPar:m,strokes:u.strokesTotal})}const o=[...r.values()].sort((c,u)=>u.holeCount-c.holeCount);let d=0;for(const c of o)d+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:d,lengths:o,avgVsParPer18:x(n*fc,t),scoreTypeCounts:i}}const Tr=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),Pr=Object.freeze({inside2m:1.25,outside2m:2.12}),Cr=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),Ir=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),gc=["scratch","hcp5","hcp12","hcp20"];function ln(s){return s===null?"hcp12":s<2.5?"scratch":s<8.5?"hcp5":s<16?"hcp12":"hcp20"}function bc(s){return Math.round(4*s.eHole[3]+10*s.eHole[4]+4*s.eHole[5])}const yc=Object.freeze({version:"v1-provisional-scratch",calibratedAt:null,eHole:Object.freeze({3:3.25,4:4.15,5:4.85}),eAfterTee:Object.freeze({4:Object.freeze({fairway:2.95,in_play:3.25,trouble:3.7}),5:Object.freeze({fairway:3.65,in_play:3.95,trouble:4.4})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),_c=Object.freeze({version:"v1-provisional-hcp5",calibratedAt:null,eHole:Object.freeze({3:3.4,4:4.45,5:5.1}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.2,in_play:3.6,trouble:4.05}),5:Object.freeze({fairway:3.9,in_play:4.25,trouble:4.55})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),vc=Object.freeze({version:"v1-provisional-hcp20",calibratedAt:null,eHole:Object.freeze({3:3.9,4:5.1,5:5.9}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.85,in_play:4.2,trouble:4.85}),5:Object.freeze({fairway:4.65,in_play:5,trouble:5.65})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),wc=Object.freeze({inside_1m:1.02,"1_to_2m":1.35,"2_to_4m":1.72,"4_to_8m":1.95,over_8m:2.2}),xc=Object.freeze({inside_1m:1.03,"1_to_2m":1.4,"2_to_4m":1.78,"4_to_8m":2.02,over_8m:2.3}),kc=Object.freeze({inside_1m:1.08,"1_to_2m":1.5,"2_to_4m":1.92,"4_to_8m":2.2,over_8m:2.55}),$c=Object.freeze({inside2m:1.19,outside2m:1.96}),Sc=Object.freeze({inside2m:1.22,outside2m:2.03}),Tc=Object.freeze({inside2m:1.29,outside2m:2.22}),Pc=Object.freeze({standard:1.55,hard:1.9,bunker:1.75}),Cc=Object.freeze({standard:1.62,hard:2,bunker:1.85}),Ic=Object.freeze({standard:1.8,hard:2.25,bunker:2.08}),mt=Object.freeze({scratch:Object.freeze({tables:yc,expected:wc,chipOutcome:$c,chipBaseline:Pc}),hcp5:Object.freeze({tables:_c,expected:xc,chipOutcome:Sc,chipBaseline:Cc}),hcp12:Object.freeze({tables:Ir,expected:Tr,chipOutcome:Pr,chipBaseline:Cr}),hcp20:Object.freeze({tables:vc,expected:kc,chipOutcome:Tc,chipBaseline:Ic})}),gt=mt.hcp12,he=["tee","approach","shortGame","putting","penalties"];function Er(s,e=Ir,t=Tr,n=Pr,i=Cr){const r=s.attHolesPar3Gir+s.attHolesPar3Miss,o=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,d=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,c=r+o+d,u={attributed:c,holesScored:s.holesScored};if(c===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const h=o+d,f=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,m=s.attMissStandard+s.attMissHard+s.attMissBunker,_=r*e.eHole[3]+o*e.eHole[4]+d*e.eHole[5],v=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+r*e.eHole[3],k=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m,N=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,B=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,U=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),O=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),ee=s.attStrokes-s.attPutts-s.attPenalties-h-f+k+U-v,ce=f-m+N-B,ue=s.attPutts-(k+N),xa=s.attPenalties,ka=s.attStrokes-_;return{tee:O,approach:ee,shortGame:ce,putting:ue,penalties:xa,total:ka,coverage:u}}function jt(s,e=gt){return Er(s,e.tables,e.expected,e.chipOutcome,e.chipBaseline)}const Rr=9;function Te(s,e){return Nr(s,Ye(s,e))}function qn(s){return Nr(s,s.total)}function Nr(s,e){return e===null||s.coverage.attributed<Rr?null:e*18/s.coverage.attributed}function Ye(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function Or(s,e){const t=n=>Vn(Te(s,n),e.map(i=>Te(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:Vn(qn(s),e.map(qn))}}function dn(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function cn(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function Vn(s,e){if(s===null)return null;const t=cn(e);return t===null?null:s-t}function Ec(s){return s.penalties}const Un=1,Rc=2,Nc=.75,Oc=4,Hc=3,Mc=12,Ac=5,Bc=2,zc=10,Kn=.35;function Lc(s,e,t,n){const i=Or(e,t),r=[];let o=0;const d=(k,N)=>{r.push({line:k,magnitude:N,order:o++})};let c=null,u=null;for(const k of he){const N=dn(i,k);N!==null&&((c===null||N<c.delta)&&(c={component:k,delta:N}),(u===null||N>u.delta)&&(u={component:k,delta:N}))}c!==null&&c.delta<=-Un&&d({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),u!==null&&u.delta>=Un&&d({id:"component_worst_vs_baseline",params:{component:u.component,delta:u.delta}},Math.abs(u.delta));const h=cn(t.map(Ec)),f=e.penalties;h!==null&&f!==null&&f>=h+Rc&&d({id:"penalties_spike",params:{penalties:f,baseline:h}},0),s.teeMissRecorded>=zc&&s.teeMissLeft>=Kn*s.teeMissRecorded&&s.teeMissRight>=Kn*s.teeMissRecorded&&d({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=Hc&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&d({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,_=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;m>=Oc&&_>=Nc*m&&d({id:"scramble_streak",params:{successes:_,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=Mc&&d({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const g=Te(e,"putting"),v=t.map(k=>Te(k,"putting")).filter(k=>k!==null);return g!==null&&v.length>=Ac&&v.every(k=>g<k)&&d({id:"best_putting_round",params:{putting:g,rounds:v.length}},0),s.bounceBackOpportunities>=Bc&&s.bounceBackSuccesses===s.bounceBackOpportunities&&d({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort((k,N)=>N.magnitude-k.magnitude||k.order-N.order),r.slice(0,Math.max(0,n)).map(k=>k.line)}const Hr=["auto",...gc],Ds="auto";function ct(s){switch(s){case"scratch":return"Scratch";case"hcp5":return"5 handicap";case"hcp12":return"12 handicap";case"hcp20":return"20+ handicap"}}function Wn(s){return s==="auto"?"Match my handicap":ct(s)}function Fc(s,e){return s!=="auto"?`About ${bc(mt[s].tables)} shots on a par 72.`:e===null?`No handicap on your profile yet, so this uses the ${ct("hcp12")} reference.`:`Your ${un(e)} handicap puts you on the ${ct(ln(e))} reference.`}function un(s){return s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}function hn(s,e){return s==="auto"?ln(e):s}const Gc=Object.freeze({cohort:ln(null),choice:Ds,handicapIndex:null});function jc(s,e){return{cohort:hn(s,e),choice:s,handicapIndex:e}}function Dc(s){return Hr.includes(s)}const Mr=Xe("tapscore.stats.sgBaseline.v1",{decode:s=>Dc(s)?s:Ds,encode:s=>s,empty:Ds});function qs(s=Z()){return Mr.read(s)}function qc(s,e=Z()){Mr.write(s,e)}const Yn=Object.freeze(Object.keys(Gt));function Vc(s){if(typeof s!="object"||s===null)return[...Yn];const e=s;return Yn.filter(t=>typeof e[t]!="number")}function Dt(s){if(s.length===0)return null;const e=Vc(s[0].measures);if(e.length===0)return null;const t=e.slice(0,3).join(", "),n=e.length>3?` and ${e.length-3} more`:"";return`The server sent stats this app does not understand (missing ${t}${n}).`}const Uc=["tee","approach","putting","shortGame","scoring"];function xs(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const Kc=3,Ar={rounds:[],totals:Gt,waterfall:Er(Gt),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function pn(s,e=gt){const t=ns(s);if(t.length===0)return Ar;const n=Pd(t.map(o=>o.measures)),i=t.map(o=>jt(o.measures,e)),r=t.length;return{rounds:t.map((o,d)=>{const c=i[d];return{id:o.roundId,date:o.date,courseName:o.courseName,name:o.name,holeCount:o.holeCount,strokes:o.measures.holesScored===0?null:o.measures.strokesTotal,vsPar:o.measures.holesScored===0?null:o.measures.strokesTotal-o.measures.parTotal,waterfall:c}}),totals:n,waterfall:jt(n,e),priorities:Wc(i),trends:Yc(t,e),tee:Xc(n,r),approach:Qc(n),putting:Jc(n,e),shortGame:Zc(n),scoring:eu(n,r),results:mc(t)}}function Wc(s){const e=he.map(n=>{const i=s.map(r=>Te(r,n));return{component:n,per18:cn(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>he.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function ks(s){return Sd(s)==="percentage"?s.value:null}function Yc(s,e=gt){const t=[...s].reverse(),n=(i,r,o,d)=>{const c=[];for(const u of t){const h=d(u.measures);h!==null&&c.push(h)}return c.length>=Kc?{id:i,title:r,kind:o,points:c}:null};return[n("fairway","Fairways","percentage",i=>ks(kr(i))),n("gir","Greens","percentage",i=>ks($r(i))),n("putting","Putting","strokesLost",i=>Te(jt(i,e),"putting")),n("scramble","Scrambling","percentage",i=>ks(Sr(i).overall))].filter(i=>i!==null)}function Xc(s,e){return s.teeRecorded<=0?null:{fairway:kr(s),inPlayOnly:x(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:Rd(s),troubleTax:zd(s),vsParByTee:Bd(s),recovery:Md(s),teeMiss:Wd(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:Ad(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:Nd(s),penaltyTax:Hd(s),vsParByPenalty:Od(s),penaltySource:Yd(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function Qc(s){if(s.girRecorded<=0)return null;const e={};for(const t of ze)e[t]=jd(s,t);return{gir:$r(s),girByTee:Ld(s),girFirstPuttMix:e,birdieConversion:Vd(s),hardChipShare:Ud(s),girByPar:Fd(s),greenMiss:Kd(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:Gd(s)}}function Jc(s,e){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const t={};for(const n of ze)t[n]=qd(s,n);return{ladder:ze.map(n=>{const i=is(s,n),r=e.expected[n];return{bucket:n,made:Xd(s,n),baseline:Math.max(0,2-r),cost:i>0?Cd(s,n)-i*r:null}}),firstPuttSpread:t,threePutt:Qd(s),threePuttsFromOver8m:ec(s),puttsPerGirHole:tc(s),puttsAfterMissedGreen:sc(s),puttDistribution:Jd(s),puttsPerHoleByPar:Zd(s)}}function Zc(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:Sr(s),mix:dc(s),outcomes:ac(s),savedInside2m:oc(s),missCost:lc(s),chipInside2m:rc(s),conversionInside2m:x(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:nc(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,extraShortGameStrokes:ic(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded}}function eu(s,e){return s.holesScored<=0?null:{avgVsParByParGroup:cc(s),doubleBogeyPlusPerRound:uc(s,e),bounceBack:hc(s)}}function Br(s){let e=0;for(const t of s)for(const n of he){const i=Ye(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function tu(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function fn(s){const e=Y.get(We);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function su(s){const e=Y.get(We);return e.load(),e.labelOf(s)??s}function nu(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:Oo(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(fn).join(" · ")}))}function iu(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function ut(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function qt(s){return s.courseName?ut(s)===s.courseName?null:s.courseName:null}function Fe(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const ot={fromMyRounds:nu,fromDeviceRounds:iu},zr="—";function de(s){return s.d<=0||s.value===null?null:`${Math.round(s.value*100)}%`}function ru(s){return s.d<=0?null:`${ae(s.n)} of ${ae(s.d)}`}function $s(s){const e=de(s);if(e===null)return null;const t=ru(s);return t===null?e:`${e} (${t})`}function ie(s,e=2,t=!1){return s.d<=0||s.value===null?null:t?we(s.value,e):Pe(s.value,e)}function Ge(s){return{one:s,many:`${s}s`}}const _e=Ge("round"),Q=Ge("hole"),Ht=Ge("green");function au(s,e){return s.d<=0?null:`over ${ne(s.d,e)}`}function Xn(s,e){const t=ie(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=au(s,e.unit);return i===null?n:`${n} (${i})`}const Lr={one:"hole from trouble",many:"holes from trouble"},ou={one:"from the fairway",many:"from the fairway"};function lu(s){const e=s.trouble.d,t=s.fairway.d;return e<=0||t<=0?null:`over ${ne(e,Lr)} vs ${ne(t,ou)}`}function Fr(s,e,t,n){return s.d<=0||t.d<=0?null:`over ${ne(s.d,e)} vs ${ne(t.d,n)}`}const Gr={one:"hole with the green missed",many:"holes with the green missed"},jr={one:"green hit",many:"greens hit"},du={one:"hole with a penalty",many:"holes with a penalty"},cu={one:"without",many:"without"},uu=Ge("penalty hole");function hu(s){return Fr(s.miss,Gr,s.hit,jr)}function pu(s){return Fr(s.penalty,du,s.clean,cu)}function rs(s){const e=s.filter(n=>n.d>0).map(n=>ne(n.d,n.unit)),t=e.pop();return t===void 0?null:e.length===0?`over ${t}`:`over ${e.join(", ")} and ${t}`}const fu={one:"hole from the fairway",many:"holes from the fairway"},mu={one:"hole in play",many:"holes in play"},gu=Ge("par 3"),bu=Ge("par 4"),yu=Ge("par 5");function _u(s){return rs([{d:s.fairway.d,unit:fu},{d:s.inPlay.d,unit:mu},{d:s.trouble.d,unit:Lr}])}function Qn(s){return rs([{d:s.par3.d,unit:gu},{d:s.par4.d,unit:bu},{d:s.par5.d,unit:yu}])}function vu(s){return rs([{d:s.hit.d,unit:jr},{d:s.miss.d,unit:Gr}])}function ae(s){return s===Math.round(s)?String(Math.round(s)):Pe(s,1)}function ne(s,e){return`${ae(s)} ${s===1?e.one:e.many}`}function Pe(s,e=1){return s.toFixed(e)}function we(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return Pe(0,e);const i=Pe(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function wu(s){return s===null?zr:we(s,1)}function xu(s){return`${we(s)} per 18`}function as(s){return s===0?"E":we(s,s===Math.round(s)?0:1)}function os(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function Ss(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function ku(s){return s==="indoor"?"Indoor":"Outdoor"}function $u(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function Dr(s){return Fe(s)}const qr="Statistics",Su="All statistics →";function Tu(s){return s==="custom"?Ft:s}function Pu(s,e,t){return on(s)!==null||!t?Lt(s):`${Lt(s)} — newest ${e}`}function Cu(s){return x(s.strokesTotal-s.parTotal,s.holesScored)}function Iu(s){const e=[],t=Cu(s.totals),n=ie(t,2,!0);n!==null&&e.push({id:"vsPar",value:n,label:"Vs par per hole"});const i=s.tee,r=i===null?null:de(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit"});const o=s.approach,d=o===null?null:de(o.gir);return d!==null&&e.push({id:"gir",value:d,label:"Greens in regulation"}),e}function Eu(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${os(e.component)}`}function Ru(s){const e=Tu(s.preset),t=vr(e,at,s.rows,s.now);if(t.length===0)return null;const n=pn(t,s.bundle??gt),i=Iu(n);if(i.length===0)return null;const r=wr({preset:e,filter:at,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:Pu(e,t.length,r),tiles:i,priorityLine:Eu(n)}}function Nu(s){const e=s.tiles.map(n=>`${n.label} ${n.value}`),t=[`${qr}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class ls{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(js());sgChoice=new p(qs());profile=Y.get(Ie);loaded=!1;loading=!1;card=new T(()=>{const e=this.rows.get();if(e===null)return null;const t=hn(this.sgChoice.get(),this.profile.player.get()?.handicapIndex??null);return Ru({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date,bundle:mt[t]})});refreshPreset(){this.preset.set(js()),this.sgChoice.set(qs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await w.playerStats.myStats({limit:ls.PAGE_SIZE});if(Dt(t.rounds)!==null)return;this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof J&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const xn=class xn extends M{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(C(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};xn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let Vs=xn;const A=s=>`var(--${s})`;let Ou=0;const kn=class kn extends M{constructor(){super(...arguments),this.returnFocusTo=null,this.wasOpen=!1}render(){const e=document.createElement("div"),t=(u,h)=>{typeof h=="function"?this.track(C(()=>{u.textContent=h()})):u.textContent=h};this.spawn(Vs,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200",this.dialogEl.setAttribute("role","dialog"),this.dialogEl.setAttribute("aria-modal","true"),this.dialogEl.setAttribute("tabindex","-1");const n=`ui-confirm-${++Ou}`,i=document.createElement("h2");i.className="ui-confirm__title",i.id=`${n}-title`,t(i,this.props.title??"Confirm"),this.dialogEl.setAttribute("aria-labelledby",i.id),this.dialogEl.appendChild(i);const r=document.createElement("p");r.className="ui-confirm__message",r.id=`${n}-message`,t(r,this.props.message),this.dialogEl.setAttribute("aria-describedby",r.id),this.dialogEl.appendChild(r);const o=document.createElement("div");o.className="ui-confirm__actions";const d=document.createElement("button");d.className="ui-confirm__btn ui-confirm__btn--cancel",t(d,this.props.cancelLabel??"Cancel"),d.addEventListener("click",u=>{u.stopPropagation(),this.handleCancel()}),o.appendChild(d),this.cancelEl=d;const c=document.createElement("button");return c.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(c,this.props.confirmLabel??"Confirm"),c.addEventListener("click",u=>{u.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),o.appendChild(c),this.confirmEl=c,this.dialogEl.appendChild(o),this.dialogEl.addEventListener("click",u=>u.stopPropagation()),this.dialogEl.addEventListener("keydown",u=>this.onKeydown(u)),e.appendChild(this.dialogEl),this.track(C(()=>{const u=this.props.open.get();u&&this.dialogEl.removeAttribute("inert"),this.dialogEl.classList.toggle("open",u),u||this.dialogEl.setAttribute("inert",""),u!==this.wasOpen&&(this.wasOpen=u,u?this.captureFocus():this.restoreFocus())})),e}onMount(){this.props.open.get()&&!this.dialogEl.contains(document.activeElement)&&this.captureFocus()}captureFocus(){const e=document.activeElement;this.returnFocusTo=e instanceof HTMLElement?e:null,this.cancelEl.focus()}restoreFocus(){const e=this.returnFocusTo;this.returnFocusTo=null,e&&e.isConnected&&e.focus()}onKeydown(e){if(!this.props.open.get())return;if(e.key==="Escape"){e.preventDefault(),e.stopPropagation(),this.handleCancel();return}if(e.key!=="Tab")return;const t=this.cancelEl,n=this.confirmEl,i=document.activeElement;e.shiftKey&&(i===t||i===this.dialogEl)?(e.preventDefault(),n.focus()):!e.shiftKey&&i===n&&(e.preventDefault(),t.focus())}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}onDestroy(){this.wasOpen&&this.restoreFocus()}};kn.styles=`
        ...
        .ui-confirm__btn {
            ...
            align-items: center;
            justify-content: center;
            min-height: ${co("confirm-btn-min-height")};
            padding: 9px 20px;
            font-size: 13px;
            line-height: 20px;
            font-family: ${A("font-ui")};
    ...
    `;let oe=kn;async function Hu(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Mu="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Ee(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Se(s){const e=()=>al(s());return{avatarPhoto:{src:()=>e()??Mu,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return ol(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Le(s,e="0.85rem"){return`
        position: relative;
    ...
    `}const Au="/tapscore/";function Bu(s=Au){const e=s.trim().replace(/\/+$/,"");return`${e===""?"":e}/manage/`}function zu(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.canManageCourses&&e.push({kind:"course-setup",label:"Course setup"}),s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Lu(s){return zu(s).map(e=>e.kind)}function Jn(s){return s.signedIn?"avatar":"signin"}const Fu=b(`
...
`),Yu='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',mn=`
...
`,Xu=b(`
    <div class="round-row">
        ...
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Yu}</button>
...
`),sh='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',nh=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${mn}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${sh}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
    </div>
`);class ih extends M{static styles=`
        .history {
...
`),ds='<button bind="infoTrigger" class="stats__info" type="button"></button>',cs=`
...
`;function Wr(s,e,t=""){const n=t?`info-dot ${t}`:"info-dot";return`<button bind="${s}" class="${n}" type="button" aria-label="${e}"><span aria-hidden="true">i</span></button>`}const Yr=`
        .info-dot {
            flex: none;
            appearance: none;
            ...
            &:hover { color: ${l("text")}; }
            &.hidden { display: none; }
        }`,Ne=60,si=8,Us=4,uh=Array.from({length:Us*2+1},(s,e)=>e-Us),hh="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",ph=b(`
    ...
    <div class="se-row">
        <div class="se-row__who">
            ...
            <span class="se-row__hcpline">
                ...
                ${Wr("hcpInfo","How this handicap was calculated","hidden")}
            </span>
        </div>
...
`),_h=b('<button bind="btn" class="se-seg" type="button"></button>'),ri=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),vh=b('<div bind="rule" class="se-stats__rule"></div>');class wh extends M{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
...
<tr class="lb-rank__panel${O?" lb-rank__panel--open":""}" data-panel-key="${F(U)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${F(ee)}"><div class="lb-rank__panelbox">${ce}</div></div></td>
</tr>`}).join(""),u=r?`
...
</div>`}function Uh(s,e){const t=Rh(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",o=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const Kh={ranked:Vh,match_summary:(s,e)=>Uh(s,e)},Wh={"default-score-grid":Fh,"compact-match-grid":Gh,"category-matrix-grid":jh};function Yh(s){return`<div class="lb-diag">Unrenderable result section <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Xh(s){return`<div class="lb-diag">Unsupported score-grid component <code>${F(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Qh(s,e,t,n=null){const i=Kh[s.kind];return i?i(s,e,t,n):Yh(s.kind)}function ea(s,e,t,n){const i=Qr(s),r=Wh[i];return r?r(s,e,t,n):Xh(i)}function ta(s,e,t=Zr,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${F(s.formatLabel)}.</div>`:s.leaderboard.map(r=>Qh(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${F(s.formatLabel)}.</div>`}function sa(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>ea(r,e,t,{mode:i})).join(`
`)}const Jh=b(`
...
`);class _n extends M{static styles=`
    ...
    `;svc=this.inject(ge);expansion=new Hh;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Jh,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=u=>{const h=this.svc.nameOf(u);return this.svc.isPending(u)?`${h} (open seat)`:h},i=u=>this.svc.groupLabelOf(u),r=Oh(t);this.expansion.retain(r.attached.keys());const o=ta(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),d=sa(r.standalone,e.routeSections,n),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return o+c}}function Zh(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const ep=b(`
...
`);class sp extends M{static styles=`
    ...
    `,lt.seq=0;let pe=lt;function ip(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function rp(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function ap(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const op=b(`
...
`);class mp extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(V);router=this.inject(q);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return hp(this.svc.startList.get())}eligible(){return this.policyState().visible&&up(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,w.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await w.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof J&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(C(()=>this.ensureTeesLoaded()));const e=new T(()=>pp(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(C(()=>{const r=e.get(),o=this.groupChoice.get();(!o||!r.options.some(d=>d.value===o&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(fp,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new pe({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new pe({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const li=1440*60*1e3;function gp(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>li?!0:e-t>=li}function bp(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function yp(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!bp(s.balls,s.playerId)||!gp(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ve(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Ut(s){return s<0?`+${String(-s)}`:String(s)}const _p=b(`
...
`);class vp extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(V);profile=this.inject(Ie);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return yp({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Ut(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ve(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(C(()=>this.ensureProfileLoaded())),this.wire(_p,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Ut(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function wp(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const xp=b(`
...
`);class kp extends M{static styles=`
...
`);class Hp extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(V);router=this.inject(q);stage=new p("prompt");error=new p("");render(){this.track(C(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(Op,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>Sp(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(_n,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=ra(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return $p({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return na({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:ia({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Be{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(js());filter=new p(at);sgChoice=new p(qs());profile=Y.get(Ie);handicapIndex=new T(()=>this.profile.player.get()?.handicapIndex??null);sgCohort=new T(()=>hn(this.sgChoice.get(),this.handicapIndex.get()));sgBundle=new T(()=>mt[this.sgCohort.get()]);sgInfo=new T(()=>jc(this.sgChoice.get(),this.handicapIndex.get()));extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;windowRounds=new T(()=>vr(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));model=new T(()=>pn(this.windowRounds.get(),this.sgBundle.get()));courses=new T(()=>xd(this.loadedRounds.get()));overFiltered=new T(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await L(this.loading,this.error,()=>w.playerStats.myStats({limit:Be.PAGE_SIZE}));if(!t)return;const n=Dt(t.rounds);if(n!==null){this.error.set({code:"server",message:n});return}this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),await this.extendIfNeeded()}select(e){this.preset.set(e),Dn(e),this.extendIfNeeded()}selectSgBaseline(e){this.sgChoice.set(e),qc(e)}async loadHandicap(){await this.profile.load()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),Dn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(at),this.select(Ft)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Be.MAX_PAGES&&wr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await w.playerStats.myStats({limit:Be.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}const n=Dt(t.rounds);if(n!==null){this.extendError.set({code:"server",message:n});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Be.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(at),this.pagesFetched=0,this.cursor=null}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class pt{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=Y.get(Be);inFlight=null;sgInfo=this.dashboard.sgInfo;model=new T(()=>{const e=this.round.get();return e===null?null:Ep({round:e,holes:this.holes.get(),history:this.history.get(),bundle:this.dashboard.sgBundle.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.dashboard.loadHandicap(),this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await w.playerStats.myRoundStats({roundId:e})}catch(o){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(ui(o)),this.failure.set(hi(o));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(o){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(ui(o)),this.failure.set(hi(o));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(o=>o.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(o=>o.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=o=>{for(const d of o)n.has(d.roundId)||(n.add(d.roundId),t.push(d))};if(i(this.dashboard.loadedRounds.get()),di(t,e,Ws))return t;let r=null;for(let o=0;o<pt.MAX_PAGES;o++){const d=await w.playerStats.myStats({limit:pt.PAGE_SIZE,cursor:r??void 0}),c=Dt(d.rounds);if(c!==null)throw new Error(c);if(i(d.rounds),di(t,e,Ws)||d.nextCursor===null)return t;r=d.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function ui(s){if(s instanceof J){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function hi(s){return s instanceof J&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const le=100,aa=88,Ys=56,pi=56;function us(s){return s>0?"loss":s<0?"gain":"zero"}function Qe(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function H(s){return String(Math.round(s*1e3)/1e3)}function hs(s){return s<0?0:s>1?1:s}function Ce(s,e){return`<svg class="chart" viewBox="0 0 ${le} ${H(s)}" preserveAspectRatio="none" style="height:${H(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function vn(s,e,t,n=1){return`<path d="M${H(s)} 0 L${H(s)} ${H(e)}" stroke="${t}" stroke-width="${H(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function me(s,e,t,n,i){return`<rect x="${H(s)}" y="${H(e)}" width="${H(t)}" height="${H(n)}" fill="${i}"/>`}const Mp=1;function Ap(s,e){const t=le/2,n=us(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:Mp,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function oa(s,e,t,n=10){const i=Ap(s,e),r=i.bar&&i.bar.width>0?me(i.bar.x,0,i.bar.width,n,Qe(i.tone,t)):"";return Ce(n,[me(0,0,le,n,t.track),r,vn(i.zeroX,n,t.rule)].join(""))}function Bp(s){const e=[];let t=0;for(const n of s){const i=le*hs(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function zp(s,e,t=12){const n=Bp(s).filter(i=>i.width>0).map(i=>me(i.x,0,i.width,t,i.color)).join("");return Ce(t,me(0,0,le,t,e.track)+n)}const fi=2,Lp=1e-4;function Fp(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=fi,o=Math.max(0,e-fi*2);return s.map((d,c)=>({x:s.length===1?le/2:c/(s.length-1)*le,y:i===0?e/2:r+o-(d-t)/i*o}))}function Gp(s){return s.map((e,t)=>`${t===0?"M":"L"}${H(e.x)} ${H(e.y)}`).join(" ")}function jp(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Lp?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Dp(s,e,t,n=34){const i=Fp(s,n);if(i.length===0)return Ce(n,"");const r=Qe(jp(s,e),t),o=`<path d="${Gp(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,d=i[i.length-1],c=`<path d="M${H(d.x)} ${H(d.y)} L${H(d.x)} ${H(d.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Ce(n,o+c)}const qp=.5;function Vp(s,e,t=12){const n=le/2,i=he.length-1,r=Math.max(1,(t-i)/he.length),o=[];return he.forEach((d,c)=>{const u=Ye(s,d);if(u===null||!(e>0))return;const h=Math.max(u===0?0:qp,n*Math.min(1,Math.abs(u)/e));o.push({component:d,x:u>=0?n:n-h,y:c*(r+1),width:h,height:r,tone:us(u)})}),o}function Up(s,e,t,n=12){const i=Vp(s,e,n).filter(r=>r.width>0).map(r=>me(r.x,r.y,r.width,r.height,Qe(r.tone,t))).join("");return Ce(n,vn(le/2,n,t.rule)+i)}const la=1,mi=.02;function Kp(s,e){const t=e>0?le*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=hs(s),i=e<=0?"neutral":s>e+mi?"gain":s<e-mi?"loss":"neutral";return{bar:{width:Math.max(la,le*n),tone:i},tickX:t}}function Wp(s,e,t,n=10){const i=Kp(s,e),r=i.bar?me(0,0,i.bar.width,n,Qe(i.bar.tone,t)):"",o=i.tickX===null?"":vn(i.tickX,n,t.rule,2);return Ce(n,me(0,0,le,n,t.track)+r+o)}function Yp(s){return s===null?null:Math.max(la,le*hs(s))}function da(s,e,t=e.neutral,n=8){const i=Yp(s),r=i===null?"":me(0,0,i,n,t);return Ce(n,me(0,0,le,n,e.track)+r)}const gi=100,Kt=50,Xp=16,Pt=22,bi=44,Qp=3,Jp=33,Zp={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function it(s,e){const t=(s-90)*Math.PI/180;return{x:Kt+e*Math.cos(t),y:Kt+e*Math.sin(t)}}function yi(s,e,t,n){const i=e-s>180?1:0,r=it(s,n),o=it(e,n),d=it(e,t),c=it(s,t);return`M${H(r.x)} ${H(r.y)} A${H(n)} ${H(n)} 0 ${i} 1 ${H(o.x)} ${H(o.y)} L${H(d.x)} ${H(d.y)} A${H(t)} ${H(t)} 0 ${i} 0 ${H(c.x)} ${H(c.y)} Z`}function ef(s){const e=Math.max(s.long,s.short,s.left,s.right),t=Qp/2,n=[];for(const i of["long","right","short","left"]){const r=Zp[i],o=r.from+t,d=r.to-t,c=e>0?hs(s[i]/e):0,u=Pt+(bi-Pt)*c,h=it((r.from+r.to)/2,Jp);n.push({id:i,trackPath:yi(o,d,Pt,bi),valuePath:yi(o,d,Pt,u),labelX:h.x,labelY:h.y})}return n}function tf(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${H(Kt)}" cy="${H(Kt)}" r="${H(Xp)}" fill="${t.track}"/>`+s.map(r=>`<text x="${H(r.labelX)}" y="${H(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${gi} ${gi}" preserveAspectRatio="xMidYMid meet" style="width:${H(n)}px;height:${H(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const sf=60,Wt=58,nf=2,rf={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function af(s,e){const t=Wt-nf,n=o=>e>0?o/e*t:0,i=[],r=(o,d)=>{const c=rf[o];let u=Wt;for(const h of d){const f=n(h.count);u-=f,i.push({id:h.id,column:o,tone:h.tone,x:c.x,y:u,width:c.width,height:f})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function of(s,e,t){const n=s.filter(i=>i.height>0).map(i=>me(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${H(Wt)} L${H(le)} ${H(Wt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return Ce(sf,n)}const ps={gain:l("accent-strong"),loss:l("danger"),zero:l("border-strong"),neutral:l("accent"),track:l("surface-sunken"),rule:l("border")},$={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",filterBaseline:"Compared to",filterBaselineHint:"Which player the strokes-gained rows measure you against. It does not change which rounds are in the window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",penaltyTax:"Extra strokes per hole on the holes where you took a penalty, against your own penalty-free holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",noValue:zr,proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate your reference expects from that distance. For the two longest bands it sits at zero: the reference expects two putts from there, so any make is ahead of it.",ladderCost:"Cost is how many strokes this distance has cost you across the window, against the reference you picked. Plus means it cost you shots; minus means you gained them.",costOfMissedGreen:"What a hole costs you against par on average with the green hit, and with it missed.",missedGreenTax:"The difference between what a hole costs you with the green hit and with it missed.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",puttsByPar:"Putts per hole on each kind of hole — every hole you recorded putts on, green hit or not.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",scrambling:"Missed greens where you still got up and down for par or better.",sandSave:"Missed greens from a bunker where you still got up and down.",missMixHead:"What your missed greens leave you",missMix:"How your missed greens split between standard, hard and bunker lies. It describes the trouble your approaches leave behind, not how you play from it.",chipOutcomes:"What each missed green turned into. The rows share the same denominator — that difficulty’s attempts — so they add up to 100%. Holes where you did not count chips are treated as one chip.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",savedInside2m:"Chips that finished inside 2 m where the next putt went in. Beside “Chipped to inside 2 m” it splits a failed scramble into its two causes: a chip left too far out, or a makeable putt missed.",missCost:"Your average score against par on the holes where you missed the green, split by how hard the recovery was. The gap between the rows is what a hard miss actually costs over a standard one.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",avgVsParByPar:"Your average score against par on each kind of hole.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function G(s,e,t){return{kind:"bar",id:s,title:e,share:t.value,value:de(t)}}function K(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}const lf=["Holed","Cost"];function df(s){const e=s.value===null?$.notRecorded:`${s.value} holed`;if(s.cost===$.noValue)return`${s.title}, ${e}, ${$.notRecorded}`;const t=s.cost.replace(/^[+\u2212]/,"");return s.cost.startsWith("+")?`${s.title}, ${e}, ${t} strokes lost`:s.cost.startsWith("−")?`${s.title}, ${e}, ${t} strokes gained`:`${s.title}, ${e}, level`}function cf(s,e){switch(s){case"tee":{const t=e.tee&&$s(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&$s(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":return e.putting?Xn(e.putting.puttsPerGirHole,{unit:Ht,label:"putts per green hit"}):null;case"shortGame":{const t=e.shortGame&&$s(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?Xn(e.scoring.doubleBogeyPlusPerRound,{unit:_e,label:"doubles or worse per round"}):null}}function uf(s){return K("troubleTax","Trouble tax",ie(s.troubleTax,2,!0),null)}function qe(s){return ie(s,2,!0)}function hf(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>de(i)??"",n=(i,r)=>`${i} ${de(r)??$.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:ef(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function pf(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:af(e,s.teeRecorded),text:[`Left ${ae(e.leftInPlay+e.leftTrouble)}`,`Fairway ${ae(e.fairway)}`,`Right ${ae(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function ff(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function _i(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:t.fairway.value,value:de(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:t.inPlayOnly.value,value:de(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:t.trouble.value,value:de(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:$.teeFanHead},pf(t)]:[],...ff(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},K("vsParFairway","From the fairway",qe(t.vsParByTee.fairway)),K("vsParInPlay","From in play",qe(t.vsParByTee.inPlay)),K("vsParTrouble","From trouble",qe(t.vsParByTee.trouble))]:[],uf(t),G("recovery","Recovery",t.recovery),...t.penaltiesRecordedHoles>0?[K("penalties","Penalties",ie(t.penaltiesPerRound,2)),G("penaltyHoleShare","Holes with a penalty",t.penaltyHoleShare),K("penaltyTax","Penalty tax",ie(t.penaltyTax,2,!0))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:$.greenMissHead},hf(t)]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},G("girFairway","From the fairway",t.girByTee.fairway),G("girInPlay","From in play",t.girByTee.inPlay),G("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},G("girPar3","Par 3",t.girByPar.par3),G("girPar4","Par 4",t.girByPar.par4),G("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"Proximity with GIR"},...ze.map(n=>G(`mix-${n}`,Ss(n),t.girFirstPuttMix[n])),G("birdieConversion","Birdie conversion",t.birdieConversion),...t.hardChipShare.d>0?[G("hardChipShare","Hard misses",t.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},K("vsParGreenHit","Green hit",ie(t.costOfMissedGreen.hit,2,!0)),K("vsParGreenMissed","Green missed",ie(t.costOfMissedGreen.miss,2,!0)),K("missedGreenTax","Missed-green tax",ie(t.costOfMissedGreen.delta,2,!0))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[ze[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},...ze.map(n=>G(`spread-${n}`,Ss(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"columns",id:"ladderCols",cells:[...lf]},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:Ss(n.bucket),made:n.made.value,baseline:n.baseline,value:de(n.made),cost:wu(n.cost)})),...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},G("putts-zero","No putts",t.puttDistribution.zero),G("putts-one","One putt",t.puttDistribution.one),G("putts-two","Two putts",t.puttDistribution.two),G("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],G("longThreePutt","Three-putts from over 8 m",t.threePuttsFromOver8m),K("puttsPerGir","Putts per green hit",ie(t.puttsPerGirHole,2)),...t.puttsAfterMissedGreen.d>0?[K("puttsAfterMissedGreen","Putts after a missed green",ie(t.puttsAfterMissedGreen,2))]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},K("puttsPar3","Par 3",ie(t.puttsPerHoleByPar.par3,2)),K("puttsPar4","Par 4",ie(t.puttsPerHoleByPar.par4,2)),K("puttsPar5","Par 5",ie(t.puttsPerHoleByPar.par5,2))]:[]]:[]}case"shortGame":{const t=e.shortGame;if(!t)return[];const n=(i,r,o,d)=>d>0?[{kind:"subhead",id:`${i}Head`,text:r},G(`${i}ChipIn`,"Holed the chip",o.chipIn),G(`${i}OnePutt`,"One putt",o.onePutt),G(`${i}TwoPutt`,"Two putts",o.twoPutt),G(`${i}ThreePutt`,"Three or more putts",o.threePlus),...t.shortGameStrokesRecorded>0?[G(`${i}MultiChip`,"More than one chip",o.multiChip)]:[]]:[];return[{kind:"subhead",id:"missMixHead",text:$.missMixHead},{kind:"split",id:"difficultyMix",segments:[{id:"standard",title:"Standard",tone:"fairway",share:t.mix.standard.value,value:de(t.mix.standard)},{id:"hard",title:"Hard",tone:"inplay",share:t.mix.hard.value,value:de(t.mix.hard)},...t.scrambleAttemptsBunker>0?[{id:"bunker",title:"Bunker",tone:"trouble",share:t.mix.bunker.value,value:de(t.mix.bunker)}]:[]]},{kind:"subhead",id:"scrambleHead",text:"Scrambling"},G("scrambleStandard","Standard",t.scramble.standard),G("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[G("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[G("sandSave","Sand save",t.sandSave)]:[],...t.shortGameStrokesRecorded>0?[K("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes))]:[],...n("afterStandard","After a standard chip",t.outcomes.standard,t.scramble.standard.d),...n("afterHard","After a hard chip",t.outcomes.hard,t.scramble.hard.d),...n("afterBunker","After a bunker shot",t.outcomes.bunker,t.scrambleAttemptsBunker),...t.missCost.standard.d>0||t.missCost.hard.d>0||t.missCost.bunker.d>0?[{kind:"subhead",id:"missCostHead",text:"Average vs par, by how hard the miss was"},K("missCostStandard","Standard",qe(t.missCost.standard)),K("missCostHard","Hard",qe(t.missCost.hard)),...t.scrambleAttemptsBunker>0||t.missCost.bunker.d>0?[K("missCostBunker","Bunker",qe(t.missCost.bunker))]:[]]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},G("chipStandard","Standard",t.chipInside2m.standard),G("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[G("chipBunker","Bunker",t.chipInside2m.bunker)]:[],G("savedInside2m","Saved when inside 2 m",t.savedInside2m.overall),G("conversionInside2m","Holed from inside 2 m",t.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},K("chipInsStandard","Standard",ae(t.chipIns.standard)),K("chipInsHard","Hard",ae(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[K("chipInsBunker","Bunker",ae(t.chipIns.bunker))]:[]]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>ie(i,2,!0);return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},K("par3","Par 3",n(t.avgVsParByParGroup.par3)),K("par4","Par 4",n(t.avgVsParByParGroup.par4)),K("par5","Par 5",n(t.avgVsParByParGroup.par5)),K("doubles","Doubles or worse",ie(t.doubleBogeyPlusPerRound,2)),G("bounceBack","Bounce-back",t.bounceBack)]}}}function mf(s){if(!s||s.rounds===0)return"";const e=ne(s.rounds,_e),t=s.lengths[0];if(s.lengths.length===1&&t)return`${e} — ${ne(t.holeCount,Q)}`;const n=s.lengths.map(i=>`${ae(i.rounds)} × ${ne(i.holeCount,Q)}`).join(", ");return`${e} — ${n}`}function gf(s){return s===18?"Best 18":s===9?"Best 9":`Best ${ae(s)} holes`}const bf=18;function yf(s){const e=s.lengths.some(i=>i.holeCount!==bf),t=s.holesScored!==s.holesExpected;if(!e&&!t)return null;const n=`over ${ne(s.holesScored,Q)}`;return e?`${n}, scaled to 18`:n}function Rs(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:we(s.avgVsParPer18.value,1),qualifier:yf(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:gf(t.holeCount),value:as(n.vsPar),qualifier:`${ae(n.strokes)} strokes`,hero:!1})}return e}function _f(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function Ct(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return pc.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:_f(t),share:x(n,e).value,value:de(x(n,e))??$.noValue}})}function vf(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function vi(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const ye={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s,e){const t=s?.baseline??Gc,n=e===void 0?mt[t.cohort].tables.calibratedAt:e,i=`under “${$.filterBaseline}” in Filters`,r=ct(t.cohort),o=t.choice!=="auto"?`Measured against the ${r} reference — you picked this ${i}.`:t.handicapIndex===null?`Measured against the ${r} reference — no handicap on your profile yet. Change it ${i}.`:`Measured against the ${r} reference — matched to your ${un(t.handicapIndex)} handicap. Change it ${i}.`,d="Each tier is one set of expected scores per hole and per lie.";return n===null?`${o} ${d} The tiers are still provisional, so treat the order of the rows as the reading and the sizes as rough.`:`${o} ${d} This tier was frozen on ${n}. Everyone on this reference is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${Rr} attributed holes is left out of the comparison entirely.`},total(s){const e=wf(s.rowsPer18);if(e===null)return null;const t=we(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${ne(e.recorded,uu)} you labelled, ${ae(e.tee)} came off the tee, ${ae(e.approach)} on the approach and ${ae(e.short)} around the green.`}};function wf(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function Yt(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Xt(s){const e=[{id:"holes",title:"Holes counted",body:ye.holesCounted(s)},{id:"rows",title:"The five rows",body:ye.fiveRows()},{id:"baseline",title:"The baseline",body:ye.baseline(s)},{id:"per18",title:"Per 18 holes",body:ye.per18()}],t=ye.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=ye.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:$.penaltySourceInfoTitle,body:n}),e}const te={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},wi={title:"Your round",seeWholeRound:"See the whole round"};function xf(s){const e=[Dr(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function ca(s,e){return s===null?null:e===null?String(s):`${s} (${as(e)})`}function kf(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function $f(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function Sf(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${as(s.vsPar)})`}function Tf(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function Pf(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function Cf(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function If(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function wn(s){const e=[],t=Sf(s);return t!==null&&e.push({label:"Score",value:t}),s.tee!==null&&e.push({label:"Tee shot",value:Tf(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:Pf(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:Cf(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Ef(s){return s===null?[]:wn(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function xi(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push(If(s.marker).toLowerCase())):e.push("no score");for(const t of wn(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function ua(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=Pe(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function ki(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function Ns(s,e=1){return typeof s=="number"?Pe(Math.abs(s),e):""}function Oe(s){return typeof s=="number"?String(Math.round(s)):""}function $i(s){return typeof s=="string"?s:"tee"}function Rf(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${ki($i(e.component))} was ${Ns(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${ki($i(e.component))} cost you ${Ns(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${Ns(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Oe(e.left)} left and ${Oe(e.right)} right of ${Oe(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Oe(e.successes)} of the ${Oe(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Oe(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Oe(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Nf=b(`
...
${cs}
    `;round=this.inject(ge);stats=this.inject(pt);auth=this.inject(V);router=this.inject(q);colors=ps;infoOpen=new p(!1);render(){this.track(C(()=>{const i=this.eligibleRoundId();se(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Nf,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>wi.title,score:()=>{const i=e();return i===null?"":ca(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>$.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ye.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>wi.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ye(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...he],(i,r,o)=>this.wireEl(Hf,{label:()=>os(i),amount:{textContent:()=>{const d=n(i);return d===null?$.notRecorded:we(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Qe(us(d),this.colors)}`}}},o),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Xt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:he.map(r=>Te(i.waterfall,r)),penaltySource:Yt(i.panels.totals),baseline:this.stats.sgInfo.get()})},(i,r,o)=>this.wireEl(yt,{ctitle:()=>i.title,ctext:()=>i.body},o),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,o)=>this.wireEl(Of,{text:()=>Rf(i)},o),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:na({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ia({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return te.waterfallHint;let t=null;for(const n of he){const i=dn(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?te.waterfallHint:ua(t,e.windowCount)}}function Si(s){return!(!s.pageVisible||s.status==="complete")}function Af(s,e){return e&&!s}const Bf=2,Ti=3,zf=75e3;function Lf(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${W}/friendly-rounds/events?${t.toString()}`}function Ff(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Gf(s){const e=s.eventSourceFactory??(B=>new EventSource(B)),t=s.setTimer??((B,U)=>setTimeout(B,U)),n=s.clearTimer??(B=>clearTimeout(B)),i=s.livenessTimeoutMs??zf,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let o=!1,d=0,c=null,u=null,h=s.since??null;const f=()=>{u!==null&&(n(u),u=null)},m=()=>{f(),u=t(k,i)},_=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{o=!0,f(),_()},v=()=>{if(_(),++d>=Ti){g(),s.onDegrade();return}N()};function k(){if(!o){if(!r()){m();return}v()}}function N(){if(o)return;let B;try{B=e(Lf(s.token,h))}catch{g(),s.onDegrade();return}c=B,B.onopen=()=>{d=0},B.onmessage=U=>{if(o||c!==B)return;m();let O;try{O=JSON.parse(U.data)}catch{return}Ff(O)&&(O.latestEventId!==null&&(h=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},B.onerror=()=>{o||c!==B||(B.readyState===Bf||++d>=Ti)&&(g(),s.onDegrade())},m()}return N(),{stop:()=>{o||g()}}}const jf=2e4;function Df(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const qf=b(`
...
`),Vf=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Uf=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Kf extends M{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class xm extends M{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`),Cm='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',Im=b(`
...
`),Ai=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Cm}</button>
    </div>
`);class Em extends M{static styles=`
        .friends {
...
`);function ba(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Nl(s),subtitle:()=>Ol(s,Fe),progress:()=>Hl(s)}}function ya(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class Bm extends M{static styles=`
    ...
    `;svc=this.inject(ss);auth=this.inject(V);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],o=()=>(t.get()??"").trim(),d=this.wire(Mm,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:o()}})},subtitle:{textContent:()=>{const c=o();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ke[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ke[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(o())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,u,h)=>this.wireEl(Am,{name:()=>c.courseName??"Course",facts:()=>Al(c,Fe)},h),c=>c.courseId),d}}function zm(s,e,t){const n=ft(e);if(n){const d=zi(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=zi(s)??"this",r=ft(t),o=r?` at ${r}`:"";return`Watching · ${i} round${o}`}function Lm(s,e,t,n){const i=ft(s)===null?null:ft(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Fm="You're watching this round. Only its players can enter scores.",Bi={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function zi(s){const e=ft(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function ft(s){return(s??"").trim()||null}const Gm=b(`
    <div class="spectate">
...
`);class jm extends M{static styles=`
        ...
        ${_n.styles}
    `;svc=this.inject(br);auth=this.inject(V);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),o=()=>(t.get()??"").trim()||null;return this.wire(Gm,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(o()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Bi[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Bi[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?zm(o(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?Lm(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Fe(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const o=i.length>1?`<h2 class="spectate__slot-head">${Dm(r.formatLabel)}</h2>`:"",d=ta(r,t,n),c=sa(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return o+d+u}).join("")}}function Dm(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const qm=b(`
    <div class="profile">
            ...
            <section class="profile__card">
                ...
                <div class="pfield">
                    <span class="pfield__label">Preferred tee
                        ${Wr("teeRoleInfo","How preferred tee works")}</span>
...
`),Qm=b('<h3 bind="text" class="block__subhead"></h3>'),Jm=b(`
...
`);class _a extends M{static styles=`
${cs}
        .statspanels {
            ...
            & .block__cost {
                width: ${pi}px; flex: none; text-align: right;
            ...
            & .block--columns {
                ...
                & .block__colhead:nth-child(4) { width: ${pi}px; }
            }
...
`);class pg extends M{static styles=`
        .stats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${cs}
    `;svc=this.inject(Be);auth=this.inject(V);router=this.inject(q);filterOpen=new p(!1);prioritiesInfoOpen=new p(!1);colors=ps;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&(this.svc.load(),this.svc.loadHandicap());const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(ag,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>$.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>$.filterClear,onclick:()=>this.svc.clearFilter()},sgLabel:()=>$.filterBaseline,sgWhat:()=>$.filterBaselineHint,sgHint:()=>Fc(this.svc.sgChoice.get(),this.svc.handicapIndex.get()),empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>mf(t().results),resultsCard:{className:()=>Rs(t().results).length===0&&Ct(t().results).length===0?"results hidden":"results"},histHead:()=>Ct(t().results).length===0?"":$.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>$.prioritiesHint,infoTrigger:{textContent:()=>$.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>ye.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>$.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>$.roundsHint,pickHint:()=>n()?$.filterRoundsHint:""});return this.setHeading(i,"resultsSec",$.resultsHeading),this.setHeading(i,"prioritiesSec",$.priorities),this.setHeading(i,"trendsSec",$.trends),this.setHeading(i,"roundsSec",$.roundsHeading),this.mountPicker(i),this.mountBaselinePicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>Rs(t().results),(r,o,d)=>this.wireEl(lg,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},d),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>Ct(t().results),(r,o,d)=>this.wireEl(dg,{title:()=>r.title,bar:{innerHTML:()=>da((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},d),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,o,d)=>this.wireEl(cg,{title:()=>os(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":oa(c.per18,tu(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?xu(c.per18):$.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c?c.per18===null?vf(c.roundsInWindow):`over ${ne(c.roundsCovered,_e)}`:""}}},d),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Xt({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:Yt(t().totals),baseline:this.svc.sgInfo.get()}),(r,o,d)=>this.wireEl(yt,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},d),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,o,d)=>this.wireEl(ug,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Dp(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return fg(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return ne(c.points.length,_e)}}},d),r=>r.id),this.spawn(_a,this.ref(i,"panels"),{model:t,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,o,d)=>this.wireEl(hg,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${vi(r)} — hole by hole`},label:()=>vi(r),subtitle:()=>mg(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(vd(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Up(c.waterfall,Br(t().rounds.map(u=>u.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":as(c.vsPar)}}},d),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(C(()=>t.set(this.svc.preset.get()))),this.track(C(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Lt(r)} — ${bd(r)}`}),i=new pe({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Lt("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountBaselinePicker(e){const t=new p(this.svc.sgChoice.get());this.track(C(()=>t.set(this.svc.sgChoice.get()))),this.track(C(()=>{const i=t.get();queueMicrotask(()=>{i!==this.svc.sgChoice.get()&&this.svc.selectSgBaseline(i)})}));const n=new pe({value:t,options:Hr.map(i=>({value:i,label:Wn(i)})),placeholder:Wn("auto")});n.mount(this.ref(e,"sgPicker")),this.track(()=>n.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,o)=>this.wireEl(Li,{chip:{textContent:()=>ku(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(ws(this.svc.filter.get(),"venueTypes",i))}},o),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,o)=>this.wireEl(Li,{chip:{textContent:()=>$u(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(ws(this.svc.filter.get(),"roundTypes",i))}},o),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,o)=>this.wireEl(og,{name:()=>i.name,count:()=>ne(i.roundCount,_e),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(ws(this.svc.filter.get(),"courseIds",i.id))}},o),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return Rs(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return Ct(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Xt({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:Yt(t.totals),baseline:this.svc.sgInfo.get()}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount();return t<=e?ne(e,_e):`${Pe(e,0)} of ${ne(t,_e)}`}statusLine(){const e=this.svc.extendError.get();return e?`${$.extendProblemPrefix}${e.message}`:this.svc.extending.get()?$.extending:this.svc.budgetSpent()?$.budgetSpent:this.svc.loading.get()?$.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?$.windowEmpty:this.svc.loadedCount()===0?$.noStats:""}}function fg(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:we(e)}function mg(s){const e=[Dr(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${Pe(s.holeCount,0)} holes`),e.join(" · ")}const gg=b(`
...
`),vg=b('<li bind="text" class="roundstats__legenditem"></li>');function wg(){const s=[];for(const[e,t]of Object.entries(bn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
            `)}class xg extends M{static styles=`
        .roundstats {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
${cs}
    `;svc=this.inject(pt);auth=this.inject(V);router=this.inject(q);colors=ps;openHole=new p(null);infoOpen=new p(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(C(()=>{const d=e.get();se(()=>{this.openHole.set(null),d&&this.svc.load(d)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",o=this.wire(gg,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":ci(t()),subtitle:()=>this.subtitle(),score:()=>{const d=t();return d===null?"":ca(d.strokes,d.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>te.waterfallHeading,wfHint:()=>te.waterfallHint,infoTrigger:{textContent:()=>$.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:d=>{d.target===d.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ye.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>te.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const d=this.selected();return d===null?"":kf(d)},detailEmpty:()=>{const d=this.selected();return d===null?"":wn(d).length===0?te.nothingRecordedOnHole:""}});return this.setHeading(o,"stripSec",te.holeStripHeading),this.$each(this.ref(o,"strip"),()=>t()?.cells??[],(d,c,u)=>this.wireEl(bg,{cell:{className:()=>{const h=this.cellNow(d.id)??d;return h.marker===null?"cell":`cell cell--${h.marker}`},"aria-pressed":()=>String(this.openHole.get()===d.id),"aria-label":()=>xi(this.cellNow(d.id)??d),title:()=>xi(this.cellNow(d.id)??d),onclick:()=>this.openHole.set(this.openHole.get()===d.id?null:d.id)},hole:()=>String((this.cellNow(d.id)??d).holeNumber),score:()=>$f(this.cellNow(d.id)??d),tee:{className:()=>(this.cellNow(d.id)??d).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const h=this.cellNow(d.id)??d;return h.tee===null?"":`background:${this.teeColor(h.tee)}`}},gir:{className:()=>{const h=this.cellNow(d.id)??d;return h.gir===null?"cell__gir cell__gir--absent":h.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const h=this.cellNow(d.id)??d;return h.putts===null?"":String(h.putts)},pen:{className:()=>Cp(this.cellNow(d.id)??d)?"cell__pen":"cell__pen cell__pen--absent"}},u),d=>d.id),this.$each(this.ref(o,"detailLines"),()=>Ef(this.selected()),(d,c,u)=>this.wireEl(yg,{label:()=>d.label,value:()=>d.value},u),d=>d.key),this.$each(this.ref(o,"deltas"),()=>{const d=t();return d===null?[]:he.filter(c=>Ye(d.waterfall,c)!==null)},(d,c,u)=>this.wireEl(_g,{title:()=>os(d),sentence:()=>{const h=t();if(h===null||h.deltas===null)return"";const f=dn(h.deltas,d);return f===null?"":ua(f,h.windowCount)},value:{textContent:()=>{const h=this.componentValue(d);return h===null?"":we(h)},style:()=>{const h=this.componentValue(d);return h===null?"":`color:${Qe(us(h),this.colors)}`}},bar:{innerHTML:()=>{const h=t(),f=this.componentValue(d);return h===null||f===null?"":oa(f,Br([h.waterfall]),this.colors)}}},u),d=>d),this.$each(this.ref(o,"infoCards"),()=>{const d=t();return d===null?[]:Xt({attributed:d.waterfall.coverage.attributed,holesScored:d.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:he.map(c=>Te(d.waterfall,c)),penaltySource:Yt(d.panels.totals),baseline:this.svc.sgInfo.get()})},(d,c,u)=>this.wireEl(yt,{ctitle:()=>d.title,ctext:()=>d.body},u),d=>d.id),this.spawn(_a,this.ref(o,"panels"),{model:()=>t()?.panels??Ar,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(o,"legend"),()=>[te.legendTee,te.legendGir,te.legendPutts,te.legendPenalty,te.legendAbsence],(d,c,u)=>this.wireEl(vg,{text:()=>d},u),d=>d),o}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Ye(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":xf({...e,title:ci(e)})}stateLine(){if(this.auth.currentUser.get()===null)return te.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return te.loading;case"notFound":return te.noStatsInRound;case"notAuthorized":return te.notSignedIn;case"failed":return`${te.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?te.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const kg=b(`
    <div class="admin">
...
`),Pg={not_started:"Not started",active:"Playing",complete:"Done"},Cg={private:"Private",friends:"Friends",link:"Link"};function Ig(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Eg(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Rg extends M{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),Et=b('<option bind="option"></option>'),jg=b(`
    <label class="cd__field">
        <span bind="label"></span>
...
`);class hb extends M{static styles=`
    ...
    `;router=this.inject(q);render(){const e=this.wire(ub,{header:{className:()=>tn(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Gu,this.ref(e,"account")),this.spawn(Qo,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":ei,"/history":ih,"/round":Kf,"/create":xm,"/login":Tm,"/friends":Em,"/friend":Nm,"/friend-rounds":Hm,"/friend-courses":Bm,"/spectate":jm,"/profile":Km,"/stats":pg,"/round-stats":xg,"/admin":Rg,...nr.competitions?{"/competitions":Ag,"/competition":cb}:{}},ei),e}}class pb extends V{constructor(e){super(),this.client=e}client;async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}Y.get(ja);const Fi=Y.get(q);Y.set(V,new pb(ma));const Gi=Y.get(V);await Ua(hb,"#app",{hot:void 0,onInit:async()=>{await Gi.load(),Gi.currentUser.get()&&Fi.route.get()==="/login"&&Fi.navigate("/",!0)}});export{Bs as A,M as C,q as R,p as S,ja as T,y as a,dt as b,T as c,Oa as d,C as e,Na as n,L as r,b as t};
