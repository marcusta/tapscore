(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const Ee="modulepreload",Pe=function(o){return"/tapscore/"+o},oe={},Ce=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let d=function(u){return Promise.all(u.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),c=a?.nonce||a?.getAttribute("nonce");n=d(t.map(u=>{if(u=Pe(u),u in oe)return;oe[u]=!0;const m=u.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${p}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":Ee,m||(g.as="script"),g.crossOrigin="",g.href=u,c&&g.setAttribute("nonce",c),document.head.appendChild(g),m)return new Promise((b,E)=>{g.addEventListener("load",b),g.addEventListener("error",()=>E(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(a){const c=new Event("vite:preloadError",{cancelable:!0});if(c.payload=a,window.dispatchEvent(c),!c.defaultPrevented)throw a}return n.then(a=>{for(const c of a||[])c.status==="rejected"&&r(c.reason);return e().catch(r)})};class ze{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){be(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const M=new ze;function be(o){for(const e of o.deps)e.delete(o);o.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return M.subscribe(this.subs),this.val}set(e){Object.is(this.val,e)||(this.val=e,M.notify(this.subs))}update(e){this.set(e(this.val))}}class ${constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){M.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,M.notify(t.subs))})},deps:new Set};s.run()}get(){return M.subscribe(this.subs),this.val}}function _(o){const e={run(){M.runTracked(e,o)},deps:new Set};return e.run(),()=>be(e)}function G(o){M.batch(o)}class je{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const j=new je,D="/tapscore/".replace(/\/+$/,"");function Z(o){return D?o===D?"/":o.startsWith(D+"/")?o.slice(D.length):o:o}function Oe(o){return D+o}class z{constructor(){this.route=new h(Z(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>G(()=>{this.route.set(Z(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",a=n>=0?e.slice(0,n):e,c=a.indexOf("?"),d=c>=0?a.slice(0,c):a,u=c>=0?a.slice(c+1):"",m=s.query!==void 0?Ne(s.query):u?"?"+u:"",p=Oe(d)+m+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),G(()=>{this.route.set(d),this.search.set(m)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new $(()=>{const s=this.route.get().split("/"),n={};for(const[r,a]of t.entries())a.startsWith(":")&&(n[a.slice(1)]=s[r]??"");return n})}query(e){return new $(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new $(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Ne(o){const e=new URLSearchParams;for(const[s,n]of Object.entries(o))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function He(o){return e=>o[e]}function Re(o,e){const t=(n,r,a)=>{const c=Object.entries(n).map(([d,u])=>`--${d}:${u}`).join(";");return`${r}{color-scheme:${a};${c}}`},s=document.createElement("style");return s.textContent=t(o,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const ie="basics-js-theme";class Le{constructor(){this.dark=new h(!1);const e=localStorage.getItem(ie),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),_(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ie,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function y(o){const e=document.createElement("template");return e.innerHTML=o,e}function Me(o,e){let t;for(const s of Object.keys(e))o.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const ae=new Set;class T{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!ae.has(t)){ae.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return j.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=new e(s[0]);return n.mount(t),this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(a=>this.track(a)),r=e.content.cloneNode(!0);for(const a of r.querySelectorAll("[bind]")){const c=t[a.getAttribute("bind")];if(c)if(typeof c=="function")n(_(()=>{const d=c();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(d):a.textContent=String(d)}));else for(const[d,u]of Object.entries(c)){const m=d.includes("-");d.startsWith("on")&&typeof u=="function"?a.addEventListener(d.slice(2),u):typeof u=="function"?n(_(()=>{const p=u();m?a.setAttribute(d,String(p)):a[d]=p})):m?a.setAttribute(d,String(u)):a[d]=u}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof T?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,a,...c)=>this.spawn(r,a,...c),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,a)=>a){const r=typeof t=="function"?t:()=>t.get(),a=new Map,c=new Map;this.track(()=>{for(const d of c.values())d.forEach(u=>u());c.clear()}),this.track(_(()=>{const d=r(),u=new Map;for(const[p,g]of d.entries()){const b=n(g,p);if(a.has(b))u.set(b,a.get(b));else{const E=[];u.set(b,s(g,p,H=>E.push(H))),c.set(b,E)}}for(const[p,g]of a)u.has(p)||(g.remove(),c.get(p)?.forEach(b=>b()),c.delete(p));let m=e.firstChild;for(const p of u.values())p===m?m=m.nextSibling:e.insertBefore(p,m);a.clear();for(const[p,g]of u)a.set(p,g)}))}$condition(e,t,s,n){let r=null;this.track(_(()=>{r&&(r.remove(),r=null),r=t.get()?s():n?.()??null,r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track(_(()=>{r&&(r.destroy(),r=null),e.textContent="";const a=t.get(),c=s[a]??Me(a,s)??n;c&&(r=new c,r.mount(e))})),this.track(()=>r?.destroy())}}async function Be(o,e,t){const s=document.querySelector(e);s.textContent="";const n=j.get(z);let r=null,a=!1,c=null,d=!!t?.hot?.data.hmr;const u=async m=>{r&&(r.destroy(),r=null,s.textContent=""),m?(c||(c=(await Ce(()=>import("./obs-shell.component-DMIl83ef.js"),[])).ObsShellComponent),r=new c):(!d&&t?.onInit&&(await t.onInit(),d=!0),r=new o),r.mount(s),a=m};await u(Z(location.pathname).startsWith("/_obs")),_(()=>{const m=n.route.get().startsWith("/_obs");m!==a&&u(m)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>r?.destroy()),t.hot.accept())}class A extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Fe=10,U=[];let Q=[],q=null;function Ae(o){U.push(o),U.length>Fe&&U.shift()}function De(o,e,t){const s={code:o,message:e,url:typeof location<"u"?location.href:"",context:[...U],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Q.push(s),qe()}function qe(){q||(q=setTimeout(ye,5e3))}function ye(){if(q&&(clearTimeout(q),q=null),Q.length===0)return;const o=Q;Q=[];for(const e of o){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ye()});const Ge=3e4,Ke=2,K=new Map,_e=new WeakMap;function We(o){if(o instanceof A)return o.traceId;if(o!=null&&typeof o=="object")return _e.get(o)}async function f(o){if(o.method==="GET"){const e=K.get(o.url);if(e)return e;const t=le(o,Ke);return K.set(o.url,t),t.then(()=>K.delete(o.url),()=>K.delete(o.url)),t}return le(o,0)}async function le(o,e){const t=o.timeout??Ge;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Qe(Ue(o,r),t)}catch(a){if(s=a,!(a instanceof A)&&a!=null&&typeof a=="object"&&_e.set(a,r),a instanceof A||n===e)break;await new Promise(c=>setTimeout(c,1e3*2**n))}}throw s}async function Ue(o,e){const t={"X-Trace-Id":e},s={method:o.method,headers:t};o.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(o.body));const n=await fetch(o.url,s),r=n.headers.get("x-trace-id")??e;if(Ae({type:"api",detail:`${o.method} ${o.url}`,timestamp:new Date().toISOString()}),!n.ok){const a=await n.json().catch(()=>({error:n.statusText}));throw new A(n.status,a.error??n.statusText,a.details,r)}return n.json()}function Qe(o,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([o,s]).finally(()=>clearTimeout(t))}async function x(o,e,t){G(()=>{o.set(!0),e.set(null)});try{const s=await t();return o.set(!1),s}catch(s){const n=Xe(s);G(()=>{o.set(!1),e.set(n)}),De(n.code,n.message,We(s));return}}function Xe(o){return o instanceof A?o.status===401?{code:"auth",message:"Unauthorized"}:o.status===409?{code:"conflict",message:"Data has changed — please try again"}:o.status===400?{code:"validation",message:o.message}:{code:"server",message:"Server error"}:o instanceof Error?o.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function Ve(o){return{me:()=>f({method:"GET",url:`${o}/auth/me`}),login:e=>f({method:"POST",url:`${o}/auth/login`,body:e}),logout:()=>f({method:"POST",url:`${o}/auth/logout`,body:{}})}}class te{constructor(){this.api=Ve("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await x(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await x(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await x(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const ce={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},i=Re({...ce,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...ce,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),I=o=>`var(--${o})`,l=He({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),k=(o=I("radius"))=>`
...
`);class Ze extends T{static styles=`
        .tabbar {
            display: flex;
...
`),ft={not_started:"Not started",active:"Live",complete:"Done"};class de extends T{static styles=`
        .landing {
    ...
    `;svc=this.inject(ht);router=this.inject(z);render(){this.svc.load();const e=this.wire(pt,{createBtn:{onclick:()=>this.router.navigate("/create")},signin:{onclick:()=>this.router.navigate("/login")},count:()=>{const t=this.svc.rounds.get().length;return t===0?"":`${t} on the card`},empty:{className:()=>this.svc.rounds.get().length===0?"landing__empty":"landing__empty hidden"}});return this.$each(this.ref(e,"list"),this.svc.rounds,(t,s,n)=>this.wireEl(mt,{row:{onclick:()=>this.router.navigate("/round",{query:{token:t.friendlyRound.shareToken}})},course:()=>t.round.courseNameSnapshot??"Round",status:{textContent:()=>ft[t.round.status]??t.round.status,className:()=>`round-row__status s-${t.round.status}`},date:()=>t.round.date,formats:()=>t.round.formatSlots.map(se).join(" · ")},n),t=>t.friendlyRound.id),e}}const gt=180,ue=4,bt=12;function F(o,e){return e<=0?0:Math.max(0,Math.min(e-1,o))}function yt(o){const{dragDistance:e,velocity:t,itemWidth:s}=o;if(Math.abs(e)<bt)return 0;const n=e+t*gt,r=Math.round(-n/s);return Math.max(-ue,Math.min(ue,r))}const _t=["1st","2nd","3rd","4th","5th","6th","7th","8th"],B=(o,e)=>`${o}|${e}`;function ve(o){return o.players.map(e=>e.displayName).join(" & ")||o.label||"Ball"}function vt(o,e,t){return o?!(o.minPar!==void 0&&e<o.minPar||o.maxPar!==void 0&&e>o.maxPar||o.pars&&!o.pars.includes(e)||o.holes&&!o.holes.includes(t)):!0}class ne{loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);holeIdx=new h(0);groupIdx=new h(0);token=null;async loadByToken(e){const t=e!==this.token;this.token=e,j.get(X).load();const s=await x(this.loading,this.error,()=>v.friendlyRounds.byToken({token:e}));if(!s)return;this.friendlyRound.set(s.friendlyRound),this.round.set(s.round);const[n,r]=await Promise.all([v.friendlyRounds.balls({token:e}).catch(()=>[]),v.friendlyRounds.scorecard({token:e}).catch(()=>[])]);this.cells.set(new Map),this.scorecards.set(r),this.balls.set(n),t&&(this.holeIdx.set(0),this.groupIdx.set(0),this.result.set(null))}async loadResult(){if(!this.token)return;const e=await x(this.resultLoading,this.resultError,()=>v.friendlyRounds.result({token:this.token}));e&&this.result.set(e)}ballNameById=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,ve(t));return e});nameOf(e){return this.ballNameById.get().get(e)??e}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return F(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(a=>a.id===e);if(!t||!s)return"";const n=t.playHoles.filter(a=>a.courseHoleNumber===s.courseHoleNumber).sort((a,c)=>a.ordinal-c.ordinal);if(n.length===1)return`${s.courseHoleNumber}`;const r=n.findIndex(a=>a.id===e);return`${s.courseHoleNumber} (${_t[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(F(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(F(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(B(e,t));return s?s.strokes:this.scorecards.get().find(a=>a.ballId===e)?.holes.find(a=>a.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(B(e,t))?.status??null}metadataFor(e,t,s){const n=this.cells.get().get(B(e,t));return n&&n.metadata!==void 0?n.metadata?.[s]:this.scorecards.get().find(c=>c.ballId===e)?.holes.find(c=>c.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=j.get(X),t=this.round.get()?.formatSlots??[],s=[],n=new Set;for(const r of t){const a=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const c of a)n.has(c.key)||(n.add(c.key),s.push(c))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>vt(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,n){const r=B(e,t),a=crypto.randomUUID();this.patchCell(r,{strokes:s,metadata:n,status:"saving",clientEventId:a}),await this.post(e,t,s,n,a)}async retry(e,t){const s=B(e,t),n=this.cells.get().get(s);n&&(this.patchCell(s,{...n,status:"saving"}),await this.post(e,t,n.strokes,n.metadata,n.clientEventId))}async post(e,t,s,n,r){if(!this.token)return;const a=B(e,t);try{await v.friendlyRounds.score({token:this.token,ballId:e,playHoleId:t,strokes:s,eventType:s===null?"score_cleared":"score_entered",clientEventId:r,...n!=null?{metadata:n}:{}});const c=this.cells.get().get(a);c&&c.clientEventId===r&&this.patchCell(a,{...c,status:"saved"})}catch{const c=this.cells.get().get(a);c&&c.clientEventId===r&&this.patchCell(a,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}}const R=60,he=8,J=4,wt=Array.from({length:J*2+1},(o,e)=>e-J),xt="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",$t=y(`
...
`),Tt=y('<button bind="chip" class="se-chip" type="button"></button>');class Et extends T{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
  ...
  ${m}${p}${g}
</article>`}function Nt(o,e){const t=o.entries.map(s=>`<tr class="${s.position===1?"lb-rank__lead":""}">
...
</div>`}function Ht(o,e){const t=o.lines.map(s=>{const n=s.segments.map(r=>"text"in r?w(r.text):w(r.ballIds.map(e).join(" & "))).join("");return`<li class="lb-match__line lb-match__line--${s.result}">${n}</li>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${w(o.title)}</h4>
  <ul class="lb-match">${t}</ul>
</div>`}function Rt(o){return`<div class="lb-diag">Unrenderable result section <code>${w(o)}</code> — no generic view yet. Results are not hidden.</div>`}function Lt(o,e){return o.leaderboard.length===0&&o.cards.length===0?`<div class="lb-empty">No scores entered yet for ${w(o.formatLabel)}.</div>`:o.leaderboard.map(s=>s.kind==="ranked"?Nt(s,e):s.kind==="match_summary"?Ht(s,e):Rt(s.kind)).join("")||`<div class="lb-empty">No leaderboard metric for ${w(o.formatLabel)}.</div>`}function Mt(o,e,t){return o.cards.length===0?"":o.cards.map(s=>Ot(s,e,t)).join(`
`)}const Bt=y(`
...
`),Ft=y('<button bind="pill" class="lb__pill" type="button"></button>');class At extends T{static styles=`
        .lb {
...
`);class qt extends T{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class ns extends T{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 18vh ${l("xl")} 0;
    ...
    `;auth=this.inject(te);router=this.inject(z);username="";password="";render(){return this.wire(ss,{root:{inert:()=>this.auth.loading.get()},error:{className:()=>this.auth.error.get()?"error show":"error",textContent:()=>this.auth.error.get()?.message??""},form:{onsubmit:async e=>{e.preventDefault(),await this.auth.login(this.username,this.password)&&this.router.navigate("/rounds",!0)}},username:{oninput:e=>{this.username=e.target.value}},password:{oninput:e=>{this.password=e.target.value}},submit:{textContent:()=>this.auth.loading.get()?"Signing in…":"Sign in"}})}}class rs{loading=new h(!1);error=new h(null);guests=new h([]);async load(){const e=await x(this.loading,this.error,()=>v.guestPlayers.list());e&&this.guests.set(e)}async create(e){const t=await x(this.loading,this.error,()=>v.guestPlayers.create(e));return t&&this.guests.update(s=>[...s,t]),t??null}}const os=y(`
    <div class="players">
...
`);function as(o){return o.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class ls extends T{static styles=`
        .players {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class hs extends T{static styles=`
        .rounds {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject(cs);router=this.inject(z);render(){this.svc.load();const e=this.wire(ds,{subtitle:()=>{const s=this.svc.rounds.get().length;return s===0?"No rounds yet — tee one up.":`${s} round${s===1?"":"s"} on the card.`},newBtn:{onclick:()=>this.router.navigate("/create")}}),t={not_started:"Not started",active:"Live",complete:"Done"};return this.$each(this.ref(e,"list"),this.svc.rounds,(s,n,r)=>this.wireEl(us,{row:{onclick:()=>this.router.navigate("/score",{query:{roundId:s.id}})},course:()=>s.courseNameSnapshot??"Round",status:{textContent:()=>t[s.status]??s.status,className:()=>`round-row__status s-${s.status}`},date:()=>s.date,formats:()=>s.formatSlots.map(se).join(" · ")},r),s=>s.id),e}}class ps{loading=new h(!1);error=new h(null);roundId=new h(null);round=new h(null);course=new h(null);balls=new h([]);strokes=new h(new Map);holes=new $(()=>this.course.get()?.holes??[]);playHoleIdByCourseHole=new $(()=>{const e=new Map;for(const t of this.round.get()?.playHoles??[])e.has(t.courseHoleNumber)||e.set(t.courseHoleNumber,t.id);return e});async load(e){if(this.roundId.get()===e&&this.round.get())return;this.roundId.set(e);const t=await x(this.loading,this.error,()=>v.rounds.get({id:e}));if(!t)return;this.round.set(t);const[s,n,r]=await Promise.all([x(this.loading,this.error,()=>v.courses.get({id:t.courseId})),x(this.loading,this.error,()=>v.rounds.balls({roundId:e})),x(this.loading,this.error,()=>v.scorecards.forRound({roundId:e}))]);if(s&&this.course.set(s),n&&this.balls.set(n),r){const a=new Map;for(const c of r)for(const d of c.holes)a.set(`${c.ballId} ${d.holeNumber}`,d.strokes);this.strokes.set(a)}}strokesFor(e,t){return this.strokes.get().get(`${e} ${t}`)??null}async setStrokes(e,t,s){const n=this.roundId.get();if(!n)return;const r=this.playHoleIdByCourseHole.get().get(t);if(!r)return;this.strokes.update(c=>new Map(c).set(`${e.id} ${t}`,s));const a=e.players.length===1?e.players[0]:null;await x(this.loading,this.error,()=>v.scoreEvents.append({roundId:n,ballId:e.id,playHoleId:r,strokes:s,eventType:s===null?"score_cleared":"score_entered",clientEventId:crypto.randomUUID(),sourcePlayerId:a?.playerId??null,sourceGuestPlayerId:a?.guestPlayerId??null}))}}const ms=y(`
    <div class="score">
...
`),fs=y('<button bind="dot" type="button" class="score-dot"></button>'),gs=y(`
    <div class="ball-row">
...
`);class bs extends T{static styles=`
    ...
    `;svc=this.inject(ps);router=this.inject(z);holeQ=this.router.query("hole");roundIdQ=this.router.query("roundId");hole=new $(()=>{const e=Number(this.holeQ.get()??"1");return Number.isFinite(e)&&e>=1?e:1});currentHole=new $(()=>this.svc.holes.get().find(e=>e.holeNumber===this.hole.get())??null);goHole(e){this.router.navigate("/score",{query:{roundId:this.roundIdQ.get(),hole:String(e)}})}render(){this.track(_(()=>{const t=this.roundIdQ.get();t&&this.svc.load(t)}));const e=this.wire(ms,{back:{onclick:()=>this.router.navigate("/rounds")},results:{onclick:()=>this.router.navigate("/results",{query:{roundId:this.roundIdQ.get()}})},course:()=>this.svc.round.get()?.courseNameSnapshot??"",holeNo:()=>String(this.hole.get()),holemeta:()=>{const t=this.currentHole.get();return t?`Par ${t.par} · Index ${t.strokeIndex}`:""},prev:{disabled:()=>this.hole.get()<=1,onclick:()=>this.goHole(this.hole.get()-1)},next:{disabled:()=>this.hole.get()>=(this.svc.holes.get().length||18),onclick:()=>this.goHole(this.hole.get()+1)}});return this.$each(this.ref(e,"dots"),this.svc.holes,(t,s,n)=>this.wireEl(fs,{dot:{className:()=>{const r=this.svc.balls.get().length>0&&this.svc.balls.get().every(c=>this.svc.strokesFor(c.id,t.holeNumber)!==null),a=this.hole.get()===t.holeNumber;return`score-dot${r?" done":""}${a?" now":""}`},onclick:()=>this.goHole(t.holeNumber)}},n),t=>String(t.holeNumber)),this.$each(this.ref(e,"balls"),this.svc.balls,(t,s,n)=>this.ballRow(t,n),t=>t.id),e}ballRow(e,t){const s=()=>this.svc.strokesFor(e.id,this.hole.get()),n=()=>this.currentHole.get()?.par??4;return this.wireEl(gs,{label:()=>e.label??e.players.map(r=>r.displayName).join(" / "),meta:()=>e.players.map(r=>`${r.teeName} · CH ${r.courseHandicap}`).join("  ·  "),minus:{onclick:()=>{const r=s();r===null?this.svc.setStrokes(e,this.hole.get(),n()):r<=1?this.svc.setStrokes(e,this.hole.get(),null):this.svc.setStrokes(e,this.hole.get(),r-1)}},plus:{onclick:()=>{const r=s();this.svc.setStrokes(e,this.hole.get(),r===null?n():r+1)}},value:{textContent:()=>{const r=s();return r===null?"–":String(r)},className:()=>{const r=s();return r===null?"ball-row__value unset":r<n()?"ball-row__value under":r>n()?"ball-row__value over":"ball-row__value"}}},t)}}class ys{loading=new h(!1);error=new h(null);roundId=new h(null);round=new h(null);result=new h(null);balls=new h([]);labelByBall=new $(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,t.label??t.players.map(s=>s.displayName).join(" / "));return e});async load(e){this.roundId.set(e);const[t,s]=await Promise.all([x(this.loading,this.error,()=>v.rounds.get({id:e})),x(this.loading,this.error,()=>v.rounds.balls({roundId:e}))]);t&&this.round.set(t),s&&this.balls.set(s);const n=await x(this.loading,this.error,()=>v.leaderboards.forRound({roundId:e}));n&&this.result.set(n)}}const _s=y(`
    <div class="results">
...
`),vs=y('<div bind="row" class="results-slot"></div>');class ws extends T{static styles=`
        .results {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class $s extends T{static styles=`
    ...
    `;router=this.inject(z);render(){const e=this.wire(xs,{});return this.spawn(Ze,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":de,"/round":qt,"/create":ts,"/login":ns,"/rounds":hs,"/players":ls,"/score":bs,"/results":ws},de),e}}j.get(Le);const fe=j.get(z),ge=j.get(te);await Be($s,"#app",{hot:void 0,onInit:async()=>{await ge.load(),ge.currentUser.get()&&fe.route.get()==="/login"&&fe.navigate("/",!0)}});export{T as C,z as R,h as S,Le as T,f as a,G as b,$ as c,_ as e,x as r,y as t};
