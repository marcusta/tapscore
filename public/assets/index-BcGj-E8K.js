(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const yt="modulepreload",_t=function(i){return"/tapscore/"+i},Ee={},vt=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let u=function(c){return Promise.all(c.map(m=>Promise.resolve(m).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=a?.nonce||a?.getAttribute("nonce");n=u(t.map(c=>{if(c=_t(c),c in Ee)return;Ee[c]=!0;const m=c.endsWith(".css"),p=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${c}"]${p}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":yt,m||(g.as="script"),g.crossOrigin="",g.href=c,d&&g.setAttribute("nonce",d),document.head.appendChild(g),m)return new Promise((x,y)=>{g.addEventListener("load",x),g.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${c}`)))})}))}function r(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return n.then(a=>{for(const d of a||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};class wt{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){Xe(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const q=new wt;function Xe(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return q.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,q.notify(this.subs))}update(e){this.set(e(this.val))}}class k{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){q.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,q.notify(t.subs))})},deps:new Set};s.run()}get(){return q.subscribe(this.subs),this.val}peek(){return this.val}}function $(i){const e={run(){q.runTracked(e,i)},deps:new Set};return e.run(),()=>Xe(e)}function ne(i){q.batch(i)}function Q(i){return q.untrack(i)}class xt{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const A=new xt,te="/tapscore/".replace(/\/+$/,"");function ge(i){return te?i===te?"/":i.startsWith(te+"/")?i.slice(te.length):i:i}function $t(i){return te+i}class j{constructor(){this.route=new h(ge(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>ne(()=>{this.route.set(ge(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",a=n>=0?e.slice(0,n):e,d=a.indexOf("?"),u=d>=0?a.slice(0,d):a,c=d>=0?a.slice(d+1):"",m=s.query!==void 0?kt(s.query):c?"?"+c:"",p=$t(u)+m+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),ne(()=>{this.route.set(u),this.search.set(m)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new k(()=>{const s=this.route.get().split("/"),n={};for(const[r,a]of t.entries())a.startsWith(":")&&(n[a.slice(1)]=s[r]??"");return n})}query(e){return new k(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new k(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function kt(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function St(i){return e=>i[e]}function It(i,e){const t=(n,r,a)=>{const d=Object.entries(n).map(([u,c])=>`--${u}:${c}`).join(";");return`${r}{color-scheme:${a};${d}}`},s=document.createElement("style");return s.textContent=t(i,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const Ce="basics-js-theme";class Tt{constructor(){this.dark=new h(!1);const e=localStorage.getItem(Ce),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),$(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(Ce,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(i){const e=document.createElement("template");return e.innerHTML=i,e}function Et(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const Ne=new Set;class T{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Ne.has(t)){Ne.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return A.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=Q(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(a=>this.track(a)),r=e.content.cloneNode(!0);for(const a of r.querySelectorAll("[bind]")){const d=t[a.getAttribute("bind")];if(d)if(typeof d=="function")n($(()=>{const u=d();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(u):a.textContent=String(u)}));else for(const[u,c]of Object.entries(d)){const m=u.includes("-");u.startsWith("on")&&typeof c=="function"?a.addEventListener(u.slice(2),c):typeof c=="function"?n($(()=>{const p=c();m?a.setAttribute(u,String(p)):a[u]=p})):m?a.setAttribute(u,String(c)):a[u]=c}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof T?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,a,...d)=>this.spawn(r,a,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,a)=>a){const r=typeof t=="function"?t:()=>t.get(),a=new Map,d=new Map;this.track(()=>{for(const u of d.values())u.forEach(c=>c());d.clear()}),this.track($(()=>{const u=r(),c=new Map;for(const[p,g]of u.entries()){const x=n(g,p);if(a.has(x))c.set(x,a.get(x));else{const y=[];c.set(x,Q(()=>s(g,p,v=>y.push(v)))),d.set(x,y)}}for(const[p,g]of a)c.has(p)||(g.remove(),d.get(p)?.forEach(x=>x()),d.delete(p));let m=e.firstChild;for(const p of c.values())p===m?m=m.nextSibling:e.insertBefore(p,m);a.clear();for(const[p,g]of c)a.set(p,g)}))}$condition(e,t,s,n){let r=null;this.track($(()=>{r&&(r.remove(),r=null);const a=t.get();r=Q(()=>a?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track($(()=>{r&&(r.destroy(),r=null),e.textContent="";const a=t.get(),d=s[a]??Et(a,s)??n;d&&(r=Q(()=>{const u=new d;return u.mount(e),u}))})),this.track(()=>r?.destroy())}}async function Ct(i,e,t){const s=document.querySelector(e);s.textContent="";const n=A.get(j);let r=null,a=!1,d=null,u=!!t?.hot?.data.hmr;const c=async m=>{r&&(r.destroy(),r=null,s.textContent=""),m?(d||(d=(await vt(()=>import("./obs-shell.component-BeY5tTfU.js"),[])).ObsShellComponent),r=Q(()=>new d)):(!u&&t?.onInit&&(await t.onInit(),u=!0),r=Q(()=>new i)),Q(()=>r.mount(s)),a=m};await c(ge(location.pathname).startsWith("/_obs")),$(()=>{const m=n.route.get().startsWith("/_obs");m!==a&&c(m)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>r?.destroy()),t.hot.accept())}class L extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const Nt=10,le=[];let de=[],se=null;function Pt(i){le.push(i),le.length>Nt&&le.shift()}function zt(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...le],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),de.push(s),jt()}function jt(){se||(se=setTimeout(Ye,5e3))}function Ye(){if(se&&(clearTimeout(se),se=null),de.length===0)return;const i=de;de=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ye()});const Ot=3e4,Rt=2,ie=new Map,Je=new WeakMap;function Ht(i){if(i instanceof L)return i.traceId;if(i!=null&&typeof i=="object")return Je.get(i)}async function f(i){if(i.method==="GET"){const e=ie.get(i.url);if(e)return e;const t=Pe(i,Rt);return ie.set(i.url,t),t.then(()=>ie.delete(i.url),()=>ie.delete(i.url)),t}return Pe(i,0)}async function Pe(i,e){const t=i.timeout??Ot;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Mt(Lt(i,r),t)}catch(a){if(s=a,!(a instanceof L)&&a!=null&&typeof a=="object"&&Je.set(a,r),a instanceof L||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function Lt(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(Pt({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const a=await n.json().catch(()=>({error:n.statusText}));throw new L(n.status,a.error??n.statusText,a.details,r)}return n.json()}function Mt(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}async function E(i,e,t){ne(()=>{i.set(!0),e.set(null)});try{const s=await t();return i.set(!1),s}catch(s){const n=Ft(s);ne(()=>{i.set(!1),e.set(n)}),zt(n.code,n.message,Ht(s));return}}function Ft(i){return i instanceof L?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function Bt(i){return{me:()=>f({method:"GET",url:`${i}/auth/me`}),login:e=>f({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>f({method:"POST",url:`${i}/auth/logout`,body:{}})}}class M{constructor(){this.api=Bt("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await E(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await E(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await E(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const ze={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},l=It({...ze,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...ze,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),P=i=>`var(--${i})`,o=St({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),S=(i=P("radius"))=>`
...
`);class Dt extends T{static styles=`
    ...
    `;let be=$e;const N=i=>`var(--${i})`,ke=class ke extends T{render(){const e=document.createElement("div");this.spawn(be,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200";const t=document.createElement("h2");t.className="ui-confirm__title",t.textContent=this.props.title??"Confirm",this.dialogEl.appendChild(t);const s=document.createElement("p");if(s.className="ui-confirm__message",typeof this.props.message=="function"){const d=this.props.message;this.track($(()=>{s.textContent=d()}))}else s.textContent=this.props.message;this.dialogEl.appendChild(s);const n=document.createElement("div");n.className="ui-confirm__actions";const r=document.createElement("button");r.className="ui-confirm__btn ui-confirm__btn--cancel",r.textContent=this.props.cancelLabel??"Cancel",r.addEventListener("click",d=>{d.stopPropagation(),this.handleCancel()}),n.appendChild(r);const a=document.createElement("button");return a.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",a.textContent=this.props.confirmLabel??"Confirm",a.addEventListener("click",d=>{d.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),n.appendChild(a),this.dialogEl.appendChild(n),this.dialogEl.addEventListener("click",d=>d.stopPropagation()),e.appendChild(this.dialogEl),this.track($(()=>{this.dialogEl.classList.toggle("open",this.props.open.get())})),e}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}};ke.styles=`
        .ui-confirm {
            position: fixed;
            top: 50%;
            left: 50%;
...
`),rt={not_started:"Not started",active:"Live",complete:"Finished"};class Re extends T{static styles=`
        .landing {
...
`);class ws extends T{static styles=`
        .history {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
...
`);class Ms extends T{static styles=`
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${Be}px; flex-shrink: 0; }
  ...
  <h4 class="lb-section__title">${w(i.metricLabel)}</h4>
  <table class="lb-rank">
    <colgroup>
...
</div>`}function Js(i,e){const t=i.matches.map(s=>{const n=w(s.sideA.ballIds.map(e).join(" & ")),r=w(s.sideB.ballIds.map(e).join(" & ")),a=s.magnitude===0?"AS":`${s.magnitude} UP`,d=s.finished?"Final":`thru ${s.thru}`,u=s.leader==="a"?" lb-mp__team--lead":"",c=s.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
  ...
  <h4 class="lb-section__title">${w(i.title)}</h4>${t}
</div>`}const Zs={ranked:Ys,match_summary:(i,e)=>Js(i,e)},en={"default-score-grid":Us,"compact-match-grid":Ws,"category-matrix-grid":Vs};function tn(i){return i.componentId??"default-score-grid"}function sn(i){return`<div class="lb-diag">Unrenderable result section <code>${w(i)}</code> — no generic view yet. Results are not hidden.</div>`}function nn(i){return`<div class="lb-diag">Unsupported score-grid component <code>${w(i)}</code> — no generic view yet. Results are not hidden.</div>`}function rn(i,e,t){const s=Zs[i.kind];return s?s(i,e,t):sn(i.kind)}function on(i,e,t,s){const n=tn(i),r=en[n];return r?r(i,e,t,s):nn(n)}function an(i,e,t=ot){return i.leaderboard.length===0&&i.cards.length===0?`<div class="lb-empty">No scores entered yet for ${w(i.formatLabel)}.</div>`:i.leaderboard.map(n=>rn(n,e,t)).join("")||`<div class="lb-empty">No leaderboard metric for ${w(i.formatLabel)}.</div>`}function ln(i,e,t,s={}){if(i.cards.length===0)return"";const n=s.mode??"product";return i.cards.map(r=>on(r,e,t,{mode:n})).join(`
`)}const dn=b(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class cn extends T{static styles=`
        .lb {
    ...
    `;svc=this.inject(J);slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(dn,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody()}})}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=u=>this.svc.nameOf(u),r=an(t,s,u=>this.svc.groupLabelOf(u)),a=ln(t,e.routeSections,s),d=a?`<h3 class="lb-cards__head">Scorecard</h3>${a}`:"";return r+d}}function un(i,e){if(!e)return[];const t=[],s=new Set;for(const n of i)for(const r of n.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const hn=b(`
...
`);class mn extends T{static styles=`
    ...
    `;let re=Se;function fn(i,e,t){if(!e||t!=="not_started")return!1;for(const s of i)for(const n of s.players)if(n.playerId===e)return!1;return!0}const De="new";function gn(i){const e=i.map((s,n)=>{const r=s.ballIds.length,a=[`Group ${n+1}`];return s.startTime.includes(":")&&a.push(s.startTime),{value:s.id,label:`${a.join(" · ")} — ${r} of ${s.capacity}`,disabled:r>=s.capacity}}),t=e.find(s=>!s.disabled);return e.push({value:De,label:"Start a new group",disabled:!1}),{options:e,defaultValue:t?.value??De}}const bn=b(`
...
`);class vn extends T{static styles=`
        .edit-card {
            margin-top: ${o("lg")};
            padding: ${o("lg")};
            ${z()}
    ...
    `;router=this.inject(j);tokenQ=this.router.query("token");editable=new h(!1);render(){const e=this.tokenQ.get();return e&&_.friendlyRounds.setup({token:e}).then(t=>this.editable.set(t.editable===!0)).catch(()=>this.editable.set(!1)),this.wire(_n,{root:{className:()=>this.editable.get()?"edit-card":"edit-card hidden"},edit:{onclick:()=>{const t=this.tokenQ.get();t&&this.router.navigate("/create",{query:{token:t}})}}})}}function wn(i,e){if(!e)return!1;for(const t of i)for(const s of t.players)if(s.playerId===e)return!0;return!1}const xn=b(`
...
`);class $n extends T{static styles=`
    ...
    `;svc=this.inject(J);auth=this.inject(M);router=this.inject(j);tokenQ=this.router.query("token");open=new h(!1);leaving=new h(!1);error=new h("");diagnostics=new h([]);eligible(){return wn(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async leave(){const e=this.tokenQ.get();if(!(!e||this.leaving.get())){this.error.set(""),this.diagnostics.set([]),this.leaving.set(!0);try{const t=await _.friendlyRounds.leave({token:e});t.ok?await this.svc.loadByToken(e):this.diagnostics.set(t.diagnostics)}catch{this.error.set("Could not remove you right now. Try again.")}finally{this.leaving.set(!1)}}}render(){const e=this.wire(xn,{root:{className:()=>this.eligible()?"leave-card":"leave-card hidden"},leaveBtn:{onclick:()=>this.open.set(!0),disabled:()=>this.leaving.get()},diag:{textContent:()=>this.diagnostics.get().map(t=>t.message).join(" · ")},err:{textContent:()=>this.error.get()}});return this.spawn(X,this.ref(e,"confirmHost"),{open:this.open,title:"Remove yourself from this round?",message:"Your scores here will be deleted. Everyone else's stay, and the round keeps going without you.",confirmLabel:"Remove me",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{this.leave()}}),e}}function kn(i){return!(i.tab!=="leaderboard"||!i.pageVisible||i.status==="complete")}const Sn=2e4;function In(i){if(!(i===null||i===""))return/^\d+$/.test(i)?Number(i):i}const Tn=b(`
...
`),En=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),Cn=b('<button bind="pill" class="round-view__grp" type="button"></button>');class Nn extends T{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class er extends T{static styles=`
        .setup {
            ...
            & .player {
                ...
                & .player__name { flex: 1; padding: ${o("md")}; font-size: 1rem; ${B()} }
                & .player__remove {
                ...
                & .player__index { flex: 1; min-width: 0; padding: ${o("md")}; font-size: 1rem; ${B()} }
            ...
            & .fslot {
                ...
                & .mrow {
                    ...
                    & .mrow__pct {
                        ...
                        &[hidden] { display: none; }
                        & input { width: 56px; padding: ${o("xs")} ${o("sm")}; ${B()} font-size: 0.95rem; }
                    }
                }
                ...
                & .fslot__flat {
                    ...
                    color: ${l("text-muted")};
                    &[hidden] { display: none; }
                    & .fslot__pct { width: 70px; padding: ${o("sm")}; font-size: 1rem; ${B()} }
                }
                & .fslot__bands {
                    display: flex; flex-direction: column; gap: ${o("xs")};
                    &[hidden] { display: none; }
                ...
                & .brow {
                    ...
                    & .brow__pct, & .brow__upto { width: 56px; padding: ${o("sm")}; font-size: 0.95rem; ${B()} }
                ...
                & .grp__start {
                    ...
                    & .grp__time { flex: 1; min-width: 0; padding: ${o("sm")} ${o("md")}; font-size: 1rem; font-family: inherit; ${B()} }
...
`);class sr extends T{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${o("xl")} 0;
...
`);function We(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class or extends T{static styles=`
        .friends {
            padding: ${o("xl")} ${o("lg")} ${o("2xl")};
...
`);class dr extends T{static styles=`
        .profile {
            ...
            & .profile__card {
                ...
                & .profile__edit {
                    ...
                    & input { width: 90px; padding: ${o("md")}; font-size: 1rem; text-align: center; ${B()} }
                    & button {
    ...
    `;svc=this.inject(dt);friends=this.inject(xe);auth=this.inject(M);router=this.inject(j);indexDraft=new h("");localErr=new h("");render(){this.auth.currentUser.get()&&this.svc.load();const e=()=>this.auth.currentUser.get()!==null,t=this.wire(ar,{anon:{className:()=>e()?"profile__anon hidden":"profile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/profile"}})},body:{className:()=>e()?"profile__body":"profile__body hidden"},name:()=>this.svc.player.get()?.displayName??"…",username:()=>{const n=this.svc.player.get();return n?`@${n.username}`:""},hcp:()=>{const n=this.svc.player.get()?.handicapIndex;return n==null?"–":n.toFixed(1)},index:{value:()=>this.indexDraft.get(),oninput:n=>this.indexDraft.set(n.target.value)},save:{disabled:()=>this.svc.saving.get()||this.indexDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},form:{onsubmit:async n=>{n.preventDefault(),this.localErr.set("");const r=this.indexDraft.get().trim().replace(",","."),a=Number.parseFloat(r);if(!Number.isFinite(a)||a<-10||a>54){this.localErr.set("Enter an index between -10 and 54.");return}await this.svc.saveIndex(a)&&this.indexDraft.set("")}},saveErr:{textContent:()=>this.localErr.get()||this.svc.saveError.get()?.message||""},genderErr:{textContent:()=>this.svc.saveError.get()?.message||""},historyEmpty:{className:()=>this.svc.history.get().length===0?"profile__empty":"profile__empty hidden"},signout:{onclick:async()=>{await this.auth.logout(),this.svc.clear(),this.friends.clear(),this.router.navigate("/")}}});this.$each(this.ref(t,"history"),this.svc.history,(n,r,a)=>this.wireEl(lr,{index:()=>n.handicapIndex.toFixed(1),source:()=>n.source,date:()=>n.effectiveDate},a),n=>n.id);const s=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];return this.$each(this.ref(t,"gender"),()=>s,(n,r,a)=>this.wireEl(b('<button bind="b" type="button"></button>'),{b:{textContent:()=>n.label,className:()=>this.svc.player.get()?.gender===n.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.saveGender(n.value)}}},a),n=>n.label),t}}const cr=b(`
    <div class="app-shell">
...
`);class ur extends T{static styles=`
    ...
    `;router=this.inject(j);render(){const e=this.wire(cr,{});return this.spawn(Dt,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Re,"/history":ws,"/round":Nn,"/create":er,"/login":sr,"/friends":or,"/profile":dr},Re),e}}A.get(Tt);const Ve=A.get(j),Qe=A.get(M);await Ct(ur,"#app",{hot:void 0,onInit:async()=>{await Qe.load(),Qe.currentUser.get()&&Ve.route.get()==="/login"&&Ve.navigate("/",!0)}});export{T as C,j as R,h as S,Tt as T,f as a,ne as b,k as c,$ as e,E as r,b as t};
