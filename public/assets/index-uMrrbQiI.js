(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const l of r.addedNodes)l.tagName==="LINK"&&l.rel==="modulepreload"&&s(l)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const Wt="modulepreload",Yt=function(i){return"/tapscore/"+i},qe={},Qt=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const l=document.querySelector("meta[property=csp-nonce]"),d=l?.nonce||l?.getAttribute("nonce");n=c(t.map(u=>{if(u=Yt(u),u in qe)return;qe[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const p=document.createElement("link");if(p.rel=f?"stylesheet":Wt,f||(p.as="script"),p.crossOrigin="",p.href=u,d&&p.setAttribute("nonce",d),document.head.appendChild(p),f)return new Promise((v,y)=>{p.addEventListener("load",v),p.addEventListener("error",()=>y(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(l){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=l,window.dispatchEvent(d),!d.defaultPrevented)throw l}return n.then(l=>{for(const d of l||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})};class Xt{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])this.batching?this.pending.add(t):t.run()}runTracked(e,t){bt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.run()}}}const U=new Xt;function bt(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class h{constructor(e){this.subs=new Set,this.val=e}get(){return U.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,U.notify(this.subs))}update(e){this.set(e(this.val))}}class w{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){U.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,U.notify(t.subs))})},deps:new Set};s.run()}get(){return U.subscribe(this.subs),this.val}peek(){return this.val}}function $(i){const e={run(){U.runTracked(e,i)},deps:new Set};return e.run(),()=>bt(e)}function de(i){U.batch(i)}function V(i){return U.untrack(i)}class Jt{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const z=new Jt,re="/tapscore/".replace(/\/+$/,"");function Ee(i){return re?i===re?"/":i.startsWith(re+"/")?i.slice(re.length):i:i}function Zt(i){return re+i}class N{constructor(){this.route=new h(Ee(location.pathname??"/")),this.search=new h(location.search??""),window.addEventListener("popstate",()=>de(()=>{this.route.set(Ee(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",l=n>=0?e.slice(0,n):e,d=l.indexOf("?"),c=d>=0?l.slice(0,d):l,u=d>=0?l.slice(d+1):"",f=s.query!==void 0?es(s.query):u?"?"+u:"",m=Zt(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),de(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new w(()=>{const s=this.route.get().split("/"),n={};for(const[r,l]of t.entries())l.startsWith(":")&&(n[l.slice(1)]=s[r]??"");return n})}query(e){return new w(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new w(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function es(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function ts(i){return e=>i[e]}function ss(i,e){const t=(n,r,l)=>{const d=Object.entries(n).map(([c,u])=>`--${c}:${u}`).join(";");return`${r}{color-scheme:${l};${d}}`},s=document.createElement("style");return s.textContent=t(i,'[data-theme="light"]',"light")+t(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),n=>`var(--${n})`}const Ke="basics-js-theme";class ns{constructor(){this.dark=new h(!1);const e=localStorage.getItem(Ke),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),$(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(Ke,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(i){const e=document.createElement("template");return e.innerHTML=i,e}function is(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const Ve=new Set;class I{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Ve.has(t)){Ve.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return z.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=V(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0}wire(e,t,s){const n=s??(l=>this.track(l)),r=e.content.cloneNode(!0);for(const l of r.querySelectorAll("[bind]")){const d=t[l.getAttribute("bind")];if(d)if(typeof d=="function")n($(()=>{const c=d();l instanceof HTMLInputElement||l instanceof HTMLTextAreaElement?l.value=String(c):l.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?l.addEventListener(c.slice(2),u):typeof u=="function"?n($(()=>{const m=u();f?l.setAttribute(c,String(m)):l[c]=m})):f?l.setAttribute(c,String(u)):l[c]=u}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof I?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,l,...d)=>this.spawn(r,l,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,l)=>l){const r=typeof t=="function"?t:()=>t.get(),l=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track($(()=>{const c=r(),u=new Map;for(const[m,p]of c.entries()){const v=n(p,m);if(l.has(v))u.set(v,l.get(v));else{const y=[];u.set(v,V(()=>s(p,m,k=>y.push(k)))),d.set(v,y)}}for(const[m,p]of l)u.has(m)||(p.remove(),d.get(m)?.forEach(v=>v()),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);l.clear();for(const[m,p]of u)l.set(m,p)}))}$condition(e,t,s,n){let r=null;this.track($(()=>{r&&(r.remove(),r=null);const l=t.get();r=V(()=>l?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track($(()=>{r&&(r.destroy(),r=null),e.textContent="";const l=t.get(),d=s[l]??is(l,s)??n;d&&(r=V(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}async function rs(i,e,t){const s=document.querySelector(e);s.textContent="";const n=z.get(N);let r=null,l=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await Qt(()=>import("./obs-shell.component-DWt4RtzQ.js"),[])).ObsShellComponent),r=V(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=V(()=>new i)),V(()=>r.mount(s)),l=f};await u(Ee(location.pathname).startsWith("/_obs")),$(()=>{const f=n.route.get().startsWith("/_obs");f!==l&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>r?.destroy()),t.hot.accept())}class M extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const os=10,be=[];let _e=[],oe=null;function as(i){be.push(i),be.length>os&&be.shift()}function ls(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...be],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),_e.push(s),ds()}function ds(){oe||(oe=setTimeout(_t,5e3))}function _t(){if(oe&&(clearTimeout(oe),oe=null),_e.length===0)return;const i=_e;_e=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon("/api/_obs/errors",new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch("/api/_obs/errors",{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&_t()});const cs=3e4,us=2,pe=new Map,yt=new WeakMap;function hs(i){if(i instanceof M)return i.traceId;if(i!=null&&typeof i=="object")return yt.get(i)}async function g(i){if(i.method==="GET"){const e=pe.get(i.url);if(e)return e;const t=Ue(i,us);return pe.set(i.url,t),t.then(()=>pe.delete(i.url),()=>pe.delete(i.url)),t}return Ue(i,0)}async function Ue(i,e){const t=i.timeout??cs;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await ms(ps(i,r),t)}catch(l){if(s=l,!(l instanceof M)&&l!=null&&typeof l=="object"&&yt.set(l,r),l instanceof M||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function ps(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(as({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const l=await n.json().catch(()=>({error:n.statusText}));throw new M(n.status,l.error??n.statusText,l.details,r)}return n.json()}function ms(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}async function C(i,e,t){de(()=>{i.set(!0),e.set(null)});try{const s=await t();return i.set(!1),s}catch(s){const n=fs(s);de(()=>{i.set(!1),e.set(n)}),ls(n.code,n.message,hs(s));return}}function fs(i){return i instanceof M?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}function gs(i){return{me:()=>g({method:"GET",url:`${i}/auth/me`}),login:e=>g({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>g({method:"POST",url:`${i}/auth/logout`,body:{}})}}class O{constructor(){this.api=gs("/api"),this.currentUser=new h(null),this.loading=new h(!1),this.error=new h(null)}async load(){const e=await C(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await C(this.loading,this.error,()=>this.api.login({username:e,password:t}));return s?(this.currentUser.set(s),!0):!1}async logout(){await C(this.loading,this.error,()=>this.api.logout());const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const We={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},o=ss({...We,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},{...We,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"}),D=i=>`var(--${i})`,a=ts({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem"}),x=(i=D("radius"))=>`
...
`);class Bs extends I{static styles=`
    ...
    `;let G=Ae;function Gs(i){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function ae(){return Gs()}const ve=10;class ce{loading=new h(!1);error=new h(null);descriptors=new h([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await C(this.loading,this.error,()=>_.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=ae()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=ae()){return e.labels?.[t]??e.labels?.en??""}presets(e=ae()){return this.descriptors.get().filter(s=>s.preset).sort((s,n)=>{const r=s.preset?.rank??Number.POSITIVE_INFINITY,l=n.preset?.rank??Number.POSITIVE_INFINITY;return r!==l?r-l:(this.labelOf(s,e)??s.id).localeCompare(this.labelOf(n,e)??n.id)})}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{},n=s.teamCount??{};return{count:{min:n.min??2,...n.max!==void 0?{max:n.max}:{}},size:{min:s.teamSize?.min??2,max:s.teamSize?.max??2}}}if(t.slotBallCount){const s=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:s?ve:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function Ct(i){const e=z.get(ce);return e.load(),e.labelOf(i.formatId)??`${i.scoringMode} · ${i.teamShape}`}function qs(i){return i.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:zs(e)||null,date:e.round.date,formats:e.round.formatSlots.map(Ct).join(" · ")}))}function Ks(i){return i.map(e=>({key:e.token,token:e.token,roundId:null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:null,formats:null}))}const le={fromMyRounds:qs,fromDeviceRounds:Ks},Vs=14,Us=1440*60*1e3;function ie(i,e){return e(i)}function Ws(i,e,t,s=Vs){const n=e-s*Us,r=[],l=[];for(const d of i){const c=ie(d,t);if(c.status==="complete"){const u=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(u)||u>=n)&&l.push(d)}else r.push(d)}return r.sort((d,c)=>Je(ie(d,t).lastActivityAt,ie(c,t).lastActivityAt)),l.sort((d,c)=>Je(ie(d,t).completedAt,ie(c,t).completedAt)),{ongoing:r,finished:l}}function Je(i,e){const t=i?Date.parse(i):NaN,s=e?Date.parse(e):NaN,n=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return n===r?0:r-n}const Ys=b(`
    <div class="landing">
...
`),Qs='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Xs=b(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Qs}</button>
    </div>
`),Tt={not_started:"Not started",active:"Live",complete:"Finished"};class Ze extends I{static styles=`
        .landing {
...
`);class sn extends I{static styles=`
    ...
    `;svc=this.inject(De);auth=this.inject(O);router=this.inject(N);loggedIn=new w(()=>this.auth.currentUser.get()!==null);rows=new w(()=>Js(this.loggedIn.get()?le.fromMyRounds(this.svc.myRounds.get()):le.fromDeviceRounds(this.svc.deviceRounds.get())));deleteOpen=new h(!1);deleteTarget=new h(null);askDelete(e,t,s){this.deleteTarget.set({token:e,roundId:t,name:s}),this.deleteOpen.set(!0)}render(){this.loggedIn.get()?this.svc.loadMine():this.svc.loadDevice();const e=this.wire(Zs,{back:{onclick:()=>this.router.navigate("/")},empty:{className:()=>this.rows.get().length===0?"history__empty":"history__empty hidden"}});this.$each(this.ref(e,"list"),this.rows,(s,n,r)=>this.roundRow(s,r),s=>s.key),this.spawn(G,this.ref(e,"confirmHost"),{open:this.deleteOpen,title:"Delete round?",message:()=>{const s=this.deleteTarget.get();return`Delete ${s?`“${s.name}”`:"this round"}? This permanently removes it and all its scores for everyone. This can't be undone.`},confirmLabel:"Delete",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const s=this.deleteTarget.get();s&&this.svc.remove(s.token,s.roundId)}});const t=s=>{s.key==="Escape"&&this.deleteOpen.get()&&this.deleteOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundRow(e,t){return this.wireEl(tn,{row:{disabled:()=>e.token===null,onclick:()=>{e.token!==null&&this.router.navigate("/round",{query:{token:e.token}})}},course:()=>e.courseName||"Round",role:{textContent:()=>e.roleLabel??"",className:()=>e.roleLabel?"round-row__role":"round-row__role hidden"},status:{textContent:()=>Tt[e.status]??e.status,className:()=>`round-row__status s-${e.status}`},date:()=>e.date??"",formats:()=>e.formats??"",del:{className:()=>e.token===null?"round-row__del hidden":"round-row__del",onclick:()=>{e.token!==null&&this.askDelete(e.token,e.roundId??"",e.courseName||"this round")}}},t)}}function Et(i){return i.handicapIndex*(i.slope/113)+(i.courseRating-i.par)}function nn(i){return Math.round(Et(i))}function rn(i,e,t){const s=t;if(s<=0)return 0;if(i>=0){const c=Math.floor(i/s),u=i-c*s;return c+(e>=1&&e<=u?1:0)}const n=-i,r=Math.floor(n/s),l=n-r*s,d=r+(e>s-l?1:0);return d===0?0:-d}const on=180,tt=4,an=12;function ne(i,e){return e<=0?0:Math.max(0,Math.min(e-1,i))}function ln(i){const{dragDistance:e,velocity:t,itemWidth:s}=i;if(Math.abs(e)<an)return 0;const n=e+t*on,r=Math.round(-n/s);return Math.max(-tt,Math.min(tt,r))}const st="tapscore:pending-scores:v1",dn=336*60*60*1e3,nt=200;function cn(){try{return globalThis.localStorage??null}catch{return null}}function un(i){if(typeof i!="object"||i===null)return!1;const e=i;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class hn{entries=[];storage;constructor(e=cn(),t=Date.now()){this.storage=e,this.entries=this.load();const s=this.applyHygiene(t);s.length!==this.entries.length&&(this.entries=s,this.persist())}enqueue(e){const t=this.entries.findIndex(s=>s.token===e.token&&s.ballId===e.ballId&&s.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(s=>s.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(s=>e-s.queuedAt<=dn);return t.length>nt?t.slice(t.length-nt):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(st);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(un):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(st,JSON.stringify(this.entries))}catch{}}}const pn=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Q=(i,e)=>`${i}|${e}`;function Nt(i){return i.players.map(e=>e.displayName).join(" & ")||i.label||"Ball"}function mn(i,e,t){return i?!(i.minPar!==void 0&&e<i.minPar||i.maxPar!==void 0&&e>i.maxPar||i.pars&&!i.pars.includes(e)||i.holes&&!i.holes.includes(t)):!0}class te{constructor(e=new hn){this.queue=e}queue;loading=new h(!1);error=new h(null);friendlyRound=new h(null);round=new h(null);startList=new h(null);balls=new h([]);scorecards=new h([]);cells=new h(new Map);result=new h(null);resultLoading=new h(!1);resultError=new h(null);resultCursor=null;holeIdx=new h(0);groupIdx=new h(0);keypadOpen=new h(!1);selectedSlot=new h(null);token=null;loadSeq=0;resultSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const s=e!==this.token;this.token=e;const n=++this.loadSeq;s&&this.resetForNewToken(t),z.get(ce).load();const r=await C(this.loading,this.error,()=>_.friendlyRounds.byToken({token:e}));if(!r||n!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),ye({token:e,courseName:r.round.courseNameSnapshot??"",status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),z.get(O).currentUser.get()&&Ds(r.round.id),this.pendingSlotIndex!==null){const u=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,u!==null&&this.selectedSlot.set(u)}const[l,d]=await Promise.all([_.friendlyRounds.balls({token:e}).catch(()=>[]),_.friendlyRounds.scorecard({token:e}).catch(()=>[])]);n!==this.loadSeq||e!==this.token||(this.cells.set(new Map),this.scorecards.set(d),this.balls.set(l),await this.flushPending())}deleting=new h(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await _.friendlyRounds.remove({token:e}),St(e);const t=this.round.get()?.id;return t&&xt(t),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new h(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.finish({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:t.completedAt}),ye({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await _.friendlyRounds.reopen({token:e}),s=this.round.get();return e===this.token&&s&&(this.round.set({...s,status:t.status,completedAt:null}),ye({token:e,courseName:s.courseNameSnapshot??"",status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,s=await C(this.resultLoading,this.resultError,()=>_.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||s&&(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let s;try{s=await _.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.resultCursor=s.cursor,s.unchanged||this.result.set(s.result))}ballNameById=new w(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,Nt(t));for(const t of this.result.get()?.slots??[])for(const s of t.subjectLabels??[])e.set(s.ballId,s.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new w(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((s,n)=>{for(const r of s.ballIds)e.set(r,`Group ${n+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(s=>s.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return ne(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),s=t?.playHoles.find(l=>l.id===e);if(!t||!s)return"";const n=t.playHoles.filter(l=>l.courseHoleNumber===s.courseHoleNumber).sort((l,d)=>l.ordinal-d.ordinal);if(n.length===1)return`${s.courseHoleNumber}`;const r=n.findIndex(l=>l.id===e);return`${s.courseHoleNumber} (${pn[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(ne(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(ne(this.holeIndex()+1,this.playedOrder().length))}strokesFor(e,t){const s=this.cells.get().get(Q(e,t));return s?s.strokes:this.scorecards.get().find(l=>l.ballId===e)?.holes.find(l=>l.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Q(e,t))?.status??null}strokesHintFor(e,t){const s=this.round.get();if(!s)return null;const n=this.balls.get().find(m=>m.id===e);if(!n||n.pending)return null;const r=this.selectedSlotDefId(),d=(n.slots.find(m=>m.slotDefId===r)??n.slots[0])?.playingHandicap;if(d==null)return null;const c=this.playHoleById(t);if(!c)return null;const u=n.players[0]?.teeName??null,f=c.tees.find(m=>m.teeName===u)?.strokeIndex??c.baseStrokeIndex;return rn(d,f,s.routeSi.allocationCycleSize)}metadataFor(e,t,s){const n=this.cells.get().get(Q(e,t));return n&&n.metadata!==void 0?n.metadata?.[s]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[s]}metadataInputs(){const e=z.get(ce),t=this.round.get()?.formatSlots??[],s=[],n=new Set;for(const r of t){const l=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of l)n.has(d.key)||(n.add(d.key),s.push(d))}return s}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>mn(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,s,n){const r=Q(e,t),l=crypto.randomUUID();this.patchCell(r,{strokes:s,metadata:n,status:"saving",clientEventId:l});const d=this.token;d&&(this.enqueue(d,e,t,s,n,l),await this.post(d,e,t,s,n,l))}async retry(e,t){const s=Q(e,t),n=this.cells.get().get(s);if(!n)return;this.patchCell(s,{...n,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,n.strokes,n.metadata,n.clientEventId),await this.post(r,e,t,n.strokes,n.metadata,n.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Q(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,s,n,r,l){this.queue.enqueue({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:l,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,s,n,r,l){const d=Q(t,s);try{await _.friendlyRounds.score({token:e,ballId:t,playHoleId:s,strokes:n,eventType:n===null?"score_cleared":"score_entered",clientEventId:l,...r!=null?{metadata:r}:{}}),this.queue.remove(l);const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"saved"});const u=this.round.get();e===this.token&&u&&u.status==="not_started"&&this.round.set({...u,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===l&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const s=new Map(this.cells.get());s.set(e,t),this.cells.set(s)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1);const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}const X=60,it=8,Pe=4,fn=Array.from({length:Pe*2+1},(i,e)=>e-Pe),gn="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",bn=b(`
...
`);class Zi extends I{static styles=`
        .setup {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
...
`);class ir extends I{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${a("xl")} 0;
...
`);function mt(i){return i.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class lr extends I{static styles=`
        .friends {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class ur extends I{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class gr extends I{static styles=`
        .comps {
            ...
            & .comps__create {
                ...
                gap: ${a("sm")};
                margin-bottom: ${a("md")};
                & input { flex: 1; padding: ${a("md")}; font-size: 1rem; ${F()} }
                & button {
                    padding: ${a("md")} ${a("lg")};
...
`),Ir=b('<button bind="chip" class="cd__friendchip" type="button"></button>');class Cr extends I{competitions=this.inject(se);state=this.inject(ue);render(){const e=()=>this.state.id.get()??"",t=this.wire(kr,{count:()=>{const s=this.competitions.participants.get().length;return s===0?"":String(s)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&ze(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:s=>{s.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:s=>this.state.guestNameDraft.set(s.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:s=>this.state.guestGenderDraft.set(s.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:s=>this.state.guestHcpDraft.set(s.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(s,n,r)=>this.wireEl(Sr,{name:()=>s.displayNameSnapshot,category:{textContent:()=>s.category??"",className:()=>s.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>s.withdrawnAt?"Withdrawn":s.cutAfterRound!==null?`Cut R${s.cutAfterRound}`:"",className:()=>s.withdrawnAt||s.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!s.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),s.id)}},remove:{className:()=>this.state.admin.get()&&ze(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),s.id)}}},r),s=>JSON.stringify({id:s.id,name:s.displayNameSnapshot,category:s.category,withdrawnAt:s.withdrawnAt,cutAfterRound:s.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(s,n,r)=>this.wireEl(Ir,{chip:{textContent:()=>s.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(l=>l.playerId===s.id),onclick:()=>{this.competitions.addPlayer(e(),s.id,null)}}},r),s=>s.id),t}}const Tr={not_started:"Not started",active:"Live",complete:"Finished"},Er=b(`
    <section class="cd__section">
...
`),Pr=b('<option bind="option"></option>');class zr extends I{competitions=this.inject(se);state=this.inject(ue);router=this.inject(N);render(){const e=new w(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Er,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&pr(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,n,r)=>this.wireEl(Pr,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,n,r)=>this.wireEl(Nr,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>Tr[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function Or(i,e,t){return JSON.stringify({entry:i,points:e,columns:t})}function Rr(i){return i.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const jr=b(`
    <div>
...
`),Dr=b('<button bind="button" type="button"></button>'),Lr=b('<th bind="cell"></th>'),Hr=b('<tr bind="row"></tr>'),Mr=b('<td bind="cell"><span bind="value"></span></td>'),Fr=b(`
...
`);class qr extends I{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
            ...
            & .cd__form {
                ...
                & .cd__field { display: flex; flex-direction: column; gap: ${a("xs")};
                    ...
                    & input, & select { padding: ${a("sm")} ${a("md")}; font-size: 0.95rem; ${F()} }
                }
            ...
            & .cd__guestrow input, & .cd__addroundrow input, & .cd__addroundrow select {
                padding: ${a("sm")} ${a("md")}; font-size: 0.9rem; ${F()} min-width: 0; }
...
`);class Vr extends I{static styles=`
    ...
    `;router=this.inject(N);render(){const e=this.wire(Kr,{});return this.spawn(Bs,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Ze,"/history":sn,"/round":xi,"/create":Zi,"/login":ir,"/friends":lr,"/profile":ur,...It.competitions?{"/competitions":gr,"/competition":qr}:{}},Ze),e}}class Ur extends O{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Ht(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await er()),this.error.set(null)}catch(e){e instanceof M&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await tr(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof M&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}z.get(ns);const ft=z.get(N);z.set(O,new Ur);const gt=z.get(O);await rs(Vr,"#app",{hot:void 0,onInit:async()=>{await gt.load(),gt.currentUser.get()&&ft.route.get()==="/login"&&ft.navigate("/",!0)}});export{I as C,N as R,h as S,ns as T,g as a,de as b,w as c,$ as e,C as r,b as t};
