(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Sa="modulepreload",Ta=function(s){return"/tapscore/"+s},$n={},Pa=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(h=>Promise.resolve(h).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");i=c(t.map(u=>{if(u=Ta(u),u in $n)return;$n[u]=!0;const h=u.endsWith(".css"),f=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${f}`))return;const m=document.createElement("link");if(m.rel=h?"stylesheet":Sa,h||(m.as="script"),m.crossOrigin="",m.href=u,d&&m.setAttribute("nonce",d),document.head.appendChild(m),h)return new Promise((_,g)=>{m.addEventListener("load",_),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return i.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Di="/tapscore/".replace(/\/+$/,""),Bs=Di+"/api",Qt={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","confirm-btn-min-height":"44px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Ca=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Ia(s,e){const t={};for(const[n,i]of Ca)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const ji=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Ea={thin:"1px",medium:"3px",thick:"5px"};function qi(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Ea[e.toLowerCase()]??e}function Ra(){return ji.map(s=>{const e=qi(Qt[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Vi={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Ui={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Na={...Ui,"done-opacity":"0.35"},Oa={...Vi,...Ui,...Qt,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ha={...Vi,...Na,...Qt,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Ma{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Ki(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const $e=new Ma;function Ki(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return $e.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,$e.notify(this.subs))}update(e){this.set(e(this.val))}}class T{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){$e.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,$e.notify(t.subs))})},deps:new Set};n.run()}get(){return $e.subscribe(this.subs),this.val}peek(){return this.val}}function C(s){const e={run(){$e.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,Ki(e)}}function dt(s){$e.batch(s)}function se(s){return $e.untrack(s)}class Aa{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const Y=new Aa,Ze=Di;function Ls(s){return Ze?s===Ze?"/":s.startsWith(Ze+"/")?s.slice(Ze.length):s:s}function Ba(s){return Ze+s}class q{constructor(){this.route=new p(Ls(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>dt(()=>{this.route.set(Ls(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",o=i>=0?e.slice(0,i):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,u=d>=0?o.slice(d+1):"",h=n.query!==void 0?La(n.query):u?"?"+u:"",f=Ba(c)+h+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",f),dt(()=>{this.route.set(c),this.search.set(h)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new T(()=>{const n=this.route.get().split("/"),i={};for(const[r,o]of t.entries())o.startsWith(":")&&(i[o.slice(1)]=n[r]??"");return i})}query(e){return new T(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new T(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function La(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function za(s){return e=>s[e]}const Fa="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Sn="data-basics-global";function Ga(){if(document.head.querySelector(`style[${Sn}]`))return;const s=document.createElement("style");s.setAttribute(Sn,""),s.textContent=Ra()+Fa,document.head.appendChild(s)}function Da(s,e){Ga();const t=new Set(ji),n=(r,o,d)=>{const c=Object.entries(r).map(([u,h])=>`--${u}:${t.has(u)?qi(h):h}`).join(";");return`${o}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const Tn="basics-js-theme";class ja{constructor(){this.dark=new p(!1);const e=localStorage.getItem(Tn),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),C(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(Tn,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function b(s){const e=document.createElement("template");return e.innerHTML=s,e}function qa(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Pn=new Set;class M{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!Pn.has(t)){Pn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return Y.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=se(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){se(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")i(C(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const h=c.includes("-");c.startsWith("on")&&typeof u=="function"?o.addEventListener(c.slice(2),u):typeof u=="function"?i(C(()=>{const f=u();h?o.setAttribute(c,String(f)):o[c]=f})):h?o.setAttribute(c,String(u)):o[c]=u}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof M?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(C(()=>{const c=r(),u=new Map;for(const[f,m]of c.entries()){const _=i(m,f);if(o.has(_))u.set(_,o.get(_));else{const g=[];u.set(_,se(()=>n(m,f,v=>g.push(v)))),d.set(_,g)}}for(const[f,m]of o)u.has(f)||(m.remove(),se(()=>d.get(f)?.forEach(_=>_())),d.delete(f));let h=e.firstChild;for(const f of u.values())f===h?h=h.nextSibling:e.insertBefore(f,h);o.clear();for(const[f,m]of u)o.set(f,m)}))}$condition(e,t,n,i){let r=null;this.track(C(()=>{r&&(r.remove(),r=null);const o=t.get();r=se(()=>o?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(C(()=>{if(r){const c=r;r=null,se(()=>c.destroy())}e.textContent="";const o=t.get(),d=n[o]??qa(o,n)??i;d&&(r=se(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Mt=new Set;function Va(s){return Mt.add(s),()=>Mt.delete(s)}function Ua(){for(const s of Array.from(Mt)){Mt.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ka(s,e,t){const n=document.querySelector(e);n.textContent="";const i=Y.get(q);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const u=async h=>{r&&(r.destroy(),r=null,n.textContent=""),h?(d||(d=(await Pa(()=>import("./obs-shell.component-BYwxTSB5.js"),[])).ObsShellComponent),r=se(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=se(()=>new s)),se(()=>r.mount(n)),o=h};await u(Ls(location.pathname).startsWith("/_obs")),C(()=>{const h=i.route.get().startsWith("/_obs");h!==o&&u(h)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(h){console.error("[startApp] the root component threw while disposing",h)}if(r=null,Ua(),t.onDispose)try{t.onDispose()}catch(h){console.error("[startApp] onDispose threw",h)}}),t.hot.accept())}class J extends Error{constructor(e,t,n,i,r){super(t),this.status=e,this.details=n,this.traceId=i,this.detail=r,this.name="ApiError"}}const Wa=10,Rt=[];let Nt=[],rt=null;function Ya(s){Rt.push(s),Rt.length>Wa&&Rt.shift()}function Wi(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Rt],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Nt.push(n),Xa()}function Xa(){rt||(rt=setTimeout(Yi,5e3))}function Yi(){if(rt&&(clearTimeout(rt),rt=null),Nt.length===0)return;const s=Nt;Nt=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Bs}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Bs}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Yi()});const Qa=3e4,Ja=2,vt=new Map,Xi=new WeakMap;function Za(s){if(s instanceof J)return s.traceId;if(s!=null&&typeof s=="object")return Xi.get(s)}async function y(s){if(s.method==="GET"){const e=vt.get(s.url);if(e)return e;const t=Cn(s,Ja);return vt.set(s.url,t),t.then(()=>vt.delete(s.url),()=>vt.delete(s.url)),t}return Cn(s,0)}async function Cn(s,e){const t=s.timeout??Qa;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await to(eo(s,r),t)}catch(o){if(n=o,!(o instanceof J)&&o!=null&&typeof o=="object"&&Xi.set(o,r),o instanceof J||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw n}async function eo(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Ya({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const o=await i.json().catch(()=>({error:i.statusText}));throw new J(i.status,o.error??i.statusText,o.details,r,o.detail)}return i.json()}function to(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const zs=new Set;let fs=!1;function so(s){return zs.add(s),()=>{zs.delete(s)}}function Qi(){if(!fs){fs=!0;try{for(const s of[...zs])try{s()}catch(e){try{Wi("session-listener",no(e))}catch{}}}finally{fs=!1}}}function no(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function F(s,e,t,n={}){dt(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=io(i);dt(()=>{s.set(!1),e.set(r)}),Wi(r.code,r.message,Za(i)),r.code==="auth"&&n.sessionExpiry!==!1&&Qi();return}}function io(s){return s instanceof J?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const ms={sessionExpiry:!1};function ro(s){return{me:()=>y({method:"GET",url:`${s}/auth/me`}),login:e=>y({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>y({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class V{constructor(){this.api=ro(Bs),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=so(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Va(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await F(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await F(this.loading,this.error,()=>this.api.login({username:e,password:t}),ms);return n?(this.currentUser.set(n),!0):!1}async logout(){await F(this.loading,this.error,()=>this.api.logout(),ms);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await F(this.loading,this.error,()=>this.api.logoutAll(),ms),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Ji={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},ao={...Ji,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},oo={...Ji,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function Zi(s,e={}){const t=s==="light"?ao:oo,n=s==="light"?Oa:Ha;return Ia({...t,...e},n)}const lo=Zi("light"),co=Zi("dark"),l=Da(lo,co),L=s=>`var(--${s})`,I=(s,e)=>`var(--${s}, ${e})`,E=s=>{const e=Qt[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},uo=s=>I(s,E(s)),a=za({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),wt=s=>`
    ...
    cursor: not-allowed;`,ho={primary:wt("primary"),secondary:wt("secondary"),ghost:wt("ghost"),danger:wt("danger"),disabled:er},S=(s=I("btn-radius",E("btn-radius")),e="secondary")=>`
    /*
    ...
    ${ho[e]}
    &:disabled {${er}}
`,po=`max(${I("field-border-width",E("field-border-width"))}, ${I("field-rule-width",E("field-rule-width"))})`,xt=(s,e)=>`
    border-top-color: ${s};
...
`);class Jo extends M{static styles=`
    ...
    `;let Vs=xn;const A=s=>`var(--${s})`;let ju=0;const kn=class kn extends M{constructor(){super(...arguments),this.returnFocusTo=null,this.wasOpen=!1}render(){const e=document.createElement("div"),t=(u,h)=>{typeof h=="function"?this.track(C(()=>{u.textContent=h()})):u.textContent=h};this.spawn(Vs,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200",this.dialogEl.setAttribute("role","dialog"),this.dialogEl.setAttribute("aria-modal","true"),this.dialogEl.setAttribute("tabindex","-1");const n=`ui-confirm-${++ju}`,i=document.createElement("h2");i.className="ui-confirm__title",i.id=`${n}-title`,t(i,this.props.title??"Confirm"),this.dialogEl.setAttribute("aria-labelledby",i.id),this.dialogEl.appendChild(i);const r=document.createElement("p");r.className="ui-confirm__message",r.id=`${n}-message`,t(r,this.props.message),this.dialogEl.setAttribute("aria-describedby",r.id),this.dialogEl.appendChild(r);const o=document.createElement("div");o.className="ui-confirm__actions";const d=document.createElement("button");d.className="ui-confirm__btn ui-confirm__btn--cancel",t(d,this.props.cancelLabel??"Cancel"),d.addEventListener("click",u=>{u.stopPropagation(),this.handleCancel()}),o.appendChild(d),this.cancelEl=d;const c=document.createElement("button");return c.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(c,this.props.confirmLabel??"Confirm"),c.addEventListener("click",u=>{u.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),o.appendChild(c),this.confirmEl=c,this.dialogEl.appendChild(o),this.dialogEl.addEventListener("click",u=>u.stopPropagation()),this.dialogEl.addEventListener("keydown",u=>this.onKeydown(u)),e.appendChild(this.dialogEl),this.track(C(()=>{const u=this.props.open.get();u&&this.dialogEl.removeAttribute("inert"),this.dialogEl.classList.toggle("open",u),u||this.dialogEl.setAttribute("inert",""),u!==this.wasOpen&&(this.wasOpen=u,u?this.captureFocus():this.restoreFocus())})),e}onMount(){this.props.open.get()&&!this.dialogEl.contains(document.activeElement)&&this.captureFocus()}captureFocus(){const e=document.activeElement;this.returnFocusTo=e instanceof HTMLElement?e:null,this.cancelEl.focus()}restoreFocus(){const e=this.returnFocusTo;this.returnFocusTo=null,e&&e.isConnected&&e.focus()}onKeydown(e){if(!this.props.open.get())return;if(e.key==="Escape"){e.preventDefault(),e.stopPropagation(),this.handleCancel();return}if(e.key!=="Tab")return;const t=this.cancelEl,n=this.confirmEl,i=document.activeElement;e.shiftKey&&(i===t||i===this.dialogEl)?(e.preventDefault(),n.focus()):!e.shiftKey&&i===n&&(e.preventDefault(),t.focus())}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}onDestroy(){this.wasOpen&&this.restoreFocus()}};kn.styles=`
        ...
        .ui-confirm__btn {
            ...
            align-items: center;
            justify-content: center;
            min-height: ${uo("confirm-btn-min-height")};
            padding: 9px 20px;
            font-size: 13px;
            line-height: 20px;
            font-family: ${A("font-ui")};
    ...
    `;let oe=kn;async function qu(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const Vu="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Ee(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Se(s){const e=()=>ol(s());return{avatarPhoto:{src:()=>e()??Vu,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return ll(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function ze(s,e="0.85rem"){return`
        position: relative;
    ...
    `}const Uu="/tapscore/";function Ku(s=Uu){const e=s.trim().replace(/\/+$/,"");return`${e===""?"":e}/manage/`}function Wu(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.canManageCourses&&e.push({kind:"course-setup",label:"Course setup"}),s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function Yu(s){return Wu(s).map(e=>e.kind)}function Jn(s){return s.signedIn?"avatar":"signin"}const Xu=b(`
...
`);class Qu extends M{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),rh='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',mn=`
...
`,ah=b(`
    <div class="round-row">
        ...
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${rh}</button>
...
`),hh='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',ph=b(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${mn}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${hh}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
...
`;function Wr(s,e,t=""){const n=t?`info-dot ${t}`:"info-dot";return`<button bind="${s}" class="${n}" type="button" aria-label="${e}"><span aria-hidden="true">i</span></button>`}const Yr=`
        .info-dot {
            ...
            &:hover { color: ${l("text")}; }
            &.hidden { display: none; }
        }`,Ne=60,si=8,Us=4,wh=Array.from({length:Us*2+1},(s,e)=>e-Us),xh="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",kh=b(`
...
`),Ih=b('<button bind="btn" class="se-seg" type="button"></button>'),ri=b(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),Eh=b('<div bind="rule" class="se-stats__rule"></div>');class Rh extends M{static styles=`
        .se {
            margin-top: ${a("xl")};
            &.hidden { display: none; }
        }
...
</tr>`;const U=Ks(n.plan.slotDefId,N.ballIds),O=n.isOpen(U),ee=ep(U),ce=ea(B,n.routeSections,e,{mode:n.mode??"product"}),ue=["lb-rank__row--expandable"];return _.lead&&ue.push("lb-rank__lead"),O&&ue.push("lb-rank__row--open"),`<tr class="${ue.join(" ")}" data-expand-key="${G(U)}">
  <td class="lb-rank__pos">${_.position}</td>
...
</div>`}function sp(s,e){const t=Gh(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",o=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const np={ranked:tp,match_summary:(s,e)=>sp(s,e)},ip={"default-score-grid":Xh,"compact-match-grid":Qh,"category-matrix-grid":Jh};function rp(s){return`<div class="lb-diag">Unrenderable result section <code>${G(s)}</code> — no generic view yet. Results are not hidden.</div>`}function ap(s){return`<div class="lb-diag">Unsupported score-grid component <code>${G(s)}</code> — no generic view yet. Results are not hidden.</div>`}function op(s,e,t,n=null){const i=np[s.kind];return i?i(s,e,t,n):rp(s.kind)}function ea(s,e,t,n){const i=Qr(s),r=ip[i];return r?r(s,e,t,n):ap(i)}function ta(s,e,t=Zr,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${G(s.formatLabel)}.</div>`:s.leaderboard.map(r=>op(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${G(s.formatLabel)}.</div>`}function sa(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>ea(r,e,t,{mode:i})).join(`
`)}const lp=b(`
...
`);class hp extends M{static styles=`
    ...
    `,lt.seq=0;let pe=lt;function fp(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function mp(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function gp(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const bp=b(`
...
`);class Sp extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(V);router=this.inject(q);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return xp(this.svc.startList.get())}eligible(){return this.policyState().visible&&wp(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,w.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await w.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof J&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(C(()=>this.ensureTeesLoaded()));const e=new T(()=>kp(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(C(()=>{const r=e.get(),o=this.groupChoice.get();(!o||!r.options.some(d=>d.value===o&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire($p,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new pe({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new pe({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const li=1440*60*1e3;function Tp(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>li?!0:e-t>=li}function Pp(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function Cp(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!Pp(s.balls,s.playerId)||!Tp(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function ve(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Ut(s){return s<0?`+${String(-s)}`:String(s)}const Ip=b(`
...
`);class Ep extends M{static styles=`
    ...
    `;svc=this.inject(ge);auth=this.inject(V);profile=this.inject(Ie);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return Cp({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Ut(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=ve(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(C(()=>this.ensureProfileLoaded())),this.wire(Ip,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Ut(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function Rp(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const Np=b(`
...
`);class qp extends M{static styles=`
...
${cs}
    `;round=this.inject(ge);stats=this.inject(pt);auth=this.inject(V);router=this.inject(q);colors=ps;infoOpen=new p(!1);render(){this.track(C(()=>{const i=this.eligibleRoundId();se(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Df,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>wi.title,score:()=>{const i=e();return i===null?"":ua(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>$.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>ye.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>wi.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Ye(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...he],(i,r,o)=>this.wireEl(qf,{label:()=>os(i),amount:{textContent:()=>{const d=n(i);return d===null?$.notRecorded:we(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Qe(us(d),this.colors)}`}}},o),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Xt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:he.map(r=>Te(i.waterfall,r)),penaltySource:Yt(i.panels.totals),baseline:this.stats.sgInfo.get()})},(i,r,o)=>this.wireEl(yt,{ctitle:()=>i.title,ctext:()=>i.body},o),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,o)=>this.wireEl(jf,{text:()=>Gf(i)},o),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:na({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ia({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return te.waterfallHint;let t=null;for(const n of he){const i=dn(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?te.waterfallHint:ha(t,e.windowCount)}}function Si(s){return!(!s.pageVisible||s.status==="complete")}function Uf(s,e){return e&&!s}const Kf=2,Ti=3,Wf=75e3;function Yf(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${W}/friendly-rounds/events?${t.toString()}`}function Xf(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Qf(s){const e=s.eventSourceFactory??(B=>new EventSource(B)),t=s.setTimer??((B,U)=>setTimeout(B,U)),n=s.clearTimer??(B=>clearTimeout(B)),i=s.livenessTimeoutMs??Wf,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let o=!1,d=0,c=null,u=null,h=s.since??null;const f=()=>{u!==null&&(n(u),u=null)},m=()=>{f(),u=t(k,i)},_=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{o=!0,f(),_()},v=()=>{if(_(),++d>=Ti){g(),s.onDegrade();return}N()};function k(){if(!o){if(!r()){m();return}v()}}function N(){if(o)return;let B;try{B=e(Yf(s.token,h))}catch{g(),s.onDegrade();return}c=B,B.onopen=()=>{d=0},B.onmessage=U=>{if(o||c!==B)return;m();let O;try{O=JSON.parse(U.data)}catch{return}Xf(O)&&(O.latestEventId!==null&&(h=O.latestEventId),s.onEvent({latestEventId:O.latestEventId,status:O.status}))},B.onerror=()=>{o||c!==B||(B.readyState===Kf||++d>=Ti)&&(g(),s.onDegrade())},m()}return N(),{stop:()=>{o||g()}}}const Jf=2e4;function Zf(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const em=b(`
...
`),tm=b('<button bind="pill" class="round-view__fmt" type="button"></button>'),sm=b('<button bind="pill" class="round-view__grp" type="button"></button>');class nm extends M{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`),Lm='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',zm=b(`
...
`),Ai=b(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Lm}</button>
    </div>
...
`);function ya(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Ol(s),subtitle:()=>Hl(s,Fe),progress:()=>Ml(s)}}function _a(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class Km extends M{static styles=`
    ...
    `;svc=this.inject(ss);auth=this.inject(V);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],o=()=>(t.get()??"").trim(),d=this.wire(Vm,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:o()}})},subtitle:{textContent:()=>{const c=o();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ke[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ke[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(o())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,u,h)=>this.wireEl(Um,{name:()=>c.courseName??"Course",facts:()=>Bl(c,Fe)},h),c=>c.courseId),d}}function Wm(s,e,t){const n=ft(e);if(n){const d=Li(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=Li(s)??"this",r=ft(t),o=r?` at ${r}`:"";return`Watching · ${i} round${o}`}function Ym(s,e,t,n){const i=ft(s)===null?null:ft(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Xm="You're watching this round. Only its players can enter scores.",Bi={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Li(s){const e=ft(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function ft(s){return(s??"").trim()||null}const Qm=b(`
    <div class="spectate">
...
`);class Jm extends M{static styles=`
        ...
        ${_n.styles}
    `;svc=this.inject(br);auth=this.inject(V);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();se(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),o=()=>(t.get()??"").trim()||null;return this.wire(Qm,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(o()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Bi[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Bi[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?Wm(o(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?Ym(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>Fe(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const o=i.length>1?`<h2 class="spectate__slot-head">${Zm(r.formatLabel)}</h2>`:"",d=ta(r,t,n),c=sa(r.cards,e.result.routeSections,t),u=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return o+d+u}).join("")}}function Zm(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const eg=b(`
    <div class="profile">
...
`),lg=b('<h3 bind="text" class="block__subhead"></h3>'),dg=b(`
...
`);class va extends M{static styles=`
${cs}
        .statspanels {
...
`),Rg=b('<li bind="text" class="roundstats__legenditem"></li>');function Ng(){const s=[];for(const[e,t]of Object.entries(bn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
...
`),Lg={not_started:"Not started",active:"Playing",complete:"Done"},zg={private:"Private",friends:"Friends",link:"Link"};function Fg(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Gg(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Dg extends M{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class kb extends M{static styles=`
    ...
    `;router=this.inject(q);render(){const e=this.wire(xb,{header:{className:()=>tn(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Qu,this.ref(e,"account")),this.spawn(Jo,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":ei,"/history":fh,"/round":nm,"/create":Nm,"/login":Am,"/friends":Fm,"/friend":Dm,"/friend-rounds":qm,"/friend-courses":Km,"/spectate":Jm,"/profile":ng,"/stats":$g,"/round-stats":Og,"/admin":Dg,...nr.competitions?{"/competitions":Kg,"/competition":wb}:{}},ei),e}}class $b extends V{constructor(e){super(),this.client=e}client;async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof J&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}Y.get(ja);const Fi=Y.get(q);Y.set(V,new $b(ga));const Gi=Y.get(V);await Ka(kb,"#app",{hot:void 0,onInit:async()=>{await Gi.load(),Gi.currentUser.get()&&Fi.route.get()==="/login"&&Fi.navigate("/",!0)}});export{Bs as A,M as C,q as R,p as S,ja as T,y as a,dt as b,T as c,Ha as d,C as e,Oa as n,F as r,b as t};
