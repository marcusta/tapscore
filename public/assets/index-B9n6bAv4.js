(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const n of document.querySelectorAll('link[rel="modulepreload"]'))s(n);new MutationObserver(n=>{for(const r of n)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&s(o)}).observe(document,{childList:!0,subtree:!0});function t(n){const r={};return n.integrity&&(r.integrity=n.integrity),n.referrerPolicy&&(r.referrerPolicy=n.referrerPolicy),n.crossOrigin==="use-credentials"?r.credentials="include":n.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(n){if(n.ep)return;n.ep=!0;const r=t(n);fetch(n.href,r)}})();const xs="modulepreload",$s=function(i){return"/tapscore/"+i},dt={},ks=function(e,t,s){let n=Promise.resolve();if(t&&t.length>0){let c=function(h){return Promise.all(h.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");n=c(t.map(h=>{if(h=$s(h),h in dt)return;dt[h]=!0;const f=h.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${m}`))return;const u=document.createElement("link");if(u.rel=f?"stylesheet":xs,f||(u.as="script"),u.crossOrigin="",u.href=h,d&&u.setAttribute("nonce",d),document.head.appendChild(u),f)return new Promise((y,g)=>{u.addEventListener("load",y),u.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return n.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Ft="/tapscore/".replace(/\/+$/,""),qe=Ft+"/api",Ee={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Ss=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Bt(i,e){const t={};for(const[s,n]of Ss)if(s in i)for(const r of n)r in i||(t[r]=`var(--${s})`);return{...e,...t,...i}}const Gt=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Cs={thin:"1px",medium:"3px",thick:"5px"};function qt(i){const e=i.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Cs[e.toLowerCase()]??e}function Ts(){return Gt.map(i=>{const e=qt(Ee[i]);return`@property --${i}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Kt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Vt={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Is={...Vt,"done-opacity":"0.35"},Es={...Kt,...Vt,...Ee,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ns={...Kt,...Is,...Ee,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Ps{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;Ut(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const Y=new Ps;function Ut(i){for(const e of i.deps)e.delete(i);i.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,Y.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){Y.runTracked(s,()=>{const n=e();Object.is(t.val,n)||(t.val=n,Y.notify(t.subs))})},deps:new Set};s.run()}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}}function N(i){const e={run(){Y.runTracked(e,i)},deps:new Set};return e.run(),()=>{e.disposed=!0,Ut(e)}}function he(i){Y.batch(i)}function q(i){return Y.untrack(i)}class zs{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const B=new zs,oe=Ft;function Ke(i){return oe?i===oe?"/":i.startsWith(oe+"/")?i.slice(oe.length):i:i}function Os(i){return oe+i}class D{constructor(){this.route=new p(Ke(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>he(()=>{this.route.set(Ke(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},n=e.indexOf("#"),r=n>=0?e.slice(n):"",o=n>=0?e.slice(0,n):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,h=d>=0?o.slice(d+1):"",f=s.query!==void 0?Rs(s.query):h?"?"+h:"",m=Os(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),he(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:n=>{n.preventDefault(),this.navigate(e)},className:()=>{const n=this.route.get();return n===s||n.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const s=this.route.get().split("/"),n={};for(const[r,o]of t.entries())o.startsWith(":")&&(n[o.slice(1)]=s[r]??"");return n})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Rs(i){const e=new URLSearchParams;for(const[s,n]of Object.entries(i))n==null||n===""||e.set(s,String(n));const t=e.toString();return t?"?"+t:""}function js(i){return e=>i[e]}const Ls="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ct="data-basics-global";function Ds(){if(document.head.querySelector(`style[${ct}]`))return;const i=document.createElement("style");i.setAttribute(ct,""),i.textContent=Ts()+Ls,document.head.appendChild(i)}function As(i,e){Ds();const t=new Set(Gt),s=(r,o,d)=>{const c=Object.entries(r).map(([h,f])=>`--${h}:${t.has(h)?qt(f):f}`).join(";");return`${o}{color-scheme:${d};${c}}`},n=document.createElement("style");return n.textContent=s(i,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(n),r=>`var(--${r})`}const ut="basics-js-theme";class Ms{constructor(){this.dark=new p(!1);const e=localStorage.getItem(ut),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),N(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ut,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(i){const e=document.createElement("template");return e.innerHTML=i,e}function Hs(i,e){let t;for(const s of Object.keys(e))i.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const ht=new Set;class O{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!ht.has(t)){ht.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return B.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const n=q(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(n),n}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){q(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const n=s??(o=>this.track(o)),r=e.content.cloneNode(!0);for(const o of r.querySelectorAll("[bind]")){const d=t[o.getAttribute("bind")];if(d)if(typeof d=="function")n(N(()=>{const c=d();o instanceof HTMLInputElement||o instanceof HTMLTextAreaElement?o.value=String(c):o.textContent=String(c)}));else for(const[c,h]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof h=="function"?o.addEventListener(c.slice(2),h):typeof h=="function"?n(N(()=>{const m=h();f?o.setAttribute(c,String(m)):o[c]=m})):f?o.setAttribute(c,String(h)):o[c]=h}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const n=this.ref(t,e);return n?(typeof s=="string"?n.textContent=s:typeof s=="function"&&s.prototype instanceof O?this.spawn(s,n):typeof s=="function"&&s(n,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,n=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(h=>h());d.clear()}),this.track(N(()=>{const c=r(),h=new Map;for(const[m,u]of c.entries()){const y=n(u,m);if(o.has(y))h.set(y,o.get(y));else{const g=[];h.set(y,q(()=>s(u,m,k=>g.push(k)))),d.set(y,g)}}for(const[m,u]of o)h.has(m)||(u.remove(),q(()=>d.get(m)?.forEach(y=>y())),d.delete(m));let f=e.firstChild;for(const m of h.values())m===f?f=f.nextSibling:e.insertBefore(m,f);o.clear();for(const[m,u]of h)o.set(m,u)}))}$condition(e,t,s,n){let r=null;this.track(N(()=>{r&&(r.remove(),r=null);const o=t.get();r=q(()=>o?s():n?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,n){let r=null;this.track(N(()=>{if(r){const c=r;r=null,q(()=>c.destroy())}e.textContent="";const o=t.get(),d=s[o]??Hs(o,s)??n;d&&(r=q(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Te=new Set;function Fs(i){return Te.add(i),()=>Te.delete(i)}function Bs(){for(const i of Array.from(Te)){Te.delete(i);try{i()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Gs(i,e,t){const s=document.querySelector(e);s.textContent="";const n=B.get(D);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const h=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await ks(()=>import("./obs-shell.component-CMg2_0pz.js"),[])).ObsShellComponent),r=q(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=q(()=>new i)),q(()=>r.mount(s)),o=f};await h(Ke(location.pathname).startsWith("/_obs")),N(()=>{const f=n.route.get().startsWith("/_obs");f!==o&&h(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,Bs(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class K extends Error{constructor(e,t,s,n){super(t),this.status=e,this.details=s,this.traceId=n,this.name="ApiError"}}const qs=10,ke=[];let Se=[],de=null;function Ks(i){ke.push(i),ke.length>qs&&ke.shift()}function Wt(i,e,t){const s={code:i,message:e,url:typeof location<"u"?location.href:"",context:[...ke],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Se.push(s),Vs()}function Vs(){de||(de=setTimeout(Yt,5e3))}function Yt(){if(de&&(clearTimeout(de),de=null),Se.length===0)return;const i=Se;Se=[];for(const e of i){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${qe}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${qe}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Yt()});const Us=3e4,Ws=2,be=new Map,Qt=new WeakMap;function Ys(i){if(i instanceof K)return i.traceId;if(i!=null&&typeof i=="object")return Qt.get(i)}async function b(i){if(i.method==="GET"){const e=be.get(i.url);if(e)return e;const t=pt(i,Ws);return be.set(i.url,t),t.then(()=>be.delete(i.url),()=>be.delete(i.url)),t}return pt(i,0)}async function pt(i,e){const t=i.timeout??Us;let s;for(let n=0;n<=e;n++){const r=crypto.randomUUID();try{return await Xs(Qs(i,r),t)}catch(o){if(s=o,!(o instanceof K)&&o!=null&&typeof o=="object"&&Qt.set(o,r),o instanceof K||n===e)break;await new Promise(d=>setTimeout(d,1e3*2**n))}}throw s}async function Qs(i,e){const t={"X-Trace-Id":e},s={method:i.method,headers:t};i.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(i.body));const n=await fetch(i.url,s),r=n.headers.get("x-trace-id")??e;if(Ks({type:"api",detail:`${i.method} ${i.url}`,timestamp:new Date().toISOString()}),!n.ok){const o=await n.json().catch(()=>({error:n.statusText}));throw new K(n.status,o.error??n.statusText,o.details,r)}return n.json()}function Xs(i,e){let t;const s=new Promise((n,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([i,s]).finally(()=>clearTimeout(t))}const Ve=new Set;let Re=!1;function Js(i){return Ve.add(i),()=>{Ve.delete(i)}}function Zs(){if(!Re){Re=!0;try{for(const i of[...Ve])try{i()}catch(e){try{Wt("session-listener",en(e))}catch{}}}finally{Re=!1}}}function en(i){try{if(i instanceof Error){const e=i.message;if(typeof e=="string")return e}return String(i)}catch{return"listener threw a value that could not be described"}}async function R(i,e,t,s={}){he(()=>{i.set(!0),e.set(null)});try{const n=await t();return i.set(!1),n}catch(n){const r=tn(n);he(()=>{i.set(!1),e.set(r)}),Wt(r.code,r.message,Ys(n)),r.code==="auth"&&s.sessionExpiry!==!1&&Zs();return}}function tn(i){return i instanceof K?i.status===401?{code:"auth",message:"Unauthorized"}:i.status===409?{code:"conflict",message:"Data has changed — please try again"}:i.status===400?{code:"validation",message:i.message}:i.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:i instanceof Error?i.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const mt={sessionExpiry:!1};function sn(i){return{me:()=>b({method:"GET",url:`${i}/auth/me`}),login:e=>b({method:"POST",url:`${i}/auth/login`,body:e}),logout:()=>b({method:"POST",url:`${i}/auth/logout`,body:{}})}}class H{constructor(){this.api=sn(qe),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=Js(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Fs(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await R(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await R(this.loading,this.error,()=>this.api.login({username:e,password:t}),mt);return s?(this.currentUser.set(s),!0):!1}async logout(){await R(this.loading,this.error,()=>this.api.logout(),mt);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const Xt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},nn={...Xt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},rn={...Xt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},on=Bt(nn,Es),an=Bt(rn,Ns),a=As(on,an),E=i=>`var(--${i})`,x=(i,e)=>`var(--${i}, ${e})`,$=i=>{const e=Ee[i];if(e===void 0)throw new Error(`unknown control token: --${i}`);return e},l=js({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ye=i=>`
    ...
    cursor: not-allowed;`,ln={primary:ye("primary"),secondary:ye("secondary"),ghost:ye("ghost"),danger:ye("danger"),disabled:Jt},T=(i=x("btn-radius",$("btn-radius")),e="secondary")=>`
    /*
    ...
    ${ln[e]}
    &:disabled {${Jt}}
`,dn=`max(${x("field-border-width",$("field-border-width"))}, ${x("field-rule-width",$("field-rule-width"))})`,_e=(i,e)=>`
    border-top-color: ${i};
...
</tr>`,g=i.entries[m],k=s&&g?s.plan.attached.get(Ye(s.plan.slotDefId,g.ballIds)):void 0;if(!s||!g||!k)return`<tr class="${f.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${f.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${P(f.name)}</span>${u}</span></td>${y}`;const z=Ye(s.plan.slotDefId,g.ballIds),L=s.isOpen(z),C=mr(z),A=gs(k,s.routeSections,e,{mode:s.mode??"product"}),F=["lb-rank__row--expandable"];return f.lead&&F.push("lb-rank__lead"),L&&F.push("lb-rank__row--open"),`<tr class="${F.join(" ")}" data-expand-key="${P(z)}">
  <td class="lb-rank__pos">${f.position}</td>
...
`);class Ia extends O{static styles=`
    ...
    `;router=this.inject(D);render(){const e=this.wire(Ta,{header:{className:()=>ss(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(ii,this.ref(e,"account")),this.spawn(qn,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":wt,"/history":yi,"/round":no,"/create":To,"/login":zo,"/friends":Lo,"/profile":Mo,"/admin":Uo,...ts.competitions?{"/competitions":Jo,"/competition":Ca}:{}},wt),e}}class Ea extends H{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await _s(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await Io()),this.error.set(null)}catch(e){e instanceof K&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await Eo(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof K&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}B.get(Ms);const Mt=B.get(D);B.set(H,new Ea);const Ht=B.get(H);await Gs(Ia,"#app",{hot:void 0,onInit:async()=>{await Ht.load(),Ht.currentUser.get()&&Mt.route.get()==="/login"&&Mt.navigate("/",!0)}});export{qe as A,O as C,D as R,p as S,Ms as T,b as a,he as b,S as c,Ns as d,N as e,Es as n,R as r,_ as t};
