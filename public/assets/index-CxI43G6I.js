(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const o of r.addedNodes)o.tagName==="LINK"&&o.rel==="modulepreload"&&n(o)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Ba="modulepreload",za=function(s){return"/tapscore/"+s},On={},La=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(h){return Promise.all(h.map(u=>Promise.resolve(u).then(f=>({status:"fulfilled",value:f}),f=>({status:"rejected",reason:f}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),d=o?.nonce||o?.getAttribute("nonce");i=c(t.map(h=>{if(h=za(h),h in On)return;On[h]=!0;const u=h.endsWith(".css"),f=u?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${h}"]${f}`))return;const m=document.createElement("link");if(m.rel=u?"stylesheet":Ba,u||(m.as="script"),m.crossOrigin="",m.href=h,d&&m.setAttribute("nonce",d),document.head.appendChild(m),u)return new Promise((b,g)=>{m.addEventListener("load",b),m.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${h}`)))})}))}function r(o){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=o,window.dispatchEvent(d),!d.defaultPrevented)throw o}return i.then(o=>{for(const d of o||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Zi="/tapscore/".replace(/\/+$/,""),js=Zi+"/api",Fa=10,Ht=[];let At=[],ot=null;function Ga(s){Ht.push(s),Ht.length>Fa&&Ht.shift()}function on(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Ht],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),At.push(n),Da()}function Da(){ot||(ot=setTimeout(er,5e3))}function er(){if(ot&&(clearTimeout(ot),ot=null),At.length===0)return;const s=At;At=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${js}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${js}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&er()});const ze=0,Mn=1,lt=2,ja=1e5;class qa{constructor(){this.tracking=null,this.batchDepth=0,this.flushing=!1,this.queue=[]}subscribe(e){const t=this.tracking;t&&(e.subs.add(t),t.sources.set(e,e.version))}notify(e){for(const t of e)this.mark(t,lt);this.batchDepth===0&&!this.flushing&&this.flush()}mark(e,t){if(e.disposed||e.state>=t)return;const n=e.state===ze;if(e.state=t,!!n){if(e.run)this.queue.push(e);else if(e.subs)for(const i of e.subs)this.mark(i,Mn)}}settle(e){if(e.state===Mn){for(const[t,n]of e.sources)if(t.refresh?.(),t.version!==n){e.state=lt;return}e.state=ze}}runTracked(e,t){if(e.disposed)return;tr(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batchDepth++;try{e()}finally{this.batchDepth--,this.batchDepth===0&&!this.flushing&&this.flush()}}flush(){this.flushing=!0;let e=0;try{for(;this.queue.length;){if(++e>ja)throw this.queue.length=0,new Error("[effect] flush did not converge: an effect keeps writing a signal it reads");const t=this.queue.shift();if(t.disposed){t.state=ze;continue}try{if(this.settle(t),t.state!==lt)continue;t.state=ze,t.run()}catch(n){t.state=ze,Va(n)}}}finally{this.flushing=!1}}}const ve=new qa;function tr(s){for(const e of s.sources.keys())e.subs.delete(s);s.sources.clear()}function Va(s){console.error("[effect] an effect threw",s);const e=s instanceof Error?s.message:String(s);on("effect",e)}class p{constructor(e){this.src={subs:new Set,version:0},this.val=e}get(){return ve.subscribe(this.src),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,this.src.version++,ve.notify(this.src.subs))}update(e){this.set(e(this.val))}}class T{constructor(e){this.val=void 0;const t=this,n={state:lt,sources:new Map,subs:new Set,version:0,refresh(){ve.settle(n),n.state===lt&&(ve.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,n.version++)}),n.state=ze)}};this.node=n,n.refresh()}get(){return this.node.refresh(),ve.subscribe(this.node),this.val}peek(){return this.node.refresh(),this.val}}function C(s){const e={state:ze,sources:new Map,run(){ve.runTracked(e,s)}};return ve.runTracked(e,s),()=>{e.disposed=!0,tr(e)}}function We(s){ve.batch(s)}function J(s){return ve.untrack(s)}class Ua{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const X=new Ua,tt=Zi;function qs(s){return tt?s===tt?"/":s.startsWith(tt+"/")?s.slice(tt.length):s:s}function Ka(s){return tt+s}class q{constructor(){this.route=new p(qs(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>We(()=>{this.route.set(qs(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",o=i>=0?e.slice(0,i):e,d=o.indexOf("?"),c=d>=0?o.slice(0,d):o,h=d>=0?o.slice(d+1):"",u=n.query!==void 0?Wa(n.query):h?"?"+h:"",f=Ka(c)+u+r;(n.replace?history.replaceState:history.pushState).call(history,null,"",f),We(()=>{this.route.set(c),this.search.set(u)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new T(()=>{const n=this.route.get().split("/"),i={};for(const[r,o]of t.entries())o.startsWith(":")&&(i[o.slice(1)]=n[r]??"");return i})}query(e){return new T(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new T(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Wa(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}const es={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","confirm-btn-min-height":"44px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Ya=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Xa(s,e){const t={};for(const[n,i]of Ya)if(n in s)for(const r of i)r in s||(t[r]=`var(--${n})`);return{...e,...t,...s}}const sr=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Qa={thin:"1px",medium:"3px",thick:"5px"};function nr(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Qa[e.toLowerCase()]??e}function Ja(){return sr.map(s=>{const e=nr(es[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const ir={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},rr={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Za={...rr,"done-opacity":"0.35"},eo={...ir,...rr,...es,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},to={...ir,...Za,...es,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};function so(s){return e=>s[e]}const no="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",Hn="data-basics-global";function io(){if(document.head.querySelector(`style[${Hn}]`))return;const s=document.createElement("style");s.setAttribute(Hn,""),s.textContent=Ja()+no,document.head.appendChild(s)}function ro(s,e){io();const t=new Set(sr),n=(r,o,d)=>{const c=Object.entries(r).map(([h,u])=>`--${h}:${t.has(h)?nr(u):u}`).join(";");return`${o}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const An="basics-js-theme";class ao{constructor(){this.dark=new p(!1);const e=localStorage.getItem(An),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),C(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(An,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function y(s){const e=document.createElement("template");return e.innerHTML=s,e}function oo(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const Bn=new Set;class A{constructor(e={}){this.props=e,this.disposers=[],this.children=[],this.abortCtrl=null;const t=this.constructor;if(t.styles&&!Bn.has(t)){Bn.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return X.get(e)}get signal(){return this.abortCtrl||(this.abortCtrl=new AbortController),this.abortCtrl.signal}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}mix(e,...t){const n={track:i=>this.track(i),signal:this.signal};for(const i of t)i(e,n)}spawn(e,t,...n){const i=J(()=>{const r=new e(n[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){J(()=>{this.abortCtrl?.abort(),this.abortCtrl=null,this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(c=>this.track(c)),r=e.content.cloneNode(!0);let o=null;const d={track:i,get signal(){return o||(o=new AbortController,i(()=>o.abort())),o.signal}};for(const c of r.querySelectorAll("[bind]")){const h=t[c.getAttribute("bind")];if(h)if(typeof h=="function")i(C(()=>{const u=h();c instanceof HTMLInputElement||c instanceof HTMLTextAreaElement?c.value=String(u):c.textContent=String(u)}));else for(const[u,f]of Object.entries(h)){if(u==="mix"){for(const b of f)b(c,d);continue}const m=u.includes("-");if(u.startsWith("on")&&typeof f=="function"){let b=null;i(()=>b?.abort()),c.addEventListener(u.slice(2),g=>{b?.abort(),b=new AbortController,f(g,b.signal)})}else typeof f=="function"?i(C(()=>{const b=f();m?c.setAttribute(u,String(b)):c[u]=b})):m?c.setAttribute(u,String(f)):c[u]=f}}return r}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof A?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(r,o,...d)=>this.spawn(r,o,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,n,i=(r,o)=>o){const r=typeof t=="function"?t:()=>t.get(),o=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(h=>h());d.clear()}),this.track(C(()=>{const c=r(),h=new Map;for(const[f,m]of c.entries()){const b=i(m,f);if(o.has(b))h.set(b,o.get(b));else{const g=[];h.set(b,J(()=>n(m,f,v=>g.push(v)))),d.set(b,g)}}for(const[f,m]of o)h.has(f)||(m.remove(),J(()=>d.get(f)?.forEach(b=>b())),d.delete(f));let u=e.firstChild;for(const f of h.values())f===u?u=u.nextSibling:e.insertBefore(f,u);o.clear();for(const[f,m]of h)o.set(f,m)}))}$condition(e,t,n,i){let r=null;this.track(C(()=>{r&&(r.remove(),r=null);const o=t.get();r=J(()=>o?n():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,n,i){let r=null;this.track(C(()=>{if(r){const c=r;r=null,J(()=>c.destroy())}e.textContent="";const o=t.get(),d=n[o]??oo(o,n)??i;d&&(r=J(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const zt=new Set;function lo(s){return zt.add(s),()=>zt.delete(s)}function co(){for(const s of Array.from(zt)){zt.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function uo(s,e,t){const n=document.querySelector(e);n.textContent="";const i=X.get(q);let r=null,o=!1,d=null,c=!!t?.hot?.data.hmr;const h=async u=>{r&&(r.destroy(),r=null,n.textContent=""),u?(d||(d=(await La(()=>import("./obs-shell.component-CEO0Iphx.js"),[])).ObsShellComponent),r=J(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=J(()=>new s)),J(()=>r.mount(n)),o=u};await h(qs(location.pathname).startsWith("/_obs")),C(()=>{const u=i.route.get().startsWith("/_obs");u!==o&&h(u)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(u){console.error("[startApp] the root component threw while disposing",u)}if(r=null,co(),t.onDispose)try{t.onDispose()}catch(u){console.error("[startApp] onDispose threw",u)}}),t.hot.accept())}class Z extends Error{constructor(e,t,n,i,r){super(t),this.status=e,this.details=n,this.traceId=i,this.detail=r,this.name="ApiError"}}const ho=3e4,po=2,xt=new Map,ar=new WeakMap;function fo(s){if(s instanceof Z)return s.traceId;if(s!=null&&typeof s=="object")return ar.get(s)}async function _(s){if(s.method==="GET"){const e=xt.get(s.url);if(e)return e;const t=zn(s,po);return xt.set(s.url,t),t.then(()=>xt.delete(s.url),()=>xt.delete(s.url)),t}return zn(s,0)}async function zn(s,e){const t=s.timeout??ho;let n;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await go(mo(s,r),t)}catch(o){if(n=o,!(o instanceof Z)&&o!=null&&typeof o=="object"&&ar.set(o,r),o instanceof Z||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw n}async function mo(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),r=i.headers.get("x-trace-id")??e;if(Ga({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const o=await i.json().catch(()=>({error:i.statusText}));throw new Z(i.status,o.error??i.statusText,o.details,r,o.detail)}return i.json()}function go(s,e){let t;const n=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const Vs=new Set;let _s=!1;function bo(s){return Vs.add(s),()=>{Vs.delete(s)}}function or(){if(!_s){_s=!0;try{for(const s of[...Vs])try{s()}catch(e){try{on("session-listener",yo(e))}catch{}}}finally{_s=!1}}}function yo(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function D(s,e,t,n={}){We(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const r=_o(i);We(()=>{s.set(!1),e.set(r)}),on(r.code,r.message,fo(i)),r.code==="auth"&&n.sessionExpiry!==!1&&or();return}}function _o(s){return s instanceof Z?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const vs={sessionExpiry:!1};function vo(s){return{me:()=>_({method:"GET",url:`${s}/auth/me`}),login:e=>_({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>_({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>_({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class U{constructor(){this.api=vo(js),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=bo(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=lo(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await D(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await D(this.loading,this.error,()=>this.api.login({username:e,password:t}),vs);return n?(this.currentUser.set(n),!0):!1}async logout(){await D(this.loading,this.error,()=>this.api.logout(),vs);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await D(this.loading,this.error,()=>this.api.logoutAll(),vs),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const lr={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},wo={...lr,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},xo={...lr,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function dr(s,e={}){const t=s==="light"?wo:xo,n=s==="light"?eo:to;return Xa({...t,...e},n)}const ko=dr("light"),$o=dr("dark"),l=ro(ko,$o),G=s=>`var(--${s})`,I=(s,e)=>`var(--${s}, ${e})`,E=s=>{const e=es[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},So=s=>I(s,E(s)),a=so({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),kt=s=>`
    ...
    cursor: not-allowed;`,To={primary:kt("primary"),secondary:kt("secondary"),ghost:kt("ghost"),danger:kt("danger"),disabled:cr},S=(s=I("btn-radius",E("btn-radius")),e="secondary")=>`
    /*
    ...
    ${To[e]}
    &:disabled {${cr}}
`,Po=`max(${I("field-border-width",E("field-border-width"))}, ${I("field-rule-width",E("field-rule-width"))})`,$t=(s,e)=>`
    border-top-color: ${s};
    ...
    ${$t(I("field-border",E("field-border")),I("field-rule",E("field-rule")))}
    ...
    transition:
        ...
        box-shadow ${G("dur-fast")} ${G("ease-standard")},
        background ${G("dur-fast")} ${G("ease-standard")};
    &::placeholder { color: ${G("text-muted")}; }
    &:focus-visible {
        outline: none;
        ${$t(I("field-focus-border",E("field-focus-border")),I("field-focus-border",E("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${$t(I("field-invalid-border",E("field-invalid-border")),I("field-invalid-rule",E("field-invalid-rule")))}
    }
...
`,O=s=>`
    ...
    ${s?.hover?`
    transition:
        box-shadow ${G("dur-base")} ${G("ease-standard")},
        border-color ${G("dur-base")} ${G("ease-standard")};
    &:hover { box-shadow: ${G("shadow-2")}; }`:""}
    & .ui-card__eyebrow {
        ${Co()}
        margin: 0 0 ${a("sm")} 0;
    }
...
`;function Io(s){return{async me(){return _({method:"GET",url:`${s}/players/me`})},async register(e){return _({method:"POST",url:`${s}/players/register`,body:e})},async updateHandicap(e){return _({method:"POST",url:`${s}/players/me/handicap`,body:e})},async confirmHandicap(){return _({method:"POST",url:`${s}/players/me/handicap/confirm`,body:{}})},async myHandicapHistory(){return _({method:"GET",url:`${s}/players/me/handicap-history`})},async updateProfile(e){return _({method:"POST",url:`${s}/players/me/profile`,body:e})},async search(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/players/search${n?"?"+n:""}`})}}}function Eo(s){return{async list(){return _({method:"GET",url:`${s}/friends`})},async add(e){return _({method:"POST",url:`${s}/friends`,body:e})},async remove(e){return _({method:"DELETE",url:`${s}/friends/${e.friendId}`})}}}function Ro(s){return{async list(){return _({method:"GET",url:`${s}/clubs`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/clubs/get${n?"?"+n:""}`})},async create(e){return _({method:"POST",url:`${s}/clubs`,body:e})},async update(e){return _({method:"POST",url:`${s}/clubs/update`,body:e})},async remove(e){return _({method:"DELETE",url:`${s}/clubs/${e.id}`})}}}function No(s){return{async list(){return _({method:"GET",url:`${s}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/courses/by-club${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/courses/get${n?"?"+n:""}`})},async teeRoleCatalog(){return _({method:"GET",url:`${s}/courses/tee-roles/catalog`})},async teeRoles(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/courses/tee-roles${n?"?"+n:""}`})},async create(e){return _({method:"POST",url:`${s}/courses`,body:e})},async update(e){return _({method:"POST",url:`${s}/courses/update`,body:e})},async updateHole(e){return _({method:"POST",url:`${s}/courses/holes/update`,body:e})},async setTeeRole(e){return _({method:"POST",url:`${s}/courses/tee-roles`,body:e})},async clearTeeRole(e){return _({method:"DELETE",url:`${s}/courses/tee-roles/${e.courseId}/${e.roleKey}/${e.gender}`})},async validate(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/courses/validate${n?"?"+n:""}`})},async remove(e){return _({method:"DELETE",url:`${s}/courses/${e.id}`})}}}function Oo(s){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/tees/by-course${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/tees/get${n?"?"+n:""}`})},async create(e){return _({method:"POST",url:`${s}/tees`,body:e})},async update(e){return _({method:"POST",url:`${s}/tees/update`,body:e})},async remove(e){return _({method:"DELETE",url:`${s}/tees/${e.id}`})}}}function Mo(s){return{async create(e){return _({method:"POST",url:`${s}/guest-players`,body:e})}}}function Ho(s){return{async latest(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/handicap/latest${n?"?"+n:""}`})},async history(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/handicap/history${n?"?"+n:""}`})},async record(e){return _({method:"POST",url:`${s}/handicap/record`,body:e})}}}function Ao(s){return{async list(){return _({method:"GET",url:`${s}/rounds`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/rounds/balls${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/rounds/get${n?"?"+n:""}`})},async create(e){return _({method:"POST",url:`${s}/rounds`,body:e})},async createFromDraft(e){return _({method:"POST",url:`${s}/rounds/from-draft`,body:e})},async update(e){return _({method:"POST",url:`${s}/rounds/update`,body:e})},async remove(e){return _({method:"DELETE",url:`${s}/rounds/${e.id}`})}}}function Bo(s){return{async listByRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/score-events/by-round${n?"?"+n:""}`})},async append(e){return _({method:"POST",url:`${s}/score-events`,body:e})}}}function zo(s){return{async forBall(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/scorecards/for-ball${n?"?"+n:""}`})},async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/scorecards/for-round${n?"?"+n:""}`})}}}function Lo(s){return{async forRound(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/leaderboards/for-round${n?"?"+n:""}`})}}}function Fo(s){return{async create(e){return _({method:"POST",url:`${s}/friendly-rounds`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/by-token${n?"?"+n:""}`})},async balls(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/balls${n?"?"+n:""}`})},async scorecard(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/scorecard${n?"?"+n:""}`})},async result(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/result${n?"?"+n:""}`})},async score(e){return _({method:"POST",url:`${s}/friendly-rounds/score`,body:e})},async setup(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/setup${n?"?"+n:""}`})},async editSetup(e){return _({method:"POST",url:`${s}/friendly-rounds/setup`,body:e})},async remove(e){return _({method:"DELETE",url:`${s}/friendly-rounds/${e.token}`})},async finish(e){return _({method:"POST",url:`${s}/friendly-rounds/finish`,body:e})},async reopen(e){return _({method:"POST",url:`${s}/friendly-rounds/reopen`,body:e})},async setVisibility(e){return _({method:"POST",url:`${s}/friendly-rounds/visibility`,body:e})},async join(e){return _({method:"POST",url:`${s}/friendly-rounds/join`,body:e})},async leave(e){return _({method:"POST",url:`${s}/friendly-rounds/leave`,body:e})},async claimGuest(e){return _({method:"POST",url:`${s}/friendly-rounds/claim-guest`,body:e})},async renameGuest(e){return _({method:"POST",url:`${s}/friendly-rounds/rename-guest`,body:e})},async claimSeat(e){return _({method:"POST",url:`${s}/friendly-rounds/claim-seat`,body:e})},async releaseSeat(e){return _({method:"POST",url:`${s}/friendly-rounds/release-seat`,body:e})}}}function Go(s){return{async myRounds(){return _({method:"GET",url:`${s}/dashboard/my-rounds`})},async friendsActivity(){return _({method:"GET",url:`${s}/dashboard/friends-activity`})}}}function Do(s){return{async clubs(){return _({method:"GET",url:`${s}/setup/clubs`})},async courses(){return _({method:"GET",url:`${s}/setup/courses`})},async teesByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/setup/tees/by-course${n?"?"+n:""}`})},async teeRoleCatalog(){return _({method:"GET",url:`${s}/setup/tee-roles/catalog`})},async teeRolesByCourse(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/setup/tee-roles/by-course${n?"?"+n:""}`})},async formats(){return _({method:"GET",url:`${s}/setup/formats`})},async aggregations(){return _({method:"GET",url:`${s}/setup/aggregations`})},async formations(){return _({method:"GET",url:`${s}/setup/formations`})}}}function jo(s){return{async get(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/competitions/get${n?"?"+n:""}`})},async participants(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/competitions/participants${n?"?"+n:""}`})},async leaderboard(e){const t=new Set(["id"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/competitions/${e.id}/leaderboard${i?"?"+i:""}`})},async results(e){const t=new Set(["id"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/competitions/${e.id}/results${i?"?"+i:""}`})},async list(){return _({method:"GET",url:`${s}/competitions`})},async create(e){return _({method:"POST",url:`${s}/competitions`,body:e})},async update(e){return _({method:"POST",url:`${s}/competitions/update`,body:e})},async transition(e){return _({method:"POST",url:`${s}/competitions/transition`,body:e})},async createRound(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return _({method:"POST",url:`${s}/competitions/${e.id}/rounds`,body:n})},async applyCut(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return _({method:"POST",url:`${s}/competitions/${e.id}/cut`,body:n})},async finalize(e){const t=new Set(["id"]),n={};for(const[i,r]of Object.entries(e))t.has(i)||(n[i]=r);return _({method:"POST",url:`${s}/competitions/${e.id}/finalize`,body:n})},async addParticipant(e){return _({method:"POST",url:`${s}/competitions/participants/add`,body:e})},async removeParticipant(e){return _({method:"POST",url:`${s}/competitions/participants/remove`,body:e})},async withdrawParticipant(e){return _({method:"POST",url:`${s}/competitions/participants/withdraw`,body:e})}}}function qo(s){return{async myRoles(){return _({method:"GET",url:`${s}/me/roles`})},async adminStats(){return _({method:"GET",url:`${s}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/admin/rounds${n?"?"+n:""}`})},async adminPlayers(){return _({method:"GET",url:`${s}/admin/players`})},async adminGrantRole(e){return _({method:"POST",url:`${s}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return _({method:"POST",url:`${s}/admin/roles/revoke`,body:e})}}}function Vo(s){return{async myConfig(){return _({method:"GET",url:`${s}/players/me/stats-config`})},async putMyConfig(e){return _({method:"PUT",url:`${s}/players/me/stats-config`,body:e})},async myStats(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/players/me/stats${n?"?"+n:""}`})},async myFirstPuttCurve(){return _({method:"GET",url:`${s}/players/me/stats/first-putt-curve`})},async myRoundStats(e){const t=new Set(["roundId"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/players/me/rounds/${e.roundId}/stats${i?"?"+i:""}`})},async appendEvents(e){return _({method:"POST",url:`${s}/friendly-rounds/stat-events`,body:e})},async byToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/stats${n?"?"+n:""}`})},async configsByToken(e){const t=new URLSearchParams;for(const[i,r]of Object.entries(e))r!==void 0&&t.set(i,String(r));const n=t.toString();return _({method:"GET",url:`${s}/friendly-rounds/stats-configs${n?"?"+n:""}`})}}}function Uo(s){return{async profile(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/friends/${e.playerId}/profile${i?"?"+i:""}`})},async rounds(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/friends/${e.playerId}/rounds${i?"?"+i:""}`})},async courses(e){const t=new Set(["playerId"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/friends/${e.playerId}/courses${i?"?"+i:""}`})}}}function Ko(s){return{async round(e){const t=new Set(["roundId"]),n=new URLSearchParams;for(const[r,o]of Object.entries(e))!t.has(r)&&o!==void 0&&n.set(r,String(o));const i=n.toString();return _({method:"GET",url:`${s}/spectate/rounds/${e.roundId}${i?"?"+i:""}`})}}}const Y="/tapscore/".replace(/\/+$/,"")+"/api",w={players:Io(Y),friends:Eo(Y),clubs:Ro(Y),courses:No(Y),tees:Oo(Y),guestPlayers:Mo(Y),handicap:Ho(Y),rounds:Ao(Y),scoreEvents:Bo(Y),scorecards:zo(Y),leaderboards:Lo(Y),friendlyRounds:Fo(Y),dashboard:Go(Y),setup:Do(Y),competitions:jo(Y),admin:qo(Y),playerStats:Vo(Y),friendProfile:Uo(Y),spectate:Ko(Y)};function Wo(s){return[...s.played?["Played"]:[],...s.created?["Created"]:[]].join(" · ")}function Yo(s,e){const t=new Map;for(const n of e)t.set(n.round.id,{round:n.round,token:n.friendlyRound.shareToken,holesPlayed:null,played:!1,created:!0});for(const n of s){const i=t.get(n.round.id);i?(i.played=!0,i.holesPlayed=n.progress?.holesPlayed??null):t.set(n.round.id,{round:n.round,token:n.shareToken,holesPlayed:n.progress?.holesPlayed??null,played:!0,created:!1})}return[...t.values()].sort((n,i)=>(i.round.lastActivityAt??"").localeCompare(n.round.lastActivityAt??"")||i.round.date.localeCompare(n.round.date)||n.round.id.localeCompare(i.round.id))}function Xo(s,e){return s.filter(t=>t.played&&!t.created&&!e.has(t.round.id)).slice().sort((t,n)=>n.round.date.localeCompare(t.round.date)||t.round.id.localeCompare(n.round.id))}function St(s,e){return s.some(t=>t.round.id===e)?s.filter(t=>t.round.id!==e):s}function ee(){try{return globalThis.localStorage??null}catch{return null}}function Je(s,e,t){return{read(n=ee()){if(!n)return e.empty;let i;try{i=n.getItem(s)}catch{return e.empty}if(!i)return e.empty;try{return e.decode(i)}catch{return e.empty}},write(n,i=ee()){if(!i)return e.empty;const r=t!==void 0&&Array.isArray(n)?n.slice(0,t):n;try{i.setItem(s,e.encode(r))}catch{}return r}}}function ln(s){return{decode(e){const t=JSON.parse(e);return Array.isArray(t)?t.filter(s):[]},encode:e=>JSON.stringify(e),get empty(){return[]}}}const Qo=500,dn=Je("tapscore.seen-rounds.v1",ln(s=>typeof s=="string"),Qo);function ts(s=ee()){return dn.read(s)}function ws(s=ee()){return new Set(ts(s))}function Jo(s,e=ee()){return ts(e).includes(s)}function Zo(s,e=ee()){if(!e)return[];const t=ts(e).filter(n=>n!==s);return dn.write([s,...t],e)}function ur(s,e=ee()){if(!e)return[];const t=ts(e),n=t.filter(i=>i!==s);return n.length!==t.length&&dn.write(n,e),n}const el=50,cn=Je("tapscore.device-rounds.v1",ln(tl),el);function ss(s=ee()){return cn.read(s)}function tl(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.courseName=="string"&&(e.status==="not_started"||e.status==="active"||e.status==="complete")&&typeof e.lastSeenAt=="string"}function st(s,e=ee()){if(!e)return[];const t=ss(e).filter(n=>n.token!==s.token);return cn.write([s,...t],e)}function hr(s,e=ee()){if(!e)return[];const t=ss(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&cn.write(n,e),n}class ns{mine=new p(null);mineLoading=new p(!1);mineError=new p(null);myRounds=new T(()=>{const e=this.mine.get();return e?Yo(e.produced,e.created):[]});deviceRounds=new p([]);seenIds=new p(ws());newRounds=new T(()=>Xo(this.myRounds.get(),this.seenIds.get()));async loadMine(){this.seenIds.set(ws());const e=await D(this.mineLoading,this.mineError,()=>w.dashboard.myRounds());e&&this.mine.set(e)}loadDevice(){this.deviceRounds.set(ss())}clear(){this.mine.set(null),this.mineError.set(null),this.mineLoading.set(!1),this.seenIds.set(ws()),this.loadDevice()}async remove(e,t){try{await w.friendlyRounds.remove({token:e})}catch(i){if(!(i instanceof Z)||i.status!==404)return!1}const n=this.mine.get();return n&&this.mine.set({produced:St(n.produced,t),created:St(n.created,t)}),this.deviceRounds.set(hr(e)),ur(t),!0}async leave(e,t){try{const i=await w.friendlyRounds.leave({token:e});if(!i.ok)return{ok:!1,message:i.diagnostics.map(r=>r.message).join(" · ")}}catch{return{ok:!1,message:"Could not remove you right now. Try again."}}const n=this.mine.get();return n&&this.mine.set({produced:St(n.produced,t),created:St(n.created,t)}),{ok:!0}}}const sl={DEV:!1};function nl(s,e){return s===void 0||s===""?e:s!=="0"&&s.toLowerCase()!=="false"}const Ln=sl??{},pr={competitions:nl(Ln.VITE_FEATURE_COMPETITIONS,!!Ln.DEV)},il='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 11.5 12 4l8 7.5"/><path d="M6 10v10h12V10"/><path d="M10 20v-5.5h4V20"/></svg>',rl='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M3.5 20c.5-3.5 2.7-5.5 5.5-5.5s5 2 5.5 5.5"/><circle cx="16.5" cy="9.5" r="2.8"/><path d="M16.8 14.6c2.2.4 3.5 2 3.9 4.9"/></svg>',al='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M8 4h8v3a4 4 0 0 1-8 0V4Z"/><path d="M8 5H5v2a3 3 0 0 0 3 3"/><path d="M16 5h3v2a3 3 0 0 1-3 3"/><path d="M10 12.5V15h4v-2.5"/><path d="M9 20h6"/><path d="M12 15v5"/></svg>';function ol(s){const e=[{key:"home",label:"Home",href:"/",icon:il},{key:"friends",label:"Friends",href:"/friends",icon:rl}];return s.competitions&&e.push({key:"comps",label:"Comps",href:"/competitions",icon:al}),e}const ll=["/login","/round"];function un(s){return!ll.includes(s)}function Fn(s,e){return e&&un(s)}function dl(s){return un(s)&&s!=="/create"}const cl=y(`
...
`);class hl extends A{static styles=`
    ...
    `;router=this.inject(q);auth=this.inject(U);landing=this.inject(ns);newCount=new T(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(cl,{bar:{className:()=>Fn(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"},play:{className:()=>{const r=this.router.route.get();return dl(r)?Fn(r,this.auth.currentUser.get()!==null)?"dock__play":"dock__play dock__play--floating":"dock__play hidden"},onclick:()=>this.router.navigate("/create")}}),t=ol(pr),n=Math.ceil(t.length/2),i=(r,o)=>this.wireEl(ul,{link:{...this.router.link(r.href),href:r.href},icon:{innerHTML:()=>r.icon},label:()=>r.label,badge:{textContent:()=>{if(r.key!=="home")return"";const d=this.newCount.get();return d===0?"":String(d)},className:()=>(r.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},o);return this.$each(this.ref(e,"left"),()=>t.slice(0,n),(r,o,d)=>i(r,d),r=>r.key),this.$each(this.ref(e,"right"),()=>t.slice(n),(r,o,d)=>i(r,d),r=>r.key),e}}const fr=["tee","approach","putting","shortGame","penalties","recovery"],Bt={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function mr(s){switch(s){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function pl(s){switch(s){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const fl="Track statistics",ml="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function gr(s){switch(s){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Lt(s,e){return s[e]}function gl(s,e){if(!s.enabled)return!0;const t=gr(e);return t===null?!1:!Lt(s,t)}function bl(s,e){if(!s.enabled)return null;const t=gr(e);return t===null||Lt(s,t)?null:`Needs ${mr(t)}`}function yl(s,e,t){return vl({...s,[e]:t})}function _l(s,e){return{...s,enabled:e}}function vl(s){const e={...s};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function xs(s){const e={...Bt,enabled:s.enabled};for(const t of fr)e[t]=s[t];return e}function wl(s){return s.avatarVersion?`${Y}/players/${encodeURIComponent(s.id)}/avatar?v=${s.avatarVersion}`:null}function xl(s,e){const t=(s??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(Tt(t[0])+Tt(t[t.length-1])).toUpperCase();if(t.length===1)return Tt(t[0]).toUpperCase();const n=(e??"").trim();return n.length>0?Tt(n).toUpperCase():"•"}function Tt(s){return[...s][0]??""}const Pt=512,kl=2*1024*1024;function $l(s,e){const t=Math.min(s,e);return{sx:Math.round((s-t)/2),sy:Math.round((e-t)/2),size:t}}const Sl=.85;class nt extends Error{}async function Tl(s){let e;try{e=await createImageBitmap(s)}catch{throw new nt("That image could not be read. Try a JPEG or PNG.")}try{const{sx:t,sy:n,size:i}=$l(e.width,e.height),r=document.createElement("canvas");r.width=Pt,r.height=Pt;const o=r.getContext("2d");if(!o)throw new nt("This browser cannot process images.");o.drawImage(e,t,n,i,i,0,0,Pt,Pt);const d=await new Promise(c=>r.toBlob(c,"image/jpeg",Sl));if(!d)throw new nt("That image could not be processed.");if(d.size>kl)throw new nt("That image is too large.");return d}finally{e.close()}}async function Pl(s){const e=await fetch(`${Y}/players/me/avatar`,{method:"PUT",headers:{"Content-Type":s.type||"application/octet-stream"},body:s});if(!e.ok)throw await br(e);return await e.json()}async function Cl(){const s=await fetch(`${Y}/players/me/avatar`,{method:"DELETE"});if(!s.ok)throw await br(s)}async function br(s){const e=await s.json().catch(()=>({})),t=s.status===413?400:s.status;return new Z(t,Il(e.error,s.status))}function Il(s,e){return s==="too_large"||e===413?"That image is too large.":s==="unsupported_type"?"That file is not a JPEG, PNG or WebP image.":s==="empty"?"That image was empty.":s??"Photo upload failed."}class Ie{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);teeRoles=new p([]);saving=new p(!1);saveError=new p(null);saveTarget=new p(null);statsConfig=new p(Bt);statsSaving=new p(!1);statsError=new p(null);hasRecordedStats=new p(!1);avatarSaving=new p(!1);avatarError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await D(this.loading,this.error,()=>Promise.all([w.players.me(),w.players.myHandicapHistory(),w.clubs.list(),w.setup.teeRoleCatalog().catch(()=>[]),w.playerStats.myConfig().catch(()=>null),w.playerStats.myStats({limit:1}).catch(()=>null)]));if(!t)return;const[n,i,r,o,d,c]=t;this.player.set(n),this.history.set(i),this.clubs.set(r),this.teeRoles.set(o),this.statsConfig.set(d?xs(d):Bt),this.hasRecordedStats.set((c?.rounds.length??0)>0)}clear(){this.player.set(null),this.history.set([]),this.teeRoles.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Bt),this.statsError.set(null),this.hasRecordedStats.set(!1),this.avatarError.set(null)}async saveIndex(e){return this.saveTarget.set("index"),await D(this.saving,this.saveError,()=>w.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveDisplayName(e){this.saveTarget.set("name");const t=await D(this.saving,this.saveError,()=>w.players.updateProfile({displayName:e}));return t?(this.player.set(t),!0):!1}async confirmHandicap(){this.saveTarget.set("index");const e=await D(this.saving,this.saveError,()=>w.players.confirmHandicap());return e?(this.player.set(e),!0):!1}async saveGender(e){this.saveTarget.set("gender");const t=await D(this.saving,this.saveError,()=>w.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){this.saveTarget.set("club");const t=await D(this.saving,this.saveError,()=>w.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async savePreferredTeeRole(e){this.saveTarget.set("tee");const t=await D(this.saving,this.saveError,()=>w.players.updateProfile({preferredTeeRoleKey:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await D(this.statsSaving,this.statsError,()=>w.playerStats.putMyConfig(xs(e)));return t?(this.statsConfig.set(xs(t)),!0):!1}async saveAvatar(e){this.avatarError.set(null);let t;try{t=await Tl(e)}catch(i){return this.avatarError.set({code:"validation",message:i instanceof nt?i.message:"That image could not be prepared."}),!1}const n=await D(this.avatarSaving,this.avatarError,()=>Pl(t));return n?(this.patchAvatarVersion(n.avatarVersion),!0):!1}async removeAvatar(){return await D(this.avatarSaving,this.avatarError,()=>Cl().then(()=>!0))?(this.patchAvatarVersion(null),!0):!1}patchAvatarVersion(e){const t=this.player.get();t&&this.player.set({...t,avatarVersion:e})}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function Ct(s){const e=[],t=[];for(const n of s)(n.isMutual?e:t).push(n);return{mutual:e,addedByMe:t}}function ks(s,e){return s.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function Ft(s,e="frecency"){return e==="alpha"?[...s].sort(ks):[...s].sort((t,n)=>{const i=t.frecency,r=n.frecency,o=i>0,d=r>0;if(o!==d)return o?-1:1;if(!o)return ks(t,n);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,h=n.lastPlayedAt?Date.parse(n.lastPlayedAt):NaN,u=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,f=Number.isNaN(h)?Number.NEGATIVE_INFINITY:h;return f!==u?f-u:ks(t,n)})}const El=1440*60*1e3;function Rl(s,e){if(!s)return null;const t=Date.parse(s),n=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(n))return null;const i=Math.floor((n-t)/El);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function Nl(s,e){if(s.sharedRoundCount<=0)return"never played";const t=Rl(s.lastPlayedAt,e),n=`played ${s.sharedRoundCount}×`;return t?`${n}, ${t}`:n}function Ol(s){return`@${s.username}`}function Ml(s){return s.homeClubName?.trim()??""}const yr=2;function Gn(s){return s.trim().length>=yr}function _r(s){return Ft(s,"frecency")}function Hl(s,e){return _r([...s.filter(t=>t.id!==e.id),e])}function Al(s,e){return s.filter(t=>t.id!==e)}function Dn(s,e,t){return s.map(n=>n.id===e?{...n,isFriend:t}:n)}function Bl(s,e,t=()=>{},n=300){let i=0,r;return o=>{const d=o.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<yr){e(d,[]);return}r=setTimeout(()=>{s(d).then(h=>{c===i&&e(d,h)},h=>{c===i&&t(d,h)})},n)}}const vr=Je("tapscore.friends.sort.v1",{decode:s=>s==="alpha"?"alpha":"frecency",encode:s=>s,empty:"frecency"});function zl(s=ee()){return vr.read(s)}function Ll(s,e=ee()){vr.write(s,e)}class is{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(zl());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=Bl(e=>w.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await D(this.loading,this.error,()=>w.friends.list());t&&(this.friends.set(_r(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await D(this.mutating,this.mutateError,()=>w.friends.add({friendId:e.id}))&&(this.friends.set(Hl(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,avatarVersion:e.avatarVersion,sharedRoundCount:0,lastPlayedAt:null,frecency:0,isMutual:!1})),this.results.set(Dn(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),Ll(e)}async remove(e){await D(this.mutating,this.mutateError,()=>w.friends.remove({friendId:e}))&&(this.friends.set(Al(this.friends.get(),e)),this.results.set(Dn(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class hn{feed=new p(null);loading=new p(!1);loaded=!1;async load(e=!1){if(!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0);try{this.feed.set(await w.dashboard.friendsActivity()),this.loaded=!0}catch{this.feed.set(null)}finally{this.loading.set(!1)}}}clear(){this.feed.set(null),this.loaded=!1,this.loading.set(!1)}}function it(s,e){return s instanceof Z&&s.status===401?(or(),"Your session expired — sign in again."):e}function Gt(s){return s===0?"E":s>0?`+${s}`:`${s}`}function Fl(s){return s.holesPlayed<=0?"Teeing off":s.scoreToPar===null?`Thru ${s.holesPlayed}`:`Thru ${s.holesPlayed} · ${Gt(s.scoreToPar)}`}function wr(s){const e=s[0];if(!e)return null;const t=s.length-1;return t>0?`${e.displayName} + ${t}`:e.displayName}function xr(s){return(s.courseName??"").trim()||null}function Gl(s){const e=[];for(const t of s){const n=t.friends[0],i=wr(t.friends);!n||!i||e.push({roundId:t.roundId,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:i,courseName:xr(t),progress:Fl(n)})}return e}function Dl(s){const e=s.courseName?` at ${s.courseName}`:"";return`${s.title}${e}, live, ${s.progress}. Watch.`}function jl(s){const e=new Set;for(const t of s)for(const n of t.friends)e.add(n.playerId);return e.size===0?null:e.size===1?"1 friend on the course":`${e.size} friends on the course`}function ql(s,e){if(!s)return null;for(const t of s.live){const n=t.friends.find(i=>i.playerId===e);if(n)return{roundId:t.roundId,holesPlayed:n.holesPlayed,scoreToPar:n.scoreToPar}}return null}function Vl(s){return s.holesPlayed<=0?"On the course now · Teeing off":s.scoreToPar===null?`On the course now · Thru ${s.holesPlayed}`:`On the course now · Thru ${s.holesPlayed} · ${Gt(s.scoreToPar)}`}function Ul(s){const e=[];for(const t of s){const n=t.friends[0],i=wr(t.friends);!n||!i||e.push({roundId:t.roundId,friendLabel:i,playerId:n.playerId,avatarVersion:n.avatarVersion,displayName:n.displayName,title:xr(t)??"A round",date:t.date,formatIds:t.formatIds??[]})}return e}function kr(s){if(s instanceof Z){if(s.status===403)return"forbidden";if(s.status===404)return"not_found"}return null}const Ye={forbidden:{title:"Profile not available",message:"This profile is no longer shared with you."},not_found:{title:"Player not found",message:"This player doesn't exist anymore."}};function Kl(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}function Wl(s,e){const t=e(s.date),n=(s.name??"").trim(),i=(s.courseName??"").trim();return n&&i?`${t} · ${i}`:t}function Yl(s){const e=s.holesPlayed;switch(s.status){case"not_started":return"Not started";case"active":return e<=0?"Teeing off":s.scoreToPar===null?`Thru ${e}`:`Thru ${e} · ${Gt(s.scoreToPar)}`;case"complete":{if(e<=0)return"Finished";const t=e<s.holeCount?`Thru ${e}`:"Finished";return s.scoreToPar===null?t:`${t} · ${Gt(s.scoreToPar)}`}}}function Xl(s,e){const t=[];s!==null&&t.push(`Hcp ${s.toFixed(1)}`);const n=(e??"").trim();return n&&t.push(n),t.length>0?t.join(" · "):null}function Ql(s,e){return`${s.roundsPlayed===1?"1 round":`${s.roundsPlayed} rounds`} · last played ${e(s.lastPlayedAt)}`}function Jl(s){return s===1?"1 course played":`${s} courses played`}const $s={rounds:[],nextCursor:null,hasMore:!1};function jn(s,e){const t=new Set(s.rounds.map(n=>n.roundId));return{rounds:[...s.rounds,...e.rounds.filter(n=>!t.has(n.roundId))],nextCursor:e.nextCursor,hasMore:e.hasMore}}function $r(s){return s.hasMore&&s.nextCursor!==null}class rs{playerId=new p(null);unavailable=new p(null);profile=new p(null);profileLoading=new p(!1);profileError=new p(null);profileLoaded=!1;rounds=new p($s);roundsLoaded=new p(!1);roundsLoading=new p(!1);loadingMore=new p(!1);roundsError=new p(null);roundsGeneration=0;courses=new p([]);coursesHasMore=new p(!1);coursesLoaded=new p(!1);coursesLoading=new p(!1);coursesError=new p(null);setPlayer(e){this.playerId.get()!==e&&(this.playerId.set(e),this.resetData())}async loadProfile(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.profileLoaded||this.profileLoading.get()))){this.profileLoading.set(!0),this.profileError.set(null);try{const n=await w.friendProfile.profile({playerId:t});if(this.playerId.get()!==t)return;this.profile.set(n),this.profileLoaded=!0,this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.profileError.set(it(n,"Couldn't load this profile.")))}finally{this.playerId.get()===t&&this.profileLoading.set(!1)}}}async loadRounds(e=!1){const t=this.playerId.get();if(!t||!e&&(this.roundsLoaded.get()||this.roundsLoading.get()))return;this.roundsGeneration+=1;const n=this.roundsGeneration;this.roundsLoading.set(!0),this.roundsError.set(null);try{const i=await w.friendProfile.rounds({playerId:t});if(n!==this.roundsGeneration)return;this.rounds.set(jn($s,i)),this.roundsLoaded.set(!0),this.unavailable.set(null)}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(it(i,"Couldn't load these rounds.")))}finally{n===this.roundsGeneration&&this.roundsLoading.set(!1)}}async loadMoreRounds(){const e=this.playerId.get(),t=this.rounds.get();if(!e||!this.roundsLoaded.get()||!$r(t)||this.loadingMore.get()||this.roundsLoading.get())return;const n=this.roundsGeneration;this.loadingMore.set(!0),this.roundsError.set(null);try{const i=await w.friendProfile.rounds({playerId:e,cursor:t.nextCursor??void 0});if(n!==this.roundsGeneration)return;this.rounds.set(jn(this.rounds.get(),i))}catch(i){if(n!==this.roundsGeneration)return;this.refuseOr(i,()=>this.roundsError.set(it(i,"Couldn't load more rounds.")))}finally{n===this.roundsGeneration&&this.loadingMore.set(!1)}}async loadCourses(e=!1){const t=this.playerId.get();if(t&&!(!e&&(this.coursesLoaded.get()||this.coursesLoading.get()))){this.coursesLoading.set(!0),this.coursesError.set(null);try{const n=await w.friendProfile.courses({playerId:t});if(this.playerId.get()!==t)return;this.courses.set(n.courses),this.coursesHasMore.set(n.hasMore),this.coursesLoaded.set(!0),this.unavailable.set(null)}catch(n){if(this.playerId.get()!==t)return;this.refuseOr(n,()=>this.coursesError.set(it(n,"Couldn't load these courses.")))}finally{this.playerId.get()===t&&this.coursesLoading.set(!1)}}}clear(){this.playerId.set(null),this.resetData()}refuseOr(e,t){const n=kr(e);if(n){this.unavailable.set(n),this.resetData(!0);return}t()}resetData(e=!1){e||this.unavailable.set(null),this.profile.set(null),this.profileLoaded=!1,this.profileLoading.set(!1),this.profileError.set(null),this.rounds.set($s),this.roundsGeneration+=1,this.roundsLoaded.set(!1),this.roundsLoading.set(!1),this.loadingMore.set(!1),this.roundsError.set(null),this.courses.set([]),this.coursesHasMore.set(!1),this.coursesLoaded.set(!1),this.coursesLoading.set(!1),this.coursesError.set(null)}}function Sr(s){return s.handicapIndex*(s.slope/113)+(s.courseRating-s.par)}function Zl(s){return Math.round(Sr(s))}function ed(s,e,t){const n=t;if(n<=0)return 0;if(s>=0){const c=Math.floor(s/n),h=s-c*n;return c+(e>=1&&e<=h?1:0)}const i=-s,r=Math.floor(i/n),o=i-r*n,d=r+(e>n-o?1:0);return d===0?0:-d}function td(s){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function ye(){return td()}const Be=10;class Xe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await D(this.loading,this.error,()=>w.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=ye()){const n=typeof e=="string"?this.byId(e):e;return n?n.labels?.[t]??n.labels?.en??n.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:n.teamSize?.min??2,max:n.teamSize?.max??2},...n.teamCount?{teamCount:n.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=ye()){return e.labels?.[t]??e.labels?.en??""}configHintOf(e,t=ye()){return e.hint?.[t]??e.hint?.en??""}configFieldIsInline(e,t=ye()){return e.options.length>2||e.options.some(n=>this.configHintOf(n,t))?!1:e.options.every(n=>this.configLabelOf(n,t).length<=12)}presets(e=ye()){return this.descriptors.get().filter(n=>n.preset).sort((n,i)=>{const r=n.preset?.rank??Number.POSITIVE_INFINITY,o=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==o?r-o:(this.labelOf(n,e)??n.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=ye()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const n=t.slotTeamGrouping??{},i=n.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:n.teamSize?.min??2,max:n.teamSize?.max??2}}}if(t.slotBallCount){const n=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:n?Be:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}const qn=["scramble","foursomes","greensomes"];class sd{loading=new p(!1);error=new p(null);descriptors=new p([]);inFlight=null;loaded=!1;async load(){if(!this.loaded){if(this.inFlight)return this.inFlight;if(typeof w.setup?.formations=="function")return this.inFlight=(async()=>{const e=await D(this.loading,this.error,()=>w.setup.formations());e&&(this.descriptors.set(e),this.loaded=!0)})().finally(()=>{this.inFlight=null}),this.inFlight}}available(){return this.descriptors.get().length>0}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}ids(){return new Set(this.descriptors.get().map(e=>e.id))}chips(){const e=this.descriptors.get(),t=n=>{const i=qn.indexOf(n);return i===-1?qn.length:i};return[...e].sort((n,i)=>t(n.id)-t(i.id))}labelOf(e,t=ye()){const n=this.byId(e);return n?n.labels?.[t]??n.labels?.en??n.id:e}sizeOf(e){return this.byId(e)?.size??null}fits(e,t){const n=this.sizeOf(e);return n?t>=n.min&&t<=n.max:!0}allowances(e,t){const n=this.byId(e)?.allowancesBySize?.[String(t)];return n&&n.length===t?n:null}}const nd=180,Vn=4,id=12;function Ue(s,e){return e<=0?0:Math.max(0,Math.min(e-1,s))}function rd(s){const{dragDistance:e,velocity:t,itemWidth:n}=s;if(Math.abs(e)<id)return 0;const i=e+t*nd,r=Math.round(-i/n);return Math.max(-Vn,Math.min(Vn,r))}const Un="tapscore:pending-scores:v1",ad=336*60*60*1e3,Kn=200;function od(){try{return globalThis.localStorage??null}catch{return null}}function ld(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.ballId=="string"&&typeof e.playHoleId=="string"&&(typeof e.strokes=="number"||e.strokes===null)&&(e.eventType==="score_entered"||e.eventType==="score_cleared")&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class dd{entries=[];storage;constructor(e=od(),t=Date.now()){this.storage=e,this.entries=this.load();const n=this.applyHygiene(t);n.length!==this.entries.length&&(this.entries=n,this.persist())}enqueue(e){const t=this.entries.findIndex(n=>n.token===e.token&&n.ballId===e.ballId&&n.playHoleId===e.playHoleId);t>=0?this.entries[t]=e:this.entries.push(e),this.entries=this.applyHygiene(e.queuedAt),this.persist()}remove(e){const t=this.entries.filter(n=>n.clientEventId!==e);t.length!==this.entries.length&&(this.entries=t,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=ad);return t.length>Kn?t.slice(t.length-Kn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Un);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(ld):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Un,JSON.stringify(this.entries))}catch{}}}const $e=["tee_result","tee_miss_dir","recovery_ok","gir","green_miss_dir","short_game_difficulty","short_game_strokes","first_putt","first_putt_m","putts","penalties","penalty_source"],cd={minPar:4},ud={tee_result:"Tee shot",tee_miss_dir:"Which side",recovery_ok:"Recovery",gir:"Green in regulation",green_miss_dir:"Approach",short_game_difficulty:"Short game",short_game_strokes:"Shots to the green",first_putt:"First putt",first_putt_m:"",putts:"Putts",penalties:"Penalties",penalty_source:"Penalty on"},Tr={tee_result:{kind:"segments",options:[{value:"fairway",label:"Fairway"},{value:"in_play",label:"In play"},{value:"trouble",label:"Trouble"}]},tee_miss_dir:{kind:"segments",options:[{value:"left",label:"Left"},{value:"right",label:"Right"}]},gir:{kind:"segments",options:[{value:"0",label:"Miss"},{value:"1",label:"Hit"}]},green_miss_dir:{kind:"segments",options:[{value:"long",label:"Long"},{value:"short",label:"Short"},{value:"left",label:"Left"},{value:"right",label:"Right"},{value:"hit_late",label:"On green"}]},first_putt:{kind:"segments",options:[{value:"inside_1m",label:"< 1m"},{value:"1_to_2m",label:"1–2m"},{value:"2_to_4m",label:"2–4m"},{value:"4_to_8m",label:"4–8m"},{value:"over_8m",label:"> 8m"}]},first_putt_m:{kind:"refine",parent:"first_putt",optionsByParent:{inside_1m:[{value:"0.3",label:"0.3m"},{value:"0.5",label:"0.5m"},{value:"0.8",label:"0.8m"}],"1_to_2m":[{value:"1",label:"1m"},{value:"1.5",label:"1.5m"},{value:"2",label:"2m"}],"2_to_4m":[{value:"2.5",label:"2.5m"},{value:"3",label:"3m"},{value:"3.5",label:"3.5m"},{value:"4",label:"4m"}],"4_to_8m":[{value:"5",label:"5m"},{value:"6",label:"6m"},{value:"7",label:"7m"},{value:"8",label:"8m"}],over_8m:[{value:"10",label:"10m"},{value:"12",label:"12m"},{value:"14",label:"14m"},{value:"16",label:"16m"},{value:"20",label:"20+"}]}},short_game_difficulty:{kind:"segments",options:[{value:"standard",label:"Standard"},{value:"hard",label:"Hard"},{value:"bunker",label:"Bunker"}]},short_game_strokes:{kind:"stepper",min:1,max:5},recovery_ok:{kind:"segments",options:[{value:"0",label:"No"},{value:"1",label:"Yes"}]},putts:{kind:"stepper",min:0,max:3},penalties:{kind:"stepper",min:0,max:null},penalty_source:{kind:"segments",options:[{value:"tee",label:"Tee shot"},{value:"approach",label:"Approach"},{value:"short_or_green",label:"Greenside"}]}};function Us(s){return ud[s]}function It(s){return Tr[s]}function Et(s,e){const t=Tr[s];return t.kind!=="refine"||e===null?null:t.optionsByParent[e]??null}function Wn(s,e){return e!==null&&s>=e?`${s}+`:`${s}`}function Pr(s,e,t){return s?!(s.minPar!=null&&e<s.minPar||s.maxPar!=null&&e>s.maxPar||s.pars!=null&&!s.pars.includes(e)||s.holes!=null&&!s.holes.includes(t)):!0}function hd(s,e,t){return e!==null&&e>0&&t!==null&&t>=0&&s>0}function pd(s,e,t){return e-t<=s-2?"1":"0"}function Ks(s){if(s.girIsLocked)return{state:"manual"};const e=s.isAnswered("gir");if(s.visibility("gir")!=="visible")return e?{state:"persisted"}:{state:"idle"};const t=s.derivedGir();if(t===null)return e?{state:"persisted"}:{state:"idle"};if(!e)return{state:"pending",derived:t};const n=s.value("gir");return n===t?{state:"persisted"}:{state:"disagree",derived:t,stored:n}}class fd{modules;par;holeNumber;persistedMap;draft=new Map;girLocked=!1;strokes=null;constructor(e,t,n,i={},r=new Map){this.modules=e,this.par=t,this.holeNumber=n,this.persistedMap=Yn(i),this.draft=new Map(r),this.prune()}refresh(e,t,n){const i=this.signature();return this.modules=e,this.persistedMap=Yn(t),this.strokes=n,this.prune(),this.signature()!==i}setScore(e){this.strokes=e}get girIsLocked(){return this.girLocked}derivedGir(){const e=this.intValue("putts");return e===0&&this.value("first_putt")!==null||!hd(this.par,this.strokes,e)?null:pd(this.par,this.strokes,e)}materialiseDerivedGir(){const e=Ks(this);return e.state!=="pending"?!1:(this.record("gir",e.derived),this.prune(),!0)}signature(){let e="";for(const t of $e)e+=`${t}:${this.visibility(t)}:${this.value(t)??""};`;return e+=`gir-derived:${Ks(this).state};`,e}get prompts(){const e=[];for(const t of $e)this.isVisible(t)&&e.push({key:t,label:Us(t),control:this.resolvedControl(t)});return e}resolvedControl(e){const t=It(e);return t.kind!=="refine"?t:{kind:"segments",options:Et(e,this.value(t.parent))??[]}}get isEmpty(){return this.prompts.length===0}visibility(e){switch(e){case"tee_result":return this.modules.tee&&Pr(cd,this.par,this.holeNumber)?"visible":"unreadable";case"tee_miss_dir":return!this.modules.tee||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="in_play"||this.value("tee_result")==="trouble"?"visible":"contradicted";case"recovery_ok":return!this.modules.recovery||this.visibility("tee_result")!=="visible"?"unreadable":this.value("tee_result")==="trouble"?"visible":"contradicted";case"gir":return this.modules.approach?"visible":"unreadable";case"green_miss_dir":return!this.modules.approach||this.visibility("gir")!=="visible"?"unreadable":this.value("gir")==="0"?"visible":"contradicted";case"short_game_difficulty":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("green_miss_dir")==="hit_late"?"contradicted":this.value("gir")!==null?"visible":"contradicted";case"short_game_strokes":return!this.modules.shortGame||this.visibility("gir")!=="visible"?"unreadable":this.value("green_miss_dir")==="hit_late"?"contradicted":this.value("gir")!==null?"visible":"contradicted";case"first_putt":case"putts":return this.modules.putting?"visible":"unreadable";case"first_putt_m":return!this.modules.putting||this.visibility("first_putt")!=="visible"?"unreadable":Et("first_putt_m",this.value("first_putt"))!==null?"visible":"contradicted";case"penalties":return this.modules.penalties?"visible":"unreadable";case"penalty_source":return!this.modules.penalties||this.visibility("penalties")!=="visible"?"unreadable":(this.intValue("penalties")??0)>=1?"visible":"contradicted"}}isVisible(e){return this.visibility(e)==="visible"}shortGameDisclosure(){return this.value("gir")!=="1"||this.visibility("short_game_difficulty")!=="visible"?"none":this.value("short_game_difficulty")===null&&this.value("short_game_strokes")===null?"collapsed":"expanded"}value(e){const t=this.draft.get(e);return t===void 0?this.persistedMap.get(e)??null:"set"in t?t.set:null}intValue(e){const t=this.value(e);if(t===null)return null;const n=Number.parseInt(t,10);return Number.isNaN(n)?null:n}isAnswered(e){return this.value(e)!==null}answer(e,t){if(!this.isVisible(e))return;const n=It(e);if(t!==null&&n.kind==="refine"){const i=Et(e,this.value(n.parent));if(i===null||!i.some(r=>r.value===t))return}e==="gir"&&(this.girLocked=!0),this.record(e,t),this.prune()}step(e,t){const n=It(e);if(!this.isVisible(e)||n.kind!=="stepper")return;let i=(this.intValue(e)??n.min)+t;i<n.min&&(i=n.min),n.max!==null&&i>n.max&&(i=n.max),this.record(e,String(i)),this.prune()}record(e,t){if(t!==null){this.persistedMap.get(e)===t?this.draft.delete(e):this.draft.set(e,{set:t});return}this.persistedMap.get(e)===void 0?this.draft.delete(e):this.draft.set(e,{cleared:!0})}prune(){for(let e=0;e<$e.length;e++){let t=!1;for(const n of $e){const i=this.draft.get(n),r=this.visibility(n);if(r==="visible"){const o=It(n),d=this.value(n);if(o.kind==="refine"&&d!==null){const c=Et(n,this.value(o.parent));(c===null||!c.some(h=>h.value===d))&&this.record(n,null)}}else r==="contradicted"?this.record(n,null):this.draft.delete(n);md(i,this.draft.get(n))||(t=!0)}if(!t)return}}get batch(){const e=[];for(const t of $e){const n=this.draft.get(t);n!==void 0&&e.push({key:t,value:"set"in n?n.set:null})}return e}commitDraft(){for(const[e,t]of this.draft)"set"in t?this.persistedMap.set(e,t.set):this.persistedMap.delete(e);this.draft.clear()}}function md(s,e){return s===void 0||e===void 0?s===e:"set"in s?"set"in e&&s.set===e.set:!("set"in e)}function Yn(s){if(s instanceof Map)return new Map(s);const e=new Map;for(const t of $e){const n=s[t];n!==void 0&&e.set(t,n)}return e}const Xn="tapscore:pending-stat-events:v1",gd=336*60*60*1e3,Qn=500;function bd(){try{return globalThis.localStorage??null}catch{return null}}function yd(){try{return crypto.randomUUID()}catch{return`stat-${Date.now()}-${Math.random().toString(36).slice(2)}`}}function _d(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.playHoleId=="string"&&typeof e.playerId=="string"&&typeof e.key=="string"&&$e.includes(e.key)&&(typeof e.value=="string"||e.value===null)&&typeof e.clientEventId=="string"&&typeof e.queuedAt=="number"}class vd{entries=[];storage;makeId;constructor(e=bd(),t=Date.now(),n=yd){this.storage=e,this.makeId=n,this.entries=this.load();const i=this.applyHygiene(t);i.length!==this.entries.length&&(this.entries=i,this.persist())}enqueueBatch(e,t,n,i,r=Date.now()){if(i.length===0)return[];const o=[];for(const d of i){const c={token:e,playHoleId:t,playerId:n,key:d.key,value:d.value,clientEventId:this.makeId(),queuedAt:r},h=this.entries.findIndex(u=>u.token===e&&u.playHoleId===t&&u.playerId===n&&u.key===d.key);h>=0?this.entries[h]=c:this.entries.push(c),o.push(c)}return this.entries=this.applyHygiene(r),this.persist(),o}ack(e){if(e.length===0)return;const t=new Set(e),n=this.entries.filter(i=>!t.has(i.clientEventId));n.length!==this.entries.length&&(this.entries=n,this.persist())}entriesFor(e){return this.entries.filter(t=>t.token===e)}size(){return this.entries.length}applyHygiene(e){const t=this.entries.filter(n=>e-n.queuedAt<=gd);return t.length>Qn?t.slice(t.length-Qn):t}load(){if(!this.storage)return[];try{const e=this.storage.getItem(Xn);if(!e)return[];const t=JSON.parse(e);return Array.isArray(t)?t.filter(_d):[]}catch{return[]}}persist(){if(this.storage)try{this.storage.setItem(Xn,JSON.stringify(this.entries))}catch{}}}const wd=50;function xd(s){if(typeof s!="object"||s===null)return!1;const e=s;return typeof e.token=="string"&&typeof e.cursor=="string"}const pn=Je("tapscore.result-cursors.v1",ln(xd),wd);function fn(s=ee()){return pn.read(s)}function kd(s,e=ee()){return fn(e).find(t=>t.token===s)?.cursor??null}function $d(s,e,t=ee()){if(!t)return[];const n=fn(t).filter(i=>i.token!==s);return pn.write([{token:s,cursor:e},...n],t)}function Sd(s,e=ee()){if(!e)return[];const t=fn(e),n=t.filter(i=>i.token!==s);return n.length!==t.length&&pn.write(n,e),n}const Td=["1st","2nd","3rd","4th","5th","6th","7th","8th"],Ne=(s,e)=>`${s}|${e}`;function mn(s){return s.players.map(e=>e.displayName).join(" & ")||s.label||"Ball"}function Pd(s,e,t){return Pr(s,e,t)}function Ss(s,e){return`${s.playHoleId}:${s.playerId}:${e}`}function Cd(s){const e=new Map;return s.teeResult!==null&&e.set("tee_result",s.teeResult),s.teeMissDir!==null&&e.set("tee_miss_dir",s.teeMissDir),s.recoveryOk!==null&&e.set("recovery_ok",s.recoveryOk?"1":"0"),s.gir!==null&&e.set("gir",s.gir?"1":"0"),s.greenMissDir!==null&&e.set("green_miss_dir",s.greenMissDir),s.shortGameDifficulty!==null&&e.set("short_game_difficulty",s.shortGameDifficulty),s.shortGameStrokes!==null&&e.set("short_game_strokes",String(s.shortGameStrokes)),s.firstPutt!==null&&e.set("first_putt",s.firstPutt),s.putts!==null&&e.set("putts",String(s.putts)),s.penalties!==null&&e.set("penalties",String(s.penalties)),s.penaltySource!==null&&e.set("penalty_source",s.penaltySource),e}function Id(s){const e=s?.status;return typeof e!="number"||e<400||e>=500?!1:e!==401&&e!==408&&e!==429}class be{constructor(e=new dd,t=new vd){this.queue=e,this.statQueue=t}queue;statQueue;loading=new p(!1);error=new p(null);friendlyRound=new p(null);round=new p(null);startList=new p(null);balls=new p([]);firstOpen=new p(!1);firstOpenRoundId=null;scorecards=new p([]);cells=new p(new Map);statModules=new p(new Map);statRows=new p([]);statRev=new p(0);statRevN=0;statLocal=new Map;statConfirmedAt=new Map;statStep=null;statCell=null;statPosting=!1;result=new p(null);resultLoading=new p(!1);resultError=new p(null);resultCursor=null;holeIdx=new p(0);groupIdx=new p(0);keypadOpen=new p(!1);finishFlowOpen=new p(!1);selectedSlot=new p(null);token=null;loadSeq=0;resultSeq=0;quietSeq=0;scorecardSeq=0;flushing=!1;pendingSlotIndex=null;async loadByToken(e,t){const n=e!==this.token;this.token=e;const i=++this.loadSeq;n&&this.resetForNewToken(t),X.get(Xe).load();const r=await D(this.loading,this.error,()=>w.friendlyRounds.byToken({token:e}));if(!r||i!==this.loadSeq||e!==this.token)return;if(this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList),st({token:e,courseName:r.round.courseNameSnapshot??"",name:r.round.name,date:r.round.date,status:r.round.status,completedAt:r.round.completedAt,lastSeenAt:new Date().toISOString()}),this.firstOpenRoundId!==r.round.id&&(this.firstOpenRoundId=r.round.id,this.firstOpen.set(!Jo(r.round.id))),X.get(U).currentUser.get()&&Zo(r.round.id),this.pendingSlotIndex!==null){const f=r.round.formatSlots[this.pendingSlotIndex]?.slotDefId??null;this.pendingSlotIndex=null,f!==null&&this.selectedSlot.set(f)}const[o,d,c,h]=await Promise.all([w.friendlyRounds.balls({token:e}).catch(()=>[]),w.friendlyRounds.scorecard({token:e}).catch(()=>[]),w.playerStats.configsByToken({token:e}).catch(()=>null),w.playerStats.byToken({token:e}).catch(()=>null)]);i!==this.loadSeq||e!==this.token||(this.flushStats(),c&&this.statModules.set(new Map(c.map(u=>[u.playerId,u.modules]))),h&&(this.statRows.set(h),this.dropConfirmedStatLocals(i)),this.cells.set(new Map),this.scorecards.set(d),this.balls.set(o),n&&t?.holeIdx===void 0&&r.round.status==="active"&&this.holeIdx.set(this.firstIncompleteHoleIndex()),await this.flushPending(),await this.flushPendingStats(),this.refreshStatStep())}deleting=new p(!1);async deleteRound(){const e=this.token;if(!e||this.deleting.get())return!1;this.deleting.set(!0);try{await w.friendlyRounds.remove({token:e}),hr(e);const t=this.round.get()?.id;return t&&ur(t),Sd(e),!0}catch{return!1}finally{this.deleting.set(!1)}}finishing=new p(!1);async finishRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await w.friendlyRounds.finish({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:t.completedAt}),st({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:t.completedAt,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async reopenRound(){const e=this.token;if(!e||this.finishing.get())return null;this.finishing.set(!0);try{const t=await w.friendlyRounds.reopen({token:e}),n=this.round.get();return e===this.token&&n&&(this.round.set({...n,status:t.status,completedAt:null}),st({token:e,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:t.status,completedAt:null,lastSeenAt:new Date().toISOString()})),{status:t.status}}catch{return null}finally{this.finishing.set(!1)}}async loadResult(){const e=this.token;if(!e)return;const t=++this.resultSeq,n=await D(this.resultLoading,this.resultError,()=>w.friendlyRounds.result({token:e}));t!==this.resultSeq||e!==this.token||n&&(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}async refreshScorecard(){const e=this.token;if(!e)return;const t=++this.scorecardSeq,n=this.loadSeq;let i;try{i=await w.friendlyRounds.scorecard({token:e})}catch{return}t!==this.scorecardSeq||n!==this.loadSeq||e!==this.token||this.scorecards.set(i)}async refreshRound(){const e=this.token;if(!e)return;const t=++this.quietSeq,n=this.loadSeq,i=()=>t!==this.quietSeq||n!==this.loadSeq||e!==this.token;try{const r=await w.friendlyRounds.byToken({token:e});if(i())return;this.friendlyRound.set(r.friendlyRound),this.round.set(r.round),this.startList.set(r.startList);const o=await w.friendlyRounds.balls({token:e}).catch(()=>null);if(o===null||i())return;this.balls.set(o)}catch{}}async refreshAll(e){if(this.token){if(e?.feedWillReconnect){await this.refreshRound();return}await Promise.all([this.refreshRound(),this.pollResult(),this.refreshScorecard()])}}persistedCursor(e=this.token){return e?kd(e):null}setResultCursor(e,t){const n=t!==null&&t!==this.resultCursor;this.resultCursor=t,n&&$d(e,t)}async pollResult(){const e=this.token;if(!e)return;const t=++this.resultSeq;let n;try{n=await w.friendlyRounds.result({token:e,...this.resultCursor!==null?{cursor:this.resultCursor}:{}})}catch{return}t!==this.resultSeq||e!==this.token||(this.setResultCursor(e,n.cursor),n.unchanged||this.result.set(n.result))}onLiveResultEvent(e){const t=this.token,n=this.round.get();if(t&&n&&e.status!==n.status){const i=e.status==="complete"?new Date().toISOString():null;this.round.set({...n,status:e.status,completedAt:i}),st({token:t,courseName:n.courseNameSnapshot??"",name:n.name,date:n.date,status:e.status,completedAt:i,lastSeenAt:new Date().toISOString()})}this.pollResult(),this.refreshScorecard()}ballNameById=new T(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,mn(t));for(const t of this.result.get()?.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}isPending(e){return this.balls.get().find(t=>t.id===e)?.pending===!0}groupLabelByBallId=new T(()=>{const e=new Map,t=this.groups();return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}selectedSlotDefId(){const e=this.round.get()?.formatSlots??[];if(e.length===0)return null;const t=this.selectedSlot.get();return t!==null&&e.some(n=>n.slotDefId===t)?t:e[0]?.slotDefId??null}selectSlot(e){this.selectedSlot.set(e)}presentedSlot(e){const t=this.selectedSlotDefId();return e.slots.find(n=>n.slotDefId===t)??e.slots[0]}effectivePlayingHandicap(e){const t=this.presentedSlot(e);return t?.handicapDerivation?.effectivePh??t?.playingHandicap??null}slotStandingFor(e){const t=this.selectedSlotDefId(),n=this.result.get()?.slots.find(r=>r.slotDefId===t);if(!n)return null;const i=r=>r.includes(e.id)||r.some(o=>n.subjectLabels?.some(d=>d.ballId===o&&d.memberBallIds.includes(e.id))??!1);for(const r of n.leaderboard){if(r.kind==="ranked"){const o=r.entries.find(d=>i(d.ballIds));if(!o)continue;return o.total===null?null:o.paceDelta!==void 0?{kind:"pace",delta:r.direction==="high"?-o.paceDelta:o.paceDelta}:{kind:"total",total:o.total}}if(r.kind==="match_summary"){const o=r.matches.find(h=>i(h.sideA.ballIds)||i(h.sideB.ballIds));if(!o)continue;if(o.thru===0&&!o.finished)return null;const d=i(o.sideA.ballIds)?"a":"b";if(o.leader===null||o.magnitude===0)return{kind:"match",text:"AS",tone:"even"};if(o.finished&&o.closeOutRemaining!==null)return{kind:"match",text:`${o.magnitude}&${o.closeOutRemaining}`,tone:o.leader===d?"under":"over"};const c=o.leader===d;return{kind:"match",text:`${o.magnitude} ${c?"UP":"DN"}`,tone:c?"under":"over"}}}return null}groups(){return this.round.get()?.playingGroups??[]}group(){const e=this.groups();return e[this.groupIdx.get()]??e[0]??null}playedOrder(){return this.group()?.playedOrder??[]}holeIndex(){return Ue(this.holeIdx.get(),this.playedOrder().length)}currentPlayedHole(){return this.playedOrder()[this.holeIndex()]??null}playHoleById(e){return this.round.get()?.playHoles.find(t=>t.id===e)??null}currentPlayHole(){const e=this.currentPlayedHole();return e?this.playHoleById(e.playHoleId):null}parFor(e){return(e?this.playHoleById(e)?.par:null)??4}occLabel(e){const t=this.round.get(),n=t?.playHoles.find(o=>o.id===e);if(!t||!n)return"";const i=t.playHoles.filter(o=>o.courseHoleNumber===n.courseHoleNumber).sort((o,d)=>o.ordinal-d.ordinal);if(i.length===1)return`${n.courseHoleNumber}`;const r=i.findIndex(o=>o.id===e);return`${n.courseHoleNumber} (${Td[r]??`${r+1}th`})`}canPrevHole(){return this.holeIndex()>0}canNextHole(){return this.holeIndex()<this.playedOrder().length-1}prevHole(){this.holeIdx.set(Ue(this.holeIndex()-1,this.playedOrder().length))}nextHole(){this.holeIdx.set(Ue(this.holeIndex()+1,this.playedOrder().length))}firstIncompleteHoleIndex(){const e=this.group();if(!e)return 0;const t=this.balls.get().filter(r=>e.ballIds.includes(r.id)&&!r.pending);if(t.length===0)return 0;const n=new Map(this.scorecards.get().map(r=>[r.ballId,r])),i=e.playedOrder.findIndex(r=>t.some(o=>{const d=n.get(o.id)?.holes.find(c=>c.playHoleId===r.playHoleId);return d?.strokes===null||d===void 0}));return i===-1?0:i}strokesFor(e,t){const n=this.cells.get().get(Ne(e,t));return n?n.strokes:this.scorecards.get().find(o=>o.ballId===e)?.holes.find(o=>o.playHoleId===t)?.strokes??null}statusFor(e,t){return this.cells.get().get(Ne(e,t))?.status??null}strokesHintFor(e,t){const n=this.round.get();if(!n)return null;const i=this.balls.get().find(h=>h.id===e);if(!i||i.pending)return null;const r=this.effectivePlayingHandicap(i);if(r==null)return null;const o=this.playHoleById(t);if(!o)return null;const d=i.players[0]?.teeName??null,c=o.tees.find(h=>h.teeName===d)?.strokeIndex??o.baseStrokeIndex;return ed(r,c,n.routeSi.allocationCycleSize)}statSubject(e){if(e.pending||e.players.length!==1)return null;const t=e.players[0];return!t||t.pending||t.playerId===null?null:this.statModules.get().has(t.playerId)?t.playerId:null}statPrompts(){return this.statRev.get(),this.statStep?.prompts??[]}statValue(e){return this.statRev.get(),this.statStep?.value(e)??null}statStepperValue(e,t){return this.statRev.get(),this.statStep?.intValue(e)??t}statShortGameDisclosure(){return this.statRev.get(),this.statStep?.shortGameDisclosure()??"none"}statIsAnswered(e){return this.statRev.get(),this.statStep?.isAnswered(e)===!0}answerStat(e,t){this.statStep&&(this.statStep.answer(e,t),this.bumpStatRev())}stepStat(e,t){this.statStep&&(this.statStep.step(e,t),this.bumpStatRev())}seedStatStep(e){const t=this.statCell;if(e!==null&&t!==null&&e.playerId===t.playerId&&e.playHoleId===t.playHoleId){this.refreshStatStep();return}this.closeStatStep(),this.setStatCell(e,e?this.makeStatStep(e):null)}refreshStatStep(){const e=this.statCell;if(!e){this.statStep!==null&&this.setStatCell(null,null);return}const t=this.statModules.get().get(e.playerId);if(!this.statStep||!t){this.setStatCell(e,this.makeStatStep(e));return}this.statStep.refresh(t,this.persistedStats(e),this.strokesForCell(e))&&this.bumpStatRev()}strokesForCell(e){const t=this.balls.get().find(n=>this.statSubject(n)===e.playerId);return t?this.strokesFor(t.id,e.playHoleId):null}statGirState(){return this.statRev.get(),this.statStep?Ks(this.statStep):{state:"idle"}}setStatCell(e,t){const n=t===null?null:e;this.statCell===n&&this.statStep===t||(this.statCell=n,this.statStep=t,this.bumpStatRev())}bumpStatRev(){this.statRev.set(++this.statRevN)}makeStatStep(e){const t=this.statModules.get().get(e.playerId),n=this.playHoleById(e.playHoleId);if(!t||!n)return null;const i=new fd(t,n.par,n.courseHoleNumber,this.persistedStats(e));return i.setScore(this.strokesForCell(e)),i}persistedStats(e){const t=this.statRows.get().find(i=>i.playHoleId===e.playHoleId&&i.playerId===e.playerId),n=t?Cd(t):new Map;for(const i of $e){const r=Ss(e,i);if(!this.statLocal.has(r))continue;const o=this.statLocal.get(r)??null;o===null?n.delete(i):n.set(i,o)}return n}closeStatStep(){return this.statStep?.materialiseDerivedGir()&&this.bumpStatRev(),this.flushStats()}flushStats(){const e=this.statCell,t=this.statStep,n=this.token;if(!e||!t||!n)return!1;const i=t.batch;if(i.length===0)return!1;t.commitDraft(),this.bumpStatRev();for(const r of i)this.writeStatLocal(e,r.key,r.value);return this.statQueue.enqueueBatch(n,e.playHoleId,e.playerId,i),this.postStats(n),!0}writeStatLocal(e,t,n){const i=Ss(e,t);this.statLocal.set(i,n),this.statConfirmedAt.delete(i)}confirmStatLocals(e){for(const t of e){const n=Ss({playerId:t.playerId,playHoleId:t.playHoleId},t.key);this.statConfirmedAt.set(n,this.loadSeq)}}dropConfirmedStatLocals(e){for(const[t,n]of[...this.statConfirmedAt])e<=n||(this.statLocal.delete(t),this.statConfirmedAt.delete(t))}async flushPendingStats(){const e=this.token;if(e){for(const t of this.statQueue.entriesFor(e))this.writeStatLocal({playerId:t.playerId,playHoleId:t.playHoleId},t.key,t.value);await this.postStats(e)}}async postStats(e){if(!this.statPosting){this.statPosting=!0;try{for(;;){const t=this.statQueue.entriesFor(e);if(t.length===0)return;const n=await this.sendStatEvents(e,t);if(n==="later")return;if(n==="ok"||t.length===1){this.settleStatEvents(t);continue}for(const i of t){if(await this.sendStatEvents(e,[i])==="later")return;this.settleStatEvents([i])}}}finally{this.statPosting=!1}}}async sendStatEvents(e,t){try{return await w.playerStats.appendEvents({token:e,items:t.map(n=>({playHoleId:n.playHoleId,playerId:n.playerId,key:n.key,value:n.value,clientEventId:n.clientEventId}))}),"ok"}catch(n){return Id(n)?"refused":"later"}}settleStatEvents(e){this.statQueue.ack(e.map(t=>t.clientEventId)),this.confirmStatLocals(e)}metadataFor(e,t,n){const i=this.cells.get().get(Ne(e,t));return i&&i.metadata!==void 0?i.metadata?.[n]:this.scorecards.get().find(d=>d.ballId===e)?.holes.find(d=>d.playHoleId===t)?.metadata?.[n]}metadataInputs(){const e=X.get(Xe),t=this.round.get()?.formatSlots??[],n=[],i=new Set;for(const r of t){const o=e.byId(r.formatId)?.requirements.scoreEntry?.metadata??[];for(const d of o)i.has(d.key)||(i.add(d.key),n.push(d))}return n}metadataInputsForHole(e){return e?this.metadataInputs().filter(t=>Pd(t.appliesWhen,e.par,e.courseHoleNumber)):[]}async setScore(e,t,n,i){const r=Ne(e,t),o=crypto.randomUUID();this.patchCell(r,{strokes:n,metadata:i,status:"saving",clientEventId:o});const d=this.token;d&&(this.enqueue(d,e,t,n,i,o),await this.post(d,e,t,n,i,o))}async retry(e,t){const n=Ne(e,t),i=this.cells.get().get(n);if(!i)return;this.patchCell(n,{...i,status:"saving"});const r=this.token;r&&(this.enqueue(r,e,t,i.strokes,i.metadata,i.clientEventId),await this.post(r,e,t,i.strokes,i.metadata,i.clientEventId))}async flushPending(){const e=this.token;if(!(!e||this.flushing)){this.flushing=!0;try{for(const t of this.queue.entriesFor(e)){if(e!==this.token)return;this.patchCell(Ne(t.ballId,t.playHoleId),{strokes:t.strokes,metadata:t.metadata,status:"saving",clientEventId:t.clientEventId}),await this.post(e,t.ballId,t.playHoleId,t.strokes,t.metadata,t.clientEventId)}}finally{this.flushing=!1}}}enqueue(e,t,n,i,r,o){this.queue.enqueue({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:o,...r!==void 0?{metadata:r}:{},queuedAt:Date.now()})}async post(e,t,n,i,r,o){const d=Ne(t,n);try{await w.friendlyRounds.score({token:e,ballId:t,playHoleId:n,strokes:i,eventType:i===null?"score_cleared":"score_entered",clientEventId:o,...r!=null?{metadata:r}:{}}),this.queue.remove(o);const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"saved"});const h=this.round.get();e===this.token&&h&&h.status==="not_started"&&this.round.set({...h,status:"active"})}catch{const c=this.cells.get().get(d);c&&c.clientEventId===o&&this.patchCell(d,{...c,status:"error"})}}patchCell(e,t){const n=new Map(this.cells.get());n.set(e,t),this.cells.set(n)}resetForNewToken(e){this.resultSeq++,this.resultCursor=null,this.friendlyRound.set(null),this.round.set(null),this.startList.set(null),this.balls.set([]),this.scorecards.set([]),this.cells.set(new Map),this.result.set(null),this.resultError.set(null),this.holeIdx.set(e?.holeIdx??0),this.groupIdx.set(e?.groupIdx??0),this.keypadOpen.set(!1),this.finishFlowOpen.set(!1),this.statModules.set(new Map),this.statRows.set([]),this.statLocal.clear(),this.statConfirmedAt.clear(),this.statStep=null,this.statCell=null,this.bumpStatRev();const t=e?.selectedSlot;this.pendingSlotIndex=null,typeof t=="string"?this.selectedSlot.set(t):typeof t=="number"?(this.pendingSlotIndex=t,this.selectedSlot.set(null)):this.selectedSlot.set(null)}}class Cr{roundId=new p(null);view=new p(null);balls=new p([]);loading=new p(!1);error=new p(null);unavailable=new p(null);loaded=!1;setRound(e){this.roundId.get()!==e&&(this.roundId.set(e),this.reset())}async load(e=!1){const t=this.roundId.get();if(t&&!(!e&&(this.loaded||this.loading.get()))){this.loading.set(!0),this.error.set(null);try{const n=await w.spectate.round({roundId:t});if(this.roundId.get()!==t)return;this.view.set(n),this.loaded=!0,this.unavailable.set(null),await this.loadBalls(t)}catch(n){if(this.roundId.get()!==t)return;const i=kr(n);i?(this.unavailable.set(i),this.view.set(null),this.balls.set([]),this.loaded=!1):this.error.set(it(n,"Couldn't load this round."))}finally{this.roundId.get()===t&&this.loading.set(!1)}}}async loadBalls(e){try{const t=await w.rounds.balls({roundId:e});this.roundId.get()===e&&this.balls.set(t)}catch{}}ballNameById=new T(()=>{const e=new Map;for(const t of this.balls.get())e.set(t.id,mn(t));for(const t of this.view.get()?.result.slots??[])for(const n of t.subjectLabels??[])e.set(n.ballId,n.label);return e});nameOf(e){return this.ballNameById.get().get(e)??e}groupLabelByBallId=new T(()=>{const e=new Map,t=this.view.get()?.round.playingGroups??[];return t.length<2||t.forEach((n,i)=>{for(const r of n.ballIds)e.set(r,`Group ${i+1}`)}),e});groupLabelOf(e){return this.groupLabelByBallId.get().get(e)??null}clear(){this.roundId.set(null),this.reset()}reset(){this.view.set(null),this.balls.set([]),this.loaded=!1,this.loading.set(!1),this.error.set(null),this.unavailable.set(null)}}class Ir{roles=new p([]);rolesPromise=null;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}canManageCourses(){return this.isSuperAdmin()||this.roles.get().some(e=>e.role==="course_admin"&&e.scopeType===null)}loadRoles(e=!1){return!e&&this.rolesPromise?this.rolesPromise:(this.rolesPromise=(async()=>{try{this.roles.set(await w.admin.myRoles())}catch{this.roles.set([])}})(),this.rolesPromise)}clear(){this.roles.set([]),this.rolesPromise=null,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await D(this.loading,this.error,()=>Promise.all([w.admin.adminStats(),w.admin.adminRounds({limit:100}),w.admin.adminPlayers()]));if(!t)return;const[n,i,r]=t;this.stats.set(n),this.rounds.set(i),this.players.set(r)}}const Ed=["last5","last10","last20","thisYear","all","custom"];function Dt(s){switch(s){case"last5":return"Last 5 rounds";case"last10":return"Last 10 rounds";case"last20":return"Last 20 rounds";case"thisYear":return"This year";case"all":return"All rounds";case"custom":return"Custom"}}function Rd(s){switch(s){case"last5":return"Your five most recent rounds with stats";case"last10":return"Enough rounds for percentages to settle";case"last20":return"A season's worth of form";case"thisYear":return"Every round dated this calendar year";case"all":return"Everything you have ever recorded";case"custom":return"Pick dates, courses and rounds by hand"}}function gn(s){switch(s){case"last5":return 5;case"last10":return 10;case"last20":return 20;default:return null}}const dt={from:null,to:null,courseIds:[],venueTypes:[],roundTypes:[],excludedRoundIds:[]};function Nd(s){return s.from===null&&s.to===null&&s.courseIds.length===0&&s.venueTypes.length===0&&s.roundTypes.length===0&&s.excludedRoundIds.length===0}function Od(s,e){return!(s.from!==null&&e.date<s.from||s.to!==null&&e.date>s.to||s.courseIds.length>0&&!s.courseIds.includes(e.courseId)||s.venueTypes.length>0&&!s.venueTypes.includes(e.venueType)||s.roundTypes.length>0&&!s.roundTypes.includes(e.roundType)||s.excludedRoundIds.includes(e.roundId))}function Ts(s,e,t){const n=s[e],i=n.includes(t)?n.filter(r=>r!==t):[...n,t];return{...s,[e]:i}}function Md(s,e,t){const n=s.excludedRoundIds.includes(e);return t===!n?s:{...s,excludedRoundIds:t?s.excludedRoundIds.filter(i=>i!==e):[...s.excludedRoundIds,e]}}function as(s){return[...s].sort((e,t)=>e.date===t.date?e.roundId>t.roundId?-1:e.roundId<t.roundId?1:0:e.date>t.date?-1:1)}function Er(s){return`${s.getFullYear()}-`}function Rr(s,e,t,n){const i=as(t);switch(s){case"last5":case"last10":case"last20":{const r=gn(s);return r===null?i:i.slice(0,r)}case"thisYear":{const r=Er(n);return i.filter(o=>o.date.startsWith(r))}case"all":return i;case"custom":return i.filter(r=>Od(e,r))}}function Nr(s){const{preset:e,filter:t,loaded:n,hasMore:i,now:r}=s;if(!i)return!1;switch(e){case"last5":case"last10":case"last20":{const o=gn(e);return o===null?!1:n.length<o}case"thisYear":{const o=`${Er(r)}01-01`;return!n.some(d=>d.date<o)}case"all":return!0;case"custom":{if(Nd(t))return!1;if(t.from===null)return!0;const o=t.from;return!n.some(d=>d.date<o)}}}const Hd="Unnamed course";function Ad(s){const e=new Map,t=new Map;for(const n of s)e.set(n.courseId,(e.get(n.courseId)??0)+1),!t.has(n.courseId)&&n.courseName&&t.set(n.courseId,n.courseName);return[...e.keys()].map(n=>({id:n,name:t.get(n)??Hd,roundCount:e.get(n)??0})).sort((n,i)=>{const r=n.name.localeCompare(i.name,void 0,{sensitivity:"base"});return r!==0?r:n.id<i.id?-1:n.id>i.id?1:0})}const jt="last10";function Bd(s){return Ed.includes(s)}const Or=Je("tapscore.stats.window.v1",{decode:s=>Bd(s)?s:jt,encode:s=>s,empty:jt});function Ws(s=ee()){return Or.read(s)}function Jn(s,e=ee()){Or.write(s,e)}function x(s,e){return{value:e===0?null:s/e,n:s,d:e}}const zd=5;function Ld(s,e=zd){return s.d===0?"absent":s.d>=e?"percentage":"fraction"}const qt=Object.freeze({teeRecorded:0,fairwayHits:0,inPlayHits:0,troubleCount:0,teeMissRecorded:0,teeMissLeft:0,teeMissRight:0,teeTroubleLeft:0,teeTroubleRight:0,girRecorded:0,girHits:0,greenMissRecorded:0,greenMissLong:0,greenMissShort:0,greenMissLeft:0,greenMissRight:0,firstPuttRecorded:0,firstPuttInside1m:0,firstPutt1To2m:0,firstPutt2To4m:0,firstPutt4To8m:0,firstPuttOver8m:0,firstPuttInside1mResolved:0,firstPutt1To2mResolved:0,firstPutt2To4mResolved:0,firstPutt4To8mResolved:0,firstPuttOver8mResolved:0,onePuttInside1m:0,onePutt1To2m:0,onePutt2To4m:0,onePutt4To8m:0,onePuttOver8m:0,puttsRecorded:0,puttsTotal:0,threePutts:0,threePuttsFromOver8m:0,scrambleAttemptsStandard:0,scrambleSuccessesStandard:0,scrambleAttemptsHard:0,scrambleSuccessesHard:0,scrambleFirstPuttStandard:0,scrambleInside2mStandard:0,scrambleFirstPuttHard:0,scrambleInside2mHard:0,scrambleHoledStandard:0,scrambleHoledHard:0,scrambleAttemptsBunker:0,scrambleSuccessesBunker:0,scrambleFirstPuttBunker:0,scrambleInside2mBunker:0,scrambleHoledBunker:0,shortGameStrokesRecorded:0,shortGameStrokesEffective:0,shortGameStrokesEffectiveStandard:0,shortGameStrokesEffectiveHard:0,shortGameStrokesEffectiveBunker:0,holesMultiChip:0,holesMultiChipBunker:0,scrambleSingleChipStandard:0,scrambleChipInStandard:0,scrambleChipOnePuttStandard:0,scrambleChipTwoPuttStandard:0,scrambleChipThreePuttStandard:0,scrambleSingleChipHard:0,scrambleChipInHard:0,scrambleChipOnePuttHard:0,scrambleChipTwoPuttHard:0,scrambleChipThreePuttHard:0,scrambleSingleChipBunker:0,scrambleChipInBunker:0,scrambleChipOnePuttBunker:0,scrambleChipTwoPuttBunker:0,scrambleChipThreePuttBunker:0,holesMultiChipStandard:0,holesMultiChipHard:0,scrambleInside2mResolvedStandard:0,scrambleInside2mSavedStandard:0,scrambleInside2mResolvedHard:0,scrambleInside2mSavedHard:0,scrambleInside2mResolvedBunker:0,scrambleInside2mSavedBunker:0,holesScoredMissStandard:0,strokesVsParMissStandard:0,holesScoredMissHard:0,strokesVsParMissHard:0,holesScoredMissBunker:0,strokesVsParMissBunker:0,penaltiesRecorded:0,penaltiesTotal:0,recoveryAttempts:0,recoverySuccesses:0,penaltySourceRecorded:0,penaltiesTee:0,penaltiesApproach:0,penaltiesShort:0,holesScored:0,strokesTotal:0,parTotal:0,holesScoredPar3:0,strokesPar3:0,holesScoredPar4:0,strokesPar4:0,holesScoredPar5:0,strokesPar5:0,holesEagleOrBetter:0,holesBirdie:0,holesPar:0,holesBogey:0,doubleBogeyPlus:0,girHolesScored:0,birdiesOnGir:0,bounceBackOpportunities:0,bounceBackSuccesses:0,holesScoredFairway:0,strokesVsParFairway:0,holesScoredInPlay:0,strokesVsParInPlay:0,holesScoredTrouble:0,strokesVsParTrouble:0,girRecordedFairway:0,girHitsFairway:0,girRecordedInPlay:0,girHitsInPlay:0,girRecordedTrouble:0,girHitsTrouble:0,girFirstPuttRecorded:0,girFirstPuttInside1m:0,girFirstPutt1To2m:0,girFirstPutt2To4m:0,girFirstPutt4To8m:0,girFirstPuttOver8m:0,puttsRecordedGir:0,puttsTotalGir:0,puttsTotalInside1mResolved:0,puttsTotal1To2mResolved:0,puttsTotal2To4mResolved:0,puttsTotal4To8mResolved:0,puttsTotalOver8mResolved:0,strokesVsParGirHit:0,holesScoredGirMiss:0,strokesVsParGirMiss:0,girRecordedPar3:0,girHitsPar3:0,girRecordedPar4:0,girHitsPar4:0,girRecordedPar5:0,girHitsPar5:0,holesZeroPutt:0,holesOnePutt:0,holesTwoPutt:0,puttsRecordedPar3:0,puttsTotalPar3:0,puttsRecordedPar4:0,puttsTotalPar4:0,puttsRecordedPar5:0,puttsTotalPar5:0,holesWithPenalty:0,holesScoredPenalty:0,strokesVsParPenalty:0,holesScoredPenaltyFree:0,strokesVsParPenaltyFree:0,teeRecordedPar4:0,fairwayHitsPar4:0,inPlayHitsPar4:0,troubleCountPar4:0,teeRecordedPar5:0,fairwayHitsPar5:0,inPlayHitsPar5:0,troubleCountPar5:0,attHolesPar3Gir:0,attHolesPar3Miss:0,attHolesPar45Gir:0,attHolesPar45Miss:0,attStrokes:0,attPutts:0,attPenalties:0,attFairwayPar4:0,attInPlayPar4:0,attTroublePar4:0,attFairwayPar5:0,attInPlayPar5:0,attTroublePar5:0,attGirFirstPuttInside1m:0,attGirFirstPutt1To2m:0,attGirFirstPutt2To4m:0,attGirFirstPutt4To8m:0,attGirFirstPuttOver8m:0,attGirHoled:0,attMissStandard:0,attMissHard:0,attChipInside2mStandard:0,attChipOutside2mStandard:0,attChipHoledStandard:0,attChipInside2mHard:0,attChipOutside2mHard:0,attChipHoledHard:0,attMissBunker:0,attChipInside2mBunker:0,attChipOutside2mBunker:0,attChipHoledBunker:0,attSgStrokesEffectiveStandard:0,attSgStrokesEffectiveHard:0,attSgStrokesEffectiveBunker:0,dblPenalty:0,dblFailedRecovery:0,dblMultiChip:0,dblThreePutt:0,dblTroubleTee:0,dblFullSwing:0,dblUnattributed:0,dblPenaltyTee:0,dblPenaltyApproach:0,dblPenaltyShort:0,dblPenaltyUnknown:0,firstPuttMRecorded:0,firstPuttMSum:0,firstPuttMRecordedGir:0,firstPuttMSumGir:0,metersMadeSum:0,metersMadeHoles:0,onePuttsUnmeasured:0,greenHitLate:0,chipGirHoles:0,chipGirOnePutt:0,chipGirPar5:0,chipGirPar5OnePutt:0});function Fd(s,e){return{teeRecorded:s.teeRecorded+e.teeRecorded,fairwayHits:s.fairwayHits+e.fairwayHits,inPlayHits:s.inPlayHits+e.inPlayHits,troubleCount:s.troubleCount+e.troubleCount,teeMissRecorded:s.teeMissRecorded+e.teeMissRecorded,teeMissLeft:s.teeMissLeft+e.teeMissLeft,teeMissRight:s.teeMissRight+e.teeMissRight,teeTroubleLeft:s.teeTroubleLeft+e.teeTroubleLeft,teeTroubleRight:s.teeTroubleRight+e.teeTroubleRight,girRecorded:s.girRecorded+e.girRecorded,girHits:s.girHits+e.girHits,greenMissRecorded:s.greenMissRecorded+e.greenMissRecorded,greenMissLong:s.greenMissLong+e.greenMissLong,greenMissShort:s.greenMissShort+e.greenMissShort,greenMissLeft:s.greenMissLeft+e.greenMissLeft,greenMissRight:s.greenMissRight+e.greenMissRight,firstPuttRecorded:s.firstPuttRecorded+e.firstPuttRecorded,firstPuttInside1m:s.firstPuttInside1m+e.firstPuttInside1m,firstPutt1To2m:s.firstPutt1To2m+e.firstPutt1To2m,firstPutt2To4m:s.firstPutt2To4m+e.firstPutt2To4m,firstPutt4To8m:s.firstPutt4To8m+e.firstPutt4To8m,firstPuttOver8m:s.firstPuttOver8m+e.firstPuttOver8m,firstPuttInside1mResolved:s.firstPuttInside1mResolved+e.firstPuttInside1mResolved,firstPutt1To2mResolved:s.firstPutt1To2mResolved+e.firstPutt1To2mResolved,firstPutt2To4mResolved:s.firstPutt2To4mResolved+e.firstPutt2To4mResolved,firstPutt4To8mResolved:s.firstPutt4To8mResolved+e.firstPutt4To8mResolved,firstPuttOver8mResolved:s.firstPuttOver8mResolved+e.firstPuttOver8mResolved,onePuttInside1m:s.onePuttInside1m+e.onePuttInside1m,onePutt1To2m:s.onePutt1To2m+e.onePutt1To2m,onePutt2To4m:s.onePutt2To4m+e.onePutt2To4m,onePutt4To8m:s.onePutt4To8m+e.onePutt4To8m,onePuttOver8m:s.onePuttOver8m+e.onePuttOver8m,puttsRecorded:s.puttsRecorded+e.puttsRecorded,puttsTotal:s.puttsTotal+e.puttsTotal,threePutts:s.threePutts+e.threePutts,threePuttsFromOver8m:s.threePuttsFromOver8m+e.threePuttsFromOver8m,scrambleAttemptsStandard:s.scrambleAttemptsStandard+e.scrambleAttemptsStandard,scrambleSuccessesStandard:s.scrambleSuccessesStandard+e.scrambleSuccessesStandard,scrambleAttemptsHard:s.scrambleAttemptsHard+e.scrambleAttemptsHard,scrambleSuccessesHard:s.scrambleSuccessesHard+e.scrambleSuccessesHard,scrambleFirstPuttStandard:s.scrambleFirstPuttStandard+e.scrambleFirstPuttStandard,scrambleInside2mStandard:s.scrambleInside2mStandard+e.scrambleInside2mStandard,scrambleFirstPuttHard:s.scrambleFirstPuttHard+e.scrambleFirstPuttHard,scrambleInside2mHard:s.scrambleInside2mHard+e.scrambleInside2mHard,scrambleHoledStandard:s.scrambleHoledStandard+e.scrambleHoledStandard,scrambleHoledHard:s.scrambleHoledHard+e.scrambleHoledHard,scrambleAttemptsBunker:s.scrambleAttemptsBunker+e.scrambleAttemptsBunker,scrambleSuccessesBunker:s.scrambleSuccessesBunker+e.scrambleSuccessesBunker,scrambleFirstPuttBunker:s.scrambleFirstPuttBunker+e.scrambleFirstPuttBunker,scrambleInside2mBunker:s.scrambleInside2mBunker+e.scrambleInside2mBunker,scrambleHoledBunker:s.scrambleHoledBunker+e.scrambleHoledBunker,shortGameStrokesRecorded:s.shortGameStrokesRecorded+e.shortGameStrokesRecorded,shortGameStrokesEffective:s.shortGameStrokesEffective+e.shortGameStrokesEffective,shortGameStrokesEffectiveStandard:s.shortGameStrokesEffectiveStandard+e.shortGameStrokesEffectiveStandard,shortGameStrokesEffectiveHard:s.shortGameStrokesEffectiveHard+e.shortGameStrokesEffectiveHard,shortGameStrokesEffectiveBunker:s.shortGameStrokesEffectiveBunker+e.shortGameStrokesEffectiveBunker,holesMultiChip:s.holesMultiChip+e.holesMultiChip,holesMultiChipBunker:s.holesMultiChipBunker+e.holesMultiChipBunker,scrambleSingleChipStandard:s.scrambleSingleChipStandard+e.scrambleSingleChipStandard,scrambleChipInStandard:s.scrambleChipInStandard+e.scrambleChipInStandard,scrambleChipOnePuttStandard:s.scrambleChipOnePuttStandard+e.scrambleChipOnePuttStandard,scrambleChipTwoPuttStandard:s.scrambleChipTwoPuttStandard+e.scrambleChipTwoPuttStandard,scrambleChipThreePuttStandard:s.scrambleChipThreePuttStandard+e.scrambleChipThreePuttStandard,scrambleSingleChipHard:s.scrambleSingleChipHard+e.scrambleSingleChipHard,scrambleChipInHard:s.scrambleChipInHard+e.scrambleChipInHard,scrambleChipOnePuttHard:s.scrambleChipOnePuttHard+e.scrambleChipOnePuttHard,scrambleChipTwoPuttHard:s.scrambleChipTwoPuttHard+e.scrambleChipTwoPuttHard,scrambleChipThreePuttHard:s.scrambleChipThreePuttHard+e.scrambleChipThreePuttHard,scrambleSingleChipBunker:s.scrambleSingleChipBunker+e.scrambleSingleChipBunker,scrambleChipInBunker:s.scrambleChipInBunker+e.scrambleChipInBunker,scrambleChipOnePuttBunker:s.scrambleChipOnePuttBunker+e.scrambleChipOnePuttBunker,scrambleChipTwoPuttBunker:s.scrambleChipTwoPuttBunker+e.scrambleChipTwoPuttBunker,scrambleChipThreePuttBunker:s.scrambleChipThreePuttBunker+e.scrambleChipThreePuttBunker,holesMultiChipStandard:s.holesMultiChipStandard+e.holesMultiChipStandard,holesMultiChipHard:s.holesMultiChipHard+e.holesMultiChipHard,scrambleInside2mResolvedStandard:s.scrambleInside2mResolvedStandard+e.scrambleInside2mResolvedStandard,scrambleInside2mSavedStandard:s.scrambleInside2mSavedStandard+e.scrambleInside2mSavedStandard,scrambleInside2mResolvedHard:s.scrambleInside2mResolvedHard+e.scrambleInside2mResolvedHard,scrambleInside2mSavedHard:s.scrambleInside2mSavedHard+e.scrambleInside2mSavedHard,scrambleInside2mResolvedBunker:s.scrambleInside2mResolvedBunker+e.scrambleInside2mResolvedBunker,scrambleInside2mSavedBunker:s.scrambleInside2mSavedBunker+e.scrambleInside2mSavedBunker,holesScoredMissStandard:s.holesScoredMissStandard+e.holesScoredMissStandard,strokesVsParMissStandard:s.strokesVsParMissStandard+e.strokesVsParMissStandard,holesScoredMissHard:s.holesScoredMissHard+e.holesScoredMissHard,strokesVsParMissHard:s.strokesVsParMissHard+e.strokesVsParMissHard,holesScoredMissBunker:s.holesScoredMissBunker+e.holesScoredMissBunker,strokesVsParMissBunker:s.strokesVsParMissBunker+e.strokesVsParMissBunker,penaltiesRecorded:s.penaltiesRecorded+e.penaltiesRecorded,penaltiesTotal:s.penaltiesTotal+e.penaltiesTotal,recoveryAttempts:s.recoveryAttempts+e.recoveryAttempts,recoverySuccesses:s.recoverySuccesses+e.recoverySuccesses,penaltySourceRecorded:s.penaltySourceRecorded+e.penaltySourceRecorded,penaltiesTee:s.penaltiesTee+e.penaltiesTee,penaltiesApproach:s.penaltiesApproach+e.penaltiesApproach,penaltiesShort:s.penaltiesShort+e.penaltiesShort,holesScored:s.holesScored+e.holesScored,strokesTotal:s.strokesTotal+e.strokesTotal,parTotal:s.parTotal+e.parTotal,holesScoredPar3:s.holesScoredPar3+e.holesScoredPar3,strokesPar3:s.strokesPar3+e.strokesPar3,holesScoredPar4:s.holesScoredPar4+e.holesScoredPar4,strokesPar4:s.strokesPar4+e.strokesPar4,holesScoredPar5:s.holesScoredPar5+e.holesScoredPar5,strokesPar5:s.strokesPar5+e.strokesPar5,holesEagleOrBetter:s.holesEagleOrBetter+e.holesEagleOrBetter,holesBirdie:s.holesBirdie+e.holesBirdie,holesPar:s.holesPar+e.holesPar,holesBogey:s.holesBogey+e.holesBogey,doubleBogeyPlus:s.doubleBogeyPlus+e.doubleBogeyPlus,girHolesScored:s.girHolesScored+e.girHolesScored,birdiesOnGir:s.birdiesOnGir+e.birdiesOnGir,bounceBackOpportunities:s.bounceBackOpportunities+e.bounceBackOpportunities,bounceBackSuccesses:s.bounceBackSuccesses+e.bounceBackSuccesses,holesScoredFairway:s.holesScoredFairway+e.holesScoredFairway,strokesVsParFairway:s.strokesVsParFairway+e.strokesVsParFairway,holesScoredInPlay:s.holesScoredInPlay+e.holesScoredInPlay,strokesVsParInPlay:s.strokesVsParInPlay+e.strokesVsParInPlay,holesScoredTrouble:s.holesScoredTrouble+e.holesScoredTrouble,strokesVsParTrouble:s.strokesVsParTrouble+e.strokesVsParTrouble,girRecordedFairway:s.girRecordedFairway+e.girRecordedFairway,girHitsFairway:s.girHitsFairway+e.girHitsFairway,girRecordedInPlay:s.girRecordedInPlay+e.girRecordedInPlay,girHitsInPlay:s.girHitsInPlay+e.girHitsInPlay,girRecordedTrouble:s.girRecordedTrouble+e.girRecordedTrouble,girHitsTrouble:s.girHitsTrouble+e.girHitsTrouble,girFirstPuttRecorded:s.girFirstPuttRecorded+e.girFirstPuttRecorded,girFirstPuttInside1m:s.girFirstPuttInside1m+e.girFirstPuttInside1m,girFirstPutt1To2m:s.girFirstPutt1To2m+e.girFirstPutt1To2m,girFirstPutt2To4m:s.girFirstPutt2To4m+e.girFirstPutt2To4m,girFirstPutt4To8m:s.girFirstPutt4To8m+e.girFirstPutt4To8m,girFirstPuttOver8m:s.girFirstPuttOver8m+e.girFirstPuttOver8m,puttsRecordedGir:s.puttsRecordedGir+e.puttsRecordedGir,puttsTotalGir:s.puttsTotalGir+e.puttsTotalGir,puttsTotalInside1mResolved:s.puttsTotalInside1mResolved+e.puttsTotalInside1mResolved,puttsTotal1To2mResolved:s.puttsTotal1To2mResolved+e.puttsTotal1To2mResolved,puttsTotal2To4mResolved:s.puttsTotal2To4mResolved+e.puttsTotal2To4mResolved,puttsTotal4To8mResolved:s.puttsTotal4To8mResolved+e.puttsTotal4To8mResolved,puttsTotalOver8mResolved:s.puttsTotalOver8mResolved+e.puttsTotalOver8mResolved,strokesVsParGirHit:s.strokesVsParGirHit+e.strokesVsParGirHit,holesScoredGirMiss:s.holesScoredGirMiss+e.holesScoredGirMiss,strokesVsParGirMiss:s.strokesVsParGirMiss+e.strokesVsParGirMiss,girRecordedPar3:s.girRecordedPar3+e.girRecordedPar3,girHitsPar3:s.girHitsPar3+e.girHitsPar3,girRecordedPar4:s.girRecordedPar4+e.girRecordedPar4,girHitsPar4:s.girHitsPar4+e.girHitsPar4,girRecordedPar5:s.girRecordedPar5+e.girRecordedPar5,girHitsPar5:s.girHitsPar5+e.girHitsPar5,holesZeroPutt:s.holesZeroPutt+e.holesZeroPutt,holesOnePutt:s.holesOnePutt+e.holesOnePutt,holesTwoPutt:s.holesTwoPutt+e.holesTwoPutt,puttsRecordedPar3:s.puttsRecordedPar3+e.puttsRecordedPar3,puttsTotalPar3:s.puttsTotalPar3+e.puttsTotalPar3,puttsRecordedPar4:s.puttsRecordedPar4+e.puttsRecordedPar4,puttsTotalPar4:s.puttsTotalPar4+e.puttsTotalPar4,puttsRecordedPar5:s.puttsRecordedPar5+e.puttsRecordedPar5,puttsTotalPar5:s.puttsTotalPar5+e.puttsTotalPar5,holesWithPenalty:s.holesWithPenalty+e.holesWithPenalty,holesScoredPenalty:s.holesScoredPenalty+e.holesScoredPenalty,strokesVsParPenalty:s.strokesVsParPenalty+e.strokesVsParPenalty,holesScoredPenaltyFree:s.holesScoredPenaltyFree+e.holesScoredPenaltyFree,strokesVsParPenaltyFree:s.strokesVsParPenaltyFree+e.strokesVsParPenaltyFree,teeRecordedPar4:s.teeRecordedPar4+e.teeRecordedPar4,fairwayHitsPar4:s.fairwayHitsPar4+e.fairwayHitsPar4,inPlayHitsPar4:s.inPlayHitsPar4+e.inPlayHitsPar4,troubleCountPar4:s.troubleCountPar4+e.troubleCountPar4,teeRecordedPar5:s.teeRecordedPar5+e.teeRecordedPar5,fairwayHitsPar5:s.fairwayHitsPar5+e.fairwayHitsPar5,inPlayHitsPar5:s.inPlayHitsPar5+e.inPlayHitsPar5,troubleCountPar5:s.troubleCountPar5+e.troubleCountPar5,attHolesPar3Gir:s.attHolesPar3Gir+e.attHolesPar3Gir,attHolesPar3Miss:s.attHolesPar3Miss+e.attHolesPar3Miss,attHolesPar45Gir:s.attHolesPar45Gir+e.attHolesPar45Gir,attHolesPar45Miss:s.attHolesPar45Miss+e.attHolesPar45Miss,attStrokes:s.attStrokes+e.attStrokes,attPutts:s.attPutts+e.attPutts,attPenalties:s.attPenalties+e.attPenalties,attFairwayPar4:s.attFairwayPar4+e.attFairwayPar4,attInPlayPar4:s.attInPlayPar4+e.attInPlayPar4,attTroublePar4:s.attTroublePar4+e.attTroublePar4,attFairwayPar5:s.attFairwayPar5+e.attFairwayPar5,attInPlayPar5:s.attInPlayPar5+e.attInPlayPar5,attTroublePar5:s.attTroublePar5+e.attTroublePar5,attGirFirstPuttInside1m:s.attGirFirstPuttInside1m+e.attGirFirstPuttInside1m,attGirFirstPutt1To2m:s.attGirFirstPutt1To2m+e.attGirFirstPutt1To2m,attGirFirstPutt2To4m:s.attGirFirstPutt2To4m+e.attGirFirstPutt2To4m,attGirFirstPutt4To8m:s.attGirFirstPutt4To8m+e.attGirFirstPutt4To8m,attGirFirstPuttOver8m:s.attGirFirstPuttOver8m+e.attGirFirstPuttOver8m,attGirHoled:s.attGirHoled+e.attGirHoled,attMissStandard:s.attMissStandard+e.attMissStandard,attMissHard:s.attMissHard+e.attMissHard,attChipInside2mStandard:s.attChipInside2mStandard+e.attChipInside2mStandard,attChipOutside2mStandard:s.attChipOutside2mStandard+e.attChipOutside2mStandard,attChipHoledStandard:s.attChipHoledStandard+e.attChipHoledStandard,attChipInside2mHard:s.attChipInside2mHard+e.attChipInside2mHard,attChipOutside2mHard:s.attChipOutside2mHard+e.attChipOutside2mHard,attChipHoledHard:s.attChipHoledHard+e.attChipHoledHard,attMissBunker:s.attMissBunker+e.attMissBunker,attChipInside2mBunker:s.attChipInside2mBunker+e.attChipInside2mBunker,attChipOutside2mBunker:s.attChipOutside2mBunker+e.attChipOutside2mBunker,attChipHoledBunker:s.attChipHoledBunker+e.attChipHoledBunker,attSgStrokesEffectiveStandard:s.attSgStrokesEffectiveStandard+e.attSgStrokesEffectiveStandard,attSgStrokesEffectiveHard:s.attSgStrokesEffectiveHard+e.attSgStrokesEffectiveHard,attSgStrokesEffectiveBunker:s.attSgStrokesEffectiveBunker+e.attSgStrokesEffectiveBunker,dblPenalty:s.dblPenalty+e.dblPenalty,dblFailedRecovery:s.dblFailedRecovery+e.dblFailedRecovery,dblMultiChip:s.dblMultiChip+e.dblMultiChip,dblThreePutt:s.dblThreePutt+e.dblThreePutt,dblTroubleTee:s.dblTroubleTee+e.dblTroubleTee,dblFullSwing:s.dblFullSwing+e.dblFullSwing,dblUnattributed:s.dblUnattributed+e.dblUnattributed,dblPenaltyTee:s.dblPenaltyTee+e.dblPenaltyTee,dblPenaltyApproach:s.dblPenaltyApproach+e.dblPenaltyApproach,dblPenaltyShort:s.dblPenaltyShort+e.dblPenaltyShort,dblPenaltyUnknown:s.dblPenaltyUnknown+e.dblPenaltyUnknown,firstPuttMRecorded:s.firstPuttMRecorded+e.firstPuttMRecorded,firstPuttMSum:s.firstPuttMSum+e.firstPuttMSum,firstPuttMRecordedGir:s.firstPuttMRecordedGir+e.firstPuttMRecordedGir,firstPuttMSumGir:s.firstPuttMSumGir+e.firstPuttMSumGir,metersMadeSum:s.metersMadeSum+e.metersMadeSum,metersMadeHoles:s.metersMadeHoles+e.metersMadeHoles,onePuttsUnmeasured:s.onePuttsUnmeasured+e.onePuttsUnmeasured,greenHitLate:s.greenHitLate+e.greenHitLate,chipGirHoles:s.chipGirHoles+e.chipGirHoles,chipGirOnePutt:s.chipGirOnePutt+e.chipGirOnePutt,chipGirPar5:s.chipGirPar5+e.chipGirPar5,chipGirPar5OnePutt:s.chipGirPar5OnePutt+e.chipGirPar5OnePutt}}function Zn(s){let e=qt;for(const t of s)e=Fd(e,t);return e}function Gd(s){return s.teeRecorded>0||s.girRecorded>0||s.puttsRecorded>0||s.firstPuttRecorded>0||s.penaltiesRecorded>0||s.greenMissRecorded>0||s.shortGameStrokesRecorded>0}const Fe=["inside_1m","1_to_2m","2_to_4m","4_to_8m","over_8m"];function os(s,e){switch(e){case"inside_1m":return s.firstPuttInside1mResolved;case"1_to_2m":return s.firstPutt1To2mResolved;case"2_to_4m":return s.firstPutt2To4mResolved;case"4_to_8m":return s.firstPutt4To8mResolved;case"over_8m":return s.firstPuttOver8mResolved}}function Dd(s,e){switch(e){case"inside_1m":return s.puttsTotalInside1mResolved;case"1_to_2m":return s.puttsTotal1To2mResolved;case"2_to_4m":return s.puttsTotal2To4mResolved;case"4_to_8m":return s.puttsTotal4To8mResolved;case"over_8m":return s.puttsTotalOver8mResolved}}function jd(s,e){switch(e){case"inside_1m":return s.onePuttInside1m;case"1_to_2m":return s.onePutt1To2m;case"2_to_4m":return s.onePutt2To4m;case"4_to_8m":return s.onePutt4To8m;case"over_8m":return s.onePuttOver8m}}function qd(s,e){switch(e){case"inside_1m":return s.girFirstPuttInside1m;case"1_to_2m":return s.girFirstPutt1To2m;case"2_to_4m":return s.girFirstPutt2To4m;case"4_to_8m":return s.girFirstPutt4To8m;case"over_8m":return s.girFirstPuttOver8m}}function Mr(s){return x(s.fairwayHits,s.teeRecorded)}function Vd(s){return x(s.troubleCount,s.teeRecorded)}function Ud(s){return x(s.holesScoredPenalty,s.holesScored)}function Kd(s){return{penalty:x(s.strokesVsParPenalty,s.holesScoredPenalty),clean:x(s.strokesVsParPenaltyFree,s.holesScoredPenaltyFree)}}function Wd(s){const e=s.strokesVsParPenalty*s.holesScoredPenaltyFree-s.strokesVsParPenaltyFree*s.holesScoredPenalty;return x(e,s.holesScoredPenalty*s.holesScoredPenaltyFree)}function Yd(s){return x(s.recoverySuccesses,s.recoveryAttempts)}function Xd(s,e){return x(s.penaltiesTotal,e)}function Qd(s){return{fairway:x(s.strokesVsParFairway,s.holesScoredFairway),inPlay:x(s.strokesVsParInPlay,s.holesScoredInPlay),trouble:x(s.strokesVsParTrouble,s.holesScoredTrouble)}}function Jd(s){const e=s.strokesVsParTrouble*s.holesScoredFairway-s.strokesVsParFairway*s.holesScoredTrouble;return x(e,s.holesScoredTrouble*s.holesScoredFairway)}function Hr(s){return x(s.girHits,s.girRecorded)}function Zd(s){return{fairway:x(s.girHitsFairway,s.girRecordedFairway),inPlay:x(s.girHitsInPlay,s.girRecordedInPlay),trouble:x(s.girHitsTrouble,s.girRecordedTrouble)}}function ec(s){return{par3:x(s.girHitsPar3,s.girRecordedPar3),par4:x(s.girHitsPar4,s.girRecordedPar4),par5:x(s.girHitsPar5,s.girRecordedPar5)}}function tc(s){const e=x(s.strokesVsParGirHit,s.girHolesScored),t=x(s.strokesVsParGirMiss,s.holesScoredGirMiss),n=s.strokesVsParGirMiss*s.girHolesScored-s.strokesVsParGirHit*s.holesScoredGirMiss;return{hit:e,miss:t,delta:x(n,s.holesScoredGirMiss*s.girHolesScored)}}function sc(s,e){return x(qd(s,e),s.girFirstPuttRecorded)}function nc(s){let e=0;for(const t of Fe)e+=os(s,t);return e}function ic(s,e){return x(os(s,e),nc(s))}function rc(s){return x(s.birdiesOnGir,s.girHolesScored)}function ac(s){return x(s.scrambleAttemptsHard,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function oc(s){const e=s.greenMissRecorded;return{long:x(s.greenMissLong,e),short:x(s.greenMissShort,e),left:x(s.greenMissLeft,e),right:x(s.greenMissRight,e)}}function lc(s){return{left:x(s.teeMissLeft,s.teeMissRecorded),right:x(s.teeMissRight,s.teeMissRecorded),troubleLeft:x(s.teeTroubleLeft,s.teeMissLeft),troubleRight:x(s.teeTroubleRight,s.teeMissRight)}}function dc(s){const e=s.penaltySourceRecorded;return{tee:x(s.penaltiesTee,e),approach:x(s.penaltiesApproach,e),short:x(s.penaltiesShort,e)}}function cc(s,e){return x(jd(s,e),os(s,e))}function uc(s){return x(s.threePutts,s.puttsRecorded)}function hc(s){const e=s.puttsRecorded;return{zero:x(s.holesZeroPutt,e),one:x(s.holesOnePutt,e),two:x(s.holesTwoPutt,e),threePlus:x(s.threePutts,e)}}function pc(s){return{par3:x(s.puttsTotalPar3,s.puttsRecordedPar3),par4:x(s.puttsTotalPar4,s.puttsRecordedPar4),par5:x(s.puttsTotalPar5,s.puttsRecordedPar5)}}function fc(s){return x(s.threePuttsFromOver8m,s.firstPuttOver8mResolved)}function mc(s){return x(s.puttsTotalGir,s.puttsRecordedGir)}function gc(s){const e=Math.max(0,s.puttsTotal-s.puttsTotalGir),t=Math.max(0,s.puttsRecorded-s.puttsRecordedGir);return x(e,t)}function Ar(s){return{standard:x(s.scrambleSuccessesStandard,s.scrambleAttemptsStandard),hard:x(s.scrambleSuccessesHard,s.scrambleAttemptsHard),bunker:x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker),overall:x(s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function bc(s){return x(s.scrambleSuccessesBunker,s.scrambleAttemptsBunker)}function yc(s){return s.shortGameStrokesEffective-(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}function _c(s){return{standard:x(s.scrambleInside2mStandard,s.scrambleFirstPuttStandard),hard:x(s.scrambleInside2mHard,s.scrambleFirstPuttHard),bunker:x(s.scrambleInside2mBunker,s.scrambleFirstPuttBunker),overall:x(s.scrambleInside2mStandard+s.scrambleInside2mHard+s.scrambleInside2mBunker,s.scrambleFirstPuttStandard+s.scrambleFirstPuttHard+s.scrambleFirstPuttBunker)}}function vc(s){const e=(t,n,i,r,o,d)=>({chipIn:x(t,d),onePutt:x(n,d),twoPutt:x(i,d),threePlus:x(r,d),multiChip:x(o,d)});return{standard:e(s.scrambleChipInStandard,s.scrambleChipOnePuttStandard,s.scrambleChipTwoPuttStandard,s.scrambleChipThreePuttStandard,s.holesMultiChipStandard,s.scrambleAttemptsStandard),hard:e(s.scrambleChipInHard,s.scrambleChipOnePuttHard,s.scrambleChipTwoPuttHard,s.scrambleChipThreePuttHard,s.holesMultiChipHard,s.scrambleAttemptsHard),bunker:e(s.scrambleChipInBunker,s.scrambleChipOnePuttBunker,s.scrambleChipTwoPuttBunker,s.scrambleChipThreePuttBunker,s.holesMultiChipBunker,s.scrambleAttemptsBunker),overall:e(s.scrambleChipInStandard+s.scrambleChipInHard+s.scrambleChipInBunker,s.scrambleChipOnePuttStandard+s.scrambleChipOnePuttHard+s.scrambleChipOnePuttBunker,s.scrambleChipTwoPuttStandard+s.scrambleChipTwoPuttHard+s.scrambleChipTwoPuttBunker,s.scrambleChipThreePuttStandard+s.scrambleChipThreePuttHard+s.scrambleChipThreePuttBunker,s.holesMultiChip,s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker)}}function wc(s){return{standard:x(s.scrambleInside2mSavedStandard,s.scrambleInside2mResolvedStandard),hard:x(s.scrambleInside2mSavedHard,s.scrambleInside2mResolvedHard),bunker:x(s.scrambleInside2mSavedBunker,s.scrambleInside2mResolvedBunker),overall:x(s.scrambleInside2mSavedStandard+s.scrambleInside2mSavedHard+s.scrambleInside2mSavedBunker,s.scrambleInside2mResolvedStandard+s.scrambleInside2mResolvedHard+s.scrambleInside2mResolvedBunker)}}function xc(s){return{standard:x(s.strokesVsParMissStandard,s.holesScoredMissStandard),hard:x(s.strokesVsParMissHard,s.holesScoredMissHard),bunker:x(s.strokesVsParMissBunker,s.holesScoredMissBunker),overall:x(s.strokesVsParMissStandard+s.strokesVsParMissHard+s.strokesVsParMissBunker,s.holesScoredMissStandard+s.holesScoredMissHard+s.holesScoredMissBunker)}}function kc(s){const e=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker;return{standard:x(s.scrambleAttemptsStandard,e),hard:x(s.scrambleAttemptsHard,e),bunker:x(s.scrambleAttemptsBunker,e),overall:x(e,e)}}function $c(s){return x(s.firstPuttMSumGir,s.firstPuttMRecordedGir)}function Sc(s){return s.metersMadeSum}function Tc(s){return x(s.girHits+s.greenHitLate,s.girRecorded)}function Pc(s){return x(s.chipGirOnePutt,s.chipGirHoles)}function Cc(s){return x(s.chipGirPar5OnePutt,s.chipGirPar5)}function Ic(s){const e=new Map;for(const t of s){const n=e.get(t.firstPuttM)??{attempts:0,onePutts:0,puttsTotal:0};n.attempts+=t.attempts,n.onePutts+=t.onePutts,n.puttsTotal+=t.puttsTotal,e.set(t.firstPuttM,n)}return[...e.entries()].sort(([t],[n])=>t-n).map(([t,n])=>({meters:t,attempts:n.attempts,onePutts:n.onePutts,avgPutts:x(n.puttsTotal,n.attempts)}))}function Ec(s){return{par3:x(s.strokesPar3-3*s.holesScoredPar3,s.holesScoredPar3),par4:x(s.strokesPar4-4*s.holesScoredPar4,s.holesScoredPar4),par5:x(s.strokesPar5-5*s.holesScoredPar5,s.holesScoredPar5)}}function Rc(s,e){return x(s.doubleBogeyPlus,e)}function Nc(s){return x(s.bounceBackSuccesses,s.bounceBackOpportunities)}function Oc(s){const e=s.doubleBogeyPlus,t=(n,i)=>({id:n,share:x(i,e)});return[{id:"offTee",share:x(s.dblTroubleTee+s.dblFailedRecovery+s.dblPenaltyTee,e),subs:[t("troubleTee",s.dblTroubleTee),t("failedRecovery",s.dblFailedRecovery),t("penaltyTee",s.dblPenaltyTee)]},{id:"longGame",share:x(s.dblFullSwing+s.dblPenaltyApproach,e),subs:[t("fullSwing",s.dblFullSwing),t("penaltyApproach",s.dblPenaltyApproach)]},{id:"shortGame",share:x(s.dblMultiChip+s.dblPenaltyShort,e),subs:[t("multiChip",s.dblMultiChip),t("penaltyShort",s.dblPenaltyShort)]},{id:"threePutt",share:x(s.dblThreePutt,e),subs:[]},{id:"unattributed",share:x(s.dblUnattributed+s.dblPenaltyUnknown,e),subs:[]}]}function Mc(s){const e=s.score===null||s.score===0?null:s.score;if(e===null||e<s.par+2)return null;const t=s.stats,n=!(t.putts===0&&t.firstPutt!==null);return(t.penalties??0)>=1?"penalty":t.recoveryOk===!1?"failedRecovery":t.gir===!1&&(t.shortGameStrokes??1)>1?"multiChip":n&&t.putts!==null&&t.putts>=3?"threePutt":t.teeResult==="trouble"?"troubleTee":t.gir!==null&&n&&t.putts!==null&&(s.par<=3||t.teeResult!==null)&&(t.gir===!0||t.shortGameDifficulty!==null)?"fullSwing":"unattributed"}const Hc=["eagleOrBetter","birdie","par","bogey","doubleBogeyPlus"],Ac=18;function Bc(s){let e=0,t=0,n=0;const i={eagleOrBetter:0,birdie:0,par:0,bogey:0,doubleBogeyPlus:0},r=new Map;for(const c of s){const h=c.measures;t+=h.holesScored,i.eagleOrBetter+=h.holesEagleOrBetter,i.birdie+=h.holesBirdie,i.par+=h.holesPar,i.bogey+=h.holesBogey,i.doubleBogeyPlus+=h.doubleBogeyPlus,h.holesScored>0&&(e+=1,n+=h.strokesTotal-h.parTotal);let u=r.get(c.holeCount);if(u||(u={holeCount:c.holeCount,rounds:0,completeRounds:0,best:null},r.set(c.holeCount,u)),u.rounds+=1,!(c.holeCount>0&&h.holesScored===c.holeCount))continue;u.completeRounds+=1;const m=h.strokesTotal-h.parTotal;(u.best===null||m<u.best.vsPar)&&(u.best={vsPar:m,strokes:h.strokesTotal})}const o=[...r.values()].sort((c,h)=>h.holeCount-c.holeCount);let d=0;for(const c of o)d+=c.rounds*c.holeCount;return{rounds:s.length,scoredRounds:e,holesScored:t,holesExpected:d,lengths:o,avgVsParPer18:x(n*Ac,t),scoreTypeCounts:i}}const Br=Object.freeze({inside_1m:1.05,"1_to_2m":1.45,"2_to_4m":1.85,"4_to_8m":2.1,over_8m:2.4}),Ys=Object.freeze([Object.freeze({meters:.3,putts:1.03}),Object.freeze({meters:.5,putts:1.05}),Object.freeze({meters:.8,putts:1.17}),Object.freeze({meters:1,putts:1.25}),Object.freeze({meters:1.5,putts:1.45}),Object.freeze({meters:2,putts:1.58}),Object.freeze({meters:2.5,putts:1.72}),Object.freeze({meters:3,putts:1.85}),Object.freeze({meters:3.5,putts:1.89}),Object.freeze({meters:4,putts:1.93}),Object.freeze({meters:5,putts:2.02}),Object.freeze({meters:6,putts:2.1}),Object.freeze({meters:7,putts:2.15}),Object.freeze({meters:8,putts:2.2}),Object.freeze({meters:10,putts:2.3}),Object.freeze({meters:12,putts:2.4}),Object.freeze({meters:14,putts:2.5}),Object.freeze({meters:16,putts:2.6}),Object.freeze({meters:20,putts:2.8})]);function zc(s){let e=Ys[0];for(const t of Ys)Math.abs(t.meters-s)<Math.abs(e.meters-s)&&(e=t);return e.putts}function Lc(s){return s<1?"inside_1m":s<=2?"1_to_2m":s<=4?"2_to_4m":s<=8?"4_to_8m":"over_8m"}const zr=Object.freeze({inside2m:1.25,outside2m:2.12}),Lr=Object.freeze({standard:1.7,hard:2.1,bunker:1.95}),Fr=Object.freeze({version:"v1-provisional",calibratedAt:null,eHole:Object.freeze({3:3.6,4:4.7,5:5.5}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.45,in_play:3.8,trouble:4.35}),5:Object.freeze({fairway:4.25,in_play:4.6,trouble:5.15})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Fc=["scratch","hcp5","hcp12","hcp20"];function bn(s){return s===null?"hcp12":s<2.5?"scratch":s<8.5?"hcp5":s<16?"hcp12":"hcp20"}function Gc(s){return Math.round(4*s.eHole[3]+10*s.eHole[4]+4*s.eHole[5])}const Dc=Object.freeze({version:"v1-provisional-scratch",calibratedAt:null,eHole:Object.freeze({3:3.25,4:4.15,5:4.85}),eAfterTee:Object.freeze({4:Object.freeze({fairway:2.95,in_play:3.25,trouble:3.7}),5:Object.freeze({fairway:3.65,in_play:3.95,trouble:4.4})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),jc=Object.freeze({version:"v1-provisional-hcp5",calibratedAt:null,eHole:Object.freeze({3:3.4,4:4.45,5:5.1}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.2,in_play:3.6,trouble:4.05}),5:Object.freeze({fairway:3.9,in_play:4.25,trouble:4.55})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),qc=Object.freeze({version:"v1-provisional-hcp20",calibratedAt:null,eHole:Object.freeze({3:3.9,4:5.1,5:5.9}),eAfterTee:Object.freeze({4:Object.freeze({fairway:3.85,in_play:4.2,trouble:4.85}),5:Object.freeze({fairway:4.65,in_play:5,trouble:5.65})}),rowCounts:Object.freeze({eHole:Object.freeze({3:0,4:0,5:0}),eAfterTee:Object.freeze({4:Object.freeze({fairway:0,in_play:0,trouble:0}),5:Object.freeze({fairway:0,in_play:0,trouble:0})})})}),Vc=Object.freeze({inside_1m:1.02,"1_to_2m":1.35,"2_to_4m":1.72,"4_to_8m":1.95,over_8m:2.2}),Uc=Object.freeze({inside_1m:1.03,"1_to_2m":1.4,"2_to_4m":1.78,"4_to_8m":2.02,over_8m:2.3}),Kc=Object.freeze({inside_1m:1.08,"1_to_2m":1.5,"2_to_4m":1.92,"4_to_8m":2.2,over_8m:2.55}),Wc=Object.freeze({inside2m:1.19,outside2m:1.96}),Yc=Object.freeze({inside2m:1.22,outside2m:2.03}),Xc=Object.freeze({inside2m:1.29,outside2m:2.22}),Qc=Object.freeze({standard:1.55,hard:1.9,bunker:1.75}),Jc=Object.freeze({standard:1.62,hard:2,bunker:1.85}),Zc=Object.freeze({standard:1.8,hard:2.25,bunker:2.08}),bt=Object.freeze({scratch:Object.freeze({tables:Dc,expected:Vc,chipOutcome:Wc,chipBaseline:Qc}),hcp5:Object.freeze({tables:jc,expected:Uc,chipOutcome:Yc,chipBaseline:Jc}),hcp12:Object.freeze({tables:Fr,expected:Br,chipOutcome:zr,chipBaseline:Lr}),hcp20:Object.freeze({tables:qc,expected:Kc,chipOutcome:Xc,chipBaseline:Zc})}),yt=bt.hcp12,he=["tee","approach","shortGame","putting","penalties"];function Gr(s,e=Fr,t=Br,n=zr,i=Lr,r=[]){const o=s.attHolesPar3Gir+s.attHolesPar3Miss,d=s.attFairwayPar4+s.attInPlayPar4+s.attTroublePar4,c=s.attFairwayPar5+s.attInPlayPar5+s.attTroublePar5,h=o+d+c,u={attributed:h,holesScored:s.holesScored};if(h===0)return{tee:null,approach:null,shortGame:null,putting:null,penalties:null,total:null,coverage:u};const f=d+c,m=s.attSgStrokesEffectiveStandard+s.attSgStrokesEffectiveHard+s.attSgStrokesEffectiveBunker,b=s.attMissStandard+s.attMissHard+s.attMissBunker,g=o*e.eHole[3]+d*e.eHole[4]+c*e.eHole[5],$=s.attFairwayPar4*e.eAfterTee[4].fairway+s.attInPlayPar4*e.eAfterTee[4].in_play+s.attTroublePar4*e.eAfterTee[4].trouble+s.attFairwayPar5*e.eAfterTee[5].fairway+s.attInPlayPar5*e.eAfterTee[5].in_play+s.attTroublePar5*e.eAfterTee[5].trouble+o*e.eHole[3];let R=s.attGirFirstPuttInside1m*t.inside_1m+s.attGirFirstPutt1To2m*t["1_to_2m"]+s.attGirFirstPutt2To4m*t["2_to_4m"]+s.attGirFirstPutt4To8m*t["4_to_8m"]+s.attGirFirstPuttOver8m*t.over_8m;for(const ys of r)R+=ys.holes*(zc(ys.meters)-t[Lc(ys.meters)]);const N=(s.attChipInside2mStandard+s.attChipInside2mHard+s.attChipInside2mBunker)*n.inside2m+(s.attChipOutside2mStandard+s.attChipOutside2mHard+s.attChipOutside2mBunker)*n.outside2m,V=s.attMissStandard*i.standard+s.attMissHard*i.hard+s.attMissBunker*i.bunker,M=s.attMissStandard*(1+i.standard)+s.attMissHard*(1+i.hard)+s.attMissBunker*(1+i.bunker),se=s.attFairwayPar4*(1+e.eAfterTee[4].fairway-e.eHole[4])+s.attInPlayPar4*(1+e.eAfterTee[4].in_play-e.eHole[4])+s.attTroublePar4*(1+e.eAfterTee[4].trouble-e.eHole[4])+s.attFairwayPar5*(1+e.eAfterTee[5].fairway-e.eHole[5])+s.attInPlayPar5*(1+e.eAfterTee[5].in_play-e.eHole[5])+s.attTroublePar5*(1+e.eAfterTee[5].trouble-e.eHole[5]),ce=s.attStrokes-s.attPutts-s.attPenalties-f-m+R+M-$,ue=m-b+N-V,Ma=s.attPutts-(R+N),Ha=s.attPenalties,Aa=s.attStrokes-g;return{tee:se,approach:ce,shortGame:ue,putting:Ma,penalties:Ha,total:Aa,coverage:u}}function Vt(s,e=yt,t=[]){return Gr(s,e.tables,e.expected,e.chipOutcome,e.chipBaseline,t)}const Dr=9;function Pe(s,e){return jr(s,Qe(s,e))}function ei(s){return jr(s,s.total)}function jr(s,e){return e===null||s.coverage.attributed<Dr?null:e*18/s.coverage.attributed}function Qe(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function qr(s,e){const t=n=>ti(Pe(s,n),e.map(i=>Pe(i,n)));return{tee:t("tee"),approach:t("approach"),shortGame:t("shortGame"),putting:t("putting"),penalties:t("penalties"),total:ti(ei(s),e.map(ei))}}function yn(s,e){switch(e){case"tee":return s.tee;case"approach":return s.approach;case"shortGame":return s.shortGame;case"putting":return s.putting;case"penalties":return s.penalties}}function _n(s){let e=0,t=0;for(const n of s)n!==null&&(e+=n,t+=1);return t===0?null:e/t}function ti(s,e){if(s===null)return null;const t=_n(e);return t===null?null:s-t}function eu(s){return s.penalties}const si=1,tu=2,su=.75,nu=4,iu=3,ru=12,au=5,ou=2,lu=10,ni=.35;function du(s,e,t,n){const i=qr(e,t),r=[];let o=0;const d=($,R)=>{r.push({line:$,magnitude:R,order:o++})};let c=null,h=null;for(const $ of he){const R=yn(i,$);R!==null&&((c===null||R<c.delta)&&(c={component:$,delta:R}),(h===null||R>h.delta)&&(h={component:$,delta:R}))}c!==null&&c.delta<=-si&&d({id:"component_best_vs_baseline",params:{component:c.component,delta:c.delta}},Math.abs(c.delta)),h!==null&&h.delta>=si&&d({id:"component_worst_vs_baseline",params:{component:h.component,delta:h.delta}},Math.abs(h.delta));const u=_n(t.map(eu)),f=e.penalties;u!==null&&f!==null&&f>=u+tu&&d({id:"penalties_spike",params:{penalties:f,baseline:u}},0),s.teeMissRecorded>=lu&&s.teeMissLeft>=ni*s.teeMissRecorded&&s.teeMissRight>=ni*s.teeMissRecorded&&d({id:"two_way_miss",params:{left:s.teeMissLeft,right:s.teeMissRight,recorded:s.teeMissRecorded}},0),s.scrambleAttemptsHard>=iu&&s.scrambleSuccessesHard===s.scrambleAttemptsHard&&d({id:"hard_scramble_streak",params:{successes:s.scrambleSuccessesHard,attempts:s.scrambleAttemptsHard}},0);const m=s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker,b=s.scrambleSuccessesStandard+s.scrambleSuccessesHard+s.scrambleSuccessesBunker;m>=nu&&b>=su*m&&d({id:"scramble_streak",params:{successes:b,attempts:m}},0),s.threePutts===0&&s.puttsTotal>=ru&&d({id:"three_putt_free",params:{putts:s.puttsTotal,holes:s.puttsRecorded}},0);const g=Pe(e,"putting"),v=t.map($=>Pe($,"putting")).filter($=>$!==null);return g!==null&&v.length>=au&&v.every($=>g<$)&&d({id:"best_putting_round",params:{putting:g,rounds:v.length}},0),s.bounceBackOpportunities>=ou&&s.bounceBackSuccesses===s.bounceBackOpportunities&&d({id:"bounce_back_perfect",params:{opportunities:s.bounceBackOpportunities,successes:s.bounceBackSuccesses}},0),r.sort(($,R)=>R.magnitude-$.magnitude||$.order-R.order),r.slice(0,Math.max(0,n)).map($=>$.line)}const Vr=["auto",...Fc],Xs="auto";function ht(s){switch(s){case"scratch":return"Scratch";case"hcp5":return"5 handicap";case"hcp12":return"12 handicap";case"hcp20":return"20+ handicap"}}function ii(s){return s==="auto"?"Match my handicap":ht(s)}function cu(s,e){return s!=="auto"?`About ${Gc(bt[s].tables)} shots on a par 72.`:e===null?`No handicap on your profile yet, so this uses the ${ht("hcp12")} reference.`:`Your ${vn(e)} handicap puts you on the ${ht(bn(e))} reference.`}function vn(s){return s<0?`+${(-s).toFixed(1)}`:s.toFixed(1)}function wn(s,e){return s==="auto"?bn(e):s}const uu=Object.freeze({cohort:bn(null),choice:Xs,handicapIndex:null});function hu(s,e){return{cohort:wn(s,e),choice:s,handicapIndex:e}}function pu(s){return Vr.includes(s)}const Ur=Je("tapscore.stats.sgBaseline.v1",{decode:s=>pu(s)?s:Xs,encode:s=>s,empty:Xs});function Qs(s=ee()){return Ur.read(s)}function fu(s,e=ee()){Ur.write(s,e)}const ri=Object.freeze(Object.keys(qt));function mu(s){if(typeof s!="object"||s===null)return[...ri];const e=s;return ri.filter(t=>typeof e[t]!="number")}function Ut(s){if(s.length===0)return null;const e=mu(s[0].measures);if(e.length===0)return null;const t=e.slice(0,3).join(", "),n=e.length>3?` and ${e.length-3} more`:"";return`The server sent stats this app does not understand (missing ${t}${n}).`}const gu=["tee","approach","putting","shortGame","scoring"];function Ps(s){switch(s){case"tee":return"Off the tee";case"approach":return"Approach";case"putting":return"Putting";case"shortGame":return"Short game";case"scoring":return"Scoring"}}const bu=3,Kr={rounds:[],statCaptureRounds:0,totals:qt,waterfall:Gr(qt),priorities:[],trends:[],tee:null,approach:null,putting:null,shortGame:null,scoring:null,results:null};function ls(s){return s.girArrivalMetres??[]}function yu(s){const e=new Map;for(const t of s)for(const n of ls(t))e.set(n.meters,(e.get(n.meters)??0)+n.holes);return[...e.entries()].sort(([t],[n])=>t-n).map(([t,n])=>({meters:t,holes:n}))}function xn(s,e=yt,t=[]){const n=as(s);if(n.length===0)return Kr;const i=Zn(n.map(h=>h.measures)),r=n.map(h=>Vt(h.measures,e,ls(h))),o=n.length,d=n.filter(h=>Gd(h.measures)),c=Zn(d.map(h=>h.measures));return{rounds:n.map((h,u)=>{const f=r[u];return{id:h.roundId,date:h.date,courseName:h.courseName,name:h.name,holeCount:h.holeCount,strokes:h.measures.holesScored===0?null:h.measures.strokesTotal,vsPar:h.measures.holesScored===0?null:h.measures.strokesTotal-h.measures.parTotal,waterfall:f}}),statCaptureRounds:d.length,totals:i,waterfall:Vt(i,e,yu(n)),priorities:_u(r),trends:vu(n,e),tee:wu(i,o),approach:xu(i),putting:ku(i,e,t),shortGame:$u(i),scoring:Su(i,o,c),results:Bc(n)}}function _u(s){const e=he.map(n=>{const i=s.map(r=>Pe(r,n));return{component:n,per18:_n(i),roundsCovered:i.filter(r=>r!==null).length,roundsInWindow:s.length}}),t=n=>he.indexOf(n);return e.sort((n,i)=>n.per18!==null&&i.per18!==null?n.per18===i.per18?t(n.component)-t(i.component):i.per18-n.per18:n.per18!==null?-1:i.per18!==null?1:t(n.component)-t(i.component))}function Cs(s){return Ld(s)==="percentage"?s.value:null}function vu(s,e=yt){const t=[...s].reverse(),n=(i,r,o,d)=>{const c=[];for(const h of t){const u=d(h.measures,ls(h));u!==null&&c.push(u)}return c.length>=bu?{id:i,title:r,kind:o,points:c}:null};return[n("fairway","Fairways","percentage",i=>Cs(Mr(i))),n("gir","Greens","percentage",i=>Cs(Hr(i))),n("putting","Putting","strokesLost",(i,r)=>Pe(Vt(i,e,r),"putting")),n("scramble","Scrambling","percentage",i=>Cs(Ar(i).overall))].filter(i=>i!==null)}function wu(s,e){return s.teeRecorded<=0?null:{fairway:Mr(s),inPlayOnly:x(s.inPlayHits-s.fairwayHits,s.teeRecorded),trouble:Vd(s),troubleTax:Jd(s),vsParByTee:Qd(s),recovery:Yd(s),teeMiss:lc(s),teeMissRecorded:s.teeMissRecorded,teeFan:{leftInPlay:Math.max(0,s.teeMissLeft-s.teeTroubleLeft),leftTrouble:s.teeTroubleLeft,fairway:s.fairwayHits,rightInPlay:Math.max(0,s.teeMissRight-s.teeTroubleRight),rightTrouble:s.teeTroubleRight},teeRecorded:s.teeRecorded,penaltiesPerRound:Xd(s,e),penaltiesRecordedHoles:s.penaltiesRecorded,penaltyHoleShare:Ud(s),penaltyTax:Wd(s),vsParByPenalty:Kd(s),penaltySource:dc(s),penaltySourceRecorded:s.penaltySourceRecorded,penaltiesTee:s.penaltiesTee,penaltiesApproach:s.penaltiesApproach,penaltiesShort:s.penaltiesShort}}function xu(s){if(s.girRecorded<=0)return null;const e={};for(const t of Fe)e[t]=sc(s,t);return{gir:Hr(s),girByTee:Zd(s),girFirstPuttMix:e,proximityOnGir:$c(s),greenAttemptsHit:Tc(s),greenHitLate:s.greenHitLate,birdieConversion:rc(s),hardChipShare:ac(s),girByPar:ec(s),greenMiss:oc(s),greenMissRecorded:s.greenMissRecorded,greenMissCounts:{long:s.greenMissLong,short:s.greenMissShort,left:s.greenMissLeft,right:s.greenMissRight},costOfMissedGreen:tc(s)}}function ku(s,e,t=[]){if(s.puttsRecorded<=0&&s.firstPuttRecorded<=0)return null;const n={};for(const i of Fe)n[i]=ic(s,i);return{ladder:Fe.map(i=>{const r=os(s,i),o=e.expected[i];return{bucket:i,made:cc(s,i),baseline:Math.max(0,2-o),cost:r>0?Dd(s,i)-r*o:null}}),firstPuttSpread:n,threePutt:uc(s),threePuttsFromOver8m:fc(s),puttsPerGirHole:mc(s),puttsAfterMissedGreen:gc(s),puttDistribution:hc(s),puttsPerHoleByPar:pc(s),metersMade:Sc(s),metersMadeHoles:s.metersMadeHoles,onePuttsUnmeasured:s.onePuttsUnmeasured,curve:Ic(t)}}function $u(s){if(s.scrambleAttemptsStandard+s.scrambleAttemptsHard+s.scrambleAttemptsBunker<=0&&s.chipGirHoles<=0)return null;const t=s.onePuttInside1m+s.onePutt1To2m,n=s.firstPuttInside1mResolved+s.firstPutt1To2mResolved;return{scramble:Ar(s),mix:kc(s),outcomes:vc(s),savedInside2m:wc(s),missCost:xc(s),chipInside2m:_c(s),conversionInside2m:x(t,n),chipIns:{standard:s.scrambleHoledStandard,hard:s.scrambleHoledHard,bunker:s.scrambleHoledBunker,overall:s.scrambleHoledStandard+s.scrambleHoledHard+s.scrambleHoledBunker},sandSave:bc(s),scrambleAttemptsBunker:s.scrambleAttemptsBunker,extraShortGameStrokes:yc(s),shortGameStrokesRecorded:s.shortGameStrokesRecorded,chipOnGir:Pc(s),chipOnGirPar5Birdie:Cc(s)}}function Su(s,e,t){return s.holesScored<=0?null:{avgVsParByParGroup:Ec(s),doubleBogeyPlusPerRound:Rc(s,e),doubleCauseGroups:Oc(t),doubleBogeyPlusHoles:t.doubleBogeyPlus,penaltyDoubleSources:{tee:t.dblPenaltyTee,approach:t.dblPenaltyApproach,short:t.dblPenaltyShort,unknown:t.dblPenaltyUnknown},bounceBack:Nc(s)}}function Wr(s){let e=0;for(const t of s)for(const n of he){const i=Qe(t,n);i!==null&&(e=Math.max(e,Math.abs(i)))}return e}function Tu(s){let e=0;for(const t of s)t.per18!==null&&(e=Math.max(e,Math.abs(t.per18)));return e}function kn(s){const e=X.get(Xe);return e.load(),e.labelOf(s.formatId)??`${s.scoringMode} · ${s.teamShape}`}function Pu(s){const e=X.get(Xe);return e.load(),e.labelOf(s)??s}function Cu(s){return s.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.lastActivityAt??e.round.date,holesPlayed:e.holesPlayed,roleLabel:Wo(e)||null,created:e.created,played:e.played,date:e.round.date,formats:e.round.formatSlots.map(kn).join(" · ")}))}function Iu(s){return s.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,holesPlayed:null,roleLabel:null,created:!1,played:!1,date:e.date??null,formats:null}))}function pt(s){const e=(s.name??"").trim();return e||s.courseName||"Round"}function Kt(s){return s.courseName?pt(s)===s.courseName?null:s.courseName:null}function De(s,e=typeof navigator>"u"?"en":navigator.language){return s?/^\d{4}-\d{2}-\d{2}$/.test(s)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${s}T12:00:00Z`)):s:""}const ct={fromMyRounds:Cu,fromDeviceRounds:Iu},Yr="—";function ie(s){return s.d<=0||s.value===null?null:`${Math.round(s.value*100)}%`}function te(s,e=2,t=!1){return s.d<=0||s.value===null?null:t?xe(s.value,e):me(s.value,e)}function Ee(s){return{one:s,many:`${s}s`}}const Se=Ee("round"),Q=Ee("hole"),Is=Ee("green"),Eu=Ee("putt"),Ru={one:"green hit with the metres recorded",many:"greens hit with the metres recorded"},Nu={one:"one-putt hole counted",many:"one-putt holes counted"},Ou={one:"first putt with a distance recorded",many:"first putts with a distance recorded"},Mu={one:"green hit where you chipped and finished the hole",many:"greens hit where you chipped and finished the hole"};function Hu(s,e){return s.d<=0?null:`over ${re(s.d,e)}`}function Au(s,e){const t=te(s,e.decimals??2,e.signed??!1);if(t===null)return null;const n=e.label?`${t} ${e.label}`:t,i=Hu(s,e.unit);return i===null?n:`${n} (${i})`}const Xr={one:"hole from trouble",many:"holes from trouble"},Bu={one:"from the fairway",many:"from the fairway"};function zu(s){const e=s.trouble.d,t=s.fairway.d;return e<=0||t<=0?null:`over ${re(e,Xr)} vs ${re(t,Bu)}`}function Qr(s,e,t,n){return s.d<=0||t.d<=0?null:`over ${re(s.d,e)} vs ${re(t.d,n)}`}const Jr={one:"hole with the green missed",many:"holes with the green missed"},Zr={one:"green hit",many:"greens hit"},Lu={one:"hole with a penalty",many:"holes with a penalty"},Fu={one:"without",many:"without"},Gu=Ee("penalty hole");function Du(s){return Qr(s.miss,Jr,s.hit,Zr)}function ju(s){return Qr(s.penalty,Lu,s.clean,Fu)}function ds(s){const e=s.filter(n=>n.d>0).map(n=>re(n.d,n.unit)),t=e.pop();return t===void 0?null:e.length===0?`over ${t}`:`over ${e.join(", ")} and ${t}`}const qu={one:"hole from the fairway",many:"holes from the fairway"},Vu={one:"hole in play",many:"holes in play"},Uu=Ee("par 3"),Ku=Ee("par 4"),Wu=Ee("par 5");function Yu(s){return ds([{d:s.fairway.d,unit:qu},{d:s.inPlay.d,unit:Vu},{d:s.trouble.d,unit:Xr}])}function ai(s){return ds([{d:s.par3.d,unit:Uu},{d:s.par4.d,unit:Ku},{d:s.par5.d,unit:Wu}])}function Xu(s){return ds([{d:s.hit.d,unit:Zr},{d:s.miss.d,unit:Jr}])}const Qu={one:"off the tee",many:"off the tee"},Ju={one:"on the approach",many:"on the approach"},Zu={one:"around the green",many:"around the green"},eh={one:"with no source recorded",many:"with no source recorded"};function th(s){const e=[{d:s.tee,unit:Qu},{d:s.approach,unit:Ju},{d:s.short,unit:Zu},{d:s.unknown,unit:eh}].filter(n=>n.d>0).map(n=>re(n.d,n.unit)),t=e.pop();return t===void 0?null:e.length===0?t:`${e.join(", ")} and ${t}`}function de(s){return s===Math.round(s)?String(Math.round(s)):me(s,1)}function re(s,e){return`${de(s)} ${s===1?e.one:e.many}`}function me(s,e=1){return s.toFixed(e)}function xe(s,e=1){const t=10**e,n=Math.round(s*t)/t;if(n===0)return me(0,e);const i=me(Math.abs(n),e);return n>0?`+${i}`:`−${i}`}function sh(s){return s===null?Yr:xe(s,1)}function cs(s){return s===0?"E":xe(s,s===Math.round(s)?0:1)}function us(s){switch(s){case"tee":return"Tee";case"approach":return"Approach";case"shortGame":return"Short game";case"putting":return"Putting";case"penalties":return"Penalties"}}const oi=Ys.reduce((s,e)=>Math.max(s,e.meters),0);function nh(s){return s>=oi?`${oi} m+`:`${me(s,Number.isInteger(s)?0:1)} m`}function ih(s,e=1){const t=te(s,e);return t===null?null:`${t} m`}function rh(s){return`${de(s)} m`}function Es(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m"}}function ah(s){return s==="indoor"?"Indoor":"Outdoor"}function oh(s){switch(s){case"full_18":return"18 holes";case"front_9":return"Front 9";case"back_9":return"Back 9";case"custom_holes":return"Custom holes"}}function ea(s){return De(s)}const ta="Statistics",lh="All statistics →";function dh(s){return s==="custom"?jt:s}function ch(s,e,t){return gn(s)!==null||!t?Dt(s):`${Dt(s)} — newest ${e}`}function uh(s){return x(s.strokesTotal-s.parTotal,s.holesScored)}function hh(s){const e=[],t=uh(s.totals),n=te(t,2,!0);n!==null&&e.push({id:"vsPar",value:n,label:"Vs par per hole"});const i=s.tee,r=i===null?null:ie(i.fairway);r!==null&&e.push({id:"fairways",value:r,label:"Fairways hit"});const o=s.approach,d=o===null?null:ie(o.gir);return d!==null&&e.push({id:"gir",value:d,label:"Greens in regulation"}),e}function ph(s){const e=s.priorities.find(t=>t.per18!==null);return!e||e.per18===null||e.per18<=0?null:`Costing you most: ${us(e.component)}`}function fh(s){const e=dh(s.preset),t=Rr(e,dt,s.rows,s.now);if(t.length===0)return null;const n=xn(t,s.bundle??yt),i=hh(n);if(i.length===0)return null;const r=Nr({preset:e,filter:dt,loaded:s.rows,hasMore:s.hasMore,now:s.now});return{windowLabel:ch(e,t.length,r),tiles:i,priorityLine:ph(n)}}function mh(s){const e=s.tiles.map(n=>`${n.label} ${n.value}`),t=[`${ta}, ${s.windowLabel}`,...e];return s.priorityLine!==null&&t.push(s.priorityLine),t.push("Opens your statistics"),t.join(". ")}class hs{static PAGE_SIZE=20;rows=new p(null);hasMore=new p(!1);preset=new p(Ws());sgChoice=new p(Qs());profile=X.get(Ie);loaded=!1;loading=!1;card=new T(()=>{const e=this.rows.get();if(e===null)return null;const t=wn(this.sgChoice.get(),this.profile.player.get()?.handicapIndex??null);return fh({rows:e,preset:this.preset.get(),hasMore:this.hasMore.get(),now:new Date,bundle:bt[t]})});refreshPreset(){this.preset.set(Ws()),this.sgChoice.set(Qs())}async load(e=!1){if(!(!e&&(this.loaded||this.loading))){this.loading=!0;try{const t=await w.playerStats.myStats({limit:hs.PAGE_SIZE});if(Ut(t.rounds)!==null)return;this.rows.set(t.rounds),this.hasMore.set(t.nextCursor!==null),this.loaded=!0}catch(t){t instanceof Z&&t.status===401&&(this.rows.set(null),this.hasMore.set(!1),this.loaded=!0)}finally{this.loading=!1}}}clear(){this.rows.set(null),this.hasMore.set(!1),this.loaded=!1,this.loading=!1}}const Rn=class Rn extends A{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(C(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};Rn.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let Js=Rn;const z=s=>`var(--${s})`;let gh=0;const Nn=class Nn extends A{constructor(){super(...arguments),this.returnFocusTo=null,this.wasOpen=!1}render(){const e=document.createElement("div"),t=(h,u)=>{typeof u=="function"?this.track(C(()=>{h.textContent=u()})):h.textContent=u};this.spawn(Js,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200",this.dialogEl.setAttribute("role","dialog"),this.dialogEl.setAttribute("aria-modal","true"),this.dialogEl.setAttribute("tabindex","-1");const n=`ui-confirm-${++gh}`,i=document.createElement("h2");i.className="ui-confirm__title",i.id=`${n}-title`,t(i,this.props.title??"Confirm"),this.dialogEl.setAttribute("aria-labelledby",i.id),this.dialogEl.appendChild(i);const r=document.createElement("p");r.className="ui-confirm__message",r.id=`${n}-message`,t(r,this.props.message),this.dialogEl.setAttribute("aria-describedby",r.id),this.dialogEl.appendChild(r);const o=document.createElement("div");o.className="ui-confirm__actions";const d=document.createElement("button");d.className="ui-confirm__btn ui-confirm__btn--cancel",t(d,this.props.cancelLabel??"Cancel"),d.addEventListener("click",h=>{h.stopPropagation(),this.handleCancel()}),o.appendChild(d),this.cancelEl=d;const c=document.createElement("button");return c.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(c,this.props.confirmLabel??"Confirm"),c.addEventListener("click",h=>{h.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),o.appendChild(c),this.confirmEl=c,this.dialogEl.appendChild(o),this.dialogEl.addEventListener("click",h=>h.stopPropagation()),this.dialogEl.addEventListener("keydown",h=>this.onKeydown(h)),e.appendChild(this.dialogEl),this.track(C(()=>{const h=this.props.open.get();h&&this.dialogEl.removeAttribute("inert"),this.dialogEl.classList.toggle("open",h),h||this.dialogEl.setAttribute("inert",""),h!==this.wasOpen&&(this.wasOpen=h,h?this.captureFocus():this.restoreFocus())})),e}onMount(){this.props.open.get()&&!this.dialogEl.contains(document.activeElement)&&this.captureFocus()}captureFocus(){const e=document.activeElement;this.returnFocusTo=e instanceof HTMLElement?e:null,this.cancelEl.focus()}restoreFocus(){const e=this.returnFocusTo;this.returnFocusTo=null,e&&e.isConnected&&e.focus()}onKeydown(e){if(!this.props.open.get())return;if(e.key==="Escape"){e.preventDefault(),e.stopPropagation(),this.handleCancel();return}if(e.key!=="Tab")return;const t=this.cancelEl,n=this.confirmEl,i=document.activeElement;e.shiftKey&&(i===t||i===this.dialogEl)?(e.preventDefault(),n.focus()):!e.shiftKey&&i===n&&(e.preventDefault(),t.focus())}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}onDestroy(){this.wasOpen&&this.restoreFocus()}};Nn.styles=`
        .ui-confirm {
            position: fixed;
            top: 50%;
            left: 50%;
        ...
        .ui-confirm__btn {
            ...
            align-items: center;
            justify-content: center;
            min-height: ${So("confirm-btn-min-height")};
            padding: 9px 20px;
            font-size: 13px;
            line-height: 20px;
            font-family: ${z("font-ui")};
    ...
    `;let oe=Nn;async function bh(s,e={}){e.everywhere?await s.auth.logoutEverywhere():await s.auth.logout(),s.profile.clear(),s.friends.clear(),s.activity.clear(),s.friendProfile.clear(),s.spectate.clear(),s.admins.clear(),s.homeStats.clear(),s.landing.clear(),s.navigate("/")}const yh="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==";function Re(s="avatar"){return`<span class="${s}">
            <img bind="avatarPhoto" class="avatar__photo" alt="" />
            <span bind="avatarInitials" class="avatar__initials"></span>
        </span>`}function Te(s){const e=()=>wl(s());return{avatarPhoto:{src:()=>e()??yh,className:()=>e()?"avatar__photo":"avatar__photo hidden"},avatarInitials:{textContent:()=>{const t=s();return xl(t.displayName,t.username)},className:()=>e()?"avatar__initials hidden":"avatar__initials"}}}function Ge(s,e="0.85rem"){return`
        position: relative;
    ...
    `}const _h="/tapscore/";function vh(s=_h){const e=s.trim().replace(/\/+$/,"");return`${e===""?"":e}/manage/`}function wh(s){if(!s.signedIn)return[];const e=[{kind:"identity",displayName:(s.displayName??"").trim()||(s.username??"").trim()||"Signed in",username:(s.username??"").trim()},{kind:"profile",label:"Profile"}];return s.canManageCourses&&e.push({kind:"course-setup",label:"Course setup"}),s.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e.push({kind:"signout-all",label:"Sign out everywhere"}),e}function xh(s){return wh(s).map(e=>e.kind)}function li(s){return s.signedIn?"avatar":"signin"}const kh=y(`
...
`);class $h extends A{static styles=`
        .acct {
            position: relative;
            display: flex;
            justify-content: flex-end;
...
`),Nh='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',$n=`
...
`,Oh=y(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${$n}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Nh}</button>
...
`),Ah=y(`
    <button bind="row" type="button" class="round-summary recent-row">
        ${Re("recent-row__avatar")}
        <span class="recent-row__content">${$n}</span>
    </button>
`);class ci extends A{static styles=`
        .landing {
...
`),Lh='<svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true"><circle cx="5" cy="12" r="1.6"/><circle cx="12" cy="12" r="1.6"/><circle cx="19" cy="12" r="1.6"/></svg>',Fh=y(`
    <div class="round-row">
        <button bind="row" type="button" class="round-summary round-row__main">${$n}</button>
        <div bind="actions" class="round-row__actions">
            <button bind="menuButton" type="button" class="round-row__menu-button" aria-label="Round actions" aria-haspopup="true" aria-expanded="false">${Lh}</button>
            <div bind="menu" class="round-row__menu" role="group" aria-label="Round actions">
                <button bind="action" type="button" class="round-row__menu-action"></button>
            </div>
        </div>
...
`),ps='<button bind="infoTrigger" class="stats__info" type="button"></button>',fs=`
...
`;function ra(s,e,t=""){const n=t?`info-dot ${t}`:"info-dot";return`<button bind="${s}" class="${n}" type="button" aria-label="${e}"><span aria-hidden="true">i</span></button>`}const aa=`
        .info-dot {
            flex: none;
            appearance: none;
            ...
            &:hover { color: ${l("text")}; }
            &.hidden { display: none; }
        }`,Oe=60,hi=8,Zs=4,Wh=Array.from({length:Zs*2+1},(s,e)=>e-Zs),Yh="transform 320ms cubic-bezier(0.22, 1, 0.36, 1)",Xh=y(`
    ...
    <div class="se-row">
        <div class="se-row__who">
            ...
            <span class="se-row__hcpline">
                ...
                ${ra("hcpInfo","How this handicap was calculated","hidden")}
            </span>
        </div>
...
`),np=y('<button bind="btn" class="se-seg" type="button"></button>'),ip=y(`
...
`),rp=y('<div bind="rule" class="se-stats__rule"></div>'),Os=["short_game_difficulty","short_game_strokes"],ap={first_putt_m:{aria:"First putt, exact distance",title:"Exact distance"}};function op(s){const e=s.control;return e.kind!=="segments"?`stat:${s.key}`:`stat:${s.key}|${e.options.map(t=>t.value).join(",")}`}function gi(s,e){return ap[s]??{aria:e,title:e}}class lp extends A{static styles=`
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${hi}px; flex-shrink: 0; }
            & .se-row__slot { width: ${Oe}px; display: flex; align-items: center; justify-content: center; }
            & .se-row__prev {
        ...
        ${aa}
    `;svc=this.inject(be);holeIdx=this.svc.holeIdx;modalOpen=this.svc.keypadOpen;currentBallIdx=new p(0);holeCompleteOnEntry=!1;extendedOpen=new p(!1);extendedScore=new p(10);statsOpen=new p(!1);explainOpen=new p(!1);shortGameOpen=new p(!1);shortGameVisit=null;statsBodyEl=null;pendingMeta=new p({});lastMetaKey=null;toastMsg=new p(null);hcpInfoBallId=new p(null);dragOffset=new p(0);transitioning=new p(!1);ptr=null;pendingSteps=null;settleTimer=null;advanceTimer=null;flashTimer=null;hasScoring=new T(()=>this.svc.balls.get().length>0);group=()=>this.svc.group();playedOrder=()=>this.svc.playedOrder();holeIndex=()=>this.svc.holeIndex();currentHole=()=>this.svc.currentPlayedHole();occAtOffset=e=>{const t=this.playedOrder();return t[Ue(this.holeIndex()+e,t.length)]??null};ballsInGroup=()=>{const e=this.group();if(!e)return[];const t=new Map(this.svc.balls.get().map(n=>[n.id,n]));return e.ballIds.map(n=>t.get(n)).filter(n=>!!n)};parFor=e=>this.svc.parFor(e);occLabel=e=>this.svc.occLabel(e);ballName=e=>mn(e);metaInputs=()=>this.svc.metadataInputsForHole(this.svc.currentPlayHole());displayScore=e=>e===null?"–":String(e);hintText=(e,t)=>{const n=this.svc.strokesHintFor(e,t);return n===null?null:n===0?"0":n>0?`-${n}`:`+${-n}`};toParValue=e=>{let t=0,n=0,i=!1;for(const r of this.playedOrder()){const o=this.svc.strokesFor(e.id,r.playHoleId);o!==null&&o>0&&(t+=o,n+=this.parFor(r.playHoleId),i=!0)}return i?t-n:null};hcpLine=e=>{const t=this.ballsInGroup().find(o=>o.id===e);if(!t||t.pending)return null;const n=t.players.length>1?t.courseHandicap:t.players[0]?.courseHandicap??t.courseHandicap;if(n===null)return null;const i=t.players.length>1?`Team · HCP ${n}`:`HCP ${n}`,r=this.svc.effectivePlayingHandicap(t);return r!==null&&r!==n?`${i} → ${r}`:i};rowDerivation=e=>{const t=this.ballsInGroup().find(n=>n.id===e);return!t||t.pending?null:this.svc.presentedSlot(t)?.handicapDerivation??null};selectedFormatLabel=()=>{const e=this.svc.round.get()?.formatSlots.find(t=>t.slotDefId===this.svc.selectedSlotDefId());return e?kn(e):null};hcpCards=e=>{const t=this.selectedFormatLabel(),n=[];for(const i of e.steps)switch(i.kind){case"course_handicap":{const r=i.handicapIndex!==null&&i.slope!==null&&i.courseRating!==null&&i.par!==null,o=i.teeName?`the ${i.teeName} tees`:"these tees";n.push({title:`Course handicap · ${i.producerLabel}`,text:r?`Exact handicap ${i.handicapIndex}, adjusted for the difficulty of ${o}.`:`The handicap ${i.producerLabel} plays this course off.`,math:r?`${i.handicapIndex} × ${i.slope} ÷ 113 + (${i.courseRating} − ${i.par}), rounded — the World Handicap System formula.`:null,result:i.result});break}case"team_combination":n.push({title:"Team handicap",text:"The team plays off a share of each member's handicap.",math:`${i.parts.map(r=>`${r.pct}% of ${r.producerLabel}'s ${r.ch}`).join(" + ")}, rounded.`,result:i.result});break;case"allowance":i.pct!==100&&n.push({title:"Allowance",text:`${t??"This format"} is played at ${i.pct}% handicap.`,math:null,result:i.result});break;case"match_delta":n.push(i.ownPh===i.lowestPh?{title:"Match difference",text:"Lowest handicap in the match — plays off scratch, and the others get the difference.",math:null,result:i.result}:{title:"Match difference",text:"In match formats only the difference matters: the lowest ball plays off 0, this ball gets the rest.",math:`${i.ownPh} − ${i.lowestPh} = ${i.result}.`,result:i.result});break}return n};figureText=e=>{const t=this.svc.slotStandingFor(e);if(t===null){const n=this.toParValue(e);return n===null?"–":n===0?"E":n>0?`+${n}`:`${n}`}switch(t.kind){case"pace":{const n=t.delta;return n===0?"E":n>0?`+${n}`:`${n}`}case"total":return String(t.total);case"match":return t.text}};figureClass=e=>{const t=this.svc.slotStandingFor(e);let n,i=!1;if(t===null){const r=this.toParValue(e);n=r===null||r===0?"even":r<0?"under":"over"}else t.kind==="pace"?n=t.delta===0?"even":t.delta<0?"under":"over":t.kind==="total"?n="even":(n=t.tone,i=!0);return`se-row__topar ${n}${i?" se-row__topar--match":""}`};scoreLabel=(e,t)=>{if(e===1)return"HIO";const n=e-t;return n<=-4||n>=5?"OTHER":{"-3":"ALBA","-2":"EAGLE","-1":"BIRDIE",0:"PAR",1:"BOGEY",2:"DOUBLE",3:"TRIPLE",4:"QUAD"}[String(n)]??""};render(){this.track(()=>{this.advanceTimer&&clearTimeout(this.advanceTimer),this.flashTimer&&clearTimeout(this.flashTimer),this.settleTimer&&clearTimeout(this.settleTimer),this.modalOpen.set(!1)}),this.track(C(()=>{const u=this.ballsInGroup().length;u>0&&this.currentBallIdx.get()>=u&&this.selectBall(0)}));const e=this.wire(Xh,{root:{className:()=>this.hasScoring.get()?"se":"se hidden"},close:{onclick:()=>{this.statsOpen.set(!1),this.modalOpen.set(!1),this.svc.closeStatStep()}},modal:{className:()=>this.modalOpen.get()?"se-modal":"se-modal hidden"},modalTitle:()=>{const u=this.currentHole();return u?`Hole ${this.occLabel(u.playHoleId)} · Par ${this.parFor(u.playHoleId)}`:""},modalPrev:{onclick:()=>this.stepHole(-1),disabled:()=>!this.svc.canPrevHole()},modalNext:{onclick:()=>this.stepHole(1),disabled:()=>!this.svc.canNextHole()},extended:{className:()=>this.extendedOpen.get()?"se-pad__ext":"se-pad__ext hidden"},extVal:()=>String(this.extendedScore.get()),extMinus:{onclick:()=>this.extendedScore.set(Math.max(10,this.extendedScore.get()-1))},extPlus:{onclick:()=>this.extendedScore.set(this.extendedScore.get()+1)},extCancel:{onclick:()=>this.extendedOpen.set(!1)},extOk:{onclick:()=>{this.extendedOpen.set(!1),this.commit(this.extendedScore.get())}},toast:{className:()=>this.toastMsg.get()?"se-toast":"se-toast hidden",textContent:()=>this.toastMsg.get()??""},hcpModal:{className:()=>this.hcpInfoBallId.get()!==null?"se-hcp":"se-hcp hidden",onclick:u=>{u.target===u.currentTarget&&this.hcpInfoBallId.set(null)}},hcpClose:{onclick:()=>this.hcpInfoBallId.set(null)},hcpTitle:()=>{const u=this.hcpInfoBallId.get(),f=u?this.ballsInGroup().find(m=>m.id===u):null;return f?this.ballName(f):""},hcpFormat:()=>this.selectedFormatLabel()??"",hcpEff:()=>{const u=this.hcpInfoBallId.get(),f=u?this.rowDerivation(u):null;return f?String(f.effectivePh):""},stats:{className:()=>this.statsOpen.get()?"se-stats":"se-stats hidden"},statsBack:{onclick:()=>{this.statsOpen.set(!1),this.explainOpen.set(!1),this.svc.closeStatStep()}},statExplain:{textContent:qe.explainerTrigger,onclick:()=>this.explainOpen.set(!0)},infoSheet:{className:()=>this.explainOpen.get()?"stats-info":"stats-info hidden",onclick:u=>{u.target===u.currentTarget&&this.explainOpen.set(!1)}},infoTitle:{textContent:qe.explainerTitle},infoDone:{onclick:()=>this.explainOpen.set(!1)},statsHole:()=>{const u=this.currentHole();return u?`Hole ${this.occLabel(u.playHoleId)} · Par ${this.parFor(u.playHoleId)}`:""},statsTitle:()=>{const u=this.ballsInGroup()[this.currentBallIdx.get()];return u?this.ballName(u):""},statsScore:()=>{const u=this.ballsInGroup()[this.currentBallIdx.get()],f=this.currentHole();return!u||!f?"":this.displayScore(this.svc.strokesFor(u.id,f.playHoleId))},statsNext:{textContent:()=>this.hasMoreUnscored()?"Next ›":"Done ›",onclick:()=>{this.statsOpen.set(!1),this.explainOpen.set(!1),this.svc.closeStatStep(),this.apply({kind:"statsDone"})}}}),t=this.ref(e,"viewport"),n=this.ref(e,"track");this.bindCarouselPointer(t,n),this.track(C(()=>{n.style.transition=this.transitioning.get()?Yh:"none",n.style.transform=`translateX(${this.dragOffset.get()}px)`})),this.$each(n,new T(()=>Wh),(u,f,m)=>this.holeItem(u,m),u=>u),this.$each(this.ref(e,"rows"),new T(()=>{const u=this.playedOrder(),f=this.holeIndex(),m=u[f];if(!m)return[];const b=f>0?u[f-1].playHoleId:null;return this.ballsInGroup().map(g=>({ball:g,ph:m.playHoleId,prevPh:b}))}),(u,f,m)=>this.playerRow(u.ball,u.ph,u.prevPh,m),u=>`${u.ball.id}|${u.ph}|${u.ball.pending}`),this.$each(this.ref(e,"hcpSteps"),new T(()=>{const u=this.hcpInfoBallId.get(),f=u?this.rowDerivation(u):null;return f?this.hcpCards(f):[]}),(u,f,m)=>this.wireEl(Zh,{ctitle:{textContent:u.title},ctext:{textContent:u.text},cmath:{textContent:u.math??"",hidden:u.math===null},cresult:{textContent:String(u.result)}},m),(u,f)=>`${f}|${u.title}|${u.result}`),this.$each(this.ref(e,"modalList"),new T(()=>this.ballsInGroup()),(u,f,m)=>this.modalRow(u,f,m),u=>u.id);const i=this.ref(e,"keys");for(const u of[1,2,3,4,5,6,7,8,9])i.appendChild(this.numberKey(u));i.appendChild(this.specialKey("10+","","se-key",()=>this.openExtended())),i.appendChild(this.specialKey("✕","clear","se-key clear",()=>this.commit(null))),i.appendChild(this.specialKey("0","pick up","se-key muted",()=>this.commit(0)));const r=this.ref(e,"statsBody");this.statsBodyEl=r,this.$each(r,new T(()=>this.statBodyRows()),(u,f,m)=>this.statBodyRow(u,m),u=>u.key),this.track(C(()=>{this.statsOpen.get()&&(r.scrollTop=0)})),this.$each(this.ref(e,"infoCards"),new T(()=>this.statExplainerCards()),(u,f,m)=>this.wireEl(vt,{ctitle:{textContent:u.title},ctext:{textContent:u.text}},m),u=>u.key),this.track(C(()=>{if(!this.modalOpen.get()){this.lastMetaKey=null,this.svc.seedStatStep(null),this.newShortGameVisit(null);return}const u=this.ballsInGroup()[this.currentBallIdx.get()],f=this.currentHole();if(!u||!f)return;this.seedStatStepForCursor();const m=`${u.id}|${f.playHoleId}`;if(m===this.lastMetaKey)return;this.lastMetaKey=m;const b={};for(const g of this.metaInputs()){const v=this.svc.metadataFor(u.id,f.playHoleId,g.key);g.kind==="number"?typeof v=="number"&&(b[g.key]=v):b[g.key]=v===!0}this.pendingMeta.set(b)}));const o=()=>{document.visibilityState==="hidden"&&this.svc.flushStats()},d=()=>this.svc.flushStats();document.addEventListener("visibilitychange",o),window.addEventListener("pagehide",d),this.track(()=>{document.removeEventListener("visibilitychange",o),window.removeEventListener("pagehide",d),this.svc.closeStatStep()});let c=0;return e.firstElementChild.addEventListener("touchend",u=>{const f=u.target instanceof Element?u.target:null;if(!u.cancelable||u.touches.length>0||u.changedTouches.length!==1||!f||f.closest(".se__carousel")||f.closest("input, textarea, select"))return;const m=performance.now(),b=m-c<350;if(c=m,!b)return;u.preventDefault(),(f.closest('button, a, [role="button"]')??f).dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window}))},{passive:!1}),e}holeItem(e,t){return this.wireEl(Qh,{item:{className:()=>{const n=e===-1&&this.holeIndex()<=0;return`se-hole${e===0?" active":""}${n?" gone":""}`}},hnum:{textContent:()=>{const n=this.occAtOffset(e);return n?this.occLabel(n.playHoleId):""}},hpar:{textContent:()=>{const n=this.occAtOffset(e);return n?`Par ${this.parFor(n.playHoleId)}`:""}}},t)}playerRow(e,t,n,i){return e.pending?this.wireEl(pi,{name:{textContent:this.ballName(e),className:"se-row__name se-row__name--pending"},hcp:{textContent:"open seat"},topar:{textContent:"",className:"se-row__topar"},prev:{textContent:""},cval:{textContent:"–"},circle:{className:"se-row__circle empty se-row__circle--pending"}},i):this.wireEl(pi,{name:{textContent:this.ballName(e)},hcp:{textContent:()=>this.hcpLine(e.id)??"",hidden:()=>this.hcpLine(e.id)===null},hcpInfo:{className:()=>this.rowDerivation(e.id)!==null?"info-dot":"info-dot hidden",onclick:()=>this.hcpInfoBallId.set(e.id)},topar:{textContent:()=>this.figureText(e),className:()=>this.figureClass(e)},prev:{textContent:()=>n?this.displayScore(this.svc.strokesFor(e.id,n)):""},cval:{textContent:()=>{const r=this.svc.strokesFor(e.id,t);return r!==null?this.displayScore(r):this.hintText(e.id,t)??"–"}},circle:{className:()=>this.svc.strokesFor(e.id,t)!==null?"se-row__circle":this.hintText(e.id,t)!==null?"se-row__circle empty hint":"se-row__circle empty",onclick:()=>this.openModalForBall(e.id)}},i)}modalRow(e,t,n){const i=()=>{if(e.pending)return"Open seat — claim to score";const r=e.players.length>1?e.courseHandicap:e.players[0]?.courseHandicap??e.courseHandicap,o=r===null?"–":String(r),d=e.players.length>1?`Team · HCP ${o}`:`HCP ${o}`,c=this.svc.effectivePlayingHandicap(e);return r!==null&&c!==null&&c!==r?`${d} → ${c}`:d};return this.wireEl(Jh,{mrow:{className:()=>this.currentBallIdx.get()===t?"se-mrow sel":"se-mrow",onclick:()=>this.selectBall(t)},mname:{textContent:this.ballName(e)},mhcp:{textContent:i},mval:{textContent:()=>{const r=this.currentHole();if(!r)return"–";const o=this.svc.strokesFor(e.id,r.playHoleId);return o!==null?this.displayScore(o):this.hintText(e.id,r.playHoleId)??"–"},className:()=>{const r=this.currentHole();return!!r&&this.svc.strokesFor(e.id,r.playHoleId)===null&&!!r&&this.hintText(e.id,r.playHoleId)!==null?"se-mrow__val se-mrow__val--hint":"se-mrow__val"}}},n)}numberKey(e){return this.wireEl(fi,{key:{className:()=>{const t=this.currentHole();return(t?e===this.parFor(t.playHoleId):!1)?"se-key par":"se-key"},onclick:()=>this.commit(e)},num:{textContent:String(e)},lbl:{textContent:()=>{const t=this.currentHole();return t?this.scoreLabel(e,this.parFor(t.playHoleId)):""}}})}specialKey(e,t,n,i){return this.wireEl(fi,{key:{className:n,onclick:i},num:{textContent:e},lbl:{textContent:t}})}openModalForBall(e){const t=this.ballsInGroup().findIndex(n=>n.id===e);this.selectBall(t<0?0:t),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.noteHoleEntered(),this.modalOpen.set(!0)}selectBall(e){this.currentBallIdx.set(e),this.seedStatStepForCursor()}seedStatStepForCursor(){const e=this.ballsInGroup()[this.currentBallIdx.get()],t=this.currentHole(),n=e?this.svc.statSubject(e):null,i=n&&t?{playerId:n,playHoleId:t.playHoleId}:null;this.svc.seedStatStep(i),this.newShortGameVisit(e&&t?`${e.id}|${t.playHoleId}`:null)}advanceState(){const e=this.currentHole();return{balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId,label:this.occLabel(e.playHoleId)}:null,holeIndex:this.holeIndex(),holeCount:this.playedOrder().length,holeCompleteOnEntry:this.holeCompleteOnEntry,collectsStats:this.metaInputs().length>0||this.svc.statPrompts().length>0}}noteHoleEntered(){this.holeCompleteOnEntry=jh(this.advanceState())}stepHole(e){this.advanceTimer&&(clearTimeout(this.advanceTimer),this.advanceTimer=null),this.extendedOpen.set(!1),this.statsOpen.set(!1),this.svc.closeStatStep(),e<0?this.svc.prevHole():this.svc.nextHole(),this.selectBall(0),this.noteHoleEntered()}openExtended(){this.extendedScore.set(10),this.extendedOpen.set(!0)}commit(e){this.apply({kind:"score",value:e})}apply(e){this.execute(Vh(this.advanceState(),e))}execute(e){const t=e.write;if(t){const i=this.ballsInGroup()[t.ballIndex];i&&this.svc.setScore(i.id,t.holeId,t.value,t.withMetadata?this.metaSnapshot():void 0)}const n=e.move;switch(n.kind){case"noop":case"stay":return;case"moveToBall":this.selectBall(n.ballIndex);return;case"openStats":this.statsOpen.set(!0);return;case"roundComplete":this.modalOpen.set(!1),this.svc.finishFlowOpen.set(!0);return;case"holeComplete":{this.flash(n.toast),this.advanceTimer&&clearTimeout(this.advanceTimer),this.advanceTimer=setTimeout(()=>{this.advanceTimer=null,this.currentHole()?.playHoleId===n.fromHoleId&&(this.holeIdx.set(Ue(n.toHoleIndex,this.playedOrder().length)),this.selectBall(0),this.noteHoleEntered(),this.modalOpen.set(!1))},n.delayMs);return}}}hasMoreUnscored=()=>{const e=this.currentHole();return qh({balls:this.ballsInGroup().map(t=>({pending:!!t.pending,scored:!!e&&this.svc.strokesFor(t.id,e.playHoleId)!==null})),currentBallIndex:this.currentBallIdx.get(),currentHole:e?{id:e.playHoleId}:null})};metaSnapshot(){const e=this.metaInputs();if(e.length===0)return;const t=this.pendingMeta.get(),n={};for(const i of e)if(i.kind==="number"){const r=t[i.key];n[i.key]=typeof r=="number"?r:null}else n[i.key]=t[i.key]===!0;return n}setMeta(e,t){const n=this.pendingMeta.get();this.pendingMeta.set({...n,[e]:t});const i=this.ballsInGroup()[this.currentBallIdx.get()],r=this.currentHole();if(!i||!r)return;const o=this.svc.strokesFor(i.id,r.playHoleId);o!==null&&this.svc.setScore(i.id,r.playHoleId,o,this.metaSnapshot())}metaChip(e,t){return e.kind==="number"?this.metaStepper(e,t):this.wireEl(ep,{glabel:{textContent:e.label},miss:{className:()=>this.pendingMeta.get()[e.key]?"se-seg":"se-seg on-miss","aria-pressed":()=>String(!this.pendingMeta.get()[e.key]),onclick:()=>this.setMeta(e.key,!1)},hit:{className:()=>this.pendingMeta.get()[e.key]?"se-seg on-hit":"se-seg","aria-pressed":()=>String(!!this.pendingMeta.get()[e.key]),onclick:()=>this.setMeta(e.key,!0)}},t)}metaStepper(e,t){const n=e.min??0,i=e.max??null,r=()=>{const d=this.pendingMeta.get()[e.key];return typeof d=="number"?d:null},o=d=>{const c=Math.min(i??1/0,Math.max(n,(r()??n)+d));this.setMeta(e.key,c)};return this.wireEl(mi,{glabel:{textContent:e.label},minus:{onclick:()=>o(-1),"aria-label":`Fewer ${e.label}`},plus:{onclick:()=>o(1),"aria-label":`More ${e.label}`},val:{textContent:()=>Wn(r()??n,i),className:()=>r()===null?"se-stats__step-val unanswered":"se-stats__step-val","aria-label":()=>r()===null?`${e.label} not answered`:`${e.label} ${r()}`}},t)}metaInputsForStep=()=>{const e=new Set(this.svc.statPrompts().map(t=>t.key));return this.metaInputs().filter(t=>!e.has(t.key))};newShortGameVisit(e){e!==this.shortGameVisit&&(this.shortGameVisit=e,this.shortGameOpen.set(e!==null&&J(()=>this.svc.statShortGameDisclosure())==="expanded"))}keepShortGameUnfolded(e){if(Os.includes(e)){this.shortGameOpen.set(!0);return}this.svc.statShortGameDisclosure()==="expanded"&&this.shortGameOpen.set(!0)}shortGameFolded=()=>this.svc.statShortGameDisclosure()==="collapsed"&&!this.shortGameOpen.get();shownStatPrompts=()=>{const e=this.svc.statPrompts();if(!this.shortGameFolded())return{prompts:e,foldAt:-1};const t=[];let n=-1;for(const i of e){if(Os.includes(i.key)){n===-1&&(n=t.length);continue}t.push(i)}return{prompts:t,foldAt:n}};statBodyRows=()=>{const e=this.metaInputsForStep(),{prompts:t,foldAt:n}=this.shownStatPrompts(),i=e.map(r=>({kind:"meta",key:`meta:${r.key}`,input:r}));e.length>0&&(t.length>0||n!==-1)&&i.push({kind:"rule",key:"rule"});for(let r=0;r<=t.length;r++){r===n&&i.push({kind:"disclose",key:"disclose:short-game"});const o=t[r];o&&i.push({kind:"stat",key:op(o),prompt:o})}return i};statBodyRow(e,t){if(e.kind==="meta")return this.metaChip(e.input,t);if(e.kind==="rule")return this.wireEl(rp,{},t);if(e.kind==="disclose")return this.wireEl(ip,{disclose:{onclick:()=>{this.shortGameOpen.set(!0),this.focusRevealedShortGame()}}},t);const n=e.prompt.control.kind==="segments"?this.statSegments(e.prompt,t):this.statStepper(e.prompt,t);return n.dataset.stat=e.prompt.key,n}focusRevealedShortGame(){this.statsBodyEl?.querySelector(`[data-stat="${Os[0]}"] .se-seg`)?.focus?.()}statSegments(e,t){const n=e.control,i=n.kind==="segments"?n.options:[],r=i.reduce((u,f)=>Math.max(u,f.label.length),0),o=i.length>=5&&r>6?" tight tighter":i.length>=4?" tight":"",d=gi(e.key,e.label),c=e.label===""?this.wireEl(sp,{seg:{role:"group","aria-label":d.aria}},t):this.wireEl(tp,{glabel:{textContent:e.label},gnote:{textContent:()=>e.key==="gir"?this.girNote():"",className:()=>e.key==="gir"&&this.girNote()!==""?`se-stats__note${this.svc.statGirState().state==="disagree"?" warn":""}`:"se-stats__note hidden"},seg:{role:"group","aria-label":()=>e.key==="gir"?this.girAria():d.aria}},t),h=this.ref(c,"seg");for(const u of i){const f=this.wireEl(np,{btn:{textContent:u.label,className:()=>`se-seg${o}${this.svc.statValue(e.key)===u.value?" on-neutral":""}`,"aria-pressed":()=>String(this.svc.statValue(e.key)===u.value),onclick:()=>this.answerStat(e.key,this.svc.statValue(e.key)===u.value?null:u.value)}},t);h?.appendChild(f)}return c}statStepper(e,t){const n=e.control,i=n.kind==="stepper"?n.min:0,r=n.kind==="stepper"?n.max:null;return this.wireEl(mi,{glabel:{textContent:e.label},minus:{onclick:()=>this.stepStat(e.key,-1),"aria-label":`Fewer ${e.label}`},plus:{onclick:()=>this.stepStat(e.key,1),"aria-label":`More ${e.label}`},val:{textContent:()=>Wn(this.svc.statStepperValue(e.key,i),r),className:()=>this.svc.statIsAnswered(e.key)?"se-stats__step-val":"se-stats__step-val unanswered","aria-label":()=>this.svc.statIsAnswered(e.key)?`${e.label} ${this.svc.statStepperValue(e.key,i)}`:`${e.label} not answered`}},t)}girNote(){const e=this.svc.statGirState();return e.state==="pending"?qe.girPending:e.state==="disagree"?e.derived==="1"?qe.girDisagreeHit:qe.girDisagreeMiss:""}girAria(){const e=this.svc.statGirState();return e.state==="pending"?qe.girPendingAria:e.state==="disagree"?`${Us("gir")}, ${e.stored==="1"?"Hit":"Miss"}, your score disagrees`:Us("gir")}statExplainerCards(){return this.shownStatPrompts().prompts.map(e=>({key:e.key,title:gi(e.key,e.label).title,text:Kh(e.key)}))}answerStat(e,t){this.svc.answerStat(e,t),this.keepShortGameUnfolded(e),this.mirrorStatToMeta(e)}stepStat(e,t){this.svc.stepStat(e,t),this.keepShortGameUnfolded(e),this.mirrorStatToMeta(e)}mirrorStatToMeta(e){const t=this.metaInputs().find(i=>i.key===e);if(!t)return;const n=this.svc.statValue(e);if(n!==null){if(t.kind==="number"){const i=Number(n);Number.isInteger(i)&&this.setMeta(e,i);return}this.setMeta(e,n==="1")}}flash(e){this.toastMsg.set(e),this.flashTimer&&clearTimeout(this.flashTimer),this.flashTimer=setTimeout(()=>{this.flashTimer=null,this.toastMsg.get()===e&&this.toastMsg.set(null)},1100)}snap(e){this.pendingSteps=e,this.transitioning.set(!0),this.dragOffset.set(-e*Oe),this.settleTimer&&clearTimeout(this.settleTimer),this.settleTimer=setTimeout(()=>this.finishSettle(),420)}finishSettle(){if(this.pendingSteps===null)return;const e=this.pendingSteps;this.pendingSteps=null,this.settleTimer&&(clearTimeout(this.settleTimer),this.settleTimer=null),this.transitioning.set(!1),e!==0&&this.holeIdx.set(Ue(this.holeIndex()+e,this.playedOrder().length)),this.dragOffset.set(0)}bindCarouselPointer(e,t){t.addEventListener("transitionend",i=>{i.propertyName==="transform"&&this.finishSettle()}),e.addEventListener("pointerdown",i=>{this.ptr||this.transitioning.get()||this.playedOrder().length<=1||(this.ptr={id:i.pointerId,startX:i.clientX,startY:i.clientY,lastX:i.clientX,lastTime:Date.now(),velocity:0,horiz:!1},this.dragOffset.set(0),e.setPointerCapture?.(i.pointerId))}),e.addEventListener("pointermove",i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const o=i.clientX-r.startX,d=i.clientY-r.startY;if(!r.horiz){if(Math.abs(d)>Math.abs(o)&&Math.abs(d)>8||Math.abs(o)<=8)return;r.horiz=!0}const c=Date.now(),h=Math.max(1,c-r.lastTime);r.velocity=(i.clientX-r.lastX)/h,r.lastX=i.clientX,r.lastTime=c,this.dragOffset.set(o)});const n=i=>{const r=this.ptr;if(!r||r.id!==i.pointerId)return;const o=i.clientX-r.startX,d=r.horiz;if(this.ptr=null,e.releasePointerCapture?.(i.pointerId),!d){this.dragOffset.set(0);return}this.snap(rd({dragDistance:o,velocity:r.velocity,itemWidth:Oe}))};e.addEventListener("pointerup",n),e.addEventListener("pointercancel",i=>{!this.ptr||this.ptr.id!==i.pointerId||(this.ptr=null,e.releasePointerCapture?.(i.pointerId),this.snap(0))})}}function dp(s,e){const t=[...s].sort((r,o)=>r.canonicalOrdinal-o.canonicalOrdinal);if(e.length===0)return[{label:"TOT",holes:t,playHoleIds:new Set(t.map(r=>r.playHoleId))}];const n=[...e].sort((r,o)=>r.fromCanonicalOrdinal-o.fromCanonicalOrdinal),i=[];for(const r of n){const o=t.filter(d=>d.canonicalOrdinal>=r.fromCanonicalOrdinal&&d.canonicalOrdinal<=r.toCanonicalOrdinal);o.length!==0&&i.push({label:r.label,holes:o,playHoleIds:new Set(o.map(d=>d.playHoleId))})}return i}function oa(s,e){const t=s.cells.filter(n=>e.has(n.playHoleId));if(s.aggregate==="sum"){const n=t.map(i=>i.value).filter(i=>i!==null);return n.length===0?"—":String(n.reduce((i,r)=>i+r,0))}if(s.aggregate==="last"){for(let n=t.length-1;n>=0;n--){const i=t[n].value;if(i!==null)return Number.isInteger(i)?String(i):i.toFixed(1)}return"—"}return"—"}function cp(s,e){if(s.aggregate==="sum"){const t=s.cells.map(n=>n.value).filter(n=>n!==null);return t.length===0?"—":String(t.reduce((n,i)=>n+i,0))}if(s.aggregate==="last"){const t=e[e.length-1];return t?oa(s,t.playHoleIds):"—"}return"—"}function up(s){const e=s?.marker;if(e){const t=e.tone;return{kind:"marker",template:e.template,tone:t==="success"||t==="warning"||t==="danger"?t:null,label:e.label?e.label:null,teamFill:s?.team??null}}return s?.team?{kind:"pill",team:s.team}:{kind:"plain"}}function hp(s){return s.filter(e=>!(e.startsWith("slot #")||/^HCP -?\d/.test(e)||/^PH -?\d/.test(e)))}const Wt=" & ";function la(s){return s.componentId??"default-score-grid"}function Sn(s,e,t,n={}){const i=dp(s.holes,e),r=n.mode??"product",o=s.rows.map(d=>{const c=new Map(d.cells.map(h=>[h.playHoleId,h]));return{kind:d.kind,emphasis:d.emphasis===!0,team:d.team??null,subjectName:d.subjectBallId?t(d.subjectBallId):null,labelText:d.label,groups:i.map(h=>({cells:h.holes.map(u=>{const f=c.get(u.playHoleId);return{text:f?.display??"",title:f?.title?f.title:null,decoration:up(f)}}),subtotal:oa(d,h.playHoleIds)})),total:cp(d,i)}});return{componentId:la(s),subjectBallIds:[...s.subjectBallIds],title:{groups:s.title.groups.map(d=>d.map(c=>t(c))),joiner:s.title.joiner,nameJoiner:Wt},subtitleFacts:r==="verification"?[...s.subtitleFacts]:hp(s.subtitleFacts),footnotes:[...s.footnotes],caption:s.caption??null,totals:s.totals.map(d=>({label:d.label,value:String(d.value??"—")})),columnGroups:i.map(d=>({label:d.label,columns:d.holes.map(c=>({label:c.occurrenceLabel}))})),hasTotalColumn:i.length>1,rows:o}}function Ms(s){return[...new Set(s)].sort().join("\0")}function pp(s,e){const t=new Map;e.forEach((i,r)=>{if(i.ballIds.length===0)return;const o=Ms(i.ballIds);t.set(o,t.has(o)?null:r)});const n=new Map;for(const i of s){if(i.subjectBallIds.length===0)continue;const r=Ms(i.subjectBallIds);n.set(r,(n.get(r)??0)+1)}return s.map(i=>{if(i.subjectBallIds.length===0)return{kind:"standalone"};const r=Ms(i.subjectBallIds);if((n.get(r)??0)!==1)return{kind:"standalone"};const o=t.get(r);return o==null?{kind:"standalone"}:{kind:"attached",entryIndex:o}})}function fp(s,e){const t=new Set(s.map(e));return t.size!==1?null:[...t][0]??null}function mp(s,e){if(s===void 0)return null;const t=e==="high"?-s:s;return{text:t===0?"E":t>0?`+${t}`:`−${Math.abs(t)}`,tone:t===0?"even":t>0?"over":"under"}}const gp=()=>null;function bp(s,e,t=gp){return{kind:"ranked",metricLabel:s.metricLabel,hasPace:s.entries.some(n=>n.paceDelta!==void 0),entries:s.entries.map(n=>({position:n.position,lead:n.position===1,name:n.ballIds.map(e).join(Wt),group:fp(n.ballIds,t),total:String(n.total??"—"),holesPlayed:n.holesPlayed,pace:mp(n.paceDelta,s.direction)}))}}function yp(s,e){return{kind:"match_summary",title:s.title,matches:s.matches.map(t=>({sideAName:t.sideA.ballIds.map(e).join(Wt),sideBName:t.sideB.ballIds.map(e).join(Wt),leader:t.leader,standing:t.magnitude===0?"AS":t.finished&&t.closeOutRemaining!=null?`${t.magnitude} & ${t.closeOutRemaining}`:`${t.magnitude} UP`,status:t.finished?"Final":`thru ${t.thru}`}))}}function en(s,e){return[s,...[...new Set(e)].sort()].join("|")}const _p=new Map;function vp(s){const e=s.cards??[],t=(s.leaderboard??[]).find(o=>o.kind==="ranked")??null;if(!t)return{rankedSection:null,slotDefId:s.slotDefId,attached:_p,standalone:[...e]};const n=pp(e,t.entries),i=new Map,r=[];return e.forEach((o,d)=>{const c=n[d],h=c?.kind==="attached"?t.entries[c.entryIndex]:void 0;if(!h){r.push(o);return}i.set(en(s.slotDefId,h.ballIds),o)}),{rankedSection:t,slotDefId:s.slotDefId,attached:i,standalone:r}}class wp{open=new Set;isOpen(e){return this.open.has(e)}toggle(e){return this.set(e,!this.open.has(e))}set(e,t){return t?this.open.add(e):this.open.delete(e),t}keys(){return[...this.open].sort()}retain(e){const t=new Set(e);for(const n of[...this.open])t.has(n)||this.open.delete(n)}}const Tn={ring:{meaning:"a single-unit decided result",fill:"#d63b2f",visual:"red filled circle — the Gamebook birdie mark (score to par −1)"},double_ring:{meaning:"a two-unit decided result; more emphatic than a ring",fill:"#e0862c",teamFillBorder:"border-width: 3px; border-style: double;",visual:"orange filled circle (score to par −2); doubled white border when team-filled"},diamond:{meaning:"a rare / high-magnitude decided result — the strongest form",fill:"#e0b41f",visual:"yellow filled circle — hole-in-one / albatross territory"},dot:{meaning:"a lightweight per-hole flag where a full ring would be too heavy",visual:"the bare base shape (no fill, no border) — inherits cell colour"},badge:{meaning:"a labelled status needing short text or a number, not just a shape",rule:["width: auto; min-width: 1.8em;","padding-left: 0.45em; padding-right: 0.45em;","border: 2px solid currentColor;"],tones:{success:"#267348",warning:"#946200",danger:"#9b332a"},visual:"outline pill in the tone colour, text inside"},square:{meaning:"a one-step negative score relation",fill:"#5b9bd5",boxy:!0,visual:"light-blue filled square (score to par +1)"},double_square:{meaning:"a stronger negative score relation",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square (score to par +2)"},box_badge:{meaning:"an angular labelled state that must not read as a round marker",fill:"#1f4e79",boxy:!0,visual:"dark-blue filled square carrying its value (+3 or worse)"}};function ft(s){return`lb-mark--${s}`}const rt=()=>Object.entries(Tn);function da(s){return s.join(`
            `)}function Hs(s,e){return s.map((t,n)=>`& .${ft(t)}${n===s.length-1?` { ${e} }`:","}`)}function xp(){const s=[];s.push("/* Outline forms keep currentColor + tone tints. */");for(const[r,o]of rt())if(!(!o.rule&&!o.tones)){if(o.rule){s.push(`& .${ft(r)} {`);for(const d of o.rule)s.push(`    ${d}`);s.push("}")}for(const[d,c]of Object.entries(o.tones??{}))s.push(`& .${ft(r)}.lb-mark-tone--${d} { color: ${c}; }`)}s.push("/* Filled forms — declared after the tone rules so white text wins. */");const e=rt().filter(([,r])=>r.boxy).map(([r])=>r),t=[],n=new Set;for(const[r,o]of rt()){if(o.fill===void 0||n.has(r))continue;const d=rt().filter(([,c])=>c.fill===o.fill).map(([c])=>c);for(const c of d)n.add(c);t.push({fill:o.fill,ids:d})}let i=-1;if(e.length>0){const r=t.findIndex(o=>o.ids.some(d=>Tn[d].boxy));i=r===-1?t.length:r}return t.forEach((r,o)=>{o===i&&s.push(...Hs(e,"border-radius: 3px;")),s.push(...Hs(r.ids,`background: ${r.fill}; color: #fff;`))}),i===t.length&&s.push(...Hs(e,"border-radius: 3px;")),da(s)}function kp(){const s=[];for(const[e,t]of rt()){if(!t.teamFillBorder)continue;const n=ft(e);s.push(`& .${n}.lb-mark-fill--a,`,`& .${n}.lb-mark-fill--b { ${t.teamFillBorder} }`)}return da(s)}const ca=()=>null;function j(s){return String(s).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;")}function $p(s){return s.kind==="si"?"lb-c-si":s.kind==="given"?"lb-c-given":s.kind==="status"?"lb-c-status":s.kind==="category"?"lb-c-cat":""}function Sp(s){const e=[s.kind==="category"?"lb-r-cat":`lb-r-${s.kind}`];return(s.kind==="si"||s.kind==="given")&&e.push("lb-r-dim"),s.team&&e.push(`lb-team-${s.team}`),e.join(" ")}function Tp(s,e,t){const n=s.title!==null?` title="${j(s.title)}"`:"",i=t(j(s.text)),r=s.decoration;let o;if(r.kind==="marker"){const d=r.tone?` lb-mark-tone--${r.tone}`:"",c=r.teamFill?` lb-mark-fill--${r.teamFill}`:"",h=r.label!==null?` title="${j(r.label)}" aria-label="${j(r.label)}"`:"";o=`<span class="lb-mark ${ft(r.template)}${d}${c}"${h}>${i}</span>`}else r.kind==="pill"?o=`<span class="lb-pill lb-pill--${r.team}">${i}</span>`:o=i;return`<td class="${$p(e)}"${n}>${o}</td>`}function Pn(s,e){const t=f=>{const m=s.columnGroups[f],b=`<tr><th class="lb-rowlabel">Hole</th>${m.columns.map(v=>`<th>${j(v.label)}</th>`).join("")}<th class="lb-sum">${j(m.label)}</th></tr>`,g=s.rows.map(v=>{const $=se=>v.emphasis?`<strong>${se}</strong>`:se,R=v.groups[f],N=R.cells.map(se=>Tp(se,v,$)).join(""),V=`<td class="lb-sum">${$(R.subtotal)}</td>`,M=v.subjectName!==null?j(v.subjectName)+(v.labelText?" "+j(v.labelText):""):j(v.labelText);return`<tr class="${Sp(v)}"><th class="lb-rowlabel">${M}</th>${N}${V}</tr>`}).join("");return`<div class="lb-card__scroll"><table class="lb-grid"><thead>${b}</thead><tbody>${g}</tbody></table></div>`},n=s.columnGroups.map((f,m)=>t(m)).join(""),i=s.title.groups.map(f=>f.map(m=>j(m)).join(s.title.nameJoiner)).filter(Boolean).join(s.title.joiner),r=s.subtitleFacts.length?`<div class="lb-card__sub">${s.subtitleFacts.map(j).join(" · ")}</div>`:"",o=e.mode==="verification"&&s.footnotes.length?`<div class="lb-card__notes"><span class="lb-card__notes-label">Points breakdown</span>${s.footnotes.map(f=>`<span class="lb-card__note">${j(f)}</span>`).join("")}</div>`:"",d=e.mode==="verification"&&s.caption?`<p class="lb-card__caption">${j(s.caption)}</p>`:"",c=s.totals.length?`<ul class="lb-card__totals">${s.totals.map(f=>`<li>${j(f.label)} = <strong>${f.value}</strong></li>`).join("")}</ul>`:"",h=i?`<header class="lb-card__head"><h4>${i}</h4>${r}</header>`:r;return`<article class="${e.cardModifier?`lb-card ${e.cardModifier}`:"lb-card"}">
  ${h}
  ${n}
  ${o}${d}${c}
</article>`}function Pp(s,e,t,n){return Pn(Sn(s,e,t,n),n)}function Cp(s,e,t,n){return Pn(Sn(s,e,t,n),{...n,cardModifier:"lb-card--compact-match"})}function Ip(s,e,t,n){return Pn(Sn(s,e,t,n),{...n,cardModifier:"lb-card--category-matrix"})}function Ep(s){return s.pace===null?'<td class="lb-rank__pace"></td>':`<td class="lb-rank__pace lb-rank__pace--${s.pace.tone}">${j(s.pace.text)}</td>`}function Rp(s){return`lb-panel-${s.replace(/[^a-zA-Z0-9_-]+/g,"-")}`}function Np(s,e,t=ca,n=null){const i=bp(s,e,t),r=i.hasPace,o=n!==null,d=(r?5:4)+(o?1:0),c=i.entries.map((b,g)=>{const v=b.group?` <span class="lb-rank__group">${j(b.group)}</span>`:"",$=`
  <td class="lb-rank__total">${b.total}</td>${r?`
  ${Ep(b)}`:""}
  <td class="lb-rank__thru">${b.holesPlayed}</td>`,R=s.entries[g],N=n&&R?n.plan.attached.get(en(n.plan.slotDefId,R.ballIds)):void 0;if(!n)return`<tr class="${b.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${j(b.name)}</span>${v}</span></td>${$}
</tr>`;if(!R||!N)return`<tr class="${b.lead?"lb-rank__lead":""}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><span class="lb-rank__whobox"><span class="lb-rank__name">${j(b.name)}</span>${v}</span></td>${$}
  <td class="lb-rank__disclosure"></td>
</tr>`;const V=en(n.plan.slotDefId,R.ballIds),M=n.isOpen(V),se=Rp(V),ce=ua(N,n.routeSections,e,{mode:n.mode??"product"}),ue=["lb-rank__row--expandable"];return b.lead&&ue.push("lb-rank__lead"),M&&ue.push("lb-rank__row--open"),`<tr class="${ue.join(" ")}" data-expand-key="${j(V)}">
  <td class="lb-rank__pos">${b.position}</td>
  <td class="lb-rank__who"><button type="button" class="lb-rank__toggle" aria-expanded="${M}" aria-controls="${j(se)}"><span class="lb-rank__whobox"><span class="lb-rank__name">${j(b.name)}</span>${v}</span></button></td>${$}
  <td class="lb-rank__disclosure"><span class="lb-rank__chev" aria-hidden="true"></span></td>
</tr>
<tr class="lb-rank__panel${M?" lb-rank__panel--open":""}" data-panel-key="${j(V)}">
  <td class="lb-rank__panelcell" colspan="${d}"><div class="lb-rank__panelwrap" id="${j(se)}"><div class="lb-rank__panelbox">${ce}</div></div></td>
</tr>`}).join(""),h=r?`
  ...
  <h4 class="lb-section__title">${j(i.metricLabel)}</h4>
  <table class="lb-rank">
    <colgroup>
...
</div>`}function Op(s,e){const t=yp(s,e),n=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",o=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
    <div class="lb-mp__team lb-mp__team--a${r}">${j(i.sideAName)}</div>
    <div class="lb-mp__center"><span class="lb-mp__standing">${j(i.standing)}</span><span class="lb-mp__status">${j(i.status)}</span></div>
    <div class="lb-mp__team lb-mp__team--b${o}">${j(i.sideBName)}</div>
  </div>`}).join("");return`<div class="lb-section">
  <h4 class="lb-section__title">${j(t.title)}</h4>${n}
</div>`}const Mp={ranked:Np,match_summary:(s,e)=>Op(s,e)},Hp={"default-score-grid":Pp,"compact-match-grid":Cp,"category-matrix-grid":Ip};function Ap(s){return`<div class="lb-diag">Unrenderable result section <code>${j(s)}</code> — no generic view yet. Results are not hidden.</div>`}function Bp(s){return`<div class="lb-diag">Unsupported score-grid component <code>${j(s)}</code> — no generic view yet. Results are not hidden.</div>`}function zp(s,e,t,n=null){const i=Mp[s.kind];return i?i(s,e,t,n):Ap(s.kind)}function ua(s,e,t,n){const i=la(s),r=Hp[i];return r?r(s,e,t,n):Bp(i)}function ha(s,e,t=ca,n=null){return s.leaderboard.length===0&&s.cards.length===0?`<div class="lb-empty">No scores entered yet for ${j(s.formatLabel)}.</div>`:s.leaderboard.map(r=>zp(r,e,t,n&&r===n.plan.rankedSection?n:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${j(s.formatLabel)}.</div>`}function pa(s,e,t,n={}){if(s.length===0)return"";const i=n.mode??"product";return s.map(r=>ua(r,e,t,{mode:i})).join(`
`)}const Lp=y(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class Cn extends A{static styles=`
        .lb {
    ...
    `;svc=this.inject(be);expansion=new wp;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(n=>n.slotDefId===t)??e[0]??null};render(){return this.wire(Lp,{status:{className:()=>{const t=this.svc.resultLoading.get(),n=this.svc.result.get()===null;return t||n?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const n=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(n))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const n=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(n)&&(this.applyOpen(t,this.expansion.set(n,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const n=e.nextElementSibling;n?.classList.contains("lb-rank__panel")&&n.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const n=h=>{const u=this.svc.nameOf(h);return this.svc.isPending(h)?`${u} (open seat)`:u},i=h=>this.svc.groupLabelOf(h),r=vp(t);this.expansion.retain(r.attached.keys());const o=ha(t,n,i,{plan:r,routeSections:e.routeSections,isOpen:h=>this.expansion.isOpen(h)}),d=pa(r.standalone,e.routeSections,n),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return o+c}}function Fp(s,e){if(!e)return[];const t=[],n=new Set;for(const i of s)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||n.has(r.guestPlayerId)||(n.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const Gp=y(`
...
`);class jp extends A{static styles=`
        .claim-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${O()}
    ...
    `;svc=this.inject(be);auth=this.inject(U);router=this.inject(q);tokenQ=this.router.query("token");claiming=new p(!1);error=new p("");claimable(){return Fp(this.svc.balls.get(),this.auth.currentUser.get()?.id??null)}async claim(e){const t=this.tokenQ.get();if(!(!t||this.claiming.get())){this.error.set(""),this.claiming.set(!0);try{await w.friendlyRounds.claimGuest({token:t,guestPlayerId:e}),await this.svc.loadByToken(t)}catch(n){this.error.set(n instanceof Z&&n.status===409?"Already claimed — or you already play in this round under your account.":n instanceof Z&&n.status===404?"That guest is no longer claimable on this round.":"Could not claim right now. Try again.")}finally{this.claiming.set(!1)}}}render(){const e=this.wire(Gp,{root:{className:()=>this.claimable().length>0?"claim-card":"claim-card hidden"},err:{textContent:()=>this.error.get()}});return this.$each(this.ref(e,"rows"),()=>this.claimable(),(t,n,i)=>this.wireEl(Dp,{name:()=>t.displayName,claim:{disabled:()=>this.claiming.get(),onclick:()=>{this.claim(t.guestPlayerId)}}},i),t=>t.guestPlayerId),e}}function qp(s,e,t){return(n,i)=>{const r=o=>{const d=o.target;n.contains(d)||e()};i.track(C(()=>{s.get()?document.addEventListener("pointerdown",r,!0):document.removeEventListener("pointerdown",r,!0)})),i.track(()=>document.removeEventListener("pointerdown",r,!0))}}function As(s){return typeof s=="object"&&s!==null&&typeof s.get=="function"}const P=s=>`var(--${s})`,bi="http://www.w3.org/2000/svg";function Vp(){const s=document.createElementNS(bi,"svg");s.setAttribute("width","12"),s.setAttribute("height","8"),s.setAttribute("viewBox","0 0 12 8"),s.setAttribute("fill","none"),s.setAttribute("aria-hidden","true"),s.setAttribute("focusable","false");const e=document.createElementNS(bi,"path");return e.setAttribute("d","M1 1.5 6 6.5 11 1.5"),e.setAttribute("stroke","currentColor"),e.setAttribute("stroke-width","1.5"),e.setAttribute("stroke-linecap","round"),e.setAttribute("stroke-linejoin","round"),e.setAttribute("fill","none"),s.appendChild(e),s}const ut=class ut extends A{constructor(){super(...arguments),this.uid=`ui-select-${ut.seq++}`,this.open=new p(!1),this.highlightIndex=new p(-1),this.query=new p(""),this.optionEls=[]}get isMulti(){return this.props.multiple===!0}get multi(){return this.props}get single(){return this.props}currentOptions(){return As(this.props.options)?this.props.options.get():this.props.options}visibleOptions(){const e=this.currentOptions();if(!this.props.searchable)return e;const t=this.query.get().trim().toLowerCase();if(t==="")return e;const n=[];let i=null;for(const r of e){if(r.disabled){i=r;continue}r.label.toLowerCase().includes(t)&&(i&&(n.push(i),i=null),n.push(r))}return n}selectedValues(){if(this.isMulti)return this.multi.values.get();const e=this.single.value.get();return e?[e]:[]}placeholderText(){const e=this.props.placeholder;return(typeof e=="function"?e():e)??""}formatCount(e){return this.multi.countLabel?this.multi.countLabel(e):String(e)}searchPlaceholderText(){const e=this.props.searchPlaceholder;return(typeof e=="function"?e():e)??""}setQuery(e){We(()=>{this.query.set(e),this.highlightIndex.set(this.visibleOptions().findIndex(t=>!t.disabled))})}render(){const e=document.createElement("div");e.className="ui-select",this.wrapperEl=e,this.mix(e,qp(this.open,()=>this.open.set(!1)));const t=this.props.zIndex??50,n=this.isMulti;this.triggerEl=document.createElement("button"),this.triggerEl.className="ui-select__trigger",this.triggerEl.setAttribute("type","button"),this.triggerEl.setAttribute("role","combobox"),this.triggerEl.setAttribute("aria-haspopup","listbox");const i=document.createElement("span");i.className="ui-select__trigger-label",this.triggerEl.appendChild(i);const r=document.createElement("span");if(r.className="ui-select__chevron",r.appendChild(Vp()),r.setAttribute("aria-hidden","true"),this.triggerEl.appendChild(r),this.triggerEl.addEventListener("click",d=>{d.stopPropagation(),this.toggle()}),this.triggerEl.addEventListener("keydown",d=>{this.handleTriggerKeydown(d)}),e.appendChild(this.triggerEl),this.dropdownEl=document.createElement("div"),this.dropdownEl.className="ui-select__dropdown",this.dropdownEl.style.zIndex=String(t),this.dropdownEl.addEventListener("keydown",d=>{this.handleDropdownKeydown(d)}),this.props.searchable){const d=document.createElement("div");d.className="ui-select__search";const c=document.createElement("input");c.className="ui-select__search-input",c.type="text",c.setAttribute("aria-autocomplete","list"),c.addEventListener("input",()=>{this.setQuery(c.value)}),c.addEventListener("keydown",h=>{["ArrowDown","ArrowUp","Enter","Escape","Tab"].includes(h.key)||h.stopPropagation()}),d.appendChild(c),this.searchEl=c,this.dropdownEl.appendChild(d)}this.listEl=document.createElement("div"),this.listEl.className="ui-select__list",this.listEl.setAttribute("role","listbox"),n&&this.listEl.setAttribute("aria-multiselectable","true"),this.dropdownEl.appendChild(this.listEl),n&&(this.countEl=document.createElement("div"),this.countEl.className="ui-select__count",this.countEl.setAttribute("role","status"),this.countEl.setAttribute("aria-live","polite"),this.dropdownEl.appendChild(this.countEl)),e.appendChild(this.dropdownEl);const o=d=>{this.optionEls=[],this.listEl.textContent="";for(let c=0;c<d.length;c++){const h=d[c],u=document.createElement("button");if(u.className=n?"ui-select__option ui-select__option--multi":"ui-select__option",u.setAttribute("type","button"),u.id=`${this.uid}-opt-${c}`,h.disabled){u.classList.add("ui-select__option--header"),u.disabled=!0,u.setAttribute("role","presentation"),u.setAttribute("aria-disabled","true");const m=document.createElement("span");m.className="ui-select__option-label",m.textContent=h.label,u.appendChild(m),this.listEl.appendChild(u),this.optionEls.push(u);continue}if(u.setAttribute("role","option"),n){const m=document.createElement("span");m.className="ui-select__checkbox",m.setAttribute("aria-hidden","true"),u.appendChild(m)}if(h.icon){const m=document.createElement("span");m.className="ui-select__option-icon",m.textContent=h.icon,u.appendChild(m)}const f=document.createElement("span");if(f.className="ui-select__option-label",f.textContent=h.label,u.appendChild(f),!n){const m=document.createElement("span");m.className="ui-select__check",m.setAttribute("aria-hidden","true"),u.appendChild(m)}u.addEventListener("click",m=>{m.stopPropagation(),this.chooseOption(h.value)}),u.addEventListener("mouseenter",()=>{this.highlightIndex.set(c)}),this.listEl.appendChild(u),this.optionEls.push(u)}J(()=>{const c=this.highlightIndex.get();c>=0&&this.optionEls[c]&&this.optionEls[c].classList.add("ui-select__option--highlighted")})};return As(this.props.options)||this.props.searchable?this.track(C(()=>{o(this.visibleOptions())})):o(this.props.options),this.searchEl&&this.track(C(()=>{const d=this.searchPlaceholderText();this.searchEl.placeholder=d,this.searchEl.setAttribute("aria-label",d)})),this.track(C(()=>{const d=this.currentOptions(),c=this.selectedValues();if(n){const u=c.length;if(u>0)i.textContent=this.formatCount(u),this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const f=this.placeholderText();i.textContent=f,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!f)}this.countEl&&(this.countEl.textContent=this.formatCount(u))}else{const u=this.single.value.get(),f=d.find(m=>m.value===u);if(f)i.textContent=f.icon?`${f.icon} ${f.label}`:f.label,this.triggerEl.classList.remove("ui-select__trigger--placeholder");else{const m=this.placeholderText();i.textContent=m,this.triggerEl.classList.toggle("ui-select__trigger--placeholder",!!m)}}const h=this.visibleOptions();for(let u=0;u<h.length;u++){const f=this.optionEls[u];if(!f||h[u].disabled)continue;const m=c.includes(h[u].value);f.setAttribute("aria-selected",String(m)),f.classList.toggle("ui-select__option--selected",m);const b=f.querySelector(".ui-select__check");b&&(b.textContent=m?"✓":"");const g=f.querySelector(".ui-select__checkbox");g&&(g.textContent=m?"✓":"")}})),this.track(C(()=>{const d=this.open.get();this.dropdownEl.classList.toggle("open",d),r.classList.toggle("ui-select__chevron--open",d),this.triggerEl.setAttribute("aria-expanded",String(d)),d?J(()=>{const c=this.visibleOptions(),h=this.selectedValues(),u=c.findIndex(m=>!m.disabled&&h.includes(m.value)),f=c.findIndex(m=>!m.disabled);this.highlightIndex.set(u>=0?u:f)}):this.searchEl&&J(()=>{this.searchEl.value="",this.query.set("")})})),this.track(C(()=>{const d=this.highlightIndex.get();for(let c=0;c<this.optionEls.length;c++)this.optionEls[c].classList.toggle("ui-select__option--highlighted",c===d);d>=0&&this.optionEls[d]&&(this.triggerEl.setAttribute("aria-activedescendant",`${this.uid}-opt-${d}`),this.optionEls[d].scrollIntoView({block:"nearest"}))})),this.props.disabled!=null&&(As(this.props.disabled)?this.track(C(()=>{const d=this.props.disabled.get();this.triggerEl.classList.toggle("ui-select__trigger--disabled",d),this.triggerEl.disabled=d})):this.props.disabled&&(this.triggerEl.classList.add("ui-select__trigger--disabled"),this.triggerEl.disabled=!0)),e}toggle(){this.open.update(e=>!e)}chooseOption(e){if(this.isMulti){const t=this.multi.values.get();this.multi.values.set(t.includes(e)?t.filter(n=>n!==e):[...t,e]);return}We(()=>{this.single.value.set(e),this.open.set(!1)}),this.triggerEl.focus()}commitHighlighted(){const e=this.highlightIndex.get(),t=this.visibleOptions();e>=0&&e<t.length&&!t[e].disabled&&this.chooseOption(t[e].value)}handleTriggerKeydown(e){switch(e.key){case"Enter":case" ":e.preventDefault(),this.open.get()?this.commitHighlighted():this.open.set(!0);break;case"ArrowDown":e.preventDefault(),this.open.get()?this.moveHighlight(1):this.open.set(!0);break;case"ArrowUp":e.preventDefault(),this.open.get()?this.moveHighlight(-1):this.open.set(!0);break;case"Escape":this.open.get()&&(e.preventDefault(),this.open.set(!1));break;default:if(this.props.searchable&&e.key.length===1&&!e.ctrlKey&&!e.metaKey&&!e.altKey){e.preventDefault(),this.open.get()||this.open.set(!0);const t=this.query.get()+e.key;this.searchEl&&(this.searchEl.value=t,this.searchEl.focus()),this.setQuery(t)}break}}handleDropdownKeydown(e){switch(e.key){case"ArrowDown":e.preventDefault(),this.moveHighlight(1);break;case"ArrowUp":e.preventDefault(),this.moveHighlight(-1);break;case"Enter":case" ":e.preventDefault(),this.commitHighlighted();break;case"Escape":e.preventDefault(),this.open.set(!1),this.triggerEl.focus();break;case"Tab":this.open.set(!1);break}}moveHighlight(e){const t=this.visibleOptions();if(t.length===0||!t.some(i=>!i.disabled))return;let n=this.highlightIndex.get();do n+=e,n<0&&(n=t.length-1),n>=t.length&&(n=0);while(t[n].disabled);this.highlightIndex.set(n)}};ut.styles=`
        .ui-select {
            position: relative;
            display: inline-block;
        }
    ...
    `,ut.seq=0;let pe=ut;function Up(s){if(!s)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=s.seats.length>0,t=s.claimedSeats.some(r=>r.viewerMayRelease),n=s.viewer.claimSeat.allowed,i=s.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&n,guestAllowed:e&&i,blockedMessage:e&&!n&&!i?s.viewer.claimSeat.message??s.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function Kp(s,e){const t=[];if(s.groupId!==null&&e.length>0){const n=e.findIndex(i=>i.id===s.groupId);if(n>=0){t.push(`Group ${n+1}`);const i=e[n].startTime;i.includes(":")&&t.push(i)}}return s.category!==null&&t.push(s.category),t.join(" · ")}function Wp(s){return(s?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Yp=y(`
...
`);class nf extends A{static styles=`
        .join-card {
            margin-top: ${a("lg")};
            padding: ${a("lg")};
            ${O()}
    ...
    `;svc=this.inject(be);auth=this.inject(U);router=this.inject(q);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return ef(this.svc.startList.get())}eligible(){return this.policyState().visible&&Zp(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,w.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const n=this.groupChoice.get(),i=await w.friendlyRounds.join({token:e,teeId:t,...n?{groupChoice:n}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(n){this.error.set(n instanceof Z&&n.status===409?n.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(C(()=>this.ensureTeesLoaded()));const e=new T(()=>tf(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(C(()=>{const r=e.get(),o=this.groupChoice.get();(!o||!r.options.some(d=>d.value===o&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(sf,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),n=new pe({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});n.mount(this.ref(t,"teeHost")),this.track(()=>n.destroy());const i=new pe({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}const _i=1440*60*1e3;function rf(s,e){if(s===null)return!0;const t=new Date(s).getTime();return!Number.isFinite(t)||t-e>_i?!0:e-t>=_i}function af(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}function of(s){const e={visible:!1,index:null};return s.settled||!s.profileLoaded||!s.firstOpen||!af(s.balls,s.playerId)||!rf(s.handicapConfirmedAt,s.now)?e:{visible:!0,index:s.handicapIndex}}function we(s){const e=s.trim().replace(",",".");if(e==="")return null;const t=e.startsWith("+"),n=Number.parseFloat(t?e.slice(1):e);return Number.isFinite(n)?t?-n:n:null}function Yt(s){return s<0?`+${String(-s)}`:String(s)}const lf=y(`
...
`);class df extends A{static styles=`
        .hcp-checkin {
            margin-bottom: ${a("lg")};
            padding: ${a("md")} ${a("lg")};
            ${O()}
    ...
    `;svc=this.inject(be);auth=this.inject(U);profile=this.inject(Ie);settled=new p(!1);editing=new p(!1);text=new p("");busy=new p(!1);error=new p("");state(){const e=this.profile.player.get();return of({playerId:this.auth.currentUser.get()?.id??null,balls:this.svc.balls.get(),firstOpen:this.svc.firstOpen.get(),handicapConfirmedAt:e?.handicapConfirmedAt??null,handicapIndex:e?.handicapIndex??null,profileLoaded:e!==null,settled:this.settled.get(),now:Date.now()})}ensureProfileLoaded(){this.settled.get()||this.svc.firstOpen.get()&&this.auth.currentUser.get()&&this.svc.balls.get().length&&this.profile.load()}async confirm(){if(this.busy.get())return;this.error.set(""),this.busy.set(!0);const e=await this.profile.confirmHandicap();this.busy.set(!1),e?this.settled.set(!0):this.error.set("Could not save that right now. Try again.")}startEdit(){const e=this.profile.player.get()?.handicapIndex??null;this.text.set(e===null?"":Yt(e)),this.error.set(""),this.editing.set(!0)}async save(){if(this.busy.get())return;const e=we(this.text.get());if(e===null){this.error.set("Enter a handicap index, e.g. 18.4 or +2.4.");return}this.error.set(""),this.busy.set(!0);const t=await this.profile.saveIndex(e);this.busy.set(!1),t?(this.editing.set(!1),this.settled.set(!0)):this.error.set("Could not save that right now. Try again.")}render(){return this.track(C(()=>this.ensureProfileLoaded())),this.wire(lf,{root:{className:()=>this.state().visible?"hcp-checkin":"hcp-checkin hidden"},ask:{className:()=>this.editing.get()?"hcp-checkin__ask hidden":"hcp-checkin__ask"},question:{textContent:()=>{const e=this.state().index;return e===null?"No handicap set — add one?":`Handicap ${Yt(e)} — still right?`}},confirm:{textContent:()=>this.state().index===null?"Not now":"Yes",disabled:()=>this.busy.get(),onclick:()=>{this.confirm()}},edit:{textContent:()=>this.state().index===null?"Add":"Update",disabled:()=>this.busy.get(),onclick:()=>this.startEdit()},editor:{className:()=>this.editing.get()?"hcp-checkin__editor":"hcp-checkin__editor hidden"},field:{value:()=>this.text.get(),oninput:e=>this.text.set(e.target.value)},save:{disabled:()=>this.busy.get(),onclick:()=>{this.save()}},cancel:{disabled:()=>this.busy.get(),onclick:()=>this.editing.set(!1)},err:{textContent:()=>this.error.get()}})}}function cf(s,e){if(!e)return!1;for(const t of s)for(const n of t.players)if(n.playerId===e)return!0;return!1}const uf=y(`
...
`);class kf extends A{static styles=`
    ...
    `;svc=this.inject(be);auth=this.inject(U);router=this.inject(q);stage=new p("prompt");error=new p("");render(){this.track(C(()=>{this.svc.finishFlowOpen.get()&&(this.stage.set("prompt"),this.error.set(""))}));const e=this.wire(xf,{root:{className:()=>this.svc.finishFlowOpen.get()?"ffl":"ffl hidden"},prompt:{className:()=>this.stage.get()==="prompt"?"ffl__prompt":"ffl__prompt hidden"},board:{className:()=>this.stage.get()==="board"?"ffl__board":"ffl__board hidden"},roundName:()=>this.roundLine(),boardRound:()=>this.roundLine(),missing:()=>ff(this.missingCount())??"",err:()=>this.error.get(),finishBtn:{onclick:()=>{this.finish()},disabled:()=>this.svc.finishing.get()},backBtn:{onclick:()=>this.svc.finishFlowOpen.set(!1)},nextBtn:{textContent:()=>this.statsEligible()?"View stats":"Close",onclick:()=>this.leave()}});this.spawn(Cn,this.ref(e,"leaderboard"));const t=n=>{n.key==="Escape"&&this.svc.finishFlowOpen.get()&&this.stage.get()==="prompt"&&this.svc.finishFlowOpen.set(!1)};return window.addEventListener("keydown",t),this.track(()=>window.removeEventListener("keydown",t)),e}roundLine(){const e=this.svc.round.get();if(e===null)return"";const t=ga(e),n=(e.courseNameSnapshot??"").trim();return n!==""&&n!==t?`${t} · ${n}`:t}missingCount(){return pf({balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}async finish(){if(this.error.set(""),await this.svc.finishRound()===null){this.error.set("Could not finish the round. Try again.");return}this.stage.set("board"),this.svc.loadResult()}statsEligible(){return fa({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.svc.statModules.get().keys()),statRows:this.svc.statRows.get(),holesUnscored:ma({playerId:this.auth.currentUser.get()?.id??"",balls:this.svc.balls.get(),groups:this.svc.groups(),strokesFor:(e,t)=>this.svc.strokesFor(e,t)})}).reason==="eligible"}leave(){const e=this.svc.round.get()?.id??null,t=this.statsEligible();this.svc.finishFlowOpen.set(!1),t&&e!==null?this.router.navigate("/round-stats",{query:{id:e,finish:"1"}}):this.router.navigate("/")}}class Le{static PAGE_SIZE=50;static MAX_PAGES=40;loading=new p(!1);error=new p(null);loaded=new p(!1);loadedRounds=new p([]);roundsWithStats=new p(null);hasMore=new p(!1);preset=new p(Ws());filter=new p(dt);sgChoice=new p(Qs());profile=X.get(Ie);handicapIndex=new T(()=>this.profile.player.get()?.handicapIndex??null);sgCohort=new T(()=>wn(this.sgChoice.get(),this.handicapIndex.get()));sgBundle=new T(()=>bt[this.sgCohort.get()]);sgInfo=new T(()=>hu(this.sgChoice.get(),this.handicapIndex.get()));extending=new p(!1);extendError=new p(null);pagesFetched=0;cursor=null;generation=0;windowRounds=new T(()=>Rr(this.preset.get(),this.filter.get(),this.loadedRounds.get(),new Date));curveRows=new p([]);model=new T(()=>xn(this.windowRounds.get(),this.sgBundle.get(),this.curveRows.get()));courses=new T(()=>Ad(this.loadedRounds.get()));overFiltered=new T(()=>this.loadedRounds.get().length>0&&this.windowRounds.get().length===0);async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;this.pagesFetched=0,this.cursor=null,this.extendError.set(null);const t=await D(this.loading,this.error,()=>w.playerStats.myStats({limit:Le.PAGE_SIZE}));if(!t)return;const n=Ut(t.rounds);if(n!==null){this.error.set({code:"server",message:n});return}this.pagesFetched=1,this.roundsWithStats.set(t.roundsWithStats),this.loadedRounds.set(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null),this.loaded.set(!0),this.loadCurve(),await this.extendIfNeeded()}async loadCurve(){const e=this.generation;let t;try{t=await w.playerStats.myFirstPuttCurve()}catch{t=[]}e===this.generation&&this.curveRows.set(t)}select(e){this.preset.set(e),Jn(e),this.extendIfNeeded()}selectSgBaseline(e){this.sgChoice.set(e),fu(e)}async loadHandicap(){await this.profile.load()}applyFilter(e){this.filter.set(e),this.preset.set("custom"),Jn("custom"),this.extendIfNeeded()}clearFilter(){this.filter.set(dt),this.select(jt)}async extendIfNeeded(){if(!(this.extending.get()||this.loading.get())){this.extendError.set(null),this.extending.set(!0);try{for(;this.cursor!==null&&this.pagesFetched<Le.MAX_PAGES&&Nr({preset:this.preset.get(),filter:this.filter.get(),loaded:this.loadedRounds.get(),hasMore:this.hasMore.get(),now:new Date});){const e=this.cursor;let t;try{t=await w.playerStats.myStats({limit:Le.PAGE_SIZE,cursor:e})}catch{this.extendError.set({code:"network",message:"Could not load older rounds."});return}const n=Ut(t.rounds);if(n!==null){this.extendError.set({code:"server",message:n});return}this.pagesFetched+=1,this.appendRounds(t.rounds),this.cursor=t.nextCursor,this.hasMore.set(t.nextCursor!==null)}}finally{this.extending.set(!1)}}}budgetSpent(){return this.pagesFetched>=Le.MAX_PAGES&&this.hasMore.get()}loadedCount(){return this.loadedRounds.get().length}clear(){this.loadedRounds.set([]),this.curveRows.set([]),this.roundsWithStats.set(null),this.hasMore.set(!1),this.loaded.set(!1),this.error.set(null),this.extendError.set(null),this.filter.set(dt),this.pagesFetched=0,this.cursor=null,this.generation+=1}appendRounds(e){const t=new Set(this.loadedRounds.get().map(i=>i.roundId)),n=e.filter(i=>!t.has(i.roundId));n.length!==0&&this.loadedRounds.set([...this.loadedRounds.get(),...n])}}class mt{static PAGE_SIZE=50;static MAX_PAGES=8;phase=new p("idle");failure=new p(null);roundId=new p(null);holes=new p([]);round=new p(null);history=new p([]);dashboard=X.get(Le);inFlight=null;sgInfo=this.dashboard.sgInfo;model=new T(()=>{const e=this.round.get();return e===null?null:_f({round:e,holes:this.holes.get(),history:this.history.get(),bundle:this.dashboard.sgBundle.get()})});async load(e,t=!1){if(!t&&(this.roundId.get()===e||this.inFlight===e))return;this.dashboard.loadHandicap(),this.inFlight=e,this.phase.set("loading"),this.failure.set(null),this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]);let n;try{n=await w.playerStats.myRoundStats({roundId:e})}catch(o){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(xi(o)),this.failure.set(ki(o));return}if(this.inFlight!==e)return;let i;try{i=await this.walkHistory(e)}catch(o){if(this.inFlight!==e)return;this.inFlight=null,this.phase.set(xi(o)),this.failure.set(ki(o));return}if(this.inFlight!==e)return;this.inFlight=null;const r=i.find(o=>o.roundId===e)??null;if(r===null){this.phase.set("notFound");return}this.roundId.set(e),this.holes.set(n),this.round.set(r),this.history.set(i.filter(o=>o.roundId!==e)),this.phase.set("ready")}async walkHistory(e){const t=[],n=new Set,i=o=>{for(const d of o)n.has(d.roundId)||(n.add(d.roundId),t.push(d))};if(i(this.dashboard.loadedRounds.get()),vi(t,e,tn))return t;let r=null;for(let o=0;o<mt.MAX_PAGES;o++){const d=await w.playerStats.myStats({limit:mt.PAGE_SIZE,cursor:r??void 0}),c=Ut(d.rounds);if(c!==null)throw new Error(c);if(i(d.rounds),vi(t,e,tn)||d.nextCursor===null)return t;r=d.nextCursor}return t}clear(){this.roundId.set(null),this.holes.set([]),this.round.set(null),this.history.set([]),this.phase.set("idle"),this.failure.set(null),this.inFlight=null}}function xi(s){if(s instanceof Z){if(s.status===401||s.status===403)return"notAuthorized";if(s.status===404)return"notFound"}return"failed"}function ki(s){return s instanceof Z&&(s.status===404||s.status===401||s.status===403)?null:s instanceof Error?s.message:"Something went wrong."}const le=100,ba=88,sn=56,$i=56;function ms(s){return s>0?"loss":s<0?"gain":"zero"}function Ze(s,e){switch(s){case"gain":return e.gain;case"loss":return e.loss;case"zero":return e.zero;case"neutral":return e.neutral}}function H(s){return String(Math.round(s*1e3)/1e3)}function gs(s){return s<0?0:s>1?1:s}function Ce(s,e){return`<svg class="chart" viewBox="0 0 ${le} ${H(s)}" preserveAspectRatio="none" style="height:${H(s)}px" aria-hidden="true" focusable="false">${e}</svg>`}function In(s,e,t,n=1){return`<path d="M${H(s)} 0 L${H(s)} ${H(e)}" stroke="${t}" stroke-width="${H(n)}" vector-effect="non-scaling-stroke" fill="none"/>`}function ge(s,e,t,n,i){return`<rect x="${H(s)}" y="${H(e)}" width="${H(t)}" height="${H(n)}" fill="${i}"/>`}const $f=1;function Sf(s,e){const t=le/2,n=ms(s);if(!(e>0))return{zeroX:t,bar:null,tone:n};const i=Math.min(1,Math.abs(s)/e),r=Math.max(s===0?0:$f,t*i);return{zeroX:t,bar:{x:s>=0?t:t-r,width:r},tone:n}}function ya(s,e,t,n=10){const i=Sf(s,e),r=i.bar&&i.bar.width>0?ge(i.bar.x,0,i.bar.width,n,Ze(i.tone,t)):"";return Ce(n,[ge(0,0,le,n,t.track),r,In(i.zeroX,n,t.rule)].join(""))}function Tf(s){const e=[];let t=0;for(const n of s){const i=le*gs(n.share);e.push({id:n.id,x:t,width:i,color:n.color}),t+=i}return e}function Pf(s,e,t=12){const n=Tf(s).filter(i=>i.width>0).map(i=>ge(i.x,0,i.width,t,i.color)).join("");return Ce(t,ge(0,0,le,t,e.track)+n)}const Si=2,Cf=1e-4;function If(s,e=34){if(s.length===0)return[];const t=Math.min(...s),i=Math.max(...s)-t,r=Si,o=Math.max(0,e-Si*2);return s.map((d,c)=>({x:s.length===1?le/2:c/(s.length-1)*le,y:i===0?e/2:r+o-(d-t)/i*o}))}function Ef(s){return s.map((e,t)=>`${t===0?"M":"L"}${H(e.x)} ${H(e.y)}`).join(" ")}function Rf(s,e){const t=s[0],n=s[s.length-1];if(t===void 0||n===void 0)return"neutral";const i=n-t;return Math.abs(i)<=Cf?"neutral":(e==="percentage"?i>0:i<0)?"gain":"loss"}function Nf(s,e,t,n=34){const i=If(s,n);if(i.length===0)return Ce(n,"");const r=Ze(Rf(s,e),t),o=`<path d="${Ef(i)}" fill="none" stroke="${r}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" vector-effect="non-scaling-stroke"/>`,d=i[i.length-1],c=`<path d="M${H(d.x)} ${H(d.y)} L${H(d.x)} ${H(d.y)}" stroke="${r}" stroke-width="5" stroke-linecap="round" vector-effect="non-scaling-stroke" fill="none"/>`;return Ce(n,o+c)}const Of=.5;function Mf(s,e,t=12){const n=le/2,i=he.length-1,r=Math.max(1,(t-i)/he.length),o=[];return he.forEach((d,c)=>{const h=Qe(s,d);if(h===null||!(e>0))return;const u=Math.max(h===0?0:Of,n*Math.min(1,Math.abs(h)/e));o.push({component:d,x:h>=0?n:n-u,y:c*(r+1),width:u,height:r,tone:ms(h)})}),o}function Hf(s,e,t,n=12){const i=Mf(s,e,n).filter(r=>r.width>0).map(r=>ge(r.x,r.y,r.width,r.height,Ze(r.tone,t))).join("");return Ce(n,In(le/2,n,t.rule)+i)}const _a=1,Ti=.02;function Af(s,e){const t=e>0?le*Math.min(1,e):null;if(s===null)return{bar:null,tickX:t};const n=gs(s),i=e<=0?"neutral":s>e+Ti?"gain":s<e-Ti?"loss":"neutral";return{bar:{width:Math.max(_a,le*n),tone:i},tickX:t}}function Bf(s,e,t,n=10){const i=Af(s,e),r=i.bar?ge(0,0,i.bar.width,n,Ze(i.bar.tone,t)):"",o=i.tickX===null?"":In(i.tickX,n,t.rule,2);return Ce(n,ge(0,0,le,n,t.track)+r+o)}function zf(s){return s===null?null:Math.max(_a,le*gs(s))}function nn(s,e,t=e.neutral,n=8){const i=zf(s),r=i===null?"":ge(0,0,i,n,t);return Ce(n,ge(0,0,le,n,e.track)+r)}const Pi=100,Xt=50,Lf=16,Rt=22,Ci=44,Ff=3,Gf=33,Df={long:{from:315,to:405},right:{from:45,to:135},short:{from:135,to:225},left:{from:225,to:315}};function at(s,e){const t=(s-90)*Math.PI/180;return{x:Xt+e*Math.cos(t),y:Xt+e*Math.sin(t)}}function Ii(s,e,t,n){const i=e-s>180?1:0,r=at(s,n),o=at(e,n),d=at(e,t),c=at(s,t);return`M${H(r.x)} ${H(r.y)} A${H(n)} ${H(n)} 0 ${i} 1 ${H(o.x)} ${H(o.y)} L${H(d.x)} ${H(d.y)} A${H(t)} ${H(t)} 0 ${i} 0 ${H(c.x)} ${H(c.y)} Z`}function jf(s){const e=Math.max(s.long,s.short,s.left,s.right),t=Ff/2,n=[];for(const i of["long","right","short","left"]){const r=Df[i],o=r.from+t,d=r.to-t,c=e>0?gs(s[i]/e):0,h=Rt+(Ci-Rt)*c,u=at((r.from+r.to)/2,Gf);n.push({id:i,trackPath:Ii(o,d,Rt,Ci),valuePath:Ii(o,d,Rt,h),labelX:u.x,labelY:u.y})}return n}function qf(s,e,t,n=132){const i=s.map(r=>`<path d="${r.trackPath}" fill="${t.track}"/>`).join("")+s.map(r=>`<path d="${r.valuePath}" fill="${t.neutral}"/>`).join("")+`<circle cx="${H(Xt)}" cy="${H(Xt)}" r="${H(Lf)}" fill="${t.track}"/>`+s.map(r=>`<text x="${H(r.labelX)}" y="${H(r.labelY)}" fill="${t.rule}" font-size="7" text-anchor="middle" dominant-baseline="middle">${e[r.id]}</text>`).join("");return`<svg class="chart chart--compass" viewBox="0 0 ${Pi} ${Pi}" preserveAspectRatio="xMidYMid meet" style="width:${H(n)}px;height:${H(n)}px" aria-hidden="true" focusable="false">${i}</svg>`}const Vf=60,Qt=58,Uf=2,Kf={left:{x:6,width:24},centre:{x:38,width:24},right:{x:70,width:24}};function Wf(s,e){const t=Qt-Uf,n=o=>e>0?o/e*t:0,i=[],r=(o,d)=>{const c=Kf[o];let h=Qt;for(const u of d){const f=n(u.count);h-=f,i.push({id:u.id,column:o,tone:u.tone,x:c.x,y:h,width:c.width,height:f})}};return r("left",[{id:"left-inplay",tone:"inplay",count:s.leftInPlay},{id:"left-trouble",tone:"trouble",count:s.leftTrouble}]),r("centre",[{id:"fairway",tone:"fairway",count:s.fairway}]),r("right",[{id:"right-inplay",tone:"inplay",count:s.rightInPlay},{id:"right-trouble",tone:"trouble",count:s.rightTrouble}]),i}function Yf(s,e,t){const n=s.filter(i=>i.height>0).map(i=>ge(i.x,i.y,i.width,i.height,e[i.tone])).join("")+`<path d="M0 ${H(Qt)} L${H(le)} ${H(Qt)}" stroke="${t.rule}" stroke-width="1" vector-effect="non-scaling-stroke" fill="none"/>`;return Ce(Vf,n)}const bs={gain:l("accent-strong"),loss:l("danger"),zero:l("border-strong"),neutral:l("accent"),track:l("surface-sunken"),rule:l("border")},k={intro:"Every window is added up on this device from the rounds you have recorded.",loading:"Adding up your rounds…",noStats:"No rounds with statistics yet. Turn statistics on in your profile and they start filling in as you score.",windowEmpty:"No rounds match this window. Widen the filter, or clear it to go back to your last 10 rounds.",extending:"Loading more history…",extendProblemPrefix:"Showing the rounds loaded so far — fetching older ones failed: ",budgetSpent:"Showing the most recent rounds — this window stops short of your whole history.",notEnoughData:"Not enough data",notRecorded:"Not recorded",priorities:"Practice priorities",prioritiesHint:"Where your shots go, worst first, in strokes per 18 holes. Positive costs you shots.",prioritiesInfo:"How this works",trends:"Trends",trendsHint:"Oldest round on the left. A round with no reading is skipped, never plotted as zero.",roundsHeading:"Rounds in this window",roundsHint:"Each strip is that round’s five terms, on one shared scale.",filterClear:"Clear filter",filterRoundsHint:"Uncheck a round below to leave it out of a custom window.",filterBaseline:"Compared to",filterBaselineHint:"Which player the strokes-gained rows measure you against. It does not change which rounds are in the window.",troubleTax:"Extra strokes per hole when the tee shot finds trouble, against your own fairway holes.",penaltyTax:"Extra strokes per hole on the holes where you took a penalty, against your own penalty-free holes.",recovery:"Holes where the shot after trouble got you back in play.",penalties:"Penalty strokes per round.",noValue:Yr,proximityProxy:"How far the first putt was on greens you hit — a stand-in for approach proximity, which the app does not measure directly.",proximityOnGir:"The average distance of the first putt on greens you hit, from the metres you tapped in. Only greens with a metre recorded count.",greenAttemptsHit:"Greens hit at any point, including the ones you reached after regulation. Read against the row above it: regulation is ball-striking, this is position.",metersMade:"The metres of first putt you holed, added up. A one-putt from inside 1 m carries no distance, so it counts at a flat half metre.",makeCurve:"How often the first putt went in from each distance you have recorded, with the average putts from there beside it, and the putts each row counts. Only distances you have actually putted from appear. A distance with no row is one you have never recorded, not one you never hole.",makeCurveWindow:"This is your whole recorded history, not the window above. A window of a few rounds holds too few putts from any one distance to read.",chipOnGir:"Greens you hit where you still played a short-game shot, such as the greenside chip on a par 5 that made regulation. Up and in counts the hole where one putt, or the chip itself, finished it.",chipOnGirPar5:"The par-5 half of the same holes: greenside in two, chipped, and the putt for birdie went in.",birdieConversion:"Greens hit that became a birdie or better.",ladderBaseline:"The tick is the make rate your reference expects from that distance. For the two longest bands it sits at zero: the reference expects two putts from there, so any make is ahead of it.",ladderCost:"Cost is how many strokes this distance has cost you across the window, against the reference you picked. Plus means it cost you shots; minus means you gained them.",costOfMissedGreen:"What a hole costs you against par on average with the green hit, and with it missed.",missedGreenTax:"The difference between what a hole costs you with the green hit and with it missed.",threePutt:"Holes with three putts or more.",longThreePutt:"Three-putts that started from over 8 m.",puttsPerGir:"Putts taken on holes where you hit the green.",conversionInside2m:"First putts from inside 2 m that went in — across every hole, not only chipped ones. The app records no chip-and-hole cross-tab.",chipIns:"Short-game shots that went in without a putt.",vsParByTee:"What each kind of tee shot actually cost you, per hole. The trouble tax below is the difference between the last row and the first.",firstPuttSpread:"Where the first putt was on every hole you recorded one — not only the greens you hit.",puttsAfterMissedGreen:"Putts taken on holes where you missed the green.",puttsByPar:"Putts per hole on each kind of hole — every hole you recorded putts on, green hit or not.",hardChipShare:"How often a missed green left a hard chip or pitch rather than a standard one.",greenMissHead:"Where you miss the green",greenMiss:"Recorded misses only. Long is past the flag, short is in front of it.",teeFanHead:"Where your tee shots finish",teeFan:"Side is recorded whenever the drive left the fairway. The darker block is trouble.",scrambling:"Missed greens where you still got up and down for par or better.",sandSave:"Missed greens from a bunker where you still got up and down.",missMixHead:"What your missed greens leave you",missMix:"How your missed greens split between standard, hard and bunker lies. It describes the trouble your approaches leave behind, not how you play from it.",chipOutcomes:"What each missed green turned into. The rows share the same denominator — that difficulty’s attempts — so they add up to 100%. Holes where you did not count chips are treated as one chip.",multiChip:"Missed greens that took more than one shot to reach the green. Holes where you did not count are treated as one.",extraShortGameStrokes:"Short-game shots beyond one per missed green, across this window.",savedInside2m:"Chips that finished inside 2 m where the next putt went in. Beside “Chipped to inside 2 m” it splits a failed scramble into its two causes: a chip left too far out, or a makeable putt missed.",missCost:"Your average score against par on the holes where you missed the green, split by how hard the recovery was. The gap between the rows is what a hard miss actually costs over a standard one.",penaltySourceInfoTitle:"Where the penalties came from",resultsHeading:"Results",scoreTypesHead:"Holes by score",avgVsParByPar:"Your average score against par on each kind of hole.",doubleBogeyPlus:"Holes at double bogey or worse, per round.",doubleCausesHead:"Where your doubles come from",doubleCauses:"What manufactured each hole at double bogey or worse, grouped by where on the course the damage happened. One cause per hole, so the groups add up to 100%, and the indented rows split a group by mechanism.",doubleCausesOrder:"A hole gets one cause, checked strongest evidence first: penalty, then failed recovery, then more than one chip, then three putts, then trouble off the tee, then the long-game residual. A trouble tee shot you recovered from, followed by three putts, is a three-putt double — the tee shot was already paid for.",doubleCausesPenalty:"A penalty double is filed under the phase where the penalty happened: off the tee, on the approach, or around the green. One source is recorded per hole, so a hole with two penalties counts under its main one — and a penalty with no source recorded counts under “Not enough recorded”, because the phase is exactly what was not recorded.",doubleCausesLongGame:"“Full swing” is the long-game residual — strokes lost to full swings between tee and green. It is only claimed on a hole that recorded enough to rule everything else out: whether you hit the green, how many putts you took, where the tee shot finished on a par 4 or 5, and how hard the chip was when you missed.",doubleCausesUnattributed:"“Not enough recorded” is a double you did not record enough about to name. Those holes are counted, never dropped, and the row shrinks as you record more.",bounceBack:"Holes after a bogey or worse that came back at par or better."};function B(s,e,t){return{kind:"bar",id:s,title:e,share:t.value,value:ie(t)}}function Xf(s,e,t){return{kind:"bar",id:s,title:e,share:t.value,value:ie(t),sub:!0}}function K(s,e,t,n=null){return{kind:"figure",id:s,title:e,value:t,hint:n}}const Qf=["Holed","Cost"];function Jf(s){const e=s.value===null?k.notRecorded:`${s.value} holed`;if(s.cost===k.noValue)return`${s.title}, ${e}, ${k.notRecorded}`;const t=s.cost.replace(/^[+\u2212]/,"");return s.cost.startsWith("+")?`${s.title}, ${e}, ${t} strokes lost`:s.cost.startsWith("−")?`${s.title}, ${e}, ${t} strokes gained`:`${s.title}, ${e}, level`}const Zf=["Holed","Putts"];function em(s){const e=s.value===null?k.notRecorded:`${s.value} holed`;return`${s.title}, ${e}, ${s.avg} putts on average`}function tm(s){const e=x(s.onePutts,s.attempts);return{kind:"curve",id:`curve-${s.meters}`,title:`${nh(s.meters)}, ${re(s.attempts,Eu)}`,share:e.value,value:ie(e),avg:te(s.avgPutts,2)??k.noValue,attempts:s.attempts}}function sm(s,e){switch(s){case"tee":{const t=e.tee&&ie(e.tee.fairway);return t?`Fairways ${t}`:null}case"approach":{const t=e.approach&&ie(e.approach.gir);return t?`Greens in regulation ${t}`:null}case"putting":{const t=e.putting&&te(e.putting.puttsPerGirHole);return t?`${t} putts per green hit`:null}case"shortGame":{const t=e.shortGame&&ie(e.shortGame.scramble.overall);return t?`Scrambling ${t}`:null}case"scoring":return e.scoring?Au(e.scoring.doubleBogeyPlusPerRound,{unit:Se,label:"doubles or worse per round"}):null}}function nm(s){return K("troubleTax","Trouble tax",te(s.troubleTax,2,!0),null)}function Ve(s){return te(s,2,!0)}function im(s){const e={long:s.greenMiss.long.value??0,short:s.greenMiss.short.value??0,left:s.greenMiss.left.value??0,right:s.greenMiss.right.value??0},t=i=>ie(i)??"",n=(i,r)=>`${i} ${ie(r)??k.notRecorded}`;return{kind:"compass",id:"greenMiss",sectors:jf(e),labels:{long:t(s.greenMiss.long),short:t(s.greenMiss.short),left:t(s.greenMiss.left),right:t(s.greenMiss.right)},text:[n("Long",s.greenMiss.long),n("Short",s.greenMiss.short),n("Left",s.greenMiss.left),n("Right",s.greenMiss.right)].join(" · "),recorded:s.greenMissRecorded}}function rm(s){const e=s.teeFan;return{kind:"fan",id:"teeFan",columns:Wf(e,s.teeRecorded),text:[`Left ${de(e.leftInPlay+e.leftTrouble)}`,`Fairway ${de(e.fairway)}`,`Right ${de(e.rightInPlay+e.rightTrouble)}`].join(" · "),recorded:s.teeRecorded}}function am(s){return s.vsParByTee.fairway.d>0||s.vsParByTee.inPlay.d>0||s.vsParByTee.trouble.d>0}function om(s){switch(s){case"penalty":return"Penalty";case"failedRecovery":return"Failed recovery";case"multiChip":return"More than one chip";case"threePutt":return"Three putts";case"troubleTee":return"Trouble off the tee";case"fullSwing":return"Long game";case"unattributed":return"Not enough recorded"}}function lm(s){switch(s){case"offTee":return"Off the tee";case"longGame":return"Long game";case"shortGame":return"Short game";case"threePutt":return"Three putts";case"unattributed":return"Not enough recorded"}}function dm(s){switch(s){case"troubleTee":return"Trouble off the tee";case"failedRecovery":return"Failed recovery";case"fullSwing":return"Full swing";case"multiChip":return"More than one chip";case"penaltyTee":case"penaltyApproach":case"penaltyShort":return"Penalty"}}function Ei(s,e){switch(s){case"tee":{const t=e.tee;return t?[{kind:"split",id:"teeSplit",segments:[{id:"fairway",title:"Fairway",tone:"fairway",share:t.fairway.value,value:ie(t.fairway)},{id:"inPlay",title:"In play",tone:"inplay",share:t.inPlayOnly.value,value:ie(t.inPlayOnly)},{id:"trouble",title:"Trouble",tone:"trouble",share:t.trouble.value,value:ie(t.trouble)}]},...t.teeMissRecorded>0?[{kind:"subhead",id:"teeFanHead",text:k.teeFanHead},rm(t)]:[],...am(t)?[{kind:"subhead",id:"vsParByTeeHead",text:"Average vs par, by where the tee shot finished"},K("vsParFairway","From the fairway",Ve(t.vsParByTee.fairway)),K("vsParInPlay","From in play",Ve(t.vsParByTee.inPlay)),K("vsParTrouble","From trouble",Ve(t.vsParByTee.trouble))]:[],nm(t),B("recovery","Recovery",t.recovery),...t.penaltiesRecordedHoles>0?[K("penalties","Penalties",te(t.penaltiesPerRound,2)),B("penaltyHoleShare","Holes with a penalty",t.penaltyHoleShare),K("penaltyTax","Penalty tax",te(t.penaltyTax,2,!0))]:[]]:[]}case"approach":{const t=e.approach;return t?[...t.greenHitLate>0?[{kind:"subhead",id:"greensHitHead",text:"Greens hit"},B("girInRegulation","In regulation",t.gir),B("greenAttemptsHit","Including over regulation",t.greenAttemptsHit)]:[],...t.greenMissRecorded>0?[{kind:"subhead",id:"greenMissHead",text:k.greenMissHead},im(t)]:[],{kind:"subhead",id:"girByTee",text:"Greens hit, by where the tee shot finished"},B("girFairway","From the fairway",t.girByTee.fairway),B("girInPlay","From in play",t.girByTee.inPlay),B("girTrouble","From trouble",t.girByTee.trouble),{kind:"subhead",id:"girByParHead",text:"Greens hit, by par"},B("girPar3","Par 3",t.girByPar.par3),B("girPar4","Par 4",t.girByPar.par4),B("girPar5","Par 5",t.girByPar.par5),{kind:"subhead",id:"mixHead",text:"Proximity with GIR"},...t.proximityOnGir.d>0?[K("proximityOnGir","Average first putt",ih(t.proximityOnGir))]:[],...Fe.map(n=>B(`mix-${n}`,Es(n),t.girFirstPuttMix[n])),B("birdieConversion","Birdie conversion",t.birdieConversion),...t.hardChipShare.d>0?[B("hardChipShare","Hard misses",t.hardChipShare)]:[],...t.costOfMissedGreen.hit.d>0||t.costOfMissedGreen.miss.d>0?[{kind:"subhead",id:"missedGreenHead",text:"Cost of a missed green"},K("vsParGreenHit","Green hit",te(t.costOfMissedGreen.hit,2,!0)),K("vsParGreenMissed","Green missed",te(t.costOfMissedGreen.miss,2,!0)),K("missedGreenTax","Missed-green tax",te(t.costOfMissedGreen.delta,2,!0))]:[]]:[]}case"putting":{const t=e.putting;return t?[...t.firstPuttSpread[Fe[0]].d>0?[{kind:"subhead",id:"firstPuttHead",text:"First putt, all holes"},...Fe.map(n=>B(`spread-${n}`,Es(n),t.firstPuttSpread[n]))]:[],{kind:"subhead",id:"ladderHead",text:"Holed on the first putt"},{kind:"columns",id:"ladderCols",cells:[...Qf]},...t.ladder.map(n=>({kind:"rung",id:`rung-${n.bucket}`,title:Es(n.bucket),made:n.made.value,baseline:n.baseline,value:ie(n.made),cost:sh(n.cost)})),...t.curve.length>0?[{kind:"subhead",id:"makeCurveHead",text:"Holed, by distance"},{kind:"columns",id:"curveCols",cells:[...Zf]},...t.curve.map(tm)]:[],...t.metersMadeHoles>0?[K("metersMade","Metres of first putts holed",rh(t.metersMade))]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttCountHead",text:"Holes by putts"},B("putts-zero","No putts",t.puttDistribution.zero),B("putts-one","One putt",t.puttDistribution.one),B("putts-two","Two putts",t.puttDistribution.two),B("putts-threePlus","Three or more",t.puttDistribution.threePlus)]:[],B("longThreePutt","Three-putts from over 8 m",t.threePuttsFromOver8m),K("puttsPerGir","Putts per green hit",te(t.puttsPerGirHole,2)),...t.puttsAfterMissedGreen.d>0?[K("puttsAfterMissedGreen","Putts after a missed green",te(t.puttsAfterMissedGreen,2))]:[],...t.puttDistribution.zero.d>0?[{kind:"subhead",id:"puttsByParHead",text:"Putts per hole, by par"},K("puttsPar3","Par 3",te(t.puttsPerHoleByPar.par3,2)),K("puttsPar4","Par 4",te(t.puttsPerHoleByPar.par4,2)),K("puttsPar5","Par 5",te(t.puttsPerHoleByPar.par5,2))]:[]]:[]}case"shortGame":{const t=e.shortGame;if(!t)return[];const n=(o,d,c,h)=>h>0?[{kind:"subhead",id:`${o}Head`,text:d},B(`${o}ChipIn`,"Holed the chip",c.chipIn),B(`${o}OnePutt`,"One putt",c.onePutt),B(`${o}TwoPutt`,"Two putts",c.twoPutt),B(`${o}ThreePutt`,"Three or more putts",c.threePlus),...t.shortGameStrokesRecorded>0?[B(`${o}MultiChip`,"More than one chip",c.multiChip)]:[]]:[],i=t.scramble.standard.d+t.scramble.hard.d+t.scrambleAttemptsBunker,r=[{kind:"subhead",id:"missMixHead",text:k.missMixHead},{kind:"split",id:"difficultyMix",segments:[{id:"standard",title:"Standard",tone:"fairway",share:t.mix.standard.value,value:ie(t.mix.standard)},{id:"hard",title:"Hard",tone:"inplay",share:t.mix.hard.value,value:ie(t.mix.hard)},...t.scrambleAttemptsBunker>0?[{id:"bunker",title:"Bunker",tone:"trouble",share:t.mix.bunker.value,value:ie(t.mix.bunker)}]:[]]},{kind:"subhead",id:"scrambleHead",text:"Scrambling"},B("scrambleStandard","Standard",t.scramble.standard),B("scrambleHard","Hard",t.scramble.hard),...t.scrambleAttemptsBunker>0?[B("scrambleBunker","Bunker",t.scramble.bunker)]:[],...t.scrambleAttemptsBunker>0?[B("sandSave","Sand save",t.sandSave)]:[],...t.shortGameStrokesRecorded>0?[K("extraShortGameStrokes","Extra short-game shots",String(t.extraShortGameStrokes))]:[],...n("afterStandard","After a standard chip",t.outcomes.standard,t.scramble.standard.d),...n("afterHard","After a hard chip",t.outcomes.hard,t.scramble.hard.d),...n("afterBunker","After a bunker shot",t.outcomes.bunker,t.scrambleAttemptsBunker),...t.missCost.standard.d>0||t.missCost.hard.d>0||t.missCost.bunker.d>0?[{kind:"subhead",id:"missCostHead",text:"Average vs par, by how hard the miss was"},K("missCostStandard","Standard",Ve(t.missCost.standard)),K("missCostHard","Hard",Ve(t.missCost.hard)),...t.scrambleAttemptsBunker>0||t.missCost.bunker.d>0?[K("missCostBunker","Bunker",Ve(t.missCost.bunker))]:[]]:[],{kind:"subhead",id:"chipHead",text:"Chipped to inside 2 m"},B("chipStandard","Standard",t.chipInside2m.standard),B("chipHard","Hard",t.chipInside2m.hard),...t.scrambleAttemptsBunker>0?[B("chipBunker","Bunker",t.chipInside2m.bunker)]:[],B("savedInside2m","Saved when inside 2 m",t.savedInside2m.overall),B("conversionInside2m","Holed from inside 2 m",t.conversionInside2m),{kind:"subhead",id:"chipInsHead",text:"Chip-ins"},K("chipInsStandard","Standard",de(t.chipIns.standard)),K("chipInsHard","Hard",de(t.chipIns.hard)),...t.scrambleAttemptsBunker>0?[K("chipInsBunker","Bunker",de(t.chipIns.bunker))]:[]];return[...i>0?r:[],...t.chipOnGir.d>0?[{kind:"subhead",id:"chipOnGirHead",text:"Chipped on a green in regulation"},B("chipOnGir","Up and in",t.chipOnGir),...t.chipOnGirPar5Birdie.d>0?[B("chipOnGirPar5","Par 5, for birdie",t.chipOnGirPar5Birdie)]:[]]:[]]}case"scoring":{const t=e.scoring;if(!t)return[];const n=i=>te(i,2,!0);return[{kind:"subhead",id:"vsParHead",text:"Average vs par"},K("par3","Par 3",n(t.avgVsParByParGroup.par3)),K("par4","Par 4",n(t.avgVsParByParGroup.par4)),K("par5","Par 5",n(t.avgVsParByParGroup.par5)),K("doubles","Doubles or worse",te(t.doubleBogeyPlusPerRound,2)),...t.doubleBogeyPlusHoles>0?[{kind:"subhead",id:"doubleCausesHead",text:k.doubleCausesHead},...t.doubleCauseGroups.flatMap(i=>[B(`dblGroup-${i.id}`,lm(i.id),i.share),...i.subs.map(r=>Xf(`dblCause-${r.id}`,dm(r.id),r.share))])]:[],B("bounceBack","Bounce-back",t.bounceBack)]}}}function cm(s){if(!s||s.rounds===0)return"";const e=re(s.rounds,Se);if(s.lengths.length<=1)return e;const t=s.lengths.map(n=>`${de(n.rounds)} × ${re(n.holeCount,Q)}`).join(", ");return`${e} — ${t}`}function um(s){return s===18?"Best 18":s===9?"Best 9":`Best ${de(s)} holes`}const hm=18;function pm(s){return s.lengths.some(t=>t.holeCount!==hm)?"scaled to 18":null}function Bs(s){if(!s)return[];const e=[];s.avgVsParPer18.value!==null&&e.push({id:"avgVsPar",label:"Average vs par",value:xe(s.avgVsParPer18.value,1),qualifier:pm(s),hero:!0});for(const t of s.lengths){const n=t.best;n&&e.push({id:`best-${t.holeCount}`,label:um(t.holeCount),value:cs(n.vsPar),qualifier:`${de(n.strokes)} strokes`,hero:!1})}return e}function fm(s){switch(s){case"eagleOrBetter":return"Eagle or better";case"birdie":return"Birdie";case"par":return"Par";case"bogey":return"Bogey";case"doubleBogeyPlus":return"Doubles or worse"}}function Nt(s){if(!s||s.holesScored===0)return[];const e=s.holesScored;return Hc.map(t=>{const n=s.scoreTypeCounts[t];return{id:t,title:fm(t),share:x(n,e).value,value:ie(x(n,e))??k.noValue}})}function mm(s){return s===1?"This round has no data for it.":`None of these ${s} rounds has data for it.`}function Ri(s){const e=(s.name??"").trim();return e||(s.courseName??"").trim()||"Round"}const _e={title:"How practice priorities work",holesCounted(s){const{attributed:e,holesScored:t,windowRounds:n}=s,i=n===0?"this round’s ":"your ";return e===0?`None of ${n===0?"this round’s":"your"} ${t} holes has the full set of answers yet, so there is nothing to show. A hole counts once it has a tee answer, a green answer and a putt answer.`:e===t?`All ${t} of ${n===0?"this round’s":"your"} holes could be fully attributed.`:`${e} of ${i}${t} holes could be fully attributed — the others are missing a tee, green or putt answer, so they are left out of every row rather than guessed at.`},fiveRows(){return"Each row is what that part of your game cost you against the Tapscore reference baseline v1 — a strokes gained-style method, worked out from the answers you tap rather than from shot distances. The five rows add up to your score against the baseline exactly; there is no leftover row."},baseline(s,e){const t=s?.baseline??uu,n=e===void 0?bt[t.cohort].tables.calibratedAt:e,i=`under “${k.filterBaseline}” in Filters`,r=ht(t.cohort),o=t.choice!=="auto"?`Measured against the ${r} reference — you picked this ${i}.`:t.handicapIndex===null?`Measured against the ${r} reference — no handicap on your profile yet. Change it ${i}.`:`Measured against the ${r} reference — matched to your ${vn(t.handicapIndex)} handicap. Change it ${i}.`,d="Each tier is one set of expected scores per hole and per lie.";return n===null?`${o} ${d} The tiers are still provisional, so treat the order of the rows as the reading and the sizes as rough.`:`${o} ${d} This tier was frozen on ${n}. Everyone on this reference is measured against the same table, so your rows can be compared with each other and with your own earlier rounds.`},per18(){return`Rows are scaled to 18 attributed holes, so a nine and an eighteen sit on the same scale. A round with fewer than ${Dr} attributed holes is left out of the comparison entirely.`},total(s){const e=gm(s.rowsPer18);if(e===null)return null;const t=xe(e);return s.windowRounds===0?`The five rows add up to ${t} strokes against the baseline.`:s.windowRounds===1?`Over this round the five rows add up to ${t} strokes against the baseline.`:`Over these ${s.windowRounds} rounds the five rows add up to ${t} strokes against the baseline.`},penaltySource(s){const e=s.penaltySource;return e===void 0||e.recorded<=0?null:`Of ${re(e.recorded,Gu)} you labelled, ${de(e.tee)} came off the tee, ${de(e.approach)} on the approach and ${de(e.short)} around the green.`}};function gm(s){if(s.length===0)return null;let e=0;for(const t of s){if(t===null)return null;e+=t}return e}function Jt(s){return{recorded:s.penaltySourceRecorded,tee:s.penaltiesTee,approach:s.penaltiesApproach,short:s.penaltiesShort}}function Zt(s){const e=[{id:"holes",title:"Holes counted",body:_e.holesCounted(s)},{id:"rows",title:"The five rows",body:_e.fiveRows()},{id:"baseline",title:"The baseline",body:_e.baseline(s)},{id:"per18",title:"Per 18 holes",body:_e.per18()}],t=_e.total(s);t!==null&&e.push({id:"total",title:"The total",body:t});const n=_e.penaltySource(s);return n!==null&&e.push({id:"penaltySource",title:k.penaltySourceInfoTitle,body:n}),e}const ne={loading:"Reading the round…",noStatsInRound:"No statistics of your own in this round. Only the player whose card carried them can see them.",notSignedIn:"Sign in to see your own statistics for a round.",failedPrefix:"Could not read the round: ",holeStripHeading:"Hole by hole",waterfallHeading:"Where the round went",legendHeading:"Reading the strip",nothingRecordedOnHole:"Nothing was recorded on this hole.",noHoleStrip:"No hole-by-hole detail for this round.",waterfallHint:"Strokes lost against a fixed baseline. Positive costs you shots.",legendTee:"Dot — where the tee shot finished: green fairway, brass in play, terracotta trouble.",legendGir:"Ring — green in regulation: filled hit, hollow missed.",legendPutts:"Number — putts taken on the hole.",legendPenalty:"Flag — a penalty stroke.",legendAbsence:"Anything you did not record is left out: an empty row is a hole nobody answered, not a hole answered no."},Ni={title:"Your round",seeWholeRound:"See the whole round"};function bm(s){const e=[ea(s.date)],t=(s.courseName??"").trim();return t!==""&&t!==s.title&&e.push(t),e.push(s.holeCount===1?"1 hole":`${s.holeCount} holes`),e.join(" · ")}function va(s,e){return s===null?null:e===null?String(s):`${s} (${cs(e)})`}function ym(s){let e=`Hole ${s.holeNumber} · par ${s.par}`;return s.lengthM!==null&&(e+=` · ${s.lengthM} m`),e}function _m(s){return s.strokes!==null?String(s.strokes):s.isPickedUp?"–":"·"}function vm(s){return s.isPickedUp?"Picked up":s.strokes===null?null:s.vsPar===null?String(s.strokes):`${s.strokes} (${cs(s.vsPar)})`}function wm(s){switch(s){case"fairway":return"Fairway";case"in_play":return"In play";case"trouble":return"Trouble"}}function xm(s){switch(s){case"inside_1m":return"Inside 1 m";case"1_to_2m":return"1–2 m";case"2_to_4m":return"2–4 m";case"4_to_8m":return"4–8 m";case"over_8m":return"Over 8 m";case"inside_2m":return"Inside 2 m";case"2_to_6m":return"2–6 m";case"over_6m":return"Over 6 m"}}function km(s){return s==="hard"?"Hard chip or pitch":"Standard chip or pitch"}function $m(s){switch(s){case"ring":return"Birdie";case"double_ring":return"Eagle";case"diamond":return"Albatross or hole in one";case"square":return"Bogey";case"double_square":return"Double bogey";case"box_badge":return"Triple bogey or worse"}}function En(s){const e=[],t=vm(s);return t!==null&&e.push({label:"Score",value:t}),s.doubleCause!==null&&e.push({label:"Mainly from",value:om(s.doubleCause)}),s.tee!==null&&e.push({label:"Tee shot",value:wm(s.tee)}),s.gir!==null&&e.push({label:"Green in regulation",value:s.gir?"Hit":"Missed"}),s.putts!==null&&e.push({label:"Putts",value:s.putts===1?"1 putt":`${s.putts} putts`}),s.firstPutt!==null&&e.push({label:"First putt",value:xm(s.firstPutt)}),s.shortGame!==null&&e.push({label:"Short game",value:km(s.shortGame)}),s.recoveryOk!==null&&e.push({label:"Recovery",value:s.recoveryOk?"Back in play":"Still in trouble"}),s.penalties!==null&&e.push({label:"Penalties",value:s.penalties===0?"None":s.penalties===1?"1 stroke":`${s.penalties} strokes`}),e}function Sm(s){return s===null?[]:En(s).map(e=>({...e,key:`${s.id}:${e.label}`}))}function Oi(s){const e=[`Hole ${s.holeNumber}`,`par ${s.par}`];s.isPickedUp?e.push("picked up"):s.strokes!==null?(e.push(s.strokes===1?"1 stroke":`${s.strokes} strokes`),s.marker!==null&&e.push($m(s.marker).toLowerCase())):e.push("no score");for(const t of En(s))t.label!=="Score"&&e.push(`${t.label.toLowerCase()} ${t.value.toLowerCase()}`);return`${e.join(", ")}.`}function wa(s,e){const t=e===1?"round":`last ${e} rounds`;if(Math.abs(s)<.05)return e===1?"The same as your previous round.":`The same as your ${t}.`;const n=s>0?"worse":"better",i=me(Math.abs(s),1);return e===1?`${i} ${n} than your previous round.`:`${i} ${n} than your ${t}.`}function Mi(s){switch(s){case"tee":return"Your tee shots";case"approach":return"Your approach play";case"shortGame":return"Your short game";case"putting":return"Putting";case"penalties":return"Penalties"}}function zs(s,e=1){return typeof s=="number"?me(Math.abs(s),e):""}function Me(s){return typeof s=="number"?String(Math.round(s)):""}function Hi(s){return typeof s=="string"?s:"tee"}function Tm(s){const e=s.params;switch(s.id){case"component_best_vs_baseline":return`${Mi(Hi(e.component))} was ${zs(e.delta)} strokes better than your recent rounds.`;case"component_worst_vs_baseline":return`${Mi(Hi(e.component))} cost you ${zs(e.delta)} strokes more than your recent rounds.`;case"penalties_spike":{const t=typeof e.penalties=="number"?Math.round(e.penalties):0;return`${t===1?"1 penalty stroke":`${t} penalty strokes`}, against ${zs(e.baseline)} in a normal round.`}case"two_way_miss":return`Your tee misses are split ${Me(e.left)} left and ${Me(e.right)} right of ${Me(e.recorded)} — you are missing both ways.`;case"scramble_streak":return`You saved par ${Me(e.successes)} of the ${Me(e.attempts)} times you missed the green.`;case"hard_scramble_streak":return`You saved par from all ${Me(e.attempts)} of the hard spots you were in.`;case"three_putt_free":return`No three-putts — ${Me(e.putts)} putts across the round.`;case"best_putting_round":{const t=typeof e.rounds=="number"?Math.round(e.rounds):0;return t===1?"Your best putting of the last round.":`Your best putting of the last ${t} rounds.`}case"bounce_back_perfect":{const t=typeof e.opportunities=="number"?Math.round(e.opportunities):0;return t===1?"You came straight back after your dropped shot.":`You came straight back after all ${t} of your dropped shots.`}}}const Pm=y(`
...
${fs}
    `;round=this.inject(be);stats=this.inject(mt);auth=this.inject(U);router=this.inject(q);colors=bs;infoOpen=new p(!1);render(){this.track(C(()=>{const i=this.eligibleRoundId();J(()=>{i!==null&&this.stats.load(i).catch(()=>{})})}));const e=()=>this.shows()?this.stats.model.get():null,t=this.wire(Pm,{story:{className:()=>this.shows()?"story":"story hidden"},title:()=>Ni.title,score:()=>{const i=e();return i===null?"":va(i.strokes,i.vsPar)??""},hint:()=>e()===null?"":this.hint(),infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:i=>{i.target===i.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},open:{textContent:()=>Ni.seeWholeRound,onclick:()=>{const i=this.stats.roundId.get();i!==null&&this.router.navigate("/round-stats",{query:{id:i}})}}}),n=i=>{const r=e();return r===null?null:Qe(r.waterfall,i)};return this.$each(this.ref(t,"values"),()=>e()===null?[]:[...he],(i,r,o)=>this.wireEl(Im,{label:()=>us(i),amount:{textContent:()=>{const d=n(i);return d===null?k.notRecorded:xe(d)},className:()=>n(i)===null?"story__valueamount story__valueamount--absent":"story__valueamount",style:()=>{const d=n(i);return d===null?"":`color:${Ze(ms(d),this.colors)}`}}},o),i=>i),this.$each(this.ref(t,"infoCards"),()=>{const i=e();return i===null?[]:Zt({attributed:i.waterfall.coverage.attributed,holesScored:i.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:he.map(r=>Pe(i.waterfall,r)),penaltySource:Jt(i.panels.totals),baseline:this.stats.sgInfo.get()})},(i,r,o)=>this.wireEl(vt,{ctitle:()=>i.title,ctext:()=>i.body},o),i=>i.id),this.$each(this.ref(t,"lines"),()=>e()?.insights??[],(i,r,o)=>this.wireEl(Cm,{text:()=>Tm(i)},o),i=>i.id),t}eligibleRoundId(){const e=this.round.round.get();return e===null?null:fa({signedInPlayerId:this.auth.currentUser.get()?.id??null,statConfigPlayerIds:new Set(this.round.statModules.get().keys()),statRows:this.round.statRows.get(),holesUnscored:ma({playerId:this.auth.currentUser.get()?.id??"",balls:this.round.balls.get(),groups:this.round.groups(),strokesFor:(n,i)=>this.round.strokesFor(n,i)})}).reason==="eligible"?e.id:null}shows(){const e=this.eligibleRoundId();return e===null?!1:this.stats.phase.get()==="ready"&&this.stats.roundId.get()===e}hint(){const e=this.stats.model.get();if(e===null)return"";if(e.deltas===null)return ne.waterfallHint;let t=null;for(const n of he){const i=yn(e.deltas,n);i!==null&&(t===null||Math.abs(i)>Math.abs(t))&&(t=i)}return t===null?ne.waterfallHint:wa(t,e.windowCount)}}function Ai(s){return!(!s.pageVisible||s.status==="complete")}function Rm(s,e){return e&&!s}const Nm=2,Bi=3,Om=75e3;function Mm(s,e=null){const t=new URLSearchParams({token:s});return e!==null&&t.set("since",e),`${Y}/friendly-rounds/events?${t.toString()}`}function Hm(s){if(typeof s!="object"||s===null)return!1;const e=s;return e.latestEventId!==null&&typeof e.latestEventId!="string"?!1:e.status==="not_started"||e.status==="active"||e.status==="complete"}function Am(s){const e=s.eventSourceFactory??(N=>new EventSource(N)),t=s.setTimer??((N,V)=>setTimeout(N,V)),n=s.clearTimer??(N=>clearTimeout(N)),i=s.livenessTimeoutMs??Om,r=s.isPageVisible??(()=>typeof document>"u"||!document.hidden);let o=!1,d=0,c=null,h=null,u=s.since??null;const f=()=>{h!==null&&(n(h),h=null)},m=()=>{f(),h=t($,i)},b=()=>{c!==null&&(c.onopen=null,c.onmessage=null,c.onerror=null,c.close(),c=null)},g=()=>{o=!0,f(),b()},v=()=>{if(b(),++d>=Bi){g(),s.onDegrade();return}R()};function $(){if(!o){if(!r()){m();return}v()}}function R(){if(o)return;let N;try{N=e(Mm(s.token,u))}catch{g(),s.onDegrade();return}c=N,N.onopen=()=>{d=0},N.onmessage=V=>{if(o||c!==N)return;m();let M;try{M=JSON.parse(V.data)}catch{return}Hm(M)&&(M.latestEventId!==null&&(u=M.latestEventId),s.onEvent({latestEventId:M.latestEventId,status:M.status}))},N.onerror=()=>{o||c!==N||(N.readyState===Nm||++d>=Bi)&&(g(),s.onDegrade())},m()}return R(),{stop:()=>{o||g()}}}const Bm=2e4;function zm(s){if(!(s===null||s===""))return/^\d+$/.test(s)?Number(s):s}const Lm=y(`
...
`),Fm=y('<button bind="pill" class="round-view__fmt" type="button"></button>'),Gm=y('<button bind="pill" class="round-view__grp" type="button"></button>');class Dm extends A{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class Tg extends A{static styles=`
    ...
    `;auth=this.inject(U);router=this.inject(q);nextQ=this.router.query("next");mode=new p("login");busy=new p(!1);formError=new p("");username="";password="";displayName="";hcp="";gender=new p(null);clubs=new p([]);homeClubId=new p("");clubsRequested=!1;async loadClubs(){if(!this.clubsRequested){this.clubsRequested=!0;try{this.clubs.set(await w.setup.clubs())}catch{}}}destination(e){const t=this.nextQ.get();return t&&t.startsWith("/")?t:e}async submit(){if(this.formError.set(""),this.mode.get()==="login"){if(!this.username.trim()||this.password===""){this.formError.set("Enter your username and password.");return}this.busy.set(!0);try{const n=await Pa.login(this.username.trim(),this.password);this.auth.currentUser.set(n),this.auth.error.set(null),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(Ui(n,"login"))}finally{this.busy.set(!1)}return}const e=this.hcp.trim(),t=e===""?null:we(e);if(e!==""&&t===null){this.formError.set("Handicap index must be a number (or leave it empty).");return}if(this.password.length<8){this.formError.set("Password must be at least 8 characters.");return}if(!this.username.trim()||!this.displayName.trim()){this.formError.set("Username and display name are required.");return}this.busy.set(!0);try{const n=await w.players.register({username:this.username.trim(),password:this.password,displayName:this.displayName.trim(),handicapIndex:t,gender:this.gender.get(),homeClubId:this.homeClubId.get()||null});this.auth.currentUser.set({id:n.id,username:n.username}),this.router.navigate(this.destination("/"),!0)}catch(n){this.formError.set(Ui(n,"register"))}finally{this.busy.set(!1)}}render(){const e=()=>this.mode.get()==="register",t=()=>this.auth.loading.get()||this.busy.get(),n=this.wire(Sg,{root:{inert:()=>t()},error:{className:()=>this.formError.get()?"error show":"error",textContent:()=>this.formError.get()},form:{onsubmit:async o=>{o.preventDefault(),await this.submit()}},username:{oninput:o=>{this.username=o.target.value}},password:{autocomplete:()=>e()?"new-password":"current-password",oninput:o=>{this.password=o.target.value}},registerFields:{className:()=>e()?"login__register":"login__register hidden"},displayName:{oninput:o=>{this.displayName=o.target.value}},hcp:{oninput:o=>{this.hcp=o.target.value}},submit:{textContent:()=>t()?e()?"Creating account…":"Signing in…":e()?"Create account":"Sign in"},toggle:{textContent:()=>e()?"Have an account? Sign in":"New here? Create an account",onclick:()=>{this.formError.set(""),this.auth.error.set(null);const o=!e();this.mode.set(o?"register":"login"),o&&this.loadClubs()}}}),i=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(n,"gender"),()=>i,(o,d,c)=>this.wireEl(y('<button bind="b" type="button"></button>'),{b:{textContent:()=>o.label,className:()=>this.gender.get()===o.value?"on":"",onclick:()=>this.gender.set(o.value)}},c),o=>o.label);const r=new pe({value:this.homeClubId,options:{get:()=>[{value:"",label:"No home club"},...this.clubs.get().map(o=>({value:o.id,label:o.name}))]},placeholder:"No home club"});return r.mount(this.ref(n,"club")),this.track(()=>r.destroy()),n}}const Pg=y(`
    <div class="friends">
...
`),Cg='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="8.5" cy="7.5" r="3.25"/><path d="M2.5 20c.5-3.5 2.7-5.5 6-5.5 2.7 0 5.1 1.8 5.8 4.5"/><circle cx="17.5" cy="16.5" r="4.25"/><path d="M15.5 16.5h4"/></svg>',Ig=y(`
    <div class="friend-row">
        ${Re("friend-row__badge")}
...
`),Ki=y(`
    <div class="friend-row">
        ...
        <span bind="hcp" class="friend-row__hcp"></span>
        <button bind="remove" class="friend-row__remove" type="button" aria-label="Remove friend">${Cg}</button>
    </div>
`);class Eg extends A{static styles=`
    ...
    `;svc=this.inject(is);auth=this.inject(U);router=this.inject(q);removeOpen=new p(!1);removeTarget=new p(null);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Pg,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:r=>this.svc.setQuery(r.target.value)},searchHint:{textContent:()=>{const r=this.svc.query.get().trim();return r.length>0&&!Gn(r)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const r=this.svc.query.get().trim();return Gn(r)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===r&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&Ct(this.svc.friends.get()).mutual.length===0?"friends__empty":"friends__empty hidden"},connectionsSection:{className:()=>Ct(this.svc.friends.get()).addedByMe.length>0?"friends__section":"friends__section hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(r,o,d)=>this.wireEl(Ig,{...Te(()=>this.svc.results.get().find(c=>c.id===r.id)??r),name:()=>r.displayName,username:()=>r.homeClubName?`@${r.username} · ${r.homeClubName}`:`@${r.username}`,hcp:()=>r.handicapIndex===null?"–":r.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(r.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const c=this.svc.results.get().find(h=>h.id===r.id);c&&!c.isFriend&&this.svc.add(c)}},added:{className:()=>this.isFriendNow(r.id)?"friend-row__added":"friend-row__added hidden"}},d),r=>r.id);const n=new Date().toISOString();this.$each(this.ref(t,"friends"),()=>Ft(Ct(this.svc.friends.get()).mutual,this.svc.sortMode.get()),(r,o,d)=>this.wireEl(Ki,this.friendRowBindings(r,n),d),r=>r.id),this.$each(this.ref(t,"connections"),()=>Ft(Ct(this.svc.friends.get()).addedByMe,this.svc.sortMode.get()),(r,o,d)=>this.wireEl(Ki,this.friendRowBindings(r,n),d),r=>r.id),this.spawn(oe,this.ref(t,"removeConfirmHost"),{open:this.removeOpen,title:()=>{const r=this.removeTarget.get();return r?`Remove ${r.displayName} from friends?`:"Remove friend?"},message:()=>{const r=this.removeTarget.get();return r?`${r.displayName} will disappear from your friends list. You can add them again later.`:"They will disappear from your friends list. You can add them again later."},confirmLabel:"Remove friend",cancelLabel:"Cancel",danger:!0,onconfirm:()=>{const r=this.removeTarget.get();r&&this.svc.remove(r.id)}});const i=r=>{r.key==="Escape"&&this.removeOpen.get()&&this.removeOpen.set(!1)};return window.addEventListener("keydown",i),this.track(()=>window.removeEventListener("keydown",i)),t}liveFriend(e){return this.svc.friends.get().find(t=>t.id===e.id)??e}askRemove(e){const t=this.liveFriend(e);this.removeTarget.set({id:t.id,displayName:t.displayName}),this.removeOpen.set(!0)}friendRowBindings(e,t){return{...Te(()=>this.svc.friends.get().find(n=>n.id===e.id)??e),open:{disabled:()=>!this.liveFriend(e).isMutual,onclick:()=>{const n=this.liveFriend(e);n.isMutual&&this.router.navigate("/friend",{query:{id:e.id,name:n.displayName}})}},name:()=>e.displayName,username:()=>Ol(this.liveFriend(e)),club:()=>Ml(this.liveFriend(e)),subtitle:()=>Nl(this.liveFriend(e),t),hcp:()=>e.handicapIndex===null?"–":e.handicapIndex.toFixed(1),remove:{"aria-label":()=>`Remove ${this.liveFriend(e).displayName} from friends`,title:()=>`Remove ${this.liveFriend(e).displayName} from friends`,disabled:()=>this.svc.mutating.get()||this.removeOpen.get(),onclick:()=>this.askRemove(e)}}}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Ca=y(`
...
`);function Ia(s,e){return{row:{onclick:()=>e(s.roundId)},title:()=>Kl(s),subtitle:()=>Wl(s,De),progress:()=>Yl(s)}}function Ea(){return`
        & .fr-row {
            display: flex; align-items: center; gap: ${a("md")};
            width: 100%;
            padding: ${a("md")} ${a("lg")};
...
`);class Ng extends A{static styles=`
        .fprofile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(rs);activity=this.inject(hn);auth=this.inject(U);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const m=e.get();J(()=>{!m||!n()||(this.svc.setPlayer(m),this.svc.loadProfile(),this.activity.load())})}));const i=()=>this.svc.profile.get(),r=()=>(t.get()??"").trim()||"Friend",o=new T(()=>{const m=e.get();return m?ql(this.activity.feed.get(),m):null}),d=()=>this.svc.unavailable.get(),c=()=>n()&&d()===null&&i()!==null,h=()=>n()&&d()===null&&i()===null,u=m=>this.router.navigate("/spectate",{query:{id:m,name:i()?.player.displayName??r()}}),f=this.wire(Rg,{back:{onclick:()=>this.router.navigate("/friends")},anon:{className:()=>n()?"fprofile__anon hidden":"fprofile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},pending:{className:()=>h()?"fprofile__pending":"fprofile__pending hidden"},pendingName:{textContent:()=>r()},state:{textContent:()=>this.svc.profileLoading.get()?"Loading…":this.svc.profileError.get()??""},retry:{className:()=>this.svc.profileError.get()!==null&&!this.svc.profileLoading.get()?"fprofile__retry":"fprofile__retry hidden",onclick:()=>{this.svc.loadProfile(!0)}},refusal:{className:()=>n()&&d()!==null?"fprofile__refusal":"fprofile__refusal hidden"},refusalName:{textContent:()=>r()},refusalTitle:{textContent:()=>{const m=d();return m?Ye[m].title:""}},refusalMsg:{textContent:()=>{const m=d();return m?Ye[m].message:""}},body:{className:()=>c()?"fprofile__body":"fprofile__body hidden"},...Te(()=>{const m=i();return m?m.player:{id:e.get()??"",avatarVersion:null,displayName:r(),username:null}}),name:{textContent:()=>i()?.player.displayName??""},username:{textContent:()=>{const m=i()?.player.username;return m?`@${m}`:""}},identity:{textContent:()=>{const m=i();return m?Xl(m.player.handicapIndex,m.player.homeClubName)??"":""}},live:{className:()=>o.get()?"fprofile__live":"fprofile__live hidden",textContent:()=>{const m=o.get();return m?Vl(m):""},onclick:()=>{const m=o.get();m&&u(m.roundId)}},statRounds:()=>String(i()?.roundsTotal??""),statYear:()=>String(i()?.roundsThisYear??""),statCourses:()=>String(i()?.coursesTotal??""),recentEmpty:{className:()=>(i()?.recentRounds.length??0)===0?"fprofile__hint":"fprofile__hint hidden"},recentCard:{className:()=>(i()?.recentRounds.length??0)>0?"fprofile__listcard":"fprofile__listcard hidden"},seeAll:{onclick:()=>this.router.navigate("/friend-rounds",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})},coursesLine:{textContent:()=>Jl(i()?.coursesTotal??0)},coursesRow:{onclick:()=>this.router.navigate("/friend-courses",{query:{id:e.get()??"",name:i()?.player.displayName??r()}})}});return this.$each(this.ref(f,"recentList"),()=>i()?.recentRounds??[],(m,b,g)=>this.wireEl(Ca,Ia(m,u),g),m=>m.roundId),f}}const Og=y(`
    <div class="frounds">
...
`);class Mg extends A{static styles=`
        .frounds {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`);class Bg extends A{static styles=`
        .fcourses {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
    ...
    `;svc=this.inject(rs);auth=this.inject(U);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();J(()=>{!c||!n()||(this.svc.setPlayer(c),this.svc.loadCourses())})}));const i=()=>this.svc.unavailable.get(),r=()=>i()===null?this.svc.courses.get():[],o=()=>(t.get()??"").trim(),d=this.wire(Hg,{back:{onclick:()=>this.router.navigate("/friend",{query:{id:e.get()??"",name:o()}})},subtitle:{textContent:()=>{const c=o();return c?`Where ${c} has played the rounds they share.`:"Where the rounds they share were played."}},refusal:{className:()=>i()!==null?"fcourses__refusal":"fcourses__refusal hidden"},refusalTitle:{textContent:()=>{const c=i();return c?Ye[c].title:""}},refusalMsg:{textContent:()=>{const c=i();return c?Ye[c].message:""}},anon:{className:()=>n()?"fcourses__anon hidden":"fcourses__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/friend-courses?id=${e.get()??""}&name=${encodeURIComponent(o())}`}})},state:{textContent:()=>i()!==null||!n()?"":this.svc.coursesLoading.get()?"Loading…":this.svc.coursesError.get()??""},retry:{className:()=>i()===null&&this.svc.coursesError.get()!==null&&!this.svc.coursesLoading.get()?"fcourses__retry":"fcourses__retry hidden",onclick:()=>{this.svc.loadCourses(!0)}},empty:{className:()=>i()===null&&this.svc.coursesLoaded.get()&&r().length===0&&this.svc.coursesError.get()===null?"fcourses__state":"fcourses__state hidden"},listCard:{className:()=>r().length>0?"fcourses__listcard":"fcourses__listcard hidden"},truncated:{className:()=>i()===null&&this.svc.coursesHasMore.get()&&r().length>0?"fcourses__state":"fcourses__state hidden"}});return this.$each(this.ref(d,"list"),r,(c,h,u)=>this.wireEl(Ag,{name:()=>c.courseName??"Course",facts:()=>Ql(c,De)},u),c=>c.courseId),d}}function zg(s,e,t){const n=gt(e);if(n){const d=Yi(s);return d?`Watching · ${d} ${n}`:`Watching · ${n}`}const i=Yi(s)??"this",r=gt(t),o=r?` at ${r}`:"";return`Watching · ${i} round${o}`}function Lg(s,e,t,n){const i=gt(s)===null?null:gt(e),r=n!==null?`${n} holes`:null;return[i,r,t==="complete"?"Finished":t==="not_started"?"Not started":null].filter(c=>c!==null).join(" · ")||null}const Fg="You're watching this round. Only its players can enter scores.",Wi={forbidden:{title:"Round not available",message:"This round is no longer shared with you."},not_found:{title:"Round not found",message:"This round doesn't exist anymore."}};function Yi(s){const e=gt(s);return e?e.toLowerCase().endsWith("s")?`${e}'`:`${e}'s`:null}function gt(s){return(s??"").trim()||null}const Gg=y(`
    <div class="spectate">
        ...
        <div bind="body" class="spectate__body">
            ...
            <p class="spectate__note">${Fg}</p>
        </div>
    </div>
`);class Dg extends A{static styles=`
        .spectate {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${Cn.styles}
    `;svc=this.inject(Cr);auth=this.inject(U);router=this.inject(q);render(){const e=this.router.query("id"),t=this.router.query("name"),n=()=>this.auth.currentUser.get()!==null;this.track(C(()=>{const c=e.get();J(()=>{!c||!n()||(this.svc.setRound(c),this.svc.load())})}));const i=()=>this.svc.view.get(),r=()=>this.svc.unavailable.get(),o=()=>(t.get()??"").trim()||null;return this.wire(Gg,{back:{onclick:()=>{window.history.length>1?window.history.back():this.router.navigate("/")}},anon:{className:()=>n()?"spectate__anon hidden":"spectate__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:`/spectate?id=${e.get()??""}&name=${encodeURIComponent(o()??"")}`}})},refusal:{className:()=>n()&&r()!==null?"spectate__refusal":"spectate__refusal hidden"},refusalTitle:{textContent:()=>{const c=r();return c?Wi[c].title:""}},refusalMsg:{textContent:()=>{const c=r();return c?Wi[c].message:""}},state:{textContent:()=>r()!==null||!n()?"":this.svc.loading.get()&&i()===null?"Loading…":i()===null?this.svc.error.get()??"":""},retry:{className:()=>n()&&r()===null&&this.svc.error.get()!==null&&i()===null&&!this.svc.loading.get()?"spectate__retry":"spectate__retry hidden",onclick:()=>{this.svc.load(!0)}},body:{className:()=>n()&&r()===null&&i()!==null?"spectate__body":"spectate__body hidden"},title:{textContent:()=>{const c=i();return c?zg(o(),c.round.name,c.round.courseNameSnapshot):""}},status:{textContent:()=>{const c=i();return c&&c.status==="active"?"Live":""},className:()=>`spectate__status s-${i()?.status??""}`},subtitle:{textContent:()=>{const c=i();return c?Lg(c.round.name,c.round.courseNameSnapshot,c.status,c.round.playHoles.length||null)??"":""}},date:{textContent:()=>De(i()?.round.date??null)},board:{innerHTML:()=>this.renderBoards()}})}renderBoards(){const e=this.svc.view.get();if(!e)return"";const t=r=>this.svc.nameOf(r),n=r=>this.svc.groupLabelOf(r),i=e.result.slots;return i.length===0?'<div class="lb-empty">No formats in this round.</div>':i.map(r=>{const o=i.length>1?`<h2 class="spectate__slot-head">${jg(r.formatLabel)}</h2>`:"",d=ha(r,t,n),c=pa(r.cards,e.result.routeSections,t),h=c?`<h3 class="lb-cards__head">Scorecard</h3>${c}`:"";return o+d+h}).join("")}}function jg(s){return s.replaceAll("&","&amp;").replaceAll("<","&lt;").replaceAll(">","&gt;").replaceAll('"',"&quot;")}const qg=y(`
    <div class="profile">
            ...
            <section class="profile__card">
                ...
                <div class="pfield">
                    <span class="pfield__label">Preferred tee
                        ${ra("teeRoleInfo","How preferred tee works")}</span>
...
`);class Kg extends A{static styles=`
        .profile {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
        ...
        ${aa}
    `;svc=this.inject(Ie);auth=this.inject(U);router=this.inject(q);indexDraft=new p("");localErr=new p("");nameDraft=new p("");nameEditing=new p(!1);nameErr=new p("");teeRoleInfoOpen=new p(!1);render(){this.auth.currentUser.get()&&this.svc.load();const e=()=>this.auth.currentUser.get()!==null;let t=null,n=null;const i=this.wire(qg,{anon:{className:()=>e()?"profile__anon hidden":"profile__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/profile"}})},body:{className:()=>e()?"profile__body":"profile__body hidden"},...Te(()=>{const u=this.svc.player.get();return{id:u?.id??"",avatarVersion:u?.avatarVersion??null,displayName:u?.displayName,username:u?.username}}),photoFile:{onchange:u=>{const f=u.target,m=f.files?.[0];f.value="",m&&this.svc.saveAvatar(m)}},photoPick:{textContent:()=>this.svc.avatarSaving.get()?"Saving…":this.svc.player.get()?.avatarVersion?"Change photo":"Add photo",disabled:()=>this.svc.avatarSaving.get(),onclick:()=>t?.click()},photoRemove:{textContent:()=>"Remove",className:()=>this.svc.player.get()?.avatarVersion?"profile__photo-remove":"profile__photo-remove hidden",disabled:()=>this.svc.avatarSaving.get(),onclick:()=>{this.svc.removeAvatar()}},photoErr:{textContent:()=>this.svc.avatarError.get()?.message??""},nameDisplay:{className:()=>this.nameEditing.get()?"profile__name-display hidden":"profile__name-display"},name:()=>this.svc.player.get()?.displayName??"…",editName:{disabled:()=>this.svc.saving.get(),onclick:()=>{this.nameDraft.set(this.svc.player.get()?.displayName??""),this.nameErr.set(""),this.nameEditing.set(!0),queueMicrotask(()=>n?.focus())}},nameForm:{className:()=>this.nameEditing.get()?"profile__name-form":"profile__name-form hidden",onsubmit:async u=>{u.preventDefault();const f=this.nameDraft.get().trim();if(!f){this.nameErr.set("Enter a display name.");return}this.nameErr.set(""),await this.svc.saveDisplayName(f)&&this.nameEditing.set(!1)}},nameInput:{value:()=>this.nameDraft.get(),disabled:()=>this.svc.saving.get(),oninput:u=>this.nameDraft.set(u.target.value)},cancelName:{disabled:()=>this.svc.saving.get(),onclick:()=>{this.nameEditing.set(!1),this.nameErr.set("")}},saveName:{disabled:()=>this.svc.saving.get()||this.nameDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},nameErr:{textContent:()=>this.nameErr.get()||this.saveErrFor("name")},username:()=>{const u=this.svc.player.get();return u?`@${u.username}`:""},hcp:()=>{const u=this.svc.player.get()?.handicapIndex;return u==null?"–":u<0?`+${(-u).toFixed(1)}`:u.toFixed(1)},index:{value:()=>this.indexDraft.get(),oninput:u=>this.indexDraft.set(u.target.value)},save:{disabled:()=>this.svc.saving.get()||this.indexDraft.get().trim()==="",textContent:()=>this.svc.saving.get()?"Saving…":"Save"},form:{onsubmit:async u=>{u.preventDefault(),this.localErr.set("");const f=we(this.indexDraft.get());if(f===null||f<-10||f>54){this.localErr.set("Enter an index between +10 and 54 (use “+” for a plus handicap).");return}await this.svc.saveIndex(f)&&this.indexDraft.set("")}},saveErr:{textContent:()=>this.localErr.get()||this.saveErrFor("index")},teeRoleInfo:{"aria-expanded":()=>String(this.teeRoleInfoOpen.get()),onclick:()=>this.teeRoleInfoOpen.set(!this.teeRoleInfoOpen.get())},teeRoleHint:{textContent:()=>{const u=this.svc.player.get()?.preferredTeeRoleKey??null;return u===null?"Rounds start you on the course default tee.":`Rounds start you on the course’s ${this.svc.teeRoles.get().find(m=>m.roleKey===u)?.displayName??u} tee when it has one.`}},teeRoleExplain:{textContent:()=>"Pick the tee type you normally play. It pre-fills your own gender’s round tee only when the selected course has a matching tee. Otherwise the course default applies. The organiser can change the round defaults, and any player’s tee can still be overridden.",className:()=>this.teeRoleInfoOpen.get()?"pfield__hint profile__tee-explain":"pfield__hint profile__tee-explain hidden"},clubErr:{textContent:()=>this.saveErrFor("club")},genderErr:{textContent:()=>this.saveErrFor("gender")},teeRoleErr:{textContent:()=>this.saveErrFor("tee")},toStats:{className:()=>this.svc.hasRecordedStats.get()?"statlink":"statlink hidden",onclick:()=>this.router.navigate("/stats")},statlinkRule:{className:()=>this.svc.hasRecordedStats.get()?"statrow__rule":"statrow__rule hidden"},masterTitle:()=>fl,masterHint:()=>ml,master:{checked:()=>this.svc.statsConfig.get().enabled,disabled:()=>this.statsBusy(),onchange:u=>{this.saveStats(u,(f,m)=>_l(f,m),f=>f.enabled)}},statsErr:{textContent:()=>this.svc.statsError.get()?.message||""},historyEmpty:{className:()=>this.svc.history.get().length===0?"profile__empty":"profile__empty hidden"}});this.$each(this.ref(i,"history"),this.svc.history,(u,f,m)=>this.wireEl(Vg,{index:()=>u.handicapIndex.toFixed(1),source:()=>u.source,date:()=>u.effectiveDate},m),u=>u.id),this.$each(this.ref(i,"statModules"),()=>[...fr],(u,f,m)=>{const b=()=>this.svc.statsConfig.get(),g=()=>gl(b(),u);return this.wireEl(Ug,{row:{className:()=>g()?"statrow statrow--locked":"statrow"},title:()=>mr(u),ann:()=>bl(b(),u)??"",hint:()=>pl(u),chk:{checked:()=>Lt(b(),u),disabled:()=>g()||this.statsBusy(),onchange:v=>{this.saveStats(v,($,R)=>yl($,u,R),$=>Lt($,u))}}},m)},u=>u);const r=[{value:"M",label:"M"},{value:"F",label:"F"},{value:null,label:"Not set"}];this.$each(this.ref(i,"gender"),()=>r,(u,f,m)=>this.wireEl(y('<button bind="b" type="button"></button>'),{b:{textContent:()=>u.label,className:()=>this.svc.player.get()?.gender===u.value?"on":"",disabled:()=>this.svc.saving.get(),onclick:()=>{this.svc.saveGender(u.value)}}},m),u=>u.label);const o=new p(this.svc.player.get()?.preferredTeeRoleKey??"");this.track(C(()=>o.set(this.svc.player.get()?.preferredTeeRoleKey??""))),this.track(C(()=>{const u=o.get();queueMicrotask(()=>{u!==(this.svc.player.get()?.preferredTeeRoleKey??"")&&this.svc.savePreferredTeeRole(u===""?null:u)})}));const d=new pe({value:o,options:{get:()=>[{value:"",label:"No preference"},...this.svc.teeRoles.get().map(u=>({value:u.roleKey,label:u.displayName}))]},placeholder:"No preference",disabled:{get:()=>this.svc.saving.get()}});d.mount(this.ref(i,"teeRole")),this.track(()=>d.destroy());const c=new p(this.svc.player.get()?.homeClubId??"");this.track(C(()=>c.set(this.svc.player.get()?.homeClubId??""))),this.track(C(()=>{const u=c.get();queueMicrotask(()=>{u!==(this.svc.player.get()?.homeClubId??"")&&this.svc.saveHomeClub(u===""?null:u)})}));const h=new pe({value:c,options:{get:()=>[{value:"",label:"No home club"},...this.svc.clubs.get().map(u=>({value:u.id,label:u.name}))]},placeholder:"No home club",disabled:{get:()=>this.svc.saving.get()}});return h.mount(this.ref(i,"club")),this.track(()=>h.destroy()),t=this.ref(i,"photoFile"),n=this.ref(i,"nameInput"),i}saveErrFor(e){return this.svc.saveTarget.get()!==e?"":this.svc.saveError.get()?.message||""}statsBusy(){return this.svc.statsSaving.get()||this.svc.saving.get()}async saveStats(e,t,n){const i=e.target;await this.svc.saveStatsConfig(t(this.svc.statsConfig.get(),i.checked)),i.checked=n(this.svc.statsConfig.get())}}function W(s,e){return s>0?`Measured over ${re(s,e)}.`:null}function ke(s){return s===null?null:`Measured ${s}.`}function Wg(s){const e=th(s);return e===null?null:`Your penalty doubles: ${e}.`}function F(...s){return s.filter(e=>e!==null&&e!=="").join(" ")}function L(s,e,t){return{id:s,title:e,body:t}}function Yg(s){return s.penaltiesRecordedHoles<=0?null:ds([{d:s.penaltiesPerRound.d,unit:Se},{d:s.penaltiesRecordedHoles,unit:Q}])}function Xg(s,e,t){switch(s){case"tee":{const n=e.tee;return n?[L("teeFan","Where your tee shots finish",F(k.teeFan,W(n.teeRecorded,Q))),L("vsParByTee","Average vs par, by where the tee shot finished",F(k.vsParByTee,ke(Yu(n.vsParByTee)))),L("troubleTax","Trouble tax",F(k.troubleTax,ke(zu(n.vsParByTee)))),L("recovery","Recovery",F(k.recovery,W(n.recovery.d,Q))),L("penalties","Penalties",F(k.penalties,ke(Yg(n)))),L("penaltyTax","Penalty tax",F(k.penaltyTax,ke(ju(n.vsParByPenalty))))]:[]}case"approach":{const n=e.approach;return n?[...n.greenHitLate>0?[L("greenAttemptsHit","Greens hit",F(k.greenAttemptsHit,W(n.greenAttemptsHit.d,Q)))]:[],L("greenMiss","Where you miss the green",F(k.greenMiss,W(n.greenMissRecorded,Q))),...n.proximityOnGir.d>0?[L("proximityOnGir","Average first putt",F(k.proximityOnGir,W(n.proximityOnGir.d,Ru)))]:[],L("proximity","Proximity with GIR",F(k.proximityProxy,W(n.girFirstPuttMix.inside_1m.d,Is))),L("birdieConversion","Birdie conversion",F(k.birdieConversion,W(n.birdieConversion.d,Is))),L("hardChipShare","Hard misses",F(k.hardChipShare,W(n.hardChipShare.d,Q))),L("costOfMissedGreen","Cost of a missed green",F(k.costOfMissedGreen,ke(Xu(n.costOfMissedGreen)))),L("missedGreenTax","Missed-green tax",F(k.missedGreenTax,ke(Du(n.costOfMissedGreen))))]:[]}case"putting":{const n=e.putting;return n?[L("firstPuttSpread","First putt, all holes",F(k.firstPuttSpread,W(n.firstPuttSpread.inside_1m.d,Q))),L("ladder","Holed on the first putt",F(k.ladderBaseline,k.ladderCost,`Measured against the ${ht(t.cohort)} reference — change it under “${k.filterBaseline}” in Filters.`)),...n.curve.length>0?[L("makeCurve","Holed, by distance",F(k.makeCurve,k.makeCurveWindow,W(n.curve.reduce((i,r)=>i+r.attempts,0),Ou)))]:[],...n.metersMadeHoles>0?[L("metersMade","Metres of first putts holed",F(k.metersMade,W(n.metersMadeHoles,Nu),n.onePuttsUnmeasured>0?`${re(n.onePuttsUnmeasured,Q)} you one-putted have no distance recorded.`:null))]:[],L("threePutt","Three or more putts",F(k.threePutt,k.longThreePutt,W(n.threePutt.d,Q))),L("puttsPerGir","Putts per green hit",F(k.puttsPerGir,W(n.puttsPerGirHole.d,Is))),L("puttsAfterMissedGreen","Putts after a missed green",F(k.puttsAfterMissedGreen,W(n.puttsAfterMissedGreen.d,Q))),L("puttsByPar","Putts per hole, by par",F(k.puttsByPar,ke(ai(n.puttsPerHoleByPar))))]:[]}case"shortGame":{const n=e.shortGame;if(!n)return[];const i=n.scramble.standard.d+n.scramble.hard.d+n.scramble.bunker.d;return[...i<=0?[]:[L("missMix",k.missMixHead,F(k.missMix,W(i,Q))),L("scrambling","Scrambling",F(k.scrambling,W(i,Q))),L("sandSave","Sand save",F(k.sandSave,W(n.sandSave.d,Q))),L("extraShortGameStrokes","Extra short-game shots",F(k.extraShortGameStrokes,W(n.shortGameStrokesRecorded,Q))),L("chipOutcomes","After the chip",F(k.chipOutcomes,k.multiChip,W(i,Q))),L("missCost","Average vs par, by how hard the miss was",F(k.missCost,W(n.missCost.standard.d+n.missCost.hard.d+n.missCost.bunker.d,Q))),L("chipInside2m","Chipped to inside 2 m",F(k.conversionInside2m,W(n.conversionInside2m.d,Q))),L("savedInside2m","Saved when inside 2 m",F(k.savedInside2m,W(n.savedInside2m.overall.d,Q))),L("chipIns","Chip-ins",k.chipIns)],...n.chipOnGir.d>0?[L("chipOnGir","Chipped on a green in regulation",F(k.chipOnGir,k.chipOnGirPar5,W(n.chipOnGir.d,Mu)))]:[]]}case"scoring":{const n=e.scoring;return n?[L("vsPar","Average vs par",F(k.avgVsParByPar,ke(ai(n.avgVsParByParGroup)))),L("doubles","Doubles or worse",F(k.doubleBogeyPlus,W(n.doubleBogeyPlusPerRound.d,Se))),...n.doubleBogeyPlusHoles>0?[L("doubleCauses",k.doubleCausesHead,F(k.doubleCauses,k.doubleCausesOrder,W(n.doubleBogeyPlusHoles,Q),k.doubleCausesLongGame,k.doubleCausesUnattributed,k.doubleCausesPenalty,Wg(n.penaltyDoubleSources)))]:[],L("bounceBack","Bounce-back",F(k.bounceBack,W(n.bounceBack.d,Q)))]:[]}case null:return[]}}const Qg=y(`
...
`),Jg=y('<h3 bind="text" class="block__subhead"></h3>'),Zg=y(`
...
`);class Ra extends A{static styles=`
${fs}
        .statspanels {
            ...
            & .block__bar {
                width: ${ba}px; flex: none;
                & svg { width: 100%; display: block; }
            }
            & .block__value {
                width: ${sn}px; flex: none; text-align: right;
                font-size: 0.9rem; font-weight: 700;
                font-variant-numeric: tabular-nums;
            ...
            & .block__cost {
                width: ${$i}px; flex: none; text-align: right;
            ...
            & .block--columns {
                ...
                & .block__colhead:nth-child(3) { width: ${sn}px; }
                & .block__colhead:nth-child(4) { width: ${$i}px; }
            }
    ...
    `;expanded=new p([]);openInfo=new p(null);colors=bs;render(){const e=()=>this.props.model(),t=this.wire(lb,{infoSheet:{className:()=>this.openInfo.get()!==null?"stats-info":"stats-info hidden",onclick:n=>{n.target===n.currentTarget&&this.openInfo.set(null)}},infoTitle:()=>{const n=this.openInfo.get();return n===null?"":Ps(n)},infoDone:{onclick:()=>this.openInfo.set(null)}});return this.$each(this.ref(t,"panels"),()=>[...gu],(n,i,r)=>{const o=()=>this.expanded.get().includes(n),d=this.wireEl(Qg,{panel:{className:()=>e()[n]?"panel":"panel hidden"},head:{"aria-expanded":()=>String(o()),onclick:()=>this.togglePanel(n)},title:()=>Ps(n),headline:()=>sm(n,e())??"",body:{className:()=>o()?"panel__body":"panel__body hidden"},infoRow:{className:()=>o()&&this.infoCards(n).length>0?"panel__inforow":"panel__inforow hidden"},infoTrigger:{textContent:()=>k.prioritiesInfo,"aria-label":()=>`${k.prioritiesInfo}: ${Ps(n)}`,onclick:()=>this.openInfo.set(n)}},r);return this.$each(this.ref(d,"blocks"),()=>Ei(n,e()),(c,h,u)=>this.renderBlock(n,c,u),c=>c.id),d},n=>n),this.$each(this.ref(t,"infoCards"),()=>this.infoCards(this.openInfo.get()),(n,i,r)=>this.wireEl(vt,{ctitle:()=>(this.infoCardNow(n.id)??n).title,ctext:()=>(this.infoCardNow(n.id)??n).body},r),n=>n.id),t}infoCards(e){return Xg(e,this.props.model(),this.props.baseline())}infoCardNow(e){return this.infoCards(this.openInfo.get()).find(t=>t.id===e)}renderBlock(e,t,n){switch(t.kind){case"subhead":return this.wireEl(Jg,{text:()=>t.text},n);case"columns":return this.wireEl(Zg,{c0:()=>t.cells[0]??"",c1:()=>t.cells[1]??""},n);case"split":{const i=()=>this.blockNow(e,t.id)??t;return this.wireEl(eb,{bar:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":Pf(r.segments.map(o=>({id:o.id,share:o.share??0,color:this.segmentColor(o.tone)})),this.colors)}},legend:{innerHTML:()=>{const r=i();return r.kind!=="split"?"":r.segments.map(o=>`<span class="legend__key"><span class="legend__swatch" style="background:${this.segmentColor(o.tone)}"></span><span>${o.title}</span><span class="legend__value">${o.value??k.noValue}</span></span>`).join("")}}},n)}case"bar":return this.wireEl(t.sub?sb:tb,{title:()=>t.title,bar:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="bar"||i.share===null?"":nn(i.share,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value,k.noValue)},n);case"rung":{const i=()=>{const r=this.blockNow(e,t.id);return r&&r.kind==="rung"?r:t};return this.wireEl(nb,{row:{"aria-label":()=>{const r=i();return Jf({title:r.title,value:r.value,cost:r.cost})}},title:()=>t.title,bar:{innerHTML:()=>{const r=i();return Bf(r.made,r.baseline,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value,k.noValue),cost:()=>i().cost},n)}case"curve":{const i=()=>{const r=this.blockNow(e,t.id);return r&&r.kind==="curve"?r:t};return this.wireEl(ib,{row:{"aria-label":()=>{const r=i();return em({title:r.title,value:r.value,avg:r.avg})}},title:()=>t.title,bar:{innerHTML:()=>{const r=i();return r.share===null?"":nn(r.share,this.colors)}},value:this.valueBinding(e,t.id,()=>t.value,k.noValue),avg:()=>i().avg},n)}case"figure":return this.wireEl(rb,{title:()=>t.title,hint:()=>{const i=this.blockNow(e,t.id)??t;return(i.kind==="figure"?i.hint:t.hint)??""},value:this.valueBinding(e,t.id,()=>t.value)},n);case"compass":return this.wireEl(ab,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="compass"?"":qf(i.sectors,i.labels,this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="compass"?i.text:t.text}},n);case"fan":return this.wireEl(ob,{chart:{innerHTML:()=>{const i=this.blockNow(e,t.id)??t;return i.kind!=="fan"?"":Yf(i.columns,this.toneColors(),this.colors)}},text:()=>{const i=this.blockNow(e,t.id)??t;return i.kind==="fan"?i.text:t.text}},n)}}toneColors(){return{fairway:this.segmentColor("fairway"),inplay:this.segmentColor("inplay"),trouble:this.segmentColor("trouble")}}valueBinding(e,t,n,i=k.notRecorded){const r=()=>{const o=this.blockNow(e,t);return o&&"value"in o?o.value:n()};return{textContent:()=>r()??i,className:()=>r()===null?"block__value block__value--absent":"block__value"}}segmentColor(e){switch(e){case"fairway":return this.colors.gain;case"inplay":return this.colors.neutral;case"trouble":return this.colors.loss}}togglePanel(e){const t=this.expanded.get();this.expanded.set(t.includes(e)?t.filter(n=>n!==e):[...t,e])}blockNow(e,t){return Ei(e,this.props.model()).find(n=>n.id===t)}}const db=y(`
    <div class="stats">
...
${fs}
    `;svc=this.inject(Le);auth=this.inject(U);router=this.inject(q);filterOpen=new p(!1);prioritiesInfoOpen=new p(!1);colors=bs;render(){const e=()=>this.auth.currentUser.get()!==null;e()&&(this.svc.load(),this.svc.loadHandicap());const t=()=>this.svc.model.get(),n=()=>this.svc.preset.get()==="custom",i=this.wire(db,{anon:{className:()=>e()?"stats__anon hidden":"stats__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/stats"}})},body:{className:()=>e()?"stats__body":"stats__body hidden"},intro:()=>k.intro,sample:()=>this.sampleMarker(),filterToggle:{"aria-expanded":()=>String(this.filterOpen.get()),onclick:()=>this.filterOpen.set(!this.filterOpen.get())},status:()=>this.statusLine(),err:()=>this.svc.error.get()?.message??"",filterPanel:{className:()=>this.filterOpen.get()?"stats__filter":"stats__filter hidden"},from:{value:()=>this.svc.filter.get().from??"",oninput:r=>this.setBound("from",r.target.value)},to:{value:()=>this.svc.filter.get().to??"",oninput:r=>this.setBound("to",r.target.value)},clearFilter:{textContent:()=>k.filterClear,onclick:()=>this.svc.clearFilter()},sgLabel:()=>k.filterBaseline,sgWhat:()=>k.filterBaselineHint,sgHint:()=>cu(this.svc.sgChoice.get(),this.svc.handicapIndex.get()),empty:()=>this.emptyLine(),resultsSec:{className:()=>t().results!==null?"stats__section":"stats__section hidden"},resultsSub:()=>cm(t().results),resultsCard:{className:()=>Bs(t().results).length===0&&Nt(t().results).length===0?"results hidden":"results"},histHead:()=>Nt(t().results).length===0?"":k.scoreTypesHead,prioritiesSec:{className:()=>t().priorities.length>0?"stats__section":"stats__section hidden"},prioritiesHint:()=>k.prioritiesHint,infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.prioritiesInfoOpen.set(!0)},infoSheet:{className:()=>this.prioritiesInfoOpen.get()?"stats-info":"stats-info hidden",onclick:r=>{r.target===r.currentTarget&&this.prioritiesInfoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.prioritiesInfoOpen.set(!1)},trendsSec:{className:()=>t().trends.length>0?"stats__section":"stats__section hidden"},trendsHint:()=>k.trendsHint,roundsSec:{className:()=>t().rounds.length>0?"stats__section":"stats__section hidden"},roundsHint:()=>k.roundsHint,pickHint:()=>n()?k.filterRoundsHint:""});return this.setHeading(i,"resultsSec",k.resultsHeading),this.setHeading(i,"prioritiesSec",k.priorities),this.setHeading(i,"trendsSec",k.trends),this.setHeading(i,"roundsSec",k.roundsHeading),this.mountPicker(i),this.mountBaselinePicker(i),this.mountFilterLists(i),this.$each(this.ref(i,"resultTiles"),()=>Bs(t().results),(r,o,d)=>this.wireEl(ub,{tile:{className:()=>(this.tileNow(r.id)??r).hero?"rtile rtile--hero":"rtile"},value:{textContent:()=>(this.tileNow(r.id)??r).value},label:{textContent:()=>(this.tileNow(r.id)??r).label},qualifier:{textContent:()=>(this.tileNow(r.id)??r).qualifier??""}},d),r=>r.id),this.$each(this.ref(i,"resultHist"),()=>Nt(t().results),(r,o,d)=>this.wireEl(hb,{title:()=>r.title,bar:{innerHTML:()=>nn((this.histNow(r.id)??r).share,this.colors)},value:{textContent:()=>(this.histNow(r.id)??r).value}},d),r=>r.id),this.$each(this.ref(i,"priorities"),()=>t().priorities,(r,o,d)=>this.wireEl(pb,{title:()=>us(r.component),chart:{innerHTML:()=>{const c=this.priorityNow(r.component);return c?.per18===null||c===void 0?"":ya(c.per18,Tu(t().priorities),this.colors)}},value:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18!==null?xe(c.per18):k.notEnoughData}},sample:{textContent:()=>{const c=this.priorityNow(r.component);return c&&c.per18===null?mm(c.roundsInWindow):""}}},d),r=>r.component),this.$each(this.ref(i,"infoCards"),()=>Zt({attributed:t().waterfall.coverage.attributed,holesScored:t().waterfall.coverage.holesScored,windowRounds:t().rounds.length,rowsPer18:t().priorities.map(r=>r.per18),penaltySource:Jt(t().totals),baseline:this.svc.sgInfo.get()}),(r,o,d)=>this.wireEl(vt,{ctitle:()=>(this.sgCardNow(r.id)??r).title,ctext:()=>(this.sgCardNow(r.id)??r).body},d),r=>r.id),this.$each(this.ref(i,"trends"),()=>t().trends,(r,o,d)=>this.wireEl(fb,{title:()=>r.title,spark:{innerHTML:()=>{const c=this.trendNow(r.id)??r;return Nf(c.points,c.kind,this.colors)}},headline:{textContent:()=>{const c=this.trendNow(r.id)??r;return bb(c)}},sample:{textContent:()=>{const c=this.trendNow(r.id)??r;return re(c.points.length,Se)}}},d),r=>r.id),this.spawn(Ra,this.ref(i,"panels"),{model:t,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(i,"rounds"),()=>t().rounds,(r,o,d)=>this.wireEl(mb,{open:{onclick:()=>this.router.navigate("/round-stats",{query:{id:r.id}}),"aria-label":()=>`${Ri(r)} — hole by hole`},label:()=>Ri(r),subtitle:()=>yb(r),pickWrap:{className:()=>n()?"statsround__pick":"statsround__pick hidden"},pick:{checked:()=>!this.svc.filter.get().excludedRoundIds.includes(r.id),onchange:c=>this.svc.applyFilter(Md(this.svc.filter.get(),r.id,c.target.checked))},strip:{innerHTML:()=>{const c=this.roundNow(r.id)??r;return Hf(c.waterfall,Wr(t().rounds.map(h=>h.waterfall)),this.colors)}},vspar:{textContent:()=>{const c=this.roundNow(r.id)??r;return c.vsPar===null?"":cs(c.vsPar)}}},d),r=>r.id),i}mountPicker(e){const t=new p(this.svc.preset.get());this.track(C(()=>t.set(this.svc.preset.get()))),this.track(C(()=>{const r=t.get();queueMicrotask(()=>{r!==this.svc.preset.get()&&this.svc.select(r)})}));const n=r=>({value:r,label:`${Dt(r)} — ${Rd(r)}`}),i=new pe({value:t,options:[{value:"__recent",label:"Recent form",disabled:!0},n("last5"),n("last10"),n("last20"),{value:"__all",label:"Everything",disabled:!0},n("thisYear"),n("all"),{value:"__custom",label:"Built by hand",disabled:!0},n("custom")],placeholder:Dt("last10")});i.mount(this.ref(e,"picker")),this.track(()=>i.destroy())}mountBaselinePicker(e){const t=new p(this.svc.sgChoice.get());this.track(C(()=>t.set(this.svc.sgChoice.get()))),this.track(C(()=>{const i=t.get();queueMicrotask(()=>{i!==this.svc.sgChoice.get()&&this.svc.selectSgBaseline(i)})}));const n=new pe({value:t,options:Vr.map(i=>({value:i,label:ii(i)})),placeholder:ii("auto")});n.mount(this.ref(e,"sgPicker")),this.track(()=>n.destroy())}mountFilterLists(e){const t=["outdoor","indoor"];this.$each(this.ref(e,"venues"),()=>t,(i,r,o)=>this.wireEl(Xi,{chip:{textContent:()=>ah(i),"aria-pressed":()=>String(this.svc.filter.get().venueTypes.includes(i)),onclick:()=>this.svc.applyFilter(Ts(this.svc.filter.get(),"venueTypes",i))}},o),i=>i);const n=["full_18","front_9","back_9","custom_holes"];this.$each(this.ref(e,"roundTypes"),()=>n,(i,r,o)=>this.wireEl(Xi,{chip:{textContent:()=>oh(i),"aria-pressed":()=>String(this.svc.filter.get().roundTypes.includes(i)),onclick:()=>this.svc.applyFilter(Ts(this.svc.filter.get(),"roundTypes",i))}},o),i=>i),this.$each(this.ref(e,"courses"),()=>this.svc.courses.get(),(i,r,o)=>this.wireEl(cb,{name:()=>i.name,count:()=>re(i.roundCount,Se),chk:{checked:()=>this.svc.filter.get().courseIds.includes(i.id),onchange:()=>this.svc.applyFilter(Ts(this.svc.filter.get(),"courseIds",i.id))}},o),i=>i.id)}setBound(e,t){this.svc.applyFilter({...this.svc.filter.get(),[e]:t===""?null:t})}priorityNow(e){return this.svc.model.get().priorities.find(t=>t.component===e)}trendNow(e){return this.svc.model.get().trends.find(t=>t.id===e)}roundNow(e){return this.svc.model.get().rounds.find(t=>t.id===e)}tileNow(e){return Bs(this.svc.model.get().results).find(t=>t.id===e)}histNow(e){return Nt(this.svc.model.get().results).find(t=>t.id===e)}sgCardNow(e){const t=this.svc.model.get();return Zt({attributed:t.waterfall.coverage.attributed,holesScored:t.waterfall.coverage.holesScored,windowRounds:t.rounds.length,rowsPer18:t.priorities.map(n=>n.per18),penaltySource:Jt(t.totals),baseline:this.svc.sgInfo.get()}).find(n=>n.id===e)}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}sampleMarker(){const e=this.svc.windowRounds.get().length,t=this.svc.roundsWithStats.get()??this.svc.loadedCount(),n=t<=e?re(e,Se):`${me(e,0)} of ${re(t,Se)}`,i=this.svc.model.get().statCaptureRounds;return e===0||i>=e?n:`${n} · stat capture on ${me(i,0)}`}statusLine(){const e=this.svc.extendError.get();return e?`${k.extendProblemPrefix}${e.message}`:this.svc.extending.get()?k.extending:this.svc.budgetSpent()?k.budgetSpent:this.svc.loading.get()?k.loading:""}emptyLine(){return!this.svc.loaded.get()||this.svc.error.get()?"":this.svc.overFiltered.get()?k.windowEmpty:this.svc.loadedCount()===0?k.noStats:""}}function bb(s){const e=s.points[s.points.length-1];return e===void 0?"":s.kind==="percentage"?`${Math.round(e*100)}%`:xe(e)}function yb(s){const e=[ea(s.date)];return s.courseName&&e.push(s.courseName),e.push(`${me(s.holeCount,0)} holes`),e.join(" · ")}const _b=y(`
...
`),kb=y('<li bind="text" class="roundstats__legenditem"></li>');function $b(){const s=[];for(const[e,t]of Object.entries(Tn))t.fill!==void 0&&s.push(`& .cell--${e} { background: ${t.fill}; color: #fff; border-color: transparent;`+(t.boxy?" border-radius: 3px;":"")+" }");return s.join(`
...
${fs}
    `;svc=this.inject(mt);auth=this.inject(U);router=this.inject(q);colors=bs;openHole=new p(null);infoOpen=new p(!1);render(){const e=this.router.query("id"),t=()=>this.svc.model.get(),n=()=>this.svc.phase.get()==="ready"&&t()!==null;this.track(C(()=>{const d=e.get();J(()=>{this.openHole.set(null),d&&this.svc.load(d)})}));const i=this.router.query("finish"),r=()=>i.get()==="1",o=this.wire(_b,{back:{className:()=>r()?"roundstats__back hidden":"roundstats__back",onclick:()=>this.router.navigate("/stats")},finishKicker:{className:()=>r()?"roundstats__kicker":"roundstats__kicker hidden"},finishClose:{className:()=>r()?"roundstats__closebtn":"roundstats__closebtn hidden",onclick:()=>this.router.navigate("/")},state:()=>this.stateLine(),body:{className:()=>n()?"roundstats__body":"roundstats__body hidden"},title:()=>t()===null?"":wi(t()),subtitle:()=>this.subtitle(),score:()=>{const d=t();return d===null?"":va(d.strokes,d.vsPar)??""},stripSec:{className:()=>(t()?.cells.length??0)>0?"roundstats__section":"roundstats__section hidden"},wfHeading:()=>ne.waterfallHeading,wfHint:()=>ne.waterfallHint,infoTrigger:{textContent:()=>k.prioritiesInfo,onclick:()=>this.infoOpen.set(!0)},infoSheet:{className:()=>this.infoOpen.get()?"stats-info":"stats-info hidden",onclick:d=>{d.target===d.currentTarget&&this.infoOpen.set(!1)}},infoTitle:()=>_e.title,infoDone:{onclick:()=>this.infoOpen.set(!1)},legendHeading:()=>ne.legendHeading,detail:{className:()=>this.selected()===null?"holedetail hidden":"holedetail"},detailTitle:()=>{const d=this.selected();return d===null?"":ym(d)},detailEmpty:()=>{const d=this.selected();return d===null?"":En(d).length===0?ne.nothingRecordedOnHole:""}});return this.setHeading(o,"stripSec",ne.holeStripHeading),this.$each(this.ref(o,"strip"),()=>t()?.cells??[],(d,c,h)=>this.wireEl(vb,{cell:{className:()=>{const u=this.cellNow(d.id)??d;return u.marker===null?"cell":`cell cell--${u.marker}`},"aria-pressed":()=>String(this.openHole.get()===d.id),"aria-label":()=>Oi(this.cellNow(d.id)??d),title:()=>Oi(this.cellNow(d.id)??d),onclick:()=>this.openHole.set(this.openHole.get()===d.id?null:d.id)},hole:()=>String((this.cellNow(d.id)??d).holeNumber),score:()=>_m(this.cellNow(d.id)??d),tee:{className:()=>(this.cellNow(d.id)??d).tee===null?"cell__tee cell__tee--absent":"cell__tee",style:()=>{const u=this.cellNow(d.id)??d;return u.tee===null?"":`background:${this.teeColor(u.tee)}`}},gir:{className:()=>{const u=this.cellNow(d.id)??d;return u.gir===null?"cell__gir cell__gir--absent":u.gir?"cell__gir cell__gir--hit":"cell__gir"}},putts:()=>{const u=this.cellNow(d.id)??d;return u.putts===null?"":String(u.putts)},pen:{className:()=>bf(this.cellNow(d.id)??d)?"cell__pen":"cell__pen cell__pen--absent"}},h),d=>d.id),this.$each(this.ref(o,"detailLines"),()=>Sm(this.selected()),(d,c,h)=>this.wireEl(wb,{label:()=>d.label,value:()=>d.value},h),d=>d.key),this.$each(this.ref(o,"deltas"),()=>{const d=t();return d===null?[]:he.filter(c=>Qe(d.waterfall,c)!==null)},(d,c,h)=>this.wireEl(xb,{title:()=>us(d),sentence:()=>{const u=t();if(u===null||u.deltas===null)return"";const f=yn(u.deltas,d);return f===null?"":wa(f,u.windowCount)},value:{textContent:()=>{const u=this.componentValue(d);return u===null?"":xe(u)},style:()=>{const u=this.componentValue(d);return u===null?"":`color:${Ze(ms(u),this.colors)}`}},bar:{innerHTML:()=>{const u=t(),f=this.componentValue(d);return u===null||f===null?"":ya(f,Wr([u.waterfall]),this.colors)}}},h),d=>d),this.$each(this.ref(o,"infoCards"),()=>{const d=t();return d===null?[]:Zt({attributed:d.waterfall.coverage.attributed,holesScored:d.waterfall.coverage.holesScored,windowRounds:0,rowsPer18:he.map(c=>Pe(d.waterfall,c)),penaltySource:Jt(d.panels.totals),baseline:this.svc.sgInfo.get()})},(d,c,h)=>this.wireEl(vt,{ctitle:()=>d.title,ctext:()=>d.body},h),d=>d.id),this.spawn(Ra,this.ref(o,"panels"),{model:()=>t()?.panels??Kr,baseline:()=>this.svc.sgInfo.get()}),this.$each(this.ref(o,"legend"),()=>[ne.legendTee,ne.legendGir,ne.legendPutts,ne.legendPenalty,ne.legendAbsence],(d,c,h)=>this.wireEl(kb,{text:()=>d},h),d=>d),o}cellNow(e){return this.svc.model.get()?.cells.find(t=>t.id===e)}selected(){const e=this.openHole.get();return e===null?null:this.cellNow(e)??null}teeColor(e){switch(e){case"fairway":return this.colors.gain;case"in_play":return this.colors.neutral;case"trouble":return this.colors.loss}}componentValue(e){const t=this.svc.model.get();return t===null?null:Qe(t.waterfall,e)}subtitle(){const e=this.svc.model.get();return e===null?"":bm({...e,title:wi(e)})}stateLine(){if(this.auth.currentUser.get()===null)return ne.notSignedIn;switch(this.svc.phase.get()){case"loading":case"idle":return ne.loading;case"notFound":return ne.noStatsInRound;case"notAuthorized":return ne.notSignedIn;case"failed":return`${ne.failedPrefix}${this.svc.failure.get()??""}`;case"ready":return this.svc.model.get()?.cells.length===0?ne.noHoleStrip:""}}setHeading(e,t,n){const i=this.ref(e,t).querySelector("h2");i&&(i.textContent=n)}}const Tb=y(`
    <div class="admin">
...
`),Eb={not_started:"Not started",active:"Playing",complete:"Done"},Rb={private:"Private",friends:"Friends",link:"Link"};function Nb(s){const e=[`${s.participants.length} players`,`${s.scoreEventCount} scores`];return s.lastEventAt?e.push(`last ${s.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Ob(s){const e=[`@${s.username}`,`${s.roundCount} rounds`];return s.lastRoundDate&&e.push(`last ${s.lastRoundDate}`),s.handicapIndex!==null&&e.push(`hcp ${s.handicapIndex}`),s.deletedAt&&e.push("DELETED"),e.join(" · ")}class Mb extends A{static styles=`
        .admin {
            padding: ${a("xl")} ${a("lg")} ${a("2xl")};
...
`),Yb=y('<button bind="chip" class="cd__friendchip" type="button"></button>');class Xb extends A{competitions=this.inject(je);state=this.inject(wt);render(){const e=()=>this.state.id.get()??"",t=this.wire(Kb,{count:()=>{const n=this.competitions.participants.get().length;return n===0?"":String(n)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&an(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:n=>{n.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:n=>this.state.guestNameDraft.set(n.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:n=>this.state.guestGenderDraft.set(n.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:n=>this.state.guestHcpDraft.set(n.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(n,i,r)=>this.wireEl(Wb,{name:()=>n.displayNameSnapshot,category:{textContent:()=>n.category??"",className:()=>n.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>n.withdrawnAt?"Withdrawn":n.cutAfterRound!==null?`Cut R${n.cutAfterRound}`:"",className:()=>n.withdrawnAt||n.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!n.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),n.id)}},remove:{className:()=>this.state.admin.get()&&an(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),n.id)}}},r),n=>JSON.stringify({id:n.id,name:n.displayNameSnapshot,category:n.category,withdrawnAt:n.withdrawnAt,cutAfterRound:n.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(n,i,r)=>this.wireEl(Yb,{chip:{textContent:()=>n.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(o=>o.playerId===n.id),onclick:()=>{this.competitions.addPlayer(e(),n.id,null)}}},r),n=>n.id),t}}const Qb={not_started:"Not started",active:"Live",complete:"Finished"},Jb=y(`
    <section class="cd__section">
...
`),ey=y('<option bind="option"></option>');class ty extends A{competitions=this.inject(je);state=this.inject(wt);router=this.inject(q);render(){const e=new T(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(Jb,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Ab(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:n=>{n.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:n=>this.state.roundCourseDraft.set(n.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:n=>this.state.roundDateDraft.set(n.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(n,i,r)=>this.wireEl(ey,{option:{value:()=>n.id,textContent:()=>n.name}},r),n=>n.id),this.$each(this.ref(t,"rounds"),e,(n,i,r)=>this.wireEl(Zb,{row:{disabled:()=>!n.shareToken,onclick:()=>{n.shareToken&&this.router.navigate("/round",{query:{token:n.shareToken}})}},number:()=>`Round ${n.roundNumber}`,meta:()=>[n.courseNameSnapshot,n.date].filter(Boolean).join(" · ")||(n.shareToken?"Open":"View-only"),status:{textContent:()=>Qb[n.status]??n.status,className:()=>`cd__rstatus s-${n.status}`}},r),n=>JSON.stringify({id:n.id,status:n.status,shareToken:n.shareToken,courseName:n.courseNameSnapshot,date:n.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function sy(s,e,t){return JSON.stringify({entry:s,points:e,columns:t})}function ny(s){return s.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const iy=y(`
    <div>
...
`),ry=y('<button bind="button" type="button"></button>'),ay=y('<th bind="cell"></th>'),oy=y('<tr bind="row"></tr>'),ly=y('<td bind="cell"><span bind="value"></span></td>'),dy=y(`
...
`);class py extends A{static styles=`
        .cd {
            padding: ${a("lg")} ${a("lg")} ${a("2xl")};
    ...
    `;competitions=this.inject(je);state=this.inject(wt);router=this.inject(q);render(){const e=()=>this.competitions.detail.get();this.track(C(()=>{const n=this.state.id.get();n&&J(()=>{this.state.enter(),this.competitions.loadDetail(n)})})),this.state.initialize();const t=this.wire(hy,{back:{onclick:()=>this.router.navigate("/competitions")},loading:{className:()=>this.competitions.detailLoading.get()&&e()===null?"cd__loading":"cd__loading hidden"},loadErr:{textContent:()=>this.competitions.detailError.get()?.message??"",className:()=>this.competitions.detailError.get()?"cd__loaderr":"cd__loaderr hidden"},body:{className:()=>e()?"cd__body":"cd__body hidden"},name:()=>e()?.name??"",chip:{textContent:()=>Na(this.state.lifecycle.get()),className:()=>Oa(this.state.lifecycle.get())},ownerLine:{textContent:()=>this.state.admin.get()?"You administer this competition.":"Read-only view."},mutateErr:{textContent:()=>this.competitions.mutateError.get()??""},transitionRow:{className:()=>this.state.admin.get()&&Ds(this.state.lifecycle.get())?"cd__transition":"cd__transition hidden"},transitionBtn:{textContent:()=>Ds(this.state.lifecycle.get())?.label??"",disabled:()=>this.competitions.mutating.get(),onclick:()=>{const n=Ds(this.state.lifecycle.get()),i=this.state.id.get();n&&i&&this.competitions.transition(i,n.to)}}});return this.spawn(Ub,this.ref(t,"setup")),this.spawn(Xb,this.ref(t,"roster")),this.spawn(ty,this.ref(t,"rounds")),this.spawn(uy,this.ref(t,"results")),t}}const fy=y(`
    <div class="app-shell">
...
`);class my extends A{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(q);render(){const e=this.wire(fy,{header:{className:()=>un(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn($h,this.ref(e,"account")),this.spawn(hl,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":ci,"/history":Gh,"/round":Dm,"/create":xg,"/login":Tg,"/friends":Eg,"/friend":Ng,"/friend-rounds":Mg,"/friend-courses":Bg,"/spectate":Dg,"/profile":Kg,"/stats":gb,"/round-stats":Sb,"/admin":Mb,...pr.competitions?{"/competitions":Lb,"/competition":py}:{}},ci),e}}class gy extends U{constructor(e){super(),this.client=e}client;async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof Z&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof Z&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof Z&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}X.get(ao);const Qi=X.get(q);X.set(U,new gy(Pa));const Ji=X.get(U);await uo(my,"#app",{hot:void 0,onInit:async()=>{await Ji.load(),Ji.currentUser.get()&&Qi.route.get()==="/login"&&Qi.navigate("/",!0)}});export{js as A,A as C,q as R,p as S,ao as T,_ as a,We as b,T as c,to as d,C as e,eo as n,D as r,y as t};
