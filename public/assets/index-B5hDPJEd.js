(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const r of i)if(r.type==="childList")for(const a of r.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const r={};return i.integrity&&(r.integrity=i.integrity),i.referrerPolicy&&(r.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?r.credentials="include":i.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function s(i){if(i.ep)return;i.ep=!0;const r=t(i);fetch(i.href,r)}})();const Hs="modulepreload",Fs=function(n){return"/tapscore/"+n},bt={},Bs=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){let c=function(u){return Promise.all(u.map(f=>Promise.resolve(f).then(m=>({status:"fulfilled",value:m}),m=>({status:"rejected",reason:m}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),d=a?.nonce||a?.getAttribute("nonce");i=c(t.map(u=>{if(u=Fs(u),u in bt)return;bt[u]=!0;const f=u.endsWith(".css"),m=f?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${u}"]${m}`))return;const h=document.createElement("link");if(h.rel=f?"stylesheet":Hs,f||(h.as="script"),h.crossOrigin="",h.href=u,d&&h.setAttribute("nonce",d),document.head.appendChild(h),f)return new Promise((b,g)=>{h.addEventListener("load",b),h.addEventListener("error",()=>g(new Error(`Unable to preload CSS for ${u}`)))})}))}function r(a){const d=new Event("vite:preloadError",{cancelable:!0});if(d.payload=a,window.dispatchEvent(d),!d.defaultPrevented)throw a}return i.then(a=>{for(const d of a||[])d.status==="rejected"&&r(d.reason);return e().catch(r)})},Zt="/tapscore/".replace(/\/+$/,""),Ze=Zt+"/api",ze={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Gs=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function es(n,e){const t={};for(const[s,i]of Gs)if(s in n)for(const r of i)r in n||(t[r]=`var(--${s})`);return{...e,...t,...n}}const ts=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],qs={thin:"1px",medium:"3px",thick:"5px"};function ss(n){const e=n.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":qs[e.toLowerCase()]??e}function Ks(){return ts.map(n=>{const e=ss(ze[n]);return`@property --${n}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const ns={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},is={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Vs={...is,"done-opacity":"0.35"},Us={...ns,...is,...ze,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ws={...ns,...Vs,...ze,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Qs{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;rs(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const Y=new Qs;function rs(n){for(const e of n.deps)e.delete(n);n.deps.clear()}class p{constructor(e){this.subs=new Set,this.val=e}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,Y.notify(this.subs))}update(e){this.set(e(this.val))}}class S{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){Y.runTracked(s,()=>{const i=e();Object.is(t.val,i)||(t.val=i,Y.notify(t.subs))})},deps:new Set};s.run()}get(){return Y.subscribe(this.subs),this.val}peek(){return this.val}}function N(n){const e={run(){Y.runTracked(e,n)},deps:new Set};return e.run(),()=>{e.disposed=!0,rs(e)}}function me(n){Y.batch(n)}function q(n){return Y.untrack(n)}class Ys{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const B=new Ys,le=Zt;function et(n){return le?n===le?"/":n.startsWith(le+"/")?n.slice(le.length):n:n}function Xs(n){return le+n}class M{constructor(){this.route=new p(et(location.pathname??"/")),this.search=new p(location.search??""),window.addEventListener("popstate",()=>me(()=>{this.route.set(et(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),r=i>=0?e.slice(i):"",a=i>=0?e.slice(0,i):e,d=a.indexOf("?"),c=d>=0?a.slice(0,d):a,u=d>=0?a.slice(d+1):"",f=s.query!==void 0?Js(s.query):u?"?"+u:"",m=Xs(c)+f+r;(s.replace?history.replaceState:history.pushState).call(history,null,"",m),me(()=>{this.route.set(c),this.search.set(f)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===s||i.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new S(()=>{const s=this.route.get().split("/"),i={};for(const[r,a]of t.entries())a.startsWith(":")&&(i[a.slice(1)]=s[r]??"");return i})}query(e){return new S(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new S(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function Js(n){const e=new URLSearchParams;for(const[s,i]of Object.entries(n))i==null||i===""||e.set(s,String(i));const t=e.toString();return t?"?"+t:""}function Zs(n){return e=>n[e]}const en="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",yt="data-basics-global";function tn(){if(document.head.querySelector(`style[${yt}]`))return;const n=document.createElement("style");n.setAttribute(yt,""),n.textContent=Ks()+en,document.head.appendChild(n)}function sn(n,e){tn();const t=new Set(ts),s=(r,a,d)=>{const c=Object.entries(r).map(([u,f])=>`--${u}:${t.has(u)?ss(f):f}`).join(";");return`${a}{color-scheme:${d};${c}}`},i=document.createElement("style");return i.textContent=s(n,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),r=>`var(--${r})`}const _t="basics-js-theme";class nn{constructor(){this.dark=new p(!1);const e=localStorage.getItem(_t),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),N(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(_t,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function _(n){const e=document.createElement("template");return e.innerHTML=n,e}function rn(n,e){let t;for(const s of Object.keys(e))n.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const vt=new Set;class O{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!vt.has(t)){vt.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return B.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const i=q(()=>{const r=new e(s[0]);return r.mount(t),r});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){q(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const i=s??(a=>this.track(a)),r=e.content.cloneNode(!0);for(const a of r.querySelectorAll("[bind]")){const d=t[a.getAttribute("bind")];if(d)if(typeof d=="function")i(N(()=>{const c=d();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(c):a.textContent=String(c)}));else for(const[c,u]of Object.entries(d)){const f=c.includes("-");c.startsWith("on")&&typeof u=="function"?a.addEventListener(c.slice(2),u):typeof u=="function"?i(N(()=>{const m=u();f?a.setAttribute(c,String(m)):a[c]=m})):f?a.setAttribute(c,String(u)):a[c]=u}}return r}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const i=this.ref(t,e);return i?(typeof s=="string"?i.textContent=s:typeof s=="function"&&s.prototype instanceof O?this.spawn(s,i):typeof s=="function"&&s(i,{spawn:(r,a,...d)=>this.spawn(r,a,...d),track:r=>this.track(r)}),!0):!1}$each(e,t,s,i=(r,a)=>a){const r=typeof t=="function"?t:()=>t.get(),a=new Map,d=new Map;this.track(()=>{for(const c of d.values())c.forEach(u=>u());d.clear()}),this.track(N(()=>{const c=r(),u=new Map;for(const[m,h]of c.entries()){const b=i(h,m);if(a.has(b))u.set(b,a.get(b));else{const g=[];u.set(b,q(()=>s(h,m,x=>g.push(x)))),d.set(b,g)}}for(const[m,h]of a)u.has(m)||(h.remove(),q(()=>d.get(m)?.forEach(b=>b())),d.delete(m));let f=e.firstChild;for(const m of u.values())m===f?f=f.nextSibling:e.insertBefore(m,f);a.clear();for(const[m,h]of u)a.set(m,h)}))}$condition(e,t,s,i){let r=null;this.track(N(()=>{r&&(r.remove(),r=null);const a=t.get();r=q(()=>a?s():i?.()??null),r&&e.appendChild(r)}))}$swap(e,t,s,i){let r=null;this.track(N(()=>{if(r){const c=r;r=null,q(()=>c.destroy())}e.textContent="";const a=t.get(),d=s[a]??rn(a,s)??i;d&&(r=q(()=>{const c=new d;return c.mount(e),c}))})),this.track(()=>r?.destroy())}}const Ne=new Set;function an(n){return Ne.add(n),()=>Ne.delete(n)}function on(){for(const n of Array.from(Ne)){Ne.delete(n);try{n()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function ln(n,e,t){const s=document.querySelector(e);s.textContent="";const i=B.get(M);let r=null,a=!1,d=null,c=!!t?.hot?.data.hmr;const u=async f=>{r&&(r.destroy(),r=null,s.textContent=""),f?(d||(d=(await Bs(()=>import("./obs-shell.component-WV9DMv4M.js"),[])).ObsShellComponent),r=q(()=>new d)):(!c&&t?.onInit&&(await t.onInit(),c=!0),r=q(()=>new n)),q(()=>r.mount(s)),a=f};await u(et(location.pathname).startsWith("/_obs")),N(()=>{const f=i.route.get().startsWith("/_obs");f!==a&&u(f)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{r?.destroy()}catch(f){console.error("[startApp] the root component threw while disposing",f)}if(r=null,on(),t.onDispose)try{t.onDispose()}catch(f){console.error("[startApp] onDispose threw",f)}}),t.hot.accept())}class V extends Error{constructor(e,t,s,i){super(t),this.status=e,this.details=s,this.traceId=i,this.name="ApiError"}}const dn=10,Ce=[];let Te=[],ue=null;function cn(n){Ce.push(n),Ce.length>dn&&Ce.shift()}function as(n,e,t){const s={code:n,message:e,url:typeof location<"u"?location.href:"",context:[...Ce],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Te.push(s),un()}function un(){ue||(ue=setTimeout(os,5e3))}function os(){if(ue&&(clearTimeout(ue),ue=null),Te.length===0)return;const n=Te;Te=[];for(const e of n){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ze}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ze}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&os()});const hn=3e4,pn=2,_e=new Map,ls=new WeakMap;function mn(n){if(n instanceof V)return n.traceId;if(n!=null&&typeof n=="object")return ls.get(n)}async function y(n){if(n.method==="GET"){const e=_e.get(n.url);if(e)return e;const t=wt(n,pn);return _e.set(n.url,t),t.then(()=>_e.delete(n.url),()=>_e.delete(n.url)),t}return wt(n,0)}async function wt(n,e){const t=n.timeout??hn;let s;for(let i=0;i<=e;i++){const r=crypto.randomUUID();try{return await gn(fn(n,r),t)}catch(a){if(s=a,!(a instanceof V)&&a!=null&&typeof a=="object"&&ls.set(a,r),a instanceof V||i===e)break;await new Promise(d=>setTimeout(d,1e3*2**i))}}throw s}async function fn(n,e){const t={"X-Trace-Id":e},s={method:n.method,headers:t};n.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(n.body));const i=await fetch(n.url,s),r=i.headers.get("x-trace-id")??e;if(cn({type:"api",detail:`${n.method} ${n.url}`,timestamp:new Date().toISOString()}),!i.ok){const a=await i.json().catch(()=>({error:i.statusText}));throw new V(i.status,a.error??i.statusText,a.details,r)}return i.json()}function gn(n,e){let t;const s=new Promise((i,r)=>{t=setTimeout(()=>r(new Error("Request timeout")),e)});return Promise.race([n,s]).finally(()=>clearTimeout(t))}const tt=new Set;let Fe=!1;function bn(n){return tt.add(n),()=>{tt.delete(n)}}function yn(){if(!Fe){Fe=!0;try{for(const n of[...tt])try{n()}catch(e){try{as("session-listener",_n(e))}catch{}}}finally{Fe=!1}}}function _n(n){try{if(n instanceof Error){const e=n.message;if(typeof e=="string")return e}return String(n)}catch{return"listener threw a value that could not be described"}}async function z(n,e,t,s={}){me(()=>{n.set(!0),e.set(null)});try{const i=await t();return n.set(!1),i}catch(i){const r=vn(i);me(()=>{n.set(!1),e.set(r)}),as(r.code,r.message,mn(i)),r.code==="auth"&&s.sessionExpiry!==!1&&yn();return}}function vn(n){return n instanceof V?n.status===401?{code:"auth",message:"Unauthorized"}:n.status===409?{code:"conflict",message:"Data has changed — please try again"}:n.status===400?{code:"validation",message:n.message}:n.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:n instanceof Error?n.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const xt={sessionExpiry:!1};function wn(n){return{me:()=>y({method:"GET",url:`${n}/auth/me`}),login:e=>y({method:"POST",url:`${n}/auth/login`,body:e}),logout:()=>y({method:"POST",url:`${n}/auth/logout`,body:{}})}}class H{constructor(){this.api=wn(Ze),this.currentUser=new p(null),this.loading=new p(!1),this.error=new p(null),this.offSessionExpired=bn(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=an(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await z(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await z(this.loading,this.error,()=>this.api.login({username:e,password:t}),xt);return s?(this.currentUser.set(s),!0):!1}async logout(){await z(this.loading,this.error,()=>this.api.logout(),xt);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}}const ds={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},xn={...ds,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},$n={...ds,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"},kn=es(xn,Us),Sn=es($n,Ws),o=sn(kn,Sn),E=n=>`var(--${n})`,$=(n,e)=>`var(--${n}, ${e})`,k=n=>{const e=ze[n];if(e===void 0)throw new Error(`unknown control token: --${n}`);return e},l=Zs({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),ve=n=>`
    ...
    cursor: not-allowed;`,Cn={primary:ve("primary"),secondary:ve("secondary"),ghost:ve("ghost"),danger:ve("danger"),disabled:cs},T=(n=$("btn-radius",k("btn-radius")),e="secondary")=>`
    /*
    ...
    ${Cn[e]}
    &:disabled {${cs}}
`,Tn=`max(${$("field-border-width",k("field-border-width"))}, ${$("field-rule-width",k("field-rule-width"))})`,we=(n,e)=>`
    border-top-color: ${n};
    ...
    ${we($("field-border",k("field-border")),$("field-rule",k("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${we($("field-focus-border",k("field-focus-border")),$("field-focus-border",k("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${we($("field-invalid-border",k("field-invalid-border")),$("field-invalid-rule",k("field-invalid-rule")))}
    }
...
`);class di extends O{static styles=`
        .tabbar {
            display: flex;
    ...
    `;router=this.inject(M);auth=this.inject(H);landing=this.inject(De);newCount=new S(()=>this.auth.currentUser.get()?this.landing.newRounds.get().length:0);render(){const e=this.wire(oi,{root:{className:()=>ai(this.router.route.get(),this.auth.currentUser.get()!==null)?"tabbar":"tabbar hidden"}}),t=ii(ps);return this.$each(this.ref(e,"root"),()=>t,(s,i,r)=>this.wireEl(li,{link:{...this.router.link(s.href),href:s.href},icon:{innerHTML:()=>s.icon},label:()=>s.label,badge:{textContent:()=>{if(s.key!=="home")return"";const a=this.newCount.get();return a===0?"":String(a)},className:()=>(s.key==="home"?this.newCount.get():0)===0?"tabbar__badge":"tabbar__badge show"}},r),s=>s.key),e}}const fs=["tee","approach","putting","shortGame","penalties","recovery"],Ie={enabled:!1,tee:!1,approach:!1,putting:!1,shortGame:!1,penalties:!1,recovery:!1};function gs(n){switch(n){case"tee":return"Tee shots";case"approach":return"Greens in regulation";case"putting":return"Putting";case"shortGame":return"Short game";case"penalties":return"Penalties";case"recovery":return"Recovery"}}function ci(n){switch(n){case"tee":return"Fairway, in play or trouble — asked on par 4s and 5s.";case"approach":return"Did the ball hit the green in regulation.";case"putting":return"How long the first putt was, and how many you took.";case"shortGame":return"Standard or hard, asked only when you missed the green.";case"penalties":return"How many penalty strokes the hole cost you.";case"recovery":return"Whether the recovery shot got you back in play."}}const ui="Track statistics",hi="Adds a few taps per hole while you score — turn it off any time, your picks are kept.";function bs(n){switch(n){case"shortGame":return"putting";case"recovery":return"tee";default:return null}}function Pe(n,e){return n[e]}function pi(n,e){if(!n.enabled)return!0;const t=bs(e);return t===null?!1:!Pe(n,t)}function mi(n,e){if(!n.enabled)return null;const t=bs(e);return t===null||Pe(n,t)?null:`Needs ${gs(t)}`}function fi(n,e,t){return bi({...n,[e]:t})}function gi(n,e){return{...n,enabled:e}}function bi(n){const e={...n};return e.putting||(e.shortGame=!1),e.tee||(e.recovery=!1),e}function Ge(n){const e={...Ie,enabled:n.enabled};for(const t of fs)e[t]=n[t];return e}class Ae{loading=new p(!1);error=new p(null);player=new p(null);history=new p([]);clubs=new p([]);saving=new p(!1);saveError=new p(null);statsConfig=new p(Ie);statsSaving=new p(!1);statsError=new p(null);async load(e=!1){if(!e&&(this.player.get()!==null||this.loading.get()))return;const t=await z(this.loading,this.error,()=>Promise.all([v.players.me(),v.players.myHandicapHistory(),v.clubs.list(),v.playerStats.myConfig().catch(()=>null)]));if(!t)return;const[s,i,r,a]=t;this.player.set(s),this.history.set(i),this.clubs.set(r),this.statsConfig.set(a?Ge(a):Ie)}clear(){this.player.set(null),this.history.set([]),this.error.set(null),this.saveError.set(null),this.statsConfig.set(Ie),this.statsError.set(null)}async saveIndex(e){return await z(this.saving,this.saveError,()=>v.players.updateHandicap({handicapIndex:e}))?(await this.load(!0),!0):!1}async saveGender(e){const t=await z(this.saving,this.saveError,()=>v.players.updateProfile({gender:e}));return t?(this.player.set(t),!0):!1}async saveHomeClub(e){const t=await z(this.saving,this.saveError,()=>v.players.updateProfile({homeClubId:e}));return t?(this.player.set(t),!0):!1}async saveStatsConfig(e){if(this.statsSaving.get()||this.saving.get())return!1;const t=await z(this.statsSaving,this.statsError,()=>v.playerStats.putMyConfig(Ge(e)));return t?(this.statsConfig.set(Ge(t)),!0):!1}homeClubName(){const e=this.player.get()?.homeClubId;return e?this.clubs.get().find(t=>t.id===e)?.name??null:null}}function qe(n,e){return n.displayName.localeCompare(e.displayName,"sv",{sensitivity:"base"})}function ct(n,e="frecency"){return e==="alpha"?[...n].sort(qe):[...n].sort((t,s)=>{const i=t.frecency,r=s.frecency,a=i>0,d=r>0;if(a!==d)return a?-1:1;if(!a)return qe(t,s);if(r!==i)return r-i;const c=t.lastPlayedAt?Date.parse(t.lastPlayedAt):NaN,u=s.lastPlayedAt?Date.parse(s.lastPlayedAt):NaN,f=Number.isNaN(c)?Number.NEGATIVE_INFINITY:c,m=Number.isNaN(u)?Number.NEGATIVE_INFINITY:u;return m!==f?m-f:qe(t,s)})}const yi=1440*60*1e3;function _i(n,e){if(!n)return null;const t=Date.parse(n),s=Date.parse(e);if(Number.isNaN(t)||Number.isNaN(s))return null;const i=Math.floor((s-t)/yi);if(i<=0)return"today";if(i===1)return"yesterday";if(i<7)return`${i} days ago`;if(i<14)return"last week";if(i<30)return`${Math.floor(i/7)} weeks ago`;if(i<60)return"last month";if(i<365)return`${Math.floor(i/30)} months ago`;const r=Math.floor(i/365);return r===1?"last year":`${r} years ago`}function vi(n,e){if(n.sharedRoundCount<=0)return"never played";const t=_i(n.lastPlayedAt,e),s=`played ${n.sharedRoundCount}×`;return t?`${s}, ${t}`:s}const ys=2;function St(n){return n.trim().length>=ys}function _s(n){return ct(n,"frecency")}function wi(n,e){return _s([...n.filter(t=>t.id!==e.id),e])}function xi(n,e){return n.filter(t=>t.id!==e)}function Ct(n,e,t){return n.map(s=>s.id===e?{...s,isFriend:t}:s)}function $i(n,e,t=()=>{},s=300){let i=0,r;return a=>{const d=a.trim(),c=++i;if(r!==void 0&&clearTimeout(r),r=void 0,d.length<ys){e(d,[]);return}r=setTimeout(()=>{n(d).then(u=>{c===i&&e(d,u)},u=>{c===i&&t(d,u)})},s)}}const vs=je("tapscore.friends.sort.v1",{decode:n=>n==="alpha"?"alpha":"frecency",encode:n=>n,empty:"frecency"});function ki(n=G()){return vs.read(n)}function Si(n,e=G()){vs.write(n,e)}class Me{loading=new p(!1);error=new p(null);friends=new p([]);loaded=new p(!1);sortMode=new p(ki());query=new p("");searching=new p(!1);searchError=new p(null);results=new p([]);resultsFor=new p("");mutating=new p(!1);mutateError=new p(null);runSearch=$i(e=>v.players.search({q:e}),(e,t)=>{this.searching.set(!1),this.results.set(t),this.resultsFor.set(e)},(e,t)=>{this.searching.set(!1),this.results.set([]),this.resultsFor.set(e),this.searchError.set({code:"network",message:t instanceof Error?t.message:"Search failed. Try again."})});async load(e=!1){if(!e&&(this.loaded.get()||this.loading.get()))return;const t=await z(this.loading,this.error,()=>v.friends.list());t&&(this.friends.set(_s(t)),this.loaded.set(!0))}setQuery(e){this.query.set(e),this.searchError.set(null),this.searching.set(e.trim().length>=2),this.runSearch(e)}async add(e){await z(this.mutating,this.mutateError,()=>v.friends.add({friendId:e.id}))&&(this.friends.set(wi(this.friends.get(),{id:e.id,username:e.username,displayName:e.displayName,gender:e.gender,handicapIndex:e.handicapIndex,homeClubName:e.homeClubName,sharedRoundCount:0,lastPlayedAt:null,frecency:0})),this.results.set(Ct(this.results.get(),e.id,!0)))}setSortMode(e){this.sortMode.set(e),Si(e)}async remove(e){await z(this.mutating,this.mutateError,()=>v.friends.remove({friendId:e}))&&(this.friends.set(xi(this.friends.get(),e)),this.results.set(Ct(this.results.get(),e,!1)))}clear(){this.friends.set([]),this.loaded.set(!1),this.query.set(""),this.results.set([]),this.resultsFor.set(""),this.error.set(null),this.searchError.set(null),this.mutateError.set(null),this.searching.set(!1)}}class ws{roles=new p([]);rolesLoaded=!1;loading=new p(!1);error=new p(null);stats=new p(null);rounds=new p([]);players=new p([]);isSuperAdmin(){return this.roles.get().some(e=>e.role==="super_admin"&&e.scopeType===null)}async loadRoles(e=!1){if(!(!e&&this.rolesLoaded)){this.rolesLoaded=!0;try{this.roles.set(await v.admin.myRoles())}catch{this.roles.set([])}}}clear(){this.roles.set([]),this.rolesLoaded=!1,this.stats.set(null),this.rounds.set([]),this.players.set([]),this.error.set(null)}async load(e=!1){if(!e&&this.stats.get()!==null)return;const t=await z(this.loading,this.error,()=>Promise.all([v.admin.adminStats(),v.admin.adminRounds({limit:100}),v.admin.adminPlayers()]));if(!t)return;const[s,i,r]=t;this.stats.set(s),this.rounds.set(i),this.players.set(r)}}async function Ci(n){await n.auth.logout(),n.profile.clear(),n.friends.clear(),n.admins.clear(),n.landing.clear(),n.navigate("/")}function Ti(n){if(!n.signedIn)return[];const e=[{kind:"identity",displayName:(n.displayName??"").trim()||(n.username??"").trim()||"Signed in",username:(n.username??"").trim()},{kind:"profile",label:"Profile"}];return n.isSuperAdmin&&e.push({kind:"admin",label:"Admin"}),e.push({kind:"signout",label:"Sign out"}),e}function Ii(n){return Ti(n).map(e=>e.kind)}function Tt(n){return n.signedIn?"avatar":"signin"}function Ei(n,e){const t=(n??"").trim().split(/\s+/).filter(i=>i.length>0);if(t.length>=2)return(xe(t[0])+xe(t[t.length-1])).toUpperCase();if(t.length===1)return xe(t[0]).toUpperCase();const s=(e??"").trim();return s.length>0?xe(s).toUpperCase():"•"}function xe(n){return[...n][0]??""}const Ni=_(`
...
`);class Pi extends O{static styles=`
        .acct {
            position: relative;
            display: flex;
    ...
    `;auth=this.inject(H);profile=this.inject(Ae);friends=this.inject(Me);admins=this.inject(ws);landing=this.inject(De);router=this.inject(M);open=new p(!1);state=new S(()=>({signedIn:this.auth.currentUser.get()!==null,displayName:this.profile.player.get()?.displayName??null,username:this.profile.player.get()?.username??this.auth.currentUser.get()?.username??null,isSuperAdmin:this.admins.isSuperAdmin()}));has(e){return Ii(this.state.get()).includes(e)}rowClass(e,t=""){const s=`acct__row${t}`;return this.has(e)?s:`${s} hidden`}render(){this.auth.currentUser.get()&&(this.profile.load(),this.admins.loadRoles());const e=this.wire(Ni,{signin:{className:()=>Tt(this.state.get())==="signin"?"acct__signin":"acct__signin hidden",onclick:()=>{this.open.set(!1),this.router.navigate("/login")}},avatar:{className:()=>Tt(this.state.get())==="avatar"?"acct__avatar":"acct__avatar hidden",textContent:()=>{const u=this.state.get();return Ei(u.displayName,u.username)},"aria-expanded":()=>this.open.get()?"true":"false",onclick:()=>this.open.set(!this.open.get())},menu:{className:()=>this.open.get()&&this.has("identity")?"acct__menu":"acct__menu hidden"},idName:()=>{const u=this.state.get();return(u.displayName??"").trim()||(u.username??"").trim()||"Signed in"},idUser:()=>{const u=(this.state.get().username??"").trim();return u===""?"":`@${u}`},profile:{className:()=>this.rowClass("profile"),onclick:()=>{this.open.set(!1),this.router.navigate("/profile")}},admin:{className:()=>this.rowClass("admin"),onclick:()=>{this.open.set(!1),this.router.navigate("/admin")}},signout:{className:()=>this.rowClass("signout"," acct__row--quiet"),onclick:async()=>{this.open.set(!1),await Ci({auth:this.auth,profile:this.profile,friends:this.friends,admins:this.admins,landing:this.landing,navigate:u=>this.router.navigate(u)})}}}),t=this.ref(e,"root"),s=e.querySelector('[bind="avatar"]'),i=u=>{u.key==="Escape"&&this.open.get()&&(this.open.set(!1),s?.focus())},r=u=>{if(!this.open.get())return;const f=u.target;f instanceof Node&&t.contains(f)||this.open.set(!1)};let a=!1;const d=()=>{a||(a=!0,window.addEventListener("keydown",i),document.addEventListener("pointerdown",r,!0))},c=()=>{a&&(a=!1,window.removeEventListener("keydown",i),document.removeEventListener("pointerdown",r,!0))};return this.track(N(()=>{this.open.get()?d():c()})),this.track(c),e}}const ft=class ft extends O{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(N(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};ft.styles=`
        .ui-overlay {
            position: fixed;
            inset: 0;
            opacity: 0;
    ...
    `;let st=ft;const I=n=>`var(--${n})`,gt=class gt extends O{render(){const e=document.createElement("div"),t=(c,u)=>{typeof u=="function"?this.track(N(()=>{c.textContent=u()})):c.textContent=u};this.spawn(st,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200";const s=document.createElement("h2");s.className="ui-confirm__title",t(s,this.props.title??"Confirm"),this.dialogEl.appendChild(s);const i=document.createElement("p");i.className="ui-confirm__message",t(i,this.props.message),this.dialogEl.appendChild(i);const r=document.createElement("div");r.className="ui-confirm__actions";const a=document.createElement("button");a.className="ui-confirm__btn ui-confirm__btn--cancel",t(a,this.props.cancelLabel??"Cancel"),a.addEventListener("click",c=>{c.stopPropagation(),this.handleCancel()}),r.appendChild(a);const d=document.createElement("button");return d.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(d,this.props.confirmLabel??"Confirm"),d.addEventListener("click",c=>{c.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),r.appendChild(d),this.dialogEl.appendChild(r),this.dialogEl.addEventListener("click",c=>c.stopPropagation()),e.appendChild(this.dialogEl),this.track(N(()=>{this.dialogEl.classList.toggle("open",this.props.open.get())})),e}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}};gt.styles=`
        .ui-confirm {
            ...
            box-shadow: ${I("shadow-3")};
            z-index: 200;
            opacity: 0;
            pointer-events: none;
            transition:
                opacity ${I("dur-slow")} ${I("ease-standard")},
                transform ${I("dur-slow")} ${I("ease-standard")};
        }
        .ui-confirm.open {
            opacity: 1;
            pointer-events: auto;
        ...
        .ui-confirm__btn:focus-visible {
            outline: none;
            box-shadow: 0 0 0 3px ${I("accent-soft")};
        }
    ...
    `;let U=gt;function Ri(n){const e=typeof navigator<"u"?navigator.language:void 0;return typeof e=="string"&&e.toLowerCase().startsWith("sv")?"sv":"en"}function re(){return Ri()}const Ee=10;class fe{loading=new p(!1);error=new p(null);descriptors=new p([]);started=!1;async load(){if(this.started)return;this.started=!0;const e=await z(this.loading,this.error,()=>v.setup.formats());e?this.descriptors.set(e):this.started=!1}byId(e){return this.descriptors.get().find(t=>t.id===e)??null}labelOf(e,t=re()){const s=typeof e=="string"?this.byId(e):e;return s?s.labels?.[t]??s.labels?.en??s.label:null}classify(e){const t=e.requirements.balls;if(t.ballMode==="team")return{kind:"team_ball",teamSize:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{};return{kind:"team_grouping",teamSize:{min:s.teamSize?.min??2,max:s.teamSize?.max??2},...s.teamCount?{teamCount:s.teamCount}:{}}}return{kind:"individual",teamSize:{min:1,max:1}}}configLabelOf(e,t=re()){return e.labels?.[t]??e.labels?.en??""}presets(e=re()){return this.descriptors.get().filter(s=>s.preset).sort((s,i)=>{const r=s.preset?.rank??Number.POSITIVE_INFINITY,a=i.preset?.rank??Number.POSITIVE_INFINITY;return r!==a?r-a:(this.labelOf(s,e)??s.id).localeCompare(this.labelOf(i,e)??i.id)})}taglineOf(e,t=re()){const i=(typeof e=="string"?this.byId(e):e)?.preset?.tagline;return i?.[t]??i?.en??""}playableShape(e){const t=e.requirements.balls;if(t.ballMode==="team")return{count:this.ballCountOf(t.slotBallCount),size:{...t.producerCount}};if(t.requiresSlotTeamGrouping){const s=t.slotTeamGrouping??{},i=s.teamCount??{};return{count:{min:i.min??2,...i.max!==void 0?{max:i.max}:{}},size:{min:s.teamSize?.min??2,max:s.teamSize?.max??2}}}if(t.slotBallCount){const s=this.acceptsSideSubjects(e);return{count:this.ballCountOf(t.slotBallCount),size:{min:1,max:s?Ee:1}}}return{count:{min:1},size:{min:1,max:1}}}ballCountOf(e){return{min:e?.min??2,...e?.max!==void 0?{max:e.max}:{}}}classifyId(e){const t=this.byId(e);return t?this.classify(t):null}needsTeams(e){const t=this.classifyId(e);return!!t&&t.kind!=="individual"}isSideFormat(e){return this.classifyId(e)?.kind==="team_grouping"}acceptsSideSubjects(e){const t=typeof e=="string"?this.byId(e):e;return!t||this.classify(t).kind==="team_grouping"?!1:(t.requirements.scoreEntry?.metadata?.length??0)===0}}function xs(n){const e=B.get(fe);return e.load(),e.labelOf(n.formatId)??`${n.scoringMode} · ${n.teamShape}`}function Oi(n){return n.map(e=>({key:e.round.id,token:e.token,roundId:e.round.id,name:e.round.name,courseName:e.round.courseNameSnapshot??"",status:e.round.status,completedAt:e.round.completedAt,lastActivityAt:e.round.date,roleLabel:Vn(e)||null,date:e.round.date,formats:e.round.formatSlots.map(xs).join(" · ")}))}function zi(n){return n.map(e=>({key:e.token,token:e.token,roundId:null,name:e.name??null,courseName:e.courseName,status:e.status,completedAt:e.completedAt??null,lastActivityAt:e.lastSeenAt,roleLabel:null,date:e.date??null,formats:null}))}function ge(n){const e=(n.name??"").trim();return e||n.courseName||"Round"}function Re(n){return n.courseName?ge(n)===n.courseName?null:n.courseName:null}function $s(n,e=typeof navigator>"u"?"en":navigator.language){return n?/^\d{4}-\d{2}-\d{2}$/.test(n)?new Intl.DateTimeFormat(e,{dateStyle:"medium",timeZone:"UTC"}).format(new Date(`${n}T12:00:00Z`)):n:""}const he={fromMyRounds:Oi,fromDeviceRounds:zi},ji=14,Li=1440*60*1e3;function oe(n,e){return e(n)}function Di(n,e,t,s=ji){const i=e-s*Li,r=[],a=[];for(const d of n){const c=oe(d,t);if(c.status==="complete"){const u=c.completedAt?Date.parse(c.completedAt):NaN;(Number.isNaN(u)||u>=i)&&a.push(d)}else r.push(d)}return r.sort((d,c)=>It(oe(d,t).lastActivityAt,oe(c,t).lastActivityAt)),a.sort((d,c)=>It(oe(d,t).completedAt,oe(c,t).completedAt)),{ongoing:r,finished:a}}function It(n,e){const t=n?Date.parse(n):NaN,s=e?Date.parse(e):NaN,i=Number.isNaN(t)?Number.NEGATIVE_INFINITY:t,r=Number.isNaN(s)?Number.NEGATIVE_INFINITY:s;return i===r?0:r-i}const Ai=_(`
    <div class="landing">
...
`),Mi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',Hi=_(`
    <div class="round-row">
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Mi}</button>
    </div>
`),ks={not_started:"Not started",active:"Live",complete:"Finished"};class Et extends O{static styles=`
        .landing {
...
`),Gi='<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><path d="M3 6h18"/><path d="M19 6v14a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2V6"/><path d="M8 6V4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/></svg>',qi=_(`
    <div class="round-row">
        <button bind="row" type="button" class="round-row__main">
            <div class="round-row__top">
                <span bind="title" class="round-row__title"></span>
        ...
        <button bind="del" type="button" class="round-row__del" aria-label="Delete round">${Gi}</button>
    </div>
`);class Ki extends O{static styles=`
        .history {
...
`),Or=_('<button bind="btn" class="se-seg" type="button"></button>'),zr=_(`
    <div class="se-stats__group">
        <span bind="glabel" class="se-stats__group-label"></span>
...
`),jr=_('<div bind="rule" class="se-stats__rule"></div>');class Lr extends O{static styles=`
        .se {
            margin-top: ${l("xl")};
            &.hidden { display: none; }
        }
        ...
        .se-row {
            ...
            & .se-row__scores { display: flex; align-items: center; padding-right: ${At}px; flex-shrink: 0; }
...
</div>`}function oa(n,e){const t=Vr(n,e),s=t.matches.map(i=>{const r=i.leader==="a"?" lb-mp__team--lead":"",a=i.leader==="b"?" lb-mp__team--lead":"";return`<div class="lb-mp">
...
</div>`}const la={ranked:aa,match_summary:(n,e)=>oa(n,e)},da={"default-score-grid":ta,"compact-match-grid":sa,"category-matrix-grid":na};function ca(n){return`<div class="lb-diag">Unrenderable result section <code>${P(n)}</code> — no generic view yet. Results are not hidden.</div>`}function ua(n){return`<div class="lb-diag">Unsupported score-grid component <code>${P(n)}</code> — no generic view yet. Results are not hidden.</div>`}function ha(n,e,t,s=null){const i=la[n.kind];return i?i(n,e,t,s):ca(n.kind)}function Os(n,e,t,s){const i=Es(n),r=da[i];return r?r(n,e,t,s):ua(i)}function pa(n,e,t=Rs,s=null){return n.leaderboard.length===0&&n.cards.length===0?`<div class="lb-empty">No scores entered yet for ${P(n.formatLabel)}.</div>`:n.leaderboard.map(r=>ha(r,e,t,s&&r===s.plan.rankedSection?s:null)).join("")||`<div class="lb-empty">No leaderboard metric for ${P(n.formatLabel)}.</div>`}function ma(n,e,t,s={}){if(n.length===0)return"";const i=s.mode??"product";return n.map(r=>Os(r,e,t,{mode:i})).join(`
`)}const fa=_(`
    <div bind="root" class="lb">
        <div bind="status" class="lb__status hidden"></div>
        <div bind="body" class="lb__body"></div>
    </div>
`);class ga extends O{static styles=`
        .lb {
    ...
    `;svc=this.inject(ne);expansion=new Qr;slots=()=>this.svc.result.get()?.slots??[];currentSlot=()=>{const e=this.slots(),t=this.svc.selectedSlotDefId();return e.find(s=>s.slotDefId===t)??e[0]??null};render(){return this.wire(fa,{status:{className:()=>{const t=this.svc.resultLoading.get(),s=this.svc.result.get()===null;return t||s?"lb__status":"lb__status hidden"},textContent:()=>this.svc.resultLoading.get()?"Loading results…":"No results yet."},body:{innerHTML:()=>this.renderBody(),onclick:t=>this.onBodyClick(t),onkeydown:t=>this.onBodyKeydown(t)}})}rowFor(e){return e.target?.closest?.("tr[data-expand-key]")??null}onBodyClick(e){const t=this.rowFor(e);if(!t||(window.getSelection?.()?.toString()??"")!=="")return;const s=t.getAttribute("data-expand-key")??"";this.applyOpen(t,this.expansion.toggle(s))}onBodyKeydown(e){if(e.key!=="Escape")return;const t=this.rowFor(e);if(!t)return;const s=t.getAttribute("data-expand-key")??"";this.expansion.isOpen(s)&&(this.applyOpen(t,this.expansion.set(s,!1)),t.querySelector(".lb-rank__toggle")?.focus(),e.stopPropagation())}applyOpen(e,t){e.classList.toggle("lb-rank__row--open",t),e.querySelector(".lb-rank__toggle")?.setAttribute("aria-expanded",String(t));const s=e.nextElementSibling;s?.classList.contains("lb-rank__panel")&&s.classList.toggle("lb-rank__panel--open",t)}renderBody(){const e=this.svc.result.get();if(!e)return"";const t=this.currentSlot();if(!t)return'<div class="lb-empty">No formats in this round.</div>';const s=u=>{const f=this.svc.nameOf(u);return this.svc.isPending(u)?`${f} (open seat)`:f},i=u=>this.svc.groupLabelOf(u),r=Wr(t);this.expansion.retain(r.attached.keys());const a=pa(t,s,i,{plan:r,routeSections:e.routeSections,isOpen:u=>this.expansion.isOpen(u)}),d=ma(r.standalone,e.routeSections,s),c=d?`<h3 class="lb-cards__head">Scorecard</h3>${d}`:"";return a+c}}function ba(n,e){if(!e)return[];const t=[],s=new Set;for(const i of n)for(const r of i.players){if(r.playerId===e)return[];r.guestPlayerId===null||s.has(r.guestPlayerId)||(s.add(r.guestPlayerId),t.push({guestPlayerId:r.guestPlayerId,displayName:r.displayName}))}return t}const ya=_(`
...
`);class va extends O{static styles=`
        .claim-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
    ...
    `,pe.seq=0;let W=pe;function xa(n){if(!n)return{visible:!1,selfAllowed:!1,guestAllowed:!1,blockedMessage:null};const e=n.seats.length>0,t=n.claimedSeats.some(r=>r.viewerMayRelease),s=n.viewer.claimSeat.allowed,i=n.viewer.claimSeatAsGuest.allowed;return{visible:e||t,selfAllowed:e&&s,guestAllowed:e&&i,blockedMessage:e&&!s&&!i?n.viewer.claimSeat.message??n.viewer.claimSeatAsGuest.message??"Claiming seats is not available on this round.":null}}function $a(n,e){const t=[];if(n.groupId!==null&&e.length>0){const s=e.findIndex(i=>i.id===n.groupId);if(s>=0){t.push(`Group ${s+1}`);const i=e[s].startTime;i.includes(":")&&t.push(i)}}return n.category!==null&&t.push(n.category),t.join(" · ")}function ka(n){return(n?.claimedSeats??[]).filter(e=>e.viewerMayRelease)}const Sa=_(`
...
`);class Ia extends O{static styles=`
        .seat-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
...
`);class Oa extends O{static styles=`
        .join-card {
            margin-top: ${l("lg")};
            padding: ${l("lg")};
            ${L()}
    ...
    `;svc=this.inject(ne);auth=this.inject(H);router=this.inject(M);tokenQ=this.router.query("token");joining=new p(!1);error=new p("");diagnostics=new p([]);teeId=new p("");tees=new p([]);loadedForCourseId=null;groupChoice=new p("");policyState(){return Na(this.svc.startList.get())}eligible(){return this.policyState().visible&&Ea(this.svc.balls.get(),this.auth.currentUser.get()?.id??null,this.svc.round.get()?.status??null)}ensureTeesLoaded(){if(!this.eligible())return;const e=this.svc.round.get()?.courseId;!e||e===this.loadedForCourseId||(this.loadedForCourseId=e,v.setup.teesByCourse({courseId:e}).then(t=>{this.tees.set(t),!this.teeId.get()&&t[0]&&this.teeId.set(t[0].id)}).catch(()=>{this.loadedForCourseId=null}))}needsProfileUpdate(){return this.diagnostics.get().some(e=>e.code==="missing_gender"||e.code==="missing_handicap_index")}async join(){const e=this.tokenQ.get(),t=this.teeId.get();if(!(!e||!t||this.joining.get())){this.error.set(""),this.diagnostics.set([]),this.joining.set(!0);try{const s=this.groupChoice.get(),i=await v.friendlyRounds.join({token:e,teeId:t,...s?{groupChoice:s}:{}});i.ok?await this.svc.loadByToken(e):this.diagnostics.set(i.diagnostics)}catch(s){this.error.set(s instanceof V&&s.status===409?s.message??"You already play in this round, or it has already started.":"Could not join right now. Try again.")}finally{this.joining.set(!1)}}}render(){this.track(N(()=>this.ensureTeesLoaded()));const e=new S(()=>Pa(this.svc.groups(),this.svc.startList.get()?.viewer.createGroup.allowed??!0));this.track(N(()=>{const r=e.get(),a=this.groupChoice.get();(!a||!r.options.some(d=>d.value===a&&!d.disabled))&&this.groupChoice.set(r.defaultValue)}));const t=this.wire(Ra,{root:{className:()=>this.eligible()?"join-card":"join-card hidden"},blocked:{className:()=>this.policyState().blockedMessage!==null?"join-card__blocked":"join-card__blocked hidden",textContent:()=>this.policyState().blockedMessage??""},groupRow:{className:()=>this.svc.groups().length>0&&this.policyState().blockedMessage===null?"join-card__group":"join-card__group hidden"},row:{className:()=>this.policyState().blockedMessage===null?"join-card__row":"join-card__row hidden"},join:{disabled:()=>this.joining.get()||!this.teeId.get(),onclick:()=>{this.join()}},diag:{className:()=>this.diagnostics.get().length>0?"join-card__diag":"join-card__diag hidden"},diagText:{textContent:()=>this.diagnostics.get().map(r=>r.message).join(" · ")},profileLink:{className:()=>this.needsProfileUpdate()?"join-card__profile-link":"join-card__profile-link hidden",onclick:()=>this.router.navigate("/profile")},err:{textContent:()=>this.error.get()}}),s=new W({value:this.teeId,options:{get:()=>this.tees.get().map(r=>({value:r.id,label:r.name}))},placeholder:"Tee"});s.mount(this.ref(t,"teeHost")),this.track(()=>s.destroy());const i=new W({value:this.groupChoice,options:{get:()=>e.get().options},placeholder:"Group"});return i.mount(this.ref(t,"groupHost")),this.track(()=>i.destroy()),t}}function za(n,e){if(!e)return!1;for(const t of n)for(const s of t.players)if(s.playerId===e)return!0;return!1}const ja=_(`
...
`);class La extends O{static styles=`
...
`),Ua=_('<button bind="pill" class="round-view__fmt" type="button"></button>'),Wa=_('<button bind="pill" class="round-view__grp" type="button"></button>');class Qa extends O{static styles=`
        .round-view {
            height: 100%;
            display: flex;
            flex-direction: column;
...
`);class xo extends O{static styles=`
        .setup {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
        ...
        .hcp {
            ...
            & .hcp__bs { ${T()} width: 44px; height: 44px; flex-shrink: 0; font-size: 1.1rem; }
            ...
            & .hcp__cancel { ${T()} flex: 1; padding: ${l("md")}; font-family: inherit; font-weight: 700; font-size: 0.95rem; }
            & .hcp__ok {
                ${T()}
...
`);class To extends O{static styles=`
        .login {
            max-width: 340px;
            margin: 0 auto;
            padding: 14vh ${l("xl")} 0;
...
`);function Yt(n){return n.split(/\s+/).filter(Boolean).slice(0,2).map(e=>e[0].toUpperCase()).join("")}class Po extends O{static styles=`
        .friends {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
    ...
    `;svc=this.inject(Me);auth=this.inject(H);router=this.inject(M);render(){const e=()=>this.auth.currentUser.get()!==null;e()&&this.svc.load();const t=this.wire(Io,{anon:{className:()=>e()?"friends__anon hidden":"friends__anon"},toLogin:{onclick:()=>this.router.navigate("/login",{query:{next:"/friends"}})},body:{className:()=>e()?"friends__body":"friends__body hidden"},search:{value:()=>this.svc.query.get(),oninput:i=>this.svc.setQuery(i.target.value)},searchHint:{textContent:()=>{const i=this.svc.query.get().trim();return i.length>0&&!St(i)?"Type at least 2 characters.":this.svc.searching.get()?"Searching…":""}},searchErr:{textContent:()=>this.svc.searchError.get()?.message??""},resultsEmpty:{className:()=>{const i=this.svc.query.get().trim();return St(i)&&!this.svc.searching.get()&&this.svc.searchError.get()===null&&this.svc.resultsFor.get()===i&&this.svc.results.get().length===0?"friends__empty":"friends__empty hidden"}},friendsEmpty:{className:()=>this.svc.loaded.get()&&this.svc.friends.get().length===0?"friends__empty":"friends__empty hidden"},sortToggle:{className:()=>this.svc.friends.get().length>0?"friends__sort":"friends__sort hidden"},sortFrecency:{"aria-pressed":()=>String(this.svc.sortMode.get()==="frecency"),onclick:()=>this.svc.setSortMode("frecency")},sortAlpha:{"aria-pressed":()=>String(this.svc.sortMode.get()==="alpha"),onclick:()=>this.svc.setSortMode("alpha")}});this.$each(this.ref(t,"results"),this.svc.results,(i,r,a)=>this.wireEl(Eo,{initials:()=>Yt(i.displayName),name:()=>i.displayName,username:()=>i.homeClubName?`@${i.username} · ${i.homeClubName}`:`@${i.username}`,hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),add:{className:()=>this.isFriendNow(i.id)?"friend-row__add hidden":"friend-row__add",disabled:()=>this.svc.mutating.get(),onclick:()=>{const d=this.svc.results.get().find(c=>c.id===i.id);d&&!d.isFriend&&this.svc.add(d)}},added:{className:()=>this.isFriendNow(i.id)?"friend-row__added":"friend-row__added hidden"}},a),i=>i.id);const s=new Date().toISOString();return this.$each(this.ref(t,"friends"),()=>ct(this.svc.friends.get(),this.svc.sortMode.get()),(i,r,a)=>this.wireEl(No,{initials:()=>Yt(i.displayName),name:()=>i.displayName,subtitle:()=>{const d=this.svc.friends.get().find(c=>c.id===i.id)??i;return vi(d,s)},hcp:()=>i.handicapIndex===null?"–":i.handicapIndex.toFixed(1),remove:{disabled:()=>this.svc.mutating.get(),onclick:()=>{this.svc.remove(i.id)}}},a),i=>i.id),t}isFriendNow(e){return this.svc.results.get().find(t=>t.id===e)?.isFriend===!0}}const Ro=_(`
    <div class="profile">
...
`);class jo extends O{static styles=`
        .profile {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),Ho={not_started:"Not started",active:"Playing",complete:"Done"};function Fo(n){const e=[`${n.participants.length} players`,`${n.scoreEventCount} scores`];return n.lastEventAt?e.push(`last ${n.lastEventAt.replace("T"," ").slice(0,16)}`):e.push("never played"),e.join(" · ")}function Bo(n){const e=[`@${n.username}`,`${n.roundCount} rounds`];return n.lastRoundDate&&e.push(`last ${n.lastRoundDate}`),n.handicapIndex!==null&&e.push(`hcp ${n.handicapIndex}`),n.deletedAt&&e.push("DELETED"),e.join(" · ")}class Go extends O{static styles=`
        .admin {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`);class Wo extends O{static styles=`
        .comps {
            padding: ${l("xl")} ${l("lg")} ${l("2xl")};
...
`),il=_('<button bind="chip" class="cd__friendchip" type="button"></button>');class rl extends O{competitions=this.inject(ie);state=this.inject(ye);render(){const e=()=>this.state.id.get()??"",t=this.wire(sl,{count:()=>{const s=this.competitions.participants.get().length;return s===0?"":String(s)},empty:{className:()=>this.competitions.participants.get().length===0?"cd__empty":"cd__empty hidden"},add:{className:()=>this.state.admin.get()&&rt(this.state.lifecycle.get())?"cd__rosteradd":"cd__rosteradd hidden"},guestForm:{onsubmit:s=>{s.preventDefault(),this.state.addGuest()}},guestName:{value:()=>this.state.guestNameDraft.get(),oninput:s=>this.state.guestNameDraft.set(s.target.value)},guestGender:{value:()=>this.state.guestGenderDraft.get(),onchange:s=>this.state.guestGenderDraft.set(s.target.value)},guestHcp:{value:()=>this.state.guestHcpDraft.get(),oninput:s=>this.state.guestHcpDraft.set(s.target.value)},addGuest:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"roster"),this.competitions.participants,(s,i,r)=>this.wireEl(nl,{name:()=>s.displayNameSnapshot,category:{textContent:()=>s.category??"",className:()=>s.category?"cd__rcat":"cd__rcat hidden"},status:{textContent:()=>s.withdrawnAt?"Withdrawn":s.cutAfterRound!==null?`Cut R${s.cutAfterRound}`:"",className:()=>s.withdrawnAt||s.cutAfterRound!==null?"cd__rout":"cd__rout hidden"},withdraw:{className:()=>this.state.admin.get()&&!s.withdrawnAt?"cd__ract":"cd__ract hidden",onclick:()=>{this.competitions.withdrawParticipant(e(),s.id)}},remove:{className:()=>this.state.admin.get()&&rt(this.state.lifecycle.get())?"cd__ract cd__ract--danger":"cd__ract cd__ract--danger hidden",onclick:()=>{this.competitions.removeParticipant(e(),s.id)}}},r),s=>JSON.stringify({id:s.id,name:s.displayNameSnapshot,category:s.category,withdrawnAt:s.withdrawnAt,cutAfterRound:s.cutAfterRound})),this.$each(this.ref(t,"friends"),this.state.friends.friends,(s,i,r)=>this.wireEl(il,{chip:{textContent:()=>s.displayName,disabled:()=>this.competitions.mutating.get()||this.competitions.participants.get().some(a=>a.playerId===s.id),onclick:()=>{this.competitions.addPlayer(e(),s.id,null)}}},r),s=>s.id),t}}const al={not_started:"Not started",active:"Live",complete:"Finished"},ol=_(`
    <section class="cd__section">
...
`),dl=_('<option bind="option"></option>');class cl extends O{competitions=this.inject(ie);state=this.inject(ye);router=this.inject(M);render(){const e=new S(()=>this.competitions.detail.get()?.rounds??[]),t=this.wire(ol,{empty:{className:()=>e.get().length===0?"cd__empty":"cd__empty hidden"},form:{className:()=>this.state.admin.get()&&Ko(this.state.lifecycle.get())?"cd__addround":"cd__addround hidden",onsubmit:s=>{s.preventDefault(),this.createRound()}},course:{value:()=>this.state.roundCourseDraft.get(),onchange:s=>this.state.roundCourseDraft.set(s.target.value)},date:{value:()=>this.state.roundDateDraft.get(),oninput:s=>this.state.roundDateDraft.set(s.target.value)},add:{disabled:()=>this.competitions.mutating.get()}});return this.$each(this.ref(t,"course"),this.state.courses,(s,i,r)=>this.wireEl(dl,{option:{value:()=>s.id,textContent:()=>s.name}},r),s=>s.id),this.$each(this.ref(t,"rounds"),e,(s,i,r)=>this.wireEl(ll,{row:{disabled:()=>!s.shareToken,onclick:()=>{s.shareToken&&this.router.navigate("/round",{query:{token:s.shareToken}})}},number:()=>`Round ${s.roundNumber}`,meta:()=>[s.courseNameSnapshot,s.date].filter(Boolean).join(" · ")||(s.shareToken?"Open":"View-only"),status:{textContent:()=>al[s.status]??s.status,className:()=>`cd__rstatus s-${s.status}`}},r),s=>JSON.stringify({id:s.id,status:s.status,shareToken:s.shareToken,courseName:s.courseNameSnapshot,date:s.date})),t}async createRound(){const e=await this.state.createRound();e&&this.router.navigate("/round",{query:{token:e}})}}function ul(n,e,t){return JSON.stringify({entry:n,points:e,columns:t})}function hl(n){return n.rounds.filter(e=>e.value!==null).map(e=>({text:String(e.value),dropped:e.status==="dropped"}))}const pl=_(`
    <div>
...
`),ml=_('<button bind="button" type="button"></button>'),fl=_('<th bind="cell"></th>'),gl=_('<tr bind="row"></tr>'),bl=_('<td bind="cell"><span bind="value"></span></td>'),yl=_(`
...
`);class xl extends O{static styles=`
        .cd {
            padding: ${l("lg")} ${l("lg")} ${l("2xl")};
...
`);class kl extends O{static styles=`
        .app-shell {
            display: grid;
    ...
    `;router=this.inject(M);render(){const e=this.wire($l,{header:{className:()=>ms(this.router.route.get())?"app-shell__header":"app-shell__header hidden"}});return this.spawn(Pi,this.ref(e,"account")),this.spawn(di,this.ref(e,"nav")),this.$swap(this.ref(e,"content"),this.router.route,{"/":Et,"/history":Ki,"/round":Qa,"/create":xo,"/login":To,"/friends":Po,"/profile":jo,"/admin":Go,...ps.competitions?{"/competitions":Wo,"/competition":xl}:{}},Et),e}}class Sl extends H{async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await Ls(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await $o()),this.error.set(null)}catch(e){e instanceof V&&e.status===401?this.error.set(null):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await ko(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof V&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}}B.get(nn);const Xt=B.get(M);B.set(H,new Sl);const Jt=B.get(H);await ln(kl,"#app",{hot:void 0,onInit:async()=>{await Jt.load(),Jt.currentUser.get()&&Xt.route.get()==="/login"&&Xt.navigate("/",!0)}});export{Ze as A,O as C,M as R,p as S,nn as T,y as a,me as b,S as c,Ws as d,N as e,Us as n,z as r,_ as t};
