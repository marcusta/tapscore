(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))n(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&n(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function n(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Ss="modulepreload",Ls=function(s){return"/tapscore/manage/"+s},ct={},As=function(e,t,n){let i=Promise.resolve();if(t&&t.length>0){let c=function(d){return Promise.all(d.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=a?.nonce||a?.getAttribute("nonce");i=c(t.map(d=>{if(d=Ls(d),d in ct)return;ct[d]=!0;const h=d.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const g=document.createElement("link");if(g.rel=h?"stylesheet":Ss,h||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),h)return new Promise((v,I)=>{g.addEventListener("load",v),g.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return i.then(a=>{for(const l of a||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})},te="/tapscore/manage/".replace(/\/+$/,""),Ue=te+"/api",Re={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","confirm-btn-min-height":"44px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Os=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Rs(s,e){const t={};for(const[n,i]of Os)if(n in s)for(const o of i)o in s||(t[o]=`var(--${n})`);return{...e,...t,...s}}const Ht=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],zs={thin:"1px",medium:"3px",thick:"5px"};function Ft(s){const e=s.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":zs[e.toLowerCase()]??e}function Ds(){return Ht.map(s=>{const e=Ft(Re[s]);return`@property --${s}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Mt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Pt={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Hs={...Pt,"done-opacity":"0.35"},Fs={...Mt,...Pt,...Re,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Ms={...Mt,...Hs,...Re,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Ps{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;jt(e);const n=this.tracking;this.tracking=e;try{t()}finally{this.tracking=n}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const n of t)n.disposed||n.run()}}}const P=new Ps;function jt(s){for(const e of s.deps)e.delete(s);s.deps.clear()}class m{constructor(e){this.subs=new Set,this.val=e}get(){return P.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,P.notify(this.subs))}update(e){this.set(e(this.val))}}class H{constructor(e){this.subs=new Set,this.val=void 0;const t=this,n={run(){P.runTracked(n,()=>{const i=e();Object.is(t.val,i)||(t.val=i,P.notify(t.subs))})},deps:new Set};n.run()}get(){return P.subscribe(this.subs),this.val}peek(){return this.val}}function b(s){const e={run(){P.runTracked(e,s)},deps:new Set};return e.run(),()=>{e.disposed=!0,jt(e)}}function ue(s){P.batch(s)}function S(s){return P.untrack(s)}class js{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const U=new js,ae=te;function qe(s){return ae?s===ae?"/":s.startsWith(ae+"/")?s.slice(ae.length):s:s}function Bs(s){return ae+s}class q{constructor(){this.route=new m(qe(location.pathname??"/")),this.search=new m(location.search??""),window.addEventListener("popstate",()=>ue(()=>{this.route.set(qe(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const n=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),o=i>=0?e.slice(i):"",a=i>=0?e.slice(0,i):e,l=a.indexOf("?"),c=l>=0?a.slice(0,l):a,d=l>=0?a.slice(l+1):"",h=n.query!==void 0?Us(n.query):d?"?"+d:"",p=Bs(c)+h+o;(n.replace?history.replaceState:history.pushState).call(history,null,"",p),ue(()=>{this.route.set(c),this.search.set(h)})}back(){history.back()}link(e,t="active"){const n=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===n||i.startsWith(n+"/")?t:""}}}params(e){const t=e.split("/");return new H(()=>{const n=this.route.get().split("/"),i={};for(const[o,a]of t.entries())a.startsWith(":")&&(i[a.slice(1)]=n[o]??"");return i})}query(e){return new H(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new H(()=>{const e={};for(const[t,n]of new URLSearchParams(this.search.get()))e[t]=n;return e})}}function Us(s){const e=new URLSearchParams;for(const[n,i]of Object.entries(s))i==null||i===""||e.set(n,String(i));const t=e.toString();return t?"?"+t:""}function qs(s){return e=>s[e]}const Ks="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ht="data-basics-global";function Ws(){if(document.head.querySelector(`style[${ht}]`))return;const s=document.createElement("style");s.setAttribute(ht,""),s.textContent=Ds()+Ks,document.head.appendChild(s)}function Gs(s,e){Ws();const t=new Set(Ht),n=(o,a,l)=>{const c=Object.entries(o).map(([d,h])=>`--${d}:${t.has(d)?Ft(h):h}`).join(";");return`${a}{color-scheme:${l};${c}}`},i=document.createElement("style");return i.textContent=n(s,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),o=>`var(--${o})`}const ut="basics-js-theme";class Bt{constructor(){this.dark=new m(!1);const e=localStorage.getItem(ut),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),b(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(ut,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function C(s){const e=document.createElement("template");return e.innerHTML=s,e}function Vs(s,e){let t;for(const n of Object.keys(e))s.startsWith(n+"/")&&(!t||n.length>t.length)&&(t=n);return t?e[t]:void 0}const mt=new Set;class E{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!mt.has(t)){mt.add(t);const n=document.createElement("style");n.textContent=t.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return U.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...n){const i=S(()=>{const o=new e(n[0]);return o.mount(t),o});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){S(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,n){const i=n??(a=>this.track(a)),o=e.content.cloneNode(!0);for(const a of o.querySelectorAll("[bind]")){const l=t[a.getAttribute("bind")];if(l)if(typeof l=="function")i(b(()=>{const c=l();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(c):a.textContent=String(c)}));else for(const[c,d]of Object.entries(l)){const h=c.includes("-");c.startsWith("on")&&typeof d=="function"?a.addEventListener(c.slice(2),d):typeof d=="function"?i(b(()=>{const p=d();h?a.setAttribute(c,String(p)):a[c]=p})):h?a.setAttribute(c,String(d)):a[c]=d}}return o}wireEl(e,t,n){return this.wire(e,t,n).firstElementChild}slot(e,t){const n=this.props[e];if(n==null)return!1;const i=this.ref(t,e);return i?(typeof n=="string"?i.textContent=n:typeof n=="function"&&n.prototype instanceof E?this.spawn(n,i):typeof n=="function"&&n(i,{spawn:(o,a,...l)=>this.spawn(o,a,...l),track:o=>this.track(o)}),!0):!1}$each(e,t,n,i=(o,a)=>a){const o=typeof t=="function"?t:()=>t.get(),a=new Map,l=new Map;this.track(()=>{for(const c of l.values())c.forEach(d=>d());l.clear()}),this.track(b(()=>{const c=o(),d=new Map;for(const[p,g]of c.entries()){const v=i(g,p);if(a.has(v))d.set(v,a.get(v));else{const I=[];d.set(v,S(()=>n(g,p,L=>I.push(L)))),l.set(v,I)}}for(const[p,g]of a)d.has(p)||(g.remove(),S(()=>l.get(p)?.forEach(v=>v())),l.delete(p));let h=e.firstChild;for(const p of d.values())p===h?h=h.nextSibling:e.insertBefore(p,h);a.clear();for(const[p,g]of d)a.set(p,g)}))}$condition(e,t,n,i){let o=null;this.track(b(()=>{o&&(o.remove(),o=null);const a=t.get();o=S(()=>a?n():i?.()??null),o&&e.appendChild(o)}))}$swap(e,t,n,i){let o=null;this.track(b(()=>{if(o){const c=o;o=null,S(()=>c.destroy())}e.textContent="";const a=t.get(),l=n[a]??Vs(a,n)??i;l&&(o=S(()=>{const c=new l;return c.mount(e),c}))})),this.track(()=>o?.destroy())}}const Ne=new Set;function Ys(s){return Ne.add(s),()=>Ne.delete(s)}function Xs(){for(const s of Array.from(Ne)){Ne.delete(s);try{s()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Qs(s,e,t){const n=document.querySelector(e);n.textContent="";const i=U.get(q);let o=null,a=!1,l=null,c=!!t?.hot?.data.hmr;const d=async h=>{o&&(o.destroy(),o=null,n.textContent=""),h?(l||(l=(await As(()=>import("./obs-shell.component-CrQ4m1cB.js"),[])).ObsShellComponent),o=S(()=>new l)):(!c&&t?.onInit&&(await t.onInit(),c=!0),o=S(()=>new s)),S(()=>o.mount(n)),a=h};await d(qe(location.pathname).startsWith("/_obs")),b(()=>{const h=i.route.get().startsWith("/_obs");h!==a&&d(h)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{o?.destroy()}catch(h){console.error("[startApp] the root component threw while disposing",h)}if(o=null,Xs(),t.onDispose)try{t.onDispose()}catch(h){console.error("[startApp] onDispose threw",h)}}),t.hot.accept())}class O extends Error{constructor(e,t,n,i,o){super(t),this.status=e,this.details=n,this.traceId=i,this.detail=o,this.name="ApiError"}}const Js=10,Ce=[];let Te=[],le=null;function Zs(s){Ce.push(s),Ce.length>Js&&Ce.shift()}function Ie(s,e,t){const n={code:s,message:e,url:typeof location<"u"?location.href:"",context:[...Ce],timestamp:new Date().toISOString()};t!==void 0&&(n.traceId=t),Te.push(n),en()}function en(){le||(le=setTimeout(Ut,5e3))}function Ut(){if(le&&(clearTimeout(le),le=null),Te.length===0)return;const s=Te;Te=[];for(const e of s){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ue}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ue}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ut()});const tn=3e4,sn=2,we=new Map,qt=new WeakMap;function Ke(s){if(s instanceof O)return s.traceId;if(s!=null&&typeof s=="object")return qt.get(s)}async function w(s){if(s.method==="GET"){const e=we.get(s.url);if(e)return e;const t=pt(s,sn);return we.set(s.url,t),t.then(()=>we.delete(s.url),()=>we.delete(s.url)),t}return pt(s,0)}async function pt(s,e){const t=s.timeout??tn;let n;for(let i=0;i<=e;i++){const o=crypto.randomUUID();try{return await rn(nn(s,o),t)}catch(a){if(n=a,!(a instanceof O)&&a!=null&&typeof a=="object"&&qt.set(a,o),a instanceof O||i===e)break;await new Promise(l=>setTimeout(l,1e3*2**i))}}throw n}async function nn(s,e){const t={"X-Trace-Id":e},n={method:s.method,headers:t};s.body!==void 0&&(t["Content-Type"]="application/json",n.body=JSON.stringify(s.body));const i=await fetch(s.url,n),o=i.headers.get("x-trace-id")??e;if(Zs({type:"api",detail:`${s.method} ${s.url}`,timestamp:new Date().toISOString()}),!i.ok){const a=await i.json().catch(()=>({error:i.statusText}));throw new O(i.status,a.error??i.statusText,a.details,o,a.detail)}return i.json()}function rn(s,e){let t;const n=new Promise((i,o)=>{t=setTimeout(()=>o(new Error("Request timeout")),e)});return Promise.race([s,n]).finally(()=>clearTimeout(t))}const We=new Set;let De=!1;function on(s){return We.add(s),()=>{We.delete(s)}}function st(){if(!De){De=!0;try{for(const s of[...We])try{s()}catch(e){try{Ie("session-listener",an(e))}catch{}}}finally{De=!1}}}function an(s){try{if(s instanceof Error){const e=s.message;if(typeof e=="string")return e}return String(s)}catch{return"listener threw a value that could not be described"}}async function ve(s,e,t,n={}){ue(()=>{s.set(!0),e.set(null)});try{const i=await t();return s.set(!1),i}catch(i){const o=ln(i);ue(()=>{s.set(!1),e.set(o)}),Ie(o.code,o.message,Ke(i)),o.code==="auth"&&n.sessionExpiry!==!1&&st();return}}function ln(s){return s instanceof O?s.status===401?{code:"auth",message:"Unauthorized"}:s.status===409?{code:"conflict",message:"Data has changed — please try again"}:s.status===400?{code:"validation",message:s.message}:s.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:s instanceof Error?s.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const He={sessionExpiry:!1};function dn(s){return{me:()=>w({method:"GET",url:`${s}/auth/me`}),login:e=>w({method:"POST",url:`${s}/auth/login`,body:e}),logout:()=>w({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>w({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}class K{constructor(){this.api=dn(Ue),this.currentUser=new m(null),this.loading=new m(!1),this.error=new m(null),this.offSessionExpired=on(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Ys(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await ve(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const n=await ve(this.loading,this.error,()=>this.api.login({username:e,password:t}),He);return n?(this.currentUser.set(n),!0):!1}async logout(){await ve(this.loading,this.error,()=>this.api.logout(),He);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await ve(this.loading,this.error,()=>this.api.logoutAll(),He),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Kt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},cn={...Kt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},hn={...Kt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function Wt(s,e={}){const t=s==="light"?cn:hn,n=s==="light"?Fs:Ms;return Rs({...t,...e},n)}const Gt={"manage-page-pad":"var(--space-4)","manage-page-pad-wide":"var(--space-6)","manage-stack-gap":"var(--space-3)","manage-section-gap":"var(--space-5)","manage-touch-target":"44px","manage-table-bg":"var(--surface)","manage-table-radius":"var(--radius)","manage-table-border":"var(--border)","manage-table-header-bg":"var(--surface-sunken)","manage-table-header-fg":"var(--text-muted)","manage-table-header-border":"var(--border-strong)","manage-table-header-pad-y":"var(--space-2)","manage-table-header-pad-x":"var(--space-3)","manage-table-cell-pad-y":"var(--space-3)","manage-table-cell-pad-x":"var(--space-3)","manage-table-row-border":"var(--border)","manage-table-row-hover-bg":"var(--hover-bg)","manage-table-row-editing-bg":"var(--accent-soft)","manage-table-card-gap":"var(--space-2)","btn-danger-bg":"transparent","btn-danger-fg":"var(--danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger)","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger)","manage-sidebar-width":"232px","manage-content-max":"1120px"},Vt=s=>({"manage-chrome-bg":"var(--topbar-bg)","manage-chrome-fg":s,"manage-chrome-fg-muted":"color-mix(in srgb, var(--manage-chrome-fg) 66%, transparent)","manage-chrome-border":"color-mix(in srgb, var(--manage-chrome-fg) 14%, transparent)","manage-chrome-hover-bg":"color-mix(in srgb, var(--manage-chrome-fg) 9%, transparent)","manage-chrome-active-bg":"color-mix(in srgb, var(--manage-chrome-fg) 16%, transparent)","manage-scrim":"color-mix(in srgb, var(--topbar-bg) 62%, transparent)"}),Yt=Wt("light",{...Gt,...Vt("var(--primary-text)")}),Xt=Wt("dark",{...Gt,...Vt("var(--text)")}),r=Gs(Yt,Xt);function un(){const s=document.querySelector('meta[name="theme-color"]');if(!s)return;const e=U.get(Bt);b(()=>{const n=(e.dark.get()?Xt:Yt)["topbar-bg"];n&&s.setAttribute("content",n)})}class mn extends K{constructor(e){super(),this.client=e}client;async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}function pn(s){return{login:(e,t)=>w({method:"POST",url:`${s}/auth/login`,body:{username:e,password:t}}),me:()=>w({method:"GET",url:`${s}/auth/me`}),logout:()=>w({method:"POST",url:`${s}/auth/logout`,body:{}}),logoutAll:()=>w({method:"POST",url:`${s}/auth/logout-all`,body:{}})}}const Q="/tapscore/manage/".replace(/\/+$/,"").replace(/\/manage$/,"")+"/api",Qt=pn(Q);function gn(s){return{async list(){return w({method:"GET",url:`${s}/clubs`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/clubs/get${n?"?"+n:""}`})},async create(e){return w({method:"POST",url:`${s}/clubs`,body:e})},async update(e){return w({method:"POST",url:`${s}/clubs/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${s}/clubs/${e.id}`})}}}function fn(s){return{async list(){return w({method:"GET",url:`${s}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/courses/by-club${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/courses/get${n?"?"+n:""}`})},async teeRoleCatalog(){return w({method:"GET",url:`${s}/courses/tee-roles/catalog`})},async teeRoles(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/courses/tee-roles${n?"?"+n:""}`})},async create(e){return w({method:"POST",url:`${s}/courses`,body:e})},async update(e){return w({method:"POST",url:`${s}/courses/update`,body:e})},async updateHole(e){return w({method:"POST",url:`${s}/courses/holes/update`,body:e})},async setTeeRole(e){return w({method:"POST",url:`${s}/courses/tee-roles`,body:e})},async clearTeeRole(e){return w({method:"DELETE",url:`${s}/courses/tee-roles/${e.courseId}/${e.roleKey}/${e.gender}`})},async validate(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/courses/validate${n?"?"+n:""}`})},async remove(e){return w({method:"DELETE",url:`${s}/courses/${e.id}`})}}}function bn(s){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/tees/by-course${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/tees/get${n?"?"+n:""}`})},async create(e){return w({method:"POST",url:`${s}/tees`,body:e})},async update(e){return w({method:"POST",url:`${s}/tees/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${s}/tees/${e.id}`})}}}function _n(s){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/course-route-templates${n?"?"+n:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/course-route-templates/get${n?"?"+n:""}`})},async validate(e){return w({method:"POST",url:`${s}/course-route-templates/validate`,body:e})},async create(e){return w({method:"POST",url:`${s}/course-route-templates`,body:e})},async update(e){return w({method:"POST",url:`${s}/course-route-templates/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${s}/course-route-templates/${e.id}`})}}}function yn(s){return{async myRoles(){return w({method:"GET",url:`${s}/me/roles`})},async adminStats(){return w({method:"GET",url:`${s}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const n=t.toString();return w({method:"GET",url:`${s}/admin/rounds${n?"?"+n:""}`})},async adminPlayers(){return w({method:"GET",url:`${s}/admin/players`})},async adminGrantRole(e){return w({method:"POST",url:`${s}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return w({method:"POST",url:`${s}/admin/roles/revoke`,body:e})}}}const N={clubs:gn(Q),courses:fn(Q),tees:bn(Q),courseRouteTemplates:_n(Q),admin:yn(Q)};class se{roles=new m([]);loaded=new m(!1);error=new m(null);inflight=null;isSuperAdmin(){return this.has("super_admin")}canManageCourses(){return this.isSuperAdmin()||this.has("course_admin")}has(e){return this.roles.get().some(t=>t.role===e&&t.scopeType===null)}load(e=!1){return!e&&this.inflight?this.inflight:(this.inflight=(async()=>{this.error.set(null);try{this.roles.set(await N.admin.myRoles())}catch(t){this.roles.set([]),t instanceof O&&t.status===401?st():(this.error.set("Cannot reach the server."),this.inflight=null)}finally{this.loaded.set(!0)}})(),this.inflight)}clear(){this.roles.set([]),this.loaded.set(!1),this.error.set(null),this.inflight=null}}const at=class at extends E{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(b(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};at.styles=`
    ...
    `;let Ge=at;const $=s=>`var(--${s})`,_=(s,e)=>`var(--${s}, ${e})`,y=s=>{const e=Re[s];if(e===void 0)throw new Error(`unknown control token: --${s}`);return e},wn=s=>_(s,y(s)),u=qs({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),$e=s=>`
    ...
    cursor: not-allowed;`,vn={primary:$e("primary"),secondary:$e("secondary"),ghost:$e("ghost"),danger:$e("danger"),disabled:Jt},k=(s=_("btn-radius",y("btn-radius")),e="secondary")=>`
    /*
    ...
    ${vn[e]}
    &:disabled {${Jt}}
`,$n=`max(${_("field-border-width",y("field-border-width"))}, ${_("field-rule-width",y("field-rule-width"))})`,xe=(s,e)=>`
    border-top-color: ${s};
...
`,x=s=>`var(--${s})`;let kn=0;const lt=class lt extends E{constructor(){super(...arguments),this.returnFocusTo=null,this.wasOpen=!1}render(){const e=document.createElement("div"),t=(d,h)=>{typeof h=="function"?this.track(b(()=>{d.textContent=h()})):d.textContent=h};this.spawn(Ge,e,{open:this.props.open,bg:"rgba(0,0,0,0.4)",zIndex:199,scrollLock:!0,onclose:()=>this.handleCancel()}),this.dialogEl=document.createElement("div"),this.dialogEl.className="ui-confirm",this.dialogEl.style.zIndex="200",this.dialogEl.setAttribute("role","dialog"),this.dialogEl.setAttribute("aria-modal","true"),this.dialogEl.setAttribute("tabindex","-1");const n=`ui-confirm-${++kn}`,i=document.createElement("h2");i.className="ui-confirm__title",i.id=`${n}-title`,t(i,this.props.title??"Confirm"),this.dialogEl.setAttribute("aria-labelledby",i.id),this.dialogEl.appendChild(i);const o=document.createElement("p");o.className="ui-confirm__message",o.id=`${n}-message`,t(o,this.props.message),this.dialogEl.setAttribute("aria-describedby",o.id),this.dialogEl.appendChild(o);const a=document.createElement("div");a.className="ui-confirm__actions";const l=document.createElement("button");l.className="ui-confirm__btn ui-confirm__btn--cancel",t(l,this.props.cancelLabel??"Cancel"),l.addEventListener("click",d=>{d.stopPropagation(),this.handleCancel()}),a.appendChild(l),this.cancelEl=l;const c=document.createElement("button");return c.className=this.props.danger?"ui-confirm__btn ui-confirm__btn--danger":"ui-confirm__btn ui-confirm__btn--confirm",t(c,this.props.confirmLabel??"Confirm"),c.addEventListener("click",d=>{d.stopPropagation(),this.props.open.set(!1),this.props.onconfirm()}),a.appendChild(c),this.confirmEl=c,this.dialogEl.appendChild(a),this.dialogEl.addEventListener("click",d=>d.stopPropagation()),this.dialogEl.addEventListener("keydown",d=>this.onKeydown(d)),e.appendChild(this.dialogEl),this.track(b(()=>{const d=this.props.open.get();d&&this.dialogEl.removeAttribute("inert"),this.dialogEl.classList.toggle("open",d),d||this.dialogEl.setAttribute("inert",""),d!==this.wasOpen&&(this.wasOpen=d,d?this.captureFocus():this.restoreFocus())})),e}onMount(){this.props.open.get()&&!this.dialogEl.contains(document.activeElement)&&this.captureFocus()}captureFocus(){const e=document.activeElement;this.returnFocusTo=e instanceof HTMLElement?e:null,this.cancelEl.focus()}restoreFocus(){const e=this.returnFocusTo;this.returnFocusTo=null,e&&e.isConnected&&e.focus()}onKeydown(e){if(!this.props.open.get())return;if(e.key==="Escape"){e.preventDefault(),e.stopPropagation(),this.handleCancel();return}if(e.key!=="Tab")return;const t=this.cancelEl,n=this.confirmEl,i=document.activeElement;e.shiftKey&&(i===t||i===this.dialogEl)?(e.preventDefault(),n.focus()):!e.shiftKey&&i===n&&(e.preventDefault(),t.focus())}handleCancel(){this.props.open.set(!1),this.props.oncancel&&this.props.oncancel()}onDestroy(){this.wasOpen&&this.restoreFocus()}};lt.styles=`
        ...
        .ui-confirm__btn {
            ...
            min-height: ${wn("confirm-btn-min-height")};
            padding: 9px 20px;
            font-size: 13px;
            line-height: 20px;
            font-family: ${x("font-ui")};
    ...
    `;let Ve=dt;const Cn=900,Tn=`(min-width: ${Cn}px)`,ts=660,ss=`(min-width: ${ts}px)`,ns=`(max-width: ${ts-.02}px)`;function Nn(s){const e=new m(!1),t=typeof globalThis.matchMedia=="function"?globalThis.matchMedia(s):null;if(!t)return{value:e,dispose:()=>{}};e.set(t.matches);const n=i=>e.set(i.matches);return t.addEventListener("change",n),{value:e,dispose:()=>t.removeEventListener("change",n)}}const gt="__actions";function B(s,e={}){const t=document.createElement("button");return t.type="button",t.className=e.variant==="primary"?"mtable__btn mtable__btn--primary":"mtable__btn",t.textContent=s,e.onclick&&t.addEventListener("click",e.onclick),t}function In(s){return typeof s=="object"&&s!==null&&typeof s.get=="function"}function ft(s,e,t){if(s.textContent="",e instanceof HTMLElement){s.appendChild(e);return}if(e==null||e===""){const n=document.createElement("span");n.className="mtable__empty-cell",n.textContent=t,s.appendChild(n);return}s.appendChild(document.createTextNode(String(e)))}class ne extends E{static styles=`
...
`,Ln="You no longer have permission to change the course catalog. Ask an administrator to grant you the course_admin role.";function R(s,e){if(!(s instanceof O))return Ie(An(s),On(s),Ke(s)),e;if(s.status===401)return st(),"Your session expired. Sign in again to continue.";if(s.status===403)return Ln;if(s.status>=400&&s.status<500){if(!s.details?.length)return s.message;const t=s.details.map(n=>`${n.path.replace(/^\//,"")} — ${n.message}`).join("; ");return`${s.message}: ${t}`}return Ie("server",`${s.status} ${s.message}`,Ke(s)),e}function An(s){return s instanceof Error?s.message==="Request timeout"?"timeout":"network":"unknown"}function On(s){return s instanceof Error?s.message:String(s)}function rs(){return{name:"",location:"",logoUrl:""}}function Rn(s){return{name:s.name,location:s.location??"",logoUrl:s.logoUrl??""}}function os(s){const e={};s.name.trim()===""&&(e.name="A club needs a name. Enter one before saving.");const t=s.logoUrl.trim();return t!==""&&!zn(t)&&(e.logoUrl="Enter a full web address starting with https://, or leave this empty."),e}function as(s){return Object.keys(s).length>0}function bt(s){return{name:s.name.trim(),location:s.location.trim()||null,logoUrl:s.logoUrl.trim()||null}}function ls(s,e){const t=e===0?"It has no courses.":e===1?"It has 1 course.":`It has ${e} courses.`;return`${s} leaves the catalog. ${t} Rounds already played keep their own copy of the course data, so no scorecard changes.`}const ds="The club is removed from the catalog.";function zn(s){try{const e=new URL(s);return e.protocol==="http:"||e.protocol==="https:"}catch{return!1}}function Dn(s,e){const t=e.trim().toLowerCase().split(/\s+/).filter(n=>n!=="");return t.length===0?s:s.filter(n=>{const i=`${n.name} ${n.location??""}`.toLowerCase();return t.every(o=>i.includes(o))})}class ze{clubs=new m([]);loading=new m(!1);error=new m(null);loaded=new m(!1);query=new m("");visible=new H(()=>Dn(this.clubs.get(),this.query.get()));inflight=null;load(e=!1){return!e&&this.inflight?this.inflight:(this.inflight=(async()=>{this.loading.set(!0),this.error.set(null);try{this.clubs.set(await N.clubs.list())}catch(t){this.error.set(R(t,"Could not load the clubs. Check your connection and try again.")),this.inflight=null}finally{this.loading.set(!1),this.loaded.set(!0)}})(),this.inflight)}byId(e){return this.clubs.get().find(t=>t.id===e)??null}async create(e){return this.write(()=>N.clubs.create(bt(e)),"Could not create the club. Check your connection and try again.")}async update(e,t){return this.write(()=>N.clubs.update({id:e,...bt(t)}),"Could not save the club. Check your connection and try again.")}async remove(e){return this.write(()=>N.clubs.remove({id:e}),"Could not delete the club. Check your connection and try again.")}async write(e,t){try{await e()}catch(n){return{ok:!1,message:R(n,t)}}return await this.load(!0),{ok:!0}}}const Hn=C(`
...
`);class ti extends E{static styles=`
    ...
    `;router=this.inject(q);crumbs=this.inject(pe);clubs=this.inject(ze);params=this.router.params(Fn);editor=new me;errors=new m({});deleteOpen=new m(!1);deleteFailure=new m(null);deleting=new m(!1);fields=null;render(){const e=this.wire(ei,{loadingNote:{textContent:"Loading club…",hidden:()=>this.clubs.loaded.get()},loadError:{textContent:()=>this.clubs.error.get()??"",hidden:()=>this.clubs.error.get()===null},retry:{hidden:()=>this.clubs.error.get()===null,onclick:()=>{this.clubs.load(!0)}},missing:{hidden:()=>!this.clubs.loaded.get()||this.clubs.error.get()!==null||this.club()!==null},backMissing:{onclick:()=>this.router.navigate(M)},body:{hidden:()=>this.club()===null},title:()=>this.club()?.name??"",subtitle:()=>this.courseSummary(),remove:{textContent:()=>this.deleting.get()?"Deleting…":"Delete club",disabled:()=>this.editing()||this.deleting.get(),onclick:()=>{this.deleteFailure.set(null),this.deleteOpen.set(!0)}},deleteError:{textContent:()=>this.deleteFailure.get()??"",hidden:()=>this.deleteFailure.get()===null},edit:{hidden:()=>this.editing(),disabled:()=>this.deleting.get(),onclick:()=>this.beginEdit()},facts:{hidden:()=>this.editing()},factName:()=>this.club()?.name??"",factLocation:()=>this.club()?.location??"Not recorded",factLogo:()=>this.club()?.logoUrl??"Not recorded",form:{hidden:()=>!this.editing(),onsubmit:n=>{n.preventDefault(),this.save()}},saveError:{textContent:()=>this.editor.errorFor(this.clubId())??"",hidden:()=>this.editor.errorFor(this.clubId())===null},save:{textContent:()=>this.saving()?"Saving…":"Save",disabled:()=>this.saving()},cancel:{disabled:()=>this.saving(),onclick:()=>this.cancelEdit()}});this.fields=this.spawn(cs,this.ref(e,"fieldsHost"),{idPrefix:"manage-club-edit",errors:this.errors,busy:{get:()=>this.saving()}});const t=this.clubId();return t!==""&&this.spawn(Zn,this.ref(e,"coursesHost"),{clubId:t}),this.spawn(X,this.ref(e,"confirmHost"),ge({open:this.deleteOpen,title:()=>{const n=this.club();return n?`Delete ${n.name}?`:"Delete this club?"},consequence:()=>this.deleteConsequence(),confirmLabel:"Delete club",onconfirm:()=>{this.remove()}})),this.track(ie(this.deleteOpen)),e}onMount(){this.clubs.load(),this.track(b(()=>{const e=this.club();this.crumbs.set([{label:"Clubs",path:M},{label:e?.name??"Club"}])})),this.clubId()===""&&this.router.navigate(M,!0)}clubId(){return this.params.get().id}club(){const e=this.clubId();return e===""?null:this.clubs.byId(e)}editing(){return this.editor.isEditing(this.clubId())}saving(){return this.editor.isSaving(this.clubId())}courseSummary(){const e=this.club();return e?e.courseCount===0?"No courses yet.":e.courseCount===1?"1 course.":`${e.courseCount} courses.`:""}beginEdit(){const e=this.club();e&&(this.errors.set({}),this.editor.begin(e.id),this.fields?.seed(Rn(e)),this.fields?.focusFirst())}cancelEdit(){this.editor.cancel(),this.errors.set({})}save(){const e=this.club();if(!e||!this.fields||this.saving())return;const t=this.fields.draft.get(),n=os(t);if(this.errors.set(n),as(n)){this.fields.focusInvalid(n);return}this.editor.commit(()=>this.clubs.update(e.id,t))}deleteConsequence(){const e=this.club();return e?ls(e.name,e.courseCount):ds}async remove(){const e=this.club();if(!(!e||this.deleting.get())){this.deleteFailure.set(null),this.deleting.set(!0);try{const t=await this.clubs.remove(e.id);if(!t.ok){this.deleteFailure.set(t.message);return}this.router.navigate(M,!0)}finally{this.deleting.set(!1)}}}}function si(s){return{par:String(s.par),strokeIndex:String(s.strokeIndex)}}function Xe(){return{par:"",strokeIndex:""}}function fs(s,e){const t=Nt(s.par);if(t===null||t<1)return{ok:!1,message:"Par is a whole number of strokes — 3, 4 or 5 on nearly every hole. Enter one and save again."};const n=Nt(s.strokeIndex);return n===null||n<1||n>e?{ok:!1,message:`Stroke index runs from 1 to ${e}, one number per hole. Enter one in that range and save again.`}:{ok:!0,par:t,strokeIndex:n}}function ni(s,e){const t=s.filter(l=>l.holeNumber>=1&&l.holeNumber<=e),n=(l,c)=>t.filter(d=>d.holeNumber>=l&&d.holeNumber<=c),i=(l,c)=>n(l,c).reduce((d,h)=>d+h.par,0),o=(l,c)=>n(l,c).length===0?null:i(l,c),a=e>9;return{front:a?o(1,9):null,back:a?o(10,e):null,split:a,total:i(1,e),counted:t.length,expected:e,extra:s.length-t.length}}function Et(s){return s===null?"—":String(s)}function Ct(s){const e=[],t=s.expected-s.counted;return t>0&&e.push(`Counted over the ${s.counted} ${V(s.counted)} that have values — ${t} of the course’s ${s.expected} ${V(s.expected)} ${t===1?"has":"have"} no row yet.`),s.extra>0&&e.push(`${Y(G(s.extra,"hole row","hole rows"))} sit beyond hole ${s.expected} and ${s.extra===1?"is":"are"} not counted.`),e.length>0?e.join(" "):null}function Ae(s,e){const t=new Set(s.map(i=>i.holeNumber)),n=[];for(let i=1;i<=e;i+=1)t.has(i)||n.push(i);return n}function rt(s,e){const t=new Set(s.map(i=>i.strokeIndex)),n=[];for(let i=1;i<=e;i+=1)t.has(i)||n.push(i);return n}function ii(s,e,t){const n=ot(s,t);if(n.length>0)return{ok:!1,message:`This course also has ${G(n.length,"hole row","hole rows")} beyond hole ${t}. Remove those rows in the panel below, or set the hole count to match the course on the club page — adding holes cannot resolve either.`};const i=[...s];for(const l of Ae(s,t)){const c=e.get(l)??Xe(),d=fs(c,t);if(!d.ok)return{ok:!1,message:`Hole ${l}: ${hi(d.message)}`};i.push({holeNumber:l,par:d.par,strokeIndex:d.strokeIndex})}const o=bs(i);if(o){const c=s.some(d=>d.holeNumber===o.holes[0])&&s.some(d=>d.holeNumber===o.holes[1])?"Change one of them in the grid above first.":"Give the new hole one of the free numbers.";return{ok:!1,message:`Holes ${o.holes[0]} and ${o.holes[1]} would both have stroke index ${o.strokeIndex}. Every hole needs its own number from 1 to ${t}. ${c}`}}const a=rt(i,t);return a.length>0?{ok:!1,message:`Stroke ${a.length===1?"index":"indices"} ${Z(a)} would be left unused. Every number from 1 to ${t} has to appear exactly once.`}:{ok:!0,holes:[...i].sort((l,c)=>l.holeNumber-c.holeNumber)}}function ot(s,e){return s.filter(t=>t.holeNumber<1||t.holeNumber>e).sort((t,n)=>t.holeNumber-n.holeNumber)}function Tt(s,e){const t=ot(s,e);if(t.length===0)return{ok:!1,message:"This course has no hole rows beyond its hole count."};const n=s.filter(c=>c.holeNumber>=1&&c.holeNumber<=e).sort((c,d)=>c.holeNumber-d.holeNumber),i=Ae(n,e);if(i.length>0)return{ok:!1,message:`${Y(V(i.length))} ${Z(i)} ${i.length===1?"has":"have"} no row either, so removing these would leave the course incomplete. Add the missing ${V(i.length)} first.`};const o=n.filter(c=>c.strokeIndex<1||c.strokeIndex>e);if(o.length>0)return{ok:!1,message:`${Y(V(o.length))} ${Z(o.map(c=>c.holeNumber))} still ${o.length===1?"has a stroke index":"have stroke indices"} above ${e}. A ${e}-hole course hands out stroke indices 1 to ${e}, so give ${o.length===1?"it":"them"} a number in that range in the grid above, then remove these rows.`};const a=bs(n);if(a)return{ok:!1,message:`Holes ${a.holes[0]} and ${a.holes[1]} both have stroke index ${a.strokeIndex}. Every one of the course’s ${e} holes needs its own number from 1 to ${e}. Change one of them in the grid above, then remove these rows.`};const l=rt(n,e);return l.length>0?{ok:!1,message:`Stroke ${l.length===1?"index":"indices"} ${Z(l)} ${l.length===1?"is":"are"} not assigned to any of the course’s ${e} holes. Hand ${l.length===1?"it":"them"} out in the grid above, then remove these rows.`}:{ok:!0,holes:n,removed:t}}function ri(s){return`Hole ${s.holeNumber} — par ${s.par}, stroke index ${s.strokeIndex}`}function oi(s,e){if(s.length===0)return"";const t=s.map(n=>n.holeNumber);return`This course is set to ${e} holes, but ${G(s.length,"row","rows")} beyond that ${s.length===1?"is":"are"} still stored — ${V(t.length)} ${Z(t)}. A hole-count change leaves them behind on purpose, because the par and stroke index on them are real numbers somebody typed. They count towards nothing, and the course check reports them until they are gone.`}function ai(s,e,t){const n=s.map(i=>i.holeNumber);return`${Y(V(n.length))} ${Z(n)} — and the par and stroke index stored on ${n.length===1?"it":"them"} — are deleted from ${e}. The course keeps its ${t} holes. This cannot be undone.`}function bs(s){const e=new Map;for(const t of[...s].sort((n,i)=>n.holeNumber-i.holeNumber)){const n=e.get(t.strokeIndex);if(n!==void 0)return{strokeIndex:t.strokeIndex,holes:[n,t.holeNumber]};e.set(t.strokeIndex,t.holeNumber)}return null}function li(s,e){return s.issues.map((t,n)=>({key:`${n}:${t.code}:${t.message}`,severity:t.severity,severityLabel:t.severity==="error"?"Problem":"Warning",explanation:di(t.code,e),detail:t.message}))}function di(s,e){switch(s){case"missing_holes":return"These holes have no par or stroke index yet, so the course is not complete. Add them below.";case"unexpected_holes":return`The course is set to ${e} holes, but rows exist past that. Remove them in the panel below, or change the hole count on the club page if the course really has them.`;case"duplicate_stroke_index":return"Two holes share a stroke index. Handicap strokes are handed out in stroke-index order, so each hole needs its own number.";case"missing_stroke_indices":return`Some numbers between 1 and ${e} are not assigned to any hole. Every one of them has to appear exactly once.`;case"stroke_index_out_of_range":return`A stroke index outside 1 to ${e} cannot be resolved when a round hands out strokes.`;case"unusual_par":return"A par outside 3 to 6 is unusual, not wrong. It saves as it is — worth a second look.";default:return"The course check reported this."}}function ci(s,e,t){if(s.status==="checking")return"Checking the course…";if(s.status==="unknown"||e===null)return"The course check did not run, so nothing here is confirmed. It runs again after the next save.";const n=e.issues.filter(o=>o.severity==="error").length,i=e.issues.length-n;return n===0&&i===0?`Nothing to fix — every hole has a par, and the stroke indices run 1 to ${t}, once each.`:n===0?`${Y(G(i,"warning","warnings"))}, nothing that blocks play.`:i===0?`${Y(G(n,"problem","problems"))} to fix.`:`${Y(G(n,"problem","problems"))} to fix, and ${G(i,"warning","warnings")}.`}function G(s,e,t){return`${s} ${s===1?e:t}`}function V(s){return s===1?"hole":"holes"}function Z(s){return s.length<=2?s.join(" and "):`${s.slice(0,-1).join(", ")} and ${s[s.length-1]}`}function Y(s){return s.charAt(0).toUpperCase()+s.slice(1)}function hi(s){return s.charAt(0).toLowerCase()+s.slice(1)}function Nt(s){const e=s.trim();if(!/^\d+$/.test(e))return null;const t=Number(e);return Number.isSafeInteger(t)?t:null}const oe="__fill";function It(s,e){return`Hole ${s.holeNumber} — ${e}`}const ui=C(`
...
`);class Fi extends E{static styles=`
    ...
    `,he.seq=0;let Ze=he;function Pi(s,e){return`<button bind="${s}" class="minfo-dot" type="button" aria-expanded="false" aria-label="${ji(e)}"><span aria-hidden="true">i</span></button>`}function ji(s){return s.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const Bi=`
        .minfo-dot {
            position: relative;
            flex: none;
            appearance: none;
...
`);class hr extends E{static styles=`
    ...
    `;router=this.inject(q);crumbs=this.inject(pe);clubs=this.inject(ze);courses=this.inject(_e);params=this.router.params(Mn);render(){const e=this.wire(cr,{loadingNote:{textContent:"Loading course…",hidden:()=>this.settled()},loadError:{textContent:()=>this.courses.error.get()??"",hidden:()=>this.courses.error.get()===null},retry:{hidden:()=>this.courses.error.get()===null,onclick:()=>{this.courses.load(this.clubId(),!0)}},missing:{hidden:()=>!this.settled()||this.courses.error.get()!==null||this.course()!==null},backMissing:{onclick:()=>this.backToClub()},body:{hidden:()=>this.course()===null},title:()=>this.course()?.name??"",subtitle:()=>this.summary(),back:{onclick:()=>this.backToClub()}}),t=this.courseId();return t!==""&&(this.spawn(mi,this.ref(e,"holesHost"),{courseId:t}),this.spawn(Fi,this.ref(e,"teesHost"),{clubId:this.clubId(),courseId:t}),this.spawn(sr,this.ref(e,"teeRolesHost"),{courseId:t}),this.spawn(or,this.ref(e,"routesHost"),{courseId:t})),e}onMount(){const e=this.clubId();if(e===""||this.courseId()===""){this.router.navigate(M,!0);return}this.clubs.load(),this.courses.load(e),this.track(b(()=>{this.crumbs.set([{label:"Clubs",path:M},{label:this.clubs.byId(e)?.name??"Club",path:Le(e)},{label:this.course()?.name??"Course"}])}))}clubId(){return this.params.get().clubId}courseId(){return this.params.get().courseId}course(){const e=this.courseId();return e===""?null:this.courses.byId(e)}settled(){return this.courses.loaded.get()}summary(){const e=this.course();if(!e)return"";const t=this.clubs.byId(this.clubId()),n=`${e.holeCount} holes`;return t?`${n} at ${t.name}.`:`${n}.`}backToClub(){this.router.navigate(Le(this.clubId()))}}const ur=[{id:"courses",label:"Courses",path:M,routes:{[M]:Bn,[nt]:ti,[it]:hr},unlocked:s=>s.canManageCourses()}];function ye(s){return ur.filter(e=>e.unlocked(s))}function mr(s){const e={};for(const t of ye(s))Object.assign(e,t.routes);return e}const pr=C(`
...
`);class vr extends E{static styles=`
    ...
    `;router=this.inject(q);auth=this.inject(K);roles=this.inject(se);breadcrumbs=this.inject(pe);drawerOpen=new m(!1);render(){const e=ye(this.roles)[0];e&&this.router.route.get()==="/"&&this.router.navigate(e.path,!0);const t=this.wire(_r,{menu:{onclick:()=>this.drawerOpen.set(!0),"aria-expanded":()=>String(this.drawerOpen.get())},close:{onclick:()=>this.drawerOpen.set(!1)},scrim:{className:()=>this.drawerOpen.get()?"mshell__scrim open":"mshell__scrim",onclick:()=>this.drawerOpen.set(!1)},drawer:{className:()=>this.drawerOpen.get()?"mshell__drawer open":"mshell__drawer",inert:()=>!this.drawerOpen.get()}});return this.spawn(Dt,this.ref(t,"sidebarNav")),this.spawn(Dt,this.ref(t,"drawerNav"),{onNavigate:()=>this.drawerOpen.set(!1)}),this.identity(this.ref(t,"sidebarIdentity")),this.identity(this.ref(t,"drawerIdentity")),this.crumbs(this.ref(t,"crumbs")),this.$swap(this.ref(t,"outlet"),this.router.route,mr(this.roles),br),t}onMount(){this.track(b(()=>{this.router.route.get(),this.drawerOpen.set(!1)}));const e=t=>{t.key==="Escape"&&this.drawerOpen.get()&&this.drawerOpen.set(!1)};document.addEventListener("keydown",e),this.track(()=>document.removeEventListener("keydown",e))}identity(e){e.appendChild(this.wire(wr,{who:()=>{const t=this.auth.currentUser.get();return t?`Signed in as ${t.username}`:""},signout:{onclick:()=>{this.drawerOpen.set(!1),this.auth.logout()}}}))}crumbs(e){const t=document.createElement("ol");e.appendChild(t),this.$each(t,()=>this.breadcrumbs.crumbs.get(),(n,i,o)=>this.wireEl(yr,{sep:{className:()=>i===0?"mshell__crumb-sep hidden":"mshell__crumb-sep"},link:{className:()=>n.path?"mshell__crumb-link":"mshell__crumb-link hidden",href:n.path?te+n.path:"",textContent:()=>n.path?n.label:"",onclick:a=>{const l=a;l.metaKey||l.ctrlKey||l.shiftKey||l.button!==0||(a.preventDefault(),n.path&&this.router.navigate(n.path))}},current:{className:()=>n.path?"mshell__crumb-current hidden":"mshell__crumb-current",textContent:()=>n.path?"":n.label}},o),En)}}const Be="Something went wrong on our end. Try again in a moment.";function $r(s,e){const t=(s.details??[]).map(i=>i.path),n=i=>t.some(o=>o===`/${i}`);return n("password")?e==="register"?"Password must be at least 8 characters.":"Enter your password.":n("username")?"Enter your username.":n("displayName")?"Enter a display name.":n("handicapIndex")?"Handicap index must be a number (or leave it empty).":n("homeClubId")?'Pick a home club from the list, or leave it as "No home club".':e==="register"?"Check the details above and try again.":"Enter your username and password."}function xr(s,e){if(s instanceof O)switch(s.status){case 400:return $r(s,e);case 401:return"Wrong username or password.";case 404:return"That club is no longer available — pick another home club.";case 409:return e==="register"?"That username is taken. Pick another one.":Be;case 429:return"Too many sign-in attempts. Wait a minute, then try again.";default:return s.status>=500?Be:"That request could not be completed."}return s instanceof Error&&s.message==="Request timeout"?"That took too long. Check your connection and try again.":s instanceof Error?"Cannot reach the server. Check your connection and try again.":Be}const kr=C(`
    <div class="msignin">
...
`;class Sr extends E{static styles=Is;render(){return this.wire(Nr,{})}}class Lr extends E{static styles=Is;roles=this.inject(se);auth=this.inject(K);render(){return this.wire(Ir,{retry:{onclick:()=>{this.auth.load(),this.roles.load(!0)}}})}}const Ar=C('<div bind="gate" class="mapp"></div>');class Or extends E{static styles=`
        .mapp { min-height: 100vh; min-height: 100dvh; }
    `;auth=this.inject(K);roles=this.inject(se);gate=new H(()=>this.auth.loading.get()?"loading":this.auth.currentUser.get()===null?this.auth.error.get()?"failed":"signed-out":this.roles.error.get()?"failed":this.roles.loaded.get()?ye(this.roles).length>0?"ready":"denied":"loading");render(){const e=this.wire(Ar,{});return this.track(b(()=>{this.auth.currentUser.get()?this.roles.load():this.roles.clear()})),this.$swap(this.ref(e,"gate"),this.gate,{loading:Sr,failed:Lr,"signed-out":Er,denied:Tr,ready:vr}),e}}U.get(Bt);un();U.set(K,new mn(Qt));const Rr=U.get(K);await Qs(Or,"#app",{hot:void 0,onInit:async()=>{await Rr.load()}});export{Ue as A,E as C,q as R,m as S,Bt as T,w as a,ue as b,H as c,Ms as d,b as e,Fs as n,ve as r,C as t};
