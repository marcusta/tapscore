(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const i of document.querySelectorAll('link[rel="modulepreload"]'))s(i);new MutationObserver(i=>{for(const o of i)if(o.type==="childList")for(const a of o.addedNodes)a.tagName==="LINK"&&a.rel==="modulepreload"&&s(a)}).observe(document,{childList:!0,subtree:!0});function t(i){const o={};return i.integrity&&(o.integrity=i.integrity),i.referrerPolicy&&(o.referrerPolicy=i.referrerPolicy),i.crossOrigin==="use-credentials"?o.credentials="include":i.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function s(i){if(i.ep)return;i.ep=!0;const o=t(i);fetch(i.href,o)}})();const Ns="modulepreload",Is=function(n){return"/tapscore/manage/"+n},ct={},Ss=function(e,t,s){let i=Promise.resolve();if(t&&t.length>0){let c=function(d){return Promise.all(d.map(h=>Promise.resolve(h).then(p=>({status:"fulfilled",value:p}),p=>({status:"rejected",reason:p}))))};document.getElementsByTagName("link");const a=document.querySelector("meta[property=csp-nonce]"),l=a?.nonce||a?.getAttribute("nonce");i=c(t.map(d=>{if(d=Is(d),d in ct)return;ct[d]=!0;const h=d.endsWith(".css"),p=h?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${p}`))return;const g=document.createElement("link");if(g.rel=h?"stylesheet":Ns,h||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),h)return new Promise((v,I)=>{g.addEventListener("load",v),g.addEventListener("error",()=>I(new Error(`Unable to preload CSS for ${d}`)))})}))}function o(a){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=a,window.dispatchEvent(l),!l.defaultPrevented)throw a}return i.then(a=>{for(const l of a||[])l.status==="rejected"&&o(l.reason);return e().catch(o)})},te="/tapscore/manage/".replace(/\/+$/,""),Ue=te+"/api",Re={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","confirm-btn-min-height":"44px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Ls=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function As(n,e){const t={};for(const[s,i]of Ls)if(s in n)for(const o of i)o in n||(t[o]=`var(--${s})`);return{...e,...t,...n}}const Ht=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],Os={thin:"1px",medium:"3px",thick:"5px"};function Ft(n){const e=n.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":Os[e.toLowerCase()]??e}function Rs(){return Ht.map(n=>{const e=Ft(Re[n]);return`@property --${n}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const Mt={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},Pt={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},zs={...Pt,"done-opacity":"0.35"},Ds={...Mt,...Pt,...Re,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},Hs={...Mt,...zs,...Re,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Fs{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const t of[...e])t.disposed||(this.batching?this.pending.add(t):t.run())}runTracked(e,t){if(e.disposed)return;jt(e);const s=this.tracking;this.tracking=e;try{t()}finally{this.tracking=s}}untrack(e){const t=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=t}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const t=[...this.pending];this.pending.clear();for(const s of t)s.disposed||s.run()}}}const P=new Fs;function jt(n){for(const e of n.deps)e.delete(n);n.deps.clear()}class m{constructor(e){this.subs=new Set,this.val=e}get(){return P.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,P.notify(this.subs))}update(e){this.set(e(this.val))}}class H{constructor(e){this.subs=new Set,this.val=void 0;const t=this,s={run(){P.runTracked(s,()=>{const i=e();Object.is(t.val,i)||(t.val=i,P.notify(t.subs))})},deps:new Set};s.run()}get(){return P.subscribe(this.subs),this.val}peek(){return this.val}}function b(n){const e={run(){P.runTracked(e,n)},deps:new Set};return e.run(),()=>{e.disposed=!0,jt(e)}}function ue(n){P.batch(n)}function S(n){return P.untrack(n)}class Ms{constructor(){this.instances=new Map}get(e){let t=this.instances.get(e);return t||(t=new e,this.instances.set(e,t)),t}set(e,t){this.instances.set(e,t)}reset(){this.instances.clear()}}const U=new Ms,ae=te;function qe(n){return ae?n===ae?"/":n.startsWith(ae+"/")?n.slice(ae.length):n:n}function Ps(n){return ae+n}class q{constructor(){this.route=new m(qe(location.pathname??"/")),this.search=new m(location.search??""),window.addEventListener("popstate",()=>ue(()=>{this.route.set(qe(location.pathname)),this.search.set(location.search)}))}navigate(e,t){const s=typeof t=="boolean"?{replace:t}:t??{},i=e.indexOf("#"),o=i>=0?e.slice(i):"",a=i>=0?e.slice(0,i):e,l=a.indexOf("?"),c=l>=0?a.slice(0,l):a,d=l>=0?a.slice(l+1):"",h=s.query!==void 0?js(s.query):d?"?"+d:"",p=Ps(c)+h+o;(s.replace?history.replaceState:history.pushState).call(history,null,"",p),ue(()=>{this.route.set(c),this.search.set(h)})}back(){history.back()}link(e,t="active"){const s=e.split("#")[0].split("?")[0];return{onclick:i=>{i.preventDefault(),this.navigate(e)},className:()=>{const i=this.route.get();return i===s||i.startsWith(s+"/")?t:""}}}params(e){const t=e.split("/");return new H(()=>{const s=this.route.get().split("/"),i={};for(const[o,a]of t.entries())a.startsWith(":")&&(i[a.slice(1)]=s[o]??"");return i})}query(e){return new H(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new H(()=>{const e={};for(const[t,s]of new URLSearchParams(this.search.get()))e[t]=s;return e})}}function js(n){const e=new URLSearchParams;for(const[s,i]of Object.entries(n))i==null||i===""||e.set(s,String(i));const t=e.toString();return t?"?"+t:""}function Bs(n){return e=>n[e]}const Us="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ht="data-basics-global";function qs(){if(document.head.querySelector(`style[${ht}]`))return;const n=document.createElement("style");n.setAttribute(ht,""),n.textContent=Rs()+Us,document.head.appendChild(n)}function Ks(n,e){qs();const t=new Set(Ht),s=(o,a,l)=>{const c=Object.entries(o).map(([d,h])=>`--${d}:${t.has(d)?Ft(h):h}`).join(";");return`${a}{color-scheme:${l};${c}}`},i=document.createElement("style");return i.textContent=s(n,'[data-theme="light"]',"light")+s(e,'[data-theme="dark"]',"dark"),document.head.appendChild(i),o=>`var(--${o})`}const ut="basics-js-theme";class Bt{constructor(){this.dark=new m(!1);const e=localStorage.getItem(ut),t=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":t),b(()=>{const s=this.dark.get();document.documentElement.setAttribute("data-theme",s?"dark":"light"),localStorage.setItem(ut,s?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function C(n){const e=document.createElement("template");return e.innerHTML=n,e}function Ws(n,e){let t;for(const s of Object.keys(e))n.startsWith(s+"/")&&(!t||s.length>t.length)&&(t=s);return t?e[t]:void 0}const mt=new Set;class E{constructor(e={}){this.props=e,this.disposers=[],this.children=[];const t=this.constructor;if(t.styles&&!mt.has(t)){mt.add(t);const s=document.createElement("style");s.textContent=t.styles,document.head.appendChild(s)}}onMount(){}onDestroy(){}inject(e){return U.get(e)}track(e){this.disposers.push(e)}ref(e,t){return e.querySelector(`[bind="${t}"]`)}spawn(e,t,...s){const i=S(()=>{const o=new e(s[0]);return o.mount(t),o});return this.children.push(i),i}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){S(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,t,s){const i=s??(a=>this.track(a)),o=e.content.cloneNode(!0);for(const a of o.querySelectorAll("[bind]")){const l=t[a.getAttribute("bind")];if(l)if(typeof l=="function")i(b(()=>{const c=l();a instanceof HTMLInputElement||a instanceof HTMLTextAreaElement?a.value=String(c):a.textContent=String(c)}));else for(const[c,d]of Object.entries(l)){const h=c.includes("-");c.startsWith("on")&&typeof d=="function"?a.addEventListener(c.slice(2),d):typeof d=="function"?i(b(()=>{const p=d();h?a.setAttribute(c,String(p)):a[c]=p})):h?a.setAttribute(c,String(d)):a[c]=d}}return o}wireEl(e,t,s){return this.wire(e,t,s).firstElementChild}slot(e,t){const s=this.props[e];if(s==null)return!1;const i=this.ref(t,e);return i?(typeof s=="string"?i.textContent=s:typeof s=="function"&&s.prototype instanceof E?this.spawn(s,i):typeof s=="function"&&s(i,{spawn:(o,a,...l)=>this.spawn(o,a,...l),track:o=>this.track(o)}),!0):!1}$each(e,t,s,i=(o,a)=>a){const o=typeof t=="function"?t:()=>t.get(),a=new Map,l=new Map;this.track(()=>{for(const c of l.values())c.forEach(d=>d());l.clear()}),this.track(b(()=>{const c=o(),d=new Map;for(const[p,g]of c.entries()){const v=i(g,p);if(a.has(v))d.set(v,a.get(v));else{const I=[];d.set(v,S(()=>s(g,p,L=>I.push(L)))),l.set(v,I)}}for(const[p,g]of a)d.has(p)||(g.remove(),S(()=>l.get(p)?.forEach(v=>v())),l.delete(p));let h=e.firstChild;for(const p of d.values())p===h?h=h.nextSibling:e.insertBefore(p,h);a.clear();for(const[p,g]of d)a.set(p,g)}))}$condition(e,t,s,i){let o=null;this.track(b(()=>{o&&(o.remove(),o=null);const a=t.get();o=S(()=>a?s():i?.()??null),o&&e.appendChild(o)}))}$swap(e,t,s,i){let o=null;this.track(b(()=>{if(o){const c=o;o=null,S(()=>c.destroy())}e.textContent="";const a=t.get(),l=s[a]??Ws(a,s)??i;l&&(o=S(()=>{const c=new l;return c.mount(e),c}))})),this.track(()=>o?.destroy())}}const Ne=new Set;function Gs(n){return Ne.add(n),()=>Ne.delete(n)}function Vs(){for(const n of Array.from(Ne)){Ne.delete(n);try{n()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Ys(n,e,t){const s=document.querySelector(e);s.textContent="";const i=U.get(q);let o=null,a=!1,l=null,c=!!t?.hot?.data.hmr;const d=async h=>{o&&(o.destroy(),o=null,s.textContent=""),h?(l||(l=(await Ss(()=>import("./obs-shell.component-OgsGQV8E.js"),[])).ObsShellComponent),o=S(()=>new l)):(!c&&t?.onInit&&(await t.onInit(),c=!0),o=S(()=>new n)),S(()=>o.mount(s)),a=h};await d(qe(location.pathname).startsWith("/_obs")),b(()=>{const h=i.route.get().startsWith("/_obs");h!==a&&d(h)}),t?.hot&&(t.hot.data.hmr=!0,t.hot.dispose(()=>{try{o?.destroy()}catch(h){console.error("[startApp] the root component threw while disposing",h)}if(o=null,Vs(),t.onDispose)try{t.onDispose()}catch(h){console.error("[startApp] onDispose threw",h)}}),t.hot.accept())}class O extends Error{constructor(e,t,s,i,o){super(t),this.status=e,this.details=s,this.traceId=i,this.detail=o,this.name="ApiError"}}const Xs=10,Ce=[];let Te=[],le=null;function Qs(n){Ce.push(n),Ce.length>Xs&&Ce.shift()}function Ie(n,e,t){const s={code:n,message:e,url:typeof location<"u"?location.href:"",context:[...Ce],timestamp:new Date().toISOString()};t!==void 0&&(s.traceId=t),Te.push(s),Js()}function Js(){le||(le=setTimeout(Ut,5e3))}function Ut(){if(le&&(clearTimeout(le),le=null),Te.length===0)return;const n=Te;Te=[];for(const e of n){const t=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${Ue}/_obs/errors`,new Blob([t],{type:"application/json"})):typeof fetch<"u"&&fetch(`${Ue}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:t}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&Ut()});const Zs=3e4,en=2,we=new Map,qt=new WeakMap;function Ke(n){if(n instanceof O)return n.traceId;if(n!=null&&typeof n=="object")return qt.get(n)}async function w(n){if(n.method==="GET"){const e=we.get(n.url);if(e)return e;const t=pt(n,en);return we.set(n.url,t),t.then(()=>we.delete(n.url),()=>we.delete(n.url)),t}return pt(n,0)}async function pt(n,e){const t=n.timeout??Zs;let s;for(let i=0;i<=e;i++){const o=crypto.randomUUID();try{return await sn(tn(n,o),t)}catch(a){if(s=a,!(a instanceof O)&&a!=null&&typeof a=="object"&&qt.set(a,o),a instanceof O||i===e)break;await new Promise(l=>setTimeout(l,1e3*2**i))}}throw s}async function tn(n,e){const t={"X-Trace-Id":e},s={method:n.method,headers:t};n.body!==void 0&&(t["Content-Type"]="application/json",s.body=JSON.stringify(n.body));const i=await fetch(n.url,s),o=i.headers.get("x-trace-id")??e;if(Qs({type:"api",detail:`${n.method} ${n.url}`,timestamp:new Date().toISOString()}),!i.ok){const a=await i.json().catch(()=>({error:i.statusText}));throw new O(i.status,a.error??i.statusText,a.details,o,a.detail)}return i.json()}function sn(n,e){let t;const s=new Promise((i,o)=>{t=setTimeout(()=>o(new Error("Request timeout")),e)});return Promise.race([n,s]).finally(()=>clearTimeout(t))}const We=new Set;let De=!1;function nn(n){return We.add(n),()=>{We.delete(n)}}function st(){if(!De){De=!0;try{for(const n of[...We])try{n()}catch(e){try{Ie("session-listener",rn(e))}catch{}}}finally{De=!1}}}function rn(n){try{if(n instanceof Error){const e=n.message;if(typeof e=="string")return e}return String(n)}catch{return"listener threw a value that could not be described"}}async function ve(n,e,t,s={}){ue(()=>{n.set(!0),e.set(null)});try{const i=await t();return n.set(!1),i}catch(i){const o=on(i);ue(()=>{n.set(!1),e.set(o)}),Ie(o.code,o.message,Ke(i)),o.code==="auth"&&s.sessionExpiry!==!1&&st();return}}function on(n){return n instanceof O?n.status===401?{code:"auth",message:"Unauthorized"}:n.status===409?{code:"conflict",message:"Data has changed — please try again"}:n.status===400?{code:"validation",message:n.message}:n.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:n instanceof Error?n.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const He={sessionExpiry:!1};function an(n){return{me:()=>w({method:"GET",url:`${n}/auth/me`}),login:e=>w({method:"POST",url:`${n}/auth/login`,body:e}),logout:()=>w({method:"POST",url:`${n}/auth/logout`,body:{}}),logoutAll:()=>w({method:"POST",url:`${n}/auth/logout-all`,body:{}})}}class K{constructor(){this.api=an(Ue),this.currentUser=new m(null),this.loading=new m(!1),this.error=new m(null),this.offSessionExpired=nn(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Gs(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await ve(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,t){const s=await ve(this.loading,this.error,()=>this.api.login({username:e,password:t}),He);return s?(this.currentUser.set(s),!0):!1}async logout(){await ve(this.loading,this.error,()=>this.api.logout(),He);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await ve(this.loading,this.error,()=>this.api.logoutAll(),He),t=this.error.get();return(!t||t.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const Kt={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},ln={...Kt,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},dn={...Kt,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function Wt(n,e={}){const t=n==="light"?ln:dn,s=n==="light"?Ds:Hs;return As({...t,...e},s)}const Gt={"manage-page-pad":"var(--space-4)","manage-page-pad-wide":"var(--space-6)","manage-stack-gap":"var(--space-3)","manage-section-gap":"var(--space-5)","manage-touch-target":"44px","manage-table-bg":"var(--surface)","manage-table-radius":"var(--radius)","manage-table-border":"var(--border)","manage-table-header-bg":"var(--surface-sunken)","manage-table-header-fg":"var(--text-muted)","manage-table-header-border":"var(--border-strong)","manage-table-header-pad-y":"var(--space-2)","manage-table-header-pad-x":"var(--space-3)","manage-table-cell-pad-y":"var(--space-3)","manage-table-cell-pad-x":"var(--space-3)","manage-table-row-border":"var(--border)","manage-table-row-hover-bg":"var(--hover-bg)","manage-table-row-editing-bg":"var(--accent-soft)","manage-table-card-gap":"var(--space-2)","btn-danger-bg":"transparent","btn-danger-fg":"var(--danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger)","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger)","manage-sidebar-width":"232px","manage-content-max":"1120px"},Vt=n=>({"manage-chrome-bg":"var(--topbar-bg)","manage-chrome-fg":n,"manage-chrome-fg-muted":"color-mix(in srgb, var(--manage-chrome-fg) 66%, transparent)","manage-chrome-border":"color-mix(in srgb, var(--manage-chrome-fg) 14%, transparent)","manage-chrome-hover-bg":"color-mix(in srgb, var(--manage-chrome-fg) 9%, transparent)","manage-chrome-active-bg":"color-mix(in srgb, var(--manage-chrome-fg) 16%, transparent)","manage-scrim":"color-mix(in srgb, var(--topbar-bg) 62%, transparent)"}),Yt=Wt("light",{...Gt,...Vt("var(--primary-text)")}),Xt=Wt("dark",{...Gt,...Vt("var(--text)")}),r=Ks(Yt,Xt);function cn(){const n=document.querySelector('meta[name="theme-color"]');if(!n)return;const e=U.get(Bt);b(()=>{const s=(e.dark.get()?Xt:Yt)["topbar-bg"];s&&n.setAttribute("content",s)})}class hn extends K{constructor(e){super(),this.client=e}client;async login(e,t){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,t)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof O&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}function un(n){return{login:(e,t)=>w({method:"POST",url:`${n}/auth/login`,body:{username:e,password:t}}),me:()=>w({method:"GET",url:`${n}/auth/me`}),logout:()=>w({method:"POST",url:`${n}/auth/logout`,body:{}}),logoutAll:()=>w({method:"POST",url:`${n}/auth/logout-all`,body:{}})}}const Q="/tapscore/manage/".replace(/\/+$/,"").replace(/\/manage$/,"")+"/api",Qt=un(Q);function mn(n){return{async list(){return w({method:"GET",url:`${n}/clubs`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/clubs/get${s?"?"+s:""}`})},async create(e){return w({method:"POST",url:`${n}/clubs`,body:e})},async update(e){return w({method:"POST",url:`${n}/clubs/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${n}/clubs/${e.id}`})}}}function pn(n){return{async list(){return w({method:"GET",url:`${n}/courses`})},async listByClub(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/courses/by-club${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/courses/get${s?"?"+s:""}`})},async teeRoleCatalog(){return w({method:"GET",url:`${n}/courses/tee-roles/catalog`})},async teeRoles(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/courses/tee-roles${s?"?"+s:""}`})},async create(e){return w({method:"POST",url:`${n}/courses`,body:e})},async update(e){return w({method:"POST",url:`${n}/courses/update`,body:e})},async updateHole(e){return w({method:"POST",url:`${n}/courses/holes/update`,body:e})},async setTeeRole(e){return w({method:"POST",url:`${n}/courses/tee-roles`,body:e})},async clearTeeRole(e){return w({method:"DELETE",url:`${n}/courses/tee-roles/${e.courseId}/${e.roleKey}/${e.gender}`})},async validate(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/courses/validate${s?"?"+s:""}`})},async remove(e){return w({method:"DELETE",url:`${n}/courses/${e.id}`})}}}function gn(n){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/tees/by-course${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/tees/get${s?"?"+s:""}`})},async create(e){return w({method:"POST",url:`${n}/tees`,body:e})},async update(e){return w({method:"POST",url:`${n}/tees/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${n}/tees/${e.id}`})}}}function fn(n){return{async listByCourse(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/course-route-templates${s?"?"+s:""}`})},async get(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/course-route-templates/get${s?"?"+s:""}`})},async validate(e){return w({method:"POST",url:`${n}/course-route-templates/validate`,body:e})},async create(e){return w({method:"POST",url:`${n}/course-route-templates`,body:e})},async update(e){return w({method:"POST",url:`${n}/course-route-templates/update`,body:e})},async remove(e){return w({method:"DELETE",url:`${n}/course-route-templates/${e.id}`})}}}function bn(n){return{async myRoles(){return w({method:"GET",url:`${n}/me/roles`})},async adminStats(){return w({method:"GET",url:`${n}/admin/stats`})},async adminRounds(e){const t=new URLSearchParams;for(const[i,o]of Object.entries(e))o!==void 0&&t.set(i,String(o));const s=t.toString();return w({method:"GET",url:`${n}/admin/rounds${s?"?"+s:""}`})},async adminPlayers(){return w({method:"GET",url:`${n}/admin/players`})},async adminGrantRole(e){return w({method:"POST",url:`${n}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return w({method:"POST",url:`${n}/admin/roles/revoke`,body:e})}}}const N={clubs:mn(Q),courses:pn(Q),tees:gn(Q),courseRouteTemplates:fn(Q),admin:bn(Q)};class se{roles=new m([]);loaded=new m(!1);error=new m(null);inflight=null;isSuperAdmin(){return this.has("super_admin")}canManageCourses(){return this.isSuperAdmin()||this.has("course_admin")}has(e){return this.roles.get().some(t=>t.role===e&&t.scopeType===null)}load(e=!1){return!e&&this.inflight?this.inflight:(this.inflight=(async()=>{this.error.set(null);try{this.roles.set(await N.admin.myRoles())}catch(t){this.roles.set([]),t instanceof O&&t.status===401?st():(this.error.set("Cannot reach the server."),this.inflight=null)}finally{this.loaded.set(!0)}})(),this.inflight)}clear(){this.roles.set([]),this.loaded.set(!1),this.error.set(null),this.inflight=null}}const at=class at extends E{render(){return this.el=document.createElement("div"),this.el.className="ui-overlay",this.el.style.background=this.props.bg??"rgba(0,0,0,0.4)",this.el.style.zIndex=String(this.props.zIndex??50),this.el.addEventListener("click",()=>{this.props.onclose?this.props.onclose():this.props.open.set(!1)}),this.track(b(()=>{const e=this.props.open.get();this.el.classList.toggle("open",e),this.props.scrollLock&&(document.body.style.overflow=e?"hidden":"")})),this.el}onDestroy(){this.props.scrollLock&&(document.body.style.overflow="")}};at.styles=`
    ...
    `;let Ge=at;const $=n=>`var(--${n})`,_=(n,e)=>`var(--${n}, ${e})`,y=n=>{const e=Re[n];if(e===void 0)throw new Error(`unknown control token: --${n}`);return e},_n=n=>_(n,y(n)),u=Bs({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),$e=n=>`
    ...
    cursor: not-allowed;`,yn={primary:$e("primary"),secondary:$e("secondary"),ghost:$e("ghost"),danger:$e("danger"),disabled:Jt},k=(n=_("btn-radius",y("btn-radius")),e="secondary")=>`
    /*
    ...
    ${yn[e]}
    &:disabled {${Jt}}
`,wn=`max(${_("field-border-width",y("field-border-width"))}, ${_("field-rule-width",y("field-rule-width"))})`,xe=(n,e)=>`
    border-top-color: ${n};
...
`,In="You no longer have permission to change the course catalog. Ask an administrator to grant you the course_admin role.";function R(n,e){if(!(n instanceof O))return Ie(Sn(n),Ln(n),Ke(n)),e;if(n.status===401)return st(),"Your session expired. Sign in again to continue.";if(n.status===403)return In;if(n.status>=400&&n.status<500){if(!n.details?.length)return n.message;const t=n.details.map(s=>`${s.path.replace(/^\//,"")} — ${s.message}`).join("; ");return`${n.message}: ${t}`}return Ie("server",`${n.status} ${n.message}`,Ke(n)),e}function Sn(n){return n instanceof Error?n.message==="Request timeout"?"timeout":"network":"unknown"}function Ln(n){return n instanceof Error?n.message:String(n)}function rs(){return{name:"",location:"",logoUrl:""}}function An(n){return{name:n.name,location:n.location??"",logoUrl:n.logoUrl??""}}function os(n){const e={};n.name.trim()===""&&(e.name="A club needs a name. Enter one before saving.");const t=n.logoUrl.trim();return t!==""&&!On(t)&&(e.logoUrl="Enter a full web address starting with https://, or leave this empty."),e}function as(n){return Object.keys(n).length>0}function bt(n){return{name:n.name.trim(),location:n.location.trim()||null,logoUrl:n.logoUrl.trim()||null}}function ls(n,e){const t=e===0?"It has no courses.":e===1?"It has 1 course.":`It has ${e} courses.`;return`${n} leaves the catalog. ${t} Rounds already played keep their own copy of the course data, so no scorecard changes.`}const ds="The club is removed from the catalog.";function On(n){try{const e=new URL(n);return e.protocol==="http:"||e.protocol==="https:"}catch{return!1}}function Rn(n,e){const t=e.trim().toLowerCase().split(/\s+/).filter(s=>s!=="");return t.length===0?n:n.filter(s=>{const i=`${s.name} ${s.location??""}`.toLowerCase();return t.every(o=>i.includes(o))})}class ze{clubs=new m([]);loading=new m(!1);error=new m(null);loaded=new m(!1);query=new m("");visible=new H(()=>Rn(this.clubs.get(),this.query.get()));inflight=null;load(e=!1){return!e&&this.inflight?this.inflight:(this.inflight=(async()=>{this.loading.set(!0),this.error.set(null);try{this.clubs.set(await N.clubs.list())}catch(t){this.error.set(R(t,"Could not load the clubs. Check your connection and try again.")),this.inflight=null}finally{this.loading.set(!1),this.loaded.set(!0)}})(),this.inflight)}byId(e){return this.clubs.get().find(t=>t.id===e)??null}async create(e){return this.write(()=>N.clubs.create(bt(e)),"Could not create the club. Check your connection and try again.")}async update(e,t){return this.write(()=>N.clubs.update({id:e,...bt(t)}),"Could not save the club. Check your connection and try again.")}async remove(e){return this.write(()=>N.clubs.remove({id:e}),"Could not delete the club. Check your connection and try again.")}async write(e,t){try{await e()}catch(s){return{ok:!1,message:R(s,t)}}return await this.load(!0),{ok:!0}}}const zn=C(`
...
`);class Zn extends E{static styles=`
    ...
    `;router=this.inject(q);crumbs=this.inject(pe);clubs=this.inject(ze);params=this.router.params(Dn);editor=new me;errors=new m({});deleteOpen=new m(!1);deleteFailure=new m(null);deleting=new m(!1);fields=null;render(){const e=this.wire(Jn,{loadingNote:{textContent:"Loading club…",hidden:()=>this.clubs.loaded.get()},loadError:{textContent:()=>this.clubs.error.get()??"",hidden:()=>this.clubs.error.get()===null},retry:{hidden:()=>this.clubs.error.get()===null,onclick:()=>{this.clubs.load(!0)}},missing:{hidden:()=>!this.clubs.loaded.get()||this.clubs.error.get()!==null||this.club()!==null},backMissing:{onclick:()=>this.router.navigate(M)},body:{hidden:()=>this.club()===null},title:()=>this.club()?.name??"",subtitle:()=>this.courseSummary(),remove:{textContent:()=>this.deleting.get()?"Deleting…":"Delete club",disabled:()=>this.editing()||this.deleting.get(),onclick:()=>{this.deleteFailure.set(null),this.deleteOpen.set(!0)}},deleteError:{textContent:()=>this.deleteFailure.get()??"",hidden:()=>this.deleteFailure.get()===null},edit:{hidden:()=>this.editing(),disabled:()=>this.deleting.get(),onclick:()=>this.beginEdit()},facts:{hidden:()=>this.editing()},factName:()=>this.club()?.name??"",factLocation:()=>this.club()?.location??"Not recorded",factLogo:()=>this.club()?.logoUrl??"Not recorded",form:{hidden:()=>!this.editing(),onsubmit:s=>{s.preventDefault(),this.save()}},saveError:{textContent:()=>this.editor.errorFor(this.clubId())??"",hidden:()=>this.editor.errorFor(this.clubId())===null},save:{textContent:()=>this.saving()?"Saving…":"Save",disabled:()=>this.saving()},cancel:{disabled:()=>this.saving(),onclick:()=>this.cancelEdit()}});this.fields=this.spawn(cs,this.ref(e,"fieldsHost"),{idPrefix:"manage-club-edit",errors:this.errors,busy:{get:()=>this.saving()}});const t=this.clubId();return t!==""&&this.spawn(Qn,this.ref(e,"coursesHost"),{clubId:t}),this.spawn(X,this.ref(e,"confirmHost"),ge({open:this.deleteOpen,title:()=>{const s=this.club();return s?`Delete ${s.name}?`:"Delete this club?"},consequence:()=>this.deleteConsequence(),confirmLabel:"Delete club",onconfirm:()=>{this.remove()}})),this.track(ie(this.deleteOpen)),e}onMount(){this.clubs.load(),this.track(b(()=>{const e=this.club();this.crumbs.set([{label:"Clubs",path:M},{label:e?.name??"Club"}])})),this.clubId()===""&&this.router.navigate(M,!0)}clubId(){return this.params.get().id}club(){const e=this.clubId();return e===""?null:this.clubs.byId(e)}editing(){return this.editor.isEditing(this.clubId())}saving(){return this.editor.isSaving(this.clubId())}courseSummary(){const e=this.club();return e?e.courseCount===0?"No courses yet.":e.courseCount===1?"1 course.":`${e.courseCount} courses.`:""}beginEdit(){const e=this.club();e&&(this.errors.set({}),this.editor.begin(e.id),this.fields?.seed(An(e)),this.fields?.focusFirst())}cancelEdit(){this.editor.cancel(),this.errors.set({})}save(){const e=this.club();if(!e||!this.fields||this.saving())return;const t=this.fields.draft.get(),s=os(t);if(this.errors.set(s),as(s)){this.fields.focusInvalid(s);return}this.editor.commit(()=>this.clubs.update(e.id,t))}deleteConsequence(){const e=this.club();return e?ls(e.name,e.courseCount):ds}async remove(){const e=this.club();if(!(!e||this.deleting.get())){this.deleteFailure.set(null),this.deleting.set(!0);try{const t=await this.clubs.remove(e.id);if(!t.ok){this.deleteFailure.set(t.message);return}this.router.navigate(M,!0)}finally{this.deleting.set(!1)}}}}function ei(n){return{par:String(n.par),strokeIndex:String(n.strokeIndex)}}function Xe(){return{par:"",strokeIndex:""}}function fs(n,e){const t=Nt(n.par);if(t===null||t<1)return{ok:!1,message:"Par is a whole number of strokes — 3, 4 or 5 on nearly every hole. Enter one and save again."};const s=Nt(n.strokeIndex);return s===null||s<1||s>e?{ok:!1,message:`Stroke index runs from 1 to ${e}, one number per hole. Enter one in that range and save again.`}:{ok:!0,par:t,strokeIndex:s}}function ti(n,e){const t=n.filter(l=>l.holeNumber>=1&&l.holeNumber<=e),s=(l,c)=>t.filter(d=>d.holeNumber>=l&&d.holeNumber<=c),i=(l,c)=>s(l,c).reduce((d,h)=>d+h.par,0),o=(l,c)=>s(l,c).length===0?null:i(l,c),a=e>9;return{front:a?o(1,9):null,back:a?o(10,e):null,split:a,total:i(1,e),counted:t.length,expected:e,extra:n.length-t.length}}function Et(n){return n===null?"—":String(n)}function Ct(n){const e=[],t=n.expected-n.counted;return t>0&&e.push(`Counted over the ${n.counted} ${V(n.counted)} that have values — ${t} of the course’s ${n.expected} ${V(n.expected)} ${t===1?"has":"have"} no row yet.`),n.extra>0&&e.push(`${Y(G(n.extra,"hole row","hole rows"))} sit beyond hole ${n.expected} and ${n.extra===1?"is":"are"} not counted.`),e.length>0?e.join(" "):null}function Ae(n,e){const t=new Set(n.map(i=>i.holeNumber)),s=[];for(let i=1;i<=e;i+=1)t.has(i)||s.push(i);return s}function rt(n,e){const t=new Set(n.map(i=>i.strokeIndex)),s=[];for(let i=1;i<=e;i+=1)t.has(i)||s.push(i);return s}function si(n,e,t){const s=ot(n,t);if(s.length>0)return{ok:!1,message:`This course also has ${G(s.length,"hole row","hole rows")} beyond hole ${t}. Remove those rows in the panel below, or set the hole count to match the course on the club page — adding holes cannot resolve either.`};const i=[...n];for(const l of Ae(n,t)){const c=e.get(l)??Xe(),d=fs(c,t);if(!d.ok)return{ok:!1,message:`Hole ${l}: ${di(d.message)}`};i.push({holeNumber:l,par:d.par,strokeIndex:d.strokeIndex})}const o=bs(i);if(o){const c=n.some(d=>d.holeNumber===o.holes[0])&&n.some(d=>d.holeNumber===o.holes[1])?"Change one of them in the grid above first.":"Give the new hole one of the free numbers.";return{ok:!1,message:`Holes ${o.holes[0]} and ${o.holes[1]} would both have stroke index ${o.strokeIndex}. Every hole needs its own number from 1 to ${t}. ${c}`}}const a=rt(i,t);return a.length>0?{ok:!1,message:`Stroke ${a.length===1?"index":"indices"} ${Z(a)} would be left unused. Every number from 1 to ${t} has to appear exactly once.`}:{ok:!0,holes:[...i].sort((l,c)=>l.holeNumber-c.holeNumber)}}function ot(n,e){return n.filter(t=>t.holeNumber<1||t.holeNumber>e).sort((t,s)=>t.holeNumber-s.holeNumber)}function Tt(n,e){const t=ot(n,e);if(t.length===0)return{ok:!1,message:"This course has no hole rows beyond its hole count."};const s=n.filter(c=>c.holeNumber>=1&&c.holeNumber<=e).sort((c,d)=>c.holeNumber-d.holeNumber),i=Ae(s,e);if(i.length>0)return{ok:!1,message:`${Y(V(i.length))} ${Z(i)} ${i.length===1?"has":"have"} no row either, so removing these would leave the course incomplete. Add the missing ${V(i.length)} first.`};const o=s.filter(c=>c.strokeIndex<1||c.strokeIndex>e);if(o.length>0)return{ok:!1,message:`${Y(V(o.length))} ${Z(o.map(c=>c.holeNumber))} still ${o.length===1?"has a stroke index":"have stroke indices"} above ${e}. A ${e}-hole course hands out stroke indices 1 to ${e}, so give ${o.length===1?"it":"them"} a number in that range in the grid above, then remove these rows.`};const a=bs(s);if(a)return{ok:!1,message:`Holes ${a.holes[0]} and ${a.holes[1]} both have stroke index ${a.strokeIndex}. Every one of the course’s ${e} holes needs its own number from 1 to ${e}. Change one of them in the grid above, then remove these rows.`};const l=rt(s,e);return l.length>0?{ok:!1,message:`Stroke ${l.length===1?"index":"indices"} ${Z(l)} ${l.length===1?"is":"are"} not assigned to any of the course’s ${e} holes. Hand ${l.length===1?"it":"them"} out in the grid above, then remove these rows.`}:{ok:!0,holes:s,removed:t}}function ni(n){return`Hole ${n.holeNumber} — par ${n.par}, stroke index ${n.strokeIndex}`}function ii(n,e){if(n.length===0)return"";const t=n.map(s=>s.holeNumber);return`This course is set to ${e} holes, but ${G(n.length,"row","rows")} beyond that ${n.length===1?"is":"are"} still stored — ${V(t.length)} ${Z(t)}. A hole-count change leaves them behind on purpose, because the par and stroke index on them are real numbers somebody typed. They count towards nothing, and the course check reports them until they are gone.`}function ri(n,e,t){const s=n.map(i=>i.holeNumber);return`${Y(V(s.length))} ${Z(s)} — and the par and stroke index stored on ${s.length===1?"it":"them"} — are deleted from ${e}. The course keeps its ${t} holes. This cannot be undone.`}function bs(n){const e=new Map;for(const t of[...n].sort((s,i)=>s.holeNumber-i.holeNumber)){const s=e.get(t.strokeIndex);if(s!==void 0)return{strokeIndex:t.strokeIndex,holes:[s,t.holeNumber]};e.set(t.strokeIndex,t.holeNumber)}return null}function oi(n,e){return n.issues.map((t,s)=>({key:`${s}:${t.code}:${t.message}`,severity:t.severity,severityLabel:t.severity==="error"?"Problem":"Warning",explanation:ai(t.code,e),detail:t.message}))}function ai(n,e){switch(n){case"missing_holes":return"These holes have no par or stroke index yet, so the course is not complete. Add them below.";case"unexpected_holes":return`The course is set to ${e} holes, but rows exist past that. Remove them in the panel below, or change the hole count on the club page if the course really has them.`;case"duplicate_stroke_index":return"Two holes share a stroke index. Handicap strokes are handed out in stroke-index order, so each hole needs its own number.";case"missing_stroke_indices":return`Some numbers between 1 and ${e} are not assigned to any hole. Every one of them has to appear exactly once.`;case"stroke_index_out_of_range":return`A stroke index outside 1 to ${e} cannot be resolved when a round hands out strokes.`;case"unusual_par":return"A par outside 3 to 6 is unusual, not wrong. It saves as it is — worth a second look.";default:return"The course check reported this."}}function li(n,e,t){if(n.status==="checking")return"Checking the course…";if(n.status==="unknown"||e===null)return"The course check did not run, so nothing here is confirmed. It runs again after the next save.";const s=e.issues.filter(o=>o.severity==="error").length,i=e.issues.length-s;return s===0&&i===0?`Nothing to fix — every hole has a par, and the stroke indices run 1 to ${t}, once each.`:s===0?`${Y(G(i,"warning","warnings"))}, nothing that blocks play.`:i===0?`${Y(G(s,"problem","problems"))} to fix.`:`${Y(G(s,"problem","problems"))} to fix, and ${G(i,"warning","warnings")}.`}function G(n,e,t){return`${n} ${n===1?e:t}`}function V(n){return n===1?"hole":"holes"}function Z(n){return n.length<=2?n.join(" and "):`${n.slice(0,-1).join(", ")} and ${n[n.length-1]}`}function Y(n){return n.charAt(0).toUpperCase()+n.slice(1)}function di(n){return n.charAt(0).toLowerCase()+n.slice(1)}function Nt(n){const e=n.trim();if(!/^\d+$/.test(e))return null;const t=Number(e);return Number.isSafeInteger(t)?t:null}const oe="__fill";function It(n,e){return`Hole ${n.holeNumber} — ${e}`}const ci=C(`
...
`);class Hi extends E{static styles=`
    ...
    `,he.seq=0;let Ze=he;function Mi(n,e){return`<button bind="${n}" class="minfo-dot" type="button" aria-expanded="false" aria-label="${Pi(e)}"><span aria-hidden="true">i</span></button>`}function Pi(n){return n.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}const ji=`
        .minfo-dot {
            position: relative;
            flex: none;
            appearance: none;
        ...
        }`,je={svart:0,black:0,vit:1,white:1,gul:2,yellow:2,blå:3,bla:3,blue:3,röd:4,rod:4,red:4,orange:5};function et(n){const e=n.name.trim().toLocaleLowerCase("sv-SE"),t=n.colour?.trim().toLocaleLowerCase("sv-SE")??"",s=e.split(/\s+/)[0]??"",i=je[e]??je[s]??je[t];if(i!==void 0)return{kind:"colour",rank:i};const o=/^(\d+(?:[.,]\d+)?)\s*(?:m)?$/i.exec(e);return o?{kind:"numeric",length:Number(o[1].replace(",","."))}:{kind:"other"}}function Bi(n){return n.map((e,t)=>({tee:e,index:t,classification:et(e)})).sort((e,t)=>{const s={numeric:0,colour:1,other:2};return e.classification.kind!==t.classification.kind?s[e.classification.kind]-s[t.classification.kind]:e.classification.kind==="numeric"&&t.classification.kind==="numeric"?t.classification.length-e.classification.length||e.index-t.index:e.classification.kind==="colour"&&t.classification.kind==="colour"?e.classification.rank-t.classification.rank||e.index-t.index:e.tee.name.localeCompare(t.tee.name,"sv-SE",{sensitivity:"base"})||e.index-t.index}).map(({tee:e})=>e)}function Es(n,e){return n.ratings.some(t=>t.gender===e)}function Ui(n,e,t,s){const i=e.find(a=>a.roleKey===t&&a.gender===s)?.teeId,o=n.find(a=>a.id===i);return o&&Es(o,s)?o:null}function qi(n,e,t,s=null){const i=[s,"club"].filter((c,d,h)=>!!c&&h.indexOf(c)===d);for(const c of i){const d=Ui(n,e,c,t);if(d)return d.id}const o=t==="M"?2:4,a=Bi(n.filter(c=>Es(c,t))),l=a.find(c=>{const d=et(c);return d.kind==="colour"&&d.rank===o});return l?l.id:a.length===0?"":a.every(c=>et(c).kind==="numeric")&&t==="M"?a[0].id:a.at(-1).id}const Oe="",Cs="Not set";function Ki(n,e){return n.filter(t=>t.ratings.some(s=>s.gender===e))}function Wi(n){const e=n.colour?.trim()??"";if(e==="")return n.name;const t=vs(e);return t.toLocaleLowerCase("sv-SE")===n.name.trim().toLocaleLowerCase("sv-SE")?n.name:`${n.name} · ${t}`}function Gi(n,e){return[{value:Oe,label:Cs},...Ki(n,e).map(t=>({value:t.id,label:Wi(t)}))]}function tt(n,e,t){return n.find(s=>s.roleKey===e&&s.gender===t)?.teeId??Oe}function Vi(n,e,t,s){const i=qi(n,e,s,t),o=n.find(a=>a.id===i);return o?tt(e,t,s)===o.id?{via:"role",teeName:o.name}:tt(e,"club",s)===o.id?{via:"club",teeName:o.name}:{via:"convention",teeName:o.name}:{via:"none"}}function Yi(n,e){return n.includes("no rating for the mapped gender")?`That tee has no rating for ${A(e).toLowerCase()} any more, so it cannot be chosen here. Rate it above, or pick another tee.`:n.includes("must belong to the mapped course")?"That tee is no longer one of this course’s tees. Reload the page to see the tees as they stand.":n}function Xi(n,e,t){const s=`A ${n.displayName} / ${A(e)} round`;switch(t.via){case"role":return`${s} plays from ${t.teeName} today.`;case"club":return`${s} plays from ${t.teeName} today, taken from the Club row because this row is empty.`;case"convention":return`${s} plays from ${t.teeName} today, picked by tee name because no row above applies.`;case"none":return`${s} has no tee to start from — no tee on this course is rated for ${A(e).toLowerCase()}.`}}class Qi{catalog=new m([]);courseId=new m(null);mappings=new m([]);loading=new m(!1);error=new m(null);loaded=new m(!1);inflight=null;catalogFetched=!1;load(e,t=!1){return this.courseId.get()!==e&&(this.courseId.set(e),this.mappings.set([]),this.loaded.set(!1),this.inflight=null),!t&&this.inflight?this.inflight:(this.inflight=(async()=>{this.loading.set(!0),this.error.set(null);try{const[s,i]=await Promise.all([this.catalogFetched?Promise.resolve(this.catalog.get()):N.courses.teeRoleCatalog(),N.courses.teeRoles({courseId:e})]);if(this.catalog.set(s),this.catalogFetched=!0,this.courseId.get()!==e)return;this.mappings.set(i)}catch(s){this.error.set(R(s,"Could not load the tee roles. Check your connection and try again.")),this.inflight=null}finally{this.loading.set(!1),this.loaded.set(!0)}})(),this.inflight)}mappedTeeId(e,t){return tt(this.mappings.get(),e,t)}async setRole(e,t,s){const i=this.courseId.get();return i===null?{ok:!1,message:"No course is loaded."}:this.write(()=>N.courses.setTeeRole({courseId:i,roleKey:e,gender:t,teeId:s}),"Could not save the tee role. Check your connection and try again.")}async clearRole(e,t){const s=this.courseId.get();return s===null?{ok:!1,message:"No course is loaded."}:this.write(()=>N.courses.clearTeeRole({courseId:s,roleKey:e,gender:t}),"Could not clear the tee role. Check your connection and try again.")}async write(e,t){try{await e()}catch(i){return{ok:!1,message:R(i,t)}}const s=this.courseId.get();return s!==null&&await this.load(s,!0),{ok:!0}}}const Ji=C(`
