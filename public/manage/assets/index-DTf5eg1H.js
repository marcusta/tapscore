(function(){const e=document.createElement("link").relList;if(e&&e.supports&&e.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const a of s)if(a.type==="childList")for(const i of a.addedNodes)i.tagName==="LINK"&&i.rel==="modulepreload"&&n(i)}).observe(document,{childList:!0,subtree:!0});function r(s){const a={};return s.integrity&&(a.integrity=s.integrity),s.referrerPolicy&&(a.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?a.credentials="include":s.crossOrigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function n(s){if(s.ep)return;s.ep=!0;const a=r(s);fetch(s.href,a)}})();const Ce="modulepreload",Oe=function(t){return"/tapscore/manage/"+t},re={},Pe=function(e,r,n){let s=Promise.resolve();if(r&&r.length>0){let p=function(m){return Promise.all(m.map(g=>Promise.resolve(g).then(b=>({status:"fulfilled",value:b}),b=>({status:"rejected",reason:b}))))};document.getElementsByTagName("link");const i=document.querySelector("meta[property=csp-nonce]"),l=i?.nonce||i?.getAttribute("nonce");s=p(r.map(m=>{if(m=Oe(m),m in re)return;re[m]=!0;const g=m.endsWith(".css"),b=g?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${m}"]${b}`))return;const y=document.createElement("link");if(y.rel=g?"stylesheet":Ce,g||(y.as="script"),y.crossOrigin="",y.href=m,l&&y.setAttribute("nonce",l),document.head.appendChild(y),g)return new Promise((S,R)=>{y.addEventListener("load",S),y.addEventListener("error",()=>R(new Error(`Unable to preload CSS for ${m}`)))})}))}function a(i){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=i,window.dispatchEvent(l),!l.defaultPrevented)throw i}return s.then(i=>{for(const l of i||[])l.status==="rejected"&&a(l.reason);return e().catch(a)})},H="/tapscore/manage/".replace(/\/+$/,""),X=H+"/api",F={"field-bg":"var(--surface)","field-bg-focus":"var(--surface)","field-border":"var(--border-strong)","field-border-width":"1px","field-rule":"var(--field-border, var(--border-strong))","field-rule-width":"0px","field-radius":"var(--radius-sm)","field-padding-y":"8px","field-padding-x":"10px","field-font-size":"14px","field-line-height":"21px","field-focus-border":"var(--accent)","field-focus-ring":"var(--accent-soft)","field-focus-ring-width":"3px","field-invalid-border":"var(--danger)","field-invalid-rule":"var(--danger)","field-invalid-ring":"var(--danger-soft)","btn-radius":"var(--radius-sm)","btn-border-width":"1px","btn-padding-y":"8px","btn-padding-x":"16px","btn-font-size":"14px","btn-line-height":"20px","btn-font-weight":"500","btn-focus-ring":"var(--accent-soft)","btn-focus-ring-width":"3px","btn-primary-bg":"var(--accent)","btn-primary-fg":"var(--on-accent)","btn-primary-border":"var(--accent)","btn-primary-shadow":"none","btn-primary-bg-hover":"var(--accent-strong)","btn-primary-fg-hover":"var(--on-accent)","btn-primary-border-hover":"var(--accent-strong)","btn-secondary-bg":"var(--surface-2)","btn-secondary-fg":"var(--text)","btn-secondary-border":"var(--border)","btn-secondary-shadow":"none","btn-secondary-bg-hover":"var(--accent-soft)","btn-secondary-fg-hover":"var(--text)","btn-secondary-border-hover":"var(--border-strong)","btn-ghost-bg":"transparent","btn-ghost-fg":"var(--text-muted)","btn-ghost-border":"transparent","btn-ghost-shadow":"none","btn-ghost-bg-hover":"var(--surface-2)","btn-ghost-fg-hover":"var(--text)","btn-ghost-border-hover":"transparent","btn-danger-bg":"var(--danger)","btn-danger-fg":"var(--on-danger)","btn-danger-border":"var(--danger)","btn-danger-shadow":"none","btn-danger-bg-hover":"var(--danger-strong, var(--danger))","btn-danger-fg-hover":"var(--on-danger)","btn-danger-border-hover":"var(--danger-strong, var(--danger))","btn-disabled-bg":"var(--surface-2)","btn-disabled-fg":"var(--text-muted)","btn-disabled-border":"var(--border)","btn-disabled-opacity":"0.7"},Ae=[["radius",["field-radius","btn-radius","radius-md"]],["border",["field-border","field-rule","btn-secondary-border","btn-disabled-border"]],["input-bg",["field-bg","field-bg-focus"]],["btn-bg",["btn-secondary-bg","btn-disabled-bg"]],["btn-hover",["btn-secondary-bg-hover"]],["primary",["btn-primary-bg","btn-primary-border","btn-primary-bg-hover","btn-primary-border-hover","field-focus-border"]],["primary-text",["btn-primary-fg","btn-primary-fg-hover"]],["hover-bg",["btn-ghost-bg-hover"]],["error",["field-invalid-border","field-invalid-rule"]],["shadow",["shadow-1"]],["shadow-elevated",["shadow-2","shadow-3"]]];function Le(t,e){const r={};for(const[n,s]of Ae)if(n in t)for(const a of s)a in t||(r[a]=`var(--${n})`);return{...e,...r,...t}}const ce=["field-border-width","field-rule-width","field-focus-ring-width","btn-border-width","btn-focus-ring-width"],je={thin:"1px",medium:"3px",thick:"5px"};function de(t){const e=t.trim();return/^[+-]?(?:\d+(?:\.\d*)?|\.\d+)$/.test(e)&&parseFloat(e)===0?"0px":je[e.toLowerCase()]??e}function ze(){return ce.map(t=>{const e=de(F[t]);return`@property --${t}{syntax:"<length>";inherits:true;initial-value:${e}}`}).join("")}const le={"font-display":"Georgia,'Times New Roman',serif","font-ui":"system-ui,-apple-system,'Segoe UI',sans-serif","space-1":"4px","space-2":"8px","space-3":"12px","space-4":"16px","space-5":"24px","space-6":"32px","space-7":"48px","space-8":"64px","radius-sm":"4px","radius-md":"8px","radius-pill":"999px","dur-fast":"120ms","dur-base":"200ms","dur-slow":"320ms","ease-standard":"cubic-bezier(.2,.7,.3,1)"},ue={primary:"var(--accent)","primary-text":"var(--on-accent)","btn-bg":"var(--surface-2)","btn-hover":"var(--accent-soft)","input-bg":"var(--surface)","topbar-bg":"var(--surface)","topbar-logo":"var(--text-muted)","active-bg":"var(--accent-soft)","active-text":"var(--accent-strong)","hover-bg":"var(--surface-2)",error:"var(--danger)",radius:"var(--radius-md)",shadow:"var(--shadow-1)","shadow-elevated":"var(--shadow-2)","done-opacity":"0.4"},Re={...ue,"done-opacity":"0.35"},Ie={...le,...ue,...F,bg:"#f8f9fa",surface:"#ffffff","surface-2":"#f1f3f5",text:"#212529","text-muted":"#5c636a",border:"#dee2e6","border-strong":"#868e96",accent:"#3b5bdb","accent-strong":"#2f44ad","accent-soft":"#edf2ff","on-accent":"#ffffff",success:"#217a36","success-soft":"#ebfbee",warning:"#a85400","warning-soft":"#fff4e6",danger:"#c92a2a","danger-strong":"#a51111","danger-soft":"#fff5f5","on-danger":"#ffffff",info:"#1864ab","info-soft":"#e7f5ff","shadow-1":"0 1px 2px rgba(33,37,41,.06)","shadow-2":"0 4px 12px rgba(33,37,41,.10)","shadow-3":"0 16px 40px rgba(33,37,41,.22)"},De={...le,...Re,...F,bg:"#141517",surface:"#1a1b1e","surface-2":"#25262b",text:"#e9ecef","text-muted":"#a6a7ab",border:"#373a40","border-strong":"#868e96",accent:"#91a7ff","accent-strong":"#bac8ff","accent-soft":"#232840","on-accent":"#141517",success:"#69db7c","success-soft":"#17301e",warning:"#ffa94d","warning-soft":"#33260f",danger:"#ff8787","danger-strong":"#ffa8a8","danger-soft":"#331f1f","on-danger":"#141517",info:"#74c0fc","info-soft":"#17242f","shadow-1":"0 1px 2px rgba(0,0,0,.4)","shadow-2":"0 4px 14px rgba(0,0,0,.5)","shadow-3":"0 16px 44px rgba(0,0,0,.6)"};class Ne{constructor(){this.tracking=null,this.batching=!1,this.pending=new Set}subscribe(e){this.tracking&&(e.add(this.tracking),this.tracking.deps.add(e))}notify(e){for(const r of[...e])r.disposed||(this.batching?this.pending.add(r):r.run())}runTracked(e,r){if(e.disposed)return;he(e);const n=this.tracking;this.tracking=e;try{r()}finally{this.tracking=n}}untrack(e){const r=this.tracking;this.tracking=null;try{return e()}finally{this.tracking=r}}batch(e){this.batching=!0;try{e()}finally{this.batching=!1;const r=[...this.pending];this.pending.clear();for(const n of r)n.disposed||n.run()}}}const E=new Ne;function he(t){for(const e of t.deps)e.delete(t);t.deps.clear()}class v{constructor(e){this.subs=new Set,this.val=e}get(){return E.subscribe(this.subs),this.val}peek(){return this.val}set(e){Object.is(this.val,e)||(this.val=e,E.notify(this.subs))}update(e){this.set(e(this.val))}}class q{constructor(e){this.subs=new Set,this.val=void 0;const r=this,n={run(){E.runTracked(n,()=>{const s=e();Object.is(r.val,s)||(r.val=s,E.notify(r.subs))})},deps:new Set};n.run()}get(){return E.subscribe(this.subs),this.val}peek(){return this.val}}function x(t){const e={run(){E.runTracked(e,t)},deps:new Set};return e.run(),()=>{e.disposed=!0,he(e)}}function U(t){E.batch(t)}function _(t){return E.untrack(t)}class Me{constructor(){this.instances=new Map}get(e){let r=this.instances.get(e);return r||(r=new e,this.instances.set(e,r)),r}set(e,r){this.instances.set(e,r)}reset(){this.instances.clear()}}const O=new Me,A=H;function J(t){return A?t===A?"/":t.startsWith(A+"/")?t.slice(A.length):t:t}function qe(t){return A+t}class K{constructor(){this.route=new v(J(location.pathname??"/")),this.search=new v(location.search??""),window.addEventListener("popstate",()=>U(()=>{this.route.set(J(location.pathname)),this.search.set(location.search)}))}navigate(e,r){const n=typeof r=="boolean"?{replace:r}:r??{},s=e.indexOf("#"),a=s>=0?e.slice(s):"",i=s>=0?e.slice(0,s):e,l=i.indexOf("?"),p=l>=0?i.slice(0,l):i,m=l>=0?i.slice(l+1):"",g=n.query!==void 0?Ge(n.query):m?"?"+m:"",b=qe(p)+g+a;(n.replace?history.replaceState:history.pushState).call(history,null,"",b),U(()=>{this.route.set(p),this.search.set(g)})}back(){history.back()}link(e,r="active"){const n=e.split("#")[0].split("?")[0];return{onclick:s=>{s.preventDefault(),this.navigate(e)},className:()=>{const s=this.route.get();return s===n||s.startsWith(n+"/")?r:""}}}params(e){const r=e.split("/");return new q(()=>{const n=this.route.get().split("/"),s={};for(const[a,i]of r.entries())i.startsWith(":")&&(s[i.slice(1)]=n[a]??"");return s})}query(e){return new q(()=>new URLSearchParams(this.search.get()).get(e)??void 0)}queries(){return new q(()=>{const e={};for(const[r,n]of new URLSearchParams(this.search.get()))e[r]=n;return e})}}function Ge(t){const e=new URLSearchParams;for(const[n,s]of Object.entries(t))s==null||s===""||e.set(n,String(s));const r=e.toString();return r?"?"+r:""}function Be(t){return e=>t[e]}const Ue="@media (prefers-reduced-motion: reduce){*,*::before,*::after{animation-duration:.01ms !important;animation-iteration-count:1 !important;transition-duration:.01ms !important}}",ne="data-basics-global";function We(){if(document.head.querySelector(`style[${ne}]`))return;const t=document.createElement("style");t.setAttribute(ne,""),t.textContent=ze()+Ue,document.head.appendChild(t)}function He(t,e){We();const r=new Set(ce),n=(a,i,l)=>{const p=Object.entries(a).map(([m,g])=>`--${m}:${r.has(m)?de(g):g}`).join(";");return`${i}{color-scheme:${l};${p}}`},s=document.createElement("style");return s.textContent=n(t,'[data-theme="light"]',"light")+n(e,'[data-theme="dark"]',"dark"),document.head.appendChild(s),a=>`var(--${a})`}const se="basics-js-theme";class fe{constructor(){this.dark=new v(!1);const e=localStorage.getItem(se),r=matchMedia("(prefers-color-scheme: dark)").matches;this.dark.set(e?e==="dark":r),x(()=>{const n=this.dark.get();document.documentElement.setAttribute("data-theme",n?"dark":"light"),localStorage.setItem(se,n?"dark":"light")})}toggle(){this.dark.update(e=>!e)}}function w(t){const e=document.createElement("template");return e.innerHTML=t,e}function Fe(t,e){let r;for(const n of Object.keys(e))t.startsWith(n+"/")&&(!r||n.length>r.length)&&(r=n);return r?e[r]:void 0}const ae=new Set;class ${constructor(e={}){this.props=e,this.disposers=[],this.children=[];const r=this.constructor;if(r.styles&&!ae.has(r)){ae.add(r);const n=document.createElement("style");n.textContent=r.styles,document.head.appendChild(n)}}onMount(){}onDestroy(){}inject(e){return O.get(e)}track(e){this.disposers.push(e)}ref(e,r){return e.querySelector(`[bind="${r}"]`)}spawn(e,r,...n){const s=_(()=>{const a=new e(n[0]);return a.mount(r),a});return this.children.push(s),s}mount(e){e.appendChild(this.render()),this.onMount()}destroy(){_(()=>{this.onDestroy();for(const e of this.children)e.destroy();this.children.length=0;for(const e of this.disposers)e();this.disposers.length=0})}wire(e,r,n){const s=n??(i=>this.track(i)),a=e.content.cloneNode(!0);for(const i of a.querySelectorAll("[bind]")){const l=r[i.getAttribute("bind")];if(l)if(typeof l=="function")s(x(()=>{const p=l();i instanceof HTMLInputElement||i instanceof HTMLTextAreaElement?i.value=String(p):i.textContent=String(p)}));else for(const[p,m]of Object.entries(l)){const g=p.includes("-");p.startsWith("on")&&typeof m=="function"?i.addEventListener(p.slice(2),m):typeof m=="function"?s(x(()=>{const b=m();g?i.setAttribute(p,String(b)):i[p]=b})):g?i.setAttribute(p,String(m)):i[p]=m}}return a}wireEl(e,r,n){return this.wire(e,r,n).firstElementChild}slot(e,r){const n=this.props[e];if(n==null)return!1;const s=this.ref(r,e);return s?(typeof n=="string"?s.textContent=n:typeof n=="function"&&n.prototype instanceof $?this.spawn(n,s):typeof n=="function"&&n(s,{spawn:(a,i,...l)=>this.spawn(a,i,...l),track:a=>this.track(a)}),!0):!1}$each(e,r,n,s=(a,i)=>i){const a=typeof r=="function"?r:()=>r.get(),i=new Map,l=new Map;this.track(()=>{for(const p of l.values())p.forEach(m=>m());l.clear()}),this.track(x(()=>{const p=a(),m=new Map;for(const[b,y]of p.entries()){const S=s(y,b);if(i.has(S))m.set(S,i.get(S));else{const R=[];m.set(S,_(()=>n(y,b,Te=>R.push(Te)))),l.set(S,R)}}for(const[b,y]of i)m.has(b)||(y.remove(),_(()=>l.get(b)?.forEach(S=>S())),l.delete(b));let g=e.firstChild;for(const b of m.values())b===g?g=g.nextSibling:e.insertBefore(b,g);i.clear();for(const[b,y]of m)i.set(b,y)}))}$condition(e,r,n,s){let a=null;this.track(x(()=>{a&&(a.remove(),a=null);const i=r.get();a=_(()=>i?n():s?.()??null),a&&e.appendChild(a)}))}$swap(e,r,n,s){let a=null;this.track(x(()=>{if(a){const p=a;a=null,_(()=>p.destroy())}e.textContent="";const i=r.get(),l=n[i]??Fe(i,n)??s;l&&(a=_(()=>{const p=new l;return p.mount(e),p}))})),this.track(()=>a?.destroy())}}const W=new Set;function Ke(t){return W.add(t),()=>W.delete(t)}function Ye(){for(const t of Array.from(W)){W.delete(t);try{t()}catch(e){console.error("[startApp] a dispose callback threw",e)}}}async function Qe(t,e,r){const n=document.querySelector(e);n.textContent="";const s=O.get(K);let a=null,i=!1,l=null,p=!!r?.hot?.data.hmr;const m=async g=>{a&&(a.destroy(),a=null,n.textContent=""),g?(l||(l=(await Pe(()=>import("./obs-shell.component-eLF5mnek.js"),[])).ObsShellComponent),a=_(()=>new l)):(!p&&r?.onInit&&(await r.onInit(),p=!0),a=_(()=>new t)),_(()=>a.mount(n)),i=g};await m(J(location.pathname).startsWith("/_obs")),x(()=>{const g=s.route.get().startsWith("/_obs");g!==i&&m(g)}),r?.hot&&(r.hot.data.hmr=!0,r.hot.dispose(()=>{try{a?.destroy()}catch(g){console.error("[startApp] the root component threw while disposing",g)}if(a=null,Ye(),r.onDispose)try{r.onDispose()}catch(g){console.error("[startApp] onDispose threw",g)}}),r.hot.accept())}class k extends Error{constructor(e,r,n,s){super(r),this.status=e,this.details=n,this.traceId=s,this.name="ApiError"}}const Ve=10,G=[];let B=[],j=null;function Xe(t){G.push(t),G.length>Ve&&G.shift()}function me(t,e,r){const n={code:t,message:e,url:typeof location<"u"?location.href:"",context:[...G],timestamp:new Date().toISOString()};r!==void 0&&(n.traceId=r),B.push(n),Je()}function Je(){j||(j=setTimeout(ge,5e3))}function ge(){if(j&&(clearTimeout(j),j=null),B.length===0)return;const t=B;B=[];for(const e of t){const r=JSON.stringify(e);typeof navigator<"u"&&navigator.sendBeacon?navigator.sendBeacon(`${X}/_obs/errors`,new Blob([r],{type:"application/json"})):typeof fetch<"u"&&fetch(`${X}/_obs/errors`,{method:"POST",headers:{"Content-Type":"application/json"},body:r}).catch(()=>{})}}typeof document<"u"&&document.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&ge()});const Ze=3e4,et=2,I=new Map,pe=new WeakMap;function tt(t){if(t instanceof k)return t.traceId;if(t!=null&&typeof t=="object")return pe.get(t)}async function u(t){if(t.method==="GET"){const e=I.get(t.url);if(e)return e;const r=oe(t,et);return I.set(t.url,r),r.then(()=>I.delete(t.url),()=>I.delete(t.url)),r}return oe(t,0)}async function oe(t,e){const r=t.timeout??Ze;let n;for(let s=0;s<=e;s++){const a=crypto.randomUUID();try{return await nt(rt(t,a),r)}catch(i){if(n=i,!(i instanceof k)&&i!=null&&typeof i=="object"&&pe.set(i,a),i instanceof k||s===e)break;await new Promise(l=>setTimeout(l,1e3*2**s))}}throw n}async function rt(t,e){const r={"X-Trace-Id":e},n={method:t.method,headers:r};t.body!==void 0&&(r["Content-Type"]="application/json",n.body=JSON.stringify(t.body));const s=await fetch(t.url,n),a=s.headers.get("x-trace-id")??e;if(Xe({type:"api",detail:`${t.method} ${t.url}`,timestamp:new Date().toISOString()}),!s.ok){const i=await s.json().catch(()=>({error:s.statusText}));throw new k(s.status,i.error??s.statusText,i.details,a)}return s.json()}function nt(t,e){let r;const n=new Promise((s,a)=>{r=setTimeout(()=>a(new Error("Request timeout")),e)});return Promise.race([t,n]).finally(()=>clearTimeout(r))}const Z=new Set;let Y=!1;function st(t){return Z.add(t),()=>{Z.delete(t)}}function be(){if(!Y){Y=!0;try{for(const t of[...Z])try{t()}catch(e){try{me("session-listener",at(e))}catch{}}}finally{Y=!1}}}function at(t){try{if(t instanceof Error){const e=t.message;if(typeof e=="string")return e}return String(t)}catch{return"listener threw a value that could not be described"}}async function D(t,e,r,n={}){U(()=>{t.set(!0),e.set(null)});try{const s=await r();return t.set(!1),s}catch(s){const a=ot(s);U(()=>{t.set(!1),e.set(a)}),me(a.code,a.message,tt(s)),a.code==="auth"&&n.sessionExpiry!==!1&&be();return}}function ot(t){return t instanceof k?t.status===401?{code:"auth",message:"Unauthorized"}:t.status===409?{code:"conflict",message:"Data has changed — please try again"}:t.status===400?{code:"validation",message:t.message}:t.status===429?{code:"rateLimit",message:"Too many requests"}:{code:"server",message:"Server error"}:t instanceof Error?t.message==="Request timeout"?{code:"timeout",message:"Request timeout"}:{code:"network",message:"Network error"}:{code:"unknown",message:"Unknown error"}}const Q={sessionExpiry:!1};function it(t){return{me:()=>u({method:"GET",url:`${t}/auth/me`}),login:e=>u({method:"POST",url:`${t}/auth/login`,body:e}),logout:()=>u({method:"POST",url:`${t}/auth/logout`,body:{}}),logoutAll:()=>u({method:"POST",url:`${t}/auth/logout-all`,body:{}})}}class T{constructor(){this.api=it(X),this.currentUser=new v(null),this.loading=new v(!1),this.error=new v(null),this.offSessionExpired=st(()=>{this.currentUser.peek()!==null&&this.currentUser.set(null)}),this.offAppDispose=Ke(()=>this.destroy())}destroy(){this.offSessionExpired(),this.offSessionExpired=()=>{},this.offAppDispose(),this.offAppDispose=()=>{}}async load(){const e=await D(this.loading,this.error,()=>this.api.me());e&&this.currentUser.set(e),this.error.get()?.code==="auth"&&this.error.set(null)}async login(e,r){const n=await D(this.loading,this.error,()=>this.api.login({username:e,password:r}),Q);return n?(this.currentUser.set(n),!0):!1}async logout(){await D(this.loading,this.error,()=>this.api.logout(),Q);const e=this.error.get();(!e||e.code==="auth")&&this.currentUser.set(null)}async logoutEverywhere(){const e=await D(this.loading,this.error,()=>this.api.logoutAll(),Q),r=this.error.get();return(!r||r.code==="auth")&&this.currentUser.set(null),e?.revoked??null}}const ye={radius:"12px","radius-pill":"999px","radius-sm":"6px","font-display":"'Fraunces', Georgia, serif",shadow:"0 1px 2px rgba(30, 53, 38, 0.08)","shadow-elevated":"0 4px 16px rgba(30, 53, 38, 0.14)"},ct={...ye,bg:"#f2eee2",surface:"#fbf9f1","surface-sunken":"#e9e4d4","surface-2":"#e9e4d4",primary:"#2c5e3f","primary-text":"#f7f4ea","btn-bg":"#fbf9f1","btn-hover":"#efeada",text:"#1e3526","text-muted":"#6b7a6e",border:"#d8d2bf","border-strong":"#b3ab92","topbar-bg":"#1e3526","active-bg":"#1e3526","active-text":"#f7f4ea","hover-bg":"#ece7d7","input-bg":"#ffffff",accent:"#b08d3e","accent-soft":"#f0e6cd","accent-strong":"#2c5e3f","on-accent":"#f7f4ea",danger:"#a0463c","danger-strong":"#7f352d","on-danger":"#f7f4ea",error:"#a0463c","under-par":"#a0463c","over-par":"#345b8a","hole-bar":"#e6a23f","hole-bar-text":"#3a2a0d"},dt={...ye,bg:"#15231a",surface:"#1d2f22","surface-sunken":"#101b14","surface-2":"#101b14",primary:"#5d9b75","primary-text":"#0f1a13","btn-bg":"#24392b","btn-hover":"#2e4836",text:"#e6e1d2","text-muted":"#8da093",border:"#33493a","border-strong":"#4d6653","topbar-bg":"#0f1a13","active-bg":"#5d9b75","active-text":"#0f1a13","hover-bg":"#273c2e","input-bg":"#101b14",accent:"#cfa84f","accent-soft":"#3a3320","accent-strong":"#5d9b75","on-accent":"#0f1a13",danger:"#d48a82","danger-strong":"#e0a49d","on-danger":"#15231a",error:"#d48a82","under-par":"#d48a82","over-par":"#8db2e0","hole-bar":"#c08a35","hole-bar-text":"#160f04",shadow:"0 1px 2px rgba(0, 0, 0, 0.3)","shadow-elevated":"0 4px 16px rgba(0, 0, 0, 0.4)"};function ve(t,e={}){const r=t==="light"?ct:dt,n=t==="light"?Ie:De;return Le({...r,...e},n)}const we={"manage-page-pad":"var(--space-4)","manage-page-pad-wide":"var(--space-6)","manage-stack-gap":"var(--space-3)","manage-section-gap":"var(--space-5)","manage-touch-target":"44px","manage-table-bg":"var(--surface)","manage-table-radius":"var(--radius)","manage-table-border":"var(--border)","manage-table-header-bg":"var(--surface-sunken)","manage-table-header-fg":"var(--text-muted)","manage-table-header-border":"var(--border-strong)","manage-table-header-pad-y":"var(--space-2)","manage-table-header-pad-x":"var(--space-3)","manage-table-cell-pad-y":"var(--space-3)","manage-table-cell-pad-x":"var(--space-3)","manage-table-row-border":"var(--border)","manage-table-row-hover-bg":"var(--hover-bg)","manage-table-card-gap":"var(--space-2)","manage-sidebar-width":"232px","manage-content-max":"1120px"},$e=t=>({"manage-chrome-bg":"var(--topbar-bg)","manage-chrome-fg":t,"manage-chrome-fg-muted":"color-mix(in srgb, var(--manage-chrome-fg) 66%, transparent)","manage-chrome-border":"color-mix(in srgb, var(--manage-chrome-fg) 14%, transparent)","manage-chrome-hover-bg":"color-mix(in srgb, var(--manage-chrome-fg) 9%, transparent)","manage-chrome-active-bg":"color-mix(in srgb, var(--manage-chrome-fg) 16%, transparent)","manage-scrim":"color-mix(in srgb, var(--topbar-bg) 62%, transparent)"}),_e=ve("light",{...we,...$e("var(--primary-text)")}),xe=ve("dark",{...we,...$e("var(--text)")}),o=He(_e,xe);function lt(){const t=document.querySelector('meta[name="theme-color"]');if(!t)return;const e=O.get(fe);x(()=>{const n=(e.dark.get()?xe:_e)["topbar-bg"];n&&t.setAttribute("content",n)})}class ut extends T{constructor(e){super(),this.client=e}client;async login(e,r){this.loading.set(!0);try{return this.currentUser.set(await this.client.login(e,r)),this.error.set(null),!0}catch{return this.error.set({message:"Sign-in failed.",code:"auth"}),!1}finally{this.loading.set(!1)}}async load(){this.loading.set(!0);try{this.currentUser.set(await this.client.me()),this.error.set(null)}catch(e){e instanceof k&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logout(){this.loading.set(!0);try{await this.client.logout(),this.currentUser.set(null),this.error.set(null)}catch(e){e instanceof k&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"})}finally{this.loading.set(!1)}}async logoutEverywhere(){this.loading.set(!0);try{const e=await this.client.logoutAll();return this.currentUser.set(null),this.error.set(null),e.revoked}catch(e){return e instanceof k&&e.status===401?(this.currentUser.set(null),this.error.set(null)):this.error.set({message:"Cannot reach the server.",code:"network"}),null}finally{this.loading.set(!1)}}}function ht(t){return{login:(e,r)=>u({method:"POST",url:`${t}/auth/login`,body:{username:e,password:r}}),me:()=>u({method:"GET",url:`${t}/auth/me`}),logout:()=>u({method:"POST",url:`${t}/auth/logout`,body:{}}),logoutAll:()=>u({method:"POST",url:`${t}/auth/logout-all`,body:{}})}}const L="/tapscore/manage/".replace(/\/+$/,"").replace(/\/manage$/,"")+"/api",ke=ht(L);function ft(t){return{async list(){return u({method:"GET",url:`${t}/clubs`})},async get(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/clubs/get${n?"?"+n:""}`})},async create(e){return u({method:"POST",url:`${t}/clubs`,body:e})},async update(e){return u({method:"POST",url:`${t}/clubs/update`,body:e})},async remove(e){return u({method:"DELETE",url:`${t}/clubs/${e.id}`})}}}function mt(t){return{async list(){return u({method:"GET",url:`${t}/courses`})},async listByClub(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/courses/by-club${n?"?"+n:""}`})},async get(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/courses/get${n?"?"+n:""}`})},async teeRoleCatalog(){return u({method:"GET",url:`${t}/courses/tee-roles/catalog`})},async teeRoles(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/courses/tee-roles${n?"?"+n:""}`})},async create(e){return u({method:"POST",url:`${t}/courses`,body:e})},async update(e){return u({method:"POST",url:`${t}/courses/update`,body:e})},async updateHole(e){return u({method:"POST",url:`${t}/courses/holes/update`,body:e})},async setTeeRole(e){return u({method:"POST",url:`${t}/courses/tee-roles`,body:e})},async clearTeeRole(e){return u({method:"DELETE",url:`${t}/courses/tee-roles/${e.courseId}/${e.roleKey}/${e.gender}`})},async validate(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/courses/validate${n?"?"+n:""}`})},async remove(e){return u({method:"DELETE",url:`${t}/courses/${e.id}`})}}}function gt(t){return{async listByCourse(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/tees/by-course${n?"?"+n:""}`})},async get(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/tees/get${n?"?"+n:""}`})},async create(e){return u({method:"POST",url:`${t}/tees`,body:e})},async update(e){return u({method:"POST",url:`${t}/tees/update`,body:e})},async remove(e){return u({method:"DELETE",url:`${t}/tees/${e.id}`})}}}function pt(t){return{async myRoles(){return u({method:"GET",url:`${t}/me/roles`})},async adminStats(){return u({method:"GET",url:`${t}/admin/stats`})},async adminRounds(e){const r=new URLSearchParams;for(const[s,a]of Object.entries(e))a!==void 0&&r.set(s,String(a));const n=r.toString();return u({method:"GET",url:`${t}/admin/rounds${n?"?"+n:""}`})},async adminPlayers(){return u({method:"GET",url:`${t}/admin/players`})},async adminGrantRole(e){return u({method:"POST",url:`${t}/admin/roles/grant`,body:e})},async adminRevokeRole(e){return u({method:"POST",url:`${t}/admin/roles/revoke`,body:e})}}}const bt={clubs:ft(L),courses:mt(L),tees:gt(L),admin:pt(L)};class P{roles=new v([]);loaded=new v(!1);error=new v(null);inflight=null;isSuperAdmin(){return this.has("super_admin")}canManageCourses(){return this.isSuperAdmin()||this.has("course_admin")}has(e){return this.roles.get().some(r=>r.role===e&&r.scopeType===null)}load(e=!1){return!e&&this.inflight?this.inflight:(this.inflight=(async()=>{this.error.set(null);try{this.roles.set(await bt.admin.myRoles())}catch(r){this.roles.set([]),r instanceof k&&r.status===401?be():(this.error.set("Cannot reach the server."),this.inflight=null)}finally{this.loaded.set(!0)}})(),this.inflight)}clear(){this.roles.set([]),this.loaded.set(!1),this.error.set(null),this.inflight=null}}const h=t=>`var(--${t})`,c=(t,e)=>`var(--${t}, ${e})`,d=t=>{const e=F[t];if(e===void 0)throw new Error(`unknown control token: --${t}`);return e},f=Be({xs:"0.25rem",sm:"0.5rem",md:"0.75rem",lg:"1rem",xl:"1.5rem","2xl":"2rem","3xl":"3rem","4xl":"4rem"}),N=t=>`
    background: ${c(`btn-${t}-bg`,d(`btn-${t}-bg`))};
    color: ${c(`btn-${t}-fg`,d(`btn-${t}-fg`))};
    border-color: ${c(`btn-${t}-border`,d(`btn-${t}-border`))};
    box-shadow: ${c(`btn-${t}-shadow`,d(`btn-${t}-shadow`))};
    &:hover {
        background: ${c(`btn-${t}-bg-hover`,d(`btn-${t}-bg-hover`))};
        color: ${c(`btn-${t}-fg-hover`,d(`btn-${t}-fg-hover`))};
        border-color: ${c(`btn-${t}-border-hover`,d(`btn-${t}-border-hover`))};
    }`,Se=`
    ...
    cursor: not-allowed;`,yt={primary:N("primary"),secondary:N("secondary"),ghost:N("ghost"),danger:N("danger"),disabled:Se},C=(t=c("btn-radius",d("btn-radius")),e="secondary")=>`
    /*
    ...
    ${yt[e]}
    &:disabled {${Se}}
`,vt=`max(${c("field-border-width",d("field-border-width"))}, ${c("field-rule-width",d("field-rule-width"))})`,M=(t,e)=>`
    border-top-color: ${t};
    border-right-color: ${t};
    border-left-color: ${t};
    border-bottom-color: ${e};`,wt=()=>`
    border-style: solid;
    ...
    ${M(c("field-border",d("field-border")),c("field-rule",d("field-rule")))}
    ...
    &:focus-visible {
        outline: none;
        ${M(c("field-focus-border",d("field-focus-border")),c("field-focus-border",d("field-focus-border")))}
    ...
    &[aria-invalid='true'] {
        ${M(c("field-invalid-border",d("field-invalid-border")),c("field-invalid-rule",d("field-invalid-rule")))}
    }
...
`;class te{crumbs=new v([]);set(e){this.crumbs.set(e)}}const _t=w(`
...
`);class xt extends ${static styles=`
        .mcourses {
            display: flex;
    ...
    `;crumbs=this.inject(te);render(){return this.wire(_t,{})}onMount(){this.crumbs.set([{label:"Courses"}])}}const kt=[{id:"courses",label:"Courses",path:"/courses",routes:{"/courses":xt},unlocked:t=>t.canManageCourses()}];function z(t){return kt.filter(e=>e.unlocked(t))}function St(t){const e={};for(const r of z(t))Object.assign(e,r.routes);return e}const Et=900,Tt=`(min-width: ${Et}px)`,Ct=w(`
...
`);class ie extends ${static styles=`
    ...
    `;router=this.inject(K);roles=this.inject(P);render(){const e=this.wire(Ct,{});return this.$each(this.ref(e,"list"),()=>z(this.roles),(r,n,s)=>this.wireEl(Ot,{link:{href:H+r.path,className:()=>{const a=this.router.route.get();return a===r.path||a.startsWith(r.path+"/")?"mnav__link mnav__link--active":"mnav__link"},"aria-current":()=>{const a=this.router.route.get();return a===r.path||a.startsWith(r.path+"/")?"page":"false"},onclick:a=>{const i=a;i.metaKey||i.ctrlKey||i.shiftKey||i.button!==0||(a.preventDefault(),this.router.navigate(r.path),this.props.onNavigate?.())}},label:()=>r.label},s),r=>r.id),e}}const Pt=w(`
    <section class="mnf">
...
`);class At extends ${static styles=`
        .mnf {
            display: flex;
            flex-direction: column;
    ...
    `;router=this.inject(K);roles=this.inject(P);crumbs=this.inject(te);onMount(){this.crumbs.set([])}render(){const e=z(this.roles)[0];return this.wire(Pt,{home:{className:()=>e?"mnf__home":"mnf__home hidden",textContent:()=>e?`Go to ${e.label}`:"",onclick:()=>{e&&this.router.navigate(e.path,!0)}}})}}const Lt=w(`
    <div class="mshell">
...
`);class Rt extends ${static styles=`
        .mshell {
            display: grid;
...
`);class Mt extends ${static styles=`
        .msignin {
            display: flex;
            align-items: center;
...
`);class Gt extends ${static styles=`
    ...
    `;auth=this.inject(T);render(){return this.wire(qt,{command:()=>`bun run grant:role grant ${this.auth.currentUser.get()?.username??"<username>"} super_admin`,who:()=>{const e=this.auth.currentUser.get();return e?`Signed in as ${e.username}`:""},signout:{onclick:()=>{this.auth.logout()}}})}}const Bt=w(`
    <div class="mboot">
...
`;class Wt extends ${static styles=Ee;render(){return this.wire(Bt,{})}}class Ht extends ${static styles=Ee;roles=this.inject(P);auth=this.inject(T);render(){return this.wire(Ut,{retry:{onclick:()=>{this.auth.load(),this.roles.load(!0)}}})}}const Ft=w('<div bind="gate" class="mapp"></div>');class Kt extends ${static styles=`
        .mapp { min-height: 100vh; min-height: 100dvh; }
    `;auth=this.inject(T);roles=this.inject(P);gate=new q(()=>this.auth.loading.get()?"loading":this.auth.currentUser.get()===null?this.auth.error.get()?"failed":"signed-out":this.roles.error.get()?"failed":this.roles.loaded.get()?z(this.roles).length>0?"ready":"denied":"loading");render(){const e=this.wire(Ft,{});return this.track(x(()=>{this.auth.currentUser.get()?this.roles.load():this.roles.clear()})),this.$swap(this.ref(e,"gate"),this.gate,{loading:Wt,failed:Ht,"signed-out":Mt,denied:Gt,ready:Rt}),e}}O.get(fe);lt();O.set(T,new ut(ke));const Yt=O.get(T);await Qe(Kt,"#app",{hot:void 0,onInit:async()=>{await Yt.load()}});export{X as A,$ as C,K as R,v as S,fe as T,u as a,U as b,q as c,De as d,x as e,Ie as n,D as r,w as t};
