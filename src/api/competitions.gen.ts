...
export interface CompetitionsApi {
    ...
    addParticipant(input: { competitionId: string; playerId?: string; guestPlayerId?: string; category?: null | string }): Promise<{ ok: true; value: CompetitionParticipant } | { ok: false; refusal: { code: string; message: string } }>;
