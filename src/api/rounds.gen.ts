...
export interface RoundsApi {
    ...
    update(input: { id: string; date?: string; roundType?: 'full_18' | 'front_9' | 'back_9' | 'custom_holes'; venueType?: 'outdoor' | 'indoor'; startListMode?: 'structured' | 'fixed_slots' | 'open_window'; windowStart?: null | string; windowEnd?: null | string; selfOrganize?: boolean; status?: 'not_started' | 'active' | 'complete' }): Promise<Round>;
